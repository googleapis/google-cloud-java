...
public final class CertificateAuthority extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class AccessUrls extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private AccessUrls(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(caCertificateAccessUrl_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, caCertificateAccessUrl_);
      }
      for (int i = 0; i < crlAccessUrls_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, crlAccessUrls_.getRaw(i));
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(caCertificateAccessUrl_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, caCertificateAccessUrl_);
      }
      {
        int dataSize = 0;
        for (int i = 0; i < crlAccessUrls_.size(); i++) {
   ...
   */
  public static final class KeyVersionSpec extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private KeyVersionSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateAuthority.SignHashAlgorithm
      ...
      if (keyVersionCase_ == 2) {
        com.google.cloud.security.privateca.v1.CertificateAuthority.SignHashAlgorithm result =
            com.google.cloud.security.privateca.v1.CertificateAuthority.SignHashAlgorithm.forNumber(
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (keyVersionCase_ == 1) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, keyVersion_);
      }
      if (keyVersionCase_ == 2) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (keyVersionCase_ == 1) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, keyVersion_);
      }
      if (keyVersionCase_ == 2) {
        size +=
   ...
   */
  public static final class UserDefinedAccessUrls extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private UserDefinedAccessUrls(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public com.google.cloud.security.privateca.v1.CertificateAuthority.Type getType() {
    com.google.cloud.security.privateca.v1.CertificateAuthority.Type result =
        com.google.cloud.security.privateca.v1.CertificateAuthority.Type.forNumber(type_);
    return result == null
  ...
  public com.google.cloud.security.privateca.v1.CertificateAuthority.State getState() {
    com.google.cloud.security.privateca.v1.CertificateAuthority.State result =
        com.google.cloud.security.privateca.v1.CertificateAuthority.State.forNumber(state_);
    return result == null
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < pemCaCertificates_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, pemCaCertificates_.getRaw(i));
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gcsBucket_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, gcsBucket_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gcsBucket_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(11, gcsBucket_);
    }
    if (((bitField0_ & 0x00000010) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetLifetimeFieldBuilder();
        internalGetKeySpecFieldBuilder();
        internalGetSubordinateConfigFieldBuilder();
        internalGetCaCertificateDescriptionsFieldBuilder();
        internalGetAccessUrlsFieldBuilder();
        ...
        internalGetUserDefinedAccessUrlsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetLifetimeFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000008;
                break;
              } // case 34
            case 42:
              {
                input.readMessage(internalGetKeySpecFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 50:
              {
                input.readMessage(
                    internalGetSubordinateConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 98:
              {
                input.readMessage(
                    internalGetAccessUrlsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 146:
              {
                input.readMessage(
                    internalGetUserDefinedAccessUrlsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.protobuf.Duration.Builder getLifetimeBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
      return internalGetLifetimeFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateAuthority.KeyVersionSpec.Builder
      ...
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetKeySpecFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.security.privateca.v1.SubordinateConfig.Builder
      ...
      bitField0_ |= 0x00000020;
      onChanged();
      return internalGetSubordinateConfigFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateDescription.Builder
      ...
      return internalGetCaCertificateDescriptionsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateDescription.Builder
      ...
      return internalGetCaCertificateDescriptionsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.cloud.security.privateca.v1.CertificateDescription.Builder>
      ...
      return internalGetCaCertificateDescriptionsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateAuthority.AccessUrls.Builder
      ...
      bitField0_ |= 0x00000800;
      onChanged();
      return internalGetAccessUrlsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateAuthority.UserDefinedAccessUrls.Builder
      ...
      bitField0_ |= 0x00020000;
      onChanged();
      return internalGetUserDefinedAccessUrlsFieldBuilder().getBuilder();
    }
