...
public final class Certificate extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class RevocationDetails extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private RevocationDetails(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public com.google.cloud.security.privateca.v1.RevocationReason getRevocationState() {
      com.google.cloud.security.privateca.v1.RevocationReason result =
          com.google.cloud.security.privateca.v1.RevocationReason.forNumber(revocationState_);
      return result == null
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetRevocationTimeFieldBuilder();
        }
      }
      ...
      private void buildPartial0(
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          result.revocationTime_ =
              revocationTimeBuilder_ == null ? revocationTime_ : revocationTimeBuilder_.build();
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18:
                {
                  input.readMessage(
                      internalGetRevocationTimeFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.protobuf.Timestamp.Builder getRevocationTimeBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetRevocationTimeFieldBuilder().getBuilder();
      }
  ...
  public com.google.cloud.security.privateca.v1.SubjectRequestMode getSubjectMode() {
    com.google.cloud.security.privateca.v1.SubjectRequestMode result =
        com.google.cloud.security.privateca.v1.SubjectRequestMode.forNumber(subjectMode_);
    return result == null
  ...
  public static final int REQUESTED_NOT_BEFORE_TIME_FIELD_NUMBER = 15;
  private com.google.protobuf.Timestamp requestedNotBeforeTime_;
   ...
   */
  @java.lang.Override
  public boolean hasRequestedNotBeforeTime() {
   ...
   */
  @java.lang.Override
  public com.google.protobuf.Timestamp getRequestedNotBeforeTime() {
    return requestedNotBeforeTime_ == null
        ? com.google.protobuf.Timestamp.getDefaultInstance()
        : requestedNotBeforeTime_;
  }
   ...
   */
  @java.lang.Override
  public com.google.protobuf.TimestampOrBuilder getRequestedNotBeforeTimeOrBuilder() {
    return requestedNotBeforeTime_ == null
        ? com.google.protobuf.Timestamp.getDefaultInstance()
        : requestedNotBeforeTime_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (certificateConfigCase_ == 2) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, certificateConfig_);
    }
    if (certificateConfigCase_ == 3) {
      output.writeMessage(
          3, (com.google.cloud.security.privateca.v1.CertificateConfig) certificateConfig_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(issuerCertificateAuthority_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, issuerCertificateAuthority_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(5, getLifetime());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(certificateTemplate_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, certificateTemplate_);
    }
    if (subjectMode_
    ...
    for (int i = 0; i < pemCertificateChain_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, pemCertificateChain_.getRaw(i));
    }
    ...
    if (((bitField0_ & 0x00000020) != 0)) {
      output.writeMessage(15, getRequestedNotBeforeTime());
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (certificateConfigCase_ == 2) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, certificateConfig_);
    }
    if (certificateConfigCase_ == 3) {
      size +=
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(issuerCertificateAuthority_)) {
      size +=
          com.google.protobuf.GeneratedMessage.computeStringSize(4, issuerCertificateAuthority_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getLifetime());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(certificateTemplate_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, certificateTemplate_);
    }
    if (subjectMode_
        != com.google.cloud.security.privateca.v1.SubjectRequestMode
            .SUBJECT_REQUEST_MODE_UNSPECIFIED
    ...
    if (((bitField0_ & 0x00000020) != 0)) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(15, getRequestedNotBeforeTime());
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasRequestedNotBeforeTime() != other.hasRequestedNotBeforeTime()) return false;
    if (hasRequestedNotBeforeTime()) {
      if (!getRequestedNotBeforeTime().equals(other.getRequestedNotBeforeTime())) return false;
    }
  ...
  public int hashCode() {
    ...
    if (hasRequestedNotBeforeTime()) {
      hash = (37 * hash) + REQUESTED_NOT_BEFORE_TIME_FIELD_NUMBER;
      hash = (53 * hash) + getRequestedNotBeforeTime().hashCode();
    }
    switch (certificateConfigCase_) {
      case 2:
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetRevocationDetailsFieldBuilder();
        internalGetCertificateDescriptionFieldBuilder();
        internalGetCreateTimeFieldBuilder();
        internalGetUpdateTimeFieldBuilder();
        internalGetRequestedNotBeforeTimeFieldBuilder();
      }
    }
    ...
    public Builder clear() {
      ...
      requestedNotBeforeTime_ = null;
      if (requestedNotBeforeTimeBuilder_ != null) {
        requestedNotBeforeTimeBuilder_.dispose();
        requestedNotBeforeTimeBuilder_ = null;
      }
    ...
    private void buildPartial0(com.google.cloud.security.privateca.v1.Certificate result) {
      ...
      if (((from_bitField0_ & 0x00000200) != 0)) {
        result.certificateDescription_ =
            certificateDescriptionBuilder_ == null
                ? certificateDescription_
      ...
      if (((from_bitField0_ & 0x00004000) != 0)) {
        result.requestedNotBeforeTime_ =
            requestedNotBeforeTimeBuilder_ == null
                ? requestedNotBeforeTime_
                : requestedNotBeforeTimeBuilder_.build();
    ...
    public Builder mergeFrom(com.google.cloud.security.privateca.v1.Certificate other) {
      ...
      if (other.hasRequestedNotBeforeTime()) {
        mergeRequestedNotBeforeTime(other.getRequestedNotBeforeTime());
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66:
              {
                input.readMessage(
                    internalGetRevocationDetailsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 82:
              {
                input.readMessage(
                    internalGetCertificateDescriptionFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 122:
              {
                input.readMessage(
                    internalGetRequestedNotBeforeTimeFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.cloud.security.privateca.v1.Certificate.RevocationDetails.Builder
      ...
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetRevocationDetailsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.security.privateca.v1.CertificateDescription.Builder
      ...
      bitField0_ |= 0x00000200;
      onChanged();
      return internalGetCertificateDescriptionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.protobuf.Timestamp.Builder,
            com.google.protobuf.TimestampOrBuilder>
        requestedNotBeforeTimeBuilder_;
    ...
    public com.google.protobuf.Timestamp getRequestedNotBeforeTime() {
      if (requestedNotBeforeTimeBuilder_ == null) {
        ...
        return requestedNotBeforeTimeBuilder_.getMessage();
      }
    }
     ...
     * </code>
     */
    public Builder setRequestedNotBeforeTime(com.google.protobuf.Timestamp value) {
      if (requestedNotBeforeTimeBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        requestedNotBeforeTimeBuilder_.setMessage(value);
      }
      bitField0_ |= 0x00004000;
      onChanged();
      return this;
     ...
     * </code>
     */
    public Builder setRequestedNotBeforeTime(
        com.google.protobuf.Timestamp.Builder builderForValue) {
      if (requestedNotBeforeTimeBuilder_ == null) {
        requestedNotBeforeTime_ = builderForValue.build();
      } else {
        requestedNotBeforeTimeBuilder_.setMessage(builderForValue.build());
      }
      bitField0_ |= 0x00004000;
      onChanged();
      return this;
     ...
     * </code>
     */
    public Builder mergeRequestedNotBeforeTime(com.google.protobuf.Timestamp value) {
      if (requestedNotBeforeTimeBuilder_ == null) {
        if (((bitField0_ & 0x00004000) != 0)
            && requestedNotBeforeTime_ != null
            && requestedNotBeforeTime_ != com.google.protobuf.Timestamp.getDefaultInstance()) {
          getRequestedNotBeforeTimeBuilder().mergeFrom(value);
        } else {
          requestedNotBeforeTime_ = value;
        }
      } else {
        requestedNotBeforeTimeBuilder_.mergeFrom(value);
      }
     ...
     * </code>
     */
    public Builder clearRequestedNotBeforeTime() {
     ...
     * </code>
     */
    public com.google.protobuf.Timestamp.Builder getRequestedNotBeforeTimeBuilder() {
      bitField0_ |= 0x00004000;
      onChanged();
      return internalGetRequestedNotBeforeTimeFieldBuilder().getBuilder();
    }
    ...
    public com.google.protobuf.TimestampOrBuilder getRequestedNotBeforeTimeOrBuilder() {
      if (requestedNotBeforeTimeBuilder_ != null) {
        return requestedNotBeforeTimeBuilder_.getMessageOrBuilder();
      } else {
        return requestedNotBeforeTime_ == null
            ? com.google.protobuf.Timestamp.getDefaultInstance()
            : requestedNotBeforeTime_;
      ...
      if (requestedNotBeforeTimeBuilder_ == null) {
        requestedNotBeforeTimeBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.protobuf.Timestamp.Builder,
                com.google.protobuf.TimestampOrBuilder>(
                getRequestedNotBeforeTime(), getParentForChildren(), isClean());
        requestedNotBeforeTime_ = null;
      }
      return requestedNotBeforeTimeBuilder_;
    }
