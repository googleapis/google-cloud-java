...
public final class CertificateExtensionConstraints extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CertificateExtensionConstraints(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private CertificateExtensionConstraints() {
    knownExtensions_ = emptyIntList();
  ...
  private com.google.protobuf.Internal.IntList knownExtensions_ = emptyIntList();
  ...
  public com.google.cloud.security.privateca.v1.CertificateExtensionConstraints
    ...
    return knownExtensions_converter_.convert(knownExtensions_.getInt(index));
  }
  ...
  public int getKnownExtensionsValue(int index) {
    return knownExtensions_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < knownExtensions_.size(); i++) {
      output.writeEnumNoTag(knownExtensions_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    {
      ...
      for (int i = 0; i < knownExtensions_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(knownExtensions_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        knownExtensions_.makeImmutable();
          ...
          if (additionalExtensionsBuilder_.isEmpty()) {
            ...
            additionalExtensionsBuilder_ =
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                    ? internalGetAdditionalExtensionsFieldBuilder()
                    : null;
          } else {
            ...
            case 8:
              {
                ...
                ensureKnownExtensionsIsMutable();
                knownExtensions_.addInt(tmpRaw);
                break;
              } // case 8
            case 10:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  knownExtensions_.addInt(input.readEnum());
                }
    ...
    private void ensureKnownExtensionsIsMutable() {
      if (!knownExtensions_.isModifiable()) {
        knownExtensions_ = makeMutableCopy(knownExtensions_);
      }
      bitField0_ |= 0x00000001;
    }
    ...
    public Builder setKnownExtensions(
      ...
      ensureKnownExtensionsIsMutable();
      knownExtensions_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addKnownExtensions(
      ...
      ensureKnownExtensionsIsMutable();
      knownExtensions_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setKnownExtensionsValue(int index, int value) {
      ensureKnownExtensionsIsMutable();
      knownExtensions_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public com.google.cloud.security.privateca.v1.ObjectId.Builder getAdditionalExtensionsBuilder(
        int index) {
      return internalGetAdditionalExtensionsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.security.privateca.v1.ObjectId.Builder
      ...
      return internalGetAdditionalExtensionsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.security.privateca.v1.ObjectId.Builder>
      ...
      return internalGetAdditionalExtensionsFieldBuilder().getBuilderList();
    }
