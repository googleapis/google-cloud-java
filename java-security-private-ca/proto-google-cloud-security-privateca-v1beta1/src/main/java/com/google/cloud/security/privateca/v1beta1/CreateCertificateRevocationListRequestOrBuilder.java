...
public interface CreateCertificateRevocationListRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.security.privateca.v1beta1.CreateCertificateRevocationListRequest)
   ...
   * </pre>
   *
   * <code>string certificate_revocation_list_id = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   * @return The certificateRevocationListId.
   */
  java.lang.String getCertificateRevocationListId();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   *
   * @return The bytes for certificateRevocationListId.
   */
   ...
   *
   * <code>
   * .google.cloud.security.privateca.v1beta1.CertificateRevocationList certificate_revocation_list = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
