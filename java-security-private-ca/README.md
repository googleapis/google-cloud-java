...
```Groovy
implementation 'com.google.cloud:google-cloud-security-private-ca:2.89.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-security-private-ca/2.89.0
