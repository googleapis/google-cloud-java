...
public class CertificateRevocationListName implements ResourceName {
  ...
  public static @Nullable CertificateRevocationListName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CertificateRevocationListName> values) {
