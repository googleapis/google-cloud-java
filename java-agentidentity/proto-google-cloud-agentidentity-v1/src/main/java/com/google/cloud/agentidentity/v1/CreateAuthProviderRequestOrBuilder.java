...
public interface CreateAuthProviderRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.agentidentity.v1.CreateAuthProviderRequest)
   ...
   *
   * <code>
   * .google.cloud.agentidentity.v1.AuthProvider auth_provider = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.agentidentity.v1.AuthProvider getAuthProvider();
   ...
   * </code>
   */
  com.google.cloud.agentidentity.v1.AuthProviderOrBuilder getAuthProviderOrBuilder();
