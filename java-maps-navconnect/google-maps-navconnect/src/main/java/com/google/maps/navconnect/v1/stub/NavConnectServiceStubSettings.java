...
/**
 * Settings class to configure an instance of {@link NavConnectServiceStub}.
 *
 * <p>The default instance has everything set to sensible defaults:
 *
 * <ul>
 *   <li>The default service address (navigationconnect.googleapis.com) and default port (443) are
 *       used.
...
public class NavConnectServiceStubSettings extends StubSettings<NavConnectServiceStubSettings> {
  ...
  public NavConnectServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcNavConnectServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonNavConnectServiceStub.create(this);
    }
  ...
  public static String getDefaultEndpoint() {
    return "navigationconnect.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "navigationconnect.mtls.googleapis.com:443";
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(NavConnectServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return NavConnectServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected NavConnectServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  protected LibraryMetadata getLibraryMetadata() {
    return LibraryMetadata.newBuilder()
        .setArtifactName("com.google.maps:google-maps-navconnect")
        .setRepository("googleapis/google-cloud-java")
        .setVersion(Version.VERSION)
        .build();
  }

  /** Builder for NavConnectServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<NavConnectServiceStubSettings, Builder> {
    ...
    protected Builder(@Nullable ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(createTripSettings, getTripSettings);
      initDefaults(this);
    }

    protected Builder(NavConnectServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public NavConnectServiceStubSettings build() throws IOException {
      return new NavConnectServiceStubSettings(this);
    }
  }
}
