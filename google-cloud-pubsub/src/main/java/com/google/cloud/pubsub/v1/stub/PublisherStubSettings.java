 ...
 * PublisherStubSettingsBuilder.createTopicSettings().getRetrySettingsBuilder()
 *     .setTotalTimeout(Duration.ofSeconds(30));
 * PublisherStubSettings PublisherStubSettings = PublisherStubSettingsBuilder.build();
 * </code>
 * </pre>
 */
