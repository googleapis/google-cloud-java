...
public final class InsertAllRequest implements Serializable {
  ...
  public static class RowToInsert implements Serializable {
    ...
    RowToInsert(String id, Map<String, ? extends Object> content) {
      this.id = id;
     ...
     */
    public static RowToInsert of(String id, Map<String, ? extends Object> content) {
     ...
     * @param content the actual content of the row
     */
    public static RowToInsert of(Map<String, ? extends Object> content) {
  ...
  public static final class Builder {
     ...
     * }</pre>
     */
    public Builder addRow(String id, Map<String, ? extends Object> content) {
     ...
     * }</pre>
     */
    public Builder addRow(Map<String, ? extends Object> content) {
