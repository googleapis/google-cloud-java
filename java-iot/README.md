...
```Groovy
implementation 'com.google.cloud:google-cloud-iot:2.47.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-iot" % "2.47.0"
```
...
Cloud Internet of Things (IoT) Core uses both gRPC and HTTP/JSON for the transport layer.
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-iot/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-iot/2.45.0
