...
```Groovy
implementation 'com.google.cloud:google-cloud-logging:3.29.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-logging/3.29.0
