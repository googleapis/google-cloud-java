...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging" % "3.39.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-logging/3.39.0
