...
public final class UpdateViewRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private UpdateViewRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(internalGetViewFieldBuilder().getBuilder(), extensionRegistry);
