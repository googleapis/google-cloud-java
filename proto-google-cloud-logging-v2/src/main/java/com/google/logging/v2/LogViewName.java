...
public class LogViewName implements ResourceName {
  ...
  private static final PathTemplate PROJECT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding(
          "projects/{project}/locations/{location}/buckets/{bucket}/views/{view}");
  private static final PathTemplate ORGANIZATION_LOCATION_BUCKET_VIEW_PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding(
          "organizations/{organization}/locations/{location}/buckets/{bucket}/views/{view}");
  private static final PathTemplate FOLDER_LOCATION_BUCKET_VIEW_PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding(
          "folders/{folder}/locations/{location}/buckets/{bucket}/views/{view}");
  private static final PathTemplate BILLING_ACCOUNT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding(
  ...
  private LogViewName(Builder builder) {
    ...
    pathTemplate = PROJECT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE;
  }
  ...
  private LogViewName(OrganizationLocationBucketViewBuilder builder) {
    ...
    bucket = Preconditions.checkNotNull(builder.getBucket());
    view = Preconditions.checkNotNull(builder.getView());
    pathTemplate = ORGANIZATION_LOCATION_BUCKET_VIEW_PATH_TEMPLATE;
  }
  ...
  private LogViewName(FolderLocationBucketViewBuilder builder) {
    ...
    bucket = Preconditions.checkNotNull(builder.getBucket());
    view = Preconditions.checkNotNull(builder.getView());
    pathTemplate = FOLDER_LOCATION_BUCKET_VIEW_PATH_TEMPLATE;
  }
  ...
  private LogViewName(BillingAccountLocationBucketViewBuilder builder) {
    ...
    bucket = Preconditions.checkNotNull(builder.getBucket());
    view = Preconditions.checkNotNull(builder.getView());
    pathTemplate = BILLING_ACCOUNT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE;
  }
  ...
  public static LogViewName of(String project, String location, String bucket, String view) {
    return newProjectLocationBucketViewBuilder()
        .setProject(project)
  ...
  public static LogViewName parse(String formattedString) {
    ...
    if (PROJECT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)) {
      Map<String, String> matchMap =
          PROJECT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.match(formattedString);
      return ofProjectLocationBucketViewName(
          matchMap.get("project"),
          matchMap.get("location"),
          matchMap.get("bucket"),
          matchMap.get("view"));
    } else if (ORGANIZATION_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)) {
      Map<String, String> matchMap =
          ORGANIZATION_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.match(formattedString);
      return ofOrganizationLocationBucketViewName(
          matchMap.get("organization"),
          matchMap.get("location"),
          matchMap.get("bucket"),
          matchMap.get("view"));
    } else if (FOLDER_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)) {
      Map<String, String> matchMap =
          FOLDER_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.match(formattedString);
      return ofFolderLocationBucketViewName(
          matchMap.get("folder"),
          matchMap.get("location"),
          matchMap.get("bucket"),
          matchMap.get("view"));
    } else if (BILLING_ACCOUNT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)) {
      Map<String, String> matchMap =
          BILLING_ACCOUNT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.match(formattedString);
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)
        || ORGANIZATION_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)
        || FOLDER_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString)
        || BILLING_ACCOUNT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE.matches(formattedString);
  }
  ...
  public static class Builder {
    ...
    private Builder(LogViewName logViewName) {
      Preconditions.checkArgument(
          logViewName.pathTemplate == PROJECT_LOCATION_BUCKET_VIEW_PATH_TEMPLATE,
  ...
  public static class OrganizationLocationBucketViewBuilder {
    ...
    private OrganizationLocationBucketViewBuilder() {}
  ...
  public static class FolderLocationBucketViewBuilder {
    ...
    private FolderLocationBucketViewBuilder() {}
  ...
  public static class BillingAccountLocationBucketViewBuilder {
    ...
    private BillingAccountLocationBucketViewBuilder() {}
