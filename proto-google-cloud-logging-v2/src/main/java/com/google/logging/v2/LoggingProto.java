  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\037google/logging/v2/logging.proto\022\021googl"
          ...
          + "Empty\"\310\001\332A\010log_name\202\323\344\223\002\266\001* /v2/{log_nam"
          + "e=projects/*/logs/*}Z\033*\031/v2/{log_name=*/"
          + "*/logs/*}Z\'*%/v2/{log_name=organizations"
          + "/*/logs/*}Z!*\037/v2/{log_name=folders/*/lo"
          + "gs/*}Z)*\'/v2/{log_name=billingAccounts/*"
          + "/logs/*}\022\251\001\n\017WriteLogEntries\022).google.lo"
          + "gging.v2.WriteLogEntriesRequest\032*.google"
          + ".logging.v2.WriteLogEntriesResponse\"?\332A "
          + "log_name,resource,labels,entries\202\323\344\223\002\026\"\021"
          + "/v2/entries:write:\001*\022\243\001\n\016ListLogEntries\022"
          + "(.google.logging.v2.ListLogEntriesReques"
          + "t\032).google.logging.v2.ListLogEntriesResp"
          + "onse\"<\332A\036resource_names,filter,order_by\202"
          + "\323\344\223\002\025\"\020/v2/entries:list:\001*\022\305\001\n ListMonit"
          ...
          + "olders/*}/logsZ%\022#/v2/{parent=billingAcc"
          + "ounts/*}/logsZ<\022:/v2/{parent=projects/*/"
          + "locations/*/buckets/*/views/*}/logsZA\022?/"
          + "v2/{parent=organizations/*/locations/*/b"
          + "uckets/*/views/*}/logsZ;\0229/v2/{parent=fo"
          + "lders/*/locations/*/buckets/*/views/*}/l"
          + "ogsZC\022A/v2/{parent=billingAccounts/*/loc"
          + "ations/*/buckets/*/views/*}/logs\022\206\001\n\016Tai"
