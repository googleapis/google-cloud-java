  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "protobuf/empty.proto\032\027google/rpc/status.proto\"H\n"
          ...
          + "logging.v2.WriteLogEntriesRequest.LabelsEntryB\003\340A\001\0221\n"
          ...
          + "\020log_entry_errors\030\001"
          + " \003(\0132C.google.logging.v2.WriteLogEntriesPartialErrors.LogEntryErrorsEntry\032I\n"
          ...
          + "\tB\"\340A\002\372A\034\022\032logging.googleapis.com/Log\022:\n"
          + "\016resource_names\030\010 \003("
          + "\tB\"\340A\001\372A\034\022\032logging.googleapis.com/Log\022\026\n"
          ...
          + "\020suppression_info\030\002"
          + " \003(\01329.google.logging.v2.TailLogEntriesResponse.SuppressionInfo\032\301\001\n"
          + "\017SuppressionInfo\022P\n"
          + "\006reason\030\001 \001(\0162@.google.l"
          + "ogging.v2.TailLogEntriesResponse.SuppressionInfo.Reason\022\030\n"
          ...
          + "g.v2.DeleteLogRequest\032\026.google.protobuf.Empty\"\310\001\332A\010log_name\202\323\344\223\002\266\001*"
          + " /v2/{log_name=projects/*/logs/*}Z\033*\031/v2/{log_name=*/"
          + "*/logs/*}Z\'*%/v2/{log_name=organizations/*/logs/*}Z!*\037/v2/{log_name=folders/*/lo"
          + "gs/*}Z)*\'/v2/{log_name=billingAccounts/*/logs/*}\022\251\001\n"
          + "\017WriteLogEntries\022).google.lo"
          + "gging.v2.WriteLogEntriesRequest\032*.google.logging.v2.WriteLogEntriesResponse\"?\332A"
          + " log_name,resource,labels,entries\202\323\344\223\002\026\"\021/v2/entries:write:\001*\022\243\001\n"
          + "\016ListLogEntries\022(.google.logging.v2.ListLogEntriesReques"
          + "t\032).google.logging.v2.ListLogEntriesResp"
          + "onse\"<\332A\036resource_names,filter,order_by\202\323\344\223\002\025\"\020/v2/entries:list:\001*\022\305\001\n"
          + " ListMonitoredResourceDescriptors\022:.google.logging"
          + ".v2.ListMonitoredResourceDescriptorsRequ"
          + "est\032;.google.logging.v2.ListMonitoredResourceDescriptorsResponse\"(\202\323\344\223\002\"\022"
          + " /v2/monitoredResourceDescriptors\022\213\004\n"
          + "\010ListLogs\022\".google.logging.v2.ListLogsRequest\032#.go"
          + "ogle.logging.v2.ListLogsResponse\"\265\003\332A\006pa"
          + "rent\202\323\344\223\002\245\003\022\025/v2/{parent=*/*}/logsZ\036\022\034/v"
          + "2/{parent=projects/*}/logsZ#\022!/v2/{paren"
          + "t=organizations/*}/logsZ\035\022\033/v2/{parent=f"
          + "olders/*}/logsZ%\022#/v2/{parent=billingAccounts/*}/logsZ<\022:/v2/{parent=projects/*/"
          + "locations/*/buckets/*/views/*}/logsZA\022?/v2/{parent=organizations/*/locations/*/b"
          + "uckets/*/views/*}/logsZ;\0229/v2/{parent=folders/*/locations/*/buckets/*/views/*}/l"
          + "ogsZC\022A/v2/{parent=billingAccounts/*/locations/*/buckets/*/views/*}/logs\022\206\001\n"
          + "\016TailLogEntries\022(.google.logging.v2.TailLogE"
          ...
          + "\001https://www.googleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/"
          + "cloud-platform.read-only,https://www.googleapis.com/auth/logging.admin,https://w"
          + "ww.googleapis.com/auth/logging.read,http"
          + "s://www.googleapis.com/auth/logging.writeB\262\001\n"
          + "\025com.google.logging.v2B\014LoggingProtoP\001Z5cloud.google.com/go/logging/apiv2/l"
