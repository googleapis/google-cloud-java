...
public class ExternalAccountKeyName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_EXTERNAL_ACCOUNT_KEY =
  ...
  private ExternalAccountKeyName(Builder builder) {
    ...
    externalAccountKey = Preconditions.checkNotNull(builder.getExternalAccountKey());
  }
  ...
  public static ExternalAccountKeyName of(
      String project, String location, String externalAccountKey) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable ExternalAccountKeyName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_EXTERNAL_ACCOUNT_KEY.validatedMatch(
            formattedString, "ExternalAccountKeyName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("external_account_key"));
  }

  public static List<ExternalAccountKeyName> parseList(List<String> formattedStrings) {
    List<ExternalAccountKeyName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ExternalAccountKeyName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (externalAccountKey != null) {
            fieldMapBuilder.put("external_account_key", externalAccountKey);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_EXTERNAL_ACCOUNT_KEY.instantiate(
        "project", project, "location", location, "external_account_key", externalAccountKey);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.externalAccountKey, that.externalAccountKey);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(externalAccountKey);
    return h;
  }
