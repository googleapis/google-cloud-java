...
public class PostureName implements ResourceName {
  private static final PathTemplate ORGANIZATION_LOCATION_POSTURE =
  ...
  private PostureName(Builder builder) {
    ...
    posture = Preconditions.checkNotNull(builder.getPosture());
  }
  ...
  public static @Nullable PostureName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        ORGANIZATION_LOCATION_POSTURE.validatedMatch(
            formattedString, "PostureName.parse: formattedString not in valid format");
    return of(matchMap.get("organization"), matchMap.get("location"), matchMap.get("posture"));
  }

  public static List<PostureName> parseList(List<String> formattedStrings) {
    List<PostureName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable PostureName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (posture != null) {
            fieldMapBuilder.put("posture", posture);
          }
  ...
  public String toString() {
    return ORGANIZATION_LOCATION_POSTURE.instantiate(
        "organization", organization, "location", location, "posture", posture);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.organization, that.organization)
          ...
          && Objects.equals(this.posture, that.posture);
    }
    return false;
  }
