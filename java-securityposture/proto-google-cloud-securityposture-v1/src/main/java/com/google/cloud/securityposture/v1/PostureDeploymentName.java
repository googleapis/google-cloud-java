...
public class PostureDeploymentName implements ResourceName {
  ...
  public static @Nullable PostureDeploymentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PostureDeploymentName> values) {
