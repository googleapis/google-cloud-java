...
public class PostureTemplateName implements ResourceName {
  ...
  public static @Nullable PostureTemplateName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PostureTemplateName> values) {
