...
public interface PscConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.sql.v1beta4.PscConfig)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.sql.v1beta4.PscAutoConnectionConfig> getPscAutoConnectionsList();
