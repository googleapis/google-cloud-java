...
public interface BackupOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.sql.v1beta4.Backup)
   ...
   * @return The type.
   */
  com.google.cloud.sql.v1beta4.Backup.SqlBackupType getType();
   ...
   * @return The state.
   */
  com.google.cloud.sql.v1beta4.Backup.SqlBackupState getState();
   ...
   */
  com.google.cloud.sql.v1beta4.DatabaseInstance getInstanceSettings();
   ...
   * </code>
   */
  com.google.cloud.sql.v1beta4.DatabaseInstanceOrBuilder getInstanceSettingsOrBuilder();
  ...
  com.google.cloud.sql.v1beta4.Backup.ExpirationCase getExpirationCase();
}
