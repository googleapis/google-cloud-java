...
public interface OnPremisesConfigurationOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.cloud.sql.v1beta4.SelectedObjects> getSelectedObjectsList();
   ...
   * </code>
   */
  com.google.cloud.sql.v1beta4.SelectedObjects getSelectedObjects(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.sql.v1beta4.SelectedObjectsOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.sql.v1beta4.SelectedObjectsOrBuilder getSelectedObjectsOrBuilder(int index);
