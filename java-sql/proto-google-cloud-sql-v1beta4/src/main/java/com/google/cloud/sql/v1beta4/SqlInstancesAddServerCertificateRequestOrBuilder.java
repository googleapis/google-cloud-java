...
public interface SqlInstancesAddServerCertificateRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.sql.v1beta4.SqlInstancesAddServerCertificateRequest)
