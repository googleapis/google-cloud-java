...
public interface SqlInstancesRotateEntraIdCertificateRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.sql.v1.SqlInstancesRotateEntraIdCertificateRequest)
   ...
   * @return The body.
   */
  com.google.cloud.sql.v1.InstancesRotateEntraIdCertificateRequest getBody();
