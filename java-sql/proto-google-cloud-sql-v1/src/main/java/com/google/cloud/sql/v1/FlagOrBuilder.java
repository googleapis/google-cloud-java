...
public interface FlagOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.sql.v1.Flag)
   ...
   * @return The type.
   */
  com.google.cloud.sql.v1.SqlFlagType getType();
   ...
   */
  java.util.List<com.google.cloud.sql.v1.SqlDatabaseVersion> getAppliesToList();
   ...
   */
  com.google.cloud.sql.v1.SqlDatabaseVersion getAppliesTo(int index);
  ...
  com.google.cloud.sql.v1.Flag.RecommendedValueCase getRecommendedValueCase();
}
