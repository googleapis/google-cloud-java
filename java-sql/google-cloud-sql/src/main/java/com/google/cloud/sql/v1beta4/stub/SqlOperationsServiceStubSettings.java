...
/**
 * Settings class to configure an instance of {@link SqlOperationsServiceStub}.
 *
...
public class SqlOperationsServiceStubSettings
    extends StubSettings<SqlOperationsServiceStubSettings> {
  ...
  private final UnaryCallSettings<SqlOperationsGetRequest, Operation> getSettings;
  private final UnaryCallSettings<SqlOperationsListRequest, OperationsListResponse> listSettings;
  private final UnaryCallSettings<SqlOperationsCancelRequest, Empty> cancelSettings;
  ...
  public SqlOperationsServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcSqlOperationsServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonSqlOperationsServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SqlOperationsServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SqlOperationsServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected SqlOperationsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for SqlOperationsServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<SqlOperationsServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<SqlOperationsGetRequest, Operation> getSettings;
    private final UnaryCallSettings.Builder<SqlOperationsListRequest, OperationsListResponse>
        listSettings;
    private final UnaryCallSettings.Builder<SqlOperationsCancelRequest, Empty> cancelSettings;
    ...
    protected Builder(@Nullable ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getSettings, listSettings, cancelSettings);
      initDefaults(this);
    }

    protected Builder(SqlOperationsServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public SqlOperationsServiceStubSettings build() throws IOException {
      return new SqlOperationsServiceStubSettings(this);
    }
  }
}
