...
import com.google.cloud.sql.v1.stub.SqlBackupsServiceStub;
import com.google.cloud.sql.v1.stub.SqlBackupsServiceStubSettings;
 ...
 *      <td><p> Updates the retention period and description of the backup. You can use this API to update final backups only.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
