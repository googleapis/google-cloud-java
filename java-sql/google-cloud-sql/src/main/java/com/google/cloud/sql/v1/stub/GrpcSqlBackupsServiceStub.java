...
public class GrpcSqlBackupsServiceStub extends SqlBackupsServiceStub {
  private static final MethodDescriptor<CreateBackupRequest, Operation>
      createBackupMethodDescriptor =
          MethodDescriptor.<CreateBackupRequest, Operation>newBuilder()
              ...
              .setFullMethodName("google.cloud.sql.v1.SqlBackupsService/CreateBackup")
  ...
  private static final MethodDescriptor<GetBackupRequest, Backup> getBackupMethodDescriptor =
      MethodDescriptor.<GetBackupRequest, Backup>newBuilder()
          .setType(MethodDescriptor.MethodType.UNARY)
          .setFullMethodName("google.cloud.sql.v1.SqlBackupsService/GetBackup")
  ...
  private static final MethodDescriptor<ListBackupsRequest, ListBackupsResponse>
      listBackupsMethodDescriptor =
          MethodDescriptor.<ListBackupsRequest, ListBackupsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.sql.v1.SqlBackupsService/ListBackups")
  ...
  private static final MethodDescriptor<UpdateBackupRequest, Operation>
      updateBackupMethodDescriptor =
          MethodDescriptor.<UpdateBackupRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.sql.v1.SqlBackupsService/UpdateBackup")
  ...
  private static final MethodDescriptor<DeleteBackupRequest, Operation>
      deleteBackupMethodDescriptor =
          MethodDescriptor.<DeleteBackupRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.sql.v1.SqlBackupsService/DeleteBackup")
  ...
  public static final GrpcSqlBackupsServiceStub create(SqlBackupsServiceStubSettings settings)
      throws IOException {
    return new GrpcSqlBackupsServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcSqlBackupsServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcSqlBackupsServiceStub(
        SqlBackupsServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcSqlBackupsServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcSqlBackupsServiceStub(
        SqlBackupsServiceStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcSqlBackupsServiceStub, using the given settings. This is
   * protected so that it is easy to make a subclass, but otherwise, the static factory methods
   * should be preferred.
   */
  protected GrpcSqlBackupsServiceStub(
      SqlBackupsServiceStubSettings settings, ClientContext clientContext) throws IOException {
    this(settings, clientContext, new GrpcSqlBackupsServiceCallableFactory());
  }
   ...
   */
  protected GrpcSqlBackupsServiceStub(
      SqlBackupsServiceStubSettings settings,
