...
import com.google.cloud.sql.v1.stub.SqlFlagsServiceStub;
 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the SqlFlagsServiceClient object to clean up resources
 ...
 *    <tr>
 *      <td><p> List</td>
 *      <td><p> Lists all available database flags for Cloud SQL instances.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> list(SqlFlagsListRequest request)
 *      </ul>
 ...
 *
 * <p>This class can be customized by passing in a custom instance of SqlFlagsServiceSettings to
 * create(). For example:
 *
...
public class SqlFlagsServiceClient implements BackgroundResource {
   ...
   * }</pre>
   */
  public final UnaryCallable<SqlFlagsListRequest, FlagsListResponse> listCallable() {
