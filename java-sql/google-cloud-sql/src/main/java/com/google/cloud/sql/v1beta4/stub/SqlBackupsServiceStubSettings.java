...
import com.google.cloud.sql.v1beta4.Backup;
import com.google.cloud.sql.v1beta4.CreateBackupRequest;
import com.google.cloud.sql.v1beta4.DeleteBackupRequest;
import com.google.cloud.sql.v1beta4.GetBackupRequest;
import com.google.cloud.sql.v1beta4.ListBackupsRequest;
import com.google.cloud.sql.v1beta4.ListBackupsResponse;
import com.google.cloud.sql.v1beta4.Operation;
import com.google.cloud.sql.v1beta4.UpdateBackupRequest;
...
/**
 * Settings class to configure an instance of {@link SqlBackupsServiceStub}.
 *
...
public class SqlBackupsServiceStubSettings extends StubSettings<SqlBackupsServiceStubSettings> {
  ...
  public SqlBackupsServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcSqlBackupsServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonSqlBackupsServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SqlBackupsServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SqlBackupsServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected SqlBackupsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<SqlBackupsServiceStubSettings, Builder> {
    ...
    @Override
    public SqlBackupsServiceStubSettings build() throws IOException {
      return new SqlBackupsServiceStubSettings(this);
    }
  }
}
