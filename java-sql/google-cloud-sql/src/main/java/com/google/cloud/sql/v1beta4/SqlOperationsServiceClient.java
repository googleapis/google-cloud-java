...
import com.google.cloud.sql.v1beta4.stub.SqlOperationsServiceStub;
 ...
 *    <tr>
 *      <td><p> Cancel</td>
 *      <td><p> Cancels an instance operation that has been performed on an instance. Ordinarily, this method name should be `CancelSqlOperation`.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
