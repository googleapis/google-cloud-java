...
/**
 * Settings class to configure an instance of {@link SqlBackupRunsServiceStub}.
 *
...
public class SqlBackupRunsServiceStubSettings
    extends StubSettings<SqlBackupRunsServiceStubSettings> {
  ...
  private final UnaryCallSettings<SqlBackupRunsDeleteRequest, Operation> deleteSettings;
  private final UnaryCallSettings<SqlBackupRunsGetRequest, BackupRun> getSettings;
  private final UnaryCallSettings<SqlBackupRunsInsertRequest, Operation> insertSettings;
  private final UnaryCallSettings<SqlBackupRunsListRequest, BackupRunsListResponse> listSettings;
  ...
  public SqlBackupRunsServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcSqlBackupRunsServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonSqlBackupRunsServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SqlBackupRunsServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SqlBackupRunsServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected SqlBackupRunsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for SqlBackupRunsServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<SqlBackupRunsServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<SqlBackupRunsDeleteRequest, Operation> deleteSettings;
    private final UnaryCallSettings.Builder<SqlBackupRunsGetRequest, BackupRun> getSettings;
    private final UnaryCallSettings.Builder<SqlBackupRunsInsertRequest, Operation> insertSettings;
    private final UnaryCallSettings.Builder<SqlBackupRunsListRequest, BackupRunsListResponse>
        listSettings;
    ...
    protected Builder(SqlBackupRunsServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public SqlBackupRunsServiceStubSettings build() throws IOException {
      return new SqlBackupRunsServiceStubSettings(this);
    }
  }
}
