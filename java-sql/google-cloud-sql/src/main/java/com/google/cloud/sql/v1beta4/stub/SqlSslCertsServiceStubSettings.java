...
/**
 * Settings class to configure an instance of {@link SqlSslCertsServiceStub}.
 *
...
public class SqlSslCertsServiceStubSettings extends StubSettings<SqlSslCertsServiceStubSettings> {
  ...
  private final UnaryCallSettings<SqlSslCertsDeleteRequest, Operation> deleteSettings;
  private final UnaryCallSettings<SqlSslCertsGetRequest, SslCert> getSettings;
  private final UnaryCallSettings<SqlSslCertsInsertRequest, SslCertsInsertResponse> insertSettings;
  private final UnaryCallSettings<SqlSslCertsListRequest, SslCertsListResponse> listSettings;
  ...
  public SqlSslCertsServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcSqlSslCertsServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonSqlSslCertsServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SqlSslCertsServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SqlSslCertsServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected SqlSslCertsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for SqlSslCertsServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<SqlSslCertsServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<SqlSslCertsDeleteRequest, Operation> deleteSettings;
    private final UnaryCallSettings.Builder<SqlSslCertsGetRequest, SslCert> getSettings;
    private final UnaryCallSettings.Builder<SqlSslCertsInsertRequest, SslCertsInsertResponse>
        insertSettings;
    private final UnaryCallSettings.Builder<SqlSslCertsListRequest, SslCertsListResponse>
        listSettings;
    ...
    protected Builder(SqlSslCertsServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public SqlSslCertsServiceStubSettings build() throws IOException {
      return new SqlSslCertsServiceStubSettings(this);
    }
  }
}
