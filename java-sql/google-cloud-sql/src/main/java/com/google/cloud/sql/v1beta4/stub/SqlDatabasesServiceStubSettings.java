...
/**
 * Settings class to configure an instance of {@link SqlDatabasesServiceStub}.
 *
...
public class SqlDatabasesServiceStubSettings extends StubSettings<SqlDatabasesServiceStubSettings> {
  ...
  private final UnaryCallSettings<SqlDatabasesDeleteRequest, Operation> deleteSettings;
  private final UnaryCallSettings<SqlDatabasesGetRequest, Database> getSettings;
  private final UnaryCallSettings<SqlDatabasesInsertRequest, Operation> insertSettings;
  private final UnaryCallSettings<SqlDatabasesListRequest, DatabasesListResponse> listSettings;
  private final UnaryCallSettings<SqlDatabasesUpdateRequest, Operation> patchSettings;
  private final UnaryCallSettings<SqlDatabasesUpdateRequest, Operation> updateSettings;
  ...
  public SqlDatabasesServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcSqlDatabasesServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonSqlDatabasesServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SqlDatabasesServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SqlDatabasesServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected SqlDatabasesServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for SqlDatabasesServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<SqlDatabasesServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<SqlDatabasesDeleteRequest, Operation> deleteSettings;
    private final UnaryCallSettings.Builder<SqlDatabasesGetRequest, Database> getSettings;
    private final UnaryCallSettings.Builder<SqlDatabasesInsertRequest, Operation> insertSettings;
    private final UnaryCallSettings.Builder<SqlDatabasesListRequest, DatabasesListResponse>
        listSettings;
    private final UnaryCallSettings.Builder<SqlDatabasesUpdateRequest, Operation> patchSettings;
    private final UnaryCallSettings.Builder<SqlDatabasesUpdateRequest, Operation> updateSettings;
    ...
    protected Builder(SqlDatabasesServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public SqlDatabasesServiceStubSettings build() throws IOException {
      return new SqlDatabasesServiceStubSettings(this);
    }
  }
}
