...
import com.google.cloud.sql.v1.stub.HttpJsonSqlBackupsServiceStub;
...
public class SqlBackupsServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static SqlBackupsServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonSqlBackupsServiceStub.getMethodDescriptors(),
            SqlBackupsServiceSettings.getDefaultEndpoint());
    SqlBackupsServiceSettings settings =
        SqlBackupsServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                SqlBackupsServiceSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void getBackupTest2() throws Exception {
    ...
    String name = "projects/project-5917/backups/backup-5917";
