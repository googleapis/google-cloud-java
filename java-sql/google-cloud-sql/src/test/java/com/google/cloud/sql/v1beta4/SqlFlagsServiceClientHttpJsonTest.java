...
import com.google.cloud.sql.v1beta4.stub.HttpJsonSqlFlagsServiceStub;
...
public class SqlFlagsServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static SqlFlagsServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonSqlFlagsServiceStub.getMethodDescriptors(),
            SqlFlagsServiceSettings.getDefaultEndpoint());
    SqlFlagsServiceSettings settings =
        SqlFlagsServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                SqlFlagsServiceSettings.defaultHttpJsonTransportProviderBuilder()
