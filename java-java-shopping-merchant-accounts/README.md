...
<!-- {x-version-update-start:google-shopping-merchant-accounts:released} -->
...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-accounts:0.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-accounts" % "0.0.0"
```
...
You'll need to obtain the `google-shopping-merchant-accounts` library.  See the [Quickstart](#quickstart) section
to add `google-shopping-merchant-accounts` as a dependency in your code.
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-shopping-merchant-accounts/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.shopping/google-shopping-merchant-accounts/0.0.0
