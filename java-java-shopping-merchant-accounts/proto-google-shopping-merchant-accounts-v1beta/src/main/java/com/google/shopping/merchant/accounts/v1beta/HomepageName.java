...
public class HomepageName implements ResourceName {
  private static final PathTemplate ACCOUNT =
      PathTemplate.createWithoutUrlEncoding("accounts/{account}/homepage");
  ...
  private HomepageName(Builder builder) {
  ...
  public static HomepageName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        ACCOUNT.validatedMatch(
            formattedString, "HomepageName.parse: formattedString not in valid format");
    return of(matchMap.get("account"));
  }

  public static List<HomepageName> parseList(List<String> formattedStrings) {
    List<HomepageName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      HomepageName that = ((HomepageName) o);
  ...
  /** Builder for accounts/{account}/homepage. */
  public static class Builder {
    ...
    private Builder(HomepageName homepageName) {
      this.account = homepageName.account;
    }

    public HomepageName build() {
      return new HomepageName(this);
    }
  }
}
