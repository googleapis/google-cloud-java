...
```Groovy
implementation 'com.google.cloud:google-cloud-advisorynotifications:0.30.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-advisorynotifications" % "0.30.0"
```
