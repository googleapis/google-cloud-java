...
public class NetAppClient implements BackgroundResource {
   ...
   * ListStoragePools
   *
   * <p>Returns descriptions of all storage pools owned by the caller.
   *
   * <p>Sample code:
   *
   * <pre>{@code
   ...
   * UpdateStoragePool
   *
   * <p>Updates the storage pool properties with the full spec
   *
   * <p>Sample code:
   *
   * <pre>{@code
   ...
   * DeleteStoragePool
   *
   * <p>Warning! This operation will permanently delete the storage pool.
   *
   * <p>Sample code:
   *
   * <pre>{@code
   ...
   * ListKmsConfigs
   *
   * <p>Returns descriptions of all KMS configs owned by the caller.
   *
   * <p>Sample code:
   *
   * <pre>{@code
   ...
   * UpdateKmsConfig
   *
   * <p>Updates the Kms config properties with the full spec
   *
   * <p>Sample code:
   *
   * <pre>{@code
   ...
   * EncryptVolumes
   *
   * <p>Encrypt the existing volumes without CMEK encryption with the desired the KMS config for the
   * whole region.
   *
   * <p>Sample code:
   *
   ...
   *
   * <p>Verifies KMS config reachability.
   *
   * <p>Sample code:
   *
   * <pre>{@code
   ...
   * DeleteKmsConfig
   *
   * <p>Warning! This operation will permanently delete the Kms config.
   *
   * <p>Sample code:
   *
   * <pre>{@code
