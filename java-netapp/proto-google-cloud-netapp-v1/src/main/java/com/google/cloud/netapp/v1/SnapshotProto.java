  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\227\001\n"
          + "\024ListSnapshotsRequest\0226\n"
          ...
          + "\025ListSnapshotsResponse\0223\n"
          + "\tsnapshots\030\001 \003(\0132 .google.cloud.netapp.v1.Snapshot\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"J\n"
          + "\022GetSnapshotRequest\0224\n"
          + "\004name\030\001 \001(\tB&\340A\002\372A \n"
          + "\036netapp.googleapis.com/Snapshot\"\242\001\n"
          + "\025CreateSnapshotRequest\0226\n"
          + "\006parent\030\001 \001(\tB&\340A\002\372A"
          + " \022\036netapp.googleapis.com/Snapshot\0227\n"
          + "\010snapshot\030\002 \001(\0132"
          + " .google.cloud.netapp.v1.SnapshotB\003\340A\002\022\030\n"
          + "\013snapshot_id\030\003 \001(\tB\003\340A\002\"M\n"
          + "\025DeleteSnapshotRequest\0224\n"
          + "\004name\030\001 \001(\tB&\340A\002\372A \n"
          + "\036netapp.googleapis.com/Snapshot\"\206\001\n"
          + "\025UpdateSnapshotRequest\0224\n"
          + "\013update_mask\030\001 \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\0227\n"
          + "\010snapshot\030\002 \001(\0132"
          + " .google.cloud.netapp.v1.SnapshotB\003\340A\002\"\277\004\n"
          + "\010Snapshot\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022:\n"
          + "\005state\030\002"
          + " \001(\0162&.google.cloud.netapp.v1.Snapshot.StateB\003\340A\003\022\032\n\r"
          + "state_details\030\003 \001(\tB\003\340A\003\022\023\n"
          + "\013description\030\004 \001(\t\022\027\n\n"
          + "used_bytes\030\005 \001(\001B\003\340A\003\0224\n"
          ...
          + "\036netapp.googleapis.com/Snapshot\022Mprojects/{project}/locations/{locat"
          + "ion}/volumes/{volume}/snapshots/{snapshot}*\tsnapshots2\010snapshotB\257\001\n"
          + "\032com.google.cloud.netapp.v1B\r"
          + "SnapshotProtoP\001Z2cloud.google.com/go/netapp/apiv1/netapppb;netap"
          + "ppb\252\002\026Google.Cloud.NetApp.V1\312\002\026Google\\Cl"
          + "oud\\NetApp\\V1\352\002\031Google::Cloud::NetApp::V1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_netapp_v1_Snapshot_descriptor = getDescriptor().getMessageType(6);
    internal_static_google_cloud_netapp_v1_Snapshot_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_netapp_v1_Snapshot_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_netapp_v1_Snapshot_LabelsEntry_descriptor =
        internal_static_google_cloud_netapp_v1_Snapshot_descriptor.getNestedType(0);
    internal_static_google_cloud_netapp_v1_Snapshot_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_netapp_v1_Snapshot_LabelsEntry_descriptor,
            new java.lang.String[] {
