...
public class BackupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_BACKUP_VAULT_BACKUP =
  ...
  public static BackupName of(String project, String location, String backupVault, String backup) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String backupVault, String backup) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setBackupVault(backupVault)
  ...
  public static BackupName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_BACKUP_VAULT_BACKUP.validatedMatch(
            formattedString, "BackupName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("backup_vault"),
        matchMap.get("backup"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_BACKUP_VAULT_BACKUP.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_BACKUP_VAULT_BACKUP.instantiate(
        "project", project, "location", location, "backup_vault", backupVault, "backup", backup);
  }
