...
public class ActiveDirectoryName implements ResourceName {
  ...
  public static @Nullable ActiveDirectoryName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ActiveDirectoryName> values) {
