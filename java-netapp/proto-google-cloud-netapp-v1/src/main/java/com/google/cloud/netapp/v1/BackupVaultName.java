...
public class BackupVaultName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_BACKUP_VAULT =
  ...
  public static BackupVaultName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_BACKUP_VAULT.validatedMatch(
            formattedString, "BackupVaultName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("backup_vault"));
  }
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (backupVault != null) {
            fieldMapBuilder.put("backup_vault", backupVault);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_BACKUP_VAULT.instantiate(
        "project", project, "location", location, "backup_vault", backupVault);
  }
