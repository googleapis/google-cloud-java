...
public final class BackupPolicyProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\014BackupPolicy\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022\037\n"
          + "\022daily_backup_limit\030\002 \001(\005H\000\210\001\001\022 \n"
          + "\023weekly_backup_limit\030\003 \001(\005H\001\210\001\001\022!\n"
          + "\024monthly_backup_limit\030\004 \001(\005H\002\210\001\001\022\030\n"
          + "\013description\030\005 \001(\tH\003\210\001\001\022\024\n"
          + "\007enabled\030\006 \001(\010H\004\210\001\001\022\'\n"
          + "\025assigned_volume_count\030\007 \001(\005B\003\340A\003H\005\210\001\001\0224\n"
          ...
          + "\005state\030\n"
          + " \001(\0162*.google.cloud.netapp.v1.BackupPolicy.StateB\003\340A\003\032-\n"
          ...
          + "\"netapp.googleapis.com/BackupPolicy\022Fprojec"
          + "ts/{project}/locations/{location}/backup"
          + "Policies/{backup_policy}*\016backupPolicies2\014backupPolicyB\025\n"
          + "\023_daily_backup_limitB\026\n"
          + "\024_weekly_backup_limitB\027\n"
          + "\025_monthly_backup_limitB\016\n"
          + "\014_descriptionB\n\n"
          + "\010_enabledB\030\n"
          + "\026_assigned_volume_count\"\270\001\n"
          + "\031CreateBackupPolicyRequest\022:\n"
          + "\006parent\030\001 \001("
          + "\tB*\340A\002\372A$\022\"netapp.googleapis.com/BackupPolicy\022@\n\r"
          + "backup_policy\030\002"
          + " \001(\0132$.google.cloud.netapp.v1.BackupPolicyB\003\340A\002\022\035\n"
          + "\020backup_policy_id\030\003 \001(\tB\003\340A\002\"R\n"
          + "\026GetBackupPolicyRequest\0228\n"
          + "\004name\030\001 \001(\tB*\340A\002\372A$\n"
          + "\"netapp.googleapis.com/BackupPolicy\"\240\001\n"
          + "\031ListBackupPoliciesRequest\022:\n"
          + "\006parent\030\001 \001("
          + "\tB*\340A\002\372A$\022\"netapp.googleapis.com/BackupPolicy\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          + "page_token\030\003 \001(\t\022\016\n"
          + "\006filter\030\004 \001(\t\022\020\n"
          + "\010order_by\030\005 \001(\t\"\211\001\n"
          + "\032ListBackupPoliciesResponse\022=\n"
          + "\017backup_policies\030\001 \003(\0132$.google.cloud.netapp.v1.BackupPolicy\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"\223\001\n"
          + "\031UpdateBackupPolicyRequest\0224\n"
          + "\013update_mask\030\001"
          + " \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\022@\n\r"
          + "backup_policy\030\002"
          + " \001(\0132$.google.cloud.netapp.v1.BackupPolicyB\003\340A\002\"U\n"
          + "\031DeleteBackupPolicyRequest\0228\n"
          + "\004name\030\001 \001(\tB*\340A\002\372A$\n"
          + "\"netapp.googleapis.com/BackupPolicyB\263\001\n"
          + "\032com.google.cloud.netapp.v1B\021BackupPolicyProt"
    ...
    internal_static_google_cloud_netapp_v1_BackupPolicy_LabelsEntry_descriptor =
        internal_static_google_cloud_netapp_v1_BackupPolicy_descriptor.getNestedType(0);
    internal_static_google_cloud_netapp_v1_BackupPolicy_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_netapp_v1_BackupPolicy_LabelsEntry_descriptor,
            new java.lang.String[] {
