...
public interface StoragePoolOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.netapp.v1beta1.StoragePool)
   ...
   *
   * <code>
   * .google.cloud.netapp.v1beta1.ServiceLevel service_level = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.netapp.v1beta1.ServiceLevel getServiceLevel();
   ...
   *
   * <code>
   * .google.cloud.netapp.v1beta1.StoragePool.State state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   *
   * <code>
   * .google.cloud.netapp.v1beta1.EncryptionType encryption_type = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.netapp.v1beta1.EncryptionType getEncryptionType();
