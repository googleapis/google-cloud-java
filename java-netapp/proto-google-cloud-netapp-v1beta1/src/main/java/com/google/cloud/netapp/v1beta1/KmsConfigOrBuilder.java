...
public interface KmsConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.netapp.v1beta1.KmsConfig)
   ...
   *
   * <code>
   * .google.cloud.netapp.v1beta1.KmsConfig.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
