...
public interface CreateSnapshotRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.netapp.v1beta1.CreateSnapshotRequest)
   ...
   *
   * <code>
   * .google.cloud.netapp.v1beta1.Snapshot snapshot = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   * @return The snapshot.
   */
  com.google.cloud.netapp.v1beta1.Snapshot getSnapshot();
  /**
   *
   *
   * <pre>
