...
// source: google/cloud/netapp/v1beta1/active_directory.proto

package com.google.cloud.netapp.v1beta1;

public interface ActiveDirectoryOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.netapp.v1beta1.ActiveDirectory)
   ...
   *
   * <code>
   * .google.cloud.netapp.v1beta1.ActiveDirectory.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
