...
<dependencies>
  <dependency>
    <groupId>com.google.cloud</groupId>
    <artifactId>google-cloud-memorystore</artifactId>
  </dependency>
</dependencies>
```
...
```Groovy
implementation 'com.google.cloud:google-cloud-memorystore:0.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-memorystore" % "0.0.0"
```
...
You'll need to obtain the `google-cloud-memorystore` library.  See the [Quickstart](#quickstart) section
to add `google-cloud-memorystore` as a dependency in your code.
...
[maven-version-image]: https://img.shields.io/maven-central/v/com.google.cloud/google-cloud-memorystore.svg
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-memorystore/0.0.0
