...
public class TaxonomyCategoryName implements ResourceName {
  ...
  public static @Nullable TaxonomyCategoryName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TaxonomyCategoryName> values) {
