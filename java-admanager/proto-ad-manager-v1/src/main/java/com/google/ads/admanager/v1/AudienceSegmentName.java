...
public class AudienceSegmentName implements ResourceName {
  ...
  public static @Nullable AudienceSegmentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AudienceSegmentName> values) {
