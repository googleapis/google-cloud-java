...
public class ProgrammaticBuyerName implements ResourceName {
  ...
  public static @Nullable ProgrammaticBuyerName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProgrammaticBuyerName> values) {
