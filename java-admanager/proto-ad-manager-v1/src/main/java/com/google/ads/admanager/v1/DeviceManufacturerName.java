...
public class DeviceManufacturerName implements ResourceName {
  ...
  public static @Nullable DeviceManufacturerName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DeviceManufacturerName> values) {
