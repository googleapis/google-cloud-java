...
public final class DeviceCategoryTargeting extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DeviceCategoryTargeting(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < targetedCategories_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, targetedCategories_.getRaw(i));
    }
    for (int i = 0; i < excludedCategories_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, excludedCategories_.getRaw(i));
    }
