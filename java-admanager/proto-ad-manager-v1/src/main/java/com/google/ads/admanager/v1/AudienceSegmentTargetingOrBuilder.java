...
public interface AudienceSegmentTargetingOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.ads.admanager.v1.AudienceSegmentTargeting)
   ...
   */
  java.util.List<java.lang.String> getAudienceSegmentsList();
   ...
   */
  java.lang.String getAudienceSegments(int index);
   ...
   */
  com.google.protobuf.ByteString getAudienceSegmentsBytes(int index);
}
