...
public class OperatingSystemName implements ResourceName {
  ...
  public static @Nullable OperatingSystemName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable OperatingSystemName> values) {
