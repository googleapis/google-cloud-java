...
public class CustomTargetingValueName implements ResourceName {
  ...
  public static @Nullable CustomTargetingValueName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CustomTargetingValueName> values) {
