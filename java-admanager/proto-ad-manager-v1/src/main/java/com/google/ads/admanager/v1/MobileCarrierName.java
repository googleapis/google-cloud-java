...
public class MobileCarrierName implements ResourceName {
  private static final PathTemplate NETWORK_CODE_MOBILE_CARRIER =
  ...
  private MobileCarrierName(Builder builder) {
    ...
    mobileCarrier = Preconditions.checkNotNull(builder.getMobileCarrier());
  }
  ...
  public static MobileCarrierName of(String networkCode, String mobileCarrier) {
    return newBuilder().setNetworkCode(networkCode).setMobileCarrier(mobileCarrier).build();
  }
  ...
  public static @Nullable MobileCarrierName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        NETWORK_CODE_MOBILE_CARRIER.validatedMatch(
            formattedString, "MobileCarrierName.parse: formattedString not in valid format");
    return of(matchMap.get("network_code"), matchMap.get("mobile_carrier"));
  }

  public static List<MobileCarrierName> parseList(List<String> formattedStrings) {
    List<MobileCarrierName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable MobileCarrierName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (mobileCarrier != null) {
            fieldMapBuilder.put("mobile_carrier", mobileCarrier);
          }
  ...
  public String toString() {
    return NETWORK_CODE_MOBILE_CARRIER.instantiate(
        "network_code", networkCode, "mobile_carrier", mobileCarrier);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.networkCode, that.networkCode)
          && Objects.equals(this.mobileCarrier, that.mobileCarrier);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(mobileCarrier);
    return h;
  }

  /** Builder for networks/{network_code}/mobileCarriers/{mobile_carrier}. */
