...
public class CreativeTemplateName implements ResourceName {
  ...
  public static @Nullable CreativeTemplateName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CreativeTemplateName> values) {
