...
public class CmsMetadataValueName implements ResourceName {
  ...
  public static @Nullable CmsMetadataValueName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CmsMetadataValueName> values) {
