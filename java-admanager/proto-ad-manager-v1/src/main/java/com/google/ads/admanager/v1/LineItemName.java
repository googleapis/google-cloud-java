...
public class LineItemName implements ResourceName {
  private static final PathTemplate NETWORK_CODE_LINE_ITEM =
      PathTemplate.createWithoutUrlEncoding("networks/{network_code}/lineItems/{line_item}");
  ...
  public static LineItemName of(String networkCode, String lineItem) {
    return newBuilder().setNetworkCode(networkCode).setLineItem(lineItem).build();
  }

  public static String format(String networkCode, String lineItem) {
    return newBuilder().setNetworkCode(networkCode).setLineItem(lineItem).build().toString();
  }

  public static @Nullable LineItemName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        NETWORK_CODE_LINE_ITEM.validatedMatch(
            formattedString, "LineItemName.parse: formattedString not in valid format");
    return of(matchMap.get("network_code"), matchMap.get("line_item"));
  }
  ...
  public static List<String> toStringList(List<@Nullable LineItemName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return NETWORK_CODE_LINE_ITEM.matches(formattedString);
  }
  ...
  public String toString() {
    return NETWORK_CODE_LINE_ITEM.instantiate("network_code", networkCode, "line_item", lineItem);
  }
  ...
  /** Builder for networks/{network_code}/lineItems/{line_item}. */
