...
public interface ListPlacementsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.ads.admanager.v1.ListPlacementsResponse)
   ...
   */
  java.util.List<com.google.ads.admanager.v1.Placement> 
      getPlacementsList();
  /**
   * <pre>
   * The `Placement` objects from the specified network.
   ...
   * <code>repeated .google.ads.admanager.v1.Placement placements = 1;</code>
   */
  com.google.ads.admanager.v1.PlacementOrBuilder getPlacementsOrBuilder(
      int index);
