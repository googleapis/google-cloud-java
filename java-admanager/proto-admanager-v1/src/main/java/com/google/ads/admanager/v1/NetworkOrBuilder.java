...
public interface NetworkOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated string secondary_currency_codes = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>string effective_root_ad_unit = 8 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }</code>
