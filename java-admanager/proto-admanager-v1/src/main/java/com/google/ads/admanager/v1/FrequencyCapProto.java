...
public final class FrequencyCapProto {
  ...
  static {
    ...
    internal_static_google_ads_admanager_v1_FrequencyCap_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_ads_admanager_v1_FrequencyCap_descriptor,
        new java.lang.String[] { "MaxImpressions", "TimeAmount", "TimeUnit", });
    internal_static_google_ads_admanager_v1_TimeUnitEnum_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_ads_admanager_v1_TimeUnitEnum_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_ads_admanager_v1_TimeUnitEnum_descriptor,
