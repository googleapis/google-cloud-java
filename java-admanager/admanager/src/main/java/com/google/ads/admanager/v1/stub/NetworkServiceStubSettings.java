...
/**
 * Settings class to configure an instance of {@link NetworkServiceStub}.
 *
 ...
 *
 * <p>For example, to set the total timeout of getNetwork to 30 seconds:
 *
 * <pre>{@code
 ...
 * NetworkServiceStubSettings.Builder networkServiceSettingsBuilder =
 *     NetworkServiceStubSettings.newBuilder();
 ...
 *             .build());
 * NetworkServiceStubSettings networkServiceSettings = networkServiceSettingsBuilder.build();
 * }</pre>
 */
...
public class NetworkServiceStubSettings extends StubSettings<NetworkServiceStubSettings> {
  ...
  public NetworkServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonNetworkServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(NetworkServiceStubSettings.class))
        .setTransportToken(
  ...
  protected NetworkServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<NetworkServiceStubSettings, Builder> {
    ...
    protected Builder(NetworkServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public NetworkServiceStubSettings build() throws IOException {
      return new NetworkServiceStubSettings(this);
    }
  }
}
