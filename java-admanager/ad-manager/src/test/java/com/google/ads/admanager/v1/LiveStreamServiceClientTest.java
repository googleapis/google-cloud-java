  ...
  public void getLiveStreamTest() throws Exception {
    LiveStream expectedResponse =
        LiveStream.newBuilder()
            ...
            .setSlate(SlateName.of("[NETWORK_CODE]", "[SLATE]").toString())
            .setDvrWindowDuration(Duration.newBuilder().build())
            ...
            .addAllDaiAuthenticationKeys(new ArrayList<String>())
            ...
            .addAllDaiEncodingProfiles(new ArrayList<String>())
            .addAllSegmentUrlAuthenticationKeys(new ArrayList<String>())
