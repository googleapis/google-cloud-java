...
/**
 * Settings class to configure an instance of {@link SiteServiceClient}.
 *
...
public class SiteServiceSettings extends ClientSettings<SiteServiceSettings> {
  ...
  public UnaryCallSettings<GetSiteRequest, Site> getSiteSettings() {
    return ((SiteServiceStubSettings) getStubSettings()).getSiteSettings();
  }
  ...
  public PagedCallSettings<ListSitesRequest, ListSitesResponse, ListSitesPagedResponse>
      listSitesSettings() {
    return ((SiteServiceStubSettings) getStubSettings()).listSitesSettings();
  }
  ...
  public UnaryCallSettings<CreateSiteRequest, Site> createSiteSettings() {
    return ((SiteServiceStubSettings) getStubSettings()).createSiteSettings();
  }
  ...
  public UnaryCallSettings<BatchCreateSitesRequest, BatchCreateSitesResponse>
    ...
    return ((SiteServiceStubSettings) getStubSettings()).batchCreateSitesSettings();
  }
  ...
  public UnaryCallSettings<UpdateSiteRequest, Site> updateSiteSettings() {
    return ((SiteServiceStubSettings) getStubSettings()).updateSiteSettings();
  }
  ...
  public UnaryCallSettings<BatchUpdateSitesRequest, BatchUpdateSitesResponse>
    ...
    return ((SiteServiceStubSettings) getStubSettings()).batchUpdateSitesSettings();
  }
  ...
  public UnaryCallSettings<BatchDeactivateSitesRequest, BatchDeactivateSitesResponse>
    ...
    return ((SiteServiceStubSettings) getStubSettings()).batchDeactivateSitesSettings();
  }
  ...
  public UnaryCallSettings<BatchSubmitSitesForApprovalRequest, BatchSubmitSitesForApprovalResponse>
    ...
    return ((SiteServiceStubSettings) getStubSettings()).batchSubmitSitesForApprovalSettings();
  }

  public static final SiteServiceSettings create(SiteServiceStubSettings stub) throws IOException {
    return new SiteServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  public static String getDefaultEndpoint() {
    return SiteServiceStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return SiteServiceStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return SiteServiceStubSettings.defaultCredentialsProviderBuilder();
  }
  ...
  public static TransportChannelProvider defaultTransportChannelProvider() {
    return SiteServiceStubSettings.defaultTransportChannelProvider();
  }

  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SiteServiceStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected SiteServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for SiteServiceSettings. */
  public static class Builder extends ClientSettings.Builder<SiteServiceSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(SiteServiceStubSettings.newBuilder(clientContext));
    }
    ...
    private static Builder createDefault() {
      return new Builder(SiteServiceStubSettings.newBuilder());
    }

    public SiteServiceStubSettings.Builder getStubSettingsBuilder() {
      return ((SiteServiceStubSettings.Builder) getStubSettings());
    }
    ...
    public UnaryCallSettings.Builder<BatchCreateSitesRequest, BatchCreateSitesResponse>
        batchCreateSitesSettings() {
      return getStubSettingsBuilder().batchCreateSitesSettings();
    }
    ...
    public UnaryCallSettings.Builder<BatchUpdateSitesRequest, BatchUpdateSitesResponse>
        batchUpdateSitesSettings() {
      return getStubSettingsBuilder().batchUpdateSitesSettings();
    }
    ...
    public UnaryCallSettings.Builder<BatchDeactivateSitesRequest, BatchDeactivateSitesResponse>
        batchDeactivateSitesSettings() {
      return getStubSettingsBuilder().batchDeactivateSitesSettings();
    }
    ...
    @Override
    public SiteServiceSettings build() throws IOException {
      return new SiteServiceSettings(this);
    }
  }
}
