...
/**
 * Settings class to configure an instance of {@link AudienceSegmentServiceClient}.
 *
...
public class AudienceSegmentServiceSettings extends ClientSettings<AudienceSegmentServiceSettings> {
  ...
  public UnaryCallSettings<GetAudienceSegmentRequest, AudienceSegment>
      getAudienceSegmentSettings() {
    return ((AudienceSegmentServiceStubSettings) getStubSettings()).getAudienceSegmentSettings();
  }
  ...
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return AudienceSegmentServiceStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return AudienceSegmentServiceStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return AudienceSegmentServiceStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return AudienceSegmentServiceStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default ChannelProvider for this service. */
  public static InstantiatingHttpJsonChannelProvider.Builder
      defaultHttpJsonTransportProviderBuilder() {
    return AudienceSegmentServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return AudienceSegmentServiceStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected AudienceSegmentServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for AudienceSegmentServiceSettings. */
  public static class Builder
      extends ClientSettings.Builder<AudienceSegmentServiceSettings, Builder> {
    ...
    protected Builder(AudienceSegmentServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(AudienceSegmentServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }

    private static Builder createDefault() {
      return new Builder(AudienceSegmentServiceStubSettings.newBuilder());
    }

    public AudienceSegmentServiceStubSettings.Builder getStubSettingsBuilder() {
      return ((AudienceSegmentServiceStubSettings.Builder) getStubSettings());
    }
    ...
    public UnaryCallSettings.Builder<GetAudienceSegmentRequest, AudienceSegment>
        getAudienceSegmentSettings() {
      return getStubSettingsBuilder().getAudienceSegmentSettings();
    }
    ...
    @Override
    public AudienceSegmentServiceSettings build() throws IOException {
      return new AudienceSegmentServiceSettings(this);
    }
  }
}
