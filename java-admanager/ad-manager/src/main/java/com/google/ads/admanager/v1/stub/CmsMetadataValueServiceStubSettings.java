...
/**
 * Settings class to configure an instance of {@link CmsMetadataValueServiceStub}.
 *
...
public class CmsMetadataValueServiceStubSettings
  ...
  private final UnaryCallSettings<GetCmsMetadataValueRequest, CmsMetadataValue>
      getCmsMetadataValueSettings;
  ...
  private static final PagedListDescriptor<
      ...
      LIST_CMS_METADATA_VALUES_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListCmsMetadataValuesRequest injectToken(
                ListCmsMetadataValuesRequest payload, String token) {
              return ListCmsMetadataValuesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListCmsMetadataValuesRequest injectPageSize(
                ListCmsMetadataValuesRequest payload, int pageSize) {
              return ListCmsMetadataValuesRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
            ...
            @Override
            public Iterable<CmsMetadataValue> extractResources(
                ListCmsMetadataValuesResponse payload) {
  ...
  private static final PagedListResponseFactory<
          ...
          ListCmsMetadataValuesResponse,
          ListCmsMetadataValuesPagedResponse>
      LIST_CMS_METADATA_VALUES_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListCmsMetadataValuesRequest,
              ListCmsMetadataValuesResponse,
              ListCmsMetadataValuesPagedResponse>() {
            @Override
            public ApiFuture<ListCmsMetadataValuesPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListCmsMetadataValuesRequest, ListCmsMetadataValuesResponse> callable,
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, LIST_CMS_METADATA_VALUES_PAGE_STR_DESC, request, context);
              return ListCmsMetadataValuesPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetCmsMetadataValueRequest, CmsMetadataValue>
      getCmsMetadataValueSettings() {
    return getCmsMetadataValueSettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListCmsMetadataValuesPagedResponse>
      listCmsMetadataValuesSettings() {
    return listCmsMetadataValuesSettings;
  }
  ...
  public UnaryCallSettings<
          BatchActivateCmsMetadataValuesRequest, BatchActivateCmsMetadataValuesResponse>
      batchActivateCmsMetadataValuesSettings() {
    return batchActivateCmsMetadataValuesSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CmsMetadataValueServiceStubSettings.class))
        .setTransportToken(
  ...
  protected CmsMetadataValueServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getCmsMetadataValueSettings = settingsBuilder.getCmsMetadataValueSettings().build();
    listCmsMetadataValuesSettings = settingsBuilder.listCmsMetadataValuesSettings().build();
    batchActivateCmsMetadataValuesSettings =
        settingsBuilder.batchActivateCmsMetadataValuesSettings().build();
    batchDeactivateCmsMetadataValuesSettings =
        settingsBuilder.batchDeactivateCmsMetadataValuesSettings().build();
  }
  ...
  /** Builder for CmsMetadataValueServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<CmsMetadataValueServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetCmsMetadataValueRequest, CmsMetadataValue>
        getCmsMetadataValueSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getCmsMetadataValueSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listCmsMetadataValuesSettings =
          PagedCallSettings.newBuilder(LIST_CMS_METADATA_VALUES_PAGE_STR_FACT);
      batchActivateCmsMetadataValuesSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      batchDeactivateCmsMetadataValuesSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(CmsMetadataValueServiceStubSettings settings) {
      ...
      getCmsMetadataValueSettings = settings.getCmsMetadataValueSettings.toBuilder();
      listCmsMetadataValuesSettings = settings.listCmsMetadataValuesSettings.toBuilder();
      batchActivateCmsMetadataValuesSettings =
          settings.batchActivateCmsMetadataValuesSettings.toBuilder();
      batchDeactivateCmsMetadataValuesSettings =
          settings.batchDeactivateCmsMetadataValuesSettings.toBuilder();
