...
public class ContactServiceStubSettings extends StubSettings<ContactServiceStubSettings> {
  ...
  private final UnaryCallSettings<BatchCreateContactsRequest, BatchCreateContactsResponse>
      batchCreateContactsSettings;
  private final UnaryCallSettings<UpdateContactRequest, Contact> updateContactSettings;
  private final UnaryCallSettings<BatchUpdateContactsRequest, BatchUpdateContactsResponse>
  ...
  public UnaryCallSettings<BatchCreateContactsRequest, BatchCreateContactsResponse>
      batchCreateContactsSettings() {
    return batchCreateContactsSettings;
  }
  ...
  public UnaryCallSettings<BatchUpdateContactsRequest, BatchUpdateContactsResponse>
      batchUpdateContactsSettings() {
    return batchUpdateContactsSettings;
  }
  ...
  protected ContactServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    batchCreateContactsSettings = settingsBuilder.batchCreateContactsSettings().build();
    updateContactSettings = settingsBuilder.updateContactSettings().build();
    batchUpdateContactsSettings = settingsBuilder.batchUpdateContactsSettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<ContactServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<BatchCreateContactsRequest, BatchCreateContactsResponse>
        batchCreateContactsSettings;
    private final UnaryCallSettings.Builder<UpdateContactRequest, Contact> updateContactSettings;
    private final UnaryCallSettings.Builder<BatchUpdateContactsRequest, BatchUpdateContactsResponse>
        batchUpdateContactsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      batchCreateContactsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      updateContactSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      batchUpdateContactsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(ContactServiceStubSettings settings) {
      ...
      batchCreateContactsSettings = settings.batchCreateContactsSettings.toBuilder();
      updateContactSettings = settings.updateContactSettings.toBuilder();
      batchUpdateContactsSettings = settings.batchUpdateContactsSettings.toBuilder();
