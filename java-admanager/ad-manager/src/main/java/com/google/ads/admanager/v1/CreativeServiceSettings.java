...
/**
 * Settings class to configure an instance of {@link CreativeServiceClient}.
 *
 ...
 * CreativeServiceSettings.Builder creativeServiceSettingsBuilder =
 ...
 *             .build());
 * CreativeServiceSettings creativeServiceSettings = creativeServiceSettingsBuilder.build();
 * }</pre>
 */
...
public class CreativeServiceSettings extends ClientSettings<CreativeServiceSettings> {
  ...
  public static final CreativeServiceSettings create(CreativeServiceStubSettings stub)
      throws IOException {
    return new CreativeServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected CreativeServiceSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<CreativeServiceSettings, Builder> {
    ...
    @Override
    public CreativeServiceSettings build() throws IOException {
