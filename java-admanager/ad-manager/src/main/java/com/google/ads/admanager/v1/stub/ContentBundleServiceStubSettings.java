...
/**
 * Settings class to configure an instance of {@link ContentBundleServiceStub}.
 *
...
public class ContentBundleServiceStubSettings
  ...
  private static final PagedListDescriptor<
      ...
      LIST_CONTENT_BUNDLES_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListContentBundlesRequest injectToken(
                ListContentBundlesRequest payload, String token) {
              return ListContentBundlesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListContentBundlesRequest injectPageSize(
                ListContentBundlesRequest payload, int pageSize) {
              return ListContentBundlesRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListContentBundlesRequest, ListContentBundlesResponse, ListContentBundlesPagedResponse>
      LIST_CONTENT_BUNDLES_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListContentBundlesRequest,
              ListContentBundlesResponse,
              ListContentBundlesPagedResponse>() {
            @Override
            public ApiFuture<ListContentBundlesPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListContentBundlesRequest, ListContentBundlesResponse> callable,
                ListContentBundlesRequest request,
                ApiCallContext context,
                ApiFuture<ListContentBundlesResponse> futureResponse) {
              PageContext<ListContentBundlesRequest, ListContentBundlesResponse, ContentBundle>
                  pageContext =
                      PageContext.create(
                          callable, LIST_CONTENT_BUNDLES_PAGE_STR_DESC, request, context);
              return ListContentBundlesPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetContentBundleRequest, ContentBundle> getContentBundleSettings() {
    return getContentBundleSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ContentBundleServiceStubSettings.class))
        .setTransportToken(
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<GetContentBundleRequest, ContentBundle>
        getContentBundleSettings;
