...
/**
 * Settings class to configure an instance of {@link BandwidthGroupServiceStub}.
 *
...
public class BandwidthGroupServiceStubSettings
  ...
  private final UnaryCallSettings<GetBandwidthGroupRequest, BandwidthGroup>
      getBandwidthGroupSettings;
  ...
  private static final PagedListDescriptor<
          ListBandwidthGroupsRequest, ListBandwidthGroupsResponse, BandwidthGroup>
      LIST_BANDWIDTH_GROUPS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListBandwidthGroupsRequest injectToken(
                ListBandwidthGroupsRequest payload, String token) {
              return ListBandwidthGroupsRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListBandwidthGroupsRequest injectPageSize(
                ListBandwidthGroupsRequest payload, int pageSize) {
              return ListBandwidthGroupsRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListBandwidthGroupsRequest, ListBandwidthGroupsResponse, ListBandwidthGroupsPagedResponse>
      LIST_BANDWIDTH_GROUPS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListBandwidthGroupsRequest,
              ListBandwidthGroupsResponse,
              ListBandwidthGroupsPagedResponse>() {
            @Override
            public ApiFuture<ListBandwidthGroupsPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListBandwidthGroupsRequest, ListBandwidthGroupsResponse> callable,
              ...
              PageContext<ListBandwidthGroupsRequest, ListBandwidthGroupsResponse, BandwidthGroup>
                  pageContext =
                      PageContext.create(
                          callable, LIST_BANDWIDTH_GROUPS_PAGE_STR_DESC, request, context);
              return ListBandwidthGroupsPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetBandwidthGroupRequest, BandwidthGroup> getBandwidthGroupSettings() {
    return getBandwidthGroupSettings;
  }
  ...
  public PagedCallSettings<
          ListBandwidthGroupsRequest, ListBandwidthGroupsResponse, ListBandwidthGroupsPagedResponse>
      listBandwidthGroupsSettings() {
    return listBandwidthGroupsSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(BandwidthGroupServiceStubSettings.class))
        .setTransportToken(
  ...
  protected BandwidthGroupServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getBandwidthGroupSettings = settingsBuilder.getBandwidthGroupSettings().build();
    listBandwidthGroupsSettings = settingsBuilder.listBandwidthGroupsSettings().build();
  }

  /** Builder for BandwidthGroupServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<BandwidthGroupServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetBandwidthGroupRequest, BandwidthGroup>
        getBandwidthGroupSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getBandwidthGroupSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listBandwidthGroupsSettings =
          PagedCallSettings.newBuilder(LIST_BANDWIDTH_GROUPS_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getBandwidthGroupSettings, listBandwidthGroupsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(BandwidthGroupServiceStubSettings settings) {
      ...
      getBandwidthGroupSettings = settings.getBandwidthGroupSettings.toBuilder();
      listBandwidthGroupsSettings = settings.listBandwidthGroupsSettings.toBuilder();
