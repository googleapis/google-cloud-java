...
public abstract class MobileCarrierServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<GetMobileCarrierRequest, MobileCarrier> getMobileCarrierCallable() {
    throw new UnsupportedOperationException("Not implemented: getMobileCarrierCallable()");
  }

  public UnaryCallable<ListMobileCarriersRequest, ListMobileCarriersPagedResponse>
      listMobileCarriersPagedCallable() {
    throw new UnsupportedOperationException("Not implemented: listMobileCarriersPagedCallable()");
  }

  public UnaryCallable<ListMobileCarriersRequest, ListMobileCarriersResponse>
      listMobileCarriersCallable() {
    throw new UnsupportedOperationException("Not implemented: listMobileCarriersCallable()");
  }
