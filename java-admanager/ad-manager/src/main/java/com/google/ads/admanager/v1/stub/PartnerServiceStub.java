...
/**
 * Base stub class for the PartnerService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@NullMarked
@Generated("by gapic-generator-java")
public abstract class PartnerServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<ListPartnersRequest, ListPartnersPagedResponse> listPartnersPagedCallable() {
    throw new UnsupportedOperationException("Not implemented: listPartnersPagedCallable()");
  }

  public UnaryCallable<ListPartnersRequest, ListPartnersResponse> listPartnersCallable() {
    throw new UnsupportedOperationException("Not implemented: listPartnersCallable()");
  }

  public UnaryCallable<UpdatePartnerRequest, Partner> updatePartnerCallable() {
    throw new UnsupportedOperationException("Not implemented: updatePartnerCallable()");
  }

  public UnaryCallable<BatchUpdatePartnersRequest, BatchUpdatePartnersResponse>
      batchUpdatePartnersCallable() {
    throw new UnsupportedOperationException("Not implemented: batchUpdatePartnersCallable()");
  }
