...
/**
 * Settings class to configure an instance of {@link ProgrammaticBuyerServiceStub}.
 *
...
public class ProgrammaticBuyerServiceStubSettings
  ...
  private final UnaryCallSettings<GetProgrammaticBuyerRequest, ProgrammaticBuyer>
      getProgrammaticBuyerSettings;
  ...
  private static final PagedListDescriptor<
      ...
      LIST_PROGRAMMATIC_BUYERS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListProgrammaticBuyersRequest injectToken(
                ListProgrammaticBuyersRequest payload, String token) {
              return ListProgrammaticBuyersRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListProgrammaticBuyersRequest injectPageSize(
                ListProgrammaticBuyersRequest payload, int pageSize) {
              return ListProgrammaticBuyersRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<ProgrammaticBuyer> extractResources(
                ListProgrammaticBuyersResponse payload) {
  ...
  private static final PagedListResponseFactory<
          ...
          ListProgrammaticBuyersResponse,
          ListProgrammaticBuyersPagedResponse>
      LIST_PROGRAMMATIC_BUYERS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListProgrammaticBuyersRequest,
              ListProgrammaticBuyersResponse,
              ListProgrammaticBuyersPagedResponse>() {
            @Override
            public ApiFuture<ListProgrammaticBuyersPagedResponse> getFuturePagedResponse(
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, LIST_PROGRAMMATIC_BUYERS_PAGE_STR_DESC, request, context);
              return ListProgrammaticBuyersPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetProgrammaticBuyerRequest, ProgrammaticBuyer>
      getProgrammaticBuyerSettings() {
    return getProgrammaticBuyerSettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListProgrammaticBuyersPagedResponse>
      listProgrammaticBuyersSettings() {
    return listProgrammaticBuyersSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ProgrammaticBuyerServiceStubSettings.class))
        .setTransportToken(
  ...
  protected ProgrammaticBuyerServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getProgrammaticBuyerSettings = settingsBuilder.getProgrammaticBuyerSettings().build();
    listProgrammaticBuyersSettings = settingsBuilder.listProgrammaticBuyersSettings().build();
  }

  /** Builder for ProgrammaticBuyerServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<ProgrammaticBuyerServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetProgrammaticBuyerRequest, ProgrammaticBuyer>
        getProgrammaticBuyerSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getProgrammaticBuyerSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listProgrammaticBuyersSettings =
          PagedCallSettings.newBuilder(LIST_PROGRAMMATIC_BUYERS_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getProgrammaticBuyerSettings, listProgrammaticBuyersSettings);
      initDefaults(this);
    }
    ...
    protected Builder(ProgrammaticBuyerServiceStubSettings settings) {
      ...
      getProgrammaticBuyerSettings = settings.getProgrammaticBuyerSettings.toBuilder();
      listProgrammaticBuyersSettings = settings.listProgrammaticBuyersSettings.toBuilder();
