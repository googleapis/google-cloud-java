...
/**
 * Settings class to configure an instance of {@link DeviceCategoryServiceStub}.
 *
...
public class DeviceCategoryServiceStubSettings
  ...
  private final UnaryCallSettings<GetDeviceCategoryRequest, DeviceCategory>
      getDeviceCategorySettings;
  ...
  private static final PagedListDescriptor<
          ListDeviceCategoriesRequest, ListDeviceCategoriesResponse, DeviceCategory>
      LIST_DEVICE_CATEGORIES_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListDeviceCategoriesRequest injectToken(
                ListDeviceCategoriesRequest payload, String token) {
              return ListDeviceCategoriesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListDeviceCategoriesRequest injectPageSize(
                ListDeviceCategoriesRequest payload, int pageSize) {
              return ListDeviceCategoriesRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ...
          ListDeviceCategoriesResponse,
          ListDeviceCategoriesPagedResponse>
      LIST_DEVICE_CATEGORIES_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListDeviceCategoriesRequest,
              ListDeviceCategoriesResponse,
              ListDeviceCategoriesPagedResponse>() {
            @Override
            public ApiFuture<ListDeviceCategoriesPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListDeviceCategoriesRequest, ListDeviceCategoriesResponse> callable,
              ...
              PageContext<ListDeviceCategoriesRequest, ListDeviceCategoriesResponse, DeviceCategory>
                  pageContext =
                      PageContext.create(
                          callable, LIST_DEVICE_CATEGORIES_PAGE_STR_DESC, request, context);
              return ListDeviceCategoriesPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetDeviceCategoryRequest, DeviceCategory> getDeviceCategorySettings() {
    return getDeviceCategorySettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListDeviceCategoriesPagedResponse>
      listDeviceCategoriesSettings() {
    return listDeviceCategoriesSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(DeviceCategoryServiceStubSettings.class))
        .setTransportToken(
  ...
  protected DeviceCategoryServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getDeviceCategorySettings = settingsBuilder.getDeviceCategorySettings().build();
    listDeviceCategoriesSettings = settingsBuilder.listDeviceCategoriesSettings().build();
  }

  /** Builder for DeviceCategoryServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<DeviceCategoryServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetDeviceCategoryRequest, DeviceCategory>
        getDeviceCategorySettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getDeviceCategorySettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listDeviceCategoriesSettings =
          PagedCallSettings.newBuilder(LIST_DEVICE_CATEGORIES_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getDeviceCategorySettings, listDeviceCategoriesSettings);
      initDefaults(this);
    }
    ...
    protected Builder(DeviceCategoryServiceStubSettings settings) {
      ...
      getDeviceCategorySettings = settings.getDeviceCategorySettings.toBuilder();
      listDeviceCategoriesSettings = settings.listDeviceCategoriesSettings.toBuilder();
