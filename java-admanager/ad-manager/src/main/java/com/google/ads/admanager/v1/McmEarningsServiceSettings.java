...
public class McmEarningsServiceSettings extends ClientSettings<McmEarningsServiceSettings> {
  ...
  public static class Builder extends ClientSettings.Builder<McmEarningsServiceSettings, Builder> {
