...
/**
 * Settings class to configure an instance of {@link RoleServiceStub}.
 *
...
public class RoleServiceStubSettings extends StubSettings<RoleServiceStubSettings> {
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(RoleServiceStubSettings.class))
        .setTransportToken(
  ...
  /** Builder for RoleServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<RoleServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(getRoleSettings, listRolesSettings);
      initDefaults(this);
    }
