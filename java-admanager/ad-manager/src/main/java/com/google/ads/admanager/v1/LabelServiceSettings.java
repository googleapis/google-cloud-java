...
public class LabelServiceSettings extends ClientSettings<LabelServiceSettings> {
  ...
  public UnaryCallSettings<CreateLabelRequest, Label> createLabelSettings() {
  ...
  public UnaryCallSettings<BatchCreateLabelsRequest, BatchCreateLabelsResponse>
  ...
  public UnaryCallSettings<UpdateLabelRequest, Label> updateLabelSettings() {
  ...
  public UnaryCallSettings<BatchUpdateLabelsRequest, BatchUpdateLabelsResponse>
  ...
  public UnaryCallSettings<BatchActivateLabelsRequest, BatchActivateLabelsResponse>
  ...
  public UnaryCallSettings<BatchDeactivateLabelsRequest, BatchDeactivateLabelsResponse>
  ...
  public static class Builder extends ClientSettings.Builder<LabelServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<BatchCreateLabelsRequest, BatchCreateLabelsResponse>
        batchCreateLabelsSettings() {
    ...
    public UnaryCallSettings.Builder<BatchUpdateLabelsRequest, BatchUpdateLabelsResponse>
        batchUpdateLabelsSettings() {
    ...
    public UnaryCallSettings.Builder<BatchActivateLabelsRequest, BatchActivateLabelsResponse>
        batchActivateLabelsSettings() {
    ...
    public UnaryCallSettings.Builder<BatchDeactivateLabelsRequest, BatchDeactivateLabelsResponse>
        batchDeactivateLabelsSettings() {
