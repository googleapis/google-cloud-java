...
/**
 * Settings class to configure an instance of {@link OperatingSystemVersionServiceStub}.
 *
...
public class OperatingSystemVersionServiceStubSettings
  ...
  private final UnaryCallSettings<GetOperatingSystemVersionRequest, OperatingSystemVersion>
      getOperatingSystemVersionSettings;
  ...
  private static final PagedListDescriptor<
      ...
      LIST_OPERATING_SYSTEM_VERSIONS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListOperatingSystemVersionsRequest injectToken(
                ListOperatingSystemVersionsRequest payload, String token) {
              return ListOperatingSystemVersionsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListOperatingSystemVersionsRequest injectPageSize(
                ListOperatingSystemVersionsRequest payload, int pageSize) {
              return ListOperatingSystemVersionsRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<OperatingSystemVersion> extractResources(
                ListOperatingSystemVersionsResponse payload) {
  ...
  private static final PagedListResponseFactory<
      ...
      LIST_OPERATING_SYSTEM_VERSIONS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ...
              ListOperatingSystemVersionsPagedResponse>() {
            @Override
            public ApiFuture<ListOperatingSystemVersionsPagedResponse> getFuturePagedResponse(
                UnaryCallable<
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, LIST_OPERATING_SYSTEM_VERSIONS_PAGE_STR_DESC, request, context);
              return ListOperatingSystemVersionsPagedResponse.createAsync(
  ...
  public UnaryCallSettings<GetOperatingSystemVersionRequest, OperatingSystemVersion>
      getOperatingSystemVersionSettings() {
    return getOperatingSystemVersionSettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListOperatingSystemVersionsPagedResponse>
      listOperatingSystemVersionsSettings() {
    return listOperatingSystemVersionsSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(OperatingSystemVersionServiceStubSettings.class))
        .setTransportToken(
  ...
  protected OperatingSystemVersionServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getOperatingSystemVersionSettings = settingsBuilder.getOperatingSystemVersionSettings().build();
    listOperatingSystemVersionsSettings =
        settingsBuilder.listOperatingSystemVersionsSettings().build();
  }

  /** Builder for OperatingSystemVersionServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<OperatingSystemVersionServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<
            GetOperatingSystemVersionRequest, OperatingSystemVersion>
        getOperatingSystemVersionSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getOperatingSystemVersionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listOperatingSystemVersionsSettings =
          PagedCallSettings.newBuilder(LIST_OPERATING_SYSTEM_VERSIONS_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getOperatingSystemVersionSettings, listOperatingSystemVersionsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(OperatingSystemVersionServiceStubSettings settings) {
      ...
      getOperatingSystemVersionSettings = settings.getOperatingSystemVersionSettings.toBuilder();
      listOperatingSystemVersionsSettings =
          settings.listOperatingSystemVersionsSettings.toBuilder();
