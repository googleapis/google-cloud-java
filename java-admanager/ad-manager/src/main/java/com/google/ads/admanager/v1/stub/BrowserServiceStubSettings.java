...
/**
 * Settings class to configure an instance of {@link BrowserServiceStub}.
 *
...
public class BrowserServiceStubSettings extends StubSettings<BrowserServiceStubSettings> {
  ...
  private static final PagedListDescriptor<ListBrowsersRequest, ListBrowsersResponse, Browser>
      LIST_BROWSERS_PAGE_STR_DESC =
          new PagedListDescriptor<ListBrowsersRequest, ListBrowsersResponse, Browser>() {
            @Override
            ...
            public ListBrowsersRequest injectToken(ListBrowsersRequest payload, String token) {
              return ListBrowsersRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListBrowsersRequest injectPageSize(ListBrowsersRequest payload, int pageSize) {
              return ListBrowsersRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListBrowsersRequest, ListBrowsersResponse, ListBrowsersPagedResponse>
      LIST_BROWSERS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListBrowsersRequest, ListBrowsersResponse, ListBrowsersPagedResponse>() {
            @Override
            public ApiFuture<ListBrowsersPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListBrowsersRequest, ListBrowsersResponse> callable,
                ListBrowsersRequest request,
                ApiCallContext context,
                ApiFuture<ListBrowsersResponse> futureResponse) {
              PageContext<ListBrowsersRequest, ListBrowsersResponse, Browser> pageContext =
                  PageContext.create(callable, LIST_BROWSERS_PAGE_STR_DESC, request, context);
              return ListBrowsersPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(BrowserServiceStubSettings.class))
        .setTransportToken(
  ...
  protected BrowserServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getBrowserSettings = settingsBuilder.getBrowserSettings().build();
    listBrowsersSettings = settingsBuilder.listBrowsersSettings().build();
  }

  /** Builder for BrowserServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<BrowserServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getBrowserSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listBrowsersSettings = PagedCallSettings.newBuilder(LIST_BROWSERS_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getBrowserSettings, listBrowsersSettings);
      initDefaults(this);
    }
    ...
    protected Builder(BrowserServiceStubSettings settings) {
      ...
      getBrowserSettings = settings.getBrowserSettings.toBuilder();
      listBrowsersSettings = settings.listBrowsersSettings.toBuilder();
