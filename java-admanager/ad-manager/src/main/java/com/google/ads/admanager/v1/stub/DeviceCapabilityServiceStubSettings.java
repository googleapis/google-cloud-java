...
/**
 * Settings class to configure an instance of {@link DeviceCapabilityServiceStub}.
 *
...
public class DeviceCapabilityServiceStubSettings
  ...
  private final UnaryCallSettings<GetDeviceCapabilityRequest, DeviceCapability>
      getDeviceCapabilitySettings;
  ...
  private static final PagedListDescriptor<
      ...
      LIST_DEVICE_CAPABILITIES_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListDeviceCapabilitiesRequest injectToken(
                ListDeviceCapabilitiesRequest payload, String token) {
              return ListDeviceCapabilitiesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListDeviceCapabilitiesRequest injectPageSize(
                ListDeviceCapabilitiesRequest payload, int pageSize) {
              return ListDeviceCapabilitiesRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<DeviceCapability> extractResources(
                ListDeviceCapabilitiesResponse payload) {
  ...
  private static final PagedListResponseFactory<
          ...
          ListDeviceCapabilitiesResponse,
          ListDeviceCapabilitiesPagedResponse>
      LIST_DEVICE_CAPABILITIES_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListDeviceCapabilitiesRequest,
              ListDeviceCapabilitiesResponse,
              ListDeviceCapabilitiesPagedResponse>() {
            @Override
            public ApiFuture<ListDeviceCapabilitiesPagedResponse> getFuturePagedResponse(
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, LIST_DEVICE_CAPABILITIES_PAGE_STR_DESC, request, context);
              return ListDeviceCapabilitiesPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetDeviceCapabilityRequest, DeviceCapability>
      getDeviceCapabilitySettings() {
    return getDeviceCapabilitySettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListDeviceCapabilitiesPagedResponse>
      listDeviceCapabilitiesSettings() {
    return listDeviceCapabilitiesSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(DeviceCapabilityServiceStubSettings.class))
        .setTransportToken(
  ...
  protected DeviceCapabilityServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getDeviceCapabilitySettings = settingsBuilder.getDeviceCapabilitySettings().build();
    listDeviceCapabilitiesSettings = settingsBuilder.listDeviceCapabilitiesSettings().build();
  }

  /** Builder for DeviceCapabilityServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<DeviceCapabilityServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetDeviceCapabilityRequest, DeviceCapability>
        getDeviceCapabilitySettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getDeviceCapabilitySettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listDeviceCapabilitiesSettings =
          PagedCallSettings.newBuilder(LIST_DEVICE_CAPABILITIES_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getDeviceCapabilitySettings, listDeviceCapabilitiesSettings);
      initDefaults(this);
    }
    ...
    protected Builder(DeviceCapabilityServiceStubSettings settings) {
      ...
      getDeviceCapabilitySettings = settings.getDeviceCapabilitySettings.toBuilder();
      listDeviceCapabilitiesSettings = settings.listDeviceCapabilitiesSettings.toBuilder();
