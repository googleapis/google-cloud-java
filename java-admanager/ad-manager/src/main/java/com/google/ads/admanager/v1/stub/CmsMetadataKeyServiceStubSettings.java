...
/**
 * Settings class to configure an instance of {@link CmsMetadataKeyServiceStub}.
 *
...
public class CmsMetadataKeyServiceStubSettings
  ...
  private static final PagedListDescriptor<
      ...
      LIST_CMS_METADATA_KEYS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListCmsMetadataKeysRequest injectToken(
                ListCmsMetadataKeysRequest payload, String token) {
              return ListCmsMetadataKeysRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListCmsMetadataKeysRequest injectPageSize(
                ListCmsMetadataKeysRequest payload, int pageSize) {
              return ListCmsMetadataKeysRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListCmsMetadataKeysRequest, ListCmsMetadataKeysResponse, ListCmsMetadataKeysPagedResponse>
      LIST_CMS_METADATA_KEYS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListCmsMetadataKeysRequest,
              ListCmsMetadataKeysResponse,
              ListCmsMetadataKeysPagedResponse>() {
            @Override
            public ApiFuture<ListCmsMetadataKeysPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListCmsMetadataKeysRequest, ListCmsMetadataKeysResponse> callable,
              ...
              PageContext<ListCmsMetadataKeysRequest, ListCmsMetadataKeysResponse, CmsMetadataKey>
                  pageContext =
                      PageContext.create(
                          callable, LIST_CMS_METADATA_KEYS_PAGE_STR_DESC, request, context);
              return ListCmsMetadataKeysPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetCmsMetadataKeyRequest, CmsMetadataKey> getCmsMetadataKeySettings() {
    return getCmsMetadataKeySettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CmsMetadataKeyServiceStubSettings.class))
        .setTransportToken(
  ...
  /** Builder for CmsMetadataKeyServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<CmsMetadataKeyServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetCmsMetadataKeyRequest, CmsMetadataKey>
        getCmsMetadataKeySettings;
