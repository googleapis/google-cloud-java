...
/**
 * Settings class to configure an instance of {@link MobileDeviceSubmodelServiceStub}.
 *
...
public class MobileDeviceSubmodelServiceStubSettings
  ...
  private final UnaryCallSettings<GetMobileDeviceSubmodelRequest, MobileDeviceSubmodel>
      getMobileDeviceSubmodelSettings;
  ...
  private static final PagedListDescriptor<
          ListMobileDeviceSubmodelsRequest, ListMobileDeviceSubmodelsResponse, MobileDeviceSubmodel>
      LIST_MOBILE_DEVICE_SUBMODELS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListMobileDeviceSubmodelsRequest injectToken(
                ListMobileDeviceSubmodelsRequest payload, String token) {
              return ListMobileDeviceSubmodelsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListMobileDeviceSubmodelsRequest injectPageSize(
                ListMobileDeviceSubmodelsRequest payload, int pageSize) {
              return ListMobileDeviceSubmodelsRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<MobileDeviceSubmodel> extractResources(
                ListMobileDeviceSubmodelsResponse payload) {
  ...
  private static final PagedListResponseFactory<
          ...
          ListMobileDeviceSubmodelsResponse,
          ListMobileDeviceSubmodelsPagedResponse>
      LIST_MOBILE_DEVICE_SUBMODELS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListMobileDeviceSubmodelsRequest,
              ListMobileDeviceSubmodelsResponse,
              ListMobileDeviceSubmodelsPagedResponse>() {
            @Override
            public ApiFuture<ListMobileDeviceSubmodelsPagedResponse> getFuturePagedResponse(
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, LIST_MOBILE_DEVICE_SUBMODELS_PAGE_STR_DESC, request, context);
              return ListMobileDeviceSubmodelsPagedResponse.createAsync(
  ...
  public PagedCallSettings<
          ...
          ListMobileDeviceSubmodelsPagedResponse>
      listMobileDeviceSubmodelsSettings() {
    return listMobileDeviceSubmodelsSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(MobileDeviceSubmodelServiceStubSettings.class))
        .setTransportToken(
  ...
  protected MobileDeviceSubmodelServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getMobileDeviceSubmodelSettings = settingsBuilder.getMobileDeviceSubmodelSettings().build();
    listMobileDeviceSubmodelsSettings = settingsBuilder.listMobileDeviceSubmodelsSettings().build();
  }

  /** Builder for MobileDeviceSubmodelServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<MobileDeviceSubmodelServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetMobileDeviceSubmodelRequest, MobileDeviceSubmodel>
        getMobileDeviceSubmodelSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getMobileDeviceSubmodelSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listMobileDeviceSubmodelsSettings =
          PagedCallSettings.newBuilder(LIST_MOBILE_DEVICE_SUBMODELS_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getMobileDeviceSubmodelSettings, listMobileDeviceSubmodelsSettings);
      initDefaults(this);
    }
    ...
    protected Builder(MobileDeviceSubmodelServiceStubSettings settings) {
      ...
      getMobileDeviceSubmodelSettings = settings.getMobileDeviceSubmodelSettings.toBuilder();
      listMobileDeviceSubmodelsSettings = settings.listMobileDeviceSubmodelsSettings.toBuilder();
