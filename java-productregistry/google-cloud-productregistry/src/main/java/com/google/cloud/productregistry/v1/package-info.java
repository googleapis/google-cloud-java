...
/**
 * A client to Cloud Product Registry API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= CloudProductRegistryReadServiceClient =======================
 *
 * <p>Service Description: Cloud Product Registry Read Service provides capabilities to access all
 * first and third party Google Cloud products.
 *
 * <p>Sample for CloudProductRegistryReadServiceClient:
 *
 * <pre>{@code
