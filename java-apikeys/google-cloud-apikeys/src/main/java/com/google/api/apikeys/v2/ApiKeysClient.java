 ...
 *    <tr>
 *      <td>ListKeys</td>
 *      <td><p>Lists the API keys owned by a project. The key string of the API key
 ...
 *    <tr>
 *      <td>GetKey</td>
 *      <td><p>Gets the metadata for an API key. The key string of the API key
 *  isn't included in the response.
 *
 *  NOTE: Key is a global resource; hence the only supported value for
 *  location is `global`.</p></td>
 ...
 *    <tr>
 *      <td>UpdateKey</td>
 *      <td><p>Patches the modifiable fields of an API key.
 ...
 *    <tr>
 *      <td>DeleteKey</td>
 *      <td><p>Deletes an API key. Deleted key can be retrieved within 30 days of
 ...
 *    <tr>
 *      <td>LookupKey</td>
 *      <td><p>Find the parent project and resource name of the API
 *  key that matches the key string in the request. If the API key has been
 *  purged, resource name will not be set.
 *  The service account must have the `apikeys.keys.lookup` permission
 *  on the parent project.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
