  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "_behavior.proto\032\031google/api/resource.proto\032\037google/protobuf/timestamp.proto\"\242\004\n"
          + "\003Key\022\021\n"
          ...
          + "\014restrictions\030\t \001(\0132#.google.api.apikeys.v2.Restrictions\022\021\n"
          + "\004etag\030\013 \001(\tB\003\340A\003\0322\n"
          + "\020AnnotationsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:a\352A^\n"
          + "\032apikeys.googleapis.com/Key\0222"
          + "projects/{project}/locations/{location}/keys/{key}*\004keys2\003keyR\001\001\"\236\003\n"
          + "\014Restrictions\022Q\n"
          + "\030browser_key_restrictions\030\001 \001(\0132-.go"
          + "ogle.api.apikeys.v2.BrowserKeyRestrictionsH\000\022O\n"
          + "\027server_key_restrictions\030\002 \001(\0132,."
          + "google.api.apikeys.v2.ServerKeyRestrictionsH\000\022Q\n"
          + "\030android_key_restrictions\030\003 \001(\0132"
          + "-.google.api.apikeys.v2.AndroidKeyRestrictionsH\000\022I\n"
          + "\024ios_key_restrictions\030\004 \001(\0132)"
          + ".google.api.apikeys.v2.IosKeyRestrictionsH\000\0225\n"
          + "\013api_targets\030\005 \003(\0132 .google.api.apikeys.v2.ApiTargetB\025\n"
          + "\023client_restrictions\"3\n"
          + "\026BrowserKeyRestrictions\022\031\n"
          + "\021allowed_referrers\030\001 \003(\t\",\n"
          + "\025ServerKeyRestrictions\022\023\n"
          + "\013allowed_ips\030\001 \003(\t\"a\n"
          + "\026AndroidKeyRestrictions\022G\n"
          + "\024allowed_applications\030\001 \003(\0132).g"
          + "oogle.api.apikeys.v2.AndroidApplication\"D\n"
          + "\022AndroidApplication\022\030\n"
          + "\020sha1_fingerprint\030\001 \001(\t\022\024\n"
          + "\014package_name\030\002 \001(\t\"0\n"
          + "\022IosKeyRestrictions\022\032\n"
          + "\022allowed_bundle_ids\030\001 \003(\t\"2\n"
          + "\tApiTarget\022\017\n"
          + "\007service\030\001 \001(\t\022\024\n"
          + "\007methods\030\002 \003(\tB\003\340A\001B\265\001\n"
          + "\031com.google.api.apikeys.v2B\016ResourcesProtoP\001Z5cloud.google.com/go"
          + "/apikeys/apiv2/apikeyspb;apikeyspb\252\002\027Goo"
          + "gle.Cloud.ApiKeys.V2\312\002\027Google\\Cloud\\ApiK"
          + "eys\\V2\352\002\032Google::Cloud::ApiKeys::V2b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_api_apikeys_v2_Key_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_api_apikeys_v2_Key_fieldAccessorTable =
    ...
    internal_static_google_api_apikeys_v2_Key_AnnotationsEntry_descriptor =
        internal_static_google_api_apikeys_v2_Key_descriptor.getNestedType(0);
    internal_static_google_api_apikeys_v2_Key_AnnotationsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_api_apikeys_v2_Key_AnnotationsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_api_apikeys_v2_ApiTarget_descriptor = getDescriptor().getMessageType(7);
    internal_static_google_api_apikeys_v2_ApiTarget_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_api_apikeys_v2_ApiTarget_descriptor,
            new java.lang.String[] {
