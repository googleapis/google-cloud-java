...
public final class ApiKeysGrpc {
  ...
  public static io.grpc.MethodDescriptor<
          com.google.api.apikeys.v2.GetKeyRequest, com.google.api.apikeys.v2.Key>
      getGetKeyMethod() {
    io.grpc.MethodDescriptor<com.google.api.apikeys.v2.GetKeyRequest, com.google.api.apikeys.v2.Key>
        getGetKeyMethod;
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.api.apikeys.v2.LookupKeyRequest, com.google.api.apikeys.v2.LookupKeyResponse>
      getLookupKeyMethod;
  ...
  public static ApiKeysBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ApiKeysBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ApiKeysBlockingV2Stub>() {
          @java.lang.Override
          public ApiKeysBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new ApiKeysBlockingV2Stub(channel, callOptions);
          }
        };
    return ApiKeysBlockingV2Stub.newStub(factory, channel);
  }

  /**
   * Creates a new blocking-style stub that supports unary and streaming output calls on the service
   */
  public static ApiKeysBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ApiKeysBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ApiKeysBlockingStub>() {
          @java.lang.Override
          public ApiKeysBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ApiKeysFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ApiKeysFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ApiKeysFutureStub>() {
          @java.lang.Override
          public ApiKeysFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void getKeyString(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getGetKeyStringMethod(), responseObserver);
    }
    ...
    default void undeleteKey(
        ...
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getUndeleteKeyMethod(), responseObserver);
    }
  ...
  public static final class ApiKeysStub extends io.grpc.stub.AbstractAsyncStub<ApiKeysStub> {
    private ApiKeysStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ApiKeysStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ApiKeysStub(channel, callOptions);
    }
    ...
    public void getKeyString(
        ...
        io.grpc.stub.StreamObserver<com.google.api.apikeys.v2.GetKeyStringResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetKeyStringMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void undeleteKey(
        ...
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUndeleteKeyMethod(), getCallOptions()),
          request,
          responseObserver);
    }
   ...
   * </pre>
   */
  public static final class ApiKeysBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<ApiKeysBlockingV2Stub> {
    private ApiKeysBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ApiKeysBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ApiKeysBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service ApiKeys.
   *
   * <pre>
   * Manages the API keys associated with projects.
   * </pre>
  ...
  public static final class ApiKeysBlockingStub
    ...
    @java.lang.Override
    protected ApiKeysBlockingStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ApiKeysBlockingStub(channel, callOptions);
    }
  ...
  public static final class ApiKeysFutureStub
    ...
    private ApiKeysFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ApiKeysFutureStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ApiKeysFutureStub(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        createKey(com.google.api.apikeys.v2.CreateKeyRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.api.apikeys.v2.ListKeysResponse>
        listKeys(com.google.api.apikeys.v2.ListKeysRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.api.apikeys.v2.GetKeyStringResponse>
        getKeyString(com.google.api.apikeys.v2.GetKeyStringRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        updateKey(com.google.api.apikeys.v2.UpdateKeyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        deleteKey(com.google.api.apikeys.v2.DeleteKeyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        undeleteKey(com.google.api.apikeys.v2.UndeleteKeyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.api.apikeys.v2.LookupKeyResponse>
        lookupKey(com.google.api.apikeys.v2.LookupKeyRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
      ...
      switch (methodId) {
        ...
        case METHODID_LIST_KEYS:
          serviceImpl.listKeys(
              (com.google.api.apikeys.v2.ListKeysRequest) request,
              (io.grpc.stub.StreamObserver<com.google.api.apikeys.v2.ListKeysResponse>)
                  responseObserver);
          break;
        ...
        case METHODID_UNDELETE_KEY:
          serviceImpl.undeleteKey(
              (com.google.api.apikeys.v2.UndeleteKeyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_LOOKUP_KEY:
          serviceImpl.lookupKey(
              (com.google.api.apikeys.v2.LookupKeyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.api.apikeys.v2.LookupKeyResponse>)
                  responseObserver);
          break;
        default:
  ...
  private static final class ApiKeysFileDescriptorSupplier extends ApiKeysBaseDescriptorSupplier {
    ApiKeysFileDescriptorSupplier() {}
  }

  private static final class ApiKeysMethodDescriptorSupplier extends ApiKeysBaseDescriptorSupplier
