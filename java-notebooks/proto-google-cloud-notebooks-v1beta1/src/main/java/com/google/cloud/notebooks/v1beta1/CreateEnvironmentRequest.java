  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.notebooks.v1beta1.CreateEnvironmentRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeEnvironment(com.google.cloud.notebooks.v1beta1.Environment value) {
      if (environmentBuilder_ == null) {
        if (environment_ != null) {
          environment_ =
              com.google.cloud.notebooks.v1beta1.Environment.newBuilder(environment_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          environment_ = value;
