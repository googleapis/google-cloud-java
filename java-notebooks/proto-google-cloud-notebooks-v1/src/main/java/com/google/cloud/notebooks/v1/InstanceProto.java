  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ironment.proto\032\037google/protobuf/timestamp.proto\"\371\001\n"
          + "\023ReservationAffinity\022Z\n"
          + "\030consume_reservation_type\030\001 \001(\01623.google.cloud"
          + ".notebooks.v1.ReservationAffinity.TypeB\003\340A\001\022\020\n"
          ...
          + "\024SPECIFIC_RESERVATION\020\003\"\255\034\n"
          + "\010Instance\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\0226\n"
          + "\010vm_image\030\002 \001(\0132\".google.cloud.notebooks.v1.VmImageH\000\022D\n"
          + "\017container_image\030\003"
          + " \001(\0132).google.cloud.notebooks.v1.ContainerImageH\000\022\033\n"
          ...
          + "\026service_account_scopes\030\037 \003(\tB\003\340A\001\022\031\n"
          + "\014machine_type\030\010 \001(\tB\003\340A\002\022Q\n"
          + "\022accelerator_config\030\t"
          + " \001(\01325.google.cloud.notebooks.v1.Instance.AcceleratorConfig\022=\n"
          + "\005state\030\n"
          + " \001(\0162).google.cloud.notebooks.v1.Instance.StateB\003\340A\003\022\032\n"
          + "\022install_gpu_driver\030\013 \001(\010\022\036\n"
          + "\026custom_gpu_driver_path\030\014 \001(\t\022I\n"
          + "\016boot_disk_type\030\r"
          + " \001(\0162,.google.cloud.notebooks.v1.Instance.DiskTypeB\003\340A\004\022\036\n"
          + "\021boot_disk_size_gb\030\016 \001(\003B\003\340A\004\022I\n"
          + "\016data_disk_type\030\031"
          + " \001(\0162,.google.cloud.notebooks.v1.Instance.DiskTypeB\003\340A\004\022\036\n"
          ...
          + "oud.notebooks.v1.Instance.DiskEncryptionB\003\340A\004\022\024\n"
          + "\007kms_key\030\020 \001(\tB\003\340A\004\022<\n"
          + "\005disks\030\034 \003"
          + "(\0132(.google.cloud.notebooks.v1.Instance.DiskB\003\340A\003\022a\n"
          + "\030shielded_instance_config\030\036 "
          + "\001(\0132:.google.cloud.notebooks.v1.Instance.ShieldedInstanceConfigB\003\340A\001\022\024\n"
          ...
          + "\006labels\030\025 \003(\0132/.google.cloud.notebooks.v1.Instance.LabelsEntry\022C\n"
          + "\010metadata\030\026 \003(\01321.google"
          + ".cloud.notebooks.v1.Instance.MetadataEntry\022\021\n"
          + "\004tags\030  \003(\tB\003\340A\001\022P\n"
          + "\017upgrade_history\030\035"
          + " \003(\01327.google.cloud.notebooks.v1.Instance.UpgradeHistoryEntry\022B\n"
          + "\010nic_type\030! \001("
          + "\0162+.google.cloud.notebooks.v1.Instance.NicTypeB\003\340A\001\022Q\n"
          + "\024reservation_affinity\030\" \001("
          + "\0132..google.cloud.notebooks.v1.ReservationAffinityB\003\340A\001\022\024\n"
          + "\007creator\030$ \001(\tB\003\340A\003\022\033\n"
          + "\016can_ip_forward\030\' \001(\010B\003\340A\001\0224\n"
          + "\013create_time\030\027 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0224\n"
          + "\013update_time\030\030 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\032j\n"
          + "\021AcceleratorConfig\022A\n"
          + "\004type\030\001"
          + " \001(\01623.google.cloud.notebooks.v1.Instance.AcceleratorType\022\022\n\n"
          ...
          + "ogle.cloud.notebooks.v1.Instance.Disk.GuestOsFeature\022\r\n"
          ...
          + "\033enable_integrity_monitoring\030\003 \001(\010\032\374\003\n"
          ...
          + "(\0162=.google.cloud.notebooks.v1.Instance.UpgradeHistoryEntry.State\022/\n"
          ...
          + "oogle.cloud.notebooks.v1.Instance.UpgradeHistoryEntry.Action\022\026\n"
          ...
          + "!notebooks.googleapis.com/Instance\022\'projects/{project}/instances/{instance}B\r\n"
          + "\013environmentB\304\001\n"
          + "\035com.google.cloud.notebooks.v1B\r"
          + "InstanceProtoP\001Z;cloud.google.com/go/notebooks/apiv1/notebookspb;notebook"
          + "spb\252\002\031Google.Cloud.Notebooks.V1\312\002\031Google"
          + "\\Cloud\\Notebooks\\V1\352\002\034Google::Cloud::Notebooks::V1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_notebooks_v1_Instance_AcceleratorConfig_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_descriptor.getNestedType(0);
    internal_static_google_cloud_notebooks_v1_Instance_AcceleratorConfig_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_AcceleratorConfig_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_notebooks_v1_Instance_Disk_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_descriptor.getNestedType(1);
    internal_static_google_cloud_notebooks_v1_Instance_Disk_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_Disk_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_notebooks_v1_Instance_Disk_GuestOsFeature_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_Disk_descriptor.getNestedType(0);
    internal_static_google_cloud_notebooks_v1_Instance_Disk_GuestOsFeature_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_Disk_GuestOsFeature_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_notebooks_v1_Instance_ShieldedInstanceConfig_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_descriptor.getNestedType(2);
    internal_static_google_cloud_notebooks_v1_Instance_ShieldedInstanceConfig_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_ShieldedInstanceConfig_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_notebooks_v1_Instance_UpgradeHistoryEntry_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_descriptor.getNestedType(3);
    internal_static_google_cloud_notebooks_v1_Instance_UpgradeHistoryEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_UpgradeHistoryEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_notebooks_v1_Instance_LabelsEntry_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_descriptor.getNestedType(4);
    internal_static_google_cloud_notebooks_v1_Instance_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_notebooks_v1_Instance_MetadataEntry_descriptor =
        internal_static_google_cloud_notebooks_v1_Instance_descriptor.getNestedType(5);
    internal_static_google_cloud_notebooks_v1_Instance_MetadataEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_notebooks_v1_Instance_MetadataEntry_descriptor,
            new java.lang.String[] {
