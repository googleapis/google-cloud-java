...
public final class CreateInstanceRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26:
            {
              com.google.cloud.notebooks.v1.Instance.Builder subBuilder = null;
              if (instance_ != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.notebooks.v1.CreateInstanceRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.notebooks.v1.CreateInstanceRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeInstance(com.google.cloud.notebooks.v1.Instance value) {
      if (instanceBuilder_ == null) {
        if (instance_ != null) {
          instance_ =
              com.google.cloud.notebooks.v1.Instance.newBuilder(instance_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          instance_ = value;
