...
```Groovy
implementation 'com.google.cloud:google-cloud-notebooks:1.3.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-notebooks" % "1.3.0"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-notebooks/latest/history
...
[contributing]: https://github.com/googleapis/java-notebooks/blob/main/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-notebooks/blob/main/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-notebooks/blob/main/LICENSE
