  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "rotobuf/timestamp.proto\032\026google/type/expr.proto\"\373\007\n\r"
          ...
          + " iam.googleapis.com/PolicyBinding\022Qorganizations/{organization"
          + "}/locations/{location}/policyBindings/{policy_binding}\022Efolders/{folder}/locatio"
          + "ns/{location}/policyBindings/{policy_binding}\022Gprojects/{project}/locations/{loc"
          + "ation}/policyBindings/{policy_binding}*\016policyBindings2\r"
          + "policyBindingB\211\001\n"
          + "\021com.google.iam.v3B\033PolicyBindingResourcesProto"
          + "P\001Z)cloud.google.com/go/iam/apiv3/iampb;"
          + "iampb\252\002\023Google.Cloud.Iam.V3\312\002\023Google\\Cloud\\Iam\\V3b\006proto3"
    };
    descriptor =
