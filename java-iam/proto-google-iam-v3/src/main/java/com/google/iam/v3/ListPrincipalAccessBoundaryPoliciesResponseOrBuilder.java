...
public interface ListPrincipalAccessBoundaryPoliciesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.iam.v3.ListPrincipalAccessBoundaryPoliciesResponse)
   ...
   *
   * <code>
   * repeated .google.iam.v3.PrincipalAccessBoundaryPolicy principal_access_boundary_policies = 1;
   * </code>
   */
  java.util.List<com.google.iam.v3.PrincipalAccessBoundaryPolicy>
   ...
   * </code>
   */
  com.google.iam.v3.PrincipalAccessBoundaryPolicy getPrincipalAccessBoundaryPolicies(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.iam.v3.PrincipalAccessBoundaryPolicyOrBuilder>
