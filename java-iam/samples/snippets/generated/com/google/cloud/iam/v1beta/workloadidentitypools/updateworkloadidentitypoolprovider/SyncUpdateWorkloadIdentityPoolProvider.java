...
public class SyncUpdateWorkloadIdentityPoolProvider {

  public static void main(String[] args) throws Exception {
    syncUpdateWorkloadIdentityPoolProvider();
  }

  public static void syncUpdateWorkloadIdentityPoolProvider() throws Exception {
