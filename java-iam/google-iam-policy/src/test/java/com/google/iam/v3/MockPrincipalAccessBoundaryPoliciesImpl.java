...
import com.google.iam.v3.PrincipalAccessBoundaryPoliciesGrpc.PrincipalAccessBoundaryPoliciesImplBase;
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreatePrincipalAccessBoundaryPolicy, expected %s or %s",
  ...
  public void getPrincipalAccessBoundaryPolicy(
    ...
    if (response instanceof PrincipalAccessBoundaryPolicy) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetPrincipalAccessBoundaryPolicy, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void updatePrincipalAccessBoundaryPolicy(
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UpdatePrincipalAccessBoundaryPolicy, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void deletePrincipalAccessBoundaryPolicy(
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeletePrincipalAccessBoundaryPolicy, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void listPrincipalAccessBoundaryPolicies(
    ...
    if (response instanceof ListPrincipalAccessBoundaryPoliciesResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListPrincipalAccessBoundaryPolicies, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void searchPrincipalAccessBoundaryPolicyBindings(
    ...
    if (response instanceof SearchPrincipalAccessBoundaryPolicyBindingsResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method SearchPrincipalAccessBoundaryPolicyBindings, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
