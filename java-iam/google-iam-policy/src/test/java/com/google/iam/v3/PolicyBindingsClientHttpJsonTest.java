...
public class PolicyBindingsClientHttpJsonTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonPolicyBindingsStub.getMethodDescriptors(),
            PolicyBindingsSettings.getDefaultEndpoint());
    PolicyBindingsSettings settings =
        PolicyBindingsSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                PolicyBindingsSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void getPolicyBindingExceptionTest2() throws Exception {
    ...
    try {
      String name =
          "projects/project-4400/locations/location-4400/policyBindings/policyBinding-4400";
      client.getPolicyBinding(name);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
