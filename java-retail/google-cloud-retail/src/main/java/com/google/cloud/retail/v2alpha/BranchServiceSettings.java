...
/**
 * Settings class to configure an instance of {@link BranchServiceClient}.
 *
...
public class BranchServiceSettings extends ClientSettings<BranchServiceSettings> {
  ...
  public static final BranchServiceSettings create(BranchServiceStubSettings stub)
      throws IOException {
    return new BranchServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected BranchServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for BranchServiceSettings. */
  public static class Builder extends ClientSettings.Builder<BranchServiceSettings, Builder> {
    ...
    protected Builder(BranchServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(BranchServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public BranchServiceSettings build() throws IOException {
