...
public class ConversationalSearchServiceStubSettings
  ...
  public ServerStreamingCallSettings<ConversationalSearchRequest, ConversationalSearchResponse>
      conversationalSearchSettings() {
    return conversationalSearchSettings;
  }
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      conversationalSearchSettings = ServerStreamingCallSettings.newBuilder();
    ...
    protected Builder(ConversationalSearchServiceStubSettings settings) {
      ...
      conversationalSearchSettings = settings.conversationalSearchSettings.toBuilder();
