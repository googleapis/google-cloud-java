 ...
 * <p>  If the [Control][google.cloud.retail.v2.Control] to create already exists, an ALREADY_EXISTS error is returned.</td>
 *      <td>
 ...
 * <p>  If the [Control][google.cloud.retail.v2.Control] to delete does not exist, a NOT_FOUND error is returned.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 * <p>  [Control][google.cloud.retail.v2.Control] cannot be set to a different oneof field, if so an INVALID_ARGUMENT is returned. If the [Control][google.cloud.retail.v2.Control] to update does not exist, a NOT_FOUND error is returned.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Lists all Controls by their parent [Catalog][google.cloud.retail.v2.Catalog].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class ControlServiceClient implements BackgroundResource {
  ...
  public final Control createControl(
      @Nullable CatalogName parent, Control control, String controlId) {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListControlsPagedResponse listControls(@Nullable CatalogName parent) {
