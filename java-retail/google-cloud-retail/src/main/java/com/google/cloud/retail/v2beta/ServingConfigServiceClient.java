 ...
 * <p>  A maximum of 100 [ServingConfig][google.cloud.retail.v2beta.ServingConfig]s are allowed in a [Catalog][google.cloud.retail.v2beta.Catalog], otherwise a FAILED_PRECONDITION error is returned.</td>
 *      <td>
...
public class ServingConfigServiceClient implements BackgroundResource {
   ...
   *
   * <p>A maximum of 100 [ServingConfig][google.cloud.retail.v2beta.ServingConfig]s are allowed in a
   * [Catalog][google.cloud.retail.v2beta.Catalog], otherwise a FAILED_PRECONDITION error is
   * returned.
   *
   * <p>Sample code:
   *
   ...
   *     [ServingConfig][google.cloud.retail.v2beta.ServingConfig] to update. The following are NOT
   *     supported:
   *     <ul>
   *       <li>[ServingConfig.name][google.cloud.retail.v2beta.ServingConfig.name]
   *     </ul>
