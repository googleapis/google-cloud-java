...
public class GenerativeQuestionServiceClient implements BackgroundResource {
   ...
   * @param updateMask Optional. Indicates which fields in the provided
   *     [GenerativeQuestionConfig][google.cloud.retail.v2.GenerativeQuestionConfig] to update. The
   *     following are NOT supported:
   *     <ul>
   *       <li>[GenerativeQuestionConfig.frequency][google.cloud.retail.v2.GenerativeQuestionConfig.frequency]
   *     </ul>
