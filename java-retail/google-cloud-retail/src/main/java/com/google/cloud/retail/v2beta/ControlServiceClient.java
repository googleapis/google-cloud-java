...
public class ControlServiceClient implements BackgroundResource {
   ...
   * Creates a Control.
   *
   * <p>If the [Control][google.cloud.retail.v2beta.Control] to create already exists, an
   ...
   * Deletes a Control.
   *
   * <p>If the [Control][google.cloud.retail.v2beta.Control] to delete does not exist, a NOT_FOUND
   * error is returned.
   *
   * <p>Sample code:
   *
   ...
   *     <ul>
   *       <li>[Control.name][google.cloud.retail.v2beta.Control.name]
   *     </ul>
