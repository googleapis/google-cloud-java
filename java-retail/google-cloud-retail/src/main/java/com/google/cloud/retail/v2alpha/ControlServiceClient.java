...
import com.google.cloud.retail.v2alpha.stub.ControlServiceStub;
 ...
 * <p>  If the [Control][google.cloud.retail.v2alpha.Control] to create already exists, an ALREADY_EXISTS error is returned.</td>
 *      <td>
 ...
 * <p>  If the [Control][google.cloud.retail.v2alpha.Control] to delete does not exist, a NOT_FOUND error is returned.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 * <p>  [Control][google.cloud.retail.v2alpha.Control] cannot be set to a different oneof field, if so an INVALID_ARGUMENT is returned. If the [Control][google.cloud.retail.v2alpha.Control] to update does not exist, a NOT_FOUND error is returned.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Lists all Controls by their parent [Catalog][google.cloud.retail.v2alpha.Catalog].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class ControlServiceClient implements BackgroundResource {
   ...
   * Creates a Control.
   *
   * <p>If the [Control][google.cloud.retail.v2alpha.Control] to create already exists, an
   ...
   * Deletes a Control.
   *
   * <p>If the [Control][google.cloud.retail.v2alpha.Control] to delete does not exist, a NOT_FOUND
   * error is returned.
   *
   * <p>Sample code:
   *
   ...
   * Updates a Control.
   *
   * <p>[Control][google.cloud.retail.v2alpha.Control] cannot be set to a different oneof field, if
   ...
   *     <ul>
   *       <li>[Control.name][google.cloud.retail.v2alpha.Control.name]
   *     </ul>
