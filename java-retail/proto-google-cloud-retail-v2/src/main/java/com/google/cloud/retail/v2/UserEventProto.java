  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "eld_behavior.proto\032#google/cloud/retail/v2/common.proto\032$google/cloud/retail/v2/"
          + "product.proto\032\037google/protobuf/timestamp"
          + ".proto\032\036google/protobuf/wrappers.proto\"\227\006\n"
          + "\tUserEvent\022\027\n\n"
          ...
          + "\017product_details\030\006 \003(\0132%.google.cloud.retail.v2.ProductDetail\022C\n"
          + "\021completion_detail\030\026"
          + " \001(\0132(.google.cloud.retail.v2.CompletionDetail\022E\n\n"
          + "attributes\030\007"
          + " \003(\01321.google.cloud.retail.v2.UserEvent.AttributesEntry\022\017\n"
          + "\007cart_id\030\010 \001(\t\022I\n"
          + "\024purchase_transaction\030\t"
          + " \001(\0132+.google.cloud.retail.v2.PurchaseTransaction\022\024\n"
          + "\014search_query\030\n"
          + " \001(\t\022\016\n"
          ...
          + "\005value\030\002 \001(\0132\'.google.cloud.retail.v2.CustomAttribute:\0028\001\"u\n\r"
          + "ProductDetail\0225\n"
          ...
          + "currency_code\030\005 \001(\tB\003\340A\002B\271\001\n"
          + "\032com.google.cloud.retail.v2B\016UserEventProtoP\001Z2cloud.google"
          + ".com/go/retail/apiv2/retailpb;retailpb\242\002"
          + "\006RETAIL\252\002\026Google.Cloud.Retail.V2\312\002\026Googl"
          + "e\\Cloud\\Retail\\V2\352\002\031Google::Cloud::Retail::V2b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_retail_v2_UserEvent_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_cloud_retail_v2_UserEvent_fieldAccessorTable =
    ...
    internal_static_google_cloud_retail_v2_UserEvent_AttributesEntry_descriptor =
        internal_static_google_cloud_retail_v2_UserEvent_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2_UserEvent_AttributesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2_UserEvent_AttributesEntry_descriptor,
            new java.lang.String[] {
