  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "&google/cloud/retail/v2/promotion.proto\032\036google/protobuf/duration.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protob"
          + "uf/timestamp.proto\032\036google/protobuf/wrappers.proto\"\333\r\n"
          + "\007Product\0221\n"
          ...
          + "\004type\030\003"
          + " \001(\0162$.google.cloud.retail.v2.Product.TypeB\003\340A\005\022\032\n"
          ...
          + "\013description\030\n"
          + " \001(\t\022\025\n\r"
          + "language_code\030\013 \001(\t\022C\n\n"
          + "attributes\030\014"
          + " \003(\0132/.google.cloud.retail.v2.Product.AttributesEntry\022\014\n"
          + "\004tags\030\r"
          + " \003(\t\0225\n\n"
          + "price_info\030\016 \001(\0132!.google.cloud.retail.v2.PriceInfo\022.\n"
          ...
          + " \001(\0162,.google.cloud.retail.v2.Product.Availability\0227\n"
          + "\022available_quantity\030\024 \001(\0132\033.google.protobuf.Int32Value\022A\n"
          + "\020fulfillment_info\030\025"
          + " \003(\0132\'.google.cloud.retail.v2.FulfillmentInfo\022\013\n"
          + "\003uri\030\026 \001(\t\022-\n"
          + "\006images\030\027 \003(\0132\035.google.cloud.retail.v2.Image\0222\n"
          + "\010audience\030\030 \001(\0132 .google.cloud.retail.v2.Audience\0225\n\n"
          + "color_info\030\031 \001(\0132!.google.cloud.retail.v2.ColorInfo\022\r\n"
          + "\005sizes\030\032 \003(\t\022\021\n"
          + "\tmaterials\030\033 \003(\t\022\020\n"
          + "\010patterns\030\034 \003(\t\022\022\n\n"
          + "conditions\030\035 \003(\t\0225\n\n"
          + "promotions\030\" \003(\0132!.google.cloud.retail.v2.Promotion\0220\n"
          + "\014publish_time\030! \001(\0132\032.google.protobuf.Timestamp\022:\n"
          + "\022retrievable_fields\030\036"
          + " \001(\0132\032.google.protobuf.FieldMaskB\002\030\001\0226\n"
          + "\010variants\030\037"
          + " \003(\0132\037.google.cloud.retail.v2.ProductB\003\340A\003\022F\n"
          + "\021local_inventories\030#"
          + " \003(\0132&.google.cloud.retail.v2.LocalInventoryB\003\340A\003\032Z\n"
          ...
          + "\035retail.googleapis.com/Product\022_projects/{project}/lo"
          + "cations/{location}/catalogs/{catalog}/branches/{branch}/products/{product}B\014\n\n"
          + "expirationB\246\002\n"
          + "\032com.google.cloud.retail.v2B\014ProductProtoP\001Z2cloud.google.com/go/ret"
          + "ail/apiv2/retailpb;retailpb\242\002\006RETAIL\252\002\026G"
          + "oogle.Cloud.Retail.V2\312\002\026Google\\Cloud\\Retail\\V2\352\002\031Google::Cloud::Retail::V2\352Al\n"
          + "\034retail.googleapis.com/Branch\022Lprojects/{p"
          + "roject}/locations/{location}/catalogs/{catalog}/branches/{branch}b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_retail_v2_Product_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_cloud_retail_v2_Product_fieldAccessorTable =
    ...
    internal_static_google_cloud_retail_v2_Product_AttributesEntry_descriptor =
        internal_static_google_cloud_retail_v2_Product_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2_Product_AttributesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2_Product_AttributesEntry_descriptor,
            new java.lang.String[] {
