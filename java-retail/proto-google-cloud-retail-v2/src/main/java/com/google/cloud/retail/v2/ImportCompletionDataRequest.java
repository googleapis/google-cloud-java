          ...
          case 18:
            {
              ...
              inputConfig_ =
                  input.readMessage(
                      com.google.cloud.retail.v2.CompletionDataInputConfig.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.retail.v2.ImportCompletionDataRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeInputConfig(com.google.cloud.retail.v2.CompletionDataInputConfig value) {
      if (inputConfigBuilder_ == null) {
        if (inputConfig_ != null) {
          inputConfig_ =
              com.google.cloud.retail.v2.CompletionDataInputConfig.newBuilder(inputConfig_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          inputConfig_ = value;
