...
public final class PurchaseTransaction extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private PurchaseTransaction(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.cloud.retail.v2.PurchaseTransaction other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getRevenue()) != 0) {
        setRevenue(other.getRevenue());
      }
      if (java.lang.Float.floatToRawIntBits(other.getTax()) != 0) {
        setTax(other.getTax());
      }
