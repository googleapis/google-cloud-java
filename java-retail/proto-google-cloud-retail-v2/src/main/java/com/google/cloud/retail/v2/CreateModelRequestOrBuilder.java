...
public interface CreateModelRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2.CreateModelRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2.Model model = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
