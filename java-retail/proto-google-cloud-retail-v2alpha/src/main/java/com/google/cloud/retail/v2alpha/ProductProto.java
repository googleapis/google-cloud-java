  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "pha/promotion.proto\032\036google/protobuf/duration.proto\032"
          + " google/protobuf/field_mask."
          + "proto\032\037google/protobuf/timestamp.proto\032\036google/protobuf/wrappers.proto\"\234\016\n"
          + "\007Product\0221\n"
          ...
          + "\013description\030\n"
          + " \001(\t\022\025\n\r"
          + "language_code\030\013 \001(\t\022H\n\n"
          + "attributes\030\014 \003(\01324.google"
          + ".cloud.retail.v2alpha.Product.AttributesEntry\022\014\n"
          + "\004tags\030\r"
          + " \003(\t\022:\n\n"
          + "price_info\030\016 \001(\0132&.google.cloud.retail.v2alpha.PriceInfo\0223\n"
          + "\006rating\030\017 \001(\0132#.google.cloud.retail.v2alpha.Rating\0222\n"
          + "\016available_time\030\022 \001(\0132\032.google.protobuf.Timestamp\022G\n"
          + "\014availability\030\023"
          + " \001(\01621.google.cloud.retail.v2alpha.Product.Availability\0227\n"
          + "\022available_quantity\030\024 \001(\0132\033.google.protobuf.Int32Value\022F\n"
          + "\020fulfillment_info\030\025"
          + " \003(\0132,.google.cloud.retail.v2alpha.FulfillmentInfo\022\013\n"
          + "\003uri\030\026 \001(\t\0222\n"
          + "\006images\030\027 \003(\0132\".google.cloud.retail.v2alpha.Image\0227\n"
          + "\010audience\030\030 \001(\0132%.google.cloud.retail.v2alpha.Audience\022:\n\n"
          + "color_info\030\031 \001(\0132&.google.cloud.retail.v2alpha.ColorInfo\022\r\n"
          ...
          + "\010variants\030\037"
          + " \003(\0132$.google.cloud.retail.v2alpha.ProductB\003\340A\003\022K\n"
          + "\021local_inventories\030#"
          + " \003(\0132+.google.cloud.retail.v2alpha.LocalInventoryB\003\340A\003\032_\n"
          + "\017AttributesEntry\022\013\n"
          + "\003key\030\001 \001(\t\022;\n"
          + "\005value\030\002 \001(\0132,.go"
          + "ogle.cloud.retail.v2alpha.CustomAttribute:\0028\001\"F\n"
          + "\004Type\022\024\n"
          ...
          + "\035retail.googleapis.com/Product\022_projects/{projec"
          + "t}/locations/{location}/catalogs/{catalo"
          + "g}/branches/{branch}/products/{product}B\014\n\n"
          + "expirationB\320\001\n"
          + "\037com.google.cloud.retail.v2alphaB\014ProductProtoP\001Z7cloud.google."
    ...
    internal_static_google_cloud_retail_v2alpha_Product_AttributesEntry_descriptor =
        internal_static_google_cloud_retail_v2alpha_Product_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2alpha_Product_AttributesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_Product_AttributesEntry_descriptor,
            new java.lang.String[] {
