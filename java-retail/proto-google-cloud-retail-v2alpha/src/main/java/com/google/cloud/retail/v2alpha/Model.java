...
public final class Model extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class PageOptimizationConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private PageOptimizationConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
     ...
     */
    public static final class Panel extends com.google.protobuf.GeneratedMessage
        implements
      ...
      public static final class Builder
        ...
        private void maybeForceBuilderInitialization() {
          if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
            ...
            internalGetDefaultCandidateFieldBuilder();
          }
        }
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 26:
                  {
                    input.readMessage(
                        internalGetDefaultCandidateFieldBuilder().getBuilder(), extensionRegistry);
        ...
        public com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.Candidate.Builder
          ...
          bitField0_ |= 0x00000004;
          onChanged();
          return internalGetDefaultCandidateFieldBuilder().getBuilder();
        }
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(pageOptimizationEventType_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, pageOptimizationEventType_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(pageOptimizationEventType_)) {
        size +=
            com.google.protobuf.GeneratedMessage.computeStringSize(1, pageOptimizationEventType_);
      }
      for (int i = 0; i < panels_.size(); i++) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.Panel.Builder
        ...
        return internalGetPanelsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.Panel.Builder
          addPanelsBuilder() {
        return internalGetPanelsFieldBuilder()
            .addBuilder(
                com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.Panel
                    .getDefaultInstance());
      }
      ...
      public java.util.List<
        ...
        return internalGetPanelsFieldBuilder().getBuilderList();
      }
   ...
   */
  public static final class ServingConfigList extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ServingConfigList(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      for (int i = 0; i < servingConfigIds_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, servingConfigIds_.getRaw(i));
      }
      getUnknownFields().writeTo(output);
    }
   ...
   */
  public static final class ModelFeaturesConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ModelFeaturesConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetFrequentlyBoughtTogetherConfigFieldBuilder().getBuilder(),
                      extensionRegistry);
      ...
      public com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig.Builder
        ...
        return internalGetFrequentlyBoughtTogetherConfigFieldBuilder().getBuilder();
      }
      ...
      private com.google.protobuf.SingleFieldBuilder<
              ...
              com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig.Builder,
              com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfigOrBuilder>
          internalGetFrequentlyBoughtTogetherConfigFieldBuilder() {
        if (frequentlyBoughtTogetherConfigBuilder_ == null) {
          if (!(typeDedicatedConfigCase_ == 1)) {
            typeDedicatedConfig_ =
                com.google.cloud.retail.v2alpha.Model.FrequentlyBoughtTogetherFeaturesConfig
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(optimizationObjective_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, optimizationObjective_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tuningOperation_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 15, tuningOperation_);
    }
    if (dataState_
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(optimizationObjective_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, optimizationObjective_);
    }
    if (periodicTuningState_
        != com.google.cloud.retail.v2alpha.Model.PeriodicTuningState
            .PERIODIC_TUNING_STATE_UNSPECIFIED
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tuningOperation_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(15, tuningOperation_);
    }
    if (dataState_
        != com.google.cloud.retail.v2alpha.Model.DataState.DATA_STATE_UNSPECIFIED.getNumber()) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetLastTuneTimeFieldBuilder();
        internalGetServingConfigListsFieldBuilder();
        internalGetModelFeaturesConfigFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98:
              {
                input.readMessage(
                    internalGetLastTuneTimeFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 138:
              {
                input.readMessage(
                    internalGetPageOptimizationConfigFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 178:
              {
                input.readMessage(
                    internalGetModelFeaturesConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.Builder
      ...
      return internalGetPageOptimizationConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.Builder,
            com.google.cloud.retail.v2alpha.Model.PageOptimizationConfigOrBuilder>
        internalGetPageOptimizationConfigFieldBuilder() {
      if (pageOptimizationConfigBuilder_ == null) {
        if (!(trainingConfigCase_ == 17)) {
          trainingConfig_ =
              com.google.cloud.retail.v2alpha.Model.PageOptimizationConfig.getDefaultInstance();
    ...
    public com.google.protobuf.Timestamp.Builder getLastTuneTimeBuilder() {
      bitField0_ |= 0x00000400;
      onChanged();
      return internalGetLastTuneTimeFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.retail.v2alpha.Model.ServingConfigList.Builder
      ...
      return internalGetServingConfigListsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.retail.v2alpha.Model.ServingConfigList.Builder
      ...
      return internalGetServingConfigListsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.retail.v2alpha.Model.ServingConfigList.Builder>
      ...
      return internalGetServingConfigListsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.retail.v2alpha.Model.ModelFeaturesConfig.Builder
      ...
      bitField0_ |= 0x00008000;
      onChanged();
      return internalGetModelFeaturesConfigFieldBuilder().getBuilder();
    }
