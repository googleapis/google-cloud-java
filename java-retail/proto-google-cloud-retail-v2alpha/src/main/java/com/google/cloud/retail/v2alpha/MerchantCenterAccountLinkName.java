...
public class MerchantCenterAccountLinkName implements ResourceName {
  ...
  public static @Nullable MerchantCenterAccountLinkName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable MerchantCenterAccountLinkName> values) {
