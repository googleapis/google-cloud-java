  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "common.proto\032\037google/protobuf/timestamp.proto\"\201\025\n"
          + "\005Model\022b\n"
          + "\030page_optimization_config\030\021"
          + " \001(\01329.google.cloud.retail.v2alpha.Model.PageOptimizationConfigB\003\340A\001H\000\022\021\n"
          ...
          + ".retail.v2alpha.Model.TrainingStateB\003\340A\001\022K\n\r"
          + "serving_state\030\004"
          + " \001(\0162/.google.cloud.retail.v2alpha.Model.ServingStateB\003\340A\003\0224\n"
          ...
          + "e.cloud.retail.v2alpha.Model.PeriodicTuningStateB\003\340A\001\0227\n"
          + "\016last_tune_time\030\014"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022\035\n"
          + "\020tuning_operation\030\017 \001(\tB\003\340A\003\022E\n\n"
          + "data_state\030\020 \001("
          + "\0162,.google.cloud.retail.v2alpha.Model.DataStateB\003\340A\003\022Z\n"
          + "\020filtering_option\030\022 \001(\0162;"
          + ".google.cloud.retail.v2alpha.RecommendationsFilteringOptionB\003\340A\001\022W\n"
          + "\024serving_config_lists\030\023"
          + " \003(\01324.google.cloud.retail.v2alpha.Model.ServingConfigListB\003\340A\003\022Z\n"
          + "\025model_features_config\030\026 \001(\01326.google.cloud."
          + "retail.v2alpha.Model.ModelFeaturesConfigB\003\340A\001\032\302\005\n"
          + "\026PageOptimizationConfig\022)\n"
          + "\034page_optimization_event_type\030\001 \001(\tB\003\340A\002\022T\n"
          + "\006panels\030\002 \003(\0132?.google.cloud.retail.v2alph"
          + "a.Model.PageOptimizationConfig.PanelB\003\340A\002\022_\n"
          + "\013restriction\030\003 \001(\0162E.google.cloud.re"
          + "tail.v2alpha.Model.PageOptimizationConfig.RestrictionB\003\340A\001\0325\n"
          + "\tCandidate\022\033\n"
          + "\021serving_config_id\030\001 \001(\tH\000B\013\n"
          + "\tcandidate\032\345\001\n"
          + "\005Panel\022\031\n"
          + "\014display_name\030\001 \001(\tB\003\340A\001\022\\\n\n"
          + "candidates\030\002 \003(\0132C.google.cloud.retail.v2alpha"
          + ".Model.PageOptimizationConfig.CandidateB\003\340A\002\022c\n"
          + "\021default_candidate\030\003 \001(\0132C.google"
          + ".cloud.retail.v2alpha.Model.PageOptimizationConfig.CandidateB\003\340A\002\"\246\001\n"
          ...
          + "&FrequentlyBoughtTogetherFeaturesConfig\022Z\n"
          + "\025context_products_type\030\002 \001"
          + "(\01626.google.cloud.retail.v2alpha.Model.ContextProductsTypeB\003\340A\001\032\246\001\n"
          + "\023ModelFeaturesConfig\022v\n"
          + "!frequently_bought_together_config\030\001 \001(\0132I.google.cloud.retail.v2alpha"
          + ".Model.FrequentlyBoughtTogetherFeaturesConfigH\000B\027\n"
          ...
          + "\033retail.googleapis.com/Model\022Iprojects/{project}/locations/{locat"
          + "ion}/catalogs/{catalog}/models/{model}B\021\n"
          + "\017training_configB\316\001\n"
          + "\037com.google.cloud.retail.v2alphaB\n"
          + "ModelProtoP\001Z7cloud.google.com/go/retail/apiv2alpha/retailpb;reta"
    ...
    internal_static_google_cloud_retail_v2alpha_Model_PageOptimizationConfig_descriptor =
        internal_static_google_cloud_retail_v2alpha_Model_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2alpha_Model_PageOptimizationConfig_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_Model_PageOptimizationConfig_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_retail_v2alpha_Model_ServingConfigList_descriptor =
        internal_static_google_cloud_retail_v2alpha_Model_descriptor.getNestedType(1);
    internal_static_google_cloud_retail_v2alpha_Model_ServingConfigList_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_Model_ServingConfigList_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_retail_v2alpha_Model_FrequentlyBoughtTogetherFeaturesConfig_descriptor =
        internal_static_google_cloud_retail_v2alpha_Model_descriptor.getNestedType(2);
    internal_static_google_cloud_retail_v2alpha_Model_FrequentlyBoughtTogetherFeaturesConfig_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_Model_FrequentlyBoughtTogetherFeaturesConfig_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_retail_v2alpha_Model_ModelFeaturesConfig_descriptor =
        internal_static_google_cloud_retail_v2alpha_Model_descriptor.getNestedType(3);
    internal_static_google_cloud_retail_v2alpha_Model_ModelFeaturesConfig_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_Model_ModelFeaturesConfig_descriptor,
            new java.lang.String[] {
