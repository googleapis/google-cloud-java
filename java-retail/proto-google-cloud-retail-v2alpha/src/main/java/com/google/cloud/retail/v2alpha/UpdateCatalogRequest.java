...
public final class UpdateCatalogRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10:
            {
              com.google.cloud.retail.v2alpha.Catalog.Builder subBuilder = null;
              if (catalog_ != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.retail.v2alpha.UpdateCatalogRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.retail.v2alpha.UpdateCatalogRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeCatalog(com.google.cloud.retail.v2alpha.Catalog value) {
      if (catalogBuilder_ == null) {
        if (catalog_ != null) {
          catalog_ =
              com.google.cloud.retail.v2alpha.Catalog.newBuilder(catalog_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          catalog_ = value;
