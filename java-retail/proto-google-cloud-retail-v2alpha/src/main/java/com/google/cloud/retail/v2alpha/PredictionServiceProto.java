...
public final class PredictionServiceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "4google/cloud/retail/v2alpha/prediction_service.proto\022\033google.cloud.retail.v2al"
          ...
          + "google/cloud/retail/v2alpha/user_event.proto\032\034google/protobuf/struct.proto\"\303\003\n"
          + "\016PredictRequest\022\026\n"
          + "\tplacement\030\001 \001(\tB\003\340A\002\022?\n"
          + "\n"
          + "user_event\030\002"
          + " \001(\0132&.google.cloud.retail.v2alpha.UserEventB\003\340A\002\022\021\n"
          + "\tpage_size\030\003 \001(\005\022\026\n\n"
          + "page_token\030\004 \001(\tB\002\030\001\022\016\n"
          + "\006filter\030\005 \001(\t\022\025\n\r"
          + "validate_only\030\006 \001(\010\022G\n"
          + "\006params\030\007 \003(\013"
          + "27.google.cloud.retail.v2alpha.PredictRequest.ParamsEntry\022G\n"
          + "\006labels\030\010 \003(\01327.goog"
          + "le.cloud.retail.v2alpha.PredictRequest.LabelsEntry\032E\n"
          ...
          + "\007results\030\001"
          + " \003(\0132=.google.cloud.retail.v2alpha.PredictResponse.PredictionResult\022\031\n"
          ...
          + "cloud.retail.v2alpha.PredictResponse.PredictionResult.MetadataEntry\032G\n\r"
          ...
          + "\007Predict\022+.google.cloud.retail.v2alpha.PredictRequest\032,.google.cloud.retai"
          + "l.v2alpha.PredictResponse\"\255\001\202\323\344\223\002\246\001\"K/v2"
          + "alpha/{placement=projects/*/locations/*/catalogs/*/placements/*}:predict:\001*ZT\"O/"
          + "v2alpha/{placement=projects/*/locations/*/catalogs/*/servingConfigs/*}:predict:\001"
          + "*\032I\312A\025retail.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\332\001\n"
          ...
          + "gle\\Cloud\\Retail\\V2alpha\352\002\036Google::Cloud::Retail::V2alphab\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_retail_v2alpha_PredictRequest_ParamsEntry_descriptor =
        internal_static_google_cloud_retail_v2alpha_PredictRequest_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2alpha_PredictRequest_ParamsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_PredictRequest_ParamsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_retail_v2alpha_PredictRequest_LabelsEntry_descriptor =
        internal_static_google_cloud_retail_v2alpha_PredictRequest_descriptor.getNestedType(1);
    internal_static_google_cloud_retail_v2alpha_PredictRequest_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_PredictRequest_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_retail_v2alpha_PredictResponse_PredictionResult_descriptor =
        internal_static_google_cloud_retail_v2alpha_PredictResponse_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2alpha_PredictResponse_PredictionResult_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_PredictResponse_PredictionResult_descriptor,
            new java.lang.String[] {
