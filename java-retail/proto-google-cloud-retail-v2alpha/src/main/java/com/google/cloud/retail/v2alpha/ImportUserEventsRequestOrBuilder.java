...
public interface ImportUserEventsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2alpha.ImportUserEventsRequest)
   ...
   */
  com.google.cloud.retail.v2alpha.UserEventInputConfig getInputConfig();
  /**
   *
   *
   * <pre>
