  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "/v2alpha/common.proto\0320google/cloud/retail/v2alpha/search_service.proto\"\252\010\n\r"
          ...
          + "\021facet_control_ids\030\005 \003(\t\022W\n"
          + "\022dynamic_facet_spec\030\006 \001(\0132"
          + ";.google.cloud.retail.v2alpha.SearchRequest.DynamicFacetSpec\022\031\n"
          ...
          + " \001(\01628.google.cloud.retail.v2alpha.ServingConfig.DiversityType\022$\n"
          + "\034enable_category_filter_level\030\020 \001(\t\022\034\n"
          + "\024ignore_recs_denylist\030\030 \001(\010\022\\\n"
          + "\024personalization_spec\030\025 "
          + "\001(\0132>.google.cloud.retail.v2alpha.SearchRequest.PersonalizationSpec\022I\n"
          + "\016solution_types\030\023"
          + " \003(\0162).google.cloud.retail.v2alpha.SolutionTypeB\006\340A\002\340A\005\"d\n\r"
          ...
          + "location}/catalogs/{catalog}/servingConfigs/{serving_config}B\326\001\n"
          + "\037com.google.cloud.retail.v2alphaB\022ServingConfigProtoP\001Z7"
          ...
          + "lpha\352\002\036Google::Cloud::Retail::V2alphab\006proto3"
    };
    descriptor =
