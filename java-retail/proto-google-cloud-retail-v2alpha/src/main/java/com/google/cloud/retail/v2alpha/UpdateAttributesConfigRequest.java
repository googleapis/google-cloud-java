...
public final class UpdateAttributesConfigRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10:
            {
              com.google.cloud.retail.v2alpha.AttributesConfig.Builder subBuilder = null;
              if (attributesConfig_ != null) {
                subBuilder = attributesConfig_.toBuilder();
              }
              attributesConfig_ =
                  input.readMessage(
                      com.google.cloud.retail.v2alpha.AttributesConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.retail.v2alpha.UpdateAttributesConfigRequest parsedMessage = null;
      try {
    ...
    public Builder mergeAttributesConfig(com.google.cloud.retail.v2alpha.AttributesConfig value) {
      if (attributesConfigBuilder_ == null) {
        if (attributesConfig_ != null) {
          attributesConfig_ =
              com.google.cloud.retail.v2alpha.AttributesConfig.newBuilder(attributesConfig_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          attributesConfig_ = value;
