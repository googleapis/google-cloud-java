  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "gle/api/field_behavior.proto\032(google/cloud/retail/v2alpha/common.proto\032)google/c"
          + "loud/retail/v2alpha/product.proto\032\037googl"
          + "e/protobuf/timestamp.proto\032\036google/protobuf/wrappers.proto\"\265\006\n"
          + "\tUserEvent\022\027\n\n"
          ...
          + " \003(\0132*.google.cloud.retail.v2alpha.ProductDetail\022H\n"
          + "\021completion_detail\030\026"
          + " \001(\0132-.google.cloud.retail.v2alpha.CompletionDetail\022J\n\n"
          + "attributes\030\007"
          + " \003(\01326.google.cloud.retail.v2alpha.UserEvent.AttributesEntry\022\017\n"
          + "\007cart_id\030\010 \001(\t\022N\n"
          + "\024purchase_transaction\030\t"
          + " \001(\01320.google.cloud.retail.v2alpha.PurchaseTransaction\022\024\n"
          + "\014search_query\030\n"
          + " \001(\t\022\016\n"
          + "\006filter\030\020 \001(\t\022\020\n"
          + "\010order_by\030\021 \001(\t\022\016\n"
          + "\006offset\030\022 \001(\005\022\027\n"
          + "\017page_categories\030\013 \003(\t\0228\n"
          + "\tuser_info\030\014 \001(\0132%.google.cloud.retail.v2alpha.UserInfo\022\013\n"
          + "\003uri\030\r"
          + " \001(\t\022\024\n"
          ...
          + "e.cloud.retail.v2alpha.CustomAttribute:\0028\001\"z\n\r"
          + "ProductDetail\022:\n"
          ...
          + "currency_code\030\005 \001(\tB\003\340A\002B\322\001\n"
          + "\037com.google.cloud.retail.v2alphaB\016UserEventP"
    ...
    internal_static_google_cloud_retail_v2alpha_UserEvent_AttributesEntry_descriptor =
        internal_static_google_cloud_retail_v2alpha_UserEvent_descriptor.getNestedType(0);
    internal_static_google_cloud_retail_v2alpha_UserEvent_AttributesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_retail_v2alpha_UserEvent_AttributesEntry_descriptor,
            new java.lang.String[] {
