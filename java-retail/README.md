...
```Groovy
implementation 'com.google.cloud:google-cloud-retail:2.100.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-retail" % "2.100.0"
```
...
Cloud Retail uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-retail/2.100.0
