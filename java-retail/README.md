...
```Groovy
implementation 'com.google.cloud:google-cloud-retail:2.0.4'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-retail" % "2.0.4"
```
...
[javadocs]: https://googleapis.dev/java/google-cloud-retail/latest/index.html
...
[contributing]: https://github.com/googleapis/java-retail/blob/master/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-retail/blob/master/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-retail/blob/master/LICENSE
