...
public interface AlertConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.AlertConfig)
   ...
   * <code>repeated .google.cloud.retail.v2beta.AlertConfig.AlertPolicy alert_policies = 2;</code>
   */
  com.google.cloud.retail.v2beta.AlertConfig.AlertPolicyOrBuilder getAlertPoliciesOrBuilder(
      int index);
}
