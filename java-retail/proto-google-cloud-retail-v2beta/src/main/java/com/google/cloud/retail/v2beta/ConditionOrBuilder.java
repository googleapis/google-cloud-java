...
public interface ConditionOrBuilder
   ...
   */
  java.util.List<com.google.cloud.retail.v2beta.Condition.QueryTerm> getQueryTermsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.retail.v2beta.Condition.QueryTerm query_terms = 1;</code>
   */
  com.google.cloud.retail.v2beta.Condition.QueryTermOrBuilder getQueryTermsOrBuilder(int index);
   ...
   */
  java.util.List<com.google.cloud.retail.v2beta.Condition.TimeRange> getActiveTimeRangeList();
  /**
   *
   *
   * <pre>
