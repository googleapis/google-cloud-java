...
public interface ImportCompletionDataRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.ImportCompletionDataRequest)
   ...
   *
   * <code>
   * .google.cloud.retail.v2beta.CompletionDataInputConfig input_config = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
