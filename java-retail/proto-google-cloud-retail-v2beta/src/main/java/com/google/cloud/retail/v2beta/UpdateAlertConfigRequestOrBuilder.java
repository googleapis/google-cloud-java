...
public interface UpdateAlertConfigRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.UpdateAlertConfigRequest)
   ...
   *
   * <code>
   * .google.cloud.retail.v2beta.AlertConfig alert_config = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.retail.v2beta.AlertConfig getAlertConfig();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.retail.v2beta.AlertConfigOrBuilder getAlertConfigOrBuilder();
