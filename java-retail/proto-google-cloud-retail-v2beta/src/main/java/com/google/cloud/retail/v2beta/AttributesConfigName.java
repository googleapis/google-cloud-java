...
public class AttributesConfigName implements ResourceName {
  ...
  public static @Nullable AttributesConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AttributesConfigName> values) {
