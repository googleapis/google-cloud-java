...
public final class CreateControlRequest extends com.google.protobuf.GeneratedMessageV3
          ...
          case 18:
            {
              ...
              control_ =
                  input.readMessage(
                      com.google.cloud.retail.v2beta.Control.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.retail.v2beta.CreateControlRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.retail.v2beta.CreateControlRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeControl(com.google.cloud.retail.v2beta.Control value) {
      if (controlBuilder_ == null) {
        if (control_ != null) {
          control_ =
              com.google.cloud.retail.v2beta.Control.newBuilder(control_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          control_ = value;
