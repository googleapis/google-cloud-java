  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "2beta/common.proto\032/google/cloud/retail/v2beta/search_service.proto\"\246\010\n\r"
          ...
          + "\021facet_control_ids\030\005 \003(\t\022V\n"
          + "\022dynamic_facet_spec\030\006 \001(\0132:.go"
          + "ogle.cloud.retail.v2beta.SearchRequest.DynamicFacetSpec\022\031\n"
          ...
          + "\017diversity_level\030\010 \001(\t\022O\n"
          + "\016diversity_type\030\024 \001"
          + "(\01627.google.cloud.retail.v2beta.ServingConfig.DiversityType\022$\n"
          + "\034enable_category_filter_level\030\020 \001(\t\022\034\n"
          + "\024ignore_recs_denylist\030\030 \001(\010\022[\n"
          + "\024personalization_spec\030\025 \001(\0132=."
          + "google.cloud.retail.v2beta.SearchRequest.PersonalizationSpec\022H\n"
          + "\016solution_types\030\023"
          + " \003(\0162(.google.cloud.retail.v2beta.SolutionTypeB\006\340A\002\340A\005\"d\n\r"
          ...
          + "#retail.googleapis.com/ServingConfig\022Zprojects/{project}/locations/{location"
          + "}/catalogs/{catalog}/servingConfigs/{serving_config}B\321\001\n"
          + "\036com.google.cloud.retail.v2betaB\022ServingConfigProtoP\001Z6cloud.goo"
