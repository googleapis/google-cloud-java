...
public interface ExportAnalyticsMetricsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.ExportAnalyticsMetricsResponse)
