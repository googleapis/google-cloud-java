...
public interface BatchUpdateGenerativeQuestionConfigsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.BatchUpdateGenerativeQuestionConfigsRequest)
   ...
   *
   * <code>
   * repeated .google.cloud.retail.v2beta.UpdateGenerativeQuestionConfigRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   */
