...
public final class AwsSourceDetails extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AwsSourceDetails(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class AccessKeyCredentials extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private AccessKeyCredentials(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class Tag extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(awsRegion_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, awsRegion_);
    }
    if (state_
    ...
    com.google.protobuf.GeneratedMessage.serializeStringMapTo(
        ...
        MigrationResourcesUserTagsDefaultEntryHolder.defaultEntry,
        8);
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(publicIp_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, publicIp_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(awsRegion_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, awsRegion_);
    }
    if (state_
        != com.google.cloud.vmmigration.v1.AwsSourceDetails.State.STATE_UNSPECIFIED.getNumber()) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(publicIp_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(9, publicIp_);
    }
    for (int i = 0; i < inventoryTagList_.size(); i++) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetInventoryTagListFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90:
              {
                input.readMessage(
                    internalGetAccessKeyCredsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.vmmigration.v1.AwsSourceDetails.AccessKeyCredentials.Builder
      ...
      return internalGetAccessKeyCredsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.vmmigration.v1.AwsSourceDetails.AccessKeyCredentials.Builder,
            com.google.cloud.vmmigration.v1.AwsSourceDetails.AccessKeyCredentialsOrBuilder>
        internalGetAccessKeyCredsFieldBuilder() {
      if (accessKeyCredsBuilder_ == null) {
        if (!(credentialsTypeCase_ == 11)) {
          credentialsType_ =
              com.google.cloud.vmmigration.v1.AwsSourceDetails.AccessKeyCredentials
    ...
    public com.google.cloud.vmmigration.v1.AwsSourceDetails.Tag.Builder getInventoryTagListBuilder(
        int index) {
      return internalGetInventoryTagListFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.vmmigration.v1.AwsSourceDetails.Tag.Builder
      ...
      return internalGetInventoryTagListFieldBuilder()
    ...
    public java.util.List<com.google.cloud.vmmigration.v1.AwsSourceDetails.Tag.Builder>
      ...
      return internalGetInventoryTagListFieldBuilder().getBuilderList();
    }
