...
public class UtilizationReportName implements ResourceName {
  ...
  public static @Nullable UtilizationReportName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable UtilizationReportName> values) {
