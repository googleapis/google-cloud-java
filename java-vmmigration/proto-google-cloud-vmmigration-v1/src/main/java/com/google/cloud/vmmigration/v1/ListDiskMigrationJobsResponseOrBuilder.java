...
public interface ListDiskMigrationJobsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmmigration.v1.ListDiskMigrationJobsResponse)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vmmigration.v1.DiskMigrationJob> getDiskMigrationJobsList();
   ...
   * </code>
   */
  com.google.cloud.vmmigration.v1.DiskMigrationJob getDiskMigrationJobs(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.vmmigration.v1.DiskMigrationJobOrBuilder>
