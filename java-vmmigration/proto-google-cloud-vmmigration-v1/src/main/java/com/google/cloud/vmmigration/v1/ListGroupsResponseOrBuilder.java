...
public interface ListGroupsResponseOrBuilder
   ...
   *
   * <code>
   * repeated .google.cloud.vmmigration.v1.Group groups = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   */
   ...
   * </code>
   */
  com.google.cloud.vmmigration.v1.GroupOrBuilder getGroupsOrBuilder(int index);
