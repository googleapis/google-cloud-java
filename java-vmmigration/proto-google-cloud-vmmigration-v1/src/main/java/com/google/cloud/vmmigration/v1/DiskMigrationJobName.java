...
public class DiskMigrationJobName implements ResourceName {
  ...
  public static @Nullable DiskMigrationJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DiskMigrationJobName> values) {
