...
public final class MigratingVm extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private MigratingVm(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class Expiration extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Expiration(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceVmId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, sourceVmId_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(group_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 15, group_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceVmId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, sourceVmId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(description_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(group_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(15, group_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetLastSyncFieldBuilder();
        internalGetStateTimeFieldBuilder();
        internalGetCurrentSyncInfoFieldBuilder();
        internalGetLastReplicationCycleFieldBuilder();
        internalGetRecentCloneJobsFieldBuilder();
        internalGetErrorFieldBuilder();
        internalGetRecentCutoverJobsFieldBuilder();
        internalGetCutoverForecastFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90:
              {
                input.readMessage(
                    internalGetLastSyncFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 106:
              {
                input.readMessage(
                    internalGetCurrentSyncInfoFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 210:
              {
                input.readMessage(
                    internalGetComputeEngineTargetDefaultsFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 226:
              {
                input.readMessage(
                    internalGetVmwareSourceVmDetailsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 234:
              {
                input.readMessage(
                    internalGetAwsSourceVmDetailsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 242:
              {
                input.readMessage(
                    internalGetAzureSourceVmDetailsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 258:
              {
                input.readMessage(
                    internalGetLastReplicationCycleFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 266:
              {
                input.readMessage(
                    internalGetCutoverForecastFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 274:
              {
                input.readMessage(
                    internalGetComputeEngineDisksTargetDefaultsFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 298:
              {
                input.readMessage(
                    internalGetExpirationFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.vmmigration.v1.ComputeEngineTargetDefaults.Builder
      ...
      return internalGetComputeEngineTargetDefaultsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.vmmigration.v1.ComputeEngineTargetDefaults.Builder,
            com.google.cloud.vmmigration.v1.ComputeEngineTargetDefaultsOrBuilder>
        internalGetComputeEngineTargetDefaultsFieldBuilder() {
      if (computeEngineTargetDefaultsBuilder_ == null) {
        if (!(targetVmDefaultsCase_ == 26)) {
          targetVmDefaults_ =
    ...
    public com.google.cloud.vmmigration.v1.ComputeEngineDisksTargetDefaults.Builder
      ...
      return internalGetComputeEngineDisksTargetDefaultsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.vmmigration.v1.ComputeEngineDisksTargetDefaults.Builder,
            com.google.cloud.vmmigration.v1.ComputeEngineDisksTargetDefaultsOrBuilder>
        internalGetComputeEngineDisksTargetDefaultsFieldBuilder() {
      if (computeEngineDisksTargetDefaultsBuilder_ == null) {
        if (!(targetVmDefaultsCase_ == 34)) {
          targetVmDefaults_ =
    ...
    public com.google.cloud.vmmigration.v1.VmwareSourceVmDetails.Builder
      ...
      return internalGetVmwareSourceVmDetailsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.vmmigration.v1.VmwareSourceVmDetails.Builder,
            com.google.cloud.vmmigration.v1.VmwareSourceVmDetailsOrBuilder>
        internalGetVmwareSourceVmDetailsFieldBuilder() {
      if (vmwareSourceVmDetailsBuilder_ == null) {
        if (!(sourceVmDetailsCase_ == 28)) {
          sourceVmDetails_ =
              com.google.cloud.vmmigration.v1.VmwareSourceVmDetails.getDefaultInstance();
    ...
    public com.google.cloud.vmmigration.v1.AwsSourceVmDetails.Builder
      ...
      return internalGetAwsSourceVmDetailsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.vmmigration.v1.AwsSourceVmDetails.Builder,
            com.google.cloud.vmmigration.v1.AwsSourceVmDetailsOrBuilder>
        internalGetAwsSourceVmDetailsFieldBuilder() {
      if (awsSourceVmDetailsBuilder_ == null) {
        if (!(sourceVmDetailsCase_ == 29)) {
          sourceVmDetails_ =
              com.google.cloud.vmmigration.v1.AwsSourceVmDetails.getDefaultInstance();
    ...
    public com.google.cloud.vmmigration.v1.AzureSourceVmDetails.Builder
      ...
      return internalGetAzureSourceVmDetailsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.vmmigration.v1.AzureSourceVmDetails.Builder,
            com.google.cloud.vmmigration.v1.AzureSourceVmDetailsOrBuilder>
        internalGetAzureSourceVmDetailsFieldBuilder() {
      if (azureSourceVmDetailsBuilder_ == null) {
        if (!(sourceVmDetailsCase_ == 30)) {
          sourceVmDetails_ =
              com.google.cloud.vmmigration.v1.AzureSourceVmDetails.getDefaultInstance();
    ...
    public com.google.cloud.vmmigration.v1.ReplicationSync.Builder getLastSyncBuilder() {
      bitField0_ |= 0x00001000;
      onChanged();
      return internalGetLastSyncFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.vmmigration.v1.ReplicationCycle.Builder getCurrentSyncInfoBuilder() {
      bitField0_ |= 0x00008000;
      onChanged();
      return internalGetCurrentSyncInfoFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.vmmigration.v1.ReplicationCycle.Builder
      ...
      bitField0_ |= 0x00010000;
      onChanged();
      return internalGetLastReplicationCycleFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.vmmigration.v1.CloneJob.Builder getRecentCloneJobsBuilder(int index) {
      return internalGetRecentCloneJobsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.vmmigration.v1.CloneJob.Builder addRecentCloneJobsBuilder() {
      return internalGetRecentCloneJobsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.vmmigration.v1.CloneJob.Builder>
      ...
      return internalGetRecentCloneJobsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.vmmigration.v1.CutoverJob.Builder getRecentCutoverJobsBuilder(
        int index) {
      return internalGetRecentCutoverJobsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.vmmigration.v1.CutoverJob.Builder addRecentCutoverJobsBuilder() {
      return internalGetRecentCutoverJobsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.vmmigration.v1.CutoverJob.Builder>
      ...
      return internalGetRecentCutoverJobsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.vmmigration.v1.CutoverForecast.Builder getCutoverForecastBuilder() {
      bitField0_ |= 0x00400000;
      onChanged();
      return internalGetCutoverForecastFieldBuilder().getBuilder();
    }
