...
public class TargetProjectName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_TARGET_PROJECT =
  ...
  private TargetProjectName(Builder builder) {
    ...
    targetProject = Preconditions.checkNotNull(builder.getTargetProject());
  }
  ...
  public static @Nullable TargetProjectName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_TARGET_PROJECT.validatedMatch(
            formattedString, "TargetProjectName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("target_project"));
  }

  public static List<TargetProjectName> parseList(List<String> formattedStrings) {
    List<TargetProjectName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable TargetProjectName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (targetProject != null) {
            fieldMapBuilder.put("target_project", targetProject);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_TARGET_PROJECT.instantiate(
        "project", project, "location", location, "target_project", targetProject);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.targetProject, that.targetProject);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(targetProject);
    return h;
  }
