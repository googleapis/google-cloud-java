...
public class ReplicationCycleName implements ResourceName {
  ...
  public static @Nullable ReplicationCycleName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ReplicationCycleName> values) {
