...
public interface AzureSourceVmDetailsOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmmigration.v1.AzureSourceVmDetails)
   ...
   * @return The firmware.
   */
  com.google.cloud.vmmigration.v1.AzureSourceVmDetails.Firmware getFirmware();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vmmigration.v1.AzureSourceVmDetails.AzureDiskDetails>
      getDisksList();
   ...
   * </code>
   */
  com.google.cloud.vmmigration.v1.AzureSourceVmDetails.AzureDiskDetails getDisks(int index);
   ...
   * </code>
   */
  com.google.cloud.vmmigration.v1.AzureSourceVmDetails.AzureDiskDetailsOrBuilder getDisksOrBuilder(
      int index);
