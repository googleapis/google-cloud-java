...
public class MockCssProductInputsServiceImpl extends CssProductInputsServiceImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockCssProductInputsServiceImpl() {
  ...
  public void insertCssProductInput(
      InsertCssProductInputRequest request, StreamObserver<CssProductInput> responseObserver) {
