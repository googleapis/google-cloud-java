 ...
 *      <td><p> Lists the daily call quota and usage per group for your CSS Center account.</td>
 *      <td>
...
public class QuotaServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param parent Required. The CSS account that owns the collection of method quotas and
