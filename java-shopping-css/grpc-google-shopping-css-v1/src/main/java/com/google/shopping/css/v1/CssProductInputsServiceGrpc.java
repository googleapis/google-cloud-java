...
public final class CssProductInputsServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.shopping.css.v1.CssProductInput>
        getInsertCssProductInputMethod;
    if ((getInsertCssProductInputMethod =
            CssProductInputsServiceGrpc.getInsertCssProductInputMethod)
        == null) {
          ...
          CssProductInputsServiceGrpc.getInsertCssProductInputMethod =
              getInsertCssProductInputMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "InsertCssProductInput"))
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            com.google.shopping.css.v1.DeleteCssProductInputRequest, com.google.protobuf.Empty>
        getDeleteCssProductInputMethod;
    if ((getDeleteCssProductInputMethod =
            CssProductInputsServiceGrpc.getDeleteCssProductInputMethod)
        == null) {
      synchronized (CssProductInputsServiceGrpc.class) {
        if ((getDeleteCssProductInputMethod =
                CssProductInputsServiceGrpc.getDeleteCssProductInputMethod)
          ...
          CssProductInputsServiceGrpc.getDeleteCssProductInputMethod =
              getDeleteCssProductInputMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "DeleteCssProductInput"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.css.v1.DeleteCssProductInputRequest
  ...
  public static CssProductInputsServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceStub>() {
          @java.lang.Override
          public CssProductInputsServiceStub newStub(
  ...
  public static CssProductInputsServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceBlockingV2Stub>() {
          @java.lang.Override
          public CssProductInputsServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CssProductInputsServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return CssProductInputsServiceBlockingV2Stub.newStub(factory, channel);
  }

  /**
   * Creates a new blocking-style stub that supports unary and streaming output calls on the service
   */
  public static CssProductInputsServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceBlockingStub>() {
          @java.lang.Override
          public CssProductInputsServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static CssProductInputsServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CssProductInputsServiceFutureStub>() {
          @java.lang.Override
          public CssProductInputsServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void insertCssProductInput(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getInsertCssProductInputMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void deleteCssProductInput(
        com.google.shopping.css.v1.DeleteCssProductInputRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getDeleteCssProductInputMethod(), responseObserver);
    }
  }
  ...
  public static final class CssProductInputsServiceStub
    ...
    private CssProductInputsServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
     ...
     * </pre>
     */
    public void insertCssProductInput(
        com.google.shopping.css.v1.InsertCssProductInputRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.css.v1.CssProductInput> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getInsertCssProductInputMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void deleteCssProductInput(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteCssProductInputMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class CssProductInputsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<CssProductInputsServiceBlockingV2Stub> {
    private CssProductInputsServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CssProductInputsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CssProductInputsServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service CssProductInputsService.
   *
   * <pre>
   * Service to use CssProductInput resource.
   * This service helps to insert/update/delete CSS Products.
  ...
  public static final class CssProductInputsServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.shopping.css.v1.CssProductInput>
        insertCssProductInput(com.google.shopping.css.v1.InsertCssProductInputRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        deleteCssProductInput(com.google.shopping.css.v1.DeleteCssProductInputRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.shopping.css.v1.DeleteCssProductInputRequest,
                    com.google.protobuf.Empty>(service, METHODID_DELETE_CSS_PRODUCT_INPUT)))
        .build();
  }

  private abstract static class CssProductInputsServiceBaseDescriptorSupplier
