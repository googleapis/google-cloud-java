...
public final class DocumentAiProcessor extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "source.proto\0320google/cloud/documentai/v1/document_schema.proto\032+google/cloud/doc"
          + "umentai/v1/evaluation.proto\032\037google/protobuf/timestamp.proto\"\251\017\n"
          ...
          + " \001(\0132*.google.cloud.documentai.v1.DocumentSchemaB\003\340A\003\022F\n"
          + "\005state\030\006"
          + " \001(\01622.google.cloud.documentai.v1.ProcessorVersion.StateB\003\340A\003\0224\n"
          + "\013create_time\030\007 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022O\n"
          + "\021latest_evaluation\030\010 \001(\0132/.google.c"
          + "loud.documentai.v1.EvaluationReferenceB\003\340A\003\022\031\n"
          ...
          + " \001(\013"
          + "2<.google.cloud.documentai.v1.ProcessorVersion.DeprecationInfoB\003\340A\003\022O\n\n"
          + "model_type\030\017"
          + " \001(\01626.google.cloud.documentai.v1.ProcessorVersion.ModelTypeB\003\340A\003\022\032\n\r"
          + "satisfies_pzs\030\020 \001(\010B\003\340A\003\022\032\n\r"
          + "satisfies_pzi\030\021 \001(\010B\003\340A\003\022[\n"
          + "\021gen_ai_model_info\030\022 \001(\0132;.google"
          + ".cloud.documentai.v1.ProcessorVersion.GenAiModelInfoB\003\340A\003\032\237\001\n"
          ...
          + "*documentai.googleapis.com/ProcessorVersion\032\210\005\n"
          + "\016GenAiModelInfo\022|\n"
          + "\034foundation_gen_ai_model_info\030\001 \001(\0132T.g"
          + "oogle.cloud.documentai.v1.ProcessorVersi"
          + "on.GenAiModelInfo.FoundationGenAiModelInfoH\000\022t\n"
          + "\030custom_gen_ai_model_info\030\002 \001(\0132P"
          + ".google.cloud.documentai.v1.ProcessorVer"
          + "sion.GenAiModelInfo.CustomGenAiModelInfoH\000\032[\n"
          + "\030FoundationGenAiModelInfo\022\032\n"
          + "\022finetuning_allowed\030\001 \001(\010\022#\n"
          + "\033min_train_labeled_documents\030\002 \001(\005\032\226\002\n"
          + "\024CustomGenAiModelInfo\022{\n"
          + "\021custom_model_type\030\001 \001(\0162`.google.clo"
          + "ud.documentai.v1.ProcessorVersion.GenAiM"
          + "odelInfo.CustomGenAiModelInfo.CustomModelType\022!\n"
          ...
          + "*documentai.googleapis.com/ProcessorVersion\022dprojects/{project}/locations/{locati"
          + "on}/processors/{processor}/processorVersions/{processor_version}\"r\n"
          + "\025ProcessorVersionAlias\022\r\n"
          + "\005alias\030\001 \001(\t\022J\n"
          + "\021processor_version\030\002 \001(\tB/\372A,\n"
          + "*documentai.googleapis.com/ProcessorVersion\"\305\005\n"
          + "\tProcessor\022\024\n"
          + "\004name\030\001 \001(\tB\006\340A\005\340A\003\022\014\n"
          + "\004type\030\002 \001(\t\022\024\n"
          + "\014display_name\030\003 \001(\t\022?\n"
          + "\005state\030\004"
          + " \001(\0162+.google.cloud.documentai.v1.Processor.StateB\003\340A\003\022R\n"
          + "\031default_processor_version\030\t \001(\tB/\372A,\n"
          + "*documentai.googleapis.com/ProcessorVersion\022Y\n"
          + "\031processor_version_aliases\030\n"
          + " \003(\01321.google.cloud.documentai.v1.ProcessorVersionAliasB\003\340A\003\022 \n"
          ...
          + "project}/locations/{location}/processors/{processor}B\321\001\n"
          + "\036com.google.cloud.documentai.v1B\023DocumentAiProcessorP\001Z>cloud.go"
    ...
    internal_static_google_cloud_documentai_v1_ProcessorVersion_DeprecationInfo_descriptor =
        internal_static_google_cloud_documentai_v1_ProcessorVersion_descriptor.getNestedType(0);
    internal_static_google_cloud_documentai_v1_ProcessorVersion_DeprecationInfo_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_documentai_v1_ProcessorVersion_DeprecationInfo_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_documentai_v1_ProcessorVersion_GenAiModelInfo_descriptor =
        internal_static_google_cloud_documentai_v1_ProcessorVersion_descriptor.getNestedType(1);
    internal_static_google_cloud_documentai_v1_ProcessorVersion_GenAiModelInfo_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_documentai_v1_ProcessorVersion_GenAiModelInfo_descriptor,
            new java.lang.String[] {
