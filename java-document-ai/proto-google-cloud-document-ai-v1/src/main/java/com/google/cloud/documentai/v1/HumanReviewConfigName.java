...
public class HumanReviewConfigName implements ResourceName {
  ...
  public static @Nullable HumanReviewConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable HumanReviewConfigName> values) {
