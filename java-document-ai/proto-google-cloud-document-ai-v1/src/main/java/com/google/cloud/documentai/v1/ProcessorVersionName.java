...
public class ProcessorVersionName implements ResourceName {
  ...
  public static @Nullable ProcessorVersionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProcessorVersionName> values) {
