...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-document-ai" % "2.26.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-document-ai/2.26.0
