          ...
          case 10:
            {
              ...
              source_ =
                  input.readMessage(
                      com.google.cloud.documentai.v1beta3.GcsPrefix.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 18:
            {
              ...
              if (sourceCase_ == 2) {
                subBuilder =
                    ((com.google.cloud.documentai.v1beta3.GcsDocuments) source_).toBuilder();
              }
              source_ =
                  input.readMessage(
                      com.google.cloud.documentai.v1beta3.GcsDocuments.parser(), extensionRegistry);
              if (subBuilder != null) {
