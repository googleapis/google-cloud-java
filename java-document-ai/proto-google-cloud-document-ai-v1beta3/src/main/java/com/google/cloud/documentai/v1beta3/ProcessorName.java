...
public class ProcessorName implements ResourceName {
  ...
  public static @Nullable ProcessorName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_PROCESSOR.validatedMatch(
            formattedString, "ProcessorName.parse: formattedString not in valid format");
  ...
  public static List<ProcessorName> parseList(List<String> formattedStrings) {
    List<ProcessorName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ProcessorName> values) {
