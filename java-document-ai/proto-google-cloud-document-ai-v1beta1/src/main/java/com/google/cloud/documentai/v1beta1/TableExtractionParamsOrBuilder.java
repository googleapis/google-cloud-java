...
public interface TableExtractionParamsOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.documentai.v1beta1.TableExtractionParams)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.documentai.v1beta1.TableBoundHint> getTableBoundHintsList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.documentai.v1beta1.TableBoundHint getTableBoundHints(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.documentai.v1beta1.TableBoundHintOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.documentai.v1beta1.TableBoundHintOrBuilder getTableBoundHintsOrBuilder(
      int index);
