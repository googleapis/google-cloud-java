  ...
  private TranslateOptions(Builder builder) {
    ...
    if (builder.getCredentials() != null) {
      ...
      if (builder.apiKey != null) {
        ...
        logger.log(
            Level.WARNING,
                "Ignoring API key set in environment variable {}: using explicit setting for credentials instead.",
                API_KEY_ENV_NAME);
      }
      ...
      if (getDefaultApiKey() != null) {
        logger.log(
            Level.WARNING,
                "Ignoring API key set in environment variable {}: using Application Default Credentials instead.",
                API_KEY_ENV_NAME);
      }
    } else {
