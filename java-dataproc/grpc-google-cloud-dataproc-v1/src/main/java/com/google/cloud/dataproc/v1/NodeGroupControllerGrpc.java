...
public final class NodeGroupControllerGrpc {
  ...
  public static final class NodeGroupControllerStub
    ...
    private NodeGroupControllerStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void createNodeGroup(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateNodeGroupMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void resizeNodeGroup(
        ...
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getResizeNodeGroupMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getNodeGroup(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.dataproc.v1.NodeGroup> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetNodeGroupMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class NodeGroupControllerFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        createNodeGroup(com.google.cloud.dataproc.v1.CreateNodeGroupRequest request) {
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        resizeNodeGroup(com.google.cloud.dataproc.v1.ResizeNodeGroupRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.dataproc.v1.NodeGroup>
        getNodeGroup(com.google.cloud.dataproc.v1.GetNodeGroupRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_NODE_GROUP:
          serviceImpl.createNodeGroup(
              (com.google.cloud.dataproc.v1.CreateNodeGroupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_RESIZE_NODE_GROUP:
          serviceImpl.resizeNodeGroup(
              (com.google.cloud.dataproc.v1.ResizeNodeGroupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_GET_NODE_GROUP:
          serviceImpl.getNodeGroup(
              (com.google.cloud.dataproc.v1.GetNodeGroupRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.dataproc.v1.NodeGroup>)
                  responseObserver);
          break;
        default:
