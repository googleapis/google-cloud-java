...
public final class BatchControllerGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloud.dataproc.v1.CreateBatchRequest, com.google.longrunning.Operation>
          ...
          BatchControllerGrpc.getCreateBatchMethod =
              getCreateBatchMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new BatchControllerMethodDescriptorSupplier("CreateBatch"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloud.dataproc.v1.GetBatchRequest, com.google.cloud.dataproc.v1.Batch>
      getGetBatchMethod;
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.dataproc.v1.ListBatchesResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new BatchControllerMethodDescriptorSupplier("ListBatches"))
                      .build();
        }
      }
    }
          ...
          BatchControllerGrpc.getDeleteBatchMethod =
              getDeleteBatchMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new BatchControllerMethodDescriptorSupplier("DeleteBatch"))
                      .build();
        }
      }
    }
  ...
  public static BatchControllerStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<BatchControllerStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<BatchControllerStub>() {
          @java.lang.Override
          public BatchControllerStub newStub(
   ...
   */
  public static BatchControllerBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<BatchControllerBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<BatchControllerBlockingStub>() {
          @java.lang.Override
          public BatchControllerBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static BatchControllerFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<BatchControllerFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<BatchControllerFutureStub>() {
          @java.lang.Override
          public BatchControllerFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public abstract static class BatchControllerImplBase implements io.grpc.BindableService {
    ...
    public void createBatch(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getCreateBatchMethod(), responseObserver);
    }
    ...
    public void listBatches(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.dataproc.v1.ListBatchesResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getListBatchesMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class BatchControllerStub
      extends io.grpc.stub.AbstractAsyncStub<BatchControllerStub> {
    private BatchControllerStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected BatchControllerStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new BatchControllerStub(channel, callOptions);
    }
    ...
    public void createBatch(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateBatchMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void listBatches(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.dataproc.v1.ListBatchesResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListBatchesMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void deleteBatch(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteBatchMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class BatchControllerBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<BatchControllerBlockingStub> {
  ...
  public static final class BatchControllerFutureStub
      extends io.grpc.stub.AbstractFutureStub<BatchControllerFutureStub> {
    private BatchControllerFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        createBatch(com.google.cloud.dataproc.v1.CreateBatchRequest request) {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.dataproc.v1.Batch>
        getBatch(com.google.cloud.dataproc.v1.GetBatchRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.dataproc.v1.ListBatchesResponse>
        listBatches(com.google.cloud.dataproc.v1.ListBatchesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        deleteBatch(com.google.cloud.dataproc.v1.DeleteBatchRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_BATCH:
          serviceImpl.createBatch(
              (com.google.cloud.dataproc.v1.CreateBatchRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        case METHODID_GET_BATCH:
          serviceImpl.getBatch(
              (com.google.cloud.dataproc.v1.GetBatchRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.dataproc.v1.Batch>) responseObserver);
          break;
        case METHODID_LIST_BATCHES:
          serviceImpl.listBatches(
              (com.google.cloud.dataproc.v1.ListBatchesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.dataproc.v1.ListBatchesResponse>)
                  responseObserver);
          break;
        case METHODID_DELETE_BATCH:
          serviceImpl.deleteBatch(
              (com.google.cloud.dataproc.v1.DeleteBatchRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
