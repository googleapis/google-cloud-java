...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dataproc" % "4.31.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dataproc/4.30.0
