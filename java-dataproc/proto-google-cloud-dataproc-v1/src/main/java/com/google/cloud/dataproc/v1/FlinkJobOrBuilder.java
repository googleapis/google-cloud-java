...
public interface FlinkJobOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataproc.v1.FlinkJob)
   ...
   * </pre>
   *
   * <code>string savepoint_uri = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   ...
   * <code>string savepoint_uri = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   * @return The bytes for savepointUri.
   */
  com.google.protobuf.ByteString getSavepointUriBytes();
  ...
  com.google.cloud.dataproc.v1.FlinkJob.DriverCase getDriverCase();
}
