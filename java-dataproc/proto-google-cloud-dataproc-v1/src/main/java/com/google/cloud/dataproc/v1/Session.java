...
public final class Session extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class SessionStateHistory extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private SessionStateHistory(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(stateMessage_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, stateMessage_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      output.writeMessage(9, getStateTime());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(creator_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, creator_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(user_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 14, user_);
    }
    for (int i = 0; i < stateHistory_.size(); i++) {
      output.writeMessage(15, stateHistory_.get(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sessionTemplate_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 16, sessionTemplate_);
    }
    if (sessionConfigCase_ == 17) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(stateMessage_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, stateMessage_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, getStateTime());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(creator_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(10, creator_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(user_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(14, user_);
    }
    for (int i = 0; i < stateHistory_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(15, stateHistory_.get(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sessionTemplate_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(16, sessionTemplate_);
    }
    if (sessionConfigCase_ == 17) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
