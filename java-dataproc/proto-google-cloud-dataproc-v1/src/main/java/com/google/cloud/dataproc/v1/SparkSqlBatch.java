 ...
 */
public final class SparkSqlBatch extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        SparkSqlBatch.class.getName());
  }
  // Use SparkSqlBatch.newBuilder() to construct.
  private SparkSqlBatch(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(queryFileUri_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, queryFileUri_);
    }
    com.google.protobuf.GeneratedMessage.serializeStringMapTo(
        output, internalGetQueryVariables(), QueryVariablesDefaultEntryHolder.defaultEntry, 2);
    for (int i = 0; i < jarFileUris_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, jarFileUris_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(queryFileUri_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, queryFileUri_);
    }
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry :
        internalGetQueryVariables().getMap().entrySet()) {
      com.google.protobuf.MapEntry<java.lang.String, java.lang.String> queryVariables__ =
          QueryVariablesDefaultEntryHolder.defaultEntry
              .newBuilderForType()
              .setKey(entry.getKey())
              .setValue(entry.getValue())
              .build();
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, queryVariables__);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < jarFileUris_.size(); i++) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.dataproc.v1.SparkSqlBatch other =
        (com.google.cloud.dataproc.v1.SparkSqlBatch) obj;

    if (!getQueryFileUri().equals(other.getQueryFileUri())) return false;
    if (!internalGetQueryVariables().equals(other.internalGetQueryVariables())) return false;
  ...
  public static com.google.cloud.dataproc.v1.SparkSqlBatch parseFrom(java.nio.ByteBuffer data)
  ...
  private static final com.google.protobuf.Parser<SparkSqlBatch> PARSER =
      new com.google.protobuf.AbstractParser<SparkSqlBatch>() {
        @java.lang.Override
