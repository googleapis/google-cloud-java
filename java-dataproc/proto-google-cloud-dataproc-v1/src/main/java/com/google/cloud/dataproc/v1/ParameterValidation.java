...
public final class ParameterValidation extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ParameterValidation(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(internalGetValuesFieldBuilder().getBuilder(), extensionRegistry);
