...
public final class BasicYarnAutoscalingConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private BasicYarnAutoscalingConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.cloud.dataproc.v1.BasicYarnAutoscalingConfig other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getScaleUpFactor()) != 0) {
        setScaleUpFactor(other.getScaleUpFactor());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getScaleDownFactor()) != 0) {
        setScaleDownFactor(other.getScaleDownFactor());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getScaleUpMinWorkerFraction()) != 0) {
        setScaleUpMinWorkerFraction(other.getScaleUpMinWorkerFraction());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getScaleDownMinWorkerFraction()) != 0) {
