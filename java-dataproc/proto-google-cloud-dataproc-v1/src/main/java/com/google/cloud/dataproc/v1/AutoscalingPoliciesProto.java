  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3google/cloud/dataproc/v1/autoscaling_p"
          ...
          + "toscalingPolicies/*}:\006policyZF\032</v1/{pol"
          + "icy.name=projects/*/regions/*/autoscalin"
          + "gPolicies/*}:\006policy\332A\006policy\022\373\001\n\024GetAut"
          + "oscalingPolicy\0225.google.cloud.dataproc.v"
          + "1.GetAutoscalingPolicyRequest\032+.google.c"
          + "loud.dataproc.v1.AutoscalingPolicy\"\177\202\323\344\223"
          + "\002r\0227/v1/{name=projects/*/locations/*/aut"
          + "oscalingPolicies/*}Z7\0225/v1/{name=project"
          + "s/*/regions/*/autoscalingPolicies/*}\332A\004n"
          + "ame\022\222\002\n\027ListAutoscalingPolicies\0228.google"
          + ".cloud.dataproc.v1.ListAutoscalingPolici"
          + "esRequest\0329.google.cloud.dataproc.v1.Lis"
          + "tAutoscalingPoliciesResponse\"\201\001\202\323\344\223\002r\0227/"
          + "v1/{parent=projects/*/locations/*}/autos"
          + "calingPoliciesZ7\0225/v1/{parent=projects/*"
          + "/regions/*}/autoscalingPolicies\332A\006parent"
          + "\022\354\001\n\027DeleteAutoscalingPolicy\0228.google.cl"
          + "oud.dataproc.v1.DeleteAutoscalingPolicyR"
          + "equest\032\026.google.protobuf.Empty\"\177\202\323\344\223\002r*7"
          + "/v1/{name=projects/*/locations/*/autosca"
          + "lingPolicies/*}Z7*5/v1/{name=projects/*/"
          + "regions/*/autoscalingPolicies/*}\332A\004name\032"
          + "K\312A\027dataproc.googleapis.com\322A.https://ww"
          + "w.googleapis.com/auth/cloud-platformB\304\001\n"
          + "\034com.google.cloud.dataproc.v1B\030Autoscali"
          + "ngPoliciesProtoP\001Z@google.golang.org/gen"
          + "proto/googleapis/cloud/dataproc/v1;datap"
          + "roc\352AE\n\036dataproc.googleapis.com/Region\022#"
          + "projects/{project}/regions/{region}b\006pro"
          + "to3"
    };
    descriptor =
