...
public final class AutoscalingPoliciesProto {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        AutoscalingPoliciesProto.class.getName());
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3google/cloud/dataproc/v1/autoscaling_p"
          ...
          + "}:\006policyZF\032</v1/{policy.name=projects/*"
          + "/regions/*/autoscalingPolicies/*}:\006polic"
          ...
          + "\0225/v1/{name=projects/*/regions/*/autosca"
          + "lingPolicies/*}\022\222\002\n\027ListAutoscalingPolic"
          ...
          + "v1/{parent=projects/*/regions/*}/autosca"
          + "lingPolicies\022\354\001\n\027DeleteAutoscalingPolicy"
          ...
          + "locations/*/autoscalingPolicies/*}Z7*5/v"
          + "1/{name=projects/*/regions/*/autoscaling"
          + "Policies/*}\032K\312A\027dataproc.googleapis.com\322"
          + "A.https://www.googleapis.com/auth/cloud-"
          + "platformB\277\001\n\034com.google.cloud.dataproc.v"
          + "1B\030AutoscalingPoliciesProtoP\001Z;cloud.goo"
          + "gle.com/go/dataproc/v2/apiv1/dataprocpb;"
          + "dataprocpb\352AE\n\036dataproc.googleapis.com/R"
          + "egion\022#projects/{project}/regions/{regio"
          + "n}b\006proto3"
    };
    descriptor =
