...
public class SessionTemplateName implements ResourceName {
  ...
  public static @Nullable SessionTemplateName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_TEMPLATE.validatedMatch(
            formattedString, "SessionTemplateName.parse: formattedString not in valid format");
  ...
  public static List<SessionTemplateName> parseList(List<String> formattedStrings) {
    List<SessionTemplateName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable SessionTemplateName> values) {
