...
/**
 * Base stub class for the GeocodeService service API.
 *
...
public abstract class GeocodeServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<GeocodeAddressRequest, GeocodeAddressResponse> geocodeAddressCallable() {
    throw new UnsupportedOperationException("Not implemented: geocodeAddressCallable()");
  }

  public UnaryCallable<GeocodeLocationRequest, GeocodeLocationResponse> geocodeLocationCallable() {
    throw new UnsupportedOperationException("Not implemented: geocodeLocationCallable()");
  }

  public UnaryCallable<GeocodePlaceRequest, GeocodeResult> geocodePlaceCallable() {
    throw new UnsupportedOperationException("Not implemented: geocodePlaceCallable()");
  }
