...
import com.google.maps.geocode.v4.stub.HttpJsonDestinationServiceStub;
...
public class DestinationServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static DestinationServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonDestinationServiceStub.getMethodDescriptors(),
            DestinationServiceSettings.getDefaultEndpoint());
    DestinationServiceSettings settings =
        DestinationServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                DestinationServiceSettings.defaultHttpJsonTransportProviderBuilder()
