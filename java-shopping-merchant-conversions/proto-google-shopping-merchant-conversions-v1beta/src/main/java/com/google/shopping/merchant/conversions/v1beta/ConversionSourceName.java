...
public class ConversionSourceName implements ResourceName {
  ...
  public static @Nullable ConversionSourceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ConversionSourceName> values) {
