    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26:
            {
              com.google.cloud.bigquery.dataexchange.v1beta1.DestinationDataset.Builder subBuilder =
                  null;
              ...
              destination_ =
                  input.readMessage(
                      com.google.cloud.bigquery.dataexchange.v1beta1.DestinationDataset.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
