...
/**
 * Settings class to configure an instance of {@link CmEnrollmentServiceStub}.
 *
...
public class CmEnrollmentServiceStubSettings extends StubSettings<CmEnrollmentServiceStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<UpdateCmEnrollmentRequest, CmEnrollment>
      updateCmEnrollmentSettings;
  ...
  public UnaryCallSettings<UpdateCmEnrollmentRequest, CmEnrollment> updateCmEnrollmentSettings() {
    return updateCmEnrollmentSettings;
  }
  ...
  public UnaryCallSettings<
          CalculateEffectiveCmEnrollmentRequest, CalculateEffectiveCmEnrollmentResponse>
      calculateEffectiveCmEnrollmentSettings() {
    return calculateEffectiveCmEnrollmentSettings;
  }
  ...
  public CmEnrollmentServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcCmEnrollmentServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonCmEnrollmentServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CmEnrollmentServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return CmEnrollmentServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected CmEnrollmentServiceStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    updateCmEnrollmentSettings = settingsBuilder.updateCmEnrollmentSettings().build();
    calculateEffectiveCmEnrollmentSettings =
        settingsBuilder.calculateEffectiveCmEnrollmentSettings().build();
    listLocationsSettings = settingsBuilder.listLocationsSettings().build();
    getLocationSettings = settingsBuilder.getLocationSettings().build();
  }

  /** Builder for CmEnrollmentServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<CmEnrollmentServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<UpdateCmEnrollmentRequest, CmEnrollment>
        updateCmEnrollmentSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      calculateEffectiveCmEnrollmentSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(CmEnrollmentServiceStubSettings settings) {
      super(settings);

      updateCmEnrollmentSettings = settings.updateCmEnrollmentSettings.toBuilder();
      calculateEffectiveCmEnrollmentSettings =
    ...
    @Override
    public CmEnrollmentServiceStubSettings build() throws IOException {
      return new CmEnrollmentServiceStubSettings(this);
    }
  }
}
