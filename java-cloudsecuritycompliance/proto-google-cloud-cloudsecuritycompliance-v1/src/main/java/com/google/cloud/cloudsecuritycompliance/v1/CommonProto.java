  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "/locations/{location}/frameworks/{framew"
          + "ork}\022>projects/{project}/locations/{location}/frameworks/{framework}*\n"
          ...
          + "parameters\030\004 \003(\01322.google.clou"
          + "d.cloudsecuritycompliance.v1.ParameterB\003\340A\001\"\234\001\n"
          ...
          + " \001(\01323.google.cloud.cloudsecuritycompliance.v1.ParamValueB\003\340A\002\"\241"
          + "\t\n"
          ...
          + "\033supported_enforcement_modes\030\007 \003(\01628"
          + ".google.cloud.cloudsecuritycompliance.v1.EnforcementModeB\003\340A\003\022S\n"
          + "\016parameter_spec\030\010"
          + " \003(\01326.google.cloud.cloudsecuritycompliance.v1.ParameterSpecB\003\340A\001\022A\n"
          + "\005rules\030\t \003("
          + "\0132-.google.cloud.cloudsecuritycompliance.v1.RuleB\003\340A\001\022H\n"
          + "\010severity\030\013 \001(\01621.google"
          + ".cloud.cloudsecuritycompliance.v1.SeverityB\003\340A\001\022\035\n"
          + "\020finding_category\030\014 \001(\tB\003\340A\001\022^\n"
          + "\031supported_cloud_providers\030\r"
          + " \003(\01626.goog"
          + "le.cloud.cloudsecuritycompliance.v1.CloudProviderB\003\340A\001\022\037\n"
          + "\022related_frameworks\030\016 \003(\tB\003\340A\003\022\036\n"
          + "\021remediation_steps\030\017 \001(\tB\003\340A\001\022V\n\n"
          + "categories\030\020 \003(\0162=.google.cloud.cloud"
          + "securitycompliance.v1.CloudControlCategoryB\003\340A\001\0224\n"
          + "\013create_time\030\021 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022i\n"
          + "\037supported_target_resource_types\030\022 \003(\0162;.google.cloud.cl"
          + "oudsecuritycompliance.v1.TargetResourceTypeB\003\340A\001\"6\n"
          + "\004Type\022\024\n"
          + "\020TYPE_UNSPECIFIED\020\000\022\n"
          + "\n"
          + "\006CUSTOM\020\001\022\014\n"
          + "\010BUILT_IN\020\002:\356\001\352A\352\001\n"
          + "3cloudsecuritycompliance.googleapis.com/CloudCon"
          + "trol\022Oorganizations/{organization}/locations/{location}/cloudControls/{cloud_con"
          + "trol}\022Eprojects/{project}/locations/{location}/cloudControls/{cloud_control}*\r"
          ...
          + "\0162@.google.cloud.cloudsecuritycompliance.v1.ParameterSpec.ValueTypeB\003\340A\002\022O\n\r"
          + "default_value\030\006"
          + " \001(\01323.google.cloud.cloudsecuritycompliance.v1.ParamValueB\003\340A\001\022c\n"
          + "\022substitution_rules\030\007 \003(\0132B.google.cloud.clo"
          + "udsecuritycompliance.v1.ParameterSubstitutionRuleB\003\340A\001\022S\n"
          + "\016sub_parameters\030\010 \003(\01326"
          + ".google.cloud.cloudsecuritycompliance.v1.ParameterSpecB\003\340A\001\022L\n\n"
          + "validation\030\t \001(\0132"
          + "3.google.cloud.cloudsecuritycompliance.v1.ValidationB\003\340A\001\"g\n"
          + "\tValueType\022\032\n"
          ...
          + "Validation\022P\n"
          + "\016allowed_values\030\001 \001("
          + "\01326.google.cloud.cloudsecuritycompliance.v1.AllowedValuesH\000\022F\n"
          + "\tint_range\030\002 \001(\01321"
          + ".google.cloud.cloudsecuritycompliance.v1.IntRangeH\000\022P\n"
          + "\016regexp_pattern\030\003 \001(\01326.go"
          + "ogle.cloud.cloudsecuritycompliance.v1.RegexpPatternH\000B\014\n\n"
          + "constraint\"Y\n\r"
          + "AllowedValues\022H\n"
          + "\006values\030\001 \003(\01323.google.cloud.clou"
          + "dsecuritycompliance.v1.ParamValueB\003\340A\002\"%\n\r"
          ...
          + "\021string_list_value\030\005 \001(\01323.google.cloud.clouds"
          + "ecuritycompliance.v1.StringListB\003\340A\001H\000\022\033\n"
          + "\014number_value\030\006 \001(\001B\003\340A\001H\000\022N\n"
          + "\013oneof_value\030\007"
          + " \001(\01322.google.cloud.cloudsecuritycompliance.v1.ParameterB\003\340A\001H\000B\006\n"
          + "\004kind\"\212\002\n"
          + "\031ParameterSubstitutionRule\022m\n"
          + "\035placeholder_substitution_rule\030\001 \001(\0132D.google.cloud."
          + "cloudsecuritycompliance.v1.PlaceholderSubstitutionRuleH\000\022i\n"
          + "\033attribute_substitution_rule\030\002 \001(\0132B.google.cloud.cloudsecuri"
          + "tycompliance.v1.AttributeSubstitutionRuleH\000B\023\n"
          ...
          + "\004Rule\022P\n"
          + "\016cel_expression\030\001 \001(\01326.go"
          + "ogle.cloud.cloudsecuritycompliance.v1.CELExpressionH\000\022\030\n"
          + "\013description\030\n"
          + " \001(\tB\003\340A\001\022W\n"
          + "\021rule_action_types\030\020 \003(\01627.google.clou"
          + "d.cloudsecuritycompliance.v1.RuleActionTypeB\003\340A\002B\020\n"
          + "\016implementation\"\212\001\n\r"
          + "CELExpression\022T\n"
          + "\025resource_types_values\030\003 \001(\01323.go"
          + "ogle.cloud.cloudsecuritycompliance.v1.StringListH\000\022\027\n\n"
          ...
          + "\013api_version\030\007 \001(\tB\003\340A\003\"\243\010\n"
          + "\007Control\022\021\n"
          ...
          + "\023responsibility_type\030\007 \001(\0162L.google.cloud.cl"
          + "oudsecuritycompliance.v1.RegulatoryControlResponsibilityTypeB\003\340A\003\022.\n"
          ...
          + ".cloudsecuritycompliance.googleapis.com/Control\022Dorganizations/{orga"
          + "nization}/locations/{location}/controls/{control}\022:projects/{project}/locations/"
          + "{location}/controls/{control}*\010controls2\007control\"8\n\r"
          ...
          + "\020CC_CATEGORY_BCDR\020\017\022\034\n"
          ...
          + "+com.google.cloud.cloudsecuritycompliance.v1B\013CommonProtoP\001Zecloud.google.com"
          ...
          + "liance\\V1\352\002*Google::Cloud::CloudSecurityCompliance::V1\352Ap\n"
          + ";cloudsecuritycompliance.googleapis.com/OrganizationLocation\0221"
          + "organizations/{organization}/locations/{location}b\006proto3"
    };
    descriptor =
