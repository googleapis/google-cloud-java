...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-monitoring" % "3.32.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-monitoring/3.32.0
