...
```Groovy
implementation 'com.google.cloud:google-cloud-monitoring:3.96.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-monitoring/3.96.0
