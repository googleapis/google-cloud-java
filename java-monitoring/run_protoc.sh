...
mkdir -p "${WORKING_DIR}/gapic_generator_java/rules_java_gapic"
mkdir -p "${WORKING_DIR}/com_google_protobuf/descriptor_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/duration_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/any_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/timestamp_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/struct_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/empty_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/field_mask_proto"
mkdir -p "${WORKING_DIR}/com_google_protobuf/wrappers_proto"
mkdir -p "${WORKING_DIR}/google/api"
mkdir -p "${WORKING_DIR}/google/rpc"
mkdir -p "${WORKING_DIR}/google/type"
mkdir -p "${WORKING_DIR}/google/monitoring/v3"
...
"--descriptor_set_out=${WORKING_DIR}/google/api/http_proto-descriptor-set.proto.bin" \
--include_source_info \
