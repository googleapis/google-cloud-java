...
public final class MetricServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            com.google.monitoring.v3.CreateTimeSeriesRequest, com.google.protobuf.Empty>
        getCreateServiceTimeSeriesMethod;
    if ((getCreateServiceTimeSeriesMethod = MetricServiceGrpc.getCreateServiceTimeSeriesMethod)
        == null) {
      synchronized (MetricServiceGrpc.class) {
        if ((getCreateServiceTimeSeriesMethod = MetricServiceGrpc.getCreateServiceTimeSeriesMethod)
            == null) {
          MetricServiceGrpc.getCreateServiceTimeSeriesMethod =
              getCreateServiceTimeSeriesMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.monitoring.v3.CreateTimeSeriesRequest, com.google.protobuf.Empty>
                          newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "CreateServiceTimeSeries"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.monitoring.v3.CreateTimeSeriesRequest
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.protobuf.Empty.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new MetricServiceMethodDescriptorSupplier("CreateServiceTimeSeries"))
                      .build();
        }
      }
    }
  ...
  public static MetricServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<MetricServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<MetricServiceBlockingV2Stub>() {
          @java.lang.Override
          public MetricServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new MetricServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return MetricServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
    ...
    default void getMonitoredResourceDescriptor(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getGetMonitoredResourceDescriptorMethod(), responseObserver);
    }
    ...
    default void listMetricDescriptors(
        ...
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.ListMetricDescriptorsResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getListMetricDescriptorsMethod(), responseObserver);
    }
    ...
    default void getMetricDescriptor(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getGetMetricDescriptorMethod(), responseObserver);
    }
    ...
    default void listTimeSeries(
        ...
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.ListTimeSeriesResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getListTimeSeriesMethod(), responseObserver);
    }
  ...
  public static final class MetricServiceStub
    ...
    public void createServiceTimeSeries(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateServiceTimeSeriesMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class MetricServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<MetricServiceBlockingV2Stub> {
    private MetricServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected MetricServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new MetricServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service MetricService.
   *
   * <pre>
   * Manages metric descriptors, monitored resource descriptors, and
   * time series data.
  ...
  public static final class MetricServiceFutureStub
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        createServiceTimeSeries(com.google.monitoring.v3.CreateTimeSeriesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_CREATE_SERVICE_TIME_SERIES:
          serviceImpl.createServiceTimeSeries(
              (com.google.monitoring.v3.CreateTimeSeriesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
