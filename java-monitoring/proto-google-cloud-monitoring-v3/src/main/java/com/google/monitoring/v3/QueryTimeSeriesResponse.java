...
public final class QueryTimeSeriesResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private QueryTimeSeriesResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetTimeSeriesDescriptorFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66:
              {
                input.readMessage(
                    internalGetTimeSeriesDescriptorFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.monitoring.v3.TimeSeriesDescriptor.Builder getTimeSeriesDescriptorBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetTimeSeriesDescriptorFieldBuilder().getBuilder();
    }
    ...
    public com.google.monitoring.v3.TimeSeriesData.Builder getTimeSeriesDataBuilder(int index) {
      return internalGetTimeSeriesDataFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.monitoring.v3.TimeSeriesData.Builder addTimeSeriesDataBuilder() {
      return internalGetTimeSeriesDataFieldBuilder()
    ...
    public java.util.List<com.google.monitoring.v3.TimeSeriesData.Builder>
      ...
      return internalGetTimeSeriesDataFieldBuilder().getBuilderList();
    }
