  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "google/api/resource.proto\032!google/monitoring/v3/common.proto\032*google/monitoring/"
          + "v3/mutation_record.proto\032\036google/protobuf/wrappers.proto\"\245\004\n"
          ...
          + "7monitoring.googleapis.com/NotificationChannelDescriptor\022Fprojects/{project"
          + "}/notificationChannelDescriptors/{channel_descriptor}\022Porganizations/{organizati"
          + "on}/notificationChannelDescriptors/{channel_descriptor}\022Dfolders/{folder}/notifi"
          + "cationChannelDescriptors/{channel_descriptor}\022\001*\"\266\007\n"
          ...
          + "5.google.monitoring.v3.NotificationChannel.LabelsEntry\022N\n"
          + "\013user_labels\030\010 \003(\01329.go"
          + "ogle.monitoring.v3.NotificationChannel.UserLabelsEntry\022Y\n"
          + "\023verification_status\030\t "
          + "\001(\0162<.google.monitoring.v3.NotificationChannel.VerificationStatus\022+\n"
          ...
          + "projects/{project}/notificationChannels/{notification_channel}\022Horganizations/{o"
          + "rganization}/notificationChannels/{notification_channel}\022<folders/{folder}/notif"
          + "icationChannels/{notification_channel}\022\001*B\314\001\n"
          + "\030com.google.monitoring.v3B\021NotificationProtoP\001ZAcloud.google.com/go/monitor"
          + "ing/apiv3/v2/monitoringpb;monitoringpb\252\002"
          + "\032Google.Cloud.Monitoring.V3\312\002\032Google\\Clo"
          + "ud\\Monitoring\\V3\352\002\035Google::Cloud::Monitoring::V3b\006proto3"
    };
    descriptor =
