  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "vior.proto\032\031google/api/resource.proto\032!google/monitoring/v3/common.proto\"\305\002\n"
          + "\006Snooze\022\021\n"
          ...
          + "%monitoring.googleapis.com/AlertPolicy:J\352AG\n"
          + " monitoring.googleapis.com/Snooze\022#projects/{project}/snoozes/{snooze}B\306\001\n"
          + "\030com.google.monitoring.v3B\013SnoozeProtoP\001ZAcloud.google.com/go/monitoring/api"
          + "v3/v2/monitoringpb;monitoringpb\252\002\032Google"
          + ".Cloud.Monitoring.V3\312\002\032Google\\Cloud\\Moni"
          + "toring\\V3\352\002\035Google::Cloud::Monitoring::V3b\006proto3"
    };
    descriptor =
