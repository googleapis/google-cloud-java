...
public final class NotificationChannelDescriptor extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private NotificationChannelDescriptor(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList supportedTiers_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      supportedTiers_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.monitoring.v3.ServiceTier>() {
            public com.google.monitoring.v3.ServiceTier convert(int from) {
  ...
  public java.util.List<com.google.monitoring.v3.ServiceTier> getSupportedTiersList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.monitoring.v3.ServiceTier>(
  ...
  public com.google.monitoring.v3.ServiceTier getSupportedTiers(int index) {
    return supportedTiers_converter_.convert(supportedTiers_.getInt(index));
  }
  ...
  public int getSupportedTiersValue(int index) {
    return supportedTiers_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < supportedTiers_.size(); i++) {
      output.writeEnumNoTag(supportedTiers_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < supportedTiers_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(supportedTiers_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            ...
            case 42:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  supportedTiers_.addInt(input.readEnum());
                }
    ...
    private void ensureSupportedTiersIsMutable() {
      if (!supportedTiers_.isModifiable()) {
        supportedTiers_ = makeMutableCopy(supportedTiers_);
      }
      bitField0_ |= 0x00000020;
    }
    ...
    public Builder setSupportedTiers(int index, com.google.monitoring.v3.ServiceTier value) {
      ...
      ensureSupportedTiersIsMutable();
      supportedTiers_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addSupportedTiers(com.google.monitoring.v3.ServiceTier value) {
      ...
      ensureSupportedTiersIsMutable();
      supportedTiers_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setSupportedTiersValue(int index, int value) {
      ensureSupportedTiersIsMutable();
      supportedTiers_.setInt(index, value);
      onChanged();
      return this;
    }
