  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "e.proto\032\031google/api/resource.proto\032\036google/protobuf/duration.proto\"\346\001\n"
          ...
          + "le.monitoring.v3.SyntheticMonitorTarget.CloudFunctionV2TargetH\000\032\225\001\n"
          ...
          + "\016resource_group\030\004"
          + " \001(\01325.google.monitoring.v3.UptimeCheckConfig.ResourceGroupH\000\022I\n"
          + "\021synthetic_monitor\030\025"
          + " \001(\0132,.google.monitoring.v3.SyntheticMonitorTargetH\000\022G\n\n"
          + "http_check\030\005"
          + " \001(\01321.google.monitoring.v3.UptimeCheckConfig.HttpCheckH\001\022E\n"
          + "\ttcp_check\030\006 \001(\01320."
          + "google.monitoring.v3.UptimeCheckConfig.TcpCheckH\001\022)\n"
          ...
          + "(\01326.google.monitoring.v3.UptimeCheckConfig.ContentMatcher\022I\n"
          + "\014checker_type\030\021 \001(\016"
          + "23.google.monitoring.v3.UptimeCheckConfig.CheckerType\022A\n"
          ...
          + "\021internal_checkers\030\016"
          + " \003(\0132%.google.monitoring.v3.InternalCheckerB\002\030\001\022L\n"
          + "\013user_labels\030\024 \003(\01327.g"
          + "oogle.monitoring.v3.UptimeCheckConfig.UserLabelsEntry\032a\n\r"
          ...
          + "oring.v3.UptimeCheckConfig.HttpCheck.RequestMethod\022\017\n"
          + "\007use_ssl\030\001 \001(\010\022\014\n"
          + "\004path\030\002 \001(\t\022\014\n"
          + "\004port\030\003 \001(\005\022X\n"
          + "\tauth_info\030\004 \001(\0132E.goo"
          + "gle.monitoring.v3.UptimeCheckConfig.HttpCheck.BasicAuthentication\022\024\n"
          + "\014mask_headers\030\005 \001(\010\022O\n"
          + "\007headers\030\006 \003(\0132>.google.monito"
          + "ring.v3.UptimeCheckConfig.HttpCheck.HeadersEntry\022S\n"
          + "\014content_type\030\t \001(\0162=.google."
          + "monitoring.v3.UptimeCheckConfig.HttpCheck.ContentType\022\033\n"
          ...
          + ".google.monitoring.v3.UptimeCheckConfig.HttpCheck.ResponseStatusCode\022G\n"
          + "\013ping_config\030\014"
          + " \001(\01322.google.monitoring.v3.UptimeCheckConfig.PingConfig\022t\n"
          + "\034service_agent_authentication\030\016 \001(\0132L.google.monitoring."
          + "v3.UptimeCheckConfig.HttpCheck.ServiceAgentAuthenticationH\000\0329\n"
          ...
          + "itoring.v3.UptimeCheckConfig.HttpCheck.ResponseStatusCode.StatusClassH\000\"\264\001\n"
          ...
          + "\004type\030\001 \001(\0162k.google.monitoring.v3.UptimeCheckConfig.Http"
          + "Check.ServiceAgentAuthentication.ServiceAgentAuthenticationType\"c\n"
          ...
          + "\013ping_config\030\002"
          + " \001(\01322.google.monitoring.v3.UptimeCheckConfig.PingConfig\032\312\005\n"
          + "\016ContentMatcher\022\017\n"
          + "\007content\030\001 \001(\t\022\\\n"
          + "\007matcher\030\002 \001(\0162K.googl"
          + "e.monitoring.v3.UptimeCheckConfig.ContentMatcher.ContentMatcherOption\022c\n"
          + "\021json_path_matcher\030\003 \001(\0132F.google.monitoring.v3."
          + "UptimeCheckConfig.ContentMatcher.JsonPathMatcherH\000\032\375\001\n"
          + "\017JsonPathMatcher\022\021\n"
          + "\tjson_path\030\001 \001(\t\022r\n"
          + "\014json_matcher\030\002 \001(\0162\\.google.monitoring.v3.UptimeCheckConfig.Content"
          + "Matcher.JsonPathMatcher.JsonPathMatcherOption\"c\n"
          ...
          + "+monitoring.googleapis.com/UptimeCheckConfig\022;projects/{project}/uptimeCheckCo"
          + "nfigs/{uptime_check_config}\022Eorganizations/{organization}/uptimeCheckConfigs/{up"
          + "time_check_config}\0229folders/{folder}/upt"
          + "imeCheckConfigs/{uptime_check_config}\022\001*B\n\n"
          + "\010resourceB\024\n"
          ...
          + "\030com.google.monitoring.v3B\013UptimeProtoP\001ZAclo"
          + "ud.google.com/go/monitoring/apiv3/v2/mon"
          + "itoringpb;monitoringpb\252\002\032Google.Cloud.Mo"
          + "nitoring.V3\312\002\032Google\\Cloud\\Monitoring\\V3\352\002\035Google::Cloud::Monitoring::V3\352Af\n"
          + "&cloudfunctions.googleapis.com/Function\022<pro"
