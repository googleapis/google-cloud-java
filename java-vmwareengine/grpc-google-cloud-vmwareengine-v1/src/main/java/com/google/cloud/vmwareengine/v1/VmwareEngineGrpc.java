...
public final class VmwareEngineGrpc {
  ...
  public static VmwareEngineBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VmwareEngineBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<VmwareEngineBlockingV2Stub>() {
          @java.lang.Override
          public VmwareEngineBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new VmwareEngineBlockingV2Stub(channel, callOptions);
          }
        };
    return VmwareEngineBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class VmwareEngineBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<VmwareEngineBlockingV2Stub> {
    private VmwareEngineBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected VmwareEngineBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new VmwareEngineBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service VmwareEngine.
   *
   * <pre>
   * VMwareEngine manages VMware's private clusters in the Cloud.
   * </pre>
