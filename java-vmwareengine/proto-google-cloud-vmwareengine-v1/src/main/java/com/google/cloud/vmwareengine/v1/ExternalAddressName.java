...
public class ExternalAddressName implements ResourceName {
  ...
  public static @Nullable ExternalAddressName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ExternalAddressName> values) {
