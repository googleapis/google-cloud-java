...
public interface CreateNetworkPeeringRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmwareengine.v1.CreateNetworkPeeringRequest)
   ...
   * </pre>
   *
   * <code>string network_peering_id = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
   ...
   * <code>string network_peering_id = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
   * @return The bytes for networkPeeringId.
   */
  com.google.protobuf.ByteString getNetworkPeeringIdBytes();
