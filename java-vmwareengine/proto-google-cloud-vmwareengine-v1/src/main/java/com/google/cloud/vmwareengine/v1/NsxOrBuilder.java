...
public interface NsxOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmwareengine.v1.Nsx)
   ...
   * @return The state.
   */
  com.google.cloud.vmwareengine.v1.Nsx.State getState();
