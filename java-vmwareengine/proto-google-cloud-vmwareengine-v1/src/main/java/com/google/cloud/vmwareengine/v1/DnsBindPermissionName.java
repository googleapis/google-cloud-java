...
public class DnsBindPermissionName implements ResourceName {
  ...
  private DnsBindPermissionName(Builder builder) {
  ...
  public static @Nullable DnsBindPermissionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION.validatedMatch(
            formattedString, "DnsBindPermissionName.parse: formattedString not in valid format");
  ...
  public static List<DnsBindPermissionName> parseList(List<String> formattedStrings) {
    List<DnsBindPermissionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable DnsBindPermissionName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (DnsBindPermissionName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      DnsBindPermissionName that = ((DnsBindPermissionName) o);
  ...
  /** Builder for projects/{project}/locations/{location}/dnsBindPermission. */
  public static class Builder {
    ...
    private Builder(DnsBindPermissionName dnsBindPermissionName) {
      this.project = dnsBindPermissionName.project;
      this.location = dnsBindPermissionName.location;
    }

    public DnsBindPermissionName build() {
      return new DnsBindPermissionName(this);
    }
  }
}
