...
public class NetworkPeeringName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_NETWORK_PEERING =
  ...
  private NetworkPeeringName(Builder builder) {
    ...
    networkPeering = Preconditions.checkNotNull(builder.getNetworkPeering());
  }
  ...
  public static @Nullable NetworkPeeringName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_NETWORK_PEERING.validatedMatch(
            formattedString, "NetworkPeeringName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("network_peering"));
  }

  public static List<NetworkPeeringName> parseList(List<String> formattedStrings) {
    List<NetworkPeeringName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable NetworkPeeringName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (networkPeering != null) {
            fieldMapBuilder.put("network_peering", networkPeering);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_NETWORK_PEERING.instantiate(
        "project", project, "location", location, "network_peering", networkPeering);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.networkPeering, that.networkPeering);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(networkPeering);
    return h;
  }

  /** Builder for projects/{project}/locations/{location}/networkPeerings/{network_peering}. */
