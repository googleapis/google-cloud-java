...
public class ClusterName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_PRIVATE_CLOUD_CLUSTER =
  ...
  public static ClusterName of(
      String project, String location, String privateCloud, String cluster) {
    return newBuilder()
        .setProject(project)
  ...
  public static ClusterName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_PRIVATE_CLOUD_CLUSTER.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_PRIVATE_CLOUD_CLUSTER.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_PRIVATE_CLOUD_CLUSTER.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public static class Builder {
    ...
    private Builder(ClusterName clusterName) {
      ...
      this.privateCloud = clusterName.privateCloud;
