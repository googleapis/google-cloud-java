...
public class PrivateConnectionName implements ResourceName {
  ...
  public static @Nullable PrivateConnectionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PrivateConnectionName> values) {
