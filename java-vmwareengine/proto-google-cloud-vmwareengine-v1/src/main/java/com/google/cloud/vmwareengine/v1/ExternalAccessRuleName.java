...
public class ExternalAccessRuleName implements ResourceName {
  ...
  public static @Nullable ExternalAccessRuleName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ExternalAccessRuleName> values) {
