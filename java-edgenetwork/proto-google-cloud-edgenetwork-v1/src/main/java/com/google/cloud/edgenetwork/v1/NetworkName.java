...
public class NetworkName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_ZONE_NETWORK =
  ...
  public static String format(String project, String location, String zone, String network) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setZone(zone)
  ...
  public static NetworkName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_ZONE_NETWORK.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_ZONE_NETWORK.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_ZONE_NETWORK.instantiate(
        "project", project, "location", location, "zone", zone, "network", network);
  }
