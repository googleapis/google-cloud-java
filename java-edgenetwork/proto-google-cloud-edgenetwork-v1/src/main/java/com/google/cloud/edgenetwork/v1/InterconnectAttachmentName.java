...
public class InterconnectAttachmentName implements ResourceName {
  ...
  public static @Nullable InterconnectAttachmentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable InterconnectAttachmentName> values) {
