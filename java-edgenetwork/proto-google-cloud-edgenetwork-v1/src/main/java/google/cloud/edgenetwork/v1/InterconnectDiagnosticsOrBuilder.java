...
public interface InterconnectDiagnosticsOrBuilder
   ...
   */
  java.util.List<google.cloud.edgenetwork.v1.LinkLayerAddress> getLinkLayerAddressesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.edgenetwork.v1.LinkLayerAddress link_layer_addresses = 2;</code>
   */
  google.cloud.edgenetwork.v1.LinkLayerAddress getLinkLayerAddresses(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.edgenetwork.v1.LinkLayerAddress link_layer_addresses = 2;</code>
   */
  java.util.List<? extends google.cloud.edgenetwork.v1.LinkLayerAddressOrBuilder>
   ...
   * <code>repeated .google.cloud.edgenetwork.v1.LinkLayerAddress link_layer_addresses = 2;</code>
   */
  google.cloud.edgenetwork.v1.LinkLayerAddressOrBuilder getLinkLayerAddressesOrBuilder(int index);
   ...
   * </code>
   */
  java.util.List<google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatus> getLinksList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatus getLinks(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatusOrBuilder>
   ...
   * </code>
   */
  google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatusOrBuilder getLinksOrBuilder(
      int index);
}
