...
import com.google.gcloud.compute.AddressInfo.GlobalForwardingUsage;
import com.google.gcloud.compute.AddressInfo.InstanceUsage;
import com.google.gcloud.compute.AddressInfo.RegionForwardingUsage;
...
public class AddressInfoTest {
  ...
  private static final InstanceUsage INSTANCE_USAGE =
      new InstanceUsage(InstanceId.of("project", "zone", "instance1"));
  ...
  public void testBuilder() {
    ...
    assertEquals(INSTANCE_USAGE.instance(),
        INSTANCE_ADDRESS_INFO.<InstanceUsage>usage().instance());
