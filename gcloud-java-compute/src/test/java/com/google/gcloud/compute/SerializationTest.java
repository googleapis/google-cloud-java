...
public class SerializationTest {
  ...
  private static final AttachedDisk PERSISTENT_ATTACHED_DISK =
      PersistentAttachedDisk.of(DISK_ID);
  private static final AttachedDisk SCRATCH_ATTACHED_DISK =
      ScratchAttachedDisk.of(DISK_TYPE_ID);
  private static final AttachedDisk CREATE_ATTACHED_DISK =
      CreateAttachedDisk.of(IMAGE_ID);
  ...
  public void testModelAndRequests() throws Exception {
    Serializable[] objects = {DISK_TYPE_ID, DISK_TYPE, MACHINE_TYPE_ID, MACHINE_TYPE, REGION_ID,
        ...
        DISK_INFO, DISK, PERSISTENT_ATTACHED_DISK, SCRATCH_ATTACHED_DISK, CREATE_ATTACHED_DISK,
