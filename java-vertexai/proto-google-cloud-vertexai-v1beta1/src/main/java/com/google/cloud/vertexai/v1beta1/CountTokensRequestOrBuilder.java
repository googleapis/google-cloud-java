...
public interface CountTokensRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1beta1.CountTokensRequest)
   ...
   *
   * <code>
   * repeated .google.cloud.vertexai.v1beta1.Content contents = 4 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   */
