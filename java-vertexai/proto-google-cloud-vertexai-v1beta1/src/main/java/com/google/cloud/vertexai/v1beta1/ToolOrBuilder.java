...
public interface ToolOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vertexai.v1beta1.FunctionDeclaration>
   ...
   * </code>
   */
  com.google.cloud.vertexai.v1beta1.FunctionDeclaration getFunctionDeclarations(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.vertexai.v1beta1.FunctionDeclarationOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.vertexai.v1beta1.FunctionDeclarationOrBuilder getFunctionDeclarationsOrBuilder(
      int index);
}
