...
public interface StreamDirectPredictRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.StreamDirectPredictRequest)
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.TensorOrBuilder getInputsOrBuilder(int index);
