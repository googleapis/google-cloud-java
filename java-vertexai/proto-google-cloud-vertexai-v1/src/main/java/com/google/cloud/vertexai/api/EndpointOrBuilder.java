...
public interface EndpointOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.Endpoint)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vertexai.api.DeployedModel> getDeployedModelsList();
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.DeployedModel getDeployedModels(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.vertexai.api.DeployedModelOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.DeployedModelOrBuilder getDeployedModelsOrBuilder(int index);
   ...
   */
  com.google.cloud.vertexai.api.PrivateServiceConnectConfig getPrivateServiceConnectConfig();
   ...
   */
  com.google.cloud.vertexai.api.ClientConnectionConfig getClientConnectionConfig();
   ...
   */
  boolean hasGenAiAdvancedFeaturesConfig();
