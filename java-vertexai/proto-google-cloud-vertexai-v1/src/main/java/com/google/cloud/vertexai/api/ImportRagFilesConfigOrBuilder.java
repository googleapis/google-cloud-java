...
public interface ImportRagFilesConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.ImportRagFilesConfig)
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.GcsSource gcs_source = 2;</code>
   *
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.GoogleDriveSource google_drive_source = 3;</code>
   *
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.SlackSource slack_source = 6;</code>
   *
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.JiraSource jira_source = 7;</code>
   *
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.SharePointSources share_point_sources = 13;</code>
   *
   ...
   *
   * <code>
   * .google.cloud.vertexai.v1.GcsDestination partial_failure_gcs_sink = 11 [deprecated = true];
   * </code>
   *
   * @deprecated google.cloud.vertexai.v1.ImportRagFilesConfig.partial_failure_gcs_sink is
   *     deprecated. See google/cloud/vertexai/v1/vertex_rag_data.proto;l=413
   ...
   */
  @java.lang.Deprecated
  com.google.cloud.vertexai.api.GcsDestinationOrBuilder getPartialFailureGcsSinkOrBuilder();
   ...
   *
   * <code>
   * .google.cloud.vertexai.v1.BigQueryDestination partial_failure_bigquery_sink = 12 [deprecated = true];
   * </code>
   *
   * @deprecated google.cloud.vertexai.v1.ImportRagFilesConfig.partial_failure_bigquery_sink is
   *     deprecated. See google/cloud/vertexai/v1/vertex_rag_data.proto;l=422
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.GcsDestination import_result_gcs_sink = 14;</code>
   *
   ...
   * <code>.google.cloud.vertexai.v1.GcsDestination import_result_gcs_sink = 14;</code>
   */
  com.google.cloud.vertexai.api.GcsDestinationOrBuilder getImportResultGcsSinkOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.vertexai.v1.BigQueryDestination import_result_bigquery_sink = 15;</code>
   *
   ...
   * <code>.google.cloud.vertexai.v1.BigQueryDestination import_result_bigquery_sink = 15;</code>
   */
  com.google.cloud.vertexai.api.BigQueryDestinationOrBuilder getImportResultBigquerySinkOrBuilder();
   ...
   *
   * <code>
   * .google.cloud.vertexai.v1.RagFileTransformationConfig rag_file_transformation_config = 16;
   * </code>
   *
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.RagFileParsingConfigOrBuilder getRagFileParsingConfigOrBuilder();
  ...
  com.google.cloud.vertexai.api.ImportRagFilesConfig.ImportSourceCase getImportSourceCase();

  com.google.cloud.vertexai.api.ImportRagFilesConfig.PartialFailureSinkCase
      getPartialFailureSinkCase();

  com.google.cloud.vertexai.api.ImportRagFilesConfig.ImportResultSinkCase getImportResultSinkCase();
}
