  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "e.proto\032.google/cloud/vertexai/v1/encryption_spec.proto\032*google/cloud/vertexai/v"
          + "1/explanation.proto\032!google/cloud/vertexai/v1/io.proto\0320google/cloud/vertexai/v1"
          + "/machine_resources.proto\0321google/cloud/v"
          + "ertexai/v1/service_networking.proto\032\036goo"
          + "gle/protobuf/duration.proto\032\037google/protobuf/timestamp.proto\"\374\013\n"
          + "\010Endpoint\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\031\n"
          + "\014display_name\030\002 \001(\tB\003\340A\002\022\023\n"
          + "\013description\030\003 \001(\t\022E\n"
          + "\017deployed_models\030\004"
          + " \003(\0132\'.google.cloud.vertexai.v1.DeployedModelB\003\340A\003\022K\n\r"
          + "traffic_split\030\005 \003(\01324.goo"
          + "gle.cloud.vertexai.v1.Endpoint.TrafficSplitEntry\022\014\n"
          ...
          + "(\01325.google.cloud.vertexai.v1.PrivateServiceConnectConfigB\003\340A\001\022g\n"
          ...
          + "\'predict_request_response_logging_config\030\022 \001(\0132=.google.cloud.vertexai"
          ...
          + " \001(\01320.google.cloud.vertexai.v1.ClientConnectionConfig\022\032\n\r"
          + "satisfies_pzs\030\033 \001(\010B\003\340A\003\022\032\n\r"
          + "satisfies_pzi\030\034 \001(\010B\003\340A\003\022c\n"
          + "\037gen_ai_advanced_features_config\030\035"
          + " \001(\01325.google.cloud.vertexai.v1.GenAiAdvancedFeaturesConfigB\003\340A\001\022$\n"
          ...
          + "\"aiplatform.googleapis.com/Endpoint\022<projects/{project}/locat"
          + "ions/{location}/endpoints/{endpoint}\022Mpr"
          + "ojects/{project}/locations/{location}/publishers/{publisher}/models/{model}\"\342"
          + "\t\n\r"
          + "DeployedModel\022K\n"
          + "\023dedicated_resources\030\007 \001"
          + "(\0132,.google.cloud.vertexai.v1.DedicatedResourcesH\000\022K\n"
          + "\023automatic_resources\030\010 \001(\0132"
          + ",.google.cloud.vertexai.v1.AutomaticResourcesH\000\022Q\n"
          ...
          + "\013create_time\030\006 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022C\n"
          + "\020explanation_spec\030\t"
          + " \001(\0132).google.cloud.vertexai.v1.ExplanationSpec\022\034\n"
          ...
          + " \001(\0132*.google.cloud.vertexai.v1.PrivateEndpointsB\003\340A\003\022R\n"
          + "\030faster_deployment_config\030\027"
          + " \001(\01320.google.cloud.vertexai.v1.FasterDeploymentConfig\022C\n"
          + "\006status\030\032 \001(\0132..goog"
          + "le.cloud.vertexai.v1.DeployedModel.StatusB\003\340A\003\022P\n\r"
          + "system_labels\030\034 \003(\01329.google.c"
          + "loud.vertexai.v1.DeployedModel.SystemLabelsEntry\022\025\n\r"
          + "checkpoint_id\030\035 \001(\t\022Y\n"
          + "\031speculative_decoding_spec\030\036 \001(\01321.google.clou"
          + "d.vertexai.v1.SpeculativeDecodingSpecB\003\340A\001\032\177\n"
          + "\006Status\022\024\n"
          ...
          + "sampling_rate\030\002 \001(\001\022K\n"
          + "\024bigquery_destination\030\003"
          + " \001(\0132-.google.cloud.vertexai.v1.BigQueryDestination\"N\n"
          ...
          + "\023fast_tryout_enabled\030\002 \001(\010\"\223\001\n"
          + "\033GenAiAdvancedFeaturesConfig\022S\n\n"
          + "rag_config\030\001 \001(\0132?.google.cloud.vertex"
          + "ai.v1.GenAiAdvancedFeaturesConfig.RagConfig\032\037\n"
          + "\tRagConfig\022\022\n\n"
          + "enable_rag\030\001 \001(\010\"\225\003\n"
          + "\027SpeculativeDecodingSpec\022j\n"
          + "\027draft_model_speculation\030\002 \001(\0132G.google.cloud.vertexa"
          + "i.v1.SpeculativeDecodingSpec.DraftModelSpeculationH\000\022_\n"
          + "\021ngram_speculation\030\003 \001(\0132"
          + "B.google.cloud.vertexai.v1.SpeculativeDecodingSpec.NgramSpeculationH\000\022\037\n"
          ...
          + "\035com.google.cloud.vertexai.apiB\r"
          + "EndpointProtoP\001Z>cloud.google.com/go/aiplatform/apiv1/aiplatformpb;aiplatformpb\252"
          + "\002\032Google.Cloud.AIPlatform.V1\312\002\032Google\\Cl"
          + "oud\\AIPlatform\\V1\352\002\035Google::Cloud::AIPlatform::V1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_vertexai_v1_Endpoint_TrafficSplitEntry_descriptor =
        internal_static_google_cloud_vertexai_v1_Endpoint_descriptor.getNestedType(0);
    internal_static_google_cloud_vertexai_v1_Endpoint_TrafficSplitEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_vertexai_v1_Endpoint_TrafficSplitEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_vertexai_v1_Endpoint_LabelsEntry_descriptor =
        internal_static_google_cloud_vertexai_v1_Endpoint_descriptor.getNestedType(1);
    internal_static_google_cloud_vertexai_v1_Endpoint_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_vertexai_v1_Endpoint_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_vertexai_v1_DeployedModel_Status_descriptor =
        internal_static_google_cloud_vertexai_v1_DeployedModel_descriptor.getNestedType(0);
    internal_static_google_cloud_vertexai_v1_DeployedModel_Status_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_vertexai_v1_DeployedModel_Status_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_vertexai_v1_DeployedModel_SystemLabelsEntry_descriptor =
        internal_static_google_cloud_vertexai_v1_DeployedModel_descriptor.getNestedType(1);
    internal_static_google_cloud_vertexai_v1_DeployedModel_SystemLabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_vertexai_v1_DeployedModel_SystemLabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_vertexai_v1_SpeculativeDecodingSpec_DraftModelSpeculation_descriptor =
        internal_static_google_cloud_vertexai_v1_SpeculativeDecodingSpec_descriptor.getNestedType(
            0);
    internal_static_google_cloud_vertexai_v1_SpeculativeDecodingSpec_DraftModelSpeculation_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_vertexai_v1_SpeculativeDecodingSpec_DraftModelSpeculation_descriptor,
