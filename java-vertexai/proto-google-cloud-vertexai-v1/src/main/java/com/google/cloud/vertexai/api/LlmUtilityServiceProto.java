  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "e/cloud/vertexai/v1/prediction_service.proto\032\034google/protobuf/struct.proto\"\322\001\n"
          ...
          + "\013CountTokens\022,.google.cloud.vertexai.v1.CountTokensRequ"
          ...
          + "endpoints/*}:countTokens:\001*ZL\"G/v1/{endpoint=projects/*/locations/*/publishers/*"
          + "/models/*}:countTokens:\001*Z+\"&/v1/{endpoi"
          + "nt=endpoints/*}:countTokens:\001*Z5\"0/v1/{e"
          + "ndpoint=publishers/*/models/*}:countTokens:\001*\022\213\003\n\r"
          + "ComputeTokens\022..google.cloud.vertexai.v1.ComputeTokensRequest\032/.google"
          + ".cloud.vertexai.v1.ComputeTokensResponse"
          + "\"\230\002\332A\022endpoint,instances\202\323\344\223\002\374\001\"?/v1/{en"
          + "dpoint=projects/*/locations/*/endpoints/*}:computeTokens:\001*ZN\"I/v1/{endpoint=pro"
          + "jects/*/locations/*/publishers/*/models/*}:computeTokens:\001*Z-\"(/v1/{endpoint=end"
          + "points/*}:computeTokens:\001*Z7\"2/v1/{endpoint=publishers/*/models/*}:computeTokens"
          + ":\001*\032M\312A\031aiplatform.googleapis.com\322A.http"
          + "s://www.googleapis.com/auth/cloud-platformB\323\001\n"
          + "\035com.google.cloud.vertexai.apiB\026LlmUtilityServiceProtoP\001Z>cloud.google.com"
