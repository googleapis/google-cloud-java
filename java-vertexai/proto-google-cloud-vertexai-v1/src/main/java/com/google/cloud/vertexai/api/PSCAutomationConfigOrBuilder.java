...
public interface PSCAutomationConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.PSCAutomationConfig)
   ...
   *
   * <code>
   * .google.cloud.vertexai.v1.PSCAutomationState state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The state.
   */
  com.google.cloud.vertexai.api.PSCAutomationState getState();
