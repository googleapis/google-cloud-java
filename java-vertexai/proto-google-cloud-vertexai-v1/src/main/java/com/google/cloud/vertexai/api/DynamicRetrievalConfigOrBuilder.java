...
public interface DynamicRetrievalConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.DynamicRetrievalConfig)
   ...
   * @return The mode.
   */
  com.google.cloud.vertexai.api.DynamicRetrievalConfig.Mode getMode();
