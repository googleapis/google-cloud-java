...
public interface FunctionCallOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.FunctionCall)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vertexai.api.PartialArg> getPartialArgsList();
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.PartialArg getPartialArgs(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.vertexai.api.PartialArgOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.PartialArgOrBuilder getPartialArgsOrBuilder(int index);
