...
public interface GoogleDriveSourceOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.GoogleDriveSource)
   ...
   *
   * <code>
   * repeated .google.cloud.vertexai.v1.GoogleDriveSource.ResourceId resource_ids = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   */
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.GoogleDriveSource.ResourceIdOrBuilder getResourceIdsOrBuilder(
      int index);
}
