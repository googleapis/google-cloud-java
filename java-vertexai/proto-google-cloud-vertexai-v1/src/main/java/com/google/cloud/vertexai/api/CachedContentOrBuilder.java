...
public interface CachedContentOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.CachedContent)
   ...
   *
   * <code>
   * .google.cloud.vertexai.v1.EncryptionSpec encryption_spec = 13 [(.google.api.field_behavior) = INPUT_ONLY, (.google.api.field_behavior) = IMMUTABLE];
   * </code>
   *
   ...
   */
  com.google.cloud.vertexai.api.EncryptionSpec getEncryptionSpec();
  /**
   *
   *
   * <pre>
