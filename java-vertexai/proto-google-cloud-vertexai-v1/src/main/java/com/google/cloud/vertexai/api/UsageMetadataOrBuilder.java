...
public interface UsageMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.UsageMetadata)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vertexai.api.ModalityTokenCount> getCandidatesTokensDetailsList();
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.ModalityTokenCount getToolUsePromptTokensDetails(int index);
   ...
   * </code>
   */
  com.google.cloud.vertexai.api.ModalityTokenCountOrBuilder getToolUsePromptTokensDetailsOrBuilder(
      int index);
   ...
   */
  com.google.cloud.vertexai.api.UsageMetadata.TrafficType getTrafficType();
}
