...
public interface FunctionCallingConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vertexai.v1.FunctionCallingConfig)
   ...
   * @return The mode.
   */
  com.google.cloud.vertexai.api.FunctionCallingConfig.Mode getMode();
