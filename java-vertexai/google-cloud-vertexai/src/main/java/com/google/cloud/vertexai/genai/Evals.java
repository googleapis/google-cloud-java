...
public final class Evals {
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode customCodeExecutionSpecFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper().createObjectNode();
    if (Common.getValueByPath(fromObject, new String[] {"evaluation_function"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"remoteCustomFunction"},
          Common.getValueByPath(fromObject, new String[] {"evaluation_function"}));
    }

    if (Common.getValueByPath(fromObject, new String[] {"evaluationFunction"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"evaluationFunction"},
          Common.getValueByPath(fromObject, new String[] {"evaluationFunction"}));
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode evaluationRunConfigFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper().createObjectNode();
    if (Common.getValueByPath(fromObject, new String[] {"metrics"}) != null) {
      ArrayNode keyArray = (ArrayNode) Common.getValueByPath(fromObject, new String[] {"metrics"});
      ObjectMapper objectMapper = new ObjectMapper();
      ArrayNode result = objectMapper.createArrayNode();

      for (JsonNode item : keyArray) {
        result.add(evaluationRunMetricFromVertex(JsonSerializable.toJsonNode(item), toObject));
      }
      Common.setValueByPath(toObject, new String[] {"metrics"}, result);
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode evaluationRunMetricFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper().createObjectNode();
    if (Common.getValueByPath(fromObject, new String[] {"metric"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"metric"},
          Common.getValueByPath(fromObject, new String[] {"metric"}));
    }

    if (Common.getValueByPath(fromObject, new String[] {"metricConfig"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"metricConfig"},
          unifiedMetricFromVertex(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"metricConfig"})),
              toObject));
    }
  ...
  ObjectNode metricToVertex(JsonNode fromObject, ObjectNode parentObject) {
    ...
    if (Common.getValueByPath(fromObject, new String[] {"remoteCustomFunction"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"custom_code_execution_spec", "evaluation_function"},
          Common.getValueByPath(fromObject, new String[] {"remoteCustomFunction"}));
    }
  ...
  @ExcludeFromGeneratedCoverageReport
  ObjectNode unifiedMetricFromVertex(JsonNode fromObject, ObjectNode parentObject) {
    ObjectNode toObject = JsonSerializable.objectMapper().createObjectNode();

    if (Common.getValueByPath(fromObject, new String[] {"llmBasedMetricSpec"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"llmBasedMetricSpec"},
          Common.getValueByPath(fromObject, new String[] {"llmBasedMetricSpec"}));
    }

    if (Common.getValueByPath(fromObject, new String[] {"customCodeExecutionSpec"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"customCodeExecutionSpec"},
          customCodeExecutionSpecFromVertex(
              JsonSerializable.toJsonNode(
                  Common.getValueByPath(fromObject, new String[] {"customCodeExecutionSpec"})),
              toObject));
    }

    if (Common.getValueByPath(fromObject, new String[] {"predefinedMetricSpec"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"predefinedMetricSpec"},
          Common.getValueByPath(fromObject, new String[] {"predefinedMetricSpec"}));
    }

    if (Common.getValueByPath(fromObject, new String[] {"computationBasedMetricSpec"}) != null) {
      Common.setValueByPath(
          toObject,
          new String[] {"computationBasedMetricSpec"},
          Common.getValueByPath(fromObject, new String[] {"computationBasedMetricSpec"}));
    }
