...
import com.google.cloud.vertexai.v1.stub.PredictionServiceStub;
import com.google.cloud.vertexai.v1.stub.PredictionServiceStubSettings;
...
public class PredictionServiceClient implements BackgroundResource {
   ...
   *
   * <ul>
   *   <li>`X-Vertex-AI-Endpoint-Id`: ID of the [Endpoint][google.cloud.vertexai.v1.Endpoint] that
   *       served this prediction.
   * </ul>
   *
   * <ul>
   *   <li>`X-Vertex-AI-Deployed-Model-Id`: ID of the Endpoint's
   *       [DeployedModel][google.cloud.vertexai.v1.DeployedModel] that served this prediction.
   * </ul>
   *
   * <p>Sample code:
   *
   ...
   *     <p>A [DeployedModel][google.cloud.vertexai.v1.DeployedModel] may have an upper limit on the
   *     number of instances it supports per request. When this limit it is exceeded for an AutoML
   *     model, the [RawPredict][google.cloud.vertexai.v1.PredictionService.RawPredict] method
   *     returns an error. When this limit is exceeded for a custom-trained model, the behavior
   ...
   *     field when you create a [Model][google.cloud.vertexai.v1.Model]. This schema applies when
   *     you deploy the `Model` as a `DeployedModel` to an
   *     [Endpoint][google.cloud.vertexai.v1.Endpoint] and use the `RawPredict` method.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
   ...
   *
   * <p>If [deployed_model_id][google.cloud.vertexai.v1.ExplainRequest.deployed_model_id] is
   * specified, the corresponding DeployModel must have
   * [explanation_spec][google.cloud.vertexai.v1.DeployedModel.explanation_spec] populated. If
   * [deployed_model_id][google.cloud.vertexai.v1.ExplainRequest.deployed_model_id] is not
