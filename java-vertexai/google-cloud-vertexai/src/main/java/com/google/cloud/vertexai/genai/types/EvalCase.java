...
public abstract class EvalCase extends JsonSerializable {
  ...
  /**
   * This field is experimental and may change in future versions. The agent data of the agent under
   * evaluation.
   */
  ...
  public abstract static class Builder {
     ...
     *
     * <p>agentData: This field is experimental and may change in future versions. The agent data of
