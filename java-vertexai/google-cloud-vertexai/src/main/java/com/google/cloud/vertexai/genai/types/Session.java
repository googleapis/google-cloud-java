...
public abstract class Session extends JsonSerializable {
  ...
  public abstract static class Builder {
     ...
     * *always* provided on output, regardless of what was sent on input. The minimum value is 24
     ...
     * Setter for ttl.
     *
     * <p>ttl: Optional. Input only. The TTL for this session. The minimum value is 24 hours.
     */
    @JsonProperty("ttl")
