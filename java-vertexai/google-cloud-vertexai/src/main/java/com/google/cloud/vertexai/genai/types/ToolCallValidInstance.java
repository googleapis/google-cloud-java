...
@AutoValue
@JsonDeserialize(builder = ToolCallValidInstance.Builder.class)
public abstract class ToolCallValidInstance extends JsonSerializable {
  ...
  /** Instantiates a builder for ToolCallValidInstance. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ToolCallValidInstance.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ToolCallValidInstance. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ToolCallValidInstance.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ToolCallValidInstance build();
  }

  /** Deserializes a JSON string to a ToolCallValidInstance object. */
  @ExcludeFromGeneratedCoverageReport
  public static ToolCallValidInstance fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ToolCallValidInstance.class);
  }
}
