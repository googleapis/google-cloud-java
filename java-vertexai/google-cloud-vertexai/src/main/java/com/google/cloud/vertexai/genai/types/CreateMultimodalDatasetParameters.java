...
@AutoValue
@InternalApi
@JsonDeserialize(builder = CreateMultimodalDatasetParameters.Builder.class)
public abstract class CreateMultimodalDatasetParameters extends JsonSerializable {
  /** */
  @JsonProperty("name")
  ...
  /** */
  @JsonProperty("config")
  public abstract Optional<CreateMultimodalDatasetConfig> config();

  /** Instantiates a builder for CreateMultimodalDatasetParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_CreateMultimodalDatasetParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for CreateMultimodalDatasetParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `CreateMultimodalDatasetParameters.builder()` for
     * instantiation.
     */
    @JsonCreator
     ...
     */
    @JsonProperty("config")
    public abstract Builder config(CreateMultimodalDatasetConfig config);
     ...
     */
    @CanIgnoreReturnValue
    public Builder config(CreateMultimodalDatasetConfig.Builder configBuilder) {
      return config(configBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder config(Optional<CreateMultimodalDatasetConfig> config);
    ...
    public abstract CreateMultimodalDatasetParameters build();
  }

  /** Deserializes a JSON string to a CreateMultimodalDatasetParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static CreateMultimodalDatasetParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, CreateMultimodalDatasetParameters.class);
  }
}
