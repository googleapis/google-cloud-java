...
@AutoValue
@JsonDeserialize(builder = PromptVersionRef.Builder.class)
public abstract class PromptVersionRef extends JsonSerializable {
  /** */
  ...
  /** Instantiates a builder for PromptVersionRef. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_PromptVersionRef.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for PromptVersionRef. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `PromptVersionRef.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract PromptVersionRef build();
  }

  /** Deserializes a JSON string to a PromptVersionRef object. */
  @ExcludeFromGeneratedCoverageReport
  public static PromptVersionRef fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, PromptVersionRef.class);
  }
}
