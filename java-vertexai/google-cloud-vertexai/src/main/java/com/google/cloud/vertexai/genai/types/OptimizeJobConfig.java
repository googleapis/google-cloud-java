...
@AutoValue
@JsonDeserialize(builder = OptimizeJobConfig.Builder.class)
public abstract class OptimizeJobConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for OptimizeJobConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_OptimizeJobConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for OptimizeJobConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `OptimizeJobConfig.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract OptimizeJobConfig build();
  }

  /** Deserializes a JSON string to a OptimizeJobConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static OptimizeJobConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, OptimizeJobConfig.class);
  }
}
