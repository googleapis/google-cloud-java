...
@AutoValue
@JsonDeserialize(builder = DeletePromptOperation.Builder.class)
public abstract class DeletePromptOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeletePromptOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeletePromptOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeletePromptOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `DeletePromptOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract DeletePromptOperation build();
  }

  /** Deserializes a JSON string to a DeletePromptOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeletePromptOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeletePromptOperation.class);
  }
}
