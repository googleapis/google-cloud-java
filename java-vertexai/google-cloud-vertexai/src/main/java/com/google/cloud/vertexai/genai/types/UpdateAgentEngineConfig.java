...
@AutoValue
@JsonDeserialize(builder = UpdateAgentEngineConfig.Builder.class)
public abstract class UpdateAgentEngineConfig extends JsonSerializable {
  ...
  public abstract Optional<ReasoningEngineSpecSourceCodeSpecDeveloperConnectConfig>
  ...
  /** Instantiates a builder for UpdateAgentEngineConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_UpdateAgentEngineConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for UpdateAgentEngineConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `UpdateAgentEngineConfig.builder()` for instantiation. */
    @JsonCreator
     ...
     * Setter for spec.
     *
     * <p>spec: Optional. Configurations of the Agent Engine.
     */
    @JsonProperty("spec")
     ...
     *
     * <p>contextSpec: Optional. The context spec to be used for the Agent Engine.
     */
    @JsonProperty("contextSpec")
     ...
     *
     * <p>pscInterfaceConfig: Optional. The PSC interface config for PSC-I to be used for the Agent
     * Engine.
     */
    @JsonProperty("pscInterfaceConfig")
     ...
     *
     * <p>developerConnectSource: Specifies the configuration for fetching source code from a Git
     * repository that is managed by Developer Connect. This includes the repository, revision, and
     * directory to use.
     */
    @JsonProperty("developerConnectSource")
    public abstract Builder developerConnectSource(
        ReasoningEngineSpecSourceCodeSpecDeveloperConnectConfig developerConnectSource);
    ...
    public Builder developerConnectSource(
        ReasoningEngineSpecSourceCodeSpecDeveloperConnectConfig.Builder
    ...
    public abstract UpdateAgentEngineConfig build();
  }

  /** Deserializes a JSON string to a UpdateAgentEngineConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static UpdateAgentEngineConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, UpdateAgentEngineConfig.class);
  }
}
