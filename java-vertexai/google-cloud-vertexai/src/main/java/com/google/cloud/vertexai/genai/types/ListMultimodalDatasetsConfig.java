...
@AutoValue
@JsonDeserialize(builder = ListMultimodalDatasetsConfig.Builder.class)
public abstract class ListMultimodalDatasetsConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListMultimodalDatasetsConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListMultimodalDatasetsConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListMultimodalDatasetsConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `ListMultimodalDatasetsConfig.builder()` for instantiation.
     */
    @JsonCreator
    ...
    public abstract ListMultimodalDatasetsConfig build();
  }

  /** Deserializes a JSON string to a ListMultimodalDatasetsConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListMultimodalDatasetsConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListMultimodalDatasetsConfig.class);
  }
}
