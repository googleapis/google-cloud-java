...
/** Rouge instance. */
@AutoValue
@JsonDeserialize(builder = RougeInstance.Builder.class)
public abstract class RougeInstance extends JsonSerializable {
  ...
  /** Instantiates a builder for RougeInstance. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_RougeInstance.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for RougeInstance. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `RougeInstance.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract RougeInstance build();
  }

  /** Deserializes a JSON string to a RougeInstance object. */
  @ExcludeFromGeneratedCoverageReport
  public static RougeInstance fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, RougeInstance.class);
  }
}
