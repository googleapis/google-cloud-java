...
public abstract class Metric extends JsonSerializable {
  ...
  /**
   * The evaluation function for the custom code execution metric. This custom code is run remotely
   * in the evaluation service.
   */
  ...
  public abstract static class Builder {
     ...
     *
     * <p>remoteCustomFunction: The evaluation function for the custom code execution metric. This
     * custom code is run remotely in the evaluation service.
     */
    @JsonProperty("remoteCustomFunction")
