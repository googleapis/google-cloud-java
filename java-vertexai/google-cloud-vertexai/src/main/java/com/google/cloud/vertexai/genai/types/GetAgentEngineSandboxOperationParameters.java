...
@AutoValue
@InternalApi
@JsonDeserialize(builder = GetAgentEngineSandboxOperationParameters.Builder.class)
public abstract class GetAgentEngineSandboxOperationParameters extends JsonSerializable {
  ...
  /** Instantiates a builder for GetAgentEngineSandboxOperationParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_GetAgentEngineSandboxOperationParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GetAgentEngineSandboxOperationParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GetAgentEngineSandboxOperationParameters.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract GetAgentEngineSandboxOperationParameters build();
  }

  /** Deserializes a JSON string to a GetAgentEngineSandboxOperationParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static GetAgentEngineSandboxOperationParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(
        jsonString, GetAgentEngineSandboxOperationParameters.class);
  }
}
