...
public abstract class OptimizeResponse extends JsonSerializable {
  ...
  public abstract Optional<ParsedResponseUnion> parsedResponse();
  ...
  public abstract static class Builder {
     ...
     */
    @JsonProperty("parsedResponse")
    public abstract Builder parsedResponse(ParsedResponseUnion parsedResponse);

    @ExcludeFromGeneratedCoverageReport
    abstract Builder parsedResponse(Optional<ParsedResponseUnion> parsedResponse);
