...
@AutoValue
@JsonDeserialize(builder = ExactMatchInstance.Builder.class)
public abstract class ExactMatchInstance extends JsonSerializable {
  ...
  /** Instantiates a builder for ExactMatchInstance. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ExactMatchInstance.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ExactMatchInstance. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `ExactMatchInstance.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract ExactMatchInstance build();
  }

  /** Deserializes a JSON string to a ExactMatchInstance object. */
  @ExcludeFromGeneratedCoverageReport
  public static ExactMatchInstance fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ExactMatchInstance.class);
  }
}
