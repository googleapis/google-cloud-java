...
public abstract class MachineSpec extends JsonSerializable {
   ...
   * infrastructure.
   */
  @JsonProperty("minGpuDriverVersion")
  public abstract Optional<String> minGpuDriverVersion();
  ...
  public abstract static class Builder {
     ...
     *
     * <p>acceleratorCount: The number of accelerators to attach to the machine. For accelerator
     * optimized machine types
     * (https://cloud.google.com/compute/docs/accelerator-optimized-machines), One may set the
     * accelerator_count from 1 to N for machine with N GPUs. If accelerator_count is less than or
     * equal to N / 2, Vertex will co-schedule the replicas of the model into the same VM to save
     * cost. For example, if the machine type is a3-highgpu-8g, which has 8 H100 GPUs, one can set
     * accelerator_count to 1 to 8. If accelerator_count is 1, 2, 3, or 4, Vertex will co-schedule
     ...
     * expect a co-scheduled replica requesting 2 GPUs out of a 8-GPU VM will receive 25% of the
     * CPU, memory and storage of the VM. Note that the feature is not compatible with
    ...
    /**
     * Setter for minGpuDriverVersion.
     *
     * <p>minGpuDriverVersion: Optional. Immutable. The minimum GPU driver version that this machine
     * requires. For example, "535.104.06". If not specified, the default GPU driver version will be
     * used by the underlying infrastructure.
     */
    @JsonProperty("minGpuDriverVersion")
    public abstract Builder minGpuDriverVersion(String minGpuDriverVersion);

    @ExcludeFromGeneratedCoverageReport
    abstract Builder minGpuDriverVersion(Optional<String> minGpuDriverVersion);

    /** Clears the value of minGpuDriverVersion field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    public Builder clearMinGpuDriverVersion() {
      return minGpuDriverVersion(Optional.empty());
    }
