...
/** None */
@AutoValue
@JsonDeserialize(builder = EvaluateDatasetOperation.Builder.class)
public abstract class EvaluateDatasetOperation extends JsonSerializable {
  /**
  ...
  public abstract Optional<EvaluationDataset> response();

  /** Instantiates a builder for EvaluateDatasetOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_EvaluateDatasetOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for EvaluateDatasetOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `EvaluateDatasetOperation.builder()` for instantiation. */
    @JsonCreator
     ...
     */
    @JsonProperty("response")
    public abstract Builder response(EvaluationDataset response);
     ...
     */
    @CanIgnoreReturnValue
    public Builder response(EvaluationDataset.Builder responseBuilder) {
      return response(responseBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder response(Optional<EvaluationDataset> response);
    ...
    public abstract EvaluateDatasetOperation build();
  }

  /** Deserializes a JSON string to a EvaluateDatasetOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static EvaluateDatasetOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, EvaluateDatasetOperation.class);
  }
}
