...
@AutoValue
@InternalApi
@JsonDeserialize(builder = UpdateDatasetParameters.Builder.class)
public abstract class UpdateDatasetParameters extends JsonSerializable {
  /** */
  @JsonProperty("name")
  ...
  /** */
  @JsonProperty("config")
  public abstract Optional<UpdateDatasetConfig> config();

  /** Instantiates a builder for UpdateDatasetParameters. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_UpdateDatasetParameters.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for UpdateDatasetParameters. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `UpdateDatasetParameters.builder()` for instantiation. */
    @JsonCreator
     ...
     */
    @JsonProperty("config")
    public abstract Builder config(UpdateDatasetConfig config);
     ...
     */
    @CanIgnoreReturnValue
    public Builder config(UpdateDatasetConfig.Builder configBuilder) {
      return config(configBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder config(Optional<UpdateDatasetConfig> config);
    ...
    public abstract UpdateDatasetParameters build();
  }

  /** Deserializes a JSON string to a UpdateDatasetParameters object. */
  @ExcludeFromGeneratedCoverageReport
  public static UpdateDatasetParameters fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, UpdateDatasetParameters.class);
  }
}
