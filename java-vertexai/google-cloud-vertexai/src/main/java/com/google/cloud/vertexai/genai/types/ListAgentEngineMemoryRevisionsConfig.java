...
@AutoValue
@JsonDeserialize(builder = ListAgentEngineMemoryRevisionsConfig.Builder.class)
public abstract class ListAgentEngineMemoryRevisionsConfig extends JsonSerializable {
  ...
  /** Instantiates a builder for ListAgentEngineMemoryRevisionsConfig. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_ListAgentEngineMemoryRevisionsConfig.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for ListAgentEngineMemoryRevisionsConfig. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `ListAgentEngineMemoryRevisionsConfig.builder()` for
     * instantiation.
     */
    @JsonCreator
    ...
    public abstract ListAgentEngineMemoryRevisionsConfig build();
  }

  /** Deserializes a JSON string to a ListAgentEngineMemoryRevisionsConfig object. */
  @ExcludeFromGeneratedCoverageReport
  public static ListAgentEngineMemoryRevisionsConfig fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, ListAgentEngineMemoryRevisionsConfig.class);
  }
}
