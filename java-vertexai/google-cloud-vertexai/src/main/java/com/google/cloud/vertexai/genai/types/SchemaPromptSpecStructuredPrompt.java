...
public abstract class SchemaPromptSpecStructuredPrompt extends JsonSerializable {
  ...
  @JsonProperty("appBuilderData")
  public abstract Optional<SchemaPromptSpecAppBuilderData> appBuilderData();
  ...
  public abstract static class Builder {
    ...
    /**
     * Setter for appBuilderData.
     *
     * <p>appBuilderData: Data for app builder use case.
     */
    @JsonProperty("appBuilderData")
    public abstract Builder appBuilderData(SchemaPromptSpecAppBuilderData appBuilderData);

    /**
     * Setter for appBuilderData builder.
     *
     * <p>appBuilderData: Data for app builder use case.
     */
    @CanIgnoreReturnValue
    public Builder appBuilderData(SchemaPromptSpecAppBuilderData.Builder appBuilderDataBuilder) {
      return appBuilderData(appBuilderDataBuilder.build());
    }

    @ExcludeFromGeneratedCoverageReport
    abstract Builder appBuilderData(Optional<SchemaPromptSpecAppBuilderData> appBuilderData);

    /** Clears the value of appBuilderData field. */
    @ExcludeFromGeneratedCoverageReport
    @CanIgnoreReturnValue
    public Builder clearAppBuilderData() {
      return appBuilderData(Optional.empty());
    }
