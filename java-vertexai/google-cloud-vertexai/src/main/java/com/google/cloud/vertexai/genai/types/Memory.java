...
public abstract class Memory extends JsonSerializable {
  ...
  /**
   * Optional. User-provided metadata for the Memory. This information was provided when creating,
   * updating, or generating the Memory. It was not generated by Memory Bank.
   */
  ...
  public abstract static class Builder {
     ...
     * Setter for metadata.
     *
     * <p>metadata: Optional. User-provided metadata for the Memory. This information was provided
     * when creating, updating, or generating the Memory. It was not generated by Memory Bank.
     */
    @JsonProperty("metadata")
     ...
     *
     * <p>revisionLabels: Optional. Input only. The labels to apply to the Memory Revision created
