...
@AutoValue
@JsonDeserialize(builder = DeleteAgentEngineOperation.Builder.class)
public abstract class DeleteAgentEngineOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeleteAgentEngineOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeleteAgentEngineOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeleteAgentEngineOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `DeleteAgentEngineOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract DeleteAgentEngineOperation build();
  }

  /** Deserializes a JSON string to a DeleteAgentEngineOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeleteAgentEngineOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeleteAgentEngineOperation.class);
  }
}
