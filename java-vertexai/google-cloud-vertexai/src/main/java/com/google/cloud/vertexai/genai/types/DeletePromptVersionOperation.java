...
@AutoValue
@JsonDeserialize(builder = DeletePromptVersionOperation.Builder.class)
public abstract class DeletePromptVersionOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DeletePromptVersionOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DeletePromptVersionOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DeletePromptVersionOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `DeletePromptVersionOperation.builder()` for instantiation.
     */
    @JsonCreator
    ...
    public abstract DeletePromptVersionOperation build();
  }

  /** Deserializes a JSON string to a DeletePromptVersionOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DeletePromptVersionOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DeletePromptVersionOperation.class);
  }
}
