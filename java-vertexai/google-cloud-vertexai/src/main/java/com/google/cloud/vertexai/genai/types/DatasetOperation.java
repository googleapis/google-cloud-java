...
@AutoValue
@JsonDeserialize(builder = DatasetOperation.Builder.class)
public abstract class DatasetOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for DatasetOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_DatasetOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for DatasetOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `DatasetOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract DatasetOperation build();
  }

  /** Deserializes a JSON string to a DatasetOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static DatasetOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, DatasetOperation.class);
  }
}
