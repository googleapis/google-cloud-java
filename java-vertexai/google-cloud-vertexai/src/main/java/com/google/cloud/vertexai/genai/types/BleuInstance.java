...
/** Bleu instance. */
@AutoValue
@JsonDeserialize(builder = BleuInstance.Builder.class)
public abstract class BleuInstance extends JsonSerializable {
  ...
  /** Instantiates a builder for BleuInstance. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_BleuInstance.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for BleuInstance. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `BleuInstance.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract BleuInstance build();
  }

  /** Deserializes a JSON string to a BleuInstance object. */
  @ExcludeFromGeneratedCoverageReport
  public static BleuInstance fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, BleuInstance.class);
  }
}
