...
public abstract class GenerateMemoriesRequestDirectContentsSourceEvent extends JsonSerializable {
  ...
  public static Builder builder() {
    return new AutoValue_GenerateMemoriesRequestDirectContentsSourceEvent.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for GenerateMemoriesRequestDirectContentsSourceEvent. */
  @AutoValue.Builder
  public abstract static class Builder {
    /**
     * For internal usage. Please use `GenerateMemoriesRequestDirectContentsSourceEvent.builder()`
     * for instantiation.
     */
    @JsonCreator
     ...
     * Setter for content.
     *
     * <p>content: Required. A single piece of content from which to generate memories.
     */
    @JsonProperty("content")
