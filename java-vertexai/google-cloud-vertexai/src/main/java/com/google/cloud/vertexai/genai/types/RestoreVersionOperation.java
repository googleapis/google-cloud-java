...
@AutoValue
@JsonDeserialize(builder = RestoreVersionOperation.Builder.class)
public abstract class RestoreVersionOperation extends JsonSerializable {
  /**
  ...
  /** Instantiates a builder for RestoreVersionOperation. */
  @ExcludeFromGeneratedCoverageReport
  public static Builder builder() {
    return new AutoValue_RestoreVersionOperation.Builder();
  }

  /** Creates a builder with the same values as this instance. */
  public abstract Builder toBuilder();

  /** Builder for RestoreVersionOperation. */
  @AutoValue.Builder
  public abstract static class Builder {
    /** For internal usage. Please use `RestoreVersionOperation.builder()` for instantiation. */
    @JsonCreator
    ...
    public abstract RestoreVersionOperation build();
  }

  /** Deserializes a JSON string to a RestoreVersionOperation object. */
  @ExcludeFromGeneratedCoverageReport
  public static RestoreVersionOperation fromJson(String jsonString) {
    return JsonSerializable.fromJsonString(jsonString, RestoreVersionOperation.class);
  }
}
