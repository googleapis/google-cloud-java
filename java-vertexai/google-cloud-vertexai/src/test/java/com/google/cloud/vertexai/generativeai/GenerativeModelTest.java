...
public final class GenerativeModelTest {
  ...
  @Test
  public void testGenerateContentAsyncWithContents() throws Exception {
    model = new GenerativeModel(MODEL_NAME, vertexAi);
  ...
  @Test
  public void testGenerateContentAsyncWithContentsAndGenerateContentConfig() throws Exception {
    model = new GenerativeModel(MODEL_NAME, vertexAi);
    ...
    ApiFuture<GenerateContentResponse> unused =
        model.generateContentAsync(Arrays.asList(content), config);
