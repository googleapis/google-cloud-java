...
import com.google.cloud.vertexai.api.stub.HttpJsonLlmUtilityServiceStub;
...
public class LlmUtilityServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static LlmUtilityServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonLlmUtilityServiceStub.getMethodDescriptors(),
            LlmUtilityServiceSettings.getDefaultEndpoint());
    LlmUtilityServiceSettings settings =
        LlmUtilityServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                LlmUtilityServiceSettings.defaultHttpJsonTransportProviderBuilder()
