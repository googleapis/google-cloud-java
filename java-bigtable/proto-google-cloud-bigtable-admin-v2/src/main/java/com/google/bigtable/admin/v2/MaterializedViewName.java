...
public class MaterializedViewName implements ResourceName {
  ...
  public static @Nullable MaterializedViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable MaterializedViewName> values) {
