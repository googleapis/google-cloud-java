  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\020retention_period\030\001 \001(\0132\031.google.protobuf.Duration\"\341\016\n"
          + "\005Table\022\014\n"
          ...
          + " \001(\01325.google.bigtable.admin.v2.Table.AutomatedBackupPolicyH\000\022e\n"
          + "!effective_automated_backup_policy\030\023"
          + " \001(\01325.google.bigtable.admin.v2.Table.AutomatedBackupPolicyB\003\340A\003\022L\n"
          + "\025tiered_storage_config\030\016"
          + " \001(\0132-.google.bigtable.admin.v2.TieredStorageConfig\022=\n"
          + "\016row_key_schema\030\017"
          + " \001(\0132%.google.bigtable.admin.v2.Type.Struct\032\306\002\n"
          + "\014ClusterState\022]\n"
          + "\021replication_state\030\001 \001(\0162=.google.bigtable.admi"
          + "n.v2.Table.ClusterState.ReplicationStateB\003\340A\003\022F\n"
          + "\017encryption_info\030\002 \003(\0132(.google."
          + "bigtable.admin.v2.EncryptionInfoB\003\340A\003\"\216\001\n"
          ...
          + "\020READY_OPTIMIZING\020\005\032\217\002\n"
          ...
          + "\021keep_hot_duration\030\004"
          + " \001(\0132\031.google.protobuf.DurationB\003\340A\001\022\025\n"
          + "\010disabled\030\005 \001(\010B\003\340A\001\032b\n"
          ...
          + "\005value\030\002 \001(\0132&.google.bigtable.admin.v2.ColumnFamily:\0028\001\"U\n"
          ...
          + "apis.com/Table\0226projects/{project}/instances/{instance}/tables/{table}B\031\n"
          + "\027automated_backup_config\"\343\005\n"
          + "\016AuthorizedView\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022J\n"
          + "\013subset_view\030\002 \001(\01323.g"
          + "oogle.bigtable.admin.v2.AuthorizedView.SubsetViewH\000\022\014\n"
          ...
          + "\016family_subsets\030\002 \003(\0132F.google.bigtable.a"
          + "dmin.v2.AuthorizedView.SubsetView.FamilySubsetsEntry\032l\n"
          + "\022FamilySubsetsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022E\n"
          + "\005value\030\002 \001(\01326.google.bigtable"
          + ".admin.v2.AuthorizedView.FamilySubsets:\0028\001\"Q\n"
          ...
          + "+bigtableadmin.googleapis.com/AuthorizedView\022Xprojects/{project}/in"
          + "stances/{instance}/tables/{table}/author"
          + "izedViews/{authorized_view}*\017authorizedViews2\016authorizedViewB\021\n"
          ...
          + "\017encryption_type\030\003 \001(\01627.google.bigt"
          + "able.admin.v2.EncryptionInfo.EncryptionTypeB\003\340A\003\0222\n"
          ...
          + "\005state\030\006"
          + " \001(\0162(.google.bigtable.admin.v2.Snapshot.StateB\003\340A\003\022\023\n"
          + "\013description\030\007 \001(\t\"5\n"
          + "\005State\022\023\n"
          + "\017STATE_NOT_KNOWN\020\000\022\t\n"
          + "\005READY\020\001\022\014\n"
          + "\010CREATING\020\002:{\352Ax\n"
          + "%bigtableadmin.googleapis.com/Snapshot\022Oprojects/{project}/instanc"
          + "es/{instance}/clusters/{cluster}/snapshots/{snapshot}\"\371\005\n"
          + "\006Backup\022\014\n"
          ...
          + "\005state\030\007"
          + " \001(\0162&.google.bigtable.admin.v2.Backup.StateB\003\340A\003\022F\n"
          ...
          + "#bigtableadmin.googleapis.com/Backup\022Kprojects/{project}"
          + "/instances/{instance}/clusters/{cluster}/backups/{backup}\"\300\001\n\n"
          + "BackupInfo\022\023\n"
          ...
          + "\021proto_descriptors\030\002 \001(\014B\003\340A\002\"\'\n\n"
          + "AvroSchema\022\031\n"
          + "\014json_schemas\030\001 \003(\tB\003\340A\002\"\342\002\n"
          + "\014SchemaBundle\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022=\n"
          + "\014proto_schema\030\002 \001(\0132%.google.bigtable.admin.v2.ProtoSchemaH\000\022@\n"
          + "\013avro_schema\030\006"
          + " \001(\0132$.google.bigtable.admin.v2.AvroSchemaB\003\340A\001H\000\022\021\n"
          + "\004etag\030\003 \001(\tB\003\340A\001:\242\001\352A\236\001\n"
          + ")bigtableadmin.googleapis.com/SchemaBundle\022T"
          + "projects/{project}/instances/{instance}/"
          + "tables/{table}/schemaBundles/{schema_bundle}*\r"
          ...
          + "V2\352\002\"Google::Cloud::Bigtable::Admin::V2\352A\246\001\n"
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022zprojects/{project}/locations/{loc"
          + "ation}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key"
    ...
    internal_static_google_bigtable_admin_v2_Table_AutomatedBackupPolicy_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_bigtable_admin_v2_Table_AutomatedBackupPolicy_descriptor,
            new java.lang.String[] {
              "RetentionPeriod", "Frequency", "Locations", "KeepHotDuration", "Disabled",
            });
    internal_static_google_bigtable_admin_v2_Table_ClusterStatesEntry_descriptor =
