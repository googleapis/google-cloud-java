  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\0132,.google.bigtable.admin.v2.Table.ClusterState:\0028\001\032]\n"
          ...
          + "\"bigtableadmin.goo"
          + "gleapis.com/Table\0226projects/{project}/instances/{instance}/tables/{table}B\031\n"
          + "\027automated_backup_config\"\343\005\n"
          + "\016AuthorizedView\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022J\n"
          + "\013subset_view\030\002 \001(\0132"
          + "3.google.bigtable.admin.v2.AuthorizedView.SubsetViewH\000\022\014\n"
          ...
          + "\016family_subsets\030\002 \003(\0132F.google.bigtabl"
          + "e.admin.v2.AuthorizedView.SubsetView.FamilySubsetsEntry\032l\n"
          + "\022FamilySubsetsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022E\n"
          + "\005value\030\002 \001(\01326.google.bigta"
          + "ble.admin.v2.AuthorizedView.FamilySubsets:\0028\001\"Q\n"
          ...
          + "+bigtableadmin.googleapis.com/AuthorizedView\022Xprojects/{project}"
          + "/instances/{instance}/tables/{table}/aut"
          + "horizedViews/{authorized_view}*\017authorizedViews2\016authorizedViewB\021\n"
          ...
          + "\017encryption_type\030\003 \001(\01627.google.b"
          + "igtable.admin.v2.EncryptionInfo.EncryptionTypeB\003\340A\003\0222\n"
          ...
          + "%bigtableadmin.googleapis.com/Snapshot\022Oprojects/{project}/inst"
          + "ances/{instance}/clusters/{cluster}/snapshots/{snapshot}\"\371\005\n"
          + "\006Backup\022\014\n"
          ...
          + "#bigtableadmin.googleapis.com/Backup\022Kprojects/{proje"
          + "ct}/instances/{instance}/clusters/{cluster}/backups/{backup}\"\300\001\n\n"
          + "BackupInfo\022\023\n"
          ...
          + ")bigtableadmin.googleapis.com/SchemaBundle\022Tprojects/{project}/insta"
          + "nces/{instance}/tables/{table}/schemaBundles/{schema_bundle}*\r"
          ...
          + "\\Bigtable\\Admin\\V2\352\002\"Google::Cloud::Bigtable::Admin::V2\352A\246\001\n"
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022zprojects/{project"
          + "}/locations/{location}/keyRings/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVers"
