...
public abstract class TableName {
  ...
  public static TableName of(String projectId, String instanceId, String tableId) {
    return builder().setProjectId(projectId).setInstanceId(instanceId).setTableId(tableId).build();
  }
