  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\007entries\030\002"
          + " \003(\0132+.google.bigtable.v2.MutateRowsRequest.EntryB\003\340A\002\032\204\001\n"
          + "\005Entry\022\017\n"
          ...
          + "\017rate_limit_info\030\003 \001(\0132!"
          + ".google.bigtable.v2.RateLimitInfoH\000\210\001\001\032:\n"
          + "\005Entry\022\r\n"
          ...
          + "\013param_types\030\006"
          + " \003(\01327.google.bigtable.v2.PrepareQueryRequest.ParamTypesEntryB\003\340A\002\032K\n"
          ...
          + "\010ReadRows\022#.google.b"
          + "igtable.v2.ReadRowsRequest\032$.google.bigtable.v2.ReadRowsResponse\"\373\003\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002\361\001\"9/v2"
          + "/{table_name=projects/*/instances/*/tables/*}:readRows:\001*ZZ\"U/v2/{authorized_vie"
          + "w_name=projects/*/instances/*/tables/*/authorizedViews/*}:readRows:\001*ZU\"P/v2/{ma"
          + "terialized_view_name=projects/*/instance"
          + "s/*/materializedViews/*}:readRows:\001*\212\323\344\223\002\323\001\022:\n\n"
          ...
          + "SampleRowKeys\022(.google.bigtable.v2.SampleRowKeysRequest\032).g"
          + "oogle.bigtable.v2.SampleRowKeysResponse\"\201\004\332A\n"
          + "table_name\332A\031table_name,app_profile"
          + "_id\202\323\344\223\002\367\001\022>/v2/{table_name=projects/*/i"
          + "nstances/*/tables/*}:sampleRowKeysZ\\\022Z/v2/{authorized_view_name=projects/*/insta"
          + "nces/*/tables/*/authorizedViews/*}:sampleRowKeysZW\022U/v2/{materialized_view_name="
          + "projects/*/instances/*/materializedViews/*}:sampleRowKeys\212\323\344\223\002\323\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_view_name\022/{table_name=projects/*/instances/*/tables/*}/**\022:\n"
          + "\026materialized_view_name\022 {name=projects/*/instances/*}/**0\001\022\351\003\n"
          + "\tMutateRow\022$.google.bigtable.v2.MutateRowRequest\032%.google.bigtable.v2.MutateRow"
          + "Response\"\216\003\332A\034table_name,row_key,mutatio"
          + "ns\332A+table_name,row_key,mutations,app_pr"
          + "ofile_id\202\323\344\223\002\234\001\":/v2/{table_name=project"
          + "s/*/instances/*/tables/*}:mutateRow:\001*Z[\"V/v2/{authorized_view_name=projects/*/i"
          + "nstances/*/tables/*/authorizedViews/*}:mutateRow:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_view_name"
          + "\022/{table_name=projects/*/instances/*/tables/*}/**\022\334\003\n\n"
          + "MutateRows\022%.google.bigtable.v2.MutateRowsRequest\032&.google.bigtabl"
          + "e.v2.MutateRowsResponse\"\374\002\332A\022table_name,"
          + "entries\332A!table_name,entries,app_profile"
          + "_id\202\323\344\223\002\236\001\";/v2/{table_name=projects/*/i"
          + "nstances/*/tables/*}:mutateRows:\001*Z\\\"W/v2/{authorized_view_name=projects/*/insta"
          + "nces/*/tables/*/authorizedViews/*}:mutateRows:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_view_name\022/{"
          + "table_name=projects/*/instances/*/tables/*}/**0\001\022\335\004\n"
          + "\021CheckAndMutateRow\022,.google.bigtable.v2.CheckAndMutateRowRequest\032-.g"
          + "oogle.bigtable.v2.CheckAndMutateRowRespo"
          + "nse\"\352\003\332ABtable_name,row_key,predicate_fi"
          + "lter,true_mutations,false_mutations\332AQtable_name,row_key,predicate_filter,true_m"
          + "utations,false_mutations,app_profile_id\202"
          + "\323\344\223\002\254\001\"B/v2/{table_name=projects/*/insta"
          + "nces/*/tables/*}:checkAndMutateRow:\001*Zc\"^/v2/{authorized_view_name=projects/*/in"
          + "stances/*/tables/*/authorizedViews/*}:checkAndMutateRow:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_vi"
          + "ew_name\022/{table_name=projects/*/instances/*/tables/*}/**\022\356\001\n"
          + "\013PingAndWarm\022&.google.bigtable.v2.PingAndWarmRequest\032\'.googl"
          + "e.bigtable.v2.PingAndWarmResponse\"\215\001\332A\004n"
          + "ame\332A\023name,app_profile_id\202\323\344\223\002+\"&/v2/{na"
          + "me=projects/*/instances/*}:ping:\001*\212\323\344\223\0029\022%\n"
          + "\004name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\216\004\n"
          + "\022ReadModifyWriteRow\022-.google.bigtable.v2.ReadModifyWriteRow"
          + "Request\032..google.bigtable.v2.ReadModifyW"
          + "riteRowResponse\"\230\003\332A\030table_name,row_key,"
          + "rules\332A\'table_name,row_key,rules,app_pro"
          + "file_id\202\323\344\223\002\256\001\"C/v2/{table_name=projects"
          + "/*/instances/*/tables/*}:readModifyWriteRow:\001*Zd\"_/v2/{authorized_view_name=proj"
          + "ects/*/instances/*/tables/*/authorizedViews/*}:readModifyWriteRow:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024aut"
          + "horized_view_name\022/{table_name=projects/*/instances/*/tables/*}/**\022\273\002\n"
          + "%GenerateInitialChangeStreamPartitions\022@.google.bi"
          + "gtable.v2.GenerateInitialChangeStreamPartitionsRequest\032A.google.bigtable.v2.Gene"
          + "rateInitialChangeStreamPartitionsResponse\"\212\001\332A\n"
          + "table_name\332A\031table_name,app_profi"
          + "le_id\202\323\344\223\002[\"V/v2/{table_name=projects/*/"
          + "instances/*/tables/*}:generateInitialChangeStreamPartitions:\001*0\001\022\346\001\n"
          + "\020ReadChangeStream\022+.google.bigtable.v2.ReadChangeStr"
          + "eamRequest\032,.google.bigtable.v2.ReadChangeStreamResponse\"u\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002F\"A/v2/{table_na"
          + "me=projects/*/instances/*/tables/*}:readChangeStream:\001*0\001\022\251\002\n"
          + "\014PrepareQuery\022\'.google.bigtable.v2.PrepareQueryRequest\032(.go"
          + "ogle.bigtable.v2.PrepareQueryResponse\"\305\001"
          + "\332A\023instance_name,query\332A\"instance_name,q"
          + "uery,app_profile_id\202\323\344\223\002<\"7/v2/{instance"
          + "_name=projects/*/instances/*}:prepareQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\253\002\n"
          + "\014ExecuteQuery\022\'.google.bigtable.v2.Exec"
          + "uteQueryRequest\032(.google.bigtable.v2.Exe"
          + "cuteQueryResponse\"\305\001\332A\023instance_name,que"
          + "ry\332A\"instance_name,query,app_profile_id\202"
          + "\323\344\223\002<\"7/v2/{instance_name=projects/*/instances/*}:executeQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id0\001\022v\n"
          + "\026GetClientConfiguration\0221.google.bigtable.v2.GetClientConf"
          + "igurationRequest\032\'.google.bigtable.v2.ClientConfiguration\"\000\022`\n"
          + "\tOpenTable\022\".googl"
          + "e.bigtable.v2.SessionRequest\032#.google.bigtable.v2.SessionResponse\"\006\240\320\245\216\004\001(\0010\001\022i\n"
          + "\022OpenAuthorizedView\022\".google.bigtable.v2"
          + ".SessionRequest\032#.google.bigtable.v2.SessionResponse\"\006\240\320\245\216\004\002(\0010\001\022k\n"
          + "\024OpenMaterializedView\022\".google.bigtable.v2.SessionReq"
          + "uest\032#.google.bigtable.v2.SessionRespons"
          + "e\"\006\240\320\245\216\004\003(\0010\001\032\333\002\312A\027bigtable.googleapis.c"
          + "om\322A\275\002https://www.googleapis.com/auth/bi"
          + "gtable.data,https://www.googleapis.com/auth/bigtable.data.readonly,https://www.g"
          + "oogleapis.com/auth/cloud-bigtable.data,https://www.googleapis.com/auth/cloud-big"
          + "table.data.readonly,https://www.googleapis.com/auth/cloud-platform,https://www.g"
          + "oogleapis.com/auth/cloud-platform.read-onlyB\365\004\n"
          + "\026com.google.bigtable.v2B\r"
          + "BigtableProtoP\001Z8cloud.google.com/go/bigtable/ap"
          + "iv2/bigtablepb;bigtablepb\252\002\030Google.Cloud"
          + ".Bigtable.V2\312\002\030Google\\Cloud\\Bigtable\\V2\352\002\033Google::Cloud::Bigtable::V2\352AP\n"
          + "%bigtab"
          + "leadmin.googleapis.com/Instance\022\'projects/{project}/instances/{instance}\352A\\\n"
          + "\"bigtableadmin.googleapis.com/Table\0226project"
          + "s/{project}/instances/{instance}/tables/{table}\352A\207\001\n"
          + "+bigtableadmin.googleapis.com/AuthorizedView\022Xprojects/{project}/ins"
          + "tances/{instance}/tables/{table}/authorizedViews/{authorized_view}\352A~\n"
          + "-bigtableadmin.googleapis.com/MaterializedView\022Mpr"
          + "ojects/{project}/instances/{instance}/materializedViews/{materialized_view}b\006proto3"
    };
    descriptor =
