  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "gtable.v2.MutateRowsRequest.EntryB\003\340A\002\032N\n"
          + "\005Entry\022\017\n"
          ...
          + "google.bigtable.v2.ReadModifyWriteRuleB\003\340A\002\"B\n"
          ...
          + "\theartbeat\030\002"
          + " \001(\01326.google.bigtable.v2.ReadChangeStreamResponse.HeartbeatH\000\022P\n"
          + "\014close_stream\030\003"
          + " \001(\01328.google.bigtable.v2.ReadChangeStreamResponse.CloseStreamH\000\032\364\001\n\r"
          + "MutationChunk\022X\n\n"
          + "chunk_info\030\001 \001(\0132D.goog"
          + "le.bigtable.v2.ReadChangeStreamResponse.MutationChunk.ChunkInfo\022.\n"
          ...
          + ".bigtable.v2.ReadChangeStreamResponse.DataChange.Type\022\031\n"
          ...
          + "\006chunks\030\006 \003(\0132:.google.big"
          + "table.v2.ReadChangeStreamResponse.MutationChunk\022\014\n"
          ...
          + "(\0132\037.google.bigtable.v2.ProtoFormatB\002\030\001H\000\022\031\n"
          ...
          + "2.ReadRowsRequest\032$.google.bigtable.v2.ReadRowsResponse\"\201\003\332A\n"
          + "table_name\332A\031table_"
          + "name,app_profile_id\202\323\344\223\002\232\001\"9/v2/{table_n"
          + "ame=projects/*/instances/*/tables/*}:readRows:\001*ZZ\"U/v2/{authorized_view_name=pr"
          + "ojects/*/instances/*/tables/*/authorizedViews/*}:readRows:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_view_name=project"
          + "s/*/instances/*/tables/*/authorizedViews/*}0\001\022\356\003\n\r"
          + "SampleRowKeys\022(.google.bigtabl"
          + "e.v2.SampleRowKeysRequest\032).google.bigtable.v2.SampleRowKeysResponse\"\205\003\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002\236\001\022"
          + ">/v2/{table_name=projects/*/instances/*/tables/*}:sampleRowKeysZ\\\022Z/v2/{authoriz"
          + "ed_view_name=projects/*/instances/*/tabl"
          + "es/*/authorizedViews/*}:sampleRowKeys\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_"
          + "view_name=projects/*/instances/*/tables/*/authorizedViews/*}0\001\022\202\004\n"
          + "\tMutateRow\022$.google.bigtable.v2.MutateRowRequest\032%.goo"
          + "gle.bigtable.v2.MutateRowResponse\"\247\003\332A\034t"
          + "able_name,row_key,mutations\332A+table_name"
          + ",row_key,mutations,app_profile_id\202\323\344\223\002\234\001"
          + "\":/v2/{table_name=projects/*/instances/*/tables/*}:mutateRow:\001*Z[\"V/v2/{authoriz"
          + "ed_view_name=projects/*/instances/*/tabl"
          + "es/*/authorizedViews/*}:mutateRow:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_v"
          + "iew_name=projects/*/instances/*/tables/*/authorizedViews/*}\022\365\003\n\n"
          + "MutateRows\022%.google.bigtable.v2.MutateRowsRequest\032&.goog"
          + "le.bigtable.v2.MutateRowsResponse\"\225\003\332A\022t"
          ...
          + "ts/*/instances/*/tables/*/authorizedViews/*}:mutateRows:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_view_name=projects/"
          + "*/instances/*/tables/*/authorizedViews/*}0\001\022\366\004\n"
          + "\021CheckAndMutateRow\022,.google.bigtable.v2.CheckAndMutateRowRequest\032-.google"
          + ".bigtable.v2.CheckAndMutateRowResponse\"\203"
          + "\004\332ABtable_name,row_key,predicate_filter,"
          + "true_mutations,false_mutations\332AQtable_name,row_key,predicate_filter,true_mutati"
          + "ons,false_mutations,app_profile_id\202\323\344\223\002\254"
          + "\001\"B/v2/{table_name=projects/*/instances/"
          + "*/tables/*}:checkAndMutateRow:\001*Zc\"^/v2/{authorized_view_name=projects/*/instanc"
          + "es/*/tables/*/authorizedViews/*}:checkAndMutateRow:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_na"
          + "me\022H{authorized_view_name=projects/*/instances/*/tables/*/authorizedViews/*}\022\356\001\n"
          + "\013PingAndWarm\022&.google.bigtable.v2.PingAn"
          + "dWarmRequest\032\'.google.bigtable.v2.PingAn"
          + "dWarmResponse\"\215\001\332A\004name\332A\023name,app_profi"
          + "le_id\202\323\344\223\002+\"&/v2/{name=projects/*/instances/*}:ping:\001*\212\323\344\223\0029\022%\n"
          + "\004name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\247\004\n"
          + "\022ReadModifyWriteRow\022-.google.bigtable.v"
          + "2.ReadModifyWriteRowRequest\032..google.big"
          + "table.v2.ReadModifyWriteRowResponse\"\261\003\332A"
          + "\030table_name,row_key,rules\332A\'table_name,r"
          + "ow_key,rules,app_profile_id\202\323\344\223\002\256\001\"C/v2/"
          + "{table_name=projects/*/instances/*/tables/*}:readModifyWriteRow:\001*Zd\"_/v2/{autho"
          + "rized_view_name=projects/*/instances/*/t"
          + "ables/*/authorizedViews/*}:readModifyWriteRow:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{"
          + "authorized_view_name=projects/*/instances/*/tables/*/authorizedViews/*}\022\273\002\n"
          + "%GenerateInitialChangeStreamPartitions\022@.goog"
          + "le.bigtable.v2.GenerateInitialChangeStreamPartitionsRequest\032A.google.bigtable.v2"
          + ".GenerateInitialChangeStreamPartitionsResponse\"\212\001\332A\n"
          + "table_name\332A\031table_name,app_"
          + "profile_id\202\323\344\223\002[\"V/v2/{table_name=projec"
          + "ts/*/instances/*/tables/*}:generateInitialChangeStreamPartitions:\001*0\001\022\346\001\n"
          + "\020ReadChangeStream\022+.google.bigtable.v2.ReadChan"
          + "geStreamRequest\032,.google.bigtable.v2.ReadChangeStreamResponse\"u\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002F\"A/v2/{tab"
          + "le_name=projects/*/instances/*/tables/*}:readChangeStream:\001*0\001\022\251\002\n"
          + "\014PrepareQuery\022\'.google.bigtable.v2.PrepareQueryRequest"
          + "\032(.google.bigtable.v2.PrepareQueryRespon"
          + "se\"\305\001\332A\023instance_name,query\332A\"instance_n"
          + "ame,query,app_profile_id\202\323\344\223\002<\"7/v2/{ins"
          + "tance_name=projects/*/instances/*}:prepareQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\253\002\n"
          + "\014ExecuteQuery\022\'.google.bigtable.v2.ExecuteQueryRequest\032(.google.bigtable.v"
          + "2.ExecuteQueryResponse\"\305\001\332A\023instance_nam"
          + "e,query\332A\"instance_name,query,app_profil"
          + "e_id\202\323\344\223\002<\"7/v2/{instance_name=projects/*/instances/*}:executeQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id0\001\032\333\002\312A\027bigtable.g"
          + "oogleapis.com\322A\275\002https://www.googleapis."
          + "com/auth/bigtable.data,https://www.googleapis.com/auth/bigtable.data.readonly,ht"
          + "tps://www.googleapis.com/auth/cloud-bigtable.data,https://www.googleapis.com/aut"
          + "h/cloud-bigtable.data.readonly,https://www.googleapis.com/auth/cloud-platform,ht"
          + "tps://www.googleapis.com/auth/cloud-platform.read-onlyB\365\004\n"
          ...
          + "igtable\\V2\352\002\033Google::Cloud::Bigtable::V2\352AP\n"
          + "%bigtableadmin.googleapis.com/Instan"
          + "ce\022\'projects/{project}/instances/{instance}\352A\\\n"
          + "\"bigtableadmin.googleapis.com/Tab"
          + "le\0226projects/{project}/instances/{instance}/tables/{table}\352A\207\001\n"
          + "+bigtableadmin.googleapis.com/AuthorizedView\022Xprojects/{p"
          + "roject}/instances/{instance}/tables/{table}/authorizedViews/{authorized_view}\352A~\n"
          + "-bigtableadmin.googleapis.com/MaterializedView\022Mprojects/{project}/instances/{i"
          + "nstance}/materializedViews/{materialized_view}b\006proto3"
    };
    descriptor =
