  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\010ReadRows\022#.go"
          + "ogle.bigtable.v2.ReadRowsRequest\032$.google.bigtable.v2.ReadRowsResponse\"\201\003\332A\n"
          ...
          + "es/*/authorizedViews/*}:readRows:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_vi"
          + "ew_name=projects/*/instances/*/tables/*/authorizedViews/*}0\001\022\356\003\n\r"
          + "SampleRowKeys\022(.google.bigtable.v2.SampleRowKeysRequest"
          + "\032).google.bigtable.v2.SampleRowKeysResponse\"\205\003\332A\n"
          + "table_name\332A\031table_name,app_pro"
          + "file_id\202\323\344\223\002\236\001\022>/v2/{table_name=projects"
          + "/*/instances/*/tables/*}:sampleRowKeysZ\\\022Z/v2/{authorized_view_name=projects/*/i"
          + "nstances/*/tables/*/authorizedViews/*}:sampleRowKeys\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_view_name=projects/*/inst"
          + "ances/*/tables/*/authorizedViews/*}0\001\022\202\004\n"
          + "\tMutateRow\022$.google.bigtable.v2.MutateRowRequest\032%.google.bigtable.v2.MutateRow"
          + "Response\"\247\003\332A\034table_name,row_key,mutatio"
          ...
          + "\022H{authorized_view_name=projects/*/instances/*/tables/*/authorizedViews/*}\022\365\003\n\n"
          + "MutateRows\022%.google.bigtable.v2.MutateRow"
          + "sRequest\032&.google.bigtable.v2.MutateRows"
          + "Response\"\225\003\332A\022table_name,entries\332A!table"
          + "_name,entries,app_profile_id\202\323\344\223\002\236\001\";/v2"
          + "/{table_name=projects/*/instances/*/tables/*}:mutateRows:\001*Z\\\"W/v2/{authorized_v"
          + "iew_name=projects/*/instances/*/tables/*"
          + "/authorizedViews/*}:mutateRows:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_view"
          + "_name=projects/*/instances/*/tables/*/authorizedViews/*}0\001\022\366\004\n"
          + "\021CheckAndMutateRow\022,.google.bigtable.v2.CheckAndMutateRowR"
          + "equest\032-.google.bigtable.v2.CheckAndMuta"
          + "teRowResponse\"\203\004\332ABtable_name,row_key,pr"
          ...
          + "jects/*/instances/*/tables/*/authorizedViews/*}:checkAndMutateRow:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_view_name"
          + "=projects/*/instances/*/tables/*/authorizedViews/*}\022\356\001\n"
          + "\013PingAndWarm\022&.google.bigtable.v2.PingAndWarmRequest\032\'.google.big"
          + "table.v2.PingAndWarmResponse\"\215\001\332A\004name\332A"
          + "\023name,app_profile_id\202\323\344\223\002+\"&/v2/{name=projects/*/instances/*}:ping:\001*\212\323\344\223\0029\022%\n"
          + "\004name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\247\004\n"
          + "\022ReadModifyWriteRow\022-.google.bigtable.v2.ReadModifyWriteRowReque"
          + "st\032..google.bigtable.v2.ReadModifyWriteR"
          + "owResponse\"\261\003\332A\030table_name,row_key,rules"
          + "\332A\'table_name,row_key,rules,app_profile_"
          + "id\202\323\344\223\002\256\001\"C/v2/{table_name=projects/*/in"
          + "stances/*/tables/*}:readModifyWriteRow:\001*Zd\"_/v2/{authorized_view_name=projects/"
          + "*/instances/*/tables/*/authorizedViews/*}:readModifyWriteRow:\001*\212\323\344\223\002\260\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022`\n"
          + "\024authorized_view_name\022H{authorized_view_name=proj"
          + "ects/*/instances/*/tables/*/authorizedViews/*}\022\273\002\n"
          + "%GenerateInitialChangeStreamPartitions\022@.google.bigtable.v2.GenerateIn"
          + "itialChangeStreamPartitionsRequest\032A.goo"
          + "gle.bigtable.v2.GenerateInitialChangeStreamPartitionsResponse\"\212\001\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002[\"V/v2/{ta"
          + "ble_name=projects/*/instances/*/tables/*"
          + "}:generateInitialChangeStreamPartitions:\001*0\001\022\346\001\n"
          + "\020ReadChangeStream\022+.google.bigtable.v2.ReadChangeStreamRequest\032,.google."
          + "bigtable.v2.ReadChangeStreamResponse\"u\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202"
          + "\323\344\223\002F\"A/v2/{table_name=projects/*/instan"
          + "ces/*/tables/*}:readChangeStream:\001*0\001\022\251\002\n"
          + "\014PrepareQuery\022\'.google.bigtable.v2.Prep"
          + "areQueryRequest\032(.google.bigtable.v2.Pre"
          + "pareQueryResponse\"\305\001\332A\023instance_name,que"
          + "ry\332A\"instance_name,query,app_profile_id\202"
          + "\323\344\223\002<\"7/v2/{instance_name=projects/*/instances/*}:prepareQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\253\002\n"
          + "\014ExecuteQuery\022\'.google.bigtable.v2.ExecuteQueryRequest\032(.go"
          + "ogle.bigtable.v2.ExecuteQueryResponse\"\305\001"
          + "\332A\023instance_name,query\332A\"instance_name,q"
          + "uery,app_profile_id\202\323\344\223\002<\"7/v2/{instance"
          + "_name=projects/*/instances/*}:executeQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id0\001\032"
          + "\333\002\312A\027bigtable.googleapis.com\322A\275\002https://"
          + "www.googleapis.com/auth/bigtable.data,https://www.googleapis.com/auth/bigtable.d"
          + "ata.readonly,https://www.googleapis.com/auth/cloud-bigtable.data,https://www.goo"
          + "gleapis.com/auth/cloud-bigtable.data.readonly,https://www.googleapis.com/auth/cl"
          + "oud-platform,https://www.googleapis.com/auth/cloud-platform.read-onlyB\365\004\n"
          + "\026com.google.bigtable.v2B\r"
          + "BigtableProtoP\001Z8cloud.google.com/go/bigtable/apiv2/bigtablepb"
          + ";bigtablepb\252\002\030Google.Cloud.Bigtable.V2\312\002"
          + "\030Google\\Cloud\\Bigtable\\V2\352\002\033Google::Cloud::Bigtable::V2\352AP\n"
          + "%bigtableadmin.google"
          + "apis.com/Instance\022\'projects/{project}/instances/{instance}\352A\\\n"
          + "\"bigtableadmin.goo"
          + "gleapis.com/Table\0226projects/{project}/instances/{instance}/tables/{table}\352A\207\001\n"
          + "+bigtableadmin.googleapis.com/AuthorizedView\022Xprojects/{project}/instances/{instan"
          + "ce}/tables/{table}/authorizedViews/{authorized_view}\352A~\n"
          + "-bigtableadmin.googleapis.com/MaterializedView\022Mprojects/{projec"
          + "t}/instances/{instance}/materializedViews/{materialized_view}b\006proto3"
    };
    descriptor =
