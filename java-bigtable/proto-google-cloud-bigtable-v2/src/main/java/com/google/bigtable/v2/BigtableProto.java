  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\013param_types\030\006 \003(\01327.google.big"
          + "table.v2.PrepareQueryRequest.ParamTypesEntryB\003\340A\002\032K\n"
          ...
          + "\010ReadRows\022#.google.bigtable.v2.ReadRowsRequest\032"
          + "$.google.bigtable.v2.ReadRowsResponse\"\373\003\332A\n"
          + "table_name\332A\031table_name,app_profile_i"
          + "d\202\323\344\223\002\361\001\"9/v2/{table_name=projects/*/ins"
          + "tances/*/tables/*}:readRows:\001*ZZ\"U/v2/{authorized_view_name=projects/*/instances"
          + "/*/tables/*/authorizedViews/*}:readRows:\001*ZU\"P/v2/{materialized_view_name=projec"
          + "ts/*/instances/*/materializedViews/*}:readRows:\001*\212\323\344\223\002\323\001\022:\n\n"
          ...
          + "SampleRowKeys\022(.google.bigtable.v2.SampleRowKe"
          + "ysRequest\032).google.bigtable.v2.SampleRowKeysResponse\"\201\004\332A\n"
          + "table_name\332A\031table_nam"
          + "e,app_profile_id\202\323\344\223\002\367\001\022>/v2/{table_name"
          + "=projects/*/instances/*/tables/*}:sampleRowKeysZ\\\022Z/v2/{authorized_view_name=pro"
          + "jects/*/instances/*/tables/*/authorizedViews/*}:sampleRowKeysZW\022U/v2/{materializ"
          + "ed_view_name=projects/*/instances/*/materializedViews/*}:sampleRowKeys\212\323\344\223\002\323\001\022:\n"
          + "\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_view_name\022/{table_name=projects/*/instances/*/tables/*}/**\022:\n"
          + "\026materialized_view_name\022 {name=projects/*/instances/*}/**0\001\022\351\003\n"
          + "\tMutateRow\022$.google.bigtable.v2.MutateRowRequest\032%.google.bigtable"
          + ".v2.MutateRowResponse\"\216\003\332A\034table_name,ro"
          + "w_key,mutations\332A+table_name,row_key,mut"
          + "ations,app_profile_id\202\323\344\223\002\234\001\":/v2/{table"
          + "_name=projects/*/instances/*/tables/*}:mutateRow:\001*Z[\"V/v2/{authorized_view_name"
          + "=projects/*/instances/*/tables/*/authorizedViews/*}:mutateRow:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authori"
          + "zed_view_name\022/{table_name=projects/*/instances/*/tables/*}/**\022\334\003\n\n"
          + "MutateRows\022%.google.bigtable.v2.MutateRowsRequest\032&.g"
          + "oogle.bigtable.v2.MutateRowsResponse\"\374\002\332"
          + "A\022table_name,entries\332A!table_name,entrie"
          + "s,app_profile_id\202\323\344\223\002\236\001\";/v2/{table_name"
          + "=projects/*/instances/*/tables/*}:mutateRows:\001*Z\\\"W/v2/{authorized_view_name=pro"
          + "jects/*/instances/*/tables/*/authorizedViews/*}:mutateRows:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized"
          + "_view_name\022/{table_name=projects/*/instances/*/tables/*}/**0\001\022\335\004\n"
          + "\021CheckAndMutateRow\022,.google.bigtable.v2.CheckAndMutateR"
          + "owRequest\032-.google.bigtable.v2.CheckAndM"
          + "utateRowResponse\"\352\003\332ABtable_name,row_key"
          + ",predicate_filter,true_mutations,false_mutations\332AQtable_name,row_key,predicate_"
          + "filter,true_mutations,false_mutations,ap"
          + "p_profile_id\202\323\344\223\002\254\001\"B/v2/{table_name=pro"
          + "jects/*/instances/*/tables/*}:checkAndMutateRow:\001*Zc\"^/v2/{authorized_view_name="
          + "projects/*/instances/*/tables/*/authoriz"
          + "edViews/*}:checkAndMutateRow:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_view_name\022/{table_name=projects/*/instances/*/tables/*}/**\022\356\001\n"
          + "\013PingAndWarm\022&.google.bigtable.v2.PingAndWarmRe"
          + "quest\032\'.google.bigtable.v2.PingAndWarmRe"
          + "sponse\"\215\001\332A\004name\332A\023name,app_profile_id\202\323"
          + "\344\223\002+\"&/v2/{name=projects/*/instances/*}:ping:\001*\212\323\344\223\0029\022%\n"
          + "\004name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\216\004\n"
          + "\022ReadModifyWriteRow\022-.google.bigtable.v2.ReadM"
          + "odifyWriteRowRequest\032..google.bigtable.v"
          + "2.ReadModifyWriteRowResponse\"\230\003\332A\030table_"
          + "name,row_key,rules\332A\'table_name,row_key,"
          + "rules,app_profile_id\202\323\344\223\002\256\001\"C/v2/{table_"
          + "name=projects/*/instances/*/tables/*}:readModifyWriteRow:\001*Zd\"_/v2/{authorized_v"
          + "iew_name=projects/*/instances/*/tables/*"
          + "/authorizedViews/*}:readModifyWriteRow:\001*\212\323\344\223\002\227\001\022:\n\n"
          + "table_name\022,{table_name=projects/*/instances/*/tables/*}\022\020\n"
          + "\016app_profile_id\022G\n"
          + "\024authorized_view_name\022/{table_n"
          + "ame=projects/*/instances/*/tables/*}/**\022\273\002\n"
          + "%GenerateInitialChangeStreamPartitions\022@.google.bigtable.v2.GenerateInitialCh"
          + "angeStreamPartitionsRequest\032A.google.big"
          + "table.v2.GenerateInitialChangeStreamPartitionsResponse\"\212\001\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002[\"V/v2/{table_nam"
          + "e=projects/*/instances/*/tables/*}:gener"
          + "ateInitialChangeStreamPartitions:\001*0\001\022\346\001\n"
          + "\020ReadChangeStream\022+.google.bigtable.v2."
          + "ReadChangeStreamRequest\032,.google.bigtable.v2.ReadChangeStreamResponse\"u\332A\n"
          + "table_name\332A\031table_name,app_profile_id\202\323\344\223\002F\"A"
          + "/v2/{table_name=projects/*/instances/*/tables/*}:readChangeStream:\001*0\001\022\251\002\n"
          + "\014PrepareQuery\022\'.google.bigtable.v2.PrepareQuer"
          + "yRequest\032(.google.bigtable.v2.PrepareQue"
          + "ryResponse\"\305\001\332A\023instance_name,query\332A\"in"
          + "stance_name,query,app_profile_id\202\323\344\223\002<\"7"
          + "/v2/{instance_name=projects/*/instances/*}:prepareQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id\022\253\002\n"
          + "\014ExecuteQuery\022\'.google.bigtable.v2.ExecuteQueryRequest\032(.google.bi"
          + "gtable.v2.ExecuteQueryResponse\"\305\001\332A\023inst"
          + "ance_name,query\332A\"instance_name,query,ap"
          + "p_profile_id\202\323\344\223\002<\"7/v2/{instance_name=p"
          + "rojects/*/instances/*}:executeQuery:\001*\212\323\344\223\002B\022.\n\r"
          + "instance_name\022\035{name=projects/*/instances/*}\022\020\n"
          + "\016app_profile_id0\001\022v\n"
          + "\026GetClientConfiguration\0221.google.bigtable.v2."
          + "GetClientConfigurationRequest\032\'.google.bigtable.v2.ClientConfiguration\"\000\022`\n"
          + "\tOpenTable\022\".google.bigtable.v2.SessionReques"
          + "t\032#.google.bigtable.v2.SessionResponse\"\006\240\320\245\216\004\001(\0010\001\022i\n"
          + "\022OpenAuthorizedView\022\".googl"
          + "e.bigtable.v2.SessionRequest\032#.google.bigtable.v2.SessionResponse\"\006\240\320\245\216\004\002(\0010\001\022k\n"
          + "\024OpenMaterializedView\022\".google.bigtable."
          + "v2.SessionRequest\032#.google.bigtable.v2.S"
          + "essionResponse\"\006\240\320\245\216\004\003(\0010\001\032\333\002\312A\027bigtable"
          + ".googleapis.com\322A\275\002https://www.googleapi"
          + "s.com/auth/bigtable.data,https://www.googleapis.com/auth/bigtable.data.readonly,"
          + "https://www.googleapis.com/auth/cloud-bigtable.data,https://www.googleapis.com/a"
          + "uth/cloud-bigtable.data.readonly,https://www.googleapis.com/auth/cloud-platform,"
          + "https://www.googleapis.com/auth/cloud-platform.read-onlyB\365\004\n"
          + "\026com.google.bigtable.v2B\r"
          + "BigtableProtoP\001Z8cloud.google.com/go/bigtable/apiv2/bigtablepb;bigtablepb\252\002"
          ...
          + "ance\022\'projects/{project}/instances/{instance}\352A\\\n"
          + "\"bigtableadmin.googleapis.com/T"
          + "able\0226projects/{project}/instances/{instance}/tables/{table}\352A\207\001\n"
          + "+bigtableadmin.googleapis.com/AuthorizedView\022Xprojects/"
          + "{project}/instances/{instance}/tables/{t"
          + "able}/authorizedViews/{authorized_view}\352A~\n"
