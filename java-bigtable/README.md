...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigtable" % "2.39.2"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-bigtable/2.39.2
