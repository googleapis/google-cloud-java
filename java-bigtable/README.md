...
```Groovy
implementation 'com.google.cloud:google-cloud-bigtable:2.23.1'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-bigtable/2.23.1
