...
public interface AutomatedBackupPolicyInfoOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.databasecenter.v1beta.AutomatedBackupPolicyInfo)
