...
public interface AggregateQueryStatsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.databasecenter.v1beta.AggregateQueryStatsRequest)
