...
/**
 * A client to Database Center API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= DatabaseCenterClient =======================
 *
 * <p>Service Description: DatabaseCenter contains methods to query fleet view for database
 * resources.
 *
 * <p>Sample for DatabaseCenterClient:
 *
 * <pre>{@code
