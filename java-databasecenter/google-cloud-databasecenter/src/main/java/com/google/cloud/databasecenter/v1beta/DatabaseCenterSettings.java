...
/**
 * Settings class to configure an instance of {@link DatabaseCenterClient}.
 *
...
public class DatabaseCenterSettings extends ClientSettings<DatabaseCenterSettings> {
  ...
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return DatabaseCenterStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return DatabaseCenterStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return DatabaseCenterStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return DatabaseCenterStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return DatabaseCenterStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return DatabaseCenterStubSettings.defaultHttpJsonTransportProviderBuilder();
  }

  public static TransportChannelProvider defaultTransportChannelProvider() {
    return DatabaseCenterStubSettings.defaultTransportChannelProvider();
  }

  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return DatabaseCenterStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected DatabaseCenterSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for DatabaseCenterSettings. */
  public static class Builder extends ClientSettings.Builder<DatabaseCenterSettings, Builder> {
    ...
    protected Builder(DatabaseCenterSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(DatabaseCenterStubSettings.Builder stubSettings) {
      super(stubSettings);
    }

    private static Builder createDefault() {
      return new Builder(DatabaseCenterStubSettings.newBuilder());
    }

    private static Builder createHttpJsonDefault() {
      return new Builder(DatabaseCenterStubSettings.newHttpJsonBuilder());
    }

    public DatabaseCenterStubSettings.Builder getStubSettingsBuilder() {
      return ((DatabaseCenterStubSettings.Builder) getStubSettings());
    }
