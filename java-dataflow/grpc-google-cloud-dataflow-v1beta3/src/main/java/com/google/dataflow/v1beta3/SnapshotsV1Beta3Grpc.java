...
public final class SnapshotsV1Beta3Grpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.dataflow.v1beta3.SnapshotsV1Beta3";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<
          com.google.dataflow.v1beta3.GetSnapshotRequest, com.google.dataflow.v1beta3.Snapshot>
          ...
          SnapshotsV1Beta3Grpc.getGetSnapshotMethod =
              getGetSnapshotMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new SnapshotsV1Beta3MethodDescriptorSupplier("GetSnapshot"))
                      .build();
        }
      }
    }
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.dataflow.v1beta3.DeleteSnapshotResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SnapshotsV1Beta3MethodDescriptorSupplier("DeleteSnapshot"))
                      .build();
        }
      }
    }
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.dataflow.v1beta3.ListSnapshotsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SnapshotsV1Beta3MethodDescriptorSupplier("ListSnapshots"))
                      .build();
        }
      }
    }
  ...
  public static SnapshotsV1Beta3Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SnapshotsV1Beta3Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SnapshotsV1Beta3Stub>() {
          @java.lang.Override
          public SnapshotsV1Beta3Stub newStub(
   ...
   */
  public static SnapshotsV1Beta3BlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SnapshotsV1Beta3BlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SnapshotsV1Beta3BlockingStub>() {
          @java.lang.Override
          public SnapshotsV1Beta3BlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static SnapshotsV1Beta3FutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SnapshotsV1Beta3FutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SnapshotsV1Beta3FutureStub>() {
          @java.lang.Override
          public SnapshotsV1Beta3FutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class SnapshotsV1Beta3Stub
      extends io.grpc.stub.AbstractAsyncStub<SnapshotsV1Beta3Stub> {
    private SnapshotsV1Beta3Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected SnapshotsV1Beta3Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new SnapshotsV1Beta3Stub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class SnapshotsV1Beta3BlockingStub
      extends io.grpc.stub.AbstractBlockingStub<SnapshotsV1Beta3BlockingStub> {
    private SnapshotsV1Beta3BlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class SnapshotsV1Beta3FutureStub
      extends io.grpc.stub.AbstractFutureStub<SnapshotsV1Beta3FutureStub> {
    private SnapshotsV1Beta3FutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.Snapshot>
        getSnapshot(com.google.dataflow.v1beta3.GetSnapshotRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.dataflow.v1beta3.DeleteSnapshotResponse>
        deleteSnapshot(com.google.dataflow.v1beta3.DeleteSnapshotRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.dataflow.v1beta3.ListSnapshotsResponse>
        listSnapshots(com.google.dataflow.v1beta3.ListSnapshotsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class SnapshotsV1Beta3MethodDescriptorSupplier
    ...
    SnapshotsV1Beta3MethodDescriptorSupplier(java.lang.String methodName) {
