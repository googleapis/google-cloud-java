...
public final class JobsV1Beta3Grpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.dataflow.v1beta3.JobsV1Beta3";
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getCreateJobMethod = JobsV1Beta3Grpc.getCreateJobMethod) == null) {
      synchronized (JobsV1Beta3Grpc.class) {
        if ((getCreateJobMethod = JobsV1Beta3Grpc.getCreateJobMethod) == null) {
          JobsV1Beta3Grpc.getCreateJobMethod =
              getCreateJobMethod =
                  io.grpc.MethodDescriptor
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.dataflow.v1beta3.ListJobsRequest, com.google.dataflow.v1beta3.ListJobsResponse>
      getListJobsMethod;
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getListJobsMethod = JobsV1Beta3Grpc.getListJobsMethod) == null) {
      synchronized (JobsV1Beta3Grpc.class) {
        if ((getListJobsMethod = JobsV1Beta3Grpc.getListJobsMethod) == null) {
          JobsV1Beta3Grpc.getListJobsMethod =
              getListJobsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.dataflow.v1beta3.ListJobsRequest,
                          com.google.dataflow.v1beta3.ListJobsResponse>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getAggregatedListJobsMethod = JobsV1Beta3Grpc.getAggregatedListJobsMethod) == null) {
      synchronized (JobsV1Beta3Grpc.class) {
        if ((getAggregatedListJobsMethod = JobsV1Beta3Grpc.getAggregatedListJobsMethod) == null) {
          JobsV1Beta3Grpc.getAggregatedListJobsMethod =
              getAggregatedListJobsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.dataflow.v1beta3.ListJobsRequest,
                          com.google.dataflow.v1beta3.ListJobsResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.dataflow.v1beta3.ListJobsResponse.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new JobsV1Beta3MethodDescriptorSupplier("AggregatedListJobs"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getCheckActiveJobsMethod = JobsV1Beta3Grpc.getCheckActiveJobsMethod) == null) {
      synchronized (JobsV1Beta3Grpc.class) {
        if ((getCheckActiveJobsMethod = JobsV1Beta3Grpc.getCheckActiveJobsMethod) == null) {
          JobsV1Beta3Grpc.getCheckActiveJobsMethod =
              getCheckActiveJobsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.dataflow.v1beta3.CheckActiveJobsRequest,
                          com.google.dataflow.v1beta3.CheckActiveJobsResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.dataflow.v1beta3.CheckActiveJobsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new JobsV1Beta3MethodDescriptorSupplier("CheckActiveJobs"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.dataflow.v1beta3.SnapshotJobRequest, com.google.dataflow.v1beta3.Snapshot>
   ...
   */
  public static JobsV1Beta3BlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<JobsV1Beta3BlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<JobsV1Beta3BlockingStub>() {
          @java.lang.Override
          public JobsV1Beta3BlockingStub newStub(
  ...
  public static JobsV1Beta3FutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<JobsV1Beta3FutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<JobsV1Beta3FutureStub>() {
          @java.lang.Override
          public JobsV1Beta3FutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void aggregatedListJobs(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getAggregatedListJobsMethod(), responseObserver);
    }
    ...
    default void checkActiveJobs(
        ...
        io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.CheckActiveJobsResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getCheckActiveJobsMethod(), responseObserver);
    }
  ...
  public static final class JobsV1Beta3Stub
      extends io.grpc.stub.AbstractAsyncStub<JobsV1Beta3Stub> {
    private JobsV1Beta3Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected JobsV1Beta3Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new JobsV1Beta3Stub(channel, callOptions);
    }
    ...
    public void aggregatedListJobs(
        ...
        io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.ListJobsResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getAggregatedListJobsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void checkActiveJobs(
        ...
        io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.CheckActiveJobsResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCheckActiveJobsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void snapshotJob(
        ...
        io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.Snapshot> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getSnapshotJobMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class JobsV1Beta3BlockingStub
      extends io.grpc.stub.AbstractBlockingStub<JobsV1Beta3BlockingStub> {
    private JobsV1Beta3BlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
  ...
  public static final class JobsV1Beta3FutureStub
      extends io.grpc.stub.AbstractFutureStub<JobsV1Beta3FutureStub> {
    private JobsV1Beta3FutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.Job>
        createJob(com.google.dataflow.v1beta3.CreateJobRequest request) {
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.Job>
        getJob(com.google.dataflow.v1beta3.GetJobRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.Job>
        updateJob(com.google.dataflow.v1beta3.UpdateJobRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.dataflow.v1beta3.ListJobsResponse>
        listJobs(com.google.dataflow.v1beta3.ListJobsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.dataflow.v1beta3.ListJobsResponse>
        aggregatedListJobs(com.google.dataflow.v1beta3.ListJobsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.dataflow.v1beta3.CheckActiveJobsResponse>
        checkActiveJobs(com.google.dataflow.v1beta3.CheckActiveJobsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.dataflow.v1beta3.Snapshot>
        snapshotJob(com.google.dataflow.v1beta3.SnapshotJobRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_AGGREGATED_LIST_JOBS:
          serviceImpl.aggregatedListJobs(
              (com.google.dataflow.v1beta3.ListJobsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.ListJobsResponse>)
                  responseObserver);
          break;
        case METHODID_CHECK_ACTIVE_JOBS:
          serviceImpl.checkActiveJobs(
              (com.google.dataflow.v1beta3.CheckActiveJobsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.CheckActiveJobsResponse>)
                  responseObserver);
          break;
        case METHODID_SNAPSHOT_JOB:
          serviceImpl.snapshotJob(
              (com.google.dataflow.v1beta3.SnapshotJobRequest) request,
              (io.grpc.stub.StreamObserver<com.google.dataflow.v1beta3.Snapshot>) responseObserver);
          break;
        default:
  ...
  private static final class JobsV1Beta3MethodDescriptorSupplier
    ...
    JobsV1Beta3MethodDescriptorSupplier(java.lang.String methodName) {
