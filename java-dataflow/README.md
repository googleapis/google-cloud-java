...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dataflow" % "0.95.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dataflow/0.95.0
