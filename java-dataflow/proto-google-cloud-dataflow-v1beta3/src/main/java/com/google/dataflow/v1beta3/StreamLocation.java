...
public final class StreamLocation extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private StreamLocation(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetStreamingStageLocationFieldBuilder().getBuilder(),
                    extensionRegistry);
                locationCase_ = 1;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(
                    internalGetPubsubLocationFieldBuilder().getBuilder(), extensionRegistry);
                locationCase_ = 2;
                break;
              } // case 18
            case 26:
              {
                input.readMessage(
                    internalGetSideInputLocationFieldBuilder().getBuilder(), extensionRegistry);
                locationCase_ = 3;
                break;
              } // case 26
            case 34:
              {
                input.readMessage(
                    internalGetCustomSourceLocationFieldBuilder().getBuilder(), extensionRegistry);
                locationCase_ = 4;
                break;
              } // case 34
            default:
    ...
    public com.google.dataflow.v1beta3.StreamingStageLocation.Builder
      ...
      return internalGetStreamingStageLocationFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.dataflow.v1beta3.StreamingStageLocation.Builder,
            com.google.dataflow.v1beta3.StreamingStageLocationOrBuilder>
        internalGetStreamingStageLocationFieldBuilder() {
      if (streamingStageLocationBuilder_ == null) {
        if (!(locationCase_ == 1)) {
    ...
    public com.google.dataflow.v1beta3.PubsubLocation.Builder getPubsubLocationBuilder() {
      return internalGetPubsubLocationFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.dataflow.v1beta3.PubsubLocation.Builder,
            com.google.dataflow.v1beta3.PubsubLocationOrBuilder>
        internalGetPubsubLocationFieldBuilder() {
      if (pubsubLocationBuilder_ == null) {
        if (!(locationCase_ == 2)) {
          location_ = com.google.dataflow.v1beta3.PubsubLocation.getDefaultInstance();
        }
    ...
    public com.google.dataflow.v1beta3.StreamingSideInputLocation.Builder
      ...
      return internalGetSideInputLocationFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.dataflow.v1beta3.StreamingSideInputLocation.Builder,
            com.google.dataflow.v1beta3.StreamingSideInputLocationOrBuilder>
        internalGetSideInputLocationFieldBuilder() {
      if (sideInputLocationBuilder_ == null) {
        if (!(locationCase_ == 3)) {
    ...
    public com.google.dataflow.v1beta3.CustomSourceLocation.Builder
      ...
      return internalGetCustomSourceLocationFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.dataflow.v1beta3.CustomSourceLocation.Builder,
            com.google.dataflow.v1beta3.CustomSourceLocationOrBuilder>
        internalGetCustomSourceLocationFieldBuilder() {
      if (customSourceLocationBuilder_ == null) {
        if (!(locationCase_ == 4)) {
          location_ = com.google.dataflow.v1beta3.CustomSourceLocation.getDefaultInstance();
        }
