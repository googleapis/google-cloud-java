...
public final class StreamingProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "\'google/dataflow/v1beta3/streaming.proto\022\027google.dataflow.v1beta3\"\235\003\n"
          + "\016TopologyConfig\022B\n"
          + "\014computations\030\001"
          + " \003(\0132,.google.dataflow.v1beta3.ComputationTopology\022J\n"
          + "\025data_disk_assignments\030\002"
          + " \003(\0132+.google.dataflow.v1beta3.DataDiskAssignment\022v\n"
          + "\"user_stage_to_computation_name_map\030\003 \003(\0132J.goog"
          + "le.dataflow.v1beta3.TopologyConfig.UserStageToComputationNameMapEntry\022\033\n"
          + "\023forwarding_key_bits\030\004 \001(\005\022 \n"
          + "\030persistent_state_version\030\005 \001(\005\032D\n"
          + "\"UserStageToComputationNameMapEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"\260\001\n"
          + "\016PubsubLocation\022\r\n"
          + "\005topic\030\001 \001(\t\022\024\n"
          + "\014subscription\030\002 \001(\t\022\027\n"
          + "\017timestamp_label\030\003 \001(\t\022\020\n"
          + "\010id_label\030\004 \001(\t\022\026\n"
          + "\016drop_late_data\030\005 \001(\010\022\035\n"
          + "\025tracking_subscription\030\006 \001(\t\022\027\n"
          + "\017with_attributes\030\007 \001(\010\"+\n"
          + "\026StreamingStageLocation\022\021\n"
          + "\tstream_id\030\001 \001(\t\"?\n"
          + "\032StreamingSideInputLocation\022\013\n"
          + "\003tag\030\001 \001(\t\022\024\n"
          + "\014state_family\030\002 \001(\t\"(\n"
          + "\024CustomSourceLocation\022\020\n"
          + "\010stateful\030\001 \001(\010\"\332\002\n"
          + "\016StreamLocation\022S\n"
          + "\030streaming_stage_location\030\001"
          + " \001(\0132/.google.dataflow.v1beta3.StreamingStageLocationH\000\022B\n"
          + "\017pubsub_location\030\002"
          + " \001(\0132\'.google.dataflow.v1beta3.PubsubLocationH\000\022R\n"
          + "\023side_input_location\030\003"
          + " \001(\01323.google.dataflow.v1beta3.StreamingSideInputLocationH\000\022O\n"
          + "\026custom_source_location\030\004"
          + " \001(\0132-.google.dataflow.v1beta3.CustomSourceLocationH\000B\n\n"
          + "\010location\":\n"
          ...
          + "\016computation_id\030\005 \001(\t\022=\n\n"
          + "key_ranges\030\002 \003(\0132).google.dataflow.v1beta3.KeyRangeLocation\0227\n"
          + "\006inputs\030\003 \003(\0132\'.google.dataflow.v1beta3.StreamLocation\0228\n"
          + "\007outputs\030\004 \003(\0132\'.google.dataflow.v1beta3.StreamLocation\022B\n"
          + "\016state_families\030\007"
          + " \003(\0132*.google.dataflow.v1beta3.StateFamilyConfig\"\211\001\n"
          + "\020KeyRangeLocation\022\r\n"
          + "\005start\030\001 \001(\t\022\013\n"
          + "\003end\030\002 \001(\t\022\031\n"
          + "\021delivery_endpoint\030\003 \001(\t\022\021\n"
          + "\tdata_disk\030\005 \001(\t\022+\n"
          + "\037deprecated_persistent_directory\030\004 \001(\tB\002\030\001\"$\n"
          ...
          + "\032KeyRangeDataDiskAssignment\022\r\n"
          + "\005start\030\001 \001(\t\022\013\n"
          + "\003end\030\002 \001(\t\022\021\n"
          + "\tdata_disk\030\003 \001(\t\"\204\001\n"
          + "\032StreamingComputationRanges\022\026\n"
          + "\016computation_id\030\001 \001(\t\022N\n"
          + "\021range_assignments\030\002"
          + " \003(\01323.google.dataflow.v1beta3.KeyRangeDataDiskAssignment\"V\n"
          + " StreamingApplianceSnapshotConfig\022\023\n"
          + "\013snapshot_id\030\001 \001(\t\022\035\n"
          + "\025import_state_endpoint\030\002 \001(\tB\321\001\n"
          + "\033com.google.dataflow.v1beta3B\016StreamingProtoP\001Z=cloud.google.com/go/data"
          + "flow/apiv1beta3/dataflowpb;dataflowpb\252\002\035"
          + "Google.Cloud.Dataflow.V1Beta3\312\002\035Google\\Cloud\\Dataflow\\V1beta3\352\002"
