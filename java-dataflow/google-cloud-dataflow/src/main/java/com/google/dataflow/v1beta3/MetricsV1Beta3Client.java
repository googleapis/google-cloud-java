 ...
 *  status of jobs that are running in `us-central1`.</p></td>
 *      <td>
 ...
 *
 *  EXPERIMENTAL.  This API is subject to change or removal without notice.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Request detailed information about the execution status of a stage of the
 *  job.
 *
 *  EXPERIMENTAL.  This API is subject to change or removal without notice.</p></td>
 *      <td>
