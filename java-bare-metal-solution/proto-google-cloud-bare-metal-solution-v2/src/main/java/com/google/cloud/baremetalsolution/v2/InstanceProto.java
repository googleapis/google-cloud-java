...
public final class InstanceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "0google/cloud/baremetalsolution/v2/instance.proto\022!google.cloud.baremetalsoluti"
          + "on.v2\032\037google/api/field_behavior.proto\032\031"
          + "google/api/resource.proto\032.google/cloud/baremetalsolution/v2/common.proto\032+googl"
          + "e/cloud/baremetalsolution/v2/lun.proto\032/google/cloud/baremetalsolution/v2/networ"
          + "k.proto\032.google/cloud/baremetalsolution/v2/volume.proto\032 google/protobuf/field_m"
          + "ask.proto\032\037google/protobuf/timestamp.proto\"\311\t\n"
          + "\010Instance\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\005\022\017\n"
          + "\002id\030\013 \001(\tB\003\340A\003\0224\n"
          ...
          + "\01621.google.cloud.baremetalsolution.v2.Instance.StateB\003\340A\003\022\036\n"
          + "\026hyperthreading_enabled\030\006 \001(\010\022G\n"
          + "\006labels\030\007 \003(\01327.google.cloud"
          + ".baremetalsolution.v2.Instance.LabelsEntry\0229\n"
          + "\004luns\030\010"
          + " \003(\0132&.google.cloud.baremetalsolution.v2.LunB\003\340A\005\022?\n"
          + "\007volumes\030\020 \003(\0132)"
          + ".google.cloud.baremetalsolution.v2.VolumeB\003\340A\004\022A\n"
          + "\010networks\030\t"
          + " \003(\0132*.google.cloud.baremetalsolution.v2.NetworkB\003\340A\003\022/\n"
          + "\"interactive_serial_console_enabled\030\n"
          + " \001(\010B\003\340A\003\022\020\n"
          + "\010os_image\030\014 \001(\t\022\020\n"
          + "\003pod\030\r"
          + " \001(\tB\003\340A\005\022U\n"
          + "\020network_template\030\016 \001(\tB;\372A8\n"
          + "6baremetalsolution.googleapis.com/ServerNetworkTemplate\022O\n"
          + "\022logical_interfaces\030\017 \003(\01323.goog"
          + "le.cloud.baremetalsolution.v2.LogicalInterface\022\027\n\n"
          + "login_info\030\021 \001(\tB\003\340A\003\022L\n"
          + "\020workload_profile\030\022"
          + " \001(\01622.google.cloud.baremetalsolution.v2.WorkloadProfile\022\035\n"
          + "\020firmware_version\030\023 \001(\tB\003\340A\003\032-\n"
          ...
          + "Instance\022<projects/{project}/locations/{location}/instances/{instance}\"U\n"
          + "\022GetInstanceRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\"\210\001\n"
          ...
          + "\tinstances\030\001 \003(\0132+.google.cloud.baremetalsolution.v2.Instance\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"\214\001\n"
          + "\025UpdateInstanceRequest\022B\n"
          + "\010instance\030\001 \001(\0132+.g"
          + "oogle.cloud.baremetalsolution.v2.InstanceB\003\340A\002\022/\n"
          + "\013update_mask\030\002 \001(\0132\032.google.protobuf.FieldMask\"v\n"
          + "\025RenameInstanceRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\022\034\n"
          + "\017new_instance_id\030\002 \001(\tB\003\340A\002\"W\n"
          + "\024ResetInstanceRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\"W\n"
          + "\024StartInstanceRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\"\027\n"
          + "\025StartInstanceResponse\"V\n"
          + "\023StopInstanceRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\"\026\n"
          + "\024StopInstanceResponse\"h\n"
          + "%EnableInteractiveSerialConsoleRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\"(\n"
          + "&EnableInteractiveSerialConsoleResponse\"i\n"
          + "&DisableInteractiveSerialConsoleRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\")\n"
          + "\'DisableInteractiveSerialConsoleResponse\"\247\001\n"
          + "\020DetachLunRequest\022C\n"
          + "\010instance\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\0229\n"
          + "\003lun\030\002 \001(\tB,\340A\002\372A&\n"
          + "$baremetalsolution.googleapis.com/Lun\022\023\n"
          + "\013skip_reboot\030\003 \001(\010\"\254\004\n"
          ...
          + "d.baremetalsolution.v2.ServerNetworkTemplate.LogicalInterface\032\335\001\n"
          + "\020LogicalInterface\022\014\n"
          + "\004name\030\001 \001(\t\022e\n"
          + "\004type\030\002 \001(\0162W.google.cloud.baremetalsolution.v2.ServerNetwork"
          + "Template.LogicalInterface.InterfaceType\022\020\n"
          ...
          + "6baremetalsolution.googleapis.com/ServerNetworkTemplate\022Wprojects/{"
          + "project}/locations/{location}/serverNetw"
          + "orkTemplate/{server_network_template}B\374\001\n"
          + "%com.google.cloud.baremetalsolution.v2B\r"
          + "InstanceProtoP\001ZScloud.google.com/go/baremetalsolution/apiv2/baremetalsolutionp"
          + "b;baremetalsolutionpb\252\002!Google.Cloud.Bar"
          + "eMetalSolution.V2\312\002!Google\\Cloud\\BareMet"
          + "alSolution\\V2\352\002$Google::Cloud::BareMetalSolution::V2b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_baremetalsolution_v2_Instance_LabelsEntry_descriptor =
        internal_static_google_cloud_baremetalsolution_v2_Instance_descriptor.getNestedType(0);
    internal_static_google_cloud_baremetalsolution_v2_Instance_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_baremetalsolution_v2_Instance_LabelsEntry_descriptor,
            new java.lang.String[] {
