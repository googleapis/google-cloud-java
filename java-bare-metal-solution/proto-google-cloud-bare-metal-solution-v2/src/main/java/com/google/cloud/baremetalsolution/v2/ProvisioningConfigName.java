...
public class ProvisioningConfigName implements ResourceName {
  ...
  public static @Nullable ProvisioningConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProvisioningConfigName> values) {
