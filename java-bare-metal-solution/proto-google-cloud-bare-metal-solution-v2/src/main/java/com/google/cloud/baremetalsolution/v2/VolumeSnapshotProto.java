...
public final class VolumeSnapshotProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "7google/cloud/baremetalsolution/v2/volume_snapshot.proto\022!google.cloud.baremeta"
          + "lsolution.v2\032\037google/api/field_behavior."
          + "proto\032\031google/api/resource.proto\032\037google/protobuf/timestamp.proto\"\347\003\n"
          + "\016VolumeSnapshot\022\014\n"
          ...
          + "\016storage_volume\030\005 \001(\tB/\340A\003\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\022Q\n"
          + "\004type\030\007 \001(\0162>."
          + "google.cloud.baremetalsolution.v2.VolumeSnapshot.SnapshotTypeB\003\340A\003\"H\n"
          + "\014SnapshotType\022\035\n"
          + "\031SNAPSHOT_TYPE_UNSPECIFIED\020\000\022\n\n"
          + "\006AD_HOC\020\001\022\r\n"
          + "\tSCHEDULED\020\002:\204\001\352A\200\001\n"
          + "/baremetalsolution.googleapis.com/VolumeSnapshot\022Mpr"
          + "ojects/{project}/locations/{location}/volumes/{volume}/snapshots/{snapshot}\"a\n"
          + "\030GetVolumeSnapshotRequest\022E\n"
          + "\004name\030\001 \001(\tB7\340A\002\372A1\n"
          + "/baremetalsolution.googleapis.com/VolumeSnapshot\"\204\001\n"
          + "\032ListVolumeSnapshotsRequest\022?\n"
          + "\006parent\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          + "page_token\030\003 \001(\t\"\230\001\n"
          + "\033ListVolumeSnapshotsResponse\022K\n"
          + "\020volume_snapshots\030\001"
          + " \003(\01321.google.cloud.baremetalsolution.v2.VolumeSnapshot\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"d\n"
          + "\033DeleteVolumeSnapshotRequest\022E\n"
          + "\004name\030\001 \001(\tB7\340A\002\372A1\n"
          + "/baremetalsolution.googleapis.com/VolumeSnapshot\"\257\001\n"
          + "\033CreateVolumeSnapshotRequest\022?\n"
          + "\006parent\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\022O\n"
          + "\017volume_snapshot\030\002"
          + " \001(\01321.google.cloud.baremetalsolution.v2.VolumeSnapshotB\003\340A\002\"p\n"
          + "\034RestoreVolumeSnapshotRequest\022P\n"
          + "\017volume_snapshot\030\001 \001(\tB7\340A\002\372A1\n"
          + "/baremetalsolution.googleapis.com/VolumeSnapshotB\202\002\n"
          + "%com.google.cloud.baremetalsolution.v2B\023VolumeSnapshotProt"
          + "oP\001ZScloud.google.com/go/baremetalsolution/apiv2/baremetalsolutionpb;baremetalso"
          + "lutionpb\252\002!Google.Cloud.BareMetalSolutio"
          + "n.V2\312\002!Google\\Cloud\\BareMetalSolution\\V2"
          + "\352\002$Google::Cloud::BareMetalSolution::V2b\006proto3"
    };
    descriptor =
