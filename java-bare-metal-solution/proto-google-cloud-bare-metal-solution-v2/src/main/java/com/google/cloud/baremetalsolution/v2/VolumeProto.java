...
public final class VolumeProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ".google/cloud/baremetalsolution/v2/volume.proto\022!google.cloud.baremetalsolution"
          + ".v2\032\037google/api/field_behavior.proto\032\031go"
          + "ogle/api/resource.proto\032.google/cloud/baremetalsolution/v2/common.proto\032 google/"
          + "protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\354\016\n"
          + "\006Volume\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\n\n"
          + "\002id\030\013 \001(\t\022K\n"
          + "\014storage_type\030\002 \001"
          + "(\01625.google.cloud.baremetalsolution.v2.Volume.StorageType\022>\n"
          ...
          + "\035originally_requested_size_gib\030\020 \001(\003\022\030\n"
          + "\020current_size_gib\030\005 \001(\003\022\032\n"
          + "\022emergency_size_gib\030\016 \001(\003\022\024\n"
          + "\014max_size_gib\030\021 \001(\003\022\033\n"
          + "\023auto_grown_size_gib\030\006 \001(\003\022\033\n"
          + "\023remaining_space_gib\030\007 \001(\003\022h\n"
          + "\033snapshot_reservation_detail\030\010 \001(\0132"
          + "C.google.cloud.baremetalsolution.v2.Volume.SnapshotReservationDetail\022k\n"
          + "\035snapshot_auto_delete_behavior\030\t \001(\0162D.google.clo"
          + "ud.baremetalsolution.v2.Volume.SnapshotAutoDeleteBehavior\022E\n"
          + "\006labels\030\014 \003(\01325.goog"
          + "le.cloud.baremetalsolution.v2.Volume.LabelsEntry\022\030\n"
          + "\020snapshot_enabled\030\r"
          + " \001(\010\022\020\n"
          + "\003pod\030\017 \001(\tB\003\340A\005\022I\n"
          + "\010protocol\030\022 \001(\01622.google."
          + "cloud.baremetalsolution.v2.Volume.ProtocolB\003\340A\003\022\030\n"
          + "\013boot_volume\030\023 \001(\010B\003\340A\003\022W\n"
          + "\020performance_tier\030\024 \001(\01628.google.cloud.barem"
          + "etalsolution.v2.VolumePerformanceTierB\003\340A\005\022\022\n"
          + "\005notes\030\025 \001(\tB\003\340A\004\022S\n"
          + "\020workload_profile\030\026"
          + " \001(\01629.google.cloud.baremetalsolution.v2.Volume.WorkloadProfile\0224\n"
          + "\013expire_time\030\030 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022D\n"
          + "\tinstances\030\031 \003(\tB1\340A\003\372A+\n"
          + ")baremetalsolution.googleapis.com/Instance\022\025\n"
          + "\010attached\030\032 \001(\010B\003\340A\003\032\242\001\n"
          + "\031SnapshotReservationDetail\022\032\n"
          ...
          + "\007volumes\030\001 \003(\0132).google.cloud.baremetalsolution.v2.Volume\022\027\n"
          ...
          + "\004name\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\022\032\n\r"
          + "new_volume_id\030\002 \001(\tB\003\340A\002\"S\n"
          + "\022EvictVolumeRequest\022=\n"
          + "\004name\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\"h\n"
          + "\023ResizeVolumeRequest\022?\n"
          + "\006volume\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\022\020\n"
          + "\010size_gib\030\002 \001(\003B\372\001\n"
          + "%com.google.cloud.baremetalsolution.v2B\013Volu"
          + "meProtoP\001ZScloud.google.com/go/baremetalsolution/apiv2/baremetalsolutionpb;barem"
          + "etalsolutionpb\252\002!Google.Cloud.BareMetalS"
          + "olution.V2\312\002!Google\\Cloud\\BareMetalSolut"
          + "ion\\V2\352\002$Google::Cloud::BareMetalSolution::V2b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_baremetalsolution_v2_Volume_SnapshotReservationDetail_descriptor =
        internal_static_google_cloud_baremetalsolution_v2_Volume_descriptor.getNestedType(0);
    internal_static_google_cloud_baremetalsolution_v2_Volume_SnapshotReservationDetail_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_baremetalsolution_v2_Volume_SnapshotReservationDetail_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_baremetalsolution_v2_Volume_LabelsEntry_descriptor =
        internal_static_google_cloud_baremetalsolution_v2_Volume_descriptor.getNestedType(1);
    internal_static_google_cloud_baremetalsolution_v2_Volume_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_baremetalsolution_v2_Volume_LabelsEntry_descriptor,
            new java.lang.String[] {
