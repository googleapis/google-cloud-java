...
public class VolumeSnapshotName implements ResourceName {
  ...
  public static VolumeSnapshotName of(
      String project, String location, String volume, String snapshot) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable VolumeSnapshotName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_VOLUME_SNAPSHOT.validatedMatch(
            formattedString, "VolumeSnapshotName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<VolumeSnapshotName> parseList(List<String> formattedStrings) {
    List<VolumeSnapshotName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable VolumeSnapshotName> values) {
