...
public final class NfsShareProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "1google/cloud/baremetalsolution/v2/nfs_share.proto\022!google.cloud.baremetalsolut"
          + "ion.v2\032\037google/api/field_behavior.proto\032\031google/api/resource.proto\032"
          + " google/protobuf/field_mask.proto\"\235\t\n"
          + "\010NfsShare\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\005\022\031\n"
          + "\014nfs_share_id\030\002 \001(\tB\003\340A\003\022\017\n"
          + "\002id\030\010 \001(\tB\003\340A\003\022E\n"
          + "\005state\030\003 \001(\01621.google"
          + ".cloud.baremetalsolution.v2.NfsShare.StateB\003\340A\003\022?\n"
          + "\006volume\030\004 \001(\tB/\340A\003\372A)\n"
          + "\'baremetalsolution.googleapis.com/Volume\022R\n"
          + "\017allowed_clients\030\005"
          + " \003(\01329.google.cloud.baremetalsolution.v2.NfsShare.AllowedClient\022G\n"
          + "\006labels\030\006"
          + " \003(\01327.google.cloud.baremetalsolution.v2.NfsShare.LabelsEntry\022\032\n"
          + "\022requested_size_gib\030\007 \001(\003\022R\n"
          + "\014storage_type\030\t \001(\0162"
          + "7.google.cloud.baremetalsolution.v2.NfsShare.StorageTypeB\003\340A\005\032\263\002\n\r"
          + "AllowedClient\022>\n"
          + "\007network\030\001 \001(\tB-\372A*\n"
          + "(baremetalsolution.googleapis.com/Network\022\025\n"
          + "\010share_ip\030\002 \001(\tB\003\340A\003\022\034\n"
          + "\024allowed_clients_cidr\030\003 \001(\t\022W\n"
          + "\021mount_permissions\030\004 \001(\0162<.google.cloud.b"
          + "aremetalsolution.v2.NfsShare.MountPermissions\022\021\n"
          + "\tallow_dev\030\005 \001(\010\022\022\n\n"
          + "allow_suid\030\006 \001(\010\022\026\n"
          + "\016no_root_squash\030\007 \001(\010\022\025\n"
          + "\010nfs_path\030\010 \001(\tB\003\340A\003\032-\n"
          ...
          + ")baremetalsolution.googleapis.com/NFSShare\022=projects/{project"
          + "}/locations/{location}/nfsShares/{nfs_share}\"U\n"
          + "\022GetNfsShareRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/NFSShare\"\210\001\n"
          ...
          + "\tnfs_share\030\001"
          + " \001(\0132+.google.cloud.baremetalsolution.v2.NfsShareB\003\340A\002\022/\n"
          + "\013update_mask\030\002 \001(\0132\032.google.protobuf.FieldMask\"v\n"
          + "\025RenameNfsShareRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/NFSShare\022\034\n"
          + "\017new_nfsshare_id\030\002 \001(\tB\003\340A\002\"\227\001\n"
          + "\025CreateNfsShareRequest\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022C\n"
          + "\tnfs_share\030\002"
          + " \001(\0132+.google.cloud.baremetalsolution.v2.NfsShareB\003\340A\002\"X\n"
          + "\025DeleteNfsShareRequest\022?\n"
          + "\004name\030\001 \001(\tB1\340A\002\372A+\n"
          + ")baremetalsolution.googleapis.com/NFSShareB\374\001\n"
          + "%com.google.cloud.baremetalsolution.v2B\r"
          + "NfsShareProtoP\001ZScloud.google.com/go/baremetalsolution/apiv2/baremetalsolutionpb;"
          + "baremetalsolutionpb\252\002!Google.Cloud.BareM"
          + "etalSolution.V2\312\002!Google\\Cloud\\BareMetal"
          + "Solution\\V2\352\002$Google::Cloud::BareMetalSolution::V2b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_baremetalsolution_v2_NfsShare_AllowedClient_descriptor =
        internal_static_google_cloud_baremetalsolution_v2_NfsShare_descriptor.getNestedType(0);
    internal_static_google_cloud_baremetalsolution_v2_NfsShare_AllowedClient_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_baremetalsolution_v2_NfsShare_AllowedClient_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_baremetalsolution_v2_NfsShare_LabelsEntry_descriptor =
        internal_static_google_cloud_baremetalsolution_v2_NfsShare_descriptor.getNestedType(1);
    internal_static_google_cloud_baremetalsolution_v2_NfsShare_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_baremetalsolution_v2_NfsShare_LabelsEntry_descriptor,
            new java.lang.String[] {
