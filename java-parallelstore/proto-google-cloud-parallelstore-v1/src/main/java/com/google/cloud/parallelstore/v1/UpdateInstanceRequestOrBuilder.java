...
public interface UpdateInstanceRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.parallelstore.v1.UpdateInstanceRequest)
   ...
   *
   * <code>
   * .google.cloud.parallelstore.v1.Instance instance = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   * @return The instance.
   */
  com.google.cloud.parallelstore.v1.Instance getInstance();
   ...
   * </code>
   */
  com.google.cloud.parallelstore.v1.InstanceOrBuilder getInstanceOrBuilder();
