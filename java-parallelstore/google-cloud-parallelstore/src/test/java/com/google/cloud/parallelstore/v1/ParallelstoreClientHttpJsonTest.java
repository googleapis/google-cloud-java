...
import com.google.cloud.parallelstore.v1.stub.HttpJsonParallelstoreStub;
...
public class ParallelstoreClientHttpJsonTest {
  private static MockHttpService mockService;
  private static ParallelstoreClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonParallelstoreStub.getMethodDescriptors(),
            ParallelstoreSettings.getDefaultEndpoint());
    ParallelstoreSettings settings =
        ParallelstoreSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                ParallelstoreSettings.defaultHttpJsonTransportProviderBuilder()
