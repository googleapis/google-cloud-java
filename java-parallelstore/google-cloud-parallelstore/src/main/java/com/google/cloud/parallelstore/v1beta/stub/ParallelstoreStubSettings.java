...
/**
 * Settings class to configure an instance of {@link ParallelstoreStub}.
 *
...
public class ParallelstoreStubSettings extends StubSettings<ParallelstoreStubSettings> {
  ...
  public ParallelstoreStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcParallelstoreStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonParallelstoreStub.create(this);
    }
  ...
  public static String getDefaultEndpoint() {
    return "parallelstore.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "parallelstore.mtls.googleapis.com:443";
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ParallelstoreStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ParallelstoreStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected ParallelstoreStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for ParallelstoreStubSettings. */
  public static class Builder extends StubSettings.Builder<ParallelstoreStubSettings, Builder> {
    ...
    protected Builder(ParallelstoreStubSettings settings) {
      super(settings);
    ...
    @Override
    public ParallelstoreStubSettings build() throws IOException {
      return new ParallelstoreStubSettings(this);
    }
  }
}
