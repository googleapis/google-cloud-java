...
public interface ListControlsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1beta.ListControlsResponse)
   ...
   * <code>repeated .google.cloud.discoveryengine.v1beta.Control controls = 1;</code>
   */
  com.google.cloud.discoveryengine.v1beta.ControlOrBuilder getControlsOrBuilder(int index);
