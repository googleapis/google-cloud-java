...
public interface CreateIdentityMappingStoreRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1beta.CreateIdentityMappingStoreRequest)
   ...
   *
   * <code>
   * .google.cloud.discoveryengine.v1beta.IdentityMappingStore identity_mapping_store = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.discoveryengine.v1beta.IdentityMappingStore getIdentityMappingStore();
  ...
  com.google.cloud.discoveryengine.v1beta.CreateIdentityMappingStoreRequest.CmekOptionsCase
      getCmekOptionsCase();
}
