  ...
  static {
    java.lang.String[] descriptorData = {
      "\n0google/cloud/discoveryengine/v1beta/co"
          ...
          + "is.com/RankingConfig\022Gprojects/{project}"
          + "/locations/{location}/rankingConfigs/{ra"
          + "nking_config}\352A\322\002\n/discoveryengine.googl"
          + "eapis.com/CompletionConfig\022Pprojects/{pr"
          + "oject}/locations/{location}/dataStores/{"
          + "data_store}/completionConfig\022iprojects/{"
          + "project}/locations/{location}/collection"
          + "s/{collection}/dataStores/{data_store}/c"
          + "ompletionConfig\022bprojects/{project}/loca"
          + "tions/{location}/collections/{collection"
          + "}/engines/{engine}/completionConfig\352Ay\n#"
          + "healthcare.googleapis.com/FhirStore\022Rpro"
          + "jects/{project}/locations/{location}/dat"
          + "asets/{dataset}/fhirStores/{fhir_store}\352"
          + "A\244\001\n&healthcare.googleapis.com/FhirResou"
          + "rce\022zprojects/{project}/locations/{locat"
          + "ion}/datasets/{dataset}/fhirStores/{fhir"
          + "_store}/fhir/{resource_type}/{fhir_resou"
          + "rce_id}b\006proto3"
    };
    descriptor =
