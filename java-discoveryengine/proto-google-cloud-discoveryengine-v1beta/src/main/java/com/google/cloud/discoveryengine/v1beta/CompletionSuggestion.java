...
public final class CompletionSuggestion extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CompletionSuggestion(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(suggestion_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, suggestion_);
    }
    if (rankingInfoCase_ == 2) {
    ...
    for (int i = 0; i < alternativePhrases_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, alternativePhrases_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(suggestion_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, suggestion_);
    }
    if (rankingInfoCase_ == 2) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.cloud.discoveryengine.v1beta.CompletionSuggestion other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getGroupScore()) != 0) {
