...
public class SiteSearchEngineName implements ResourceName {
  ...
  public static @Nullable SiteSearchEngineName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SiteSearchEngineName> values) {
