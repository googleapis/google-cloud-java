...
public interface IdentityMappingStoreOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1beta.IdentityMappingStore)
   ...
   *
   * <code>
   * .google.cloud.discoveryengine.v1beta.CmekConfig cmek_config = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
