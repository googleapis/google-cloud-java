  ...
  static {
    java.lang.String[] descriptorData = {
      "\n0google/cloud/discoveryengine/v1beta/an"
          ...
          + "yClassificationInfo\032\250\002\n\027QueryClassificat"
          ...
          + "SWER_SEEKING_QUERY\020\002\022\027\n\023JAIL_BREAKING_QU"
          ...
          + "LEVANT_CONTENT\020\005\022\037\n\033JAIL_BREAKING_QUERY_"
          + "IGNORED\020\006\022\035\n\031CUSTOMER_POLICY_VIOLATION\020\007"
          + "\022\'\n#NON_ANSWER_SEEKING_QUERY_IGNORED_V2\020"
          + "\010\022\027\n\023LOW_GROUNDED_ANSWER\020\t:\205\003\352A\201\003\n%disco"
          + "veryengine.googleapis.com/Answer\022cprojec"
          + "ts/{project}/locations/{location}/dataSt"
          + "ores/{data_store}/sessions/{session}/ans"
          + "wers/{answer}\022|projects/{project}/locati"
          + "ons/{location}/collections/{collection}/"
          + "dataStores/{data_store}/sessions/{sessio"
          + "n}/answers/{answer}\022uprojects/{project}/"
          + "locations/{location}/collections/{collec"
          + "tion}/engines/{engine}/sessions/{session"
          + "}/answers/{answer}B\222\002\n\'com.google.cloud."
          + "discoveryengine.v1betaB\013AnswerProtoP\001ZQc"
