...
public final class FhirStoreSource extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private FhirStoreSource(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(fhirStore_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, fhirStore_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gcsStagingDir_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, gcsStagingDir_);
    }
    for (int i = 0; i < resourceTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, resourceTypes_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(fhirStore_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, fhirStore_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gcsStagingDir_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, gcsStagingDir_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < resourceTypes_.size(); i++) {
