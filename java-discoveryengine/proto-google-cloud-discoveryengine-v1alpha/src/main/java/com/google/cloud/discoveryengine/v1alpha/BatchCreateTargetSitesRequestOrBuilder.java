...
public interface BatchCreateTargetSitesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.BatchCreateTargetSitesRequest)
   ...
   * </code>
   */
  com.google.cloud.discoveryengine.v1alpha.CreateTargetSiteRequestOrBuilder getRequestsOrBuilder(
      int index);
}
