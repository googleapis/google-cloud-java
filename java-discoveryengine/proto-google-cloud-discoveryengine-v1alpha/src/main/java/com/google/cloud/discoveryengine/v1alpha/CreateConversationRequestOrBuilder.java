...
public interface CreateConversationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.CreateConversationRequest)
   ...
   *
   * <code>
   * .google.cloud.discoveryengine.v1alpha.Conversation conversation = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
