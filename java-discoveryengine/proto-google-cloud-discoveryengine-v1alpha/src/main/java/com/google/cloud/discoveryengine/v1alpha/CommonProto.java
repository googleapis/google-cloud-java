  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "(com.google.cloud.discoveryengine.v1alphaB\013CommonProtoP\001ZRcloud.goo"
          ...
          + "e\\V1alpha\352\002\'Google::Cloud::DiscoveryEngine::V1alpha\352A\346\001\n"
          + "%discoveryengine.googleapis.com/Branch\022Qprojects/{project}/locat"
          + "ions/{location}/dataStores/{data_store}/branches/{branch}\022jprojects/{project}/lo"
          + "cations/{location}/collections/{collecti"
          + "on}/dataStores/{data_store}/branches/{branch}\352Am\n"
          + ")discoveryengine.googleapis.com/Collection\022@projects/{project}/location"
          + "s/{location}/collections/{collection}\352AR\n"
          + "\'discoveryengine.googleapis.com/Locatio"
          + "n\022\'projects/{project}/locations/{location}\352A}\n"
          + ".discoveryengine.googleapis.com/GroundingConfig\022Kprojects/{project}/locati"
          + "ons/{location}/groundingConfigs/{grounding_config}\352Aw\n"
          + ",discoveryengine.googleapis.com/RankingConfig\022Gprojects/{project}/"
          + "locations/{location}/rankingConfigs/{ranking_config}\352Ay\n"
          + "#healthcare.googleapis.com/FhirStore\022Rprojects/{project}/locatio"
          + "ns/{location}/datasets/{dataset}/fhirStores/{fhir_store}b\006proto3"
    };
    descriptor =
