...
public interface ListDataStoresResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.ListDataStoresResponse)
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.DataStore> getDataStoresList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.discoveryengine.v1alpha.DataStore data_stores = 1;</code>
   */
  java.util.List<? extends com.google.cloud.discoveryengine.v1alpha.DataStoreOrBuilder>
