...
public final class ControlProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "2google/cloud/discoveryengine/v1alpha/control.proto\022$google.cloud.discoveryengi"
          + "ne.v1alpha\032\037google/api/field_behavior.pr"
          + "oto\032\031google/api/resource.proto\0321google/c"
          + "loud/discoveryengine/v1alpha/common.proto\032\037google/protobuf/timestamp.proto\"\314\002\n"
          + "\tCondition\022N\n"
          + "\013query_terms\030\002 \003(\01329.google.c"
          + "loud.discoveryengine.v1alpha.Condition.QueryTerm\022T\n"
          + "\021active_time_range\030\003 \003(\01329.go"
          + "ogle.cloud.discoveryengine.v1alpha.Condition.TimeRange\032.\n"
          + "\tQueryTerm\022\r\n"
          + "\005value\030\001 \001(\t\022\022\n\n"
          + "full_match\030\002 \001(\010\032i\n"
          + "\tTimeRange\022.\n\n"
          + "start_time\030\001 \001(\0132\032.google.protobuf.Timestamp\022,\n"
          + "\010end_time\030\002 \001(\0132\032.google.protobuf.Timestamp\"\267\n\n"
          + "\007Control\022Q\n"
          + "\014boost_action\030\006 "
          + "\001(\01329.google.cloud.discoveryengine.v1alpha.Control.BoostActionH\000\022S\n\r"
          + "filter_action\030\007"
          + " \001(\0132:.google.cloud.discoveryengine.v1alpha.Control.FilterActionH\000\022W\n"
          + "\017redirect_action\030\t \001(\0132<.google.cloud.discoverye"
          + "ngine.v1alpha.Control.RedirectActionH\000\022W\n"
          + "\017synonyms_action\030\n"
          + " \001(\0132<.google.cloud.d"
          + "iscoveryengine.v1alpha.Control.SynonymsActionH\000\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\005\022\031\n"
          + "\014display_name\030\002 \001(\tB\003\340A\002\022*\n"
          + "\035associated_serving_config_ids\030\003 \003(\tB\003\340A\003\022Q\n\r"
          + "solution_type\030\004 \001(\016"
          + "22.google.cloud.discoveryengine.v1alpha.SolutionTypeB\006\340A\002\340A\005\022F\n"
          + "\tuse_cases\030\010 \003(\0162"
          + "3.google.cloud.discoveryengine.v1alpha.SearchUseCase\022C\n\n"
          + "conditions\030\005 \003(\0132/.google.cloud.discoveryengine.v1alpha.Condition\032|\n"
          ...
          + "&discoveryengine.googleapis.com/Control\022Rprojects/{project}/locations/{locati"
          + "on}/dataStores/{data_store}/controls/{control}\022kprojects/{project}/locations/{lo"
          + "cation}/collections/{collection}/dataStores/{data_store}/controls/{control}\022dpro"
          + "jects/{project}/locations/{location}/col"
          + "lections/{collection}/engines/{engine}/controls/{control}B\010\n"
          + "\006actionB\230\002\n"
          + "(com.google.cloud.discoveryengine.v1alphaB\014Contro"
          + "lProtoP\001ZRcloud.google.com/go/discoveryengine/apiv1alpha/discoveryenginepb;disco"
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Condition_QueryTerm_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Condition_descriptor.getNestedType(0);
    internal_static_google_cloud_discoveryengine_v1alpha_Condition_QueryTerm_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Condition_QueryTerm_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Condition_TimeRange_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Condition_descriptor.getNestedType(1);
    internal_static_google_cloud_discoveryengine_v1alpha_Condition_TimeRange_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Condition_TimeRange_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Control_BoostAction_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Control_descriptor.getNestedType(0);
    internal_static_google_cloud_discoveryengine_v1alpha_Control_BoostAction_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Control_BoostAction_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Control_FilterAction_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Control_descriptor.getNestedType(1);
    internal_static_google_cloud_discoveryengine_v1alpha_Control_FilterAction_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Control_FilterAction_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Control_RedirectAction_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Control_descriptor.getNestedType(2);
    internal_static_google_cloud_discoveryengine_v1alpha_Control_RedirectAction_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Control_RedirectAction_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Control_SynonymsAction_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Control_descriptor.getNestedType(3);
    internal_static_google_cloud_discoveryengine_v1alpha_Control_SynonymsAction_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Control_SynonymsAction_descriptor,
            new java.lang.String[] {
