  ...
  static {
    java.lang.String[] descriptorData = {
      "\n7google/cloud/discoveryengine/v1alpha/c"
          ...
          + "/dataStores/{data_store}/conversations/{"
          + "conversation}\022nprojects/{project}/locati"
          + "ons/{location}/collections/{collection}/"
          + "engines/{engine}/conversations/{conversa"
          + "tion}\"\207\002\n\005Reply\022\021\n\005reply\030\001 \001(\tB\002\030\001\022M\n\nre"
          + "ferences\030\002 \003(\01325.google.cloud.discoverye"
          + "ngine.v1alpha.Reply.ReferenceB\002\030\001\022M\n\007sum"
          + "mary\030\003 \001(\0132<.google.cloud.discoveryengin"
          + "e.v1alpha.SearchResponse.Summary\032M\n\tRefe"
