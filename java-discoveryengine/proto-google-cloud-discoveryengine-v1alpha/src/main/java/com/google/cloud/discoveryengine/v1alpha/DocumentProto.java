...
public final class DocumentProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "3google/cloud/discoveryengine/v1alpha/document.proto\022$google.cloud.discoveryeng"
          ...
          + "/protobuf/timestamp.proto\032\027google/rpc/status.proto\"\247\t\n"
          + "\010Document\022.\n"
          ...
          + "\007content\030\n"
          + " \001(\01326.google.cloud.discoveryengine.v1alpha.Document.Content\022\032\n"
          + "\022parent_document_id\030\007 \001(\t\0229\n"
          + "\023derived_struct_data\030\006"
          + " \001(\0132\027.google.protobuf.StructB\003\340A\003\022H\n"
          + "\010acl_info\030\013"
          + " \001(\01326.google.cloud.discoveryengine.v1alpha.Document.AclInfo\0223\n\n"
          + "index_time\030\r"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022U\n"
          + "\014index_status\030\017 \001(\0132:.google.cloud.discover"
          + "yengine.v1alpha.Document.IndexStatusB\003\340A\003\032K\n"
          + "\007Content\022\023\n"
          + "\traw_bytes\030\002 \001(\014H\000\022\r\n"
          + "\003uri\030\003 \001(\tH\000\022\021\n"
          + "\tmime_type\030\001 \001(\tB\t\n"
          + "\007content\032\320\001\n"
          + "\007AclInfo\022Y\n"
          + "\007readers\030\001 \003(\0132H.google.clo"
          + "ud.discoveryengine.v1alpha.Document.AclInfo.AccessRestriction\032j\n"
          + "\021AccessRestriction\022C\n\n"
          + "principals\030\001"
          + " \003(\0132/.google.cloud.discoveryengine.v1alpha.Principal\022\020\n"
          + "\010idp_wide\030\002 \001(\010\032h\n"
          + "\013IndexStatus\022.\n\n"
          ...
          + "\'discoveryengine.googleapis.com/Document\022fprojects/{project}/locations/{locat"
          + "ion}/dataStores/{data_store}/branches/{branch}/documents/{document}\022\177projects/{p"
          + "roject}/locations/{location}/collections"
          + "/{collection}/dataStores/{data_store}/branches/{branch}/documents/{document}B\006\n"
          + "\004data\"\204\001\n"
          + "\021ProcessedDocument\022\023\n"
          + "\tjson_data\030\002 \001(\tH\000\022A\n"
          + "\010document\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'discoveryengine.googleapis.com/DocumentB\027\n"
          + "\025processed_data_formatB\231\002\n"
          + "(com.google.cloud.discoveryengine.v1alphaB\r"
          + "DocumentProtoP\001ZRcloud.google.com/go/discoveryengine/a"
          ...
          + "scoveryEngine\\V1alpha\352\002\'Google::Cloud::DiscoveryEngine::V1alphab\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Document_Content_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Document_descriptor.getNestedType(0);
    internal_static_google_cloud_discoveryengine_v1alpha_Document_Content_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Document_Content_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Document_AclInfo_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Document_descriptor.getNestedType(1);
    internal_static_google_cloud_discoveryengine_v1alpha_Document_AclInfo_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Document_AclInfo_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Document_IndexStatus_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Document_descriptor.getNestedType(2);
    internal_static_google_cloud_discoveryengine_v1alpha_Document_IndexStatus_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Document_IndexStatus_descriptor,
            new java.lang.String[] {
