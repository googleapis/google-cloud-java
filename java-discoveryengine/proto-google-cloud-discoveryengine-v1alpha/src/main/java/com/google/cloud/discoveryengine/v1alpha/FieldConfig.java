...
public final class FieldConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private FieldConfig() {
    ...
    keyPropertyType_ = "";
    advancedSiteSearchDataSources_ = emptyIntList();
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList advancedSiteSearchDataSources_ = emptyIntList();
  ...
  public com.google.cloud.discoveryengine.v1alpha.FieldConfig.AdvancedSiteSearchDataSource
    ...
    return advancedSiteSearchDataSources_converter_.convert(
        advancedSiteSearchDataSources_.getInt(index));
  }
  ...
  public int getAdvancedSiteSearchDataSourcesValue(int index) {
    return advancedSiteSearchDataSources_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(keyPropertyType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, keyPropertyType_);
    }
    ...
    for (int i = 0; i < advancedSiteSearchDataSources_.size(); i++) {
      output.writeEnumNoTag(advancedSiteSearchDataSources_.getInt(i));
    }
    for (int i = 0; i < schemaOrgPaths_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, schemaOrgPaths_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(keyPropertyType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, keyPropertyType_);
    }
    if (completableOption_
        != com.google.cloud.discoveryengine.v1alpha.FieldConfig.CompletableOption
            .COMPLETABLE_OPTION_UNSPECIFIED
      ...
      for (int i = 0; i < advancedSiteSearchDataSources_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                advancedSiteSearchDataSources_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.cloud.discoveryengine.v1alpha.FieldConfig result) {
      ...
      if (((from_bitField0_ & 0x00000200) != 0)) {
        advancedSiteSearchDataSources_.makeImmutable();
            ...
            case 80:
              {
                ...
                ensureAdvancedSiteSearchDataSourcesIsMutable();
                advancedSiteSearchDataSources_.addInt(tmpRaw);
                break;
              } // case 80
            case 82:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  advancedSiteSearchDataSources_.addInt(input.readEnum());
                }
    ...
    private void ensureAdvancedSiteSearchDataSourcesIsMutable() {
      if (!advancedSiteSearchDataSources_.isModifiable()) {
        advancedSiteSearchDataSources_ = makeMutableCopy(advancedSiteSearchDataSources_);
      }
      bitField0_ |= 0x00000200;
    }
    ...
    public Builder setAdvancedSiteSearchDataSources(
      ...
      ensureAdvancedSiteSearchDataSourcesIsMutable();
      advancedSiteSearchDataSources_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addAdvancedSiteSearchDataSources(
      ...
      ensureAdvancedSiteSearchDataSourcesIsMutable();
      advancedSiteSearchDataSources_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setAdvancedSiteSearchDataSourcesValue(int index, int value) {
      ensureAdvancedSiteSearchDataSourcesIsMutable();
      advancedSiteSearchDataSources_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addAdvancedSiteSearchDataSourcesValue(int value) {
      ensureAdvancedSiteSearchDataSourcesIsMutable();
      advancedSiteSearchDataSources_.addInt(value);
      onChanged();
      return this;
    }
