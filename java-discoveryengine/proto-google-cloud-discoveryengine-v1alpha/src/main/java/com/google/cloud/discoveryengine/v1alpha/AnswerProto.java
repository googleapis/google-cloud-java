  ...
  static {
    java.lang.String[] descriptorData = {
      "\n1google/cloud/discoveryengine/v1alpha/a"
          ...
          + "TENT\020\005\022\037\n\033JAIL_BREAKING_QUERY_IGNORED\020\006\022"
          + "\035\n\031CUSTOMER_POLICY_VIOLATION\020\007:\205\003\352A\201\003\n%d"
          + "iscoveryengine.googleapis.com/Answer\022cpr"
          + "ojects/{project}/locations/{location}/da"
          + "taStores/{data_store}/sessions/{session}"
          + "/answers/{answer}\022|projects/{project}/lo"
          + "cations/{location}/collections/{collecti"
          + "on}/dataStores/{data_store}/sessions/{se"
          + "ssion}/answers/{answer}\022uprojects/{proje"
          + "ct}/locations/{location}/collections/{co"
          + "llection}/engines/{engine}/sessions/{ses"
          + "sion}/answers/{answer}B\227\002\n(com.google.cl"
          + "oud.discoveryengine.v1alphaB\013AnswerProto"
