...
public final class AnswerProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "1google/cloud/discoveryengine/v1alpha/answer.proto\022$google.cloud.discoveryengin"
          + "e.v1alpha\032\037google/api/field_behavior.pro"
          + "to\032\031google/api/resource.proto\032\034google/pr"
          + "otobuf/struct.proto\032\037google/protobuf/timestamp.proto\"\337\"\n"
          + "\006Answer\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\005\022A\n"
          + "\005state\030\002"
          + " \001(\01622.google.cloud.discoveryengine.v1alpha.Answer.State\022\023\n"
          + "\013answer_text\030\003 \001(\t\022H\n"
          + "\tcitations\030\004 \003(\01325.google.c"
          + "loud.discoveryengine.v1alpha.Answer.Citation\022J\n\n"
          + "references\030\005 \003(\01326.google.cloud."
          + "discoveryengine.v1alpha.Answer.Reference\022\031\n"
          + "\021related_questions\030\006 \003(\t\022@\n"
          + "\005steps\030\007 \003(\01321.google.cloud.discoveryengine.v1alpha.Answer.Step\022e\n"
          + "\030query_understanding_info\030\n"
          + " \001(\0132C.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfo\022`\n"
          + "\026answer_skipped_reasons\030\013 \003(\0162@.google.cl"
          + "oud.discoveryengine.v1alpha.Answer.AnswerSkippedReason\0224\n"
          + "\013create_time\030\010"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0226\n\r"
          + "complete_time\030\t"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\032\200\001\n"
          + "\010Citation\022\023\n"
          + "\013start_index\030\001 \001(\003\022\021\n"
          + "\tend_index\030\002 \001(\003\022L\n"
          + "\007sources\030\003 \003(\0132;.goo"
          + "gle.cloud.discoveryengine.v1alpha.Answer.CitationSource\032&\n"
          + "\016CitationSource\022\024\n"
          + "\014reference_id\030\001 \001(\t\032\233\n\n"
          + "\tReference\022u\n"
          + "\032unstructured_document_info\030\001 \001(\0132O.google.cloud"
          + ".discoveryengine.v1alpha.Answer.Reference.UnstructuredDocumentInfoH\000\022V\n\n"
          + "chunk_info\030\002"
          + " \001(\0132@.google.cloud.discoveryengine.v1alpha.Answer.Reference.ChunkInfoH\000\022q\n"
          + "\030structured_document_info\030\003 \001(\0132M.google."
          + "cloud.discoveryengine.v1alpha.Answer.Reference.StructuredDocumentInfoH\000\032\206\003\n"
          ...
          + "\016chunk_contents\030\004 \003(\0132\\.google.cloud.discover"
          + "yengine.v1alpha.Answer.Reference.UnstructuredDocumentInfo.ChunkContent\022,\n"
          ...
          + "\020_relevance_score\032\256\003\n"
          + "\tChunkInfo\0228\n"
          + "\005chunk\030\001 \001(\tB)\372A&\n"
          + "$discoveryengine.googleapis.com/Chunk\022\017\n"
          + "\007content\030\002 \001(\t\022\034\n"
          + "\017relevance_score\030\003 \001(\002H\000\210\001\001\022l\n"
          + "\021document_metadata\030\004 \001(\0132Q.google.cloud.discoveryengin"
          + "e.v1alpha.Answer.Reference.ChunkInfo.DocumentMetadata\032\265\001\n"
          ...
          + "\007content\032\337\010\n"
          + "\004Step\022F\n"
          + "\005state\030\001 \001(\01627.google.c"
          + "loud.discoveryengine.v1alpha.Answer.Step.State\022\023\n"
          + "\013description\030\002 \001(\t\022\017\n"
          + "\007thought\030\003 \001(\t\022I\n"
          + "\007actions\030\004 \003(\01328.google.cloud.dis"
          + "coveryengine.v1alpha.Answer.Step.Action\032\321\006\n"
          + "\006Action\022^\n\r"
          + "search_action\030\002 \001(\0132E.goog"
          + "le.cloud.discoveryengine.v1alpha.Answer.Step.Action.SearchActionH\000\022Y\n"
          + "\013observation\030\003"
          + " \001(\0132D.google.cloud.discoveryengine.v1alpha.Answer.Step.Action.Observation\032\035\n"
          + "\014SearchAction\022\r\n"
          + "\005query\030\001 \001(\t\032\342\004\n"
          + "\013Observation\022i\n"
          + "\016search_results\030\002 \003(\0132Q.google.cl"
          + "oud.discoveryengine.v1alpha.Answer.Step.Action.Observation.SearchResult\032\347\003\n"
          + "\014SearchResult\022\020\n"
          + "\010document\030\001 \001(\t\022\013\n"
          + "\003uri\030\002 \001(\t\022\r\n"
          + "\005title\030\003 \001(\t\022s\n"
          + "\014snippet_info\030\004 \003(\0132].google.cloud.discoveryengine.v1alpha.Answ"
          + "er.Step.Action.Observation.SearchResult.SnippetInfo\022o\n\n"
          + "chunk_info\030\005 \003(\0132[.google.cloud.discoveryengine.v1alpha.Answer.St"
          + "ep.Action.Observation.SearchResult.ChunkInfo\022,\n"
          ...
          + "\tSUCCEEDED\020\003\032\242\003\n"
          + "\026QueryUnderstandingInfo\022~\n"
          + "\031query_classification_info\030\001 \003(\0132[.google.c"
          + "loud.discoveryengine.v1alpha.Answer.Quer"
          + "yUnderstandingInfo.QueryClassificationInfo\032\207\002\n"
          + "\027QueryClassificationInfo\022n\n"
          + "\004type\030\001 \001(\0162`.google.cloud.discoveryengine.v1al"
          + "pha.Answer.QueryUnderstandingInfo.QueryClassificationInfo.Type\022\020\n"
          ...
          + "%discoveryengine.googleapis.com/Answer\022cprojects/{project}/locations/{location}/da"
          + "taStores/{data_store}/sessions/{session}/answers/{answer}\022|projects/{project}/lo"
          + "cations/{location}/collections/{collection}/dataStores/{data_store}/sessions/{se"
          + "ssion}/answers/{answer}\022uprojects/{project}/locations/{location}/collections/{co"
          + "llection}/engines/{engine}/sessions/{session}/answers/{answer}B\227\002\n"
          + "(com.google.cloud.discoveryengine.v1alphaB\013AnswerProto"
          + "P\001ZRcloud.google.com/go/discoveryengine/apiv1alpha/discoveryenginepb;discoveryen"
          + "ginepb\242\002\017DISCOVERYENGINE\252\002$Google.Cloud."
          + "DiscoveryEngine.V1Alpha\312\002$Google\\Cloud\\D"
          + "iscoveryEngine\\V1alpha\352\002\'Google::Cloud::DiscoveryEngine::V1alphab\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Citation_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Answer_descriptor.getNestedType(0);
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Citation_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Answer_Citation_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_CitationSource_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Answer_descriptor.getNestedType(1);
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_CitationSource_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Answer_CitationSource_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Reference_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Answer_descriptor.getNestedType(2);
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Reference_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Answer_Reference_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Answer_descriptor.getNestedType(3);
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_Action_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_descriptor.getNestedType(
            0);
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_Action_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Answer_Step_Action_descriptor,
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_QueryUnderstandingInfo_descriptor =
        internal_static_google_cloud_discoveryengine_v1alpha_Answer_descriptor.getNestedType(4);
    internal_static_google_cloud_discoveryengine_v1alpha_Answer_QueryUnderstandingInfo_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_discoveryengine_v1alpha_Answer_QueryUnderstandingInfo_descriptor,
            new java.lang.String[] {
