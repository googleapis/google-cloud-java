  ...
  static {
    java.lang.String[] descriptorData = {
      "\n1google/cloud/discoveryengine/v1alpha/a"
          ...
          + "v1alpha.Answer.Reference.ChunkInfoH\000\022q\n\030"
          + "structured_document_info\030\003 \001(\0132M.google."
          + "cloud.discoveryengine.v1alpha.Answer.Ref"
          + "erence.StructuredDocumentInfoH\000\032\206\003\n\030Unst"
          + "ructuredDocumentInfo\022>\n\010document\030\001 \001(\tB,"
          + "\372A)\n\'discoveryengine.googleapis.com/Docu"
          + "ment\022\013\n\003uri\030\002 \001(\t\022\r\n\005title\030\003 \001(\t\022t\n\016chun"
          + "k_contents\030\004 \003(\0132\\.google.cloud.discover"
          + "yengine.v1alpha.Answer.Reference.Unstruc"
          + "turedDocumentInfo.ChunkContent\022,\n\013struct"
          + "_data\030\005 \001(\0132\027.google.protobuf.Struct\032j\n\014"
          + "ChunkContent\022\017\n\007content\030\001 \001(\t\022\027\n\017page_id"
          + "entifier\030\002 \001(\t\022\034\n\017relevance_score\030\003 \001(\002H"
          + "\000\210\001\001B\022\n\020_relevance_score\032\256\003\n\tChunkInfo\0228"
          + "\n\005chunk\030\001 \001(\tB)\372A&\n$discoveryengine.goog"
          + "leapis.com/Chunk\022\017\n\007content\030\002 \001(\t\022\034\n\017rel"
          + "evance_score\030\003 \001(\002H\000\210\001\001\022l\n\021document_meta"
          + "data\030\004 \001(\0132Q.google.cloud.discoveryengin"
          + "e.v1alpha.Answer.Reference.ChunkInfo.Doc"
          + "umentMetadata\032\265\001\n\020DocumentMetadata\022>\n\010do"
          + "cument\030\001 \001(\tB,\372A)\n\'discoveryengine.googl"
          + "eapis.com/Document\022\013\n\003uri\030\002 \001(\t\022\r\n\005title"
          + "\030\003 \001(\t\022\027\n\017page_identifier\030\004 \001(\t\022,\n\013struc"
          + "t_data\030\005 \001(\0132\027.google.protobuf.StructB\022\n"
          + "\020_relevance_score\032\206\001\n\026StructuredDocument"
          + "Info\022>\n\010document\030\001 \001(\tB,\372A)\n\'discoveryen"
          + "gine.googleapis.com/Document\022,\n\013struct_d"
          + "ata\030\002 \001(\0132\027.google.protobuf.StructB\t\n\007co"
          + "ntent\032\337\010\n\004Step\022F\n\005state\030\001 \001(\01627.google.c"
          + "loud.discoveryengine.v1alpha.Answer.Step"
          + ".State\022\023\n\013description\030\002 \001(\t\022\017\n\007thought\030\003"
          + " \001(\t\022I\n\007actions\030\004 \003(\01328.google.cloud.dis"
          + "coveryengine.v1alpha.Answer.Step.Action\032"
          + "\321\006\n\006Action\022^\n\rsearch_action\030\002 \001(\0132E.goog"
          + "le.cloud.discoveryengine.v1alpha.Answer."
          + "Step.Action.SearchActionH\000\022Y\n\013observatio"
          + "n\030\003 \001(\0132D.google.cloud.discoveryengine.v"
          + "1alpha.Answer.Step.Action.Observation\032\035\n"
          + "\014SearchAction\022\r\n\005query\030\001 \001(\t\032\342\004\n\013Observa"
          + "tion\022i\n\016search_results\030\002 \003(\0132Q.google.cl"
          + "oud.discoveryengine.v1alpha.Answer.Step."
          + "Action.Observation.SearchResult\032\347\003\n\014Sear"
          + "chResult\022\020\n\010document\030\001 \001(\t\022\013\n\003uri\030\002 \001(\t\022"
          + "\r\n\005title\030\003 \001(\t\022s\n\014snippet_info\030\004 \003(\0132].g"
          + "oogle.cloud.discoveryengine.v1alpha.Answ"
          + "er.Step.Action.Observation.SearchResult."
          + "SnippetInfo\022o\n\nchunk_info\030\005 \003(\0132[.google"
          + ".cloud.discoveryengine.v1alpha.Answer.St"
          + "ep.Action.Observation.SearchResult.Chunk"
          + "Info\022,\n\013struct_data\030\006 \001(\0132\027.google.proto"
          + "buf.Struct\0326\n\013SnippetInfo\022\017\n\007snippet\030\001 \001"
          + "(\t\022\026\n\016snippet_status\030\002 \001(\t\032]\n\tChunkInfo\022"
          + "\r\n\005chunk\030\001 \001(\t\022\017\n\007content\030\002 \001(\t\022\034\n\017relev"
          + "ance_score\030\003 \001(\002H\000\210\001\001B\022\n\020_relevance_scor"
          + "eB\010\n\006action\"J\n\005State\022\025\n\021STATE_UNSPECIFIE"
          + "D\020\000\022\017\n\013IN_PROGRESS\020\001\022\n\n\006FAILED\020\002\022\r\n\tSUCC"
          + "EEDED\020\003\032\242\003\n\026QueryUnderstandingInfo\022~\n\031qu"
          + "ery_classification_info\030\001 \003(\0132[.google.c"
          + "loud.discoveryengine.v1alpha.Answer.Quer"
          + "yUnderstandingInfo.QueryClassificationIn"
          + "fo\032\207\002\n\027QueryClassificationInfo\022n\n\004type\030\001"
          + " \001(\0162`.google.cloud.discoveryengine.v1al"
          + "pha.Answer.QueryUnderstandingInfo.QueryC"
          + "lassificationInfo.Type\022\020\n\010positive\030\002 \001(\010"
          + "\"j\n\004Type\022\024\n\020TYPE_UNSPECIFIED\020\000\022\025\n\021ADVERS"
          + "ARIAL_QUERY\020\001\022\034\n\030NON_ANSWER_SEEKING_QUER"
          + "Y\020\002\022\027\n\023JAIL_BREAKING_QUERY\020\003\"J\n\005State\022\025\n"
          + "\021STATE_UNSPECIFIED\020\000\022\017\n\013IN_PROGRESS\020\001\022\n\n"
          + "\006FAILED\020\002\022\r\n\tSUCCEEDED\020\003\"\374\001\n\023AnswerSkipp"
          + "edReason\022%\n!ANSWER_SKIPPED_REASON_UNSPEC"
          + "IFIED\020\000\022\035\n\031ADVERSARIAL_QUERY_IGNORED\020\001\022$"
          + "\n NON_ANSWER_SEEKING_QUERY_IGNORED\020\002\022\037\n\033"
          + "OUT_OF_DOMAIN_QUERY_IGNORED\020\003\022\036\n\032POTENTI"
          + "AL_POLICY_VIOLATION\020\004\022\027\n\023NO_RELEVANT_CON"
          + "TENT\020\005\022\037\n\033JAIL_BREAKING_QUERY_IGNORED\020\006:"
          + "\205\003\352A\201\003\n%discoveryengine.googleapis.com/A"
          + "nswer\022cprojects/{project}/locations/{loc"
          + "ation}/dataStores/{data_store}/sessions/"
          + "{session}/answers/{answer}\022|projects/{pr"
          + "oject}/locations/{location}/collections/"
          + "{collection}/dataStores/{data_store}/ses"
          + "sions/{session}/answers/{answer}\022uprojec"
          + "ts/{project}/locations/{location}/collec"
          + "tions/{collection}/engines/{engine}/sess"
          + "ions/{session}/answers/{answer}B\227\002\n(com."
          + "google.cloud.discoveryengine.v1alphaB\013An"
          + "swerProtoP\001ZRcloud.google.com/go/discove"
