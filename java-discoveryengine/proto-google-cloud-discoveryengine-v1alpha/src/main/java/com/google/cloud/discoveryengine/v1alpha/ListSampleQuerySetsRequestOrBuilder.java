...
public interface ListSampleQuerySetsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.ListSampleQuerySetsRequest)
