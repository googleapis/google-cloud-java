...
public interface ListChunksResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.ListChunksResponse)
   ...
   * <code>repeated .google.cloud.discoveryengine.v1alpha.Chunk chunks = 1;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.ChunkOrBuilder getChunksOrBuilder(int index);
