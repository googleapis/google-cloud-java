...
public class DocumentProcessingConfigName implements ResourceName {
  ...
  @Deprecated
  protected DocumentProcessingConfigName() {
    project = null;
    location = null;
    dataStore = null;
    collection = null;
  ...
  private DocumentProcessingConfigName(Builder builder) {
  ...
  private DocumentProcessingConfigName(ProjectLocationCollectionDataStoreBuilder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
  ...
  public static DocumentProcessingConfigName ofProjectLocationDataStoreName(
      String project, String location, String dataStore) {
    return newBuilder().setProject(project).setLocation(location).setDataStore(dataStore).build();
  }

  public static DocumentProcessingConfigName ofProjectLocationCollectionDataStoreName(
  ...
  public static DocumentProcessingConfigName parse(String formattedString) {
    ...
    throw new ValidationException(
        "DocumentProcessingConfigName.parse: formattedString not in valid format");
  }

  public static List<DocumentProcessingConfigName> parseList(List<String> formattedStrings) {
    List<DocumentProcessingConfigName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      DocumentProcessingConfigName that = ((DocumentProcessingConfigName) o);
  ...
  public static class Builder {
    ...
    public DocumentProcessingConfigName build() {
      return new DocumentProcessingConfigName(this);
    }
  }
