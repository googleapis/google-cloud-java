...
public interface SessionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1.Session)
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1.Session.State state = 2;</code>
   *
   ...
   * @return The state.
   */
  com.google.cloud.discoveryengine.v1.Session.State getState();
   ...
   * <code>repeated .google.cloud.discoveryengine.v1.Session.Turn turns = 4;</code>
   */
  com.google.cloud.discoveryengine.v1.Session.TurnOrBuilder getTurnsOrBuilder(int index);
