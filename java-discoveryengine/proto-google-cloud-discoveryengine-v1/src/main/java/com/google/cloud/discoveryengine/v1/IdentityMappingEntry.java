...
public final class IdentityMappingEntry extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private IdentityMappingEntry(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(externalIdentity_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, externalIdentity_);
    }
    if (identityProviderIdCase_ == 2) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, identityProviderId_);
    }
    if (identityProviderIdCase_ == 3) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, identityProviderId_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(externalIdentity_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, externalIdentity_);
    }
    if (identityProviderIdCase_ == 2) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, identityProviderId_);
    }
    if (identityProviderIdCase_ == 3) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, identityProviderId_);
    }
