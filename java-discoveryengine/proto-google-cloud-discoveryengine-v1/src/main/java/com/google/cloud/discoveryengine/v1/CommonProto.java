  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\021SEARCH_ADD_ON_LLM\020\001B\313\t\n"
          + "#com.google.cloud.discoveryengine.v1B\013CommonProtoP\001ZMcloud.google.com"
          ...
          + "le\\Cloud\\DiscoveryEngine\\V1\352\002\"Google::Cloud::DiscoveryEngine::V1\352A\346\001\n"
          + "%discoveryengine.googleapis.com/Branch\022Qprojects/{p"
          + "roject}/locations/{location}/dataStores/{data_store}/branches/{branch}\022jprojects"
          + "/{project}/locations/{location}/collecti"
          + "ons/{collection}/dataStores/{data_store}/branches/{branch}\352Am\n"
          + ")discoveryengine.googleapis.com/Collection\022@projects/{proj"
          + "ect}/locations/{location}/collections/{collection}\352AR\n"
          + "\'discoveryengine.googleapi"
          + "s.com/Location\022\'projects/{project}/locations/{location}\352A}\n"
          + ".discoveryengine.googleapis.com/GroundingConfig\022Kprojects/{pr"
          + "oject}/locations/{location}/groundingConfigs/{grounding_config}\352Aw\n"
          + ",discoveryengine.googleapis.com/RankingConfig\022Gprojec"
          + "ts/{project}/locations/{location}/rankingConfigs/{ranking_config}\352Ay\n"
          + "#healthcare.googleapis.com/FhirStore\022Rprojects/{pro"
          + "ject}/locations/{location}/datasets/{dataset}/fhirStores/{fhir_store}\352A\244\001\n"
          + "&healthcare.googleapis.com/FhirResource\022zproje"
          + "cts/{project}/locations/{location}/datasets/{dataset}/fhirStores/{fhir_store}/fh"
          + "ir/{resource_type}/{fhir_resource_id}b\006proto3"
    };
    descriptor =
