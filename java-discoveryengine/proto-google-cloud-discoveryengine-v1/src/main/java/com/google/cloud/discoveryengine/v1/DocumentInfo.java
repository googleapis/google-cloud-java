 ...
 */
public final class DocumentInfo extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (documentDescriptorCase_ == 1) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, documentDescriptor_);
    }
    if (documentDescriptorCase_ == 2) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, documentDescriptor_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeInt32(3, quantity_);
    }
    for (int i = 0; i < promotionIds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, promotionIds_.getRaw(i));
    }
    if (documentDescriptorCase_ == 6) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, documentDescriptor_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (documentDescriptorCase_ == 1) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, documentDescriptor_);
    }
    if (documentDescriptorCase_ == 2) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, documentDescriptor_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
    ...
    if (documentDescriptorCase_ == 6) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, documentDescriptor_);
    }
