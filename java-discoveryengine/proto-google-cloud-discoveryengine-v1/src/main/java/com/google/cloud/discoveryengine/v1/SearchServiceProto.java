  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ine/v1/document.proto\032\034google/protobuf/struct.proto\"\2740\n\r"
          + "SearchRequest\022L\n"
          ...
          + "yengine.v1.SearchRequest.BoostSpecB\003\340A\001\022$\n"
          + "\027custom_search_operators\030\007 \001(\tB\003\340A\001\032\374\002\n"
          + "\tFacetSpec\022Y\n"
          + "\tfacet_key\030\001 \001(\0132A.google."
          + "cloud.discoveryengine.v1.SearchRequest.FacetSpec.FacetKeyB\003\340A\002\022\r\n"
          ...
          + "\022boost_control_spec\030\003 \001(\0132\\.google.clo"
          + "ud.discoveryengine.v1.SearchRequest.Boos"
          + "tSpec.ConditionBoostSpec.BoostControlSpec\032\217\005\n"
          + "\020BoostControlSpec\022\022\n\n"
          + "field_name\030\001 \001(\t\022\202\001\n"
          + "\016attribute_type\030\002 \001(\0162j.google.clo"
          + "ud.discoveryengine.v1.SearchRequest.Boos"
          + "tSpec.ConditionBoostSpec.BoostControlSpec.AttributeType\022\212\001\n"
          + "\022interpolation_type\030\003 \001(\0162n.google.cloud.discoveryengine.v1.S"
          + "earchRequest.BoostSpec.ConditionBoostSpec.BoostControlSpec.InterpolationType\022\201\001\n"
          + "\016control_points\030\004 \003(\0132i.google.cloud.dis"
          + "coveryengine.v1.SearchRequest.BoostSpec."
          + "ConditionBoostSpec.BoostControlSpec.ControlPoint\032=\n"
          ...
          + "\tcondition\030\001 \001(\0162K.google.cloud.dis"
          + "coveryengine.v1.SearchRequest.QueryExpansionSpec.Condition\022\036\n"
          ...
          + "\004mode\030\001 \001(\0162G.googl"
          + "e.cloud.discoveryengine.v1.SearchRequest.SpellCorrectionSpec.Mode\";\n"
          + "\004Mode\022\024\n"
          ...
          + "\014snippet_spec\030\001 \001(\0132L.google.cloud.discoveryengin"
          + "e.v1.SearchRequest.ContentSearchSpec.SnippetSpec\022b\n"
          + "\014summary_spec\030\002 \001(\0132L.google."
          + "cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.SummarySpec\022w\n"
          + "\027extractive_content_spec\030\003 \001(\0132V.google.cloud.dis"
          + "coveryengine.v1.SearchRequest.ContentSearchSpec.ExtractiveContentSpec\022m\n"
          + "\022search_result_mode\030\004 \001(\0162Q.google.cloud.discove"
          + "ryengine.v1.SearchRequest.ContentSearchSpec.SearchResultMode\022^\n\n"
          + "chunk_spec\030\005 \001(\013"
          + "2J.google.cloud.discoveryengine.v1.SearchRequest.ContentSearchSpec.ChunkSpec\032`\n"
          ...
          + "oud.discoveryengine.v1.SearchRequest.Con"
          + "tentSearchSpec.SummarySpec.ModelPromptSpec\022\025\n\r"
          + "language_code\030\006 \001(\t\022j\n\n"
          + "model_spec\030\007 \001(\0132V.google.cloud.discoveryengine.v1."
          + "SearchRequest.ContentSearchSpec.SummarySpec.ModelSpec\022\033\n"
          ...
          + "\tcondition\030\001 \001(\0162L.google.cloud.di"
          + "scoveryengine.v1.SearchRequest.SearchAsYouTypeSpec.Condition\"K\n"
          + "\tCondition\022\031\n"
          + "\025CONDITION_UNSPECIFIED\020\000\022\014\n"
          ...
          + "\013DisplaySpec\022{\n"
          + "\034match_highlighting_condition\030\001 \001(\0162U.google"
          + ".cloud.discoveryengine.v1.SearchRequest."
          + "DisplaySpec.MatchHighlightingCondition\"\213\001\n"
          ...
          + "\024query_expansion_info\030\016 \001(\0132B.google.cloud.discoveryengin"
          + "e.v1.SearchResponse.QueryExpansionInfo\022Q\n"
          + "\014session_info\030\023 \001(\0132;.google.cloud.disc"
          + "overyengine.v1.SearchResponse.SessionInfo\022T\n"
          + "\026search_link_promotions\030\027 \003(\01324.goog"
          + "le.cloud.discoveryengine.v1.SearchLinkPromotion\032\331\002\n"
          + "\014SearchResult\022\n\n"
          ...
          + "\014model_scores\030\004 \003(\0132M.google.cloud.discoverye"
          + "ngine.v1.SearchResponse.SearchResult.ModelScoresEntryB\003\340A\003\032_\n"
          ...
          + "gle.cloud.discoveryengine.v1.SearchResponse.Facet.FacetValue\022\025\n\r"
          ...
          + "\027summary_skipped_reasons\030\002 \003(\0162L.goo"
          + "gle.cloud.discoveryengine.v1.SearchResponse.Summary.SummarySkippedReason\022c\n"
          + "\021safety_attributes\030\003 \001(\0132H.google.cloud.disco"
          + "veryengine.v1.SearchResponse.Summary.SafetyAttributes\022j\n"
          + "\025summary_with_metadata\030\004 \001(\0132K.google.cloud.discoveryengine.v1.S"
          + "earchResponse.Summary.SummaryWithMetadata\0326\n"
          + "\020SafetyAttributes\022\022\n\n"
          + "categories\030\001 \003(\t\022\016\n"
          + "\006scores\030\002 \003(\002\032g\n"
          + "\020CitationMetadata\022S\n"
          + "\tcitations\030\001 \003(\0132@.google.cloud.discover"
          + "yengine.v1.SearchResponse.Summary.Citation\032\213\001\n"
          + "\010Citation\022\023\n"
          + "\013start_index\030\001 \001(\003\022\021\n"
          + "\tend_index\030\002 \001(\003\022W\n"
          + "\007sources\030\003 \003(\0132F.googl"
          + "e.cloud.discoveryengine.v1.SearchResponse.Summary.CitationSource\032)\n"
          ...
          + "\016chunk_contents\030\004 \003(\0132N.google.cloud.discoveryengine.v1.Searc"
          + "hResponse.Summary.Reference.ChunkContent\0328\n"
          ...
          + "\021citation_metadata\030\002 \001(\0132H.google.cloud.discoveryengine.v1"
          + ".SearchResponse.Summary.CitationMetadata\022U\n\n"
          + "references\030\003 \003(\0132A.google.cloud.disc"
          + "overyengine.v1.SearchResponse.Summary.Reference\"\361\002\n"
          ...
          + "\006Search\022..google.cloud.discoveryengine.v1.SearchRequest\032/.google.cloud.discov"
          + "eryengine.v1.SearchResponse\"\243\002\202\323\344\223\002\234\002\"P/"
          + "v1/{serving_config=projects/*/locations/*/dataStores/*/servingConfigs/*}:search:"
          + "\001*Zc\"^/v1/{serving_config=projects/*/locations/*/collections/*/dataStores/*/serv"
          + "ingConfigs/*}:search:\001*Z`\"[/v1/{serving_config=projects/*/locations/*/collection"
          + "s/*/engines/*/servingConfigs/*}:search:\001*\022\237\003\n\n"
          + "SearchLite\022..google.cloud.discoveryengine.v1.SearchRequest\032/.google.cloud."
          + "discoveryengine.v1.SearchResponse\"\257\002\202\323\344\223"
          + "\002\250\002\"T/v1/{serving_config=projects/*/loca"
          + "tions/*/dataStores/*/servingConfigs/*}:searchLite:\001*Zg\"b/v1/{serving_config=proj"
          + "ects/*/locations/*/collections/*/dataStores/*/servingConfigs/*}:searchLite:\001*Zd\""
          + "_/v1/{serving_config=projects/*/locations/*/collections/*/engines/*/servingConfi"
          + "gs/*}:searchLite:\001*\032R\312A\036discoveryengine."
          + "googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\205\002\n"
          + "#com.google.cloud.discoveryengine.v1B\022SearchServicePr"
