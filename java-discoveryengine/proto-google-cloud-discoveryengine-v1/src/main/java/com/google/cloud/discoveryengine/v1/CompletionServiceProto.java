  ...
  static {
    java.lang.String[] descriptorData = {
      "\n8google/cloud/discoveryengine/v1/comple"
          ...
          + "id\030\004 \001(\t\"\241\001\n\025CompleteQueryResponse\022a\n\021qu"
          + "ery_suggestions\030\001 \003(\0132F.google.cloud.dis"
          + "coveryengine.v1.CompleteQueryResponse.Qu"
          + "erySuggestion\032%\n\017QuerySuggestion\022\022\n\nsugg"
          + "estion\030\001 \001(\t2\212\003\n\021CompletionService\022\240\002\n\rC"
          + "ompleteQuery\0225.google.cloud.discoveryeng"
          + "ine.v1.CompleteQueryRequest\0326.google.clo"
          + "ud.discoveryengine.v1.CompleteQueryRespo"
          + "nse\"\237\001\202\323\344\223\002\230\001\022B/v1/{data_store=projects/"
          + "*/locations/*/dataStores/*}:completeQuer"
          + "yZR\022P/v1/{data_store=projects/*/location"
          + "s/*/collections/*/dataStores/*}:complete"
          + "Query\032R\312A\036discoveryengine.googleapis.com"
          + "\322A.https://www.googleapis.com/auth/cloud"
          + "-platformB\211\002\n#com.google.cloud.discovery"
          + "engine.v1B\026CompletionServiceProtoP\001ZMclo"
          + "ud.google.com/go/discoveryengine/apiv1/d"
          + "iscoveryenginepb;discoveryenginepb\242\002\017DIS"
          + "COVERYENGINE\252\002\037Google.Cloud.DiscoveryEng"
          + "ine.V1\312\002\037Google\\Cloud\\DiscoveryEngine\\V1"
          + "\352\002\"Google::Cloud::DiscoveryEngine::V1b\006p"
          + "roto3"
    };
    descriptor =
