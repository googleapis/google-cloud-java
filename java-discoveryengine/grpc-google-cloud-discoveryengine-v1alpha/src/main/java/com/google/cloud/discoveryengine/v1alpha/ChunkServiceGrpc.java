...
public final class ChunkServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getGetChunkMethod = ChunkServiceGrpc.getGetChunkMethod) == null) {
      synchronized (ChunkServiceGrpc.class) {
        if ((getGetChunkMethod = ChunkServiceGrpc.getGetChunkMethod) == null) {
          ChunkServiceGrpc.getGetChunkMethod =
              getGetChunkMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.discoveryengine.v1alpha.GetChunkRequest,
                          com.google.cloud.discoveryengine.v1alpha.Chunk>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getListChunksMethod = ChunkServiceGrpc.getListChunksMethod) == null) {
      synchronized (ChunkServiceGrpc.class) {
        if ((getListChunksMethod = ChunkServiceGrpc.getListChunksMethod) == null) {
          ChunkServiceGrpc.getListChunksMethod =
              getListChunksMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.discoveryengine.v1alpha.ListChunksRequest,
                          com.google.cloud.discoveryengine.v1alpha.ListChunksResponse>
  ...
  public static ChunkServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChunkServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ChunkServiceStub>() {
          @java.lang.Override
          public ChunkServiceStub newStub(
   ...
   */
  public static ChunkServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChunkServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ChunkServiceBlockingStub>() {
          @java.lang.Override
          public ChunkServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ChunkServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ChunkServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ChunkServiceFutureStub>() {
          @java.lang.Override
          public ChunkServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getChunk(
        com.google.cloud.discoveryengine.v1alpha.GetChunkRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.Chunk>
            responseObserver) {
     ...
     * </pre>
     */
    default void listChunks(
        com.google.cloud.discoveryengine.v1alpha.ListChunksRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.ListChunksResponse>
            responseObserver) {
   ...
   * </pre>
   */
  public abstract static class ChunkServiceImplBase
  ...
  public static final class ChunkServiceStub
    ...
    private ChunkServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected ChunkServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new ChunkServiceStub(channel, callOptions);
    }
  ...
  public static final class ChunkServiceBlockingStub
    ...
    private ChunkServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
  ...
  public static final class ChunkServiceFutureStub
    ...
    private ChunkServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.discoveryengine.v1alpha.Chunk>
        getChunk(com.google.cloud.discoveryengine.v1alpha.GetChunkRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.discoveryengine.v1alpha.ListChunksResponse>
        listChunks(com.google.cloud.discoveryengine.v1alpha.ListChunksRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CHUNK:
          serviceImpl.getChunk(
              (com.google.cloud.discoveryengine.v1alpha.GetChunkRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.Chunk>)
                  responseObserver);
          break;
        case METHODID_LIST_CHUNKS:
          serviceImpl.listChunks(
              (com.google.cloud.discoveryengine.v1alpha.ListChunksRequest) request,
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloud.discoveryengine.v1alpha.GetChunkRequest,
                    com.google.cloud.discoveryengine.v1alpha.Chunk>(service, METHODID_GET_CHUNK)))
        .addMethod(
            getListChunksMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
  ...
  private abstract static class ChunkServiceBaseDescriptorSupplier
