...
public final class EstimateBillingServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getEstimateDataSizeMethod = EstimateBillingServiceGrpc.getEstimateDataSizeMethod)
      ...
      synchronized (EstimateBillingServiceGrpc.class) {
        if ((getEstimateDataSizeMethod = EstimateBillingServiceGrpc.getEstimateDataSizeMethod)
            == null) {
          EstimateBillingServiceGrpc.getEstimateDataSizeMethod =
              getEstimateDataSizeMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.discoveryengine.v1alpha.EstimateDataSizeRequest,
                          com.google.longrunning.Operation>
                      ...
                      .setSchemaDescriptor(
                          new EstimateBillingServiceMethodDescriptorSupplier("EstimateDataSize"))
                      .build();
        }
      }
    }
  ...
  public static EstimateBillingServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<EstimateBillingServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<EstimateBillingServiceStub>() {
          @java.lang.Override
          public EstimateBillingServiceStub newStub(
   ...
   */
  public static EstimateBillingServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<EstimateBillingServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<EstimateBillingServiceBlockingStub>() {
          @java.lang.Override
          public EstimateBillingServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static EstimateBillingServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<EstimateBillingServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<EstimateBillingServiceFutureStub>() {
          @java.lang.Override
          public EstimateBillingServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void estimateDataSize(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getEstimateDataSizeMethod(), responseObserver);
    }
  }
  ...
  public static final class EstimateBillingServiceStub
    ...
    private EstimateBillingServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void estimateDataSize(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getEstimateDataSizeMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class EstimateBillingServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        estimateDataSize(com.google.cloud.discoveryengine.v1alpha.EstimateDataSizeRequest request) {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloud.discoveryengine.v1alpha.EstimateDataSizeRequest,
                    com.google.longrunning.Operation>(service, METHODID_ESTIMATE_DATA_SIZE)))
        .build();
  }

  private abstract static class EstimateBillingServiceBaseDescriptorSupplier
