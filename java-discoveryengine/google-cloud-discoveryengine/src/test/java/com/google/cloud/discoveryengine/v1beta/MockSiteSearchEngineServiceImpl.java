...
import com.google.cloud.discoveryengine.v1beta.SiteSearchEngineServiceGrpc.SiteSearchEngineServiceImplBase;
...
public class MockSiteSearchEngineServiceImpl extends SiteSearchEngineServiceImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockSiteSearchEngineServiceImpl() {
  ...
  public void getSiteSearchEngine(
      GetSiteSearchEngineRequest request, StreamObserver<SiteSearchEngine> responseObserver) {
  ...
  public void createTargetSite(
      CreateTargetSiteRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
  ...
  public void batchCreateTargetSites(
      BatchCreateTargetSitesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void getTargetSite(
      GetTargetSiteRequest request, StreamObserver<TargetSite> responseObserver) {
    Object response = responses.poll();
  ...
  public void updateTargetSite(
      UpdateTargetSiteRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deleteTargetSite(
      DeleteTargetSiteRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void listTargetSites(
      ListTargetSitesRequest request, StreamObserver<ListTargetSitesResponse> responseObserver) {
    Object response = responses.poll();
  ...
  public void disableAdvancedSiteSearch(
      DisableAdvancedSiteSearchRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void recrawlUris(RecrawlUrisRequest request, StreamObserver<Operation> responseObserver) {
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method RecrawlUris, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void batchVerifyTargetSites(
      BatchVerifyTargetSitesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void fetchDomainVerificationStatus(
      ...
      StreamObserver<FetchDomainVerificationStatusResponse> responseObserver) {
    Object response = responses.poll();
