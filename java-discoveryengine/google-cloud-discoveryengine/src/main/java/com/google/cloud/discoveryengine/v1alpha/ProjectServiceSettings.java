...
public class ProjectServiceSettings extends ClientSettings<ProjectServiceSettings> {
  ...
  public UnaryCallSettings<ProvisionProjectRequest, Operation> provisionProjectSettings() {
    return ((ProjectServiceStubSettings) getStubSettings()).provisionProjectSettings();
  }

  /** Returns the object with the settings used for calls to provisionProject. */
  public OperationCallSettings<ProvisionProjectRequest, Project, ProvisionProjectMetadata>
      provisionProjectOperationSettings() {
    return ((ProjectServiceStubSettings) getStubSettings()).provisionProjectOperationSettings();
  }
  ...
  public UnaryCallSettings<ReportConsentChangeRequest, Project> reportConsentChangeSettings() {
    return ((ProjectServiceStubSettings) getStubSettings()).reportConsentChangeSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<ProjectServiceSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<ProvisionProjectRequest, Operation>
      ...
      return getStubSettingsBuilder().provisionProjectSettings();
    }

    /** Returns the builder for the settings used for calls to provisionProject. */
    public OperationCallSettings.Builder<ProvisionProjectRequest, Project, ProvisionProjectMetadata>
        provisionProjectOperationSettings() {
      return getStubSettingsBuilder().provisionProjectOperationSettings();
    }
    ...
    public UnaryCallSettings.Builder<ReportConsentChangeRequest, Project>
      ...
      return getStubSettingsBuilder().reportConsentChangeSettings();
    }
