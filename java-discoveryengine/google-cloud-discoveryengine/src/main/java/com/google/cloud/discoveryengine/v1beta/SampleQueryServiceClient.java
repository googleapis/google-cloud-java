 ...
 *      <td><p> Gets a [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery].</td>
 *      <td>
 ...
 *      <td><p> Gets a list of [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Creates a [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Updates a [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Deletes a [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Bulk import of multiple [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s. Sample queries that already exist may be deleted.
 * <p>  Note: It is possible for a subset of the [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s to be successfully imported.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class SampleQueryServiceClient implements BackgroundResource {
  private final @Nullable SampleQueryServiceSettings settings;
  ...
  public final @Nullable SampleQueryServiceSettings getSettings() {
    return settings;
  }
   ...
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery], regardless of whether or
   *     not it exists, a PERMISSION_DENIED error is returned.
   *     <p>If the requested [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery] does not
   *     exist, a NOT_FOUND error is returned.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final SampleQuery getSampleQuery(@Nullable SampleQueryName name) {
   ...
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s under this sample query
   *     set, regardless of whether or not this sample query set exists, a `PERMISSION_DENIED` error
   *     is returned.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListSampleQueriesPagedResponse listSampleQueries(
      @Nullable SampleQuerySetName parent) {
   ...
   *     `projects/{project}/locations/{location}/sampleQuerySets/{sampleQuerySet}`.
   * @param sampleQuery Required. The [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]
   *     to create.
   * @param sampleQueryId Required. The ID to use for the
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery], which will become the final
   *     component of the [SampleQuery.name][google.cloud.discoveryengine.v1beta.SampleQuery.name].
   *     <p>If the caller does not have permission to create the
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery], regardless of whether or
   *     not it exists, a `PERMISSION_DENIED` error is returned.
   *     <p>This field must be unique among all
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s with the same
   *     [parent][google.cloud.discoveryengine.v1beta.CreateSampleQueryRequest.parent]. Otherwise,
  ...
  public final SampleQuery createSampleQuery(
      @Nullable SampleQuerySetName parent, SampleQuery sampleQuery, String sampleQueryId) {
   ...
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery], regardless of whether or
   *     not it exists, a `PERMISSION_DENIED` error is returned.
   *     <p>If the [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery] to update does not
   *     exist a `NOT_FOUND` error is returned.
   ...
   *     [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery], regardless of whether or
   *     not it exists, a `PERMISSION_DENIED` error is returned.
   *     <p>If the [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery] to delete does not
   *     exist, a `NOT_FOUND` error is returned.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final void deleteSampleQuery(@Nullable SampleQueryName name) {
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Bulk import of multiple [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s. Sample
   * queries that already exist may be deleted.
   *
   * <p>Note: It is possible for a subset of the
   * [SampleQuery][google.cloud.discoveryengine.v1beta.SampleQuery]s to be successfully imported.
   *
   * <p>Sample code:
   *
   * <pre>{@code
  ...
  public static class ListSampleQueriesPage
    ...
    private ListSampleQueriesPage(
        @Nullable PageContext<ListSampleQueriesRequest, ListSampleQueriesResponse, SampleQuery>
            context,
        @Nullable ListSampleQueriesResponse response) {
  ...
  public static class ListSampleQueriesFixedSizeCollection
    ...
    private ListSampleQueriesFixedSizeCollection(
        @Nullable List<ListSampleQueriesPage> pages, int collectionSize) {
