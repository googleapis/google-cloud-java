...
import com.google.cloud.discoveryengine.v1beta.stub.CmekConfigServiceStub;
 ...
 *      <td><p> Gets the [CmekConfig][google.cloud.discoveryengine.v1beta.CmekConfig].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Lists all the [CmekConfig][google.cloud.discoveryengine.v1beta.CmekConfig]s with the project.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class CmekConfigServiceClient implements BackgroundResource {
   ...
   *     [CmekConfig][google.cloud.discoveryengine.v1beta.CmekConfig], regardless of whether or not
   ...
   *     [CmekConfig][google.cloud.discoveryengine.v1beta.CmekConfig]s under this location,
   *     regardless of whether or not a CmekConfig exists, a PERMISSION_DENIED error is returned.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
   ...
   *     [CmekConfig][google.cloud.discoveryengine.v1beta.CmekConfig] to delete, such as
