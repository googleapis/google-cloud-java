...
public class SessionServiceStubSettings extends StubSettings<SessionServiceStubSettings> {
  ...
  private static final PagedListDescriptor<ListFilesRequest, ListFilesResponse, FileMetadata>
      LIST_FILES_PAGE_STR_DESC =
          new PagedListDescriptor<ListFilesRequest, ListFilesResponse, FileMetadata>() {
            @Override
            public String emptyToken() {
              return "";
            }
      ...
      LIST_FILES_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListFilesPagedResponse> getFuturePagedResponse(
              ...
              PageContext<ListFilesRequest, ListFilesResponse, FileMetadata> pageContext =
