...
public class RecommendationServiceStubSettings
  ...
  private final UnaryCallSettings<RecommendRequest, RecommendResponse> recommendSettings;
  ...
  public RecommendationServiceStub createStub() throws IOException {
    ...
    if (getTransportChannelProvider()
      ...
      return HttpJsonRecommendationServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return RecommendationServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected RecommendationServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    recommendSettings = settingsBuilder.recommendSettings().build();
  }
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<RecommendRequest, RecommendResponse> recommendSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      recommendSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(recommendSettings);
      initDefaults(this);
    }
    ...
    protected Builder(RecommendationServiceStubSettings settings) {
      ...
      recommendSettings = settings.recommendSettings.toBuilder();
