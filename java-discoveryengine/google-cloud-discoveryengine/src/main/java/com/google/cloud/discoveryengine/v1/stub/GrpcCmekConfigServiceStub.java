...
public class GrpcCmekConfigServiceStub extends CmekConfigServiceStub {
  private static final MethodDescriptor<UpdateCmekConfigRequest, Operation>
      updateCmekConfigMethodDescriptor =
          MethodDescriptor.<UpdateCmekConfigRequest, Operation>newBuilder()
  ...
  private static final MethodDescriptor<ListCmekConfigsRequest, ListCmekConfigsResponse>
      listCmekConfigsMethodDescriptor =
          MethodDescriptor.<ListCmekConfigsRequest, ListCmekConfigsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
  ...
  private static final MethodDescriptor<DeleteCmekConfigRequest, Operation>
      deleteCmekConfigMethodDescriptor =
          MethodDescriptor.<DeleteCmekConfigRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
  ...
  public static final GrpcCmekConfigServiceStub create(CmekConfigServiceStubSettings settings)
      throws IOException {
    return new GrpcCmekConfigServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcCmekConfigServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcCmekConfigServiceStub(
        CmekConfigServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcCmekConfigServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcCmekConfigServiceStub(
        CmekConfigServiceStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcCmekConfigServiceStub, using the given settings. This is
   * protected so that it is easy to make a subclass, but otherwise, the static factory methods
   * should be preferred.
   */
  protected GrpcCmekConfigServiceStub(
      CmekConfigServiceStubSettings settings, ClientContext clientContext) throws IOException {
    this(settings, clientContext, new GrpcCmekConfigServiceCallableFactory());
  }
  ...
  protected GrpcCmekConfigServiceStub(
    ...
    GrpcCallSettings<UpdateCmekConfigRequest, Operation> updateCmekConfigTransportSettings =
        GrpcCallSettings.<UpdateCmekConfigRequest, Operation>newBuilder()
    ...
    GrpcCallSettings<ListCmekConfigsRequest, ListCmekConfigsResponse>
        listCmekConfigsTransportSettings =
            GrpcCallSettings.<ListCmekConfigsRequest, ListCmekConfigsResponse>newBuilder()
