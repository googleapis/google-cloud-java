...
import com.google.cloud.discoveryengine.v1alpha.stub.ControlServiceStub;
import com.google.cloud.discoveryengine.v1alpha.stub.ControlServiceStubSettings;
 ...
 * <p>  By default 1000 controls are allowed for a data store. A request can be submitted to adjust this limit. If the [Control][google.cloud.discoveryengine.v1alpha.Control] to create already exists, an ALREADY_EXISTS error is returned.</td>
 *      <td>
 ...
 * <p>  If the [Control][google.cloud.discoveryengine.v1alpha.Control] to delete does not exist, a NOT_FOUND error is returned.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 * <p>  [Control][google.cloud.discoveryengine.v1alpha.Control] action type cannot be changed. If the [Control][google.cloud.discoveryengine.v1alpha.Control] to update does not exist, a NOT_FOUND error is returned.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Lists all Controls by their parent [DataStore][google.cloud.discoveryengine.v1alpha.DataStore].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class ControlServiceClient implements BackgroundResource {
   ...
   * this limit. If the [Control][google.cloud.discoveryengine.v1alpha.Control] to create already
   ...
   * Deletes a Control.
   *
   * <p>If the [Control][google.cloud.discoveryengine.v1alpha.Control] to delete does not exist, a
   ...
   * Updates a Control.
   *
   * <p>[Control][google.cloud.discoveryengine.v1alpha.Control] action type cannot be changed. If
   * the [Control][google.cloud.discoveryengine.v1alpha.Control] to update does not exist, a
   * NOT_FOUND error is returned.
   *
   * <p>Sample code:
   *
   ...
   *     [Control][google.cloud.discoveryengine.v1alpha.Control] to update. The following are NOT
   *     supported:
   *     <ul>
   *       <li>[Control.name][google.cloud.discoveryengine.v1alpha.Control.name]
   *       <li>[Control.solution_type][google.cloud.discoveryengine.v1alpha.Control.solution_type]
   *     </ul>
