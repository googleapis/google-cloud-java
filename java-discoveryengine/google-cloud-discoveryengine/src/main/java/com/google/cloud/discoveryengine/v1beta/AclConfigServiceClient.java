...
import com.google.cloud.discoveryengine.v1beta.stub.AclConfigServiceStub;
 ...
 *      <td><p> Gets the [AclConfig][google.cloud.discoveryengine.v1beta.AclConfig].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class AclConfigServiceClient implements BackgroundResource {
   ...
   *     [AclConfig][google.cloud.discoveryengine.v1beta.AclConfig], regardless of whether or not it
