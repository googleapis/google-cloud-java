 ...
 * configure the RetrySettings for provisionProject:
 *
 * <pre>{@code
 * // This snippet has been automatically generated and should be regarded as a code template only.
 * // It will require modifications to work:
...
public class ProjectServiceStubSettings extends StubSettings<ProjectServiceStubSettings> {
  ...
  private final UnaryCallSettings<ProvisionProjectRequest, Operation> provisionProjectSettings;
  private final OperationCallSettings<ProvisionProjectRequest, Project, ProvisionProjectMetadata>
      provisionProjectOperationSettings;
  private final UnaryCallSettings<ReportConsentChangeRequest, Project> reportConsentChangeSettings;
  ...
  /** Returns the object with the settings used for calls to provisionProject. */
  public UnaryCallSettings<ProvisionProjectRequest, Operation> provisionProjectSettings() {
    return provisionProjectSettings;
  }

  /** Returns the object with the settings used for calls to provisionProject. */
  public OperationCallSettings<ProvisionProjectRequest, Project, ProvisionProjectMetadata>
      provisionProjectOperationSettings() {
    return provisionProjectOperationSettings;
  }

  /** Returns the object with the settings used for calls to reportConsentChange. */
  public UnaryCallSettings<ReportConsentChangeRequest, Project> reportConsentChangeSettings() {
  ...
  protected ProjectServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    provisionProjectSettings = settingsBuilder.provisionProjectSettings().build();
    provisionProjectOperationSettings = settingsBuilder.provisionProjectOperationSettings().build();
    reportConsentChangeSettings = settingsBuilder.reportConsentChangeSettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<ProjectServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<ProvisionProjectRequest, Operation>
        provisionProjectSettings;
    private final OperationCallSettings.Builder<
            ProvisionProjectRequest, Project, ProvisionProjectMetadata>
        provisionProjectOperationSettings;
    private final UnaryCallSettings.Builder<ReportConsentChangeRequest, Project>
    ...
    protected Builder(ClientContext clientContext) {
      ...
      provisionProjectSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      provisionProjectOperationSettings = OperationCallSettings.newBuilder();
      reportConsentChangeSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getProjectSettings, provisionProjectSettings, reportConsentChangeSettings);
      initDefaults(this);
    }
    ...
    protected Builder(ProjectServiceStubSettings settings) {
      ...
      provisionProjectSettings = settings.provisionProjectSettings.toBuilder();
      provisionProjectOperationSettings = settings.provisionProjectOperationSettings.toBuilder();
      reportConsentChangeSettings = settings.reportConsentChangeSettings.toBuilder();
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<ProvisionProjectRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_1_params"))
                  .build())
          ...
          .setMetadataTransformer(
              ProtoOperationTransformers.MetadataTransformer.create(ProvisionProjectMetadata.class))
          .setPollingAlgorithm(
    ...
    /** Returns the builder for the settings used for calls to provisionProject. */
    public UnaryCallSettings.Builder<ProvisionProjectRequest, Operation>
        provisionProjectSettings() {
      return provisionProjectSettings;
    }

    /** Returns the builder for the settings used for calls to provisionProject. */
    public OperationCallSettings.Builder<ProvisionProjectRequest, Project, ProvisionProjectMetadata>
        provisionProjectOperationSettings() {
      return provisionProjectOperationSettings;
    }

    /** Returns the builder for the settings used for calls to reportConsentChange. */
