...
public final class ExportArtifactRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ExportArtifactRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (sourceArtifactCase_ == 2) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, sourceArtifact_);
    }
    if (destinationCase_ == 3) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, destination_);
    }
    if (sourceArtifactCase_ == 4) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, sourceArtifact_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (sourceArtifactCase_ == 2) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, sourceArtifact_);
    }
    if (destinationCase_ == 3) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, destination_);
    }
    if (sourceArtifactCase_ == 4) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, sourceArtifact_);
    }
