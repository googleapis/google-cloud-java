...
public final class AptArtifactProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "6google/devtools/artifactregistry/v1/apt_artifact.proto\022#google.devtools.artifa"
          + "ctregistry.v1\032\037google/api/field_behavior"
          + ".proto\032\031google/api/resource.proto\032\027google/rpc/status.proto\"\272\003\n"
          ...
          + ".artifactregistry.v1.AptArtifact.PackageTypeB\003\340A\003\022\031\n"
          ...
          + "+artifactregistry.googleapis.com/AptArtifact\022]projects/{project}/locations/{"
          + "location}/repositories/{repository}/aptArtifacts/{apt_artifact}\"B\n"
          + "\033ImportAptArtifactsGcsSource\022\014\n"
          + "\004uris\030\001 \003(\t\022\025\n\r"
          + "use_wildcards\030\002 \001(\010\"\215\001\n"
          + "\031ImportAptArtifactsRequest\022V\n\n"
          + "gcs_source\030\002 \001(\0132@.google.devtools."
          + "artifactregistry.v1.ImportAptArtifactsGcsSourceH\000\022\016\n"
          + "\006parent\030\001 \001(\tB\010\n"
          + "\006source\"\242\001\n"
          + "\033ImportAptArtifactsErrorInfo\022V\n\n"
          + "gcs_source\030\001"
          + " \001(\0132@.google.devtools.artifactregistry.v1.ImportAptArtifactsGcsSourceH\000\022!\n"
          + "\005error\030\002 \001(\0132\022.google.rpc.StatusB\010\n"
          + "\006source\"\267\001\n"
          + "\032ImportAptArtifactsResponse\022G\n\r"
          + "apt_artifacts\030\001"
          + " \003(\01320.google.devtools.artifactregistry.v1.AptArtifact\022P\n"
          + "\006errors\030\002 \003(\013"
          + "2@.google.devtools.artifactregistry.v1.ImportAptArtifactsErrorInfo\"\034\n"
          + "\032ImportAptArtifactsMetadataB\373\001\n"
          + "\'com.google.devtools.artifactregistry.v1B\020AptArtifactProtoP\001"
          + "ZPcloud.google.com/go/artifactregistry/a"
          + "piv1/artifactregistrypb;artifactregistrypb\252\002"
