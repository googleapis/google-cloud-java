...
public final class YumArtifactProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "6google/devtools/artifactregistry/v1/yum_artifact.proto\022#google.devtools.artifa"
          + "ctregistry.v1\032\037google/api/field_behavior"
          + ".proto\032\031google/api/resource.proto\032\027google/rpc/status.proto\"\207\003\n"
          ...
          + ".artifactregistry.v1.YumArtifact.PackageTypeB\003\340A\003\022\031\n"
          ...
          + "+artifactregistry.googleapis.com/YumArtifact\022]p"
          + "rojects/{project}/locations/{location}/r"
          + "epositories/{repository}/yumArtifacts/{yum_artifact}\"B\n"
          + "\033ImportYumArtifactsGcsSource\022\014\n"
          + "\004uris\030\001 \003(\t\022\025\n\r"
          + "use_wildcards\030\002 \001(\010\"\215\001\n"
          + "\031ImportYumArtifactsRequest\022V\n\n"
          + "gcs_source\030\002 \001(\0132@.google.devtools.artifactreg"
          + "istry.v1.ImportYumArtifactsGcsSourceH\000\022\016\n"
          + "\006parent\030\001 \001(\tB\010\n"
          + "\006source\"\242\001\n"
          + "\033ImportYumArtifactsErrorInfo\022V\n\n"
          + "gcs_source\030\001 \001(\0132@.g"
          + "oogle.devtools.artifactregistry.v1.ImportYumArtifactsGcsSourceH\000\022!\n"
          + "\005error\030\002 \001(\0132\022.google.rpc.StatusB\010\n"
          + "\006source\"\267\001\n"
          + "\032ImportYumArtifactsResponse\022G\n\r"
          + "yum_artifacts\030\001 "
          + "\003(\01320.google.devtools.artifactregistry.v1.YumArtifact\022P\n"
          + "\006errors\030\002 \003(\0132@.google.d"
          + "evtools.artifactregistry.v1.ImportYumArtifactsErrorInfo\"\034\n"
          + "\032ImportYumArtifactsMetadataB\373\001\n"
          + "\'com.google.devtools.artifactregistry.v1B\020YumArtifactProtoP\001ZPcloud.goo"
          + "gle.com/go/artifactregistry/apiv1/artifactregistrypb;artifactregistrypb\252\002"
          + " Google.Cloud.ArtifactRegistry.V1\312\002 Google\\Clou"
          + "d\\ArtifactRegistry\\V1\352\002#Google::Cloud::ArtifactRegistry::V1b\006proto3"
    };
    descriptor =
