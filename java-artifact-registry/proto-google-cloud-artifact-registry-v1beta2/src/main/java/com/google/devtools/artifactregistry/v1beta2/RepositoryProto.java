...
public final class RepositoryProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "9google/devtools/artifactregistry/v1beta2/repository.proto\022(google.devtools.art"
          + "ifactregistry.v1beta2\032\037google/api/field_"
          + "behavior.proto\032\031google/api/resource.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\271\007\n\n"
          + "Repository\022b\n"
          + "\014maven_config\030\t \001(\0132J.google.devto"
          + "ols.artifactregistry.v1beta2.Repository.MavenRepositoryConfigH\000\022\014\n"
          + "\004name\030\001 \001(\t\022K\n"
          + "\006format\030\002"
          + " \001(\0162;.google.devtools.artifactregistry.v1beta2.Repository.Format\022\023\n"
          + "\013description\030\003 \001(\t\022P\n"
          + "\006labels\030\004 \003(\0132@.google"
          + ".devtools.artifactregistry.v1beta2.Repository.LabelsEntry\022/\n"
          ...
          + "\014kms_key_name\030\010 \001(\t\032\370\001\n"
          ...
          + ".artifactregistry.v1beta2.Repository.MavenRepositoryConfig.VersionPolicy\"J\n\r"
          ...
          + "/locations/{location}/repositories/{repository}B\017\n\r"
          + "format_config\"\204\001\n"
          + "\027ListRepositoriesRequest\022B\n"
          + "\006parent\030\001 \001(\tB2\340A\002\372A,\022*ar"
          + "tifactregistry.googleapis.com/Repository\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          + "page_token\030\003 \001(\t\"\177\n"
          + "\030ListRepositoriesResponse\022J\n"
          + "\014repositories\030\001"
          + " \003(\01324.google.devtools.artifactregistry.v1beta2.Repository\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"X\n"
          + "\024GetRepositoryRequest\022@\n"
          + "\004name\030\001 \001(\tB2\340A\002\372A,\n"
          + "*artifactregistry.googleapis.com/Repository\"\276\001\n"
          + "\027CreateRepositoryRequest\022B\n"
          + "\006parent\030\001 \001("
          + "\tB2\340A\002\372A,\022*artifactregistry.googleapis.com/Repository\022\025\n\r"
          + "repository_id\030\002 \001(\t\022H\n\n"
          + "repository\030\003 \001(\01324."
          + "google.devtools.artifactregistry.v1beta2.Repository\"\224\001\n"
          + "\027UpdateRepositoryRequest\022H\n\n"
          + "repository\030\001"
          + " \001(\01324.google.devtools.artifactregistry.v1beta2.Repository\022/\n"
          + "\013update_mask\030\002 \001(\0132\032.google.protobuf.FieldMask\"[\n"
          + "\027DeleteRepositoryRequest\022@\n"
          + "\004name\030\001 \001(\tB2\340A\002\372A,\n"
          + "*artifactregistry.googleapis.com/RepositoryB\223\002\n"
          + ",com.google.devtools.artifactregistry.v1beta2B\017RepositoryProt"
          + "oP\001ZUcloud.google.com/go/artifactregistry/apiv1beta2/artifactregistrypb;artifact"
          + "registrypb\252\002%Google.Cloud.ArtifactRegist"
          + "ry.V1Beta2\312\002%Google\\Cloud\\ArtifactRegist"
          + "ry\\V1beta2\352\002(Google::Cloud::ArtifactRegistry::V1beta2b\006proto3"
    };
    descriptor =
