...
public class ProjectSettingsName implements ResourceName {
  ...
  public static @Nullable ProjectSettingsName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProjectSettingsName> values) {
