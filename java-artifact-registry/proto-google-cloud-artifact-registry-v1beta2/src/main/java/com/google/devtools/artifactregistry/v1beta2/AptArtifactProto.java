...
public final class AptArtifactProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ";google/devtools/artifactregistry/v1beta2/apt_artifact.proto\022(google.devtools.a"
          + "rtifactregistry.v1beta2\032\037google/api/fiel"
          + "d_behavior.proto\032\031google/api/resource.proto\032\027google/rpc/status.proto\"\277\003\n"
          + "\013AptArtifact\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\031\n"
          + "\014package_name\030\002 \001(\tB\003\340A\003\022\\\n"
          + "\014package_type\030\003 \001(\0162A.googl"
          + "e.devtools.artifactregistry.v1beta2.AptArtifact.PackageTypeB\003\340A\003\022\031\n"
          ...
          + "+artifactregistry.googleapis.com/AptArtifact\022]projects/{proje"
          + "ct}/locations/{location}/repositories/{repository}/aptArtifacts/{apt_artifact}\"B\n"
          + "\033ImportAptArtifactsGcsSource\022\014\n"
          + "\004uris\030\001 \003(\t\022\025\n\r"
          + "use_wildcards\030\002 \001(\010\"\222\001\n"
          + "\031ImportAptArtifactsRequest\022[\n\n"
          + "gcs_source\030\002 \001(\0132E.g"
          + "oogle.devtools.artifactregistry.v1beta2.ImportAptArtifactsGcsSourceH\000\022\016\n"
          + "\006parent\030\001 \001(\tB\010\n"
          + "\006source\"\247\001\n"
          + "\033ImportAptArtifactsErrorInfo\022[\n\n"
          + "gcs_source\030\001 \001(\0132E.google.dev"
          + "tools.artifactregistry.v1beta2.ImportAptArtifactsGcsSourceH\000\022!\n"
          + "\005error\030\002 \001(\0132\022.google.rpc.StatusB\010\n"
          + "\006source\"\301\001\n"
          + "\032ImportAptArtifactsResponse\022L\n\r"
          + "apt_artifacts\030\001 \003(\0132"
          + "5.google.devtools.artifactregistry.v1beta2.AptArtifact\022U\n"
          + "\006errors\030\002 \003(\0132E.google."
          + "devtools.artifactregistry.v1beta2.ImportAptArtifactsErrorInfo\"\034\n"
          + "\032ImportAptArtifactsMetadataB\224\002\n"
          + ",com.google.devtools.artifactregistry.v1beta2B\020AptArtifactProtoP\001"
          + "ZUcloud.google.com/go/artifactregistry/apiv1beta2/artifactregistrypb;artifactreg"
          + "istrypb\252\002%Google.Cloud.ArtifactRegistry."
          + "V1Beta2\312\002%Google\\Cloud\\ArtifactRegistry\\"
          + "V1beta2\352\002(Google::Cloud::ArtifactRegistry::V1beta2b\006proto3"
    };
    descriptor =
