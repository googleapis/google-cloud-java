...
public class UpdateModelDescriptionIT {
  ...
  @Test
  public void testUpdateModelDescription() {
    String newDescription = "A really great model.";
    UpdateModelDescription.updateModelDescription(BIGQUERY_DATASET_NAME, modelName, newDescription);
    assertThat(bout.toString()).contains("Model description updated successfully");
  }
}
