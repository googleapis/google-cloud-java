...
public class DeleteMaterializedViewIT {
  ...
  @Test
  public void testDeleteMaterializedView() {
    DeleteMaterializedView.deleteMaterializedView(BIGQUERY_DATASET_NAME, materializedViewName);
    assertThat(bout.toString()).contains("Materialized view deleted successfully");
  }
}
