...
public abstract class BigLakeConfiguration implements Serializable {
  ...
  public abstract static class Builder {
    /**
     * Immutable. Credential reference for accessing external storage
    ...
    /**
     * Immutable. Open source file format that the table data is stored in.
    ...
    /**
     * Immutable. Fully qualified location prefix of the external folder
