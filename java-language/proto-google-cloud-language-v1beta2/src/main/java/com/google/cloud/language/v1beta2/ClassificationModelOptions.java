...
public final class ClassificationModelOptions extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ClassificationModelOptions(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class V1Model extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private V1Model(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        implements
        // @@protoc_insertion_point(builder_implements:google.cloud.language.v1beta2.ClassificationModelOptions.V1Model)
      ...
      @java.lang.Override
      public com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model
      ...
      @java.lang.Override
      public com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model build() {
        com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model result =
            buildPartial();
      ...
      @java.lang.Override
      public com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model buildPartial() {
        com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model result =
            new com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model(this);
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model) {
          return mergeFrom(
              (com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model) other);
        } else {
      ...
      // @@protoc_insertion_point(builder_scope:google.cloud.language.v1beta2.ClassificationModelOptions.V1Model)
    }

    // @@protoc_insertion_point(class_scope:google.cloud.language.v1beta2.ClassificationModelOptions.V1Model)
    private static final com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model
        DEFAULT_INSTANCE;

    static {
      DEFAULT_INSTANCE = new com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model();
    }
  ...
  public interface V2ModelOrBuilder
      extends
      // @@protoc_insertion_point(interface_extends:google.cloud.language.v1beta2.ClassificationModelOptions.V2Model)
      com.google.protobuf.MessageOrBuilder {
   ...
   */
  public static final class V2Model extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private V2Model(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public enum ContentCategoriesVersion implements com.google.protobuf.ProtocolMessageEnum {
      ...
      public static com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
        return com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model.getDescriptor()
            .getEnumTypes()
            .get(0);
      }
      ...
      // @@protoc_insertion_point(enum_scope:google.cloud.language.v1beta2.ClassificationModelOptions.V2Model.ContentCategoriesVersion)
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        implements
        // @@protoc_insertion_point(builder_implements:google.cloud.language.v1beta2.ClassificationModelOptions.V2Model)
      ...
      @java.lang.Override
      public com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model build() {
        com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model result =
            buildPartial();
        if (!result.isInitialized()) {
          throw newUninitializedMessageException(result);
        }
      ...
      @java.lang.Override
      public com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model buildPartial() {
        com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model result =
            new com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model(this);
        if (bitField0_ != 0) {
      ...
      @java.lang.Override
      public Builder mergeFrom(com.google.protobuf.Message other) {
        if (other instanceof com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model) {
          return mergeFrom(
              (com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model) other);
        } else {
          super.mergeFrom(other);
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.cloud.language.v1beta2.ClassificationModelOptions)
    ...
    // Construct using com.google.cloud.language.v1beta2.ClassificationModelOptions.newBuilder()
    private Builder() {}
    ...
    public com.google.cloud.language.v1beta2.ClassificationModelOptions
        getDefaultInstanceForType() {
      return com.google.cloud.language.v1beta2.ClassificationModelOptions.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.language.v1beta2.ClassificationModelOptions build() {
      com.google.cloud.language.v1beta2.ClassificationModelOptions result = buildPartial();
      if (!result.isInitialized()) {
        throw newUninitializedMessageException(result);
      }
      return result;
    ...
    @java.lang.Override
    public com.google.cloud.language.v1beta2.ClassificationModelOptions buildPartial() {
      com.google.cloud.language.v1beta2.ClassificationModelOptions result =
          new com.google.cloud.language.v1beta2.ClassificationModelOptions(this);
      if (bitField0_ != 0) {
        buildPartial0(result);
      }
    ...
    @java.lang.Override
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.language.v1beta2.ClassificationModelOptions) {
        return mergeFrom((com.google.cloud.language.v1beta2.ClassificationModelOptions) other);
      } else {
        super.mergeFrom(other);
        return this;
      }
    ...
    public Builder mergeFrom(com.google.cloud.language.v1beta2.ClassificationModelOptions other) {
      if (other
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetV1ModelFieldBuilder().getBuilder(), extensionRegistry);
                modelTypeCase_ = 1;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(internalGetV2ModelFieldBuilder().getBuilder(), extensionRegistry);
                modelTypeCase_ = 2;
                break;
              } // case 18
            default:
    ...
    public com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model.Builder
        getV1ModelBuilder() {
      return internalGetV1ModelFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model.Builder,
            com.google.cloud.language.v1beta2.ClassificationModelOptions.V1ModelOrBuilder>
        internalGetV1ModelFieldBuilder() {
      if (v1ModelBuilder_ == null) {
        if (!(modelTypeCase_ == 1)) {
          modelType_ =
              com.google.cloud.language.v1beta2.ClassificationModelOptions.V1Model
    ...
    public com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model.Builder
        getV2ModelBuilder() {
      return internalGetV2ModelFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model.Builder,
            com.google.cloud.language.v1beta2.ClassificationModelOptions.V2ModelOrBuilder>
        internalGetV2ModelFieldBuilder() {
      if (v2ModelBuilder_ == null) {
        if (!(modelTypeCase_ == 2)) {
          modelType_ =
              com.google.cloud.language.v1beta2.ClassificationModelOptions.V2Model
  ...
  @java.lang.Override
  public com.google.cloud.language.v1beta2.ClassificationModelOptions getDefaultInstanceForType() {
    return DEFAULT_INSTANCE;
  }
}
