...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-language" % "2.20.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-language/2.19.0
