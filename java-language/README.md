...
```Groovy
implementation 'com.google.cloud:google-cloud-language:2.1.10'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-language" % "2.1.10"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-language/latest/history
