...
```Groovy
implementation 'com.google.cloud:google-cloud-language:2.99.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-language/2.99.0
