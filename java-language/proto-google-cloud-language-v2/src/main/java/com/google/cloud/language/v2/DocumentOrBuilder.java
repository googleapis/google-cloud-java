...
public interface DocumentOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.language.v2.Document)
   ...
   * @return The type.
   */
  com.google.cloud.language.v2.Document.Type getType();
  ...
  com.google.cloud.language.v2.Document.SourceCase getSourceCase();
}
