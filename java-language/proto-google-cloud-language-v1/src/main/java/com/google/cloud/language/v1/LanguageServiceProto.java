...
public final class LanguageServiceProto extends com.google.protobuf.GeneratedFile {
  ...
  static final com.google.protobuf.Descriptors.Descriptor
      internal_static_google_cloud_language_v1_ModerateTextResponse_descriptor;
  static final com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_google_cloud_language_v1_ModerateTextResponse_fieldAccessorTable;
  static final com.google.protobuf.Descriptors.Descriptor
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ient.proto\032\037google/api/field_behavior.proto\"\303\001\n"
          + "\010Document\0225\n"
          ...
          + "\006source\"t\n"
          + "\010Sentence\0220\n"
          + "\004text\030\001 \001(\0132\".google.cloud.language.v1.TextSpan\0226\n"
          ...
          + "\010metadata\030\003"
          + " \003(\0132..google.cloud.language.v1.Entity.MetadataEntry\022\020\n"
          + "\010salience\030\004 \001(\002\0229\n"
          + "\010mentions\030\005 \003(\0132\'.google.cloud.language.v1.EntityMention\0226\n"
          ...
          + " \001(\0132(.google.cloud.language.v1.DependencyEdge\022\r\n"
          + "\005lemma\030\004 \001(\t\"-\n"
          + "\tSentiment\022\021\n"
          + "\tmagnitude\030\002 \001(\002\022\r\n"
          + "\005score\030\003 \001(\002\"\243\020\n"
          + "\014PartOfSpeech\0227\n"
          + "\003tag\030\001 \001(\0162*.google.cloud.language.v1.PartOfSpeech.Tag\022=\n"
          + "\006aspect\030\002 \001(\0162-.google.cloud.language.v1.PartOfSpeech.Aspect\0229\n"
          + "\004case\030\003 \001(\0162+.google.cloud.language.v1.PartOfSpeech.Case\0229\n"
          + "\004form\030\004 \001(\0162+.google.cloud.language.v1.PartOfSpeech.Form\022=\n"
          + "\006gender\030\005 \001(\0162-.google.cloud.language.v1.PartOfSpeech.Gender\0229\n"
          ...
          + "\006person\030\010 \001(\0162-.google.cloud.language.v1.PartOfSpeech.Person\022=\n"
          + "\006proper\030\t \001(\0162-.google.cloud.language.v1.PartOfSpeech.Proper\022G\n"
          + "\013reciprocity\030\n"
          + " \001(\01622.google.cloud.language.v1.PartOfSpeech.Reciprocity\022;\n"
          + "\005tense\030\013 \001(\0162,.google.cloud.language.v1.PartOfSpeech.Tense\022;\n"
          + "\005voice\030\014 \001(\0162,.google.cloud.language.v1.PartOfSpeech.Voice\"\215\001\n"
          + "\003Tag\022\013\n"
          ...
          + "e.cloud.language.v1.DependencyEdge.Label\"\251\007\n"
          + "\005Label\022\013\n"
          + "\007UNKNOWN\020\000\022\n\n"
          ...
          + "EntityMention\0220\n"
          + "\004text\030\001 \001(\0132\".google.cloud.language.v1.TextSpan\022:\n"
          + "\004type\030\002 \001(\0162,.google.cloud.language.v1.EntityMention.Type\0226\n"
          + "\tsentiment\030\003 \001(\0132#.google.cloud.language.v1.Sentiment\"0\n"
          + "\004Type\022\020\n"
          ...
          + "confidence\030\002 \001(\002\"\270\003\n"
          + "\032ClassificationModelOptions\022P\n"
          + "\010v1_model\030\001 \001(\0132<.google.cloud.language.v"
          + "1.ClassificationModelOptions.V1ModelH\000\022P\n"
          + "\010v2_model\030\002 \001(\0132<.google.cloud.language"
          + ".v1.ClassificationModelOptions.V2ModelH\000\032\t\n"
          + "\007V1Model\032\334\001\n"
          + "\007V2Model\022y\n"
          + "\032content_categories_version\030\001 \001(\0162U.google.cloud.langu"
          + "age.v1.ClassificationModelOptions.V2Model.ContentCategoriesVersion\"V\n"
          + "\030ContentCategoriesVersion\022*\n"
          + "&CONTENT_CATEGORIES_VERSION_UNSPECIFIED\020\000\022\006\n"
          + "\002V1\020\001\022\006\n"
          + "\002V2\020\002B\014\n\n"
          + "model_type\"\223\001\n"
          + "\027AnalyzeSentimentRequest\0229\n"
          + "\010document\030\001"
          + " \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\022=\n\r"
          + "encoding_type\030\002 \001(\0162&.google.cloud.language.v1.EncodingType\"\244\001\n"
          + "\030AnalyzeSentimentResponse\022?\n"
          + "\022document_sentiment\030\001"
          + " \001(\0132#.google.cloud.language.v1.Sentiment\022\020\n"
          + "\010language\030\002 \001(\t\0225\n"
          + "\tsentences\030\003 \003(\0132\".google.cloud.language.v1.Sentence\"\231\001\n"
          + "\035AnalyzeEntitySentimentRequest\0229\n"
          + "\010document\030\001"
          + " \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\022=\n\r"
          + "encoding_type\030\002 \001(\0162&.google.cloud.language.v1.EncodingType\"f\n"
          ...
          + "\010document\030\001"
          + " \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\022=\n\r"
          + "encoding_type\030\002 \001(\0162&.google.cloud.language.v1.EncodingType\"_\n"
          + "\027AnalyzeEntitiesResponse\0222\n"
          + "\010entities\030\001 \003(\0132 .google.cloud.language.v1.Entity\022\020\n"
          + "\010language\030\002 \001(\t\"\220\001\n"
          + "\024AnalyzeSyntaxRequest\0229\n"
          + "\010document\030\001"
          + " \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\022=\n\r"
          + "encoding_type\030\002 \001(\0162&.google.cloud.language.v1.EncodingType\"\221\001\n"
          + "\025AnalyzeSyntaxResponse\0225\n"
          + "\tsentences\030\001 \003(\0132\".google.cloud.language.v1.Sentence\022/\n"
          + "\006tokens\030\002 \003(\0132\037.google.cloud.language.v1.Token\022\020\n"
          + "\010language\030\003 \001(\t\"\254\001\n"
          + "\023ClassifyTextRequest\0229\n"
          + "\010document\030\001"
          + " \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\022Z\n"
          + "\034classification_model_options\030\003"
          + " \001(\01324.google.cloud.language.v1.ClassificationModelOptions\"\\\n"
          + "\024ClassifyTextResponse\022D\n\n"
          + "categories\030\001 \003(\01320.google.cloud.language.v1.ClassificationCategory\"P\n"
          + "\023ModerateTextRequest\0229\n"
          + "\010document\030\001 \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\"g\n"
          + "\024ModerateTextResponse\022O\n"
          + "\025moderation_categories\030\001"
          + " \003(\01320.google.cloud.language.v1.ClassificationCategory\"\355\003\n"
          + "\023AnnotateTextRequest\0229\n"
          + "\010document\030\001"
          + " \001(\0132\".google.cloud.language.v1.DocumentB\003\340A\002\022M\n"
          + "\010features\030\002 "
          + "\001(\01326.google.cloud.language.v1.AnnotateTextRequest.FeaturesB\003\340A\002\022=\n\r"
          + "encoding_type\030\003 \001(\0162&.google.cloud.language.v1.EncodingType\032\214\002\n"
          + "\010Features\022\026\n"
          ...
          + "classify_text\030\006 \001(\010\022\025\n\r"
          + "moderate_text\030\013 \001(\010\022Z\n"
          + "\034classification_model_options\030\n"
          + " \001(\01324.google.cloud.language.v1.ClassificationModelOptions\"\234\003\n"
          + "\024AnnotateTextResponse\0225\n"
          + "\tsentences\030\001 \003(\0132\".google.cloud.language.v1.Sentence\022/\n"
          + "\006tokens\030\002 \003(\0132\037.google.cloud.language.v1.Token\0222\n"
          + "\010entities\030\003 \003(\0132 .google.cloud.language.v1.Entity\022?\n"
          + "\022document_sentiment\030\004"
          + " \001(\0132#.google.cloud.language.v1.Sentiment\022\020\n"
          + "\010language\030\005 \001(\t\022D\n\n"
          + "categories\030\006 \003(\01320.google.cloud.language.v1.ClassificationCategory\022O\n"
          + "\025moderation_categories\030\007 "
          + "\003(\01320.google.cloud.language.v1.ClassificationCategory*8\n"
          + "\014EncodingType\022\010\n"
          + "\004NONE\020\000\022\010\n"
          + "\004UTF8\020\001\022\t\n"
          + "\005UTF16\020\002\022\t\n"
          + "\005UTF32\020\0032\322\013\n"
          + "\017LanguageService\022\310\001\n"
          + "\020AnalyzeSentiment\0221.google.cloud.language.v1.AnalyzeSentimentRequ"
          + "est\0322.google.cloud.language.v1.AnalyzeSe"
          + "ntimentResponse\"M\332A\026document,encoding_ty"
          + "pe\332A\010document\202\323\344\223\002#\"\036/v1/documents:analyzeSentiment:\001*\022\304\001\n"
          + "\017AnalyzeEntities\0220.google.cloud.language.v1.AnalyzeEntitiesReq"
          + "uest\0321.google.cloud.language.v1.AnalyzeE"
          + "ntitiesResponse\"L\332A\026document,encoding_ty"
          + "pe\332A\010document\202\323\344\223\002\"\"\035/v1/documents:analyzeEntities:\001*\022\340\001\n"
          + "\026AnalyzeEntitySentiment\0227.google.cloud.language.v1.AnalyzeEntit"
          + "ySentimentRequest\0328.google.cloud.languag"
          + "e.v1.AnalyzeEntitySentimentResponse\"S\332A\026"
          + "document,encoding_type\332A\010document\202\323\344\223\002)\""
          + "$/v1/documents:analyzeEntitySentiment:\001*\022\274\001\n\r"
          + "AnalyzeSyntax\022..google.cloud.language.v1.AnalyzeSyntaxRequest\032/.google.clou"
          + "d.language.v1.AnalyzeSyntaxResponse\"J\332A\026document,encoding_type\332A\010document\202\323\344\223\002"
          + " \"\033/v1/documents:analyzeSyntax:\001*\022\237\001\n"
          + "\014ClassifyText\022-.google.cloud.language.v1.Clas"
          + "sifyTextRequest\032..google.cloud.language."
          + "v1.ClassifyTextResponse\"0\332A\010document\202\323\344\223\002\037\"\032/v1/documents:classifyText:\001*\022\237\001\n"
          + "\014ModerateText\022-.google.cloud.language.v1.Mo"
          + "derateTextRequest\032..google.cloud.languag"
          + "e.v1.ModerateTextResponse\"0\332A\010document\202\323\344\223\002\037\"\032/v1/documents:moderateText:\001*\022\312\001\n"
          + "\014AnnotateText\022-.google.cloud.language.v1."
          + "AnnotateTextRequest\032..google.cloud.langu"
          + "age.v1.AnnotateTextResponse\"[\332A\037document"
          + ",features,encoding_type\332A\021document,featu"
          + "res\202\323\344\223\002\037\"\032/v1/documents:annotateText:\001*"
          + "\032z\312A\027language.googleapis.com\322A]https://w"
          + "ww.googleapis.com/auth/cloud-language,ht"
          + "tps://www.googleapis.com/auth/cloud-platformBp\n"
          + "\034com.google.cloud.language.v1B\024LanguageServiceProtoP\001Z8cloud.google.com/g"
          + "o/language/apiv1/languagepb;languagepbb\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_language_v1_Entity_descriptor = getDescriptor().getMessageType(2);
    internal_static_google_cloud_language_v1_Entity_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_language_v1_Entity_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_language_v1_Entity_MetadataEntry_descriptor =
        internal_static_google_cloud_language_v1_Entity_descriptor.getNestedType(0);
    internal_static_google_cloud_language_v1_Entity_MetadataEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_language_v1_Entity_MetadataEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_language_v1_Token_descriptor = getDescriptor().getMessageType(3);
    internal_static_google_cloud_language_v1_Token_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_language_v1_Token_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_language_v1_AnnotateTextRequest_Features_descriptor =
        internal_static_google_cloud_language_v1_AnnotateTextRequest_descriptor.getNestedType(0);
    internal_static_google_cloud_language_v1_AnnotateTextRequest_Features_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_language_v1_AnnotateTextRequest_Features_descriptor,
            new java.lang.String[] {
