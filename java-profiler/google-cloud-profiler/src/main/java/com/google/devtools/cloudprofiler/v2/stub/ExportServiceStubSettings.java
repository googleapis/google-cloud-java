...
/**
 * Settings class to configure an instance of {@link ExportServiceStub}.
 *
...
public class ExportServiceStubSettings extends StubSettings<ExportServiceStubSettings> {
      ...
      LIST_PROFILES_PAGE_STR_DESC =
          new PagedListDescriptor<ListProfilesRequest, ListProfilesResponse, Profile>() {
            ...
            public Iterable<Profile> extractResources(ListProfilesResponse payload) {
              return payload.getProfilesList();
            }
          };
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ExportServiceStubSettings.class))
        .setTransportToken(
  ...
  /** Builder for ExportServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<ExportServiceStubSettings, Builder> {
    ...
    static {
      ...
      settings =
          RetrySettings.newBuilder()
              ...
              .setInitialRpcTimeoutDuration(Duration.ofMillis(130000L))
              .setRpcTimeoutMultiplier(1.0)
              .setMaxRpcTimeoutDuration(Duration.ofMillis(130000L))
              .setTotalTimeoutDuration(Duration.ofMillis(130000L))
              .build();
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(listProfilesSettings);
      initDefaults(this);
    }
