...
public final class CreateProfileRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList profileType_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      profileType_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.devtools.cloudprofiler.v2.ProfileType>() {
            public com.google.devtools.cloudprofiler.v2.ProfileType convert(int from) {
  ...
  public java.util.List<com.google.devtools.cloudprofiler.v2.ProfileType> getProfileTypeList() {
    return new com.google.protobuf.Internal.IntListAdapter<
        com.google.devtools.cloudprofiler.v2.ProfileType>(profileType_, profileType_converter_);
  }
  ...
  public com.google.devtools.cloudprofiler.v2.ProfileType getProfileType(int index) {
    return profileType_converter_.convert(profileType_.getInt(index));
  }
  ...
  public int getProfileTypeValue(int index) {
    return profileType_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < profileType_.size(); i++) {
      output.writeEnumNoTag(profileType_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < profileType_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(profileType_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            ...
            case 18:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  profileType_.addInt(input.readEnum());
                }
    ...
    private void ensureProfileTypeIsMutable() {
      if (!profileType_.isModifiable()) {
        profileType_ = makeMutableCopy(profileType_);
      }
      bitField0_ |= 0x00000004;
    }
    ...
    public Builder setProfileType(
      ...
      ensureProfileTypeIsMutable();
      profileType_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addProfileType(com.google.devtools.cloudprofiler.v2.ProfileType value) {
      ...
      ensureProfileTypeIsMutable();
      profileType_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setProfileTypeValue(int index, int value) {
      ensureProfileTypeIsMutable();
      profileType_.setInt(index, value);
      onChanged();
      return this;
    }
