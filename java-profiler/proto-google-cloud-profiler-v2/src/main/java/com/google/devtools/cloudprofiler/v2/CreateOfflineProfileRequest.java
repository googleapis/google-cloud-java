...
public final class CreateOfflineProfileRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CreateOfflineProfileRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(internalGetProfileFieldBuilder().getBuilder(), extensionRegistry);
