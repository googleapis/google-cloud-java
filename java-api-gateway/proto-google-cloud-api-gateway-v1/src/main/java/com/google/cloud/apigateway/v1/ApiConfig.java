...
public final class ApiConfig extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class File extends com.google.protobuf.GeneratedMessage
      implements
   ...
   */
  public static final class OpenApiDocument extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private OpenApiDocument(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class GrpcServiceDefinition extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private GrpcServiceDefinition(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetFileDescriptorSetFieldBuilder();
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetFileDescriptorSetFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000001;
                  break;
                } // case 10
              case 18:
      ...
      public com.google.cloud.apigateway.v1.ApiConfig.File.Builder getFileDescriptorSetBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetFileDescriptorSetFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.apigateway.v1.ApiConfig.File.Builder getSourceBuilder(int index) {
        return internalGetSourceFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.apigateway.v1.ApiConfig.File.Builder addSourceBuilder() {
        return internalGetSourceFieldBuilder()
      ...
      public java.util.List<com.google.cloud.apigateway.v1.ApiConfig.File.Builder>
        ...
        return internalGetSourceFieldBuilder().getBuilderList();
      }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceConfigId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, serviceConfigId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gatewayServiceAccount_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 14, gatewayServiceAccount_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceConfigId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(12, serviceConfigId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gatewayServiceAccount_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(14, gatewayServiceAccount_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetOpenapiDocumentsFieldBuilder();
        internalGetGrpcServicesFieldBuilder();
        internalGetManagedServiceConfigsFieldBuilder();
      }
    }
    ...
    public com.google.cloud.apigateway.v1.ApiConfig.OpenApiDocument.Builder
      ...
      return internalGetOpenapiDocumentsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.apigateway.v1.ApiConfig.OpenApiDocument.Builder
      ...
      return internalGetOpenapiDocumentsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.cloud.apigateway.v1.ApiConfig.OpenApiDocument.Builder>
      ...
      return internalGetOpenapiDocumentsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.apigateway.v1.ApiConfig.GrpcServiceDefinition.Builder
      ...
      return internalGetGrpcServicesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.apigateway.v1.ApiConfig.GrpcServiceDefinition.Builder
      ...
      return internalGetGrpcServicesFieldBuilder()
          .addBuilder(
              com.google.cloud.apigateway.v1.ApiConfig.GrpcServiceDefinition.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.cloud.apigateway.v1.ApiConfig.GrpcServiceDefinition.Builder>
      ...
      return internalGetGrpcServicesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.apigateway.v1.ApiConfig.File.Builder getManagedServiceConfigsBuilder(
        int index) {
      return internalGetManagedServiceConfigsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.apigateway.v1.ApiConfig.File.Builder addManagedServiceConfigsBuilder() {
      return internalGetManagedServiceConfigsFieldBuilder()
          .addBuilder(com.google.cloud.apigateway.v1.ApiConfig.File.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.cloud.apigateway.v1.ApiConfig.File.Builder>
      ...
      return internalGetManagedServiceConfigsFieldBuilder().getBuilderList();
    }
