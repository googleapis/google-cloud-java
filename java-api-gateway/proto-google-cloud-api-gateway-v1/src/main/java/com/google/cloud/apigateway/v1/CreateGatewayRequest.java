...
public final class CreateGatewayRequest extends com.google.protobuf.GeneratedMessage
    implements
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(internalGetGatewayFieldBuilder().getBuilder(), extensionRegistry);
