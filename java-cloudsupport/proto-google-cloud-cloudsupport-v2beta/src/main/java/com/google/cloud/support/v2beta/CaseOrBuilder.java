...
public interface CaseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.support.v2beta.Case)
   ...
   * </pre>
   *
   * <code>.google.cloud.support.v2beta.CaseClassification classification = 4;</code>
   *
   ...
   */
  com.google.cloud.support.v2beta.CaseClassification getClassification();
   ...
   * <code>.google.cloud.support.v2beta.CaseClassification classification = 4;</code>
   */
  com.google.cloud.support.v2beta.CaseClassificationOrBuilder getClassificationOrBuilder();
   ...
   *
   * <code>
   * .google.cloud.support.v2beta.Case.State state = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The state.
   */
  com.google.cloud.support.v2beta.Case.State getState();
   ...
   * </pre>
   *
   * <code>.google.cloud.support.v2beta.Actor creator = 15;</code>
   *
   ...
   * @return The creator.
   */
  com.google.cloud.support.v2beta.Actor getCreator();
   ...
   * <code>.google.cloud.support.v2beta.Actor creator = 15;</code>
   */
  com.google.cloud.support.v2beta.ActorOrBuilder getCreatorOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.support.v2beta.Case.Priority priority = 32;</code>
   *
   ...
   * @return The priority.
   */
  com.google.cloud.support.v2beta.Case.Priority getPriority();
}
