...
public interface ListSupportEventSubscriptionsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.support.v2.ListSupportEventSubscriptionsRequest)
