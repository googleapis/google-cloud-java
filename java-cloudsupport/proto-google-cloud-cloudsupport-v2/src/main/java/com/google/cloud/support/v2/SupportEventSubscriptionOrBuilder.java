...
public interface SupportEventSubscriptionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.support.v2.SupportEventSubscription)
   ...
   * @return The state.
   */
  com.google.cloud.support.v2.SupportEventSubscription.State getState();
   ...
   */
  com.google.cloud.support.v2.SupportEventSubscription.FailureReason getFailureReason();
