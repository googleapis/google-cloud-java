...
public final class CommentServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.support.v2beta.CommentService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloud.support.v2beta.ListCommentsRequest,
          com.google.cloud.support.v2beta.ListCommentsResponse>
      getListCommentsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ListComments",
      requestType = com.google.cloud.support.v2beta.ListCommentsRequest.class,
      responseType = com.google.cloud.support.v2beta.ListCommentsResponse.class,
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.support.v2beta.ListCommentsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CommentServiceMethodDescriptorSupplier("ListComments"))
                      .build();
        }
      }
    }
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.google.cloud.support.v2beta.CreateCommentRequest.class,
  ...
  public static CommentServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CommentServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CommentServiceStub>() {
          @java.lang.Override
          public CommentServiceStub newStub(
  ...
  public static CommentServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CommentServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CommentServiceBlockingV2Stub>() {
          @java.lang.Override
          public CommentServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CommentServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return CommentServiceBlockingV2Stub.newStub(factory, channel);
  }

  /**
   * Creates a new blocking-style stub that supports unary and streaming output calls on the service
   */
  public static CommentServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CommentServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CommentServiceBlockingStub>() {
          @java.lang.Override
          public CommentServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static CommentServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CommentServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CommentServiceFutureStub>() {
          @java.lang.Override
          public CommentServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void listComments(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.support.v2beta.ListCommentsResponse>
            responseObserver) {
   ...
   * </pre>
   */
  public abstract static class CommentServiceImplBase
  ...
  public static final class CommentServiceStub
    ...
    private CommentServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CommentServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CommentServiceStub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class CommentServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<CommentServiceBlockingV2Stub> {
    private CommentServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CommentServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CommentServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service CommentService.
   *
   * <pre>
   * A service to manage comments on cases.
   * </pre>
  ...
  public static final class CommentServiceBlockingStub
    ...
    private CommentServiceBlockingStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
  ...
  public static final class CommentServiceFutureStub
    ...
    private CommentServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.support.v2beta.ListCommentsResponse>
        listComments(com.google.cloud.support.v2beta.ListCommentsRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.support.v2beta.Comment>
        createComment(com.google.cloud.support.v2beta.CreateCommentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private abstract static class CommentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.cloud.support.v2beta.CommentServiceProto.getDescriptor();
    }
