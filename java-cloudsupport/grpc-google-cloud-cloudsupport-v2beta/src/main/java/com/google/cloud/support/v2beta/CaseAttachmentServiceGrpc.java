...
@javax.annotation.Generated(
    ...
    comments = "Source: google/cloud/support/v2beta/attachment_service.proto")
...
public final class CaseAttachmentServiceGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.google.cloud.support.v2beta.ListAttachmentsRequest.class,
      responseType = com.google.cloud.support.v2beta.ListAttachmentsResponse.class,
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getListAttachmentsMethod = CaseAttachmentServiceGrpc.getListAttachmentsMethod) == null) {
      synchronized (CaseAttachmentServiceGrpc.class) {
        if ((getListAttachmentsMethod = CaseAttachmentServiceGrpc.getListAttachmentsMethod)
            == null) {
          CaseAttachmentServiceGrpc.getListAttachmentsMethod =
              getListAttachmentsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.support.v2beta.ListAttachmentsRequest,
                          com.google.cloud.support.v2beta.ListAttachmentsResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.support.v2beta.ListAttachmentsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CaseAttachmentServiceMethodDescriptorSupplier("ListAttachments"))
                      .build();
        }
      }
    }
  ...
  public static CaseAttachmentServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CaseAttachmentServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CaseAttachmentServiceStub>() {
          @java.lang.Override
          public CaseAttachmentServiceStub newStub(
   ...
   */
  public static CaseAttachmentServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CaseAttachmentServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CaseAttachmentServiceBlockingStub>() {
          @java.lang.Override
          public CaseAttachmentServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static CaseAttachmentServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CaseAttachmentServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CaseAttachmentServiceFutureStub>() {
          @java.lang.Override
          public CaseAttachmentServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static final class CaseAttachmentServiceStub
    ...
    private CaseAttachmentServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static final class CaseAttachmentServiceBlockingV2Stub
     ...
     * </pre>
     */
    public com.google.cloud.support.v2beta.ListAttachmentsResponse listAttachments(
        com.google.cloud.support.v2beta.ListAttachmentsRequest request) {
  ...
  public static final class CaseAttachmentServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.support.v2beta.ListAttachmentsResponse>
        listAttachments(com.google.cloud.support.v2beta.ListAttachmentsRequest request) {
  ...
  private abstract static class CaseAttachmentServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.cloud.support.v2beta.AttachmentServiceProto.getDescriptor();
    }
