...
import com.google.cloud.support.v2beta.stub.HttpJsonFeedServiceStub;
...
public class FeedServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static FeedServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonFeedServiceStub.getMethodDescriptors(),
            FeedServiceSettings.getDefaultEndpoint());
    FeedServiceSettings settings =
        FeedServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                FeedServiceSettings.defaultHttpJsonTransportProviderBuilder()
