 ...
 * <p>  EXAMPLES:
 * <p>  cURL:
 * <p>  ```shell support_event_subscription="organizations/123456789/supportEventSubscriptions/abcdef123456" curl \\\\   --request POST \\\\   --header "Authorization: Bearer $(gcloud auth print-access-token)" \\\\   "https://cloudsupport.googleapis.com/v2beta/$support_event_subscription:expunge" ```
 * <p>  Python:
 * <p>  ```python import googleapiclient.discovery
 * <p>  api_version = "v2beta" supportApiService = googleapiclient.discovery.build(     serviceName="cloudsupport",     version=api_version,     discoveryServiceUrl=f"https://cloudsupport.googleapis.com/$discovery/rest?version={api_version}", )
...
public class SupportEventSubscriptionServiceClient implements BackgroundResource {
   ...
   * <p>```python import googleapiclient.discovery
   *
   * <p>api_version = "v2beta" supportApiService = googleapiclient.discovery.build(
