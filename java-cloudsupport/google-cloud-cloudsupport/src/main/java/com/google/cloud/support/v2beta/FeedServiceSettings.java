...
public class FeedServiceSettings extends ClientSettings<FeedServiceSettings> {
  ...
  public PagedCallSettings<ShowFeedRequest, ShowFeedResponse, ShowFeedPagedResponse>
      showFeedSettings() {
    return ((FeedServiceStubSettings) getStubSettings()).showFeedSettings();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return FeedServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static class Builder extends ClientSettings.Builder<FeedServiceSettings, Builder> {
    ...
    private static Builder createHttpJsonDefault() {
      return new Builder(FeedServiceStubSettings.newHttpJsonBuilder());
    }
    ...
    public PagedCallSettings.Builder<ShowFeedRequest, ShowFeedResponse, ShowFeedPagedResponse>
        showFeedSettings() {
      return getStubSettingsBuilder().showFeedSettings();
    }
