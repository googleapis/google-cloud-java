 ...
 *    <tr>
 *      <td>ListComments</td>
 *      <td><p>Retrieve all Comments associated with the Case object.</p></td>
 *      <td>
 ...
 *    <tr>
 *      <td>CreateComment</td>
 *      <td><p>Add a new comment to the specified Case.
 *  The comment object must have the following fields set: body.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
