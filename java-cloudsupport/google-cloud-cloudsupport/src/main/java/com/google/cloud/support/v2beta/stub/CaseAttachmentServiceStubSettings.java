...
/**
 * Settings class to configure an instance of {@link CaseAttachmentServiceStub}.
 *
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(CaseAttachmentServiceStubSettings.class))
        .setTransportToken(
