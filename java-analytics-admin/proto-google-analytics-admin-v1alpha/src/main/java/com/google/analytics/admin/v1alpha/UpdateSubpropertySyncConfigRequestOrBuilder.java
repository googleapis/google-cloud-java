...
public interface UpdateSubpropertySyncConfigRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.UpdateSubpropertySyncConfigRequest)
