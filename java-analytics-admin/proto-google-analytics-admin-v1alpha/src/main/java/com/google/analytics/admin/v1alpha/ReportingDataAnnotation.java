...
public final class ReportingDataAnnotation extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ReportingDataAnnotation(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class DateRange extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetAnnotationDateFieldBuilder().getBuilder(), extensionRegistry);
                targetCase_ = 4;
                break;
              } // case 34
            case 42:
              {
                input.readMessage(
                    internalGetAnnotationDateRangeFieldBuilder().getBuilder(), extensionRegistry);
                targetCase_ = 5;
                break;
              } // case 42
            case 48:
    ...
    public com.google.type.Date.Builder getAnnotationDateBuilder() {
      return internalGetAnnotationDateFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            com.google.type.Date, com.google.type.Date.Builder, com.google.type.DateOrBuilder>
        internalGetAnnotationDateFieldBuilder() {
      if (annotationDateBuilder_ == null) {
        if (!(targetCase_ == 4)) {
    ...
    public com.google.analytics.admin.v1alpha.ReportingDataAnnotation.DateRange.Builder
      ...
      return internalGetAnnotationDateRangeFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.analytics.admin.v1alpha.ReportingDataAnnotation.DateRange.Builder,
            com.google.analytics.admin.v1alpha.ReportingDataAnnotation.DateRangeOrBuilder>
        internalGetAnnotationDateRangeFieldBuilder() {
      if (annotationDateRangeBuilder_ == null) {
        if (!(targetCase_ == 5)) {
          target_ =
              com.google.analytics.admin.v1alpha.ReportingDataAnnotation.DateRange
