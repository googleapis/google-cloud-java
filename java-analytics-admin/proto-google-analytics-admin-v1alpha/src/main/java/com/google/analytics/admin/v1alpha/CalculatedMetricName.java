...
public class CalculatedMetricName implements ResourceName {
  ...
  public static @Nullable CalculatedMetricName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CalculatedMetricName> values) {
