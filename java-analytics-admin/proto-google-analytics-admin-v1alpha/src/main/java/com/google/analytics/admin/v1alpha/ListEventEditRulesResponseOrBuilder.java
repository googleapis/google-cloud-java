...
public interface ListEventEditRulesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.ListEventEditRulesResponse)
   ...
   * <code>repeated .google.analytics.admin.v1alpha.EventEditRule event_edit_rules = 1;</code>
   */
  com.google.analytics.admin.v1alpha.EventEditRuleOrBuilder getEventEditRulesOrBuilder(int index);
