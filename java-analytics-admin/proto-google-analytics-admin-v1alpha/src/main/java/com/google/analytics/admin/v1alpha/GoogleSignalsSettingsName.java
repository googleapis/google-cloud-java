...
public class GoogleSignalsSettingsName implements ResourceName {
  private static final PathTemplate PROPERTY =
      PathTemplate.createWithoutUrlEncoding("properties/{property}/googleSignalsSettings");
  private volatile Map<String, String> fieldValuesMap;
  private final String property;

  @Deprecated
  protected GoogleSignalsSettingsName() {
    property = null;
  }

  private GoogleSignalsSettingsName(Builder builder) {
  ...
  public static GoogleSignalsSettingsName of(String property) {
  ...
  public static GoogleSignalsSettingsName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROPERTY.validatedMatch(
            formattedString,
            "GoogleSignalsSettingsName.parse: formattedString not in valid format");
    return of(matchMap.get("property"));
  }

  public static List<GoogleSignalsSettingsName> parseList(List<String> formattedStrings) {
    List<GoogleSignalsSettingsName> list = new ArrayList<>(formattedStrings.size());
  ...
  /** Builder for properties/{property}/googleSignalsSettings. */
  public static class Builder {
    ...
    public GoogleSignalsSettingsName build() {
      return new GoogleSignalsSettingsName(this);
    }
  }
}
