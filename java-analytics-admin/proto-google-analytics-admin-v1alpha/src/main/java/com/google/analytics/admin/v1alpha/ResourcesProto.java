  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\032-google/analytics/admin/v1alpha/audience.proto\0322google/analytics/admin/v1alpha/"
          + "channel_group.proto\032:google/analytics/admin/v1alpha/event_create_and_edit.proto\032"
          ...
          + "gle/protobuf/timestamp.proto\032\036google/protobuf/wrappers.proto\"\344\002\n"
          + "\007Account\022\021\n"
          ...
          + "property_type\030\016 \001(\0162,.goo"
          + "gle.analytics.admin.v1alpha.PropertyTypeB\003\340A\005\0224\n"
          ...
          + "8.google.analytics.admin.v1alpha.DataStream.WebStreamDataH\000\022b\n"
          + "\027android_app_stream_data\030\007 \001(\0132?.google.analytics.admin.v1"
          + "alpha.DataStream.AndroidAppStreamDataH\000\022Z\n"
          + "\023ios_app_stream_data\030\010 \001(\0132;.google.an"
          + "alytics.admin.v1alpha.DataStream.IosAppStreamDataH\000\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022O\n"
          + "\004type\030\002"
          + " \001(\01629.google.analytics.admin.v1alpha.DataStream.DataStreamTypeB\006\340A\005\340A\002\022\024\n"
          ...
          + "(analyticsadmin.googleapis.com/DataStream\022/properti"
          ...
          + "om/FirebaseLink\0223properties/{property}/firebaseLinks/{firebase_link}\"\251\001\n\r"
          + "GlobalSiteTag\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\024\n"
          + "\007snippet\030\002 \001(\tB\003\340A\005:o\352Al\n"
          + "+analyticsadmin.googleapis.com/GlobalSiteTag\022=properties/{property}"
          + "/dataStreams/{data_stream}/globalSiteTag\"\230\003\n\r"
          ...
          + "+analyticsadmin.googleapis.com/GoogleAdsLink\0226pro"
          + "perties/{property}/googleAdsLinks/{google_ads_link}\"\353\002\n"
          ...
          + "taSharingSettings\022&accounts/{account}/dataSharingSettings\"\225\002\n"
          ...
          + "is.com/AccountSummary\022\"accountSummaries/{account_summary}\"\273\001\n"
          ...
          + "7analyticsadmin.googleapis.com/MeasurementProtocolSecret\022hproperties/{property}/da"
          + "taStreams/{data_stream}/measurementProto"
          + "colSecrets/{measurement_protocol_secret}\"\203\004\n"
          ...
          + ">analyticsadmin.googleapis.com/SKAdNetworkConversionValueSchema\022v"
          + "properties/{property}/dataStreams/{data_stream}/sKAdNetworkConversionValueSchema"
          + "/{skadnetwork_conversion_value_schema}\"\207\001\n"
          ...
          + "\017max_event_value\030\005 \001(\001H\003\210\001\001B\022\n"
          ...
          + "\01323.google.analytics.admin.v1alpha.ChangeHistoryChange\"\337\022\n"
          ...
          + "\026resource_before_change\030\003 \001(\0132I.google.an"
          + "alytics.admin.v1alpha.ChangeHistoryChange.ChangeHistoryResource\022h\n"
          + "\025resource_after_change\030\004 \001(\0132I.google.analytics.admin."
          + "v1alpha.ChangeHistoryChange.ChangeHistoryResource\032\244\020\n"
          ...
          + "!display_video_360_advertiser_link\030\t \001(\0132=.go"
          + "ogle.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkH\000\022{\n"
          + "*display_video_360_advertiser_link_proposal\030\n"
          + " \001(\0132E.googl"
          + "e.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkProposalH\000\022K\n"
          + "\020conversion_event\030\013"
          + " \001(\0132/.google.analytics.admin.v1alpha.ConversionEventH\000\022`\n"
          + "\033measurement_protocol_secret\030\014 \001(\01329.google.analytics.a"
          + "dmin.v1alpha.MeasurementProtocolSecretH\000\022K\n"
          ...
          + "\027data_retention_settings\030\017 \001(\01325.google.analytics"
          + ".admin.v1alpha.DataRetentionSettingsH\000\022O\n"
          + "\023search_ads_360_link\030\020 \001(\01320.google.ana"
          + "lytics.admin.v1alpha.SearchAds360LinkH\000\022A\n"
          ...
          + "\027data_redaction_settings\030\031 \001(\01325.google.anal"
          + "ytics.admin.v1alpha.DataRedactionSettingsH\000\022o\n"
          ...
          + "gle.analytics.admin.v1alpha.EventCreateRuleH\000\022M\n"
          + "\021calculated_metric\030\037 \001(\01320.googl"
          + "e.analytics.admin.v1alpha.CalculatedMetricH\000B\n\n"
          + "\010resource\"\337\003\n"
          ...
          + ";analyticsadmin.googleapis.com/DisplayVideo360Advert"
          + "iserLink\022Xproperties/{property}/displayV"
          + "ideo360AdvertiserLinks/{display_video_360_advertiser_link}\"\212\005\n"
          ...
          + "360AdvertiserLinkProposals/{display_video_360_advertiser_link_proposal}\"\350\003\n"
          + "\020SearchAds360Link\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\032\n\r"
          + "advertiser_id\030\002 \001(\tB\003\340A\005\022F\n"
          + "\035campaign_data_sharing_enabled\030\003"
          + " \001(\0132\032.google.protobuf.BoolValueB\003\340A\005\022B\n"
          + "\031cost_data_sharing_enabled\030\004"
          + " \001(\0132\032.google.protobuf.BoolValueB\003\340A\005\022$\n"
          ...
          + ".analyticsadmin.googleapis.com/SearchAds360Link\022=properties/{propert"
          + "y}/searchAds360Links/{search_ads_360_link}\"\374\001\n"
          + "\031LinkProposalStatusDetails\022l\n"
          + " link_proposal_initiating_product\030\001 \001(\0162=.goo"
          + "gle.analytics.admin.v1alpha.LinkProposalInitiatingProductB\003\340A\003\022\034\n"
          + "\017requestor_email\030\002 \001(\tB\003\340A\003\022S\n"
          + "\023link_proposal_state\030\003 \001("
          + "\01621.google.analytics.admin.v1alpha.LinkProposalStateB\003\340A\003\"\340\005\n"
          ...
          + "\017counting_method\030\006 \001(\0162H.google.analytics.admin.v1alpha.C"
          + "onversionEvent.ConversionCountingMethodB\003\340A\001\022r\n"
          ...
          + "/{property}/conversionEvents/{conversion_event}B\033\n"
          ...
          + "\017counting_method\030\006 \001(\01627.google.analytics.adm"
          + "in.v1alpha.KeyEvent.CountingMethodB\003\340A\002\022Q\n\r"
          + "default_value\030\007 \001(\01325.google.analytic"
          + "s.admin.v1alpha.KeyEvent.DefaultValueB\003\340A\001\032F\n"
          ...
          + "com/KeyEvent\022+properties/{property}/keyEvents/{key_event}*"
          ...
          + "3analyticsadmin.googleapis.com/GoogleSignalsSett"
          + "ings\022+properties/{property}/googleSignalsSettings\"\274\003\n"
          ...
          + "alytics.admin.v1alpha.CustomDimension.DimensionScopeB\006\340A\002\340A\005\022)\n"
          ...
          + "-analyticsadmin.googleapis.com/CustomDimension\0229p"
          + "roperties/{property}/customDimensions/{custom_dimension}\"\305\006\n"
          ...
          + "\005scope\030\006"
          + " \001(\01628.google.analytics.admin.v1alpha.CustomMetric.MetricScopeB\006\340A\002\340A\005\022f\n"
          + "\026restricted_metric_type\030\010 \003(\0162A.google.analyti"
          + "cs.admin.v1alpha.CustomMetric.RestrictedMetricTypeB\003\340A\001\"\267\001\n"
          ...
          + "ric\0223properties/{property}/customMetrics/{custom_metric}\"\247\006\n"
          ...
          + "\026restricted_metric_type\030\006 \003(\0162E.google.analyti"
          + "cs.admin.v1alpha.CalculatedMetric.RestrictedMetricTypeB\003\340A\003\022\024\n"
          ...
          + ".analyticsadmin.googleapis.com/CalculatedMetric\022;properties/{property}/calculat"
          + "edMetrics/{calculated_metric}*\021calculatedMetrics2\020calculatedMetric\"\302\003\n"
          + "\025DataRetentionSettings\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022e\n"
          + "\024event_data_retention\030\002 \001(\0162G.google.analytics"
          + ".admin.v1alpha.DataRetentionSettings.RetentionDuration\022\'\n"
          ...
          + "3analyticsadmin.googleapis.com/DataRetentionSettings\022+prop"
          + "erties/{property}/dataRetentionSettings\"\374\013\n"
          ...
          + " \001(\0162\\.google.analytics.adm"
          + "in.v1alpha.AttributionSettings.AcquisitionConversionEventLookbackWindowB\003\340A\002\022\213\001\n"
          + "&other_conversion_event_lookback_window\030\003"
          + " \001(\0162V.google.analytics.admin.v1alpha.A"
          + "ttributionSettings.OtherConversionEventLookbackWindowB\003\340A\002\022w\n"
          + "\033reporting_attribution_model\030\004 \001(\0162M.google.analytics.admin"
          + ".v1alpha.AttributionSettings.ReportingAttributionModelB\003\340A\002\022\206\001\n"
          + "$ads_web_conversion_data_export_scope\030\005 \001(\0162S.google.anal"
          + "ytics.admin.v1alpha.AttributionSettings.AdsWebConversionDataExportScopeB\003\340A\002\"\333\001\n"
          ...
          + "4ACQUISITION_CONVERSION_EVENT_LOOKBACK_WINDOW_30_DAYS\020\002\"\370\001\n"
          + "\"OtherConversionEventLookbackWindow\0226\n"
          + "2OTHER_CONVERSION_EVENT_LOOKBACK_WINDOW_UNSPECIFIED\020\000\0222\n"
          + ".OTHER_CONVERSION_EVENT_LOOKBACK_WINDOW_30_DAYS\020\001\0222\n"
          + ".OTHER_CONVERSION_EVENT_LOOKBACK_WINDOW_60_DAYS\020\002\0222\n"
          + ".OTHER_CONVERSION_EVENT_LOOKBACK_WINDOW_90_DAYS\020\003\"\302\001\n"
          ...
          + "ionSettings\022)properties/{property}/attributionSettings\"\361\001\n\r"
          + "AccessBinding\022\016\n"
          + "\004user\030\002 \001(\tH\000\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\r\n"
          + "\005roles\030\003 \003(\t:\234\001\352A\230\001\n"
          + "+analyticsadmin.googleapis.com/AccessBinding\0222accounts/{account}/acces"
          + "sBindings/{access_binding}\0225properties/{",
      "property}/accessBindings/{access_binding}B\017\n\r"
          ...
          + "*analyticsadmin.googleapis.com/BigQueryLink\0223prop"
          + "erties/{property}/bigQueryLinks/{bigquery_link}\"\363\003\n"
          ...
          + "9analyticsadmin.googleapis.com/EnhancedMeasurementSettings\022Kproper"
          + "ties/{property}/dataStreams/{data_stream}/enhancedMeasurementSettings\"B\n"
          ...
          + "3analyticsadmin.googleapis.com/DataRedactionSettings\022Eproperties/{"
          + "property}/dataStreams/{data_stream}/dataRedactionSettings\"\240\001\n"
          ...
          + "SenseLink\0221properties/{property}/adSenseLinks/{adsense_link}\"\216\002\n"
          ...
          + "6analyticsadmin.googleapis.com/RollupPropertySourceLin"
          + "k\022Mproperties/{property}/rollupPropertySourceLinks/{rollup_property_source_link}"
          + "*\031rollupPropertySourceLinks2\030rollupPropertySourceLink*\252\004\n"
          ...
          + "*DISPLAY_VIDEO_360_ADVERTISER_LINK_PROPOSAL\020\017\022\027\n"
          ...
          + "CHANNEL_GROUP\020\026\022\021\n\r"
          + "BIGQUERY_LINK\020\027\022!\n"
          ...
          + "\"com.google.analytics.admin.v1alphaB\016ResourcesProtoP\001Z>cloud.google.com/go"
          + "/analytics/admin/apiv1alpha/adminpb;adminpb\352AR\n"
          + "2marketingplatformadmin.googleapis.com/Organization\022\034organizations/{organ"
          + "ization}b\006proto3"
    };
    descriptor =
