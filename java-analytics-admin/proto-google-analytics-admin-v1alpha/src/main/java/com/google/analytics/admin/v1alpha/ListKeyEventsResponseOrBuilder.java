...
public interface ListKeyEventsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.ListKeyEventsResponse)
   ...
   * <code>repeated .google.analytics.admin.v1alpha.KeyEvent key_events = 1;</code>
   */
  com.google.analytics.admin.v1alpha.KeyEventOrBuilder getKeyEventsOrBuilder(int index);
