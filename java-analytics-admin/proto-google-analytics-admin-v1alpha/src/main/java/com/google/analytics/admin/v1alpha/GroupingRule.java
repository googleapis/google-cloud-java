...
public final class GroupingRule extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private GroupingRule(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetExpressionFieldBuilder().getBuilder(), extensionRegistry);
