...
public class SubpropertyEventFilterName implements ResourceName {
  ...
  public static @Nullable SubpropertyEventFilterName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SubpropertyEventFilterName> values) {
