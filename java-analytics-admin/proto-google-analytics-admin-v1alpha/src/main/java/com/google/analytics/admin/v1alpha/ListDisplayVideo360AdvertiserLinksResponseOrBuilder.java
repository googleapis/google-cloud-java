...
public interface ListDisplayVideo360AdvertiserLinksResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.ListDisplayVideo360AdvertiserLinksResponse)
   ...
   * </code>
   */
  java.util.List<com.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLink>
   ...
   * </code>
   */
  int getDisplayVideo360AdvertiserLinksCount();
  /**
   *
   *
   * <pre>
   ...
   */
  java.util.List<
          ? extends com.google.analytics.admin.v1alpha.DisplayVideo360AdvertiserLinkOrBuilder>
