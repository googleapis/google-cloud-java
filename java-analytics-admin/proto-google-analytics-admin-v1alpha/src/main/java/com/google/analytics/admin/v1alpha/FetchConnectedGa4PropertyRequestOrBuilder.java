...
public interface FetchConnectedGa4PropertyRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.FetchConnectedGa4PropertyRequest)
