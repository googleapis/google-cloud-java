...
public interface CreateEventEditRuleRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.CreateEventEditRuleRequest)
