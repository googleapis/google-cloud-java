...
public class AsyncUpdateEnhancedMeasurementSettings {

  public static void main(String[] args) throws Exception {
    asyncUpdateEnhancedMeasurementSettings();
  }

  public static void asyncUpdateEnhancedMeasurementSettings() throws Exception {
