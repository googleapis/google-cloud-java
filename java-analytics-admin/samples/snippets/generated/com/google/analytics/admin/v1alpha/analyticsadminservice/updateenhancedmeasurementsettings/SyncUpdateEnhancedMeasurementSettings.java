...
public class SyncUpdateEnhancedMeasurementSettings {

  public static void main(String[] args) throws Exception {
    syncUpdateEnhancedMeasurementSettings();
  }

  public static void syncUpdateEnhancedMeasurementSettings() throws Exception {
