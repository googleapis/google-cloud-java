...
public class SyncUpdateMeasurementProtocolSecret {

  public static void main(String[] args) throws Exception {
    syncUpdateMeasurementProtocolSecret();
  }

  public static void syncUpdateMeasurementProtocolSecret() throws Exception {
