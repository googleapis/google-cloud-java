...
```Groovy
implementation 'com.google.analytics:google-analytics-admin:0.64.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.analytics" % "google-analytics-admin" % "0.64.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.analytics/google-analytics-admin/0.64.0
