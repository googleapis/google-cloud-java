...
public interface CustomDimensionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1beta.CustomDimension)
   ...
   * @return The scope.
   */
  com.google.analytics.admin.v1beta.CustomDimension.DimensionScope getScope();
