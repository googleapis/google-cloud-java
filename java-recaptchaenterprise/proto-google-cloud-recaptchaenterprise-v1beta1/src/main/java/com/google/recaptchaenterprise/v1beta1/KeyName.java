...
public class KeyName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/keys/{key}");
  ...
  public String toString() {
    return PATH_TEMPLATE.instantiate("project", project, "key", key);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof KeyName) {
      ...
      return (this.project.equals(that.project)) && (this.key.equals(that.key));
    }
    return false;
  }
