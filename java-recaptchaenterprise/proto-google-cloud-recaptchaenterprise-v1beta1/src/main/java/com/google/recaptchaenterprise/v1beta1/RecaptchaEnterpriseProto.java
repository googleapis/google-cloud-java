  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "google/api/resource.proto\032\037google/protobuf/timestamp.proto\"\255\001\n"
          + "\027CreateAssessmentRequest\022C\n"
          + "\006parent\030\001 \001(\tB3\340A\002\372A-\n"
          + "+cloudresourcemanager.googleapis.com/Project\022M\n\n"
          + "assessment\030\002"
          + " \001(\01324.google.cloud.recaptchaenterprise.v1beta1.AssessmentB\003\340A\002\"\227\005\n"
          + "\020TransactionEvent\022h\n\n"
          + "event_type\030\001 \001(\0162O.google.cloud.recaptchaenterprise.v1beta1.T"
          + "ransactionEvent.TransactionEventTypeB\003\340A\001\022\023\n"
          ...
          + "tchaenterprise.v1beta1.AnnotateAssessmentRequest.AnnotationB\003\340A\001\022`\n"
          + "\007reasons\030\003 \003(\0162J.google.cloud.recaptchaenterprise.v1b"
          + "eta1.AnnotateAssessmentRequest.ReasonB\003\340A\001\022\036\n"
          + "\021hashed_account_id\030\004 \001(\014B\003\340A\001\022Z\n"
          + "\021transaction_event\030\005 \001(\0132:.google.cloud.rec"
          + "aptchaenterprise.v1beta1.TransactionEventB\003\340A\001\"~\n\n"
          + "Annotation\022\032\n"
          ...
          + "ecaptchaenterprise.v1beta1.TokenPropertiesB\003\340A\003\022_\n"
          + "\007reasons\030\005 \003(\0162I.google.cloud."
          + "recaptchaenterprise.v1beta1.Assessment.ClassificationReasonB\003\340A\003\022f\n"
          + "\032password_leak_verification\030\007 \001(\0132B.google.cloud.reca"
          + "ptchaenterprise.v1beta1.PasswordLeakVerification\022h\n"
          + "\033account_defender_assessment\030\010"
          + " \001(\0132C.google.cloud.recaptchaenterprise.v1beta1.AccountDefenderAssessment\022h\n"
          + "\033fraud_prevention_assessment\030\013 \001(\0132C.google"
          + ".cloud.recaptchaenterprise.v1beta1.FraudPreventionAssessment\"\351\001\n"
          ...
          + "-recaptchaenterpri"
          + "se.googleapis.com/Assessment\022+projects/{project}/assessments/{assessment}\"\261\003\n"
          + "\005Event\022\022\n"
          ...
          + " \001(\01329.google.c"
          + "loud.recaptchaenterprise.v1beta1.TransactionDataB\003\340A\001\022^\n"
          + "\020fraud_prevention\030\021 \001(\0162"
          + "?.google.cloud.recaptchaenterprise.v1beta1.Event.FraudPreventionB\003\340A\001\"N\n"
          ...
          + "e.cloud.recaptchaenterprise.v1beta1.TransactionData.Address\022Z\n"
          + "\017billing_address\030\007"
          + " \001(\0132A.google.cloud.recaptchaenterprise.v1beta1.TransactionData.Address\022L\n"
          + "\004user\030\010"
          + " \001(\0132>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.User\022Q\n"
          + "\tmerchants\030\r"
          + " \003(\0132>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.User\022M\n"
          + "\005items\030\016"
          + " \003(\0132>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.Item\022[\n"
          + "\014gateway_info\030\n"
          + " \001(\0132E.google.cloud.recaptchaen"
          + "terprise.v1beta1.TransactionData.GatewayInfo\032\206\001\n"
          + "\007Address\022\021\n"
          ...
          + "e.cloud.recaptchaenterprise.v1beta1.TokenProperties.InvalidReason\022/\n"
          ...
          + "SITE_MISMATCH\020\005\032\002\010\001\022\013\n"
          + "\007MISSING\020\006\022\021\n\r"
          + "BROWSER_ERROR\020\007\"\237\004\n"
          + "\031FraudPreventionAssessment\022\030\n"
          + "\020transaction_risk\030\001 \001(\002\022~\n"
          + "\031stolen_instrument_verdict\030\002 \001(\0132[.google.cloud.recaptchaenter"
          + "prise.v1beta1.FraudPreventionAssessment.StolenInstrumentVerdict\022t\n"
          + "\024card_testing_verdict\030\003 \001(\0132V.google.cloud.recaptchaen"
          + "terprise.v1beta1.FraudPreventionAssessment.CardTestingVerdict\022|\n"
          + "\030behavioral_trust_verdict\030\004 \001(\0132Z.google.cloud.recaptcha"
          + "enterprise.v1beta1.FraudPreventionAssessment.BehavioralTrustVerdict\032\'\n"
          ...
          + "\006labels\030\001 \003(\0162X.google.cloud.recaptchaenterprise.v1beta1.Accou"
          + "ntDefenderAssessment.AccountDefenderLabel\"\263\001\n"
          ...
          + "\020CreateAssessment\022A.google.cloud.recaptchaenterprise.v1"
          + "beta1.CreateAssessmentRequest\0324.google.cloud.recaptchaenterprise.v1beta1.Assessm"
          + "ent\"P\332A\021parent,assessment\202\323\344\223\0026\"(/v1beta1/{parent=projects/*}/assessments:\n"
          + "assessment\022\357\001\n"
          + "\022AnnotateAssessment\022C.google.cloud.recaptchaenterprise.v1beta1.Annotate"
          + "AssessmentRequest\032D.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentR"
          ...
          + "is.com\322A.https://www.googleapis.com/auth/cloud-platformB\262\002\n"
          + "&com.google.recaptchaenterprise.v1beta1B\030RecaptchaEnterpriseP"
          + "rotoP\001Zacloud.google.com/go/recaptchaenterprise/v2/apiv1beta1/recaptchaenterpris"
          ...
          + "+Google::Cloud::RecaptchaEnterprise::V1beta1b\006proto3"
    };
    descriptor =
