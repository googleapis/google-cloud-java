...
public class RecaptchaEnterpriseServiceV1Beta1StubSettings
  ...
  public RecaptchaEnterpriseServiceV1Beta1Stub createStub() throws IOException {
    ...
    if (getTransportChannelProvider()
      ...
      return HttpJsonRecaptchaEnterpriseServiceV1Beta1Stub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(RecaptchaEnterpriseServiceV1Beta1StubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return RecaptchaEnterpriseServiceV1Beta1StubSettings
  ...
  protected RecaptchaEnterpriseServiceV1Beta1StubSettings(Builder settingsBuilder)
      throws IOException {
