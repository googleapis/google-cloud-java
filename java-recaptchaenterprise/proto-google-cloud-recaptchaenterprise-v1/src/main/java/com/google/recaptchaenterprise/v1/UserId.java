 ...
 */
public final class UserId extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (idOneofCase_ == 1) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, idOneof_);
    }
    if (idOneofCase_ == 2) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, idOneof_);
    }
    if (idOneofCase_ == 3) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, idOneof_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (idOneofCase_ == 1) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, idOneof_);
    }
    if (idOneofCase_ == 2) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, idOneof_);
    }
    if (idOneofCase_ == 3) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, idOneof_);
    }
