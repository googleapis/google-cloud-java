...
public class RelatedAccountGroupName implements ResourceName {
  ...
  public static @Nullable RelatedAccountGroupName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RelatedAccountGroupName> values) {
