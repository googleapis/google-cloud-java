...
public class PolicyName implements ResourceName {
  private static final PathTemplate PROJECT_KEY =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/keys/{key}/policy");
  ...
  public static PolicyName of(String project, String key) {
  ...
  /** Builder for projects/{project}/keys/{key}/policy. */
