...
public final class FraudSignals extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private FraudSignals(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class UserSignals extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private UserSignals(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(com.google.recaptchaenterprise.v1.FraudSignals.UserSignals other) {
        ...
        if (java.lang.Float.floatToRawIntBits(other.getSyntheticRisk()) != 0) {
   ...
   */
  public static final class CardSignals extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private CardSignals(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }

    private CardSignals() {
      cardLabels_ = emptyIntList();
    }
    ...
    private com.google.protobuf.Internal.IntList cardLabels_ = emptyIntList();
    ...
    public com.google.recaptchaenterprise.v1.FraudSignals.CardSignals.CardLabel getCardLabels(
        int index) {
      return cardLabels_converter_.convert(cardLabels_.getInt(index));
    }
    ...
    public int getCardLabelsValue(int index) {
      return cardLabels_.getInt(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < cardLabels_.size(); i++) {
        output.writeEnumNoTag(cardLabels_.getInt(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < cardLabels_.size(); i++) {
          dataSize +=
              com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(cardLabels_.getInt(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
              ...
              case 10:
                {
                  ...
                  while (input.getBytesUntilLimit() > 0) {
                    cardLabels_.addInt(input.readEnum());
                  }
      ...
      private void ensureCardLabelsIsMutable() {
        if (!cardLabels_.isModifiable()) {
          cardLabels_ = makeMutableCopy(cardLabels_);
        }
        bitField0_ |= 0x00000001;
      }
      ...
      public Builder setCardLabels(
        ...
        ensureCardLabelsIsMutable();
        cardLabels_.setInt(index, value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder addCardLabels(
        ...
        ensureCardLabelsIsMutable();
        cardLabels_.addInt(value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder setCardLabelsValue(int index, int value) {
        ensureCardLabelsIsMutable();
        cardLabels_.setInt(index, value);
        onChanged();
        return this;
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetUserSignalsFieldBuilder();
        internalGetCardSignalsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetUserSignalsFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(
                    internalGetCardSignalsFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000002;
                break;
              } // case 18
            default:
    ...
    public com.google.recaptchaenterprise.v1.FraudSignals.UserSignals.Builder
      ...
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetUserSignalsFieldBuilder().getBuilder();
    }
    ...
    public com.google.recaptchaenterprise.v1.FraudSignals.CardSignals.Builder
      ...
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetCardSignalsFieldBuilder().getBuilder();
    }
