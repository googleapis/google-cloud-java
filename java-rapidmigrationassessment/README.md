# Google Rapid Migration Assessment API Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-rapidmigrationassessment:0.25.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-rapidmigrationassessment" % "0.25.0"
```
...
Rapid Migration Assessment API uses both gRPC and HTTP/JSON for the transport layer.
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-rapidmigrationassessment/0.25.0
