  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022zprojects/{project}/locati"
          + "ons/{location}/keyRings/{key_ring}/crypt"
          + "oKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}\"\234\003\n"
          + "\tPublicKey\022\013\n"
          + "\003pem\030\001 \001(\t\022R\n"
          + "\talgorithm\030\002 \001(\0162?.google.cloud.k"
          + "ms.v1.CryptoKeyVersion.CryptoKeyVersionAlgorithm\022/\n\n"
          + "pem_crc32c\030\003 \001(\0132\033.google.protobuf.Int64Value\022\014\n"
          + "\004name\030\004 \001(\t\022>\n"
          + "\020protection_level\030\005"
          + " \001(\0162$.google.cloud.kms.v1.ProtectionLevel:\256\001\352A\252\001\n"
          + "!cloudkms.googleapis.com/PublicKey\022\204\001projects/{project}/l"
          + "ocations/{location}/keyRings/{key_ring}/"
          + "cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}/publicKey\"\324\010\n"
          + "\tImportJob\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022J\n\r"
          ...
          + "2,.google.cloud.kms.v1.KeyOperationAttestationB\003\340A\003\032 \n"
          ...
          + "!cloudkms.googleapis.com/ImportJob\022Sprojects/{project}/l"
          + "ocations/{location}/keyRings/{key_ring}/importJobs/{import_job}\"[\n"
          ...
          + "\022*\n"
          + "&CUSTOMER_AUTHORIZED_WORKFLOW_SERVICING\020\013B\210\001\n"
          + "\027com.google.cloud.kms.v1B\021KmsResourcesProt"
