...
public class RetiredResourceName implements ResourceName {
  ...
  public static @Nullable RetiredResourceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RetiredResourceName> values) {
