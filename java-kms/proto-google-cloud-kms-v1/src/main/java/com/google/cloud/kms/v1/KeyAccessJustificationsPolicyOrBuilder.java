...
public interface KeyAccessJustificationsPolicyOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.kms.v1.KeyAccessJustificationsPolicy)
   ...
   */
  int getAllowedAccessReasonsValue(int index);
}
