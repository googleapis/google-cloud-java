...
public class MockKeyManagementServiceImpl extends KeyManagementServiceImplBase {
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method ListCryptoKeyVersions, expected %s
  // or"
  //                      + " %s",
  //                  response == null ? "null" : response.getClass().getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method GetCryptoKeyVersion, expected %s or
  // %s",
  //                  response == null ? "null" : response.getClass().getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method CreateCryptoKeyVersion, expected %s
  // or"
  //                      + " %s",
  //                  response == null ? "null" : response.getClass().getName(),
  //                  CryptoKeyVersion.class.getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method ImportCryptoKeyVersion, expected %s
  // or"
  //                      + " %s",
  //                  response == null ? "null" : response.getClass().getName(),
  //                  CryptoKeyVersion.class.getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method UpdateCryptoKeyVersion, expected %s
  // or"
  //                      + " %s",
  //                  response == null ? "null" : response.getClass().getName(),
  //                  CryptoKeyVersion.class.getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method UpdateCryptoKeyPrimaryVersion,
  // expected"
  //                      + " %s or %s",
  //                  response == null ? "null" : response.getClass().getName(),
  //                  CryptoKey.class.getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method DestroyCryptoKeyVersion, expected %s
  // or"
  //                      + " %s",
  //                  response == null ? "null" : response.getClass().getName(),
  //                  CryptoKeyVersion.class.getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method RestoreCryptoKeyVersion, expected %s
  // or"
  //                      + " %s",
  //                  response == null ? "null" : response.getClass().getName(),
  //                  CryptoKeyVersion.class.getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method AsymmetricDecrypt, expected %s or
  // %s",
  //                  response == null ? "null" : response.getClass().getName(),
  ...
  //          new IllegalArgumentException(
  //              String.format(
  //                  "Unrecognized response type %s for method GenerateRandomBytes, expected %s or
  // %s",
  //                  response == null ? "null" : response.getClass().getName(),
