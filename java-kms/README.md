...
```Groovy
implementation 'com.google.cloud:google-cloud-kms:2.1.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-kms" % "2.1.1"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-kms/tree/master/samples) directory.
