...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-kms" % "2.63.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-kms/2.63.0
