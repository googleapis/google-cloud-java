...
public class GenerateSignedPostPolicyV4 {
  public static void generateSignedPostPolicyV4(
     ...
     * Storage.PostPolicyV4Option.signWith(ServiceAccountSigner) option. If you don't, you could
     * also pass a service account signer to StorageOptions, i.e.
    ...
    StringBuilder htmlForm =
        new StringBuilder("<form action='" + policy.getUrl() + "' method='POST' enctype='multipart/form-data'>\n");
