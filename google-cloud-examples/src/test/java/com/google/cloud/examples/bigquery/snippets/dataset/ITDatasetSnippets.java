...
public class ITDatasetSnippets {
    ...
    public void testDatasetSnippets() throws InterruptedException {
        ...
        Dataset updated = UpdateDatasetDescription.updateDatasetDescription(PROJECT_ID, DATASET_ID, newDescription);
        ...
        // Delete the dataset.
        assertTrue("Failed to delete dataset " + DATASET_ID, DeleteDataset.deleteDataset(PROJECT_ID, DATASET_ID, true));
    }
}
