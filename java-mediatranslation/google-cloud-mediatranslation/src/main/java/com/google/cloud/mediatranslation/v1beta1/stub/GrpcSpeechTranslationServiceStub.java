...
/**
 * gRPC stub implementation for Media Translation API.
 *
...
public class GrpcSpeechTranslationServiceStub extends SpeechTranslationServiceStub {
  ...
  private static final MethodDescriptor<
      ...
      streamingTranslateSpeechMethodDescriptor =
          MethodDescriptor
              .<StreamingTranslateSpeechRequest, StreamingTranslateSpeechResponse>newBuilder()
  ...
  public static final GrpcSpeechTranslationServiceStub create(
      SpeechTranslationServiceStubSettings settings) throws IOException {
    return new GrpcSpeechTranslationServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcSpeechTranslationServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcSpeechTranslationServiceStub(
        SpeechTranslationServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcSpeechTranslationServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcSpeechTranslationServiceStub(
        SpeechTranslationServiceStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcSpeechTranslationServiceStub, using the given settings. This is
   * protected so that it is easy to make a subclass, but otherwise, the static factory methods
   * should be preferred.
   */
  protected GrpcSpeechTranslationServiceStub(
      SpeechTranslationServiceStubSettings settings, ClientContext clientContext)
      throws IOException {
    this(settings, clientContext, new GrpcSpeechTranslationServiceCallableFactory());
  }
  ...
  protected GrpcSpeechTranslationServiceStub(
    ...
    GrpcCallSettings<StreamingTranslateSpeechRequest, StreamingTranslateSpeechResponse>
        streamingTranslateSpeechTransportSettings =
            GrpcCallSettings
                .<StreamingTranslateSpeechRequest, StreamingTranslateSpeechResponse>newBuilder()
                .setMethodDescriptor(streamingTranslateSpeechMethodDescriptor)
                .build();

    this.streamingTranslateSpeechCallable =
        callableFactory.createBidiStreamingCallable(
            streamingTranslateSpeechTransportSettings,
            settings.streamingTranslateSpeechSettings(),
            clientContext);
