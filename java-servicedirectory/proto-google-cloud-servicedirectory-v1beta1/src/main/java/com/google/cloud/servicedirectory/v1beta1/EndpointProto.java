  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + ".proto\032\031google/api/resource.proto\032\037google/protobuf/timestamp.proto\"\246\004\n"
          + "\010Endpoint\022\021\n"
          ...
          + "google.cloud.servicedirectory.v1beta1.Endpoint.MetadataEntryB\003\340A\001\022@\n"
          ...
          + "(servicedirectory.googleapis.com/Endpoint\022fpro"
          + "jects/{project}/locations/{location}/nam"
          + "espaces/{namespace}/services/{service}/endpoints/{endpoint}B\362\002\n"
          + ")com.google.cloud.servicedirectory.v1beta1B\r"
          + "EndpointProtoP\001ZUcloud.google.com/go/servicedirectory"
          + "/apiv1beta1/servicedirectorypb;servicedirectorypb\252\002%Google.Cloud.ServiceDirector"
          + "y.V1Beta1\312\002%Google\\Cloud\\ServiceDirector"
          + "y\\V1beta1\352\002(Google::Cloud::ServiceDirectory::V1beta1\352Aa\n"
          + "\'servicedirectory.googleapis.com/Network\0226projects/{project}/loc"
          + "ations/global/networks/{network}b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_servicedirectory_v1beta1_Endpoint_MetadataEntry_descriptor =
        internal_static_google_cloud_servicedirectory_v1beta1_Endpoint_descriptor.getNestedType(0);
    internal_static_google_cloud_servicedirectory_v1beta1_Endpoint_MetadataEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_servicedirectory_v1beta1_Endpoint_MetadataEntry_descriptor,
            new java.lang.String[] {
