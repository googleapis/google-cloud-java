...
public interface CreateServiceRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.servicedirectory.v1.CreateServiceRequest)
   ...
   *
   * <code>
   * .google.cloud.servicedirectory.v1.Service service = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
