...
/**
 * Settings class to configure an instance of {@link LookupServiceStub}.
 *
...
public class LookupServiceStubSettings extends StubSettings<LookupServiceStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<ResolveServiceRequest, ResolveServiceResponse>
      resolveServiceSettings;
  ...
  public LookupServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcLookupServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonLookupServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(LookupServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return LookupServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected LookupServiceStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    resolveServiceSettings = settingsBuilder.resolveServiceSettings().build();
  }

  /** Builder for LookupServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<LookupServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<ResolveServiceRequest, ResolveServiceResponse>
        resolveServiceSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(resolveServiceSettings);
      initDefaults(this);
    }

    protected Builder(LookupServiceStubSettings settings) {
      super(settings);

      resolveServiceSettings = settings.resolveServiceSettings.toBuilder();
