...
public interface DeleteDeliveryVehicleRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:maps.fleetengine.delivery.v1.DeleteDeliveryVehicleRequest)
