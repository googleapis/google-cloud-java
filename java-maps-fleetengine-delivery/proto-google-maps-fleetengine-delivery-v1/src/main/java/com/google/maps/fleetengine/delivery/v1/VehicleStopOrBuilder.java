...
public interface VehicleStopOrBuilder
   ...
   * <code>repeated .maps.fleetengine.delivery.v1.VehicleStop.TaskInfo tasks = 2;</code>
   */
  com.google.maps.fleetengine.delivery.v1.VehicleStop.TaskInfoOrBuilder getTasksOrBuilder(
      int index);
   ...
   * @return The state.
   */
  com.google.maps.fleetengine.delivery.v1.VehicleStop.State getState();
}
