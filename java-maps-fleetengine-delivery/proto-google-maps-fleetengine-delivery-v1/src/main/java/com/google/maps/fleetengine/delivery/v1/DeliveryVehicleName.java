...
public class DeliveryVehicleName implements ResourceName {
  ...
  public static @Nullable DeliveryVehicleName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DeliveryVehicleName> values) {
