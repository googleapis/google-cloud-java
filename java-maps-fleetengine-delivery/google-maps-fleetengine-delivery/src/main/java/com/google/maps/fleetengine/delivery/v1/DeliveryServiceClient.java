...
public class DeliveryServiceClient implements BackgroundResource {
   ...
   * `VehicleJourneySegment`s to be persisted on the `DeliveryVehicle`. The `task_id`s are retrieved
   * from `remaining_vehicle_journey_segments`, and their corresponding `Tasks` are assigned to the
