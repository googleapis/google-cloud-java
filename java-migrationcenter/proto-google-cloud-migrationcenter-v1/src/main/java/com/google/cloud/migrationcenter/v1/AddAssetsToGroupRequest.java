...
public final class AddAssetsToGroupRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AddAssetsToGroupRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(internalGetAssetsFieldBuilder().getBuilder(), extensionRegistry);
