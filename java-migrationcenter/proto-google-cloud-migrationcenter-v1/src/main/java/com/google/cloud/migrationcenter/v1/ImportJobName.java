...
public class ImportJobName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_IMPORT_JOB =
  ...
  public static ImportJobName of(String project, String location, String importJob) {
    return newBuilder().setProject(project).setLocation(location).setImportJob(importJob).build();
  }

  public static String format(String project, String location, String importJob) {
    return newBuilder()
        .setProject(project)
  ...
  public static ImportJobName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_IMPORT_JOB.validatedMatch(
            formattedString, "ImportJobName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("import_job"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_IMPORT_JOB.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_IMPORT_JOB.instantiate(
        "project", project, "location", location, "import_job", importJob);
  }
