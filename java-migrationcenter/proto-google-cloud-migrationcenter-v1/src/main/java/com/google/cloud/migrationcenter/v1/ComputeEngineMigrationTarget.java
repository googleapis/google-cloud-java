...
public final class ComputeEngineMigrationTarget extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ComputeEngineMigrationTarget(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetShapeFieldBuilder().getBuilder(), extensionRegistry);
