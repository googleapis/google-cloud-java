...
public final class AppendRowsResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AppendRowsResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class AppendResult extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private AppendResult(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetOffsetFieldBuilder().getBuilder(), extensionRegistry);
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetUpdatedSchemaFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetAppendResultFieldBuilder().getBuilder(), extensionRegistry);
                responseCase_ = 1;
                break;
              } // case 10
            case 18:
            ...
            case 26:
              {
                input.readMessage(
                    internalGetUpdatedSchemaFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.bigquery.storage.v1beta2.AppendRowsResponse.AppendResult.Builder
      ...
      return internalGetAppendResultFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.bigquery.storage.v1beta2.AppendRowsResponse.AppendResult.Builder,
            com.google.cloud.bigquery.storage.v1beta2.AppendRowsResponse.AppendResultOrBuilder>
        internalGetAppendResultFieldBuilder() {
      if (appendResultBuilder_ == null) {
        if (!(responseCase_ == 1)) {
          response_ =
              com.google.cloud.bigquery.storage.v1beta2.AppendRowsResponse.AppendResult
    ...
    public com.google.cloud.bigquery.storage.v1beta2.TableSchema.Builder getUpdatedSchemaBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetUpdatedSchemaFieldBuilder().getBuilder();
    }
