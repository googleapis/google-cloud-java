  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "age/v1beta2/table.proto\032\037google/protobuf/timestamp.proto\"\362\007\n"
          ...
          + "\017table_modifiers\030\007 \001(\0132A.google.cloud.big"
          + "query.storage.v1beta2.ReadSession.TableModifiersB\003\340A\001\022^\n"
          + "\014read_options\030\010 \001(\0132C.go"
          + "ogle.cloud.bigquery.storage.v1beta2.ReadSession.TableReadOptionsB\003\340A\001\022G\n"
          + "\007streams\030\n"
          ...
          + "@.google.cloud.bigquery.storage.v1beta2.ArrowSerializationOptionsB\003\340A\001:k\352Ah\n"
          + "*bigquerystorage.googleapis.com/ReadSession\022"
          + ":projects/{project}/locations/{location}/sessions/{session}B\010\n"
          + "\006schema\"\234\001\n\n"
          + "ReadStream\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003:{\352Ax\n"
          + ")bigquerystorage.googleapis.com/ReadStream\022Kproject"
          + "s/{project}/locations/{location}/sessions/{session}/streams/{stream}\"\347\003\n"
          + "\013WriteStream\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022J\n"
          + "\004type\030\002 \001(\01627."
          + "google.cloud.bigquery.storage.v1beta2.WriteStream.TypeB\003\340A\005\0224\n"
          ...
          + "loud.bigquery.storage.v1beta2.TableSchemaB\003\340A\003\"F\n"
          + "\004Type\022\024\n"
          + "\020TYPE_UNSPECIFIED\020\000\022\r\n"
          + "\tCOMMITTED\020\001\022\013\n"
          + "\007PENDING\020\002\022\014\n"
          + "\010BUFFERED\020\003:v\352As\n"
          + "*bigquerystorage.googleapis.com/WriteStream\022Eprojects/{project}/datasets/{da"
          ...
          + "oP\001ZCcloud.google.com/go/bigquery/storage/apiv1beta2/storagepb;storagepb\352AU\n"
          + "\035bigquery.googleapis.com/Table\0224projects/{pr"
          + "oject}/datasets/{dataset}/tables/{table}b\006proto3"
    };
    descriptor =
