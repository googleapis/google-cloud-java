...
public final class SecurityCenterSettingsServiceGrpc {
  ...
  public static SecurityCenterSettingsServiceBlockingV2Stub newBlockingV2Stub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SecurityCenterSettingsServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SecurityCenterSettingsServiceBlockingV2Stub>() {
          @java.lang.Override
          public SecurityCenterSettingsServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new SecurityCenterSettingsServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return SecurityCenterSettingsServiceBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void calculateEffectiveSettings(
     ...
     * </pre>
     */
    default void batchCalculateEffectiveSettings(
        com.google.cloud.securitycenter.settings.v1beta1.BatchCalculateEffectiveSettingsRequest
            request,
        io.grpc.stub.StreamObserver<
                com.google.cloud.securitycenter.settings.v1beta1
     ...
     * </pre>
     */
    default void getComponentSettings(
     ...
     * </pre>
     */
    default void updateComponentSettings(
     ...
     * </pre>
     */
    default void resetComponentSettings(
     ...
     * </pre>
     */
    default void calculateEffectiveComponentSettings(
   ...
   * </pre>
   */
  public static final class SecurityCenterSettingsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<SecurityCenterSettingsServiceBlockingV2Stub> {
    private SecurityCenterSettingsServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected SecurityCenterSettingsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new SecurityCenterSettingsServiceBlockingV2Stub(channel, callOptions);
    }
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloud.securitycenter.settings.v1beta1.ResetSettingsRequest,
                    com.google.protobuf.Empty>(service, METHODID_RESET_SETTINGS)))
        .addMethod(
            getBatchGetSettingsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloud.securitycenter.settings.v1beta1.ResetComponentSettingsRequest,
                    com.google.protobuf.Empty>(service, METHODID_RESET_COMPONENT_SETTINGS)))
        .addMethod(
            getCalculateEffectiveComponentSettingsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
