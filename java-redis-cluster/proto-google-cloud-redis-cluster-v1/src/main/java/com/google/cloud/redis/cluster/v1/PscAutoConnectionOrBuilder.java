...
public interface PscAutoConnectionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.redis.cluster.v1.PscAutoConnection)
   ...
   *
   * <code>
   * .google.cloud.redis.cluster.v1.PscConnectionStatus psc_connection_status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.redis.cluster.v1.PscConnectionStatus getPscConnectionStatus();
   ...
   *
   * <code>
   * .google.cloud.redis.cluster.v1.ConnectionType connection_type = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.redis.cluster.v1.ConnectionType getConnectionType();
}
