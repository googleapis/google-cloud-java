...
public interface ClusterEndpointOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.redis.cluster.v1.ClusterEndpoint)
   ...
   * <code>repeated .google.cloud.redis.cluster.v1.ConnectionDetail connections = 1;</code>
   */
  com.google.cloud.redis.cluster.v1.ConnectionDetailOrBuilder getConnectionsOrBuilder(int index);
}
