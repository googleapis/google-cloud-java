...
public interface ZoneDistributionConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.redis.cluster.v1.ZoneDistributionConfig)
   ...
   * @return The mode.
   */
  com.google.cloud.redis.cluster.v1.ZoneDistributionConfig.ZoneDistributionMode getMode();
