...
public interface BackupOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.redis.cluster.v1.Backup)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.redis.cluster.v1.BackupFile> getBackupFilesList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.redis.cluster.v1.BackupFile getBackupFiles(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.redis.cluster.v1.BackupFileOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.redis.cluster.v1.BackupFileOrBuilder getBackupFilesOrBuilder(int index);
   ...
   */
  com.google.cloud.redis.cluster.v1.Backup.BackupType getBackupType();
