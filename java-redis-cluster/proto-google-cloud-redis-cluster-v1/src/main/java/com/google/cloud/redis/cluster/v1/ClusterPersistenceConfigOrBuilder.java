...
public interface ClusterPersistenceConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.redis.cluster.v1.ClusterPersistenceConfig)
   ...
   * @return The mode.
   */
  com.google.cloud.redis.cluster.v1.ClusterPersistenceConfig.PersistenceMode getMode();
   ...
   */
  com.google.cloud.redis.cluster.v1.ClusterPersistenceConfig.RDBConfig getRdbConfig();
  /**
   *
   *
   * <pre>
   ...
   */
  com.google.cloud.redis.cluster.v1.ClusterPersistenceConfig.AOFConfig getAofConfig();
  /**
   *
   *
   * <pre>
