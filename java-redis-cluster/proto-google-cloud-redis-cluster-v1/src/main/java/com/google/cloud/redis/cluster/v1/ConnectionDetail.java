...
public final class ConnectionDetail extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ConnectionDetail(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetPscAutoConnectionFieldBuilder().getBuilder(), extensionRegistry);
                connectionCase_ = 1;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(
                    internalGetPscConnectionFieldBuilder().getBuilder(), extensionRegistry);
                connectionCase_ = 2;
                break;
              } // case 18
            default:
    ...
    public com.google.cloud.redis.cluster.v1.PscAutoConnection.Builder
      ...
      return internalGetPscAutoConnectionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.redis.cluster.v1.PscAutoConnection.Builder,
            com.google.cloud.redis.cluster.v1.PscAutoConnectionOrBuilder>
        internalGetPscAutoConnectionFieldBuilder() {
      if (pscAutoConnectionBuilder_ == null) {
        if (!(connectionCase_ == 1)) {
    ...
    public com.google.cloud.redis.cluster.v1.PscConnection.Builder getPscConnectionBuilder() {
      return internalGetPscConnectionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.redis.cluster.v1.PscConnection.Builder,
            com.google.cloud.redis.cluster.v1.PscConnectionOrBuilder>
        internalGetPscConnectionFieldBuilder() {
      if (pscConnectionBuilder_ == null) {
        if (!(connectionCase_ == 2)) {
