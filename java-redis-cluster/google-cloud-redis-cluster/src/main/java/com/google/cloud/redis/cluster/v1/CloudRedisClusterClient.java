 ...
 *    <tr>
 *      <td>ListClusters</td>
 *      <td><p>Lists all Redis clusters owned by a project in either the specified
 ...
 *    <tr>
 *      <td>GetCluster</td>
 *      <td><p>Gets the details of a specific Redis cluster.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>DeleteCluster</td>
 *      <td><p>Deletes a specific Redis cluster. Cluster stops serving and data is
 *  deleted.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>CreateCluster</td>
 *      <td><p>Creates a Redis cluster based on the specified properties.
