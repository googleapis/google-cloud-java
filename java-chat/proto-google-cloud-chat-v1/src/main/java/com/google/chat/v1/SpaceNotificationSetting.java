...
public final class SpaceNotificationSetting extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SpaceNotificationSetting(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.chat.v1.SpaceNotificationSetting other) {
      ...
      if (other.hasNotificationSetting()) {
        setNotificationSettingValue(other.getNotificationSettingValue());
      }
      if (other.hasMuteSetting()) {
        setMuteSettingValue(other.getMuteSettingValue());
      }
