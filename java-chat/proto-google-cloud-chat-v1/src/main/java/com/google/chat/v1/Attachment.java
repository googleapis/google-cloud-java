...
public final class Attachment extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(contentName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, contentName_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(thumbnailUri_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, thumbnailUri_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(downloadUri_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, downloadUri_);
    }
    if (dataRefCase_ == 7) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(contentName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, contentName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(contentType_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(thumbnailUri_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, thumbnailUri_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(downloadUri_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, downloadUri_);
    }
    if (dataRefCase_ == 7) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
