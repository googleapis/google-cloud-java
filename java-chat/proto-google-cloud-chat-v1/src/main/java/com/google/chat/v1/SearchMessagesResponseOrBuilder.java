...
public interface SearchMessagesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.chat.v1.SearchMessagesResponse)
   ...
   */
  java.util.List<com.google.chat.v1.SearchMessageResult> getResultsList();
