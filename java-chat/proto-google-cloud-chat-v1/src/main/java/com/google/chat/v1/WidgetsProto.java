...
public final class WidgetsProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "\034google/chat/v1/widgets.proto\022\016google.chat.v1\"\365\016\n"
          + "\014WidgetMarkup\022D\n"
          + "\016text_paragraph\030\001"
          + " \001(\0132*.google.chat.v1.WidgetMarkup.TextParagraphH\000\0223\n"
          + "\005image\030\002 \001(\0132\".google.chat.v1.WidgetMarkup.ImageH\000\022:\n"
          + "\tkey_value\030\003 \001(\0132%.google.chat.v1.WidgetMarkup.KeyValueH\000\0224\n"
          + "\007buttons\030\006 \003(\0132#.google.chat.v1.WidgetMarkup.Button\032\035\n\r"
          + "TextParagraph\022\014\n"
          + "\004text\030\001 \001(\t\032\222\001\n"
          + "\006Button\022>\n"
          + "\013text_button\030\001 "
          + "\001(\0132\'.google.chat.v1.WidgetMarkup.TextButtonH\000\022@\n"
          + "\014image_button\030\002"
          + " \001(\0132(.google.chat.v1.WidgetMarkup.ImageButtonH\000B\006\n"
          + "\004type\032R\n\n"
          + "TextButton\022\014\n"
          + "\004text\030\001 \001(\t\0226\n"
          + "\010on_click\030\002 \001(\0132$.google.chat.v1.WidgetMarkup.OnClick\032\251\002\n"
          + "\010KeyValue\0221\n"
          + "\004icon\030\001 \001(\0162!.google.chat.v1.WidgetMarkup.IconH\000\022\022\n"
          + "\010icon_url\030\002 \001(\tH\000\022\021\n"
          + "\ttop_label\030\003 \001(\t\022\017\n"
          + "\007content\030\004 \001(\t\022\031\n"
          + "\021content_multiline\030\t \001(\010\022\024\n"
          + "\014bottom_label\030\005 \001(\t\0226\n"
          + "\010on_click\030\006 \001(\0132$.google.chat.v1.WidgetMarkup.OnClick\0225\n"
          + "\006button\030\007 \001(\0132#.google.chat.v1.WidgetMarkup.ButtonH\001B\007\n"
          + "\005iconsB\t\n"
          + "\007control\032h\n"
          + "\005Image\022\021\n"
          + "\timage_url\030\001 \001(\t\0226\n"
          + "\010on_click\030\002 \001(\0132$.google.chat.v1.WidgetMarkup.OnClick\022\024\n"
          + "\014aspect_ratio\030\003 \001(\001\032\243\001\n"
          + "\013ImageButton\0221\n"
          + "\004icon\030\001 \001(\0162!.google.chat.v1.WidgetMarkup.IconH\000\022\022\n"
          + "\010icon_url\030\003 \001(\tH\000\0226\n"
          + "\010on_click\030\002 \001(\0132$.google.chat.v1.WidgetMarkup.OnClick\022\014\n"
          + "\004name\030\004 \001(\tB\007\n"
          + "\005icons\032\210\001\n"
          + "\007OnClick\0229\n"
          + "\006action\030\001 \001(\0132\'.google.chat.v1.WidgetMarkup.FormActionH\000\022:\n"
          + "\topen_link\030\002 \001(\0132%.google.chat.v1.WidgetMarkup.OpenLinkH\000B\006\n"
          + "\004data\032\027\n"
          + "\010OpenLink\022\013\n"
          + "\003url\030\001 \001(\t\032\244\001\n\n"
          + "FormAction\022\032\n"
          + "\022action_method_name\030\001 \001(\t\022K\n\n"
          + "parameters\030\002 "
          + "\003(\01327.google.chat.v1.WidgetMarkup.FormAction.ActionParameter\032-\n"
          + "\017ActionParameter\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t\"\340\003\n"
          + "\004Icon\022\024\n"
          + "\020ICON_UNSPECIFIED\020\000\022\014\n"
          + "\010AIRPLANE\020\001\022\014\n"
          + "\010BOOKMARK\020\032\022\007\n"
          + "\003BUS\020\031\022\007\n"
          + "\003CAR\020\t\022\t\n"
          + "\005CLOCK\020\002\022\034\n"
          + "\030CONFIRMATION_NUMBER_ICON\020\014\022\n\n"
          + "\006DOLLAR\020\016\022\017\n"
          + "\013DESCRIPTION\020\033\022\t\n"
          + "\005EMAIL\020\n"
          + "\022\023\n"
          + "\017EVENT_PERFORMER\020\024\022\016\n\n"
          + "EVENT_SEAT\020\025\022\022\n"
          + "\016FLIGHT_ARRIVAL\020\020\022\024\n"
          + "\020FLIGHT_DEPARTURE\020\017\022\t\n"
          + "\005HOTEL\020\006\022\023\n"
          + "\017HOTEL_ROOM_TYPE\020\021\022\n\n"
          + "\006INVITE\020\023\022\013\n"
          + "\007MAP_PIN\020\003\022\016\n\n"
          ...
          + "\005PHONE\020\r"
          + "\022\023\n"
          + "\017RESTAURANT_ICON\020\007\022\021\n\r"
          + "SHOPPING_CART\020\010\022\010\n"
          + "\004STAR\020\005\022\t\n"
          + "\005STORE\020\026\022\n\n"
          + "\006TICKET\020\004\022\t\n"
          + "\005TRAIN\020\027\022\020\n"
          + "\014VIDEO_CAMERA\020\034\022\016\n\n"
          ...
          + "\002\023Google\\Apps\\Chat\\V1\352\002\026Google::Apps::Chat::V1b\006proto3"
    };
    descriptor =
        com.google.protobuf.Descriptors.FileDescriptor.internalBuildGeneratedFileFrom(
            descriptorData, new com.google.protobuf.Descriptors.FileDescriptor[] {});
    internal_static_google_chat_v1_WidgetMarkup_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_chat_v1_WidgetMarkup_fieldAccessorTable =
    ...
    internal_static_google_chat_v1_WidgetMarkup_TextParagraph_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(0);
    internal_static_google_chat_v1_WidgetMarkup_TextParagraph_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_TextParagraph_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_Button_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(1);
    internal_static_google_chat_v1_WidgetMarkup_Button_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_Button_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_TextButton_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(2);
    internal_static_google_chat_v1_WidgetMarkup_TextButton_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_TextButton_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_KeyValue_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(3);
    internal_static_google_chat_v1_WidgetMarkup_KeyValue_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_KeyValue_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_Image_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(4);
    internal_static_google_chat_v1_WidgetMarkup_Image_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_Image_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_ImageButton_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(5);
    internal_static_google_chat_v1_WidgetMarkup_ImageButton_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_ImageButton_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_OnClick_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(6);
    internal_static_google_chat_v1_WidgetMarkup_OnClick_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_OnClick_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_OpenLink_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(7);
    internal_static_google_chat_v1_WidgetMarkup_OpenLink_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_OpenLink_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_FormAction_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_descriptor.getNestedType(8);
    internal_static_google_chat_v1_WidgetMarkup_FormAction_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_FormAction_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_chat_v1_WidgetMarkup_FormAction_ActionParameter_descriptor =
        internal_static_google_chat_v1_WidgetMarkup_FormAction_descriptor.getNestedType(0);
    internal_static_google_chat_v1_WidgetMarkup_FormAction_ActionParameter_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_chat_v1_WidgetMarkup_FormAction_ActionParameter_descriptor,
            new java.lang.String[] {
