...
public final class MatchedUrlProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    ...
    internal_static_google_chat_v1_MatchedUrl_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_chat_v1_MatchedUrl_fieldAccessorTable =
