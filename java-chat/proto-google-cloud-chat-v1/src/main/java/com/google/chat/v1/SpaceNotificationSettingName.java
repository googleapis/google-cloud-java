...
public class SpaceNotificationSettingName implements ResourceName {
  private static final PathTemplate USER_SPACE =
      PathTemplate.createWithoutUrlEncoding("users/{user}/spaces/{space}/spaceNotificationSetting");
  private volatile Map<String, String> fieldValuesMap;
  private final String user;
  private final String space;

  @Deprecated
  protected SpaceNotificationSettingName() {
    user = null;
    space = null;
  }

  private SpaceNotificationSettingName(Builder builder) {
  ...
  public static SpaceNotificationSettingName of(String user, String space) {
  ...
  public static SpaceNotificationSettingName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        USER_SPACE.validatedMatch(
            formattedString,
            "SpaceNotificationSettingName.parse: formattedString not in valid format");
    return of(matchMap.get("user"), matchMap.get("space"));
  }

  public static List<SpaceNotificationSettingName> parseList(List<String> formattedStrings) {
    List<SpaceNotificationSettingName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      SpaceNotificationSettingName that = ((SpaceNotificationSettingName) o);
  ...
  public static class Builder {
    ...
    private Builder(SpaceNotificationSettingName spaceNotificationSettingName) {
      this.user = spaceNotificationSettingName.user;
      this.space = spaceNotificationSettingName.space;
    }

    public SpaceNotificationSettingName build() {
      return new SpaceNotificationSettingName(this);
    }
  }
}
