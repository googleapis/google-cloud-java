...
public interface ListDatasetsResponseOrBuilder
   ...
   */
  java.util.List<com.google.maps.mapsplatformdatasets.v1.Dataset> getDatasetsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.maps.mapsplatformdatasets.v1.Dataset datasets = 1;</code>
   */
  com.google.maps.mapsplatformdatasets.v1.DatasetOrBuilder getDatasetsOrBuilder(int index);
