...
/**
 * Settings class to configure an instance of {@link MapsPlatformDatasetsClient}.
 *
...
public class MapsPlatformDatasetsSettings extends ClientSettings<MapsPlatformDatasetsSettings> {
  ...
  public UnaryCallSettings<CreateDatasetRequest, Dataset> createDatasetSettings() {
    return ((MapsPlatformDatasetsStubSettings) getStubSettings()).createDatasetSettings();
  }
  ...
  public UnaryCallSettings<UpdateDatasetMetadataRequest, Dataset> updateDatasetMetadataSettings() {
    return ((MapsPlatformDatasetsStubSettings) getStubSettings()).updateDatasetMetadataSettings();
  }
  ...
  public PagedCallSettings<ListDatasetsRequest, ListDatasetsResponse, ListDatasetsPagedResponse>
    ...
    return ((MapsPlatformDatasetsStubSettings) getStubSettings()).listDatasetsSettings();
  }
  ...
  public UnaryCallSettings<DeleteDatasetRequest, Empty> deleteDatasetSettings() {
    return ((MapsPlatformDatasetsStubSettings) getStubSettings()).deleteDatasetSettings();
  }

  public static final MapsPlatformDatasetsSettings create(MapsPlatformDatasetsStubSettings stub)
      throws IOException {
    return new MapsPlatformDatasetsSettings.Builder(stub.toBuilder()).build();
  }

  /** Returns a builder for the default ExecutorProvider for this service. */
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return MapsPlatformDatasetsStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return MapsPlatformDatasetsStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return MapsPlatformDatasetsStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return MapsPlatformDatasetsStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return MapsPlatformDatasetsStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return MapsPlatformDatasetsStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  protected MapsPlatformDatasetsSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for MapsPlatformDatasetsSettings. */
  public static class Builder
      extends ClientSettings.Builder<MapsPlatformDatasetsSettings, Builder> {
    ...
    protected Builder(MapsPlatformDatasetsSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(MapsPlatformDatasetsStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    public MapsPlatformDatasetsStubSettings.Builder getStubSettingsBuilder() {
      return ((MapsPlatformDatasetsStubSettings.Builder) getStubSettings());
    }
    ...
    @Override
    public MapsPlatformDatasetsSettings build() throws IOException {
      return new MapsPlatformDatasetsSettings(this);
    }
  }
}
