...
public class MapsPlatformDatasetsV1AlphaClientHttpJsonTest {
  private static MockHttpService mockService;
  private static MapsPlatformDatasetsV1AlphaClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonMapsPlatformDatasetsV1AlphaStub.getMethodDescriptors(),
            MapsPlatformDatasetsV1AlphaSettings.getDefaultEndpoint());
    MapsPlatformDatasetsV1AlphaSettings settings =
        MapsPlatformDatasetsV1AlphaSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                MapsPlatformDatasetsV1AlphaSettings.defaultHttpJsonTransportProviderBuilder()
