...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-vision" % "3.56.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-vision/3.56.0
