...
public interface ListProductSetsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.vision.v1p4beta1.ProductSet> getProductSetsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.ProductSet product_sets = 1;</code>
   */
  com.google.cloud.vision.v1p4beta1.ProductSetOrBuilder getProductSetsOrBuilder(int index);
