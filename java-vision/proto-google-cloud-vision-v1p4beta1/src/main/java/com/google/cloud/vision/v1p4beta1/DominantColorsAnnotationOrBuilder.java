...
public interface DominantColorsAnnotationOrBuilder
   ...
   */
  java.util.List<com.google.cloud.vision.v1p4beta1.ColorInfo> getColorsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.ColorInfo colors = 1;</code>
   */
  com.google.cloud.vision.v1p4beta1.ColorInfoOrBuilder getColorsOrBuilder(int index);
}
