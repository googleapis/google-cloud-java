        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) == 0x00000001)) {
              responses_ = new java.util.ArrayList<com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileResponse>();
              mutable_bitField0_ |= 0x00000001;
            }
            responses_.add(
                input.readMessage(com.google.cloud.vision.v1p2beta1.AsyncAnnotateFileResponse.parser(), extensionRegistry));
            break;
          }
        }
      }
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.vision.v1p2beta1.AsyncBatchAnnotateFilesResponse) e.getUnfinishedMessage();
