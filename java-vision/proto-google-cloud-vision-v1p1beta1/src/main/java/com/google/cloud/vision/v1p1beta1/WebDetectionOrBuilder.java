...
public interface WebDetectionOrBuilder
   ...
   */
  java.util.List<com.google.cloud.vision.v1p1beta1.WebDetection.WebEntity> getWebEntitiesList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<com.google.cloud.vision.v1p1beta1.WebDetection.WebLabel> getBestGuessLabelsList();
  /**
   *
   *
   * <pre>
