...
public final class GeometryProto {
  ...
  static {
    ...
    internal_static_google_cloud_vision_v1p3beta1_Vertex_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_Vertex_descriptor,
        new java.lang.String[] { "X", "Y", });
    internal_static_google_cloud_vision_v1p3beta1_NormalizedVertex_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_vision_v1p3beta1_NormalizedVertex_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_NormalizedVertex_descriptor,
        new java.lang.String[] { "X", "Y", });
    internal_static_google_cloud_vision_v1p3beta1_BoundingPoly_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_vision_v1p3beta1_BoundingPoly_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_BoundingPoly_descriptor,
        new java.lang.String[] { "Vertices", "NormalizedVertices", });
    internal_static_google_cloud_vision_v1p3beta1_NormalizedBoundingPoly_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_vision_v1p3beta1_NormalizedBoundingPoly_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_NormalizedBoundingPoly_descriptor,
        new java.lang.String[] { "Vertices", });
    internal_static_google_cloud_vision_v1p3beta1_Position_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_cloud_vision_v1p3beta1_Position_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_Position_descriptor,
