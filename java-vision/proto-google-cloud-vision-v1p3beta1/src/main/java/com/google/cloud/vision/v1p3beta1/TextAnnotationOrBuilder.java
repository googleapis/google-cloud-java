...
public interface TextAnnotationOrBuilder
   ...
   */
  java.util.List<com.google.cloud.vision.v1p3beta1.Page> getPagesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p3beta1.Page pages = 1;</code>
   */
  java.util.List<? extends com.google.cloud.vision.v1p3beta1.PageOrBuilder> getPagesOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p3beta1.Page pages = 1;</code>
   */
  com.google.cloud.vision.v1p3beta1.PageOrBuilder getPagesOrBuilder(int index);
