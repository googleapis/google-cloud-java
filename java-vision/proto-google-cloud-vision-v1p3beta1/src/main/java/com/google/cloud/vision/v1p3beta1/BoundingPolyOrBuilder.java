...
public interface BoundingPolyOrBuilder
   ...
   */
  java.util.List<com.google.cloud.vision.v1p3beta1.Vertex> getVerticesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p3beta1.Vertex vertices = 1;</code>
   */
  com.google.cloud.vision.v1p3beta1.VertexOrBuilder getVerticesOrBuilder(int index);
   ...
   */
  java.util.List<com.google.cloud.vision.v1p3beta1.NormalizedVertex> getNormalizedVerticesList();
  /**
   *
   *
   * <pre>
