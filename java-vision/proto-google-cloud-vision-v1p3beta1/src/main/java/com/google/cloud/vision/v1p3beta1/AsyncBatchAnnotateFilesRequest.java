...
public final class AsyncBatchAnnotateFilesRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AsyncBatchAnnotateFilesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest m =
                    input.readMessage(
