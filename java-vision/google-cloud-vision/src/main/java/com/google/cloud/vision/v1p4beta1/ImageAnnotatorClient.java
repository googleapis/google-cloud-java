 ...
 *      <td><p>Service that performs image detection and annotation for a batch of files.
 ...
 *  GCS bucket, each json file containing BatchAnnotateImagesResponse proto.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
