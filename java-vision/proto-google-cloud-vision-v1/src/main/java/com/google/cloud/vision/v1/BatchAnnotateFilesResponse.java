...
public final class BatchAnnotateFilesResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private BatchAnnotateFilesResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.vision.v1.AnnotateFileResponse m =
                    input.readMessage(
                        com.google.cloud.vision.v1.AnnotateFileResponse.parser(),
                        extensionRegistry);
                if (responsesBuilder_ == null) {
                  ensureResponsesIsMutable();
                  responses_.add(m);
