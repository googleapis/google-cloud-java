...
public final class FaceAnnotation extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class Landmark extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetFdBoundingPolyFieldBuilder();
    ...
    public Builder mergeFrom(com.google.cloud.vision.v1.FaceAnnotation other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getRollAngle()) != 0) {
        setRollAngle(other.getRollAngle());
      }
      if (java.lang.Float.floatToRawIntBits(other.getPanAngle()) != 0) {
        setPanAngle(other.getPanAngle());
      }
      if (java.lang.Float.floatToRawIntBits(other.getTiltAngle()) != 0) {
        setTiltAngle(other.getTiltAngle());
      }
      if (java.lang.Float.floatToRawIntBits(other.getDetectionConfidence()) != 0) {
        setDetectionConfidence(other.getDetectionConfidence());
      }
      if (java.lang.Float.floatToRawIntBits(other.getLandmarkingConfidence()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetFdBoundingPolyFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000002;
                break;
              } // case 18
            case 26:
              {
                com.google.cloud.vision.v1.FaceAnnotation.Landmark m =
                    input.readMessage(
    ...
    public com.google.cloud.vision.v1.BoundingPoly.Builder getFdBoundingPolyBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetFdBoundingPolyFieldBuilder().getBuilder();
    }
