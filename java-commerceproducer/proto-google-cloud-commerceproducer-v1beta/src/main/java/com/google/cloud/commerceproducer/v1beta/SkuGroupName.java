...
public class SkuGroupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_SKU_GROUP =
  ...
  public static SkuGroupName of(String project, String location, String skuGroup) {
    return newBuilder().setProject(project).setLocation(location).setSkuGroup(skuGroup).build();
  }

  public static String format(String project, String location, String skuGroup) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setSkuGroup(skuGroup)
        .build()
        .toString();
  }

  public static @Nullable SkuGroupName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_SKU_GROUP.validatedMatch(
            formattedString, "SkuGroupName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("sku_group"));
  }
  ...
  public static List<String> toStringList(List<@Nullable SkuGroupName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_SKU_GROUP.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_SKU_GROUP.instantiate(
        "project", project, "location", location, "sku_group", skuGroup);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/skuGroups/{sku_group}. */
  public static class Builder {
    ...
    private Builder(SkuGroupName skuGroupName) {
      this.project = skuGroupName.project;
      this.location = skuGroupName.location;
