...
public class SkuName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_SERVICE_SKU =
  ...
  public static SkuName of(String project, String location, String service, String sku) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String service, String sku) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setService(service)
  ...
  public static @Nullable SkuName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_SERVICE_SKU.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_SERVICE_SKU.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_SERVICE_SKU.instantiate(
        "project", project, "location", location, "service", service, "sku", sku);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/services/{service}/skus/{sku}. */
