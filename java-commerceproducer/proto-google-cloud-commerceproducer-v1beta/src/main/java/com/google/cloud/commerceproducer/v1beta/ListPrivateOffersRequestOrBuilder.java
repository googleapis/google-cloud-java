...
public interface ListPrivateOffersRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.commerceproducer.v1beta.ListPrivateOffersRequest)
