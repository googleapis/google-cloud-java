...
/**
 * A client to Cloud Commerce Producer API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= CommerceTransactionClient =======================
 *
 * <p>Service Description: APIs related to managing resources that model commercial transactions.
 *
 * <p>Sample for CommerceTransactionClient:
 *
 * <pre>{@code
