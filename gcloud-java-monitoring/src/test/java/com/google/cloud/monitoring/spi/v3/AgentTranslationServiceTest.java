...
public class AgentTranslationServiceTest {
  ...
  public static void startStaticServer() {
    MockAgentTranslationService mockService = new MockAgentTranslationService();
  ...
  public void createCollectdTimeSeriesTest() {
    ...
    Assert.assertEquals(actualRequest.getResource(), resource);
    Assert.assertEquals(actualRequest.getCollectdVersion(), collectdVersion);
    Assert.assertEquals(actualRequest.getCollectdPayloadsList(), collectdPayloads);
  }
}
