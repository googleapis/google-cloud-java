...
public class GroupServiceApi implements AutoCloseable {
   ...
   *   for (Group element : groupServiceApi.listGroups(formattedName, childrenOfGroup, ancestorsOfGroup, descendantsOfGroup)) {
   ...
   */
  public final PageAccessor<Group> listGroups(
