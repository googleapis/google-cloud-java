...
public final class WorkflowsProto extends com.google.protobuf.GeneratedFile {
  ...
  static final com.google.protobuf.GeneratedMessage.FieldAccessorTable
      internal_static_google_cloud_workflows_v1_Workflow_TagsEntry_fieldAccessorTable;
  static final com.google.protobuf.Descriptors.Descriptor
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "nning/operations.proto\032\033google/protobuf/empty.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\215\r\n"
          + "\010Workflow\022\014\n"
          + "\004name\030\001 \001(\t\022\023\n"
          + "\013description\030\002 \001(\t\022=\n"
          + "\005state\030\003"
          + " \001(\0162).google.cloud.workflows.v1.Workflow.StateB\003\340A\003\022\030\n"
          ...
          + "(\0132/.google.cloud.workflows.v1.Workflow.LabelsEntry\022\027\n"
          ...
          + "e.cloud.workflows.v1.Workflow.StateErrorB\003\340A\003\022M\n"
          + "\016call_log_level\030\r"
          + " \001(\01620.google.cloud.workflows.v1.Workflow.CallLogLevelB\003\340A\001\022P\n\r"
          + "user_env_vars\030\016 \003(\01324.google.clo"
          + "ud.workflows.v1.Workflow.UserEnvVarsEntryB\003\340A\001\022V\n"
          + "\027execution_history_level\030\017 \001(\0162"
          + "0.google.cloud.workflows.v1.ExecutionHistoryLevelB\003\340A\001\022?\n"
          ...
          + "\004tags\030\023 \003(\0132-.google.cloud.workflows.v1.Workflow.TagsEntryB"
          + "\t\340A\004\340A\005\340A\001\032\215\001\n\n"
          + "StateError\022\017\n"
          ...
          + "!workflows.googleapis.com/Workflo"
          + "w\022<projects/{project}/locations/{location}/workflows/{workflow}B\r\n"
          ...
          + "\tworkflows\030\001 \003(\0132#.google.cloud.workflows.v1.Workflow\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"g\n"
          + "\022GetWorkflowRequest\0227\n"
          + "\004name\030\001 \001(\tB)\340A\002\372A#\n"
          + "!workflows.googleapis.com/Workflow\022\030\n"
          + "\013revision_id\030\002 \001(\tB\003\340A\001\"\250\001\n"
          + "\025CreateWorkflowRequest\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022:\n"
          + "\010workflow\030\002"
          + " \001(\0132#.google.cloud.workflows.v1.WorkflowB\003\340A\002\022\030\n"
          + "\013workflow_id\030\003 \001(\tB\003\340A\002\"P\n"
          + "\025DeleteWorkflowRequest\0227\n"
          + "\004name\030\001 \001(\tB)\340A\002\372A#\n"
          + "!workflows.googleapis.com/Workflow\"\204\001\n"
          + "\025UpdateWorkflowRequest\022:\n"
          + "\010workflow\030\001"
          + " \001(\0132#.google.cloud.workflows.v1.WorkflowB\003\340A\002\022/\n"
          ...
          + "\034ListWorkflowRevisionsRequest\0227\n"
          + "\004name\030\001 \001(\tB)\340A\002\372A#\n"
          + "!workflows.googleapis.com/Workflow\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          + "page_token\030\003 \001(\t\"p\n"
          + "\035ListWorkflowRevisionsResponse\0226\n"
          + "\tworkflows\030\001 \003(\0132#.google.cloud.workflows.v1.Workflow\022\027\n"
          + "\017next_page_token\030\002 \001(\t*}\n"
          + "\025ExecutionHistoryLevel\022\'\n"
          + "#EXECUTION_HISTORY_LEVEL_UNSPECIFIED\020\000\022\033\n"
          + "\027EXECUTION_HISTORY_BASIC\020\001\022\036\n"
          + "\032EXECUTION_HISTORY_DETAILED\020\0022\231\n\n"
          + "\tWorkflows\022\262\001\n\r"
          + "ListWorkflows\022/.google.cloud.workflows.v1.ListWorkflowsRequest\0320.goog"
          + "le.cloud.workflows.v1.ListWorkflowsRespo"
          + "nse\">\332A\006parent\202\323\344\223\002/\022-/v1/{parent=projects/*/locations/*}/workflows\022\237\001\n"
          + "\013GetWorkflow\022-.google.cloud.workflows.v1.GetWorkf"
          + "lowRequest\032#.google.cloud.workflows.v1.W"
          + "orkflow\"<\332A\004name\202\323\344\223\002/\022-/v1/{name=projects/*/locations/*/workflows/*}\022\340\001\n"
          + "\016CreateWorkflow\0220.google.cloud.workflows.v1.Cre"
          + "ateWorkflowRequest\032\035.google.longrunning.Operation\"}\312A\035\n"
          + "\010Workflow\022\021OperationMetad"
          + "ata\332A\033parent,workflow,workflow_id\202\323\344\223\0029\""
          + "-/v1/{parent=projects/*/locations/*}/workflows:\010workflow\022\314\001\n"
          + "\016DeleteWorkflow\0220.google.cloud.workflows.v1.DeleteWorkflowRe"
          + "quest\032\035.google.longrunning.Operation\"i\312A*\n"
          + "\025google.protobuf.Empty\022\021OperationMetad"
          + "ata\332A\004name\202\323\344\223\002/*-/v1/{name=projects/*/locations/*/workflows/*}\022\342\001\n"
          + "\016UpdateWorkflow\0220.google.cloud.workflows.v1.UpdateWor"
          + "kflowRequest\032\035.google.longrunning.Operation\"\177\312A\035\n"
          + "\010Workflow\022\021OperationMetadata\332A\024"
          + "workflow,update_mask\202\323\344\223\002B26/v1/{workflo"
          + "w.name=projects/*/locations/*/workflows/*}:\010workflow\022\317\001\n"
          + "\025ListWorkflowRevisions\0227.google.cloud.workflows.v1.ListWorkflowR"
          + "evisionsRequest\0328.google.cloud.workflows"
          + ".v1.ListWorkflowRevisionsResponse\"C\202\323\344\223\002"
          + "=\022;/v1/{name=projects/*/locations/*/work"
          + "flows/*}:listRevisions\032L\312A\030workflows.goo"
          + "gleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\215\003\n"
          + "\035com.google.cloud.workflows.v1B\016WorkflowsProtoP\001Z;cloud."
          + "google.com/go/workflows/apiv1/workflowspb;workflowspb\352Av\n"
          + "!cloudkms.googleapis.com/CryptoKey\022Qprojects/{project}/location"
          + "s/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}\352A\242\001\n"
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022vprojects/{project}"
          + "/locations/{location}/keyRings/{keyRing}/cryptoKeys/{cryptoKey}/cryptoKeyVersion"
          + "s/{cryptoKeyVersion}b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_workflows_v1_Workflow_StateError_descriptor =
        internal_static_google_cloud_workflows_v1_Workflow_descriptor.getNestedType(0);
    internal_static_google_cloud_workflows_v1_Workflow_StateError_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_workflows_v1_Workflow_StateError_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_workflows_v1_Workflow_LabelsEntry_descriptor =
        internal_static_google_cloud_workflows_v1_Workflow_descriptor.getNestedType(1);
    internal_static_google_cloud_workflows_v1_Workflow_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_workflows_v1_Workflow_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_workflows_v1_Workflow_UserEnvVarsEntry_descriptor =
        internal_static_google_cloud_workflows_v1_Workflow_descriptor.getNestedType(2);
    internal_static_google_cloud_workflows_v1_Workflow_UserEnvVarsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_workflows_v1_Workflow_UserEnvVarsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_workflows_v1_Workflow_TagsEntry_descriptor =
        internal_static_google_cloud_workflows_v1_Workflow_descriptor.getNestedType(3);
    internal_static_google_cloud_workflows_v1_Workflow_TagsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_workflows_v1_Workflow_TagsEntry_descriptor,
            new java.lang.String[] {
