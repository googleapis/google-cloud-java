 ...
 *    <tr>
 *      <td>ListWorkflows</td>
 *      <td><p>Lists workflows in a given project and location.
 *  The default order is not specified.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listWorkflows(ListWorkflowsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listWorkflows(LocationName parent)
 *           <li>listWorkflows(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listWorkflowsPagedCallable()
 *           <li>listWorkflowsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetWorkflow</td>
 *      <td><p>Gets details of a single workflow.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>getWorkflow(GetWorkflowRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getWorkflow(WorkflowName name)
 *           <li>getWorkflow(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>getWorkflowCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>CreateWorkflow</td>
 *      <td><p>Creates a new workflow. If a workflow with the specified name already
 *  exists in the specified project and location, the long running operation
 *  returns a [ALREADY_EXISTS][google.rpc.Code.ALREADY_EXISTS] error.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>createWorkflowAsync(CreateWorkflowRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>createWorkflowAsync(LocationName parent, Workflow workflow, String workflowId)
 *           <li>createWorkflowAsync(String parent, Workflow workflow, String workflowId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>createWorkflowOperationCallable()
 *           <li>createWorkflowCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>DeleteWorkflow</td>
 *      <td><p>Deletes a workflow with the specified name.
 *  This method also cancels and deletes all running executions of the
 *  workflow.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>deleteWorkflowAsync(DeleteWorkflowRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>deleteWorkflowAsync(WorkflowName name)
 *           <li>deleteWorkflowAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>deleteWorkflowOperationCallable()
 *           <li>deleteWorkflowCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>UpdateWorkflow</td>
 *      <td><p>Updates an existing workflow.
 ...
 *  in new workflow executions.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>updateWorkflowAsync(UpdateWorkflowRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>updateWorkflowAsync(Workflow workflow, FieldMask updateMask)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>updateWorkflowOperationCallable()
 *           <li>updateWorkflowCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
