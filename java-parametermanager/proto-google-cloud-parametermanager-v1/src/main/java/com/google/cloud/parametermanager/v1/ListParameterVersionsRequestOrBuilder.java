...
public interface ListParameterVersionsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.parametermanager.v1.ListParameterVersionsRequest)
