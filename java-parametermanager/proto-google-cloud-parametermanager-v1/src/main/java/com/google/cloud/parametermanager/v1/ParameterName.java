...
public class ParameterName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_PARAMETER =
  ...
  public static ParameterName of(String project, String location, String parameter) {
    return newBuilder().setProject(project).setLocation(location).setParameter(parameter).build();
  }
  ...
  public static @Nullable ParameterName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_PARAMETER.validatedMatch(
            formattedString, "ParameterName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("parameter"));
  }

  public static List<ParameterName> parseList(List<String> formattedStrings) {
    List<ParameterName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ParameterName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_PARAMETER.instantiate(
        "project", project, "location", location, "parameter", parameter);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/parameters/{parameter}. */
