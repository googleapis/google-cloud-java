...
public interface TemplateOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.parametermanager.v1.Template)
   ...
   *
   * <code>
   * .google.cloud.parametermanager.v1.TemplateFormat format = 5 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The format.
   */
  com.google.cloud.parametermanager.v1.TemplateFormat getFormat();
}
