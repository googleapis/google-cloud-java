...
public interface SearchDocumentChunksResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.developers.knowledge.v1.DocumentChunk> 
      getResultsList();
  /**
   * <pre>
   * Contains the search results for the given query. Each
   ...
   * <code>repeated .google.developers.knowledge.v1.DocumentChunk results = 1;</code>
   */
  com.google.developers.knowledge.v1.DocumentChunkOrBuilder getResultsOrBuilder(
      int index);
