...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-developer-knowledge" % "0.6.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-developer-knowledge/0.6.0
