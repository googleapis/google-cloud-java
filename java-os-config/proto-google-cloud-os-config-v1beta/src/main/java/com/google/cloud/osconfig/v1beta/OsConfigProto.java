  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3google/cloud/osconfig/v1beta/osconfig_"
          ...
          + "projects/*/patchDeployments/*}\022\316\001\n\021Creat"
          + "eGuestPolicy\0226.google.cloud.osconfig.v1b"
          + "eta.CreateGuestPolicyRequest\032).google.cl"
          + "oud.osconfig.v1beta.GuestPolicy\"V\202\323\344\223\0029\""
          + ")/v1beta/{parent=projects/*}/guestPolici"
          + "es:\014guest_policy\332A\024parent, guest_policy\022"
          + "\252\001\n\016GetGuestPolicy\0223.google.cloud.osconf"
          + "ig.v1beta.GetGuestPolicyRequest\032).google"
          + ".cloud.osconfig.v1beta.GuestPolicy\"8\202\323\344\223"
          + "\002+\022)/v1beta/{name=projects/*/guestPolici"
          + "es/*}\332A\004name\022\300\001\n\021ListGuestPolicies\0226.goo"
          + "gle.cloud.osconfig.v1beta.ListGuestPolic"
          + "iesRequest\0327.google.cloud.osconfig.v1bet"
          + "a.ListGuestPoliciesResponse\":\202\323\344\223\002+\022)/v1"
          + "beta/{parent=projects/*}/guestPolicies\332A"
          + "\006parent\022\337\001\n\021UpdateGuestPolicy\0226.google.c"
          + "loud.osconfig.v1beta.UpdateGuestPolicyRe"
          + "quest\032).google.cloud.osconfig.v1beta.Gue"
          + "stPolicy\"g\202\323\344\223\002F26/v1beta/{guest_policy."
          + "name=projects/*/guestPolicies/*}:\014guest_"
          + "policy\332A\030guest_policy,update_mask\022\235\001\n\021De"
          + "leteGuestPolicy\0226.google.cloud.osconfig."
          + "v1beta.DeleteGuestPolicyRequest\032\026.google"
          + ".protobuf.Empty\"8\202\323\344\223\002+*)/v1beta/{name=p"
          + "rojects/*/guestPolicies/*}\332A\004name\022\352\001\n\032Lo"
          + "okupEffectiveGuestPolicy\022?.google.cloud."
          + "osconfig.v1beta.LookupEffectiveGuestPoli"
          + "cyRequest\0322.google.cloud.osconfig.v1beta"
          + ".EffectiveGuestPolicy\"W\202\323\344\223\002Q\"L/v1beta/{"
          + "instance=projects/*/zones/*/instances/*}"
          + ":lookupEffectiveGuestPolicy:\001*\032K\312A\027oscon"
          + "fig.googleapis.com\322A.https://www.googlea"
          + "pis.com/auth/cloud-platformBw\n com.googl"
          + "e.cloud.osconfig.v1betaB\rOsConfigProtoZD"
          + "google.golang.org/genproto/googleapis/cl"
          + "oud/osconfig/v1beta;osconfigb\006proto3"
    };
    descriptor =
