  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "api/resource.proto\032\037google/protobuf/timestamp.proto\032\026google/type/date.proto\"\267\026\n"
          + "\tInventory\022\021\n"
          + "\004name\030\003 \001(\tB\003\340A\003\022E\n"
          + "\007os_info\030\001"
          + " \001(\0132/.google.cloud.osconfig.v1alpha.Inventory.OsInfoB\003\340A\003\022G\n"
          + "\005items\030\002 \003(\01323.goo"
          + "gle.cloud.osconfig.v1alpha.Inventory.ItemsEntryB\003\340A\003\0224\n"
          ...
          + "\013origin_type\030\002"
          + " \001(\01628.google.cloud.osconfig.v1alpha.Inventory.Item.OriginType\022/\n"
          ...
          + "osconfig.v1alpha.Inventory.SoftwarePackageH\000\022U\n"
          + "\021available_package\030\007 \001(\01328.google"
          + ".cloud.osconfig.v1alpha.Inventory.SoftwarePackageH\000\"?\n\n"
          + "OriginType\022\033\n"
          ...
          + " \001(\01329.google.cloud.osconfig.v1alpha.Inventory.VersionedPackageH\000\022P\n"
          + "\013apt_package\030\002"
          + " \001(\01329.google.cloud.osconfig.v1alpha.Inventory.VersionedPackageH\000\022S\n"
          + "\016zypper_package\030\003"
          + " \001(\01329.google.cloud.osconfig.v1alpha.Inventory.VersionedPackageH\000\022S\n"
          + "\016googet_package\030\004"
          + " \001(\01329.google.cloud.osconfig.v1alpha.Inventory.VersionedPackageH\000\022L\n"
          + "\014zypper_patch\030\005"
          + " \001(\01324.google.cloud.osconfig.v1alpha.Inventory.ZypperPatchH\000\022T\n"
          + "\013wua_package\030\006 \001(\0132=.google.cloud.osconfig"
          + ".v1alpha.Inventory.WindowsUpdatePackageH\000\022a\n"
          + "\013qfe_package\030\007 \001(\0132J.google.cloud.os"
          + "config.v1alpha.Inventory.WindowsQuickFixEngineeringPackageH\000\022P\n"
          + "\013cos_package\030\010 \001("
          + "\01329.google.cloud.osconfig.v1alpha.Inventory.VersionedPackageH\000\022Z\n"
          + "\023windows_application\030\t"
          + " \001(\0132;.google.cloud.osconfig.v1alpha.Inventory.WindowsApplicationH\000B\t\n"
          + "\007details\032O\n"
          ...
          + "categories\030\003 \003(\0132S.google.cloud.osconfig."
          + "v1alpha.Inventory.WindowsUpdatePackage.WindowsUpdateCategory\022\026\n"
          ...
          + "d.osconfig.v1alpha.Inventory.Item:\0028\001:n\352Ak\n"
          + "!osconfig.googleapis.com/Inventory\022Fp"
          + "rojects/{project}/locations/{location}/instances/{instance}/inventory\"\212\001\n"
          + "\023GetInventoryRequest\0227\n"
          + "\004name\030\001 \001(\tB)\340A\002\372A#\n"
          + "!osconfig.googleapis.com/Inventory\022:\n"
          + "\004view\030\002 \001(\0162,.google.cloud.osconfig.v1alpha.InventoryView\"\304\001\n"
          + "\026ListInventoriesRequest\0227\n"
          + "\006parent\030\001 \001(\tB\'\340A\002\372A!\n"
          + "\037compute.googleapis.com/Instance\022:\n"
          + "\004view\030\002 \001(\0162,.google.cloud.osconfig.v1alpha.InventoryView\022\021\n"
          + "\tpage_size\030\003 \001(\005\022\022\n\n"
          + "page_token\030\004 \001(\t\022\016\n"
          + "\006filter\030\005 \001(\t\"q\n"
          + "\027ListInventoriesResponse\022=\n"
          + "\013inventories\030\001 \003(\0132(.google.cloud.osconfig.v1alpha.Inventory\022\027\n"
          ...
          + "!com.google.cloud.osconfig.v1alphaB\013Invent"
          + "oriesP\001Z=cloud.google.com/go/osconfig/ap"
          + "iv1alpha/osconfigpb;osconfigpb\252\002\035Google."
          + "Cloud.OsConfig.V1Alpha\312\002\035Google\\Cloud\\OsConfig\\V1alpha\352\002"
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_OsInfo_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(0);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_OsInfo_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_OsInfo_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_Item_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(1);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_Item_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_Item_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_SoftwarePackage_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(2);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_SoftwarePackage_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_SoftwarePackage_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_VersionedPackage_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(3);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_VersionedPackage_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_VersionedPackage_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_ZypperPatch_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(4);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_ZypperPatch_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_ZypperPatch_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsUpdatePackage_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(5);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsUpdatePackage_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsUpdatePackage_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsQuickFixEngineeringPackage_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(6);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsQuickFixEngineeringPackage_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsQuickFixEngineeringPackage_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsApplication_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(7);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsApplication_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_WindowsApplication_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_osconfig_v1alpha_Inventory_ItemsEntry_descriptor =
        internal_static_google_cloud_osconfig_v1alpha_Inventory_descriptor.getNestedType(8);
    internal_static_google_cloud_osconfig_v1alpha_Inventory_ItemsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_osconfig_v1alpha_Inventory_ItemsEntry_descriptor,
            new java.lang.String[] {
