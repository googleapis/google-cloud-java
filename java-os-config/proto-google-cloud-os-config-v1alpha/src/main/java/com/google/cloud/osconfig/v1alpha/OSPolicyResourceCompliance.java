...
public final class OSPolicyResourceCompliance extends com.google.protobuf.GeneratedMessage
    implements
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetExecResourceOutputFieldBuilder().getBuilder(), extensionRegistry);
                outputCase_ = 4;
                break;
              } // case 34
            default:
