...
public class OSPolicyAssignmentName implements ResourceName {
  ...
  public static @Nullable OSPolicyAssignmentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable OSPolicyAssignmentName> values) {
