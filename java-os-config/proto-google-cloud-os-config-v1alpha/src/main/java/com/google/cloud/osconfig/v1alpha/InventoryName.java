...
public class InventoryName implements ResourceName {
  ...
  private InventoryName(Builder builder) {
  ...
  public static InventoryName of(String project, String location, String instance) {
  ...
  public static @Nullable InventoryName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_INSTANCE.validatedMatch(
            formattedString, "InventoryName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("instance"));
  }

  public static List<InventoryName> parseList(List<String> formattedStrings) {
    List<InventoryName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable InventoryName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (InventoryName value : values) {
      if (value == null) {
        list.add("");
      } else {
