 ...
 * <p>  For more information, see [Method: projects.locations.osPolicyAssignments.operations.cancel](https://cloud.google.com/compute/docs/osconfig/rest/v1alpha/projects.locations.osPolicyAssignments.operations/cancel).</td>
 *      <td>
 ...
 *    </tr>
 *    <tr>
 *      <td><p> GetInstanceOSPoliciesCompliance</td>
 *      <td><p> Get OS policies compliance data for the specified Compute Engine VM instance.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> getInstanceOSPoliciesCompliance(GetInstanceOSPoliciesComplianceRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> getInstanceOSPoliciesCompliance(InstanceOSPoliciesComplianceName name)
 *           <li><p> getInstanceOSPoliciesCompliance(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> getInstanceOSPoliciesComplianceCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> ListInstanceOSPoliciesCompliances</td>
 *      <td><p> List OS policies compliance data for all Compute Engine VM instances in the specified zone.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> listInstanceOSPoliciesCompliances(ListInstanceOSPoliciesCompliancesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> listInstanceOSPoliciesCompliances(LocationName parent)
 *           <li><p> listInstanceOSPoliciesCompliances(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> listInstanceOSPoliciesCompliancesPagedCallable()
 *           <li><p> listInstanceOSPoliciesCompliancesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
...
public class OsConfigZonalServiceClient implements BackgroundResource {
    ...
    private ListInstanceOSPoliciesCompliancesPage(
        @Nullable
            PageContext<
                ...
                InstanceOSPoliciesCompliance>
            context,
        @Nullable ListInstanceOSPoliciesCompliancesResponse response) {
      super(context, response);
    }
  ...
  public static class ListInstanceOSPoliciesCompliancesFixedSizeCollection
    ...
    private ListInstanceOSPoliciesCompliancesFixedSizeCollection(
        @Nullable List<ListInstanceOSPoliciesCompliancesPage> pages, int collectionSize) {
      super(pages, collectionSize);
    }
