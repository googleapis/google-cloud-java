...
public class OsConfigZonalServiceClientTest {
  ...
  public void getInstanceOSPoliciesComplianceTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockOsConfigZonalService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetInstanceOSPoliciesComplianceRequest actualRequest =
        ((GetInstanceOSPoliciesComplianceRequest) actualRequests.get(0));
  ...
  public void listInstanceOSPoliciesCompliancesTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockOsConfigZonalService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListInstanceOSPoliciesCompliancesRequest actualRequest =
        ((ListInstanceOSPoliciesCompliancesRequest) actualRequests.get(0));
