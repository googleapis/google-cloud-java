 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the OrganizationAddressGroupServiceClient object to clean
 ...
 *      <td><p> Updates parameters of an address group.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Deletes an address group.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 * OrganizationAddressGroupServiceSettings to create(). For example:
 *
...
public class OrganizationAddressGroupServiceClient implements BackgroundResource {
  private final @Nullable OrganizationAddressGroupServiceSettings settings;
  private final OrganizationAddressGroupServiceStub stub;
  private final OperationsClient operationsClient;

  /** Constructs an instance of OrganizationAddressGroupServiceClient with default settings. */
  public static final OrganizationAddressGroupServiceClient create() throws IOException {
    return create(OrganizationAddressGroupServiceSettings.newBuilder().build());
  }

  /**
   * Constructs an instance of OrganizationAddressGroupServiceClient, using the given settings. The
   * channels are created based on the settings passed in, or defaults for any settings that are not
   * set.
   */
  public static final OrganizationAddressGroupServiceClient create(
      OrganizationAddressGroupServiceSettings settings) throws IOException {
    return new OrganizationAddressGroupServiceClient(settings);
  }

  /**
   * Constructs an instance of OrganizationAddressGroupServiceClient, using the given stub for
   * making calls. This is for advanced usage - prefer using
   * create(OrganizationAddressGroupServiceSettings).
   */
  public static final OrganizationAddressGroupServiceClient create(
      OrganizationAddressGroupServiceStub stub) {
    return new OrganizationAddressGroupServiceClient(stub);
  }

  /**
   * Constructs an instance of OrganizationAddressGroupServiceClient, using the given settings. This
  ...
  protected OrganizationAddressGroupServiceClient(OrganizationAddressGroupServiceSettings settings)
    ...
    this.stub =
        ((OrganizationAddressGroupServiceStubSettings) settings.getStubSettings()).createStub();
  ...
  public final @Nullable OrganizationAddressGroupServiceSettings getSettings() {
    return settings;
  }
