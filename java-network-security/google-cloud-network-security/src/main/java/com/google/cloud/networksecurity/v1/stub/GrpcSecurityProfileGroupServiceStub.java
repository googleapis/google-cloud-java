...
/**
 * gRPC stub implementation for the SecurityProfileGroupService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@NullMarked
@Generated("by gapic-generator-java")
public class GrpcSecurityProfileGroupServiceStub extends SecurityProfileGroupServiceStub {
  ...
  public static final GrpcSecurityProfileGroupServiceStub create(
      SecurityProfileGroupServiceStubSettings settings) throws IOException {
    return new GrpcSecurityProfileGroupServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcSecurityProfileGroupServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcSecurityProfileGroupServiceStub(
        SecurityProfileGroupServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcSecurityProfileGroupServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcSecurityProfileGroupServiceStub(
        SecurityProfileGroupServiceStubSettings.newBuilder().build(),
        clientContext,
        callableFactory);
  }

  /**
   * Constructs an instance of GrpcSecurityProfileGroupServiceStub, using the given settings. This
   * is protected so that it is easy to make a subclass, but otherwise, the static factory methods
   * should be preferred.
   */
  protected GrpcSecurityProfileGroupServiceStub(
      SecurityProfileGroupServiceStubSettings settings, ClientContext clientContext)
      throws IOException {
    this(settings, clientContext, new GrpcSecurityProfileGroupServiceCallableFactory());
  }
   ...
   */
  protected GrpcSecurityProfileGroupServiceStub(
      SecurityProfileGroupServiceStubSettings settings,
