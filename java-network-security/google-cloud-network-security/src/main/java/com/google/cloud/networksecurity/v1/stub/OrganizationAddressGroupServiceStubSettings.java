...
/**
 * Settings class to configure an instance of {@link OrganizationAddressGroupServiceStub}.
 *
...
public class OrganizationAddressGroupServiceStubSettings
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(OrganizationAddressGroupServiceStubSettings.class))
        .setTransportToken(
  ...
  protected OrganizationAddressGroupServiceStubSettings(Builder settingsBuilder)
      throws IOException {
  ...
  /** Builder for OrganizationAddressGroupServiceStubSettings. */
