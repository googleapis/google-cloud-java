...
public class AddressGroupServiceClientTest {
  private static MockAddressGroupService mockAddressGroupService;
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private AddressGroupServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockAddressGroupService = new MockAddressGroupService();
    mockLocations = new MockLocations();
    mockIAMPolicy = new MockIAMPolicy();
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(),
            Arrays.<MockGrpcService>asList(mockAddressGroupService, mockLocations, mockIAMPolicy));
  ...
  public void setUp() throws IOException {
    ...
    AddressGroupServiceSettings settings =
        AddressGroupServiceSettings.newBuilder()
            .setTransportChannelProvider(channelProvider)
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = AddressGroupServiceClient.create(settings);
  }
  ...
  public void listAddressGroupsTest() throws Exception {
    ...
    ListAddressGroupsResponse expectedResponse =
        ListAddressGroupsResponse.newBuilder()
            ...
            .build();
    mockAddressGroupService.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockAddressGroupService.getRequests();
  ...
  public void listAddressGroupsExceptionTest() throws Exception {
    ...
    mockAddressGroupService.addException(exception);
  ...
  public void createAddressGroupTest() throws Exception {
    ...
    Operation resultOperation =
        Operation.newBuilder()
            ...
            .build();
    mockAddressGroupService.addResponse(resultOperation);
