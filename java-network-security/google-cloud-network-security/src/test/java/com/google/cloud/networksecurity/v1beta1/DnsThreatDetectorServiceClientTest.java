...
public class DnsThreatDetectorServiceClientTest {
  private static MockDnsThreatDetectorService mockDnsThreatDetectorService;
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private DnsThreatDetectorServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockDnsThreatDetectorService = new MockDnsThreatDetectorService();
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(
                mockDnsThreatDetectorService, mockLocations, mockIAMPolicy));
  ...
  public void listDnsThreatDetectorsTest() throws Exception {
    ...
    ListDnsThreatDetectorsResponse expectedResponse =
        ListDnsThreatDetectorsResponse.newBuilder()
            ...
            .build();
    mockDnsThreatDetectorService.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockDnsThreatDetectorService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListDnsThreatDetectorsRequest actualRequest =
        ((ListDnsThreatDetectorsRequest) actualRequests.get(0));
  ...
  public void listDnsThreatDetectorsExceptionTest() throws Exception {
    ...
    mockDnsThreatDetectorService.addException(exception);
  ...
  public void getDnsThreatDetectorTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDnsThreatDetectorService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetDnsThreatDetectorRequest actualRequest =
        ((GetDnsThreatDetectorRequest) actualRequests.get(0));
  ...
  public void createDnsThreatDetectorTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDnsThreatDetectorService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    CreateDnsThreatDetectorRequest actualRequest =
        ((CreateDnsThreatDetectorRequest) actualRequests.get(0));

    Assert.assertEquals(parent.toString(), actualRequest.getParent());
    Assert.assertEquals(dnsThreatDetector, actualRequest.getDnsThreatDetector());
    Assert.assertEquals(dnsThreatDetectorId, actualRequest.getDnsThreatDetectorId());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void updateDnsThreatDetectorTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDnsThreatDetectorService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    UpdateDnsThreatDetectorRequest actualRequest =
        ((UpdateDnsThreatDetectorRequest) actualRequests.get(0));
  ...
  public void deleteDnsThreatDetectorTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDnsThreatDetectorService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    DeleteDnsThreatDetectorRequest actualRequest =
        ((DeleteDnsThreatDetectorRequest) actualRequests.get(0));
