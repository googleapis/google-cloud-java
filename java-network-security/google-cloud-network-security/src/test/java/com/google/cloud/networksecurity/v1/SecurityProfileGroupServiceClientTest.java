...
public class SecurityProfileGroupServiceClientTest {
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockSecurityProfileGroupService mockSecurityProfileGroupService;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private SecurityProfileGroupServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockSecurityProfileGroupService = new MockSecurityProfileGroupService();
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(
                mockSecurityProfileGroupService, mockLocations, mockIAMPolicy));
  ...
  public void setUp() throws IOException {
    ...
    SecurityProfileGroupServiceSettings settings =
        SecurityProfileGroupServiceSettings.newBuilder()
            .setTransportChannelProvider(channelProvider)
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = SecurityProfileGroupServiceClient.create(settings);
  }
  ...
  public void listSecurityProfileGroupsTest() throws Exception {
    ...
    ListSecurityProfileGroupsResponse expectedResponse =
        ListSecurityProfileGroupsResponse.newBuilder()
            ...
            .build();
    mockSecurityProfileGroupService.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockSecurityProfileGroupService.getRequests();
  ...
  public void listSecurityProfileGroupsExceptionTest() throws Exception {
    ...
    mockSecurityProfileGroupService.addException(exception);
  ...
  public void createSecurityProfileGroupTest() throws Exception {
    ...
    Operation resultOperation =
        Operation.newBuilder()
            ...
            .build();
    mockSecurityProfileGroupService.addResponse(resultOperation);
