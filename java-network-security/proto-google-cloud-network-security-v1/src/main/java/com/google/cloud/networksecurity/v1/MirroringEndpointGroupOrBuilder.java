...
public interface MirroringEndpointGroupOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networksecurity.v1.MirroringEndpointGroup)
   ...
   * </code>
   */
  int getConnectedDeploymentGroupsCount();
   ...
   * </code>
   */
  com.google.cloud.networksecurity.v1.MirroringEndpointGroup.ConnectedDeploymentGroupOrBuilder
   ...
   * @return The state.
   */
  com.google.cloud.networksecurity.v1.MirroringEndpointGroup.State getState();
   ...
   * @return The type.
   */
  com.google.cloud.networksecurity.v1.MirroringEndpointGroup.Type getType();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.networksecurity.v1.MirroringEndpointGroup.AssociationDetails>
      getAssociationsList();
   ...
   * </code>
   */
  com.google.cloud.networksecurity.v1.MirroringEndpointGroup.AssociationDetails getAssociations(
      int index);
