...
public class GatewaySecurityPolicyRuleName implements ResourceName {
  ...
  public static @Nullable GatewaySecurityPolicyRuleName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GatewaySecurityPolicyRuleName> values) {
