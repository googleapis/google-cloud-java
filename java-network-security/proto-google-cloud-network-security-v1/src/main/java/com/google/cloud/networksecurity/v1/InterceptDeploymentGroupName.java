...
public class InterceptDeploymentGroupName implements ResourceName {
  ...
  public static @Nullable InterceptDeploymentGroupName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable InterceptDeploymentGroupName> values) {
