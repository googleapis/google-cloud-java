...
public class SecurityProfileName implements ResourceName {
  ...
  public static @Nullable SecurityProfileName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SecurityProfileName> values) {
