...
public final class ClientTlsPolicy extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ClientTlsPolicy(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sni_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, sni_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sni_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, sni_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetClientCertificateFieldBuilder();
        internalGetServerValidationCaFieldBuilder();
      }
    }
    ...
    private void buildPartial0(com.google.cloud.networksecurity.v1.ClientTlsPolicy result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58:
              {
                input.readMessage(
                    internalGetClientCertificateFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.networksecurity.v1.CertificateProvider.Builder
      ...
      bitField0_ |= 0x00000040;
      onChanged();
      return internalGetClientCertificateFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.networksecurity.v1.ValidationCA.Builder getServerValidationCaBuilder(
        int index) {
      return internalGetServerValidationCaFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.networksecurity.v1.ValidationCA.Builder addServerValidationCaBuilder() {
      return internalGetServerValidationCaFieldBuilder()
    ...
    public java.util.List<com.google.cloud.networksecurity.v1.ValidationCA.Builder>
      ...
      return internalGetServerValidationCaFieldBuilder().getBuilderList();
    }
