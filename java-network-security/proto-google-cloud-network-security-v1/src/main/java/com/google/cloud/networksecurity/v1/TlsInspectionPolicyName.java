...
public class TlsInspectionPolicyName implements ResourceName {
  ...
  public static @Nullable TlsInspectionPolicyName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TlsInspectionPolicyName> values) {
