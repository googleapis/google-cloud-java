...
public class ClientTlsPolicyName implements ResourceName {
  ...
  public static @Nullable ClientTlsPolicyName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ClientTlsPolicyName> values) {
