...
public class DnsThreatDetectorName implements ResourceName {
  ...
  public static @Nullable DnsThreatDetectorName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DnsThreatDetectorName> values) {
