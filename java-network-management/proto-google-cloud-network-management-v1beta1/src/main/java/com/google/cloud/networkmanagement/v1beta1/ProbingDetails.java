...
public final class ProbingDetails extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 66:
            {
              com.google.cloud.networkmanagement.v1beta1.LatencyDistribution.Builder subBuilder =
                  null;
              if (probingLatency_ != null) {
                subBuilder = probingLatency_.toBuilder();
              }
              probingLatency_ =
                  input.readMessage(
                      com.google.cloud.networkmanagement.v1beta1.LatencyDistribution.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(probingLatency_);
                probingLatency_ = subBuilder.buildPartial();
              }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.networkmanagement.v1beta1.ProbingDetails parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.networkmanagement.v1beta1.ProbingDetails) e.getUnfinishedMessage();
        throw e.unwrapIOException();
      } finally {
        if (parsedMessage != null) {
          mergeFrom(parsedMessage);
