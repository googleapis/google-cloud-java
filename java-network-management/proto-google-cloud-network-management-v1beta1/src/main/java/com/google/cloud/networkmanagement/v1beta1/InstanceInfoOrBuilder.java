...
public interface InstanceInfoOrBuilder
   ...
   *     See google/cloud/networkmanagement/v1beta1/trace.proto;l=426
   ...
   *     google/cloud/networkmanagement/v1beta1/trace.proto;l=433
   * @return The running.
   */
  @java.lang.Deprecated
  boolean getRunning();
   ...
   * </pre>
   *
   * <code>.google.cloud.networkmanagement.v1beta1.InstanceInfo.Status status = 11;</code>
   *
   ...
   * @return The status.
   */
  com.google.cloud.networkmanagement.v1beta1.InstanceInfo.Status getStatus();
}
