...
public final class TestOuterClass extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ">google/cloud/networkmanagement/v1beta1/connectivity_test.proto\022&google.cloud.n"
          + "etworkmanagement.v1beta1\032\037google/api/fie"
          + "ld_behavior.proto\032\031google/api/resource.p"
          + "roto\0322google/cloud/networkmanagement/v1b"
          + "eta1/trace.proto\032\037google/protobuf/timestamp.proto\032\027google/rpc/status.proto\"\314\007\n"
          ...
          + ".cloud.networkmanagement.v1beta1.EndpointB\003\340A\002\022J\n"
          + "\013destination\030\004 \001(\01320.google.clo"
          + "ud.networkmanagement.v1beta1.EndpointB\003\340A\002\022\020\n"
          + "\010protocol\030\005 \001(\t\022\030\n"
          + "\020related_projects\030\006 \003(\t\022\031\n"
          + "\014display_name\030\007 \001(\tB\003\340A\003\022T\n"
          + "\006labels\030\010 \003(\0132D.google.cloud.networkmanageme"
          + "nt.v1beta1.ConnectivityTest.LabelsEntry\0224\n"
          + "\013create_time\030\n"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\0224\n"
          + "\013update_time\030\013 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022^\n"
          + "\024reachability_details\030\014 \001(\0132;.google.cloud.network"
          + "management.v1beta1.ReachabilityDetailsB\003\340A\003\022T\n"
          + "\017probing_details\030\016 \001(\01326.google.cl"
          + "oud.networkmanagement.v1beta1.ProbingDetailsB\003\340A\003\022\022\n\n"
          + "round_trip\030\017 \001(\010\022e\n"
          + "\033return_reachability_details\030\020 \001(\0132;.google.clou"
          + "d.networkmanagement.v1beta1.ReachabilityDetailsB\003\340A\003\022\036\n"
          + "\026bypass_firewall_checks\030\021 \001(\010\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:t\352Aq\n"
          + "1networkmanagement.googleapis.com/ConnectivityTest\022<projects/{p"
          + "roject}/locations/global/connectivityTests/{test}\"\305\n\n"
          + "\010Endpoint\022\022\n\n"
          + "ip_address\030\001 \001(\t\022\014\n"
          + "\004port\030\002 \001(\005\022\020\n"
          + "\010instance\030\003 \001(\t\022\027\n"
          + "\017forwarding_rule\030\r"
          + " \001(\t\022o\n"
          + "\026forwarding_rule_target\030\016 \001(\0162E.google.cloud.networkmanage"
          + "ment.v1beta1.Endpoint.ForwardingRuleTargetB\003\340A\003H\000\210\001\001\022\"\n"
          + "\020load_balancer_id\030\017 \001(\tB\003\340A\003H\001\210\001\001\022^\n"
          + "\022load_balancer_type\030\020 \001(\01628.g"
          + "oogle.cloud.networkmanagement.v1beta1.LoadBalancerTypeB\003\340A\003H\002\210\001\001\022\032\n"
          + "\022gke_master_cluster\030\007 \001(\t\022\014\n"
          + "\004fqdn\030\023 \001(\t\022\032\n"
          + "\022cloud_sql_instance\030\010 \001(\t\022\026\n"
          + "\016redis_instance\030\021 \001(\t\022\025\n\r"
          + "redis_cluster\030\022 \001(\t\022\017\n"
          + "\007gke_pod\030\025 \001(\t\022^\n"
          + "\016cloud_function\030\n"
          + " \001(\0132F.google.cloud.ne"
          + "tworkmanagement.v1beta1.Endpoint.CloudFunctionEndpoint\022e\n"
          + "\022app_engine_version\030\013 \001"
          + "(\0132I.google.cloud.networkmanagement.v1beta1.Endpoint.AppEngineVersionEndpoint\022e\n"
          + "\022cloud_run_revision\030\014 \001(\0132I.google.cloud"
          + ".networkmanagement.v1beta1.Endpoint.CloudRunRevisionEndpoint\022\025\n\r"
          + "cloud_run_job\030\030 \001(\t\022\017\n"
          + "\007network\030\004 \001(\t\022R\n"
          + "\014network_type\030\005 \001"
          + "(\0162<.google.cloud.networkmanagement.v1beta1.Endpoint.NetworkType\022\022\n\n"
          + "project_id\030\006 \001(\t\032$\n"
          + "\025CloudFunctionEndpoint\022\013\n"
          + "\003uri\030\001 \001(\t\032\'\n"
          + "\030AppEngineVersionEndpoint\022\013\n"
          + "\003uri\030\001 \001(\t\032A\n"
          + "\030CloudRunRevisionEndpoint\022\013\n"
          + "\003uri\030\001 \001(\t\022\030\n"
          + "\013service_uri\030\002 \001(\tB\003\340A\003\"_\n"
          + "\013NetworkType\022\034\n"
          + "\030NETWORK_TYPE_UNSPECIFIED\020\000\022\017\n"
          + "\013GCP_NETWORK\020\001\022\023\n"
          + "\017NON_GCP_NETWORK\020\002\022\014\n"
          + "\010INTERNET\020\003\"y\n"
          + "\024ForwardingRuleTarget\022&\n"
          + "\"FORWARDING_RULE_TARGET_UNSPECIFIED\020\000\022\014\n"
          + "\010INSTANCE\020\001\022\021\n\r"
          + "LOAD_BALANCER\020\002\022\017\n"
          ...
          + "\0162B.google.cloud.networkmanagement.v1beta1.ReachabilityDetails.Result\022/\n"
          + "\013verify_time\030\002 \001(\0132\032.google.protobuf.Timestamp\022!\n"
          + "\005error\030\003 \001(\0132\022.google.rpc.Status\022=\n"
          + "\006traces\030\005 \003(\0132-.google.cloud.networkmanagement.v1beta1.Trace\"a\n"
          + "\006Result\022\026\n"
          ...
          + "loud.networkmanagement.v1beta1.LatencyPercentile\"\371\n\n"
          + "\016ProbingDetails\022T\n"
          + "\006result\030\001 "
          + "\001(\0162D.google.cloud.networkmanagement.v1beta1.ProbingDetails.ProbingResult\022/\n"
          + "\013verify_time\030\002 \001(\0132\032.google.protobuf.Timestamp\022!\n"
          + "\005error\030\003 \001(\0132\022.google.rpc.Status\022]\n"
          + "\013abort_cause\030\004 \001(\0162H.google.cloud.networ"
          + "kmanagement.v1beta1.ProbingDetails.ProbingAbortCause\022\030\n"
          + "\020sent_probe_count\030\005 \001(\005\022\036\n"
          + "\026successful_probe_count\030\006 \001(\005\022K\n\r"
          + "endpoint_info\030\007"
          + " \001(\01324.google.cloud.networkmanagement.v1beta1.EndpointInfo\022T\n"
          + "\017probing_latency\030\010"
          + " \001(\0132;.google.cloud.networkmanagement.v1beta1.LatencyDistribution\022h\n"
          + "\033destination_egress_location\030\t \001(\0132C.google."
          + "cloud.networkmanagement.v1beta1.ProbingDetails.EdgeLocation\022a\n"
          + "\016edge_responses\030\n"
          + " \003(\0132I.google.cloud.networkmanagement.v1b"
          + "eta1.ProbingDetails.SingleEdgeResponse\022\032\n"
          + "\022probed_all_devices\030\013 \001(\010\032)\n"
          + "\014EdgeLocation\022\031\n"
          + "\021metropolitan_area\030\001 \001(\t\032\200\003\n"
          + "\022SingleEdgeResponse\022T\n"
          + "\006result\030\001 \001(\0162D.google.cl"
          + "oud.networkmanagement.v1beta1.ProbingDetails.ProbingResult\022\030\n"
          + "\020sent_probe_count\030\002 \001(\005\022\036\n"
          + "\026successful_probe_count\030\003 \001(\005\022T\n"
          + "\017probing_latency\030\004 \001(\0132;.google.cloud.net"
          + "workmanagement.v1beta1.LatencyDistribution\022h\n"
          + "\033destination_egress_location\030\005 \001(\0132"
          + "C.google.cloud.networkmanagement.v1beta1.ProbingDetails.EdgeLocation\022\032\n"
          ...
          + "*com.google.cloud.networkmanagement.v1beta1B\016TestOuterClassP\001ZXc"
          + "loud.google.com/go/networkmanagement/apiv1beta1/networkmanagementpb;networkmanag"
          + "ementpb\252\002&Google.Cloud.NetworkManagement"
          + ".V1Beta1\312\002&Google\\Cloud\\NetworkManagemen"
          + "t\\V1beta1\352\002)Google::Cloud::NetworkManagement::V1beta1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_CloudFunctionEndpoint_descriptor =
        internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_descriptor.getNestedType(0);
    internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_CloudFunctionEndpoint_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_CloudFunctionEndpoint_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_AppEngineVersionEndpoint_descriptor =
        internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_descriptor.getNestedType(1);
    internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_AppEngineVersionEndpoint_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_AppEngineVersionEndpoint_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_CloudRunRevisionEndpoint_descriptor =
        internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_descriptor.getNestedType(2);
    internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_CloudRunRevisionEndpoint_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1beta1_Endpoint_CloudRunRevisionEndpoint_descriptor,
            new java.lang.String[] {
