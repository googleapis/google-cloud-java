 ...
 *
 * <p>For example, to set the total timeout of getVpcFlowLogsConfig to 30 seconds:
 *
 * <pre>{@code
      ...
      LIST_VPC_FLOW_LOGS_CONFIGS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            public Iterable<VpcFlowLogsConfig> extractResources(
              ...
              return payload.getVpcFlowLogsConfigsList() == null
                  ? ImmutableList.<VpcFlowLogsConfig>of()
                  : payload.getVpcFlowLogsConfigsList();
            }
          };
