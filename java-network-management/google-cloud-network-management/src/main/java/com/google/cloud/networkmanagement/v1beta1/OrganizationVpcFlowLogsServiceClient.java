...
import com.google.cloud.networkmanagement.v1beta1.stub.OrganizationVpcFlowLogsServiceStub;
...
/**
 * Service Description: The VPC Flow Logs organization service in the Google Cloud Network
 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the OrganizationVpcFlowLogsServiceClient object to clean
 ...
 *      <td><p> Lists all `VpcFlowLogsConfigs` in a given organization.</td>
 *      <td>
 ...
 * OrganizationVpcFlowLogsServiceSettings to create(). For example:
 *
...
public class OrganizationVpcFlowLogsServiceClient implements BackgroundResource {
  ...
  /** Constructs an instance of OrganizationVpcFlowLogsServiceClient with default settings. */
  public static final OrganizationVpcFlowLogsServiceClient create() throws IOException {
    return create(OrganizationVpcFlowLogsServiceSettings.newBuilder().build());
  }

  /**
   * Constructs an instance of OrganizationVpcFlowLogsServiceClient, using the given settings. The
   * channels are created based on the settings passed in, or defaults for any settings that are not
   * set.
   */
  public static final OrganizationVpcFlowLogsServiceClient create(
      OrganizationVpcFlowLogsServiceSettings settings) throws IOException {
    return new OrganizationVpcFlowLogsServiceClient(settings);
  }

  /**
   * Constructs an instance of OrganizationVpcFlowLogsServiceClient, using the given stub for making
   * calls. This is for advanced usage - prefer using
   * create(OrganizationVpcFlowLogsServiceSettings).
   */
  public static final OrganizationVpcFlowLogsServiceClient create(
      OrganizationVpcFlowLogsServiceStub stub) {
    return new OrganizationVpcFlowLogsServiceClient(stub);
  }

  /**
   * Constructs an instance of OrganizationVpcFlowLogsServiceClient, using the given settings. This
   * is protected so that it is easy to make a subclass, but otherwise, the static factory methods
   * should be preferred.
   */
  protected OrganizationVpcFlowLogsServiceClient(OrganizationVpcFlowLogsServiceSettings settings)
      throws IOException {
    this.settings = settings;
    this.stub =
        ((OrganizationVpcFlowLogsServiceStubSettings) settings.getStubSettings()).createStub();
    this.operationsClient =
        com.google.longrunning.OperationsClient.create(this.stub.getOperationsStub());
    this.httpJsonOperationsClient = OperationsClient.create(this.stub.getHttpJsonOperationsStub());
  }

  protected OrganizationVpcFlowLogsServiceClient(OrganizationVpcFlowLogsServiceStub stub) {
    this.settings = null;
    this.stub = stub;
    this.operationsClient =
        com.google.longrunning.OperationsClient.create(this.stub.getOperationsStub());
  ...
  public OrganizationVpcFlowLogsServiceStub getStub() {
    return stub;
  }
