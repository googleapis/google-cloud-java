...
/**
 * gRPC stub implementation for the VpcFlowLogsService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator-java")
public class GrpcVpcFlowLogsServiceStub extends VpcFlowLogsServiceStub {
  ...
  public static final GrpcVpcFlowLogsServiceStub create(VpcFlowLogsServiceStubSettings settings)
      throws IOException {
    return new GrpcVpcFlowLogsServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcVpcFlowLogsServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcVpcFlowLogsServiceStub(
        VpcFlowLogsServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcVpcFlowLogsServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcVpcFlowLogsServiceStub(
        VpcFlowLogsServiceStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcVpcFlowLogsServiceStub, using the given settings. This is
  ...
  protected GrpcVpcFlowLogsServiceStub(
    ...
    this(settings, clientContext, new GrpcVpcFlowLogsServiceCallableFactory());
  }
