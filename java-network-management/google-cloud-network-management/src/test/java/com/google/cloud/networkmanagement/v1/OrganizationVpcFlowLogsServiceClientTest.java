...
public class OrganizationVpcFlowLogsServiceClientTest {
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockOrganizationVpcFlowLogsService mockOrganizationVpcFlowLogsService;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private OrganizationVpcFlowLogsServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockOrganizationVpcFlowLogsService = new MockOrganizationVpcFlowLogsService();
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(
                mockOrganizationVpcFlowLogsService, mockLocations, mockIAMPolicy));
  ...
  public void listVpcFlowLogsConfigsTest() throws Exception {
    ...
    ListVpcFlowLogsConfigsResponse expectedResponse =
        ListVpcFlowLogsConfigsResponse.newBuilder()
            ...
            .build();
    mockOrganizationVpcFlowLogsService.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockOrganizationVpcFlowLogsService.getRequests();
  ...
  public void listVpcFlowLogsConfigsExceptionTest() throws Exception {
    ...
    mockOrganizationVpcFlowLogsService.addException(exception);
  ...
  public void createVpcFlowLogsConfigTest() throws Exception {
    ...
    Operation resultOperation =
        Operation.newBuilder()
            ...
            .build();
    mockOrganizationVpcFlowLogsService.addResponse(resultOperation);
