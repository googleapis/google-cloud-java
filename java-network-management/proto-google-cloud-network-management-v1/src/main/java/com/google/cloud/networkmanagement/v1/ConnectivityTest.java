          ...
          case 26:
            {
              ...
              source_ =
                  input.readMessage(
                      com.google.cloud.networkmanagement.v1.Endpoint.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 98:
            {
              ...
              reachabilityDetails_ =
                  input.readMessage(
                      com.google.cloud.networkmanagement.v1.ReachabilityDetails.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.networkmanagement.v1.ConnectivityTest) e.getUnfinishedMessage();
    ...
    public Builder mergeSource(com.google.cloud.networkmanagement.v1.Endpoint value) {
      if (sourceBuilder_ == null) {
        if (source_ != null) {
          source_ =
              com.google.cloud.networkmanagement.v1.Endpoint.newBuilder(source_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          source_ = value;
    ...
    public Builder mergeDestination(com.google.cloud.networkmanagement.v1.Endpoint value) {
      if (destinationBuilder_ == null) {
        if (destination_ != null) {
          destination_ =
              com.google.cloud.networkmanagement.v1.Endpoint.newBuilder(destination_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          destination_ = value;
    ...
    public Builder mergeReachabilityDetails(
      ...
      if (reachabilityDetailsBuilder_ == null) {
        if (reachabilityDetails_ != null) {
          reachabilityDetails_ =
              com.google.cloud.networkmanagement.v1.ReachabilityDetails.newBuilder(
                      reachabilityDetails_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
