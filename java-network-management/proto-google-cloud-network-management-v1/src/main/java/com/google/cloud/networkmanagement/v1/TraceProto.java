...
public final class TraceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "-google/cloud/networkmanagement/v1/trace.proto\022!google.cloud.networkmanagement."
          + "v1\032\037google/api/field_behavior.proto\032\033google/api/field_info.proto\"\241\001\n"
          + "\005Trace\022F\n\r"
          ...
          + "\020forward_trace_id\030\004 \001(\005\"\353#\n"
          + "\004Step\022\023\n"
          ...
          + "\010endpoint\030\010"
          + " \001(\0132/.google.cloud.networkmanagement.v1.EndpointInfoH\000\022N\n"
          ...
          + "google.cloud.networkmanagement.v1.GKEMasterInfoH\000\022@\n"
          ...
          + "cloud_run_job\030- "
          + "\001(\01322.google.cloud.networkmanagement.v1.CloudRunJobInfoH\000\0229\n"
          + "\003nat\030\031 \001(\0132*.google.cloud.networkmanagement.v1.NatInfoH\000\022R\n"
          + "\020proxy_connection\030\032 \001(\01326.google.cloud.ne"
          + "tworkmanagement.v1.ProxyConnectionInfoH\000\022`\n"
          + "\032load_balancer_backend_info\030\033 \001(\0132:.g"
          + "oogle.cloud.networkmanagement.v1.LoadBalancerBackendInfoH\000\022N\n"
          + "\016storage_bucket\030\034 \001"
          + "(\01324.google.cloud.networkmanagement.v1.StorageBucketInfoH\000\022N\n"
          + "\016serverless_neg\030\035 \001"
          + "(\01324.google.cloud.networkmanagement.v1.ServerlessNegInfoH\000\022]\n"
          + "\026ngfw_packet_inspection\030*"
          + " \001(\0132;.google.cloud.networkmanagement.v1.NgfwPacketInspectionInfoH\000\022Z\n"
          + "\026dms_private_connection\030+ \001(\01328.google.cloud"
          + ".networkmanagement.v1.PrivateConnectionInfoH\000\"\365\n\n"
          + "\005State\022\025\n"
          ...
          + "\006status\030\013 \001(\01626.g"
          + "oogle.cloud.networkmanagement.v1.InstanceInfo.Status\">\n"
          + "\006Status\022\026\n"
          ...
          + " \001(\0162:.google.cloud.networkmanagement.v1.FirewallInfo.TargetType\"\274\003\n"
          ...
          + "next_hop_type\030\t"
          + " \001(\01628.google.cloud.networkmanagement.v1.RouteInfo.NextHopType\022P\n"
          + "\013route_scope\030\016"
          + " \001(\01627.google.cloud.networkmanagement.v1.RouteInfo.RouteScopeB\002\030\001\022\024\n"
          + "\014display_name\030\001 \001(\t\022\013\n"
          ...
          + "\023google_service_type\030\002 \001(\0162F.google.cloud.networkmanage"
          + "ment.v1.GoogleServiceInfo.GoogleServiceType\"\314\001\n"
          ...
          + "\022load_balancer_type\030\001 \001(\0162D.google.cloud.networkmanag"
          + "ement.v1.LoadBalancerInfo.LoadBalancerType\022\034\n"
          ...
          + "2O.google.cloud.networkmanagement.v1.Loa"
          + "dBalancerBackend.HealthCheckFirewallState\022,\n"
          ...
          + "\014routing_type\030\t \001(\0162<.google.cloud.net"
          + "workmanagement.v1.VpnTunnelInfo.RoutingType\"[\n"
          ...
          + "\020source_agent_uri\030\010 \001(\t\"\203\007\n"
          + "\013DeliverInfo\022E\n"
          + "\006target\030\001 \001(\01625.google.clou"
          + "d.networkmanagement.v1.DeliverInfo.Target\022\024\n"
          ...
          + "\023google_service_type\030\006 \001(\0162@.google.cloud.network"
          + "management.v1.DeliverInfo.GoogleServiceType\"\263\003\n"
          + "\006Target\022\026\n"
          ...
          + "\01622.google.cloud.networkmanagement.v1.AbortInfo.Cause\022\024\n"
          + "\014resource_uri\030\002 \001(\t\022\034\n\n"
          ...
          + "!GKE_POD_UNKNOWN_ENDPOINT_LOCATION\020)\"\245#\n"
          + "\010DropInfo\022@\n"
          + "\005cause\030\001 \001(\01621.googl"
          + "e.cloud.networkmanagement.v1.DropInfo.Cause\022\024\n"
      ...
      "PSC_ENDPOINT_ACCESSED_FROM_PEERED_NETWORK\020)\022.\n"
          ...
          + "\006reason\030\001 \001(\0162C.google.cloud."
          + "networkmanagement.v1.IpMasqueradingSkippedInfo.Reason\022\034\n"
          ...
          + "\006reason\030\001 \001(\0162E.google.cloud.networkmanagem"
          + "ent.v1.GkeNetworkPolicySkippedInfo.Reason\"\347\001\n"
          + "\006Reason\022\026\n"
          ...
          + "\tB\010\342\214\317\327\010\002\010\004\"\221\006\n"
          + "\007NatInfo\022=\n"
          ...
          + "2>.google.cloud.networkmanagement.v1.NatInfo.CloudNatGatewayType\"\231\001\n"
          + "\004Type\022\024\n"
          ...
          + "\001(\0162Z.google.cloud.networkmanagement.v1."
          + "LoadBalancerBackendInfo.HealthCheckFirewallsConfigStateB\003\340A\003\"\315\001\n"
          ...
          + "TraceProtoP\001ZScloud.google.com/go/networkmanagement/ap"
          + "iv1/networkmanagementpb;networkmanagemen"
          + "tpb\252\002!Google.Cloud.NetworkManagement.V1\312"
          + "\002!Google\\Cloud\\NetworkManagement\\V1\352\002$Go"
          + "ogle::Cloud::NetworkManagement::V1b\006proto3"
    };
    descriptor =
