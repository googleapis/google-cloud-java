...
public final class TestOuterClass extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "9google/cloud/networkmanagement/v1/connectivity_test.proto\022!google.cloud.networ"
          ...
          + "o\032\037google/protobuf/timestamp.proto\032\027google/rpc/status.proto\"\256\007\n"
          + "\020ConnectivityTest\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022\023\n"
          + "\013description\030\002 \001(\t\022@\n"
          + "\006source\030\003"
          + " \001(\0132+.google.cloud.networkmanagement.v1.EndpointB\003\340A\002\022E\n"
          + "\013destination\030\004"
          + " \001(\0132+.google.cloud.networkmanagement.v1.EndpointB\003\340A\002\022\020\n"
          ...
          + "networkmanagement.v1.ConnectivityTest.LabelsEntry\0224\n"
          + "\013create_time\030\n"
          ...
          + "ud.networkmanagement.v1.ReachabilityDetailsB\003\340A\003\022O\n"
          + "\017probing_details\030\016 \001(\01321.goog"
          + "le.cloud.networkmanagement.v1.ProbingDetailsB\003\340A\003\022\022\n\n"
          + "round_trip\030\017 \001(\010\022`\n"
          + "\033return_reachability_details\030\020 \001(\01326.google.clou"
          + "d.networkmanagement.v1.ReachabilityDetailsB\003\340A\003\022\036\n"
          + "\026bypass_firewall_checks\030\021 \001(\010\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:t\352Aq\n"
          + "1networkmanagement.googleapis.com/ConnectivityTest\022<projects/{projec"
          + "t}/locations/global/connectivityTests/{test}\"\247\n\n"
          + "\010Endpoint\022\022\n\n"
          ...
          + " \001(\t\022j\n"
          + "\026forwarding_rule_target\030\016 \001(\0162@.google.cloud.networkmanagement."
          + "v1.Endpoint.ForwardingRuleTargetB\003\340A\003H\000\210\001\001\022\"\n"
          + "\020load_balancer_id\030\017 \001(\tB\003\340A\003H\001\210\001\001\022Y\n"
          + "\022load_balancer_type\030\020 \001(\01623.google.clou"
          + "d.networkmanagement.v1.LoadBalancerTypeB\003\340A\003H\002\210\001\001\022\032\n"
          ...
          + "\007gke_pod\030\025 \001(\t\022Y\n"
          + "\016cloud_function\030\n"
          + " \001(\0132A.google.cloud.networkmanagement.v1.Endpoint.CloudFunctionEndpoint\022`\n"
          + "\022app_engine_version\030\013 \001(\0132D.google.cloud.ne"
          + "tworkmanagement.v1.Endpoint.AppEngineVersionEndpoint\022`\n"
          + "\022cloud_run_revision\030\014 \001(\013"
          + "2D.google.cloud.networkmanagement.v1.Endpoint.CloudRunRevisionEndpoint\022\025\n\r"
          + "cloud_run_job\030\030 \001(\t\022\017\n"
          + "\007network\030\004 \001(\t\022M\n"
          + "\014network_type\030\005"
          + " \001(\01627.google.cloud.networkmanagement.v1.Endpoint.NetworkType\022\022\n\n"
          ...
          + "\006result\030\001"
          + " \001(\0162=.google.cloud.networkmanagement.v1.ReachabilityDetails.Result\022/\n"
          ...
          + "\023latency_percentiles\030\001 \003(\01324.google.cloud."
          + "networkmanagement.v1.LatencyPercentile\"\314\n\n"
          + "\016ProbingDetails\022O\n"
          + "\006result\030\001 \001(\0162?.goog"
          + "le.cloud.networkmanagement.v1.ProbingDetails.ProbingResult\022/\n"
          + "\013verify_time\030\002 \001(\0132\032.google.protobuf.Timestamp\022!\n"
          + "\005error\030\003 \001(\0132\022.google.rpc.Status\022X\n"
          + "\013abort_cause\030\004 "
          + "\001(\0162C.google.cloud.networkmanagement.v1.ProbingDetails.ProbingAbortCause\022\030\n"
          + "\020sent_probe_count\030\005 \001(\005\022\036\n"
          + "\026successful_probe_count\030\006 \001(\005\022F\n\r"
          + "endpoint_info\030\007 \001(\0132/.goog"
          + "le.cloud.networkmanagement.v1.EndpointInfo\022O\n"
          + "\017probing_latency\030\010 \001(\01326.google.clo"
          + "ud.networkmanagement.v1.LatencyDistribution\022c\n"
          + "\033destination_egress_location\030\t \001(\013"
          + "2>.google.cloud.networkmanagement.v1.ProbingDetails.EdgeLocation\022\\\n"
          + "\016edge_responses\030\n"
          + " \003(\0132D.google.cloud.networkmanagemen"
          + "t.v1.ProbingDetails.SingleEdgeResponse\022\032\n"
          ...
          + "\006result\030\001 \001(\0162?.google.cl"
          + "oud.networkmanagement.v1.ProbingDetails.ProbingResult\022\030\n"
          ...
          + "\033destination_egress_location\030\005 \001(\0132>.google.c"
          + "loud.networkmanagement.v1.ProbingDetails.EdgeLocation\022\032\n"
          ...
          + "%com.google.cloud.networkmanagement.v1B\016TestOuterClassP\001ZScloud.google.com/go/n"
          + "etworkmanagement/apiv1/networkmanagementpb;networkmanagementpb\252\002!Google.Cloud.Ne"
          + "tworkManagement.V1\312\002!Google\\Cloud\\Networ"
          + "kManagement\\V1\352\002$Google::Cloud::NetworkManagement::V1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_networkmanagement_v1_ConnectivityTest_LabelsEntry_descriptor =
        internal_static_google_cloud_networkmanagement_v1_ConnectivityTest_descriptor.getNestedType(
            0);
    internal_static_google_cloud_networkmanagement_v1_ConnectivityTest_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1_ConnectivityTest_LabelsEntry_descriptor,
    ...
    internal_static_google_cloud_networkmanagement_v1_Endpoint_CloudFunctionEndpoint_descriptor =
        internal_static_google_cloud_networkmanagement_v1_Endpoint_descriptor.getNestedType(0);
    internal_static_google_cloud_networkmanagement_v1_Endpoint_CloudFunctionEndpoint_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1_Endpoint_CloudFunctionEndpoint_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_networkmanagement_v1_Endpoint_AppEngineVersionEndpoint_descriptor =
        internal_static_google_cloud_networkmanagement_v1_Endpoint_descriptor.getNestedType(1);
    internal_static_google_cloud_networkmanagement_v1_Endpoint_AppEngineVersionEndpoint_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1_Endpoint_AppEngineVersionEndpoint_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_networkmanagement_v1_Endpoint_CloudRunRevisionEndpoint_descriptor =
        internal_static_google_cloud_networkmanagement_v1_Endpoint_descriptor.getNestedType(2);
    internal_static_google_cloud_networkmanagement_v1_Endpoint_CloudRunRevisionEndpoint_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1_Endpoint_CloudRunRevisionEndpoint_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_networkmanagement_v1_ProbingDetails_EdgeLocation_descriptor =
        internal_static_google_cloud_networkmanagement_v1_ProbingDetails_descriptor.getNestedType(
            0);
    internal_static_google_cloud_networkmanagement_v1_ProbingDetails_EdgeLocation_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_networkmanagement_v1_ProbingDetails_EdgeLocation_descriptor,
