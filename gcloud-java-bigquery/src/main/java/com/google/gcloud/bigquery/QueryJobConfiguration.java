...
public final class QueryJobConfiguration extends JobConfiguration {
  ...
  private final Map<String, ExternalTableType> tableDefinitions;
  ...
  public static final class Builder
    ...
    private Map<String, ExternalTableType> tableDefinitions;
     ...
     */
    public Builder tableDefinitions(Map<String, ExternalTableType> tableDefinitions) {
   ...
   * standard BigQuery tables.
   */
  public Map<String, ExternalTableType> tableDefinitions() {
