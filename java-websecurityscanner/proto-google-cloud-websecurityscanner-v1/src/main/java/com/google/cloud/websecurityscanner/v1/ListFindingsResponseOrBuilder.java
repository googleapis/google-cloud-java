...
public interface ListFindingsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.websecurityscanner.v1.Finding> getFindingsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.websecurityscanner.v1.Finding findings = 1;</code>
   */
  com.google.cloud.websecurityscanner.v1.FindingOrBuilder getFindingsOrBuilder(int index);
