...
public final class ScanConfigProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "4google/cloud/websecurityscanner/v1/scan_config.proto\022\"google.cloud.websecurity"
          + "scanner.v1\032\037google/api/field_behavior.proto\032\037google/protobuf/timestamp.proto\"\304\r\n"
          + "\n"
          + "ScanConfig\022\014\n"
          + "\004name\030\001 \001(\t\022\024\n"
          + "\014display_name\030\002 \001(\t\022\017\n"
          + "\007max_qps\030\003 \001(\005\022\025\n\r"
          + "starting_urls\030\004 \003(\t\022U\n"
          + "\016authentication\030\005 \001(\0132=.google"
          + ".cloud.websecurityscanner.v1.ScanConfig.Authentication\022L\n\n"
          + "user_agent\030\006 \001(\01628.goo"
          + "gle.cloud.websecurityscanner.v1.ScanConfig.UserAgent\022\032\n"
          + "\022blacklist_patterns\030\007 \003(\t\022I\n"
          + "\010schedule\030\010"
          + " \001(\01327.google.cloud.websecurityscanner.v1.ScanConfig.Schedule\022w\n"
          + "!export_to_security_command_center\030\n"
          + " \001(\0162L"
          + ".google.cloud.websecurityscanner.v1.ScanConfig.ExportToSecurityCommandCenter\022L\n\n"
          + "risk_level\030\014"
          + " \001(\01628.google.cloud.websecurityscanner.v1.ScanConfig.RiskLevel\022\024\n"
          + "\014managed_scan\030\r"
          + " \001(\010\022\026\n"
          + "\016static_ip_scan\030\016 \001(\010\022!\n"
          + "\031ignore_http_status_errors\030\017 \001(\010\032\327\005\n"
          + "\016Authentication\022i\n"
          + "\016google_account\030\001 \001(\0132K.google.cloud.websecurityscanner.v1.Scan"
          + "Config.Authentication.GoogleAccountB\002\030\001H\000\022e\n"
          + "\016custom_account\030\002 \001(\0132K.google.cloud"
          + ".websecurityscanner.v1.ScanConfig.Authentication.CustomAccountH\000\022e\n"
          + "\016iap_credential\030\004 \001(\0132K.google.cloud.websecurityscann"
          + "er.v1.ScanConfig.Authentication.IapCredentialH\000\0327\n\r"
          + "GoogleAccount\022\020\n"
          + "\010username\030\001 \001(\t\022\020\n"
          + "\010password\030\002 \001(\t:\002\030\001\032F\n\r"
          + "CustomAccount\022\020\n"
          + "\010username\030\001 \001(\t\022\020\n"
          + "\010password\030\002 \001(\t\022\021\n"
          + "\tlogin_url\030\003 \001(\t\032\370\001\n\r"
          + "IapCredential\022\216\001\n"
          + "\035iap_test_service_account_info\030\001 \001(\0132e.goo"
          + "gle.cloud.websecurityscanner.v1.ScanConf"
          + "ig.Authentication.IapCredential.IapTestServiceAccountInfoH\000\032C\n"
          + "\031IapTestServiceAccountInfo\022&\n"
          + "\031target_audience_client_id\030\001 \001(\tB\003\340A\002B\021\n"
          + "\017iap_credentialsB\020\n"
          + "\016authentication\032]\n"
          + "\010Schedule\0221\n\r"
          + "schedule_time\030\001 \001(\0132\032.google.protobuf.Timestamp\022\036\n"
          + "\026interval_duration_days\030\002 \001(\005\"`\n"
          + "\tUserAgent\022\032\n"
          + "\026USER_AGENT_UNSPECIFIED\020\000\022\020\n"
          + "\014CHROME_LINUX\020\001\022\022\n"
          + "\016CHROME_ANDROID\020\002\022\021\n\r"
          + "SAFARI_IPHONE\020\003\"<\n"
          + "\tRiskLevel\022\032\n"
          ...
          + "&com.google.cloud.websecurityscanner.v1B\017ScanConfigProtoP\001ZVcloud"
          + ".google.com/go/websecurityscanner/apiv1/websecurityscannerpb;websecurityscannerp"
          + "b\252\002\"Google.Cloud.WebSecurityScanner.V1\312\002"
          + "\"Google\\Cloud\\WebSecurityScanner\\V1\352\002%Go"
          + "ogle::Cloud::WebSecurityScanner::V1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_websecurityscanner_v1_ScanConfig_Authentication_descriptor =
        internal_static_google_cloud_websecurityscanner_v1_ScanConfig_descriptor.getNestedType(0);
    internal_static_google_cloud_websecurityscanner_v1_ScanConfig_Authentication_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_websecurityscanner_v1_ScanConfig_Authentication_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_websecurityscanner_v1_ScanConfig_Schedule_descriptor =
        internal_static_google_cloud_websecurityscanner_v1_ScanConfig_descriptor.getNestedType(1);
    internal_static_google_cloud_websecurityscanner_v1_ScanConfig_Schedule_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_websecurityscanner_v1_ScanConfig_Schedule_descriptor,
            new java.lang.String[] {
