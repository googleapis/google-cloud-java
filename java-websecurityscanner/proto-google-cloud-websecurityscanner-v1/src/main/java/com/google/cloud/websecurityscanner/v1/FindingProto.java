...
public final class FindingProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "0google/cloud/websecurityscanner/v1/finding.proto\022\"google.cloud.websecurityscan"
          + "ner.v1\032\037google/api/field_behavior.proto\032"
          + "\031google/api/resource.proto\0326google/cloud"
          + "/websecurityscanner/v1/finding_addon.proto\"\354\007\n"
          + "\007Finding\022\014\n"
          + "\004name\030\001 \001(\t\022\024\n"
          + "\014finding_type\030\002 \001(\t\022K\n"
          + "\010severity\030\021 \001(\01624.google.cl"
          + "oud.websecurityscanner.v1.Finding.SeverityB\003\340A\003\022\023\n"
          ...
          + "\013tracking_id\030\n"
          + " \001(\t\0226\n"
          + "\004form\030\020 \001(\0132(.google.cloud.websecurityscanner.v1.Form\022M\n"
          + "\020outdated_library\030\013"
          + " \001(\01323.google.cloud.websecurityscanner.v1.OutdatedLibrary\022Q\n"
          + "\022violating_resource\030\014"
          + " \001(\01325.google.cloud.websecurityscanner.v1.ViolatingResource\022Q\n"
          + "\022vulnerable_headers\030\017"
          + " \001(\01325.google.cloud.websecurityscanner.v1.VulnerableHeaders\022W\n"
          + "\025vulnerable_parameters\030\r"
          + " \001(\01328.google.cloud.websecurityscanner.v1.VulnerableParameters\0224\n"
          + "\003xss\030\016 \001(\0132\'.google.cloud.websecurityscanner.v1.Xss\0229\n"
          ...
          + ")websecurityscanner.googleapis.com/Finding\022Sprojects/{project}/scanConfigs/{sc"
          + "an_config}/scanRuns/{scan_run}/findings/{finding}B\202\002\n"
          + "&com.google.cloud.websecurityscanner.v1B\014FindingProtoP\001ZVcloud.goog"
