...
public interface ScanConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.websecurityscanner.v1beta.ScanConfig)
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.Authentication getAuthentication();
  /**
   *
   *
   * <pre>
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.UserAgent getUserAgent();
   ...
   * @return The schedule.
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.Schedule getSchedule();
  /**
   *
   *
   * <pre>
   ...
   * <code>.google.cloud.websecurityscanner.v1beta.ScanConfig.Schedule schedule = 8;</code>
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.ScheduleOrBuilder getScheduleOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.websecurityscanner.v1beta.ScanConfig.TargetPlatform>
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.TargetPlatform getTargetPlatforms(
      int index);
  /**
   *
   *
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanRun getLatestRun();
  /**
   *
   *
   * <pre>
   ...
   * <code>.google.cloud.websecurityscanner.v1beta.ScanRun latest_run = 11;</code>
   */
  com.google.cloud.websecurityscanner.v1beta.ScanRunOrBuilder getLatestRunOrBuilder();
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.RiskLevel getRiskLevel();
}
