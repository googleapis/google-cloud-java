...
public interface ListControlsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.auditmanager.v1.ListControlsResponse)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.auditmanager.v1.Control> getControlsList();
   ...
   * </code>
   */
  com.google.cloud.auditmanager.v1.Control getControls(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.auditmanager.v1.ControlOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.auditmanager.v1.ControlOrBuilder getControlsOrBuilder(int index);
