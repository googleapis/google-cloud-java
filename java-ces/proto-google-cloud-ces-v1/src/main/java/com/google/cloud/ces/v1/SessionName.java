...
public class SessionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_SESSION =
  ...
  public static SessionName of(String project, String location, String app, String session) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String session) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static SessionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_SESSION.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_SESSION.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_SESSION.instantiate(
        "project", project, "location", location, "app", app, "session", session);
  }
