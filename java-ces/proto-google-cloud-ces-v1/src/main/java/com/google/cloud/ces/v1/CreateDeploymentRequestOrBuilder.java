...
public interface CreateDeploymentRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1.CreateDeploymentRequest)
   ...
   * </pre>
   *
   * <code>string deployment_id = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   ...
   * </pre>
   *
   * <code>.google.cloud.ces.v1.Deployment deployment = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.ces.v1.Deployment getDeployment();
   ...
   * </code>
   */
  com.google.cloud.ces.v1.DeploymentOrBuilder getDeploymentOrBuilder();
}
