...
public interface SpanOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1.Span)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.ces.v1.Span> getChildSpansList();
   ...
   * </code>
   */
  com.google.cloud.ces.v1.Span getChildSpans(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.ces.v1.SpanOrBuilder> getChildSpansOrBuilderList();
   ...
   * </code>
   */
  com.google.cloud.ces.v1.SpanOrBuilder getChildSpansOrBuilder(int index);
}
