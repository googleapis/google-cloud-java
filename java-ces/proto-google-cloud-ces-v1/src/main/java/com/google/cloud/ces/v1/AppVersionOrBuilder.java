...
public interface AppVersionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1.AppVersion)
   ...
   * @return The snapshot.
   */
  com.google.cloud.ces.v1.AppSnapshot getSnapshot();
