...
public abstract class WidgetServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<GenerateChatTokenRequest, GenerateChatTokenResponse>
      generateChatTokenCallable() {
    throw new UnsupportedOperationException("Not implemented: generateChatTokenCallable()");
  }
