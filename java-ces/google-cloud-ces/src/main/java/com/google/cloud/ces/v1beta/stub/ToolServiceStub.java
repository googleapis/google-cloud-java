...
/**
 * Base stub class for the ToolService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@BetaApi
@Generated("by gapic-generator-java")
public abstract class ToolServiceStub implements BackgroundResource {

  public UnaryCallable<ExecuteToolRequest, ExecuteToolResponse> executeToolCallable() {
    throw new UnsupportedOperationException("Not implemented: executeToolCallable()");
  }

  public UnaryCallable<RetrieveToolSchemaRequest, RetrieveToolSchemaResponse>
      retrieveToolSchemaCallable() {
    throw new UnsupportedOperationException("Not implemented: retrieveToolSchemaCallable()");
  }

  public UnaryCallable<RetrieveToolsRequest, RetrieveToolsResponse> retrieveToolsCallable() {
    throw new UnsupportedOperationException("Not implemented: retrieveToolsCallable()");
  }
