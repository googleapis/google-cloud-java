...
public class WidgetServiceClientTest {
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private static MockWidgetService mockWidgetService;
  private LocalChannelProvider channelProvider;
  private WidgetServiceClient client;
  ...
  public static void startStaticServer() {
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(mockWidgetService, mockLocations));
  ...
  public void generateChatTokenTest() throws Exception {
    GenerateChatTokenResponse expectedResponse =
        GenerateChatTokenResponse.newBuilder()
            ...
            .build();
    mockWidgetService.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockWidgetService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GenerateChatTokenRequest actualRequest = ((GenerateChatTokenRequest) actualRequests.get(0));
  ...
  public void generateChatTokenExceptionTest() throws Exception {
    ...
    mockWidgetService.addException(exception);
