...
import com.google.cloud.ces.v1.stub.HttpJsonSessionServiceStub;
...
public class SessionServiceClientHttpJsonTest {
        ...
        RunSessionRequest.newBuilder()
            .setConfig(
                SessionConfig.newBuilder()
                    .setSession(
                        SessionName.of("[PROJECT]", "[LOCATION]", "[APP]", "[SESSION]").toString())
                    .setInputAudioConfig(InputAudioConfig.newBuilder().build())
                    .setOutputAudioConfig(OutputAudioConfig.newBuilder().build())
                    .addAllHistoricalContexts(new ArrayList<Message>())
                    .setEntryAgent(
      ...
      RunSessionRequest request =
          RunSessionRequest.newBuilder()
              .setConfig(
                  SessionConfig.newBuilder()
                      .setSession(
                          SessionName.of("[PROJECT]", "[LOCATION]", "[APP]", "[SESSION]")
                              .toString())
                      .setInputAudioConfig(InputAudioConfig.newBuilder().build())
                      .setOutputAudioConfig(OutputAudioConfig.newBuilder().build())
                      .addAllHistoricalContexts(new ArrayList<Message>())
  ...
  @Test
  public void bidiRunSessionUnsupportedMethodTest() throws Exception {
    // The bidiRunSession() method is not supported in REST transport.
