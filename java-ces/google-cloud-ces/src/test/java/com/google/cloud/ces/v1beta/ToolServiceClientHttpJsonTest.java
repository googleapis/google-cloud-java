...
import com.google.cloud.ces.v1beta.stub.HttpJsonToolServiceStub;
...
public class ToolServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static ToolServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonToolServiceStub.getMethodDescriptors(),
            ToolServiceSettings.getDefaultEndpoint());
    ToolServiceSettings settings =
        ToolServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                ToolServiceSettings.defaultHttpJsonTransportProviderBuilder()
