...
public class AsyncStreamRunSession {

  public static void main(String[] args) throws Exception {
    asyncStreamRunSession();
  }

  public static void asyncStreamRunSession() throws Exception {
    ...
    try (SessionServiceClient sessionServiceClient = SessionServiceClient.create()) {
      RunSessionRequest request =
          RunSessionRequest.newBuilder()
              ...
              .build();
      ServerStream<RunSessionResponse> stream =
