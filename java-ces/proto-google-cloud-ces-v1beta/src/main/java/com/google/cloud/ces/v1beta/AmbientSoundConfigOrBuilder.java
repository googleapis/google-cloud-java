...
public interface AmbientSoundConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.AmbientSoundConfig)
   ...
   *
   * <code>
   * .google.cloud.ces.v1beta.AmbientSoundConfig.PrebuiltAmbientNoise prebuilt_ambient_noise = 1 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   * @deprecated google.cloud.ces.v1beta.AmbientSoundConfig.prebuilt_ambient_noise is deprecated.
   *     See google/cloud/ces/v1beta/app.proto;l=313
   ...
   */
  @java.lang.Deprecated
  com.google.cloud.ces.v1beta.AmbientSoundConfig.PrebuiltAmbientNoise getPrebuiltAmbientNoise();
  ...
  com.google.cloud.ces.v1beta.AmbientSoundConfig.SourceCase getSourceCase();
}
