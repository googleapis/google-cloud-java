...
public interface ConnectorToolOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.ConnectorTool)
   ...
   * </pre>
   *
   * <code>.google.cloud.ces.v1beta.Action action = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   * @return The action.
   */
  com.google.cloud.ces.v1beta.Action getAction();
   ...
   * </code>
   */
  com.google.cloud.ces.v1beta.ActionOrBuilder getActionOrBuilder();
   ...
   *
   * <code>
   * .google.cloud.ces.v1beta.EndUserAuthConfig auth_config = 3 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
