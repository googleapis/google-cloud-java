...
public interface UpdateToolRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.UpdateToolRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.ces.v1beta.Tool tool = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   *
