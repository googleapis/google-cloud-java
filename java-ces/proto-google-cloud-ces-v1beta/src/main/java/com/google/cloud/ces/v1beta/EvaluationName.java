...
public class EvaluationName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_EVALUATION =
  ...
  public static EvaluationName of(String project, String location, String app, String evaluation) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String evaluation) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static EvaluationName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_EVALUATION.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_EVALUATION.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_EVALUATION.instantiate(
        "project", project, "location", location, "app", app, "evaluation", evaluation);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/apps/{app}/evaluations/{evaluation}. */
