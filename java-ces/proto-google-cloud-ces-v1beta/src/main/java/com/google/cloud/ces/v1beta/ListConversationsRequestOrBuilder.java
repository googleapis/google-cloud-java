...
public interface ListConversationsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.ListConversationsRequest)
   ...
   */
  java.util.List<com.google.cloud.ces.v1beta.Conversation.Source> getSourcesList();
   ...
   */
  com.google.cloud.ces.v1beta.Conversation.Source getSources(int index);
