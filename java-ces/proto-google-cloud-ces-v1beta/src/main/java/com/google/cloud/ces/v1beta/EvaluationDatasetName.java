...
public class EvaluationDatasetName implements ResourceName {
  ...
  public static @Nullable EvaluationDatasetName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable EvaluationDatasetName> values) {
