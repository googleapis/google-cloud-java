...
public interface CreateAgentRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.CreateAgentRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.ces.v1beta.Agent agent = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
