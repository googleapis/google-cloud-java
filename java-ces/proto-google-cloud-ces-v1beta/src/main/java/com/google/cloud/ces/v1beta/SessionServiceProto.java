  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "v1beta/search_suggestions.proto\032\031google/"
          + "protobuf/any.proto\032\034google/protobuf/struct.proto\"\246\002\n\n"
          + "MockConfig\022G\n"
          + "\021mocked_tool_calls\030\001"
          + " \003(\0132\'.google.cloud.ces.v1beta.MockedToolCallB\003\340A\001\022h\n"
          + "\034unmatched_tool_call_behavior\030\002 \001(\0162=.google.cloud.ces.v1beta"
          + ".MockConfig.UnmatchedToolCallBehaviorB\003\340A\002\"e\n"
          ...
          + "\"remote_dialogflow_query_parameters\030\017 \001(\0132F.google.cloud.ces.v1b"
          + "eta.SessionConfig.RemoteDialogflowQueryParametersB\003\340A\001\022\"\n"
          + "\025enable_text_streaming\030\022 \001(\010B\003\340A\001\032\272\002\n"
          + "\037RemoteDialogflowQueryParameters\022x\n"
          + "\017webhook_headers\030\001 \003(\0132Z.google.cloud.ces.v1beta.SessionConfig.RemoteDi"
          + "alogflowQueryParameters.WebhookHeadersEntryB\003\340A\001\022-\n"
          ...
          + "ToolResponses\022B\n"
          + "\016tool_responses\030\001 \003("
          + "\0132%.google.cloud.ces.v1beta.ToolResponseB\003\340A\001\"\246\001\n"
          + "\tCitations\022C\n"
          + "\014cited_chunks\030\001 \003("
          + "\0132-.google.cloud.ces.v1beta.Citations.CitedChunk\032T\n\n"
          + "CitedChunk\022\013\n"
          ...
          + "\017diagnostic_info\030\007 \001(\01325.goo"
          + "gle.cloud.ces.v1beta.SessionOutput.DiagnosticInfoB\003\340A\001\032v\n"
          ...
          + "\016session_output\030\001 \001(\013"
          + "2&.google.cloud.ces.v1beta.SessionOutputB\003\340A\001H\000\022M\n"
          + "\022recognition_result\030\002 \001(\0132*.go"
          + "ogle.cloud.ces.v1beta.RecognitionResultB\003\340A\001H\000\022O\n"
          + "\023interruption_signal\030\003 \001(\0132+.go"
          + "ogle.cloud.ces.v1beta.InterruptionSignalB\003\340A\001H\000\022?\n"
          ...
          + "RunSession\022*.google.cloud.ces.v1beta.RunSessionRequest\032+.google.clo"
          + "ud.ces.v1beta.RunSessionResponse\"W\202\323\344\223\002Q"
          + "\"L/v1beta/{config.session=projects/*/loc"
          + "ations/*/apps/*/sessions/*}:runSession:\001*\022\314\001\n"
          + "\020StreamRunSession\022*.google.cloud.ces.v1beta.RunSessionRequest\032+.google.clou"
          + "d.ces.v1beta.RunSessionResponse\"]\202\323\344\223\002W\""
          + "R/v1beta/{config.session=projects/*/loca"
          + "tions/*/apps/*/sessions/*}:streamRunSession:\001*0\001\022|\n"
          + "\016BidiRunSession\0221.google.cloud.ces.v1beta.BidiSessionClientMessage\0321."
          + "google.cloud.ces.v1beta.BidiSessionServe"
          + "rMessage\"\000(\0010\001\032j\312A\022ces.googleapis.com\322AR"
          + "https://www.googleapis.com/auth/ces,http"
          + "s://www.googleapis.com/auth/cloud-platformB\311\001\n"
          + "\033com.google.cloud.ces.v1betaB\023Sess"
          + "ionServiceProtoP\001Z-cloud.google.com/go/ces/apiv1beta/cespb;cespb\352Ac\n"
          + "\032ces.googleapis.com/Session\022Eprojects/{project}/loca"
          + "tions/{location}/apps/{app}/sessions/{session}b\006proto3"
    };
    descriptor =
