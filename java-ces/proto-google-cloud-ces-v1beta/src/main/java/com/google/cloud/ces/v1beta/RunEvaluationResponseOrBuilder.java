...
public interface RunEvaluationResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.RunEvaluationResponse)
   ...
   * </pre>
   *
   * <code>string evaluation_run = 1 [(.google.api.resource_reference) = { ... }</code>
   *
