...
public class ConversationName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_CONVERSATION =
  ...
  public static ConversationName of(
      String project, String location, String app, String conversation) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String conversation) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static @Nullable ConversationName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_CONVERSATION.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable ConversationName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_CONVERSATION.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_CONVERSATION.instantiate(
        "project", project, "location", location, "app", app, "conversation", conversation);
  }
