...
public class ExampleName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_EXAMPLE =
  ...
  public static ExampleName of(String project, String location, String app, String example) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String example) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static ExampleName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_EXAMPLE.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_EXAMPLE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_EXAMPLE.instantiate(
        "project", project, "location", location, "app", app, "example", example);
  }
