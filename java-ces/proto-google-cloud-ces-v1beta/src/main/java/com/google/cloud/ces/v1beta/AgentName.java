...
public class AgentName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_AGENT =
  ...
  public static AgentName of(String project, String location, String app, String agent) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String agent) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static AgentName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_AGENT.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_AGENT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_AGENT.instantiate(
        "project", project, "location", location, "app", app, "agent", agent);
  }
