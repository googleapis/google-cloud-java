...
public interface UpdateSecuritySettingsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.UpdateSecuritySettingsRequest)
   ...
   *
   * <code>
   * .google.cloud.ces.v1beta.SecuritySettings security_settings = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.ces.v1beta.SecuritySettings getSecuritySettings();
   ...
   * </code>
   */
  com.google.cloud.ces.v1beta.SecuritySettingsOrBuilder getSecuritySettingsOrBuilder();
