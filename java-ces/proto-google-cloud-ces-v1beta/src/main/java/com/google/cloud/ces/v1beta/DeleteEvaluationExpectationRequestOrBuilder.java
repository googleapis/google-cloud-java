...
public interface DeleteEvaluationExpectationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.DeleteEvaluationExpectationRequest)
