...
public interface RunEvaluationResultMetricsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.RunEvaluationResultMetricsResponse)
   ...
   * @return The status.
   */
  com.google.cloud.ces.v1beta.EvaluationResult.Outcome getStatus();
}
