...
public interface DeploymentOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.Deployment)
   ...
   *
   * <code>
   * .google.cloud.ces.v1beta.ChannelProfile channel_profile = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.ces.v1beta.ChannelProfile getChannelProfile();
   ...
   * </code>
   */
  com.google.cloud.ces.v1beta.ChannelProfileOrBuilder getChannelProfileOrBuilder();
