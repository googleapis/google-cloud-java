...
public class EvaluationResultName implements ResourceName {
  ...
  public static @Nullable EvaluationResultName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable EvaluationResultName> values) {
