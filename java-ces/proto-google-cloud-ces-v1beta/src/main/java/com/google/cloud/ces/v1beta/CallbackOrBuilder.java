...
public interface CallbackOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ces.v1beta.Callback)
   ...
   */
  boolean getProactiveExecutionEnabled();

  com.google.cloud.ces.v1beta.Callback.CallbackCase getCallbackCase();
}
