...
public class DeploymentName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_DEPLOYMENT =
  ...
  public static DeploymentName of(String project, String location, String app, String deployment) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String deployment) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static DeploymentName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_DEPLOYMENT.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_DEPLOYMENT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_DEPLOYMENT.instantiate(
        "project", project, "location", location, "app", app, "deployment", deployment);
  }
