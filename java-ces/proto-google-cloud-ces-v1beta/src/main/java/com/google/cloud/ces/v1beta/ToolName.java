...
public class ToolName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_TOOL =
  ...
  public static ToolName of(String project, String location, String app, String tool) {
    return newBuilder().setProject(project).setLocation(location).setApp(app).setTool(tool).build();
  }

  public static String format(String project, String location, String app, String tool) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable ToolName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_TOOL.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable ToolName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_TOOL.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_TOOL.instantiate(
        "project", project, "location", location, "app", app, "tool", tool);
  }
