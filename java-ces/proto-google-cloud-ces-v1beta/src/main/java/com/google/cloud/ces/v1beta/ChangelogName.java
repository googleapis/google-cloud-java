...
public class ChangelogName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APP_CHANGELOG =
  ...
  public static ChangelogName of(String project, String location, String app, String changelog) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String app, String changelog) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApp(app)
  ...
  public static @Nullable ChangelogName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_APP_CHANGELOG.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable ChangelogName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APP_CHANGELOG.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APP_CHANGELOG.instantiate(
        "project", project, "location", location, "app", app, "changelog", changelog);
  }
