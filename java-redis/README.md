...
```Groovy
implementation 'com.google.cloud:google-cloud-redis:2.90.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-redis/2.90.0
