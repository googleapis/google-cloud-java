...
public final class CloudRedisGrpc {
  ...
  public static CloudRedisBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CloudRedisBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CloudRedisBlockingV2Stub>() {
          @java.lang.Override
          public CloudRedisBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CloudRedisBlockingV2Stub(channel, callOptions);
          }
        };
    return CloudRedisBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class CloudRedisBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<CloudRedisBlockingV2Stub> {
    private CloudRedisBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CloudRedisBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CloudRedisBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service CloudRedis.
   *
   * <pre>
   * Configures and manages Cloud Memorystore for Redis instances
   * Google Cloud Memorystore for Redis v1
