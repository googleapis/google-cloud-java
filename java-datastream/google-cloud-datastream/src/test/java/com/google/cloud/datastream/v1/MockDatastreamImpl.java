...
import com.google.cloud.datastream.v1.DatastreamGrpc.DatastreamImplBase;
...
public class MockDatastreamImpl extends DatastreamImplBase {
  ...
  public void getStreamObject(
    ...
    Object response = responses.poll();
    if (response instanceof StreamObject) {
      requests.add(request);
      responseObserver.onNext(((StreamObject) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetStreamObject, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  StreamObject.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void lookupStreamObject(
      LookupStreamObjectRequest request, StreamObserver<StreamObject> responseObserver) {
    Object response = responses.poll();
    if (response instanceof StreamObject) {
      requests.add(request);
      responseObserver.onNext(((StreamObject) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method LookupStreamObject, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  StreamObject.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void listStreamObjects(
      ...
      StreamObserver<ListStreamObjectsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListStreamObjectsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListStreamObjectsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListStreamObjects, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListStreamObjectsResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void startBackfillJob(
      StartBackfillJobRequest request, StreamObserver<StartBackfillJobResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof StartBackfillJobResponse) {
      requests.add(request);
      responseObserver.onNext(((StartBackfillJobResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method StartBackfillJob, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  StartBackfillJobResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void stopBackfillJob(
      StopBackfillJobRequest request, StreamObserver<StopBackfillJobResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof StopBackfillJobResponse) {
      requests.add(request);
      responseObserver.onNext(((StopBackfillJobResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method StopBackfillJob, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
