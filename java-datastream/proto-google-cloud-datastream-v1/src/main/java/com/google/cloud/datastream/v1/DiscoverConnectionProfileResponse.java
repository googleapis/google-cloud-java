...
public final class DiscoverConnectionProfileResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 818:
              {
                input.readMessage(
                    internalGetPostgresqlRdbmsFieldBuilder().getBuilder(), extensionRegistry);
                dataObjectCase_ = 102;
                break;
              } // case 818
            case 826:
              {
                input.readMessage(
                    internalGetSqlServerRdbmsFieldBuilder().getBuilder(), extensionRegistry);
                dataObjectCase_ = 103;
                break;
              } // case 826
            case 834:
              {
                input.readMessage(
                    internalGetSalesforceOrgFieldBuilder().getBuilder(), extensionRegistry);
                dataObjectCase_ = 104;
                break;
              } // case 834
            case 842:
              {
                input.readMessage(
                    internalGetMongodbClusterFieldBuilder().getBuilder(), extensionRegistry);
                dataObjectCase_ = 105;
                break;
              } // case 842
            default:
    ...
    public com.google.cloud.datastream.v1.PostgresqlRdbms.Builder getPostgresqlRdbmsBuilder() {
      return internalGetPostgresqlRdbmsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.PostgresqlRdbms.Builder,
            com.google.cloud.datastream.v1.PostgresqlRdbmsOrBuilder>
        internalGetPostgresqlRdbmsFieldBuilder() {
      if (postgresqlRdbmsBuilder_ == null) {
        if (!(dataObjectCase_ == 102)) {
          dataObject_ = com.google.cloud.datastream.v1.PostgresqlRdbms.getDefaultInstance();
        }
    ...
    public com.google.cloud.datastream.v1.SqlServerRdbms.Builder getSqlServerRdbmsBuilder() {
      return internalGetSqlServerRdbmsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.SqlServerRdbms.Builder,
            com.google.cloud.datastream.v1.SqlServerRdbmsOrBuilder>
        internalGetSqlServerRdbmsFieldBuilder() {
      if (sqlServerRdbmsBuilder_ == null) {
        if (!(dataObjectCase_ == 103)) {
          dataObject_ = com.google.cloud.datastream.v1.SqlServerRdbms.getDefaultInstance();
        }
    ...
    public com.google.cloud.datastream.v1.SalesforceOrg.Builder getSalesforceOrgBuilder() {
      return internalGetSalesforceOrgFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.SalesforceOrg.Builder,
            com.google.cloud.datastream.v1.SalesforceOrgOrBuilder>
        internalGetSalesforceOrgFieldBuilder() {
      if (salesforceOrgBuilder_ == null) {
        if (!(dataObjectCase_ == 104)) {
          dataObject_ = com.google.cloud.datastream.v1.SalesforceOrg.getDefaultInstance();
        }
    ...
    public com.google.cloud.datastream.v1.MongodbCluster.Builder getMongodbClusterBuilder() {
      return internalGetMongodbClusterFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.MongodbCluster.Builder,
            com.google.cloud.datastream.v1.MongodbClusterOrBuilder>
        internalGetMongodbClusterFieldBuilder() {
      if (mongodbClusterBuilder_ == null) {
        if (!(dataObjectCase_ == 105)) {
          dataObject_ = com.google.cloud.datastream.v1.MongodbCluster.getDefaultInstance();
        }
