...
public final class MongodbProfile extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private MongodbProfile(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(replicaSet_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, replicaSet_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(secretManagerStoredPassword_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, secretManagerStoredPassword_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(replicaSet_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, replicaSet_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(username_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(secretManagerStoredPassword_)) {
      size +=
          com.google.protobuf.GeneratedMessage.computeStringSize(5, secretManagerStoredPassword_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetHostAddressesFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 810:
              {
                input.readMessage(
                    internalGetSrvConnectionFormatFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 818:
              {
                input.readMessage(
                    internalGetStandardConnectionFormatFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.cloud.datastream.v1.HostAddress.Builder getHostAddressesBuilder(int index) {
      return internalGetHostAddressesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.datastream.v1.HostAddress.Builder addHostAddressesBuilder() {
      return internalGetHostAddressesFieldBuilder()
    ...
    public java.util.List<com.google.cloud.datastream.v1.HostAddress.Builder>
      ...
      return internalGetHostAddressesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.datastream.v1.SrvConnectionFormat.Builder
      ...
      return internalGetSrvConnectionFormatFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.SrvConnectionFormat.Builder,
            com.google.cloud.datastream.v1.SrvConnectionFormatOrBuilder>
        internalGetSrvConnectionFormatFieldBuilder() {
      if (srvConnectionFormatBuilder_ == null) {
        if (!(mongodbConnectionFormatCase_ == 101)) {
          mongodbConnectionFormat_ =
              com.google.cloud.datastream.v1.SrvConnectionFormat.getDefaultInstance();
    ...
    public com.google.cloud.datastream.v1.StandardConnectionFormat.Builder
      ...
      return internalGetStandardConnectionFormatFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.StandardConnectionFormat.Builder,
            com.google.cloud.datastream.v1.StandardConnectionFormatOrBuilder>
        internalGetStandardConnectionFormatFieldBuilder() {
      if (standardConnectionFormatBuilder_ == null) {
        if (!(mongodbConnectionFormatCase_ == 102)) {
          mongodbConnectionFormat_ =
              com.google.cloud.datastream.v1.StandardConnectionFormat.getDefaultInstance();
