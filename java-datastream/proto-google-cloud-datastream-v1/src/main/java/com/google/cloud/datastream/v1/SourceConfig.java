...
public final class SourceConfig extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceConnectionProfile_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, sourceConnectionProfile_);
    }
    if (sourceStreamConfigCase_ == 100) {
      output.writeMessage(
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceConnectionProfile_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, sourceConnectionProfile_);
    }
    if (sourceStreamConfigCase_ == 100) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 818:
              {
                input.readMessage(
                    internalGetPostgresqlSourceConfigFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 826:
              {
                input.readMessage(
                    internalGetSqlServerSourceConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 834:
              {
                input.readMessage(
                    internalGetSalesforceSourceConfigFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 842:
              {
                input.readMessage(
                    internalGetMongodbSourceConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.datastream.v1.PostgresqlSourceConfig.Builder
      ...
      return internalGetPostgresqlSourceConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.PostgresqlSourceConfig.Builder,
            com.google.cloud.datastream.v1.PostgresqlSourceConfigOrBuilder>
        internalGetPostgresqlSourceConfigFieldBuilder() {
      if (postgresqlSourceConfigBuilder_ == null) {
        if (!(sourceStreamConfigCase_ == 102)) {
          sourceStreamConfig_ =
              com.google.cloud.datastream.v1.PostgresqlSourceConfig.getDefaultInstance();
    ...
    public com.google.cloud.datastream.v1.SqlServerSourceConfig.Builder
      ...
      return internalGetSqlServerSourceConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.SqlServerSourceConfig.Builder,
            com.google.cloud.datastream.v1.SqlServerSourceConfigOrBuilder>
        internalGetSqlServerSourceConfigFieldBuilder() {
      if (sqlServerSourceConfigBuilder_ == null) {
        if (!(sourceStreamConfigCase_ == 103)) {
          sourceStreamConfig_ =
              com.google.cloud.datastream.v1.SqlServerSourceConfig.getDefaultInstance();
    ...
    public com.google.cloud.datastream.v1.SalesforceSourceConfig.Builder
      ...
      return internalGetSalesforceSourceConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.SalesforceSourceConfig.Builder,
            com.google.cloud.datastream.v1.SalesforceSourceConfigOrBuilder>
        internalGetSalesforceSourceConfigFieldBuilder() {
      if (salesforceSourceConfigBuilder_ == null) {
        if (!(sourceStreamConfigCase_ == 104)) {
          sourceStreamConfig_ =
              com.google.cloud.datastream.v1.SalesforceSourceConfig.getDefaultInstance();
    ...
    public com.google.cloud.datastream.v1.MongodbSourceConfig.Builder
      ...
      return internalGetMongodbSourceConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1.MongodbSourceConfig.Builder,
            com.google.cloud.datastream.v1.MongodbSourceConfigOrBuilder>
        internalGetMongodbSourceConfigFieldBuilder() {
      if (mongodbSourceConfigBuilder_ == null) {
        if (!(sourceStreamConfigCase_ == 105)) {
          sourceStreamConfig_ =
              com.google.cloud.datastream.v1.MongodbSourceConfig.getDefaultInstance();
