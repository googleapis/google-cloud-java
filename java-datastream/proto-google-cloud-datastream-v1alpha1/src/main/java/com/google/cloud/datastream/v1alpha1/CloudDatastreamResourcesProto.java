...
public final class CloudDatastreamResourcesProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "gle/protobuf/duration.proto\032\037google/protobuf/timestamp.proto\"\250\002\n\r"
          ...
          + "\025connection_attributes\030\006 \003(\0132I.google.cloud.d"
          + "atastream.v1alpha1.OracleProfile.ConnectionAttributesEntry\032;\n"
          ...
          + "\006labels\030\004"
          + " \003(\0132?.google.cloud.datastream.v1alpha1.PrivateConnection.LabelsEntry\022\031\n"
          + "\014display_name\030\005 \001(\tB\003\340A\002\022M\n"
          + "\005state\030\006 \001(\01629.go"
          + "ogle.cloud.datastream.v1alpha1.PrivateConnection.StateB\003\340A\003\022;\n"
          + "\005error\030\007 \001(\0132\'.goo"
          + "gle.cloud.datastream.v1alpha1.ErrorB\003\340A\003\022N\n"
          + "\022vpc_peering_config\030d \001(\01322.google.cl"
          + "oud.datastream.v1alpha1.VpcPeeringConfig\032-\n"
          ...
          + "+datastream.googleapis.com/PrivateConnection\022Oprojects/{project}/locations/"
          + "{location}/privateConnections/{private_connection}\";\n"
          ...
          + "\037datastream.googleapis.com/Route\022^projects/{project}/location"
          + "s/{location}/privateConnections/{private_connection}/routes/{route}\"\312\001\n"
          ...
          + "google.cloud.datastream.v1alpha1.ConnectionProfile.LabelsEntry\022\031\n"
          + "\014display_name\030\005 \001(\tB\003\340A\002\022I\n"
          + "\016oracle_profile\030d \001(\0132/.goog"
          + "le.cloud.datastream.v1alpha1.OracleProfileH\000\022C\n"
          + "\013gcs_profile\030e"
          ...
          + "\017no_connectivity\030\310\001"
          + " \001(\01328.google.cloud.datastream.v1alpha1.NoConnectivitySettingsH\001\022h\n"
          + "\036static_service_ip_connectivity\030\311\001 \001(\0132=.goog"
          + "le.cloud.datastream.v1alpha1.StaticServiceIpConnectivityH\001\022c\n"
          + "\030forward_ssh_connectivity\030\312\001 \001(\0132>.google.cloud.datastream."
          + "v1alpha1.ForwardSshTunnelConnectivityH\001\022V\n"
          + "\024private_connectivity\030\313\001 \001(\01325.google."
          + "cloud.datastream.v1alpha1.PrivateConnectivityH\001\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\201\001\352A~\n"
          + "+datastream.googleapis.com/ConnectionProfile\022Oprojects/{pro"
          + "ject}/locations/{location}/connectionProfiles/{connection_profile}B\t\n"
          + "\007profileB\016\n"
          ...
          + "\01324.google.cloud.datastream.v1alpha1.OracleSourceConfigH\000\022R\n"
          + "\023mysql_source_config\030e"
          + " \001(\01323.google.cloud.datastream.v1alpha1.MysqlSourceConfigH\000B\026\n"
          + "\024source_stream_config\"\020\n"
          + "\016AvroFileFormat\"\212\002\n"
          + "\016JsonFileFormat\022N\n"
          + "\022schema_file_format\030\001 \001(\01622.google."
          + "cloud.datastream.v1alpha1.SchemaFileFormat\022U\n"
          + "\013compression\030\002 \001(\0162@.google.cloud.d"
          + "atastream.v1alpha1.JsonFileFormat.JsonCompression\"Q\n"
          ...
          + "oogle.cloud.datastream.v1alpha1.GcsFileFormatB\002\030\001\022\030\n"
          ...
          + "20.google.cloud.datastream.v1alpha1.AvroFileFormatH\000\022L\n"
          + "\020json_file_format\030e \001(\01320"
          + ".google.cloud.datastream.v1alpha1.JsonFileFormatH\000B\r\n"
          ...
          + " \001(\01326.google.cloud.datastream.v1alpha1.GcsDestinationConfigH\000B\033\n"
          ...
          + "\006labels\030\004"
          + " \003(\01324.google.cloud.datastream.v1alpha1.Stream.LabelsEntry\022\031\n"
          + "\014display_name\030\005 \001(\tB\003\340A\002\022J\n\r"
          + "source_config\030\006 \001(\0132..goo"
          + "gle.cloud.datastream.v1alpha1.SourceConfigB\003\340A\002\022T\n"
          + "\022destination_config\030\007 \001(\01323.go"
          + "ogle.cloud.datastream.v1alpha1.DestinationConfigB\003\340A\002\022=\n"
          + "\005state\030\010 \001(\0162..google.cloud.datastream.v1alpha1.Stream.State\022T\n"
          + "\014backfill_all\030e \001(\0132<.google.cloud.datast"
          + "ream.v1alpha1.Stream.BackfillAllStrategyH\000\022V\n\r"
          + "backfill_none\030f \001(\0132=.google.cloud"
          + ".datastream.v1alpha1.Stream.BackfillNoneStrategyH\000\022<\n"
          + "\006errors\030\t"
          ...
          + " \001(\0132-.google.cloud.datastream.v1alpha1.OracleRdbmsH\000\022N\n"
          + "\026mysql_excluded_objects\030\002"
          + " \001(\0132,.google.cloud.datastream.v1alpha1.MysqlRdbmsH\000B\022\n"
          ...
          + " datastream.googleapis.com/Stream\0228projects/{project}"
          ...
          + "ud.datastream.v1alpha1.Error.DetailsEntry\032.\n"
          + "\014DetailsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"U\n"
          + "\020ValidationResult\022A\n"
          + "\013validations\030\001"
          + " \003(\0132,.google.cloud.datastream.v1alpha1.Validation\"\206\002\n\n"
          + "Validation\022\023\n"
          + "\013description\030\001 \001(\t\022C\n"
          + "\006status\030\002 \001(\01623.google.cl"
          + "oud.datastream.v1alpha1.Validation.Status\022D\n"
          + "\007message\030\003"
          ...
          + "\010metadata\030\003 \003(\0132A.google.cloud.datastream.v"
          + "1alpha1.ValidationMessage.MetadataEntry\022\014\n"
          ...
          + "\020AVRO_SCHEMA_FILE\020\002B\371\001\n"
          + "$com.google.cloud.datastream.v1alpha1B\035CloudDatastreamResourcesProtoP\001ZDclou"
          + "d.google.com/go/datastream/apiv1alpha1/datastreampb;datastreampb\252\002"
          + " Google.Cloud.Datastream.V1Alpha1\312\002 Google\\Cloud\\Datas"
          + "tream\\V1alpha1\352\002#Google::Cloud::Datastream::V1alpha1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_datastream_v1alpha1_OracleProfile_ConnectionAttributesEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_OracleProfile_descriptor.getNestedType(0);
    internal_static_google_cloud_datastream_v1alpha1_OracleProfile_ConnectionAttributesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_OracleProfile_ConnectionAttributesEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_datastream_v1alpha1_PrivateConnection_LabelsEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_PrivateConnection_descriptor.getNestedType(
            0);
    internal_static_google_cloud_datastream_v1alpha1_PrivateConnection_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_PrivateConnection_LabelsEntry_descriptor,
    ...
    internal_static_google_cloud_datastream_v1alpha1_Route_LabelsEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_Route_descriptor.getNestedType(0);
    internal_static_google_cloud_datastream_v1alpha1_Route_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_Route_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_datastream_v1alpha1_ConnectionProfile_LabelsEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_ConnectionProfile_descriptor.getNestedType(
            0);
    internal_static_google_cloud_datastream_v1alpha1_ConnectionProfile_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_ConnectionProfile_LabelsEntry_descriptor,
    ...
    internal_static_google_cloud_datastream_v1alpha1_Stream_BackfillAllStrategy_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_Stream_descriptor.getNestedType(0);
    internal_static_google_cloud_datastream_v1alpha1_Stream_BackfillAllStrategy_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_Stream_BackfillAllStrategy_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_datastream_v1alpha1_Stream_BackfillNoneStrategy_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_Stream_descriptor.getNestedType(1);
    internal_static_google_cloud_datastream_v1alpha1_Stream_BackfillNoneStrategy_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_Stream_BackfillNoneStrategy_descriptor,
            new java.lang.String[] {});
    internal_static_google_cloud_datastream_v1alpha1_Stream_LabelsEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_Stream_descriptor.getNestedType(2);
    internal_static_google_cloud_datastream_v1alpha1_Stream_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_Stream_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_datastream_v1alpha1_Error_DetailsEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_Error_descriptor.getNestedType(0);
    internal_static_google_cloud_datastream_v1alpha1_Error_DetailsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_Error_DetailsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_datastream_v1alpha1_ValidationMessage_MetadataEntry_descriptor =
        internal_static_google_cloud_datastream_v1alpha1_ValidationMessage_descriptor.getNestedType(
            0);
    internal_static_google_cloud_datastream_v1alpha1_ValidationMessage_MetadataEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_datastream_v1alpha1_ValidationMessage_MetadataEntry_descriptor,
