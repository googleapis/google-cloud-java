...
public final class SourceConfig extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceConnectionProfileName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, sourceConnectionProfileName_);
    }
    if (sourceStreamConfigCase_ == 100) {
      output.writeMessage(
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceConnectionProfileName_)) {
      size +=
          com.google.protobuf.GeneratedMessage.computeStringSize(1, sourceConnectionProfileName_);
    }
    if (sourceStreamConfigCase_ == 100) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 802:
              {
                input.readMessage(
                    internalGetOracleSourceConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 810:
              {
                input.readMessage(
                    internalGetMysqlSourceConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.datastream.v1alpha1.OracleSourceConfig.Builder
      ...
      return internalGetOracleSourceConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1alpha1.OracleSourceConfig.Builder,
            com.google.cloud.datastream.v1alpha1.OracleSourceConfigOrBuilder>
        internalGetOracleSourceConfigFieldBuilder() {
      if (oracleSourceConfigBuilder_ == null) {
        if (!(sourceStreamConfigCase_ == 100)) {
          sourceStreamConfig_ =
              com.google.cloud.datastream.v1alpha1.OracleSourceConfig.getDefaultInstance();
    ...
    public com.google.cloud.datastream.v1alpha1.MysqlSourceConfig.Builder
      ...
      return internalGetMysqlSourceConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datastream.v1alpha1.MysqlSourceConfig.Builder,
            com.google.cloud.datastream.v1alpha1.MysqlSourceConfigOrBuilder>
        internalGetMysqlSourceConfigFieldBuilder() {
      if (mysqlSourceConfigBuilder_ == null) {
        if (!(sourceStreamConfigCase_ == 101)) {
          sourceStreamConfig_ =
              com.google.cloud.datastream.v1alpha1.MysqlSourceConfig.getDefaultInstance();
