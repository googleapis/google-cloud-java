...
public final class KubernetesConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private KubernetesConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class GatewayServiceMesh extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private GatewayServiceMesh(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
     ...
     */
    public static final class RouteDestinations extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private RouteDestinations(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        for (int i = 0; i < destinationIds_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 1, destinationIds_.getRaw(i));
        }
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(httpRoute_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, httpRoute_);
      }
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(podSelectorLabel_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 6, podSelectorLabel_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(httpRoute_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, httpRoute_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(service_)) {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(podSelectorLabel_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(6, podSelectorLabel_);
      }
      if (((bitField0_ & 0x00000004) != 0)) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetRouteUpdateWaitTimeFieldBuilder();
          internalGetStableCutbackDurationFieldBuilder();
          internalGetRouteDestinationsFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34:
                {
                  input.readMessage(
                      internalGetRouteUpdateWaitTimeFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 42:
                {
                  input.readMessage(
                      internalGetStableCutbackDurationFieldBuilder().getBuilder(),
                      extensionRegistry);
              ...
              case 66:
                {
                  input.readMessage(
                      internalGetRouteDestinationsFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.protobuf.Duration.Builder getRouteUpdateWaitTimeBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
        return internalGetRouteUpdateWaitTimeFieldBuilder().getBuilder();
      }
      ...
      public com.google.protobuf.Duration.Builder getStableCutbackDurationBuilder() {
        bitField0_ |= 0x00000010;
        onChanged();
        return internalGetStableCutbackDurationFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.deploy.v1.KubernetesConfig.GatewayServiceMesh.RouteDestinations
        ...
        bitField0_ |= 0x00000040;
        onChanged();
        return internalGetRouteDestinationsFieldBuilder().getBuilder();
      }
   ...
   */
  public static final class ServiceNetworking extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ServiceNetworking(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(podSelectorLabel_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, podSelectorLabel_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(podSelectorLabel_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(4, podSelectorLabel_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetGatewayServiceMeshFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 18:
              {
                input.readMessage(
                    internalGetServiceNetworkingFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.deploy.v1.KubernetesConfig.GatewayServiceMesh.Builder
      ...
      return internalGetGatewayServiceMeshFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.deploy.v1.KubernetesConfig.GatewayServiceMesh.Builder,
            com.google.cloud.deploy.v1.KubernetesConfig.GatewayServiceMeshOrBuilder>
        internalGetGatewayServiceMeshFieldBuilder() {
      if (gatewayServiceMeshBuilder_ == null) {
        if (!(serviceDefinitionCase_ == 1)) {
          serviceDefinition_ =
              com.google.cloud.deploy.v1.KubernetesConfig.GatewayServiceMesh.getDefaultInstance();
    ...
    public com.google.cloud.deploy.v1.KubernetesConfig.ServiceNetworking.Builder
      ...
      return internalGetServiceNetworkingFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.deploy.v1.KubernetesConfig.ServiceNetworking.Builder,
            com.google.cloud.deploy.v1.KubernetesConfig.ServiceNetworkingOrBuilder>
        internalGetServiceNetworkingFieldBuilder() {
      if (serviceNetworkingBuilder_ == null) {
        if (!(serviceDefinitionCase_ == 2)) {
          serviceDefinition_ =
              com.google.cloud.deploy.v1.KubernetesConfig.ServiceNetworking.getDefaultInstance();
