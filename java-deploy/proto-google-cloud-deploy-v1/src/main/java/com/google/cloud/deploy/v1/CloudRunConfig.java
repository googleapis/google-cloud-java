 ...
 */
public final class CloudRunConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        CloudRunConfig.class.getName());
  }
  // Use CloudRunConfig.newBuilder() to construct.
  private CloudRunConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < canaryRevisionTags_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, canaryRevisionTags_.getRaw(i));
    }
    for (int i = 0; i < priorRevisionTags_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, priorRevisionTags_.getRaw(i));
    }
    for (int i = 0; i < stableRevisionTags_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, stableRevisionTags_.getRaw(i));
    }
