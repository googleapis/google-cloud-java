...
public final class AutomationRule extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AutomationRule(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetPromoteReleaseRuleFieldBuilder().getBuilder(), extensionRegistry);
                ruleCase_ = 1;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(
                    internalGetAdvanceRolloutRuleFieldBuilder().getBuilder(), extensionRegistry);
                ruleCase_ = 2;
                break;
              } // case 18
            case 26:
              {
                input.readMessage(
                    internalGetRepairRolloutRuleFieldBuilder().getBuilder(), extensionRegistry);
                ruleCase_ = 3;
                break;
              } // case 26
            case 34:
              {
                input.readMessage(
                    internalGetTimedPromoteReleaseRuleFieldBuilder().getBuilder(),
                    extensionRegistry);
                ruleCase_ = 4;
                break;
              } // case 34
    ...
    public com.google.cloud.deploy.v1.PromoteReleaseRule.Builder getPromoteReleaseRuleBuilder() {
      return internalGetPromoteReleaseRuleFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.deploy.v1.PromoteReleaseRule.Builder,
            com.google.cloud.deploy.v1.PromoteReleaseRuleOrBuilder>
        internalGetPromoteReleaseRuleFieldBuilder() {
      if (promoteReleaseRuleBuilder_ == null) {
        if (!(ruleCase_ == 1)) {
          rule_ = com.google.cloud.deploy.v1.PromoteReleaseRule.getDefaultInstance();
        }
    ...
    public com.google.cloud.deploy.v1.AdvanceRolloutRule.Builder getAdvanceRolloutRuleBuilder() {
      return internalGetAdvanceRolloutRuleFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.deploy.v1.AdvanceRolloutRule.Builder,
            com.google.cloud.deploy.v1.AdvanceRolloutRuleOrBuilder>
        internalGetAdvanceRolloutRuleFieldBuilder() {
      if (advanceRolloutRuleBuilder_ == null) {
        if (!(ruleCase_ == 2)) {
          rule_ = com.google.cloud.deploy.v1.AdvanceRolloutRule.getDefaultInstance();
        }
    ...
    public com.google.cloud.deploy.v1.RepairRolloutRule.Builder getRepairRolloutRuleBuilder() {
      return internalGetRepairRolloutRuleFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.deploy.v1.RepairRolloutRule.Builder,
            com.google.cloud.deploy.v1.RepairRolloutRuleOrBuilder>
        internalGetRepairRolloutRuleFieldBuilder() {
      if (repairRolloutRuleBuilder_ == null) {
        if (!(ruleCase_ == 3)) {
          rule_ = com.google.cloud.deploy.v1.RepairRolloutRule.getDefaultInstance();
        }
    ...
    public com.google.cloud.deploy.v1.TimedPromoteReleaseRule.Builder
      ...
      return internalGetTimedPromoteReleaseRuleFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.deploy.v1.TimedPromoteReleaseRule.Builder,
            com.google.cloud.deploy.v1.TimedPromoteReleaseRuleOrBuilder>
        internalGetTimedPromoteReleaseRuleFieldBuilder() {
      if (timedPromoteReleaseRuleBuilder_ == null) {
        if (!(ruleCase_ == 4)) {
          rule_ = com.google.cloud.deploy.v1.TimedPromoteReleaseRule.getDefaultInstance();
        }
