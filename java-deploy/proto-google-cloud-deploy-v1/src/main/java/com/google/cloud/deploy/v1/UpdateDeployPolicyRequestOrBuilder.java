...
public interface UpdateDeployPolicyRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.deploy.v1.UpdateDeployPolicyRequest)
   ...
   *
   * <code>
   * .google.cloud.deploy.v1.DeployPolicy deploy_policy = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
