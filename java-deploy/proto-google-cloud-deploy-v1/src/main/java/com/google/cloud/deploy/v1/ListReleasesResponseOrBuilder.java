...
public interface ListReleasesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.deploy.v1.ListReleasesResponse)
   ...
   * <code>repeated .google.cloud.deploy.v1.Release releases = 1;</code>
   */
  com.google.cloud.deploy.v1.ReleaseOrBuilder getReleasesOrBuilder(int index);
