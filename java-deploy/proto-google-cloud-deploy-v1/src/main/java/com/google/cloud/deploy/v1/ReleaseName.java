...
public class ReleaseName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_DELIVERY_PIPELINE_RELEASE =
  ...
  public static ReleaseName of(
      String project, String location, String deliveryPipeline, String release) {
    return newBuilder()
        .setProject(project)
  ...
  public static ReleaseName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_DELIVERY_PIPELINE_RELEASE.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_DELIVERY_PIPELINE_RELEASE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_DELIVERY_PIPELINE_RELEASE.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public static class Builder {
    ...
    private Builder(ReleaseName releaseName) {
      ...
      this.deliveryPipeline = releaseName.deliveryPipeline;
