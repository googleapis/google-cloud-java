...
public interface CreateAutomationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.deploy.v1.CreateAutomationRequest)
   ...
   * </pre>
   *
   * <code>string automation_id = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
