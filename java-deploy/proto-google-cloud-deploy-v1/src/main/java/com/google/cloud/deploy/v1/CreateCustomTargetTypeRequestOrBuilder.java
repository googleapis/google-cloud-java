...
public interface CreateCustomTargetTypeRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.deploy.v1.CreateCustomTargetTypeRequest)
   ...
   * </pre>
   *
   * <code>string custom_target_type_id = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
   ...
   * </code>
   */
  com.google.cloud.deploy.v1.CustomTargetTypeOrBuilder getCustomTargetTypeOrBuilder();
