...
public class DeliveryPipelineName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_DELIVERY_PIPELINE =
  ...
  public static @Nullable DeliveryPipelineName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_DELIVERY_PIPELINE.validatedMatch(
            formattedString, "DeliveryPipelineName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("delivery_pipeline"));
  }

  public static List<DeliveryPipelineName> parseList(List<String> formattedStrings) {
    List<DeliveryPipelineName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable DeliveryPipelineName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_DELIVERY_PIPELINE.instantiate(
        "project", project, "location", location, "delivery_pipeline", deliveryPipeline);
  }
