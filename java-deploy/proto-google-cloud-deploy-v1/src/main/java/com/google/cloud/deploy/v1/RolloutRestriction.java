...
public final class RolloutRestriction extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private RolloutRestriction(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private RolloutRestriction() {
    id_ = "";
    invokers_ = emptyIntList();
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList invokers_ = emptyIntList();

  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.cloud.deploy.v1.DeployPolicy.Invoker>
      invokers_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.cloud.deploy.v1.DeployPolicy.Invoker>() {
            public com.google.cloud.deploy.v1.DeployPolicy.Invoker convert(int from) {
  ...
  public java.util.List<com.google.cloud.deploy.v1.DeployPolicy.Invoker> getInvokersList() {
    return new com.google.protobuf.Internal.IntListAdapter<
        com.google.cloud.deploy.v1.DeployPolicy.Invoker>(invokers_, invokers_converter_);
  }
  ...
  public com.google.cloud.deploy.v1.DeployPolicy.Invoker getInvokers(int index) {
    return invokers_converter_.convert(invokers_.getInt(index));
  }
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.cloud.deploy.v1.RolloutRestriction.RolloutActions>
      actions_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.cloud.deploy.v1.RolloutRestriction.RolloutActions>() {
            public com.google.cloud.deploy.v1.RolloutRestriction.RolloutActions convert(int from) {
  ...
  public java.util.List<com.google.cloud.deploy.v1.RolloutRestriction.RolloutActions>
      getActionsList() {
    return new com.google.protobuf.Internal.IntListAdapter<
        com.google.cloud.deploy.v1.RolloutRestriction.RolloutActions>(actions_, actions_converter_);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < invokers_.size(); i++) {
      output.writeEnumNoTag(invokers_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      int dataSize = 0;
      for (int i = 0; i < invokers_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(invokers_.getInt(i));
      }
      size += dataSize;
    ...
    }
    {
      int dataSize = 0;
      for (int i = 0; i < actions_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(actions_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  invokers_.addInt(input.readEnum());
                }
            ...
            case 34:
              {
                input.readMessage(
                    internalGetTimeWindowsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    private void ensureInvokersIsMutable() {
      if (!invokers_.isModifiable()) {
        invokers_ = makeMutableCopy(invokers_);
      }
      bitField0_ |= 0x00000002;
    }
    ...
    public Builder setInvokers(int index, com.google.cloud.deploy.v1.DeployPolicy.Invoker value) {
      ...
      ensureInvokersIsMutable();
      invokers_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addInvokers(com.google.cloud.deploy.v1.DeployPolicy.Invoker value) {
      ...
      ensureInvokersIsMutable();
      invokers_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public com.google.cloud.deploy.v1.TimeWindows.Builder getTimeWindowsBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
      return internalGetTimeWindowsFieldBuilder().getBuilder();
    }
