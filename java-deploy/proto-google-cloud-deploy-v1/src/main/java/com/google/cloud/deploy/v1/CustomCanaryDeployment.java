...
public final class CustomCanaryDeployment extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CustomCanaryDeployment(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class PhaseConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private PhaseConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(phaseId_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, phaseId_);
      }
      if (percentage_ != 0) {
        output.writeInt32(2, percentage_);
      }
      for (int i = 0; i < profiles_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, profiles_.getRaw(i));
      }
      if (verify_ != false) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(phaseId_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, phaseId_);
      }
      if (percentage_ != 0) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetPredeployFieldBuilder();
          internalGetPostdeployFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42:
                {
                  input.readMessage(
                      internalGetPredeployFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 50:
                {
                  input.readMessage(
                      internalGetPostdeployFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.deploy.v1.Predeploy.Builder getPredeployBuilder() {
        bitField0_ |= 0x00000010;
        onChanged();
        return internalGetPredeployFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.deploy.v1.Postdeploy.Builder getPostdeployBuilder() {
        bitField0_ |= 0x00000020;
        onChanged();
        return internalGetPostdeployFieldBuilder().getBuilder();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          if (phaseConfigsBuilder_.isEmpty()) {
            ...
            phaseConfigsBuilder_ =
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                    ? internalGetPhaseConfigsFieldBuilder()
                    : null;
          } else {
    ...
    public com.google.cloud.deploy.v1.CustomCanaryDeployment.PhaseConfig.Builder
      ...
      return internalGetPhaseConfigsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.deploy.v1.CustomCanaryDeployment.PhaseConfig.Builder
      ...
      return internalGetPhaseConfigsFieldBuilder()
          .addBuilder(
              com.google.cloud.deploy.v1.CustomCanaryDeployment.PhaseConfig.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.cloud.deploy.v1.CustomCanaryDeployment.PhaseConfig.Builder>
      ...
      return internalGetPhaseConfigsFieldBuilder().getBuilderList();
    }
