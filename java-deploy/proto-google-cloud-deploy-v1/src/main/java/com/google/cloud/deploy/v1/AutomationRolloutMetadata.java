 ...
 */
public final class AutomationRolloutMetadata extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        AutomationRolloutMetadata.class.getName());
  }
  // Use AutomationRolloutMetadata.newBuilder() to construct.
  private AutomationRolloutMetadata(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(promoteAutomationRun_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, promoteAutomationRun_);
    }
    for (int i = 0; i < advanceAutomationRuns_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, advanceAutomationRuns_.getRaw(i));
    }
    for (int i = 0; i < repairAutomationRuns_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, repairAutomationRuns_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(promoteAutomationRun_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, promoteAutomationRun_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < advanceAutomationRuns_.size(); i++) {
