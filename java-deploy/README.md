...
```Groovy
implementation 'com.google.cloud:google-cloud-deploy:1.3.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-deploy" % "1.3.0"
```
...
[contributing]: https://github.com/googleapis/java-deploy/blob/main/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-deploy/blob/main/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-deploy/blob/main/LICENSE
