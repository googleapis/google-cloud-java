...
```Groovy
implementation 'com.google.cloud:google-cloud-deploy:1.85.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-deploy/1.85.0
