...
public interface ReleaseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.deploy.v1.BuildArtifact> 
   ...
   * <code>repeated .google.cloud.deploy.v1.BuildArtifact build_artifacts = 10;</code>
   */
  com.google.cloud.deploy.v1.BuildArtifactOrBuilder getBuildArtifactsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.deploy.v1.Target target_snapshots = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.deploy.v1.TargetOrBuilder getTargetSnapshotsOrBuilder(
      int index);
   ...
   * <code>map&lt;string, .google.cloud.deploy.v1.TargetArtifact&gt; target_artifacts = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  boolean containsTargetArtifacts(
      java.lang.String key);
  /**
