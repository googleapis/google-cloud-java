...
```Groovy
compile 'com.google.cloud:google-cloud-video-intelligence:0.23.1-alpha'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-intelligence" % "0.23.1-alpha"
```
