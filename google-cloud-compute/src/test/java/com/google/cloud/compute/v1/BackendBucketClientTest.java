...
public class BackendBucketClientTest {
  ...
  public static void setUp() throws IOException {
    clientSettings =
        BackendBucketSettings.newBuilder()
           ...
           .build();
    client =
       BackendBucketClient.create(clientSettings);
  }
  ...
  public void getBackendBucketTest() {
    ...
    String id = "id3355";
    String selfLink = "selfLink-1691268851";
    BackendBucket expectedResponse = BackendBucket.newBuilder()
  ...
  public void listBackendBucketsTest() {
    ...
    BackendBucketList expectedResponse = BackendBucketList.newBuilder()
      .setKind(kind)
