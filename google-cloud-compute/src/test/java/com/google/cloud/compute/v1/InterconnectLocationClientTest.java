...
public class InterconnectLocationClientTest {
  ...
  private static final MockHttpService mockService
      = new MockHttpService(METHOD_DESCRIPTORS, InterconnectLocationStubSettings.getDefaultEndpoint());
  ...
  public static void setUp() throws IOException {
    clientSettings =
        InterconnectLocationSettings.newBuilder()
           ...
           .build();
    client =
       InterconnectLocationClient.create(clientSettings);
  }
  ...
  public void getInterconnectLocationTest() {
    ...
    String id = "id3355";
    InterconnectLocation expectedResponse = InterconnectLocation.newBuilder()
  ...
  public void listInterconnectLocationsTest() {
    ...
    InterconnectLocationList expectedResponse = InterconnectLocationList.newBuilder()
      .setKind(kind)
    ...
    ListInterconnectLocationsPagedResponse pagedListResponse = client.listInterconnectLocations(project);
