...
public class HttpJsonBackendBucketStub extends BackendBucketStub {
  ...
  public static final ApiMethodDescriptor<DeleteBackendBucketHttpRequest, Operation> deleteBackendBucketMethodDescriptor =
      ApiMethodDescriptor.<DeleteBackendBucketHttpRequest, Operation>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<GetBackendBucketHttpRequest, BackendBucket> getBackendBucketMethodDescriptor =
  ...
  public static final ApiMethodDescriptor<InsertBackendBucketHttpRequest, Operation> insertBackendBucketMethodDescriptor =
      ApiMethodDescriptor.<InsertBackendBucketHttpRequest, Operation>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<ListBackendBucketsHttpRequest, BackendBucketList> listBackendBucketsMethodDescriptor =
      ApiMethodDescriptor.<ListBackendBucketsHttpRequest, BackendBucketList>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<PatchBackendBucketHttpRequest, Operation> patchBackendBucketMethodDescriptor =
  ...
  private final UnaryCallable<ListBackendBucketsHttpRequest, ListBackendBucketsPagedResponse> listBackendBucketsPagedCallable;
  ...
  protected HttpJsonBackendBucketStub(BackendBucketStubSettings settings, ClientContext clientContext, HttpJsonStubCallableFactory callableFactory) throws IOException {
    ...
    HttpJsonCallSettings<DeleteBackendBucketHttpRequest, Operation> deleteBackendBucketTransportSettings =
        HttpJsonCallSettings.<DeleteBackendBucketHttpRequest, Operation>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<GetBackendBucketHttpRequest, BackendBucket> getBackendBucketTransportSettings =
        HttpJsonCallSettings.<GetBackendBucketHttpRequest, BackendBucket>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<InsertBackendBucketHttpRequest, Operation> insertBackendBucketTransportSettings =
        HttpJsonCallSettings.<InsertBackendBucketHttpRequest, Operation>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<ListBackendBucketsHttpRequest, BackendBucketList> listBackendBucketsTransportSettings =
        HttpJsonCallSettings.<ListBackendBucketsHttpRequest, BackendBucketList>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<PatchBackendBucketHttpRequest, Operation> patchBackendBucketTransportSettings =
        HttpJsonCallSettings.<PatchBackendBucketHttpRequest, Operation>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<UpdateBackendBucketHttpRequest, Operation> updateBackendBucketTransportSettings =
