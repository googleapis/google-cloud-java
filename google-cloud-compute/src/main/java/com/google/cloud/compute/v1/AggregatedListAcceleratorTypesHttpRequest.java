...
public final class AggregatedListAcceleratorTypesHttpRequest implements ApiMessage {
  ...
  private AggregatedListAcceleratorTypesHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListAcceleratorTypesHttpRequest prototype) {
  ...
  public static AggregatedListAcceleratorTypesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final AggregatedListAcceleratorTypesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new AggregatedListAcceleratorTypesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListAcceleratorTypesHttpRequest other) {
      if (other == AggregatedListAcceleratorTypesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListAcceleratorTypesHttpRequest source) {
    ...
    public AggregatedListAcceleratorTypesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListAcceleratorTypesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListAcceleratorTypesHttpRequest) {
      AggregatedListAcceleratorTypesHttpRequest that = (AggregatedListAcceleratorTypesHttpRequest) o;
      return
