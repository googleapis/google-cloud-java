 ...
 * object. For example, to set the total timeout of deleteInterconnect to 30 seconds:
 *
 * <pre>
 * <code>
...
public class InterconnectSettings extends ClientSettings<InterconnectSettings> {
   ...
   */
  public PagedCallSettings<ListInterconnectsHttpRequest, InterconnectList, ListInterconnectsPagedResponse> listInterconnectsSettings() {
  ...
  public static class Builder extends ClientSettings.Builder<InterconnectSettings, Builder> {
     ...
     */
    public PagedCallSettings.Builder<ListInterconnectsHttpRequest, InterconnectList, ListInterconnectsPagedResponse> listInterconnectsSettings() {
