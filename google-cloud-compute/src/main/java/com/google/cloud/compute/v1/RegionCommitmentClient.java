 ...
 * </pre>
 *
 * <p>Note: close() needs to be called on the regionCommitmentClient object to clean up resources such
...
public class RegionCommitmentClient implements BackgroundResource {
   ...
   */
  @BetaApi
  public final Operation insertRegionCommitment(String requestId, String region, Commitment commitmentResource) {
  ...
  public static class AggregatedListRegionCommitmentsPagedResponse extends AbstractPagedListResponse<
    ...
    public static ApiFuture<AggregatedListRegionCommitmentsPagedResponse> createAsync(
        PageContext<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, CommitmentsScopedList> context,
        ApiFuture<CommitmentAggregatedList> futureResponse) {
      ApiFuture<AggregatedListRegionCommitmentsPage> futurePage =
          AggregatedListRegionCommitmentsPage.createEmptyPage().createPageAsync(context, futureResponse);
      return ApiFutures.transform(
          futurePage,
          new ApiFunction<AggregatedListRegionCommitmentsPage, AggregatedListRegionCommitmentsPagedResponse>() {
            @Override
  ...
  public static class AggregatedListRegionCommitmentsPage extends AbstractPage<
      AggregatedListRegionCommitmentsHttpRequest,
      CommitmentAggregatedList,
      CommitmentsScopedList,
      AggregatedListRegionCommitmentsPage> {
  ...
  public static class AggregatedListRegionCommitmentsFixedSizeCollection extends AbstractFixedSizeCollection<
      AggregatedListRegionCommitmentsHttpRequest,
      CommitmentAggregatedList,
      CommitmentsScopedList,
      AggregatedListRegionCommitmentsPage,
  ...
  public static class ListRegionCommitmentsPagedResponse extends AbstractPagedListResponse<
  ...
  public static class ListRegionCommitmentsPage extends AbstractPage<
      ListRegionCommitmentsHttpRequest,
      CommitmentList,
      Commitment,
      ListRegionCommitmentsPage> {
  ...
  public static class ListRegionCommitmentsFixedSizeCollection extends AbstractFixedSizeCollection<
      ListRegionCommitmentsHttpRequest,
      CommitmentList,
      Commitment,
      ListRegionCommitmentsPage,
