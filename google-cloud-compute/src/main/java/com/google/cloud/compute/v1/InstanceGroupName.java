...
@Generated("by GAPIC")
@BetaApi
public final class InstanceGroupName implements com.google.api.resourcenames.ResourceName {
  ...
  public static ResourceNameFactory<InstanceGroupName> newFactory() {
    return new ResourceNameFactory<InstanceGroupName>() {
      public InstanceGroupName parse(String formattedString) {return InstanceGroupName.parse(formattedString);}
    };
  }
