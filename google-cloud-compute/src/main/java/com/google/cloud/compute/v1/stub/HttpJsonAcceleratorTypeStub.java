...
public class HttpJsonAcceleratorTypeStub extends AcceleratorTypeStub {
  @InternalApi
  public static final ApiMethodDescriptor<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList> aggregatedListAcceleratorTypesMethodDescriptor =
      ApiMethodDescriptor.<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList>newBuilder()
          .setFullMethodName("compute.acceleratorTypes.aggregatedList")
          .setHttpMethod(HttpMethods.GET)
          .setRequestFormatter(
              ApiMessageHttpRequestFormatter.<AggregatedListAcceleratorTypesHttpRequest>newBuilder()
                  .setRequestInstance(AggregatedListAcceleratorTypesHttpRequest.getDefaultInstance())
  ...
  public static final ApiMethodDescriptor<GetAcceleratorTypeHttpRequest, AcceleratorType> getAcceleratorTypeMethodDescriptor =
      ApiMethodDescriptor.<GetAcceleratorTypeHttpRequest, AcceleratorType>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<ListAcceleratorTypesHttpRequest, AcceleratorTypeList> listAcceleratorTypesMethodDescriptor =
      ApiMethodDescriptor.<ListAcceleratorTypesHttpRequest, AcceleratorTypeList>newBuilder()
          ...
          .setRequestFormatter(
              ApiMessageHttpRequestFormatter.<ListAcceleratorTypesHttpRequest>newBuilder()
                  ...
                  .setPathTemplate(PathTemplate.create("{project}/zones/{zone}/acceleratorTypes"))
                  .setQueryParams(Sets.<String>newHashSet(
                                     "filter",    "maxResults",    "orderBy",    "pageToken"
                                     ))
  ...
  private final UnaryCallable<AggregatedListAcceleratorTypesHttpRequest, AggregatedListAcceleratorTypesPagedResponse> aggregatedListAcceleratorTypesPagedCallable;
  ...
  private final UnaryCallable<ListAcceleratorTypesHttpRequest, ListAcceleratorTypesPagedResponse> listAcceleratorTypesPagedCallable;

  private final HttpJsonStubCallableFactory callableFactory;
  public static final HttpJsonAcceleratorTypeStub create(AcceleratorTypeStubSettings settings) throws IOException {
  ...
  public static final HttpJsonAcceleratorTypeStub create(ClientContext clientContext) throws IOException {
    return new HttpJsonAcceleratorTypeStub(AcceleratorTypeStubSettings.newBuilder().build(), clientContext);
  }

  public static final HttpJsonAcceleratorTypeStub create(ClientContext clientContext, HttpJsonStubCallableFactory callableFactory) throws IOException {
    return new HttpJsonAcceleratorTypeStub(AcceleratorTypeStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of HttpJsonAcceleratorTypeStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static
   * factory methods should be preferred.
   */
  protected HttpJsonAcceleratorTypeStub(AcceleratorTypeStubSettings settings, ClientContext clientContext) throws IOException {
   ...
   * factory methods should be preferred.
   */
  protected HttpJsonAcceleratorTypeStub(AcceleratorTypeStubSettings settings, ClientContext clientContext, HttpJsonStubCallableFactory callableFactory) throws IOException {
    this.callableFactory = callableFactory;

    HttpJsonCallSettings<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList> aggregatedListAcceleratorTypesTransportSettings =
        HttpJsonCallSettings.<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList>newBuilder()
            .setMethodDescriptor(aggregatedListAcceleratorTypesMethodDescriptor)
            .build();
    HttpJsonCallSettings<GetAcceleratorTypeHttpRequest, AcceleratorType> getAcceleratorTypeTransportSettings =
        HttpJsonCallSettings.<GetAcceleratorTypeHttpRequest, AcceleratorType>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<ListAcceleratorTypesHttpRequest, AcceleratorTypeList> listAcceleratorTypesTransportSettings =
    ...
    this.aggregatedListAcceleratorTypesCallable = callableFactory.createUnaryCallable(aggregatedListAcceleratorTypesTransportSettings,settings.aggregatedListAcceleratorTypesSettings(), clientContext);
    this.aggregatedListAcceleratorTypesPagedCallable = callableFactory.createPagedCallable(aggregatedListAcceleratorTypesTransportSettings,settings.aggregatedListAcceleratorTypesSettings(), clientContext);
