...
public final class AggregatedListInstanceGroupsHttpRequest implements ApiMessage {
  ...
  private AggregatedListInstanceGroupsHttpRequest() {
  ...
  public static Builder newBuilder(AggregatedListInstanceGroupsHttpRequest prototype) {
  ...
  public static AggregatedListInstanceGroupsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListInstanceGroupsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListInstanceGroupsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListInstanceGroupsHttpRequest other) {
      if (other == AggregatedListInstanceGroupsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListInstanceGroupsHttpRequest source) {
    ...
    public AggregatedListInstanceGroupsHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListInstanceGroupsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListInstanceGroupsHttpRequest) {
      AggregatedListInstanceGroupsHttpRequest that = (AggregatedListInstanceGroupsHttpRequest) o;
