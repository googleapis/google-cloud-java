...
public final class GetInstanceHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetInstanceHttpRequest other) {
      if (other == GetInstanceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetInstanceHttpRequest source) {
