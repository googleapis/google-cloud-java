...
public final class CommitmentAggregatedList implements ApiMessage {
  ...
  private final Map<String, CommitmentsScopedList> items;
  ...
  private CommitmentAggregatedList(
      String id,
      Map<String, CommitmentsScopedList> items,
      String kind,
  ...
  public Map<String, CommitmentsScopedList> getItemsMap() {
    return items;
  }
  ...
  public static class Builder {
    private String id;
    private Map<String, CommitmentsScopedList> items;
    private String kind;
    ...
    public Builder putAllItems(Map<String, CommitmentsScopedList> items) {
      this.items = items;
      return this;
    }
    ...
    public CommitmentAggregatedList build() {
      ...
      return new CommitmentAggregatedList(id, items, kind, nextPageToken, selfLink, warning);
    }
