 ...
 * object. For example, to set the total timeout of deleteTargetTcpProxy to 30 seconds:
 *
 * <pre>
 * <code>
...
public class TargetTcpProxyStubSettings extends StubSettings<TargetTcpProxyStubSettings> {
  ...
  private final PagedCallSettings<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, ListTargetTcpProxiesPagedResponse> listTargetTcpProxiesSettings;
   ...
   */
  public PagedCallSettings<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, ListTargetTcpProxiesPagedResponse> listTargetTcpProxiesSettings() {
  ...
  private static final PagedListDescriptor<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, TargetTcpProxy> LIST_TARGET_TCP_PROXIES_PAGE_STR_DESC =
  ...
  private static final PagedListResponseFactory<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, ListTargetTcpProxiesPagedResponse> LIST_TARGET_TCP_PROXIES_PAGE_STR_FACT =
      new PagedListResponseFactory<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, ListTargetTcpProxiesPagedResponse>() {
        @Override
        public ApiFuture<ListTargetTcpProxiesPagedResponse> getFuturePagedResponse(
          ...
          PageContext<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, TargetTcpProxy> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<TargetTcpProxyStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, ListTargetTcpProxiesPagedResponse> listTargetTcpProxiesSettings;
     ...
     */
    public PagedCallSettings.Builder<ListTargetTcpProxiesHttpRequest, TargetTcpProxyList, ListTargetTcpProxiesPagedResponse> listTargetTcpProxiesSettings() {
      return listTargetTcpProxiesSettings;
    }
