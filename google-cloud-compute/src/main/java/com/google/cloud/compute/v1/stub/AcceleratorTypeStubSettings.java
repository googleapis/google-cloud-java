 ...
 * object. For example, to set the total timeout of getAcceleratorType to 30 seconds:
 *
 * <pre>
 * <code>
...
public class AcceleratorTypeStubSettings extends StubSettings<AcceleratorTypeStubSettings> {
  ...
  private final PagedCallSettings<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AggregatedListAcceleratorTypesPagedResponse> aggregatedListAcceleratorTypesSettings;
  private final UnaryCallSettings<GetAcceleratorTypeHttpRequest, AcceleratorType> getAcceleratorTypeSettings;
  private final PagedCallSettings<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, ListAcceleratorTypesPagedResponse> listAcceleratorTypesSettings;

  /**
   * Returns the object with the settings used for calls to aggregatedListAcceleratorTypes.
   */
  public PagedCallSettings<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AggregatedListAcceleratorTypesPagedResponse> aggregatedListAcceleratorTypesSettings() {
   ...
   */
  public PagedCallSettings<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, ListAcceleratorTypesPagedResponse> listAcceleratorTypesSettings() {
  ...
  private static final PagedListDescriptor<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AcceleratorTypesScopedList> AGGREGATED_LIST_ACCELERATOR_TYPES_PAGE_STR_DESC =
      new PagedListDescriptor<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AcceleratorTypesScopedList>() {
        @Override
  ...
  private static final PagedListDescriptor<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, AcceleratorType> LIST_ACCELERATOR_TYPES_PAGE_STR_DESC =
      new PagedListDescriptor<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, AcceleratorType>() {
        @Override
        public String emptyToken() {
          return "";
        }
  ...
  private static final PagedListResponseFactory<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AggregatedListAcceleratorTypesPagedResponse> AGGREGATED_LIST_ACCELERATOR_TYPES_PAGE_STR_FACT =
      new PagedListResponseFactory<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AggregatedListAcceleratorTypesPagedResponse>() {
        @Override
        public ApiFuture<AggregatedListAcceleratorTypesPagedResponse> getFuturePagedResponse(
            UnaryCallable<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList> callable,
            AggregatedListAcceleratorTypesHttpRequest request,
            ApiCallContext context,
            ApiFuture<AcceleratorTypeAggregatedList> futureResponse) {
          PageContext<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AcceleratorTypesScopedList> pageContext =
  ...
  private static final PagedListResponseFactory<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, ListAcceleratorTypesPagedResponse> LIST_ACCELERATOR_TYPES_PAGE_STR_FACT =
      new PagedListResponseFactory<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, ListAcceleratorTypesPagedResponse>() {
        @Override
        public ApiFuture<ListAcceleratorTypesPagedResponse> getFuturePagedResponse(
          ...
          PageContext<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, AcceleratorType> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<AcceleratorTypeStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AggregatedListAcceleratorTypesPagedResponse> aggregatedListAcceleratorTypesSettings;
    private final UnaryCallSettings.Builder<GetAcceleratorTypeHttpRequest, AcceleratorType> getAcceleratorTypeSettings;
    private final PagedCallSettings.Builder<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, ListAcceleratorTypesPagedResponse> listAcceleratorTypesSettings;
     ...
     */
    public PagedCallSettings.Builder<AggregatedListAcceleratorTypesHttpRequest, AcceleratorTypeAggregatedList, AggregatedListAcceleratorTypesPagedResponse> aggregatedListAcceleratorTypesSettings() {
      return aggregatedListAcceleratorTypesSettings;
    }
     ...
     */
    public PagedCallSettings.Builder<ListAcceleratorTypesHttpRequest, AcceleratorTypeList, ListAcceleratorTypesPagedResponse> listAcceleratorTypesSettings() {
      return listAcceleratorTypesSettings;
    }
