...
@Generated("by GAPIC")
@BetaApi
public final class DeleteTargetHttpsProxyHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteTargetHttpsProxyHttpRequest other) {
      if (other == DeleteTargetHttpsProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteTargetHttpsProxyHttpRequest source) {
