...
public class RegionCommitmentStubSettings extends StubSettings<RegionCommitmentStubSettings> {
  ...
  private final PagedCallSettings<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, AggregatedListRegionCommitmentsPagedResponse> aggregatedListRegionCommitmentsSettings;
  ...
  private final PagedCallSettings<ListRegionCommitmentsHttpRequest, CommitmentList, ListRegionCommitmentsPagedResponse> listRegionCommitmentsSettings;
  ...
  private static final PagedListDescriptor<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, CommitmentsScopedList> AGGREGATED_LIST_REGION_COMMITMENTS_PAGE_STR_DESC =
      new PagedListDescriptor<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, CommitmentsScopedList>() {
        @Override
  ...
  private static final PagedListDescriptor<ListRegionCommitmentsHttpRequest, CommitmentList, Commitment> LIST_REGION_COMMITMENTS_PAGE_STR_DESC =
  ...
  private static final PagedListResponseFactory<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, AggregatedListRegionCommitmentsPagedResponse> AGGREGATED_LIST_REGION_COMMITMENTS_PAGE_STR_FACT =
      new PagedListResponseFactory<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, AggregatedListRegionCommitmentsPagedResponse>() {
        @Override
        public ApiFuture<AggregatedListRegionCommitmentsPagedResponse> getFuturePagedResponse(
            UnaryCallable<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList> callable,
            AggregatedListRegionCommitmentsHttpRequest request,
            ApiCallContext context,
            ApiFuture<CommitmentAggregatedList> futureResponse) {
          PageContext<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, CommitmentsScopedList> pageContext =
  ...
  private static final PagedListResponseFactory<ListRegionCommitmentsHttpRequest, CommitmentList, ListRegionCommitmentsPagedResponse> LIST_REGION_COMMITMENTS_PAGE_STR_FACT =
      new PagedListResponseFactory<ListRegionCommitmentsHttpRequest, CommitmentList, ListRegionCommitmentsPagedResponse>() {
        @Override
        public ApiFuture<ListRegionCommitmentsPagedResponse> getFuturePagedResponse(
          ...
          PageContext<ListRegionCommitmentsHttpRequest, CommitmentList, Commitment> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<RegionCommitmentStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<AggregatedListRegionCommitmentsHttpRequest, CommitmentAggregatedList, AggregatedListRegionCommitmentsPagedResponse> aggregatedListRegionCommitmentsSettings;
    ...
    private final PagedCallSettings.Builder<ListRegionCommitmentsHttpRequest, CommitmentList, ListRegionCommitmentsPagedResponse> listRegionCommitmentsSettings;
