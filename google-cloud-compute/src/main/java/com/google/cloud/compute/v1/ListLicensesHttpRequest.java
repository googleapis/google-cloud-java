...
public final class ListLicensesHttpRequest implements ApiMessage {
  ...
  private ListLicensesHttpRequest() {
  ...
  public static Builder newBuilder(ListLicensesHttpRequest prototype) {
  ...
  public static ListLicensesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListLicensesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListLicensesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListLicensesHttpRequest other) {
      if (other == ListLicensesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListLicensesHttpRequest source) {
    ...
    public ListLicensesHttpRequest build() {
      String missing = "";
      ...
      return new ListLicensesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListLicensesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListLicensesHttpRequest) {
      ListLicensesHttpRequest that = (ListLicensesHttpRequest) o;
