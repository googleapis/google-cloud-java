...
@Generated("by GAPIC")
@BetaApi
public final class InterconnectName implements com.google.api.resourcenames.ResourceName {
  ...
  public static ResourceNameFactory<InterconnectName> newFactory() {
    return new ResourceNameFactory<InterconnectName>() {
      public InterconnectName parse(String formattedString) {return InterconnectName.parse(formattedString);}
    };
  }

  public static InterconnectName parse(String formattedString) {
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "InterconnectName.parse: formattedString not in valid format");
    return of(
  ...
  public static class Builder {
    ...
    public Builder (InterconnectName interconnectName) {
      interconnect = interconnectName.interconnect;
      project = interconnectName.project;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InterconnectName) {
