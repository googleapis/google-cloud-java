...
public final class InsertTargetPoolHttpRequest implements ApiMessage {
  ...
  private final TargetPool targetPoolResource;
  ...
  @Nullable
  @Override
  public TargetPool getApiMessageRequestBody() {
  ...
  public static class Builder {
    ...
    private TargetPool targetPoolResource;
    private String userIp;

    Builder() {}

    public Builder mergeFrom(InsertTargetPoolHttpRequest other) {
      if (other == InsertTargetPoolHttpRequest.getDefaultInstance()) return this;
      ...
      if (other.getTargetPoolResource() != null) {
        this.targetPoolResource = other.targetPoolResource;
      }
    ...
    Builder(InsertTargetPoolHttpRequest source) {
      ...
      this.targetPoolResource = source.targetPoolResource;
    ...
    public Builder clone() {
      ...
      newBuilder.setTargetPoolResource(this.targetPoolResource);
