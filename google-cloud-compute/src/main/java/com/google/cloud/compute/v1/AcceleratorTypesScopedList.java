...
public final class AcceleratorTypesScopedList implements ApiMessage {
  ...
  public Map<String, List<String>> populateFieldsInMap(Set<String> fieldNames) {
    ...
    if (fieldNames.contains("acceleratorTypes") && acceleratorTypes != null) {
      ImmutableList.Builder stringList = ImmutableList.builder();
      for (AcceleratorType item : acceleratorTypes) {
        stringList.add(item.toString());
      }
      fieldMap.put("acceleratorTypes", stringList.build());
    }
  ...
  public String getFieldStringValue(String fieldName) {
    if (fieldName.equals("acceleratorTypes")) {
      return String.valueOf(acceleratorTypes);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AcceleratorTypesScopedList) {
      ...
      return
          Objects.equals(this.acceleratorTypes, that.getAcceleratorTypesList()) &&
