...
@Generated("by GAPIC")
@BetaApi
public final class InterconnectList implements ApiMessage {
  private final String id;
  private final List<Interconnect> items;
  ...
  public static class Builder {
    private String id;
    private List<Interconnect> items;
    private String kind;
    ...
    public Builder mergeFrom(InterconnectList other) {
      if (other == InterconnectList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(InterconnectList source) {
      this.id = source.id;
    ...
    public Builder addAllItems(List<Interconnect> items) {
      if (this.items == null) {
    ...
    public Builder addItems(Interconnect items) {
