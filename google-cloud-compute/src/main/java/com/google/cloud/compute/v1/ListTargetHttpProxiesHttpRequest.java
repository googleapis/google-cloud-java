...
@Generated("by GAPIC")
@BetaApi
public final class ListTargetHttpProxiesHttpRequest implements ApiMessage {
  ...
  private ListTargetHttpProxiesHttpRequest() {
  ...
  public static Builder newBuilder(ListTargetHttpProxiesHttpRequest prototype) {
  ...
  public static ListTargetHttpProxiesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }
  private static final ListTargetHttpProxiesHttpRequest DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new ListTargetHttpProxiesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListTargetHttpProxiesHttpRequest other) {
      if (other == ListTargetHttpProxiesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListTargetHttpProxiesHttpRequest source) {
    ...
    public ListTargetHttpProxiesHttpRequest build() {
      String missing = "";
      ...
      return new ListTargetHttpProxiesHttpRequest(
        access_token,
        callback,
        fields,
        filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListTargetHttpProxiesHttpRequest) {
      ListTargetHttpProxiesHttpRequest that = (ListTargetHttpProxiesHttpRequest) o;
      return
