...
public class InterconnectStubSettings extends StubSettings<InterconnectStubSettings> {
  ...
  private final PagedCallSettings<ListInterconnectsHttpRequest, InterconnectList, ListInterconnectsPagedResponse> listInterconnectsSettings;
  ...
  private static final PagedListDescriptor<ListInterconnectsHttpRequest, InterconnectList, Interconnect> LIST_INTERCONNECTS_PAGE_STR_DESC =
  ...
  private static final PagedListResponseFactory<ListInterconnectsHttpRequest, InterconnectList, ListInterconnectsPagedResponse> LIST_INTERCONNECTS_PAGE_STR_FACT =
      new PagedListResponseFactory<ListInterconnectsHttpRequest, InterconnectList, ListInterconnectsPagedResponse>() {
        @Override
        public ApiFuture<ListInterconnectsPagedResponse> getFuturePagedResponse(
          ...
          PageContext<ListInterconnectsHttpRequest, InterconnectList, Interconnect> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<InterconnectStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<ListInterconnectsHttpRequest, InterconnectList, ListInterconnectsPagedResponse> listInterconnectsSettings;
