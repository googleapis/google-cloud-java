...
public class BackendBucketStubSettings extends StubSettings<BackendBucketStubSettings> {
  ...
  private final PagedCallSettings<ListBackendBucketsHttpRequest, BackendBucketList, ListBackendBucketsPagedResponse> listBackendBucketsSettings;
  ...
  private static final PagedListDescriptor<ListBackendBucketsHttpRequest, BackendBucketList, BackendBucket> LIST_BACKEND_BUCKETS_PAGE_STR_DESC =
      new PagedListDescriptor<ListBackendBucketsHttpRequest, BackendBucketList, BackendBucket>() {
        @Override
  ...
  private static final PagedListResponseFactory<ListBackendBucketsHttpRequest, BackendBucketList, ListBackendBucketsPagedResponse> LIST_BACKEND_BUCKETS_PAGE_STR_FACT =
      new PagedListResponseFactory<ListBackendBucketsHttpRequest, BackendBucketList, ListBackendBucketsPagedResponse>() {
        @Override
        public ApiFuture<ListBackendBucketsPagedResponse> getFuturePagedResponse(
          ...
          PageContext<ListBackendBucketsHttpRequest, BackendBucketList, BackendBucket> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<BackendBucketStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<ListBackendBucketsHttpRequest, BackendBucketList, ListBackendBucketsPagedResponse> listBackendBucketsSettings;
