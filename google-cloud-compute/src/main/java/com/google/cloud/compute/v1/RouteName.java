...
public final class RouteName implements ResourceName {
  ...
  public static ResourceNameFactory<RouteName> newFactory() {
    return new ResourceNameFactory<RouteName>() {
      public RouteName parse(String formattedString) {return RouteName.parse(formattedString);}
    };
  }
