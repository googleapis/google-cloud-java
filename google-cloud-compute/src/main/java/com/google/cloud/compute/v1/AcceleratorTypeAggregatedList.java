...
@Generated("by GAPIC")
@BetaApi
public final class AcceleratorTypeAggregatedList implements ApiMessage {
  private final String id;
  private final Map<String, AcceleratorTypesScopedList> items;
  ...
  public Map<String, AcceleratorTypesScopedList> getItemsMap() {
    return items;
  }
  ...
  public static class Builder {
    private String id;
    private Map<String, AcceleratorTypesScopedList> items;
    private String kind;
    ...
    public Builder mergeFrom(AcceleratorTypeAggregatedList other) {
      if (other == AcceleratorTypeAggregatedList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(AcceleratorTypeAggregatedList source) {
      this.id = source.id;
    ...
    public Builder putAllItems(Map<String, AcceleratorTypesScopedList> items) {
      this.items = items;
      return this;
    }
