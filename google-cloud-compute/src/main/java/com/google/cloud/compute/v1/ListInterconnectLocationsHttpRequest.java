...
public final class ListInterconnectLocationsHttpRequest implements ApiMessage {
  ...
  private ListInterconnectLocationsHttpRequest() {
  ...
  public static Builder newBuilder(ListInterconnectLocationsHttpRequest prototype) {
  ...
  public static ListInterconnectLocationsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListInterconnectLocationsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListInterconnectLocationsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListInterconnectLocationsHttpRequest other) {
      if (other == ListInterconnectLocationsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListInterconnectLocationsHttpRequest source) {
    ...
    public ListInterconnectLocationsHttpRequest build() {
      String missing = "";
      ...
      return new ListInterconnectLocationsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListInterconnectLocationsHttpRequest) {
      ListInterconnectLocationsHttpRequest that = (ListInterconnectLocationsHttpRequest) o;
