...
@Generated("by GAPIC")
@BetaApi
public final class ResourceName implements com.google.api.resourcenames.ResourceName {
  ...
  public static ResourceNameFactory<ResourceName> newFactory() {
    return new ResourceNameFactory<ResourceName>() {
      public ResourceName parse(String formattedString) {return ResourceName.parse(formattedString);}
    };
  }

  public static ResourceName parse(String formattedString) {
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(formattedString, "ResourceName.parse: formattedString not in valid format");
    return of(
  ...
  public static class Builder {
    ...
    public Builder (ResourceName resourceName) {
      project = resourceName.project;
      resource = resourceName.resource;
      zone = resourceName.zone;
    }
