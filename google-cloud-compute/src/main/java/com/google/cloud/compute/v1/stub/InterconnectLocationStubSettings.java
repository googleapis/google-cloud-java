 ...
 * object. For example, to set the total timeout of getInterconnectLocation to 30 seconds:
 *
 * <pre>
 * <code>
...
@BetaApi
public class InterconnectLocationStubSettings extends StubSettings<InterconnectLocationStubSettings> {
  /**
   ...
   */
  public PagedCallSettings<ListInterconnectLocationsHttpRequest, InterconnectLocationList, ListInterconnectLocationsPagedResponse> listInterconnectLocationsSettings() {
  ...
  private static final PagedListDescriptor<ListInterconnectLocationsHttpRequest, InterconnectLocationList, InterconnectLocation> LIST_INTERCONNECT_LOCATIONS_PAGE_STR_DESC =
      new PagedListDescriptor<ListInterconnectLocationsHttpRequest, InterconnectLocationList, InterconnectLocation>() {
        @Override
  ...
  private static final PagedListResponseFactory<ListInterconnectLocationsHttpRequest, InterconnectLocationList, ListInterconnectLocationsPagedResponse> LIST_INTERCONNECT_LOCATIONS_PAGE_STR_FACT =
      new PagedListResponseFactory<ListInterconnectLocationsHttpRequest, InterconnectLocationList, ListInterconnectLocationsPagedResponse>() {
        @Override
        public ApiFuture<ListInterconnectLocationsPagedResponse> getFuturePagedResponse(
            UnaryCallable<ListInterconnectLocationsHttpRequest, InterconnectLocationList> callable,
            ListInterconnectLocationsHttpRequest request,
            ApiCallContext context,
            ApiFuture<InterconnectLocationList> futureResponse) {
          PageContext<ListInterconnectLocationsHttpRequest, InterconnectLocationList, InterconnectLocation> pageContext =
   ...
   */
  public static class Builder extends StubSettings.Builder<InterconnectLocationStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<ListInterconnectLocationsHttpRequest, InterconnectLocationList, ListInterconnectLocationsPagedResponse> listInterconnectLocationsSettings;
     ...
     */
    public PagedCallSettings.Builder<ListInterconnectLocationsHttpRequest, InterconnectLocationList, ListInterconnectLocationsPagedResponse> listInterconnectLocationsSettings() {
      return listInterconnectLocationsSettings;
    }
