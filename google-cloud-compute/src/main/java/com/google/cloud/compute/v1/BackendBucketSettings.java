 ...
 * object. For example, to set the total timeout of deleteBackendBucket to 30 seconds:
 *
 * <pre>
 * <code>
...
public class BackendBucketSettings extends ClientSettings<BackendBucketSettings> {
   ...
   */
  public PagedCallSettings<ListBackendBucketsHttpRequest, BackendBucketList, ListBackendBucketsPagedResponse> listBackendBucketsSettings() {
  ...
  public static class Builder extends ClientSettings.Builder<BackendBucketSettings, Builder> {
     ...
     */
    public PagedCallSettings.Builder<ListBackendBucketsHttpRequest, BackendBucketList, ListBackendBucketsPagedResponse> listBackendBucketsSettings() {
