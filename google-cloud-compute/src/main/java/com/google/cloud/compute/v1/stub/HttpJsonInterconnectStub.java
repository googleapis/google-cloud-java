...
public class HttpJsonInterconnectStub extends InterconnectStub {
  @InternalApi
  public static final ApiMethodDescriptor<DeleteInterconnectHttpRequest, Operation> deleteInterconnectMethodDescriptor =
      ApiMethodDescriptor.<DeleteInterconnectHttpRequest, Operation>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<GetInterconnectHttpRequest, Interconnect> getInterconnectMethodDescriptor =
      ApiMethodDescriptor.<GetInterconnectHttpRequest, Interconnect>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<InsertInterconnectHttpRequest, Operation> insertInterconnectMethodDescriptor =
      ApiMethodDescriptor.<InsertInterconnectHttpRequest, Operation>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<ListInterconnectsHttpRequest, InterconnectList> listInterconnectsMethodDescriptor =
      ApiMethodDescriptor.<ListInterconnectsHttpRequest, InterconnectList>newBuilder()
          ...
          .build();
  @InternalApi
  public static final ApiMethodDescriptor<PatchInterconnectHttpRequest, Operation> patchInterconnectMethodDescriptor =
  ...
  private final UnaryCallable<ListInterconnectsHttpRequest, ListInterconnectsPagedResponse> listInterconnectsPagedCallable;
  ...
  /**
   * Constructs an instance of HttpJsonInterconnectStub, using the given settings.
  ...
  protected HttpJsonInterconnectStub(InterconnectStubSettings settings, ClientContext clientContext, HttpJsonStubCallableFactory callableFactory) throws IOException {
    ...
    HttpJsonCallSettings<DeleteInterconnectHttpRequest, Operation> deleteInterconnectTransportSettings =
        HttpJsonCallSettings.<DeleteInterconnectHttpRequest, Operation>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<GetInterconnectHttpRequest, Interconnect> getInterconnectTransportSettings =
        HttpJsonCallSettings.<GetInterconnectHttpRequest, Interconnect>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<InsertInterconnectHttpRequest, Operation> insertInterconnectTransportSettings =
        HttpJsonCallSettings.<InsertInterconnectHttpRequest, Operation>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<ListInterconnectsHttpRequest, InterconnectList> listInterconnectsTransportSettings =
        HttpJsonCallSettings.<ListInterconnectsHttpRequest, InterconnectList>newBuilder()
            ...
            .build();
    HttpJsonCallSettings<PatchInterconnectHttpRequest, Operation> patchInterconnectTransportSettings =
