...
public final class TemporalAsset extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TemporalAsset(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetWindowFieldBuilder().getBuilder(), extensionRegistry);
