...
```Groovy
compile 'com.google.cloud:google-cloud-asset:0.64.0-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-asset" % "0.64.0-beta"
```
...
[asset-lib-docs]: https://googlecloudplatform.github.io/google-cloud-java/google-cloud-clients/apidocs/index.html?com/google/cloud/asset/v1beta1/package-summary.html
