...
public final class IamPolicyAnalysisQuery extends com.google.protobuf.GeneratedMessageV3
  ...
  public interface OptionsOrBuilder
     ...
     * </pre>
     *
     * <code>int32 max_fanouts_per_group = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
     *
     * @return The maxFanoutsPerGroup.
     */
    int getMaxFanoutsPerGroup();
     ...
     * </pre>
     *
     * <code>int32 max_fanouts_per_resource = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
     *
     * @return The maxFanoutsPerResource.
     */
    int getMaxFanoutsPerResource();
  }
  /**
   *
   *
  ...
  public static final class Options extends com.google.protobuf.GeneratedMessageV3
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 56:
              {
                maxFanoutsPerGroup_ = input.readInt32();
                break;
              }
            case 64:
              {
                maxFanoutsPerResource_ = input.readInt32();
                break;
              }
            default:
              {
    ...
    public static final int MAX_FANOUTS_PER_GROUP_FIELD_NUMBER = 7;
     ...
     */
    @java.lang.Override
    public int getMaxFanoutsPerGroup() {
      return maxFanoutsPerGroup_;
    }

    public static final int MAX_FANOUTS_PER_RESOURCE_FIELD_NUMBER = 8;
     ...
     */
    @java.lang.Override
    public int getMaxFanoutsPerResource() {
      return maxFanoutsPerResource_;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (maxFanoutsPerGroup_ != 0) {
        output.writeInt32(7, maxFanoutsPerGroup_);
      }
      if (maxFanoutsPerResource_ != 0) {
        output.writeInt32(8, maxFanoutsPerResource_);
      }
      unknownFields.writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (maxFanoutsPerGroup_ != 0) {
        size += com.google.protobuf.CodedOutputStream.computeInt32Size(7, maxFanoutsPerGroup_);
      }
      if (maxFanoutsPerResource_ != 0) {
        size += com.google.protobuf.CodedOutputStream.computeInt32Size(8, maxFanoutsPerResource_);
      }
      size += unknownFields.getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (getAnalyzeServiceAccountImpersonation() != other.getAnalyzeServiceAccountImpersonation())
        return false;
      if (getMaxFanoutsPerGroup() != other.getMaxFanoutsPerGroup()) return false;
      if (getMaxFanoutsPerResource() != other.getMaxFanoutsPerResource()) return false;
      if (!unknownFields.equals(other.unknownFields)) return false;
      return true;
    }
    ...
    public int hashCode() {
      ...
      hash = (53 * hash) + getMaxFanoutsPerGroup();
      hash = (37 * hash) + MAX_FANOUTS_PER_RESOURCE_FIELD_NUMBER;
      hash = (53 * hash) + getMaxFanoutsPerResource();
      hash = (29 * hash) + unknownFields.hashCode();
      memoizedHashCode = hash;
      return hash;
    }
    ...
    public static final class Builder
      ...
      public Builder clear() {
        ...
        maxFanoutsPerGroup_ = 0;

        maxFanoutsPerResource_ = 0;
      ...
      public com.google.cloud.asset.v1.IamPolicyAnalysisQuery.Options buildPartial() {
        ...
        result.maxFanoutsPerGroup_ = maxFanoutsPerGroup_;
        result.maxFanoutsPerResource_ = maxFanoutsPerResource_;
        onBuilt();
        return result;
      }
      ...
      public Builder mergeFrom(com.google.cloud.asset.v1.IamPolicyAnalysisQuery.Options other) {
        ...
        if (other.getMaxFanoutsPerGroup() != 0) {
          setMaxFanoutsPerGroup(other.getMaxFanoutsPerGroup());
        }
        if (other.getMaxFanoutsPerResource() != 0) {
          setMaxFanoutsPerResource(other.getMaxFanoutsPerResource());
        }
        this.mergeUnknownFields(other.unknownFields);
        onChanged();
        return this;
       ...
       * <code>int32 max_fanouts_per_group = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
       *
       * @param value The maxFanoutsPerGroup to set.
       * @return This builder for chaining.
       */
      public Builder setMaxFanoutsPerGroup(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMaxFanoutsPerGroup() {
       ...
       * <code>int32 max_fanouts_per_resource = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
       *
       * @param value The maxFanoutsPerResource to set.
       * @return This builder for chaining.
       */
      public Builder setMaxFanoutsPerResource(int value) {
       ...
       * @return This builder for chaining.
       */
      public Builder clearMaxFanoutsPerResource() {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeOptions(com.google.cloud.asset.v1.IamPolicyAnalysisQuery.Options value) {
      if (optionsBuilder_ == null) {
        if (options_ != null) {
          options_ =
              com.google.cloud.asset.v1.IamPolicyAnalysisQuery.Options.newBuilder(options_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          options_ = value;
