...
/**
 * Settings class to configure an instance of {@link ZoneVmExtensionPoliciesClient}.
 *
...
public class ZoneVmExtensionPoliciesSettings
  ...
  public UnaryCallSettings<DeleteZoneVmExtensionPolicyRequest, Operation> deleteSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).deleteSettings();
  }

  /** Returns the object with the settings used for calls to delete. */
  public OperationCallSettings<DeleteZoneVmExtensionPolicyRequest, Operation, Operation>
      deleteOperationSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).deleteOperationSettings();
  }

  /** Returns the object with the settings used for calls to get. */
  public UnaryCallSettings<GetZoneVmExtensionPolicyRequest, VmExtensionPolicy> getSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).getSettings();
  }

  /** Returns the object with the settings used for calls to insert. */
  public UnaryCallSettings<InsertZoneVmExtensionPolicyRequest, Operation> insertSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).insertSettings();
  }

  /** Returns the object with the settings used for calls to insert. */
  public OperationCallSettings<InsertZoneVmExtensionPolicyRequest, Operation, Operation>
      insertOperationSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).insertOperationSettings();
  }
  ...
  public PagedCallSettings<
      ...
      listSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).listSettings();
  }

  /** Returns the object with the settings used for calls to update. */
  public UnaryCallSettings<UpdateZoneVmExtensionPolicyRequest, Operation> updateSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).updateSettings();
  }

  /** Returns the object with the settings used for calls to update. */
  public OperationCallSettings<UpdateZoneVmExtensionPolicyRequest, Operation, Operation>
      updateOperationSettings() {
    return ((ZoneVmExtensionPoliciesStubSettings) getStubSettings()).updateOperationSettings();
  }

  public static final ZoneVmExtensionPoliciesSettings create(
      ZoneVmExtensionPoliciesStubSettings stub) throws IOException {
    return new ZoneVmExtensionPoliciesSettings.Builder(stub.toBuilder()).build();
  }

  /** Returns a builder for the default ExecutorProvider for this service. */
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return ZoneVmExtensionPoliciesStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return ZoneVmExtensionPoliciesStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return ZoneVmExtensionPoliciesStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return ZoneVmExtensionPoliciesStubSettings.defaultCredentialsProviderBuilder();
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ZoneVmExtensionPoliciesStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected ZoneVmExtensionPoliciesSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for ZoneVmExtensionPoliciesSettings. */
  public static class Builder
      extends ClientSettings.Builder<ZoneVmExtensionPoliciesSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(ZoneVmExtensionPoliciesStubSettings.newBuilder(clientContext));
    }

    protected Builder(ZoneVmExtensionPoliciesSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(ZoneVmExtensionPoliciesStubSettings.Builder stubSettings) {
      super(stubSettings);
    }

    private static Builder createDefault() {
      return new Builder(ZoneVmExtensionPoliciesStubSettings.newBuilder());
    }

    public ZoneVmExtensionPoliciesStubSettings.Builder getStubSettingsBuilder() {
      return ((ZoneVmExtensionPoliciesStubSettings.Builder) getStubSettings());
    }
    ...
    @Override
    public ZoneVmExtensionPoliciesSettings build() throws IOException {
      return new ZoneVmExtensionPoliciesSettings(this);
    }
  }
}
