 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         regionNetworkEndpointGroupsSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionNetworkEndpointGroupsSettings regionNetworkEndpointGroupsSettings = regionNetworkEndpointGroupsSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionNetworkEndpointGroupsSettings
  ...
  public static int getDefaultServicePort() {
    return RegionNetworkEndpointGroupsStubSettings.getDefaultServicePort();
  }
