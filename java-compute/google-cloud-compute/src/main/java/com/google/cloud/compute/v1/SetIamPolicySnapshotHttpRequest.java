...
public final class SetIamPolicySnapshotHttpRequest implements ApiMessage {
  ...
  private SetIamPolicySnapshotHttpRequest() {
  ...
  public static Builder newBuilder(SetIamPolicySnapshotHttpRequest prototype) {
  ...
  public static SetIamPolicySnapshotHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicySnapshotHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicySnapshotHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicySnapshotHttpRequest other) {
      if (other == SetIamPolicySnapshotHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicySnapshotHttpRequest source) {
    ...
    public SetIamPolicySnapshotHttpRequest build() {
      ...
      return new SetIamPolicySnapshotHttpRequest(
          access_token,
          callback,
          fields,
  ...
  public String toString() {
    return "SetIamPolicySnapshotHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicySnapshotHttpRequest) {
      SetIamPolicySnapshotHttpRequest that = (SetIamPolicySnapshotHttpRequest) o;
