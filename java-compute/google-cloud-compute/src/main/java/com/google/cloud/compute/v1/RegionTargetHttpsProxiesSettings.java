 ...
 *             .build());
 * RegionTargetHttpsProxiesSettings regionTargetHttpsProxiesSettings = regionTargetHttpsProxiesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionTargetHttpsProxiesSettings
  ...
  public static int getDefaultServicePort() {
    return RegionTargetHttpsProxiesStubSettings.getDefaultServicePort();
  }
