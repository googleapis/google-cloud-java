 ...
 *    <tr>
 *      <td><p> Patch</td>
 *      <td><p> Updates the specified firewall rule with the data included in the request. This method supportsPATCH semantics and uses theJSON merge patch format and processing rules.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> testIamPermissions(TestIamPermissionsFirewallRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
...
public class FirewallsClient implements BackgroundResource {
  private final @Nullable FirewallsSettings settings;
  ...
  public final @Nullable FirewallsSettings getSettings() {
    return settings;
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<TestIamPermissionsFirewallRequest, TestPermissionsResponse>
  ...
  public static class ListPage
    ...
    private ListPage(
        @Nullable PageContext<ListFirewallsRequest, FirewallList, Firewall> context,
        @Nullable FirewallList response) {
