 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         regionHealthCheckServicesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionHealthCheckServicesSettings regionHealthCheckServicesSettings = regionHealthCheckServicesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionHealthCheckServicesSettings
  ...
  public static int getDefaultServicePort() {
    return RegionHealthCheckServicesStubSettings.getDefaultServicePort();
  }
