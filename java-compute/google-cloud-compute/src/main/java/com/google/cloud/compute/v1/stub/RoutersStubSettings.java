 ...
 * <pre>
 * <code>
 * RoutersStubSettings.Builder routersSettingsBuilder =
...
public class RoutersStubSettings extends StubSettings<RoutersStubSettings> {
  ...
  private static final PagedListDescriptor<
          AggregatedListRoutersRequest, RouterAggregatedList, Entry<String, RoutersScopedList>>
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<Entry<String, RoutersScopedList>> extractResources(
                RouterAggregatedList payload) {
              return payload.getItemsMap() != null
                  ? payload.getItemsMap().entrySet()
                  : ImmutableList.<Entry<String, RoutersScopedList>>of();
            }
          };
