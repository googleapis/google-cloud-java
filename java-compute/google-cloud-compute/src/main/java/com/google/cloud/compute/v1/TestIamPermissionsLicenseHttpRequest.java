...
public final class TestIamPermissionsLicenseHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsLicenseHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsLicenseHttpRequest prototype) {
  ...
  public static TestIamPermissionsLicenseHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsLicenseHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsLicenseHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsLicenseHttpRequest other) {
      if (other == TestIamPermissionsLicenseHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsLicenseHttpRequest source) {
    ...
    public TestIamPermissionsLicenseHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsLicenseHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsLicenseHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsLicenseHttpRequest) {
      TestIamPermissionsLicenseHttpRequest that = (TestIamPermissionsLicenseHttpRequest) o;
