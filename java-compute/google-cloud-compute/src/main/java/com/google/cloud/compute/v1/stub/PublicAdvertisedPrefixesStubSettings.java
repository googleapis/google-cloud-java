 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         publicAdvertisedPrefixesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * PublicAdvertisedPrefixesStubSettings publicAdvertisedPrefixesSettings = publicAdvertisedPrefixesSettingsBuilder.build();
 * </code>
 * </pre>
 */
