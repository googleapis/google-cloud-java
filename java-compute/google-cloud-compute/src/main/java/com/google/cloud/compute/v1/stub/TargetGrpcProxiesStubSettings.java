 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         targetGrpcProxiesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * TargetGrpcProxiesStubSettings targetGrpcProxiesSettings = targetGrpcProxiesSettingsBuilder.build();
 * </code>
 * </pre>
 */
