...
public final class ListXpnHostsProjectsHttpRequest implements ApiMessage {
  ...
  private final ProjectsListXpnHostsRequest projectsListXpnHostsRequestResource;
  ...
  private ListXpnHostsProjectsHttpRequest() {
    ...
    this.project = null;
    this.projectsListXpnHostsRequestResource = null;
    this.quotaUser = null;
    this.userIp = null;
  }
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("projectsListXpnHostsRequestResource".equals(fieldName)) {
  ...
  @Nullable
  @Override
  public ProjectsListXpnHostsRequest getApiMessageRequestBody() {
    return projectsListXpnHostsRequestResource;
  }
  ...
  public ProjectsListXpnHostsRequest getProjectsListXpnHostsRequestResource() {
    return projectsListXpnHostsRequestResource;
  }
  ...
  public static class Builder {
    ...
    private ProjectsListXpnHostsRequest projectsListXpnHostsRequestResource;
    private String quotaUser;
    private String userIp;

    Builder() {}

    public Builder mergeFrom(ListXpnHostsProjectsHttpRequest other) {
      if (other == ListXpnHostsProjectsHttpRequest.getDefaultInstance()) return this;
      ...
      if (other.getProjectsListXpnHostsRequestResource() != null) {
        this.projectsListXpnHostsRequestResource = other.projectsListXpnHostsRequestResource;
      }
    ...
    Builder(ListXpnHostsProjectsHttpRequest source) {
      ...
      this.projectsListXpnHostsRequestResource = source.projectsListXpnHostsRequestResource;
    ...
    public Builder clone() {
      ...
      newBuilder.setProjectsListXpnHostsRequestResource(this.projectsListXpnHostsRequestResource);
