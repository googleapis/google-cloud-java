 ...
 *             .build());
 * RegionTargetHttpProxiesSettings regionTargetHttpProxiesSettings = regionTargetHttpProxiesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionTargetHttpProxiesSettings
  ...
  public static int getDefaultServicePort() {
    return RegionTargetHttpProxiesStubSettings.getDefaultServicePort();
  }
