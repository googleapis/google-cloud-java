 ...
 *             .build());
 * InterconnectLocationsSettings interconnectLocationsSettings = interconnectLocationsSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class InterconnectLocationsSettings extends ClientSettings<InterconnectLocationsSettings> {
  ...
  public static int getDefaultServicePort() {
    return InterconnectLocationsStubSettings.getDefaultServicePort();
  }
