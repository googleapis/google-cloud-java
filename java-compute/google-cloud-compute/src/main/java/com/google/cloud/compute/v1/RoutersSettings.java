 ...
 * <pre>
 * <code>
 * RoutersSettings.Builder routersSettingsBuilder =
 *     RoutersSettings.newBuilder();
 * routersSettingsBuilder
 *     .deleteSettings()
 *     .setRetrySettings(
 *         routersSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
...
public class RoutersSettings extends ClientSettings<RoutersSettings> {
  ...
  public static int getDefaultServicePort() {
    return RoutersStubSettings.getDefaultServicePort();
  }
