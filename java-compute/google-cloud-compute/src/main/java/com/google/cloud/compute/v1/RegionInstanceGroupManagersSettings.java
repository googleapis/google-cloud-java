 ...
 *     .setRetrySettings(
 *         regionInstanceGroupManagersSettingsBuilder.abandonInstancesSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionInstanceGroupManagersSettings regionInstanceGroupManagersSettings = regionInstanceGroupManagersSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionInstanceGroupManagersSettings
  ...
  public static int getDefaultServicePort() {
    return RegionInstanceGroupManagersStubSettings.getDefaultServicePort();
  }
