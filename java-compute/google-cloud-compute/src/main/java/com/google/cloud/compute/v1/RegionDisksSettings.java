 ...
 * <pre>
 * <code>
 * RegionDisksSettings.Builder regionDisksSettingsBuilder =
 *     RegionDisksSettings.newBuilder();
 * regionDisksSettingsBuilder
 *     .addResourcePoliciesSettings()
 *     .setRetrySettings(
 *         regionDisksSettingsBuilder.addResourcePoliciesSettings().getRetrySettings().toBuilder()
...
public class RegionDisksSettings extends ClientSettings<RegionDisksSettings> {
  ...
  public static int getDefaultServicePort() {
    return RegionDisksStubSettings.getDefaultServicePort();
  }
