...
public final class ListRegionUrlMapsHttpRequest implements ApiMessage {
  ...
  private ListRegionUrlMapsHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionUrlMapsHttpRequest prototype) {
  ...
  public static ListRegionUrlMapsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionUrlMapsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionUrlMapsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionUrlMapsHttpRequest other) {
      if (other == ListRegionUrlMapsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionUrlMapsHttpRequest source) {
    ...
    public ListRegionUrlMapsHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionUrlMapsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionUrlMapsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionUrlMapsHttpRequest) {
      ListRegionUrlMapsHttpRequest that = (ListRegionUrlMapsHttpRequest) o;
