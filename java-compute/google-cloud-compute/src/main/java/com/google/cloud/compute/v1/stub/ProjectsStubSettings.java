 ...
 * <pre>
 * <code>
 * ProjectsStubSettings.Builder projectsSettingsBuilder =
 *     ProjectsStubSettings.newBuilder();
 * projectsSettingsBuilder
 *     .disableXpnHostSettings()
 *     .setRetrySettings(
 *         projectsSettingsBuilder.disableXpnHostSettings().getRetrySettings().toBuilder()
