...
public final class TestIamPermissionsSnapshotHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(TestIamPermissionsSnapshotHttpRequest prototype) {
  ...
  private static final TestIamPermissionsSnapshotHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsSnapshotHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsSnapshotHttpRequest other) {
      if (other == TestIamPermissionsSnapshotHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsSnapshotHttpRequest source) {
    ...
    public TestIamPermissionsSnapshotHttpRequest build() {
      ...
      return new TestIamPermissionsSnapshotHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsSnapshotHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsSnapshotHttpRequest) {
      TestIamPermissionsSnapshotHttpRequest that = (TestIamPermissionsSnapshotHttpRequest) o;
