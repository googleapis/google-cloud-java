 ...
 *             .build());
 * PublicAdvertisedPrefixesSettings publicAdvertisedPrefixesSettings = publicAdvertisedPrefixesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class PublicAdvertisedPrefixesSettings
  ...
  public static int getDefaultServicePort() {
    return PublicAdvertisedPrefixesStubSettings.getDefaultServicePort();
  }
