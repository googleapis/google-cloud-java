...
/**
 * Settings class to configure an instance of {@link AdviceStub}.
 *
...
public class AdviceStubSettings extends StubSettings<AdviceStubSettings> {
  ...
  public AdviceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonAdviceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken("gapic", GaxProperties.getLibraryVersion(AdviceStubSettings.class))
        .setTransportToken(
  ...
  protected AdviceStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    calendarModeSettings = settingsBuilder.calendarModeSettings().build();
  }

  /** Builder for AdviceStubSettings. */
  public static class Builder extends StubSettings.Builder<AdviceStubSettings, Builder> {
    ...
    protected Builder(AdviceStubSettings settings) {
      super(settings);
    ...
    @Override
    public AdviceStubSettings build() throws IOException {
      return new AdviceStubSettings(this);
    }
  }
}
