 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         regionHealthChecksSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionHealthChecksSettings regionHealthChecksSettings = regionHealthChecksSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionHealthChecksSettings extends ClientSettings<RegionHealthChecksSettings> {
  ...
  public static int getDefaultServicePort() {
    return RegionHealthChecksStubSettings.getDefaultServicePort();
  }
