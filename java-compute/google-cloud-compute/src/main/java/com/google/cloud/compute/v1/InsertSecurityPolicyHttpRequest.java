...
public final class InsertSecurityPolicyHttpRequest implements ApiMessage {
  ...
  private InsertSecurityPolicyHttpRequest() {
  ...
  public static Builder newBuilder(InsertSecurityPolicyHttpRequest prototype) {
  ...
  public static InsertSecurityPolicyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertSecurityPolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertSecurityPolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertSecurityPolicyHttpRequest other) {
      if (other == InsertSecurityPolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(InsertSecurityPolicyHttpRequest source) {
    ...
    public InsertSecurityPolicyHttpRequest build() {
      ...
      return new InsertSecurityPolicyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "InsertSecurityPolicyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertSecurityPolicyHttpRequest) {
      InsertSecurityPolicyHttpRequest that = (InsertSecurityPolicyHttpRequest) o;
