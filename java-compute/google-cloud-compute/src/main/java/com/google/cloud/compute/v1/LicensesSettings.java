 ...
 * <pre>
 * <code>
 * LicensesSettings.Builder licensesSettingsBuilder =
 *     LicensesSettings.newBuilder();
 * licensesSettingsBuilder
 *     .deleteSettings()
 *     .setRetrySettings(
 *         licensesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
...
public class LicensesSettings extends ClientSettings<LicensesSettings> {
  ...
  public static int getDefaultServicePort() {
    return LicensesStubSettings.getDefaultServicePort();
  }
