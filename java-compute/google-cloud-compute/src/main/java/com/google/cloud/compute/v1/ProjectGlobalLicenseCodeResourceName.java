...
public final class ProjectGlobalLicenseCodeResourceName implements ResourceName {
  ...
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("{project}/global/licenseCodes/{resource}");
  ...
  public static ResourceNameFactory<ProjectGlobalLicenseCodeResourceName> newFactory() {
    return new ResourceNameFactory<ProjectGlobalLicenseCodeResourceName>() {
      public ProjectGlobalLicenseCodeResourceName parse(String formattedString) {
        return ProjectGlobalLicenseCodeResourceName.parse(formattedString);
      }
    };
  }
  ...
  public static ProjectGlobalLicenseCodeResourceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(
            resourcePath,
            "ProjectGlobalLicenseCodeResourceName.parse: formattedString not in valid format");
  ...
  public static class Builder {
    ...
    public Builder(ProjectGlobalLicenseCodeResourceName projectGlobalLicenseCodeResourceName) {
      project = projectGlobalLicenseCodeResourceName.project;
      resource = projectGlobalLicenseCodeResourceName.resource;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ProjectGlobalLicenseCodeResourceName) {
      ProjectGlobalLicenseCodeResourceName that = (ProjectGlobalLicenseCodeResourceName) o;
