 ...
 *             .build());
 * PublicDelegatedPrefixesSettings publicDelegatedPrefixesSettings = publicDelegatedPrefixesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class PublicDelegatedPrefixesSettings
  ...
  public static int getDefaultServicePort() {
    return PublicDelegatedPrefixesStubSettings.getDefaultServicePort();
  }
