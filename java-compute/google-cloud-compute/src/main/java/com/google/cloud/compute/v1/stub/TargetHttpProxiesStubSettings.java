 ...
 *             .build());
 * TargetHttpProxiesStubSettings targetHttpProxiesSettings = targetHttpProxiesSettingsBuilder.build();
 * </code>
 * </pre>
 */
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<Entry<String, TargetHttpProxiesScopedList>> extractResources(
                TargetHttpProxyAggregatedList payload) {
              return payload.getItemsMap() != null
                  ? payload.getItemsMap().entrySet()
                  : ImmutableList.<Entry<String, TargetHttpProxiesScopedList>>of();
            }
          };
