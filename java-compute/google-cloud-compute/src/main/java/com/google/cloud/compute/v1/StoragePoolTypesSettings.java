...
/**
 * Settings class to configure an instance of {@link StoragePoolTypesClient}.
 *
...
public class StoragePoolTypesSettings extends ClientSettings<StoragePoolTypesSettings> {
  ...
  public static final StoragePoolTypesSettings create(StoragePoolTypesStubSettings stub)
      throws IOException {
    return new StoragePoolTypesSettings.Builder(stub.toBuilder()).build();
  }
  ...
  protected StoragePoolTypesSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<StoragePoolTypesSettings, Builder> {
    ...
    protected Builder(StoragePoolTypesSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(StoragePoolTypesStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    @Override
    public StoragePoolTypesSettings build() throws IOException {
