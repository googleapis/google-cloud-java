 ...
 *             .build());
 * ExternalVpnGatewaysSettings externalVpnGatewaysSettings = externalVpnGatewaysSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class ExternalVpnGatewaysSettings extends ClientSettings<ExternalVpnGatewaysSettings> {
  ...
  public static int getDefaultServicePort() {
    return ExternalVpnGatewaysStubSettings.getDefaultServicePort();
  }
