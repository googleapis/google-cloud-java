 ...
 * <pre>
 * <code>
 * UrlMapsSettings.Builder urlMapsSettingsBuilder =
 *     UrlMapsSettings.newBuilder();
 * urlMapsSettingsBuilder
 *     .deleteSettings()
 *     .setRetrySettings(
 *         urlMapsSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
...
public class UrlMapsSettings extends ClientSettings<UrlMapsSettings> {
  ...
  public static int getDefaultServicePort() {
    return UrlMapsStubSettings.getDefaultServicePort();
  }
