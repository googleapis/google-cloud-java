...
public final class GetRuleSecurityPolicyHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(GetRuleSecurityPolicyHttpRequest prototype) {
  ...
  private static final GetRuleSecurityPolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetRuleSecurityPolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetRuleSecurityPolicyHttpRequest other) {
      if (other == GetRuleSecurityPolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetRuleSecurityPolicyHttpRequest source) {
    ...
    public GetRuleSecurityPolicyHttpRequest build() {
      ...
      return new GetRuleSecurityPolicyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "GetRuleSecurityPolicyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetRuleSecurityPolicyHttpRequest) {
      GetRuleSecurityPolicyHttpRequest that = (GetRuleSecurityPolicyHttpRequest) o;
