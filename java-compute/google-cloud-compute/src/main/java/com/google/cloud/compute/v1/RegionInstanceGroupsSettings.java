 ...
 *             .build());
 * RegionInstanceGroupsSettings regionInstanceGroupsSettings = regionInstanceGroupsSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionInstanceGroupsSettings extends ClientSettings<RegionInstanceGroupsSettings> {
  ...
  public static int getDefaultServicePort() {
    return RegionInstanceGroupsStubSettings.getDefaultServicePort();
  }
