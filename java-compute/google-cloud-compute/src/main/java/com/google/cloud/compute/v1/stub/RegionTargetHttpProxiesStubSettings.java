...
/**
 * Settings class to configure an instance of {@link RegionTargetHttpProxiesStub}.
 *
...
public class RegionTargetHttpProxiesStubSettings
    extends StubSettings<RegionTargetHttpProxiesStubSettings> {
  ...
  private final UnaryCallSettings<DeleteRegionTargetHttpProxyRequest, Operation> deleteSettings;
  private final OperationCallSettings<DeleteRegionTargetHttpProxyRequest, Operation, Operation>
      deleteOperationSettings;
  private final UnaryCallSettings<GetRegionTargetHttpProxyRequest, TargetHttpProxy> getSettings;
  private final UnaryCallSettings<InsertRegionTargetHttpProxyRequest, Operation> insertSettings;
  private final OperationCallSettings<InsertRegionTargetHttpProxyRequest, Operation, Operation>
      insertOperationSettings;
  private final PagedCallSettings<
          ListRegionTargetHttpProxiesRequest, TargetHttpProxyList, ListPagedResponse>
      listSettings;
  private final UnaryCallSettings<SetUrlMapRegionTargetHttpProxyRequest, Operation>
      setUrlMapSettings;
  private final OperationCallSettings<SetUrlMapRegionTargetHttpProxyRequest, Operation, Operation>
      setUrlMapOperationSettings;

  private static final PagedListDescriptor<
          ListRegionTargetHttpProxiesRequest, TargetHttpProxyList, TargetHttpProxy>
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListRegionTargetHttpProxiesRequest injectToken(
                ListRegionTargetHttpProxiesRequest payload, String token) {
              return ListRegionTargetHttpProxiesRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListRegionTargetHttpProxiesRequest injectPageSize(
                ListRegionTargetHttpProxiesRequest payload, int pageSize) {
              return ListRegionTargetHttpProxiesRequest.newBuilder(payload)
            ...
            @Override
            public Integer extractPageSize(ListRegionTargetHttpProxiesRequest payload) {
      ...
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListRegionTargetHttpProxiesRequest, TargetHttpProxyList> callable,
  ...
  public RegionTargetHttpProxiesStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonRegionTargetHttpProxiesStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(RegionTargetHttpProxiesStubSettings.class))
        .setTransportToken(
  ...
  protected RegionTargetHttpProxiesStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<RegionTargetHttpProxiesStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<DeleteRegionTargetHttpProxyRequest, Operation>
        deleteSettings;
    private final OperationCallSettings.Builder<
            DeleteRegionTargetHttpProxyRequest, Operation, Operation>
        deleteOperationSettings;
    private final UnaryCallSettings.Builder<GetRegionTargetHttpProxyRequest, TargetHttpProxy>
        getSettings;
    private final UnaryCallSettings.Builder<InsertRegionTargetHttpProxyRequest, Operation>
        insertSettings;
    private final OperationCallSettings.Builder<
            InsertRegionTargetHttpProxyRequest, Operation, Operation>
        insertOperationSettings;
    private final PagedCallSettings.Builder<
            ListRegionTargetHttpProxiesRequest, TargetHttpProxyList, ListPagedResponse>
        listSettings;
    private final UnaryCallSettings.Builder<SetUrlMapRegionTargetHttpProxyRequest, Operation>
        setUrlMapSettings;
    private final OperationCallSettings.Builder<
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              deleteSettings, getSettings, insertSettings, listSettings, setUrlMapSettings);
      initDefaults(this);
    }

    protected Builder(RegionTargetHttpProxiesStubSettings settings) {
      super(settings);
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteRegionTargetHttpProxyRequest, OperationSnapshot>
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertRegionTargetHttpProxyRequest, OperationSnapshot>
                      newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<SetUrlMapRegionTargetHttpProxyRequest, OperationSnapshot>
                      newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
    ...
    @Override
    public RegionTargetHttpProxiesStubSettings build() throws IOException {
      return new RegionTargetHttpProxiesStubSettings(this);
    }
  }
}
