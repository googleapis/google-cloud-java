 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         regionTargetHttpProxiesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionTargetHttpProxiesStubSettings regionTargetHttpProxiesSettings = regionTargetHttpProxiesSettingsBuilder.build();
 * </code>
 * </pre>
 */
