...
/**
 * Settings class to configure an instance of {@link RegionHealthSourcesClient}.
 *
...
public class RegionHealthSourcesSettings extends ClientSettings<RegionHealthSourcesSettings> {
  ...
  public PagedCallSettings<
    ...
    return ((RegionHealthSourcesStubSettings) getStubSettings()).aggregatedListSettings();
  }

  /** Returns the object with the settings used for calls to delete. */
  public UnaryCallSettings<DeleteRegionHealthSourceRequest, Operation> deleteSettings() {
    return ((RegionHealthSourcesStubSettings) getStubSettings()).deleteSettings();
  }

  /** Returns the object with the settings used for calls to delete. */
  public OperationCallSettings<DeleteRegionHealthSourceRequest, Operation, Operation>
      deleteOperationSettings() {
    return ((RegionHealthSourcesStubSettings) getStubSettings()).deleteOperationSettings();
  }
  ...
  public OperationCallSettings<InsertRegionHealthSourceRequest, Operation, Operation>
    ...
    return ((RegionHealthSourcesStubSettings) getStubSettings()).insertOperationSettings();
  }

  /** Returns the object with the settings used for calls to list. */
  public PagedCallSettings<ListRegionHealthSourcesRequest, HealthSourceList, ListPagedResponse>
      listSettings() {
    return ((RegionHealthSourcesStubSettings) getStubSettings()).listSettings();
  }

  /** Returns the object with the settings used for calls to patch. */
  public UnaryCallSettings<PatchRegionHealthSourceRequest, Operation> patchSettings() {
    return ((RegionHealthSourcesStubSettings) getStubSettings()).patchSettings();
  }

  /** Returns the object with the settings used for calls to patch. */
  public OperationCallSettings<PatchRegionHealthSourceRequest, Operation, Operation>
      patchOperationSettings() {
    return ((RegionHealthSourcesStubSettings) getStubSettings()).patchOperationSettings();
  }

  /** Returns the object with the settings used for calls to testIamPermissions. */
  public UnaryCallSettings<TestIamPermissionsRegionHealthSourceRequest, TestPermissionsResponse>
      testIamPermissionsSettings() {
    return ((RegionHealthSourcesStubSettings) getStubSettings()).testIamPermissionsSettings();
  }

  public static final RegionHealthSourcesSettings create(RegionHealthSourcesStubSettings stub)
      throws IOException {
    return new RegionHealthSourcesSettings.Builder(stub.toBuilder()).build();
  }

  /** Returns a builder for the default ExecutorProvider for this service. */
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return RegionHealthSourcesStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return RegionHealthSourcesStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return RegionHealthSourcesStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return RegionHealthSourcesStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default ChannelProvider for this service. */
  public static InstantiatingHttpJsonChannelProvider.Builder
      defaultHttpJsonTransportProviderBuilder() {
    return RegionHealthSourcesStubSettings.defaultHttpJsonTransportProviderBuilder();
  }

  public static TransportChannelProvider defaultTransportChannelProvider() {
    return RegionHealthSourcesStubSettings.defaultTransportChannelProvider();
  }

  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return RegionHealthSourcesStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected RegionHealthSourcesSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for RegionHealthSourcesSettings. */
  public static class Builder extends ClientSettings.Builder<RegionHealthSourcesSettings, Builder> {
    ...
    protected Builder(RegionHealthSourcesSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(RegionHealthSourcesStubSettings.Builder stubSettings) {
      super(stubSettings);
    }

    private static Builder createDefault() {
      return new Builder(RegionHealthSourcesStubSettings.newBuilder());
    }

    public RegionHealthSourcesStubSettings.Builder getStubSettingsBuilder() {
      return ((RegionHealthSourcesStubSettings.Builder) getStubSettings());
    }
    ...
    @Override
    public RegionHealthSourcesSettings build() throws IOException {
      return new RegionHealthSourcesSettings(this);
    }
  }
}
