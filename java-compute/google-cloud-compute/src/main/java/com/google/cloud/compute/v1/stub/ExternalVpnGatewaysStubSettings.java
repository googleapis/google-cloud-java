 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         externalVpnGatewaysSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * ExternalVpnGatewaysStubSettings externalVpnGatewaysSettings = externalVpnGatewaysSettingsBuilder.build();
 * </code>
 * </pre>
 */
