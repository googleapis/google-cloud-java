...
public final class InsertFirewallHttpRequest implements ApiMessage {
  ...
  private InsertFirewallHttpRequest() {
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("firewallResource".equals(fieldName)) {
  ...
  public static Builder newBuilder(InsertFirewallHttpRequest prototype) {
  ...
  public static InsertFirewallHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertFirewallHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertFirewallHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertFirewallHttpRequest other) {
      if (other == InsertFirewallHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(InsertFirewallHttpRequest source) {
    ...
    public InsertFirewallHttpRequest build() {
      String missing = "";
      ...
      return new InsertFirewallHttpRequest(
          access_token,
          callback,
          fields,
          firewallResource,
  ...
  public String toString() {
    return "InsertFirewallHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertFirewallHttpRequest) {
      InsertFirewallHttpRequest that = (InsertFirewallHttpRequest) o;
