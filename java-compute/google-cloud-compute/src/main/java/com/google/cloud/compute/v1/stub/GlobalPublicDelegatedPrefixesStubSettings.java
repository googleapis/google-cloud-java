 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         globalPublicDelegatedPrefixesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * GlobalPublicDelegatedPrefixesStubSettings globalPublicDelegatedPrefixesSettings = globalPublicDelegatedPrefixesSettingsBuilder.build();
 * </code>
 * </pre>
 */
