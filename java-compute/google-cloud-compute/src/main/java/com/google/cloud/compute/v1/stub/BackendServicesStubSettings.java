 ...
 *     .setRetrySettings(
 *         backendServicesSettingsBuilder.addSignedUrlKeySettings().getRetrySettings().toBuilder()
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<Entry<String, BackendServicesScopedList>> extractResources(
                BackendServiceAggregatedList payload) {
              return payload.getItemsMap() != null
                  ? payload.getItemsMap().entrySet()
                  : ImmutableList.<Entry<String, BackendServicesScopedList>>of();
            }
          };
