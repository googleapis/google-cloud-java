...
@BetaApi
public class HttpJsonFirewallPoliciesCallableFactory
    implements HttpJsonStubCallableFactory<Operation, GlobalOrganizationOperationsStub> {
  ...
  public <RequestT, ResponseT, MetadataT>
      OperationCallable<RequestT, ResponseT, MetadataT> createOperationCallable(
          ...
          ClientContext clientContext,
          GlobalOrganizationOperationsStub operationsStub) {
