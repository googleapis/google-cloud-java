...
/**
 * Settings class to configure an instance of {@link RolloutsStub}.
 *
...
public class RolloutsStubSettings extends StubSettings<RolloutsStubSettings> {
  ...
  private final UnaryCallSettings<DeleteRolloutRequest, Operation> deleteSettings;
  private final OperationCallSettings<DeleteRolloutRequest, Operation, Operation>
  ...
  private static final PagedListDescriptor<ListRolloutsRequest, RolloutsListResponse, Rollout>
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<ListRolloutsRequest, RolloutsListResponse, Rollout>() {
            @Override
            ...
            public ListRolloutsRequest injectPageSize(ListRolloutsRequest payload, int pageSize) {
              return ListRolloutsRequest.newBuilder(payload).setMaxResults(pageSize).build();
            }
            ...
            @Override
            public String extractNextToken(RolloutsListResponse payload) {
              return payload.getNextPageToken();
            }

            @Override
            public Iterable<Rollout> extractResources(RolloutsListResponse payload) {
      ...
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListRolloutsRequest, RolloutsListResponse> callable,
                ListRolloutsRequest request,
                ApiCallContext context,
                ApiFuture<RolloutsListResponse> futureResponse) {
              PageContext<ListRolloutsRequest, RolloutsListResponse, Rollout> pageContext =
  ...
  public RolloutsStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonRolloutsStub.create(this);
    }
  ...
  public static class Builder extends StubSettings.Builder<RolloutsStubSettings, Builder> {
    ...
    private final OperationCallSettings.Builder<CancelRolloutRequest, Operation, Operation>
        cancelOperationSettings;
    private final UnaryCallSettings.Builder<DeleteRolloutRequest, Operation> deleteSettings;
    private final OperationCallSettings.Builder<DeleteRolloutRequest, Operation, Operation>
        deleteOperationSettings;
    private final UnaryCallSettings.Builder<GetRolloutRequest, Rollout> getSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<CancelRolloutRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteRolloutRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
    ...
    @Override
    public RolloutsStubSettings build() throws IOException {
      return new RolloutsStubSettings(this);
    }
  }
}
