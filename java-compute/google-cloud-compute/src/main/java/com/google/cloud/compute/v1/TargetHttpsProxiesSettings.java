 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         targetHttpsProxiesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * TargetHttpsProxiesSettings targetHttpsProxiesSettings = targetHttpsProxiesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class TargetHttpsProxiesSettings extends ClientSettings<TargetHttpsProxiesSettings> {
  ...
  public static int getDefaultServicePort() {
    return TargetHttpsProxiesStubSettings.getDefaultServicePort();
  }
