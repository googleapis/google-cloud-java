 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         nodeTemplatesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<Entry<String, NodeTemplatesScopedList>> extractResources(
                NodeTemplateAggregatedList payload) {
              return payload.getItemsMap() != null
                  ? payload.getItemsMap().entrySet()
                  : ImmutableList.<Entry<String, NodeTemplatesScopedList>>of();
            }
          };
