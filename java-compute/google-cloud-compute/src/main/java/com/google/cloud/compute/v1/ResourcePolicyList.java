...
@Generated("by GAPIC")
@BetaApi
public final class ResourcePolicyList implements ApiMessage {
  ...
  private static final ResourcePolicyList DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ResourcePolicyList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ResourcePolicyList other) {
      if (other == ResourcePolicyList.getDefaultInstance()) return this;
    ...
    public ResourcePolicyList build() {
      ...
      return new ResourcePolicyList(etag, id, items, kind, nextPageToken, selfLink, warning);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ResourcePolicyList) {
      ...
      return Objects.equals(this.etag, that.getEtag())
  ...
  @Override
  public int hashCode() {
    return Objects.hash(etag, id, items, kind, nextPageToken, selfLink, warning);
  }
}
