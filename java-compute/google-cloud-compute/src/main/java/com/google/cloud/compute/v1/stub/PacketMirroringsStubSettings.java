 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         packetMirroringsSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<Entry<String, PacketMirroringsScopedList>> extractResources(
                PacketMirroringAggregatedList payload) {
              return payload.getItemsMap() != null
                  ? payload.getItemsMap().entrySet()
                  : ImmutableList.<Entry<String, PacketMirroringsScopedList>>of();
            }
          };
