...
/**
 * Settings class to configure an instance of {@link InterconnectRemoteLocationsStub}.
 *
...
public class InterconnectRemoteLocationsStubSettings
  ...
  private final UnaryCallSettings<GetInterconnectRemoteLocationRequest, InterconnectRemoteLocation>
      getSettings;
  ...
  private static final PagedListDescriptor<
      ...
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListInterconnectRemoteLocationsRequest injectToken(
                ListInterconnectRemoteLocationsRequest payload, String token) {
              return ListInterconnectRemoteLocationsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListInterconnectRemoteLocationsRequest injectPageSize(
                ListInterconnectRemoteLocationsRequest payload, int pageSize) {
              return ListInterconnectRemoteLocationsRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<InterconnectRemoteLocation> extractResources(
                InterconnectRemoteLocationList payload) {
              return payload.getItemsList() == null
                  ? ImmutableList.<InterconnectRemoteLocation>of()
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(InterconnectRemoteLocationsStubSettings.class))
        .setTransportToken(
