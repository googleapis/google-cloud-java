 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         regionBackendServicesSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionBackendServicesSettings regionBackendServicesSettings = regionBackendServicesSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionBackendServicesSettings extends ClientSettings<RegionBackendServicesSettings> {
  ...
  public static int getDefaultServicePort() {
    return RegionBackendServicesStubSettings.getDefaultServicePort();
  }
