 ...
 *             .build());
 * InterconnectAttachmentsSettings interconnectAttachmentsSettings = interconnectAttachmentsSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class InterconnectAttachmentsSettings
  ...
  public static int getDefaultServicePort() {
    return InterconnectAttachmentsStubSettings.getDefaultServicePort();
  }
