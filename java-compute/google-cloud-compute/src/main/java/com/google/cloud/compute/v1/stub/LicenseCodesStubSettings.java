...
/**
 * Settings class to configure an instance of {@link LicenseCodesStub}.
 *
...
public class LicenseCodesStubSettings extends StubSettings<LicenseCodesStubSettings> {
  ...
  public LicenseCodesStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return HttpJsonLicenseCodesStub.create(this);
    }
  ...
  protected LicenseCodesStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<LicenseCodesStubSettings, Builder> {
    ...
    protected Builder(LicenseCodesStubSettings settings) {
      super(settings);
    ...
    @Override
    public LicenseCodesStubSettings build() throws IOException {
      return new LicenseCodesStubSettings(this);
    }
  }
}
