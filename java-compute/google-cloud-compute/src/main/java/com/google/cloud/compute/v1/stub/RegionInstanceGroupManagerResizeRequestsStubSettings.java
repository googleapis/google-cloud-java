...
/**
 * Settings class to configure an instance of {@link RegionInstanceGroupManagerResizeRequestsStub}.
 *
...
public class RegionInstanceGroupManagerResizeRequestsStubSettings
    extends StubSettings<RegionInstanceGroupManagerResizeRequestsStubSettings> {
  ...
  private final UnaryCallSettings<CancelRegionInstanceGroupManagerResizeRequestRequest, Operation>
      cancelSettings;
  private final OperationCallSettings<
          CancelRegionInstanceGroupManagerResizeRequestRequest, Operation, Operation>
      cancelOperationSettings;
  private final UnaryCallSettings<DeleteRegionInstanceGroupManagerResizeRequestRequest, Operation>
      deleteSettings;
  private final OperationCallSettings<
  ...
  private final UnaryCallSettings<
      ...
      getSettings;
  private final UnaryCallSettings<InsertRegionInstanceGroupManagerResizeRequestRequest, Operation>
      insertSettings;
  private final OperationCallSettings<
  ...
  private static final PagedListDescriptor<
      ...
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListRegionInstanceGroupManagerResizeRequestsRequest injectToken(
                ListRegionInstanceGroupManagerResizeRequestsRequest payload, String token) {
              return ListRegionInstanceGroupManagerResizeRequestsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListRegionInstanceGroupManagerResizeRequestsRequest injectPageSize(
                ListRegionInstanceGroupManagerResizeRequestsRequest payload, int pageSize) {
              return ListRegionInstanceGroupManagerResizeRequestsRequest.newBuilder(payload)
            ...
            public Integer extractPageSize(
                ListRegionInstanceGroupManagerResizeRequestsRequest payload) {
              return payload.getMaxResults();
            }

            @Override
            public String extractNextToken(
                RegionInstanceGroupManagerResizeRequestsListResponse payload) {
  ...
  public RegionInstanceGroupManagerResizeRequestsStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonRegionInstanceGroupManagerResizeRequestsStub.create(this);
    }
    ...
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            ...
            GaxProperties.getLibraryVersion(
                RegionInstanceGroupManagerResizeRequestsStubSettings.class))
        .setTransportToken(
  ...
  protected RegionInstanceGroupManagerResizeRequestsStubSettings(Builder settingsBuilder)
      throws IOException {
  ...
  /** Builder for RegionInstanceGroupManagerResizeRequestsStubSettings. */
  public static class Builder
      extends StubSettings.Builder<RegionInstanceGroupManagerResizeRequestsStubSettings, Builder> {
    ...
    protected Builder(RegionInstanceGroupManagerResizeRequestsStubSettings settings) {
      super(settings);
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<CancelRegionInstanceGroupManagerResizeRequestRequest, OperationSnapshot>
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteRegionInstanceGroupManagerResizeRequestRequest, OperationSnapshot>
                      newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertRegionInstanceGroupManagerResizeRequestRequest, OperationSnapshot>
                      newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
    ...
    @Override
    public RegionInstanceGroupManagerResizeRequestsStubSettings build() throws IOException {
      return new RegionInstanceGroupManagerResizeRequestsStubSettings(this);
    }
  }
}
