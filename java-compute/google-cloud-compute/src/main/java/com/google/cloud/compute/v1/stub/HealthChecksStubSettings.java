 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         healthChecksSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<Entry<String, HealthChecksScopedList>> extractResources(
                HealthChecksAggregatedList payload) {
              return payload.getItemsMap() != null
                  ? payload.getItemsMap().entrySet()
                  : ImmutableList.<Entry<String, HealthChecksScopedList>>of();
            }
          };
