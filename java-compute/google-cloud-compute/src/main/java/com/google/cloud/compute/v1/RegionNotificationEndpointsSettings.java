 ...
 *     .deleteSettings()
 *     .setRetrySettings(
 *         regionNotificationEndpointsSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
 *             .setTotalTimeout(Duration.ofSeconds(30))
 *             .build());
 * RegionNotificationEndpointsSettings regionNotificationEndpointsSettings = regionNotificationEndpointsSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionNotificationEndpointsSettings
  ...
  public static int getDefaultServicePort() {
    return RegionNotificationEndpointsStubSettings.getDefaultServicePort();
  }
