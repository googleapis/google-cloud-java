...
public final class UpdateBackendServiceHttpRequest implements ApiMessage {
  ...
  private UpdateBackendServiceHttpRequest() {
  ...
  public static Builder newBuilder(UpdateBackendServiceHttpRequest prototype) {
  ...
  private static final UpdateBackendServiceHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new UpdateBackendServiceHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(UpdateBackendServiceHttpRequest other) {
      if (other == UpdateBackendServiceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(UpdateBackendServiceHttpRequest source) {
    ...
    public UpdateBackendServiceHttpRequest build() {
      ...
      return new UpdateBackendServiceHttpRequest(
          access_token,
          backendService,
  ...
  public String toString() {
    return "UpdateBackendServiceHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "backendService="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof UpdateBackendServiceHttpRequest) {
      UpdateBackendServiceHttpRequest that = (UpdateBackendServiceHttpRequest) o;
