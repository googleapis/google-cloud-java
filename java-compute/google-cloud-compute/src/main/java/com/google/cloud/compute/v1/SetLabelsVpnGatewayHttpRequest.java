...
public final class SetLabelsVpnGatewayHttpRequest implements ApiMessage {
  ...
  private SetLabelsVpnGatewayHttpRequest() {
   ...
   * `{project}/regions/{region}/vpnGateways/{resource}/setLabels`. \`{resource}\` must start with a
  ...
  public static Builder newBuilder(SetLabelsVpnGatewayHttpRequest prototype) {
  ...
  public static SetLabelsVpnGatewayHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetLabelsVpnGatewayHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetLabelsVpnGatewayHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetLabelsVpnGatewayHttpRequest other) {
      if (other == SetLabelsVpnGatewayHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetLabelsVpnGatewayHttpRequest source) {
    ...
    /**
     * Name or id of the resource for this request. It must have the format
     * `{project}/regions/{region}/vpnGateways/{resource}/setLabels`. \`{resource}\` must start with
    ...
    public SetLabelsVpnGatewayHttpRequest build() {
      String missing = "";
      ...
      return new SetLabelsVpnGatewayHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetLabelsVpnGatewayHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetLabelsVpnGatewayHttpRequest) {
      SetLabelsVpnGatewayHttpRequest that = (SetLabelsVpnGatewayHttpRequest) o;
