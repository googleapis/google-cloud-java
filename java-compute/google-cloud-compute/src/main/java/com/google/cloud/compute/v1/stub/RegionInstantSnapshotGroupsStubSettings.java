...
/**
 * Settings class to configure an instance of {@link RegionInstantSnapshotGroupsStub}.
 *
...
public class RegionInstantSnapshotGroupsStubSettings
    extends StubSettings<RegionInstantSnapshotGroupsStubSettings> {
  ...
  private final UnaryCallSettings<DeleteRegionInstantSnapshotGroupRequest, Operation>
      deleteSettings;
  private final OperationCallSettings<DeleteRegionInstantSnapshotGroupRequest, Operation, Operation>
      deleteOperationSettings;
  private final UnaryCallSettings<GetRegionInstantSnapshotGroupRequest, InstantSnapshotGroup>
      getSettings;
  private final UnaryCallSettings<GetIamPolicyRegionInstantSnapshotGroupRequest, Policy>
      getIamPolicySettings;
  private final UnaryCallSettings<InsertRegionInstantSnapshotGroupRequest, Operation>
      insertSettings;
  private final OperationCallSettings<InsertRegionInstantSnapshotGroupRequest, Operation, Operation>
      insertOperationSettings;
  private final PagedCallSettings<
          ListRegionInstantSnapshotGroupsRequest, ListInstantSnapshotGroups, ListPagedResponse>
      listSettings;
  private final UnaryCallSettings<SetIamPolicyRegionInstantSnapshotGroupRequest, Policy>
  ...
  private static final PagedListDescriptor<
          ListRegionInstantSnapshotGroupsRequest, ListInstantSnapshotGroups, InstantSnapshotGroup>
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListRegionInstantSnapshotGroupsRequest injectToken(
                ListRegionInstantSnapshotGroupsRequest payload, String token) {
              return ListRegionInstantSnapshotGroupsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListRegionInstantSnapshotGroupsRequest injectPageSize(
                ListRegionInstantSnapshotGroupsRequest payload, int pageSize) {
              return ListRegionInstantSnapshotGroupsRequest.newBuilder(payload)
            ...
            @Override
            public Integer extractPageSize(ListRegionInstantSnapshotGroupsRequest payload) {
              return payload.getMaxResults();
            }

            @Override
            public String extractNextToken(ListInstantSnapshotGroups payload) {
              return payload.getNextPageToken();
            }

            @Override
            public Iterable<InstantSnapshotGroup> extractResources(
                ListInstantSnapshotGroups payload) {
  ...
  public RegionInstantSnapshotGroupsStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonRegionInstantSnapshotGroupsStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(RegionInstantSnapshotGroupsStubSettings.class))
        .setTransportToken(
  ...
  protected RegionInstantSnapshotGroupsStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<RegionInstantSnapshotGroupsStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<DeleteRegionInstantSnapshotGroupRequest, Operation>
        deleteSettings;
    ...
    private final UnaryCallSettings.Builder<
        ...
        getSettings;
    private final UnaryCallSettings.Builder<GetIamPolicyRegionInstantSnapshotGroupRequest, Policy>
        getIamPolicySettings;
    private final UnaryCallSettings.Builder<InsertRegionInstantSnapshotGroupRequest, Operation>
        insertSettings;
    private final OperationCallSettings.Builder<
    ...
    private final PagedCallSettings.Builder<
            ListRegionInstantSnapshotGroupsRequest, ListInstantSnapshotGroups, ListPagedResponse>
        listSettings;
    private final UnaryCallSettings.Builder<SetIamPolicyRegionInstantSnapshotGroupRequest, Policy>
        setIamPolicySettings;
    private final UnaryCallSettings.Builder<
            TestIamPermissionsRegionInstantSnapshotGroupRequest, TestPermissionsResponse>
        testIamPermissionsSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteRegionInstantSnapshotGroupRequest, OperationSnapshot>
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<InsertRegionInstantSnapshotGroupRequest, OperationSnapshot>
                      newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
    ...
    @Override
    public RegionInstantSnapshotGroupsStubSettings build() throws IOException {
      return new RegionInstantSnapshotGroupsStubSettings(this);
    }
  }
}
