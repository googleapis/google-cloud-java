 ...
 * <pre>
 * <code>
 * AutoscalersSettings.Builder autoscalersSettingsBuilder =
 *     AutoscalersSettings.newBuilder();
 * autoscalersSettingsBuilder
 *     .deleteSettings()
 *     .setRetrySettings(
 *         autoscalersSettingsBuilder.deleteSettings().getRetrySettings().toBuilder()
...
public class AutoscalersSettings extends ClientSettings<AutoscalersSettings> {
  ...
  public static int getDefaultServicePort() {
    return AutoscalersStubSettings.getDefaultServicePort();
  }
