...
import com.google.cloud.compute.v1.stub.HttpJsonRegionHealthCheckServicesStub;
...
public class RegionHealthCheckServicesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionHealthCheckServicesStub.getMethodDescriptors(),
            RegionHealthCheckServicesSettings.getDefaultEndpoint());
    RegionHealthCheckServicesSettings settings =
  ...
  public void aggregatedListTest() throws Exception {
    HealthCheckServicesScopedList responsesElement =
        HealthCheckServicesScopedList.newBuilder().build();
    HealthCheckServiceAggregatedList expectedResponse =
        HealthCheckServiceAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, HealthCheckServicesScopedList>> resources =
  ...
  public void deleteTest() throws Exception {
    ...
    String healthCheckService = "healthCheckService-6913";

    Operation actualResponse = client.deleteAsync(project, region, healthCheckService).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String healthCheckService = "healthCheckService-6913";
      client.deleteAsync(project, region, healthCheckService).get();
      Assert.fail("No exception raised");
  ...
  public void getTest() throws Exception {
    HealthCheckService expectedResponse =
        HealthCheckService.newBuilder()
            ...
            .setKind("kind3292052")
            .setName("name3373707")
            .addAllNetworkEndpointGroups(new ArrayList<String>())
            .addAllNotificationEndpoints(new ArrayList<String>())
            .setRegion("region-934795532")
            .setSelfLink("selfLink1191800166")
            .build();
    mockService.addResponse(expectedResponse);
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse =
        client.insertAsync(project, region, healthCheckServiceResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    HealthCheckService responsesElement = HealthCheckService.newBuilder().build();
  ...
  public void patchTest() throws Exception {
    ...
    Operation actualResponse =
        client.patchAsync(project, region, healthCheckService, healthCheckServiceResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
