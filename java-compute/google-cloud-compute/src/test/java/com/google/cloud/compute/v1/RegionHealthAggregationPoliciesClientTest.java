...
import com.google.cloud.compute.v1.stub.HttpJsonRegionHealthAggregationPoliciesStub;
...
public class RegionHealthAggregationPoliciesClientTest {
  private static MockHttpService mockService;
  private static RegionHealthAggregationPoliciesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionHealthAggregationPoliciesStub.getMethodDescriptors(),
            RegionHealthAggregationPoliciesSettings.getDefaultEndpoint());
    RegionHealthAggregationPoliciesSettings settings =
        RegionHealthAggregationPoliciesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionHealthAggregationPoliciesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionHealthAggregationPoliciesClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    HealthAggregationPoliciesScopedList responsesElement =
        HealthAggregationPoliciesScopedList.newBuilder().build();
    HealthAggregationPolicyAggregatedList expectedResponse =
        HealthAggregationPolicyAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, HealthAggregationPoliciesScopedList>> resources =
  ...
  public void deleteTest() throws Exception {
    ...
    String healthAggregationPolicy = "healthAggregationPolicy-6162";

    Operation actualResponse = client.deleteAsync(project, region, healthAggregationPolicy).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String healthAggregationPolicy = "healthAggregationPolicy-6162";
      client.deleteAsync(project, region, healthAggregationPolicy).get();
      Assert.fail("No exception raised");
  ...
  public void getTest() throws Exception {
    HealthAggregationPolicy expectedResponse =
        HealthAggregationPolicy.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setFingerprint("fingerprint-1375934236")
            .setHealthyPercentThreshold(-1001498929)
            .setId(3355)
            .setKind("kind3292052")
            .setMinHealthyThreshold(-1478301796)
            .setName("name3373707")
    ...
    HealthAggregationPolicy actualResponse = client.get(project, region, healthAggregationPolicy);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String healthAggregationPolicy = "healthAggregationPolicy-6162";
      client.get(project, region, healthAggregationPolicy);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse =
        client.insertAsync(project, region, healthAggregationPolicyResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    HealthAggregationPolicy responsesElement = HealthAggregationPolicy.newBuilder().build();
    HealthAggregationPolicyList expectedResponse =
        HealthAggregationPolicyList.newBuilder()
            .setNextPageToken("")
    ...
    List<HealthAggregationPolicy> resources = Lists.newArrayList(pagedListResponse.iterateAll());
