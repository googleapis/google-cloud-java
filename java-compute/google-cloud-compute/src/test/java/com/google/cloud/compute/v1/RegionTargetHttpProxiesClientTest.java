...
import com.google.cloud.compute.v1.stub.HttpJsonRegionTargetHttpProxiesStub;
...
public class RegionTargetHttpProxiesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionTargetHttpProxiesStub.getMethodDescriptors(),
            RegionTargetHttpProxiesSettings.getDefaultEndpoint());
    RegionTargetHttpProxiesSettings settings =
        RegionTargetHttpProxiesSettings.newBuilder()
            ...
            .build();
    client = RegionTargetHttpProxiesClient.create(settings);
  }
