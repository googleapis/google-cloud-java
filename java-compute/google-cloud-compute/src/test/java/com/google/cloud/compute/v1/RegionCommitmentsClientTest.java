...
public class RegionCommitmentsClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionCommitmentsStub.getMethodDescriptors(),
            RegionCommitmentsSettings.getDefaultEndpoint());
    RegionCommitmentsSettings settings =
  ...
  public void aggregatedListTest() throws Exception {
    CommitmentsScopedList responsesElement = CommitmentsScopedList.newBuilder().build();
    ...
    List<Map.Entry<String, CommitmentsScopedList>> resources =
  ...
  public void listTest() throws Exception {
    Commitment responsesElement = Commitment.newBuilder().build();
  ...
  public void updateTest() throws Exception {
    ...
    Operation actualResponse =
        client.updateAsync(project, region, commitment, commitmentResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
