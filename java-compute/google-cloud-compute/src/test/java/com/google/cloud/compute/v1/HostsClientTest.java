...
import com.google.cloud.compute.v1.stub.HttpJsonHostsStub;
...
public class HostsClientTest {
  private static MockHttpService mockService;
  private static HostsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonHostsStub.getMethodDescriptors(), HostsSettings.getDefaultEndpoint());
    HostsSettings settings =
        HostsSettings.newBuilder()
            .setTransportChannelProvider(
                HostsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = HostsClient.create(settings);
  }
  ...
  public void getTest() throws Exception {
    Host expectedResponse =
        Host.newBuilder()
            .addAllAliasLinks(new ArrayList<String>())
            ...
            .setStatus(HostStatus.newBuilder().build())
            .setZone("zone3744684")
            .build();
    ...
    String association = "association-8281";
    String host = "host-7138";

    Host actualResponse = client.get(project, zone, association, host);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String association = "association-8281";
      String host = "host-7138";
      client.get(project, zone, association, host);
  ...
  public void listTest() throws Exception {
    Host responsesElement = Host.newBuilder().build();
    HostsListResponse expectedResponse =
        HostsListResponse.newBuilder()
            .setNextPageToken("")
    ...
    ListPagedResponse pagedListResponse = client.list(project, zone, association);

    List<Host> resources = Lists.newArrayList(pagedListResponse.iterateAll());
  ...
  public void listExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String association = "association-8281";
      client.list(project, zone, association);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
