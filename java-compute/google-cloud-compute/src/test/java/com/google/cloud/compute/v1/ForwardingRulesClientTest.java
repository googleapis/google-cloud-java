...
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.listMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.patchMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.setLabelsMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonForwardingRulesStub.setTargetMethodDescriptor;
...
public class ForwardingRulesClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, ForwardingRulesStubSettings.getDefaultEndpoint());

  private static ForwardingRulesClient client;
  private static ForwardingRulesSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        ForwardingRulesSettings.newBuilder()
            ...
            .build();
    client = ForwardingRulesClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    List<Entry<String, ForwardingRulesScopedList>> resources =
  ...
  public void deleteTest() {
    ...
    Operation actualResponse = client.delete(project, region, forwardingRule);
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      client.delete(project, region, forwardingRule);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
  ...
  public void insertTest() {
    ...
    Operation actualResponse = client.insert(project, region, forwardingRuleResource);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      client.insert(project, region, forwardingRuleResource);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
  ...
  public void patchTest() {
    ...
    Operation actualResponse =
        client.patch(project, region, forwardingRule, forwardingRuleResource);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void setTargetTest() {
    ...
    Operation actualResponse =
        client.setTarget(project, region, forwardingRule, targetReferenceResource);
    Assert.assertEquals(expectedResponse, actualResponse);
