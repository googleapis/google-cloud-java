...
public class RegionNotificationEndpointsClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionNotificationEndpointsStub.getMethodDescriptors(),
            RegionNotificationEndpointsSettings.getDefaultEndpoint());
    RegionNotificationEndpointsSettings settings =
  ...
  public void aggregatedListTest() throws Exception {
    NotificationEndpointsScopedList responsesElement =
        NotificationEndpointsScopedList.newBuilder().build();
    NotificationEndpointAggregatedList expectedResponse =
        NotificationEndpointAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, NotificationEndpointsScopedList>> resources =
  ...
  public void getTest() throws Exception {
    NotificationEndpoint expectedResponse =
        NotificationEndpoint.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setGrpcSettings(NotificationEndpointGrpcSettings.newBuilder().build())
            .setId(3355)
            .setKind("kind3292052")
            .setName("name3373707")
            .setRegion("region-934795532")
