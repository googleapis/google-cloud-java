...
import com.google.cloud.compute.v1.stub.HttpJsonZonesStub;
...
public class ZonesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonZonesStub.getMethodDescriptors(), ZonesSettings.getDefaultEndpoint());
  ...
  public void getTest() throws Exception {
    Zone expectedResponse =
        Zone.newBuilder()
            .addAllAvailableCpuPlatforms(new ArrayList<String>())
