...
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.getIamPolicyMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.listMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.setIamPolicyMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonResourcePoliciesStub.testIamPermissionsMethodDescriptor;
...
public class ResourcePoliciesClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, ResourcePoliciesStubSettings.getDefaultEndpoint());

  private static ResourcePoliciesClient client;
  private static ResourcePoliciesSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        ResourcePoliciesSettings.newBuilder()
            ...
            .build();
    client = ResourcePoliciesClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    ResourcePoliciesScopedList itemsItem = ResourcePoliciesScopedList.newBuilder().build();
    Map<String, ResourcePoliciesScopedList> items = new HashMap<>();
    ...
    List<Entry<String, ResourcePoliciesScopedList>> resources =
  ...
  public void deleteTest() {
    ...
    String resourcePolicy = "resourcePolicy696111747";

    Operation actualResponse = client.delete(project, region, resourcePolicy);
  ...
  public void insertTest() {
    ...
    Operation actualResponse = client.insert(project, region, resourcePolicyResource);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      client.insert(project, region, resourcePolicyResource);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
  ...
  public void listTest() {
    ...
    String nextPageToken = "";
    String selfLink = "selfLink-1691268851";
    ResourcePolicy itemsElement = ResourcePolicy.newBuilder().build();
    List<ResourcePolicy> items = Arrays.asList(itemsElement);
