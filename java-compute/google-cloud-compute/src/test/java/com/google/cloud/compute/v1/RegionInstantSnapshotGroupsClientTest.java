...
import com.google.cloud.compute.v1.stub.HttpJsonRegionInstantSnapshotGroupsStub;
...
public class RegionInstantSnapshotGroupsClientTest {
  private static MockHttpService mockService;
  private static RegionInstantSnapshotGroupsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionInstantSnapshotGroupsStub.getMethodDescriptors(),
            RegionInstantSnapshotGroupsSettings.getDefaultEndpoint());
    RegionInstantSnapshotGroupsSettings settings =
        RegionInstantSnapshotGroupsSettings.newBuilder()
            .setTransportChannelProvider(
                RegionInstantSnapshotGroupsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionInstantSnapshotGroupsClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    String instantSnapshotGroup = "instantSnapshotGroup-352";

    Operation actualResponse = client.deleteAsync(project, region, instantSnapshotGroup).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String instantSnapshotGroup = "instantSnapshotGroup-352";
      client.deleteAsync(project, region, instantSnapshotGroup).get();
  ...
  public void getTest() throws Exception {
    InstantSnapshotGroup expectedResponse =
        InstantSnapshotGroup.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setId(3355)
            .setKind("kind3292052")
            .setName("name3373707")
            .setRegion("region-934795532")
            .setResourceStatus(InstantSnapshotGroupResourceStatus.newBuilder().build())
            .setSelfLink("selfLink1191800166")
    ...
    InstantSnapshotGroup actualResponse = client.get(project, region, instantSnapshotGroup);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String instantSnapshotGroup = "instantSnapshotGroup-352";
      client.get(project, region, instantSnapshotGroup);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse =
        client.insertAsync(project, region, instantSnapshotGroupResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    InstantSnapshotGroup responsesElement = InstantSnapshotGroup.newBuilder().build();
    ListInstantSnapshotGroups expectedResponse =
        ListInstantSnapshotGroups.newBuilder()
            .setNextPageToken("")
    ...
    List<InstantSnapshotGroup> resources = Lists.newArrayList(pagedListResponse.iterateAll());
