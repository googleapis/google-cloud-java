...
public class RegionTargetTcpProxiesClientTest {
  private static MockHttpService mockService;
  private static RegionTargetTcpProxiesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionTargetTcpProxiesStub.getMethodDescriptors(),
            RegionTargetTcpProxiesSettings.getDefaultEndpoint());
    RegionTargetTcpProxiesSettings settings =
        RegionTargetTcpProxiesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionTargetTcpProxiesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionTargetTcpProxiesClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, targetTcpProxy).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String targetTcpProxy = "targetTcpProxy-7204";
      client.deleteAsync(project, region, targetTcpProxy).get();
  ...
  public void getTest() throws Exception {
    ...
    TargetTcpProxy actualResponse = client.get(project, region, targetTcpProxy);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String targetTcpProxy = "targetTcpProxy-7204";
      client.get(project, region, targetTcpProxy);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, targetTcpProxyResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      TargetTcpProxy targetTcpProxyResource = TargetTcpProxy.newBuilder().build();
      client.insertAsync(project, region, targetTcpProxyResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
