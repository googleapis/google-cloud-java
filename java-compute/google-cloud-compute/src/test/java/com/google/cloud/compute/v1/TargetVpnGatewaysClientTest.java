...
import static com.google.cloud.compute.v1.stub.HttpJsonTargetVpnGatewaysStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetVpnGatewaysStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetVpnGatewaysStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetVpnGatewaysStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetVpnGatewaysStub.listMethodDescriptor;
...
public class TargetVpnGatewaysClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, TargetVpnGatewaysStubSettings.getDefaultEndpoint());

  private static TargetVpnGatewaysClient client;
  private static TargetVpnGatewaysSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        TargetVpnGatewaysSettings.newBuilder()
            ...
            .build();
    client = TargetVpnGatewaysClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    List<Entry<String, TargetVpnGatewaysScopedList>> resources =
  ...
  public void deleteTest() {
    ...
    Operation actualResponse = client.delete(project, region, targetVpnGateway);
  ...
  public void insertTest() {
    ...
    Operation actualResponse = client.insert(project, region, targetVpnGatewayResource);
    Assert.assertEquals(expectedResponse, actualResponse);
