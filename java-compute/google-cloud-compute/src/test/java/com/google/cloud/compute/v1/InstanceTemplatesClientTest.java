...
public class InstanceTemplatesClientTest {
  ...
  public void aggregatedListTest() throws Exception {
    InstanceTemplatesScopedList responsesElement = InstanceTemplatesScopedList.newBuilder().build();
    InstanceTemplateAggregatedList expectedResponse =
        InstanceTemplateAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, InstanceTemplatesScopedList>> resources =
