...
public class VpnGatewaysClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonVpnGatewaysStub.getMethodDescriptors(),
            VpnGatewaysSettings.getDefaultEndpoint());
    VpnGatewaysSettings settings =
        VpnGatewaysSettings.newBuilder()
            ...
            .build();
    client = VpnGatewaysClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    ...
    List<Map.Entry<String, VpnGatewaysScopedList>> resources =
  ...
  public void getTest() throws Exception {
    VpnGateway expectedResponse =
        VpnGateway.newBuilder()
            ...
            .setParams(VpnGatewayParams.newBuilder().build())
            .setRegion("region-934795532")
            .setSelfLink("selfLink1191800166")
  ...
  public void getStatusTest() throws Exception {
    VpnGatewaysGetStatusResponse expectedResponse =
        VpnGatewaysGetStatusResponse.newBuilder()
            .setResult(VpnGatewayStatus.newBuilder().build())
            .build();
    mockService.addResponse(expectedResponse);
