...
public class ReservationSubBlocksClientTest {
  private static MockHttpService mockService;
  private static ReservationSubBlocksClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonReservationSubBlocksStub.getMethodDescriptors(),
            ReservationSubBlocksSettings.getDefaultEndpoint());
    ReservationSubBlocksSettings settings =
        ReservationSubBlocksSettings.newBuilder()
            .setTransportChannelProvider(
                ReservationSubBlocksSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = ReservationSubBlocksClient.create(settings);
  }
  ...
  public void getTest() throws Exception {
    ReservationSubBlocksGetResponse expectedResponse =
        ReservationSubBlocksGetResponse.newBuilder()
            .setResource(ReservationSubBlock.newBuilder().build())
            .build();
  ...
  public void listTest() throws Exception {
    ...
    ReservationSubBlocksListResponse expectedResponse =
        ReservationSubBlocksListResponse.newBuilder()
            .setNextPageToken("")
    ...
    List<ReservationSubBlock> resources = Lists.newArrayList(pagedListResponse.iterateAll());
