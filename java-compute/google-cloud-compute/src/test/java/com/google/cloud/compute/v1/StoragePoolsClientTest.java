...
public class StoragePoolsClientTest {
  private static MockHttpService mockService;
  private static StoragePoolsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonStoragePoolsStub.getMethodDescriptors(),
            StoragePoolsSettings.getDefaultEndpoint());
    StoragePoolsSettings settings =
        StoragePoolsSettings.newBuilder()
            .setTransportChannelProvider(
                StoragePoolsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = StoragePoolsClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    StoragePoolsScopedList responsesElement = StoragePoolsScopedList.newBuilder().build();
    StoragePoolAggregatedList expectedResponse =
        StoragePoolAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, StoragePoolsScopedList>> resources =
  ...
  public void deleteTest() throws Exception {
    ...
    String storagePool = "storagePool-1587";

    Operation actualResponse = client.deleteAsync(project, zone, storagePool).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String storagePool = "storagePool-1587";
      client.deleteAsync(project, zone, storagePool).get();
      Assert.fail("No exception raised");
  ...
  public void getTest() throws Exception {
    StoragePool expectedResponse =
        StoragePool.newBuilder()
            ...
            .setPoolProvisionedThroughput(1779828376)
    ...
    StoragePool actualResponse = client.get(project, zone, storagePool);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String storagePool = "storagePool-1587";
      client.get(project, zone, storagePool);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, zone, storagePoolResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      StoragePool storagePoolResource = StoragePool.newBuilder().build();
      client.insertAsync(project, zone, storagePoolResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void listTest() throws Exception {
    ...
    StoragePoolList expectedResponse =
        StoragePoolList.newBuilder()
            .setNextPageToken("")
  ...
  public void listDisksTest() throws Exception {
    StoragePoolDisk responsesElement = StoragePoolDisk.newBuilder().build();
    StoragePoolListDisks expectedResponse =
        StoragePoolListDisks.newBuilder()
            .setNextPageToken("")
            .addAllItems(Arrays.asList(responsesElement))
            .build();
    mockService.addResponse(expectedResponse);
    ...
    ListDisksPagedResponse pagedListResponse = client.listDisks(project, zone, storagePool);

    List<StoragePoolDisk> resources = Lists.newArrayList(pagedListResponse.iterateAll());
  ...
  public void listDisksExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String storagePool = "storagePool-1587";
      client.listDisks(project, zone, storagePool);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void updateTest() throws Exception {
    ...
    Operation actualResponse =
        client.updateAsync(project, zone, storagePool, storagePoolResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
