...
public class FutureReservationsClientTest {
  private static MockHttpService mockService;
  private static FutureReservationsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonFutureReservationsStub.getMethodDescriptors(),
            FutureReservationsSettings.getDefaultEndpoint());
    FutureReservationsSettings settings =
        FutureReservationsSettings.newBuilder()
            .setTransportChannelProvider(
                FutureReservationsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = FutureReservationsClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    FutureReservationsScopedList responsesElement =
        FutureReservationsScopedList.newBuilder().build();
    FutureReservationsAggregatedListResponse expectedResponse =
        FutureReservationsAggregatedListResponse.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, FutureReservationsScopedList>> resources =
  ...
  public void cancelTest() throws Exception {
    ...
    String futureReservation = "futureReservation-5807";

    Operation actualResponse = client.cancelAsync(project, zone, futureReservation).get();
  ...
  public void cancelExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String futureReservation = "futureReservation-5807";
      client.cancelAsync(project, zone, futureReservation).get();
      Assert.fail("No exception raised");
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, zone, futureReservation).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String futureReservation = "futureReservation-5807";
      client.deleteAsync(project, zone, futureReservation).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void getTest() throws Exception {
    FutureReservation expectedResponse =
        FutureReservation.newBuilder()
            ...
            .setKind("kind3292052")
            .setName("name3373707")
            .setNamePrefix("namePrefix-835992323")
            .setParams(FutureReservationParams.newBuilder().build())
    ...
    FutureReservation actualResponse = client.get(project, zone, futureReservation);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String futureReservation = "futureReservation-5807";
      client.get(project, zone, futureReservation);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, zone, futureReservationResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      FutureReservation futureReservationResource = FutureReservation.newBuilder().build();
      client.insertAsync(project, zone, futureReservationResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void listTest() throws Exception {
    FutureReservation responsesElement = FutureReservation.newBuilder().build();
    FutureReservationsListResponse expectedResponse =
        FutureReservationsListResponse.newBuilder()
            .setNextPageToken("")
    ...
    List<FutureReservation> resources = Lists.newArrayList(pagedListResponse.iterateAll());
  ...
  public void updateTest() throws Exception {
    ...
    Operation actualResponse =
        client.updateAsync(project, zone, futureReservation, futureReservationResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
