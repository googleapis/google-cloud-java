...
import com.google.cloud.compute.v1.stub.HttpJsonRegionZonesStub;
...
public class RegionZonesClientTest {
  private static MockHttpService mockService;
  private static RegionZonesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionZonesStub.getMethodDescriptors(),
            RegionZonesSettings.getDefaultEndpoint());
    RegionZonesSettings settings =
        RegionZonesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionZonesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionZonesClient.create(settings);
  }
