...
import com.google.cloud.compute.v1.stub.HttpJsonRegionSslPoliciesStub;
...
public class RegionSslPoliciesClientTest {
  private static MockHttpService mockService;
  private static RegionSslPoliciesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionSslPoliciesStub.getMethodDescriptors(),
            RegionSslPoliciesSettings.getDefaultEndpoint());
    RegionSslPoliciesSettings settings =
        RegionSslPoliciesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionSslPoliciesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionSslPoliciesClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, sslPolicy).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String sslPolicy = "sslPolicy-6284";
      client.deleteAsync(project, region, sslPolicy).get();
  ...
  public void getTest() throws Exception {
    ...
    SslPolicy actualResponse = client.get(project, region, sslPolicy);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String sslPolicy = "sslPolicy-6284";
      client.get(project, region, sslPolicy);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, sslPolicyResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      SslPolicy sslPolicyResource = SslPolicy.newBuilder().build();
      client.insertAsync(project, region, sslPolicyResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void listAvailableFeaturesTest() throws Exception {
    ...
    SslPoliciesListAvailableFeaturesResponse actualResponse =
        client.listAvailableFeatures(project, region);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void patchTest() throws Exception {
    ...
    Operation actualResponse =
        client.patchAsync(project, region, sslPolicy, sslPolicyResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
