...
import com.google.cloud.compute.v1.stub.HttpJsonInstantSnapshotGroupsStub;
...
public class InstantSnapshotGroupsClientTest {
  private static MockHttpService mockService;
  private static InstantSnapshotGroupsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonInstantSnapshotGroupsStub.getMethodDescriptors(),
            InstantSnapshotGroupsSettings.getDefaultEndpoint());
    InstantSnapshotGroupsSettings settings =
        InstantSnapshotGroupsSettings.newBuilder()
            .setTransportChannelProvider(
                InstantSnapshotGroupsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = InstantSnapshotGroupsClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, zone, instantSnapshotGroup).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String instantSnapshotGroup = "instantSnapshotGroup-352";
      client.deleteAsync(project, zone, instantSnapshotGroup).get();
  ...
  public void getTest() throws Exception {
    ...
    InstantSnapshotGroup actualResponse = client.get(project, zone, instantSnapshotGroup);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String instantSnapshotGroup = "instantSnapshotGroup-352";
      client.get(project, zone, instantSnapshotGroup);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse =
        client.insertAsync(project, zone, instantSnapshotGroupResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
