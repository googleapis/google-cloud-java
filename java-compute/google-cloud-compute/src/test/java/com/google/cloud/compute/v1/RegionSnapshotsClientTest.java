...
import com.google.cloud.compute.v1.stub.HttpJsonRegionSnapshotsStub;
...
public class RegionSnapshotsClientTest {
  private static MockHttpService mockService;
  private static RegionSnapshotsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionSnapshotsStub.getMethodDescriptors(),
            RegionSnapshotsSettings.getDefaultEndpoint());
    RegionSnapshotsSettings settings =
        RegionSnapshotsSettings.newBuilder()
            .setTransportChannelProvider(
                RegionSnapshotsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionSnapshotsClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, snapshot).get();
  ...
  public void getTest() throws Exception {
    Snapshot expectedResponse =
        Snapshot.newBuilder()
            ...
            .setSnapshotGroupId("snapshotGroupId423090582")
            .setSnapshotGroupName("snapshotGroupName-1431694266")
    ...
    Snapshot actualResponse = client.get(project, region, snapshot);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String snapshot = "snapshot-5030";
      client.get(project, region, snapshot);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, snapshotResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      Snapshot snapshotResource = Snapshot.newBuilder().build();
      client.insertAsync(project, region, snapshotResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  @Test
  public void updateKmsKeyTest() throws Exception {
    Operation expectedResponse =
        Operation.newBuilder()
            .setClientOperationId("clientOperationId-1230366697")
            .setCreationTimestamp("creationTimestamp-370203401")
    ...
    Operation actualResponse =
        client
            .updateKmsKeyAsync(project, region, snapshot, regionSnapshotUpdateKmsKeyRequestResource)
            .get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void updateKmsKeyExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
