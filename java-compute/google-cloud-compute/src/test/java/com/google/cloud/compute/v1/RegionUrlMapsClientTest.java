...
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.listMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.patchMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.updateMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionUrlMapsStub.validateMethodDescriptor;
...
public class RegionUrlMapsClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, RegionUrlMapsStubSettings.getDefaultEndpoint());

  private static RegionUrlMapsClient client;
  private static RegionUrlMapsSettings clientSettings;
    ...
    clientSettings =
        RegionUrlMapsSettings.newBuilder()
            .setTransportChannelProvider(
                RegionUrlMapsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionUrlMapsClient.create(clientSettings);
  }
