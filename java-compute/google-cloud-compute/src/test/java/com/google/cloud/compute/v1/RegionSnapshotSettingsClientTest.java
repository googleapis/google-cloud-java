...
import com.google.cloud.compute.v1.stub.HttpJsonRegionSnapshotSettingsStub;
...
public class RegionSnapshotSettingsClientTest {
  private static MockHttpService mockService;
  private static RegionSnapshotSettingsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionSnapshotSettingsStub.getMethodDescriptors(),
            RegionSnapshotSettingsSettings.getDefaultEndpoint());
    RegionSnapshotSettingsSettings settings =
        RegionSnapshotSettingsSettings.newBuilder()
            .setTransportChannelProvider(
                RegionSnapshotSettingsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionSnapshotSettingsClient.create(settings);
  }
  ...
  public void getTest() throws Exception {
    ...
    SnapshotSettings actualResponse = client.get(project, region);
  ...
  public void patchTest() throws Exception {
    ...
    Operation actualResponse = client.patchAsync(project, region, snapshotSettingsResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void patchExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      SnapshotSettings snapshotSettingsResource = SnapshotSettings.newBuilder().build();
      client.patchAsync(project, region, snapshotSettingsResource).get();
      Assert.fail("No exception raised");
