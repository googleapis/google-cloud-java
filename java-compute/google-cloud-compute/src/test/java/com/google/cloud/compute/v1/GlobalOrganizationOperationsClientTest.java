...
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOrganizationOperationsStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOrganizationOperationsStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOrganizationOperationsStub.listMethodDescriptor;
...
public class GlobalOrganizationOperationsClientTest {
  private static final List<ApiMethodDescriptor> METHOD_DESCRIPTORS =
      ImmutableList.copyOf(
          Lists.<ApiMethodDescriptor>newArrayList(
              deleteMethodDescriptor, getMethodDescriptor, listMethodDescriptor));
  private static final MockHttpService mockService =
      new MockHttpService(
          METHOD_DESCRIPTORS, GlobalOrganizationOperationsStubSettings.getDefaultEndpoint());

  private static GlobalOrganizationOperationsClient client;
  private static GlobalOrganizationOperationsSettings clientSettings;
    ...
    clientSettings =
        GlobalOrganizationOperationsSettings.newBuilder()
            .setTransportChannelProvider(
                GlobalOrganizationOperationsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = GlobalOrganizationOperationsClient.create(clientSettings);
  }
  ...
  public void deleteTest() {
    DeleteGlobalOrganizationOperationResponse expectedResponse =
