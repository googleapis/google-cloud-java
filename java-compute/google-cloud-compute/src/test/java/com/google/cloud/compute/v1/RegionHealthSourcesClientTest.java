...
import com.google.cloud.compute.v1.stub.HttpJsonRegionHealthSourcesStub;
...
public class RegionHealthSourcesClientTest {
  private static MockHttpService mockService;
  private static RegionHealthSourcesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionHealthSourcesStub.getMethodDescriptors(),
            RegionHealthSourcesSettings.getDefaultEndpoint());
    RegionHealthSourcesSettings settings =
        RegionHealthSourcesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionHealthSourcesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionHealthSourcesClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    HealthSourcesScopedList responsesElement = HealthSourcesScopedList.newBuilder().build();
    HealthSourceAggregatedList expectedResponse =
        HealthSourceAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, HealthSourcesScopedList>> resources =
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, healthSource).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String healthSource = "healthSource-6365";
      client.deleteAsync(project, region, healthSource).get();
      Assert.fail("No exception raised");
  ...
  public void getTest() throws Exception {
    HealthSource expectedResponse =
        HealthSource.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
    ...
    HealthSource actualResponse = client.get(project, region, healthSource);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String healthSource = "healthSource-6365";
      client.get(project, region, healthSource);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, healthSourceResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      HealthSource healthSourceResource = HealthSource.newBuilder().build();
      client.insertAsync(project, region, healthSourceResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void listTest() throws Exception {
    HealthSource responsesElement = HealthSource.newBuilder().build();
    HealthSourceList expectedResponse =
        HealthSourceList.newBuilder()
            .setNextPageToken("")
    ...
    List<HealthSource> resources = Lists.newArrayList(pagedListResponse.iterateAll());
  ...
  public void patchTest() throws Exception {
    ...
    Operation actualResponse =
        client.patchAsync(project, region, healthSource, healthSourceResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
