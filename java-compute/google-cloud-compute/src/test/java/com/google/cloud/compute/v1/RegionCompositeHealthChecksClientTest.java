...
import com.google.cloud.compute.v1.stub.HttpJsonRegionCompositeHealthChecksStub;
...
public class RegionCompositeHealthChecksClientTest {
  private static MockHttpService mockService;
  private static RegionCompositeHealthChecksClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionCompositeHealthChecksStub.getMethodDescriptors(),
            RegionCompositeHealthChecksSettings.getDefaultEndpoint());
    RegionCompositeHealthChecksSettings settings =
        RegionCompositeHealthChecksSettings.newBuilder()
            .setTransportChannelProvider(
                RegionCompositeHealthChecksSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionCompositeHealthChecksClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    CompositeHealthChecksScopedList responsesElement =
        CompositeHealthChecksScopedList.newBuilder().build();
    CompositeHealthCheckAggregatedList expectedResponse =
        CompositeHealthCheckAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, CompositeHealthChecksScopedList>> resources =
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, compositeHealthCheck).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String compositeHealthCheck = "compositeHealthCheck-6763";
      client.deleteAsync(project, region, compositeHealthCheck).get();
      Assert.fail("No exception raised");
  ...
  public void getTest() throws Exception {
    CompositeHealthCheck expectedResponse =
        CompositeHealthCheck.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setFingerprint("fingerprint-1375934236")
            .setHealthDestination("healthDestination1526536210")
            .addAllHealthSources(new ArrayList<String>())
            .setId(3355)
            .setKind("kind3292052")
            .setName("name3373707")
            .setRegion("region-934795532")
    ...
    CompositeHealthCheck actualResponse = client.get(project, region, compositeHealthCheck);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String compositeHealthCheck = "compositeHealthCheck-6763";
      client.get(project, region, compositeHealthCheck);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse =
        client.insertAsync(project, region, compositeHealthCheckResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    CompositeHealthCheck responsesElement = CompositeHealthCheck.newBuilder().build();
    CompositeHealthCheckList expectedResponse =
        CompositeHealthCheckList.newBuilder()
            .setNextPageToken("")
    ...
    List<CompositeHealthCheck> resources = Lists.newArrayList(pagedListResponse.iterateAll());
  ...
  public void patchExceptionTest() throws Exception {
    ...
    try {
      ...
      String compositeHealthCheck = "compositeHealthCheck-6763";
      CompositeHealthCheck compositeHealthCheckResource = CompositeHealthCheck.newBuilder().build();
      client.patchAsync(project, region, compositeHealthCheck, compositeHealthCheckResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
