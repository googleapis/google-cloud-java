...
public class ReservationBlocksClientTest {
  private static MockHttpService mockService;
  private static ReservationBlocksClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonReservationBlocksStub.getMethodDescriptors(),
            ReservationBlocksSettings.getDefaultEndpoint());
    ReservationBlocksSettings settings =
        ReservationBlocksSettings.newBuilder()
            .setTransportChannelProvider(
                ReservationBlocksSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = ReservationBlocksClient.create(settings);
  }
  ...
  public void getTest() throws Exception {
    ReservationBlocksGetResponse expectedResponse =
        ReservationBlocksGetResponse.newBuilder()
            .setResource(ReservationBlock.newBuilder().build())
            .build();
    ...
    String reservationBlock = "reservationBlock-3449";

    ReservationBlocksGetResponse actualResponse =
        client.get(project, zone, reservation, reservationBlock);
  ...
  public void listTest() throws Exception {
    ReservationBlock responsesElement = ReservationBlock.newBuilder().build();
    ReservationBlocksListResponse expectedResponse =
        ReservationBlocksListResponse.newBuilder()
            .setNextPageToken("")
    ...
    ListPagedResponse pagedListResponse = client.list(project, zone, reservation);

    List<ReservationBlock> resources = Lists.newArrayList(pagedListResponse.iterateAll());
  ...
  public void listExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String reservation = "reservation-4882";
      client.list(project, zone, reservation);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
