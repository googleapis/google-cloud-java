...
public class DiskTypesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonDiskTypesStub.getMethodDescriptors(), DiskTypesSettings.getDefaultEndpoint());
    DiskTypesSettings settings =
        DiskTypesSettings.newBuilder()
            ...
            .build();
    client = DiskTypesClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    DiskTypesScopedList responsesElement = DiskTypesScopedList.newBuilder().build();
    ...
    List<Map.Entry<String, DiskTypesScopedList>> resources =
