...
public class TargetGrpcProxiesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonTargetGrpcProxiesStub.getMethodDescriptors(),
            TargetGrpcProxiesSettings.getDefaultEndpoint());
    TargetGrpcProxiesSettings settings =
        TargetGrpcProxiesSettings.newBuilder()
            ...
            .build();
    client = TargetGrpcProxiesClient.create(settings);
  }
  ...
  public void listTest() throws Exception {
    TargetGrpcProxy responsesElement = TargetGrpcProxy.newBuilder().build();
