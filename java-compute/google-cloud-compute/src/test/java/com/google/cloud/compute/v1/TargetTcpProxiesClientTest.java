...
import static com.google.cloud.compute.v1.stub.HttpJsonTargetTcpProxiesStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetTcpProxiesStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetTcpProxiesStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetTcpProxiesStub.listMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetTcpProxiesStub.setBackendServiceMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetTcpProxiesStub.setProxyHeaderMethodDescriptor;
...
public class TargetTcpProxiesClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, TargetTcpProxiesStubSettings.getDefaultEndpoint());

  private static TargetTcpProxiesClient client;
  private static TargetTcpProxiesSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        TargetTcpProxiesSettings.newBuilder()
            ...
            .build();
    client = TargetTcpProxiesClient.create(clientSettings);
  }
  ...
  public void deleteTest() {
    ...
    String targetTcpProxy = "targetTcpProxy503065442";

    Operation actualResponse = client.delete(project, targetTcpProxy);
  ...
  public void insertTest() {
    ...
    Operation actualResponse = client.insert(project, targetTcpProxyResource);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void setBackendServiceTest() {
    String clientOperationId = "clientOperationId-239630617";
    String creationTimestamp = "creationTimestamp567396278";
    String description = "description-1724546052";
    String endTime = "endTime1725551537";
  ...
  @Test
  @SuppressWarnings("all")
  public void setProxyHeaderTest() {
    String clientOperationId = "clientOperationId-239630617";
    String creationTimestamp = "creationTimestamp567396278";
    String description = "description-1724546052";
    String endTime = "endTime1725551537";
  ...
  public void setProxyHeaderExceptionTest() throws Exception {
    ...
    try {
      ...
      client.setProxyHeader(project, targetTcpProxy, targetTcpProxiesSetProxyHeaderRequestResource);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
