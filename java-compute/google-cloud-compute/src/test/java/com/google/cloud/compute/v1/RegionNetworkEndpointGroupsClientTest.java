...
import static com.google.cloud.compute.v1.stub.HttpJsonRegionNetworkEndpointGroupsStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionNetworkEndpointGroupsStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionNetworkEndpointGroupsStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionNetworkEndpointGroupsStub.listMethodDescriptor;
...
public class RegionNetworkEndpointGroupsClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(
          METHOD_DESCRIPTORS, RegionNetworkEndpointGroupsStubSettings.getDefaultEndpoint());

  private static RegionNetworkEndpointGroupsClient client;
  private static RegionNetworkEndpointGroupsSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        RegionNetworkEndpointGroupsSettings.newBuilder()
            ...
            .build();
    client = RegionNetworkEndpointGroupsClient.create(clientSettings);
  }
  ...
  public void deleteTest() {
    ...
    Operation actualResponse = client.delete(project, region, networkEndpointGroup);
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      client.delete(project, region, networkEndpointGroup);
  ...
  public void insertTest() {
    ...
    Operation actualResponse = client.insert(project, region, networkEndpointGroupResource);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      client.insert(project, region, networkEndpointGroupResource);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
