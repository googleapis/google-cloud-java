...
import static com.google.cloud.compute.v1.stub.HttpJsonRegionsStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionsStub.listMethodDescriptor;
...
public class RegionsClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, RegionsStubSettings.getDefaultEndpoint());

  private static RegionsClient client;
  private static RegionsSettings clientSettings;
  ...
  public static void setUp() throws IOException {
    clientSettings =
        RegionsSettings.newBuilder()
            ...
            .build();
    client = RegionsClient.create(clientSettings);
  }
