...
public class InterconnectAttachmentGroupsClientTest {
  private static MockHttpService mockService;
  private static InterconnectAttachmentGroupsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonInterconnectAttachmentGroupsStub.getMethodDescriptors(),
            InterconnectAttachmentGroupsSettings.getDefaultEndpoint());
    InterconnectAttachmentGroupsSettings settings =
        InterconnectAttachmentGroupsSettings.newBuilder()
            .setTransportChannelProvider(
                InterconnectAttachmentGroupsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = InterconnectAttachmentGroupsClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    String interconnectAttachmentGroup = "interconnectAttachmentGroup-4444";

    Operation actualResponse = client.deleteAsync(project, interconnectAttachmentGroup).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      String project = "project-6911";
      String interconnectAttachmentGroup = "interconnectAttachmentGroup-4444";
      client.deleteAsync(project, interconnectAttachmentGroup).get();
  ...
  public void getTest() throws Exception {
    InterconnectAttachmentGroup expectedResponse =
        InterconnectAttachmentGroup.newBuilder()
            .putAllAttachments(new HashMap<String, InterconnectAttachmentGroupAttachment>())
            .setConfigured(InterconnectAttachmentGroupConfigured.newBuilder().build())
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setEtag("etag3123477")
            .setId(3355)
            .setIntent(InterconnectAttachmentGroupIntent.newBuilder().build())
            .setInterconnectGroup("interconnectGroup2103544465")
            .setKind("kind3292052")
            .setLogicalStructure(InterconnectAttachmentGroupLogicalStructure.newBuilder().build())
            .setName("name3373707")
            .setSelfLink("selfLink1191800166")
            .build();
    mockService.addResponse(expectedResponse);
    ...
    InterconnectAttachmentGroup actualResponse = client.get(project, interconnectAttachmentGroup);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      String project = "project-6911";
      String interconnectAttachmentGroup = "interconnectAttachmentGroup-4444";
      client.get(project, interconnectAttachmentGroup);
      Assert.fail("No exception raised");
  ...
  public void getOperationalStatusTest() throws Exception {
    InterconnectAttachmentGroupsGetOperationalStatusResponse expectedResponse =
        InterconnectAttachmentGroupsGetOperationalStatusResponse.newBuilder()
            .setEtag("etag3123477")
            .setResult(InterconnectAttachmentGroupsOperationalStatus.newBuilder().build())
            .build();
    mockService.addResponse(expectedResponse);
    ...
    InterconnectAttachmentGroupsGetOperationalStatusResponse actualResponse =
        client.getOperationalStatus(project, interconnectAttachmentGroup);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse =
        client.insertAsync(project, interconnectAttachmentGroupResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    InterconnectAttachmentGroup responsesElement = InterconnectAttachmentGroup.newBuilder().build();
    InterconnectAttachmentGroupsListResponse expectedResponse =
        InterconnectAttachmentGroupsListResponse.newBuilder()
            .setNextPageToken("")
    ...
    List<InterconnectAttachmentGroup> resources =
