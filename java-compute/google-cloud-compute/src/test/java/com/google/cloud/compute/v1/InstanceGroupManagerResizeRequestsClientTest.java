...
public class InstanceGroupManagerResizeRequestsClientTest {
  private static MockHttpService mockService;
  private static InstanceGroupManagerResizeRequestsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonInstanceGroupManagerResizeRequestsStub.getMethodDescriptors(),
            InstanceGroupManagerResizeRequestsSettings.getDefaultEndpoint());
    InstanceGroupManagerResizeRequestsSettings settings =
        InstanceGroupManagerResizeRequestsSettings.newBuilder()
            .setTransportChannelProvider(
                InstanceGroupManagerResizeRequestsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = InstanceGroupManagerResizeRequestsClient.create(settings);
  }
  ...
  public void cancelTest() throws Exception {
    ...
    Operation actualResponse =
        client.cancelAsync(project, zone, instanceGroupManager, resizeRequest).get();
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse =
        client.deleteAsync(project, zone, instanceGroupManager, resizeRequest).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getTest() throws Exception {
    ...
    InstanceGroupManagerResizeRequest actualResponse =
        client.get(project, zone, instanceGroupManager, resizeRequest);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void listTest() throws Exception {
    InstanceGroupManagerResizeRequest responsesElement =
        InstanceGroupManagerResizeRequest.newBuilder().build();
    InstanceGroupManagerResizeRequestsListResponse expectedResponse =
    ...
    ListPagedResponse pagedListResponse = client.list(project, zone, instanceGroupManager);
  ...
  public void listExceptionTest() throws Exception {
    ...
    try {
      ...
      String zone = "zone-5246";
      String instanceGroupManager = "instanceGroupManager-7543";
      client.list(project, zone, instanceGroupManager);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
