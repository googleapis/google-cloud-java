...
public class NetworkFirewallPoliciesClientTest {
  ...
  public void aggregatedListTest() throws Exception {
    FirewallPoliciesScopedList responsesElement = FirewallPoliciesScopedList.newBuilder().build();
    NetworkFirewallPolicyAggregatedList expectedResponse =
        NetworkFirewallPolicyAggregatedList.newBuilder()
            .setNextPageToken("")
    ...
    List<Map.Entry<String, FirewallPoliciesScopedList>> resources =
