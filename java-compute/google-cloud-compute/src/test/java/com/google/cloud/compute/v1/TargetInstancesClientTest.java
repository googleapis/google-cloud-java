...
public class TargetInstancesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonTargetInstancesStub.getMethodDescriptors(),
            TargetInstancesSettings.getDefaultEndpoint());
    TargetInstancesSettings settings =
        TargetInstancesSettings.newBuilder()
            ...
            .build();
    client = TargetInstancesClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    ...
    List<Map.Entry<String, TargetInstancesScopedList>> resources =
  ...
  public void setSecurityPolicyTest() throws Exception {
    ...
    Operation actualResponse =
        client
            .setSecurityPolicyAsync(project, zone, targetInstance, securityPolicyReferenceResource)
            .get();
    Assert.assertEquals(expectedResponse, actualResponse);
