...
import static com.google.cloud.compute.v1.stub.HttpJsonTargetInstancesStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetInstancesStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetInstancesStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetInstancesStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonTargetInstancesStub.listMethodDescriptor;
...
public class TargetInstancesClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, TargetInstancesStubSettings.getDefaultEndpoint());

  private static TargetInstancesClient client;
  private static TargetInstancesSettings clientSettings;
    ...
    clientSettings =
        TargetInstancesSettings.newBuilder()
            .setTransportChannelProvider(
                TargetInstancesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = TargetInstancesClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    List<Entry<String, TargetInstancesScopedList>> resources =
  ...
  public void deleteTest() {
    ...
    String targetInstance = "targetInstance826640259";
