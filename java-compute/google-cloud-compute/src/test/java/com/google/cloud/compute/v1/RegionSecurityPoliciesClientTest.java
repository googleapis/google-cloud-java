...
public class RegionSecurityPoliciesClientTest {
  private static MockHttpService mockService;
  private static RegionSecurityPoliciesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionSecurityPoliciesStub.getMethodDescriptors(),
            RegionSecurityPoliciesSettings.getDefaultEndpoint());
    RegionSecurityPoliciesSettings settings =
        RegionSecurityPoliciesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionSecurityPoliciesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionSecurityPoliciesClient.create(settings);
  }
  ...
  public void addRuleTest() throws Exception {
    ...
    Operation actualResponse =
        client.addRuleAsync(project, region, securityPolicy, securityPolicyRuleResource).get();
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, securityPolicy).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String securityPolicy = "securityPolicy-7672";
      client.deleteAsync(project, region, securityPolicy).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void getTest() throws Exception {
    ...
    SecurityPolicy actualResponse = client.get(project, region, securityPolicy);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getRuleTest() throws Exception {
    ...
    SecurityPolicyRule actualResponse = client.getRule(project, region, securityPolicy);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getRuleExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String securityPolicy = "securityPolicy-7672";
      client.getRule(project, region, securityPolicy);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, securityPolicyResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void patchRuleTest() throws Exception {
    ...
    Operation actualResponse =
        client.patchRuleAsync(project, region, securityPolicy, securityPolicyRuleResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void removeRuleTest() throws Exception {
    ...
    Operation actualResponse = client.removeRuleAsync(project, region, securityPolicy).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void removeRuleExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String securityPolicy = "securityPolicy-7672";
      client.removeRuleAsync(project, region, securityPolicy).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
