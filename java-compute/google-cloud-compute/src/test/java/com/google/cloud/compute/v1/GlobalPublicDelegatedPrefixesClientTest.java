...
import com.google.cloud.compute.v1.stub.HttpJsonGlobalPublicDelegatedPrefixesStub;
...
public class GlobalPublicDelegatedPrefixesClientTest {
  private static MockHttpService mockService;
  private static GlobalPublicDelegatedPrefixesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonGlobalPublicDelegatedPrefixesStub.getMethodDescriptors(),
            GlobalPublicDelegatedPrefixesSettings.getDefaultEndpoint());
    GlobalPublicDelegatedPrefixesSettings settings =
        GlobalPublicDelegatedPrefixesSettings.newBuilder()
            .setTransportChannelProvider(
                GlobalPublicDelegatedPrefixesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = GlobalPublicDelegatedPrefixesClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.delete(project, publicDelegatedPrefix);
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insert(project, publicDelegatedPrefixResource);
    Assert.assertEquals(expectedResponse, actualResponse);
