...
import com.google.cloud.compute.v1.stub.HttpJsonRegionBackendBucketsStub;
...
public class RegionBackendBucketsClientTest {
  private static MockHttpService mockService;
  private static RegionBackendBucketsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionBackendBucketsStub.getMethodDescriptors(),
            RegionBackendBucketsSettings.getDefaultEndpoint());
    RegionBackendBucketsSettings settings =
        RegionBackendBucketsSettings.newBuilder()
            .setTransportChannelProvider(
                RegionBackendBucketsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionBackendBucketsClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, backendBucket).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String backendBucket = "backendBucket-4508";
      client.deleteAsync(project, region, backendBucket).get();
  ...
  public void getTest() throws Exception {
    ...
    BackendBucket actualResponse = client.get(project, region, backendBucket);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String backendBucket = "backendBucket-4508";
      client.get(project, region, backendBucket);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, backendBucketResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      BackendBucket backendBucketResource = BackendBucket.newBuilder().build();
      client.insertAsync(project, region, backendBucketResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void listUsableTest() throws Exception {
    ...
    ListUsablePagedResponse pagedListResponse = client.listUsable(project, region);
  ...
  public void listUsableExceptionTest() throws Exception {
    ...
    try {
      String project = "project-6911";
      String region = "region-9622";
      client.listUsable(project, region);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  public void patchTest() throws Exception {
    ...
    Operation actualResponse =
        client.patchAsync(project, region, backendBucket, backendBucketResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
