...
public class SslCertificatesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonSslCertificatesStub.getMethodDescriptors(),
            SslCertificatesSettings.getDefaultEndpoint());
    SslCertificatesSettings settings =
        SslCertificatesSettings.newBuilder()
            ...
            .build();
    client = SslCertificatesClient.create(settings);
  }
  ...
  public void aggregatedListTest() throws Exception {
    ...
    List<Map.Entry<String, SslCertificatesScopedList>> resources =
