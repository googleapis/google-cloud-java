...
import static com.google.cloud.compute.v1.stub.HttpJsonSslCertificatesStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonSslCertificatesStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonSslCertificatesStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonSslCertificatesStub.insertMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonSslCertificatesStub.listMethodDescriptor;
...
public class SslCertificatesClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, SslCertificatesStubSettings.getDefaultEndpoint());

  private static SslCertificatesClient client;
  private static SslCertificatesSettings clientSettings;
    ...
    clientSettings =
        SslCertificatesSettings.newBuilder()
            .setTransportChannelProvider(
                SslCertificatesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = SslCertificatesClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    List<Entry<String, SslCertificatesScopedList>> resources =
  ...
  public void deleteTest() {
    ...
    Operation actualResponse = client.delete(project, sslCertificate);
  ...
  public void insertTest() {
    ...
    Operation actualResponse = client.insert(project, sslCertificateResource);
    Assert.assertEquals(expectedResponse, actualResponse);
