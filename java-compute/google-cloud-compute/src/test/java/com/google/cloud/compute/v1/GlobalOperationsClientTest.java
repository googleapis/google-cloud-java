...
public class GlobalOperationsClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonGlobalOperationsStub.getMethodDescriptors(),
            GlobalOperationsSettings.getDefaultEndpoint());
    GlobalOperationsSettings settings =
  ...
  public void aggregatedListTest() throws Exception {
    OperationsScopedList responsesElement = OperationsScopedList.newBuilder().build();
    ...
    List<Map.Entry<String, OperationsScopedList>> resources =
