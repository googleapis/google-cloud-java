...
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOperationsStub.aggregatedListMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOperationsStub.deleteMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOperationsStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOperationsStub.listMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonGlobalOperationsStub.waitMethodDescriptor;
...
public class GlobalOperationsClientTest {
  ...
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, GlobalOperationsStubSettings.getDefaultEndpoint());

  private static GlobalOperationsClient client;
  private static GlobalOperationsSettings clientSettings;
    ...
    clientSettings =
        GlobalOperationsSettings.newBuilder()
            .setTransportChannelProvider(
                GlobalOperationsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = GlobalOperationsClient.create(clientSettings);
  }
  ...
  public void aggregatedListTest() {
    ...
    List<Entry<String, OperationsScopedList>> resources =
  ...
  public void deleteTest() {
    DeleteGlobalOperationResponse expectedResponse =
