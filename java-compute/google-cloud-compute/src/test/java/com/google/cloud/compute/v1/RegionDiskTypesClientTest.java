...
import static com.google.cloud.compute.v1.stub.HttpJsonRegionDiskTypesStub.getMethodDescriptor;
import static com.google.cloud.compute.v1.stub.HttpJsonRegionDiskTypesStub.listMethodDescriptor;
...
public class RegionDiskTypesClientTest {
  private static final List<ApiMethodDescriptor> METHOD_DESCRIPTORS =
      ImmutableList.copyOf(
          Lists.<ApiMethodDescriptor>newArrayList(getMethodDescriptor, listMethodDescriptor));
  private static final MockHttpService mockService =
      new MockHttpService(METHOD_DESCRIPTORS, RegionDiskTypesStubSettings.getDefaultEndpoint());

  private static RegionDiskTypesClient client;
  private static RegionDiskTypesSettings clientSettings;
    ...
    clientSettings =
        RegionDiskTypesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionDiskTypesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionDiskTypesClient.create(clientSettings);
  }
