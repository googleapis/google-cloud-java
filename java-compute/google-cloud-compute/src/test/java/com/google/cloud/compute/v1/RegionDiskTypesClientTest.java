...
import com.google.cloud.compute.v1.stub.HttpJsonRegionDiskTypesStub;
...
public class RegionDiskTypesClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionDiskTypesStub.getMethodDescriptors(),
            RegionDiskTypesSettings.getDefaultEndpoint());
    RegionDiskTypesSettings settings =
  ...
  public void getTest() throws Exception {
    DiskType expectedResponse =
        DiskType.newBuilder()
            ...
            .setValidDiskSize("validDiskSize-594443430")
            .setZone("zone3744684")
            .build();
