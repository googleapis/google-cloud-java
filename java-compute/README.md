...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-compute" % "1.59.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-compute/1.57.0
