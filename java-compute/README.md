...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-compute" % "1.90.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-compute/1.90.0
