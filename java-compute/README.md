...
```Groovy
implementation 'com.google.cloud:google-cloud-compute:1.80.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-compute/1.80.0
