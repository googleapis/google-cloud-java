...
public final class InterconnectGroupConfiguredTopologyCapabilityIntendedCapabilityBlockers
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < interconnects_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 520187301, interconnects_.getRaw(i));
    }
    ...
    for (int i = 0; i < facilities_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 536683137, facilities_.getRaw(i));
    }
