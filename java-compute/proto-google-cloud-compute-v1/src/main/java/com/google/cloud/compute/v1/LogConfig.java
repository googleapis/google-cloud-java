      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case -2001896246:
              {
                input.readMessage(getDataAccessFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000004;
                break;
              } // case -2001896246
            case -992146806:
              {
                input.readMessage(getCloudAuditFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case -992146806
            case -927289374:
              {
                input.readMessage(getCounterFieldBuilder().getBuilder(), extensionRegistry);
