...
public interface StartAsyncReplicationRegionDiskRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.StartAsyncReplicationRegionDiskRequest)
   ...
   * </code>
   *
   * @return Whether the regionDisksStartAsyncReplicationRequestResource field is set.
   */
  boolean hasRegionDisksStartAsyncReplicationRequestResource();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   *
   * @return The regionDisksStartAsyncReplicationRequestResource.
   */
