...
public interface SetSecurityPolicyInstanceRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.SetSecurityPolicyInstanceRequest)
   ...
   */
  boolean hasInstancesSetSecurityPolicyRequestResource();
  /**
   *
   *
   * <pre>
