...
public final class InterconnectGroupsOperationalStatusInterconnectStatus
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (((bitField0_ & 0x00000008) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 114830267, isActive_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (((bitField0_ & 0x00000008) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(114830267, isActive_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case -1628123806:
              {
                input.readMessage(
                    internalGetDiagnosticsFieldBuilder().getBuilder(), extensionRegistry);
