...
public interface SuspendInstancesRegionInstanceGroupManagerRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.SuspendInstancesRegionInstanceGroupManagerRequest)
   ...
   *
   * <code>
   * .google.cloud.compute.v1.RegionInstanceGroupManagersSuspendInstancesRequest region_instance_group_managers_suspend_instances_request_resource = 214250236 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   * @return Whether the regionInstanceGroupManagersSuspendInstancesRequestResource field is set.
   */
   ...
   * </code>
   *
   * @return The regionInstanceGroupManagersSuspendInstancesRequestResource.
   */
