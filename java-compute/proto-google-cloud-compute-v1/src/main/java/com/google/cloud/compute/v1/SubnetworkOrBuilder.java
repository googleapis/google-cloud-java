...
public interface SubnetworkOrBuilder
   ...
   */
  com.google.protobuf.ByteString getIpv6GceEndpointBytes();
   ...
   */
  java.util.List<java.lang.String> getSystemReservedExternalIpv6RangesList();
   ...
   */
  int getSystemReservedExternalIpv6RangesCount();
   ...
   */
  java.lang.String getSystemReservedExternalIpv6Ranges(int index);
   ...
   */
  com.google.protobuf.ByteString getSystemReservedExternalIpv6RangesBytes(int index);
   ...
   */
  java.util.List<java.lang.String> getSystemReservedInternalIpv6RangesList();
   ...
   */
  int getSystemReservedInternalIpv6RangesCount();
   ...
   */
  java.lang.String getSystemReservedInternalIpv6Ranges(int index);
