...
public final class InterconnectAttachmentGroupConfiguredAvailabilitySLAIntendedSlaBlockers
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < regions_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12367871, regions_.getRaw(i));
    }
    if (((bitField0_ & 0x00000002) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 93465183, documentationLink_);
    }
    for (int i = 0; i < zones_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 116085319, zones_.getRaw(i));
    }
    for (int i = 0; i < attachments_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 334744496, attachments_.getRaw(i));
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 381194847, blockerType_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 504745497, explanation_);
    }
    for (int i = 0; i < metros_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 533067386, metros_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(93465183, documentationLink_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < zones_.size(); i++) {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(381194847, blockerType_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(504745497, explanation_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < metros_.size(); i++) {
