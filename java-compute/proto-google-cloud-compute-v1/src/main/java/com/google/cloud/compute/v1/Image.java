...
public final class Image extends com.google.protobuf.GeneratedMessage
  ...
  private com.google.cloud.compute.v1.ImageParams params_;
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.ImageParams getParams() {
    return params_ == null ? com.google.cloud.compute.v1.ImageParams.getDefaultInstance() : params_;
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.ImageParamsOrBuilder getParamsOrBuilder() {
    return params_ == null ? com.google.cloud.compute.v1.ImageParams.getDefaultInstance() : params_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (((bitField0_ & 0x01000000) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 55328291, sourceImageId_);
    }
    ...
    if (((bitField0_ & 0x08000000) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 98962258, sourceSnapshotId_);
    }
    if (((bitField0_ & 0x00000040) != 0)) {
      output.writeBool(102135228, enableConfidentialCompute_);
    }
    if (((bitField0_ & 0x02000000) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 126061928, sourceSnapshot_);
    }
    ...
    if (((bitField0_ & 0x00000080) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 328751972, family_);
    }
    for (int i = 0; i < licenses_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 337642578, licenses_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x01000000) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(55328291, sourceImageId_);
    }
    if (((bitField0_ & 0x00002000) != 0)) {
    ...
    if (((bitField0_ & 0x08000000) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(98962258, sourceSnapshotId_);
    }
    if (((bitField0_ & 0x00000040) != 0)) {
      size +=
    ...
    if (((bitField0_ & 0x02000000) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(126061928, sourceSnapshot_);
    }
    if (((bitField0_ & 0x00000800) != 0)) {
    ...
    if (((bitField0_ & 0x00000080) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(328751972, family_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < licenses_.size(); i++) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetGuestOsFeaturesFieldBuilder();
        internalGetImageEncryptionKeyFieldBuilder();
        internalGetParamsFieldBuilder();
        internalGetRawDiskFieldBuilder();
        internalGetShieldedInstanceInitialStateFieldBuilder();
        internalGetSourceDiskEncryptionKeyFieldBuilder();
        internalGetSourceImageEncryptionKeyFieldBuilder();
        internalGetSourceSnapshotEncryptionKeyFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 1538854938:
              {
                input.readMessage(
                    internalGetShieldedInstanceInitialStateFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case -1865532718:
              {
                input.readMessage(
                    internalGetSourceSnapshotEncryptionKeyFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case -1258866630:
              {
                input.readMessage(
                    internalGetImageEncryptionKeyFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case -1242938022:
              {
                input.readMessage(
                    internalGetSourceImageEncryptionKeyFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case -270058846:
              {
                input.readMessage(internalGetRawDiskFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.compute.v1.GuestOsFeature.Builder getGuestOsFeaturesBuilder(int index) {
      return internalGetGuestOsFeaturesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.compute.v1.GuestOsFeature.Builder addGuestOsFeaturesBuilder() {
      return internalGetGuestOsFeaturesFieldBuilder()
    ...
    public java.util.List<com.google.cloud.compute.v1.GuestOsFeature.Builder>
      ...
      return internalGetGuestOsFeaturesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.compute.v1.CustomerEncryptionKey.Builder
      ...
      bitField0_ |= 0x00000400;
      onChanged();
      return internalGetImageEncryptionKeyFieldBuilder().getBuilder();
    }
    ...
    private com.google.cloud.compute.v1.ImageParams params_;
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.compute.v1.ImageParams,
            com.google.cloud.compute.v1.ImageParams.Builder,
            com.google.cloud.compute.v1.ImageParamsOrBuilder>
        paramsBuilder_;
    ...
    public com.google.cloud.compute.v1.ImageParams getParams() {
      if (paramsBuilder_ == null) {
        return params_ == null
            ? com.google.cloud.compute.v1.ImageParams.getDefaultInstance()
            : params_;
      } else {
     ...
     * <code>optional .google.cloud.compute.v1.ImageParams params = 78313862;</code>
     */
    public Builder setParams(com.google.cloud.compute.v1.ImageParams value) {
      if (paramsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>optional .google.cloud.compute.v1.ImageParams params = 78313862;</code>
     */
    public Builder setParams(com.google.cloud.compute.v1.ImageParams.Builder builderForValue) {
      if (paramsBuilder_ == null) {
     ...
     * <code>optional .google.cloud.compute.v1.ImageParams params = 78313862;</code>
     */
    public Builder mergeParams(com.google.cloud.compute.v1.ImageParams value) {
      if (paramsBuilder_ == null) {
        if (((bitField0_ & 0x00020000) != 0)
            && params_ != null
            && params_ != com.google.cloud.compute.v1.ImageParams.getDefaultInstance()) {
     ...
     * <code>optional .google.cloud.compute.v1.ImageParams params = 78313862;</code>
     */
    public com.google.cloud.compute.v1.ImageParams.Builder getParamsBuilder() {
      bitField0_ |= 0x00020000;
      onChanged();
    ...
    public com.google.cloud.compute.v1.RawDisk.Builder getRawDiskBuilder() {
      bitField0_ |= 0x00040000;
      onChanged();
      return internalGetRawDiskFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.compute.v1.InitialStateConfig.Builder
      ...
      bitField0_ |= 0x00400000;
      onChanged();
      return internalGetShieldedInstanceInitialStateFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.compute.v1.CustomerEncryptionKey.Builder
      ...
      bitField0_ |= 0x08000000;
      onChanged();
      return internalGetSourceImageEncryptionKeyFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.compute.v1.CustomerEncryptionKey.Builder
      ...
      bitField0_ |= 0x40000000;
      onChanged();
      return internalGetSourceSnapshotEncryptionKeyFieldBuilder().getBuilder();
    }
