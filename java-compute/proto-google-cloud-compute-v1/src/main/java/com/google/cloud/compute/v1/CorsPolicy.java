 ...
 */
public final class CorsPolicy extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < allowHeaders_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 45179024, allowHeaders_.getRaw(i));
    }
    for (int i = 0; i < allowOrigins_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 194914071, allowOrigins_.getRaw(i));
    }
    for (int i = 0; i < allowMethods_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 205405372, allowMethods_.getRaw(i));
    }
    ...
    for (int i = 0; i < exposeHeaders_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 247604747, exposeHeaders_.getRaw(i));
    }
