 ...
 */
public final class PacketMirroringFilter extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        PacketMirroringFilter.class.getName());
  }
  // Use PacketMirroringFilter.newBuilder() to construct.
  private PacketMirroringFilter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < iPProtocols_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 98544854, iPProtocols_.getRaw(i));
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 111150975, direction_);
    }
    for (int i = 0; i < cidrRanges_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 487901697, cidrRanges_.getRaw(i));
    }
