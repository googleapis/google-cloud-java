...
public interface StartInstancesInstanceGroupManagerRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.StartInstancesInstanceGroupManagerRequest)
   ...
   * </code>
   *
   * @return Whether the instanceGroupManagersStartInstancesRequestResource field is set.
   */
  boolean hasInstanceGroupManagersStartInstancesRequestResource();
   ...
   * </code>
   *
   * @return The instanceGroupManagersStartInstancesRequestResource.
   */
