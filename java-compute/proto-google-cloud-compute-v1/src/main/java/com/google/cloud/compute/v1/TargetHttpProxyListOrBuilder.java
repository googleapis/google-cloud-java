...
public interface TargetHttpProxyListOrBuilder
    extends
   ...
   */
  java.util.List<com.google.cloud.compute.v1.TargetHttpProxy> getItemsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.compute.v1.TargetHttpProxy items = 100526016;</code>
   */
  com.google.cloud.compute.v1.TargetHttpProxyOrBuilder getItemsOrBuilder(int index);
