...
public interface PerformMaintenanceReservationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.PerformMaintenanceReservationRequest)
   ...
   * </code>
   *
   * @return Whether the reservationsPerformMaintenanceRequestResource field is set.
   */
  boolean hasReservationsPerformMaintenanceRequestResource();
   ...
   * </code>
   *
   * @return The reservationsPerformMaintenanceRequestResource.
   */
  com.google.cloud.compute.v1.ReservationsPerformMaintenanceRequest
