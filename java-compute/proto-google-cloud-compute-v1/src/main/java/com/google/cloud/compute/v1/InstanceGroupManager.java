        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 177763082:
              {
                input.readMessage(
                    getResourcePoliciesFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case -300148702:
              {
                input.readMessage(getStandbyPolicyFieldBuilder().getBuilder(), extensionRegistry);
