...
// [START compute_v1_generated_MachineImages_SetLabels_LRO_async]
  ...
  public static void asyncSetLabelsLRO() throws Exception {
    ...
    try (MachineImagesClient machineImagesClient = MachineImagesClient.create()) {
      ...
      OperationFuture<Operation, Operation> future =
          machineImagesClient.setLabelsOperationCallable().futureCall(request);
      // Do something.
      Operation response = future.get();
    }
  }
}
// [END compute_v1_generated_MachineImages_SetLabels_LRO_async]
