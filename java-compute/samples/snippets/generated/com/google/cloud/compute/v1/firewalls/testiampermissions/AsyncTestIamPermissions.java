...
// [START compute_v1_generated_Firewalls_TestIamPermissions_async]
  ...
  public static void asyncTestIamPermissions() throws Exception {
    ...
    try (FirewallsClient firewallsClient = FirewallsClient.create()) {
      ...
      ApiFuture<TestPermissionsResponse> future =
          firewallsClient.testIamPermissionsCallable().futureCall(request);
      // Do something.
      TestPermissionsResponse response = future.get();
    }
  }
}
// [END compute_v1_generated_Firewalls_TestIamPermissions_async]
