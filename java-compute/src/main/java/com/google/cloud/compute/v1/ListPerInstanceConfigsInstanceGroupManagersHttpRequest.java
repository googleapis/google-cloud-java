...
@BetaApi
/**
 * Request object for method compute.instanceGroupManagers.listPerInstanceConfigs. Lists all of the
 * per-instance configs defined for the managed instance group. The orderBy query parameter is not
 * supported.
 */
public final class ListPerInstanceConfigsInstanceGroupManagersHttpRequest implements ApiMessage {
  ...
  private ListPerInstanceConfigsInstanceGroupManagersHttpRequest() {
  ...
  public static Builder newBuilder(
      ListPerInstanceConfigsInstanceGroupManagersHttpRequest prototype) {
  ...
  public static ListPerInstanceConfigsInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListPerInstanceConfigsInstanceGroupManagersHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListPerInstanceConfigsInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListPerInstanceConfigsInstanceGroupManagersHttpRequest other) {
      if (other == ListPerInstanceConfigsInstanceGroupManagersHttpRequest.getDefaultInstance())
        return this;
    ...
    Builder(ListPerInstanceConfigsInstanceGroupManagersHttpRequest source) {
    ...
    public ListPerInstanceConfigsInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new ListPerInstanceConfigsInstanceGroupManagersHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListPerInstanceConfigsInstanceGroupManagersHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListPerInstanceConfigsInstanceGroupManagersHttpRequest) {
      ListPerInstanceConfigsInstanceGroupManagersHttpRequest that =
          (ListPerInstanceConfigsInstanceGroupManagersHttpRequest) o;
