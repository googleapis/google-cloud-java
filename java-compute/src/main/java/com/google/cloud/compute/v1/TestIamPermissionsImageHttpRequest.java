...
@BetaApi
/**
 * Request object for method compute.images.testIamPermissions. Returns permissions that a caller
 * has on the specified resource.
 */
public final class TestIamPermissionsImageHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsImageHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsImageHttpRequest prototype) {
  ...
  public static TestIamPermissionsImageHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsImageHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsImageHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsImageHttpRequest other) {
      if (other == TestIamPermissionsImageHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsImageHttpRequest source) {
    ...
    public TestIamPermissionsImageHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsImageHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsImageHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsImageHttpRequest) {
      TestIamPermissionsImageHttpRequest that = (TestIamPermissionsImageHttpRequest) o;
