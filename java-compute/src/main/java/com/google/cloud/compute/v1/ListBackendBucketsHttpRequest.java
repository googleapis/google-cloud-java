...
public final class ListBackendBucketsHttpRequest implements ApiMessage {
  ...
  private ListBackendBucketsHttpRequest() {
  ...
  public static Builder newBuilder(ListBackendBucketsHttpRequest prototype) {
  ...
  public static ListBackendBucketsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListBackendBucketsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListBackendBucketsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListBackendBucketsHttpRequest other) {
      if (other == ListBackendBucketsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListBackendBucketsHttpRequest source) {
    ...
    public ListBackendBucketsHttpRequest build() {
      String missing = "";
      ...
      return new ListBackendBucketsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListBackendBucketsHttpRequest) {
      ListBackendBucketsHttpRequest that = (ListBackendBucketsHttpRequest) o;
