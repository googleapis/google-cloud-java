...
public final class InsertAddressHttpRequest implements ApiMessage {
   ...
   *
   * <p>- External IP addresses for VM instances - Regional external forwarding rules - Cloud NAT
   * external IP addresses - GFE based LBs in Standard Tier - Network LBs in Premium or Standard
   * Tier - Cloud VPN gateways (both Classic and HA)
   *
