...
public final class RegionDisksRemoveResourcePoliciesRequest implements ApiMessage {
  ...
  private RegionDisksRemoveResourcePoliciesRequest(List<String> resourcePolicies) {
  ...
  public static Builder newBuilder(RegionDisksRemoveResourcePoliciesRequest prototype) {
  ...
  private static final RegionDisksRemoveResourcePoliciesRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new RegionDisksRemoveResourcePoliciesRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RegionDisksRemoveResourcePoliciesRequest other) {
      if (other == RegionDisksRemoveResourcePoliciesRequest.getDefaultInstance()) return this;
    ...
    Builder(RegionDisksRemoveResourcePoliciesRequest source) {
    ...
    public RegionDisksRemoveResourcePoliciesRequest build() {
      return new RegionDisksRemoveResourcePoliciesRequest(resourcePolicies);
    }
  ...
  public String toString() {
    return "RegionDisksRemoveResourcePoliciesRequest{"
        + "resourcePolicies="
        + resourcePolicies
        + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RegionDisksRemoveResourcePoliciesRequest) {
      RegionDisksRemoveResourcePoliciesRequest that = (RegionDisksRemoveResourcePoliciesRequest) o;
