...
public final class ListSslPoliciesHttpRequest implements ApiMessage {
  ...
  private ListSslPoliciesHttpRequest() {
  ...
  public static Builder newBuilder(ListSslPoliciesHttpRequest prototype) {
  ...
  public static ListSslPoliciesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListSslPoliciesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListSslPoliciesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListSslPoliciesHttpRequest other) {
      if (other == ListSslPoliciesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListSslPoliciesHttpRequest source) {
    ...
    public ListSslPoliciesHttpRequest build() {
      String missing = "";
      ...
      return new ListSslPoliciesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListSslPoliciesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListSslPoliciesHttpRequest) {
      ListSslPoliciesHttpRequest that = (ListSslPoliciesHttpRequest) o;
