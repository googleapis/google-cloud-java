...
public final class GetDiagnosticsInterconnectHttpRequest implements ApiMessage {
  ...
  private GetDiagnosticsInterconnectHttpRequest() {
  ...
  public static Builder newBuilder(GetDiagnosticsInterconnectHttpRequest prototype) {
  ...
  public static GetDiagnosticsInterconnectHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetDiagnosticsInterconnectHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetDiagnosticsInterconnectHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetDiagnosticsInterconnectHttpRequest other) {
      if (other == GetDiagnosticsInterconnectHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetDiagnosticsInterconnectHttpRequest source) {
    ...
    public GetDiagnosticsInterconnectHttpRequest build() {
      String missing = "";
      ...
      return new GetDiagnosticsInterconnectHttpRequest(
  ...
  public String toString() {
    return "GetDiagnosticsInterconnectHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetDiagnosticsInterconnectHttpRequest) {
      GetDiagnosticsInterconnectHttpRequest that = (GetDiagnosticsInterconnectHttpRequest) o;
