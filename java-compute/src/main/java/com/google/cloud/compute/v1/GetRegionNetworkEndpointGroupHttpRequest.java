...
@BetaApi
/**
 * Request object for method compute.regionNetworkEndpointGroups.get. Returns the specified network
 * endpoint group. Gets a list of available network endpoint groups by making a list() request.
 */
public final class GetRegionNetworkEndpointGroupHttpRequest implements ApiMessage {
  ...
  private GetRegionNetworkEndpointGroupHttpRequest() {
  ...
  public static Builder newBuilder(GetRegionNetworkEndpointGroupHttpRequest prototype) {
  ...
  public static GetRegionNetworkEndpointGroupHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetRegionNetworkEndpointGroupHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetRegionNetworkEndpointGroupHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetRegionNetworkEndpointGroupHttpRequest other) {
      if (other == GetRegionNetworkEndpointGroupHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetRegionNetworkEndpointGroupHttpRequest source) {
     ...
     * format `{project}/regions/{region}/networkEndpointGroups/{networkEndpointGroup}`.
     * \`{networkEndpointGroup}\` must start with a letter, and contain only letters (\`[A-Za-z]\`),
     * numbers (\`[0-9]\`), dashes (\`-\`), &#42; underscores (\`_\`), periods (\`.\`), tildes
     * (\`~\`), plus (\`+\`) or percent &#42; signs (\`%\`). It must be between 3 and 255 characters
     * in length, and it &#42; must not start with \`"goog"\`.
    ...
    public GetRegionNetworkEndpointGroupHttpRequest build() {
      String missing = "";
      ...
      return new GetRegionNetworkEndpointGroupHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "GetRegionNetworkEndpointGroupHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetRegionNetworkEndpointGroupHttpRequest) {
      GetRegionNetworkEndpointGroupHttpRequest that = (GetRegionNetworkEndpointGroupHttpRequest) o;
