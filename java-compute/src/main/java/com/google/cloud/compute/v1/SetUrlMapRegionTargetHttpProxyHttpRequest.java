...
@BetaApi
/**
 * Request object for method compute.regionTargetHttpProxies.setUrlMap. Changes the URL map for
 * TargetHttpProxy.
 */
public final class SetUrlMapRegionTargetHttpProxyHttpRequest implements ApiMessage {
  ...
  private SetUrlMapRegionTargetHttpProxyHttpRequest() {
   ...
   * \`{targetHttpProxy}\` must start with a letter, and contain only letters (\`[A-Za-z]\`),
  ...
  public static Builder newBuilder(SetUrlMapRegionTargetHttpProxyHttpRequest prototype) {
  ...
  public static SetUrlMapRegionTargetHttpProxyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetUrlMapRegionTargetHttpProxyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetUrlMapRegionTargetHttpProxyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetUrlMapRegionTargetHttpProxyHttpRequest other) {
      if (other == SetUrlMapRegionTargetHttpProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetUrlMapRegionTargetHttpProxyHttpRequest source) {
    ...
    public SetUrlMapRegionTargetHttpProxyHttpRequest build() {
      String missing = "";
      ...
      return new SetUrlMapRegionTargetHttpProxyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetUrlMapRegionTargetHttpProxyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetUrlMapRegionTargetHttpProxyHttpRequest) {
      SetUrlMapRegionTargetHttpProxyHttpRequest that =
          (SetUrlMapRegionTargetHttpProxyHttpRequest) o;
