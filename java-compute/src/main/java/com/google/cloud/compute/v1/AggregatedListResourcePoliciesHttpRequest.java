...
public final class AggregatedListResourcePoliciesHttpRequest implements ApiMessage {
  ...
  private AggregatedListResourcePoliciesHttpRequest() {
  ...
  /**
   * Project ID for this request. It must have the format `{project}/aggregated/resourcePolicies`.
  ...
  public static Builder newBuilder(AggregatedListResourcePoliciesHttpRequest prototype) {
  ...
  public static AggregatedListResourcePoliciesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListResourcePoliciesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListResourcePoliciesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListResourcePoliciesHttpRequest other) {
      if (other == AggregatedListResourcePoliciesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListResourcePoliciesHttpRequest source) {
    ...
    public AggregatedListResourcePoliciesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListResourcePoliciesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListResourcePoliciesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListResourcePoliciesHttpRequest) {
      AggregatedListResourcePoliciesHttpRequest that =
          (AggregatedListResourcePoliciesHttpRequest) o;
