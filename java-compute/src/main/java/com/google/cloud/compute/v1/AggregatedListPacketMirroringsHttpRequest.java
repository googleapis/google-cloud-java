...
@BetaApi
/**
 * Request object for method compute.packetMirrorings.aggregatedList. Retrieves an aggregated list
 * of packetMirrorings.
 */
public final class AggregatedListPacketMirroringsHttpRequest implements ApiMessage {
  ...
  private AggregatedListPacketMirroringsHttpRequest() {
  ...
  /**
   * Project ID for this request. It must have the format `{project}/aggregated/packetMirrorings`.
  ...
  public static Builder newBuilder(AggregatedListPacketMirroringsHttpRequest prototype) {
  ...
  public static AggregatedListPacketMirroringsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListPacketMirroringsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListPacketMirroringsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListPacketMirroringsHttpRequest other) {
      if (other == AggregatedListPacketMirroringsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListPacketMirroringsHttpRequest source) {
    ...
    public AggregatedListPacketMirroringsHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListPacketMirroringsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListPacketMirroringsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListPacketMirroringsHttpRequest) {
      AggregatedListPacketMirroringsHttpRequest that =
          (AggregatedListPacketMirroringsHttpRequest) o;
