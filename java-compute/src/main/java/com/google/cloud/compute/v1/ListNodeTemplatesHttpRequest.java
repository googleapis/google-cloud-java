...
@BetaApi
/**
 * Request object for method compute.nodeTemplates.list. Retrieves a list of node templates
 * available to the specified project.
 */
public final class ListNodeTemplatesHttpRequest implements ApiMessage {
  ...
  private ListNodeTemplatesHttpRequest() {
  ...
  public static Builder newBuilder(ListNodeTemplatesHttpRequest prototype) {
  ...
  public static ListNodeTemplatesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListNodeTemplatesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListNodeTemplatesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListNodeTemplatesHttpRequest other) {
      if (other == ListNodeTemplatesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListNodeTemplatesHttpRequest source) {
    ...
    public ListNodeTemplatesHttpRequest build() {
      String missing = "";
      ...
      return new ListNodeTemplatesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListNodeTemplatesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListNodeTemplatesHttpRequest) {
      ListNodeTemplatesHttpRequest that = (ListNodeTemplatesHttpRequest) o;
