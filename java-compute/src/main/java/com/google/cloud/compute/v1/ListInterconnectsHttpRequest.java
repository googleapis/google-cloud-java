...
@BetaApi
/**
 * Request object for method compute.interconnects.list. Retrieves the list of interconnect
 * available to the specified project.
 */
public final class ListInterconnectsHttpRequest implements ApiMessage {
  ...
  private ListInterconnectsHttpRequest() {
  ...
  public static Builder newBuilder(ListInterconnectsHttpRequest prototype) {
  ...
  public static ListInterconnectsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListInterconnectsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListInterconnectsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListInterconnectsHttpRequest other) {
      if (other == ListInterconnectsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListInterconnectsHttpRequest source) {
    ...
    public ListInterconnectsHttpRequest build() {
      String missing = "";
      ...
      return new ListInterconnectsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListInterconnectsHttpRequest) {
      ListInterconnectsHttpRequest that = (ListInterconnectsHttpRequest) o;
