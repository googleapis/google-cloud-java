...
@Generated("by GAPIC")
@BetaApi
/** Request object for method compute.routes.delete. Deletes the specified Route resource. */
public final class DeleteRouteHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteRouteHttpRequest other) {
      if (other == DeleteRouteHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteRouteHttpRequest source) {
    ...
    public DeleteRouteHttpRequest build() {
      ...
      return new DeleteRouteHttpRequest(
          access_token, callback, fields, key, prettyPrint, quotaUser, requestId, route, userIp);
    }
