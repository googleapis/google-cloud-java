...
public final class StartInstanceHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(StartInstanceHttpRequest other) {
      if (other == StartInstanceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(StartInstanceHttpRequest source) {
    ...
    public StartInstanceHttpRequest build() {
      ...
      return new StartInstanceHttpRequest(
          access_token, callback, fields, instance, key, prettyPrint, quotaUser, requestId, userIp);
    }
