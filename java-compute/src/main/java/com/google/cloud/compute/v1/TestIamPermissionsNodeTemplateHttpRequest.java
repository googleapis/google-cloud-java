...
@BetaApi
/**
 * Request object for method compute.nodeTemplates.testIamPermissions. Returns permissions that a
 * caller has on the specified resource.
 */
public final class TestIamPermissionsNodeTemplateHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsNodeTemplateHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsNodeTemplateHttpRequest prototype) {
  ...
  public static TestIamPermissionsNodeTemplateHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsNodeTemplateHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsNodeTemplateHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsNodeTemplateHttpRequest other) {
      if (other == TestIamPermissionsNodeTemplateHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsNodeTemplateHttpRequest source) {
    ...
    public TestIamPermissionsNodeTemplateHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsNodeTemplateHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsNodeTemplateHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsNodeTemplateHttpRequest) {
      TestIamPermissionsNodeTemplateHttpRequest that =
          (TestIamPermissionsNodeTemplateHttpRequest) o;
