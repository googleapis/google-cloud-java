...
@BetaApi
/**
 * Request object for method compute.regionHealthChecks.list. Retrieves the list of HealthCheck
 * resources available to the specified project.
 */
public final class ListRegionHealthChecksHttpRequest implements ApiMessage {
  ...
  private ListRegionHealthChecksHttpRequest() {
   ...
   * `{project}/regions/{region}/healthChecks`. \`{region}\` must start with a letter, and contain
  ...
  public static Builder newBuilder(ListRegionHealthChecksHttpRequest prototype) {
  ...
  public static ListRegionHealthChecksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionHealthChecksHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionHealthChecksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionHealthChecksHttpRequest other) {
      if (other == ListRegionHealthChecksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionHealthChecksHttpRequest source) {
    ...
    public ListRegionHealthChecksHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionHealthChecksHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionHealthChecksHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionHealthChecksHttpRequest) {
      ListRegionHealthChecksHttpRequest that = (ListRegionHealthChecksHttpRequest) o;
