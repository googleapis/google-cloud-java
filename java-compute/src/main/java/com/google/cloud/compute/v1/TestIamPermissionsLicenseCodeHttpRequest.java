...
public final class TestIamPermissionsLicenseCodeHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsLicenseCodeHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsLicenseCodeHttpRequest prototype) {
  ...
  public static TestIamPermissionsLicenseCodeHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsLicenseCodeHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsLicenseCodeHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsLicenseCodeHttpRequest other) {
      if (other == TestIamPermissionsLicenseCodeHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsLicenseCodeHttpRequest source) {
    ...
    public TestIamPermissionsLicenseCodeHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsLicenseCodeHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsLicenseCodeHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsLicenseCodeHttpRequest) {
      TestIamPermissionsLicenseCodeHttpRequest that = (TestIamPermissionsLicenseCodeHttpRequest) o;
