...
@Generated("by GAPIC")
@BetaApi
public final class NetworkEndpointGroupsAttachEndpointsRequest implements ApiMessage {
  ...
  private NetworkEndpointGroupsAttachEndpointsRequest(List<NetworkEndpoint> networkEndpoints) {
  ...
  public static Builder newBuilder(NetworkEndpointGroupsAttachEndpointsRequest prototype) {
  ...
  private static final NetworkEndpointGroupsAttachEndpointsRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new NetworkEndpointGroupsAttachEndpointsRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(NetworkEndpointGroupsAttachEndpointsRequest other) {
      if (other == NetworkEndpointGroupsAttachEndpointsRequest.getDefaultInstance()) return this;
    ...
    Builder(NetworkEndpointGroupsAttachEndpointsRequest source) {
    ...
    public NetworkEndpointGroupsAttachEndpointsRequest build() {
      return new NetworkEndpointGroupsAttachEndpointsRequest(networkEndpoints);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof NetworkEndpointGroupsAttachEndpointsRequest) {
      NetworkEndpointGroupsAttachEndpointsRequest that =
          (NetworkEndpointGroupsAttachEndpointsRequest) o;
