...
@BetaApi
/**
 * Request object for method compute.regionTargetHttpsProxies.setUrlMap. Changes the URL map for
 * TargetHttpsProxy.
 */
public final class SetUrlMapRegionTargetHttpsProxyHttpRequest implements ApiMessage {
  ...
  private SetUrlMapRegionTargetHttpsProxyHttpRequest() {
  ...
  /**
   * Name of the TargetHttpsProxy to set a URL map for. It must have the format
  ...
  public static Builder newBuilder(SetUrlMapRegionTargetHttpsProxyHttpRequest prototype) {
  ...
  public static SetUrlMapRegionTargetHttpsProxyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetUrlMapRegionTargetHttpsProxyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetUrlMapRegionTargetHttpsProxyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetUrlMapRegionTargetHttpsProxyHttpRequest other) {
      if (other == SetUrlMapRegionTargetHttpsProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetUrlMapRegionTargetHttpsProxyHttpRequest source) {
    ...
    public SetUrlMapRegionTargetHttpsProxyHttpRequest build() {
      String missing = "";
      ...
      return new SetUrlMapRegionTargetHttpsProxyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetUrlMapRegionTargetHttpsProxyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetUrlMapRegionTargetHttpsProxyHttpRequest) {
      SetUrlMapRegionTargetHttpsProxyHttpRequest that =
          (SetUrlMapRegionTargetHttpsProxyHttpRequest) o;
