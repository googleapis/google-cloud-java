...
public final class AggregatedListTargetHttpsProxiesHttpRequest implements ApiMessage {
  ...
  private AggregatedListTargetHttpsProxiesHttpRequest() {
   ...
   * `{project}/aggregated/targetHttpsProxies`. \`{project}\` must start with a letter, and contain
  ...
  public static Builder newBuilder(AggregatedListTargetHttpsProxiesHttpRequest prototype) {
  ...
  public static AggregatedListTargetHttpsProxiesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListTargetHttpsProxiesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListTargetHttpsProxiesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListTargetHttpsProxiesHttpRequest other) {
      if (other == AggregatedListTargetHttpsProxiesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListTargetHttpsProxiesHttpRequest source) {
    ...
    /**
     * Name of the project scoping this request. It must have the format
     * `{project}/aggregated/targetHttpsProxies`. \`{project}\` must start with a letter, and
    ...
    public AggregatedListTargetHttpsProxiesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListTargetHttpsProxiesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListTargetHttpsProxiesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListTargetHttpsProxiesHttpRequest) {
      AggregatedListTargetHttpsProxiesHttpRequest that =
          (AggregatedListTargetHttpsProxiesHttpRequest) o;
