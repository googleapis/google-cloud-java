...
@BetaApi
/**
 * Request object for method compute.vpnGateways.list. Retrieves a list of VPN gateways available to
 * the specified project and region. (== suppress_warning http-rest-shadowed ==)
 */
public final class ListVpnGatewaysHttpRequest implements ApiMessage {
  ...
  private ListVpnGatewaysHttpRequest() {
   ...
   * `{project}/regions/{region}/vpnGateways`. \`{region}\` must start with a letter, and contain
  ...
  public static Builder newBuilder(ListVpnGatewaysHttpRequest prototype) {
  ...
  public static ListVpnGatewaysHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListVpnGatewaysHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListVpnGatewaysHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListVpnGatewaysHttpRequest other) {
      if (other == ListVpnGatewaysHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListVpnGatewaysHttpRequest source) {
    ...
    public ListVpnGatewaysHttpRequest build() {
      String missing = "";
      ...
      return new ListVpnGatewaysHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListVpnGatewaysHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListVpnGatewaysHttpRequest) {
      ListVpnGatewaysHttpRequest that = (ListVpnGatewaysHttpRequest) o;
