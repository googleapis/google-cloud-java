...
public final class AggregatedListReservationsHttpRequest implements ApiMessage {
  ...
  private AggregatedListReservationsHttpRequest() {
  ...
  /**
   * Project ID for this request. It must have the format `{project}/aggregated/reservations`.
  ...
  public static Builder newBuilder(AggregatedListReservationsHttpRequest prototype) {
  ...
  public static AggregatedListReservationsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListReservationsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListReservationsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListReservationsHttpRequest other) {
      if (other == AggregatedListReservationsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListReservationsHttpRequest source) {
    ...
    public AggregatedListReservationsHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListReservationsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListReservationsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListReservationsHttpRequest) {
      AggregatedListReservationsHttpRequest that = (AggregatedListReservationsHttpRequest) o;
