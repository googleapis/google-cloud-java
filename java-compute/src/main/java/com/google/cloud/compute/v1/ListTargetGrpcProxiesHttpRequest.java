...
@BetaApi
/**
 * Request object for method compute.targetGrpcProxies.list. Lists the TargetGrpcProxies for a
 * project in the given scope.
 */
public final class ListTargetGrpcProxiesHttpRequest implements ApiMessage {
  ...
  private ListTargetGrpcProxiesHttpRequest() {
  ...
  /**
   * Project ID for this request. It must have the format `{project}/global/targetGrpcProxies`.
  ...
  public static Builder newBuilder(ListTargetGrpcProxiesHttpRequest prototype) {
  ...
  public static ListTargetGrpcProxiesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListTargetGrpcProxiesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListTargetGrpcProxiesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListTargetGrpcProxiesHttpRequest other) {
      if (other == ListTargetGrpcProxiesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListTargetGrpcProxiesHttpRequest source) {
    ...
    public ListTargetGrpcProxiesHttpRequest build() {
      String missing = "";
      ...
      return new ListTargetGrpcProxiesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListTargetGrpcProxiesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListTargetGrpcProxiesHttpRequest) {
      ListTargetGrpcProxiesHttpRequest that = (ListTargetGrpcProxiesHttpRequest) o;
