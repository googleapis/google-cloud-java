...
@BetaApi
/**
 * Request object for method compute.disks.testIamPermissions. Returns permissions that a caller has
 * on the specified resource.
 */
public final class TestIamPermissionsDiskHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsDiskHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsDiskHttpRequest prototype) {
  ...
  public static TestIamPermissionsDiskHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsDiskHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsDiskHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsDiskHttpRequest other) {
      if (other == TestIamPermissionsDiskHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsDiskHttpRequest source) {
    ...
    public TestIamPermissionsDiskHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsDiskHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsDiskHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsDiskHttpRequest) {
      TestIamPermissionsDiskHttpRequest that = (TestIamPermissionsDiskHttpRequest) o;
