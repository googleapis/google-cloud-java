...
public final class ListSecurityPoliciesHttpRequest implements ApiMessage {
  ...
  private ListSecurityPoliciesHttpRequest() {
  ...
  public static Builder newBuilder(ListSecurityPoliciesHttpRequest prototype) {
  ...
  public static ListSecurityPoliciesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListSecurityPoliciesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListSecurityPoliciesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListSecurityPoliciesHttpRequest other) {
      if (other == ListSecurityPoliciesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListSecurityPoliciesHttpRequest source) {
    ...
    public ListSecurityPoliciesHttpRequest build() {
      String missing = "";
      ...
      return new ListSecurityPoliciesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListSecurityPoliciesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListSecurityPoliciesHttpRequest) {
      ListSecurityPoliciesHttpRequest that = (ListSecurityPoliciesHttpRequest) o;
