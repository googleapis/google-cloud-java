...
public final class ListErrorsRegionInstanceGroupManagersHttpRequest implements ApiMessage {
  ...
  private ListErrorsRegionInstanceGroupManagersHttpRequest() {
   ...
   * (?:[a-z](?:[-a-z0-9]{0,61}[a-z0-9])?)|[1-9][0-9]{0,19}. It must have the format
  ...
  public static Builder newBuilder(ListErrorsRegionInstanceGroupManagersHttpRequest prototype) {
  ...
  public static ListErrorsRegionInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListErrorsRegionInstanceGroupManagersHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListErrorsRegionInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListErrorsRegionInstanceGroupManagersHttpRequest other) {
      if (other == ListErrorsRegionInstanceGroupManagersHttpRequest.getDefaultInstance())
        return this;
    ...
    Builder(ListErrorsRegionInstanceGroupManagersHttpRequest source) {
    ...
    public ListErrorsRegionInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new ListErrorsRegionInstanceGroupManagersHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListErrorsRegionInstanceGroupManagersHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListErrorsRegionInstanceGroupManagersHttpRequest) {
      ListErrorsRegionInstanceGroupManagersHttpRequest that =
          (ListErrorsRegionInstanceGroupManagersHttpRequest) o;
