...
@BetaApi
/**
 * Request object for method compute.httpHealthChecks.get. Returns the specified HttpHealthCheck
 * resource. Gets a list of available HTTP health checks by making a list() request.
 */
public final class GetHttpHealthCheckHttpRequest implements ApiMessage {
  ...
  private GetHttpHealthCheckHttpRequest() {
  ...
  public static Builder newBuilder(GetHttpHealthCheckHttpRequest prototype) {
  ...
  public static GetHttpHealthCheckHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetHttpHealthCheckHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetHttpHealthCheckHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetHttpHealthCheckHttpRequest other) {
      if (other == GetHttpHealthCheckHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetHttpHealthCheckHttpRequest source) {
    ...
    public GetHttpHealthCheckHttpRequest build() {
      ...
      return new GetHttpHealthCheckHttpRequest(
  ...
  public String toString() {
    return "GetHttpHealthCheckHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetHttpHealthCheckHttpRequest) {
      GetHttpHealthCheckHttpRequest that = (GetHttpHealthCheckHttpRequest) o;
