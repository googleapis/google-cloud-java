...
public final class GetLicenseCodeHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(GetLicenseCodeHttpRequest prototype) {
  ...
  private static final GetLicenseCodeHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetLicenseCodeHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetLicenseCodeHttpRequest other) {
      if (other == GetLicenseCodeHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetLicenseCodeHttpRequest source) {
    ...
    public GetLicenseCodeHttpRequest build() {
      ...
      return new GetLicenseCodeHttpRequest(
          access_token, callback, fields, key, licenseCode, prettyPrint, quotaUser, userIp);
    }
  ...
  public String toString() {
    return "GetLicenseCodeHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetLicenseCodeHttpRequest) {
      GetLicenseCodeHttpRequest that = (GetLicenseCodeHttpRequest) o;
