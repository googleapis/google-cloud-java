...
public final class DeleteRegionUrlMapHttpRequest implements ApiMessage {
  ...
  private DeleteRegionUrlMapHttpRequest() {
  ...
  public static Builder newBuilder(DeleteRegionUrlMapHttpRequest prototype) {
  ...
  public static DeleteRegionUrlMapHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final DeleteRegionUrlMapHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new DeleteRegionUrlMapHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(DeleteRegionUrlMapHttpRequest other) {
      if (other == DeleteRegionUrlMapHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(DeleteRegionUrlMapHttpRequest source) {
    ...
    public DeleteRegionUrlMapHttpRequest build() {
      String missing = "";
      ...
      return new DeleteRegionUrlMapHttpRequest(
          access_token, callback, fields, key, prettyPrint, quotaUser, requestId, urlMap, userIp);
    }
  ...
  public String toString() {
    return "DeleteRegionUrlMapHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof DeleteRegionUrlMapHttpRequest) {
      DeleteRegionUrlMapHttpRequest that = (DeleteRegionUrlMapHttpRequest) o;
