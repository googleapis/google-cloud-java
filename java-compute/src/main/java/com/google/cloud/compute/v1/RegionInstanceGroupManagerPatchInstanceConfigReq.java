...
public final class RegionInstanceGroupManagerPatchInstanceConfigReq implements ApiMessage {
  ...
  public static Builder newBuilder(RegionInstanceGroupManagerPatchInstanceConfigReq prototype) {
  ...
  public static RegionInstanceGroupManagerPatchInstanceConfigReq getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final RegionInstanceGroupManagerPatchInstanceConfigReq DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new RegionInstanceGroupManagerPatchInstanceConfigReq();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RegionInstanceGroupManagerPatchInstanceConfigReq other) {
      if (other == RegionInstanceGroupManagerPatchInstanceConfigReq.getDefaultInstance())
        return this;
    ...
    Builder(RegionInstanceGroupManagerPatchInstanceConfigReq source) {
    ...
    public RegionInstanceGroupManagerPatchInstanceConfigReq build() {
      return new RegionInstanceGroupManagerPatchInstanceConfigReq(perInstanceConfigs);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RegionInstanceGroupManagerPatchInstanceConfigReq) {
      RegionInstanceGroupManagerPatchInstanceConfigReq that =
          (RegionInstanceGroupManagerPatchInstanceConfigReq) o;
