...
public final class RemoveRuleSecurityPolicyHttpRequest implements ApiMessage {
  ...
  private RemoveRuleSecurityPolicyHttpRequest() {
  ...
  public static Builder newBuilder(RemoveRuleSecurityPolicyHttpRequest prototype) {
  ...
  public static RemoveRuleSecurityPolicyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final RemoveRuleSecurityPolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new RemoveRuleSecurityPolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RemoveRuleSecurityPolicyHttpRequest other) {
      if (other == RemoveRuleSecurityPolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(RemoveRuleSecurityPolicyHttpRequest source) {
    ...
    public RemoveRuleSecurityPolicyHttpRequest build() {
      String missing = "";
      ...
      return new RemoveRuleSecurityPolicyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "RemoveRuleSecurityPolicyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RemoveRuleSecurityPolicyHttpRequest) {
      RemoveRuleSecurityPolicyHttpRequest that = (RemoveRuleSecurityPolicyHttpRequest) o;
