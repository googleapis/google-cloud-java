...
public final class NodeGroupsListNodes implements ApiMessage {
  ...
  public static Builder newBuilder(NodeGroupsListNodes prototype) {
  ...
  private static final NodeGroupsListNodes DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new NodeGroupsListNodes();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(NodeGroupsListNodes other) {
      if (other == NodeGroupsListNodes.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(NodeGroupsListNodes source) {
      this.id = source.id;
    ...
    public NodeGroupsListNodes build() {
      ...
      return new NodeGroupsListNodes(id, items, kind, nextPageToken, selfLink, warning);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof NodeGroupsListNodes) {
      NodeGroupsListNodes that = (NodeGroupsListNodes) o;
