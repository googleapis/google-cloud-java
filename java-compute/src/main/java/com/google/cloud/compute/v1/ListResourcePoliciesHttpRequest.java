...
public final class ListResourcePoliciesHttpRequest implements ApiMessage {
  ...
  private ListResourcePoliciesHttpRequest() {
   ...
   * `{project}/regions/{region}/resourcePolicies`. \`{region}\` must start with a letter, and
  ...
  public static Builder newBuilder(ListResourcePoliciesHttpRequest prototype) {
  ...
  public static ListResourcePoliciesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListResourcePoliciesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListResourcePoliciesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListResourcePoliciesHttpRequest other) {
      if (other == ListResourcePoliciesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListResourcePoliciesHttpRequest source) {
    ...
    public ListResourcePoliciesHttpRequest build() {
      String missing = "";
      ...
      return new ListResourcePoliciesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListResourcePoliciesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListResourcePoliciesHttpRequest) {
      ListResourcePoliciesHttpRequest that = (ListResourcePoliciesHttpRequest) o;
