...
@BetaApi
/**
 * Request object for method compute.regionNetworkEndpointGroups.insert. Creates a network endpoint
 * group in the specified project using the parameters that are included in the request.
 */
public final class InsertRegionNetworkEndpointGroupHttpRequest implements ApiMessage {
  ...
  private InsertRegionNetworkEndpointGroupHttpRequest() {
  ...
  /**
   * The name of the region where you want to create the network endpoint group. It should comply
   * with RFC1035. It must have the format `{project}/regions/{region}/networkEndpointGroups`.
  ...
  public static Builder newBuilder(InsertRegionNetworkEndpointGroupHttpRequest prototype) {
  ...
  public static InsertRegionNetworkEndpointGroupHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertRegionNetworkEndpointGroupHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertRegionNetworkEndpointGroupHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertRegionNetworkEndpointGroupHttpRequest other) {
      if (other == InsertRegionNetworkEndpointGroupHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(InsertRegionNetworkEndpointGroupHttpRequest source) {
    ...
    public InsertRegionNetworkEndpointGroupHttpRequest build() {
      String missing = "";
      ...
      return new InsertRegionNetworkEndpointGroupHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "InsertRegionNetworkEndpointGroupHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertRegionNetworkEndpointGroupHttpRequest) {
      InsertRegionNetworkEndpointGroupHttpRequest that =
          (InsertRegionNetworkEndpointGroupHttpRequest) o;
