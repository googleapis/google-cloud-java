...
public final class InsertVpnTunnelHttpRequest implements ApiMessage {
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("vpnTunnelResource".equals(fieldName)) {
  ...
  @Nullable
  @Override
  public VpnTunnel getApiMessageRequestBody() {
    return vpnTunnelResource;
  }
  ...
  public static class Builder {
    ...
    private VpnTunnel vpnTunnelResource;

    Builder() {}

    public Builder mergeFrom(InsertVpnTunnelHttpRequest other) {
      if (other == InsertVpnTunnelHttpRequest.getDefaultInstance()) return this;
      ...
      if (other.getVpnTunnelResource() != null) {
        this.vpnTunnelResource = other.vpnTunnelResource;
      }
      return this;
    }

    Builder(InsertVpnTunnelHttpRequest source) {
      ...
      this.vpnTunnelResource = source.vpnTunnelResource;
    }
    ...
    public Builder clone() {
      ...
      newBuilder.setVpnTunnelResource(this.vpnTunnelResource);
      return newBuilder;
    }
  }
