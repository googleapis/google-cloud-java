...
@BetaApi
/**
 * Request object for method compute.regionInstanceGroupManagers.listPerInstanceConfigs. Lists all
 * of the per-instance configs defined for the managed instance group. The orderBy query parameter
 * is not supported.
 */
public final class ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest
  ...
  private ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest() {
  ...
  public static Builder newBuilder(
      ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest prototype) {
  ...
  public static ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest
      DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest other) {
      if (other
          == ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest.getDefaultInstance())
        return this;
    ...
    Builder(ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest source) {
    ...
    public ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest) {
      ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest that =
          (ListPerInstanceConfigsRegionInstanceGroupManagersHttpRequest) o;
