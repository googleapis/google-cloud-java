...
public final class RegionInstanceGroupManagersCreateInstancesRequest implements ApiMessage {
  ...
  private static final RegionInstanceGroupManagersCreateInstancesRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new RegionInstanceGroupManagersCreateInstancesRequest();
  }
  ...
  public static class Builder {
    ...
    public RegionInstanceGroupManagersCreateInstancesRequest build() {
      return new RegionInstanceGroupManagersCreateInstancesRequest(instances);
    }
  ...
  public String toString() {
    return "RegionInstanceGroupManagersCreateInstancesRequest{" + "instances=" + instances + "}";
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RegionInstanceGroupManagersCreateInstancesRequest) {
      RegionInstanceGroupManagersCreateInstancesRequest that =
          (RegionInstanceGroupManagersCreateInstancesRequest) o;
