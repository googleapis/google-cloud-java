...
@BetaApi
/**
 * Request object for method compute.packetMirrorings.list. Retrieves a list of PacketMirroring
 * resources available to the specified project and region.
 */
public final class ListPacketMirroringsHttpRequest implements ApiMessage {
  ...
  private ListPacketMirroringsHttpRequest() {
  ...
  public static Builder newBuilder(ListPacketMirroringsHttpRequest prototype) {
  ...
  public static ListPacketMirroringsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListPacketMirroringsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListPacketMirroringsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListPacketMirroringsHttpRequest other) {
      if (other == ListPacketMirroringsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListPacketMirroringsHttpRequest source) {
    ...
    public ListPacketMirroringsHttpRequest build() {
      String missing = "";
      ...
      return new ListPacketMirroringsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListPacketMirroringsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListPacketMirroringsHttpRequest) {
      ListPacketMirroringsHttpRequest that = (ListPacketMirroringsHttpRequest) o;
