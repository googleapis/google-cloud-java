...
public final class ListRegionDisksHttpRequest implements ApiMessage {
  ...
  private ListRegionDisksHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionDisksHttpRequest prototype) {
  ...
  public static ListRegionDisksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionDisksHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionDisksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionDisksHttpRequest other) {
      if (other == ListRegionDisksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionDisksHttpRequest source) {
    ...
    public ListRegionDisksHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionDisksHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionDisksHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionDisksHttpRequest) {
      ListRegionDisksHttpRequest that = (ListRegionDisksHttpRequest) o;
