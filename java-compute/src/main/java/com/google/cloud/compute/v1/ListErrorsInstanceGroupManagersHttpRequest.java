...
public final class ListErrorsInstanceGroupManagersHttpRequest implements ApiMessage {
  ...
  private ListErrorsInstanceGroupManagersHttpRequest() {
  ...
  public static Builder newBuilder(ListErrorsInstanceGroupManagersHttpRequest prototype) {
  ...
  public static ListErrorsInstanceGroupManagersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListErrorsInstanceGroupManagersHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListErrorsInstanceGroupManagersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListErrorsInstanceGroupManagersHttpRequest other) {
      if (other == ListErrorsInstanceGroupManagersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListErrorsInstanceGroupManagersHttpRequest source) {
    ...
    public ListErrorsInstanceGroupManagersHttpRequest build() {
      String missing = "";
      ...
      return new ListErrorsInstanceGroupManagersHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListErrorsInstanceGroupManagersHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListErrorsInstanceGroupManagersHttpRequest) {
      ListErrorsInstanceGroupManagersHttpRequest that =
          (ListErrorsInstanceGroupManagersHttpRequest) o;
