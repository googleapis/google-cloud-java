...
@BetaApi
/**
 * Request object for method compute.vpnGateways.aggregatedList. Retrieves an aggregated list of VPN
 * gateways.
 */
public final class AggregatedListVpnGatewaysHttpRequest implements ApiMessage {
  ...
  private AggregatedListVpnGatewaysHttpRequest() {
  ...
  /**
   * Project ID for this request. It must have the format `{project}/aggregated/vpnGateways`.
  ...
  public static Builder newBuilder(AggregatedListVpnGatewaysHttpRequest prototype) {
  ...
  public static AggregatedListVpnGatewaysHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListVpnGatewaysHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListVpnGatewaysHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListVpnGatewaysHttpRequest other) {
      if (other == AggregatedListVpnGatewaysHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListVpnGatewaysHttpRequest source) {
    ...
    public AggregatedListVpnGatewaysHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListVpnGatewaysHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListVpnGatewaysHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListVpnGatewaysHttpRequest) {
      AggregatedListVpnGatewaysHttpRequest that = (AggregatedListVpnGatewaysHttpRequest) o;
