...
public final class SetSslPolicyTargetHttpsProxyHttpRequest implements ApiMessage {
  ...
  private SetSslPolicyTargetHttpsProxyHttpRequest() {
  ...
  public static Builder newBuilder(SetSslPolicyTargetHttpsProxyHttpRequest prototype) {
  ...
  public static SetSslPolicyTargetHttpsProxyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetSslPolicyTargetHttpsProxyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetSslPolicyTargetHttpsProxyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetSslPolicyTargetHttpsProxyHttpRequest other) {
      if (other == SetSslPolicyTargetHttpsProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetSslPolicyTargetHttpsProxyHttpRequest source) {
    ...
    public SetSslPolicyTargetHttpsProxyHttpRequest build() {
      String missing = "";
      ...
      return new SetSslPolicyTargetHttpsProxyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetSslPolicyTargetHttpsProxyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetSslPolicyTargetHttpsProxyHttpRequest) {
      SetSslPolicyTargetHttpsProxyHttpRequest that = (SetSslPolicyTargetHttpsProxyHttpRequest) o;
