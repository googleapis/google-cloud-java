...
@BetaApi
/**
 * Request object for method compute.packetMirrorings.testIamPermissions. Returns permissions that a
 * caller has on the specified resource.
 */
public final class TestIamPermissionsPacketMirroringHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsPacketMirroringHttpRequest() {
   ...
   * `{project}/regions/{region}/packetMirrorings/{resource}/testIamPermissions`. \`{resource}\`
  ...
  public static Builder newBuilder(TestIamPermissionsPacketMirroringHttpRequest prototype) {
  ...
  public static TestIamPermissionsPacketMirroringHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsPacketMirroringHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsPacketMirroringHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsPacketMirroringHttpRequest other) {
      if (other == TestIamPermissionsPacketMirroringHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsPacketMirroringHttpRequest source) {
    ...
    public TestIamPermissionsPacketMirroringHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsPacketMirroringHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsPacketMirroringHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsPacketMirroringHttpRequest) {
      TestIamPermissionsPacketMirroringHttpRequest that =
          (TestIamPermissionsPacketMirroringHttpRequest) o;
