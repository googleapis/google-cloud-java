...
public final class PatchSubnetworkHttpRequest implements ApiMessage {
  ...
  private final Integer drainTimeoutSeconds;
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("drainTimeoutSeconds".equals(fieldName)) {
   ...
   * connections from the current ACTIVE subnetwork to the current BACKUP subnetwork. The drain
   * timeout is only applicable when the following conditions are true: - the subnetwork being
   * patched has purpose = INTERNAL_HTTPS_LOAD_BALANCER - the subnetwork being patched has role =
   * BACKUP - the patch request is setting the role to ACTIVE. Note that after this patch operation
   * the roles of the ACTIVE and BACKUP subnetworks will be swapped.
   */
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(PatchSubnetworkHttpRequest other) {
      ...
      if (other.getDrainTimeoutSeconds() != null) {
        this.drainTimeoutSeconds = other.drainTimeoutSeconds;
      }
    ...
    Builder(PatchSubnetworkHttpRequest source) {
      ...
      this.drainTimeoutSeconds = source.drainTimeoutSeconds;
     ...
     * timeout is only applicable when the following conditions are true: - the subnetwork being
     * patched has purpose = INTERNAL_HTTPS_LOAD_BALANCER - the subnetwork being patched has role =
     * BACKUP - the patch request is setting the role to ACTIVE. Note that after this patch
     ...
     * operation the roles of the ACTIVE and BACKUP subnetworks will be swapped.
     */
    public Builder setDrainTimeoutSeconds(Integer drainTimeoutSeconds) {
      this.drainTimeoutSeconds = drainTimeoutSeconds;
      return this;
    }
    ...
    public Builder clone() {
      ...
      newBuilder.setDrainTimeoutSeconds(this.drainTimeoutSeconds);
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof PatchSubnetworkHttpRequest) {
      ...
      return Objects.equals(this.access_token, that.getAccessToken())
          ...
          && Objects.equals(this.drainTimeoutSeconds, that.getDrainTimeoutSeconds())
