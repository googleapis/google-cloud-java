...
@Generated("by GAPIC")
@BetaApi
public final class ProjectRegionHealthCheckServiceName implements ResourceName {
  ...
  private ProjectRegionHealthCheckServiceName(Builder builder) {
    healthCheckService = Preconditions.checkNotNull(builder.getHealthCheckService());
    project = Preconditions.checkNotNull(builder.getProject());
    region = Preconditions.checkNotNull(builder.getRegion());
  }

  public static ProjectRegionHealthCheckServiceName of(
      String healthCheckService, String project, String region) {
    return newBuilder()
  ...
  public static String format(String healthCheckService, String project, String region) {
    return of(healthCheckService, project, region).toString();
  }
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("healthCheckService", healthCheckService);
  ...
  public static ProjectRegionHealthCheckServiceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(
            resourcePath,
            "ProjectRegionHealthCheckServiceName.parse: formattedString not in valid format");
    return of(matchMap.get("healthCheckService"), matchMap.get("project"), matchMap.get("region"));
  }
  ...
  public static class Builder {
    ...
    public Builder(ProjectRegionHealthCheckServiceName projectRegionHealthCheckServiceName) {
      healthCheckService = projectRegionHealthCheckServiceName.healthCheckService;
      project = projectRegionHealthCheckServiceName.project;
      region = projectRegionHealthCheckServiceName.region;
    }
  ...
  @Override
  public int hashCode() {
    return Objects.hash(healthCheckService, project, region);
  }
}
