...
public final class RegionInstanceGroupManagerUpdateInstanceConfigReq implements ApiMessage {
  ...
  public static Builder newBuilder(RegionInstanceGroupManagerUpdateInstanceConfigReq prototype) {
  ...
  public static RegionInstanceGroupManagerUpdateInstanceConfigReq getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final RegionInstanceGroupManagerUpdateInstanceConfigReq DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new RegionInstanceGroupManagerUpdateInstanceConfigReq();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RegionInstanceGroupManagerUpdateInstanceConfigReq other) {
      if (other == RegionInstanceGroupManagerUpdateInstanceConfigReq.getDefaultInstance())
        return this;
    ...
    Builder(RegionInstanceGroupManagerUpdateInstanceConfigReq source) {
    ...
    public RegionInstanceGroupManagerUpdateInstanceConfigReq build() {
      return new RegionInstanceGroupManagerUpdateInstanceConfigReq(perInstanceConfigs);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof RegionInstanceGroupManagerUpdateInstanceConfigReq) {
      RegionInstanceGroupManagerUpdateInstanceConfigReq that =
          (RegionInstanceGroupManagerUpdateInstanceConfigReq) o;
