...
@Generated("by GAPIC")
@BetaApi
public final class GlobalSetPolicyRequest implements ApiMessage {
  ...
  private GlobalSetPolicyRequest(List<Binding> bindings, String etag, Policy policy) {
  ...
  public static Builder newBuilder(GlobalSetPolicyRequest prototype) {
  ...
  public static GlobalSetPolicyRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GlobalSetPolicyRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GlobalSetPolicyRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GlobalSetPolicyRequest other) {
      if (other == GlobalSetPolicyRequest.getDefaultInstance()) return this;
    ...
    Builder(GlobalSetPolicyRequest source) {
    ...
    public GlobalSetPolicyRequest build() {

      return new GlobalSetPolicyRequest(bindings, etag, policy);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GlobalSetPolicyRequest) {
      GlobalSetPolicyRequest that = (GlobalSetPolicyRequest) o;
