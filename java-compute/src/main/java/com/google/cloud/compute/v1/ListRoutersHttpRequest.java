...
@BetaApi
/**
 * Request object for method compute.routers.list. Retrieves a list of Router resources available to
 * the specified project.
 */
public final class ListRoutersHttpRequest implements ApiMessage {
  ...
  private ListRoutersHttpRequest() {
  ...
  public static Builder newBuilder(ListRoutersHttpRequest prototype) {
  ...
  public static ListRoutersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRoutersHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRoutersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRoutersHttpRequest other) {
      if (other == ListRoutersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRoutersHttpRequest source) {
    ...
    public ListRoutersHttpRequest build() {
      String missing = "";
      ...
      return new ListRoutersHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRoutersHttpRequest) {
      ListRoutersHttpRequest that = (ListRoutersHttpRequest) o;
