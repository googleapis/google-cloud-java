...
/**
 * Settings class to configure an instance of {@link RegionNotificationEndpointStub}.
 *
 ...
 * <pre>
 * <code>
 * RegionNotificationEndpointStubSettings.Builder regionNotificationEndpointSettingsBuilder =
 *     RegionNotificationEndpointStubSettings.newBuilder();
 ...
 *             .build());
 * RegionNotificationEndpointStubSettings regionNotificationEndpointSettings = regionNotificationEndpointSettingsBuilder.build();
 * </code>
 * </pre>
 */
...
public class RegionNotificationEndpointStubSettings
  ...
  private final UnaryCallSettings<DeleteRegionNotificationEndpointHttpRequest, Operation>
      deleteRegionNotificationEndpointSettings;
  private final UnaryCallSettings<GetRegionNotificationEndpointHttpRequest, NotificationEndpoint>
      getRegionNotificationEndpointSettings;
  private final UnaryCallSettings<InsertRegionNotificationEndpointHttpRequest, Operation>
  ...
  public UnaryCallSettings<DeleteRegionNotificationEndpointHttpRequest, Operation>
      deleteRegionNotificationEndpointSettings() {
    return deleteRegionNotificationEndpointSettings;
  }
  ...
  public UnaryCallSettings<GetRegionNotificationEndpointHttpRequest, NotificationEndpoint>
      getRegionNotificationEndpointSettings() {
    return getRegionNotificationEndpointSettings;
  }
  ...
  public UnaryCallSettings<InsertRegionNotificationEndpointHttpRequest, Operation>
      insertRegionNotificationEndpointSettings() {
    return insertRegionNotificationEndpointSettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListRegionNotificationEndpointsPagedResponse>
      listRegionNotificationEndpointsSettings() {
    return listRegionNotificationEndpointsSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(RegionNotificationEndpointStubSettings.class))
        .setTransportToken(
  ...
  protected RegionNotificationEndpointStubSettings(Builder settingsBuilder) throws IOException {
    ...
    deleteRegionNotificationEndpointSettings =
        settingsBuilder.deleteRegionNotificationEndpointSettings().build();
    getRegionNotificationEndpointSettings =
        settingsBuilder.getRegionNotificationEndpointSettings().build();
    insertRegionNotificationEndpointSettings =
        settingsBuilder.insertRegionNotificationEndpointSettings().build();
    listRegionNotificationEndpointsSettings =
        settingsBuilder.listRegionNotificationEndpointsSettings().build();
  }
  ...
  private static final PagedListDescriptor<
      ...
      LIST_REGION_NOTIFICATION_ENDPOINTS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListRegionNotificationEndpointsHttpRequest injectToken(
                ListRegionNotificationEndpointsHttpRequest payload, String token) {
              return ListRegionNotificationEndpointsHttpRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListRegionNotificationEndpointsHttpRequest injectPageSize(
                ListRegionNotificationEndpointsHttpRequest payload, int pageSize) {
              return ListRegionNotificationEndpointsHttpRequest.newBuilder(payload)
  ...
  private static final PagedListResponseFactory<
          ...
          NotificationEndpointList,
          ListRegionNotificationEndpointsPagedResponse>
      LIST_REGION_NOTIFICATION_ENDPOINTS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListRegionNotificationEndpointsHttpRequest,
              NotificationEndpointList,
              ListRegionNotificationEndpointsPagedResponse>() {
            @Override
            public ApiFuture<ListRegionNotificationEndpointsPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListRegionNotificationEndpointsHttpRequest, NotificationEndpointList>
                    callable,
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          ...
                          request,
                          context);
              return ListRegionNotificationEndpointsPagedResponse.createAsync(
                  pageContext, futureResponse);
            }
          };

  /** Builder for RegionNotificationEndpointStubSettings. */
  public static class Builder
      extends StubSettings.Builder<RegionNotificationEndpointStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;

    private final UnaryCallSettings.Builder<DeleteRegionNotificationEndpointHttpRequest, Operation>
        deleteRegionNotificationEndpointSettings;
    private final UnaryCallSettings.Builder<
            GetRegionNotificationEndpointHttpRequest, NotificationEndpoint>
        getRegionNotificationEndpointSettings;
    private final UnaryCallSettings.Builder<InsertRegionNotificationEndpointHttpRequest, Operation>
        insertRegionNotificationEndpointSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      deleteRegionNotificationEndpointSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      getRegionNotificationEndpointSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      insertRegionNotificationEndpointSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      listRegionNotificationEndpointsSettings =
          PagedCallSettings.newBuilder(LIST_REGION_NOTIFICATION_ENDPOINTS_PAGE_STR_FACT);
    ...
    protected Builder(RegionNotificationEndpointStubSettings settings) {
      ...
      deleteRegionNotificationEndpointSettings =
          settings.deleteRegionNotificationEndpointSettings.toBuilder();
      getRegionNotificationEndpointSettings =
          settings.getRegionNotificationEndpointSettings.toBuilder();
      insertRegionNotificationEndpointSettings =
          settings.insertRegionNotificationEndpointSettings.toBuilder();
      listRegionNotificationEndpointsSettings =
          settings.listRegionNotificationEndpointsSettings.toBuilder();
