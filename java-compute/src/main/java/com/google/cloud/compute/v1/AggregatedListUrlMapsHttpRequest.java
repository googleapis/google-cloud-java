...
public final class AggregatedListUrlMapsHttpRequest implements ApiMessage {
  ...
  private AggregatedListUrlMapsHttpRequest() {
   ...
   * `{project}/aggregated/urlMaps`. \`{project}\` must start with a letter, and contain only
  ...
  public static Builder newBuilder(AggregatedListUrlMapsHttpRequest prototype) {
  ...
  public static AggregatedListUrlMapsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListUrlMapsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListUrlMapsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListUrlMapsHttpRequest other) {
      if (other == AggregatedListUrlMapsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListUrlMapsHttpRequest source) {
    ...
    public AggregatedListUrlMapsHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListUrlMapsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListUrlMapsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListUrlMapsHttpRequest) {
      AggregatedListUrlMapsHttpRequest that = (AggregatedListUrlMapsHttpRequest) o;
