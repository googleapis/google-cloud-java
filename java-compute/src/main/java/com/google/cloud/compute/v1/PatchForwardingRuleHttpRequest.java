...
@BetaApi
/**
 * Request object for method compute.forwardingRules.patch. Updates the specified forwarding rule
 * with the data included in the request. This method supports PATCH semantics and uses the JSON
 * merge patch format and processing rules. Currently, you can only patch the network_tier field.
 */
public final class PatchForwardingRuleHttpRequest implements ApiMessage {
  ...
  private PatchForwardingRuleHttpRequest() {
  ...
  /**
   * Name of the ForwardingRule resource to patch. It must have the format
  ...
  public static Builder newBuilder(PatchForwardingRuleHttpRequest prototype) {
  ...
  public static PatchForwardingRuleHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final PatchForwardingRuleHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new PatchForwardingRuleHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(PatchForwardingRuleHttpRequest other) {
      if (other == PatchForwardingRuleHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(PatchForwardingRuleHttpRequest source) {
    ...
    public PatchForwardingRuleHttpRequest build() {
      String missing = "";
      ...
      return new PatchForwardingRuleHttpRequest(
          access_token,
          callback,
          fieldMask,
          fields,
  ...
  public String toString() {
    return "PatchForwardingRuleHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof PatchForwardingRuleHttpRequest) {
      PatchForwardingRuleHttpRequest that = (PatchForwardingRuleHttpRequest) o;
