...
public final class ListNodeGroupsHttpRequest implements ApiMessage {
  ...
  private ListNodeGroupsHttpRequest() {
  ...
  public static Builder newBuilder(ListNodeGroupsHttpRequest prototype) {
  ...
  public static ListNodeGroupsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListNodeGroupsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListNodeGroupsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListNodeGroupsHttpRequest other) {
      if (other == ListNodeGroupsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListNodeGroupsHttpRequest source) {
    ...
    public ListNodeGroupsHttpRequest build() {
      String missing = "";
      ...
      return new ListNodeGroupsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListNodeGroupsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListNodeGroupsHttpRequest) {
      ListNodeGroupsHttpRequest that = (ListNodeGroupsHttpRequest) o;
