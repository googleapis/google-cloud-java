...
@Generated("by GAPIC")
@BetaApi
/** Request object for method compute.nodeGroups.listNodes. Lists nodes in the node group. */
public final class ListNodesNodeGroupsHttpRequest implements ApiMessage {
  ...
  private ListNodesNodeGroupsHttpRequest() {
  ...
  public static Builder newBuilder(ListNodesNodeGroupsHttpRequest prototype) {
  ...
  public static ListNodesNodeGroupsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListNodesNodeGroupsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListNodesNodeGroupsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListNodesNodeGroupsHttpRequest other) {
      if (other == ListNodesNodeGroupsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListNodesNodeGroupsHttpRequest source) {
    ...
    public ListNodesNodeGroupsHttpRequest build() {
      String missing = "";
      ...
      return new ListNodesNodeGroupsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListNodesNodeGroupsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListNodesNodeGroupsHttpRequest) {
      ListNodesNodeGroupsHttpRequest that = (ListNodesNodeGroupsHttpRequest) o;
