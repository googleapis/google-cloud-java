...
@BetaApi
/**
 * Request object for method compute.externalVpnGateways.list. Retrieves the list of
 * ExternalVpnGateway available to the specified project.
 */
public final class ListExternalVpnGatewaysHttpRequest implements ApiMessage {
  ...
  private ListExternalVpnGatewaysHttpRequest() {
  ...
  public static Builder newBuilder(ListExternalVpnGatewaysHttpRequest prototype) {
  ...
  public static ListExternalVpnGatewaysHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListExternalVpnGatewaysHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListExternalVpnGatewaysHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListExternalVpnGatewaysHttpRequest other) {
      if (other == ListExternalVpnGatewaysHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListExternalVpnGatewaysHttpRequest source) {
    ...
    public ListExternalVpnGatewaysHttpRequest build() {
      String missing = "";
      ...
      return new ListExternalVpnGatewaysHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListExternalVpnGatewaysHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListExternalVpnGatewaysHttpRequest) {
      ListExternalVpnGatewaysHttpRequest that = (ListExternalVpnGatewaysHttpRequest) o;
