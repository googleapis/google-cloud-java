...
@BetaApi
/**
 * Request object for method compute.regionNetworkEndpointGroups.list. Retrieves the list of
 * regional network endpoint groups available to the specified project in the given region.
 */
public final class ListRegionNetworkEndpointGroupsHttpRequest implements ApiMessage {
  ...
  private ListRegionNetworkEndpointGroupsHttpRequest() {
  ...
  /**
   * The name of the region where the network endpoint group is located. It should comply with
   * RFC1035. It must have the format `{project}/regions/{region}/networkEndpointGroups`.
  ...
  public static Builder newBuilder(ListRegionNetworkEndpointGroupsHttpRequest prototype) {
  ...
  public static ListRegionNetworkEndpointGroupsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionNetworkEndpointGroupsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionNetworkEndpointGroupsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionNetworkEndpointGroupsHttpRequest other) {
      if (other == ListRegionNetworkEndpointGroupsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionNetworkEndpointGroupsHttpRequest source) {
    ...
    public ListRegionNetworkEndpointGroupsHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionNetworkEndpointGroupsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionNetworkEndpointGroupsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionNetworkEndpointGroupsHttpRequest) {
      ListRegionNetworkEndpointGroupsHttpRequest that =
          (ListRegionNetworkEndpointGroupsHttpRequest) o;
