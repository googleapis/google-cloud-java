...
public final class ListRegionSslCertificatesHttpRequest implements ApiMessage {
  ...
  private ListRegionSslCertificatesHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionSslCertificatesHttpRequest prototype) {
  ...
  public static ListRegionSslCertificatesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionSslCertificatesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionSslCertificatesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionSslCertificatesHttpRequest other) {
      if (other == ListRegionSslCertificatesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionSslCertificatesHttpRequest source) {
    ...
    public ListRegionSslCertificatesHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionSslCertificatesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionSslCertificatesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionSslCertificatesHttpRequest) {
      ListRegionSslCertificatesHttpRequest that = (ListRegionSslCertificatesHttpRequest) o;
