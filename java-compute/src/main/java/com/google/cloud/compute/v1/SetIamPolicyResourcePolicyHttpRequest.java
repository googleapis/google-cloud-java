...
public final class SetIamPolicyResourcePolicyHttpRequest implements ApiMessage {
  ...
  private SetIamPolicyResourcePolicyHttpRequest() {
   ...
   * `{project}/regions/{region}/resourcePolicies/{resource}/setIamPolicy`. \`{resource}\` must
  ...
  public static Builder newBuilder(SetIamPolicyResourcePolicyHttpRequest prototype) {
  ...
  public static SetIamPolicyResourcePolicyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicyResourcePolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicyResourcePolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicyResourcePolicyHttpRequest other) {
      if (other == SetIamPolicyResourcePolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicyResourcePolicyHttpRequest source) {
    ...
    public SetIamPolicyResourcePolicyHttpRequest build() {
      String missing = "";
      ...
      return new SetIamPolicyResourcePolicyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetIamPolicyResourcePolicyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicyResourcePolicyHttpRequest) {
      SetIamPolicyResourcePolicyHttpRequest that = (SetIamPolicyResourcePolicyHttpRequest) o;
