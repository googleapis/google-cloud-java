...
public final class ListNetworkEndpointGroupsHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(ListNetworkEndpointGroupsHttpRequest prototype) {
  ...
  public static ListNetworkEndpointGroupsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListNetworkEndpointGroupsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListNetworkEndpointGroupsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListNetworkEndpointGroupsHttpRequest other) {
      if (other == ListNetworkEndpointGroupsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListNetworkEndpointGroupsHttpRequest source) {
    ...
    public ListNetworkEndpointGroupsHttpRequest build() {
      String missing = "";
      ...
      return new ListNetworkEndpointGroupsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListNetworkEndpointGroupsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListNetworkEndpointGroupsHttpRequest) {
      ListNetworkEndpointGroupsHttpRequest that = (ListNetworkEndpointGroupsHttpRequest) o;
