...
public final class ProjectZoneNetworkEndpointGroupResourceName implements ResourceName {
  ...
  public static ResourceNameFactory<ProjectZoneNetworkEndpointGroupResourceName> newFactory() {
    return new ResourceNameFactory<ProjectZoneNetworkEndpointGroupResourceName>() {
