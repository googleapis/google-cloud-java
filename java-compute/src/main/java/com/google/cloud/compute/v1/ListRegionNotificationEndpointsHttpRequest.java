...
@BetaApi
/**
 * Request object for method compute.regionNotificationEndpoints.list. Lists the
 * NotificationEndpoints for a project in the given region.
 */
public final class ListRegionNotificationEndpointsHttpRequest implements ApiMessage {
  ...
  private ListRegionNotificationEndpointsHttpRequest() {
   ...
   * `{project}/regions/{region}/notificationEndpoints`. \`{region}\` must start with a letter, and
  ...
  public static Builder newBuilder(ListRegionNotificationEndpointsHttpRequest prototype) {
  ...
  public static ListRegionNotificationEndpointsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionNotificationEndpointsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionNotificationEndpointsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionNotificationEndpointsHttpRequest other) {
      if (other == ListRegionNotificationEndpointsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionNotificationEndpointsHttpRequest source) {
    ...
    /**
     * Name of the region scoping this request. It must have the format
     * `{project}/regions/{region}/notificationEndpoints`. \`{region}\` must start with a letter,
    ...
    public ListRegionNotificationEndpointsHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionNotificationEndpointsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionNotificationEndpointsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionNotificationEndpointsHttpRequest) {
      ListRegionNotificationEndpointsHttpRequest that =
          (ListRegionNotificationEndpointsHttpRequest) o;
