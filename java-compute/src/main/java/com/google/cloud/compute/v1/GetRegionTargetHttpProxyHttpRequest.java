...
public final class GetRegionTargetHttpProxyHttpRequest implements ApiMessage {
  ...
  private GetRegionTargetHttpProxyHttpRequest() {
  ...
  public static Builder newBuilder(GetRegionTargetHttpProxyHttpRequest prototype) {
  ...
  public static GetRegionTargetHttpProxyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetRegionTargetHttpProxyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetRegionTargetHttpProxyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetRegionTargetHttpProxyHttpRequest other) {
      if (other == GetRegionTargetHttpProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetRegionTargetHttpProxyHttpRequest source) {
    ...
    public GetRegionTargetHttpProxyHttpRequest build() {
      String missing = "";
      ...
      return new GetRegionTargetHttpProxyHttpRequest(
  ...
  public String toString() {
    return "GetRegionTargetHttpProxyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetRegionTargetHttpProxyHttpRequest) {
      GetRegionTargetHttpProxyHttpRequest that = (GetRegionTargetHttpProxyHttpRequest) o;
