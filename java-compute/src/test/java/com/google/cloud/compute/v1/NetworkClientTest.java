...
import static com.google.cloud.compute.v1.stub.HttpJsonNetworkStub.updatePeeringNetworkMethodDescriptor;
...
public class NetworkClientTest {
  ...
  @Test
  @SuppressWarnings("all")
  public void updatePeeringNetworkTest() {
    String clientOperationId = "clientOperationId-239630617";
    String creationTimestamp = "creationTimestamp567396278";
    String description = "description-1724546052";
    String endTime = "endTime1725551537";
    ...
    Operation actualResponse =
        client.updatePeeringNetwork(network, networksUpdatePeeringRequestResource, fieldMask);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void updatePeeringNetworkExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
