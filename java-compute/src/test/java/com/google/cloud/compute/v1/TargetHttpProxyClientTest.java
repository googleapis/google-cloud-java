...
import static com.google.cloud.compute.v1.stub.HttpJsonTargetHttpProxyStub.aggregatedListTargetHttpProxiesMethodDescriptor;
...
public class TargetHttpProxyClientTest {
  ...
  public void aggregatedListTargetHttpProxiesTest() {
    ...
    TargetHttpProxiesScopedList itemsItem = TargetHttpProxiesScopedList.newBuilder().build();
    Map<String, TargetHttpProxiesScopedList> items = new HashMap<>();
    ...
    AggregatedListTargetHttpProxiesPagedResponse pagedListResponse =
        client.aggregatedListTargetHttpProxies(includeAllScopes, project);

    List<TargetHttpProxiesScopedList> resources =
  ...
  @Test
  @SuppressWarnings("all")
  public void aggregatedListTargetHttpProxiesExceptionTest() throws Exception {
