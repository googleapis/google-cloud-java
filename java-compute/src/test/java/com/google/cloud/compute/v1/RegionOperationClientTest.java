...
import static com.google.cloud.compute.v1.stub.HttpJsonRegionOperationStub.waitRegionOperationMethodDescriptor;
...
public class RegionOperationClientTest {
  ...
  @Test
  @SuppressWarnings("all")
  public void waitRegionOperationTest() {
    String clientOperationId = "clientOperationId-239630617";
    String creationTimestamp = "creationTimestamp567396278";
    String description = "description-1724546052";
    String endTime = "endTime1725551537";
    ...
    Operation actualResponse = client.waitRegionOperation(operation);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  @SuppressWarnings("all")
  public void waitRegionOperationExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
    ...
    try {
      ...
      client.waitRegionOperation(operation);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception
    }
