...
public final class ShipmentRoute extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ShipmentRoute(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class Visit extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(shipmentLabel_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 7, shipmentLabel_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(visitLabel_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 8, visitLabel_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(shipmentLabel_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(7, shipmentLabel_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(visitLabel_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(8, visitLabel_);
      }
      for (int i = 0; i < arrivalLoads_.size(); i++) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetStartTimeFieldBuilder();
          internalGetDetourFieldBuilder();
          internalGetArrivalLoadsFieldBuilder();
          internalGetDelayBeforeStartFieldBuilder();
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 50:
                {
                  input.readMessage(
                      internalGetDetourFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 82:
                {
                  input.readMessage(
                      internalGetDelayBeforeStartFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.protobuf.Duration.Builder getDetourBuilder() {
        bitField0_ |= 0x00000020;
        onChanged();
        return internalGetDetourFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.optimization.v1.CapacityQuantity.Builder getArrivalLoadsBuilder(
          int index) {
        return internalGetArrivalLoadsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.optimization.v1.CapacityQuantity.Builder addArrivalLoadsBuilder() {
        return internalGetArrivalLoadsFieldBuilder()
      ...
      public java.util.List<com.google.cloud.optimization.v1.CapacityQuantity.Builder>
        ...
        return internalGetArrivalLoadsFieldBuilder().getBuilderList();
      }
      ...
      public com.google.cloud.optimization.v1.ShipmentRoute.Delay.Builder
        ...
        bitField0_ |= 0x00000200;
        onChanged();
        return internalGetDelayBeforeStartFieldBuilder().getBuilder();
      }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          ...
          internalGetStartTimeFieldBuilder();
          internalGetRoutePolylineFieldBuilder();
          internalGetLoadsFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 74:
                {
                  input.readMessage(
                      internalGetRoutePolylineFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000100;
                  break;
                } // case 74
              case 82:
      ...
      public com.google.cloud.optimization.v1.ShipmentRoute.EncodedPolyline.Builder
        ...
        bitField0_ |= 0x00000100;
        onChanged();
        return internalGetRoutePolylineFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.optimization.v1.CapacityQuantity.Builder getLoadsBuilder(int index) {
        return internalGetLoadsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.optimization.v1.CapacityQuantity.Builder addLoadsBuilder() {
        return internalGetLoadsFieldBuilder()
            .addBuilder(com.google.cloud.optimization.v1.CapacityQuantity.getDefaultInstance());
      }
      ...
      public java.util.List<com.google.cloud.optimization.v1.CapacityQuantity.Builder>
          getLoadsBuilderList() {
        return internalGetLoadsFieldBuilder().getBuilderList();
      }
   ...
   */
  public static final class VehicleLoad extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private VehicleLoad(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class EncodedPolyline extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private EncodedPolyline(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(points_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, points_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(points_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, points_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
   ...
   */
  public static final class Break extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Break(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  @java.lang.Deprecated
  public static final class TravelStep extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(com.google.cloud.optimization.v1.ShipmentRoute.TravelStep other) {
        ...
        if (java.lang.Double.doubleToRawLongBits(other.getDistanceMeters()) != 0) {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vehicleLabel_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, vehicleLabel_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vehicleLabel_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, vehicleLabel_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetVehicleStartTimeFieldBuilder();
        internalGetVehicleEndTimeFieldBuilder();
        internalGetVisitsFieldBuilder();
        internalGetTransitionsFieldBuilder();
        internalGetRoutePolylineFieldBuilder();
        internalGetBreaksFieldBuilder();
        internalGetMetricsFieldBuilder();
        internalGetEndLoadsFieldBuilder();
        internalGetTravelStepsFieldBuilder();
        internalGetVehicleDetourFieldBuilder();
        internalGetDelayBeforeVehicleEndFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.cloud.optimization.v1.ShipmentRoute other) {
      ...
      bitField0_ |= 0x00000400;
      if (java.lang.Double.doubleToRawLongBits(other.getRouteTotalCost()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetVehicleStartTimeFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000004;
                break;
              } // case 42
            case 50:
              {
                input.readMessage(
                    internalGetVehicleEndTimeFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000008;
                break;
              } // case 50
            case 58:
            ...
            case 122:
              {
                input.readMessage(
                    internalGetVehicleDetourFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 130:
              {
                input.readMessage(
                    internalGetDelayBeforeVehicleEndFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.protobuf.Timestamp.Builder getVehicleStartTimeBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetVehicleStartTimeFieldBuilder().getBuilder();
    }
    ...
    public com.google.protobuf.Timestamp.Builder getVehicleEndTimeBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
      return internalGetVehicleEndTimeFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.Visit.Builder getVisitsBuilder(
        int index) {
      return internalGetVisitsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.Visit.Builder addVisitsBuilder() {
      return internalGetVisitsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.optimization.v1.ShipmentRoute.Visit.Builder>
      ...
      return internalGetVisitsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.Break.Builder getBreaksBuilder(
        int index) {
      return internalGetBreaksFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.Break.Builder addBreaksBuilder() {
      return internalGetBreaksFieldBuilder()
    ...
    public java.util.List<com.google.cloud.optimization.v1.ShipmentRoute.Break.Builder>
      ...
      return internalGetBreaksFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.optimization.v1.CapacityQuantity.Builder getEndLoadsBuilder(int index) {
      return internalGetEndLoadsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.optimization.v1.CapacityQuantity.Builder addEndLoadsBuilder() {
      return internalGetEndLoadsFieldBuilder()
          .addBuilder(com.google.cloud.optimization.v1.CapacityQuantity.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.cloud.optimization.v1.CapacityQuantity.Builder>
      ...
      return internalGetEndLoadsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.TravelStep.Builder getTravelStepsBuilder(
        int index) {
      return internalGetTravelStepsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.TravelStep.Builder
      ...
      return internalGetTravelStepsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.cloud.optimization.v1.ShipmentRoute.TravelStep.Builder>
      ...
      return internalGetTravelStepsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.protobuf.Duration.Builder getVehicleDetourBuilder() {
      bitField0_ |= 0x00004000;
      onChanged();
      return internalGetVehicleDetourFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.optimization.v1.ShipmentRoute.Delay.Builder
      ...
      bitField0_ |= 0x00008000;
      onChanged();
      return internalGetDelayBeforeVehicleEndFieldBuilder().getBuilder();
    }
