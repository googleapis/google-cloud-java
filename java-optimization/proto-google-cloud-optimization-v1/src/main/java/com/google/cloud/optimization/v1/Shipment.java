...
public final class Shipment extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class VisitRequest extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private VisitRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < visitTypes_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 10, visitTypes_.getRaw(i));
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(label_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 11, label_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(label_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(11, label_);
      }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          ...
          internalGetArrivalWaypointFieldBuilder();
          internalGetDepartureLocationFieldBuilder();
          internalGetDepartureWaypointFieldBuilder();
          internalGetTimeWindowsFieldBuilder();
          internalGetDurationFieldBuilder();
          internalGetDemandsFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetArrivalLocationFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 18:
                {
                  input.readMessage(
                      internalGetArrivalWaypointFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetDepartureLocationFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 34:
                {
                  input.readMessage(
                      internalGetDepartureWaypointFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.optimization.v1.Waypoint.Builder getArrivalWaypointBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetArrivalWaypointFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.optimization.v1.Waypoint.Builder getDepartureWaypointBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
        return internalGetDepartureWaypointFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.optimization.v1.TimeWindow.Builder getTimeWindowsBuilder(int index) {
        return internalGetTimeWindowsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.optimization.v1.TimeWindow.Builder addTimeWindowsBuilder() {
        return internalGetTimeWindowsFieldBuilder()
      ...
      public java.util.List<com.google.cloud.optimization.v1.TimeWindow.Builder>
        ...
        return internalGetTimeWindowsFieldBuilder().getBuilderList();
      }
      ...
      public com.google.cloud.optimization.v1.CapacityQuantity.Builder getDemandsBuilder(
          int index) {
        return internalGetDemandsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.optimization.v1.CapacityQuantity.Builder addDemandsBuilder() {
        return internalGetDemandsFieldBuilder()
      ...
      public java.util.List<com.google.cloud.optimization.v1.CapacityQuantity.Builder>
        ...
        return internalGetDemandsFieldBuilder().getBuilderList();
      }
   ...
   */
  public static final class Load extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Load(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(shipmentType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, shipmentType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(label_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, label_);
    }
    if (ignore_ != false) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(shipmentType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(11, shipmentType_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(label_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(12, label_);
    }
    if (ignore_ != false) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetPickupsFieldBuilder();
        internalGetDeliveriesFieldBuilder();
        internalGetPickupToDeliveryAbsoluteDetourLimitFieldBuilder();
        internalGetPickupToDeliveryTimeLimitFieldBuilder();
        internalGetDemandsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 74:
              {
                input.readMessage(
                    internalGetPickupToDeliveryAbsoluteDetourLimitFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000100;
                break;
              } // case 74
            case 82:
              {
                input.readMessage(
                    internalGetPickupToDeliveryTimeLimitFieldBuilder().getBuilder(),
                    extensionRegistry);
                bitField0_ |= 0x00000200;
                break;
              } // case 82
    ...
    public com.google.cloud.optimization.v1.Shipment.VisitRequest.Builder getPickupsBuilder(
        int index) {
      return internalGetPickupsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.optimization.v1.Shipment.VisitRequest.Builder addPickupsBuilder() {
      return internalGetPickupsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.optimization.v1.Shipment.VisitRequest.Builder>
      ...
      return internalGetPickupsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.optimization.v1.Shipment.VisitRequest.Builder addDeliveriesBuilder() {
      return internalGetDeliveriesFieldBuilder()
          .addBuilder(com.google.cloud.optimization.v1.Shipment.VisitRequest.getDefaultInstance());
    }
    ...
    public /* nullable */ com.google.cloud.optimization.v1.Shipment.Load getLoadDemandsOrDefault(
      ...
      java.util.Map<java.lang.String, com.google.cloud.optimization.v1.Shipment.LoadOrBuilder> map =
          internalGetMutableLoadDemands().ensureBuilderMap();
      return map.containsKey(key) ? loadDemandsConverter.build(map.get(key)) : defaultValue;
    }
    ...
    public Builder putAllLoadDemands(
        java.util.Map<java.lang.String, com.google.cloud.optimization.v1.Shipment.Load> values) {
      for (java.util.Map.Entry<java.lang.String, com.google.cloud.optimization.v1.Shipment.Load> e :
          values.entrySet()) {
        if (e.getKey() == null || e.getValue() == null) {
          throw new NullPointerException();
        }
    ...
    public com.google.protobuf.Duration.Builder getPickupToDeliveryAbsoluteDetourLimitBuilder() {
      bitField0_ |= 0x00000100;
      onChanged();
      return internalGetPickupToDeliveryAbsoluteDetourLimitFieldBuilder().getBuilder();
    }
    ...
    public com.google.protobuf.Duration.Builder getPickupToDeliveryTimeLimitBuilder() {
      bitField0_ |= 0x00000200;
      onChanged();
      return internalGetPickupToDeliveryTimeLimitFieldBuilder().getBuilder();
    }
