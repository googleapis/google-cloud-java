...
import com.google.cloud.dialogflow.v2beta1.AnswerRecordsGrpc.AnswerRecordsImplBase;
...
public class MockAnswerRecordsImpl extends AnswerRecordsImplBase {
  ...
  public void getAnswerRecord(
      GetAnswerRecordRequest request, StreamObserver<AnswerRecord> responseObserver) {
    ...
    if (response instanceof AnswerRecord) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetAnswerRecord, expected %s or %s",
