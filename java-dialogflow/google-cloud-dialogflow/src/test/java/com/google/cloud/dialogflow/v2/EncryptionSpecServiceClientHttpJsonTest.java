...
import com.google.cloud.dialogflow.v2.stub.HttpJsonEncryptionSpecServiceStub;
...
public class EncryptionSpecServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static EncryptionSpecServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonEncryptionSpecServiceStub.getMethodDescriptors(),
            EncryptionSpecServiceSettings.getDefaultEndpoint());
    EncryptionSpecServiceSettings settings =
        EncryptionSpecServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                EncryptionSpecServiceSettings.defaultHttpJsonTransportProviderBuilder()
