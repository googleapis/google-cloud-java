...
public class ConversationsClientTest {
  ...
  public void createCallMatcherTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockConversations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    CreateCallMatcherRequest actualRequest = ((CreateCallMatcherRequest) actualRequests.get(0));

    Assert.assertEquals(parent.toString(), actualRequest.getParent());
    Assert.assertEquals(callMatcher, actualRequest.getCallMatcher());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void listCallMatchersTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockConversations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListCallMatchersRequest actualRequest = ((ListCallMatchersRequest) actualRequests.get(0));
  ...
  public void deleteCallMatcherTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockConversations.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    DeleteCallMatcherRequest actualRequest = ((DeleteCallMatcherRequest) actualRequests.get(0));
