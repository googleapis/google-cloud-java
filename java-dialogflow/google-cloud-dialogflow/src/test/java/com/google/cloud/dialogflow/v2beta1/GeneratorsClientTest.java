...
public class GeneratorsClientTest {
  ...
  public void createGeneratorTest() throws Exception {
    Generator expectedResponse =
        Generator.newBuilder()
            ...
            .setInferenceParameter(InferenceParameter.newBuilder().build())
    ...
    Generator actualResponse = client.createGenerator(parent, generator, generatorId);
    ...
    Assert.assertEquals(generatorId, actualRequest.getGeneratorId());
    Assert.assertTrue(
  ...
  public void createGeneratorExceptionTest() throws Exception {
    ...
    try {
      ...
      Generator generator = Generator.newBuilder().build();
      String generatorId = "generatorId887044942";
      client.createGenerator(parent, generator, generatorId);
