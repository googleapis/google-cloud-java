...
import com.google.cloud.dialogflow.v2.stub.HttpJsonFulfillmentsStub;
...
public class FulfillmentsClientHttpJsonTest {
  private static MockHttpService mockService;
  private static FulfillmentsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonFulfillmentsStub.getMethodDescriptors(),
            FulfillmentsSettings.getDefaultEndpoint());
    FulfillmentsSettings settings =
        FulfillmentsSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                FulfillmentsSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void getFulfillmentTest2() throws Exception {
    ...
    String name = "projects/project-2293/agent/fulfillment";
