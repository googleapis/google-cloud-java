...
import com.google.cloud.dialogflow.v2.ConversationModelsGrpc.ConversationModelsImplBase;
...
public class MockConversationModelsImpl extends ConversationModelsImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockConversationModelsImpl() {
  ...
  public void createConversationModel(
      CreateConversationModelRequest request, StreamObserver<Operation> responseObserver) {
  ...
  public void getConversationModel(
      GetConversationModelRequest request, StreamObserver<ConversationModel> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ConversationModel) {
      requests.add(request);
      responseObserver.onNext(((ConversationModel) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void listConversationModels(
      ...
      StreamObserver<ListConversationModelsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListConversationModelsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListConversationModelsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void deleteConversationModel(
      DeleteConversationModelRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deployConversationModel(
      DeployConversationModelRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void undeployConversationModel(
      UndeployConversationModelRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void getConversationModelEvaluation(
      ...
      StreamObserver<ConversationModelEvaluation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ConversationModelEvaluation) {
      requests.add(request);
      responseObserver.onNext(((ConversationModelEvaluation) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void listConversationModelEvaluations(
      ...
      StreamObserver<ListConversationModelEvaluationsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListConversationModelEvaluationsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListConversationModelEvaluationsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
