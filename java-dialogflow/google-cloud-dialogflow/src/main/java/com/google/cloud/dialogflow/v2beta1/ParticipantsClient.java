...
public class ParticipantsClient implements BackgroundResource {
  ...
  public static class ListSuggestionsPagedResponse
    ...
    public static ApiFuture<ListSuggestionsPagedResponse> createAsync(
      ...
      return ApiFutures.transform(
          futurePage,
          new ApiFunction<ListSuggestionsPage, ListSuggestionsPagedResponse>() {
            @Override
            public ListSuggestionsPagedResponse apply(ListSuggestionsPage input) {
              return new ListSuggestionsPagedResponse(input);
            }
          },
          MoreExecutors.directExecutor());
    }
