...
/**
 * Base stub class for the CompanionAgents service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@NullMarked
@Generated("by gapic-generator-java")
public abstract class CompanionAgentsStub implements BackgroundResource {

  public UnaryCallable<CreateCompanionAgentRequest, CompanionAgent> createCompanionAgentCallable() {
    throw new UnsupportedOperationException("Not implemented: createCompanionAgentCallable()");
  }

  public UnaryCallable<GetCompanionAgentRequest, CompanionAgent> getCompanionAgentCallable() {
    throw new UnsupportedOperationException("Not implemented: getCompanionAgentCallable()");
  }

  public UnaryCallable<UpdateCompanionAgentRequest, CompanionAgent> updateCompanionAgentCallable() {
    throw new UnsupportedOperationException("Not implemented: updateCompanionAgentCallable()");
  }

  public UnaryCallable<DeleteCompanionAgentRequest, Empty> deleteCompanionAgentCallable() {
    throw new UnsupportedOperationException("Not implemented: deleteCompanionAgentCallable()");
  }

  public UnaryCallable<ListCompanionAgentsRequest, ListCompanionAgentsPagedResponse>
      listCompanionAgentsPagedCallable() {
    throw new UnsupportedOperationException("Not implemented: listCompanionAgentsPagedCallable()");
  }

  public UnaryCallable<ListCompanionAgentsRequest, ListCompanionAgentsResponse>
      listCompanionAgentsCallable() {
    throw new UnsupportedOperationException("Not implemented: listCompanionAgentsCallable()");
  }
