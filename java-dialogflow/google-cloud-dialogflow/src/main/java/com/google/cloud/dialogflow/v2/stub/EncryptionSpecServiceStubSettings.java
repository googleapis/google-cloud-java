...
/**
 * Settings class to configure an instance of {@link EncryptionSpecServiceStub}.
 *
...
public class EncryptionSpecServiceStubSettings
    extends StubSettings<EncryptionSpecServiceStubSettings> {
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(EncryptionSpecServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return EncryptionSpecServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected EncryptionSpecServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for EncryptionSpecServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<EncryptionSpecServiceStubSettings, Builder> {
    ...
    protected Builder(EncryptionSpecServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public EncryptionSpecServiceStubSettings build() throws IOException {
