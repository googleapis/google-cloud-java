...
```Groovy
implementation 'com.google.cloud:google-cloud-dialogflow:4.1.2'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dialogflow" % "4.1.2"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-dialogflow/tree/master/samples) directory.
