...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dialogflow" % "4.74.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dialogflow/4.74.0
