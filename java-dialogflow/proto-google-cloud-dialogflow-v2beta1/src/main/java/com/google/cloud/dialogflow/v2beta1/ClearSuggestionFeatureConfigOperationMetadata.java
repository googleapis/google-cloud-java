...
public final class ClearSuggestionFeatureConfigOperationMetadata
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(conversationProfile_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, conversationProfile_);
    }
    if (participantRole_
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(conversationProfile_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, conversationProfile_);
    }
    if (participantRole_
        != com.google.cloud.dialogflow.v2beta1.Participant.Role.ROLE_UNSPECIFIED.getNumber()) {
