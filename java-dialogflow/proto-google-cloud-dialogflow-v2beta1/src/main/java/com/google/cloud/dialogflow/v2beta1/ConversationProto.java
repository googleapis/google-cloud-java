  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\022CreateConversation\022:.google.cloud.dialogflow.v2beta1.CreateCon"
          + "versationRequest\032-.google.cloud.dialogfl"
          + "ow.v2beta1.Conversation\"\237\001\332A\023parent,conv"
          + "ersation\202\323\344\223\002\202\001\"*/v2beta1/{parent=projec"
          + "ts/*}/conversations:\014conversationZF\"6/v2"
          + "beta1/{parent=projects/*/locations/*}/conversations:\014conversation\022\201\002\n"
          + "\021ListConversations\0229.google.cloud.dialogflow.v2beta"
          + "1.ListConversationsRequest\032:.google.cloud.dialogflow.v2beta1.ListConversationsRe"
          + "sponse\"u\332A\006parent\202\323\344\223\002f\022*/v2beta1/{paren"
          + "t=projects/*}/conversationsZ8\0226/v2beta1/"
          + "{parent=projects/*/locations/*}/conversations\022\356\001\n"
          + "\017GetConversation\0227.google.cloud.dialogflow.v2beta1.GetConversationReque"
          + "st\032-.google.cloud.dialogflow.v2beta1.Con"
          + "versation\"s\332A\004name\202\323\344\223\002f\022*/v2beta1/{name"
          + "=projects/*/conversations/*}Z8\0226/v2beta1"
          + "/{name=projects/*/locations/*/conversations/*}\022\221\002\n"
          + "\024CompleteConversation\022<.google.cloud.dialogflow.v2beta1.CompleteConver"
          + "sationRequest\032-.google.cloud.dialogflow."
          + "v2beta1.Conversation\"\213\001\332A\004name\202\323\344\223\002~\"3/v"
          + "2beta1/{name=projects/*/conversations/*}:complete:\001*ZD\"?/v2beta1/{name=projects/"
          + "*/locations/*/conversations/*}:complete:\001*\022\242\002\n"
          + "\027IngestContextReferences\022?.google.cloud.dialogflow.v2beta1.IngestContextRe"
          + "ferencesRequest\032@.google.cloud.dialogflow.v2beta1.IngestContextReferencesRespons"
          + "e\"\203\001\332A\037conversation,context_references\202\323"
          + "\344\223\002[\"V/v2beta1/{conversation=projects/*/"
          + "locations/*/conversations/*}:ingestContextReferences:\001*\022\306\002\n"
          + "\023BatchCreateMessages\022;.google.cloud.dialogflow.v2beta1.BatchC"
          + "reateMessagesRequest\032<.google.cloud.dialogflow.v2beta1.BatchCreateMessagesRespon"
          + "se\"\263\001\332A\017parent,requests\202\323\344\223\002\232\001\"A/v2beta1"
          + "/{parent=projects/*/conversations/*}/messages:batchCreate:\001*ZR\"M/v2beta1/{parent"
          + "=projects/*/locations/*/conversations/*}/messages:batchCreate:\001*\022\211\002\n"
          + "\014ListMessages\0224.google.cloud.dialogflow.v2beta1.List"
          + "MessagesRequest\0325.google.cloud.dialogflo"
          + "w.v2beta1.ListMessagesResponse\"\213\001\332A\006pare"
          + "nt\202\323\344\223\002|\0225/v2beta1/{parent=projects/*/co"
          + "nversations/*}/messagesZC\022A/v2beta1/{par"
          + "ent=projects/*/locations/*/conversations/*}/messages\022\210\003\n"
          + "\032SuggestConversationSummary\022B.google.cloud.dialogflow.v2beta1.Su"
          + "ggestConversationSummaryRequest\032C.google.cloud.dialogflow.v2beta1.SuggestConvers"
          + "ationSummaryResponse\"\340\001\332A\014conversation\202\323"
          + "\344\223\002\312\001\"Y/v2beta1/{conversation=projects/*"
          + "/conversations/*}/suggestions:suggestConversationSummary:\001*Zj\"e/v2beta1/{convers"
          + "ation=projects/*/locations/*/conversatio"
          + "ns/*}/suggestions:suggestConversationSummary:\001*\022\361\002\n"
          + "\030GenerateStatelessSummary\022@.google.cloud.dialogflow.v2beta1.GenerateS"
          + "tatelessSummaryRequest\032A.google.cloud.dialogflow.v2beta1.GenerateStatelessSummar"
          + "yResponse\"\317\001\202\323\344\223\002\310\001\"X/v2beta1/{stateless"
          + "_conversation.parent=projects/*}/suggestions:generateStatelessSummary:\001*Zi\"d/v2b"
          + "eta1/{stateless_conversation.parent=proj"
          + "ects/*/locations/*}/suggestions:generateStatelessSummary:\001*\022\372\001\n"
          + "\033GenerateStatelessSuggestion\022C.google.cloud.dialogflow.v2"
          + "beta1.GenerateStatelessSuggestionRequest\032D.google.cloud.dialogflow.v2beta1.Gener"
          + "ateStatelessSuggestionResponse\"P\202\323\344\223\002J\"E"
          + "/v2beta1/{parent=projects/*/locations/*}/statelessSuggestion:generate:\001*\022\314\003\n"
          + "\017SearchKnowledge\0227.google.cloud.dialogflow.v"
          + "2beta1.SearchKnowledgeRequest\0328.google.cloud.dialogflow.v2beta1.SearchKnowledgeR"
          + "esponse\"\305\002\202\323\344\223\002\276\002\"8/v2beta1/{parent=proj"
          + "ects/*}/suggestions:searchKnowledge:\001*ZI\"D/v2beta1/{parent=projects/*/locations/"
          + "*}/suggestions:searchKnowledge:\001*ZS\"N/v2beta1/{conversation=projects/*/conversat"
          + "ions/*}/suggestions:searchKnowledge:\001*Z_\"Z/v2beta1/{conversation=projects/*/loca"
          + "tions/*/conversations/*}/suggestions:searchKnowledge:\001*\022\317\002\n"
          + "\023GenerateSuggestions\022;.google.cloud.dialogflow.v2beta1.Genera"
          + "teSuggestionsRequest\032<.google.cloud.dialogflow.v2beta1.GenerateSuggestionsRespon"
          + "se\"\274\001\332A\014conversation\202\323\344\223\002\246\001\"G/v2beta1/{c"
          + "onversation=projects/*/conversations/*}/suggestions:generate:\001*ZX\"S/v2beta1/{con"
          + "versation=projects/*/locations/*/convers"
          + "ations/*}/suggestions:generate:\001*\032x\312A\031di",
      "alogflow.googleapis.com\322AYhttps://www.go"
          + "ogleapis.com/auth/cloud-platform,https:/"
          + "/www.googleapis.com/auth/dialogflowB\314\003\n#"
          + "com.google.cloud.dialogflow.v2beta1B\021Con"
          + "versationProtoP\001ZCcloud.google.com/go/di"
          + "alogflow/apiv2beta1/dialogflowpb;dialogf"
          + "lowpb\242\002\002DF\252\002\037Google.Cloud.Dialogflow.V2B"
          + "eta1\352A\305\001\n(discoveryengine.googleapis.com"
          + "/DataStore\022Xprojects/{project}/locations"
          + "/{location}/collections/{collection}/dat"
          + "aStores/{data_store}\022?projects/{project}"
          + "/locations/{location}/dataStores/{data_s"
          + "tore}\352AZ\n\027ces.googleapis.com/Tool\022?proje"
          + "cts/{project}/locations/{location}/apps/"
