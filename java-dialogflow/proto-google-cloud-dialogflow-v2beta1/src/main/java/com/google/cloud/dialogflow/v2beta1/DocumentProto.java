  ...
  static {
    java.lang.String[] descriptorData = {
      "\n.google/cloud/dialogflow/v2beta1/docume"
          ...
          + "le.cloud.dialogflow.v2beta1.GcsSourcesH\000"
          + "\022W\n\021document_template\030\003 \001(\01327.google.clo"
          ...
          + "types\030\002 \003(\01627.google.cloud.dialogflow.v2"
          + "beta1.Document.KnowledgeTypeB\003\340A\002\022W\n\010met"
          + "adata\030\003 \003(\0132E.google.cloud.dialogflow.v2"
          + "beta1.ImportDocumentTemplate.MetadataEnt"
          + "ry\032/\n\rMetadataEntry\022\013\n\003key\030\001 \001(\t\022\r\n\005valu"
          + "e\030\002 \001(\t:\0028\001\"?\n\027ImportDocumentsResponse\022$"
          + "\n\010warnings\030\001 \003(\0132\022.google.rpc.Status\"Q\n\025"
          + "DeleteDocumentRequest\0228\n\004name\030\001 \001(\tB*\340A\002"
          + "\372A$\n\"dialogflow.googleapis.com/Document\""
          + "\217\001\n\025UpdateDocumentRequest\022@\n\010document\030\001 "
          + "\001(\0132).google.cloud.dialogflow.v2beta1.Do"
          + "cumentB\003\340A\002\0224\n\013update_mask\030\002 \001(\0132\032.googl"
          + "e.protobuf.FieldMaskB\003\340A\001\"l\n\027ExportOpera"
          + "tionMetadata\022Q\n\030exported_gcs_destination"
          + "\030\001 \001(\0132/.google.cloud.dialogflow.v2beta1"
          + ".GcsDestination\"\304\002\n\032KnowledgeOperationMe"
          + "tadata\022U\n\005state\030\001 \001(\0162A.google.cloud.dia"
          + "logflow.v2beta1.KnowledgeOperationMetada"
          + "ta.StateB\003\340A\003\022\026\n\016knowledge_base\030\003 \001(\t\022]\n"
          + "\031export_operation_metadata\030\004 \001(\01328.googl"
          + "e.cloud.dialogflow.v2beta1.ExportOperati"
          + "onMetadataH\000\"B\n\005State\022\025\n\021STATE_UNSPECIFI"
          + "ED\020\000\022\013\n\007PENDING\020\001\022\013\n\007RUNNING\020\002\022\010\n\004DONE\020\003"
          + "B\024\n\022operation_metadata\"\301\001\n\025ReloadDocumen"
          + "tRequest\0228\n\004name\030\001 \001(\tB*\340A\002\372A$\n\"dialogfl"
          + "ow.googleapis.com/Document\022@\n\ngcs_source"
          + "\030\003 \001(\0132*.google.cloud.dialogflow.v2beta1"
          + ".GcsSourceH\000\022\"\n\032import_gcs_custom_metada"
          + "ta\030\004 \001(\010B\010\n\006source2\245\025\n\tDocuments\022\322\002\n\rLis"
          + "tDocuments\0225.google.cloud.dialogflow.v2b"
          + "eta1.ListDocumentsRequest\0326.google.cloud"
          + ".dialogflow.v2beta1.ListDocumentsRespons"
          + "e\"\321\001\202\323\344\223\002\301\001\0227/v2beta1/{parent=projects/*"
          + "/knowledgeBases/*}/documentsZE\022C/v2beta1"
          + "/{parent=projects/*/locations/*/knowledg"
          + "eBases/*}/documentsZ?\022=/v2beta1/{parent="
          + "projects/*/agent/knowledgeBases/*}/docum"
          + "ents\332A\006parent\022\277\002\n\013GetDocument\0223.google.c"
          + "loud.dialogflow.v2beta1.GetDocumentReque"
          + "st\032).google.cloud.dialogflow.v2beta1.Doc"
          + "ument\"\317\001\202\323\344\223\002\301\001\0227/v2beta1/{name=projects"
          + "/*/knowledgeBases/*/documents/*}ZE\022C/v2b"
          + "eta1/{name=projects/*/locations/*/knowle"
          + "dgeBases/*/documents/*}Z?\022=/v2beta1/{nam"
          + "e=projects/*/agent/knowledgeBases/*/docu"
          + "ments/*}\332A\004name\022\213\003\n\016CreateDocument\0226.goo"
          + "gle.cloud.dialogflow.v2beta1.CreateDocum"
          + "entRequest\032\035.google.longrunning.Operatio"
          + "n\"\241\002\202\323\344\223\002\337\001\"7/v2beta1/{parent=projects/*"
          ...
          + "wledgeBases/*}/documents:\010document\332A\017par"
          + "ent,document\312A&\n\010Document\022\032KnowledgeOper"
          + "ationMetadata\022\277\002\n\017ImportDocuments\0227.goog"
          + "le.cloud.dialogflow.v2beta1.ImportDocume"
          + "ntsRequest\032\035.google.longrunning.Operatio"
          + "n\"\323\001\202\323\344\223\002\224\001\">/v2beta1/{parent=projects/*"
          + "/knowledgeBases/*}/documents:import:\001*ZO"
          + "\"J/v2beta1/{parent=projects/*/locations/"
          + "*/knowledgeBases/*}/documents:import:\001*\312"
          + "A5\n\027ImportDocumentsResponse\022\032KnowledgeOp"
          + "erationMetadata\022\357\002\n\016DeleteDocument\0226.goo"
          + "gle.cloud.dialogflow.v2beta1.DeleteDocum"
          + "entRequest\032\035.google.longrunning.Operatio"
          + "n\"\205\002\202\323\344\223\002\301\001*7/v2beta1/{name=projects/*/k"
          + "nowledgeBases/*/documents/*}ZE*C/v2beta1"
          + "/{name=projects/*/locations/*/knowledgeB"
          + "ases/*/documents/*}Z?*=/v2beta1/{name=pr"
          + "ojects/*/agent/knowledgeBases/*/document"
          + "s/*}\332A\004name\312A3\n\025google.protobuf.Empty\022\032K"
          + "nowledgeOperationMetadata\022\266\003\n\016UpdateDocu"
          + "ment\0226.google.cloud.dialogflow.v2beta1.U"
          + "pdateDocumentRequest\032\035.google.longrunnin"
          + "g.Operation\"\314\002\202\323\344\223\002\372\0012@/v2beta1/{documen"
          ...
          + "eBases/*/documents/*}:\010document\332A\024docume"
          + "nt,update_mask\332A\010document\312A&\n\010Document\022\032"
          + "KnowledgeOperationMetadata\022\213\003\n\016ReloadDoc"
          + "ument\0226.google.cloud.dialogflow.v2beta1."
          + "ReloadDocumentRequest\032\035.google.longrunni"
          + "ng.Operation\"\241\002\202\323\344\223\002\337\001\">/v2beta1/{name=p"
          ...
          + "ad:\001*\332A\017name,gcs_source\312A&\n\010Document\022\032Kn"
          + "owledgeOperationMetadata\032x\312A\031dialogflow."
          + "googleapis.com\322AYhttps://www.googleapis."
          + "com/auth/cloud-platform,https://www.goog"
          + "leapis.com/auth/dialogflowB\245\001\n#com.googl"
          + "e.cloud.dialogflow.v2beta1B\rDocumentProt"
