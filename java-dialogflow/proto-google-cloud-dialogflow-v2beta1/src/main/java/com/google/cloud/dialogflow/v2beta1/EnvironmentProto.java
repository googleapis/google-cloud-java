...
public final class EnvironmentProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "1google/cloud/dialogflow/v2beta1/environment.proto\022\037google.cloud.dialogflow.v2b"
          ...
          + "2google/cloud/dialogflow/v2beta1/audio_config.proto\0321google/cloud/dialogflow/v2b"
          + "eta1/fulfillment.proto\032\033google/protobuf/empty.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\223\005\n"
          + "\013Environment\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\030\n"
          + "\013description\030\002 \001(\tB\003\340A\001\022@\n\r"
          + "agent_version\030\003 \001(\tB)\340A\001\372A#\n"
          + "!dialogflow.googleapis.com/Version\022F\n"
          + "\005state\030\004"
          + " \001(\01622.google.cloud.dialogflow.v2beta1.Environment.StateB\003\340A\003\0224\n"
          + "\013update_time\030\005 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022[\n"
          + "\027text_to_speech_settings\030\007"
          + " \001(\01325.google.cloud.dialogflow.v2beta1.TextToSpeechSettingsB\003\340A\001\022F\n"
          + "\013fulfillment\030\010"
          + " \001(\0132,.google.cloud.dialogflow.v2beta1.FulfillmentB\003\340A\001\"E\n"
          + "\005State\022\025\n"
          + "\021STATE_UNSPECIFIED\020\000\022\013\n"
          + "\007STOPPED\020\001\022\013\n"
          + "\007LOADING\020\002\022\013\n"
          + "\007RUNNING\020\003:\252\001\352A\246\001\n"
          + "%dialogflow.googleapis.com/Environment\0223projects/{project}/agent/"
          + "environments/{environment}\022Hprojects/{pr"
          + "oject}/locations/{location}/agent/environments/{environment}\"\251\003\n"
          + "\024TextToSpeechSettings\022\"\n"
          + "\025enable_text_to_speech\030\001 \001(\010B\003\340A\001\022X\n"
          + "\025output_audio_encoding\030\002 \001(\01624.googl"
          + "e.cloud.dialogflow.v2beta1.OutputAudioEncodingB\003\340A\002\022\036\n"
          + "\021sample_rate_hertz\030\003 \001(\005B\003\340A\001\022z\n"
          + "\031synthesize_speech_configs\030\004 \003(\0132R"
          + ".google.cloud.dialogflow.v2beta1.TextToS"
          + "peechSettings.SynthesizeSpeechConfigsEntryB\003\340A\001\032w\n"
          + "\034SynthesizeSpeechConfigsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022F\n"
          + "\005value\030\002 \001(\01327.google.clo"
          + "ud.dialogflow.v2beta1.SynthesizeSpeechConfig:\0028\001\"\211\001\n"
          + "\027ListEnvironmentsRequest\022=\n"
          + "\006parent\030\001 \001("
          + "\tB-\340A\002\372A\'\022%dialogflow.googleapis.com/Environment\022\026\n"
          + "\tpage_size\030\002 \001(\005B\003\340A\001\022\027\n\n"
          + "page_token\030\003 \001(\tB\003\340A\001\"w\n"
          + "\030ListEnvironmentsResponse\022B\n"
          + "\014environments\030\001 \003(\0132,"
          + ".google.cloud.dialogflow.v2beta1.Environment\022\027\n"
          ...
          + "\006parent\030\001 \001(\t"
          + "B-\340A\002\372A\'\022%dialogflow.googleapis.com/Environment\022F\n"
          + "\013environment\030\002 \001(\0132,.google.cl"
          + "oud.dialogflow.v2beta1.EnvironmentB\003\340A\002\022\033\n"
          + "\016environment_id\030\003 \001(\tB\003\340A\002\"\316\001\n"
          + "\030UpdateEnvironmentRequest\022F\n"
          + "\013environment\030\001 \001(\0132,"
          + ".google.cloud.dialogflow.v2beta1.EnvironmentB\003\340A\002\0224\n"
          + "\013update_mask\030\002 \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\0224\n"
          + "\'allow_load_to_draft_and_discard_changes\030\003 \001(\010B\003\340A\001\"W\n"
          + "\030DeleteEnvironmentRequest\022;\n"
          + "\004name\030\001 \001(\tB-\340A\002\372A\'\n"
          + "%dialogflow.googleapis.com/Environment\"\216\001\n"
          ...
          + "\007entries\030\002"
          + " \003(\01329.google.cloud.dialogflow.v2beta1.EnvironmentHistory.EntryB\003\340A\003\022\034\n"
          + "\017next_page_token\030\003 \001(\tB\003\340A\003\032d\n"
          + "\005Entry\022\025\n\r"
          + "agent_version\030\001 \001(\t\022\023\n"
          + "\013description\030\002 \001(\t\022/\n"
          + "\013create_time\030\003 \001(\0132\032.google.protobuf.Timestamp2\277\r\n"
          + "\014Environments\022\210\002\n"
          + "\020ListEnvironments\0228.google.cloud.dialogflow.v2beta1"
          + ".ListEnvironmentsRequest\0329.google.cloud.dialogflow.v2beta1.ListEnvironmentsRespo"
          + "nse\"\177\332A\006parent\202\323\344\223\002p\022//v2beta1/{parent=p"
          + "rojects/*/agent}/environmentsZ=\022;/v2beta"
          + "1/{parent=projects/*/locations/*/agent}/environments\022\356\001\n"
          + "\016GetEnvironment\0226.google.cloud.dialogflow.v2beta1.GetEnvironment"
          ...
          + "a1/{name=projects/*/locations/*/agent/environments/*}\022\220\002\n"
          + "\021CreateEnvironment\0229.google.cloud.dialogflow.v2beta1.CreateEnvi"
          + "ronmentRequest\032,.google.cloud.dialogflow"
          + ".v2beta1.Environment\"\221\001\202\323\344\223\002\212\001\"//v2beta1"
          + "/{parent=projects/*/agent}/environments:\013environmentZJ\";/v2beta1/{parent=project"
          + "s/*/locations/*/agent}/environments:\013environment\022\250\002\n"
          + "\021UpdateEnvironment\0229.google.cloud.dialogflow.v2beta1.UpdateEnvironme"
          + "ntRequest\032,.google.cloud.dialogflow.v2be"
          + "ta1.Environment\"\251\001\202\323\344\223\002\242\0012;/v2beta1/{env"
          + "ironment.name=projects/*/agent/environments/*}:\013environmentZV2G/v2beta1/{environ"
          + "ment.name=projects/*/locations/*/agent/environments/*}:\013environment\022\336\001\n"
          + "\021DeleteEnvironment\0229.google.cloud.dialogflow.v2be"
          ...
          + "1/{name=projects/*/locations/*/agent/environments/*}\022\231\002\n"
          + "\025GetEnvironmentHistory\022=.google.cloud.dialogflow.v2beta1.GetEnvi"
          ...
          + "environments/*}/historyZG\022E/v2beta1/{parent=projects/*/locations/*/agent/environ"
          + "ments/*}/history\032x\312A\031dialogflow.googleap"
          + "is.com\322AYhttps://www.googleapis.com/auth"
          + "/cloud-platform,https://www.googleapis.com/auth/dialogflowB\245\001\n"
          + "#com.google.cloud.dialogflow.v2beta1B\020EnvironmentProtoP\001ZC"
    ...
    internal_static_google_cloud_dialogflow_v2beta1_EnvironmentHistory_Entry_descriptor =
        internal_static_google_cloud_dialogflow_v2beta1_EnvironmentHistory_descriptor.getNestedType(
            0);
    internal_static_google_cloud_dialogflow_v2beta1_EnvironmentHistory_Entry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_dialogflow_v2beta1_EnvironmentHistory_Entry_descriptor,
