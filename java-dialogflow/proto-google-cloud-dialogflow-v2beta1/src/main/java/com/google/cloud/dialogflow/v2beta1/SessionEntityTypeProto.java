  ...
  static {
    java.lang.String[] descriptorData = {
      "\n9google/cloud/dialogflow/v2beta1/sessio"
          ...
          + "ionEntityTypesResponse\"\310\002\332A\006parent\202\323\344\223\002\270"
          + "\002\0229/v2beta1/{parent=projects/*/agent/ses"
          + "sions/*}/entityTypesZR\022P/v2beta1/{parent"
          + "=projects/*/agent/environments/*/users/*"
          + "/sessions/*}/entityTypesZG\022E/v2beta1/{pa"
          + "rent=projects/*/locations/*/agent/sessio"
          + "ns/*}/entityTypesZ^\022\\/v2beta1/{parent=pr"
          + "ojects/*/locations/*/agent/environments/"
          + "*/users/*/sessions/*}/entityTypes\022\321\003\n\024Ge"
          ...
          + "onEntityType\"\306\002\332A\004name\202\323\344\223\002\270\002\0229/v2beta1/"
          + "{name=projects/*/agent/sessions/*/entity"
          + "Types/*}ZR\022P/v2beta1/{name=projects/*/ag"
          + "ent/environments/*/users/*/sessions/*/en"
          + "tityTypes/*}ZG\022E/v2beta1/{name=projects/"
          + "*/locations/*/agent/sessions/*/entityTyp"
          + "es/*}Z^\022\\/v2beta1/{name=projects/*/locat"
          + "ions/*/agent/environments/*/users/*/sess"
          + "ions/*/entityTypes/*}\022\301\004\n\027CreateSessionE"
          ...
          + "tyType\"\260\003\332A\032parent,session_entity_type\202\323"
          + "\344\223\002\214\003\"9/v2beta1/{parent=projects/*/agent"
          + "/sessions/*}/entityTypes:\023session_entity"
          + "_typeZg\"P/v2beta1/{parent=projects/*/age"
          + "nt/environments/*/users/*/sessions/*}/en"
          + "tityTypes:\023session_entity_typeZ\\\"E/v2bet"
          + "a1/{parent=projects/*/locations/*/agent/"
          + "sessions/*}/entityTypes:\023session_entity_"
          + "typeZs\"\\/v2beta1/{parent=projects/*/loca"
          ...
          + ".v2beta1.SessionEntityType\"\234\004\332A\023session_"
          + "entity_type\332A\037session_entity_type,update"
          + "_mask\202\323\344\223\002\335\0032M/v2beta1/{session_entity_t"
          + "ype.name=projects/*/agent/sessions/*/ent"
          + "ityTypes/*}:\023session_entity_typeZ{2d/v2b"
          + "eta1/{session_entity_type.name=projects/"
          + "*/agent/environments/*/users/*/sessions/"
          + "*/entityTypes/*}:\023session_entity_typeZp2"
          + "Y/v2beta1/{session_entity_type.name=proj"
          + "ects/*/locations/*/agent/sessions/*/enti"
          + "tyTypes/*}:\023session_entity_typeZ\207\0012p/v2b"
          + "eta1/{session_entity_type.name=projects/"
          + "*/locations/*/agent/environments/*/users"
          + "/*/sessions/*/entityTypes/*}:\023session_en"
          + "tity_type\022\273\003\n\027DeleteSessionEntityType\022?."
          + "google.cloud.dialogflow.v2beta1.DeleteSe"
          + "ssionEntityTypeRequest\032\026.google.protobuf"
          + ".Empty\"\306\002\332A\004name\202\323\344\223\002\270\002*9/v2beta1/{name="
          + "projects/*/agent/sessions/*/entityTypes/"
          + "*}ZR*P/v2beta1/{name=projects/*/agent/en"
          + "vironments/*/users/*/sessions/*/entityTy"
          + "pes/*}ZG*E/v2beta1/{name=projects/*/loca"
          + "tions/*/agent/sessions/*/entityTypes/*}Z"
          ...
          + "2beta1/dialogflowpb;dialogflowpb\242\002\002DF\252\002\037"
