  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "#com.google.cloud.dialogflow.v2beta1B\020AudioConf"
          + "igProtoP\001ZCcloud.google.com/go/dialogflo"
          + "w/apiv2beta1/dialogflowpb;dialogflowpb\242\002"
          + "\002DF\252\002\037Google.Cloud.Dialogflow.V2Beta1\352AU\n"
          + "\033automl.googleapis.com/Model\0226projects/"
          + "{project}/locations/{location}/models/{model}\352Ab\n"
          + "\037speech.googleapis.com/PhraseSet\022?projects/{project}/locations/{locatio"
          + "n}/phraseSets/{phrase_set}b\006proto3"
    };
    descriptor =
