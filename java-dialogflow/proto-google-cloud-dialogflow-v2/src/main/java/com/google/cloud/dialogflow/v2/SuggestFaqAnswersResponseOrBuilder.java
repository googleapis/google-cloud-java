...
public interface SuggestFaqAnswersResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.dialogflow.v2.FaqAnswer> getFaqAnswersList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.dialogflow.v2.FaqAnswer faq_answers = 1;</code>
   */
  com.google.cloud.dialogflow.v2.FaqAnswerOrBuilder getFaqAnswersOrBuilder(int index);
