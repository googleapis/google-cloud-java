...
public interface UpdateGeneratorRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.v2.UpdateGeneratorRequest)
   ...
   *
   * <code>
   * .google.cloud.dialogflow.v2.Generator generator = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
