  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "google.cloud.dialogflow.v2.Version.VersionStatusB\003\340A\003\"W\n\r"
          ...
          + "!dialogflow.googleapis.com/Version\022+projects/{proj"
          + "ect}/agent/versions/{version}\022@projects/"
          + "{project}/locations/{location}/agent/versions/{version}\"\201\001\n"
          ...
          + "ListVersionsResponse\"m\332A\006parent\202\323\344\223\002^\022&/"
          + "v2/{parent=projects/*/agent}/versionsZ4\022"
          + "2/v2/{parent=projects/*/locations/*/agent}/versions\022\315\001\n\n"
          + "GetVersion\022-.google.cloud.dialogflow.v2.GetVersionRequest\032#.goog"
          + "le.cloud.dialogflow.v2.Version\"k\332A\004name\202"
          + "\323\344\223\002^\022&/v2/{name=projects/*/agent/versio"
          + "ns/*}Z4\0222/v2/{name=projects/*/locations/*/agent/versions/*}\022\360\001\n\r"
          + "CreateVersion\0220.google.cloud.dialogflow.v2.CreateVersion"
          + "Request\032#.google.cloud.dialogflow.v2.Ver"
          + "sion\"\207\001\332A\016parent,version\202\323\344\223\002p\"&/v2/{par"
          + "ent=projects/*/agent}/versions:\007versionZ"
          + "=\"2/v2/{parent=projects/*/locations/*/agent}/versions:\007version\022\206\002\n\r"
          + "UpdateVersion\0220.google.cloud.dialogflow.v2.UpdateVers"
          + "ionRequest\032#.google.cloud.dialogflow.v2."
          + "Version\"\235\001\332A\023version,update_mask\202\323\344\223\002\200\0012"
          + "./v2/{version.name=projects/*/agent/versions/*}:\007versionZE2:/v2/{version.name=pr"
          + "ojects/*/locations/*/agent/versions/*}:\007version\022\306\001\n\r"
          + "DeleteVersion\0220.google.cloud.dialogflow.v2.DeleteVersionRequest\032\026.go"
          + "ogle.protobuf.Empty\"k\332A\004name\202\323\344\223\002^*&/v2/"
          + "{name=projects/*/agent/versions/*}Z4*2/v2/{name=projects/*/locations/*/agent/ver"
          + "sions/*}\032x\312A\031dialogflow.googleapis.com\322A"
          + "Yhttps://www.googleapis.com/auth/cloud-p"
          + "latform,https://www.googleapis.com/auth/dialogflowB\222\001\n"
          + "\036com.google.cloud.dialogflow.v2B\014VersionProtoP\001Z>cloud.google.com/"
          + "go/dialogflow/apiv2/dialogflowpb;dialogf"
          + "lowpb\242\002\002DF\252\002\032Google.Cloud.Dialogflow.V2b\006proto3"
    };
    descriptor =
