...
public final class SuggestionResult extends com.google.protobuf.GeneratedMessage
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.cloud.dialogflow.v2.ParticipantProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.cloud.dialogflow.v2.SuggestionResult.class,
            com.google.cloud.dialogflow.v2.SuggestionResult.Builder.class);
  }
  ...
  public enum SuggestionResponseCase
    ...
    GENERATE_COMPANION_SUGGESTIONS_RESPONSE(10),
    ...
    public static SuggestionResponseCase forNumber(int value) {
      switch (value) {
        ...
        case 10:
          return GENERATE_COMPANION_SUGGESTIONS_RESPONSE;
        case 0:
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.SuggestArticlesResponseOrBuilder
  ...
  public com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse
    ...
    if (suggestionResponseCase_ == 8) {
      return (com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse) suggestionResponse_;
    }
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponseOrBuilder
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.SuggestFaqAnswersResponseOrBuilder
  ...
  public static final int GENERATE_COMPANION_SUGGESTIONS_RESPONSE_FIELD_NUMBER = 10;
   ...
   */
  @java.lang.Override
  public boolean hasGenerateCompanionSuggestionsResponse() {
    return suggestionResponseCase_ == 10;
  }
  ...
  public com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse
    ...
    if (suggestionResponseCase_ == 10) {
      return (com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse)
          suggestionResponse_;
    }
    return com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse.getDefaultInstance();
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponseOrBuilder
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (suggestionResponseCase_ == 2) {
      output.writeMessage(
          2, (com.google.cloud.dialogflow.v2.SuggestArticlesResponse) suggestionResponse_);
    }
    if (suggestionResponseCase_ == 3) {
      output.writeMessage(
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.dialogflow.v2.SuggestionResult other =
        (com.google.cloud.dialogflow.v2.SuggestionResult) obj;
    ...
    switch (suggestionResponseCase_) {
      ...
      case 9:
        ...
        break;
      case 10:
        if (!getGenerateCompanionSuggestionsResponse()
            .equals(other.getGenerateCompanionSuggestionsResponse())) return false;
        break;
      case 0:
      default:
    }
  ...
  public int hashCode() {
    ...
    switch (suggestionResponseCase_) {
      ...
      case 9:
        ...
        break;
      case 10:
        hash = (37 * hash) + GENERATE_COMPANION_SUGGESTIONS_RESPONSE_FIELD_NUMBER;
        hash = (53 * hash) + getGenerateCompanionSuggestionsResponse().hashCode();
        break;
      case 0:
      default:
    }
  ...
  public static com.google.cloud.dialogflow.v2.SuggestionResult parseFrom(java.nio.ByteBuffer data)
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder clear() {
      ...
      if (generateCompanionSuggestionsResponseBuilder_ != null) {
        generateCompanionSuggestionsResponseBuilder_.clear();
      }
    ...
    public com.google.cloud.dialogflow.v2.SuggestionResult buildPartial() {
      com.google.cloud.dialogflow.v2.SuggestionResult result =
          new com.google.cloud.dialogflow.v2.SuggestionResult(this);
      if (bitField0_ != 0) {
    ...
    private void buildPartialOneofs(com.google.cloud.dialogflow.v2.SuggestionResult result) {
      ...
      if (suggestionResponseCase_ == 10 && generateCompanionSuggestionsResponseBuilder_ != null) {
        result.suggestionResponse_ = generateCompanionSuggestionsResponseBuilder_.build();
      }
    }
    ...
    public Builder mergeFrom(com.google.cloud.dialogflow.v2.SuggestionResult other) {
      if (other == com.google.cloud.dialogflow.v2.SuggestionResult.getDefaultInstance())
        return this;
      switch (other.getSuggestionResponseCase()) {
        ...
        case GENERATE_COMPANION_SUGGESTIONS_RESPONSE:
          {
            mergeGenerateCompanionSuggestionsResponse(
                other.getGenerateCompanionSuggestionsResponse());
            break;
          }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82:
              {
                input.readMessage(
                    internalGetGenerateCompanionSuggestionsResponseFieldBuilder().getBuilder(),
                    extensionRegistry);
                suggestionResponseCase_ = 10;
                break;
              } // case 82
            default:
              {
     ...
     * </pre>
     *
     * <code>.google.cloud.dialogflow.v2.SuggestArticlesResponse suggest_articles_response = 2;
     * </code>
     *
     * @return Whether the suggestArticlesResponse field is set.
     */
    ...
    public Builder setSuggestArticlesResponse(
        com.google.cloud.dialogflow.v2.SuggestArticlesResponse value) {
      if (suggestArticlesResponseBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder mergeSuggestArticlesResponse(
      ...
      if (suggestArticlesResponseBuilder_ == null) {
        if (suggestionResponseCase_ == 2
          ...
          suggestionResponse_ =
              com.google.cloud.dialogflow.v2.SuggestArticlesResponse.newBuilder(
     ...
     * </code>
     */
    public com.google.cloud.dialogflow.v2.SuggestArticlesResponse.Builder
    ...
    public com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse
      ...
      if (suggestKnowledgeAssistResponseBuilder_ == null) {
        if (suggestionResponseCase_ == 8) {
          return (com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse)
              suggestionResponse_;
        }
        return com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse.getDefaultInstance();
      } else {
    ...
    public Builder setSuggestKnowledgeAssistResponse(
        com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse value) {
      if (suggestKnowledgeAssistResponseBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setSuggestKnowledgeAssistResponse(
        com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse.Builder builderForValue) {
      if (suggestKnowledgeAssistResponseBuilder_ == null) {
        suggestionResponse_ = builderForValue.build();
        onChanged();
      } else {
        ...
        if (suggestionResponseCase_ == 8
            && suggestionResponse_
                != com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse
                    .getDefaultInstance()) {
          suggestionResponse_ =
              com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse.newBuilder(
                      (com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse)
                          suggestionResponse_)
                  .mergeFrom(value)
                  .buildPartial();
     ...
     * </code>
     */
    public com.google.cloud.dialogflow.v2.SuggestKnowledgeAssistResponse.Builder
    ...
    public Builder setSuggestFaqAnswersResponse(
        com.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse value) {
      if (suggestFaqAnswersResponseBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder mergeSuggestFaqAnswersResponse(
      ...
      if (suggestFaqAnswersResponseBuilder_ == null) {
        if (suggestionResponseCase_ == 3
          ...
          suggestionResponse_ =
              com.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse.newBuilder(
                      (com.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse)
                          suggestionResponse_)
                  .mergeFrom(value)
                  .buildPartial();
     ...
     * </code>
     */
    public com.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse.Builder
    ...
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse,
            com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse.Builder,
            com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponseOrBuilder>
        generateCompanionSuggestionsResponseBuilder_;
    ...
    public com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse
      ...
      if (generateCompanionSuggestionsResponseBuilder_ == null) {
        ...
        if (suggestionResponseCase_ == 10) {
          return generateCompanionSuggestionsResponseBuilder_.getMessage();
        }
        return com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse
            .getDefaultInstance();
      }
     ...
     * </code>
     */
    public Builder setGenerateCompanionSuggestionsResponse(
        com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse value) {
      if (generateCompanionSuggestionsResponseBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        generateCompanionSuggestionsResponseBuilder_.setMessage(value);
      }
      suggestionResponseCase_ = 10;
      return this;
    }
    ...
    public Builder setGenerateCompanionSuggestionsResponse(
      ...
      if (generateCompanionSuggestionsResponseBuilder_ == null) {
        ...
        generateCompanionSuggestionsResponseBuilder_.setMessage(builderForValue.build());
      }
      suggestionResponseCase_ = 10;
      return this;
    }
     ...
     * </code>
     */
    public Builder mergeGenerateCompanionSuggestionsResponse(
        com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse value) {
      if (generateCompanionSuggestionsResponseBuilder_ == null) {
        if (suggestionResponseCase_ == 10
            && suggestionResponse_
        ...
        if (suggestionResponseCase_ == 10) {
          generateCompanionSuggestionsResponseBuilder_.mergeFrom(value);
        } else {
          generateCompanionSuggestionsResponseBuilder_.setMessage(value);
        }
      }
     ...
     * </code>
     */
    public Builder clearGenerateCompanionSuggestionsResponse() {
      if (generateCompanionSuggestionsResponseBuilder_ == null) {
        if (suggestionResponseCase_ == 10) {
          suggestionResponseCase_ = 0;
          suggestionResponse_ = null;
     ...
     * </code>
     */
    public com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse.Builder
        getGenerateCompanionSuggestionsResponseBuilder() {
      return internalGetGenerateCompanionSuggestionsResponseFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponseOrBuilder
        getGenerateCompanionSuggestionsResponseOrBuilder() {
      if ((suggestionResponseCase_ == 10)
          && (generateCompanionSuggestionsResponseBuilder_ != null)) {
        return generateCompanionSuggestionsResponseBuilder_.getMessageOrBuilder();
      } else {
        if (suggestionResponseCase_ == 10) {
          return (com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse)
              suggestionResponse_;
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse.Builder,
            com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponseOrBuilder>
        internalGetGenerateCompanionSuggestionsResponseFieldBuilder() {
      if (generateCompanionSuggestionsResponseBuilder_ == null) {
        if (!(suggestionResponseCase_ == 10)) {
          suggestionResponse_ =
              com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse
      ...
      suggestionResponseCase_ = 10;
      onChanged();
      return generateCompanionSuggestionsResponseBuilder_;
    }
