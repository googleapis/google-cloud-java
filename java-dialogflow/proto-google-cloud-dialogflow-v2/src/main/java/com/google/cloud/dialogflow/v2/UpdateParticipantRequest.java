...
public final class UpdateParticipantRequest extends com.google.protobuf.GeneratedMessage
    implements
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetParticipantFieldBuilder().getBuilder(), extensionRegistry);
