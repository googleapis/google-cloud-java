...
public interface SuggestionResultOrBuilder
   ...
   *
   * <code>
   * .google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse generate_companion_suggestions_response = 10;
   * </code>
   *
   * @return Whether the generateCompanionSuggestionsResponse field is set.
   */
  boolean hasGenerateCompanionSuggestionsResponse();
   ...
   * </code>
   *
   * @return The generateCompanionSuggestionsResponse.
   */
  com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponse
      getGenerateCompanionSuggestionsResponse();
  ...
  com.google.cloud.dialogflow.v2.GenerateCompanionSuggestionsResponseOrBuilder
      getGenerateCompanionSuggestionsResponseOrBuilder();
