...
public final class ConversationEvent extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ConversationEvent(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.StreamingRecognitionResult
      getNewRecognitionResultPayload() {
    if (payloadCase_ == 5) {
      return (com.google.cloud.dialogflow.v2.StreamingRecognitionResult) payload_;
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (payloadCase_ == 5) {
      output.writeMessage(5, (com.google.cloud.dialogflow.v2.StreamingRecognitionResult) payload_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (payloadCase_ == 5) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
              5, (com.google.cloud.dialogflow.v2.StreamingRecognitionResult) payload_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetNewMessagePayloadFieldBuilder().getBuilder(), extensionRegistry);
                payloadCase_ = 4;
                break;
              } // case 34
            case 42:
              {
                input.readMessage(
                    internalGetNewRecognitionResultPayloadFieldBuilder().getBuilder(),
                    extensionRegistry);
                payloadCase_ = 5;
                break;
              } // case 42
    ...
    public com.google.cloud.dialogflow.v2.Message.Builder getNewMessagePayloadBuilder() {
      return internalGetNewMessagePayloadFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dialogflow.v2.Message.Builder,
            com.google.cloud.dialogflow.v2.MessageOrBuilder>
        internalGetNewMessagePayloadFieldBuilder() {
      if (newMessagePayloadBuilder_ == null) {
        if (!(payloadCase_ == 4)) {
          payload_ = com.google.cloud.dialogflow.v2.Message.getDefaultInstance();
        }
        ...
        if (payloadCase_ == 5
          ...
          payload_ =
              com.google.cloud.dialogflow.v2.StreamingRecognitionResult.newBuilder(
                      (com.google.cloud.dialogflow.v2.StreamingRecognitionResult) payload_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          payload_ = value;
    ...
    public com.google.cloud.dialogflow.v2.StreamingRecognitionResult.Builder
      ...
      return internalGetNewRecognitionResultPayloadFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dialogflow.v2.StreamingRecognitionResult.Builder,
            com.google.cloud.dialogflow.v2.StreamingRecognitionResultOrBuilder>
        internalGetNewRecognitionResultPayloadFieldBuilder() {
      if (newRecognitionResultPayloadBuilder_ == null) {
        if (!(payloadCase_ == 5)) {
          payload_ = com.google.cloud.dialogflow.v2.StreamingRecognitionResult.getDefaultInstance();
        }
        newRecognitionResultPayloadBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                com.google.cloud.dialogflow.v2.StreamingRecognitionResult,
