...
public class GeneratorEvaluationName implements ResourceName {
  ...
  public static @Nullable GeneratorEvaluationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GeneratorEvaluationName> values) {
