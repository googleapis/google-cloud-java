...
public final class EvaluationConfig extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class SmartReplyConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private SmartReplyConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(allowlistDocument_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, allowlistDocument_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(allowlistDocument_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, allowlistDocument_);
      }
      if (maxResultCount_ != 0) {
   ...
   */
  public static final class SmartComposeConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private SmartComposeConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          if (datasetsBuilder_.isEmpty()) {
            ...
            datasetsBuilder_ =
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                    ? internalGetDatasetsFieldBuilder()
                    : null;
          } else {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetSmartReplyConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 34:
              {
                input.readMessage(
                    internalGetSmartComposeConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.dialogflow.v2.InputDataset.Builder getDatasetsBuilder(int index) {
      return internalGetDatasetsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.dialogflow.v2.InputDataset.Builder addDatasetsBuilder() {
      return internalGetDatasetsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.dialogflow.v2.InputDataset.Builder>
      ...
      return internalGetDatasetsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.dialogflow.v2.EvaluationConfig.SmartReplyConfig.Builder
      ...
      return internalGetSmartReplyConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dialogflow.v2.EvaluationConfig.SmartReplyConfig.Builder,
            com.google.cloud.dialogflow.v2.EvaluationConfig.SmartReplyConfigOrBuilder>
        internalGetSmartReplyConfigFieldBuilder() {
      if (smartReplyConfigBuilder_ == null) {
        if (!(modelSpecificConfigCase_ == 2)) {
          modelSpecificConfig_ =
    ...
    public com.google.cloud.dialogflow.v2.EvaluationConfig.SmartComposeConfig.Builder
      ...
      return internalGetSmartComposeConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dialogflow.v2.EvaluationConfig.SmartComposeConfig.Builder,
            com.google.cloud.dialogflow.v2.EvaluationConfig.SmartComposeConfigOrBuilder>
        internalGetSmartComposeConfigFieldBuilder() {
      if (smartComposeConfigBuilder_ == null) {
        if (!(modelSpecificConfigCase_ == 4)) {
          modelSpecificConfig_ =
              com.google.cloud.dialogflow.v2.EvaluationConfig.SmartComposeConfig
