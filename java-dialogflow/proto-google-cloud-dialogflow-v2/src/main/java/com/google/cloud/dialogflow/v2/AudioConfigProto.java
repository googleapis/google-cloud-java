  ...
  static {
    java.lang.String[] descriptorData = {
      "\n-google/cloud/dialogflow/v2/audio_confi"
          ...
          + "v2.VoiceSelectionParams\"\323\001\n\021OutputAudioC"
          + "onfig\022M\n\016audio_encoding\030\001 \001(\0162/.google.c"
          + "loud.dialogflow.v2.OutputAudioEncodingB\004"
          ...
          + "\0162).google.cloud.dialogflow.v2.Telephony"
          + "Dtmf\"q\n\022SpeechToTextConfig\022L\n\024speech_mod"
          + "el_variant\030\001 \001(\0162..google.cloud.dialogfl"
          + "ow.v2.SpeechModelVariant\022\r\n\005model\030\002 \001(\t*"
          ...
          + "figProtoP\001Z>cloud.google.com/go/dialogfl"
          + "ow/apiv2/dialogflowpb;dialogflowpb\370\001\001\242\002\002"
          + "DF\252\002\032Google.Cloud.Dialogflow.V2\352AU\n\033auto"
          + "ml.googleapis.com/Model\0226projects/{proje"
          + "ct}/locations/{location}/models/{model}\352"
          + "Ab\n\037speech.googleapis.com/PhraseSet\022?pro"
          + "jects/{project}/locations/{location}/phr"
          + "aseSets/{phrase_set}b\006proto3"
    };
    descriptor =
