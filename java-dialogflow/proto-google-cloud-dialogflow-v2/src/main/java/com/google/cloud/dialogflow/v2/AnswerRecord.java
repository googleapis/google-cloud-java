          ...
          case 18:
            {
              ...
              answerFeedback_ =
                  input.readMessage(
                      com.google.cloud.dialogflow.v2.AnswerFeedback.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 34:
            {
              ...
              if (recordCase_ == 4) {
                subBuilder =
                    ((com.google.cloud.dialogflow.v2.AgentAssistantRecord) record_).toBuilder();
              }
              record_ =
                  input.readMessage(
                      com.google.cloud.dialogflow.v2.AgentAssistantRecord.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
