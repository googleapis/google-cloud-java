...
public class ConversationProfileName implements ResourceName {
  ...
  public static @Nullable ConversationProfileName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ConversationProfileName> values) {
