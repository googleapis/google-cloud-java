...
public final class AgentAssistantRecord extends com.google.protobuf.GeneratedMessage
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.DialogflowAssistAnswer getDialogflowAssistAnswer() {
    if (answerCase_ == 7) {
      return (com.google.cloud.dialogflow.v2.DialogflowAssistAnswer) answer_;
    }
   ...
   */
  @java.lang.Override
  public com.google.cloud.dialogflow.v2.DialogflowAssistAnswerOrBuilder
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.dialogflow.v2.DialogflowAssistAnswer,
    ...
    public Builder setDialogflowAssistAnswer(
        com.google.cloud.dialogflow.v2.DialogflowAssistAnswer value) {
      if (dialogflowAssistAnswerBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setDialogflowAssistAnswer(
        com.google.cloud.dialogflow.v2.DialogflowAssistAnswer.Builder builderForValue) {
      if (dialogflowAssistAnswerBuilder_ == null) {
        answer_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeDialogflowAssistAnswer(
      ...
      if (dialogflowAssistAnswerBuilder_ == null) {
        if (answerCase_ == 7
            && answer_
                != com.google.cloud.dialogflow.v2.DialogflowAssistAnswer.getDefaultInstance()) {
          answer_ =
              com.google.cloud.dialogflow.v2.DialogflowAssistAnswer.newBuilder(
                      (com.google.cloud.dialogflow.v2.DialogflowAssistAnswer) answer_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          answer_ = value;
     ...
     * </code>
     */
    public com.google.cloud.dialogflow.v2.DialogflowAssistAnswer.Builder
    ...
    private com.google.protobuf.SingleFieldBuilder<
      ...
      if (dialogflowAssistAnswerBuilder_ == null) {
        if (!(answerCase_ == 7)) {
          answer_ = com.google.cloud.dialogflow.v2.DialogflowAssistAnswer.getDefaultInstance();
        }
        dialogflowAssistAnswerBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                com.google.cloud.dialogflow.v2.DialogflowAssistAnswer,
