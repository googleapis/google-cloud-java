  ...
  static {
    java.lang.String[] descriptorData = {
      "\n(google/cloud/dialogflow/v2/session.pro"
          ...
          + "ge_code\030\002 \001(\tB\003\340A\002\"h\n\nEventInput\022\021\n\004name"
          ...
          + "SentimentAnalysisResult\022C\n\024query_text_se"
          + "ntiment\030\001 \001(\0132%.google.cloud.dialogflow."
          + "v2.Sentiment\"-\n\tSentiment\022\r\n\005score\030\001 \001(\002"
          + "\022\021\n\tmagnitude\030\002 \001(\0022\345\005\n\010Sessions\022\311\003\n\014Det"
          + "ectIntent\022/.google.cloud.dialogflow.v2.D"
          + "etectIntentRequest\0320.google.cloud.dialog"
          + "flow.v2.DetectIntentResponse\"\325\002\202\323\344\223\002\270\002\"6"
          + "/v2/{session=projects/*/agent/sessions/*"
          + "}:detectIntent:\001*ZR\"M/v2/{session=projec"
          + "ts/*/agent/environments/*/users/*/sessio"
          + "ns/*}:detectIntent:\001*ZG\"B/v2/{session=pr"
          + "ojects/*/locations/*/agent/sessions/*}:d"
          + "etectIntent:\001*Z^\"Y/v2/{session=projects/"
          + "*/locations/*/agent/environments/*/users"
          + "/*/sessions/*}:detectIntent:\001*\332A\023session"
          + ",query_input\022\222\001\n\025StreamingDetectIntent\0228"
          + ".google.cloud.dialogflow.v2.StreamingDet"
          + "ectIntentRequest\0329.google.cloud.dialogfl"
          + "ow.v2.StreamingDetectIntentResponse\"\000(\0010"
          + "\001\032x\312A\031dialogflow.googleapis.com\322AYhttps:"
          + "//www.googleapis.com/auth/cloud-platform"
          + ",https://www.googleapis.com/auth/dialogf"
          + "lowB\360\003\n\036com.google.cloud.dialogflow.v2B\014"
          + "SessionProtoP\001ZDgoogle.golang.org/genpro"
          + "to/googleapis/cloud/dialogflow/v2;dialog"
          + "flow\370\001\001\242\002\002DF\252\002\032Google.Cloud.Dialogflow.V"
          + "2\352A\321\002\n!dialogflow.googleapis.com/Session"
          + "\022+projects/{project}/agent/sessions/{ses"
          + "sion}\022Sprojects/{project}/agent/environm"
          + "ents/{environment}/users/{user}/sessions"
          + "/{session}\022@projects/{project}/locations"
          + "/{location}/agent/sessions/{session}\022hpr"
          + "ojects/{project}/locations/{location}/ag"
          + "ent/environments/{environment}/users/{us"
          + "er}/sessions/{session}b\006proto3"
    };
    descriptor =
