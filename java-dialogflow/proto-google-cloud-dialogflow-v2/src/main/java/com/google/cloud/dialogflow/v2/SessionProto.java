  ...
  static {
    java.lang.String[] descriptorData = {
      "\n(google/cloud/dialogflow/v2/session.pro"
          ...
          + "leapis.com/auth/dialogflowB\347\003\n\036com.googl"
          + "e.cloud.dialogflow.v2B\014SessionProtoP\001Z>c"
          + "loud.google.com/go/dialogflow/apiv2/dial"
          + "ogflowpb;dialogflowpb\242\002\002DF\252\002\032Google.Clou"
          + "d.Dialogflow.V2\352A\321\002\n!dialogflow.googleap"
          + "is.com/Session\022+projects/{project}/agent"
          + "/sessions/{session}\022Sprojects/{project}/"
          + "agent/environments/{environment}/users/{"
          + "user}/sessions/{session}\022@projects/{proj"
          + "ect}/locations/{location}/agent/sessions"
          + "/{session}\022hprojects/{project}/locations"
          + "/{location}/agent/environments/{environm"
          + "ent}/users/{user}/sessions/{session}b\006pr"
          + "oto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_dialogflow_v2_QueryParameters_WebhookHeadersEntry_descriptor =
        internal_static_google_cloud_dialogflow_v2_QueryParameters_descriptor.getNestedType(0);
    internal_static_google_cloud_dialogflow_v2_QueryParameters_WebhookHeadersEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_dialogflow_v2_QueryParameters_WebhookHeadersEntry_descriptor,
            new java.lang.String[] {
