  ...
  static {
    java.lang.String[] descriptorData = {
      "\n(google/cloud/dialogflow/v2/session.pro"
          ...
          + "oud.dialogflow.v2.DetectIntentResponse\"\325"
          + "\002\202\323\344\223\002\270\002\"6/v2/{session=projects/*/agent/"
          + "sessions/*}:detectIntent:\001*ZR\"M/v2/{sess"
          + "ion=projects/*/agent/environments/*/user"
          + "s/*/sessions/*}:detectIntent:\001*ZG\"B/v2/{"
          + "session=projects/*/locations/*/agent/ses"
          + "sions/*}:detectIntent:\001*Z^\"Y/v2/{session"
          + "=projects/*/locations/*/agent/environmen"
          + "ts/*/users/*/sessions/*}:detectIntent:\001*"
          + "\332A\023session,query_input\022\222\001\n\025StreamingDete"
