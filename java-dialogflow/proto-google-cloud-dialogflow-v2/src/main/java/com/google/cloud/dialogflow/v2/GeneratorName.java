...
public class GeneratorName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_GENERATOR =
  ...
  public static GeneratorName of(String project, String location, String generator) {
    return newBuilder().setProject(project).setLocation(location).setGenerator(generator).build();
  }
  ...
  public static @Nullable GeneratorName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_GENERATOR.validatedMatch(
            formattedString, "GeneratorName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("generator"));
  }
  ...
  public static List<String> toStringList(List<@Nullable GeneratorName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_GENERATOR.instantiate(
        "project", project, "location", location, "generator", generator);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/generators/{generator}. */
