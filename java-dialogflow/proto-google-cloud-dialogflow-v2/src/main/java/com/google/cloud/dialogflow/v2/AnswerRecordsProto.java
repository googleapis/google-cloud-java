  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "roto\032\031google/api/resource.proto\032,google/cloud/dialogflow/v2/participant.proto\032"
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\361\002\n"
          + "\014AnswerRecord\022\014\n"
          + "\004name\030\001 \001(\t\022H\n"
          + "\017answer_feedback\030\002 \001(\013"
          + "2*.google.cloud.dialogflow.v2.AnswerFeedbackB\003\340A\002\022W\n"
          + "\026agent_assistant_record\030\004 \001("
          + "\01320.google.cloud.dialogflow.v2.AgentAssistantRecordB\003\340A\003H\000:\245\001\352A\241\001\n"
          + "&dialogflow.googleapis.com/AnswerRecord\0220projects/{pro"
          + "ject}/answerRecords/{answer_record}\022Epro"
          + "jects/{project}/locations/{location}/answerRecords/{answer_record}B\010\n"
          + "\006record\"\240\001\n"
          + "\030ListAnswerRecordsRequest\022>\n"
          + "\006parent\030\001 \001("
          + "\tB.\340A\002\372A(\022&dialogflow.googleapis.com/AnswerRecord\022\023\n"
          ...
          + " \003(\0132(.google.cloud.dialogflow.v2.AnswerRecord\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"\227\001\n"
          + "\031UpdateAnswerRecordRequest\022D\n\r"
          + "answer_record\030\001"
          + " \001(\0132(.google.cloud.dialogflow.v2.AnswerRecordB\003\340A\002\0224\n"
          ...
          + ";.google.cloud.dialogflow.v2.AnswerFeedback.CorrectnessLevel\022]\n"
          + "\037agent_assistant_detail_feedback\030\002"
          + " \001(\01322.google.cloud.dialogflow.v2.AgentAssistantFeedbackH\000\022\017\n"
          ...
          + "FULLY_CORRECT\020\003B\021\n"
          + "\017detail_feedback\"\373\n\n"
          + "\026AgentAssistantFeedback\022a\n"
          + "\020answer_relevance\030\001 \001(\0162B.go"
          + "ogle.cloud.dialogflow.v2.AgentAssistantFeedback.AnswerRelevanceB\003\340A\001\022i\n"
          + "\024document_correctness\030\002 \001(\0162F.google.cloud.dialog"
          + "flow.v2.AgentAssistantFeedback.DocumentCorrectnessB\003\340A\001\022g\n"
          + "\023document_efficiency\030\003 \001(\0162E.google.cloud.dialogflow.v2.AgentA"
          + "ssistantFeedback.DocumentEfficiencyB\003\340A\001\022m\n"
          + "\026summarization_feedback\030\004 \001(\0132H.googl"
          + "e.cloud.dialogflow.v2.AgentAssistantFeedback.SummarizationFeedbackB\003\340A\001\022r\n"
          + "\031knowledge_search_feedback\030\005 \001(\0132J.google.clou"
          + "d.dialogflow.v2.AgentAssistantFeedback.KnowledgeSearchFeedbackB\003\340A\001\022r\n"
          + "\031knowledge_assist_feedback\030\006 \001(\0132J.google.cloud.di"
          + "alogflow.v2.AgentAssistantFeedback.KnowledgeAssistFeedbackB\003\340A\001\032\273\002\n"
          ...
          + "text_sections\030\004 \003(\0132Z.google.cloud.dialogflow.v2.AgentAssistantFeedb"
          + "ack.SummarizationFeedback.TextSectionsEntryB\003\340A\001\0323\n"
          + "\021TextSectionsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\032F\n"
          + "\027KnowledgeSearchFeedback\022\025\n\r"
          + "answer_copied\030\001 \001(\010\022\024\n"
          ...
          + "\031article_suggestion_answer\030\005"
          + " \001(\0132).google.cloud.dialogflow.v2.ArticleAnswerB\003\340A\003H\000\022@\n\n"
          + "faq_answer\030\006 \001(\0132%"
          + ".google.cloud.dialogflow.v2.FaqAnswerB\003\340A\003H\000\022[\n"
          + "\030dialogflow_assist_answer\030\007 \001(\01322"
          + ".google.cloud.dialogflow.v2.DialogflowAssistAnswerB\003\340A\003H\000B\010\n"
          + "\006answer2\255\005\n\r"
          + "AnswerRecords\022\355\001\n"
          + "\021ListAnswerRecords\0224.google.cloud.dialogflow.v2.ListAnswerRecordsReques"
          + "t\0325.google.cloud.dialogflow.v2.ListAnswe"
          + "rRecordsResponse\"k\332A\006parent\202\323\344\223\002\\\022%/v2/{"
          + "parent=projects/*}/answerRecordsZ3\0221/v2/"
          + "{parent=projects/*/locations/*}/answerRecords\022\261\002\n"
          + "\022UpdateAnswerRecord\0225.google.cloud.dialogflow.v2.UpdateAnswerRecordRequ"
          + "est\032(.google.cloud.dialogflow.v2.AnswerR"
          + "ecord\"\271\001\332A\031answer_record,update_mask\202\323\344\223"
          + "\002\226\00123/v2/{answer_record.name=projects/*/answerRecords/*}:\r"
          + "answer_recordZP2?/v2/{answer_record.name=projects/*/locations/*/answerRecords/*}:\r"
          + "answer_record\032x\312A\031dialogflow.googleapis.com\322AYhttps://www.go"
          + "ogleapis.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\230\001\n"
          + "\036com.google.cloud.dialogflow.v2B\022AnswerRe"
