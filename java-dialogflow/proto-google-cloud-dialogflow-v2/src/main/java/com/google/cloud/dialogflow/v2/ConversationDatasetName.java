...
public class ConversationDatasetName implements ResourceName {
  ...
  public static @Nullable ConversationDatasetName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ConversationDatasetName> values) {
