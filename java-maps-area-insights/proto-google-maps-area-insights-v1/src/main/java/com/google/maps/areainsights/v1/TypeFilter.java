...
public final class TypeFilter extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TypeFilter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < includedTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, includedTypes_.getRaw(i));
    }
    for (int i = 0; i < excludedTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, excludedTypes_.getRaw(i));
    }
    for (int i = 0; i < includedPrimaryTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, includedPrimaryTypes_.getRaw(i));
    }
    for (int i = 0; i < excludedPrimaryTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, excludedPrimaryTypes_.getRaw(i));
    }
