...
/**
 * Base stub class for the OrderTrackingSignalsService service API.
 *
...
public abstract class OrderTrackingSignalsServiceStub implements BackgroundResource {

  public UnaryCallable<CreateOrderTrackingSignalRequest, OrderTrackingSignal>
      createOrderTrackingSignalCallable() {
    throw new UnsupportedOperationException("Not implemented: createOrderTrackingSignalCallable()");
  }
