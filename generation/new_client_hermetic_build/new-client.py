...
def add_new_library(
  ...
  _add_new_library_impl(*positional_args)

def _add_new_library_impl(
    api_shortname,
    name_pretty,
    proto_path,
    product_docs,
  ...
  for library in config['libraries']:
    config_destination_name = library['destination_name'] if 'destination_name' in library else f'java-{library.api_shortname}'
    if config_destination_name == destination_name
