...
echo "  cd workspace/repo && gh pr create --base ${BRANCH} \
    --title 'deps: regenerating with new Protobuf (${BRANCH})'" \
    --body "'To merge into ${BRANCH} branch. This PR was generated using Protobuf ${PROTOBUF_VERSION}. Source-Link: https://github.com/googleapis/googleapis/commit/${last_googleapis_commit}'"
