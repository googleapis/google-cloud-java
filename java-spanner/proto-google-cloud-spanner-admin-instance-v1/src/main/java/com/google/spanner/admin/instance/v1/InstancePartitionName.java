...
public class InstancePartitionName implements ResourceName {
  ...
  public static @Nullable InstancePartitionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable InstancePartitionName> values) {
