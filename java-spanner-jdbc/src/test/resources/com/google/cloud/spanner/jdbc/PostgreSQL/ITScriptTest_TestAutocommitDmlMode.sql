...
@EXPECT EXCEPTION INVALID_ARGUMENT 'INVALID_ARGUMENT: Unknown value for SPANNER.AUTOCOMMIT_DML_MODE: 'None''
SET SPANNER.AUTOCOMMIT_DML_MODE = 'None';
...
-- Verify that turning off autocommit and on again will not reset the SPANNER.AUTOCOMMIT_DML_MODE value
@EXPECT RESULT_SET 'SPANNER.AUTOCOMMIT_DML_MODE','PARTITIONED_NON_ATOMIC'
SHOW VARIABLE SPANNER.AUTOCOMMIT_DML_MODE;
SET AUTOCOMMIT = FALSE;
SET AUTOCOMMIT = TRUE;
