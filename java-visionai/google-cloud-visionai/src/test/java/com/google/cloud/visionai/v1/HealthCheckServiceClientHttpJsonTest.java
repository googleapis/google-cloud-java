...
public class HealthCheckServiceClientHttpJsonTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonHealthCheckServiceStub.getMethodDescriptors(),
            HealthCheckServiceSettings.getDefaultEndpoint());
    HealthCheckServiceSettings settings =
        HealthCheckServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                HealthCheckServiceSettings.defaultHttpJsonTransportProviderBuilder()
