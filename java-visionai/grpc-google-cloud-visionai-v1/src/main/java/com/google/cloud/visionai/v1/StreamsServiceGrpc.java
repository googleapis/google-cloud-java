...
public final class StreamsServiceGrpc {
  ...
  public static StreamsServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<StreamsServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<StreamsServiceBlockingV2Stub>() {
          @java.lang.Override
          public StreamsServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new StreamsServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return StreamsServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class StreamsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<StreamsServiceBlockingV2Stub> {
    private StreamsServiceBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected StreamsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new StreamsServiceBlockingV2Stub(channel, callOptions);
    }
