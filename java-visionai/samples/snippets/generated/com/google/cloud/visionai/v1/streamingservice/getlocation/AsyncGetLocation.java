...
// [START visionai_v1_generated_StreamingService_GetLocation_async]
...
public class AsyncGetLocation {
  ...
  public static void asyncGetLocation() throws Exception {
    ...
    try (StreamingServiceClient streamingServiceClient = StreamingServiceClient.create()) {
      ...
      ApiFuture<Location> future = streamingServiceClient.getLocationCallable().futureCall(request);
      // Do something.
      Location response = future.get();
    }
  }
}
// [END visionai_v1_generated_StreamingService_GetLocation_async]
