...
// [START visionai_v1_generated_StreamsService_GetLocation_async]
...
public class AsyncGetLocation {
  ...
  public static void asyncGetLocation() throws Exception {
    ...
    try (StreamsServiceClient streamsServiceClient = StreamsServiceClient.create()) {
      ...
      ApiFuture<Location> future = streamsServiceClient.getLocationCallable().futureCall(request);
      // Do something.
      Location response = future.get();
    }
  }
}
// [END visionai_v1_generated_StreamsService_GetLocation_async]
