...
// [START visionai_v1_generated_StreamingService_ListLocations_async]
  ...
  public static void asyncListLocations() throws Exception {
    ...
    try (StreamingServiceClient streamingServiceClient = StreamingServiceClient.create()) {
      ...
      ApiFuture<Location> future =
          streamingServiceClient.listLocationsPagedCallable().futureCall(request);
      // Do something.
...
// [END visionai_v1_generated_StreamingService_ListLocations_async]
