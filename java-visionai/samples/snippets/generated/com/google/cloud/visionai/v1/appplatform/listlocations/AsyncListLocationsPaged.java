...
// [START visionai_v1_generated_AppPlatform_ListLocations_Paged_async]
    ...
    try (AppPlatformClient appPlatformClient = AppPlatformClient.create()) {
      ListLocationsRequest request =
          ListLocationsRequest.newBuilder()
              ...
              .build();
      while (true) {
        ListLocationsResponse response = appPlatformClient.listLocationsCallable().call(request);
...
// [END visionai_v1_generated_AppPlatform_ListLocations_Paged_async]
