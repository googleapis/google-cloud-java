...
// [START visionai_v1_generated_StreamingService_ListLocations_Paged_async]
    ...
    try (StreamingServiceClient streamingServiceClient = StreamingServiceClient.create()) {
      ...
      while (true) {
        ListLocationsResponse response =
            streamingServiceClient.listLocationsCallable().call(request);
...
// [END visionai_v1_generated_StreamingService_ListLocations_Paged_async]
