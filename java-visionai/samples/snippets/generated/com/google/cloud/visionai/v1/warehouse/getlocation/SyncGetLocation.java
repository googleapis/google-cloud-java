...
// [START visionai_v1_generated_Warehouse_GetLocation_sync]
...
public class SyncGetLocation {
  ...
  public static void syncGetLocation() throws Exception {
    ...
    try (WarehouseClient warehouseClient = WarehouseClient.create()) {
      ...
      Location response = warehouseClient.getLocation(request);
    }
  }
}
// [END visionai_v1_generated_Warehouse_GetLocation_sync]
