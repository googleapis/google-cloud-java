...
// [START visionai_v1_generated_StreamsService_ListLocations_async]
  ...
  public static void asyncListLocations() throws Exception {
    ...
    try (StreamsServiceClient streamsServiceClient = StreamsServiceClient.create()) {
      ...
      ApiFuture<Location> future =
          streamsServiceClient.listLocationsPagedCallable().futureCall(request);
      // Do something.
...
// [END visionai_v1_generated_StreamsService_ListLocations_async]
