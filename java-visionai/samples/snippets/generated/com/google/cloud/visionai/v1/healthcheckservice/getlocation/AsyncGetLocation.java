...
// [START visionai_v1_generated_HealthCheckService_GetLocation_async]
  ...
  public static void asyncGetLocation() throws Exception {
    ...
    try (HealthCheckServiceClient healthCheckServiceClient = HealthCheckServiceClient.create()) {
      ...
      ApiFuture<Location> future =
          healthCheckServiceClient.getLocationCallable().futureCall(request);
      // Do something.
      Location response = future.get();
    }
  }
}
// [END visionai_v1_generated_HealthCheckService_GetLocation_async]
