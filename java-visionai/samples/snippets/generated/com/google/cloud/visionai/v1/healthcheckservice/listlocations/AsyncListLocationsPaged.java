...
// [START visionai_v1_generated_HealthCheckService_ListLocations_Paged_async]
    ...
    try (HealthCheckServiceClient healthCheckServiceClient = HealthCheckServiceClient.create()) {
      ...
      while (true) {
        ListLocationsResponse response =
            healthCheckServiceClient.listLocationsCallable().call(request);
...
// [END visionai_v1_generated_HealthCheckService_ListLocations_Paged_async]
