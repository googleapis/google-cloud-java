...
public final class ReceivePacketsResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ReceivePacketsResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetPacketFieldBuilder().getBuilder(), extensionRegistry);
                responseCase_ = 1;
                break;
              } // case 10
            case 26:
