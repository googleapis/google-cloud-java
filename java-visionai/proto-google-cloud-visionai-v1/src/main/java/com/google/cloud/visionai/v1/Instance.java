...
public final class Instance extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class InputResource extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private InputResource(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (inputResourceInformationCase_ == 1) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, inputResourceInformation_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(consumerNode_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, consumerNode_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(inputResourceBinding_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, inputResourceBinding_);
      }
      if (inputResourceInformationCase_ == 4) {
        output.writeMessage(
    ...
    public int getSerializedSize() {
      ...
      if (inputResourceInformationCase_ == 1) {
        size +=
            com.google.protobuf.GeneratedMessage.computeStringSize(1, inputResourceInformation_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(consumerNode_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, consumerNode_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(inputResourceBinding_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, inputResourceBinding_);
      }
      if (inputResourceInformationCase_ == 4) {
        size +=
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 34:
                {
                  input.readMessage(
                      internalGetAnnotatedStreamFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.visionai.v1.StreamWithAnnotation.Builder getAnnotatedStreamBuilder() {
        return internalGetAnnotatedStreamFieldBuilder().getBuilder();
      }
      ...
      private com.google.protobuf.SingleFieldBuilder<
              ...
              com.google.cloud.visionai.v1.StreamWithAnnotation.Builder,
              com.google.cloud.visionai.v1.StreamWithAnnotationOrBuilder>
          internalGetAnnotatedStreamFieldBuilder() {
        if (annotatedStreamBuilder_ == null) {
          if (!(inputResourceInformationCase_ == 4)) {
            inputResourceInformation_ =
                com.google.cloud.visionai.v1.StreamWithAnnotation.getDefaultInstance();
   ...
   */
  public static final class OutputResource extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private OutputResource(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputResource_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, outputResource_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(producerNode_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, producerNode_);
      }
      if (isTemporary_ != false) {
        output.writeBool(3, isTemporary_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputResourceBinding_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, outputResourceBinding_);
      }
      if (autogen_ != false) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputResource_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, outputResource_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(producerNode_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, producerNode_);
      }
      if (isTemporary_ != false) {
        size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, isTemporary_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputResourceBinding_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(4, outputResourceBinding_);
      }
      if (autogen_ != false) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetInputResourcesFieldBuilder();
        internalGetOutputResourcesFieldBuilder();
      }
    }
    ...
    public com.google.cloud.visionai.v1.Instance.InputResource.Builder getInputResourcesBuilder(
        int index) {
      return internalGetInputResourcesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.visionai.v1.Instance.InputResource.Builder addInputResourcesBuilder() {
      return internalGetInputResourcesFieldBuilder()
    ...
    public java.util.List<com.google.cloud.visionai.v1.Instance.InputResource.Builder>
      ...
      return internalGetInputResourcesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.visionai.v1.Instance.OutputResource.Builder getOutputResourcesBuilder(
        int index) {
      return internalGetOutputResourcesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.visionai.v1.Instance.OutputResource.Builder
      ...
      return internalGetOutputResourcesFieldBuilder()
    ...
    public java.util.List<com.google.cloud.visionai.v1.Instance.OutputResource.Builder>
      ...
      return internalGetOutputResourcesFieldBuilder().getBuilderList();
    }
