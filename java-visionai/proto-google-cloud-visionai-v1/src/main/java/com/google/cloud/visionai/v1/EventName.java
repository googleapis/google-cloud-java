...
public class EventName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CLUSTER_EVENT =
  ...
  public static EventName of(String project, String location, String cluster, String event) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String cluster, String event) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setCluster(cluster)
  ...
  public static EventName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CLUSTER_EVENT.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_CLUSTER_EVENT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_CLUSTER_EVENT.instantiate(
        "project", project, "location", location, "cluster", cluster, "event", event);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/clusters/{cluster}/events/{event}. */
  public static class Builder {
    ...
    private Builder(EventName eventName) {
      ...
      this.cluster = eventName.cluster;
