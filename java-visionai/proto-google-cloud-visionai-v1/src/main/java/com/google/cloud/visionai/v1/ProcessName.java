...
public class ProcessName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CLUSTER_PROCESS =
  ...
  public static @Nullable ProcessName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_CLUSTER_PROCESS.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable ProcessName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_CLUSTER_PROCESS.instantiate(
        "project", project, "location", location, "cluster", cluster, "process", process);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/clusters/{cluster}/processes/{process}. */
