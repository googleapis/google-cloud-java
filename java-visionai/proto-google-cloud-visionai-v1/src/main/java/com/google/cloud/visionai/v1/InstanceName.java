...
public class InstanceName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APPLICATION_INSTANCE =
  ...
  public static InstanceName of(
      String project, String location, String application, String instance) {
    return newBuilder()
        .setProject(project)
  ...
  public static InstanceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APPLICATION_INSTANCE.validatedMatch(
  ...
  public String toString() {
    return PROJECT_LOCATION_APPLICATION_INSTANCE.instantiate(
        "project", project, "location", location, "application", application, "instance", instance);
  }
