...
public class AnalysisName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CLUSTER_ANALYSIS =
  ...
  public static AnalysisName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CLUSTER_ANALYSIS.validatedMatch(
  ...
  public String toString() {
    return PROJECT_LOCATION_CLUSTER_ANALYSIS.instantiate(
        "project", project, "location", location, "cluster", cluster, "analysis", analysis);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/clusters/{cluster}/analyses/{analysis}. */
