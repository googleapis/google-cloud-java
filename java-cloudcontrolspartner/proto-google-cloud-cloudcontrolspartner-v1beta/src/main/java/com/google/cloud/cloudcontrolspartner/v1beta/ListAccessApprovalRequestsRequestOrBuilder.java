...
public interface ListAccessApprovalRequestsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.cloudcontrolspartner.v1beta.ListAccessApprovalRequestsRequest)
