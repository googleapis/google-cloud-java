...
public class ViolationName implements ResourceName {
  private static final PathTemplate ORGANIZATION_LOCATION_CUSTOMER_WORKLOAD_VIOLATION =
  ...
  public static ViolationName of(
      String organization, String location, String customer, String workload, String violation) {
    return newBuilder()
  ...
  public static @Nullable ViolationName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        ORGANIZATION_LOCATION_CUSTOMER_WORKLOAD_VIOLATION.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable ViolationName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return ORGANIZATION_LOCATION_CUSTOMER_WORKLOAD_VIOLATION.matches(formattedString);
  }
  ...
  public String toString() {
    return ORGANIZATION_LOCATION_CUSTOMER_WORKLOAD_VIOLATION.instantiate(
        "organization",
        organization,
        "location",
        location,
  ...
  public static class Builder {
    ...
    private Builder(ViolationName violationName) {
      ...
      this.customer = violationName.customer;
