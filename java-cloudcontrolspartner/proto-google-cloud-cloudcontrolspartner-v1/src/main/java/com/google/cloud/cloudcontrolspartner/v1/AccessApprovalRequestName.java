...
public class AccessApprovalRequestName implements ResourceName {
  ...
  public static @Nullable AccessApprovalRequestName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AccessApprovalRequestName> values) {
