...
public class StorageBatchOperationsClientHttpJsonTest {
  private static MockHttpService mockService;
  private static StorageBatchOperationsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonStorageBatchOperationsStub.getMethodDescriptors(),
            StorageBatchOperationsSettings.getDefaultEndpoint());
    StorageBatchOperationsSettings settings =
        StorageBatchOperationsSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                StorageBatchOperationsSettings.defaultHttpJsonTransportProviderBuilder()
