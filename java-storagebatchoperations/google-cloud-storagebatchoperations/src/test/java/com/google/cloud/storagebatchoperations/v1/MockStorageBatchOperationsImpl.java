...
import com.google.cloud.storagebatchoperations.v1.StorageBatchOperationsGrpc.StorageBatchOperationsImplBase;
...
public class MockStorageBatchOperationsImpl extends StorageBatchOperationsImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockStorageBatchOperationsImpl() {
  ...
  public void cancelJob(
    ...
    Object response = responses.poll();
    if (response instanceof CancelJobResponse) {
      requests.add(request);
      responseObserver.onNext(((CancelJobResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
