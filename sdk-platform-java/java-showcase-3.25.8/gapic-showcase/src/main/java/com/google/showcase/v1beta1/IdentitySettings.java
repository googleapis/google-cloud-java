...
/**
 * Settings class to configure an instance of {@link IdentityClient}.
 *
...
public class IdentitySettings extends ClientSettings<IdentitySettings> {
  ...
  public UnaryCallSettings<CreateUserRequest, User> createUserSettings() {
    return ((IdentityStubSettings) getStubSettings()).createUserSettings();
  }
  ...
  public UnaryCallSettings<GetUserRequest, User> getUserSettings() {
    return ((IdentityStubSettings) getStubSettings()).getUserSettings();
  }
  ...
  public UnaryCallSettings<UpdateUserRequest, User> updateUserSettings() {
    return ((IdentityStubSettings) getStubSettings()).updateUserSettings();
  }
  ...
  public UnaryCallSettings<DeleteUserRequest, Empty> deleteUserSettings() {
    return ((IdentityStubSettings) getStubSettings()).deleteUserSettings();
  }
  ...
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return IdentityStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return IdentityStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return IdentityStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return IdentityStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return IdentityStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return IdentityStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  protected IdentitySettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for IdentitySettings. */
  public static class Builder extends ClientSettings.Builder<IdentitySettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(IdentityStubSettings.newBuilder(clientContext));
    }

    protected Builder(IdentitySettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(IdentityStubSettings.Builder stubSettings) {
      super(stubSettings);
    }
    ...
    public IdentityStubSettings.Builder getStubSettingsBuilder() {
      return ((IdentityStubSettings.Builder) getStubSettings());
    }
