...
/**
 * Settings class to configure an instance of {@link IdentityStub}.
 *
...
public class IdentityStubSettings extends StubSettings<IdentityStubSettings> {
  ...
  public IdentityStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcIdentityStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonIdentityStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken("gapic", GaxProperties.getLibraryVersion(IdentityStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return IdentityStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected IdentityStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<IdentityStubSettings, Builder> {
    ...
    protected Builder(IdentityStubSettings settings) {
      super(settings);
    ...
    @Override
    public IdentityStubSettings build() throws IOException {
      return new IdentityStubSettings(this);
    }
  }
}
