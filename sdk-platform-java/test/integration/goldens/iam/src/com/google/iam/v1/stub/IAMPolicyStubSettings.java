...
/**
 * Settings class to configure an instance of {@link IAMPolicyStub}.
 *
...
public class IAMPolicyStubSettings extends StubSettings<IAMPolicyStubSettings> {
  ...
  public IAMPolicyStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcIAMPolicyStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken("gapic", GaxProperties.getLibraryVersion(IAMPolicyStubSettings.class))
        .setTransportToken(
  ...
  protected IAMPolicyStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<IAMPolicyStubSettings, Builder> {
    ...
    protected Builder(IAMPolicyStubSettings settings) {
      super(settings);
    ...
    @Override
    public IAMPolicyStubSettings build() throws IOException {
      return new IAMPolicyStubSettings(this);
    }
  }
}
