...
/**
 * Settings class to configure an instance of {@link TetherStub}.
 *
...
public class TetherStubSettings extends StubSettings<TetherStubSettings> {
  ...
  private final StreamingCallSettings<EgressResponse, EgressRequest> egressSettings;
  ...
  public TetherStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcTetherStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken("gapic", GaxProperties.getLibraryVersion(TetherStubSettings.class))
        .setTransportToken(
            GaxGrpcProperties.getGrpcTokenName(), GaxGrpcProperties.getGrpcVersion());
  }

  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return TetherStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected TetherStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<TetherStubSettings, Builder> {
    ...
    private final StreamingCallSettings.Builder<EgressResponse, EgressRequest> egressSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      egressSettings = StreamingCallSettings.newBuilder();

      unaryMethodSettingsBuilders = ImmutableList.<UnaryCallSettings.Builder<?, ?>>of();
      initDefaults(this);
    }

    protected Builder(TetherStubSettings settings) {
      super(settings);

      egressSettings = settings.egressSettings.toBuilder();
    ...
    @Override
    public TetherStubSettings build() throws IOException {
      return new TetherStubSettings(this);
    }
  }
}
