...
public class BillingAccountLocationName implements ResourceName {
  ...
  public static @Nullable BillingAccountLocationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BillingAccountLocationName> values) {
