...
public interface DeletePrincipalAccessBoundaryPolicyRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.iam.v3.DeletePrincipalAccessBoundaryPolicyRequest)
