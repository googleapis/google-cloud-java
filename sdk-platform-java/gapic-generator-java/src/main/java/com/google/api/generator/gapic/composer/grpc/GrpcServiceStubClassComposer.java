...
public class GrpcServiceStubClassComposer extends AbstractTransportServiceStubClassComposer {
  ...
  protected List<Statement> createResumableUploadStubInitStatements(
        ...
        VariableExpr.builder()
            .setVariable(
                Variable.builder()
                    ...
                    .setType(FIXED_GRPC_TYPE_STORE.get("ManagedHttpJsonChannel"))
                    .build())
            .setIsDecl(true)
            .build();
    ...
    MethodInvocationExpr channelNewBuilderExpr =
        MethodInvocationExpr.builder()
            .setStaticReferenceType(FIXED_GRPC_TYPE_STORE.get("ManagedHttpJsonChannel"))
            .setMethodName("newBuilder")
            .build();
    ...
    channelNewBuilderExpr =
        MethodInvocationExpr.builder()
            .setExprReferenceExpr(channelNewBuilderExpr)
            .setMethodName("build")
            .setReturnType(FIXED_GRPC_TYPE_STORE.get("ManagedHttpJsonChannel"))
            .build();
        ...
        VariableExpr.builder()
            .setVariable(
                Variable.builder()
                    ...
                    .setType(FIXED_GRPC_TYPE_STORE.get("HttpJsonTransportChannel"))
                    .build())
            .setIsDecl(true)
            .build();
    ...
    MethodInvocationExpr createTransportChannelExpr =
        MethodInvocationExpr.builder()
            .setStaticReferenceType(FIXED_GRPC_TYPE_STORE.get("HttpJsonTransportChannel"))
            .setMethodName("create")
            .setArguments(
                Arrays.asList(httpJsonManagedChannelVarExpr.toBuilder().setIsDecl(false).build()))
            .setReturnType(FIXED_GRPC_TYPE_STORE.get("HttpJsonTransportChannel"))
            .build();
    ...
    MethodInvocationExpr newBuilderExpr =
        MethodInvocationExpr.builder()
            .setStaticReferenceType(FIXED_TYPESTORE.get("ClientContext"))
            .setMethodName("newBuilder")
            .build();
    newBuilderExpr =
        MethodInvocationExpr.builder()
    ...
    newBuilderExpr =
        MethodInvocationExpr.builder()
            .setExprReferenceExpr(newBuilderExpr)
            .setMethodName("build")
            .setReturnType(FIXED_TYPESTORE.get("ClientContext"))
            .build();
    ...
    TypeNode uploadStubType =
        typeStore.get(String.format("HttpJson%sResumableUploadStub", service.name()));
    Expr createStubExpr =
        MethodInvocationExpr.builder()
  ...
  protected List<MethodDefinition> createResumableUploadCallableGetterMethods(
      Service service, TypeStore typeStore, Map<String, VariableExpr> classMemberVarExprs) {
    VariableExpr resumableUploadStubVarExpr =
