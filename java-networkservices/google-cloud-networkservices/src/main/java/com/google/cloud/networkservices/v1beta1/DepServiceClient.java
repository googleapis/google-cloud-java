...
import com.google.cloud.networkservices.v1beta1.stub.DepServiceStub;
 ...
 *    </tr>
 *    <tr>
 *      <td><p> ListExtensionBindings</td>
 *      <td><p> Lists `ExtensionBinding` resources in a given project and location.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> listExtensionBindings(ListExtensionBindingsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> listExtensionBindings(LocationName parent)
 *           <li><p> listExtensionBindings(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> listExtensionBindingsPagedCallable()
 *           <li><p> listExtensionBindingsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> GetExtensionBinding</td>
 *      <td><p> Gets details of the specified `ExtensionBinding` resource.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> getExtensionBinding(GetExtensionBindingRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> getExtensionBinding(ExtensionBindingName name)
 *           <li><p> getExtensionBinding(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> getExtensionBindingCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> CreateExtensionBinding</td>
 *      <td><p> Creates a new `ExtensionBinding` resource in a given project and location.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> createExtensionBindingAsync(CreateExtensionBindingRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> createExtensionBindingAsync(LocationName parent, ExtensionBinding extensionBinding, String extensionBindingId)
 *           <li><p> createExtensionBindingAsync(String parent, ExtensionBinding extensionBinding, String extensionBindingId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> createExtensionBindingOperationCallable()
 *           <li><p> createExtensionBindingCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> UpdateExtensionBinding</td>
 *      <td><p> Updates the parameters of the specified `ExtensionBinding` resource.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> updateExtensionBindingAsync(UpdateExtensionBindingRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> updateExtensionBindingAsync(ExtensionBinding extensionBinding, FieldMask updateMask)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> updateExtensionBindingOperationCallable()
 *           <li><p> updateExtensionBindingCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> DeleteExtensionBinding</td>
 *      <td><p> Deletes the specified `ExtensionBinding` resource.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> deleteExtensionBindingAsync(DeleteExtensionBindingRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> deleteExtensionBindingAsync(ExtensionBindingName name)
 *           <li><p> deleteExtensionBindingAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> deleteExtensionBindingOperationCallable()
 *           <li><p> deleteExtensionBindingCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
...
public class DepServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param parent Required. The project and location from which the `ExtensionBinding` resources
   *     should be listed, specified in the format `projects/{project}/locations/{location}`.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListExtensionBindingsPagedResponse listExtensionBindings(
      @Nullable LocationName parent) {
    ListExtensionBindingsRequest request =
        ListExtensionBindingsRequest.newBuilder()
            .setParent(parent == null ? null : parent.toString())
            .build();
    return listExtensionBindings(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListExtensionBindingsPagedResponse listExtensionBindings(String parent) {
    ListExtensionBindingsRequest request =
        ListExtensionBindingsRequest.newBuilder().setParent(parent).build();
    return listExtensionBindings(request);
  }
  ...
  public final ListExtensionBindingsPagedResponse listExtensionBindings(
      ListExtensionBindingsRequest request) {
    return listExtensionBindingsPagedCallable().call(request);
  }
   ...
   *       depServiceClient.listExtensionBindingsPagedCallable().futureCall(request);
   *   // Do something.
   *   for (ExtensionBinding element : future.get().iterateAll()) {
   *     // doThingsWith(element);
   *   }
   * }
   * }</pre>
   */
  public final UnaryCallable<ListExtensionBindingsRequest, ListExtensionBindingsPagedResponse>
      listExtensionBindingsPagedCallable() {
    return stub.listExtensionBindingsPagedCallable();
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<ListExtensionBindingsRequest, ListExtensionBindingsResponse>
      listExtensionBindingsCallable() {
    return stub.listExtensionBindingsCallable();
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ExtensionBinding getExtensionBinding(@Nullable ExtensionBindingName name) {
    GetExtensionBindingRequest request =
        GetExtensionBindingRequest.newBuilder()
            .setName(name == null ? null : name.toString())
            .build();
    return getExtensionBinding(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ExtensionBinding getExtensionBinding(String name) {
    GetExtensionBindingRequest request =
        GetExtensionBindingRequest.newBuilder().setName(name).build();
    return getExtensionBinding(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ExtensionBinding getExtensionBinding(GetExtensionBindingRequest request) {
    return getExtensionBindingCallable().call(request);
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<GetExtensionBindingRequest, ExtensionBinding>
      getExtensionBindingCallable() {
    return stub.getExtensionBindingCallable();
  }
   ...
   * }</pre>
   *
   * @param parent Required. The parent resource of the `ExtensionBinding` resource. Must be in the
   *     format `projects/{project}/locations/{location}`.
   * @param extensionBinding Required. `ExtensionBinding` resource to be created.
   * @param extensionBindingId Required. Short name of the `ExtensionBinding` resource to be
   *     created.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final OperationFuture<ExtensionBinding, OperationMetadata> createExtensionBindingAsync(
      @Nullable LocationName parent, ExtensionBinding extensionBinding, String extensionBindingId) {
    CreateExtensionBindingRequest request =
        CreateExtensionBindingRequest.newBuilder()
            ...
            .build();
    return createExtensionBindingAsync(request);
  }
   ...
   */
  public final OperationFuture<ExtensionBinding, OperationMetadata> createExtensionBindingAsync(
      String parent, ExtensionBinding extensionBinding, String extensionBindingId) {
    CreateExtensionBindingRequest request =
        CreateExtensionBindingRequest.newBuilder()
            .setParent(parent)
            .setExtensionBinding(extensionBinding)
  ...
  public final OperationFuture<ExtensionBinding, OperationMetadata> createExtensionBindingAsync(
      CreateExtensionBindingRequest request) {
    return createExtensionBindingOperationCallable().futureCall(request);
  }
   ...
   * }</pre>
   */
  public final OperationCallable<CreateExtensionBindingRequest, ExtensionBinding, OperationMetadata>
      createExtensionBindingOperationCallable() {
    return stub.createExtensionBindingOperationCallable();
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<CreateExtensionBindingRequest, Operation>
      createExtensionBindingCallable() {
    return stub.createExtensionBindingCallable();
  }
   ...
   * }</pre>
   *
   * @param extensionBinding Required. Updated `ExtensionBinding` resource.
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final OperationFuture<ExtensionBinding, OperationMetadata> updateExtensionBindingAsync(
      ExtensionBinding extensionBinding, FieldMask updateMask) {
    UpdateExtensionBindingRequest request =
        UpdateExtensionBindingRequest.newBuilder()
            .setExtensionBinding(extensionBinding)
            .setUpdateMask(updateMask)
            .build();
    return updateExtensionBindingAsync(request);
  }
  ...
  public final OperationFuture<ExtensionBinding, OperationMetadata> updateExtensionBindingAsync(
      UpdateExtensionBindingRequest request) {
    return updateExtensionBindingOperationCallable().futureCall(request);
  }
   ...
   * }</pre>
   */
  public final OperationCallable<UpdateExtensionBindingRequest, ExtensionBinding, OperationMetadata>
      updateExtensionBindingOperationCallable() {
    return stub.updateExtensionBindingOperationCallable();
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<UpdateExtensionBindingRequest, Operation>
      updateExtensionBindingCallable() {
    return stub.updateExtensionBindingCallable();
  }
   ...
   * }</pre>
   *
   * @param name Required. A name of the `ExtensionBinding` resource to delete. Must be in the
   *     format `projects/{project}/locations/{location}/extensionBindings/{extension_binding}`.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final OperationFuture<Empty, OperationMetadata> deleteExtensionBindingAsync(
      @Nullable ExtensionBindingName name) {
    DeleteExtensionBindingRequest request =
        DeleteExtensionBindingRequest.newBuilder()
            .setName(name == null ? null : name.toString())
            .build();
    return deleteExtensionBindingAsync(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final OperationFuture<Empty, OperationMetadata> deleteExtensionBindingAsync(String name) {
    DeleteExtensionBindingRequest request =
        DeleteExtensionBindingRequest.newBuilder().setName(name).build();
    return deleteExtensionBindingAsync(request);
  }
  ...
  public final OperationFuture<Empty, OperationMetadata> deleteExtensionBindingAsync(
      DeleteExtensionBindingRequest request) {
    return deleteExtensionBindingOperationCallable().futureCall(request);
  }
   ...
   * }</pre>
   */
  public final OperationCallable<DeleteExtensionBindingRequest, Empty, OperationMetadata>
      deleteExtensionBindingOperationCallable() {
    return stub.deleteExtensionBindingOperationCallable();
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<DeleteExtensionBindingRequest, Operation>
      deleteExtensionBindingCallable() {
    return stub.deleteExtensionBindingCallable();
  }
  ...
  public static class ListExtensionBindingsPagedResponse
      extends AbstractPagedListResponse<
          ListExtensionBindingsRequest,
          ListExtensionBindingsResponse,
          ExtensionBinding,
          ListExtensionBindingsPage,
          ListExtensionBindingsFixedSizeCollection> {

    public static ApiFuture<ListExtensionBindingsPagedResponse> createAsync(
        PageContext<ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>
            context,
        ApiFuture<ListExtensionBindingsResponse> futureResponse) {
      ApiFuture<ListExtensionBindingsPage> futurePage =
          ListExtensionBindingsPage.createEmptyPage().createPageAsync(context, futureResponse);
      return ApiFutures.transform(
          futurePage,
          input -> new ListExtensionBindingsPagedResponse(input),
          MoreExecutors.directExecutor());
    }

    private ListExtensionBindingsPagedResponse(ListExtensionBindingsPage page) {
      super(page, ListExtensionBindingsFixedSizeCollection.createEmptyCollection());
    }
  }

  public static class ListExtensionBindingsPage
      extends AbstractPage<
          ListExtensionBindingsRequest,
          ListExtensionBindingsResponse,
          ExtensionBinding,
    ...
    private ListExtensionBindingsPage(
        @Nullable
            PageContext<
                ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>
            context,
        @Nullable ListExtensionBindingsResponse response) {
      super(context, response);
    }

    private static ListExtensionBindingsPage createEmptyPage() {
      return new ListExtensionBindingsPage(null, null);
    }

    @Override
    protected ListExtensionBindingsPage createPage(
        @Nullable
            PageContext<
                ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>
            context,
        @Nullable ListExtensionBindingsResponse response) {
      return new ListExtensionBindingsPage(context, response);
    }

    @Override
    public ApiFuture<ListExtensionBindingsPage> createPageAsync(
        @Nullable
            PageContext<
                ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>
            context,
  ...
  public static class ListExtensionBindingsFixedSizeCollection
      extends AbstractFixedSizeCollection<
          ListExtensionBindingsRequest,
          ListExtensionBindingsResponse,
          ExtensionBinding,
    ...
    private ListExtensionBindingsFixedSizeCollection(
        @Nullable List<ListExtensionBindingsPage> pages, int collectionSize) {
      super(pages, collectionSize);
    }

    private static ListExtensionBindingsFixedSizeCollection createEmptyCollection() {
      return new ListExtensionBindingsFixedSizeCollection(null, 0);
    }

    @Override
    protected ListExtensionBindingsFixedSizeCollection createCollection(
        @Nullable List<ListExtensionBindingsPage> pages, int collectionSize) {
      return new ListExtensionBindingsFixedSizeCollection(pages, collectionSize);
    }
  }
