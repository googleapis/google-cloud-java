...
public class DepServiceStubSettings extends StubSettings<DepServiceStubSettings> {
  ...
  private final UnaryCallSettings<GetExtensionBindingRequest, ExtensionBinding>
      getExtensionBindingSettings;
  private final UnaryCallSettings<CreateExtensionBindingRequest, Operation>
  ...
  private final UnaryCallSettings<UpdateExtensionBindingRequest, Operation>
  ...
  private final UnaryCallSettings<DeleteExtensionBindingRequest, Operation>
      deleteExtensionBindingSettings;
  private final OperationCallSettings<DeleteExtensionBindingRequest, Empty, OperationMetadata>
  ...
  private static final PagedListDescriptor<
          ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>
      LIST_EXTENSION_BINDINGS_PAGE_STR_DESC =
          new PagedListDescriptor<
              ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>() {
            @Override
            public String emptyToken() {
            ...
            @Override
            public ListExtensionBindingsRequest injectToken(
                ListExtensionBindingsRequest payload, String token) {
              return ListExtensionBindingsRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListExtensionBindingsRequest injectPageSize(
                ListExtensionBindingsRequest payload, int pageSize) {
              return ListExtensionBindingsRequest.newBuilder(payload).setPageSize(pageSize).build();
            }

            @Override
            public Integer extractPageSize(ListExtensionBindingsRequest payload) {
              return payload.getPageSize();
            }

            @Override
            public String extractNextToken(ListExtensionBindingsResponse payload) {
              return payload.getNextPageToken();
            }

            @Override
            public Iterable<ExtensionBinding> extractResources(
                ListExtensionBindingsResponse payload) {
              return payload.getExtensionBindingsList();
            }
          };
  ...
  private static final PagedListResponseFactory<
          ...
          ListExtensionBindingsResponse,
          ListExtensionBindingsPagedResponse>
      LIST_EXTENSION_BINDINGS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListExtensionBindingsRequest,
              ListExtensionBindingsResponse,
              ListExtensionBindingsPagedResponse>() {
            @Override
            public ApiFuture<ListExtensionBindingsPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListExtensionBindingsRequest, ListExtensionBindingsResponse> callable,
                ListExtensionBindingsRequest request,
                ApiCallContext context,
                ApiFuture<ListExtensionBindingsResponse> futureResponse) {
              PageContext<
                      ListExtensionBindingsRequest, ListExtensionBindingsResponse, ExtensionBinding>
                  pageContext =
                      PageContext.create(
                          callable, LIST_EXTENSION_BINDINGS_PAGE_STR_DESC, request, context);
              return ListExtensionBindingsPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public PagedCallSettings<
          ...
          ListExtensionBindingsPagedResponse>
      listExtensionBindingsSettings() {
    return listExtensionBindingsSettings;
  }
  ...
  public UnaryCallSettings<GetExtensionBindingRequest, ExtensionBinding>
      getExtensionBindingSettings() {
    return getExtensionBindingSettings;
  }
  ...
  public UnaryCallSettings<DeleteExtensionBindingRequest, Operation>
      deleteExtensionBindingSettings() {
    return deleteExtensionBindingSettings;
  }

  /** Returns the object with the settings used for calls to deleteExtensionBinding. */
  public OperationCallSettings<DeleteExtensionBindingRequest, Empty, OperationMetadata>
      deleteExtensionBindingOperationSettings() {
    return deleteExtensionBindingOperationSettings;
  }
  ...
  protected DepServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    listExtensionBindingsSettings = settingsBuilder.listExtensionBindingsSettings().build();
    getExtensionBindingSettings = settingsBuilder.getExtensionBindingSettings().build();
    createExtensionBindingSettings = settingsBuilder.createExtensionBindingSettings().build();
    createExtensionBindingOperationSettings =
        settingsBuilder.createExtensionBindingOperationSettings().build();
    updateExtensionBindingSettings = settingsBuilder.updateExtensionBindingSettings().build();
    updateExtensionBindingOperationSettings =
        settingsBuilder.updateExtensionBindingOperationSettings().build();
    deleteExtensionBindingSettings = settingsBuilder.deleteExtensionBindingSettings().build();
    deleteExtensionBindingOperationSettings =
        settingsBuilder.deleteExtensionBindingOperationSettings().build();
  ...
  public static class Builder extends StubSettings.Builder<DepServiceStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<
            ...
            ListExtensionBindingsPagedResponse>
        listExtensionBindingsSettings;
    private final UnaryCallSettings.Builder<GetExtensionBindingRequest, ExtensionBinding>
        getExtensionBindingSettings;
    private final UnaryCallSettings.Builder<CreateExtensionBindingRequest, Operation>
        createExtensionBindingSettings;
    private final OperationCallSettings.Builder<
            CreateExtensionBindingRequest, ExtensionBinding, OperationMetadata>
        createExtensionBindingOperationSettings;
    private final UnaryCallSettings.Builder<UpdateExtensionBindingRequest, Operation>
        updateExtensionBindingSettings;
    private final OperationCallSettings.Builder<
            UpdateExtensionBindingRequest, ExtensionBinding, OperationMetadata>
        updateExtensionBindingOperationSettings;
    private final UnaryCallSettings.Builder<DeleteExtensionBindingRequest, Operation>
        deleteExtensionBindingSettings;
    private final OperationCallSettings.Builder<
            DeleteExtensionBindingRequest, Empty, OperationMetadata>
        deleteExtensionBindingOperationSettings;
    private final PagedCallSettings.Builder<
            ListLocationsRequest, ListLocationsResponse, ListLocationsPagedResponse>
        listLocationsSettings;
    ...
    protected Builder(@Nullable ClientContext clientContext) {
      ...
      listExtensionBindingsSettings =
          PagedCallSettings.newBuilder(LIST_EXTENSION_BINDINGS_PAGE_STR_FACT);
      getExtensionBindingSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      createExtensionBindingSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      createExtensionBindingOperationSettings = OperationCallSettings.newBuilder();
      updateExtensionBindingSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      updateExtensionBindingOperationSettings = OperationCallSettings.newBuilder();
      deleteExtensionBindingSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      deleteExtensionBindingOperationSettings = OperationCallSettings.newBuilder();
    ...
    protected Builder(DepServiceStubSettings settings) {
      ...
      listExtensionBindingsSettings = settings.listExtensionBindingsSettings.toBuilder();
      getExtensionBindingSettings = settings.getExtensionBindingSettings.toBuilder();
      createExtensionBindingSettings = settings.createExtensionBindingSettings.toBuilder();
      createExtensionBindingOperationSettings =
          settings.createExtensionBindingOperationSettings.toBuilder();
      updateExtensionBindingSettings = settings.updateExtensionBindingSettings.toBuilder();
      updateExtensionBindingOperationSettings =
          settings.updateExtensionBindingOperationSettings.toBuilder();
      deleteExtensionBindingSettings = settings.deleteExtensionBindingSettings.toBuilder();
      deleteExtensionBindingOperationSettings =
          settings.deleteExtensionBindingOperationSettings.toBuilder();
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<CreateExtensionBindingRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_0_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_0_params"))
                  .build())
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.create(ExtensionBinding.class))
          .setMetadataTransformer(
              ProtoOperationTransformers.MetadataTransformer.create(OperationMetadata.class))
          .setPollingAlgorithm(
              OperationTimedPollAlgorithm.create(
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<UpdateExtensionBindingRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_0_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_0_params"))
                  .build())
          .setResponseTransformer(
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<DeleteExtensionBindingRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_0_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_0_params"))
                  .build())
          .setResponseTransformer(
