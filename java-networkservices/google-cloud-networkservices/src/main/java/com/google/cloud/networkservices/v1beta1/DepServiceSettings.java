...
public class DepServiceSettings extends ClientSettings<DepServiceSettings> {
  ...
  /** Returns the object with the settings used for calls to listExtensionBindings. */
  public PagedCallSettings<
          ListExtensionBindingsRequest,
          ListExtensionBindingsResponse,
          ListExtensionBindingsPagedResponse>
      listExtensionBindingsSettings() {
    return ((DepServiceStubSettings) getStubSettings()).listExtensionBindingsSettings();
  }

  /** Returns the object with the settings used for calls to getExtensionBinding. */
  public UnaryCallSettings<GetExtensionBindingRequest, ExtensionBinding>
      getExtensionBindingSettings() {
    return ((DepServiceStubSettings) getStubSettings()).getExtensionBindingSettings();
  }

  /** Returns the object with the settings used for calls to createExtensionBinding. */
  public UnaryCallSettings<CreateExtensionBindingRequest, Operation>
      createExtensionBindingSettings() {
    return ((DepServiceStubSettings) getStubSettings()).createExtensionBindingSettings();
  }

  /** Returns the object with the settings used for calls to createExtensionBinding. */
  public OperationCallSettings<CreateExtensionBindingRequest, ExtensionBinding, OperationMetadata>
      createExtensionBindingOperationSettings() {
    return ((DepServiceStubSettings) getStubSettings()).createExtensionBindingOperationSettings();
  }

  /** Returns the object with the settings used for calls to updateExtensionBinding. */
  public UnaryCallSettings<UpdateExtensionBindingRequest, Operation>
      updateExtensionBindingSettings() {
    return ((DepServiceStubSettings) getStubSettings()).updateExtensionBindingSettings();
  }

  /** Returns the object with the settings used for calls to updateExtensionBinding. */
  public OperationCallSettings<UpdateExtensionBindingRequest, ExtensionBinding, OperationMetadata>
      updateExtensionBindingOperationSettings() {
    return ((DepServiceStubSettings) getStubSettings()).updateExtensionBindingOperationSettings();
  }

  /** Returns the object with the settings used for calls to deleteExtensionBinding. */
  public UnaryCallSettings<DeleteExtensionBindingRequest, Operation>
      deleteExtensionBindingSettings() {
    return ((DepServiceStubSettings) getStubSettings()).deleteExtensionBindingSettings();
  }

  /** Returns the object with the settings used for calls to deleteExtensionBinding. */
  public OperationCallSettings<DeleteExtensionBindingRequest, Empty, OperationMetadata>
      deleteExtensionBindingOperationSettings() {
    return ((DepServiceStubSettings) getStubSettings()).deleteExtensionBindingOperationSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<DepServiceSettings, Builder> {
    ...
    /** Returns the builder for the settings used for calls to listExtensionBindings. */
    public PagedCallSettings.Builder<
            ListExtensionBindingsRequest,
            ListExtensionBindingsResponse,
            ListExtensionBindingsPagedResponse>
        listExtensionBindingsSettings() {
      return getStubSettingsBuilder().listExtensionBindingsSettings();
    }

    /** Returns the builder for the settings used for calls to getExtensionBinding. */
    public UnaryCallSettings.Builder<GetExtensionBindingRequest, ExtensionBinding>
        getExtensionBindingSettings() {
      return getStubSettingsBuilder().getExtensionBindingSettings();
    }

    /** Returns the builder for the settings used for calls to createExtensionBinding. */
    public UnaryCallSettings.Builder<CreateExtensionBindingRequest, Operation>
        createExtensionBindingSettings() {
      return getStubSettingsBuilder().createExtensionBindingSettings();
    }
    ...
    public OperationCallSettings.Builder<
        ...
        createExtensionBindingOperationSettings() {
      return getStubSettingsBuilder().createExtensionBindingOperationSettings();
    }

    /** Returns the builder for the settings used for calls to updateExtensionBinding. */
    public UnaryCallSettings.Builder<UpdateExtensionBindingRequest, Operation>
        updateExtensionBindingSettings() {
      return getStubSettingsBuilder().updateExtensionBindingSettings();
    }
    ...
    public OperationCallSettings.Builder<
        ...
        updateExtensionBindingOperationSettings() {
      return getStubSettingsBuilder().updateExtensionBindingOperationSettings();
    }

    /** Returns the builder for the settings used for calls to deleteExtensionBinding. */
    public UnaryCallSettings.Builder<DeleteExtensionBindingRequest, Operation>
        deleteExtensionBindingSettings() {
      return getStubSettingsBuilder().deleteExtensionBindingSettings();
    }

    /** Returns the builder for the settings used for calls to deleteExtensionBinding. */
    public OperationCallSettings.Builder<DeleteExtensionBindingRequest, Empty, OperationMetadata>
        deleteExtensionBindingOperationSettings() {
      return getStubSettingsBuilder().deleteExtensionBindingOperationSettings();
    }
