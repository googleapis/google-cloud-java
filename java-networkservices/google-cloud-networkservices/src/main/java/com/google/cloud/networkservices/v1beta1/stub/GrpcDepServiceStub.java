...
public class GrpcDepServiceStub extends DepServiceStub {
  ...
  private static final MethodDescriptor<ListExtensionBindingsRequest, ListExtensionBindingsResponse>
      listExtensionBindingsMethodDescriptor =
          MethodDescriptor.<ListExtensionBindingsRequest, ListExtensionBindingsResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.networkservices.v1beta1.DepService/ListExtensionBindings")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(ListExtensionBindingsRequest.getDefaultInstance()))
              .setResponseMarshaller(
                  ProtoUtils.marshaller(ListExtensionBindingsResponse.getDefaultInstance()))
              .setSampledToLocalTracing(true)
              .build();

  private static final MethodDescriptor<GetExtensionBindingRequest, ExtensionBinding>
      getExtensionBindingMethodDescriptor =
          MethodDescriptor.<GetExtensionBindingRequest, ExtensionBinding>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.networkservices.v1beta1.DepService/GetExtensionBinding")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(GetExtensionBindingRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(ExtensionBinding.getDefaultInstance()))
              .setSampledToLocalTracing(true)
              .build();

  private static final MethodDescriptor<CreateExtensionBindingRequest, Operation>
      createExtensionBindingMethodDescriptor =
          MethodDescriptor.<CreateExtensionBindingRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.networkservices.v1beta1.DepService/CreateExtensionBinding")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(CreateExtensionBindingRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance()))
              .setSampledToLocalTracing(true)
              .build();

  private static final MethodDescriptor<UpdateExtensionBindingRequest, Operation>
      updateExtensionBindingMethodDescriptor =
          MethodDescriptor.<UpdateExtensionBindingRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.networkservices.v1beta1.DepService/UpdateExtensionBinding")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(UpdateExtensionBindingRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance()))
              .setSampledToLocalTracing(true)
              .build();

  private static final MethodDescriptor<DeleteExtensionBindingRequest, Operation>
      deleteExtensionBindingMethodDescriptor =
          MethodDescriptor.<DeleteExtensionBindingRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
                  "google.cloud.networkservices.v1beta1.DepService/DeleteExtensionBinding")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(DeleteExtensionBindingRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance()))
              .setSampledToLocalTracing(true)
              .build();
    ...
    GrpcCallSettings<DeleteLbRouteExtensionRequest, Operation>
        deleteLbRouteExtensionTransportSettings =
            GrpcCallSettings.<DeleteLbRouteExtensionRequest, Operation>newBuilder()
                ...
                .setResourceNameExtractor(request -> request.getName())
                .build();
    GrpcCallSettings<ListExtensionBindingsRequest, ListExtensionBindingsResponse>
        listExtensionBindingsTransportSettings =
            GrpcCallSettings
                ...
                .setResourceNameExtractor(request -> request.getParent())
                .build();
    GrpcCallSettings<GetExtensionBindingRequest, ExtensionBinding>
        getExtensionBindingTransportSettings =
            GrpcCallSettings.<GetExtensionBindingRequest, ExtensionBinding>newBuilder()
                ...
                .setResourceNameExtractor(request -> request.getName())
                .build();
    GrpcCallSettings<CreateExtensionBindingRequest, Operation>
        createExtensionBindingTransportSettings =
            GrpcCallSettings.<CreateExtensionBindingRequest, Operation>newBuilder()
                ...
                .setResourceNameExtractor(request -> request.getParent())
                .build();
    GrpcCallSettings<UpdateExtensionBindingRequest, Operation>
        updateExtensionBindingTransportSettings =
            GrpcCallSettings.<UpdateExtensionBindingRequest, Operation>newBuilder()
                ...
                .build();
    GrpcCallSettings<DeleteExtensionBindingRequest, Operation>
        deleteExtensionBindingTransportSettings =
            GrpcCallSettings.<DeleteExtensionBindingRequest, Operation>newBuilder()
