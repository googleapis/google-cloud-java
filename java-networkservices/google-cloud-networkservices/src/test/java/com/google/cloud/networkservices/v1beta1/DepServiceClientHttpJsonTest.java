...
import com.google.cloud.networkservices.v1beta1.stub.HttpJsonDepServiceStub;
...
public class DepServiceClientHttpJsonTest {
  ...
  @Test
  public void listExtensionBindingsTest() throws Exception {
    ExtensionBinding responsesElement = ExtensionBinding.newBuilder().build();
    ListExtensionBindingsResponse expectedResponse =
        ListExtensionBindingsResponse.newBuilder()
            .setNextPageToken("")
            .addAllExtensionBindings(Arrays.asList(responsesElement))
            .build();
    mockService.addResponse(expectedResponse);

    LocationName parent = LocationName.of("[PROJECT]", "[LOCATION]");

    ListExtensionBindingsPagedResponse pagedListResponse = client.listExtensionBindings(parent);

    List<ExtensionBinding> resources = Lists.newArrayList(pagedListResponse.iterateAll());

    Assert.assertEquals(1, resources.size());
    Assert.assertEquals(expectedResponse.getExtensionBindingsList().get(0), resources.get(0));
  ...
  @Test
  public void listExtensionBindingsExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
    ...
    try {
      LocationName parent = LocationName.of("[PROJECT]", "[LOCATION]");
      client.listExtensionBindings(parent);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  @Test
  public void listExtensionBindingsTest2() throws Exception {
    ExtensionBinding responsesElement = ExtensionBinding.newBuilder().build();
    ListExtensionBindingsResponse expectedResponse =
        ListExtensionBindingsResponse.newBuilder()
            .setNextPageToken("")
  ...
  @Test
  public void listExtensionBindingsExceptionTest2() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void getExtensionBindingTest() throws Exception {
    ExtensionBinding expectedResponse =
        ExtensionBinding.newBuilder()
            .setName(
                ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]")
                    .toString())
            .setCreateTime(Timestamp.newBuilder().build())
            .setUpdateTime(Timestamp.newBuilder().build())
            .setDescription("description-1724546052")
            .putAllLabels(new HashMap<String, String>())
            .setEtag("etag3123477")
            .setProducerExtension("producerExtension-1015099187")
            .setTarget(ExtensionBinding.Target.newBuilder().build())
            .addAllMatchConditions(new ArrayList<ExtensionBinding.MatchCondition>())
            .setFailOpen(true)
            .putAllProducerMetadata(new HashMap<String, String>())
            .setPriority(-1165461084)
            .build();
    mockService.addResponse(expectedResponse);

    ExtensionBindingName name =
        ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]");

    ExtensionBinding actualResponse = client.getExtensionBinding(name);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void getExtensionBindingExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
    ...
    try {
      ExtensionBindingName name =
          ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]");
      client.getExtensionBinding(name);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  @Test
  public void getExtensionBindingTest2() throws Exception {
    ExtensionBinding expectedResponse =
        ExtensionBinding.newBuilder()
            .setName(
                ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]")
    ...
    String name =
        "projects/project-2755/locations/location-2755/extensionBindings/extensionBinding-2755";
  ...
  @Test
  public void getExtensionBindingExceptionTest2() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void createExtensionBindingTest() throws Exception {
    ExtensionBinding expectedResponse =
        ExtensionBinding.newBuilder()
            .setName(
                ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]")
    ...
    Operation resultOperation =
        Operation.newBuilder()
            .setName("createExtensionBindingTest")
            .setDone(true)
            .setResponse(Any.pack(expectedResponse))
            .build();
    mockService.addResponse(resultOperation);
    ...
    LocationName parent = LocationName.of("[PROJECT]", "[LOCATION]");
    ExtensionBinding extensionBinding = ExtensionBinding.newBuilder().build();
    String extensionBindingId = "extensionBindingId673350913";

    ExtensionBinding actualResponse =
        client.createExtensionBindingAsync(parent, extensionBinding, extensionBindingId).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void createExtensionBindingExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void createExtensionBindingTest2() throws Exception {
    ExtensionBinding expectedResponse =
        ExtensionBinding.newBuilder()
            .setName(
                ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]")
  ...
  @Test
  public void createExtensionBindingExceptionTest2() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void updateExtensionBindingTest() throws Exception {
    ExtensionBinding expectedResponse =
        ExtensionBinding.newBuilder()
            .setName(
                ExtensionBindingName.of("[PROJECT]", "[LOCATION]", "[EXTENSION_BINDING]")
    ...
    Operation resultOperation =
        Operation.newBuilder()
            .setName("updateExtensionBindingTest")
            .setDone(true)
            .setResponse(Any.pack(expectedResponse))
            .build();
    mockService.addResponse(resultOperation);
    ...
    ExtensionBinding actualResponse =
        client.updateExtensionBindingAsync(extensionBinding, updateMask).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void updateExtensionBindingExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void deleteExtensionBindingTest() throws Exception {
    Empty expectedResponse = Empty.newBuilder().build();
    Operation resultOperation =
        Operation.newBuilder()
            .setName("deleteExtensionBindingTest")
            .setDone(true)
            .setResponse(Any.pack(expectedResponse))
            .build();
    mockService.addResponse(resultOperation);
    ...
    client.deleteExtensionBindingAsync(name).get();
  ...
  @Test
  public void deleteExtensionBindingExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void deleteExtensionBindingTest2() throws Exception {
    Empty expectedResponse = Empty.newBuilder().build();
    Operation resultOperation =
        Operation.newBuilder()
            .setName("deleteExtensionBindingTest")
  ...
  @Test
  public void deleteExtensionBindingExceptionTest2() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
