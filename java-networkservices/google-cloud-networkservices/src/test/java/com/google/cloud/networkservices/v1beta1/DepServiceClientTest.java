...
public class DepServiceClientTest {
  ...
  public void listExtensionBindingsTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDepService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListExtensionBindingsRequest actualRequest =
        ((ListExtensionBindingsRequest) actualRequests.get(0));
  ...
  public void getExtensionBindingTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDepService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetExtensionBindingRequest actualRequest = ((GetExtensionBindingRequest) actualRequests.get(0));
  ...
  public void createExtensionBindingTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDepService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    CreateExtensionBindingRequest actualRequest =
        ((CreateExtensionBindingRequest) actualRequests.get(0));

    Assert.assertEquals(parent.toString(), actualRequest.getParent());
    Assert.assertEquals(extensionBinding, actualRequest.getExtensionBinding());
    Assert.assertEquals(extensionBindingId, actualRequest.getExtensionBindingId());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void updateExtensionBindingTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDepService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    UpdateExtensionBindingRequest actualRequest =
        ((UpdateExtensionBindingRequest) actualRequests.get(0));
  ...
  public void deleteExtensionBindingTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDepService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    DeleteExtensionBindingRequest actualRequest =
        ((DeleteExtensionBindingRequest) actualRequests.get(0));
