...
public class LbEdgeExtensionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_LB_EDGE_EXTENSION =
  ...
  protected LbEdgeExtensionName() {
    project = null;
    location = null;
    lbEdgeExtension = null;
  }

  private LbEdgeExtensionName(Builder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
    lbEdgeExtension = Preconditions.checkNotNull(builder.getLbEdgeExtension());
  }
  ...
  public static @Nullable LbEdgeExtensionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_LB_EDGE_EXTENSION.validatedMatch(
            formattedString, "LbEdgeExtensionName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("lb_edge_extension"));
  }

  public static List<LbEdgeExtensionName> parseList(List<String> formattedStrings) {
    List<LbEdgeExtensionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable LbEdgeExtensionName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (lbEdgeExtension != null) {
            fieldMapBuilder.put("lb_edge_extension", lbEdgeExtension);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_LB_EDGE_EXTENSION.instantiate(
        "project", project, "location", location, "lb_edge_extension", lbEdgeExtension);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.lbEdgeExtension, that.lbEdgeExtension);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(lbEdgeExtension);
    return h;
  }

  /** Builder for projects/{project}/locations/{location}/lbEdgeExtensions/{lb_edge_extension}. */
