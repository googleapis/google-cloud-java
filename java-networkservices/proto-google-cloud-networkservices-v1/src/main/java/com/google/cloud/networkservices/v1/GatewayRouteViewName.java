...
public class GatewayRouteViewName implements ResourceName {
  ...
  public static @Nullable GatewayRouteViewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GatewayRouteViewName> values) {
