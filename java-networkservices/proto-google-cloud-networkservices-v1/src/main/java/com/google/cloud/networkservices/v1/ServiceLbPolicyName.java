...
public class ServiceLbPolicyName implements ResourceName {
  ...
  public static @Nullable ServiceLbPolicyName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ServiceLbPolicyName> values) {
