...
public class LbRouteExtensionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_LB_ROUTE_EXTENSION =
  ...
  protected LbRouteExtensionName() {
    project = null;
    location = null;
    lbRouteExtension = null;
  }

  private LbRouteExtensionName(Builder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
    lbRouteExtension = Preconditions.checkNotNull(builder.getLbRouteExtension());
  }
  ...
  public static @Nullable LbRouteExtensionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_LB_ROUTE_EXTENSION.validatedMatch(
            formattedString, "LbRouteExtensionName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("lb_route_extension"));
  }

  public static List<LbRouteExtensionName> parseList(List<String> formattedStrings) {
    List<LbRouteExtensionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable LbRouteExtensionName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (lbRouteExtension != null) {
            fieldMapBuilder.put("lb_route_extension", lbRouteExtension);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_LB_ROUTE_EXTENSION.instantiate(
        "project", project, "location", location, "lb_route_extension", lbRouteExtension);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.lbRouteExtension, that.lbRouteExtension);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(lbRouteExtension);
    return h;
  }

  /** Builder for projects/{project}/locations/{location}/lbRouteExtensions/{lb_route_extension}. */
