...
public class AsyncUpdateExtensionBinding {

  public static void main(String[] args) throws Exception {
    asyncUpdateExtensionBinding();
  }

  public static void asyncUpdateExtensionBinding() throws Exception {
    ...
    try (DepServiceClient depServiceClient = DepServiceClient.create()) {
      ...
      ApiFuture<Operation> future =
          depServiceClient.updateExtensionBindingCallable().futureCall(request);
      // Do something.
