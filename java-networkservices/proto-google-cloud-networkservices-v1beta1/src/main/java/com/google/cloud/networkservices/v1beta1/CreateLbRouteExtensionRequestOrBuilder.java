...
public interface CreateLbRouteExtensionRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkservices.v1beta1.CreateLbRouteExtensionRequest)
   ...
   *
   * <code>
   * .google.cloud.networkservices.v1beta1.LbRouteExtension lb_route_extension = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.networkservices.v1beta1.LbRouteExtension getLbRouteExtension();
   ...
   * </code>
   */
  com.google.cloud.networkservices.v1beta1.LbRouteExtensionOrBuilder getLbRouteExtensionOrBuilder();
