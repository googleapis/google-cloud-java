...
public interface LbTrafficExtensionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkservices.v1beta1.LbTrafficExtension)
   ...
   *
   * <code>
   * repeated .google.cloud.networkservices.v1beta1.ExtensionChain extension_chains = 7 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   */
  java.util.List<com.google.cloud.networkservices.v1beta1.ExtensionChain> getExtensionChainsList();
   ...
   * </code>
   */
  com.google.cloud.networkservices.v1beta1.ExtensionChain getExtensionChains(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.networkservices.v1beta1.ExtensionChainOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.networkservices.v1beta1.ExtensionChainOrBuilder getExtensionChainsOrBuilder(
      int index);
   ...
   *
   * <code>
   * .google.cloud.networkservices.v1beta1.LoadBalancingScheme load_balancing_scheme = 8 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.networkservices.v1beta1.LoadBalancingScheme getLoadBalancingScheme();
}
