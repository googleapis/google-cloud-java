...
public interface CreateEndpointPolicyRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkservices.v1beta1.CreateEndpointPolicyRequest)
   ...
   *
   * <code>
   * .google.cloud.networkservices.v1beta1.EndpointPolicy endpoint_policy = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
