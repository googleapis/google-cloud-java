...
```Groovy
compile 'com.google.cloud:google-cloud-bigquerydatatransfer:0.96.0-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigquerydatatransfer" % "0.96.0-beta"
```
