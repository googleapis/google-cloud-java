...
public final class ListTransferLogsRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ListTransferLogsRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList messageTypes_ = emptyIntList();
  ...
  public com.google.cloud.bigquery.datatransfer.v1.TransferMessage.MessageSeverity getMessageTypes(
      int index) {
    return messageTypes_converter_.convert(messageTypes_.getInt(index));
  }
  ...
  public int getMessageTypesValue(int index) {
    return messageTypes_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < messageTypes_.size(); i++) {
      output.writeEnumNoTag(messageTypes_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < messageTypes_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(messageTypes_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            ...
            case 50:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  messageTypes_.addInt(input.readEnum());
                }
    ...
    private void ensureMessageTypesIsMutable() {
      if (!messageTypes_.isModifiable()) {
        messageTypes_ = makeMutableCopy(messageTypes_);
      }
      bitField0_ |= 0x00000008;
    }
    ...
    public Builder setMessageTypes(
      ...
      ensureMessageTypesIsMutable();
      messageTypes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addMessageTypes(
      ...
      ensureMessageTypesIsMutable();
      messageTypes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setMessageTypesValue(int index, int value) {
      ensureMessageTypesIsMutable();
      messageTypes_.setInt(index, value);
      onChanged();
      return this;
    }
