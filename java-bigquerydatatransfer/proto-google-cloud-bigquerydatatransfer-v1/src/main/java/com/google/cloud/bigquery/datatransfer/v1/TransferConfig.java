...
public final class TransferConfig extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 226:
            {
              com.google.cloud.bigquery.datatransfer.v1.EncryptionConfiguration.Builder subBuilder =
                  null;
              if (encryptionConfiguration_ != null) {
                subBuilder = encryptionConfiguration_.toBuilder();
              }
              encryptionConfiguration_ =
                  input.readMessage(
                      com.google.cloud.bigquery.datatransfer.v1.EncryptionConfiguration.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(encryptionConfiguration_);
                encryptionConfiguration_ = subBuilder.buildPartial();
              }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public com.google.cloud.bigquery.datatransfer.v1.TransferConfig buildPartial() {
      ...
      if (encryptionConfigurationBuilder_ == null) {
        result.encryptionConfiguration_ = encryptionConfiguration_;
      } else {
        result.encryptionConfiguration_ = encryptionConfigurationBuilder_.build();
      }
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.bigquery.datatransfer.v1.TransferConfig) e.getUnfinishedMessage();
     ...
     */
    public boolean hasEncryptionConfiguration() {
      return encryptionConfigurationBuilder_ != null || encryptionConfiguration_ != null;
    }
    /**
     *
     *
