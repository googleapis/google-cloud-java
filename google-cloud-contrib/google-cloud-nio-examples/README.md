...
4.    Run the sample with:
    ...
    ```
    java -cp google-cloud-contrib/google-cloud-nio-examples/target/google-cloud-nio-examples-0.21.2-alpha-SNAPSHOT.jar com.google.cloud.nio.examples.ListFilesystems
    ```
