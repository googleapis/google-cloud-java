...
public final class AMLGrpc {
  ...
  public static AMLBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AMLBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AMLBlockingV2Stub>() {
          @java.lang.Override
          public AMLBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new AMLBlockingV2Stub(channel, callOptions);
          }
        };
    return AMLBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class AMLBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<AMLBlockingV2Stub> {
    private AMLBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected AMLBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new AMLBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service AML.
   *
   * <pre>
   * The AML (Anti Money Laundering) service allows users to perform REST
   * operations on aml.
