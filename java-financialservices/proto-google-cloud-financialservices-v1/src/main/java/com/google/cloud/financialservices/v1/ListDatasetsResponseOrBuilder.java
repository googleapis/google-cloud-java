...
public interface ListDatasetsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.financialservices.v1.ListDatasetsResponse)
   ...
   * <code>repeated .google.cloud.financialservices.v1.Dataset datasets = 1;</code>
   */
  com.google.cloud.financialservices.v1.DatasetOrBuilder getDatasetsOrBuilder(int index);
