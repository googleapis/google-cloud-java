...
public class BacktestResultName implements ResourceName {
  private static final PathTemplate PROJECT_NUM_LOCATION_INSTANCE_BACKTEST_RESULT =
  ...
  private BacktestResultName(Builder builder) {
    ...
    backtestResult = Preconditions.checkNotNull(builder.getBacktestResult());
  }
  ...
  public static BacktestResultName of(
      String projectNum, String location, String instance, String backtestResult) {
    return newBuilder()
  ...
  public static @Nullable BacktestResultName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_NUM_LOCATION_INSTANCE_BACKTEST_RESULT.validatedMatch(
            formattedString, "BacktestResultName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project_num"),
        matchMap.get("location"),
        matchMap.get("instance"),
        matchMap.get("backtest_result"));
  }

  public static List<BacktestResultName> parseList(List<String> formattedStrings) {
    List<BacktestResultName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable BacktestResultName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (backtestResult != null) {
            fieldMapBuilder.put("backtest_result", backtestResult);
          }
  ...
  public String toString() {
    return PROJECT_NUM_LOCATION_INSTANCE_BACKTEST_RESULT.instantiate(
        "project_num",
        projectNum,
        "location",
        location,
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.projectNum, that.projectNum)
          ...
          && Objects.equals(this.backtestResult, that.backtestResult);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(backtestResult);
    return h;
  }
