...
public interface UpdateModelRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.financialservices.v1.UpdateModelRequest)
   ...
   *
   * <code>
   * .google.cloud.financialservices.v1.Model model = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
