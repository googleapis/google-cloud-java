...
public class ModelName implements ResourceName {
  private static final PathTemplate PROJECT_NUM_LOCATION_INSTANCE_MODEL =
  ...
  public static @Nullable ModelName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_NUM_LOCATION_INSTANCE_MODEL.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable ModelName> values) {
  ...
  public String toString() {
    return PROJECT_NUM_LOCATION_INSTANCE_MODEL.instantiate(
        "project_num", projectNum, "location", location, "instance", instance, "model", model);
  }
  ...
  /**
   * Builder for projects/{project_num}/locations/{location}/instances/{instance}/models/{model}.
   */
