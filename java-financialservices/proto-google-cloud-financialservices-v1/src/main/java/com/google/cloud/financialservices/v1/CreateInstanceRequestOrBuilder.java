...
public interface CreateInstanceRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.financialservices.v1.CreateInstanceRequest)
   ...
   *
   * <code>
   * .google.cloud.financialservices.v1.Instance instance = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   * @return The instance.
   */
  com.google.cloud.financialservices.v1.Instance getInstance();
   ...
   * </code>
   */
  com.google.cloud.financialservices.v1.InstanceOrBuilder getInstanceOrBuilder();
