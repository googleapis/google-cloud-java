...
import com.google.cloud.financialservices.v1.AMLGrpc.AMLImplBase;
...
public class MockAMLImpl extends AMLImplBase {
  ...
  public void importRegisteredParties(
      ImportRegisteredPartiesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void exportRegisteredParties(
      ExportRegisteredPartiesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  @Override
  public void updateModel(UpdateModelRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void exportModelMetadata(
      ExportModelMetadataRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ExportModelMetadata, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void listEngineConfigs(
      ...
      StreamObserver<ListEngineConfigsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListEngineConfigsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListEngineConfigsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListEngineConfigs, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListEngineConfigsResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void getEngineConfig(
      GetEngineConfigRequest request, StreamObserver<EngineConfig> responseObserver) {
    Object response = responses.poll();
    if (response instanceof EngineConfig) {
      requests.add(request);
      responseObserver.onNext(((EngineConfig) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetEngineConfig, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void createEngineConfig(
      CreateEngineConfigRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateEngineConfig, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void updateEngineConfig(
      UpdateEngineConfigRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UpdateEngineConfig, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void exportEngineConfigMetadata(
      ExportEngineConfigMetadataRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deleteEngineConfig(
      DeleteEngineConfigRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteEngineConfig, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void getEngineVersion(
      GetEngineVersionRequest request, StreamObserver<EngineVersion> responseObserver) {
    Object response = responses.poll();
    if (response instanceof EngineVersion) {
      requests.add(request);
      responseObserver.onNext(((EngineVersion) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetEngineVersion, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  EngineVersion.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void listEngineVersions(
      ...
      StreamObserver<ListEngineVersionsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListEngineVersionsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListEngineVersionsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListEngineVersions, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListEngineVersionsResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void listPredictionResults(
      ...
      StreamObserver<ListPredictionResultsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListPredictionResultsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListPredictionResultsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void getPredictionResult(
      GetPredictionResultRequest request, StreamObserver<PredictionResult> responseObserver) {
    Object response = responses.poll();
    if (response instanceof PredictionResult) {
      requests.add(request);
      responseObserver.onNext(((PredictionResult) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetPredictionResult, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  PredictionResult.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void createPredictionResult(
      CreatePredictionResultRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void updatePredictionResult(
      UpdatePredictionResultRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void exportPredictionResultMetadata(
      ExportPredictionResultMetadataRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deletePredictionResult(
      DeletePredictionResultRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void listBacktestResults(
      ...
      StreamObserver<ListBacktestResultsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListBacktestResultsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListBacktestResultsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListBacktestResults, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListBacktestResultsResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void getBacktestResult(
      GetBacktestResultRequest request, StreamObserver<BacktestResult> responseObserver) {
    Object response = responses.poll();
    if (response instanceof BacktestResult) {
      requests.add(request);
      responseObserver.onNext(((BacktestResult) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetBacktestResult, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  BacktestResult.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void createBacktestResult(
      CreateBacktestResultRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void updateBacktestResult(
      UpdateBacktestResultRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void exportBacktestResultMetadata(
      ExportBacktestResultMetadataRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deleteBacktestResult(
      DeleteBacktestResultRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
