...
public interface OperationMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1beta.OperationMetadata)
   ...
   *
   * <code>
   * .google.cloud.alloydb.v1beta.BatchCreateInstancesMetadata batch_create_instances_metadata = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
  ...
  com.google.cloud.alloydb.v1beta.OperationMetadata.RequestSpecificCase getRequestSpecificCase();
}
