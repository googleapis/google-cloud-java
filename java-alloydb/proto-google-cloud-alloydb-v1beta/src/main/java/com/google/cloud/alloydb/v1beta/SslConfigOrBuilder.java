...
public interface SslConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1beta.SslConfig)
   ...
   * @return The sslMode.
   */
  com.google.cloud.alloydb.v1beta.SslConfig.SslMode getSslMode();
   ...
   * @return The caSource.
   */
  com.google.cloud.alloydb.v1beta.SslConfig.CaSource getCaSource();
}
