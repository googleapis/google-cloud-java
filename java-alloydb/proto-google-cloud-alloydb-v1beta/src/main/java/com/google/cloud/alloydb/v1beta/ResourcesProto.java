  ...
  static {
    java.lang.String[] descriptorData = {
      "\n+google/cloud/alloydb/v1beta/resources."
          ...
          + "\001 \001(\tB\003\340A\003\022\017\n\002id\030\002 \001(\tB\003\340A\003\022\017\n\002ip\030\003 \001(\tB"
          + "\003\340A\003\022\022\n\005state\030\004 \001(\tB\003\340A\003\032\372\001\n\033QueryInsigh"
          + "tsInstanceConfig\022$\n\027record_application_t"
          + "ags\030\002 \001(\010H\000\210\001\001\022\"\n\025record_client_address\030"
          + "\003 \001(\010H\001\210\001\001\022\033\n\023query_string_length\030\004 \001(\r\022"
          + "#\n\026query_plans_per_minute\030\005 \001(\rH\002\210\001\001B\032\n\030"
          + "_record_application_tagsB\030\n\026_record_clie"
          + "nt_addressB\031\n\027_query_plans_per_minute\032\254\004"
          + "\n\033ObservabilityInstanceConfig\022\024\n\007enabled"
          + "\030\001 \001(\010H\000\210\001\001\022\036\n\021preserve_comments\030\002 \001(\010H\001"
          + "\210\001\001\022\036\n\021track_wait_events\030\003 \001(\010H\002\210\001\001\022(\n\026t"
          + "rack_wait_event_types\030\004 \001(\010B\003\340A\003H\003\210\001\001\022$\n"
          + "\027max_query_string_length\030\005 \001(\005H\004\210\001\001\022$\n\027r"
          + "ecord_application_tags\030\006 \001(\010H\005\210\001\001\022#\n\026que"
          + "ry_plans_per_minute\030\007 \001(\005H\006\210\001\001\022!\n\024track_"
          + "active_queries\030\010 \001(\010H\007\210\001\001\022!\n\024track_clien"
          + "t_address\030\t \001(\010H\010\210\001\001B\n\n\010_enabledB\024\n\022_pre"
          + "serve_commentsB\024\n\022_track_wait_eventsB\031\n\027"
          + "_track_wait_event_typesB\032\n\030_max_query_st"
          + "ring_lengthB\032\n\030_record_application_tagsB"
          + "\031\n\027_query_plans_per_minuteB\027\n\025_track_act"
          + "ive_queriesB\027\n\025_track_client_address\032$\n\016"
          + "ReadPoolConfig\022\022\n\nnode_count\030\001 \001(\005\032\221\001\n\014U"
          + "pdatePolicy\022E\n\004mode\030\001 \001(\01627.google.cloud"
          + ".alloydb.v1beta.Instance.UpdatePolicy.Mo"
          + "de\":\n\004Mode\022\024\n\020MODE_UNSPECIFIED\020\000\022\013\n\007DEFA"
          + "ULT\020\001\022\017\n\013FORCE_APPLY\020\002\032z\n\026ClientConnecti"
          + "onConfig\022\037\n\022require_connectors\030\001 \001(\010B\003\340A"
          + "\001\022?\n\nssl_config\030\002 \001(\0132&.google.cloud.all"
          + "oydb.v1beta.SslConfigB\003\340A\001\032|\n\021PscInstanc"
          + "eConfig\022$\n\027service_attachment_link\030\001 \001(\t"
          + "B\003\340A\003\022&\n\031allowed_consumer_projects\030\002 \003(\t"
          + "B\003\340A\001\022\031\n\014psc_dns_name\030\007 \001(\tB\003\340A\003\032\213\002\n\025Ins"
          + "tanceNetworkConfig\022x\n\034authorized_externa"
          + "l_networks\030\001 \003(\0132M.google.cloud.alloydb."
          + "v1beta.Instance.InstanceNetworkConfig.Au"
          + "thorizedNetworkB\003\340A\001\022\035\n\020enable_public_ip"
          + "\030\002 \001(\010B\003\340A\001\022&\n\031enable_outbound_public_ip"
          + "\030\003 \001(\010B\003\340A\001\0321\n\021AuthorizedNetwork\022\034\n\ncidr"
          + "_range\030\001 \001(\tB\010\342\214\317\327\010\002\010\002\032-\n\013LabelsEntry\022\013\n"
          ...
          + "G\020\t\"X\n\014InstanceType\022\035\n\031INSTANCE_TYPE_UNS"
          + "PECIFIED\020\000\022\013\n\007PRIMARY\020\001\022\r\n\tREAD_POOL\020\002\022\r"
          + "\n\tSECONDARY\020\003\"N\n\020AvailabilityType\022!\n\035AVA"
          + "ILABILITY_TYPE_UNSPECIFIED\020\000\022\t\n\005ZONAL\020\001\022"
          + "\014\n\010REGIONAL\020\002:\216\001\352A\212\001\n\037alloydb.googleapis"
          + ".com/Instance\022Oprojects/{project}/locati"
          + "ons/{location}/clusters/{cluster}/instan"
          + "ces/{instance}*\tinstances2\010instanceR\001\001\"\352"
          + "\002\n\016ConnectionInfo\022\014\n\004name\030\001 \001(\t\022\027\n\nip_ad"
          + "dress\030\002 \001(\tB\003\340A\003\022&\n\021public_ip_address\030\005 "
          + "\001(\tB\013\340A\003\342\214\317\327\010\002\010\002\022$\n\025pem_certificate_chai"
          + "n\030\003 \003(\tB\005\030\001\340A\003\022\031\n\014instance_uid\030\004 \001(\tB\003\340A"
          + "\003\022\031\n\014psc_dns_name\030\006 \001(\tB\003\340A\003:\254\001\352A\250\001\n%all"
          + "oydb.googleapis.com/ConnectionInfo\022^proj"
          + "ects/{project}/locations/{location}/clus"
          + "ters/{cluster}/instances/{instance}/conn"
          + "ectionInfo*\017connectionInfos2\016connectionI"
          + "nfo\"\350\014\n\006Backup\022\021\n\004name\030\001 \001(\tB\003\340A\003\022\024\n\014dis"
          ...
          + "abels\030\006 \003(\0132/.google.cloud.alloydb.v1bet"
          + "a.Backup.LabelsEntry\022=\n\005state\030\007 \001(\0162).go"
          + "ogle.cloud.alloydb.v1beta.Backup.StateB\003"
          + "\340A\003\0226\n\004type\030\010 \001(\0162(.google.cloud.alloydb"
          + ".v1beta.Backup.Type\022\023\n\013description\030\t \001(\t"
          + "\022\030\n\013cluster_uid\030\022 \001(\tB\003\340A\003\022<\n\014cluster_na"
          + "me\030\n \001(\tB&\340A\002\372A \n\036alloydb.googleapis.com"
          + "/Cluster\022\030\n\013reconciling\030\013 \001(\010B\003\340A\003\022M\n\021en"
          + "cryption_config\030\014 \001(\0132-.google.cloud.all"
          + "oydb.v1beta.EncryptionConfigB\003\340A\001\022I\n\017enc"
          + "ryption_info\030\r \001(\0132+.google.cloud.alloyd"
          + "b.v1beta.EncryptionInfoB\003\340A\003\022\014\n\004etag\030\016 \001"
          + "(\t\022I\n\013annotations\030\020 \003(\01324.google.cloud.a"
          + "lloydb.v1beta.Backup.AnnotationsEntry\022\027\n"
          ...
          + "expiry_quantity\030\024 \001(\01327.google.cloud.all"
          + "oydb.v1beta.Backup.QuantityBasedExpiryB\003"
          + "\340A\003\022\032\n\rsatisfies_pzs\030\025 \001(\010B\003\340A\003\022K\n\020datab"
          + "ase_version\030\026 \001(\0162,.google.cloud.alloydb"
          + ".v1beta.DatabaseVersionB\003\340A\003\022F\n\004tags\030\031 \003"
          + "(\0132-.google.cloud.alloydb.v1beta.Backup."
          + "TagsEntryB\t\340A\004\340A\005\340A\001\032W\n\023QuantityBasedExp"
          + "iry\022\034\n\017retention_count\030\001 \001(\005B\003\340A\003\022\"\n\025tot"
          + "al_retention_count\030\002 \001(\005B\003\340A\003\032-\n\013LabelsE"
          + "ntry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001\0322\n\020"
          ...
          + "location}/backups/{backup}*\007backups2\006bac"
          + "kupR\001\001\"\211\007\n\025SupportedDatabaseFlag\022d\n\023stri"
          + "ng_restrictions\030\007 \001(\0132E.google.cloud.all"
          + "oydb.v1beta.SupportedDatabaseFlag.String"
          + "RestrictionsH\000\022f\n\024integer_restrictions\030\010"
          + " \001(\0132F.google.cloud.alloydb.v1beta.Suppo"
          + "rtedDatabaseFlag.IntegerRestrictionsH\000\022\014"
          + "\n\004name\030\001 \001(\t\022\021\n\tflag_name\030\002 \001(\t\022P\n\nvalue"
          + "_type\030\003 \001(\0162<.google.cloud.alloydb.v1bet"
          + "a.SupportedDatabaseFlag.ValueType\022\037\n\027acc"
          + "epts_multiple_values\030\004 \001(\010\022K\n\025supported_"
          + "db_versions\030\005 \003(\0162,.google.cloud.alloydb"
          + ".v1beta.DatabaseVersion\022\033\n\023requires_db_r"
          + "estart\030\006 \001(\010\032,\n\022StringRestrictions\022\026\n\016al"
          + "lowed_values\030\001 \003(\t\032u\n\023IntegerRestriction"
          + "s\022.\n\tmin_value\030\001 \001(\0132\033.google.protobuf.I"
          + "nt64Value\022.\n\tmax_value\030\002 \001(\0132\033.google.pr"
          + "otobuf.Int64Value\"U\n\tValueType\022\032\n\026VALUE_"
          ...
          + "lags/{flag}*\026supportedDatabaseFlags2\025sup"
          + "portedDatabaseFlagB\016\n\014restrictions\"\376\002\n\004U"
          + "ser\022\021\n\004name\030\001 \001(\tB\003\340A\003\022\025\n\010password\030\002 \001(\t"
          + "B\003\340A\004\022\033\n\016database_roles\030\004 \003(\tB\003\340A\001\022B\n\tus"
          + "er_type\030\005 \001(\0162*.google.cloud.alloydb.v1b"
          + "eta.User.UserTypeB\003\340A\001\022\035\n\020keep_extra_rol"
          + "es\030\006 \001(\010B\003\340A\004\"Q\n\010UserType\022\031\n\025USER_TYPE_U"
          + "NSPECIFIED\020\000\022\024\n\020ALLOYDB_BUILT_IN\020\001\022\024\n\020AL"
          + "LOYDB_IAM_USER\020\002:y\352Av\n\033alloydb.googleapi"
          + "s.com/User\022Gprojects/{project}/locations"
          + "/{location}/clusters/{cluster}/users/{us"
          + "er}*\005users2\004userR\001\001\"\334\001\n\010Database\022\021\n\004name"
          + "\030\001 \001(\tB\003\340A\010\022\024\n\007charset\030\002 \001(\tB\003\340A\001\022\026\n\tcol"
          + "lation\030\003 \001(\tB\003\340A\001:\216\001\352A\212\001\n\037alloydb.google"
          + "apis.com/Database\022Oprojects/{project}/lo"
          + "cations/{location}/clusters/{cluster}/da"
          + "tabases/{database}*\tdatabases2\010databaseR"
          + "\001\001*^\n\014InstanceView\022\035\n\031INSTANCE_VIEW_UNSP"
          + "ECIFIED\020\000\022\027\n\023INSTANCE_VIEW_BASIC\020\001\022\026\n\022IN"
          + "STANCE_VIEW_FULL\020\002*g\n\013ClusterView\022\034\n\030CLU"
          + "STER_VIEW_UNSPECIFIED\020\000\022\026\n\022CLUSTER_VIEW_"
          + "BASIC\020\001\022\"\n\036CLUSTER_VIEW_CONTINUOUS_BACKU"
          ...
          + "TION_TYPE_UNSPECIFIED\020\000\022\014\n\010STANDARD\020\001\022\t\n"
          + "\005TRIAL\020\002B\306\003\n\037com.google.cloud.alloydb.v1"
          + "betaB\016ResourcesProtoP\001Z9cloud.google.com"
          + "/go/alloydb/apiv1beta/alloydbpb;alloydbp"
          + "b\252\002\033Google.Cloud.AlloyDb.V1Beta\312\002\033Google"
          + "\\Cloud\\AlloyDb\\V1beta\352\002\036Google::Cloud::A"
          + "lloyDB::V1beta\352A\246\001\n(cloudkms.googleapis."
          + "com/CryptoKeyVersion\022zprojects/{project}"
          + "/locations/{location}/keyRings/{key_ring"
          + "}/cryptoKeys/{crypto_key}/cryptoKeyVersi"
          + "ons/{crypto_key_version}\352AN\n\036compute.goo"
