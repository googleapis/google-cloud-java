  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\036alloydb.googleapis.com/Cluster\022:projects/{project}/locations/{location}/"
          + "clusters/{cluster}*\010clusters2\007clusterR\001\001B\010\n"
          + "\006source\"\315\037\n"
          + "\010Instance\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\024\n"
          + "\014display_name\030\002 \001(\t\022\020\n"
          ...
          + "2.google.cloud.alloydb.v1beta.Instance.InstanceTypeB\003\340A\002\022K\n"
          ...
          + "26.google.cloud.alloydb.v1beta.Instance.AvailabilityType\022\020\n"
          ...
          + "\024observability_config\030\032 \001(\0132A.google.cloud.allo"
          + "ydb.v1beta.Instance.ObservabilityInstanceConfig\022N\n"
          + "\020read_pool_config\030\016 \001(\01324.goog"
          + "le.cloud.alloydb.v1beta.Instance.ReadPoolConfig\022\027\n\n"
          ...
          + "\030client_connection_config\030\027 \001(\0132<.google.cloud.alloyd"
          + "b.v1beta.Instance.ClientConnectionConfigB\003\340A\001\022\032\n\r"
          + "satisfies_pzs\030\030 \001(\010B\003\340A\003\022Y\n"
          + "\023psc_instance_config\030\034 \001(\01327.google.cloud.al"
          + "loydb.v1beta.Instance.PscInstanceConfigB\003\340A\001\022X\n"
          + "\016network_config\030\035 \001(\0132;.google.cl"
          + "oud.alloydb.v1beta.Instance.InstanceNetworkConfigB\003\340A\001\022M\n\r"
          + "gemini_config\030! \001(\01321."
          + "google.cloud.alloydb.v1beta.GeminiInstanceConfigB\003\340A\001\0221\n"
          ...
          + "\0132&.google.cloud.alloydb.v1beta.SslConfigB\003\340A\001\032|\n"
          ...
          + "anceNetworkConfig.AuthorizedNetworkB\003\340A\001\022\035\n"
          ...
          + "cts/{project}/locations/{location}/clusters/{cluster}/instances/{instance}*"
          ...
          + "%alloydb.googleapis.com/ConnectionInfo\022^projects/{project}/locat"
          + "ions/{location}/clusters/{cluster}/insta"
          + "nces/{instance}/connectionInfo*\017connectionInfos2\016connectionInfo\"\350\014\n"
          + "\006Backup\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\024\n"
          + "\014display_name\030\002 \001(\t\022\020\n"
          + "\003uid\030\003 \001(\tB\003\340A\003\0224\n"
          ...
          + "\0132-.google.cloud.alloydb.v1beta.EncryptionConfigB\003\340A\001\022I\n"
          ...
          + "\01327.google.cloud.alloydb.v1beta.Backup.QuantityBasedExpiryB\003\340A\003\022\032\n\r"
          + "satisfies_pzs\030\025 \001(\010B\003\340A\003\022K\n"
          + "\020database_version\030\026 \001(\0162,."
          + "google.cloud.alloydb.v1beta.DatabaseVersionB\003\340A\003\022F\n"
          ...
          + "project}/locations/{location}/backups/{backup}*\007backups2\006backupR\001\001\"\211\007\n"
          + "\025SupportedDatabaseFlag\022d\n"
          + "\023string_restrictions\030\007 \001("
          + "\0132E.google.cloud.alloydb.v1beta.SupportedDatabaseFlag.StringRestrictionsH\000\022f\n"
          + "\024integer_restrictions\030\010 \001(\0132F.google.cloud."
          + "alloydb.v1beta.SupportedDatabaseFlag.IntegerRestrictionsH\000\022\014\n"
          + "\004name\030\001 \001(\t\022\021\n"
          + "\tflag_name\030\002 \001(\t\022P\n\n"
          + "value_type\030\003 \001(\0162<.google"
          + ".cloud.alloydb.v1beta.SupportedDatabaseFlag.ValueType\022\037\n"
          + "\027accepts_multiple_values\030\004 \001(\010\022K\n"
          + "\025supported_db_versions\030\005 \003(\0162,."
          + "google.cloud.alloydb.v1beta.DatabaseVersion\022\033\n"
          ...
          + ",alloydb.googleapis.com/SupportedDatabaseFlag\0224projects/{project}/lo"
          ...
          + "le.cloud.alloydb.v1beta.User.UserTypeB\003\340A\001\022\035\n"
          ...
          + "/{cluster}/users/{user}*\005users2\004userR\001\001\"\334\001\n"
          + "\010Database\022\021\n"
          ...
          + "rojects/{project}/locations/{location}/clusters/{cluster}/databases/{database}*"
          ...
          + "\037com.google.cloud.alloydb.v1betaB\016ResourcesProto"
          + "P\001Z9cloud.google.com/go/alloydb/apiv1bet"
          + "a/alloydbpb;alloydbpb\252\002\033Google.Cloud.All"
          + "oyDb.V1Beta\312\002\033Google\\Cloud\\AlloyDb\\V1beta\352\002\036Google::Cloud::AlloyDB::V1beta\352A\246\001\n"
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022zprojects/{project}/locations/{location"
          + "}/keyRings/{key_ring}/cryptoKeys/{crypto"
          + "_key}/cryptoKeyVersions/{crypto_key_version}\352AN\n"
