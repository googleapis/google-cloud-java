  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " \001(\01323.google.cloud.alloydb.v1beta.Cluster.DataplexConfigB\003\340A\001\032i\n\r"
          + "NetworkConfig\0227\n"
          ...
          + "instance_type\030\t \001(\01622.google.cloud."
          + "alloydb.v1beta.Instance.InstanceTypeB\003\340A\002\022K\n"
          ...
          + "\016network_config\030\035 \001(\0132;.google.cloud.alloydb.v1b"
          + "eta.Instance.InstanceNetworkConfigB\003\340A\001\022O\n\r"
          + "gemini_config\030! \001(\01321.google.cloud.al"
          + "loydb.v1beta.GeminiInstanceConfigB\005\030\001\340A\001\0221\n"
          + "\034outbound_public_ip_addresses\030\" \003("
          + "\tB\013\340A\003\342\214\317\327\010\002\010\002\022V\n"
          + "\021activation_policy\030# \001(\01626"
          + ".google.cloud.alloydb.v1beta.Instance.ActivationPolicyB\003\340A\001\022_\n"
          + "\026connection_pool_config\030%"
          + " \001(\0132:.google.cloud.alloydb.v1beta.Instance.ConnectionPoolConfigB\003\340A\001\022G\n\n"
          + "gca_config\030&"
          ...
          + "\024psc_auto_connections\030\t \003(\0132=.google.cloud.alloyd"
          + "b.v1beta.Instance.PscAutoConnectionConfigB\003\340A\001\032\356\002\n"
          + "\025InstanceNetworkConfig\022x\n"
          + "\034authorized_external_networks\030\001 \003(\0132M.google."
          + "cloud.alloydb.v1beta.Instance.InstanceNetworkConfig.AuthorizedNetworkB\003\340A\001\022\035\n"
          ...
          + "\005flags\030\r"
          + " \003(\0132E."
          + "google.cloud.alloydb.v1beta.Instance.ConnectionPoolConfig.FlagsEntryB\003\340A\001\022\031\n"
          ...
          + "nnectionInfo*\017connectionInfos2\016connectionInfo\"\251\r\n"
          + "\006Backup\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\024\n"
          + "\014display_name\030\002 \001(\t\022\020\n"
          + "\003uid\030\003 \001(\tB\003\340A\003\0224\n"
          ...
          + "\035alloydb.googleapis.com/Backup\0228pro"
          + "jects/{project}/locations/{location}/backups/{backup}*\007backups2\006backupR\001\001\"\220"
          + "\t\n"
          + "\025SupportedDatabaseFlag\022d\n"
          + "\023string_restrictions\030\007 \001(\0132E.google.cloud.alloydb.v1beta.S"
          + "upportedDatabaseFlag.StringRestrictionsH\000\022f\n"
          ...
          + "value_type\030\003 \001(\0162<.google.cloud.allo"
          + "ydb.v1beta.SupportedDatabaseFlag.ValueType\022\037\n"
          ...
          + "\005scope\030\t \001(\01628.g"
          + "oogle.cloud.alloydb.v1beta.SupportedDatabaseFlag.Scope\032,\n"
      ...
      "/users/{user}*\005users2\004userR\001\001\"\202\003\n"
          + "\010Database\022\021\n"
          ...
          + ".google.com/go/alloydb/apiv1beta/alloydb"
          + "pb;alloydbpb\252\002\033Google.Cloud.AlloyDb.V1Be"
          + "ta\312\002\033Google\\Cloud\\AlloyDb\\V1beta\352\002\036Google::Cloud::AlloyDB::V1beta\352A\246\001\n"
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022zproject"
          + "s/{project}/locations/{location}/keyRing"
          + "s/{key_ring}/cryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}\352AN\n"
          ...
          + "ings/{key_ring}/cryptoKeys/{crypto_key}\352Aw\n"
    ...
    internal_static_google_cloud_alloydb_v1beta_Cluster_TagsEntry_descriptor =
        internal_static_google_cloud_alloydb_v1beta_Cluster_descriptor.getNestedType(8);
    internal_static_google_cloud_alloydb_v1beta_Cluster_TagsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_alloydb_v1beta_Cluster_TagsEntry_descriptor,
            new java.lang.String[] {
