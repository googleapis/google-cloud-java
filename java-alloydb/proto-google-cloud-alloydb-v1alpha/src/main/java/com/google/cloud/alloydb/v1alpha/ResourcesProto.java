  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ydb.v1alpha.MigrationSource.MigrationSourceTypeB\003\340A\003\"E\n"
          ...
          + "ud.alloydb.v1alpha.SslConfig.SslModeB\003\340A\001\022H\n"
          + "\tca_source\030\002"
          ...
          + "\0132B.google.cloud.alloydb.v1alpha.AutomatedBackupPolicy.WeeklyScheduleH\000\022f\n"
          + "\024time_based_retention\030\004 \001(\0132F.google.cloud.all"
          + "oydb.v1alpha.AutomatedBackupPolicy.TimeBasedRetentionH\001\022n\n"
          + "\030quantity_based_retention\030\005 \001(\0132J.google.cloud.alloydb.v1alpha"
          + ".AutomatedBackupPolicy.QuantityBasedRetentionH\001\022\024\n"
          ...
          + "d.alloydb.v1alpha.EncryptionConfigB\003\340A\001\022\020\n"
          + "\010location\030\006 \001(\t\022O\n"
          + "\006labels\030\007 \003(\0132?.goog"
          + "le.cloud.alloydb.v1alpha.AutomatedBackupPolicy.LabelsEntry\032k\n"
          ...
          + "le.cloud.alloydb.v1alpha.EncryptionConfigB\n\n"
          + "\010_enabled\"\213\002\n"
          ...
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\002\"\252\023\n"
          + "\007Cluster\022H\n\r"
          ...
          + "2-.google.cloud.alloydb.v1alpha.MigrationSourceB\003\340A\003H\000\022\021\n"
          ...
          + "google.cloud.alloydb.v1alpha.Cluster.StateB\003\340A\003\022L\n"
          + "\014cluster_type\030\030 \001(\01621.google.c"
          + "loud.alloydb.v1alpha.Cluster.ClusterTypeB\003\340A\003\022L\n"
          + "\020database_version\030\t \001(\0162-.google"
          + ".cloud.alloydb.v1alpha.DatabaseVersionB\003\340A\001\022P\n"
          + "\016network_config\030\035 \001(\01323.google.clo"
          + "ud.alloydb.v1alpha.Cluster.NetworkConfigB\003\340A\001\0229\n"
          + "\007network\030\n"
          + " \001(\tB(\030\001\340A\002\372A \n"
          + "\036compute.googleapis.com/Network\022\014\n"
          + "\004etag\030\013 \001(\t\022K\n"
          + "\013annotations\030\014"
          + " \003(\01326.google.cloud.alloydb.v1alpha.Cluster.AnnotationsEntry\022\030\n"
          ...
          + ".google.cloud.alloydb.v1alpha.SslConfigB\002\030\001\022N\n"
          + "\021encryption_config\030\023 \001(\0132..google."
          + "cloud.alloydb.v1alpha.EncryptionConfigB\003\340A\001\022J\n"
          ...
          + "le.cloud.alloydb.v1alpha.ContinuousBackupConfigB\003\340A\001\022W\n"
          ...
          + " \001(\01323.google.cloud.alloydb.v1alpha.Cluster.PrimaryConfigB\003\340A\003\022\032\n\r"
          + "satisfies_pzi\030! \001(\010B\003\340A\003\022\032\n\r"
          + "satisfies_pzs\030\036 \001(\010B\003\340A\003\022H\n\n"
          + "psc_config\030\037"
          + " \001(\0132/.google.cloud.alloydb.v1alpha.Cluster.PscConfigB\003\340A\001\032i\n\r"
          + "NetworkConfig\0227\n"
          ...
          + "\tPscConfig\022\030\n"
          + "\013psc_enabled\030\001 \001(\010B\003\340A\001\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          ...
          + ".com/Cluster\022:projects/{project}/locations/{location}/clusters/{cluster}R\001\001B\010\n"
          + "\006source\"\252\033\n"
          + "\010Instance\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\024\n"
          + "\014display_name\030\002 \001(\t\022\020\n"
          ...
          + "(\0162,.google.cloud.alloydb.v1alpha.Instance.StateB\003\340A\003\022O\n\r"
          + "instance_type\030\t \001(\01623.g"
          + "oogle.cloud.alloydb.v1alpha.Instance.InstanceTypeB\003\340A\002\022L\n"
          ...
          + "7.google.cloud.alloydb.v1alpha.Instance.AvailabilityType\022\020\n"
          ...
          + " \001(\0132B.google.cloud.alloydb.v1alpha.Instance.QueryInsightsInstanceConfig\022O\n"
          ...
          + "le.cloud.alloydb.v1alpha.Instance.AnnotationsEntry\022J\n\r"
          + "update_policy\030\026 \001(\01323.goog"
          + "le.cloud.alloydb.v1alpha.Instance.UpdatePolicy\022d\n"
          + "\030client_connection_config\030\027 \001(\013"
          + "2=.google.cloud.alloydb.v1alpha.Instance.ClientConnectionConfigB\003\340A\001\022\032\n\r"
          ...
          + "le.cloud.alloydb.v1alpha.Instance.PscInstanceConfigB\003\340A\001\022Y\n"
          + "\016network_config\030\035 \001(\013"
          + "2<.google.cloud.alloydb.v1alpha.Instance.InstanceNetworkConfigB\003\340A\001\032\"\n\r"
          ...
          + "ssl_config\030\002"
          + " \001(\0132\'.google.cloud.alloydb.v1alpha.SslConfigB\003\340A\001\032O\n"
          + "\022PscInterfaceConfig\022\035\n"
          + "\025consumer_endpoint_ips\030\001 \003(\t\022\032\n"
          + "\022network_attachment\030\002 \001(\t\032\262\002\n"
          ...
          + "\025psc_interface_configs\030\004 \003(\01329.google.cloud."
          + "alloydb.v1alpha.Instance.PscInterfaceConfigB\003\340A\001\022.\n"
          ...
          + "\034authorized_external_networks\030\001 \003(\0132N.google.clou"
          + "d.alloydb.v1alpha.Instance.InstanceNetworkConfig.AuthorizedNetworkB\003\340A\001\022\035\n"
          ...
          + "t}/locations/{location}/clusters/{cluster}/instances/{instance}R\001\001\"\311\002\n"
          ...
          + "r}/instances/{instance}/connectionInfo\"\206\014\n"
          + "\006Backup\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022\024\n"
          + "\014display_name\030\002 \001(\t\022\020\n"
          + "\003uid\030\003 \001(\tB\003\340A\003\0224\n"
          ...
          + "loydb.v1alpha.Backup.QuantityBasedExpiryB\003\340A\003\022\032\n\r"
          ...
          + " \001(\0162-.google.cloud.alloydb.v1alpha.DatabaseVersionB\003\340A\003\032W\n"
          ...
          + "up\0228projects/{project}/locations/{location}/backups/{backup}R\001\001\"\334\006\n"
          + "\025SupportedDatabaseFlag\022e\n"
          + "\023string_restrictions\030\007 \001(\0132F"
          + ".google.cloud.alloydb.v1alpha.SupportedDatabaseFlag.StringRestrictionsH\000\022g\n"
          + "\024integer_restrictions\030\010 \001(\0132G.google.cloud.al"
          + "loydb.v1alpha.SupportedDatabaseFlag.IntegerRestrictionsH\000\022\014\n"
          + "\004name\030\001 \001(\t\022\021\n"
          + "\tflag_name\030\002 \001(\t\022Q\n\n"
          + "value_type\030\003 \001(\0162=.google."
          + "cloud.alloydb.v1alpha.SupportedDatabaseFlag.ValueType\022\037\n"
          ...
          + "rtedDatabaseFlag\0224projects/{project}/locations/{location}/flags/{flag}B\016\n"
          ...
          + "\tuser_type\030\005"
          + " \001(\0162+.google.cloud.alloydb.v1alpha.User.UserTypeB\003\340A\001\"Q\n"
          + "\010UserType\022\031\n"
          ...
          + "ts/{project}/locations/{location}/clusters/{cluster}/users/{user}R\001\001\"\334\001\n"
          + "\010Database\022\021\n"
          ...
          + "oject}/locations/{location}/clusters/{cluster}/databases/{database}*"
          ...
          + " com.google.cloud.alloydb.v1alphaB\016ResourcesProtoP\001Z:cloud.google.com/go/all"
          + "oydb/apiv1alpha/alloydbpb;alloydbpb\252\002\034Go"
          + "ogle.Cloud.AlloyDb.V1Alpha\312\002\034Google\\Clou"
          + "d\\AlloyDb\\V1alpha\352\002\037Google::Cloud::AlloyDB::V1alpha\352A\246\001\n"
          + "(cloudkms.googleapis.com/CryptoKeyVersion\022zprojects/{project}/lo"
          + "cations/{location}/keyRings/{key_ring}/c"
          + "ryptoKeys/{crypto_key}/cryptoKeyVersions/{crypto_key_version}\352AN\n"
          + "\036compute.googleapis.com/Network\022,projects/{project}/glo"
