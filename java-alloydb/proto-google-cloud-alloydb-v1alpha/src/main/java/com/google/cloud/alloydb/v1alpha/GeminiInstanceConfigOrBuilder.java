...
public interface GeminiInstanceConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.GeminiInstanceConfig)
   ...
   *
   * @deprecated google.cloud.alloydb.v1alpha.GeminiInstanceConfig.entitled is deprecated. See
   *     google/cloud/alloydb/v1alpha/gemini.proto;l=49
   * @return The entitled.
   */
