...
public interface InjectFaultRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.InjectFaultRequest)
   ...
   *
   * <code>
   * .google.cloud.alloydb.v1alpha.InjectFaultRequest.FaultType fault_type = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.alloydb.v1alpha.InjectFaultRequest.FaultType getFaultType();
