...
public interface PromoteClusterStatusOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.PromoteClusterStatus)
   ...
   * @return The state.
   */
  com.google.cloud.alloydb.v1alpha.PromoteClusterStatus.State getState();
}
