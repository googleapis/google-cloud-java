...
public class SupportedDatabaseFlagName implements ResourceName {
  ...
  public static @Nullable SupportedDatabaseFlagName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SupportedDatabaseFlagName> values) {
