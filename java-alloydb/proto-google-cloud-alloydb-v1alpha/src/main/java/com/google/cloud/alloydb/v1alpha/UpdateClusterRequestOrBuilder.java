...
public interface UpdateClusterRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.UpdateClusterRequest)
   ...
   *
   * <code>
   * .google.cloud.alloydb.v1alpha.Cluster cluster = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
