...
public interface UpgradeClusterRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.UpgradeClusterRequest)
   ...
   * @return The version.
   */
  com.google.cloud.alloydb.v1alpha.DatabaseVersion getVersion();
