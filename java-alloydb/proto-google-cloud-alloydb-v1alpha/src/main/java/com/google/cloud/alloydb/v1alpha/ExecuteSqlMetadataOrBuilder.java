...
public interface ExecuteSqlMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.ExecuteSqlMetadata)
   ...
   * @return The status.
   */
  com.google.cloud.alloydb.v1alpha.ExecuteSqlMetadata.Status getStatus();
}
