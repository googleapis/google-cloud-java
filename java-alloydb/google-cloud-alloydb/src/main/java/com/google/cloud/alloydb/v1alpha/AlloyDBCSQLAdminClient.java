...
public class AlloyDBCSQLAdminClient implements BackgroundResource {
  private final @Nullable AlloyDBCSQLAdminSettings settings;
  ...
  public final @Nullable AlloyDBCSQLAdminSettings getSettings() {
    return settings;
  }
  ...
  public final OperationFuture<Cluster, OperationMetadata> restoreFromCloudSQLAsync(
      @Nullable LocationName parent, String clusterId) {
