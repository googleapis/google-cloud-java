...
public class AlloyDBCSQLAdminStubSettings extends StubSettings<AlloyDBCSQLAdminStubSettings> {
  ...
  private final UnaryCallSettings<RestoreFromCloudSQLRequest, Operation>
      restoreFromCloudSQLSettings;
  private final OperationCallSettings<RestoreFromCloudSQLRequest, Cluster, OperationMetadata>
  ...
  public static class Builder extends StubSettings.Builder<AlloyDBCSQLAdminStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<RestoreFromCloudSQLRequest, Operation>
        restoreFromCloudSQLSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<RestoreFromCloudSQLRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_params"))
                  .build())
