...
public interface ExecuteSqlMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1.ExecuteSqlMetadata)
   ...
   * </pre>
   *
   * <code>.google.cloud.alloydb.v1.ExecuteSqlMetadata.Status status = 4;</code>
   *
   ...
   * @return The status.
   */
  com.google.cloud.alloydb.v1.ExecuteSqlMetadata.Status getStatus();
}
