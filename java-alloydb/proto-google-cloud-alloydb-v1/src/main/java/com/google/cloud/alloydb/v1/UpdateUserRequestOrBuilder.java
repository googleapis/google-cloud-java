...
public interface UpdateUserRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1.UpdateUserRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.alloydb.v1.User user = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
   ...
   * <code>.google.cloud.alloydb.v1.User user = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.alloydb.v1.UserOrBuilder getUserOrBuilder();
