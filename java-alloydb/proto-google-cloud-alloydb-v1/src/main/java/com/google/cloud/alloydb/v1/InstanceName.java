...
public class InstanceName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CLUSTER_INSTANCE =
  ...
  public static InstanceName of(String project, String location, String cluster, String instance) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String cluster, String instance) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setCluster(cluster)
  ...
  public static @Nullable InstanceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CLUSTER_INSTANCE.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable InstanceName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_CLUSTER_INSTANCE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_CLUSTER_INSTANCE.instantiate(
        "project", project, "location", location, "cluster", cluster, "instance", instance);
  }
  ...
  public static class Builder {
    ...
    private Builder(InstanceName instanceName) {
      ...
      this.cluster = instanceName.cluster;
