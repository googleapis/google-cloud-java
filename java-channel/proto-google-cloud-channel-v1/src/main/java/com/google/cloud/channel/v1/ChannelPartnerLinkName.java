...
public class ChannelPartnerLinkName implements ResourceName {
  ...
  public static @Nullable ChannelPartnerLinkName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ChannelPartnerLinkName> values) {
