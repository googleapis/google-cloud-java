...
public final class CustomerConstraints extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CustomerConstraints(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private CustomerConstraints() {
    allowedRegions_ = com.google.protobuf.LazyStringArrayList.emptyList();
    allowedCustomerTypes_ = emptyIntList();
    promotionalOrderTypes_ = emptyIntList();
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList allowedCustomerTypes_ = emptyIntList();

  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.cloud.channel.v1.CloudIdentityInfo.CustomerType>
      allowedCustomerTypes_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.cloud.channel.v1.CloudIdentityInfo.CustomerType>() {
            public com.google.cloud.channel.v1.CloudIdentityInfo.CustomerType convert(int from) {
  ...
  public com.google.cloud.channel.v1.CloudIdentityInfo.CustomerType getAllowedCustomerTypes(
      int index) {
    return allowedCustomerTypes_converter_.convert(allowedCustomerTypes_.getInt(index));
  }
  ...
  public int getAllowedCustomerTypesValue(int index) {
    return allowedCustomerTypes_.getInt(index);
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList promotionalOrderTypes_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      promotionalOrderTypes_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.cloud.channel.v1.PromotionalOrderType>() {
            public com.google.cloud.channel.v1.PromotionalOrderType convert(int from) {
  ...
  public com.google.cloud.channel.v1.PromotionalOrderType getPromotionalOrderTypes(int index) {
    return promotionalOrderTypes_converter_.convert(promotionalOrderTypes_.getInt(index));
  }
  ...
  public int getPromotionalOrderTypesValue(int index) {
    return promotionalOrderTypes_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < allowedCustomerTypes_.size(); i++) {
      output.writeEnumNoTag(allowedCustomerTypes_.getInt(i));
    }
    ...
    for (int i = 0; i < promotionalOrderTypes_.size(); i++) {
      output.writeEnumNoTag(promotionalOrderTypes_.getInt(i));
    }
  ...
  public int getSerializedSize() {
      ...
      for (int i = 0; i < allowedCustomerTypes_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                allowedCustomerTypes_.getInt(i));
      }
      size += dataSize;
    ...
    }
    {
      ...
      for (int i = 0; i < promotionalOrderTypes_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                promotionalOrderTypes_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.cloud.channel.v1.CustomerConstraints result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        allowedCustomerTypes_.makeImmutable();
        result.allowedCustomerTypes_ = allowedCustomerTypes_;
      }
      if (((from_bitField0_ & 0x00000004) != 0)) {
        promotionalOrderTypes_.makeImmutable();
            ...
            case 16:
              {
                ...
                ensureAllowedCustomerTypesIsMutable();
                allowedCustomerTypes_.addInt(tmpRaw);
                break;
              } // case 16
            case 18:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  allowedCustomerTypes_.addInt(input.readEnum());
                }
            ...
            case 24:
              {
                int tmpRaw = input.readEnum();
                ensurePromotionalOrderTypesIsMutable();
                promotionalOrderTypes_.addInt(tmpRaw);
                break;
              } // case 24
            case 26:
              {
                ...
                ensurePromotionalOrderTypesIsMutable();
                while (input.getBytesUntilLimit() > 0) {
                  promotionalOrderTypes_.addInt(input.readEnum());
                }
                input.popLimit(limit);
                break;
              } // case 26
    ...
    private void ensureAllowedCustomerTypesIsMutable() {
      if (!allowedCustomerTypes_.isModifiable()) {
        allowedCustomerTypes_ = makeMutableCopy(allowedCustomerTypes_);
      }
      bitField0_ |= 0x00000002;
    }
    ...
    public Builder setAllowedCustomerTypes(
      ...
      ensureAllowedCustomerTypesIsMutable();
      allowedCustomerTypes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedCustomerTypes(
      ...
      ensureAllowedCustomerTypesIsMutable();
      allowedCustomerTypes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setAllowedCustomerTypesValue(int index, int value) {
      ensureAllowedCustomerTypesIsMutable();
      allowedCustomerTypes_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedCustomerTypesValue(int value) {
      ensureAllowedCustomerTypesIsMutable();
      allowedCustomerTypes_.addInt(value);
      onChanged();
      return this;
    }
    ...
    private void ensurePromotionalOrderTypesIsMutable() {
      if (!promotionalOrderTypes_.isModifiable()) {
        promotionalOrderTypes_ = makeMutableCopy(promotionalOrderTypes_);
      }
      bitField0_ |= 0x00000004;
    }
    ...
    public Builder setPromotionalOrderTypes(
      ...
      ensurePromotionalOrderTypesIsMutable();
      promotionalOrderTypes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addPromotionalOrderTypes(
      ...
      ensurePromotionalOrderTypesIsMutable();
      promotionalOrderTypes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setPromotionalOrderTypesValue(int index, int value) {
      ensurePromotionalOrderTypesIsMutable();
      promotionalOrderTypes_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addPromotionalOrderTypesValue(int value) {
      ensurePromotionalOrderTypesIsMutable();
      promotionalOrderTypes_.addInt(value);
      onChanged();
      return this;
    }
