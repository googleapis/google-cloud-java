...
public class CustomerRepricingConfigName implements ResourceName {
  ...
  public static @Nullable CustomerRepricingConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CustomerRepricingConfigName> values) {
