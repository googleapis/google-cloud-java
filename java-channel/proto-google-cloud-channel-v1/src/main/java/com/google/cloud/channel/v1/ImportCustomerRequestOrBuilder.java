...
public interface ImportCustomerRequestOrBuilder
   ...
   * </pre>
   *
   * <code>string primary_admin_email = 8 [(.google.api.field_behavior) = REQUIRED];</code>
   *
   ...
   * <code>string primary_admin_email = 8 [(.google.api.field_behavior) = REQUIRED];</code>
   *
   * @return The bytes for primaryAdminEmail.
   */
  com.google.protobuf.ByteString getPrimaryAdminEmailBytes();
