  ...
  public void getCustomerRepricingConfig(
    ...
    if (response instanceof CustomerRepricingConfig) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetCustomerRepricingConfig, expected %s"
                      + " or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void listCustomerRepricingConfigs(
    ...
    if (response instanceof ListCustomerRepricingConfigsResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListCustomerRepricingConfigs, expected"
                      + " %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void createCustomerRepricingConfig(
    ...
    if (response instanceof CustomerRepricingConfig) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateCustomerRepricingConfig, expected"
                      + " %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  CustomerRepricingConfig.class.getName(),
                  Exception.class.getName())));
  ...
  public void updateCustomerRepricingConfig(
    ...
    if (response instanceof CustomerRepricingConfig) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UpdateCustomerRepricingConfig, expected"
                      + " %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  CustomerRepricingConfig.class.getName(),
                  Exception.class.getName())));
  ...
  public void deleteCustomerRepricingConfig(
    ...
    if (response instanceof Empty) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteCustomerRepricingConfig, expected"
                      + " %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Empty.class.getName(),
                  Exception.class.getName())));
  ...
  public void getChannelPartnerRepricingConfig(
    ...
    if (response instanceof ChannelPartnerRepricingConfig) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetChannelPartnerRepricingConfig,"
                      + " expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void listChannelPartnerRepricingConfigs(
    ...
    if (response instanceof ListChannelPartnerRepricingConfigsResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListChannelPartnerRepricingConfigs,"
                      + " expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void createChannelPartnerRepricingConfig(
    ...
    if (response instanceof ChannelPartnerRepricingConfig) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateChannelPartnerRepricingConfig,"
                      + " expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ChannelPartnerRepricingConfig.class.getName(),
                  Exception.class.getName())));
  ...
  public void updateChannelPartnerRepricingConfig(
    ...
    if (response instanceof ChannelPartnerRepricingConfig) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UpdateChannelPartnerRepricingConfig,"
                      + " expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ChannelPartnerRepricingConfig.class.getName(),
                  Exception.class.getName())));
  ...
  public void deleteChannelPartnerRepricingConfig(
    ...
    if (response instanceof Empty) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteChannelPartnerRepricingConfig,"
                      + " expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Empty.class.getName(),
                  Exception.class.getName())));
  ...
  public void listSkuGroupBillableSkus(
    ...
    if (response instanceof ListSkuGroupBillableSkusResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListSkuGroupBillableSkus, expected %s"
                      + " or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void queryEligibleBillingAccounts(
    ...
    if (response instanceof QueryEligibleBillingAccountsResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method QueryEligibleBillingAccounts, expected"
                      + " %s or %s",
                  response == null ? "null" : response.getClass().getName(),
  ...
  public void listEntitlementChanges(
    ...
    if (response instanceof ListEntitlementChangesResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListEntitlementChanges, expected %s or"
                      + " %s",
                  response == null ? "null" : response.getClass().getName(),
