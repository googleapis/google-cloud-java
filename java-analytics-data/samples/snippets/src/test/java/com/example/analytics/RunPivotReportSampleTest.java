...
/** Tests for the RunPivotReport sample. */
@RunWith(JUnit4.class)
public class RunPivotReportSampleTest {
  ...
  private String runSample(String ga4PropertyId) throws Exception {
    ...
    RunPivotReportSample.sampleRunPivotReport(ga4PropertyId);
    System.setOut(stdOut);
    return bout.toString();
  }

  @Test
  public void testRunPivotReport() throws Exception {
    // Act
