 ...
 *    <tr>
 *      <td>RunReport</td>
 *      <td><p>Returns a customized report of your Google Analytics event data. Reports
 ...
 *  [Creating a
 *  Report](https://developers.google.com/analytics/devguides/reporting/data/v1/basics).</p></td>
 *      <td>
 ...
 *      <td><p>Returns a customized pivot report of your Google Analytics event data.
 ...
 *      <td><p>Returns multiple reports in a batch. All reports must be for the same
 *  GA4 Property.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Returns multiple pivot reports in a batch. All reports must be for the same
 *  GA4 Property.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>GetMetadata</td>
 *      <td><p>Returns metadata for dimensions and metrics available in reporting methods.
 ...
 *  metrics applicable to any property such as `country` and `totalUsers`.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *  Report](https://developers.google.com/analytics/devguides/reporting/data/v1/realtime-basics).</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>This compatibility method lists dimensions and metrics that can be added to
 ...
 *  method checks compatibility for Core reports.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
