...
public interface ListReportTasksResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.analytics.data.v1alpha.ListReportTasksResponse)
   ...
   * <code>repeated .google.analytics.data.v1alpha.ReportTask report_tasks = 1;</code>
   */
  com.google.analytics.data.v1alpha.ReportTaskOrBuilder getReportTasksOrBuilder(int index);
