 ...
 * </pre>
 *
 * Protobuf type {@code google.analytics.data.v1alpha.QueryReportTaskResponse}
 */
@com.google.protobuf.Generated
public final class QueryReportTaskResponse extends com.google.protobuf.GeneratedMessage
    implements
    // @@protoc_insertion_point(message_implements:google.analytics.data.v1alpha.QueryReportTaskResponse)
    QueryReportTaskResponseOrBuilder {
  ...
  // Use QueryReportTaskResponse.newBuilder() to construct.
  private QueryReportTaskResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private QueryReportTaskResponse() {
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.analytics.data.v1alpha.AnalyticsDataApiProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.analytics.data.v1alpha.QueryReportTaskResponse.class,
            com.google.analytics.data.v1alpha.QueryReportTaskResponse.Builder.class);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.analytics.data.v1alpha.QueryReportTaskResponse)) {
      return super.equals(obj);
    }
    com.google.analytics.data.v1alpha.QueryReportTaskResponse other =
        (com.google.analytics.data.v1alpha.QueryReportTaskResponse) obj;
  ...
  public static com.google.analytics.data.v1alpha.QueryReportTaskResponse parseFrom(
  ...
  public static com.google.analytics.data.v1alpha.QueryReportTaskResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static com.google.analytics.data.v1alpha.QueryReportTaskResponse parseDelimitedFrom(
      java.io.InputStream input) throws java.io.IOException {
  ...
  public static Builder newBuilder(
      com.google.analytics.data.v1alpha.QueryReportTaskResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.analytics.data.v1alpha.QueryReportTaskResponse)
      com.google.analytics.data.v1alpha.QueryReportTaskResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return com.google.analytics.data.v1alpha.AnalyticsDataApiProto
          .internal_static_google_analytics_data_v1alpha_QueryReportTaskResponse_descriptor;
    }
    ...
    // Construct using com.google.analytics.data.v1alpha.QueryReportTaskResponse.newBuilder()
    private Builder() {
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetDimensionHeadersFieldBuilder();
        internalGetMetricHeadersFieldBuilder();
        internalGetRowsFieldBuilder();
        internalGetTotalsFieldBuilder();
        internalGetMaximumsFieldBuilder();
    ...
    @java.lang.Override
    public com.google.analytics.data.v1alpha.QueryReportTaskResponse getDefaultInstanceForType() {
      return com.google.analytics.data.v1alpha.QueryReportTaskResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.analytics.data.v1alpha.QueryReportTaskResponse build() {
      com.google.analytics.data.v1alpha.QueryReportTaskResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.google.analytics.data.v1alpha.QueryReportTaskResponse buildPartial() {
      com.google.analytics.data.v1alpha.QueryReportTaskResponse result =
          new com.google.analytics.data.v1alpha.QueryReportTaskResponse(this);
    ...
    private void buildPartial0(com.google.analytics.data.v1alpha.QueryReportTaskResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.analytics.data.v1alpha.QueryReportTaskResponse) {
        return mergeFrom((com.google.analytics.data.v1alpha.QueryReportTaskResponse) other);
      } else {
    ...
    public Builder mergeFrom(com.google.analytics.data.v1alpha.QueryReportTaskResponse other) {
      if (other == com.google.analytics.data.v1alpha.QueryReportTaskResponse.getDefaultInstance())
        return this;
      if (dimensionHeadersBuilder_ == null) {
    ...
    public com.google.analytics.data.v1alpha.DimensionHeader.Builder getDimensionHeadersBuilder(
        int index) {
      return internalGetDimensionHeadersFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.analytics.data.v1alpha.DimensionHeader.Builder addDimensionHeadersBuilder() {
      return internalGetDimensionHeadersFieldBuilder()
    ...
    public java.util.List<com.google.analytics.data.v1alpha.DimensionHeader.Builder>
      ...
      return internalGetDimensionHeadersFieldBuilder().getBuilderList();
    }
    ...
    public com.google.analytics.data.v1alpha.MetricHeader.Builder getMetricHeadersBuilder(
        int index) {
      return internalGetMetricHeadersFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.analytics.data.v1alpha.MetricHeader.Builder addMetricHeadersBuilder() {
      return internalGetMetricHeadersFieldBuilder()
    ...
    public java.util.List<com.google.analytics.data.v1alpha.MetricHeader.Builder>
      ...
      return internalGetMetricHeadersFieldBuilder().getBuilderList();
    }
    ...
    public com.google.analytics.data.v1alpha.Row.Builder getTotalsBuilder(int index) {
      return internalGetTotalsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.analytics.data.v1alpha.Row.Builder addTotalsBuilder() {
      return internalGetTotalsFieldBuilder()
          .addBuilder(com.google.analytics.data.v1alpha.Row.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.analytics.data.v1alpha.Row.Builder> getTotalsBuilderList() {
      return internalGetTotalsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.analytics.data.v1alpha.Row.Builder getMaximumsBuilder(int index) {
      return internalGetMaximumsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.analytics.data.v1alpha.Row.Builder addMaximumsBuilder() {
      return internalGetMaximumsFieldBuilder()
          .addBuilder(com.google.analytics.data.v1alpha.Row.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.analytics.data.v1alpha.Row.Builder> getMaximumsBuilderList() {
      return internalGetMaximumsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.analytics.data.v1alpha.Row.Builder addMinimumsBuilder() {
      return internalGetMinimumsFieldBuilder()
          .addBuilder(com.google.analytics.data.v1alpha.Row.getDefaultInstance());
    }
    ...
    // @@protoc_insertion_point(builder_scope:google.analytics.data.v1alpha.QueryReportTaskResponse)
  }

  // @@protoc_insertion_point(class_scope:google.analytics.data.v1alpha.QueryReportTaskResponse)
  private static final com.google.analytics.data.v1alpha.QueryReportTaskResponse DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new com.google.analytics.data.v1alpha.QueryReportTaskResponse();
  }

  public static com.google.analytics.data.v1alpha.QueryReportTaskResponse getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<QueryReportTaskResponse> PARSER =
      new com.google.protobuf.AbstractParser<QueryReportTaskResponse>() {
        @java.lang.Override
        public QueryReportTaskResponse parsePartialFrom(
            com.google.protobuf.CodedInputStream input,
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
  ...
  public static com.google.protobuf.Parser<QueryReportTaskResponse> parser() {
    return PARSER;
  }

  @java.lang.Override
  public com.google.protobuf.Parser<QueryReportTaskResponse> getParserForType() {
    return PARSER;
  }
