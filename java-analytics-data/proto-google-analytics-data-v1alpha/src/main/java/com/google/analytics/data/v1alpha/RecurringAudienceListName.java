...
public class RecurringAudienceListName implements ResourceName {
  ...
  public static @Nullable RecurringAudienceListName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RecurringAudienceListName> values) {
