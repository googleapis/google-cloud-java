...
public interface DimensionMetadataOrBuilder
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.data.v1alpha.Section sections = 7;</code>
   *
   * @return A list containing the sections.
   */
  java.util.List<com.google.analytics.data.v1alpha.Section> getSectionsList();
   ...
   */
  java.util.List<java.lang.Integer> getSectionsValueList();
   ...
   */
  int getSectionsValue(int index);
}
