...
public final class UserSegmentSequenceGroup extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private UserSegmentSequenceGroup(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetSequenceMaximumDurationFieldBuilder();
        internalGetUserSequenceStepsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetSequenceMaximumDurationFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.protobuf.Duration.Builder getSequenceMaximumDurationBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetSequenceMaximumDurationFieldBuilder().getBuilder();
    }
    ...
    public com.google.analytics.data.v1alpha.UserSequenceStep.Builder getUserSequenceStepsBuilder(
        int index) {
      return internalGetUserSequenceStepsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.analytics.data.v1alpha.UserSequenceStep.Builder
      ...
      return internalGetUserSequenceStepsFieldBuilder()
    ...
    public java.util.List<com.google.analytics.data.v1alpha.UserSequenceStep.Builder>
      ...
      return internalGetUserSequenceStepsFieldBuilder().getBuilderList();
    }
