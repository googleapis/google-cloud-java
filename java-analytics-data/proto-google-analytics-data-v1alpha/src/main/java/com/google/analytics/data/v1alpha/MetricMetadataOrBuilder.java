...
public interface MetricMetadataOrBuilder
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason>
   ...
   */
  com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason getBlockedReasons(int index);
