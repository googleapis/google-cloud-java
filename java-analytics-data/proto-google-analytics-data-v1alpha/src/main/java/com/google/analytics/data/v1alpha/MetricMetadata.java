...
public final class MetricMetadata extends com.google.protobuf.GeneratedMessage
   ...
   * </pre>
   *
   * Protobuf enum {@code google.analytics.data.v1alpha.MetricMetadata.BlockedReason}
   */
  public enum BlockedReason implements com.google.protobuf.ProtocolMessageEnum {
    ...
    public static com.google.protobuf.Descriptors.EnumDescriptor getDescriptor() {
      return com.google.analytics.data.v1alpha.MetricMetadata.getDescriptor().getEnumTypes().get(0);
    }
    ...
    // @@protoc_insertion_point(enum_scope:google.analytics.data.v1alpha.MetricMetadata.BlockedReason)
  }
  ...
  public com.google.analytics.data.v1alpha.MetricType getType() {
    com.google.analytics.data.v1alpha.MetricType result =
        com.google.analytics.data.v1alpha.MetricType.forNumber(type_);
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList blockedReasons_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      blockedReasons_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason>() {
            public com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason convert(
                int from) {
              com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason result =
                  com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason.forNumber(from);
              return result == null
                  ? com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason.UNRECOGNIZED
                  : result;
            }
          };
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.data.v1alpha.MetricMetadata.BlockedReason blocked_reasons = 8;
   * </code>
   *
   * @return A list containing the blockedReasons.
   */
  @java.lang.Override
  public java.util.List<com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason>
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason getBlockedReasons(
      int index) {
    return blockedReasons_converter_.convert(blockedReasons_.getInt(index));
  }
  ...
  public int getBlockedReasonsValue(int index) {
    return blockedReasons_.getInt(index);
  }
  ...
  public static final int SECTIONS_FIELD_NUMBER = 10;
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.data.v1alpha.Section sections = 10;</code>
   *
   * @return A list containing the sections.
   */
  @java.lang.Override
  public java.util.List<com.google.analytics.data.v1alpha.Section> getSectionsList() {
    return new com.google.protobuf.Internal.IntListAdapter<
        com.google.analytics.data.v1alpha.Section>(sections_, sections_converter_);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<java.lang.Integer> getSectionsValueList() {
    return sections_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(expression_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, expression_);
    }
    ...
    for (int i = 0; i < blockedReasons_.size(); i++) {
      output.writeEnumNoTag(blockedReasons_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(expression_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, expression_);
    }
    if (customDefinition_ != false) {
    ...
    }
    {
      ...
      for (int i = 0; i < blockedReasons_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(blockedReasons_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.analytics.data.v1alpha.MetricMetadata result) {
            ...
            case 66:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  blockedReasons_.addInt(input.readEnum());
                }
            ...
            case 82:
              {
                ...
                ensureSectionsIsMutable();
                while (input.getBytesUntilLimit() > 0) {
                  sections_.addInt(input.readEnum());
                }
                input.popLimit(limit);
                break;
              } // case 82
    ...
    private void ensureBlockedReasonsIsMutable() {
      if (!blockedReasons_.isModifiable()) {
        blockedReasons_ = makeMutableCopy(blockedReasons_);
      }
      bitField0_ |= 0x00000080;
    }
     ...
     *
     * <code>
     * repeated .google.analytics.data.v1alpha.MetricMetadata.BlockedReason blocked_reasons = 8;
     * </code>
     *
     * @return A list containing the blockedReasons.
     */
    ...
    public Builder setBlockedReasons(
        int index, com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureBlockedReasonsIsMutable();
      blockedReasons_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addBlockedReasons(
        com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureBlockedReasonsIsMutable();
      blockedReasons_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addAllBlockedReasons(
        java.lang.Iterable<? extends com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason>
            values) {
      ensureBlockedReasonsIsMutable();
      for (com.google.analytics.data.v1alpha.MetricMetadata.BlockedReason value : values) {
        blockedReasons_.addInt(value.getNumber());
      }
      onChanged();
      return this;
    ...
    public Builder setBlockedReasonsValue(int index, int value) {
      ensureBlockedReasonsIsMutable();
      blockedReasons_.setInt(index, value);
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addAllSectionsValue(java.lang.Iterable<java.lang.Integer> values) {
      ensureSectionsIsMutable();
      for (int value : values) {
        sections_.addInt(value);
      }
