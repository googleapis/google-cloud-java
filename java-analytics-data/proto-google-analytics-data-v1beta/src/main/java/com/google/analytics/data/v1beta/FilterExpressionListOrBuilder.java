...
public interface FilterExpressionListOrBuilder
   ...
   */
  java.util.List<com.google.analytics.data.v1beta.FilterExpression> getExpressionsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.analytics.data.v1beta.FilterExpression expressions = 1;</code>
   */
  com.google.analytics.data.v1beta.FilterExpressionOrBuilder getExpressionsOrBuilder(int index);
}
