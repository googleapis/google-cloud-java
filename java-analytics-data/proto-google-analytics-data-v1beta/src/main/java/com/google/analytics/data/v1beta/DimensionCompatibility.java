...
public final class DimensionCompatibility extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DimensionCompatibility(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetDimensionMetadataFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.analytics.data.v1beta.DimensionCompatibility other) {
      ...
      if (other.hasCompatibility()) {
        setCompatibilityValue(other.getCompatibilityValue());
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetDimensionMetadataFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.analytics.data.v1beta.DimensionMetadata.Builder
      ...
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetDimensionMetadataFieldBuilder().getBuilder();
    }
