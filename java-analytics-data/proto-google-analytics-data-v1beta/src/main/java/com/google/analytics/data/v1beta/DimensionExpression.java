...
public final class DimensionExpression extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DimensionExpression(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class CaseExpression extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private CaseExpression(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class ConcatenateExpression extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ConcatenateExpression(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      for (int i = 0; i < dimensionNames_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, dimensionNames_.getRaw(i));
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetLowerCaseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 42:
              {
                input.readMessage(
                    internalGetUpperCaseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 50:
              {
                input.readMessage(
                    internalGetConcatenateFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.analytics.data.v1beta.DimensionExpression.CaseExpression.Builder
        getLowerCaseBuilder() {
      return internalGetLowerCaseFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.analytics.data.v1beta.DimensionExpression.CaseExpression.Builder,
            com.google.analytics.data.v1beta.DimensionExpression.CaseExpressionOrBuilder>
        internalGetLowerCaseFieldBuilder() {
      if (lowerCaseBuilder_ == null) {
        if (!(oneExpressionCase_ == 4)) {
          oneExpression_ =
              com.google.analytics.data.v1beta.DimensionExpression.CaseExpression
    ...
    public com.google.analytics.data.v1beta.DimensionExpression.CaseExpression.Builder
        getUpperCaseBuilder() {
      return internalGetUpperCaseFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.analytics.data.v1beta.DimensionExpression.CaseExpression.Builder,
            com.google.analytics.data.v1beta.DimensionExpression.CaseExpressionOrBuilder>
        internalGetUpperCaseFieldBuilder() {
      if (upperCaseBuilder_ == null) {
        if (!(oneExpressionCase_ == 5)) {
          oneExpression_ =
              com.google.analytics.data.v1beta.DimensionExpression.CaseExpression
    ...
    public com.google.analytics.data.v1beta.DimensionExpression.ConcatenateExpression.Builder
      ...
      return internalGetConcatenateFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.analytics.data.v1beta.DimensionExpression.ConcatenateExpression.Builder,
            com.google.analytics.data.v1beta.DimensionExpression.ConcatenateExpressionOrBuilder>
        internalGetConcatenateFieldBuilder() {
      if (concatenateBuilder_ == null) {
        if (!(oneExpressionCase_ == 6)) {
          oneExpression_ =
              com.google.analytics.data.v1beta.DimensionExpression.ConcatenateExpression
