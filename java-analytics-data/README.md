...
```Scala
libraryDependencies += "com.google.analytics" % "google-analytics-data" % "0.44.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.analytics/google-analytics-data/0.44.0
