...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-secretmanager" % "2.94.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-secretmanager/2.94.0
