...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-secretmanager" % "2.75.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-secretmanager/2.75.0
