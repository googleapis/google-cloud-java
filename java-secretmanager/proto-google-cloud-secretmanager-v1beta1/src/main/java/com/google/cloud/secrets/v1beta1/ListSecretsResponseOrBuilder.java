...
public interface ListSecretsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.secrets.v1beta1.Secret> getSecretsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.secrets.v1beta1.Secret secrets = 1;</code>
   */
  com.google.cloud.secrets.v1beta1.Secret getSecrets(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.secrets.v1beta1.Secret secrets = 1;</code>
   */
  java.util.List<? extends com.google.cloud.secrets.v1beta1.SecretOrBuilder>
   ...
   * <code>repeated .google.cloud.secrets.v1beta1.Secret secrets = 1;</code>
   */
  com.google.cloud.secrets.v1beta1.SecretOrBuilder getSecretsOrBuilder(int index);
