...
import com.google.shopping.merchant.issueresolution.v1beta.stub.IssueResolutionServiceStub;
...
public class IssueResolutionServiceClient implements BackgroundResource {
   ...
   * [Ids][google.shopping.merchant.issueresolution.v1beta.InputField.id] for all problematic field
   * together with translated, human readable error messages that can be shown to the user.
   *
   * <p>Sample code:
   *
   * <pre>{@code
