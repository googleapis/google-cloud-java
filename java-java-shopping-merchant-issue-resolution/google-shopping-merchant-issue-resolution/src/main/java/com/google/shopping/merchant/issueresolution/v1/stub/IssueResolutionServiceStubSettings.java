...
/**
 * Settings class to configure an instance of {@link IssueResolutionServiceStub}.
 *
...
public class IssueResolutionServiceStubSettings
  ...
  private final UnaryCallSettings<RenderAccountIssuesRequest, RenderAccountIssuesResponse>
      renderAccountIssuesSettings;
  private final UnaryCallSettings<RenderProductIssuesRequest, RenderProductIssuesResponse>
      renderProductIssuesSettings;
  private final UnaryCallSettings<TriggerActionRequest, TriggerActionResponse>
  ...
  public UnaryCallSettings<RenderAccountIssuesRequest, RenderAccountIssuesResponse>
      renderAccountIssuesSettings() {
    return renderAccountIssuesSettings;
  }
  ...
  public UnaryCallSettings<RenderProductIssuesRequest, RenderProductIssuesResponse>
      renderProductIssuesSettings() {
    return renderProductIssuesSettings;
  }
  ...
  public UnaryCallSettings<TriggerActionRequest, TriggerActionResponse> triggerActionSettings() {
    return triggerActionSettings;
  }

  public IssueResolutionServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcIssueResolutionServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonIssueResolutionServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(IssueResolutionServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return IssueResolutionServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected IssueResolutionServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<IssueResolutionServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<RenderAccountIssuesRequest, RenderAccountIssuesResponse>
        renderAccountIssuesSettings;
    private final UnaryCallSettings.Builder<RenderProductIssuesRequest, RenderProductIssuesResponse>
        renderProductIssuesSettings;
    private final UnaryCallSettings.Builder<TriggerActionRequest, TriggerActionResponse>
        triggerActionSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      renderAccountIssuesSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      renderProductIssuesSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      triggerActionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              renderAccountIssuesSettings, renderProductIssuesSettings, triggerActionSettings);
      initDefaults(this);
    }

    protected Builder(IssueResolutionServiceStubSettings settings) {
      super(settings);

      renderAccountIssuesSettings = settings.renderAccountIssuesSettings.toBuilder();
      renderProductIssuesSettings = settings.renderProductIssuesSettings.toBuilder();
      triggerActionSettings = settings.triggerActionSettings.toBuilder();
    ...
    @Override
    public IssueResolutionServiceStubSettings build() throws IOException {
      return new IssueResolutionServiceStubSettings(this);
    }
  }
}
