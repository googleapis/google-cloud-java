...
public class RestorePlanBindingName implements ResourceName {
  ...
  public static @Nullable RestorePlanBindingName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RestorePlanBindingName> values) {
