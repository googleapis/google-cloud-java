...
public final class RestorePlanProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "/restore.proto\032\037google/protobuf/timestamp.proto\"\376\006\n"
          ...
          + "\013backup_plan\030\006 \001(\tB.\340A\005\340A\002\372A%\n"
          + "#gkebackup.googleapis.com/BackupPlan\022<\n"
          + "\007cluster\030\007 \001(\tB+\340A\005\340A\002\372A\"\n"
          + " container.googleapis.com/Cluster\022E\n"
          + "\016restore_config\030\010"
          + " \001(\0132(.google.cloud.gkebackup.v1.RestoreConfigB\003\340A\002\022G\n"
          + "\006labels\030\t"
          + " \003(\01322.google.cloud.gkebackup.v1.RestorePlan.LabelsEntryB\003\340A\001\022\021\n"
          + "\004etag\030\n"
          + " \001(\tB\003\340A\003\022@\n"
          + "\005state\030\013"
          + " \001(\0162,.google.cloud.gkebackup.v1.RestorePlan.StateB\003\340A\003\022\031\n"
          + "\014state_reason\030\014 \001(\tB\003\340A\003\022H\n"
          + "\017restore_channel\030\r"
          + " \001(\tB/\340A\003\372A)\n"
          + "\'gkebackup.googleapis.com/RestoreChannel\032-\n"
          ...
          + "$gkebackup.googleapis.com/RestorePlan\022Cpro"
          + "jects/{project}/locations/{location}/restorePlans/{restore_plan}B\307\001\n"
          + "\035com.google.cloud.gkebackup.v1B\020RestorePlanProtoP\001Z;"
    ...
    internal_static_google_cloud_gkebackup_v1_RestorePlan_LabelsEntry_descriptor =
        internal_static_google_cloud_gkebackup_v1_RestorePlan_descriptor.getNestedType(0);
    internal_static_google_cloud_gkebackup_v1_RestorePlan_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkebackup_v1_RestorePlan_LabelsEntry_descriptor,
            new java.lang.String[] {
