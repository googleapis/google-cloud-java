  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "field_behavior.proto\032\031google/api/resource.proto\"%\n\n"
          + "Namespaces\022\027\n\n"
          + "namespaces\030\001 \003(\tB\003\340A\001\";\n"
          + "\016NamespacedName\022\026\n"
          + "\tnamespace\030\001 \001(\tB\003\340A\001\022\021\n"
          + "\004name\030\002 \001(\tB\003\340A\001\"[\n"
          + "\017NamespacedNames\022H\n"
          + "\020namespaced_names\030\001 \003(\0132).googl"
          + "e.cloud.gkebackup.v1.NamespacedNameB\003\340A\001\"Z\n\r"
          + "EncryptionKey\022I\n"
          + "\026gcp_kms_encryption_key\030\001 \001(\tB)\340A\001\372A#\n"
          + "!cloudkms.googleapis.com/CryptoKey\"T\n"
          + "\016VolumeTypeEnum\"B\n\n"
          + "VolumeType\022\033\n"
          + "\027VOLUME_TYPE_UNSPECIFIED\020\000\022\027\n"
          + "\023GCE_PERSISTENT_DISK\020\001B\302\001\n"
          + "\035com.google.cloud.gkebackup.v1B\013CommonProtoP\001Z;cloud.googl"
          + "e.com/go/gkebackup/apiv1/gkebackuppb;gke"
          + "backuppb\252\002\031Google.Cloud.GkeBackup.V1\312\002\031G"
          + "oogle\\Cloud\\GkeBackup\\V1\352\002\034Google::Cloud::GkeBackup::V1b\006proto3"
    };
    descriptor =
