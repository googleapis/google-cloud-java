  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "n.proto\032\037google/protobuf/timestamp.proto\"\276\016\n"
          + "\006Backup\022\021\n"
          ...
          + "\006manual\030\005 \001(\010B\003\340A\003\022B\n"
          + "\006labels\030\006 \003(\0132-.goog"
          + "le.cloud.gkebackup.v1.Backup.LabelsEntryB\003\340A\001\022\035\n"
          + "\020delete_lock_days\030\007 \001(\005B\003\340A\001\022@\n"
          + "\027delete_lock_expire_time\030\010"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022\030\n"
          + "\013retain_days\030\t \001(\005B\003\340A\001\022;\n"
          + "\022retain_expire_time\030\n"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022E\n"
          + "\016encryption_key\030\013"
          + " \001(\0132(.google.cloud.gkebackup.v1.EncryptionKeyB\003\340A\003\022\035\n"
          + "\016all_namespaces\030\014 \001(\010B\003\340A\003H\000\022I\n"
          + "\023selected_namespaces\030\r"
          + " \001(\0132%.google.cloud.gkebackup.v1.NamespacesB\003\340A\003H\000\022P\n"
          + "\025selected_applications\030\016 \001(\0132*."
          + "google.cloud.gkebackup.v1.NamespacedNamesB\003\340A\003H\000\022!\n"
          + "\024contains_volume_data\030\017 \001(\010B\003\340A\003\022\035\n"
          + "\020contains_secrets\030\020 \001(\010B\003\340A\003\022P\n"
          + "\020cluster_metadata\030\021"
          + " \001(\01321.google.cloud.gkebackup.v1.Backup.ClusterMetadataB\003\340A\003\022;\n"
          + "\005state\030\022"
          + " \001(\0162\'.google.cloud.gkebackup.v1.Backup.StateB\003\340A\003\022\031\n"
          + "\014state_reason\030\023 \001(\tB\003\340A\003\0226\n\r"
          + "complete_time\030\024 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022\033\n"
          ...
          + "\030config_backup_size_bytes\030\033 \001(\003B\003\340A\003\022\034\n"
          + "\017permissive_mode\030\034 \001(\010B\003\340A\003\022\032\n\r"
          + "satisfies_pzs\030\035 \001(\010B\003\340A\003\022\032\n\r"
          + "satisfies_pzi\030\036 \001(\010B\003\340A\003\032\266\002\n"
          + "\017ClusterMetadata\022\024\n"
          + "\007cluster\030\001 \001(\tB\003\340A\003\022\030\n"
          + "\013k8s_version\030\002 \001(\tB\003\340A\003\022j\n"
          + "\023backup_crd_versions\030\003 \003(\0132H.googl"
          + "e.cloud.gkebackup.v1.Backup.ClusterMetadata.BackupCrdVersionsEntryB\003\340A\003\022\032\n"
          ...
          + "\037gkebackup.googleapis.com/Backup\022Rprojects/{project}/locations/{location}/b"
          + "ackupPlans/{backup_plan}/backups/{backup}B\016\n"
          + "\014backup_scopeB\302\001\n"
          + "\035com.google.cloud.gkebackup.v1B\013BackupProtoP\001Z;cloud.google"
          + ".com/go/gkebackup/apiv1/gkebackuppb;gkeb"
          + "ackuppb\252\002\031Google.Cloud.GkeBackup.V1\312\002\031Go"
          + "ogle\\Cloud\\GkeBackup\\V1\352\002\034Google::Cloud::GkeBackup::V1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_gkebackup_v1_Backup_descriptor = getDescriptor().getMessageType(0);
    internal_static_google_cloud_gkebackup_v1_Backup_fieldAccessorTable =
    ...
    internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_descriptor =
        internal_static_google_cloud_gkebackup_v1_Backup_descriptor.getNestedType(0);
    internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_BackupCrdVersionsEntry_descriptor =
        internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_descriptor.getNestedType(
            0);
    internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_BackupCrdVersionsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkebackup_v1_Backup_ClusterMetadata_BackupCrdVersionsEntry_descriptor,
    ...
    internal_static_google_cloud_gkebackup_v1_Backup_LabelsEntry_descriptor =
        internal_static_google_cloud_gkebackup_v1_Backup_descriptor.getNestedType(1);
    internal_static_google_cloud_gkebackup_v1_Backup_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkebackup_v1_Backup_LabelsEntry_descriptor,
            new java.lang.String[] {
