...
public class BackupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_BACKUP_PLAN_BACKUP =
  ...
  public static BackupName of(String project, String location, String backupPlan, String backup) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String backupPlan, String backup) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setBackupPlan(backupPlan)
  ...
  public static BackupName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_BACKUP_PLAN_BACKUP.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_BACKUP_PLAN_BACKUP.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_BACKUP_PLAN_BACKUP.instantiate(
        "project", project, "location", location, "backup_plan", backupPlan, "backup", backup);
  }
  ...
  public static class Builder {
    ...
    private Builder(BackupName backupName) {
      ...
      this.backupPlan = backupName.backupPlan;
