...
public final class CreateBackupRequest extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18:
            {
              com.google.cloud.gkebackup.v1.Backup.Builder subBuilder = null;
              if (backup_ != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.gkebackup.v1.CreateBackupRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.gkebackup.v1.CreateBackupRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeBackup(com.google.cloud.gkebackup.v1.Backup value) {
      if (backupBuilder_ == null) {
        if (backup_ != null) {
          backup_ =
              com.google.cloud.gkebackup.v1.Backup.newBuilder(backup_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          backup_ = value;
