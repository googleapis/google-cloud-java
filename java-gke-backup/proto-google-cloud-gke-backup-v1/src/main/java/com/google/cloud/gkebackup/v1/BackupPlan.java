...
public final class BackupPlan extends com.google.protobuf.GeneratedMessage
  ...
  public static final class Schedule extends com.google.protobuf.GeneratedMessage
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cronSchedule_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, cronSchedule_);
      }
      if (paused_ != false) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cronSchedule_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, cronSchedule_);
      }
      if (paused_ != false) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetRpoConfigFieldBuilder();
          internalGetNextScheduledBackupTimeFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetRpoConfigFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000004;
                  break;
                } // case 26
              case 34:
                {
                  input.readMessage(
                      internalGetNextScheduledBackupTimeFieldBuilder().getBuilder(),
                      extensionRegistry);
      ...
      public com.google.cloud.gkebackup.v1.RpoConfig.Builder getRpoConfigBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetRpoConfigFieldBuilder().getBuilder();
      }
      ...
      public com.google.protobuf.Timestamp.Builder getNextScheduledBackupTimeBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
        return internalGetNextScheduledBackupTimeFieldBuilder().getBuilder();
      }
   ...
   */
  public static final class BackupConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private BackupConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetSelectedApplicationsFieldBuilder().getBuilder(),
                      extensionRegistry);
                  backupScopeCase_ = 3;
                  break;
                } // case 26
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cluster_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, cluster_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(stateReason_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 15, stateReason_);
    }
    if (rpoRiskLevel_ != 0) {
      output.writeInt32(16, rpoRiskLevel_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rpoRiskReason_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 17, rpoRiskReason_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(backupChannel_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 18, backupChannel_);
    }
    if (((bitField0_ & 0x00000020) != 0)) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cluster_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, cluster_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(stateReason_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(15, stateReason_);
    }
    if (rpoRiskLevel_ != 0) {
      size += com.google.protobuf.CodedOutputStream.computeInt32Size(16, rpoRiskLevel_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(rpoRiskReason_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(17, rpoRiskReason_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(backupChannel_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(18, backupChannel_);
    }
    if (((bitField0_ & 0x00000020) != 0)) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
              19, getLastSuccessfulBackupTime());
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetBackupConfigFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98:
              {
                input.readMessage(
                    internalGetBackupConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.gkebackup.v1.BackupPlan.BackupConfig.Builder getBackupConfigBuilder() {
      bitField0_ |= 0x00000800;
      onChanged();
      return internalGetBackupConfigFieldBuilder().getBuilder();
    }
