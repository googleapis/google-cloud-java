...
/**
 * A client to Cloud API Registry API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= CloudApiRegistryClient =======================
 *
 * <p>Service Description: The Cloud API Registry service provides a central registry for managing
 * API Data.
 *
 * <p>Sample for CloudApiRegistryClient:
 *
 * <pre>{@code
