...
import com.google.cloud.hypercomputecluster.v1beta.stub.HttpJsonHypercomputeClusterStub;
...
public class HypercomputeClusterClientHttpJsonTest {
  private static MockHttpService mockService;
  private static HypercomputeClusterClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonHypercomputeClusterStub.getMethodDescriptors(),
            HypercomputeClusterSettings.getDefaultEndpoint());
    HypercomputeClusterSettings settings =
        HypercomputeClusterSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                HypercomputeClusterSettings.defaultHttpJsonTransportProviderBuilder()
