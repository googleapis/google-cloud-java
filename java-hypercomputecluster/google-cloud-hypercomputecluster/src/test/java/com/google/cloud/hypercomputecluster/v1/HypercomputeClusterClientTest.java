...
public class HypercomputeClusterClientTest {
  private static MockHypercomputeCluster mockHypercomputeCluster;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private HypercomputeClusterClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockHypercomputeCluster = new MockHypercomputeCluster();
    mockLocations = new MockLocations();
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(),
            Arrays.<MockGrpcService>asList(mockHypercomputeCluster, mockLocations));
  ...
  public void setUp() throws IOException {
    ...
    HypercomputeClusterSettings settings =
        HypercomputeClusterSettings.newBuilder()
            .setTransportChannelProvider(channelProvider)
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = HypercomputeClusterClient.create(settings);
  }
  ...
  public void listClustersTest() throws Exception {
    ...
    ListClustersResponse expectedResponse =
        ListClustersResponse.newBuilder()
            ...
            .build();
    mockHypercomputeCluster.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockHypercomputeCluster.getRequests();
  ...
  public void listClustersExceptionTest() throws Exception {
    ...
    mockHypercomputeCluster.addException(exception);
  ...
  public void getClusterTest() throws Exception {
    Cluster expectedResponse =
        Cluster.newBuilder()
            ...
            .setReconciling(true)
            .putAllNetworkResources(new HashMap<String, NetworkResource>())
            .putAllStorageResources(new HashMap<String, StorageResource>())
            .putAllComputeResources(new HashMap<String, ComputeResource>())
            .setOrchestrator(Orchestrator.newBuilder().build())
            .build();
    mockHypercomputeCluster.addResponse(expectedResponse);
  ...
  public void createClusterTest() throws Exception {
    ...
    Operation resultOperation =
        Operation.newBuilder()
            ...
            .build();
    mockHypercomputeCluster.addResponse(resultOperation);
