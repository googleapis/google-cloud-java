...
import com.google.cloud.hypercomputecluster.v1.DeleteClusterRequest;
...
import com.google.cloud.hypercomputecluster.v1.OperationMetadata;
...
/**
 * Settings class to configure an instance of {@link HypercomputeClusterStub}.
 *
...
public class HypercomputeClusterStubSettings extends StubSettings<HypercomputeClusterStubSettings> {
  ...
  public HypercomputeClusterStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcHypercomputeClusterStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonHypercomputeClusterStub.create(this);
    }
  ...
  public static String getDefaultEndpoint() {
    return "hypercomputecluster.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "hypercomputecluster.mtls.googleapis.com:443";
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(HypercomputeClusterStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return HypercomputeClusterStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected HypercomputeClusterStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<HypercomputeClusterStubSettings, Builder> {
    ...
    @Override
    public HypercomputeClusterStubSettings build() throws IOException {
      return new HypercomputeClusterStubSettings(this);
    }
  }
}
