...
```Scala
libraryDependencies += "com.google.cloud" % "google-iam-admin" % "3.53.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-iam-admin/3.53.0
