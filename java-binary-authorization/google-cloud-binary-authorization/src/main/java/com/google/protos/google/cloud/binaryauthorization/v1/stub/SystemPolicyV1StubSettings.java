...
/**
 * Settings class to configure an instance of {@link SystemPolicyV1Stub}.
 *
...
public class SystemPolicyV1StubSettings extends StubSettings<SystemPolicyV1StubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<Service.GetSystemPolicyRequest, Resources.Policy>
      getSystemPolicySettings;
  ...
  public SystemPolicyV1Stub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcSystemPolicyV1Stub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonSystemPolicyV1Stub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SystemPolicyV1StubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SystemPolicyV1StubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected SystemPolicyV1StubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<SystemPolicyV1StubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<Service.GetSystemPolicyRequest, Resources.Policy>
        getSystemPolicySettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(getSystemPolicySettings);
      initDefaults(this);
    }

    protected Builder(SystemPolicyV1StubSettings settings) {
      super(settings);
    ...
    @Override
    public SystemPolicyV1StubSettings build() throws IOException {
      return new SystemPolicyV1StubSettings(this);
    }
  }
}
