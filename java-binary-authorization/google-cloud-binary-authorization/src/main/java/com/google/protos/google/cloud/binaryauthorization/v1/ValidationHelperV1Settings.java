...
public class ValidationHelperV1Settings extends ClientSettings<ValidationHelperV1Settings> {
  ...
  public static class Builder extends ClientSettings.Builder<ValidationHelperV1Settings, Builder> {
