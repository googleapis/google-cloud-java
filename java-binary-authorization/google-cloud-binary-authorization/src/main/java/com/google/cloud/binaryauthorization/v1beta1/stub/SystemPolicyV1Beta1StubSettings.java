...
public class SystemPolicyV1Beta1StubSettings extends StubSettings<SystemPolicyV1Beta1StubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<GetSystemPolicyRequest, Policy> getSystemPolicySettings;
  ...
  public SystemPolicyV1Beta1Stub createStub() throws IOException {
    ...
    if (getTransportChannelProvider()
      ...
      return HttpJsonSystemPolicyV1Beta1Stub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SystemPolicyV1Beta1StubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  public static class Builder
      extends StubSettings.Builder<SystemPolicyV1Beta1StubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetSystemPolicyRequest, Policy> getSystemPolicySettings;
