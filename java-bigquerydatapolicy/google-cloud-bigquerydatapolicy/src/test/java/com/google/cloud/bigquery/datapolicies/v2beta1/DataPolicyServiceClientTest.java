...
public class DataPolicyServiceClientTest {
  ...
  public void createDataPolicyTest() throws Exception {
    ...
    Assert.assertEquals(dataPolicyId, actualRequest.getDataPolicyId());
    Assert.assertTrue(
  ...
  public void addGranteesTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDataPolicyService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    AddGranteesRequest actualRequest = ((AddGranteesRequest) actualRequests.get(0));

    Assert.assertEquals(dataPolicy.toString(), actualRequest.getDataPolicy());
    Assert.assertEquals(grantees, actualRequest.getGranteesList());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void addGranteesTest2() throws Exception {
    ...
    String dataPolicy = "dataPolicy1186306428";
    List<String> grantees = new ArrayList<>();
  ...
  public void removeGranteesTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockDataPolicyService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    RemoveGranteesRequest actualRequest = ((RemoveGranteesRequest) actualRequests.get(0));
