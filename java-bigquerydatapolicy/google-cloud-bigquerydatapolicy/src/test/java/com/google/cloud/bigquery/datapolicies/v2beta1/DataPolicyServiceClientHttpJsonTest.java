...
import com.google.cloud.bigquery.datapolicies.v2beta1.stub.HttpJsonDataPolicyServiceStub;
...
public class DataPolicyServiceClientHttpJsonTest {
  ...
  public void createDataPolicyTest() throws Exception {
    DataPolicy expectedResponse =
        DataPolicy.newBuilder()
            ...
            .setEtag("etag3123477")
            .setPolicyTag("policyTag-225690360")
    ...
    DataPolicy actualResponse = client.createDataPolicy(parent, dataPolicy, dataPolicyId);
  ...
  public void createDataPolicyExceptionTest() throws Exception {
    ...
    try {
      ...
      DataPolicy dataPolicy = DataPolicy.newBuilder().build();
      String dataPolicyId = "dataPolicyId1874146231";
      client.createDataPolicy(parent, dataPolicy, dataPolicyId);
  ...
  @Test
  public void addGranteesTest() throws Exception {
    DataPolicy expectedResponse =
        DataPolicy.newBuilder()
            .setName(DataPolicyName.of("[PROJECT]", "[LOCATION]", "[DATA_POLICY]").toString())
            .setDataPolicyId("dataPolicyId1874146231")
    ...
    DataPolicy actualResponse = client.addGrantees(dataPolicy, grantees);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void addGranteesExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
    ...
    try {
      DataPolicyName dataPolicy = DataPolicyName.of("[PROJECT]", "[LOCATION]", "[DATA_POLICY]");
      List<String> grantees = new ArrayList<>();
      client.addGrantees(dataPolicy, grantees);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  @Test
  public void addGranteesTest2() throws Exception {
    DataPolicy expectedResponse =
        DataPolicy.newBuilder()
            .setName(DataPolicyName.of("[PROJECT]", "[LOCATION]", "[DATA_POLICY]").toString())
            .setDataPolicyId("dataPolicyId1874146231")
    ...
    String dataPolicy =
        "projects/project-1209/locations/location-1209/dataPolicies/dataPolicie-1209";
    List<String> grantees = new ArrayList<>();
  ...
  @Test
  public void addGranteesExceptionTest2() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void removeGranteesTest() throws Exception {
    DataPolicy expectedResponse =
        DataPolicy.newBuilder()
            .setName(DataPolicyName.of("[PROJECT]", "[LOCATION]", "[DATA_POLICY]").toString())
            .setDataPolicyId("dataPolicyId1874146231")
    ...
    DataPolicy actualResponse = client.removeGrantees(dataPolicy, grantees);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  @Test
  public void removeGranteesExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
    ...
    try {
      DataPolicyName dataPolicy = DataPolicyName.of("[PROJECT]", "[LOCATION]", "[DATA_POLICY]");
      List<String> grantees = new ArrayList<>();
      client.removeGrantees(dataPolicy, grantees);
      Assert.fail("No exception raised");
    } catch (InvalidArgumentException e) {
      // Expected exception.
    }
  ...
  @Test
  public void removeGranteesTest2() throws Exception {
    DataPolicy expectedResponse =
        DataPolicy.newBuilder()
            .setName(DataPolicyName.of("[PROJECT]", "[LOCATION]", "[DATA_POLICY]").toString())
            .setDataPolicyId("dataPolicyId1874146231")
  ...
  @Test
  public void removeGranteesExceptionTest2() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
