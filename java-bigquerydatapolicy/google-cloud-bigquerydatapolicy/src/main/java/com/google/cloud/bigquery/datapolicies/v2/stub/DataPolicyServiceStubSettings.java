...
public class DataPolicyServiceStubSettings extends StubSettings<DataPolicyServiceStubSettings> {
  ...
  private final UnaryCallSettings<AddGranteesRequest, DataPolicy> addGranteesSettings;
  private final UnaryCallSettings<RemoveGranteesRequest, DataPolicy> removeGranteesSettings;
  ...
  protected DataPolicyServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    addGranteesSettings = settingsBuilder.addGranteesSettings().build();
    removeGranteesSettings = settingsBuilder.removeGranteesSettings().build();
  ...
  public static class Builder extends StubSettings.Builder<DataPolicyServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<CreateDataPolicyRequest, DataPolicy>
        createDataPolicySettings;
    private final UnaryCallSettings.Builder<AddGranteesRequest, DataPolicy> addGranteesSettings;
    private final UnaryCallSettings.Builder<RemoveGranteesRequest, DataPolicy>
    ...
    static {
      ...
      settings =
          RetrySettings.newBuilder()
              ...
              .setInitialRpcTimeoutDuration(Duration.ofMillis(64000L))
              .setRpcTimeoutMultiplier(1.0)
              .setMaxRpcTimeoutDuration(Duration.ofMillis(64000L))
              .setTotalTimeoutDuration(Duration.ofMillis(64000L))
              .build();
    ...
    protected Builder(ClientContext clientContext) {
      ...
      addGranteesSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      removeGranteesSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(DataPolicyServiceStubSettings settings) {
      ...
      addGranteesSettings = settings.addGranteesSettings.toBuilder();
      removeGranteesSettings = settings.removeGranteesSettings.toBuilder();
