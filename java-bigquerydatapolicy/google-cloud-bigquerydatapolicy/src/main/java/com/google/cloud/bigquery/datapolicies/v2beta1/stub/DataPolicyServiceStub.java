...
public abstract class DataPolicyServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<AddGranteesRequest, DataPolicy> addGranteesCallable() {
    throw new UnsupportedOperationException("Not implemented: addGranteesCallable()");
  }

  public UnaryCallable<RemoveGranteesRequest, DataPolicy> removeGranteesCallable() {
    throw new UnsupportedOperationException("Not implemented: removeGranteesCallable()");
  }
