  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "google/api/routing.proto\032#google/cloud/run/v2/condition.proto\032#google/cloud/run/"
          + "v2/execution.proto\032,google/cloud/run/v2/execution_template.proto\032!google/cloud/r"
          ...
          + "\036google/protobuf/duration.proto\032\037google/protobuf/timestamp.proto\"\232\001\n"
          + "\020CreateJobRequest\022.\n"
          + "\006parent\030\001 \001(\tB\036\340A\002\372A\030\022\026run.googleapis.com/Job\022*\n"
          + "\003job\030\002 \001(\0132\030.google.cloud.run.v2.JobB\003\340A\002\022\023\n"
          + "\006job_id\030\003 \001(\tB\003\340A\002\022\025\n\r"
          + "validate_only\030\004 \001(\010\"=\n\r"
          + "GetJobRequest\022,\n"
          ...
          + "allow_missing\030\004 \001(\010B\003\340A\001\"~\n"
          + "\017ListJobsRequest\022.\n"
          + "\006parent\030\001 \001("
          + "\tB\036\340A\002\372A\030\022\026run.googleapis.com/Job\022\021\n"
          ...
          + "\toverrides\030\004 \001(\0132,.go"
          + "ogle.cloud.run.v2.RunJobRequest.Overrides\032\246\002\n"
          + "\tOverrides\022[\n"
          + "\023container_overrides\030\001"
          + " \003(\0132>.google.cloud.run.v2.RunJobRequest.Overrides.ContainerOverride\022\027\n\n"
          + "task_count\030\002 \001(\005B\003\340A\001\022*\n"
          + "\007timeout\030\004 \001(\0132\031.google.protobuf.Duration\032w\n"
          ...
          + "last_modifier\030\013 \001(\tB\003\340A\003\022\016\n"
          + "\006client\030\014 \001(\t\022\026\n"
          + "\016client_version\030\r"
          + " \001(\t\022-\n"
          + "\014launch_stage\030\016 \001(\0162\027.google.api.LaunchStage\022F\n"
          + "\024binary_authorization\030\017"
          + " \001(\0132(.google.cloud.run.v2.BinaryAuthorization\022=\n"
          + "\010template\030\020"
          + " \001(\0132&.google.cloud.run.v2.ExecutionTemplateB\003\340A\002\022 \n"
          + "\023observed_generation\030\021 \001(\003B\003\340A\003\022?\n"
          + "\022terminal_condition\030\022"
          + " \001(\0132\036.google.cloud.run.v2.ConditionB\003\340A\003\0227\n\n"
          + "conditions\030\023"
          + " \003(\0132\036.google.cloud.run.v2.ConditionB\003\340A\003\022\034\n"
          + "\017execution_count\030\024 \001(\005B\003\340A\003\022N\n"
          + "\030latest_created_execution\030\026"
          + " \001(\0132\'.google.cloud.run.v2.ExecutionReferenceB\003\340A\003\022\030\n"
          ...
          + "\026ru"
          + "n.googleapis.com/Job\0222projects/{project}/locations/{location}/jobs/{job}R\001\001B\022\n"
          ...
          + "\013delete_time\030\005 \001(\0132\032.google.protobuf.Timestamp\022S\n"
          + "\021completion_status\030\004 \001(\01628.google.cloud"
          + ".run.v2.ExecutionReference.CompletionStatus\"\253\001\n"
          + "\020CompletionStatus\022!\n"
          + "\035COMPLETION_STATUS_UNSPECIFIED\020\000\022\027\n"
          + "\023EXECUTION_SUCCEEDED\020\001\022\024\n"
          + "\020EXECUTION_FAILED\020\002\022\025\n"
          + "\021EXECUTION_RUNNING\020\003\022\025\n"
          + "\021EXECUTION_PENDING\020\004\022\027\n"
          + "\023EXECUTION_CANCELLED\020\0052\212\016\n"
          + "\004Jobs\022\335\001\n"
          + "\tCreateJob"
          + "\022%.google.cloud.run.v2.CreateJobRequest\032\035.google.longrunning.Operation\"\211\001\312A\n\n"
          + "\003Job\022\003Job\332A\021parent,job,job_id\202\323\344\223\002/\"(/v2/{p"
          + "arent=projects/*/locations/*}/jobs:\003job\212\323\344\223\002-\022+\n"
          + "\006parent\022!projects/*/locations/{location=*}\022\263\001\n"
          + "\006GetJob\022\".google.cloud.run.v2.GetJobRequest\032\030.google.cloud.run.v2."
          + "Job\"k\332A\004name\202\323\344\223\002*\022(/v2/{name=projects/*/locations/*/jobs/*}\212\323\344\223\002.\022,\n"
          + "\004name\022$projects/*/locations/{location=*}/**\022\305\001\n"
          + "\010ListJobs\022$.google.cloud.run.v2.ListJobsRequ"
          + "est\032%.google.cloud.run.v2.ListJobsRespon"
          + "se\"l\332A\006parent\202\323\344\223\002*\022(/v2/{parent=projects/*/locations/*}/jobs\212\323\344\223\002-\022+\n"
          + "\006parent\022!projects/*/locations/{location=*}\022\330\001\n"
          + "\tUpdateJob\022%.google.cloud.run.v2.UpdateJobRe"
          + "quest\032\035.google.longrunning.Operation\"\204\001\312A\n\n"
          + "\003Job\022\003Job\332A\003job\202\323\344\223\00232,/v2/{job.name="
          + "projects/*/locations/*/jobs/*}:\003job\212\323\344\223\0022\0220\n"
          + "\010job.name\022$projects/*/locations/{location=*}/**\022\313\001\n"
          + "\tDeleteJob\022%.google.cloud"
          + ".run.v2.DeleteJobRequest\032\035.google.longrunning.Operation\"x\312A\n\n"
          + "\003Job\022\003Job\332A\004name\202\323\344"
          + "\223\002**(/v2/{name=projects/*/locations/*/jobs/*}\212\323\344\223\002.\022,\n"
          + "\004name\022$projects/*/locations/{location=*}/**\022\331\001\n"
          + "\006RunJob\022\".google.cl"
          + "oud.run.v2.RunJobRequest\032\035.google.longrunning.Operation\"\213\001\312A\026\n"
          + "\tExecution\022\tExecut"
          + "ion\332A\004name\202\323\344\223\0021\",/v2/{name=projects/*/locations/*/jobs/*}:run:\001*\212\323\344\223\002.\022,\n"
          + "\004name\022$projects/*/locations/{location=*}/**\022\214\001\n"
          + "\014GetIamPolicy\022\".google.iam.v1.GetIamPol"
          + "icyRequest\032\025.google.iam.v1.Policy\"A\202\323\344\223\002"
          + ";\0229/v2/{resource=projects/*/locations/*/jobs/*}:getIamPolicy\022\217\001\n"
          + "\014SetIamPolicy\022\".google.iam.v1.SetIamPolicyRequest\032\025.goog"
          + "le.iam.v1.Policy\"D\202\323\344\223\002>\"9/v2/{resource="
          + "projects/*/locations/*/jobs/*}:setIamPolicy:\001*\022\265\001\n"
          + "\022TestIamPermissions\022(.google.iam.v1.TestIamPermissionsRequest\032).google"
          + ".iam.v1.TestIamPermissionsResponse\"J\202\323\344\223"
          + "\002D\"?/v2/{resource=projects/*/locations/*"
          + "/jobs/*}:testIamPermissions:\001*\032F\312A\022run.g"
          + "oogleapis.com\322A.https://www.googleapis.com/auth/cloud-platformBP\n"
          + "\027com.google.cloud.run.v2B\010JobProtoP\001Z)cloud.google.com/"
          + "go/run/apiv2/runpb;runpbb\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_run_v2_RunJobRequest_Overrides_descriptor =
        internal_static_google_cloud_run_v2_RunJobRequest_descriptor.getNestedType(0);
    internal_static_google_cloud_run_v2_RunJobRequest_Overrides_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_run_v2_RunJobRequest_Overrides_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_run_v2_RunJobRequest_Overrides_ContainerOverride_descriptor =
        internal_static_google_cloud_run_v2_RunJobRequest_Overrides_descriptor.getNestedType(0);
    internal_static_google_cloud_run_v2_RunJobRequest_Overrides_ContainerOverride_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_run_v2_RunJobRequest_Overrides_ContainerOverride_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_run_v2_Job_descriptor = getDescriptor().getMessageType(7);
    internal_static_google_cloud_run_v2_Job_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_run_v2_Job_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_run_v2_Job_LabelsEntry_descriptor =
        internal_static_google_cloud_run_v2_Job_descriptor.getNestedType(0);
    internal_static_google_cloud_run_v2_Job_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_run_v2_Job_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_run_v2_Job_AnnotationsEntry_descriptor =
        internal_static_google_cloud_run_v2_Job_descriptor.getNestedType(1);
    internal_static_google_cloud_run_v2_Job_AnnotationsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_run_v2_Job_AnnotationsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_run_v2_ExecutionReference_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_run_v2_ExecutionReference_descriptor,
            new java.lang.String[] {
              "Name", "CreateTime", "CompletionTime", "DeleteTime", "CompletionStatus",
            });
