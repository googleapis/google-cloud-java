...
public class BuildWorkerPoolName implements ResourceName {
  ...
  public static @Nullable BuildWorkerPoolName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BuildWorkerPoolName> values) {
