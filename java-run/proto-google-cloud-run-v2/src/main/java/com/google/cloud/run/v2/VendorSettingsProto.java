  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "#networkservices.googleapis.com/Mesh\"\305\001\n"
          + "\016ServiceScaling\022\037\n"
          + "\022min_instance_count\030\001 \001(\005B\003\340A\001\022J\n"
          + "\014scaling_mode\030\003 \001("
          + "\0162/.google.cloud.run.v2.ServiceScaling.ScalingModeB\003\340A\001\"F\n"
          ...
          + "\027com.google.cloud.run.v2B\023VendorSettingsProt"
          + "oP\001Z)cloud.google.com/go/run/apiv2/runpb;runpb\352Ac\n"
          + ")binaryauthorization.googleapi"
          + "s.com/Policy\022\031projects/{project}/policy\022\033locations/{location}/policy\352A\\\n"
          + "#networkservices.googleapis.com/Mesh\0225projects/{"
          + "project}/locations/{location}/meshes/{mesh}b\006proto3"
    };
    descriptor =
