  ...
  static {
    java.lang.String[] descriptorData = {
      "\n!google/cloud/run/v2/service.proto\022\023goo"
          ...
          + "atisfies_pzs\030& \001(\010B\003\340A\003\022\030\n\013reconciling\030b"
          ...
          + "}/services/{service}R\001\0012\267\r\n\010Services\022\375\001\n"
          + "\rCreateService\022).google.cloud.run.v2.Cre"
          + "ateServiceRequest\032\035.google.longrunning.O"
          + "peration\"\241\001\202\323\344\223\0027\",/v2/{parent=projects/"
          + "*/locations/*}/services:\007service\212\323\344\223\002-\022+"
          + "\n\006parent\022!projects/*/locations/{location"
          + "=*}\332A\031parent,service,service_id\312A\022\n\007Serv"
          + "ice\022\007Service\022\303\001\n\nGetService\022&.google.clo"
          + "ud.run.v2.GetServiceRequest\032\034.google.clo"
          + "ud.run.v2.Service\"o\202\323\344\223\002.\022,/v2/{name=pro"
          + "jects/*/locations/*/services/*}\212\323\344\223\002.\022,\n"
          + "\004name\022$projects/*/locations/{location=*}"
          + "/**\332A\004name\022\325\001\n\014ListServices\022(.google.clo"
          + "ud.run.v2.ListServicesRequest\032).google.c"
          + "loud.run.v2.ListServicesResponse\"p\202\323\344\223\002."
          + "\022,/v2/{parent=projects/*/locations/*}/se"
          + "rvices\212\323\344\223\002-\022+\n\006parent\022!projects/*/locat"
          + "ions/{location=*}\332A\006parent\022\374\001\n\rUpdateSer"
          + "vice\022).google.cloud.run.v2.UpdateService"
          + "Request\032\035.google.longrunning.Operation\"\240"
          + "\001\202\323\344\223\002?24/v2/{service.name=projects/*/lo"
          + "cations/*/services/*}:\007service\212\323\344\223\0026\0224\n\014"
          + "service.name\022$projects/*/locations/{loca"
          + "tion=*}/**\332A\007service\312A\022\n\007Service\022\007Servic"
          + "e\022\340\001\n\rDeleteService\022).google.cloud.run.v"
          + "2.DeleteServiceRequest\032\035.google.longrunn"
          + "ing.Operation\"\204\001\202\323\344\223\002.*,/v2/{name=projec"
          + "ts/*/locations/*/services/*}\212\323\344\223\002.\022,\n\004na"
          + "me\022$projects/*/locations/{location=*}/**"
          + "\332A\004name\312A\022\n\007Service\022\007Service\022\220\001\n\014GetIamP"
