  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\"google/cloud/run/v2/revision.proto\022\023go"
          ...
          + "ryptoKey\0226\n\014service_mesh\030\026 \001(\0132 .google."
          + "cloud.run.v2.ServiceMesh\022\\\n encryption_k"
          + "ey_revocation_action\030\027 \001(\01622.google.clou"
          + "d.run.v2.EncryptionKeyRevocationAction\022C"
          + "\n encryption_key_shutdown_duration\030\030 \001(\013"
          + "2\031.google.protobuf.Duration\022\030\n\013reconcili"
          + "ng\030\036 \001(\010B\003\340A\003\0227\n\nconditions\030\037 \003(\0132\036.goog"
          + "le.cloud.run.v2.ConditionB\003\340A\003\022 \n\023observ"
          + "ed_generation\030  \001(\003B\003\340A\003\022\024\n\007log_uri\030! \001("
          + "\tB\003\340A\003\022\032\n\rsatisfies_pzs\030% \001(\010B\003\340A\003\022\030\n\020se"
          + "ssion_affinity\030& \001(\010\022G\n\016scaling_status\030\'"
          + " \001(\0132*.google.cloud.run.v2.RevisionScali"
          + "ngStatusB\003\340A\003\0228\n\rnode_selector\030( \001(\0132!.g"
          + "oogle.cloud.run.v2.NodeSelector\022\021\n\004etag\030"
          + "c \001(\tB\003\340A\003\032-\n\013LabelsEntry\022\013\n\003key\030\001 \001(\t\022\r"
          + "\n\005value\030\002 \001(\t:\0028\001\0322\n\020AnnotationsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t:\0028\001:t\352Aq\n\033run."
          + "googleapis.com/Revision\022Oprojects/{proje"
          + "ct}/locations/{location}/services/{servi"
          + "ce}/revisions/{revision}R\001\0012\205\006\n\tRevision"
          + "s\022\322\001\n\013GetRevision\022\'.google.cloud.run.v2."
          + "GetRevisionRequest\032\035.google.cloud.run.v2"
          + ".Revision\"{\332A\004name\202\323\344\223\002:\0228/v2/{name=proj"
          + "ects/*/locations/*/services/*/revisions/"
          + "*}\212\323\344\223\002.\022,\n\004name\022$projects/*/locations/{"
          + "location=*}/**\022\347\001\n\rListRevisions\022).googl"
          + "e.cloud.run.v2.ListRevisionsRequest\032*.go"
          + "ogle.cloud.run.v2.ListRevisionsResponse\""
          + "\177\332A\006parent\202\323\344\223\002:\0228/v2/{parent=projects/*"
          + "/locations/*/services/*}/revisions\212\323\344\223\0020"
          + "\022.\n\006parent\022$projects/*/locations/{locati"
          + "on=*}/**\022\360\001\n\016DeleteRevision\022*.google.clo"
          + "ud.run.v2.DeleteRevisionRequest\032\035.google"
          + ".longrunning.Operation\"\222\001\312A\024\n\010Revision\022\010"
          + "Revision\332A\004name\202\323\344\223\002:*8/v2/{name=project"
          + "s/*/locations/*/services/*/revisions/*}\212"
          + "\323\344\223\002.\022,\n\004name\022$projects/*/locations/{loc"
          + "ation=*}/**\032F\312A\022run.googleapis.com\322A.htt"
          + "ps://www.googleapis.com/auth/cloud-platf"
          + "ormBU\n\027com.google.cloud.run.v2B\rRevision"
