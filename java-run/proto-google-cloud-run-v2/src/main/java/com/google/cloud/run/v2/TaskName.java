...
public class TaskName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_JOB_EXECUTION_TASK =
  ...
  public static TaskName of(
      String project, String location, String job, String execution, String task) {
    return newBuilder()
        .setProject(project)
  ...
  public static TaskName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_JOB_EXECUTION_TASK.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_JOB_EXECUTION_TASK.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_JOB_EXECUTION_TASK.instantiate(
        "project", project, "location", location, "job", job, "execution", execution, "task", task);
  }
  ...
  public static class Builder {
    ...
    private Builder(TaskName taskName) {
      ...
      this.execution = taskName.execution;
