...
public class InstancesSettings extends ClientSettings<InstancesSettings> {
  ...
  public UnaryCallSettings<CreateInstanceRequest, Operation> createInstanceSettings() {
    return ((InstancesStubSettings) getStubSettings()).createInstanceSettings();
  }

  /** Returns the object with the settings used for calls to createInstance. */
  public OperationCallSettings<CreateInstanceRequest, Instance, Instance>
      createInstanceOperationSettings() {
    return ((InstancesStubSettings) getStubSettings()).createInstanceOperationSettings();
  }
  ...
  public UnaryCallSettings<StopInstanceRequest, Operation> stopInstanceSettings() {
    return ((InstancesStubSettings) getStubSettings()).stopInstanceSettings();
  }

  /** Returns the object with the settings used for calls to stopInstance. */
  public OperationCallSettings<StopInstanceRequest, Instance, Instance>
      stopInstanceOperationSettings() {
    return ((InstancesStubSettings) getStubSettings()).stopInstanceOperationSettings();
  }
  ...
  public UnaryCallSettings<StartInstanceRequest, Operation> startInstanceSettings() {
    return ((InstancesStubSettings) getStubSettings()).startInstanceSettings();
  }

  /** Returns the object with the settings used for calls to startInstance. */
  public OperationCallSettings<StartInstanceRequest, Instance, Instance>
      startInstanceOperationSettings() {
    return ((InstancesStubSettings) getStubSettings()).startInstanceOperationSettings();
  }
