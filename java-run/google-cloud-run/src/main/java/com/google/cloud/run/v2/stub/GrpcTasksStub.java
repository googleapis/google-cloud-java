...
public class GrpcTasksStub extends TasksStub {
  ...
  public static final GrpcTasksStub create(TasksStubSettings settings) throws IOException {
    return new GrpcTasksStub(settings, ClientContext.create(settings));
  }
  ...
  public static final GrpcTasksStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcTasksStub(
        TasksStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcTasksStub, using the given settings. This is protected so that it
