...
import com.google.cloud.run.v2.RevisionsGrpc.RevisionsImplBase;
...
public class MockRevisionsImpl extends RevisionsImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockRevisionsImpl() {
  ...
  public void deleteRevision(
      DeleteRevisionRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteRevision, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
