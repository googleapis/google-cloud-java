...
public class LfpMerchantStateName implements ResourceName {
  ...
  public static @Nullable LfpMerchantStateName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable LfpMerchantStateName> values) {
