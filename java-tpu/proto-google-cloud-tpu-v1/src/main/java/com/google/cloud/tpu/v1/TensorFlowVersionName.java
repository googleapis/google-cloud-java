...
public class TensorFlowVersionName implements ResourceName {
  ...
  public static @Nullable TensorFlowVersionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TensorFlowVersionName> values) {
