...
public interface GuestAttributesValueOrBuilder
   ...
   */
  java.util.List<com.google.cloud.tpu.v2.GuestAttributesEntry> getItemsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.tpu.v2.GuestAttributesEntry items = 1;</code>
   */
  com.google.cloud.tpu.v2.GuestAttributesEntryOrBuilder getItemsOrBuilder(int index);
}
