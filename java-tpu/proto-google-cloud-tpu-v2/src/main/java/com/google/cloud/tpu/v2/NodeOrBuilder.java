...
public interface NodeOrBuilder
   ...
   * </pre>
   *
   * <code>.google.cloud.tpu.v2.Node.State state = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * </code>
   */
  com.google.cloud.tpu.v2.NetworkConfigOrBuilder getNetworkConfigsOrBuilder(int index);
   ...
   * </code>
   */
  com.google.cloud.tpu.v2.NetworkEndpointOrBuilder getNetworkEndpointsOrBuilder(int index);
   ...
   * <code>repeated .google.cloud.tpu.v2.AttachedDisk data_disks = 41;</code>
   */
  com.google.cloud.tpu.v2.AttachedDiskOrBuilder getDataDisksOrBuilder(int index);
   ...
   * </code>
   */
  com.google.cloud.tpu.v2.SymptomOrBuilder getSymptomsOrBuilder(int index);
