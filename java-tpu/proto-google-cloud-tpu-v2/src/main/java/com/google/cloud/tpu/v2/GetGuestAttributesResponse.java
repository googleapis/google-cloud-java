 ...
 * </pre>
 *
 * Protobuf type {@code google.cloud.tpu.v2.GetGuestAttributesResponse}
 */
public final class GetGuestAttributesResponse extends com.google.protobuf.GeneratedMessageV3
    implements
    // @@protoc_insertion_point(message_implements:google.cloud.tpu.v2.GetGuestAttributesResponse)
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.tpu.v2.CloudTpuProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.cloud.tpu.v2.GetGuestAttributesResponse.class,
            com.google.cloud.tpu.v2.GetGuestAttributesResponse.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<com.google.cloud.tpu.v2.GuestAttributes> getGuestAttributesList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.cloud.tpu.v2.GuestAttributesOrBuilder>
   ...
   */
  @java.lang.Override
  public com.google.cloud.tpu.v2.GuestAttributes getGuestAttributes(int index) {
   ...
   */
  @java.lang.Override
  public com.google.cloud.tpu.v2.GuestAttributesOrBuilder getGuestAttributesOrBuilder(int index) {
    return guestAttributes_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.cloud.tpu.v2.GetGuestAttributesResponse)) {
      return super.equals(obj);
    }
    com.google.cloud.tpu.v2.GetGuestAttributesResponse other =
        (com.google.cloud.tpu.v2.GetGuestAttributesResponse) obj;
  ...
  public static com.google.cloud.tpu.v2.GetGuestAttributesResponse parseFrom(
  ...
  public static com.google.cloud.tpu.v2.GetGuestAttributesResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static com.google.cloud.tpu.v2.GetGuestAttributesResponse parseDelimitedFrom(
      java.io.InputStream input) throws java.io.IOException {
  ...
  public static Builder newBuilder(com.google.cloud.tpu.v2.GetGuestAttributesResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.cloud.tpu.v2.GetGuestAttributesResponse)
    ...
    // Construct using com.google.cloud.tpu.v2.GetGuestAttributesResponse.newBuilder()
    private Builder() {}
    ...
    @java.lang.Override
    public com.google.cloud.tpu.v2.GetGuestAttributesResponse getDefaultInstanceForType() {
      return com.google.cloud.tpu.v2.GetGuestAttributesResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.tpu.v2.GetGuestAttributesResponse build() {
      com.google.cloud.tpu.v2.GetGuestAttributesResponse result = buildPartial();
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.tpu.v2.GetGuestAttributesResponse) {
        return mergeFrom((com.google.cloud.tpu.v2.GetGuestAttributesResponse) other);
      } else {
    ...
    public Builder mergeFrom(com.google.cloud.tpu.v2.GetGuestAttributesResponse other) {
      if (other == com.google.cloud.tpu.v2.GetGuestAttributesResponse.getDefaultInstance())
        return this;
      if (guestAttributesBuilder_ == null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.tpu.v2.GuestAttributes m =
                    input.readMessage(
                        com.google.cloud.tpu.v2.GuestAttributes.parser(), extensionRegistry);
                if (guestAttributesBuilder_ == null) {
                  ensureGuestAttributesIsMutable();
    ...
    private void ensureGuestAttributesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        guestAttributes_ =
            new java.util.ArrayList<com.google.cloud.tpu.v2.GuestAttributes>(guestAttributes_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
            ...
            com.google.cloud.tpu.v2.GuestAttributes.Builder,
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public Builder setGuestAttributes(int index, com.google.cloud.tpu.v2.GuestAttributes value) {
      if (guestAttributesBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setGuestAttributes(
        int index, com.google.cloud.tpu.v2.GuestAttributes.Builder builderForValue) {
      if (guestAttributesBuilder_ == null) {
        ensureGuestAttributesIsMutable();
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public Builder addGuestAttributes(com.google.cloud.tpu.v2.GuestAttributes value) {
      if (guestAttributesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public Builder addGuestAttributes(int index, com.google.cloud.tpu.v2.GuestAttributes value) {
      if (guestAttributesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addGuestAttributes(
        com.google.cloud.tpu.v2.GuestAttributes.Builder builderForValue) {
      if (guestAttributesBuilder_ == null) {
        ensureGuestAttributesIsMutable();
    ...
    public Builder addAllGuestAttributes(
        java.lang.Iterable<? extends com.google.cloud.tpu.v2.GuestAttributes> values) {
      if (guestAttributesBuilder_ == null) {
        ensureGuestAttributesIsMutable();
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public com.google.cloud.tpu.v2.GuestAttributes.Builder getGuestAttributesBuilder(int index) {
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public com.google.cloud.tpu.v2.GuestAttributes.Builder addGuestAttributesBuilder() {
      return getGuestAttributesFieldBuilder()
          .addBuilder(com.google.cloud.tpu.v2.GuestAttributes.getDefaultInstance());
    }
    /**
     *
     *
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public com.google.cloud.tpu.v2.GuestAttributes.Builder addGuestAttributesBuilder(int index) {
      return getGuestAttributesFieldBuilder()
          .addBuilder(index, com.google.cloud.tpu.v2.GuestAttributes.getDefaultInstance());
    }
    /**
     *
     *
     ...
     * <code>repeated .google.cloud.tpu.v2.GuestAttributes guest_attributes = 1;</code>
     */
    public java.util.List<com.google.cloud.tpu.v2.GuestAttributes.Builder>
    ...
    // @@protoc_insertion_point(builder_scope:google.cloud.tpu.v2.GetGuestAttributesResponse)
  }

  // @@protoc_insertion_point(class_scope:google.cloud.tpu.v2.GetGuestAttributesResponse)
  private static final com.google.cloud.tpu.v2.GetGuestAttributesResponse DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new com.google.cloud.tpu.v2.GetGuestAttributesResponse();
  }

  public static com.google.cloud.tpu.v2.GetGuestAttributesResponse getDefaultInstance() {
