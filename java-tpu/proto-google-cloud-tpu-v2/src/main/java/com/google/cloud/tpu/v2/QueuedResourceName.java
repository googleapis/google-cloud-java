...
public class QueuedResourceName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_QUEUED_RESOURCE =
  ...
  private QueuedResourceName(Builder builder) {
    ...
    queuedResource = Preconditions.checkNotNull(builder.getQueuedResource());
  }
  ...
  public static @Nullable QueuedResourceName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_QUEUED_RESOURCE.validatedMatch(
            formattedString, "QueuedResourceName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("queued_resource"));
  }

  public static List<QueuedResourceName> parseList(List<String> formattedStrings) {
    List<QueuedResourceName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable QueuedResourceName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (queuedResource != null) {
            fieldMapBuilder.put("queued_resource", queuedResource);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_QUEUED_RESOURCE.instantiate(
        "project", project, "location", location, "queued_resource", queuedResource);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.queuedResource, that.queuedResource);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(queuedResource);
    return h;
  }
