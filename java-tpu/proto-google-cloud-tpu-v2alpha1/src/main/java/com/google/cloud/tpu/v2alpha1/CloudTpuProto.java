  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "pc/status.proto\032\032google/type/interval.proto\"k\n"
          ...
          + "2(.google.cloud.tpu.v2alpha1.NetworkConfig\022\022\n\n"
          + "cidr_block\030\r"
          + " \001(\t\022B\n"
          ...
          + "\010symptoms\030\'"
          + " \003(\0132\".google.cloud.tpu.v2alpha1.SymptomB\003\340A\003\022\034\n"
          + "\017queued_resource\030+ \001(\tB\003\340A\003\022H\n"
          + "\022accelerator_config\030, \001(\0132,.goog"
          + "le.cloud.tpu.v2alpha1.AcceleratorConfig\022S\n"
          + "\030shielded_instance_config\030- \001(\01321.goog"
          + "le.cloud.tpu.v2alpha1.ShieldedInstanceConfig\022\034\n"
          + "\017multislice_node\030/ \001(\010B\003\340A\003\022H\n"
          + "\020boot_disk_config\0301"
          + " \001(\0132).google.cloud.tpu.v2alpha1.BootDiskConfigB\003\340A\001\032-\n"
          ...
          + "\027tpu.goo"
          + "gleapis.com/Node\0224projects/{project}/locations/{location}/nodes/{node}\"\275\013\n"
          ...
          + "gle.cloud.tpu.v2alpha1.QueuedResource.BestEffortH\001\022J\n\n"
          + "guaranteed\030\004 \001(\01324.google."
          + "cloud.tpu.v2alpha1.QueuedResource.GuaranteedH\001\022C\n"
          + "\004spot\030\t"
          + " \001(\0132..google.cloud.tpu.v2alpha1.QueuedResource.SpotB\003\340A\001H\001\022Q\n"
          + "\017queueing_policy\030\005 \001(\01328.google.cloud.tpu."
          + "v2alpha1.QueuedResource.QueueingPolicy\022B\n"
          + "\005state\030\006"
          + " \001(\0132..google.cloud.tpu.v2alpha1.QueuedResourceStateB\003\340A\003\022\030\n"
          + "\020reservation_name\030\010 \001(\t\032\211\003\n"
          + "\003Tpu\022I\n"
          + "\tnode_spec\030\001 \003(\0132"
          + "6.google.cloud.tpu.v2alpha1.QueuedResource.Tpu.NodeSpec\032\266\002\n"
          + "\010NodeSpec\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022\017\n"
          + "\007node_id\030\002 \001(\t\022f\n"
          + "\021multi_node_params\030\006 \001(\0132F.google.cloud.tpu.v2alpha1."
          + "QueuedResource.Tpu.NodeSpec.MultiNodeParamsB\003\340A\001\0222\n"
          + "\004node\030\003 \001(\0132\037.google.cloud.tpu.v2alpha1.NodeB\003\340A\002\032B\n"
          ...
          + "!tpu.googleapis.com/QueuedResource\022Iprojects/{project}/locations/{l"
          + "ocation}/queuedResources/{queued_resource}B\n\n"
          + "\010resourceB\006\n"
          + "\004tier\"\232\n\n"
          + "\023QueuedResourceState\022C\n"
          + "\005state\030\001"
          + " \001(\01624.google.cloud.tpu.v2alpha1.QueuedResourceState.State\022T\n\r"
          + "creating_data\030\002 \001(\0132;.google.cloud.tpu.v2"
          + "alpha1.QueuedResourceState.CreatingDataH\000\022T\n\r"
          + "accepted_data\030\003 \001(\0132;.google.cloud."
          + "tpu.v2alpha1.QueuedResourceState.AcceptedDataH\000\022\\\n"
          + "\021provisioning_data\030\004 \001(\0132?.goo"
          + "gle.cloud.tpu.v2alpha1.QueuedResourceState.ProvisioningDataH\000\022P\n"
          + "\013failed_data\030\005 \001"
          + "(\01329.google.cloud.tpu.v2alpha1.QueuedResourceState.FailedDataH\000\022T\n\r"
          + "deleting_data\030\006"
          + " \001(\0132;.google.cloud.tpu.v2alpha1.QueuedResourceState.DeletingDataH\000\022P\n"
          + "\013active_data\030\007"
          + " \001(\01329.google.cloud.tpu.v2alpha1.QueuedResourceState.ActiveDataH\000\022X\n"
          + "\017suspending_data\030\010 \001(\0132=.google.cloud.tpu.v2al"
          + "pha1.QueuedResourceState.SuspendingDataH\000\022V\n"
          + "\016suspended_data\030\t \001(\0132<.google.cloud"
          + ".tpu.v2alpha1.QueuedResourceState.SuspendedDataH\000\022[\n"
          + "\017state_initiator\030\n"
          + " \001(\0162=.goo"
          + "gle.cloud.tpu.v2alpha1.QueuedResourceState.StateInitiatorB\003\340A\003\032\016\n"
          ...
          + "\004node\030\003"
          + " \001(\0132\037.google.cloud.tpu.v2alpha1.NodeB\003\340A\002\022\022\n\n"
          ...
          + "\0132).google.cloud.tpu.v2alpha1.QueuedResourceB\003\340A\002\022\022\n\n"
          ...
          + "\"tpu.googleapis.com/AcceleratorType\022Kprojects/{p"
          + "roject}/locations/{location}/acceleratorTypes/{accelerator_type}\"U\n"
          + "\031GetAcceleratorTypeRequest\0228\n"
          + "\004name\030\001 \001(\tB*\340A\002\372A$\n"
          + "\"tpu.googleapis.com/AcceleratorType\"\242\001\n"
          + "\033ListAcceleratorTypesRequest\022:\n"
          + "\006parent\030\001 \001(\tB"
          + "*\340A\002\372A$\022\"tpu.googleapis.com/AcceleratorType\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          ...
          + "ojects/{project}/locations/{location}/runtimeVersions/{runtime_version}\"S\n"
          ...
          + "\003key2\236\037\n"
          + "\003Tpu\022\250\001\n"
          + "\tListNodes\022+.google.cloud.tpu.v2alpha1.ListNodesRequest\032,.google."
          + "cloud.tpu.v2alpha1.ListNodesResponse\"@\332A"
          + "\006parent\202\323\344\223\0021\022//v2alpha1/{parent=projects/*/locations/*}/nodes\022\225\001\n"
          + "\007GetNode\022).google.cloud.tpu.v2alpha1.GetNodeRequest\032\037."
          + "google.cloud.tpu.v2alpha1.Node\">\332A\004name\202"
          + "\323\344\223\0021\022//v2alpha1/{name=projects/*/locations/*/nodes/*}\022\312\001\n\n"
          + "CreateNode\022,.google.c"
          + "loud.tpu.v2alpha1.CreateNodeRequest\032\035.google.longrunning.Operation\"o\312A\031\n"
          + "\004Node\022\021OperationMetadata\332A\023parent,node,node_id\202\323"
          + "\344\223\0027\"//v2alpha1/{parent=projects/*/locations/*}/nodes:\004node\022\306\001\n\n"
          + "DeleteNode\022,.goo"
          + "gle.cloud.tpu.v2alpha1.DeleteNodeRequest\032\035.google.longrunning.Operation\"k\312A*\n"
          + "\025google.protobuf.Empty\022\021OperationMetadata\332A"
          + "\004name\202\323\344\223\0021*//v2alpha1/{name=projects/*/locations/*/nodes/*}\022\262\001\n"
          + "\010StopNode\022*.goog"
          + "le.cloud.tpu.v2alpha1.StopNodeRequest\032\035.google.longrunning.Operation\"[\312A\031\n"
          + "\004Node\022\021OperationMetadata\202\323\344\223\0029\"4/v2alpha1/{nam"
          + "e=projects/*/locations/*/nodes/*}:stop:\001*\022\265\001\n"
          + "\tStartNode\022+.google.cloud.tpu.v2alp"
          + "ha1.StartNodeRequest\032\035.google.longrunning.Operation\"\\\312A\031\n"
          + "\004Node\022\021OperationMetadat"
          + "a\202\323\344\223\002:\"5/v2alpha1/{name=projects/*/locations/*/nodes/*}:start:\001*\022\314\001\n\n"
          + "UpdateNode\022,.google.cloud.tpu.v2alpha1.UpdateNodeR"
          + "equest\032\035.google.longrunning.Operation\"q\312A\031\n"
          + "\004Node\022\021OperationMetadata\332A\020node,updat"
          + "e_mask\202\323\344\223\002<24/v2alpha1/{node.name=projects/*/locations/*/nodes/*}:\004node\022\320\001\n"
          ...
          + "rojects/*/locations/*/queuedResources/*}:reset:\001*\022\336\001\n"
          + "\027GenerateServiceIdentity\0229.google.cloud.tpu.v2alpha1.GenerateServic"
          + "eIdentityRequest\032:.google.cloud.tpu.v2al"
          + "pha1.GenerateServiceIdentityResponse\"L\202\323"
          + "\344\223\002F\"A/v2alpha1/{parent=projects/*/locations/*}:generateServiceIdentity:\001*\022\324\001\n"
          + "\024ListAcceleratorTypes\0226.google.cloud.tpu.v"
          + "2alpha1.ListAcceleratorTypesRequest\0327.google.cloud.tpu.v2alpha1.ListAcceleratorT"
          + "ypesResponse\"K\332A\006parent\202\323\344\223\002<\022:/v2alpha1"
          + "/{parent=projects/*/locations/*}/acceleratorTypes\022\301\001\n"
          + "\022GetAcceleratorType\0224.google.cloud.tpu.v2alpha1.GetAcceleratorTypeR"
          + "equest\032*.google.cloud.tpu.v2alpha1.Accel"
          + "eratorType\"I\332A\004name\202\323\344\223\002<\022:/v2alpha1/{na"
          + "me=projects/*/locations/*/acceleratorTypes/*}\022\320\001\n"
          + "\023ListRuntimeVersions\0225.google.cloud.tpu.v2alpha1.ListRuntimeVersionsReq"
          + "uest\0326.google.cloud.tpu.v2alpha1.ListRun"
          + "timeVersionsResponse\"J\332A\006parent\202\323\344\223\002;\0229/"
          + "v2alpha1/{parent=projects/*/locations/*}/runtimeVersions\022\275\001\n"
          + "\021GetRuntimeVersion\0223.google.cloud.tpu.v2alpha1.GetRuntimeVer"
          + "sionRequest\032).google.cloud.tpu.v2alpha1."
          + "RuntimeVersion\"H\332A\004name\202\323\344\223\002;\0229/v2alpha1"
          + "/{name=projects/*/locations/*/runtimeVersions/*}\022\320\001\n"
          + "\022GetGuestAttributes\0224.google.cloud.tpu.v2alpha1.GetGuestAttributesRe"
          + "quest\0325.google.cloud.tpu.v2alpha1.GetGue"
          + "stAttributesResponse\"M\202\323\344\223\002G\"B/v2alpha1/"
          + "{name=projects/*/locations/*/nodes/*}:getGuestAttributes:\001*\022\346\001\n"
          + "\030SimulateMaintenanceEvent\022:.google.cloud.tpu.v2alpha1.Sim"
          + "ulateMaintenanceEventRequest\032\035.google.longrunning.Operation\"o\312A\031\n"
          + "\004Node\022\021OperationMetadata\202\323\344\223\002M\"H/v2alpha1/{name=project"
          + "s/*/locations/*/nodes/*}:simulateMainten"
          + "anceEvent:\001*\032F\312A\022tpu.googleapis.com\322A.ht"
          + "tps://www.googleapis.com/auth/cloud-platformBa\n"
          + "\035com.google.cloud.tpu.v2alpha1B\r"
          + "CloudTpuProtoP\001Z/cloud.google.com/go/tpu/apiv2alpha1/tpupb;tpupbb\006proto3"
    };
    descriptor =
