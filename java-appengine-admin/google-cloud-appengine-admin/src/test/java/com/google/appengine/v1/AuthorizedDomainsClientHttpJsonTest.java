...
public class AuthorizedDomainsClientHttpJsonTest {
  private static MockHttpService mockService;
  private static AuthorizedDomainsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonAuthorizedDomainsStub.getMethodDescriptors(),
            AuthorizedDomainsSettings.getDefaultEndpoint());
    AuthorizedDomainsSettings settings =
        AuthorizedDomainsSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                AuthorizedDomainsSettings.defaultHttpJsonTransportProviderBuilder()
