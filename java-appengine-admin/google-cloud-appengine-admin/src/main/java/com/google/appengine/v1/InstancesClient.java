 ...
 *  [Stackdriver Monitoring API](https://cloud.google.com/monitoring/api/ref_v3/rest/v3/projects.timeSeries/list).</p></td>
 *      <td>
 ...
 *    <tr>
 *      <td>GetInstance</td>
 *      <td><p>Gets instance information.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>DebugInstance</td>
 *      <td><p>Enables debugging on a VM instance. This allows you to use the SSH
 ...
 *  should be started.
 *
 *  Only applicable for instances in App Engine flexible environment.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
