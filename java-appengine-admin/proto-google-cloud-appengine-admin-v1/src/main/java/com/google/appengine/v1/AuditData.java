      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(getUpdateServiceFieldBuilder().getBuilder(), extensionRegistry);
                methodCase_ = 1;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(getCreateVersionFieldBuilder().getBuilder(), extensionRegistry);
                methodCase_ = 2;
                break;
              } // case 18
            default:
