...
public final class OperationMetadataV1 extends com.google.protobuf.GeneratedMessage
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.appengine.v1.OperationProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.appengine.v1.OperationMetadataV1.class,
            com.google.appengine.v1.OperationMetadataV1.Builder.class);
  }
  ...
  public MethodMetadataCase getMethodMetadataCase() {
    return MethodMetadataCase.forNumber(methodMetadataCase_);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ephemeralMessage_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, ephemeralMessage_);
    }
    for (int i = 0; i < warning_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, warning_.getRaw(i));
    }
    if (methodMetadataCase_ == 8) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(ephemeralMessage_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, ephemeralMessage_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < warning_.size(); i++) {
    ...
    if (methodMetadataCase_ == 8) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
              8, (com.google.appengine.v1.CreateVersionMetadataV1) methodMetadata_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.appengine.v1.OperationMetadataV1 other =
        (com.google.appengine.v1.OperationMetadataV1) obj;
    ...
    if (!getEphemeralMessage().equals(other.getEphemeralMessage())) return false;
    if (!getWarningList().equals(other.getWarningList())) return false;
    if (!getMethodMetadataCase().equals(other.getMethodMetadataCase())) return false;
    switch (methodMetadataCase_) {
      case 8:
        if (!getCreateVersionMetadata().equals(other.getCreateVersionMetadata())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static com.google.appengine.v1.OperationMetadataV1 parseFrom(java.nio.ByteBuffer data)
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66:
              {
                input.readMessage(
                    internalGetCreateVersionMetadataFieldBuilder().getBuilder(), extensionRegistry);
     ...
     * @return This builder for chaining.
     */
    public Builder setEphemeralMessage(java.lang.String value) {
      if (value == null) {
        throw new NullPointerException();
      }
     ...
     * @return This builder for chaining.
     */
    public Builder setEphemeralMessageBytes(com.google.protobuf.ByteString value) {
      if (value == null) {
        throw new NullPointerException();
      }
      checkByteStringIsUtf8(value);
     ...
     * @return This builder for chaining.
     */
    public Builder setWarning(int index, java.lang.String value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureWarningIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addWarning(java.lang.String value) {
      if (value == null) {
        throw new NullPointerException();
      }
      ensureWarningIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addWarningBytes(com.google.protobuf.ByteString value) {
      if (value == null) {
        throw new NullPointerException();
      }
      checkByteStringIsUtf8(value);
    ...
    public Builder mergeCreateVersionMetadata(
      ...
      if (createVersionMetadataBuilder_ == null) {
        if (methodMetadataCase_ == 8
            && methodMetadata_
                != com.google.appengine.v1.CreateVersionMetadataV1.getDefaultInstance()) {
          methodMetadata_ =
              com.google.appengine.v1.CreateVersionMetadataV1.newBuilder(
    ...
    public com.google.appengine.v1.CreateVersionMetadataV1.Builder
      ...
      return internalGetCreateVersionMetadataFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.appengine.v1.CreateVersionMetadataV1.Builder,
            com.google.appengine.v1.CreateVersionMetadataV1OrBuilder>
        internalGetCreateVersionMetadataFieldBuilder() {
      if (createVersionMetadataBuilder_ == null) {
        if (!(methodMetadataCase_ == 8)) {
