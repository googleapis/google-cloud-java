...
public final class OperationMetadataV1 extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 66:
            {
              com.google.appengine.v1.CreateVersionMetadataV1.Builder subBuilder = null;
              if (methodMetadataCase_ == 8) {
                subBuilder =
                    ((com.google.appengine.v1.CreateVersionMetadataV1) methodMetadata_).toBuilder();
              }
              methodMetadata_ =
                  input.readMessage(
                      com.google.appengine.v1.CreateVersionMetadataV1.parser(), extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(
                    (com.google.appengine.v1.CreateVersionMetadataV1) methodMetadata_);
                methodMetadata_ = subBuilder.buildPartial();
              }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!getEphemeralMessageBytes().isEmpty()) {
