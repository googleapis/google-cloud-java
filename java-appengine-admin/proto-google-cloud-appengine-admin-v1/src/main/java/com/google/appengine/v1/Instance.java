...
public final class Instance extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class Liveness extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Liveness(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(appEngineRelease_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, appEngineRelease_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, vmName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmZoneName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, vmZoneName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, vmId_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmStatus_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 14, vmStatus_);
    }
    if (vmDebugEnabled_ != false) {
      output.writeBool(15, vmDebugEnabled_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmIp_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 16, vmIp_);
    }
    if (vmLiveness_
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(appEngineRelease_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, appEngineRelease_);
    }
    if (availability_ != com.google.appengine.v1.Instance.Availability.UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream.computeEnumSize(4, availability_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, vmName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmZoneName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, vmZoneName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, vmId_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmStatus_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(14, vmStatus_);
    }
    if (vmDebugEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream.computeBoolSize(15, vmDebugEnabled_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vmIp_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(16, vmIp_);
    }
    if (vmLiveness_
        != com.google.appengine.v1.Instance.Liveness.LivenessState.LIVENESS_STATE_UNSPECIFIED
            .getNumber()) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.appengine.v1.Instance other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getQps()) != 0) {
        setQps(other.getQps());
      }
