...
public final class CpuUtilization extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CpuUtilization(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetAggregationWindowLengthFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.appengine.v1.CpuUtilization other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getTargetUtilization()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetAggregationWindowLengthFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.protobuf.Duration.Builder getAggregationWindowLengthBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetAggregationWindowLengthFieldBuilder().getBuilder();
    }
