...
public final class Network extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < forwardedPorts_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, forwardedPorts_.getRaw(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(instanceTag_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, instanceTag_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(name_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, name_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(subnetworkName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, subnetworkName_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(instanceTag_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, instanceTag_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(name_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, name_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(subnetworkName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, subnetworkName_);
    }
    if (sessionAffinity_ != false) {
