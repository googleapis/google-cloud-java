...
```Groovy
implementation 'com.google.cloud:google-cloud-appengine-admin:0.1.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-appengine-admin/0.1.0
