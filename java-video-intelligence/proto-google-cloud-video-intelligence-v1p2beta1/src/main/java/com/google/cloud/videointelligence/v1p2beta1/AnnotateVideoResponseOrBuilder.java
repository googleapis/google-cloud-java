...
public interface AnnotateVideoResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.videointelligence.v1p2beta1.AnnotateVideoResponse)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.videointelligence.v1p2beta1.VideoAnnotationResults>
   ...
   * </code>
   */
  com.google.cloud.videointelligence.v1p2beta1.VideoAnnotationResults getAnnotationResults(
      int index);
  /**
   *
   *
