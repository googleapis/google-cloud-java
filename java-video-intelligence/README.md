...
```Groovy
compile 'com.google.cloud:google-cloud-video-intelligence:0.116.1-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-intelligence" % "0.116.1-beta"
```
