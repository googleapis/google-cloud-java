  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.videointelligence.v1p1beta1.LabelSegment) e.getUnfinishedMessage();
    ...
    public Builder mergeSegment(com.google.cloud.videointelligence.v1p1beta1.VideoSegment value) {
      if (segmentBuilder_ == null) {
        if (segment_ != null) {
          segment_ =
              com.google.cloud.videointelligence.v1p1beta1.VideoSegment.newBuilder(segment_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          segment_ = value;
