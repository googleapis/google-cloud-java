...
public interface ListFunctionsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.functions.v2beta.ListFunctionsResponse)
   ...
   * <code>repeated .google.cloud.functions.v2beta.Function functions = 1;</code>
   */
  com.google.cloud.functions.v2beta.FunctionOrBuilder getFunctionsOrBuilder(int index);
