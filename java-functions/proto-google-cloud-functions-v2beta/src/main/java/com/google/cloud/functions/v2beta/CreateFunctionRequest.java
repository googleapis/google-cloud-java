          ...
          case 18:
            {
              ...
              function_ =
                  input.readMessage(
                      com.google.cloud.functions.v2beta.Function.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.functions.v2beta.CreateFunctionRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeFunction(com.google.cloud.functions.v2beta.Function value) {
      if (functionBuilder_ == null) {
        if (function_ != null) {
          function_ =
              com.google.cloud.functions.v2beta.Function.newBuilder(function_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          function_ = value;
