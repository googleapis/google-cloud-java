          ...
          case 18:
            {
              ...
              function_ =
                  input.readMessage(
                      com.google.cloud.functions.v2.Function.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.functions.v2.CreateFunctionRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeFunction(com.google.cloud.functions.v2.Function value) {
      if (functionBuilder_ == null) {
        if (function_ != null) {
          function_ =
              com.google.cloud.functions.v2.Function.newBuilder(function_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          function_ = value;
