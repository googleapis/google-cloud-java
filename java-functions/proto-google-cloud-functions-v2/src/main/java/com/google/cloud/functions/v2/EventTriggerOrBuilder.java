...
public interface EventTriggerOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.functions.v2.EventTrigger)
   ...
   */
  java.util.List<com.google.cloud.functions.v2.EventFilter> getEventFiltersList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.functions.v2.EventFilter event_filters = 4;</code>
   */
  com.google.cloud.functions.v2.EventFilter getEventFilters(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.functions.v2.EventFilter event_filters = 4;</code>
   */
  java.util.List<? extends com.google.cloud.functions.v2.EventFilterOrBuilder>
   ...
   * <code>repeated .google.cloud.functions.v2.EventFilter event_filters = 4;</code>
   */
  com.google.cloud.functions.v2.EventFilterOrBuilder getEventFiltersOrBuilder(int index);
   ...
   */
  com.google.cloud.functions.v2.EventTrigger.RetryPolicy getRetryPolicy();
