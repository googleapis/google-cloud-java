...
```Groovy
implementation 'com.google.cloud:google-cloud-functions:2.14.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-functions/2.14.0
