...
public interface FunctionOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.cloud.functions.v2alpha.StateMessage> getStateMessagesList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.functions.v2alpha.StateMessageOrBuilder getStateMessagesOrBuilder(int index);
}
