...
public interface OperationMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.functions.v2alpha.OperationMetadata)
   ...
   */
  java.util.List<com.google.cloud.functions.v2alpha.Stage> getStagesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.functions.v2alpha.Stage stages = 9;</code>
   */
  com.google.cloud.functions.v2alpha.Stage getStages(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.functions.v2alpha.Stage stages = 9;</code>
   */
  java.util.List<? extends com.google.cloud.functions.v2alpha.StageOrBuilder>
   ...
   * <code>repeated .google.cloud.functions.v2alpha.Stage stages = 9;</code>
   */
  com.google.cloud.functions.v2alpha.StageOrBuilder getStagesOrBuilder(int index);
   ...
   */
  com.google.cloud.functions.v2alpha.OperationType getOperationType();
}
