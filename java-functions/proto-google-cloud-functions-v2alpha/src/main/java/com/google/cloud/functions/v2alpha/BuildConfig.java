...
public final class BuildConfig extends com.google.protobuf.GeneratedMessage
   ...
   */
  @java.lang.Override
  public com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy getAutomaticUpdatePolicy() {
    if (runtimeUpdatePolicyCase_ == 40) {
      return (com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy) runtimeUpdatePolicy_;
    }
   ...
   */
  @java.lang.Override
  public com.google.cloud.functions.v2alpha.AutomaticUpdatePolicyOrBuilder
   ...
   */
  @java.lang.Override
  public com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy getOnDeployUpdatePolicy() {
    if (runtimeUpdatePolicyCase_ == 41) {
      return (com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy) runtimeUpdatePolicy_;
    }
   ...
   */
  @java.lang.Override
  public com.google.cloud.functions.v2alpha.OnDeployUpdatePolicyOrBuilder
  ...
  public com.google.cloud.functions.v2alpha.BuildConfig.DockerRegistry getDockerRegistry() {
    com.google.cloud.functions.v2alpha.BuildConfig.DockerRegistry result =
        com.google.cloud.functions.v2alpha.BuildConfig.DockerRegistry.forNumber(dockerRegistry_);
    return result == null
        ? com.google.cloud.functions.v2alpha.BuildConfig.DockerRegistry.UNRECOGNIZED
        : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (dockerRegistry_
        != com.google.cloud.functions.v2alpha.BuildConfig.DockerRegistry.DOCKER_REGISTRY_UNSPECIFIED
            .getNumber()) {
    ...
    if (runtimeUpdatePolicyCase_ == 40) {
      output.writeMessage(
          40, (com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy) runtimeUpdatePolicy_);
    }
    if (runtimeUpdatePolicyCase_ == 41) {
      output.writeMessage(
          41, (com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy) runtimeUpdatePolicy_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartialOneofs(com.google.cloud.functions.v2alpha.BuildConfig result) {
    ...
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy,
            com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy.Builder,
    ...
    public Builder setAutomaticUpdatePolicy(
        com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy value) {
      if (automaticUpdatePolicyBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setAutomaticUpdatePolicy(
        com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy.Builder builderForValue) {
      if (automaticUpdatePolicyBuilder_ == null) {
      ...
      if (automaticUpdatePolicyBuilder_ == null) {
        if (runtimeUpdatePolicyCase_ == 40
            && runtimeUpdatePolicy_
                != com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy.getDefaultInstance()) {
          runtimeUpdatePolicy_ =
              com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy.newBuilder(
                      (com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy)
                          runtimeUpdatePolicy_)
                  .mergeFrom(value)
                  .buildPartial();
     ...
     * </code>
     */
    public com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy.Builder
      ...
      if (automaticUpdatePolicyBuilder_ == null) {
        ...
        automaticUpdatePolicyBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy.Builder,
                com.google.cloud.functions.v2alpha.AutomaticUpdatePolicyOrBuilder>(
                (com.google.cloud.functions.v2alpha.AutomaticUpdatePolicy) runtimeUpdatePolicy_,
    ...
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy,
            com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy.Builder,
            com.google.cloud.functions.v2alpha.OnDeployUpdatePolicyOrBuilder>
        onDeployUpdatePolicyBuilder_;

    /**
     * <code>.google.cloud.functions.v2alpha.OnDeployUpdatePolicy on_deploy_update_policy = 41;
     * </code>
     *
     * @return Whether the onDeployUpdatePolicy field is set.
     */
    ...
    public Builder setOnDeployUpdatePolicy(
        com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy value) {
      if (onDeployUpdatePolicyBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     */
    public Builder setOnDeployUpdatePolicy(
        com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy.Builder builderForValue) {
      if (onDeployUpdatePolicyBuilder_ == null) {
        runtimeUpdatePolicy_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeOnDeployUpdatePolicy(
      ...
      if (onDeployUpdatePolicyBuilder_ == null) {
        if (runtimeUpdatePolicyCase_ == 41
            && runtimeUpdatePolicy_
                != com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy.getDefaultInstance()) {
          runtimeUpdatePolicy_ =
              com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy.newBuilder(
                      (com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy)
                          runtimeUpdatePolicy_)
                  .mergeFrom(value)
                  .buildPartial();
     ...
     * </code>
     */
    public com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy.Builder
      ...
      if (onDeployUpdatePolicyBuilder_ == null) {
        ...
        onDeployUpdatePolicyBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy.Builder,
                com.google.cloud.functions.v2alpha.OnDeployUpdatePolicyOrBuilder>(
                (com.google.cloud.functions.v2alpha.OnDeployUpdatePolicy) runtimeUpdatePolicy_,
                getParentForChildren(),
                isClean());
        runtimeUpdatePolicy_ = null;
      }
    ...
    public Builder setDockerRegistry(
        com.google.cloud.functions.v2alpha.BuildConfig.DockerRegistry value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000200;
