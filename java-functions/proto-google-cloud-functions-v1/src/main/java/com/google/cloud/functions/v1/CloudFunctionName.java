...
public class CloudFunctionName implements ResourceName {
  ...
  public static @Nullable CloudFunctionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_FUNCTION.validatedMatch(
            formattedString, "CloudFunctionName.parse: formattedString not in valid format");
  ...
  public static List<CloudFunctionName> parseList(List<String> formattedStrings) {
    List<CloudFunctionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable CloudFunctionName> values) {
