  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\267\024\n\r"
          ...
          + "oud.functions.v1.CloudFunctionStatusB\003\340A\003\022\023\n"
          ...
          + ".google.cloud.functions.v1.CloudFunction.LabelsEntry\022a\n"
          + "\025environment_variables\030\021 "
          + "\003(\0132B.google.cloud.functions.v1.CloudFunction.EnvironmentVariablesEntry\022l\n"
          + "\033build_environment_variables\030\034 \003(\0132G.google.cl"
          + "oud.functions.v1.CloudFunction.BuildEnvironmentVariablesEntry\022\023\n"
          + "\007network\030\022 \001(\tB\002\030\001\022\025\n\r"
          + "max_instances\030\024 \001(\005\022\025\n\r"
          + "min_instances\030  \001(\005\022\025\n\r"
          + "vpc_connector\030\026 \001(\t\022j\n"
          + "\035vpc_connector_egress_settings\030\027 \001(\0162C.google."
          + "cloud.functions.v1.CloudFunction.VpcConnectorEgressSettings\022R\n"
          ...
          + "e.cloud.functions.v1.CloudFunction.DockerRegistry\022a\n"
          + "\027automatic_update_policy\030( \001"
          + "(\0132>.google.cloud.functions.v1.CloudFunction.AutomaticUpdatePolicyH\002\022`\n"
          + "\027on_deploy_update_policy\030) \001(\0132=.google.cloud.fun"
          + "ctions.v1.CloudFunction.OnDeployUpdatePolicyH\002\022\035\n"
          + "\025build_service_account\030+ \001(\t\032\027\n"
          + "\025AutomaticUpdatePolicy\0324\n"
          + "\024OnDeployUpdatePolicy\022\034\n"
          + "\017runtime_version\030\001 \001(\tB\003\340A\003\032-\n"
          ...
          + "+cloudfunctions.googleapis.com/CloudFunction\022"
          + "<projects/{project}/locations/{location}/functions/{function}B\r\n"
          + "\013source_codeB\t\n"
          + "\007triggerB\027\n"
          ...
          + "\016security_level\030\002 \001(\01625.google"
          + ".cloud.functions.v1.HttpsTrigger.SecurityLevel\"W\n\r"
          ...
          + "\010versions\030\004 \003(\01325.google.clo"
          + "ud.functions.v1.SecretVolume.SecretVersion\032.\n\r"
          ...
          + "\010function\030\002 \001(\0132(.go"
          + "ogle.cloud.functions.v1.CloudFunctionB\003\340A\002\"\211\001\n"
          ...
          + "+cloudfunctions.googleapis.com/CloudFunction\022\027\n\n"
          ...
          + "ListFunctions\022/.google.cloud.functions.v1."
          + "ListFunctionsRequest\0320.google.cloud.func"
          + "tions.v1.ListFunctionsResponse\"5\202\323\344\223\002/\022-"
          + "/v1/{parent=projects/*/locations/*}/functions\022\244\001\n"
          + "\013GetFunction\022-.google.cloud.functions.v1.GetFunctionRequest\032(.google.cl"
          + "oud.functions.v1.CloudFunction\"<\332A\004name\202"
          + "\323\344\223\002/\022-/v1/{name=projects/*/locations/*/functions/*}\022\337\001\n"
          + "\016CreateFunction\0220.google"
          + ".cloud.functions.v1.CreateFunctionRequest\032\035.google.longrunning.Operation\"|\312A$\n\r"
          + "CloudFunction\022\023OperationMetadataV1\332A\021loca"
          + "tion,function\202\323\344\223\002;\"//v1/{location=proje"
          + "cts/*/locations/*}/functions:\010function\022\335\001\n"
          + "\016UpdateFunction\0220.google.cloud.functio"
          + "ns.v1.UpdateFunctionRequest\032\035.google.longrunning.Operation\"z\312A$\n\r"
          + "CloudFunction\022\023OperationMetadataV1\332A\010function\202\323\344\223\002B26/v"
          + "1/{function.name=projects/*/locations/*/functions/*}:\010function\022\316\001\n"
          + "\016DeleteFunction\0220.google.cloud.functions.v1.DeleteFunc"
          + "tionRequest\032\035.google.longrunning.Operation\"k\312A,\n"
          + "\025google.protobuf.Empty\022\023Operatio"
          + "nMetadataV1\332A\004name\202\323\344\223\002/*-/v1/{name=projects/*/locations/*/functions/*}\022\272\001\n"
          + "\014CallFunction\022..google.cloud.functions.v1.Cal"
          + "lFunctionRequest\032/.google.cloud.functions.v1.CallFunctionResponse\"I\332A"
          + "\tname,data\202"
          + "\323\344\223\0027\"2/v1/{name=projects/*/locations/*/functions/*}:call:\001*\022\312\001\n"
          + "\021GenerateUploadUrl\0223.google.cloud.functions.v1.GenerateU"
          + "ploadUrlRequest\0324.google.cloud.functions"
          + ".v1.GenerateUploadUrlResponse\"J\202\323\344\223\002D\"?/"
          + "v1/{parent=projects/*/locations/*}/functions:generateUploadUrl:\001*\022\322\001\n"
          + "\023GenerateDownloadUrl\0225.google.cloud.functions.v1.Ge"
          + "nerateDownloadUrlRequest\0326.google.cloud.functions.v1.GenerateDownloadUrlResponse"
          ...
          + "licyRequest\032\025.google.iam.v1.Policy\"I\202\323\344\223"
          + "\002C\">/v1/{resource=projects/*/locations/*/functions/*}:setIamPolicy:\001*\022\221\001\n"
          + "\014GetIamPolicy\022\".google.iam.v1.GetIamPolicyReque"
          + "st\032\025.google.iam.v1.Policy\"F\202\323\344\223\002@\022>/v1/{"
          + "resource=projects/*/locations/*/functions/*}:getIamPolicy\022\272\001\n"
          + "\022TestIamPermissions\022(.google.iam.v1.TestIamPermissionsReque"
          + "st\032).google.iam.v1.TestIamPermissionsRes"
          + "ponse\"O\202\323\344\223\002I\"D/v1/{resource=projects/*/"
          + "locations/*/functions/*}:testIamPermissi"
          + "ons:\001*\032Q\312A\035cloudfunctions.googleapis.com"
          + "\322A.https://www.googleapis.com/auth/cloud-platformB\341\002\n"
          + "\035com.google.cloud.functions.v1B\016FunctionsProtoP\001Z;cloud.google.com/"
          + "go/functions/apiv1/functionspb;functionspb\242\002\003GCF\352Ao\n"
          + "*artifactregistry.googleapis.com/Repository\022Aprojects/{project}/loca"
          + "tions/{location}/repositories/{repository}\352Ax\n"
