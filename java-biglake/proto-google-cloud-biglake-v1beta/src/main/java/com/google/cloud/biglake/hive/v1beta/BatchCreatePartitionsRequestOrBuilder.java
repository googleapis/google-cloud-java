...
public interface BatchCreatePartitionsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.biglake.hive.v1beta.BatchCreatePartitionsRequest)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.biglake.hive.v1beta.CreatePartitionRequest> getRequestsList();
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1beta.CreatePartitionRequest getRequests(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.biglake.hive.v1beta.CreatePartitionRequestOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1beta.CreatePartitionRequestOrBuilder getRequestsOrBuilder(
      int index);
