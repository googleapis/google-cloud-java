...
public class TableName implements ResourceName {
  private static final PathTemplate PROJECT_CATALOG_DATABASE_TABLE =
      PathTemplate.createWithoutUrlEncoding(
          "projects/{project}/catalogs/{catalog}/databases/{database}/tables/{table}");
  ...
  public static TableName of(String project, String catalog, String database, String table) {
    return newBuilder()
        .setProject(project)
        .setCatalog(catalog)
  ...
  public static String format(String project, String catalog, String database, String table) {
    return newBuilder()
        .setProject(project)
        .setCatalog(catalog)
        .setDatabase(database)
  ...
  public static TableName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_CATALOG_DATABASE_TABLE.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_CATALOG_DATABASE_TABLE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_CATALOG_DATABASE_TABLE.instantiate(
        "project", project, "catalog", catalog, "database", database, "table", table);
  }
  ...
  /** Builder for projects/{project}/catalogs/{catalog}/databases/{database}/tables/{table}. */
