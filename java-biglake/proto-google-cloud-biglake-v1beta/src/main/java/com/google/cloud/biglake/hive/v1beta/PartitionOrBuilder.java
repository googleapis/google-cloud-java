...
public interface PartitionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.biglake.hive.v1beta.Partition)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.biglake.hive.v1beta.FieldSchema> getFieldsList();
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1beta.FieldSchema getFields(int index);
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1beta.FieldSchemaOrBuilder getFieldsOrBuilder(int index);
}
