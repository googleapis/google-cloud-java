...
public interface ListTablesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.bigquery.biglake.v1alpha1.ListTablesResponse)
   ...
   * <code>repeated .google.cloud.bigquery.biglake.v1alpha1.Table tables = 1;</code>
   */
  com.google.cloud.bigquery.biglake.v1alpha1.TableOrBuilder getTablesOrBuilder(int index);
