...
public class ApiSpecName implements ResourceName {
  ...
  private ApiSpecName(Builder builder) {
  ...
  public static ApiSpecName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_API_VERSION_SPEC.validatedMatch(
            formattedString, "ApiSpecName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<ApiSpecName> parseList(List<String> formattedStrings) {
    List<ApiSpecName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<ApiSpecName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (ApiSpecName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ApiSpecName that = ((ApiSpecName) o);
  ...
  public static class Builder {
    ...
    private Builder(ApiSpecName apiSpecName) {
      this.project = apiSpecName.project;
      this.location = apiSpecName.location;
      this.api = apiSpecName.api;
      this.version = apiSpecName.version;
      this.spec = apiSpecName.spec;
    }

    public ApiSpecName build() {
      return new ApiSpecName(this);
    }
  }
}
