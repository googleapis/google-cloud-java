          ...
          case 26:
            {
              ...
              instance_ =
                  input.readMessage(
                      com.google.cloud.apigeeregistry.v1.Instance.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.apigeeregistry.v1.CreateInstanceRequest) e.getUnfinishedMessage();
    ...
    public Builder mergeInstance(com.google.cloud.apigeeregistry.v1.Instance value) {
      if (instanceBuilder_ == null) {
        if (instance_ != null) {
          instance_ =
              com.google.cloud.apigeeregistry.v1.Instance.newBuilder(instance_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          instance_ = value;
