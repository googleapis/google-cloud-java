...
/**
 * Settings class to configure an instance of {@link ProvisioningStub}.
 *
...
public class ProvisioningStubSettings extends StubSettings<ProvisioningStubSettings> {
  ...
  public ProvisioningStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcProvisioningStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonProvisioningStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ProvisioningStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ProvisioningStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected ProvisioningStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for ProvisioningStubSettings. */
  public static class Builder extends StubSettings.Builder<ProvisioningStubSettings, Builder> {
    ...
    protected Builder(ProvisioningStubSettings settings) {
      super(settings);
    ...
    @Override
    public ProvisioningStubSettings build() throws IOException {
      return new ProvisioningStubSettings(this);
    }
  }
}
