...
public final class ListAvailableFeaturesSslPoliciesHttpRequest implements ApiMessage {
  ...
  private ListAvailableFeaturesSslPoliciesHttpRequest() {
  ...
  public static Builder newBuilder(ListAvailableFeaturesSslPoliciesHttpRequest prototype) {
  ...
  public static ListAvailableFeaturesSslPoliciesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListAvailableFeaturesSslPoliciesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListAvailableFeaturesSslPoliciesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListAvailableFeaturesSslPoliciesHttpRequest other) {
      if (other == ListAvailableFeaturesSslPoliciesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListAvailableFeaturesSslPoliciesHttpRequest source) {
    ...
    public ListAvailableFeaturesSslPoliciesHttpRequest build() {
      String missing = "";
      ...
      return new ListAvailableFeaturesSslPoliciesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListAvailableFeaturesSslPoliciesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListAvailableFeaturesSslPoliciesHttpRequest) {
      ListAvailableFeaturesSslPoliciesHttpRequest that =
          (ListAvailableFeaturesSslPoliciesHttpRequest) o;
