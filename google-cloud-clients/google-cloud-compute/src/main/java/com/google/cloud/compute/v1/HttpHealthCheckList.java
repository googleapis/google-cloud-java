...
public final class HttpHealthCheckList implements ApiMessage {
  ...
  public static Builder newBuilder(HttpHealthCheckList prototype) {
  ...
  public static HttpHealthCheckList getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final HttpHealthCheckList DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new HttpHealthCheckList();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(HttpHealthCheckList other) {
      if (other == HttpHealthCheckList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    Builder(HttpHealthCheckList source) {
      this.id = source.id;
    ...
    public HttpHealthCheckList build() {
      ...
      return new HttpHealthCheckList(id, items, kind, nextPageToken, selfLink, warning);
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof HttpHealthCheckList) {
      HttpHealthCheckList that = (HttpHealthCheckList) o;
