...
@BetaApi
/**
 * Request object for method compute.regionHealthChecks.patch. Updates a HealthCheck resource in the
 * specified project using the data included in the request. This method supports PATCH semantics
 * and uses the JSON merge patch format and processing rules. (== suppress_warning
 * http-rest-shadowed ==)
 */
public final class PatchRegionHealthCheckHttpRequest implements ApiMessage {
  ...
  private PatchRegionHealthCheckHttpRequest() {
  ...
  public static Builder newBuilder(PatchRegionHealthCheckHttpRequest prototype) {
  ...
  public static PatchRegionHealthCheckHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final PatchRegionHealthCheckHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new PatchRegionHealthCheckHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(PatchRegionHealthCheckHttpRequest other) {
      if (other == PatchRegionHealthCheckHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(PatchRegionHealthCheckHttpRequest source) {
    ...
    public PatchRegionHealthCheckHttpRequest build() {
      String missing = "";
      ...
      return new PatchRegionHealthCheckHttpRequest(
          access_token,
          callback,
          fieldMask,
          fields,
  ...
  public String toString() {
    return "PatchRegionHealthCheckHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof PatchRegionHealthCheckHttpRequest) {
      PatchRegionHealthCheckHttpRequest that = (PatchRegionHealthCheckHttpRequest) o;
