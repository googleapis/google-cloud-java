...
@BetaApi
/**
 * Request object for method compute.routers.getNatMappingInfo. Retrieves runtime Nat mapping
 * information of VM endpoints. (== suppress_warning http-rest-shadowed ==)
 */
public final class GetNatMappingInfoRoutersHttpRequest implements ApiMessage {
  ...
  private GetNatMappingInfoRoutersHttpRequest() {
  ...
  public static Builder newBuilder(GetNatMappingInfoRoutersHttpRequest prototype) {
  ...
  public static GetNatMappingInfoRoutersHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetNatMappingInfoRoutersHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetNatMappingInfoRoutersHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetNatMappingInfoRoutersHttpRequest other) {
      if (other == GetNatMappingInfoRoutersHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetNatMappingInfoRoutersHttpRequest source) {
    ...
    public GetNatMappingInfoRoutersHttpRequest build() {
      String missing = "";
      ...
      return new GetNatMappingInfoRoutersHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "GetNatMappingInfoRoutersHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetNatMappingInfoRoutersHttpRequest) {
      GetNatMappingInfoRoutersHttpRequest that = (GetNatMappingInfoRoutersHttpRequest) o;
