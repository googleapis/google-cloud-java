...
@BetaApi
/**
 * Request object for method compute.images.setIamPolicy. Sets the access control policy on the
 * specified resource. Replaces any existing policy.
 */
public final class SetIamPolicyImageHttpRequest implements ApiMessage {
  ...
  private SetIamPolicyImageHttpRequest() {
  ...
  public static Builder newBuilder(SetIamPolicyImageHttpRequest prototype) {
  ...
  public static SetIamPolicyImageHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicyImageHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicyImageHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicyImageHttpRequest other) {
      if (other == SetIamPolicyImageHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicyImageHttpRequest source) {
    ...
    public SetIamPolicyImageHttpRequest build() {
      String missing = "";
      ...
      return new SetIamPolicyImageHttpRequest(
          access_token,
          callback,
          fields,
  ...
  public String toString() {
    return "SetIamPolicyImageHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicyImageHttpRequest) {
      SetIamPolicyImageHttpRequest that = (SetIamPolicyImageHttpRequest) o;
