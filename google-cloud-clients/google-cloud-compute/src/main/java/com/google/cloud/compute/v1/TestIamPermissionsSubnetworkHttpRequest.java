...
public final class TestIamPermissionsSubnetworkHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsSubnetworkHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsSubnetworkHttpRequest prototype) {
  ...
  public static TestIamPermissionsSubnetworkHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsSubnetworkHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsSubnetworkHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsSubnetworkHttpRequest other) {
      if (other == TestIamPermissionsSubnetworkHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsSubnetworkHttpRequest source) {
    ...
    public TestIamPermissionsSubnetworkHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsSubnetworkHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsSubnetworkHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsSubnetworkHttpRequest) {
      TestIamPermissionsSubnetworkHttpRequest that = (TestIamPermissionsSubnetworkHttpRequest) o;
