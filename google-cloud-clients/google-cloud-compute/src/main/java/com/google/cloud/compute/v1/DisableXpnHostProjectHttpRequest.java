...
@BetaApi
/**
 * Request object for method compute.projects.disableXpnHost. Disable this project as a shared VPC
 * host project.
 */
  ...
  public static class Builder {
    ...
    public DisableXpnHostProjectHttpRequest build() {
      ...
      return new DisableXpnHostProjectHttpRequest(
          access_token, callback, fields, key, prettyPrint, project, quotaUser, requestId, userIp);
    }
