...
@BetaApi
/**
 * Request object for method compute.regionHealthChecks.insert. Creates a HealthCheck resource in
 * the specified project using the data included in the request.
 */
public final class InsertRegionHealthCheckHttpRequest implements ApiMessage {
  ...
  private InsertRegionHealthCheckHttpRequest() {
  ...
  public static Builder newBuilder(InsertRegionHealthCheckHttpRequest prototype) {
  ...
  public static InsertRegionHealthCheckHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertRegionHealthCheckHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertRegionHealthCheckHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertRegionHealthCheckHttpRequest other) {
      if (other == InsertRegionHealthCheckHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(InsertRegionHealthCheckHttpRequest source) {
    ...
    public InsertRegionHealthCheckHttpRequest build() {
      String missing = "";
      ...
      return new InsertRegionHealthCheckHttpRequest(
          access_token,
          callback,
          fields,
          healthCheckResource,
  ...
  public String toString() {
    return "InsertRegionHealthCheckHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertRegionHealthCheckHttpRequest) {
      InsertRegionHealthCheckHttpRequest that = (InsertRegionHealthCheckHttpRequest) o;
