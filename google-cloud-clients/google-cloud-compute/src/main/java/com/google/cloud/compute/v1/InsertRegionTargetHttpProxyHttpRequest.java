...
public final class InsertRegionTargetHttpProxyHttpRequest implements ApiMessage {
  ...
  private InsertRegionTargetHttpProxyHttpRequest() {
   ...
   * `{project}/regions/{region}/targetHttpProxies`. \`{region}\` must start with a letter, and
  ...
  public static Builder newBuilder(InsertRegionTargetHttpProxyHttpRequest prototype) {
  ...
  public static InsertRegionTargetHttpProxyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertRegionTargetHttpProxyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertRegionTargetHttpProxyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertRegionTargetHttpProxyHttpRequest other) {
      if (other == InsertRegionTargetHttpProxyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(InsertRegionTargetHttpProxyHttpRequest source) {
    ...
    public InsertRegionTargetHttpProxyHttpRequest build() {
      String missing = "";
      ...
      return new InsertRegionTargetHttpProxyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "InsertRegionTargetHttpProxyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertRegionTargetHttpProxyHttpRequest) {
      InsertRegionTargetHttpProxyHttpRequest that = (InsertRegionTargetHttpProxyHttpRequest) o;
