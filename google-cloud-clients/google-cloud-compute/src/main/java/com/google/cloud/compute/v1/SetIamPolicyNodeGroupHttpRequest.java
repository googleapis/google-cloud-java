...
@BetaApi
/**
 * Request object for method compute.nodeGroups.setIamPolicy. Sets the access control policy on the
 * specified resource. Replaces any existing policy. (== suppress_warning http-rest-shadowed ==)
 */
public final class SetIamPolicyNodeGroupHttpRequest implements ApiMessage {
  ...
  private SetIamPolicyNodeGroupHttpRequest() {
  ...
  public static Builder newBuilder(SetIamPolicyNodeGroupHttpRequest prototype) {
  ...
  public static SetIamPolicyNodeGroupHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicyNodeGroupHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicyNodeGroupHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicyNodeGroupHttpRequest other) {
      if (other == SetIamPolicyNodeGroupHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicyNodeGroupHttpRequest source) {
    ...
    public SetIamPolicyNodeGroupHttpRequest build() {
      String missing = "";
      ...
      return new SetIamPolicyNodeGroupHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetIamPolicyNodeGroupHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicyNodeGroupHttpRequest) {
      SetIamPolicyNodeGroupHttpRequest that = (SetIamPolicyNodeGroupHttpRequest) o;
