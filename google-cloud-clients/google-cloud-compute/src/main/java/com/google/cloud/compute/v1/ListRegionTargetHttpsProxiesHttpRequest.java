...
@BetaApi
/**
 * Request object for method compute.regionTargetHttpsProxies.list. Retrieves the list of
 * TargetHttpsProxy resources available to the specified project in the specified region.
 */
public final class ListRegionTargetHttpsProxiesHttpRequest implements ApiMessage {
  ...
  private ListRegionTargetHttpsProxiesHttpRequest() {
   ...
   * `{project}/regions/{region}/targetHttpsProxies`. \`{region}\` must start with a letter, and
  ...
  public static Builder newBuilder(ListRegionTargetHttpsProxiesHttpRequest prototype) {
  ...
  public static ListRegionTargetHttpsProxiesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionTargetHttpsProxiesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionTargetHttpsProxiesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionTargetHttpsProxiesHttpRequest other) {
      if (other == ListRegionTargetHttpsProxiesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionTargetHttpsProxiesHttpRequest source) {
    ...
    public ListRegionTargetHttpsProxiesHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionTargetHttpsProxiesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListRegionTargetHttpsProxiesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionTargetHttpsProxiesHttpRequest) {
      ListRegionTargetHttpsProxiesHttpRequest that = (ListRegionTargetHttpsProxiesHttpRequest) o;
