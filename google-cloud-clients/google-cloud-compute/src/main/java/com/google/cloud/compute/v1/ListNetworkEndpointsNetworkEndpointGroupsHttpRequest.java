...
public final class ListNetworkEndpointsNetworkEndpointGroupsHttpRequest implements ApiMessage {
  ...
  private final NetworkEndpointGroupsListEndpointsRequest
  ...
  private ListNetworkEndpointsNetworkEndpointGroupsHttpRequest() {
    ...
    this.networkEndpointGroupsListEndpointsRequestResource = null;
    this.orderBy = null;
    this.pageToken = null;
  ...
  private ListNetworkEndpointsNetworkEndpointGroupsHttpRequest(
    ...
    this.networkEndpointGroupsListEndpointsRequestResource =
        networkEndpointGroupsListEndpointsRequestResource;
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("networkEndpointGroupsListEndpointsRequestResource".equals(fieldName)) {
      return networkEndpointGroupsListEndpointsRequestResource;
    }
  ...
  @Nullable
  @Override
  public NetworkEndpointGroupsListEndpointsRequest getApiMessageRequestBody() {
    return networkEndpointGroupsListEndpointsRequestResource;
  }
  ...
  public static Builder newBuilder(ListNetworkEndpointsNetworkEndpointGroupsHttpRequest prototype) {
  ...
  public static ListNetworkEndpointsNetworkEndpointGroupsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListNetworkEndpointsNetworkEndpointGroupsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListNetworkEndpointsNetworkEndpointGroupsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListNetworkEndpointsNetworkEndpointGroupsHttpRequest other) {
      if (other == ListNetworkEndpointsNetworkEndpointGroupsHttpRequest.getDefaultInstance())
        return this;
      ...
      if (other.getNetworkEndpointGroupsListEndpointsRequestResource() != null) {
        this.networkEndpointGroupsListEndpointsRequestResource =
            other.networkEndpointGroupsListEndpointsRequestResource;
      }
    ...
    Builder(ListNetworkEndpointsNetworkEndpointGroupsHttpRequest source) {
      ...
      this.networkEndpointGroupsListEndpointsRequestResource =
          source.networkEndpointGroupsListEndpointsRequestResource;
    ...
    public ListNetworkEndpointsNetworkEndpointGroupsHttpRequest build() {
      ...
      return new ListNetworkEndpointsNetworkEndpointGroupsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
    ...
    public Builder clone() {
      ...
      newBuilder.setNetworkEndpointGroupsListEndpointsRequestResource(
          this.networkEndpointGroupsListEndpointsRequestResource);
  ...
  public String toString() {
    return "ListNetworkEndpointsNetworkEndpointGroupsHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListNetworkEndpointsNetworkEndpointGroupsHttpRequest) {
      ListNetworkEndpointsNetworkEndpointGroupsHttpRequest that =
          (ListNetworkEndpointsNetworkEndpointGroupsHttpRequest) o;
      return Objects.equals(this.access_token, that.getAccessToken())
          ...
          && Objects.equals(
              this.networkEndpointGroupsListEndpointsRequestResource,
              that.getNetworkEndpointGroupsListEndpointsRequestResource())
