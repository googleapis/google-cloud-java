...
public final class TargetVpnGatewayAggregatedList implements ApiMessage {
  ...
  private final Map<String, TargetVpnGatewaysScopedList> items;
  ...
  private TargetVpnGatewayAggregatedList(
      String id,
      Map<String, TargetVpnGatewaysScopedList> items,
      String kind,
  ...
  public static class Builder {
    private String id;
    private Map<String, TargetVpnGatewaysScopedList> items;
    private String kind;
     ...
     * containing this set of target VPN gateways.
     */
    public Builder putAllItems(Map<String, TargetVpnGatewaysScopedList> items) {
      this.items = items;
      return this;
    }
    ...
    public TargetVpnGatewayAggregatedList build() {
      ...
      return new TargetVpnGatewayAggregatedList(id, items, kind, nextPageToken, selfLink, warning);
    }
