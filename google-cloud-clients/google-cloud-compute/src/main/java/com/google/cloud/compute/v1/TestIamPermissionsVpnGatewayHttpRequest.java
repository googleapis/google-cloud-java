...
@BetaApi
/**
 * Request object for method compute.vpnGateways.testIamPermissions. Returns permissions that a
 * caller has on the specified resource.
 */
public final class TestIamPermissionsVpnGatewayHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsVpnGatewayHttpRequest() {
   ...
   * `{project}/regions/{region}/vpnGateways/{resource}/testIamPermissions`. \`{resource}\` must
  ...
  public static Builder newBuilder(TestIamPermissionsVpnGatewayHttpRequest prototype) {
  ...
  public static TestIamPermissionsVpnGatewayHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsVpnGatewayHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsVpnGatewayHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsVpnGatewayHttpRequest other) {
      if (other == TestIamPermissionsVpnGatewayHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsVpnGatewayHttpRequest source) {
    ...
    public TestIamPermissionsVpnGatewayHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsVpnGatewayHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsVpnGatewayHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsVpnGatewayHttpRequest) {
      TestIamPermissionsVpnGatewayHttpRequest that = (TestIamPermissionsVpnGatewayHttpRequest) o;
