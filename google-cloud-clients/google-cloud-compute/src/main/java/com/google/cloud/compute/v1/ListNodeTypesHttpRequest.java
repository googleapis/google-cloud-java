...
@BetaApi
/**
 * Request object for method compute.nodeTypes.list. Retrieves a list of node types available to the
 * specified project.
 */
public final class ListNodeTypesHttpRequest implements ApiMessage {
  ...
  private ListNodeTypesHttpRequest() {
  ...
  public static Builder newBuilder(ListNodeTypesHttpRequest prototype) {
  ...
  public static ListNodeTypesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListNodeTypesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListNodeTypesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListNodeTypesHttpRequest other) {
      if (other == ListNodeTypesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListNodeTypesHttpRequest source) {
    ...
    public ListNodeTypesHttpRequest build() {
      String missing = "";
      ...
      return new ListNodeTypesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "ListNodeTypesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListNodeTypesHttpRequest) {
      ListNodeTypesHttpRequest that = (ListNodeTypesHttpRequest) o;
