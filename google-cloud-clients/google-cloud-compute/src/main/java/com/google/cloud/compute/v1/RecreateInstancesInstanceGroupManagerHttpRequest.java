...
@BetaApi
/**
 * Request object for method compute.instanceGroupManagers.recreateInstances. Flags the specified
 * instances in the managed instance group to be immediately recreated. The instances are deleted
 * and recreated using the current instance template for the managed instance group. This operation
 * is marked as DONE when the flag is set even if the instances have not yet been recreated. You
 * must separately verify the status of the recreating action with the listmanagedinstances method.
 *
...
public final class RecreateInstancesInstanceGroupManagerHttpRequest implements ApiMessage {
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("instanceGroupManagersRecreateInstancesRequestResource".equals(fieldName)) {
