...
@BetaApi
/**
 * Request object for method compute.reservations.testIamPermissions. Returns permissions that a
 * caller has on the specified resource.
 */
public final class TestIamPermissionsReservationHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsReservationHttpRequest() {
   ...
   * `{project}/zones/{zone}/reservations/{resource}/testIamPermissions`. \`{resource}\` must start
  ...
  public static Builder newBuilder(TestIamPermissionsReservationHttpRequest prototype) {
  ...
  public static TestIamPermissionsReservationHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsReservationHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsReservationHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsReservationHttpRequest other) {
      if (other == TestIamPermissionsReservationHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsReservationHttpRequest source) {
    ...
    /**
     * Name or id of the resource for this request. It must have the format
     * `{project}/zones/{zone}/reservations/{resource}/testIamPermissions`. \`{resource}\` must
    ...
    public TestIamPermissionsReservationHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsReservationHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsReservationHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsReservationHttpRequest) {
      TestIamPermissionsReservationHttpRequest that = (TestIamPermissionsReservationHttpRequest) o;
