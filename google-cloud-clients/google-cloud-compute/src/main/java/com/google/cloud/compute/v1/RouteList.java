...
@Generated("by GAPIC")
@BetaApi
public final class RouteList implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(RouteList other) {
      if (other == RouteList.getDefaultInstance()) return this;
      if (other.getId() != null) {
        this.id = other.id;
      }
    ...
    public Builder addAllItems(List<Route> items) {
      if (this.items == null) {
    ...
    public Builder addItems(Route items) {
      if (this.items == null) {
        this.items = new LinkedList<>();
      }
