...
@Generated("by GAPIC")
@BetaApi
public final class ReservationList implements ApiMessage {
  ...
  public static class Builder {
    ...
    Builder(ReservationList source) {
      this.id = source.id;
    ...
    /** [Output Only] A list of Allocation resources. */
    public Builder addAllItems(List<Reservation> items) {
      if (this.items == null) {
    ...
    /** [Output Only] A list of Allocation resources. */
    public Builder addItems(Reservation items) {
      if (this.items == null) {
        this.items = new LinkedList<>();
      }
    ...
    public ReservationList build() {
      ...
      return new ReservationList(id, items, kind, nextPageToken, selfLink, warning);
    }
