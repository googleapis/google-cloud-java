...
@BetaApi
/**
 * Request object for method compute.targetVpnGateways.list. Retrieves a list of target VPN gateways
 * available to the specified project and region. (== suppress_warning http-rest-shadowed ==)
 */
