...
@BetaApi
/**
 * Request object for method compute.targetHttpProxies.aggregatedList. Retrieves the list of all
 * TargetHttpProxy resources, regional and global, available to the specified project. (==
 * suppress_warning http-rest-shadowed ==)
 */
public final class AggregatedListTargetHttpProxiesHttpRequest implements ApiMessage {
  ...
  private AggregatedListTargetHttpProxiesHttpRequest() {
   ...
   * `{project}/aggregated/targetHttpProxies`. \`{project}\` must start with a letter, and contain
  ...
  public static Builder newBuilder(AggregatedListTargetHttpProxiesHttpRequest prototype) {
  ...
  public static AggregatedListTargetHttpProxiesHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListTargetHttpProxiesHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListTargetHttpProxiesHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListTargetHttpProxiesHttpRequest other) {
      if (other == AggregatedListTargetHttpProxiesHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListTargetHttpProxiesHttpRequest source) {
    ...
    public AggregatedListTargetHttpProxiesHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListTargetHttpProxiesHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListTargetHttpProxiesHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListTargetHttpProxiesHttpRequest) {
      AggregatedListTargetHttpProxiesHttpRequest that =
          (AggregatedListTargetHttpProxiesHttpRequest) o;
