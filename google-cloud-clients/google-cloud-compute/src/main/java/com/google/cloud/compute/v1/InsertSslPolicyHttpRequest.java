...
public final class InsertSslPolicyHttpRequest implements ApiMessage {
  ...
  private InsertSslPolicyHttpRequest() {
  ...
  public static Builder newBuilder(InsertSslPolicyHttpRequest prototype) {
  ...
  public static InsertSslPolicyHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertSslPolicyHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertSslPolicyHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertSslPolicyHttpRequest other) {
      if (other == InsertSslPolicyHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(InsertSslPolicyHttpRequest source) {
    ...
    public InsertSslPolicyHttpRequest build() {
      String missing = "";
      ...
      return new InsertSslPolicyHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "InsertSslPolicyHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertSslPolicyHttpRequest) {
      InsertSslPolicyHttpRequest that = (InsertSslPolicyHttpRequest) o;
