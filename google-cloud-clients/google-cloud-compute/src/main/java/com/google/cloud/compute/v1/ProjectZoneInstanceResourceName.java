...
@Generated("by GAPIC")
@BetaApi
public final class ProjectZoneInstanceResourceName implements ResourceName {
  ...
  public static ProjectZoneInstanceResourceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(
            resourcePath,
            "ProjectZoneInstanceResourceName.parse: formattedString not in valid format");
  ...
  public static class Builder {
    ...
    public Builder(ProjectZoneInstanceResourceName projectZoneInstanceResourceName) {
      project = projectZoneInstanceResourceName.project;
      resource = projectZoneInstanceResourceName.resource;
      zone = projectZoneInstanceResourceName.zone;
    }
