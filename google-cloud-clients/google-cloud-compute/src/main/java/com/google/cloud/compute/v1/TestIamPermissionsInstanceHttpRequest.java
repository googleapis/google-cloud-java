...
@BetaApi
/**
 * Request object for method compute.instances.testIamPermissions. Returns permissions that a caller
 * has on the specified resource.
 */
public final class TestIamPermissionsInstanceHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsInstanceHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsInstanceHttpRequest prototype) {
  ...
  public static TestIamPermissionsInstanceHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsInstanceHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsInstanceHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsInstanceHttpRequest other) {
      if (other == TestIamPermissionsInstanceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsInstanceHttpRequest source) {
    ...
    public TestIamPermissionsInstanceHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsInstanceHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsInstanceHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsInstanceHttpRequest) {
      TestIamPermissionsInstanceHttpRequest that = (TestIamPermissionsInstanceHttpRequest) o;
