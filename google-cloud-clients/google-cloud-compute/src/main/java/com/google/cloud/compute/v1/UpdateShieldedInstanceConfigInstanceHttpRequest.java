...
public final class UpdateShieldedInstanceConfigInstanceHttpRequest implements ApiMessage {
  ...
  public static Builder newBuilder(UpdateShieldedInstanceConfigInstanceHttpRequest prototype) {
  ...
  public static UpdateShieldedInstanceConfigInstanceHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final UpdateShieldedInstanceConfigInstanceHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new UpdateShieldedInstanceConfigInstanceHttpRequest();
  }
  ...
  public static class Builder {
    ...
    private ShieldedInstanceConfig shieldedInstanceConfigResource;
    private String userIp;

    Builder() {}

    public Builder mergeFrom(UpdateShieldedInstanceConfigInstanceHttpRequest other) {
      if (other == UpdateShieldedInstanceConfigInstanceHttpRequest.getDefaultInstance())
        return this;
      ...
      if (other.getShieldedInstanceConfigResource() != null) {
        this.shieldedInstanceConfigResource = other.shieldedInstanceConfigResource;
      }
    ...
    Builder(UpdateShieldedInstanceConfigInstanceHttpRequest source) {
      ...
      this.shieldedInstanceConfigResource = source.shieldedInstanceConfigResource;
    ...
    public UpdateShieldedInstanceConfigInstanceHttpRequest build() {
      ...
      return new UpdateShieldedInstanceConfigInstanceHttpRequest(
          access_token,
          callback,
          fieldMask,
          fields,
    ...
    public Builder clone() {
      ...
      newBuilder.setShieldedInstanceConfigResource(this.shieldedInstanceConfigResource);
  ...
  public String toString() {
    return "UpdateShieldedInstanceConfigInstanceHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof UpdateShieldedInstanceConfigInstanceHttpRequest) {
      UpdateShieldedInstanceConfigInstanceHttpRequest that =
          (UpdateShieldedInstanceConfigInstanceHttpRequest) o;
      return Objects.equals(this.access_token, that.getAccessToken())
          ...
          && Objects.equals(
              this.shieldedInstanceConfigResource, that.getShieldedInstanceConfigResource())
