...
public final class ListRegionCommitmentsHttpRequest implements ApiMessage {
  ...
  private ListRegionCommitmentsHttpRequest() {
  ...
  public static Builder newBuilder(ListRegionCommitmentsHttpRequest prototype) {
  ...
  public static ListRegionCommitmentsHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final ListRegionCommitmentsHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new ListRegionCommitmentsHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(ListRegionCommitmentsHttpRequest other) {
      if (other == ListRegionCommitmentsHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(ListRegionCommitmentsHttpRequest source) {
    ...
    public ListRegionCommitmentsHttpRequest build() {
      String missing = "";
      ...
      return new ListRegionCommitmentsHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ListRegionCommitmentsHttpRequest) {
      ListRegionCommitmentsHttpRequest that = (ListRegionCommitmentsHttpRequest) o;
