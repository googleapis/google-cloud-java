...
@BetaApi
/**
 * Request object for method compute.interconnects.patch. Updates the specified interconnect with
 * the data included in the request. This method supports PATCH semantics and uses the JSON merge
