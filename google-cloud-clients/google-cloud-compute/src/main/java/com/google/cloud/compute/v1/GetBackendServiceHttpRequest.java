...
public final class GetBackendServiceHttpRequest implements ApiMessage {
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetBackendServiceHttpRequest other) {
      if (other == GetBackendServiceHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetBackendServiceHttpRequest source) {
