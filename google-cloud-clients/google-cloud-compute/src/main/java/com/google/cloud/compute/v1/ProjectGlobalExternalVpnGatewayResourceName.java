...
@Generated("by GAPIC")
@BetaApi
public final class ProjectGlobalExternalVpnGatewayResourceName implements ResourceName {
  private final String project;
  private final String resource;
  private static final PathTemplate PATH_TEMPLATE =
      PathTemplate.createWithoutUrlEncoding("{project}/global/externalVpnGateways/{resource}");
  ...
  public static ProjectGlobalExternalVpnGatewayResourceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(
            resourcePath,
            "ProjectGlobalExternalVpnGatewayResourceName.parse: formattedString not in valid format");
  ...
  public static class Builder {
    ...
    public Builder(
        ProjectGlobalExternalVpnGatewayResourceName projectGlobalExternalVpnGatewayResourceName) {
      project = projectGlobalExternalVpnGatewayResourceName.project;
      resource = projectGlobalExternalVpnGatewayResourceName.resource;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof ProjectGlobalExternalVpnGatewayResourceName) {
      ProjectGlobalExternalVpnGatewayResourceName that =
          (ProjectGlobalExternalVpnGatewayResourceName) o;
