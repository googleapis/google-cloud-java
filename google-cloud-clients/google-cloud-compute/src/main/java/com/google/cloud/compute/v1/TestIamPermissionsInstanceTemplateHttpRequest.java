...
public final class TestIamPermissionsInstanceTemplateHttpRequest implements ApiMessage {
  ...
  private TestIamPermissionsInstanceTemplateHttpRequest() {
  ...
  public static Builder newBuilder(TestIamPermissionsInstanceTemplateHttpRequest prototype) {
  ...
  public static TestIamPermissionsInstanceTemplateHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final TestIamPermissionsInstanceTemplateHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new TestIamPermissionsInstanceTemplateHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(TestIamPermissionsInstanceTemplateHttpRequest other) {
      if (other == TestIamPermissionsInstanceTemplateHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(TestIamPermissionsInstanceTemplateHttpRequest source) {
    ...
    public TestIamPermissionsInstanceTemplateHttpRequest build() {
      String missing = "";
      ...
      return new TestIamPermissionsInstanceTemplateHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "TestIamPermissionsInstanceTemplateHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof TestIamPermissionsInstanceTemplateHttpRequest) {
      TestIamPermissionsInstanceTemplateHttpRequest that =
          (TestIamPermissionsInstanceTemplateHttpRequest) o;
