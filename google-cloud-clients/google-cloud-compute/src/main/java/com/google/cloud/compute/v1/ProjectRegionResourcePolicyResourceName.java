...
@Generated("by GAPIC")
@BetaApi
public final class ProjectRegionResourcePolicyResourceName implements ResourceName {
  ...
  public static ProjectRegionResourcePolicyResourceName of(
  ...
  public static ProjectRegionResourcePolicyResourceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(
            resourcePath,
            "ProjectRegionResourcePolicyResourceName.parse: formattedString not in valid format");
  ...
  public static class Builder {
    ...
    public Builder(
        ProjectRegionResourcePolicyResourceName projectRegionResourcePolicyResourceName) {
      project = projectRegionResourcePolicyResourceName.project;
      region = projectRegionResourcePolicyResourceName.region;
      resource = projectRegionResourcePolicyResourceName.resource;
    }
