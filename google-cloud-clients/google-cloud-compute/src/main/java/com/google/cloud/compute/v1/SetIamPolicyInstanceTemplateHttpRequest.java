...
@BetaApi
/**
 * Request object for method compute.instanceTemplates.setIamPolicy. Sets the access control policy
 * on the specified resource. Replaces any existing policy.
 */
public final class SetIamPolicyInstanceTemplateHttpRequest implements ApiMessage {
  ...
  private SetIamPolicyInstanceTemplateHttpRequest() {
  ...
  public static Builder newBuilder(SetIamPolicyInstanceTemplateHttpRequest prototype) {
  ...
  public static SetIamPolicyInstanceTemplateHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicyInstanceTemplateHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicyInstanceTemplateHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicyInstanceTemplateHttpRequest other) {
      if (other == SetIamPolicyInstanceTemplateHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicyInstanceTemplateHttpRequest source) {
    ...
    public SetIamPolicyInstanceTemplateHttpRequest build() {
      String missing = "";
      ...
      return new SetIamPolicyInstanceTemplateHttpRequest(
          access_token,
          callback,
          fields,
  ...
  public String toString() {
    return "SetIamPolicyInstanceTemplateHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicyInstanceTemplateHttpRequest) {
      SetIamPolicyInstanceTemplateHttpRequest that = (SetIamPolicyInstanceTemplateHttpRequest) o;
