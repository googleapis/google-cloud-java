...
public final class AggregatedListHealthChecksHttpRequest implements ApiMessage {
  ...
  private AggregatedListHealthChecksHttpRequest() {
   ...
   * `{project}/aggregated/healthChecks`. \`{project}\` must start with a letter, and contain only
  ...
  public static Builder newBuilder(AggregatedListHealthChecksHttpRequest prototype) {
  ...
  public static AggregatedListHealthChecksHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final AggregatedListHealthChecksHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new AggregatedListHealthChecksHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(AggregatedListHealthChecksHttpRequest other) {
      if (other == AggregatedListHealthChecksHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(AggregatedListHealthChecksHttpRequest source) {
    ...
    public AggregatedListHealthChecksHttpRequest build() {
      String missing = "";
      ...
      return new AggregatedListHealthChecksHttpRequest(
          access_token,
          callback,
          fields,
          filter,
  ...
  public String toString() {
    return "AggregatedListHealthChecksHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof AggregatedListHealthChecksHttpRequest) {
      AggregatedListHealthChecksHttpRequest that = (AggregatedListHealthChecksHttpRequest) o;
