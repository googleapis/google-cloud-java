...
@BetaApi
/**
 * Request object for method compute.nodeTemplates.setIamPolicy. Sets the access control policy on
 * the specified resource. Replaces any existing policy.
 */
public final class SetIamPolicyNodeTemplateHttpRequest implements ApiMessage {
  ...
  private SetIamPolicyNodeTemplateHttpRequest() {
  ...
  public static Builder newBuilder(SetIamPolicyNodeTemplateHttpRequest prototype) {
  ...
  public static SetIamPolicyNodeTemplateHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicyNodeTemplateHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicyNodeTemplateHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicyNodeTemplateHttpRequest other) {
      if (other == SetIamPolicyNodeTemplateHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicyNodeTemplateHttpRequest source) {
    ...
    public SetIamPolicyNodeTemplateHttpRequest build() {
      String missing = "";
      ...
      return new SetIamPolicyNodeTemplateHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetIamPolicyNodeTemplateHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicyNodeTemplateHttpRequest) {
      SetIamPolicyNodeTemplateHttpRequest that = (SetIamPolicyNodeTemplateHttpRequest) o;
