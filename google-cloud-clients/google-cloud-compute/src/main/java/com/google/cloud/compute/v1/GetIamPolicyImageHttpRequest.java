...
public final class GetIamPolicyImageHttpRequest implements ApiMessage {
  ...
  private GetIamPolicyImageHttpRequest() {
  ...
  public static Builder newBuilder(GetIamPolicyImageHttpRequest prototype) {
  ...
  public static GetIamPolicyImageHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final GetIamPolicyImageHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new GetIamPolicyImageHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(GetIamPolicyImageHttpRequest other) {
      if (other == GetIamPolicyImageHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(GetIamPolicyImageHttpRequest source) {
    ...
    public GetIamPolicyImageHttpRequest build() {
      String missing = "";
      ...
      return new GetIamPolicyImageHttpRequest(
  ...
  public String toString() {
    return "GetIamPolicyImageHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof GetIamPolicyImageHttpRequest) {
      GetIamPolicyImageHttpRequest that = (GetIamPolicyImageHttpRequest) o;
