 ...
 * <pre>
 * <code>
 * try (BaseBigtableInstanceAdminClient bigtableInstanceAdminClient = BaseBigtableInstanceAdminClient.create()) {
 ...
 *         .build();
 * BaseBigtableInstanceAdminClient bigtableInstanceAdminClient =
 *     BaseBigtableInstanceAdminClient.create(bigtableInstanceAdminSettings);
 * </code>
 * </pre>
 *
...
public class BaseBigtableInstanceAdminClient implements BackgroundResource {
  ...
  /**
   * Constructs an instance of BaseBigtableInstanceAdminClient, using the given settings. The channels
   * are created based on the settings passed in, or defaults for any settings that are not set.
   */
  public static final BaseBigtableInstanceAdminClient create(BigtableInstanceAdminSettings settings)
      throws IOException {
   ...
   * should be preferred.
   */
  protected BaseBigtableInstanceAdminClient(BigtableInstanceAdminSettings settings) throws IOException {
