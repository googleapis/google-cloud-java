Google Cloud Java Client for Service Account Credentials API
===================================================

Java idiomatic client for [Service Account Credentials API][product-overview].
...
About Service Account Credentials API
----------------------------

[Service Account Credentials API][product-overview] creates short-lived, limited-privilege credentials for IAM service accounts.

See the [Service Account Credentials client library docs][lib-docs] to learn how to use this Service Account Credentials Client Library.

Getting Started
---------------
#### Prerequisites
You will need a [Google Developers Console](https://console.developers.google.com/) project with the Service Account Credentials API enabled. [Follow these instructions](https://cloud.google.com/resource-manager/docs/creating-managing-projects) to get your project set up. You will also need to set up the local development environment by [installing the Google Cloud SDK](https://cloud.google.com/sdk/) and running the following commands in command line: `gcloud auth login` and `gcloud config set project [YOUR PROJECT ID]`.
...
Transport
---------
Service Account Credentials API uses gRPC for the transport layer.
