...
def main():
  ...
  java.format_code('google-cloud-bigtable/src')
...
def generate_data_api(gapic):
  ...
  s.copy(library / 'gapic-google-cloud-bigtable-v2', './google-cloud-bigtable', excludes=excludes)
  s.copy(library / 'grpc-google-cloud-bigtable-v2/src', './grpc-google-cloud-bigtable-v2/src')
  s.copy(library / 'proto-google-cloud-bigtable-v2/src', './proto-google-cloud-bigtable-v2/src')

  make_internal_only(internal_only)

  java.format_code('./grpc-google-cloud-bigtable-v2/src')
  java.format_code('./proto-google-cloud-bigtable-v2/src')
...
def generate_admin_api(gapic):
  ...
  s.copy(library / 'gapic-google-cloud-bigtable-admin-v2/src', './google-cloud-bigtable/src', excludes=excludes)
  s.copy(library / 'grpc-google-cloud-bigtable-admin-v2/src', './grpc-google-cloud-bigtable-admin-v2/src')
  s.copy(library / 'proto-google-cloud-bigtable-admin-v2/src', './proto-google-cloud-bigtable-admin-v2/src')

  make_internal_only(internal_only)

  java.format_code('./grpc-google-cloud-bigtable-admin-v2/src')
  java.format_code('./proto-google-cloud-bigtable-admin-v2/src')
