...
public class RoutineTest {
    ...
    private static final RoutineInfo ROUTINE_INFO = RoutineInfo.newBuilder(ROUTINE_ID)
            .setEtag(ETAG)
    ...
    private void initializeExpectedRoutine(int optionsCalls) {
        ...
        expectedRoutine = new Routine(serviceMockReturnsOptions, new RoutineInfo.BuilderImpl(ROUTINE_INFO));
    }
    ...
    public void testExists_False() throws Exception {
        ...
        BigQuery.RoutineOption[] expectedOptions = {BigQuery.RoutineOption.fields()};
        expect(bigquery.getOptions()).andReturn(mockOptions);
        expect(bigquery.getRoutine(ROUTINE_INFO.getRoutineId(), expectedOptions)).andReturn(expectedRoutine);
        replay(bigquery);
        initializeRoutine();
