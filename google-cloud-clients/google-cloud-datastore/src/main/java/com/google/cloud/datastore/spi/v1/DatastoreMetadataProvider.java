 ...
 */
class DatastoreMetadataProvider {
  ...
  private DatastoreMetadataProvider(Map<String, String> headers, String resourceHeaderKey) {
    this.resourceHeaderKey = resourceHeaderKey;
    this.headers = constructHeadersAsMetadata(headers);
  }

  static DatastoreMetadataProvider create(Map<String, String> headers, String resourceHeaderKey) {
    return new DatastoreMetadataProvider(headers, resourceHeaderKey);
  }
