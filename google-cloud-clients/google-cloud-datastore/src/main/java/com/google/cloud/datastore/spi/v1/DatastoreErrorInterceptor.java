...
/**
 * Adds error details to statuses returned by the Cloud Datastore API. TODO(user): Add integration
 * tests to check for error details.
 */
public final class DatastoreErrorInterceptor implements ClientInterceptor {
  private static final Logger logger = Logger.getLogger(DatastoreErrorInterceptor.class.getName());
