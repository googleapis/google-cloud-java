...
```Groovy
compile 'com.google.cloud:google-cloud-video-intelligence:0.104.0-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-video-intelligence" % "0.104.0-beta"
```
