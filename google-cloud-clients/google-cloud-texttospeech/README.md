...
```Groovy
compile 'com.google.cloud:google-cloud-texttospeech:0.48.0-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-texttospeech" % "0.48.0-beta"
```
...
[texttospeech-client-lib-docs]: https://googlecloudplatform.github.io/google-cloud-java/latest/apidocs/index.html?com/google/cloud/texttospeech/v1beta1/package-summary.html
