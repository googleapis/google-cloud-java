...
public class DatabaseAdminSettings extends ClientSettings<DatabaseAdminSettings> {
  ...
  public UnaryCallSettings<SetIamPolicyRequest, Policy> setIamPolicyOnBackupInternalOnlySettings() {
    return ((DatabaseAdminStubSettings) getStubSettings())
  ...
  public static class Builder extends ClientSettings.Builder<DatabaseAdminSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<SetIamPolicyRequest, Policy>
        setIamPolicyOnBackupInternalOnlySettings() {
      return getStubSettingsBuilder().setIamPolicyOnBackupInternalOnlySettings();
    }
    ...
    public UnaryCallSettings.Builder<GetIamPolicyRequest, Policy>
        getIamPolicyOnBackupInternalOnlySettings() {
      return getStubSettingsBuilder().getIamPolicyOnBackupInternalOnlySettings();
    }
    ...
    public UnaryCallSettings.Builder<TestIamPermissionsRequest, TestIamPermissionsResponse>
        testIamPermissionsOnBackupInternalOnlySettings() {
      return getStubSettingsBuilder().testIamPermissionsOnBackupInternalOnlySettings();
    }
