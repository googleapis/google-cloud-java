...
public class DeviceManagerClient implements BackgroundResource {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final DeviceRegistry getDeviceRegistry(DeviceRegistryName name) {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final void deleteDeviceRegistry(DeviceRegistryName name) {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final Device createDevice(DeviceRegistryName parent, Device device) {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final ListDevicesPagedResponse listDevices(DeviceRegistryName parent) {
  ...
  public final BindDeviceToGatewayResponse bindDeviceToGateway(
      DeviceRegistryName parent, String gatewayId, String deviceId) {
