...
```Groovy
compile 'com.google.cloud:google-cloud-automl:0.54.0-alpha'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-automl" % "0.54.0-alpha"
```
...
[Cloud Auto ML][cloud-automl] is a web security scanner for common vulnerabilities in Google App Engine applications.
