...
public class ITReadWriteAutocommitSpannerTest extends ITAbstractSpannerTest {
  ...
  @Test
  public void test05_MultipleStatements_WithTimeouts() throws InterruptedException {
    try (ITConnection connection = createConnection()) {
  ...
  @Test
  public void test08_BatchUpdate() {
    try (ITConnection connection = createConnection()) {
  ...
  @Test
  public void test09_BatchUpdateWithException() {
