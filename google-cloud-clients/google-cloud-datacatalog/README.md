Google Cloud Java Client for Data Catalog
===================================================
...
```Groovy
compile 'com.google.cloud:google-cloud-datacatalog:0.10.0-alpha'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datacatalog" % "0.10.0-alpha"
```
