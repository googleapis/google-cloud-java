...
public class DataTransferServiceClient implements BackgroundResource {
   ...
   * <pre><code>
   * try (DataTransferServiceClient dataTransferServiceClient = DataTransferServiceClient.create()) {
   *   EnableDataTransferServiceRequest request = EnableDataTransferServiceRequest.newBuilder().build();
   ...
   * <pre><code>
   * try (DataTransferServiceClient dataTransferServiceClient = DataTransferServiceClient.create()) {
   *   IsDataTransferServiceEnabledRequest request = IsDataTransferServiceEnabledRequest.newBuilder().build();
