...
```Groovy
compile 'com.google.cloud:google-cloud-webrisk:0.71.0-beta'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-webrisk" % "0.71.0-beta"
```
...
[Cloud Web Risk][product-overview] Cloud Web Risk
