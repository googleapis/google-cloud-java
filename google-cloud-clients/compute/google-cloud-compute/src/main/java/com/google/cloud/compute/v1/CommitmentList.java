...
public final class CommitmentList implements ApiMessage {
  ...
  private final List<Commitment> items;
  ...
  public static class Builder {
    ...
    /** A list of Commitment resources. */
    public Builder addAllItems(List<Commitment> items) {
      if (this.items == null) {
    ...
    public CommitmentList build() {
      ...
      return new CommitmentList(id, items, kind, nextPageToken, selfLink, warning);
    }
