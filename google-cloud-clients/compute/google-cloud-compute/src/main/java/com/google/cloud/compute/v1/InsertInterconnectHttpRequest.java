...
@BetaApi
/**
 * Request object for method compute.interconnects.insert. Creates a Interconnect in the specified
 * project using the data included in the request.
 */
public final class InsertInterconnectHttpRequest implements ApiMessage {
  ...
  private InsertInterconnectHttpRequest() {
  ...
  public Object getFieldValue(String fieldName) {
    ...
    if ("interconnectResource".equals(fieldName)) {
  ...
  @Nullable
  @Override
  public Interconnect getApiMessageRequestBody() {
    return interconnectResource;
  }
  ...
  public static Builder newBuilder(InsertInterconnectHttpRequest prototype) {
  ...
  public static InsertInterconnectHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final InsertInterconnectHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new InsertInterconnectHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(InsertInterconnectHttpRequest other) {
      if (other == InsertInterconnectHttpRequest.getDefaultInstance()) return this;
      ...
      if (other.getInterconnectResource() != null) {
        this.interconnectResource = other.interconnectResource;
      }
    ...
    Builder(InsertInterconnectHttpRequest source) {
    ...
    public InsertInterconnectHttpRequest build() {
      ...
      return new InsertInterconnectHttpRequest(
          access_token,
          callback,
          fields,
  ...
  public String toString() {
    return "InsertInterconnectHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof InsertInterconnectHttpRequest) {
      InsertInterconnectHttpRequest that = (InsertInterconnectHttpRequest) o;
