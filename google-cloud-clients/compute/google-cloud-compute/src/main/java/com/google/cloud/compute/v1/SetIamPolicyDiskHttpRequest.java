...
@BetaApi
/**
 * Request object for method compute.disks.setIamPolicy. Sets the access control policy on the
 * specified resource. Replaces any existing policy.
 */
public final class SetIamPolicyDiskHttpRequest implements ApiMessage {
  ...
  private SetIamPolicyDiskHttpRequest() {
  ...
  public static Builder newBuilder(SetIamPolicyDiskHttpRequest prototype) {
  ...
  public static SetIamPolicyDiskHttpRequest getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final SetIamPolicyDiskHttpRequest DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new SetIamPolicyDiskHttpRequest();
  }
  ...
  public static class Builder {
    ...
    public Builder mergeFrom(SetIamPolicyDiskHttpRequest other) {
      if (other == SetIamPolicyDiskHttpRequest.getDefaultInstance()) return this;
    ...
    Builder(SetIamPolicyDiskHttpRequest source) {
    ...
    public SetIamPolicyDiskHttpRequest build() {
      ...
      return new SetIamPolicyDiskHttpRequest(
          access_token,
          callback,
          fields,
          key,
  ...
  public String toString() {
    return "SetIamPolicyDiskHttpRequest{"
        + "access_token="
        + access_token
        + ", "
        + "callback="
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof SetIamPolicyDiskHttpRequest) {
      SetIamPolicyDiskHttpRequest that = (SetIamPolicyDiskHttpRequest) o;
