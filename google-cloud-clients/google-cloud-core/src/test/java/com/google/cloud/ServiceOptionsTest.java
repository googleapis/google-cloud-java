...
public class ServiceOptionsTest {
  ...
  private interface TestServiceRpcFactory extends ServiceRpcFactory<TestServiceOptions> {}
  ...
  private static class TestServiceOptions extends ServiceOptions<TestService, TestServiceOptions> {
