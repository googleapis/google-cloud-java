...
def build_proto(target):
  ...
  s.copy(src_output / "src/com", "proto-google-devtools-source-protos/src/main/java/com")

build_proto("//google/devtools/source/v1:source_java_proto")

java.format_code("proto-google-devtools-source-protos/src")
