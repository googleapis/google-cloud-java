 ...
 */
public final class ListBreakpointsRequest extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class BreakpointActionValue extends com.google.protobuf.GeneratedMessage
      implements
    ...
    static {
      com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
          ...
          /* patch= */ 1,
          /* suffix= */ "",
          BreakpointActionValue.class.getName());
    }
    // Use BreakpointActionValue.newBuilder() to construct.
    private BreakpointActionValue(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  @java.lang.Override
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(debuggeeId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, debuggeeId_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(waitToken_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, waitToken_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(debuggeeId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, debuggeeId_);
    }
    if (includeAllUsers_ != false) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(waitToken_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, waitToken_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(clientVersion_)) {
