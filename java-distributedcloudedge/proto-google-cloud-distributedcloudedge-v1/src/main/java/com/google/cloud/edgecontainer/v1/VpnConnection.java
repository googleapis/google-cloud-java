...
public final class VpnConnection extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private VpnConnection(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class VpcProject extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private VpcProject(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class Details extends com.google.protobuf.GeneratedMessage
      implements
     ...
     */
    public static final class CloudRouter extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private CloudRouter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
     ...
     */
    public static final class CloudVpn extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private CloudVpn(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetCloudRouterFieldBuilder();
          internalGetCloudVpnsFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetCloudRouterFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.edgecontainer.v1.VpnConnection.Details.CloudRouter.Builder
        ...
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetCloudRouterFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.edgecontainer.v1.VpnConnection.Details.CloudVpn.Builder
        ...
        return internalGetCloudVpnsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.edgecontainer.v1.VpnConnection.Details.CloudVpn.Builder
          addCloudVpnsBuilder() {
        return internalGetCloudVpnsFieldBuilder()
            .addBuilder(
                com.google.cloud.edgecontainer.v1.VpnConnection.Details.CloudVpn
                    .getDefaultInstance());
      }
      ...
      public java.util.List<
        ...
        return internalGetCloudVpnsFieldBuilder().getBuilderList();
      }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(natGatewayIp_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, natGatewayIp_);
    }
    if (bgpRoutingMode_
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vpc_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, vpc_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(router_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, router_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(natGatewayIp_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, natGatewayIp_);
    }
    if (bgpRoutingMode_
        != com.google.cloud.edgecontainer.v1.VpnConnection.BgpRoutingMode
            .BGP_ROUTING_MODE_UNSPECIFIED
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(vpc_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, vpc_);
    }
    if (enableHighAvailability_ != false) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(router_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(12, router_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetVpcProjectFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 90:
              {
                input.readMessage(
                    internalGetVpcProjectFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.edgecontainer.v1.VpnConnection.VpcProject.Builder
      ...
      bitField0_ |= 0x00000100;
      onChanged();
      return internalGetVpcProjectFieldBuilder().getBuilder();
    }
