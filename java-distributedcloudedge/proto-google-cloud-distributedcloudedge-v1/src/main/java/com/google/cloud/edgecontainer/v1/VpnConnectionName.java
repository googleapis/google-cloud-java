...
public class VpnConnectionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_VPN_CONNECTION =
  ...
  private VpnConnectionName(Builder builder) {
    ...
    vpnConnection = Preconditions.checkNotNull(builder.getVpnConnection());
  }
  ...
  public static @Nullable VpnConnectionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_VPN_CONNECTION.validatedMatch(
            formattedString, "VpnConnectionName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("vpn_connection"));
  }

  public static List<VpnConnectionName> parseList(List<String> formattedStrings) {
    List<VpnConnectionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable VpnConnectionName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (vpnConnection != null) {
            fieldMapBuilder.put("vpn_connection", vpnConnection);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_VPN_CONNECTION.instantiate(
        "project", project, "location", location, "vpn_connection", vpnConnection);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.vpnConnection, that.vpnConnection);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(vpnConnection);
    return h;
  }
