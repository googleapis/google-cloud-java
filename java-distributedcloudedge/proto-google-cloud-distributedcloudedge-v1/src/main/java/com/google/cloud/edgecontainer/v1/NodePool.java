...
public final class NodePool extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class LocalDiskEncryption extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private LocalDiskEncryption(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public static final class NodeConfig extends com.google.protobuf.GeneratedMessage
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(nodeStorageSchema_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, nodeStorageSchema_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(nodeStorageSchema_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, nodeStorageSchema_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(machineFilter_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, machineFilter_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(nodeLocation_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, nodeLocation_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      output.writeMessage(9, getLocalDiskEncryption());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(nodeVersion_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, nodeVersion_);
    }
    if (((bitField0_ & 0x00000008) != 0)) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(machineFilter_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, machineFilter_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(nodeLocation_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, nodeLocation_);
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, getLocalDiskEncryption());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(nodeVersion_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(10, nodeVersion_);
    }
    if (((bitField0_ & 0x00000008) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetLocalDiskEncryptionFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 74:
              {
                input.readMessage(
                    internalGetLocalDiskEncryptionFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.edgecontainer.v1.NodePool.LocalDiskEncryption.Builder
      ...
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetLocalDiskEncryptionFieldBuilder().getBuilder();
    }
