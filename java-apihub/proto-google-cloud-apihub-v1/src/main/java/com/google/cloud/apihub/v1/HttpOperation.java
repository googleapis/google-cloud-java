...
public final class HttpOperation extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private HttpOperation(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetPathFieldBuilder().getBuilder(), extensionRegistry);
