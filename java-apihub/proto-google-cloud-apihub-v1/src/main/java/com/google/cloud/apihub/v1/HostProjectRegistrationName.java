...
public class HostProjectRegistrationName implements ResourceName {
  ...
  public static @Nullable HostProjectRegistrationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable HostProjectRegistrationName> values) {
