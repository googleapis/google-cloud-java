...
public class DefinitionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_API_VERSION_DEFINITION =
  ...
  private DefinitionName(Builder builder) {
    ...
    definition = Preconditions.checkNotNull(builder.getDefinition());
  }
  ...
  public static DefinitionName of(
      String project, String location, String api, String version, String definition) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable DefinitionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_API_VERSION_DEFINITION.validatedMatch(
            formattedString, "DefinitionName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("api"),
        matchMap.get("version"),
        matchMap.get("definition"));
  }

  public static List<DefinitionName> parseList(List<String> formattedStrings) {
    List<DefinitionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable DefinitionName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (definition != null) {
            fieldMapBuilder.put("definition", definition);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_API_VERSION_DEFINITION.instantiate(
        "project",
        project,
        "location",
        location,
