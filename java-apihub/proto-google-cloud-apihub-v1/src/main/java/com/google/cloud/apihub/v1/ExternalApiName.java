...
public class ExternalApiName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_EXTERNAL_API =
  ...
  private ExternalApiName(Builder builder) {
    ...
    externalApi = Preconditions.checkNotNull(builder.getExternalApi());
  }
  ...
  public static @Nullable ExternalApiName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_EXTERNAL_API.validatedMatch(
            formattedString, "ExternalApiName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("external_api"));
  }

  public static List<ExternalApiName> parseList(List<String> formattedStrings) {
    List<ExternalApiName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ExternalApiName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (externalApi != null) {
            fieldMapBuilder.put("external_api", externalApi);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_EXTERNAL_API.instantiate(
        "project", project, "location", location, "external_api", externalApi);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.externalApi, that.externalApi);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(externalApi);
    return h;
  }
