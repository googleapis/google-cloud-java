...
public final class Plugin extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class HostingService extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private HostingService(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class ConfigTemplate extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ConfigTemplate(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
     ...
     */
    public static final class AuthConfigTemplate extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private AuthConfigTemplate(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }

      private AuthConfigTemplate() {
        supportedAuthTypes_ = emptyIntList();
      }
      ...
      @SuppressWarnings("serial")
      private com.google.protobuf.Internal.IntList supportedAuthTypes_ = emptyIntList();

      private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.cloud.apihub.v1.AuthType>
          supportedAuthTypes_converter_ =
              new com.google.protobuf.Internal.IntListAdapter.IntConverter<
                  com.google.cloud.apihub.v1.AuthType>() {
                public com.google.cloud.apihub.v1.AuthType convert(int from) {
      ...
      public java.util.List<com.google.cloud.apihub.v1.AuthType> getSupportedAuthTypesList() {
        return new com.google.protobuf.Internal.IntListAdapter<com.google.cloud.apihub.v1.AuthType>(
      ...
      public com.google.cloud.apihub.v1.AuthType getSupportedAuthTypes(int index) {
        return supportedAuthTypes_converter_.convert(supportedAuthTypes_.getInt(index));
      }
      ...
      public int getSupportedAuthTypesValue(int index) {
        return supportedAuthTypes_.getInt(index);
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        ...
        for (int i = 0; i < supportedAuthTypes_.size(); i++) {
          output.writeEnumNoTag(supportedAuthTypes_.getInt(i));
        }
      ...
      public static final class Builder
        ...
        private void buildPartial0(
          ...
          int from_bitField0_ = bitField0_;
          if (((from_bitField0_ & 0x00000001) != 0)) {
            supportedAuthTypes_.makeImmutable();
                ...
                case 8:
                  {
                    ...
                    ensureSupportedAuthTypesIsMutable();
                    supportedAuthTypes_.addInt(tmpRaw);
                    break;
                  } // case 8
                case 10:
                  {
                    ...
                    while (input.getBytesUntilLimit() > 0) {
                      supportedAuthTypes_.addInt(input.readEnum());
                    }
        ...
        private void ensureSupportedAuthTypesIsMutable() {
          if (!supportedAuthTypes_.isModifiable()) {
            supportedAuthTypes_ = makeMutableCopy(supportedAuthTypes_);
          }
          bitField0_ |= 0x00000001;
        }
        ...
        public Builder setSupportedAuthTypes(int index, com.google.cloud.apihub.v1.AuthType value) {
          ...
          ensureSupportedAuthTypesIsMutable();
          supportedAuthTypes_.setInt(index, value.getNumber());
          onChanged();
          return this;
        }
        ...
        public Builder addSupportedAuthTypes(com.google.cloud.apihub.v1.AuthType value) {
          ...
          ensureSupportedAuthTypesIsMutable();
          supportedAuthTypes_.addInt(value.getNumber());
          onChanged();
          return this;
        }
        ...
        public Builder setSupportedAuthTypesValue(int index, int value) {
          ensureSupportedAuthTypesIsMutable();
          supportedAuthTypes_.setInt(index, value);
          onChanged();
          return this;
        }
        ...
        public Builder addSupportedAuthTypesValue(int value) {
          ensureSupportedAuthTypesIsMutable();
          supportedAuthTypes_.addInt(value);
          onChanged();
          return this;
        }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetAuthConfigTemplateFieldBuilder();
          internalGetAdditionalConfigTemplateFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetAuthConfigTemplateFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000001;
                  break;
                } // case 10
              case 18:
      ...
      public com.google.cloud.apihub.v1.Plugin.ConfigTemplate.AuthConfigTemplate.Builder
        ...
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetAuthConfigTemplateFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.apihub.v1.ConfigVariableTemplate.Builder
        ...
        return internalGetAdditionalConfigTemplateFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.apihub.v1.ConfigVariableTemplate.Builder
        ...
        return internalGetAdditionalConfigTemplateFieldBuilder()
      ...
      public java.util.List<com.google.cloud.apihub.v1.ConfigVariableTemplate.Builder>
        ...
        return internalGetAdditionalConfigTemplateFieldBuilder().getBuilderList();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetHostingServiceFieldBuilder();
        internalGetActionsConfigFieldBuilder();
        internalGetDocumentationFieldBuilder();
        internalGetConfigTemplateFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58:
              {
                input.readMessage(
                    internalGetHostingServiceFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 98:
              {
                input.readMessage(
                    internalGetConfigTemplateFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.apihub.v1.Plugin.HostingService.Builder getHostingServiceBuilder() {
      bitField0_ |= 0x00000040;
      onChanged();
      return internalGetHostingServiceFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.apihub.v1.PluginActionConfig.Builder getActionsConfigBuilder(
        int index) {
      return internalGetActionsConfigFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.apihub.v1.PluginActionConfig.Builder addActionsConfigBuilder() {
      return internalGetActionsConfigFieldBuilder()
    ...
    public java.util.List<com.google.cloud.apihub.v1.PluginActionConfig.Builder>
      ...
      return internalGetActionsConfigFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.apihub.v1.Plugin.ConfigTemplate.Builder getConfigTemplateBuilder() {
      bitField0_ |= 0x00000400;
      onChanged();
      return internalGetConfigTemplateFieldBuilder().getBuilder();
    }
