...
/**
 * Settings class to configure an instance of {@link HostProjectRegistrationServiceStub}.
 *
...
public class HostProjectRegistrationServiceStubSettings
  ...
  private final UnaryCallSettings<CreateHostProjectRegistrationRequest, HostProjectRegistration>
      createHostProjectRegistrationSettings;
  private final UnaryCallSettings<GetHostProjectRegistrationRequest, HostProjectRegistration>
  ...
  private static final PagedListDescriptor<
      ...
      LIST_HOST_PROJECT_REGISTRATIONS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListHostProjectRegistrationsRequest injectToken(
                ListHostProjectRegistrationsRequest payload, String token) {
              return ListHostProjectRegistrationsRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListHostProjectRegistrationsRequest injectPageSize(
                ListHostProjectRegistrationsRequest payload, int pageSize) {
              return ListHostProjectRegistrationsRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<HostProjectRegistration> extractResources(
                ListHostProjectRegistrationsResponse payload) {
              return payload.getHostProjectRegistrationsList() == null
                  ? ImmutableList.<HostProjectRegistration>of()
                  : payload.getHostProjectRegistrationsList();
            }
          };
  ...
  private static final PagedListResponseFactory<
          ...
          ListHostProjectRegistrationsResponse,
          ListHostProjectRegistrationsPagedResponse>
      LIST_HOST_PROJECT_REGISTRATIONS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListHostProjectRegistrationsRequest,
              ListHostProjectRegistrationsResponse,
              ListHostProjectRegistrationsPagedResponse>() {
            @Override
            public ApiFuture<ListHostProjectRegistrationsPagedResponse> getFuturePagedResponse(
                UnaryCallable<
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          ...
                          request,
                          context);
              return ListHostProjectRegistrationsPagedResponse.createAsync(
  ...
  public UnaryCallSettings<CreateHostProjectRegistrationRequest, HostProjectRegistration>
      createHostProjectRegistrationSettings() {
    return createHostProjectRegistrationSettings;
  }
  ...
  public UnaryCallSettings<GetHostProjectRegistrationRequest, HostProjectRegistration>
      getHostProjectRegistrationSettings() {
    return getHostProjectRegistrationSettings;
  }
  ...
  public PagedCallSettings<
          ...
          ListHostProjectRegistrationsPagedResponse>
      listHostProjectRegistrationsSettings() {
    return listHostProjectRegistrationsSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(HostProjectRegistrationServiceStubSettings.class))
        .setTransportToken(
  ...
  protected HostProjectRegistrationServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    createHostProjectRegistrationSettings =
        settingsBuilder.createHostProjectRegistrationSettings().build();
    getHostProjectRegistrationSettings =
        settingsBuilder.getHostProjectRegistrationSettings().build();
    listHostProjectRegistrationsSettings =
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      createHostProjectRegistrationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      getHostProjectRegistrationSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      listHostProjectRegistrationsSettings =
          PagedCallSettings.newBuilder(LIST_HOST_PROJECT_REGISTRATIONS_PAGE_STR_FACT);
    ...
    protected Builder(HostProjectRegistrationServiceStubSettings settings) {
      ...
      createHostProjectRegistrationSettings =
          settings.createHostProjectRegistrationSettings.toBuilder();
      getHostProjectRegistrationSettings = settings.getHostProjectRegistrationSettings.toBuilder();
      listHostProjectRegistrationsSettings =
          settings.listHostProjectRegistrationsSettings.toBuilder();
