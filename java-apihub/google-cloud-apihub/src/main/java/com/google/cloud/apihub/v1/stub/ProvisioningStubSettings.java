...
public class ProvisioningStubSettings extends StubSettings<ProvisioningStubSettings> {
  ...
  private final UnaryCallSettings<CreateApiHubInstanceRequest, Operation>
  ...
  public UnaryCallSettings<CreateApiHubInstanceRequest, Operation> createApiHubInstanceSettings() {
    return createApiHubInstanceSettings;
  }
  ...
  public UnaryCallSettings<GetApiHubInstanceRequest, ApiHubInstance> getApiHubInstanceSettings() {
    return getApiHubInstanceSettings;
  }
  ...
  public static class Builder extends StubSettings.Builder<ProvisioningStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<CreateApiHubInstanceRequest, Operation>
        createApiHubInstanceSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<CreateApiHubInstanceRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.create(ApiHubInstance.class))
