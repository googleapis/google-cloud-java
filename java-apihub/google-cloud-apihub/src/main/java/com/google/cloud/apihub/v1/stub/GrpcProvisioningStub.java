...
public class GrpcProvisioningStub extends ProvisioningStub {
  private static final MethodDescriptor<CreateApiHubInstanceRequest, Operation>
      createApiHubInstanceMethodDescriptor =
          MethodDescriptor.<CreateApiHubInstanceRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.apihub.v1.Provisioning/CreateApiHubInstance")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(CreateApiHubInstanceRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(Operation.getDefaultInstance()))
              .build();

  private static final MethodDescriptor<GetApiHubInstanceRequest, ApiHubInstance>
      getApiHubInstanceMethodDescriptor =
          MethodDescriptor.<GetApiHubInstanceRequest, ApiHubInstance>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.apihub.v1.Provisioning/GetApiHubInstance")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(GetApiHubInstanceRequest.getDefaultInstance()))
              .setResponseMarshaller(ProtoUtils.marshaller(ApiHubInstance.getDefaultInstance()))
              .build();

  private static final MethodDescriptor<LookupApiHubInstanceRequest, LookupApiHubInstanceResponse>
      lookupApiHubInstanceMethodDescriptor =
          MethodDescriptor.<LookupApiHubInstanceRequest, LookupApiHubInstanceResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.apihub.v1.Provisioning/LookupApiHubInstance")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(LookupApiHubInstanceRequest.getDefaultInstance()))
              .setResponseMarshaller(
                  ProtoUtils.marshaller(LookupApiHubInstanceResponse.getDefaultInstance()))
              .build();
  ...
  protected GrpcProvisioningStub(
    ...
    GrpcCallSettings<CreateApiHubInstanceRequest, Operation> createApiHubInstanceTransportSettings =
        GrpcCallSettings.<CreateApiHubInstanceRequest, Operation>newBuilder()
            ...
            .build();
    GrpcCallSettings<GetApiHubInstanceRequest, ApiHubInstance> getApiHubInstanceTransportSettings =
        GrpcCallSettings.<GetApiHubInstanceRequest, ApiHubInstance>newBuilder()
            ...
            .build();
    GrpcCallSettings<LookupApiHubInstanceRequest, LookupApiHubInstanceResponse>
        lookupApiHubInstanceTransportSettings =
            GrpcCallSettings.<LookupApiHubInstanceRequest, LookupApiHubInstanceResponse>newBuilder()
