...
public interface PreviewGameServerDeploymentRolloutRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gaming.v1.PreviewGameServerDeploymentRolloutRequest)
   ...
   *
   * <code>
   * .google.cloud.gaming.v1.GameServerDeploymentRollout rollout = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
