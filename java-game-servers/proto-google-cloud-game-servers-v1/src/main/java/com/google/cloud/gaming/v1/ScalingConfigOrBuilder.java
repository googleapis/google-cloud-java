...
public interface ScalingConfigOrBuilder
   ...
   */
  java.util.List<com.google.cloud.gaming.v1.LabelSelector> getSelectorsList();
  /**
   *
   *
   * <pre>
   ...
   */
  java.util.List<com.google.cloud.gaming.v1.Schedule> getSchedulesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.gaming.v1.Schedule schedules = 5;</code>
   */
  com.google.cloud.gaming.v1.ScheduleOrBuilder getSchedulesOrBuilder(int index);
}
