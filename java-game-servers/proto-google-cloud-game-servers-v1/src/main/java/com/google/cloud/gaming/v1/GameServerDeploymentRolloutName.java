...
public class GameServerDeploymentRolloutName implements ResourceName {
  ...
  @Deprecated
  protected GameServerDeploymentRolloutName() {
    project = null;
    location = null;
    deployment = null;
  }

  private GameServerDeploymentRolloutName(Builder builder) {
  ...
  public static GameServerDeploymentRolloutName of(
      String project, String location, String deployment) {
  ...
  public static GameServerDeploymentRolloutName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_DEPLOYMENT.validatedMatch(
            formattedString,
            "GameServerDeploymentRolloutName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("deployment"));
  }

  public static List<GameServerDeploymentRolloutName> parseList(List<String> formattedStrings) {
    List<GameServerDeploymentRolloutName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<GameServerDeploymentRolloutName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (GameServerDeploymentRolloutName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      GameServerDeploymentRolloutName that = ((GameServerDeploymentRolloutName) o);
  ...
  /**
   * Builder for projects/{project}/locations/{location}/gameServerDeployments/{deployment}/rollout.
   */
  public static class Builder {
    ...
    public GameServerDeploymentRolloutName build() {
      return new GameServerDeploymentRolloutName(this);
    }
  }
}
