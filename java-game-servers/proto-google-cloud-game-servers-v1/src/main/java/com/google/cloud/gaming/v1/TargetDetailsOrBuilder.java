...
public interface TargetDetailsOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gaming.v1.TargetDetails)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.gaming.v1.TargetDetails.TargetFleetDetails> getFleetDetailsList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.gaming.v1.TargetDetails.TargetFleetDetails getFleetDetails(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.gaming.v1.TargetDetails.TargetFleetDetailsOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.gaming.v1.TargetDetails.TargetFleetDetailsOrBuilder getFleetDetailsOrBuilder(
      int index);
}
