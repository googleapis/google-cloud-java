...
public interface GameServerDeploymentRolloutOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gaming.v1alpha.GameServerDeploymentRollout)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.gaming.v1alpha.GameServerConfigOverride>
   ...
   * </code>
   */
  com.google.cloud.gaming.v1alpha.GameServerConfigOverride getGameServerConfigOverrides(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.gaming.v1alpha.GameServerConfigOverrideOrBuilder>
