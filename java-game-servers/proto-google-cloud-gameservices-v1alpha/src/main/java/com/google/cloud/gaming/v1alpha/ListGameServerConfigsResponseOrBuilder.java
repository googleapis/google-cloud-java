...
public interface ListGameServerConfigsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gaming.v1alpha.ListGameServerConfigsResponse)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.gaming.v1alpha.GameServerConfig game_server_configs = 1;</code>
   */
  java.util.List<com.google.cloud.gaming.v1alpha.GameServerConfig> getGameServerConfigsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.gaming.v1alpha.GameServerConfig game_server_configs = 1;</code>
   */
  com.google.cloud.gaming.v1alpha.GameServerConfig getGameServerConfigs(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.gaming.v1alpha.GameServerConfig game_server_configs = 1;</code>
   */
  java.util.List<? extends com.google.cloud.gaming.v1alpha.GameServerConfigOrBuilder>
   ...
   * <code>repeated .google.cloud.gaming.v1alpha.GameServerConfig game_server_configs = 1;</code>
   */
  com.google.cloud.gaming.v1alpha.GameServerConfigOrBuilder getGameServerConfigsOrBuilder(
      int index);
