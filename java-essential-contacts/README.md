...
```Groovy
implementation 'com.google.cloud:google-cloud-essential-contacts:2.1.0'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-essential-contacts" % "2.1.0"
```
...
[contributing]: https://github.com/googleapis/java-essential-contacts/blob/master/CONTRIBUTING.md
