...
public final class UpdateTenantRequest extends com.google.protobuf.GeneratedMessage
    implements
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetTenantFieldBuilder().getBuilder(), extensionRegistry);
