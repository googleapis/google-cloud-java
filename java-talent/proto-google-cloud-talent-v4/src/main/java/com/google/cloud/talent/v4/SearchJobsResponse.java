          ...
          case 18:
            {
              ...
              histogramQueryResults_.add(
                  input.readMessage(
                      com.google.cloud.talent.v4.HistogramQueryResult.parser(), extensionRegistry));
              break;
            }
          case 26:
            {
          ...
          case 58:
            {
              ...
              metadata_ =
                  input.readMessage(
                      com.google.cloud.talent.v4.ResponseMetadata.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 74:
            {
              ...
              spellCorrection_ =
                  input.readMessage(
                      com.google.cloud.talent.v4.SpellingCorrection.parser(), extensionRegistry);
              if (subBuilder != null) {
            ...
            case 42:
              {
                ...
                commuteInfo_ =
                    input.readMessage(
                        com.google.cloud.talent.v4.SearchJobsResponse.CommuteInfo.parser(),
                        extensionRegistry);
                if (subBuilder != null) {
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage =
              (com.google.cloud.talent.v4.SearchJobsResponse.MatchingJob) e.getUnfinishedMessage();
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage =
              (com.google.cloud.talent.v4.SearchJobsResponse.CommuteInfo) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      public Builder mergeJobLocation(com.google.cloud.talent.v4.Location value) {
        if (jobLocationBuilder_ == null) {
          if (jobLocation_ != null) {
            jobLocation_ =
                com.google.cloud.talent.v4.Location.newBuilder(jobLocation_)
                    .mergeFrom(value)
                    .buildPartial();
          } else {
            jobLocation_ = value;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeSpellCorrection(com.google.cloud.talent.v4.SpellingCorrection value) {
      if (spellCorrectionBuilder_ == null) {
        if (spellCorrection_ != null) {
          spellCorrection_ =
              com.google.cloud.talent.v4.SpellingCorrection.newBuilder(spellCorrection_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          spellCorrection_ = value;
