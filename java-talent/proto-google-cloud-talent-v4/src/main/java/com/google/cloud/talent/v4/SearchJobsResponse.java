...
public final class SearchJobsResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SearchJobsResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class MatchingJob extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private MatchingJob(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(jobSummary_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, jobSummary_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(jobTitleSnippet_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, jobTitleSnippet_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(searchTextSnippet_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, searchTextSnippet_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(jobSummary_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, jobSummary_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(jobTitleSnippet_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, jobTitleSnippet_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(searchTextSnippet_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(4, searchTextSnippet_);
      }
      if (((bitField0_ & 0x00000002) != 0)) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          ...
          internalGetCommuteInfoFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42:
                {
                  input.readMessage(
                      internalGetCommuteInfoFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.talent.v4.SearchJobsResponse.CommuteInfo.Builder
        ...
        bitField0_ |= 0x00000010;
        onChanged();
        return internalGetCommuteInfoFieldBuilder().getBuilder();
      }
   ...
   */
  public static final class CommuteInfo extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private CommuteInfo(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetJobLocationFieldBuilder();
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetJobLocationFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000001;
                  break;
                } // case 10
              case 18:
      ...
      public com.google.cloud.talent.v4.Location.Builder getJobLocationBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetJobLocationFieldBuilder().getBuilder();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetMatchingJobsFieldBuilder();
        internalGetHistogramQueryResultsFieldBuilder();
        internalGetLocationFiltersFieldBuilder();
        internalGetMetadataFieldBuilder();
        internalGetSpellCorrectionFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 74:
              {
                input.readMessage(
                    internalGetSpellCorrectionFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.talent.v4.SearchJobsResponse.MatchingJob.Builder getMatchingJobsBuilder(
        int index) {
      return internalGetMatchingJobsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.talent.v4.SearchJobsResponse.MatchingJob.Builder
      ...
      return internalGetMatchingJobsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.cloud.talent.v4.SearchJobsResponse.MatchingJob.Builder>
      ...
      return internalGetMatchingJobsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.talent.v4.HistogramQueryResult.Builder getHistogramQueryResultsBuilder(
        int index) {
      return internalGetHistogramQueryResultsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.talent.v4.HistogramQueryResult.Builder
      ...
      return internalGetHistogramQueryResultsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.talent.v4.HistogramQueryResult.Builder>
      ...
      return internalGetHistogramQueryResultsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.talent.v4.Location.Builder getLocationFiltersBuilder(int index) {
      return internalGetLocationFiltersFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.talent.v4.Location.Builder addLocationFiltersBuilder() {
      return internalGetLocationFiltersFieldBuilder()
    ...
    public java.util.List<com.google.cloud.talent.v4.Location.Builder>
      ...
      return internalGetLocationFiltersFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.talent.v4.SpellingCorrection.Builder getSpellCorrectionBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetSpellCorrectionFieldBuilder().getBuilder();
    }
