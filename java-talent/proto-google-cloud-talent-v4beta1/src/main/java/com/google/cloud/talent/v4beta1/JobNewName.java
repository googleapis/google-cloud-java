...
public class JobNewName extends JobName {
  ...
  public static JobNewName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PATH_TEMPLATE.validatedMatch(
            formattedString, "JobNewName.parse: formattedString not in valid format");
  ...
  public static List<JobNewName> parseList(List<String> formattedStrings) {
    List<JobNewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static class Builder {
    ...
    private Builder(JobNewName jobNewName) {
      project = jobNewName.project;
      tenant = jobNewName.tenant;
      jobs = jobNewName.jobs;
    }
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof JobNewName) {
      JobNewName that = (JobNewName) o;
