...
```Groovy
implementation 'com.google.cloud:google-identity-accesscontextmanager:1.18.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-identity-accesscontextmanager" % "1.18.0"
```
