...
public class GcpUserAccessBindingName implements ResourceName {
  ...
  public static @Nullable GcpUserAccessBindingName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GcpUserAccessBindingName> values) {
