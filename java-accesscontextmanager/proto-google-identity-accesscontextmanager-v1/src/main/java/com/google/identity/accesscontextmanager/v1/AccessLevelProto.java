...
public final class AccessLevelProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ":google/identity/accesscontextmanager/v1/access_level.proto\022\'google.identity.ac"
          ...
          + "le/protobuf/timestamp.proto\032\026google/type/expr.proto\"\252\003\n"
          + "\013AccessLevel\022\014\n"
          + "\004name\030\001 \001(\t\022\r\n"
          + "\005title\030\002 \001(\t\022\023\n"
          + "\013description\030\003 \001(\t\022D\n"
          + "\005basic\030\004"
          + " \001(\01323.google.identity.accesscontextmanager.v1.BasicLevelH\000\022F\n"
          + "\006custom\030\005 "
          + "\001(\01324.google.identity.accesscontextmanager.v1.CustomLevelH\000\022/\n"
          ...
          + "AccessLevel\022:accessPolicies/{access_policy}/accessLevels/{access_level}B\007\n"
          + "\005level\"\357\001\n\n"
          + "BasicLevel\022F\n\n"
          + "conditions\030\001 \003(\01322.go"
          + "ogle.identity.accesscontextmanager.v1.Condition\022j\n"
          + "\022combining_function\030\002 \001(\0162N.go"
          + "ogle.identity.accesscontextmanager.v1.BasicLevel.ConditionCombiningFunction\"-\n"
          + "\032ConditionCombiningFunction\022\007\n"
          + "\003AND\020\000\022\006\n"
          + "\002OR\020\001\"\303\001\n"
          + "\tCondition\022\026\n"
          + "\016ip_subnetworks\030\001 \003(\t\022L\n\r"
          + "device_policy\030\002 \001(\01325.google.identit"
          ...
          + "\033allowed_encryption_statuses\030\002"
          + " \003(\0162A.google.identity.accesscontextmanager.type.DeviceEncryptionStatus\022M\n"
          + "\016os_constraints\030\003"
          + " \003(\01325.google.identity.accesscontextmanager.v1.OsConstraint\022j\n"
          + " allowed_device_management_levels\030\006 \003(\0162@"
          + ".google.identity.accesscontextmanager.type.DeviceManagementLevel\022\036\n"
          ...
          + ".google.identity.accesscontextmanager.type.OsType\022\027\n"
          + "\017minimum_version\030\002 \001(\t\022\"\n"
          + "\032require_verified_chrome_os\030\003 \001(\010B\247\002\n"
          + "+com.google.identity.accesscontextmanager.v1B\020"
          + "AccessLevelProtoP\001Z\\cloud.google.com/go/accesscontextmanager/apiv1/accesscontext"
          ...
          + "\\V1\352\002*Google::Identity::AccessContextManager::V1b\006proto3"
    };
    descriptor =
