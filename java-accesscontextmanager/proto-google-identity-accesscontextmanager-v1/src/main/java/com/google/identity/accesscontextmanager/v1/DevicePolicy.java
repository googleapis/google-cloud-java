...
public final class DevicePolicy extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DevicePolicy(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private DevicePolicy() {
    allowedEncryptionStatuses_ = emptyIntList();
    osConstraints_ = java.util.Collections.emptyList();
    allowedDeviceManagementLevels_ = emptyIntList();
  }
  ...
  private com.google.protobuf.Internal.IntList allowedEncryptionStatuses_ = emptyIntList();
  ...
  public com.google.identity.accesscontextmanager.type.DeviceEncryptionStatus
    ...
    return allowedEncryptionStatuses_converter_.convert(allowedEncryptionStatuses_.getInt(index));
  }
  ...
  public int getAllowedEncryptionStatusesValue(int index) {
    return allowedEncryptionStatuses_.getInt(index);
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList allowedDeviceManagementLevels_ = emptyIntList();
  ...
  public com.google.identity.accesscontextmanager.type.DeviceManagementLevel
    ...
    return allowedDeviceManagementLevels_converter_.convert(
        allowedDeviceManagementLevels_.getInt(index));
  }
  ...
  public int getAllowedDeviceManagementLevelsValue(int index) {
    return allowedDeviceManagementLevels_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < allowedEncryptionStatuses_.size(); i++) {
      output.writeEnumNoTag(allowedEncryptionStatuses_.getInt(i));
    }
    ...
    for (int i = 0; i < allowedDeviceManagementLevels_.size(); i++) {
      output.writeEnumNoTag(allowedDeviceManagementLevels_.getInt(i));
    }
  ...
  public int getSerializedSize() {
      ...
      for (int i = 0; i < allowedEncryptionStatuses_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                allowedEncryptionStatuses_.getInt(i));
      }
      size += dataSize;
    ...
    }
    {
      ...
      for (int i = 0; i < allowedDeviceManagementLevels_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                allowedDeviceManagementLevels_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.identity.accesscontextmanager.v1.DevicePolicy result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        allowedEncryptionStatuses_.makeImmutable();
        result.allowedEncryptionStatuses_ = allowedEncryptionStatuses_;
      }
      if (((from_bitField0_ & 0x00000008) != 0)) {
        allowedDeviceManagementLevels_.makeImmutable();
          ...
          if (osConstraintsBuilder_.isEmpty()) {
            ...
            osConstraintsBuilder_ =
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                    ? internalGetOsConstraintsFieldBuilder()
                    : null;
          } else {
            ...
            case 16:
              {
                ...
                ensureAllowedEncryptionStatusesIsMutable();
                allowedEncryptionStatuses_.addInt(tmpRaw);
                break;
              } // case 16
            case 18:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  allowedEncryptionStatuses_.addInt(input.readEnum());
                }
            ...
            case 48:
              {
                int tmpRaw = input.readEnum();
                ensureAllowedDeviceManagementLevelsIsMutable();
                allowedDeviceManagementLevels_.addInt(tmpRaw);
                break;
              } // case 48
            case 50:
              {
                ...
                ensureAllowedDeviceManagementLevelsIsMutable();
                while (input.getBytesUntilLimit() > 0) {
                  allowedDeviceManagementLevels_.addInt(input.readEnum());
                }
                input.popLimit(limit);
                break;
              } // case 50
    ...
    private void ensureAllowedEncryptionStatusesIsMutable() {
      if (!allowedEncryptionStatuses_.isModifiable()) {
        allowedEncryptionStatuses_ = makeMutableCopy(allowedEncryptionStatuses_);
      }
      bitField0_ |= 0x00000002;
    }
    ...
    public Builder setAllowedEncryptionStatuses(
      ...
      ensureAllowedEncryptionStatusesIsMutable();
      allowedEncryptionStatuses_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedEncryptionStatuses(
      ...
      ensureAllowedEncryptionStatusesIsMutable();
      allowedEncryptionStatuses_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setAllowedEncryptionStatusesValue(int index, int value) {
      ensureAllowedEncryptionStatusesIsMutable();
      allowedEncryptionStatuses_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedEncryptionStatusesValue(int value) {
      ensureAllowedEncryptionStatusesIsMutable();
      allowedEncryptionStatuses_.addInt(value);
      onChanged();
      return this;
    }
    ...
    public com.google.identity.accesscontextmanager.v1.OsConstraint.Builder getOsConstraintsBuilder(
        int index) {
      return internalGetOsConstraintsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.identity.accesscontextmanager.v1.OsConstraint.Builder
      ...
      return internalGetOsConstraintsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.identity.accesscontextmanager.v1.OsConstraint.Builder>
      ...
      return internalGetOsConstraintsFieldBuilder().getBuilderList();
    }
    ...
    private void ensureAllowedDeviceManagementLevelsIsMutable() {
      if (!allowedDeviceManagementLevels_.isModifiable()) {
        allowedDeviceManagementLevels_ = makeMutableCopy(allowedDeviceManagementLevels_);
      }
      bitField0_ |= 0x00000008;
    }
    ...
    public Builder setAllowedDeviceManagementLevels(
      ...
      ensureAllowedDeviceManagementLevelsIsMutable();
      allowedDeviceManagementLevels_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedDeviceManagementLevels(
      ...
      ensureAllowedDeviceManagementLevelsIsMutable();
      allowedDeviceManagementLevels_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setAllowedDeviceManagementLevelsValue(int index, int value) {
      ensureAllowedDeviceManagementLevelsIsMutable();
      allowedDeviceManagementLevels_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedDeviceManagementLevelsValue(int value) {
      ensureAllowedDeviceManagementLevelsIsMutable();
      allowedDeviceManagementLevels_.addInt(value);
      onChanged();
      return this;
    }
