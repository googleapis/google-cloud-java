...
public class ServicePerimeterName implements ResourceName {
  ...
  public static @Nullable ServicePerimeterName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ServicePerimeterName> values) {
