...
public final class Condition extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < ipSubnetworks_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, ipSubnetworks_.getRaw(i));
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(2, getDevicePolicy());
    }
    for (int i = 0; i < requiredAccessLevels_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, requiredAccessLevels_.getRaw(i));
    }
    if (negate_ != false) {
      output.writeBool(5, negate_);
    }
    for (int i = 0; i < members_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, members_.getRaw(i));
    }
    for (int i = 0; i < regions_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, regions_.getRaw(i));
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetDevicePolicyFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetDevicePolicyFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.identity.accesscontextmanager.v1.DevicePolicy.Builder
      ...
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetDevicePolicyFieldBuilder().getBuilder();
    }
