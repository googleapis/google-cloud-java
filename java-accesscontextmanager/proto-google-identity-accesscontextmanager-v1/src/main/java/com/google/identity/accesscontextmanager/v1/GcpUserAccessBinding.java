 ...
 */
public final class GcpUserAccessBinding extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private GcpUserAccessBinding(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(groupKey_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, groupKey_);
    }
    for (int i = 0; i < accessLevels_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, accessLevels_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(groupKey_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, groupKey_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < accessLevels_.size(); i++) {
