...
public final class SearchTextRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SearchTextRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18:
                {
                  input.readMessage(
                      internalGetCircleFieldBuilder().getBuilder(), extensionRegistry);
                  typeCase_ = 2;
                  break;
                } // case 18
              default:
   ...
   */
  public static final class LocationRestriction extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private LocationRestriction(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class EVOptions extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private EVOptions(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }

    private EVOptions() {
      connectorTypes_ = emptyIntList();
    }
    ...
    @SuppressWarnings("serial")
    private com.google.protobuf.Internal.IntList connectorTypes_ = emptyIntList();

    private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
            com.google.maps.places.v1.EVConnectorType>
        connectorTypes_converter_ =
            new com.google.protobuf.Internal.IntListAdapter.IntConverter<
                com.google.maps.places.v1.EVConnectorType>() {
              public com.google.maps.places.v1.EVConnectorType convert(int from) {
    ...
    public java.util.List<com.google.maps.places.v1.EVConnectorType> getConnectorTypesList() {
      return new com.google.protobuf.Internal.IntListAdapter<
          com.google.maps.places.v1.EVConnectorType>(connectorTypes_, connectorTypes_converter_);
    }
    ...
    public com.google.maps.places.v1.EVConnectorType getConnectorTypes(int index) {
      return connectorTypes_converter_.convert(connectorTypes_.getInt(index));
    }
    ...
    public int getConnectorTypesValue(int index) {
      return connectorTypes_.getInt(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < connectorTypes_.size(); i++) {
        output.writeEnumNoTag(connectorTypes_.getInt(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      }
      {
        ...
        for (int i = 0; i < connectorTypes_.size(); i++) {
          dataSize +=
              com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(connectorTypes_.getInt(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(com.google.maps.places.v1.SearchTextRequest.EVOptions other) {
        if (other == com.google.maps.places.v1.SearchTextRequest.EVOptions.getDefaultInstance())
          return this;
        if (java.lang.Double.doubleToRawLongBits(other.getMinimumChargingRateKw()) != 0) {
              ...
              case 18:
                {
                  ...
                  while (input.getBytesUntilLimit() > 0) {
                    connectorTypes_.addInt(input.readEnum());
                  }
      ...
      private void ensureConnectorTypesIsMutable() {
        if (!connectorTypes_.isModifiable()) {
          connectorTypes_ = makeMutableCopy(connectorTypes_);
        }
        bitField0_ |= 0x00000002;
      }
      ...
      public Builder setConnectorTypes(int index, com.google.maps.places.v1.EVConnectorType value) {
        ...
        ensureConnectorTypesIsMutable();
        connectorTypes_.setInt(index, value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder addConnectorTypes(com.google.maps.places.v1.EVConnectorType value) {
        ...
        ensureConnectorTypesIsMutable();
        connectorTypes_.addInt(value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder setConnectorTypesValue(int index, int value) {
        ensureConnectorTypesIsMutable();
        connectorTypes_.setInt(index, value);
        onChanged();
        return this;
      }
   ...
   */
  public static final class SearchAlongRouteParameters extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private SearchAlongRouteParameters(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.maps.places.v1.PriceLevel>
      priceLevels_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.maps.places.v1.PriceLevel>() {
            public com.google.maps.places.v1.PriceLevel convert(int from) {
  ...
  public java.util.List<com.google.maps.places.v1.PriceLevel> getPriceLevelsList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.maps.places.v1.PriceLevel>(
  ...
  public static final int INCLUDE_FUTURE_OPENING_BUSINESSES_FIELD_NUMBER = 21;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(textQuery_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, textQuery_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(includedType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, includedType_);
    }
    if (openNow_ != false) {
    ...
    if (includeFutureOpeningBusinesses_ != false) {
      output.writeBool(21, includeFutureOpeningBusinesses_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(textQuery_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, textQuery_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(languageCode_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(includedType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, includedType_);
    }
    if (openNow_ != false) {
    ...
    if (includeFutureOpeningBusinesses_ != false) {
      size +=
          com.google.protobuf.CodedOutputStream.computeBoolSize(
              21, includeFutureOpeningBusinesses_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetLocationRestrictionFieldBuilder();
        internalGetEvOptionsFieldBuilder();
        internalGetRoutingParametersFieldBuilder();
        internalGetSearchAlongRouteParametersFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.maps.places.v1.SearchTextRequest other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getMinRating()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114:
              {
                input.readMessage(
                    internalGetLocationRestrictionFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 122:
              {
                input.readMessage(
                    internalGetEvOptionsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 130:
              {
                input.readMessage(
                    internalGetRoutingParametersFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 138:
              {
                input.readMessage(
                    internalGetSearchAlongRouteParametersFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.maps.places.v1.SearchTextRequest.LocationRestriction.Builder
      ...
      bitField0_ |= 0x00000800;
      onChanged();
      return internalGetLocationRestrictionFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.places.v1.SearchTextRequest.EVOptions.Builder getEvOptionsBuilder() {
      bitField0_ |= 0x00001000;
      onChanged();
      return internalGetEvOptionsFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.places.v1.RoutingParameters.Builder getRoutingParametersBuilder() {
      bitField0_ |= 0x00002000;
      onChanged();
      return internalGetRoutingParametersFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.places.v1.SearchTextRequest.SearchAlongRouteParameters.Builder
      ...
      bitField0_ |= 0x00004000;
      onChanged();
      return internalGetSearchAlongRouteParametersFieldBuilder().getBuilder();
    }
