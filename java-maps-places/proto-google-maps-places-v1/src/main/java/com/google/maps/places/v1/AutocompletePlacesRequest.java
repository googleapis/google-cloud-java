...
public final class AutocompletePlacesRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AutocompletePlacesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < includedPrimaryTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, includedPrimaryTypes_.getRaw(i));
    }
    for (int i = 0; i < includedRegionCodes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, includedRegionCodes_.getRaw(i));
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sessionToken_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, sessionToken_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sessionToken_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(11, sessionToken_);
    }
    if (includePureServiceAreaBusinesses_ != false) {
      size +=
