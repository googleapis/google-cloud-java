...
```Scala
libraryDependencies += "com.google.maps" % "google-maps-places" % "0.47.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.maps/google-maps-places/0.47.0
