...
public interface PartitionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.biglake.hive.v1.Partition)
   ...
   *
   * <code>
   * .google.cloud.biglake.hive.v1.StorageDescriptor storage_descriptor = 3 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   */
  com.google.cloud.biglake.hive.v1.StorageDescriptor getStorageDescriptor();
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1.StorageDescriptorOrBuilder getStorageDescriptorOrBuilder();
   ...
   *
   * <code>
   * repeated .google.cloud.biglake.hive.v1.FieldSchema fields = 5 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   */
  java.util.List<com.google.cloud.biglake.hive.v1.FieldSchema> getFieldsList();
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1.FieldSchema getFields(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.biglake.hive.v1.FieldSchemaOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1.FieldSchemaOrBuilder getFieldsOrBuilder(int index);
}
