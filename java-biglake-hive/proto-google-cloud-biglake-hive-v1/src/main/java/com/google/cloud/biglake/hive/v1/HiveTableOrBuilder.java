...
public interface HiveTableOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.biglake.hive.v1.HiveTable)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.biglake.hive.v1.FieldSchema> getPartitionKeysList();
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1.FieldSchema getPartitionKeys(int index);
   ...
   * </code>
   */
  com.google.cloud.biglake.hive.v1.FieldSchemaOrBuilder getPartitionKeysOrBuilder(int index);
