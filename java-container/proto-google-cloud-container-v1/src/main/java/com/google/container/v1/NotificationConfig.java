...
public final class NotificationConfig extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class PubSub extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private PubSub(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetFilterFieldBuilder().getBuilder(), extensionRegistry);
  ...
  public static final class Filter extends com.google.protobuf.GeneratedMessage
    ...
    @SuppressWarnings("serial")
    private com.google.protobuf.Internal.IntList eventType_ = emptyIntList();

    private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
            com.google.container.v1.NotificationConfig.EventType>
        eventType_converter_ =
            new com.google.protobuf.Internal.IntListAdapter.IntConverter<
                com.google.container.v1.NotificationConfig.EventType>() {
              public com.google.container.v1.NotificationConfig.EventType convert(int from) {
    ...
    public java.util.List<com.google.container.v1.NotificationConfig.EventType> getEventTypeList() {
      return new com.google.protobuf.Internal.IntListAdapter<
          com.google.container.v1.NotificationConfig.EventType>(eventType_, eventType_converter_);
    }
    ...
    public com.google.container.v1.NotificationConfig.EventType getEventType(int index) {
      return eventType_converter_.convert(eventType_.getInt(index));
    }
    ...
    public int getEventTypeValue(int index) {
      return eventType_.getInt(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < eventType_.size(); i++) {
        output.writeEnumNoTag(eventType_.getInt(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < eventType_.size(); i++) {
          dataSize +=
              com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(eventType_.getInt(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
              ...
              case 10:
                {
                  ...
                  while (input.getBytesUntilLimit() > 0) {
                    eventType_.addInt(input.readEnum());
                  }
      ...
      private void ensureEventTypeIsMutable() {
        if (!eventType_.isModifiable()) {
          eventType_ = makeMutableCopy(eventType_);
        }
        bitField0_ |= 0x00000001;
      }
      ...
      public Builder setEventType(
        ...
        ensureEventTypeIsMutable();
        eventType_.setInt(index, value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder addEventType(com.google.container.v1.NotificationConfig.EventType value) {
        ...
        ensureEventTypeIsMutable();
        eventType_.addInt(value.getNumber());
        onChanged();
        return this;
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetPubsubFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
            default:
    ...
    public com.google.container.v1.NotificationConfig.PubSub.Builder getPubsubBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetPubsubFieldBuilder().getBuilder();
    }
