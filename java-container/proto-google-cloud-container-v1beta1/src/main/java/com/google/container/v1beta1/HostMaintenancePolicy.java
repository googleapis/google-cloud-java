...
public final class HostMaintenancePolicy extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private HostMaintenancePolicy(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetNodeIdleTimeWindowFieldBuilder();
          internalGetMaintenanceAvailabilityWindowFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetNodeIdleTimeWindowFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 18:
                {
                  input.readMessage(
                      internalGetMaintenanceAvailabilityWindowFieldBuilder().getBuilder(),
                      extensionRegistry);
      ...
      public com.google.protobuf.Duration.Builder getNodeIdleTimeWindowBuilder() {
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetNodeIdleTimeWindowFieldBuilder().getBuilder();
      }
      ...
      public com.google.protobuf.Duration.Builder getMaintenanceAvailabilityWindowBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetMaintenanceAvailabilityWindowFieldBuilder().getBuilder();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.container.v1beta1.HostMaintenancePolicy other) {
      ...
      if (other.hasMaintenanceInterval()) {
        setMaintenanceIntervalValue(other.getMaintenanceIntervalValue());
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetOpportunisticMaintenanceStrategyFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.container.v1beta1.HostMaintenancePolicy.OpportunisticMaintenanceStrategy
      ...
      return internalGetOpportunisticMaintenanceStrategyFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.container.v1beta1.HostMaintenancePolicy
                .OpportunisticMaintenanceStrategyOrBuilder>
        internalGetOpportunisticMaintenanceStrategyFieldBuilder() {
      if (opportunisticMaintenanceStrategyBuilder_ == null) {
        if (!(maintenanceStrategyCase_ == 2)) {
          maintenanceStrategy_ =
              com.google.container.v1beta1.HostMaintenancePolicy.OpportunisticMaintenanceStrategy
