...
public final class ProtectConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ProtectConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetWorkloadConfigFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.container.v1beta1.ProtectConfig other) {
      ...
      if (other.hasWorkloadVulnerabilityMode()) {
        setWorkloadVulnerabilityModeValue(other.getWorkloadVulnerabilityModeValue());
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetWorkloadConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.container.v1beta1.WorkloadConfig.Builder getWorkloadConfigBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetWorkloadConfigFieldBuilder().getBuilder();
    }
