...
public final class EphemeralStorageLocalSsdConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private EphemeralStorageLocalSsdConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final int DATA_CACHE_COUNT_FIELD_NUMBER = 2;
  private int dataCacheCount_ = 0;
   ...
   */
  @java.lang.Override
  public int getDataCacheCount() {
    return dataCacheCount_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (dataCacheCount_ != 0) {
      output.writeInt32(2, dataCacheCount_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (dataCacheCount_ != 0) {
      size += com.google.protobuf.CodedOutputStream.computeInt32Size(2, dataCacheCount_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getDataCacheCount() != other.getDataCacheCount()) return false;
  ...
  public int hashCode() {
    ...
    hash = (37 * hash) + DATA_CACHE_COUNT_FIELD_NUMBER;
    hash = (53 * hash) + getDataCacheCount();
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.container.v1beta1.EphemeralStorageLocalSsdConfig result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.dataCacheCount_ = dataCacheCount_;
      }
    }
    ...
    public Builder mergeFrom(com.google.container.v1beta1.EphemeralStorageLocalSsdConfig other) {
      ...
      if (other.getDataCacheCount() != 0) {
        setDataCacheCount(other.getDataCacheCount());
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 16:
              {
                dataCacheCount_ = input.readInt32();
     ...
     * <code>int32 data_cache_count = 2;</code>
     *
     * @param value The dataCacheCount to set.
     * @return This builder for chaining.
     */
    public Builder setDataCacheCount(int value) {
     ...
     * @return This builder for chaining.
     */
    public Builder clearDataCacheCount() {
