...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-container" % "2.43.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-container/2.43.0
