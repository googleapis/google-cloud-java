...
<dependencies>
  <dependency>
    <groupId>com.google.cloud</groupId>
    <artifactId>google-cloud-connectgateway</artifactId>
  </dependency>
</dependencies>
```
...
implementation 'com.google.cloud:google-cloud-connectgateway'
```

If you are using Gradle without BOM, add this to your dependencies:

```Groovy
implementation 'com.google.cloud:google-cloud-connectgateway:0.46.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-connectgateway" % "0.46.0"
```
...
You'll need to obtain the `google-cloud-connectgateway` library.  See the [Quickstart](#quickstart) section
to add `google-cloud-connectgateway` as a dependency in your code.

## About Connect Gateway API


[Connect Gateway API][product-docs] The Connect Gateway service allows connectivity from external parties to     connected Kubernetes clusters.
...
[product-docs]: https://cloud.google.com/kubernetes-engine/enterprise/multicluster-management/gateway
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-connectgateway/0.46.0
