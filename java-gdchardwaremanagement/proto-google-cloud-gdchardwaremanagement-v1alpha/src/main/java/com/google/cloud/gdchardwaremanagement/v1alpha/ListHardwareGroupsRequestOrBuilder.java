...
public interface ListHardwareGroupsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gdchardwaremanagement.v1alpha.ListHardwareGroupsRequest)
