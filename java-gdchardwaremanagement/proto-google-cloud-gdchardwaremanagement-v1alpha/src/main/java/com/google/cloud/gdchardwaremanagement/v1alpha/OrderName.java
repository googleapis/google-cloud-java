...
public class OrderName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_ORDER =
  ...
  public static OrderName of(String project, String location, String order) {
    return newBuilder().setProject(project).setLocation(location).setOrder(order).build();
  }
  ...
  public static @Nullable OrderName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_ORDER.validatedMatch(
            formattedString, "OrderName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("order"));
  }
  ...
  public static List<String> toStringList(List<@Nullable OrderName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_ORDER.instantiate(
        "project", project, "location", location, "order", order);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/orders/{order}. */
