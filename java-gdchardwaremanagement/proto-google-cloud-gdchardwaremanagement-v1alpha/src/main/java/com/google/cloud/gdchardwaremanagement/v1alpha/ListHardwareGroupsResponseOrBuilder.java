...
public interface ListHardwareGroupsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gdchardwaremanagement.v1alpha.ListHardwareGroupsResponse)
   ...
   * </code>
   */
  com.google.cloud.gdchardwaremanagement.v1alpha.HardwareGroupOrBuilder getHardwareGroupsOrBuilder(
      int index);
