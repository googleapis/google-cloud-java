...
public final class TimePeriod extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public int getSerializedSize() {
    ...
    }
    {
      int dataSize = 0;
      for (int i = 0; i < days_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(days_.getInt(i));
      }
      size += dataSize;
