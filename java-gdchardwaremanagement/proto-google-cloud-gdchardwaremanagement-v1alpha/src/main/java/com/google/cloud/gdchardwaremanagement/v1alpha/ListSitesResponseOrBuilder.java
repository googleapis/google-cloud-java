...
public interface ListSitesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gdchardwaremanagement.v1alpha.ListSitesResponse)
   ...
   * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Site sites = 1;</code>
   */
  com.google.cloud.gdchardwaremanagement.v1alpha.SiteOrBuilder getSitesOrBuilder(int index);
