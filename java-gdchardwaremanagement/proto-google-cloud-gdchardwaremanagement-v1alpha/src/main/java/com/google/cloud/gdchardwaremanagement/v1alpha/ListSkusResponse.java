 ...
 * </pre>
 *
 * Protobuf type {@code google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse}
 */
@com.google.protobuf.Generated
public final class ListSkusResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ListSkusResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.cloud.gdchardwaremanagement.v1alpha.ServiceProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse.class,
            com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.cloud.gdchardwaremanagement.v1alpha.SkuOrBuilder>
   ...
   */
  @java.lang.Override
  public com.google.cloud.gdchardwaremanagement.v1alpha.SkuOrBuilder getSkusOrBuilder(int index) {
    return skus_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse)) {
      return super.equals(obj);
    }
    com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse other =
        (com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse) obj;
  ...
  public static com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse parseFrom(
  ...
  public static com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse parseDelimitedFrom(
      java.io.InputStream input) throws java.io.IOException {
  ...
  public static Builder newBuilder(
      com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse)
      com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return com.google.cloud.gdchardwaremanagement.v1alpha.ServiceProto
          .internal_static_google_cloud_gdchardwaremanagement_v1alpha_ListSkusResponse_descriptor;
    }
    ...
    // Construct using com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse.newBuilder()
    private Builder() {}
    ...
    @java.lang.Override
    public com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse
        getDefaultInstanceForType() {
      return com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse build() {
      com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse buildPartial() {
      com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse result =
          new com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse) {
        return mergeFrom((com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse) other);
      } else {
    ...
    public Builder mergeFrom(
        com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse other) {
      if (other
          == com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse.getDefaultInstance())
        return this;
      if (skusBuilder_ == null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.gdchardwaremanagement.v1alpha.Sku m =
                    input.readMessage(
                        com.google.cloud.gdchardwaremanagement.v1alpha.Sku.parser(),
                        extensionRegistry);
                if (skusBuilder_ == null) {
                  ensureSkusIsMutable();
                  skus_.add(m);
    ...
    private void ensureSkusIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        skus_ = new java.util.ArrayList<com.google.cloud.gdchardwaremanagement.v1alpha.Sku>(skus_);
    ...
    private com.google.protobuf.RepeatedFieldBuilder<
            ...
            com.google.cloud.gdchardwaremanagement.v1alpha.Sku.Builder,
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Sku skus = 1;</code>
     */
    public Builder setSkus(int index, com.google.cloud.gdchardwaremanagement.v1alpha.Sku value) {
      if (skusBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setSkus(
        int index, com.google.cloud.gdchardwaremanagement.v1alpha.Sku.Builder builderForValue) {
      if (skusBuilder_ == null) {
        ensureSkusIsMutable();
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Sku skus = 1;</code>
     */
    public Builder addSkus(com.google.cloud.gdchardwaremanagement.v1alpha.Sku value) {
      if (skusBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Sku skus = 1;</code>
     */
    public Builder addSkus(int index, com.google.cloud.gdchardwaremanagement.v1alpha.Sku value) {
      if (skusBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addSkus(
        com.google.cloud.gdchardwaremanagement.v1alpha.Sku.Builder builderForValue) {
      if (skusBuilder_ == null) {
        ensureSkusIsMutable();
    ...
    public Builder addAllSkus(
        java.lang.Iterable<? extends com.google.cloud.gdchardwaremanagement.v1alpha.Sku> values) {
      if (skusBuilder_ == null) {
        ensureSkusIsMutable();
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Sku skus = 1;</code>
     */
    public com.google.cloud.gdchardwaremanagement.v1alpha.Sku.Builder addSkusBuilder() {
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Sku skus = 1;</code>
     */
    public com.google.cloud.gdchardwaremanagement.v1alpha.Sku.Builder addSkusBuilder(int index) {
      return internalGetSkusFieldBuilder()
          .addBuilder(
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Sku skus = 1;</code>
     */
    public java.util.List<com.google.cloud.gdchardwaremanagement.v1alpha.Sku.Builder>
        getSkusBuilderList() {
    ...
    // @@protoc_insertion_point(builder_scope:google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse)
  }

  // @@protoc_insertion_point(class_scope:google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse)
  private static final com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse
      DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse();
  }

  public static com.google.cloud.gdchardwaremanagement.v1alpha.ListSkusResponse
      getDefaultInstance() {
