...
public interface ListOrdersResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gdchardwaremanagement.v1alpha.ListOrdersResponse)
   ...
   * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Order orders = 1;</code>
   */
  com.google.cloud.gdchardwaremanagement.v1alpha.OrderOrBuilder getOrdersOrBuilder(int index);
