...
public interface CreateSiteRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gdchardwaremanagement.v1alpha.CreateSiteRequest)
   ...
   * </pre>
   *
   * <code>string site_id = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   * @return The siteId.
   */
   ...
   */
  com.google.protobuf.ByteString getSiteIdBytes();
