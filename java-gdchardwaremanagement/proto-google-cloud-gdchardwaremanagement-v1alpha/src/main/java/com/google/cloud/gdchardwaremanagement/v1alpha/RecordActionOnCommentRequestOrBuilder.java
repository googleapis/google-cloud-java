...
public interface RecordActionOnCommentRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gdchardwaremanagement.v1alpha.RecordActionOnCommentRequest)
