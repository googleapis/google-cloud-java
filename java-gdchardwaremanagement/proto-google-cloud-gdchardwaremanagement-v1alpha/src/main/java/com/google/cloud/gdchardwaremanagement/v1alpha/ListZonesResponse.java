...
public final class ListZonesResponse extends com.google.protobuf.GeneratedMessage
    implements
    // @@protoc_insertion_point(message_implements:google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse)
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.cloud.gdchardwaremanagement.v1alpha.ServiceProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse.class,
            com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse.Builder.class);
  }

  public static final int ZONES_FIELD_NUMBER = 1;

  @SuppressWarnings("serial")
  private java.util.List<com.google.cloud.gdchardwaremanagement.v1alpha.Zone> zones_;
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
   */
  @java.lang.Override
  public java.util.List<com.google.cloud.gdchardwaremanagement.v1alpha.Zone> getZonesList() {
    return zones_;
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.cloud.gdchardwaremanagement.v1alpha.ZoneOrBuilder>
   ...
   */
  @java.lang.Override
  public com.google.cloud.gdchardwaremanagement.v1alpha.Zone getZones(int index) {
   ...
   */
  @java.lang.Override
  public com.google.cloud.gdchardwaremanagement.v1alpha.ZoneOrBuilder getZonesOrBuilder(int index) {
    return zones_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse)) {
      return super.equals(obj);
    }
    com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse other =
        (com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse) obj;
  ...
  public static com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse parseFrom(
  ...
  public static com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse parseDelimitedFrom(
      java.io.InputStream input) throws java.io.IOException {
  ...
  public static Builder newBuilder(
      com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse)
      com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return com.google.cloud.gdchardwaremanagement.v1alpha.ServiceProto
          .internal_static_google_cloud_gdchardwaremanagement_v1alpha_ListZonesResponse_descriptor;
    }
    ...
    // Construct using com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse.newBuilder()
    private Builder() {}
    ...
    @java.lang.Override
    public com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse
        getDefaultInstanceForType() {
      return com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse build() {
      com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse buildPartial() {
      com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse result =
          new com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse) {
        return mergeFrom((com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse) other);
      } else {
    ...
    public Builder mergeFrom(
        com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse other) {
      if (other
          == com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse.getDefaultInstance())
        return this;
      if (zonesBuilder_ == null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.gdchardwaremanagement.v1alpha.Zone m =
                    input.readMessage(
                        com.google.cloud.gdchardwaremanagement.v1alpha.Zone.parser(),
                        extensionRegistry);
                if (zonesBuilder_ == null) {
                  ensureZonesIsMutable();
                  zones_.add(m);
    ...
    private void ensureZonesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        zones_ =
            new java.util.ArrayList<com.google.cloud.gdchardwaremanagement.v1alpha.Zone>(zones_);
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public Builder setZones(int index, com.google.cloud.gdchardwaremanagement.v1alpha.Zone value) {
      if (zonesBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setZones(
        int index, com.google.cloud.gdchardwaremanagement.v1alpha.Zone.Builder builderForValue) {
      if (zonesBuilder_ == null) {
        ensureZonesIsMutable();
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public Builder addZones(com.google.cloud.gdchardwaremanagement.v1alpha.Zone value) {
      if (zonesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public Builder addZones(int index, com.google.cloud.gdchardwaremanagement.v1alpha.Zone value) {
      if (zonesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllZones(
        java.lang.Iterable<? extends com.google.cloud.gdchardwaremanagement.v1alpha.Zone> values) {
      if (zonesBuilder_ == null) {
        ensureZonesIsMutable();
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public com.google.cloud.gdchardwaremanagement.v1alpha.Zone.Builder getZonesBuilder(int index) {
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public com.google.cloud.gdchardwaremanagement.v1alpha.ZoneOrBuilder getZonesOrBuilder(
        int index) {
      if (zonesBuilder_ == null) {
        return zones_.get(index);
      } else {
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public com.google.cloud.gdchardwaremanagement.v1alpha.Zone.Builder addZonesBuilder() {
      return internalGetZonesFieldBuilder()
          .addBuilder(com.google.cloud.gdchardwaremanagement.v1alpha.Zone.getDefaultInstance());
    }
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public com.google.cloud.gdchardwaremanagement.v1alpha.Zone.Builder addZonesBuilder(int index) {
      return internalGetZonesFieldBuilder()
          .addBuilder(
              index, com.google.cloud.gdchardwaremanagement.v1alpha.Zone.getDefaultInstance());
    }
     ...
     * <code>repeated .google.cloud.gdchardwaremanagement.v1alpha.Zone zones = 1;</code>
     */
    public java.util.List<com.google.cloud.gdchardwaremanagement.v1alpha.Zone.Builder>
        getZonesBuilderList() {
    ...
    // @@protoc_insertion_point(builder_scope:google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse)
  }

  // @@protoc_insertion_point(class_scope:google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse)
  private static final com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse
      DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new com.google.cloud.gdchardwaremanagement.v1alpha.ListZonesResponse();
  }
