...
public final class VideoStitcherServiceGrpc {
  ...
  public static VideoStitcherServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VideoStitcherServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<VideoStitcherServiceBlockingV2Stub>() {
          @java.lang.Override
          public VideoStitcherServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new VideoStitcherServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return VideoStitcherServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class VideoStitcherServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<VideoStitcherServiceBlockingV2Stub> {
    private VideoStitcherServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected VideoStitcherServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new VideoStitcherServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service VideoStitcherService.
   *
   * <pre>
   * Video-On-Demand content stitching API allows you to insert ads
   * into (VoD) video on demand files. You will be able to render custom
