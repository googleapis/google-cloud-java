...
public class LiveSessionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_LIVE_SESSION =
  ...
  public static @Nullable LiveSessionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_LIVE_SESSION.validatedMatch(
            formattedString, "LiveSessionName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("live_session"));
  }

  public static List<LiveSessionName> parseList(List<String> formattedStrings) {
    List<LiveSessionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable LiveSessionName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_LIVE_SESSION.instantiate(
        "project", project, "location", location, "live_session", liveSession);
  }
