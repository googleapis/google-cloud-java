...
public class CatalogItemPathName implements ResourceName {
  ...
  public static @Nullable CatalogItemPathName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CatalogItemPathName> values) {
