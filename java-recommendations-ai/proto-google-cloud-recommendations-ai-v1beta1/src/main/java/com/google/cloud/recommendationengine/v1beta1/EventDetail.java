...
public final class EventDetail extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private EventDetail(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(pageViewId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, pageViewId_);
    }
    for (int i = 0; i < experimentIds_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, experimentIds_.getRaw(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(recommendationToken_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, recommendationToken_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(5, getEventAttributes());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(referrerUri_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, referrerUri_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(pageViewId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, pageViewId_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < experimentIds_.size(); i++) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(recommendationToken_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, recommendationToken_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(5, getEventAttributes());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(referrerUri_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, referrerUri_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetEventAttributesFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetEventAttributesFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.recommendationengine.v1beta1.FeatureMap.Builder
      ...
      bitField0_ |= 0x00000020;
      onChanged();
      return internalGetEventAttributesFieldBuilder().getBuilder();
    }
