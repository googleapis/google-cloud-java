 ...
 * of createPredictionApiKeyRegistration:
 *
 * <pre>{@code
...
public class PredictionApiKeyRegistryStubSettings
      ...
      LIST_PREDICTION_API_KEY_REGISTRATIONS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            public Iterable<PredictionApiKeyRegistration> extractResources(
              ...
              return payload.getPredictionApiKeyRegistrationsList();
            }
          };
  ...
  public PredictionApiKeyRegistryStub createStub() throws IOException {
    ...
    if (getTransportChannelProvider()
      ...
      return HttpJsonPredictionApiKeyRegistryStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return PredictionApiKeyRegistryStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
