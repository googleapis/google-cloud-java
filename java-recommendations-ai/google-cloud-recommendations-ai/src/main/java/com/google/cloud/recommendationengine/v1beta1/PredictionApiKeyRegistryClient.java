 ...
 *      <td><p>Register an API key for use with predict method.</p></td>
 *      <td>
 ...
 *      <td><p>List the registered apiKeys for use with predict method.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Unregister an apiKey from using for predict method.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
