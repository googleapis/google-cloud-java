...
public class DeploymentEventName implements ResourceName {
  ...
  public static @Nullable DeploymentEventName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DeploymentEventName> values) {
