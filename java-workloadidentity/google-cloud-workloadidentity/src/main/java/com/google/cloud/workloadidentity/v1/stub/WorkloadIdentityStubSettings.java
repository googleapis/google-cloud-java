 ...
 *
 * <ul>
 *   <li>The default service address (workloadidentity.googleapis.com) and default port (443) are
 *       used.
...
public class WorkloadIdentityStubSettings extends StubSettings<WorkloadIdentityStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<GenerateServiceAgentsRequest, Operation>
  ...
  public UnaryCallSettings<GenerateServiceAgentsRequest, Operation>
      generateServiceAgentsSettings() {
  ...
  public static class Builder extends StubSettings.Builder<WorkloadIdentityStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GenerateServiceAgentsRequest, Operation>
        generateServiceAgentsSettings;
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<GenerateServiceAgentsRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_0_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_0_params"))
                  .build())
    ...
    public UnaryCallSettings.Builder<GenerateServiceAgentsRequest, Operation>
        generateServiceAgentsSettings() {
      return generateServiceAgentsSettings;
    }
    ...
    @Override
    public WorkloadIdentityStubSettings build() throws IOException {
      return new WorkloadIdentityStubSettings(this);
    }
  }
}
