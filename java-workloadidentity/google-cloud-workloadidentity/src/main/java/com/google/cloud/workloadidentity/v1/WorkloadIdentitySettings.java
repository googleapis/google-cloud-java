...
public class WorkloadIdentitySettings extends ClientSettings<WorkloadIdentitySettings> {
  ...
  public static class Builder extends ClientSettings.Builder<WorkloadIdentitySettings, Builder> {
