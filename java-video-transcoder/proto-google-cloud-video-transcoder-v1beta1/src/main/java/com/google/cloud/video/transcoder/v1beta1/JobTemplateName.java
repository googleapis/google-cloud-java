...
public class JobTemplateName implements ResourceName {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("jobTemplate", jobTemplate);
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof JobTemplateName) {
      JobTemplateName that = (JobTemplateName) o;
      return (this.project.equals(that.project))
          && (this.location.equals(that.location))
          && (this.jobTemplate.equals(that.jobTemplate));
    }
    return false;
  }
