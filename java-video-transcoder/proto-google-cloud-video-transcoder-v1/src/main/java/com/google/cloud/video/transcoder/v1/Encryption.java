    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26:
            {
              com.google.cloud.video.transcoder.v1.Encryption.Aes128Encryption.Builder subBuilder =
                  null;
              ...
              encryptionMode_ =
                  input.readMessage(
                      com.google.cloud.video.transcoder.v1.Encryption.Aes128Encryption.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 34:
            {
              ...
              encryptionMode_ =
                  input.readMessage(
                      com.google.cloud.video.transcoder.v1.Encryption.SampleAesEncryption.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(
                    (com.google.cloud.video.transcoder.v1.Encryption.SampleAesEncryption)
          ...
          case 42:
            {
              ...
              encryptionMode_ =
                  input.readMessage(
                      com.google.cloud.video.transcoder.v1.Encryption.MpegCommonEncryption.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(
                    (com.google.cloud.video.transcoder.v1.Encryption.MpegCommonEncryption)
