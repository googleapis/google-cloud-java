...
public final class PreprocessingConfig extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class Color extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(
        ...
        if (java.lang.Double.doubleToRawLongBits(other.getContrast()) != 0) {
          setContrast(other.getContrast());
        }
        if (java.lang.Double.doubleToRawLongBits(other.getBrightness()) != 0) {
   ...
   */
  public static final class Denoise extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Denoise(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tune_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, tune_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tune_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, tune_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(
        ...
        if (java.lang.Double.doubleToRawLongBits(other.getStrength()) != 0) {
   ...
   */
  public static final class Deblock extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Deblock(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class Deinterlace extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Deinterlace(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
     ...
     */
    public static final class YadifConfig extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private YadifConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        ...
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parity_)) {
          com.google.protobuf.GeneratedMessage.writeString(output, 3, parity_);
        }
      ...
      public int getSerializedSize() {
        ...
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parity_)) {
          size += com.google.protobuf.GeneratedMessage.computeStringSize(3, parity_);
        }
        if (deinterlaceAllFrames_ != false) {
     ...
     */
    public static final class BwdifConfig extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private BwdifConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        ...
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parity_)) {
          com.google.protobuf.GeneratedMessage.writeString(output, 2, parity_);
        }
        if (deinterlaceAllFrames_ != false) {
      ...
      public int getSerializedSize() {
        ...
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parity_)) {
          size += com.google.protobuf.GeneratedMessage.computeStringSize(2, parity_);
        }
        if (deinterlaceAllFrames_ != false) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        try {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(internalGetYadifFieldBuilder().getBuilder(), extensionRegistry);
                  deinterlacingFilterCase_ = 1;
                  break;
                } // case 10
              case 18:
                {
                  input.readMessage(internalGetBwdifFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.video.transcoder.v1.PreprocessingConfig.Deinterlace.YadifConfig
              .Builder
          getYadifBuilder() {
        return internalGetYadifFieldBuilder().getBuilder();
      }
      ...
      public com.google.cloud.video.transcoder.v1.PreprocessingConfig.Deinterlace.BwdifConfig
              .Builder
          getBwdifBuilder() {
        return internalGetBwdifFieldBuilder().getBuilder();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetDenoiseFieldBuilder();
        internalGetDeblockFieldBuilder();
        internalGetAudioFieldBuilder();
        internalGetCropFieldBuilder();
        internalGetPadFieldBuilder();
        internalGetDeinterlaceFieldBuilder();
      }
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(internalGetDenoiseFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000002;
                break;
              } // case 18
            case 26:
              {
                input.readMessage(internalGetDeblockFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000004;
                break;
              } // case 26
            case 34:
            ...
            case 58:
              {
                input.readMessage(
                    internalGetDeinterlaceFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.video.transcoder.v1.PreprocessingConfig.Denoise.Builder
      ...
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetDenoiseFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.video.transcoder.v1.PreprocessingConfig.Deblock.Builder
      ...
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetDeblockFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.video.transcoder.v1.PreprocessingConfig.Deinterlace.Builder
      ...
      bitField0_ |= 0x00000040;
      onChanged();
      return internalGetDeinterlaceFieldBuilder().getBuilder();
    }
