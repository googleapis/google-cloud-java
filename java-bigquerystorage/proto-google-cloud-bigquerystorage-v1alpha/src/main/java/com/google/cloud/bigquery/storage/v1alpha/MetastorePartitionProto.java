  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "r.proto\032\031google/api/resource.proto\032\037google/protobuf/timestamp.proto\"3\n"
          ...
          + "serde_info\030\004"
          + " \001(\01320.google.cloud.bigquery.storage.v1alpha.SerDeInfoB\003\340A\001\"\320\001\n"
          + "\tSerDeInfo\022\021\n"
          ...
          + "oud.bigquery.storage.v1alpha.SerDeInfo.ParametersEntryB\003\340A\001\0321\n"
          ...
          + "oogle.cloud.bigquery.storage.v1alpha.StorageDescriptorB\003\340A\001\022b\n\n"
          + "parameters\030\004 \003(\0132I.google.cloud.bigquery.storage.v1alpha."
          + "MetastorePartition.ParametersEntryB\003\340A\001\022G\n"
          + "\006fields\030\005"
          + " \003(\01322.google.cloud.bigquery.storage.v1alpha.FieldSchemaB\003\340A\001\0321\n"
          + "\017ParametersEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"l\n"
          + "\026MetastorePartitionList\022R\n\n"
          + "partitions\030\001"
          + " \003(\01329.google.cloud.bigquery.storage.v1alpha.MetastorePartitionB\003\340A\002\"\272\001\n\n"
          + "ReadStream\022\024\n"
          + "\004name\030\001 \001(\tB\006\340A\003\340A\010:\225\001\352A\221\001\n"
          + ")bigquerystorage.googleapis.com/ReadStream\022Kprojects/{project}/locations/{location"
          + "}/sessions/{session}/streams/{stream}*\013readStreams2\n"
          + "readStream\"U\n\n"
          + "StreamList\022G\n"
          + "\007streams\030\001"
          + " \003(\01321.google.cloud.bigquery.storage.v1alpha.ReadStreamB\003\340A\003\"/\n"
          + "\030MetastorePartitionValues\022\023\n"
          + "\006values\030\001 \003(\tB\003\340A\002B\333\001\n"
          + ")com.google.cloud.bigquery.storage.v1alphaB\027MetastorePartitionProtoP\001ZCcloud.g"
          + "oogle.com/go/bigquery/storage/apiv1alpha/storagepb;storagepb\252\002%Google.Cloud.BigQ"
          + "uery.Storage.V1Alpha\312\002%Google\\Cloud\\BigQuery\\Storage\\V1alphab\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_bigquery_storage_v1alpha_SerDeInfo_ParametersEntry_descriptor =
        internal_static_google_cloud_bigquery_storage_v1alpha_SerDeInfo_descriptor.getNestedType(0);
    internal_static_google_cloud_bigquery_storage_v1alpha_SerDeInfo_ParametersEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_bigquery_storage_v1alpha_SerDeInfo_ParametersEntry_descriptor,
            new java.lang.String[] {
