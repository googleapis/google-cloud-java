...
public final class AppendRowsRequest extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class ArrowData extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ArrowData(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public static final int CLIENT_STATS_FIELD_NUMBER = 9;
  private com.google.cloud.bigquery.storage.v1.ClientStats clientStats_;
   ...
   */
  @java.lang.Override
  public com.google.cloud.bigquery.storage.v1.ClientStats getClientStats() {
    return clientStats_ == null
        ? com.google.cloud.bigquery.storage.v1.ClientStats.getDefaultInstance()
        : clientStats_;
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.bigquery.storage.v1.ClientStatsOrBuilder getClientStatsOrBuilder() {
    return clientStats_ == null
        ? com.google.cloud.bigquery.storage.v1.ClientStats.getDefaultInstance()
        : clientStats_;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      output.writeMessage(9, getClientStats());
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(9, getClientStats());
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (defaultMissingValueInterpretation_ != other.defaultMissingValueInterpretation_)
      return false;
    if (hasClientStats() != other.hasClientStats()) return false;
    if (hasClientStats()) {
      if (!getClientStats().equals(other.getClientStats())) return false;
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.cloud.bigquery.storage.v1.AppendRowsRequest result) {
      ...
      if (((from_bitField0_ & 0x00000080) != 0)) {
        result.clientStats_ =
            clientStatsBuilder_ == null ? clientStats_ : clientStatsBuilder_.build();
        to_bitField0_ |= 0x00000002;
      }
      result.bitField0_ |= to_bitField0_;
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetArrowRowsFieldBuilder().getBuilder(), extensionRegistry);
                rowsCase_ = 5;
                break;
              } // case 42
            case 50:
            ...
            case 74:
              {
                input.readMessage(
                    internalGetClientStatsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.bigquery.storage.v1.AppendRowsRequest.ArrowData.Builder
        getArrowRowsBuilder() {
      return internalGetArrowRowsFieldBuilder().getBuilder();
    }
    ...
    private com.google.cloud.bigquery.storage.v1.ClientStats clientStats_;
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.bigquery.storage.v1.ClientStats,
            com.google.cloud.bigquery.storage.v1.ClientStats.Builder,
     ...
     * </code>
     */
    public Builder setClientStats(com.google.cloud.bigquery.storage.v1.ClientStats value) {
      if (clientStatsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder setClientStats(
        com.google.cloud.bigquery.storage.v1.ClientStats.Builder builderForValue) {
      if (clientStatsBuilder_ == null) {
        clientStats_ = builderForValue.build();
      } else {
     ...
     * </code>
     */
    public Builder mergeClientStats(com.google.cloud.bigquery.storage.v1.ClientStats value) {
      if (clientStatsBuilder_ == null) {
        if (((bitField0_ & 0x00000080) != 0)
            && clientStats_ != null
            && clientStats_
                != com.google.cloud.bigquery.storage.v1.ClientStats.getDefaultInstance()) {
          getClientStatsBuilder().mergeFrom(value);
        } else {
          clientStats_ = value;
        }
      } else {
     ...
     * </code>
     */
    public com.google.cloud.bigquery.storage.v1.ClientStats.Builder getClientStatsBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetClientStatsFieldBuilder().getBuilder();
    }
      ...
      if (clientStatsBuilder_ == null) {
        clientStatsBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.cloud.bigquery.storage.v1.ClientStats.Builder,
                com.google.cloud.bigquery.storage.v1.ClientStatsOrBuilder>(
                getClientStats(), getParentForChildren(), isClean());
        clientStats_ = null;
      }
