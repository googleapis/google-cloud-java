...
public interface MetastorePartitionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.bigquery.storage.v1beta.MetastorePartition)
   ...
   */
  com.google.cloud.bigquery.storage.v1beta.StorageDescriptor getStorageDescriptor();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.bigquery.storage.v1beta.FieldSchema> getFieldsList();
   ...
   * </code>
   */
  com.google.cloud.bigquery.storage.v1beta.FieldSchema getFields(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.bigquery.storage.v1beta.FieldSchemaOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.bigquery.storage.v1beta.FieldSchemaOrBuilder getFieldsOrBuilder(int index);
}
