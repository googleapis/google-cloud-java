...
```Groovy
implementation 'com.google.cloud:google-cloud-gsuite-addons:2.1.12'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gsuite-addons" % "2.1.12"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-gsuite-addons/latest/history
...
[contributing]: https://github.com/googleapis/java-gsuite-addons/blob/main/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-gsuite-addons/blob/main/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-gsuite-addons/blob/main/LICENSE
