...
public class DeploymentName implements ResourceName {
  private static final PathTemplate PROJECT_DEPLOYMENT =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/deployments/{deployment}");
  ...
  public static @Nullable DeploymentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DeploymentName> values) {
