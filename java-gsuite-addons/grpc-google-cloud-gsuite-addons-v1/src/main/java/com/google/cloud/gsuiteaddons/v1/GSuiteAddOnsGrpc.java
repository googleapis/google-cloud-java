...
public final class GSuiteAddOnsGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.gsuiteaddons.v1.GSuiteAddOns";
  ...
  public static final class GSuiteAddOnsStub
      extends io.grpc.stub.AbstractAsyncStub<GSuiteAddOnsStub> {
    private GSuiteAddOnsStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void replaceDeployment(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.gsuiteaddons.v1.Deployment> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getReplaceDeploymentMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void installDeployment(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getInstallDeploymentMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void uninstallDeployment(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUninstallDeploymentMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getInstallStatus(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.gsuiteaddons.v1.InstallStatus>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetInstallStatusMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class GSuiteAddOnsBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<GSuiteAddOnsBlockingStub> {
   ...
   * </pre>
   */
  public static final class GSuiteAddOnsFutureStub
      extends io.grpc.stub.AbstractFutureStub<GSuiteAddOnsFutureStub> {
    private GSuiteAddOnsFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.gsuiteaddons.v1.Authorization>
        getAuthorization(com.google.cloud.gsuiteaddons.v1.GetAuthorizationRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.gsuiteaddons.v1.Deployment>
        createDeployment(com.google.cloud.gsuiteaddons.v1.CreateDeploymentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.gsuiteaddons.v1.Deployment>
        replaceDeployment(com.google.cloud.gsuiteaddons.v1.ReplaceDeploymentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.gsuiteaddons.v1.Deployment>
        getDeployment(com.google.cloud.gsuiteaddons.v1.GetDeploymentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.gsuiteaddons.v1.ListDeploymentsResponse>
        listDeployments(com.google.cloud.gsuiteaddons.v1.ListDeploymentsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        deleteDeployment(com.google.cloud.gsuiteaddons.v1.DeleteDeploymentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        installDeployment(com.google.cloud.gsuiteaddons.v1.InstallDeploymentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        uninstallDeployment(com.google.cloud.gsuiteaddons.v1.UninstallDeploymentRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.gsuiteaddons.v1.InstallStatus>
        getInstallStatus(com.google.cloud.gsuiteaddons.v1.GetInstallStatusRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
      ...
      switch (methodId) {
        ...
        case METHODID_CREATE_DEPLOYMENT:
          serviceImpl.createDeployment(
              (com.google.cloud.gsuiteaddons.v1.CreateDeploymentRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.gsuiteaddons.v1.Deployment>)
                  responseObserver);
          break;
        case METHODID_REPLACE_DEPLOYMENT:
          serviceImpl.replaceDeployment(
              (com.google.cloud.gsuiteaddons.v1.ReplaceDeploymentRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.gsuiteaddons.v1.Deployment>)
                  responseObserver);
          break;
        ...
        case METHODID_INSTALL_DEPLOYMENT:
          serviceImpl.installDeployment(
              (com.google.cloud.gsuiteaddons.v1.InstallDeploymentRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_UNINSTALL_DEPLOYMENT:
          serviceImpl.uninstallDeployment(
              (com.google.cloud.gsuiteaddons.v1.UninstallDeploymentRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_GET_INSTALL_STATUS:
          serviceImpl.getInstallStatus(
              (com.google.cloud.gsuiteaddons.v1.GetInstallStatusRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.gsuiteaddons.v1.InstallStatus>)
                  responseObserver);
          break;
  ...
  private static final class GSuiteAddOnsMethodDescriptorSupplier
    ...
    GSuiteAddOnsMethodDescriptorSupplier(java.lang.String methodName) {
