...
public final class GmailAddOnManifest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private GmailAddOnManifest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(authorizationCheckFunction_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, authorizationCheckFunction_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(authorizationCheckFunction_)) {
      size +=
          com.google.protobuf.GeneratedMessage.computeStringSize(7, authorizationCheckFunction_);
    }
    if (((bitField0_ & 0x00000002) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetContextualTriggersFieldBuilder();
        internalGetUniversalActionsFieldBuilder();
        internalGetComposeTriggerFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 98:
              {
                input.readMessage(
                    internalGetComposeTriggerFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.apps.script.type.gmail.ContextualTrigger.Builder getContextualTriggersBuilder(
        int index) {
      return internalGetContextualTriggersFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.apps.script.type.gmail.ContextualTrigger.Builder
      ...
      return internalGetContextualTriggersFieldBuilder()
    ...
    public java.util.List<com.google.apps.script.type.gmail.ContextualTrigger.Builder>
      ...
      return internalGetContextualTriggersFieldBuilder().getBuilderList();
    }
    ...
    public com.google.apps.script.type.gmail.UniversalAction.Builder getUniversalActionsBuilder(
        int index) {
      return internalGetUniversalActionsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.apps.script.type.gmail.UniversalAction.Builder addUniversalActionsBuilder() {
      return internalGetUniversalActionsFieldBuilder()
    ...
    public java.util.List<com.google.apps.script.type.gmail.UniversalAction.Builder>
      ...
      return internalGetUniversalActionsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.apps.script.type.gmail.ComposeTrigger.Builder getComposeTriggerBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
      return internalGetComposeTriggerFieldBuilder().getBuilder();
    }
