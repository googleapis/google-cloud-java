...
public final class EvaluationJobOuterClass extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "6google/cloud/datalabeling/v1beta1/evaluation_job.proto\022!google.cloud.datalabel"
          + "ing.v1beta1\032\031google/api/resource.proto\032/"
          + "google/cloud/datalabeling/v1beta1/dataset.proto\0322google/cloud/datalabeling/v1bet"
          + "a1/evaluation.proto\032?google/cloud/datalabeling/v1beta1/human_annotation_config.p"
          + "roto\032\037google/protobuf/timestamp.proto\032\027google/rpc/status.proto\"\342\004\n\r"
          + "EvaluationJob\022\014\n"
          + "\004name\030\001 \001(\t\022\023\n"
          + "\013description\030\002 \001(\t\022E\n"
          + "\005state\030\003"
          + " \001(\01626.google.cloud.datalabeling.v1beta1.EvaluationJob.State\022\020\n"
          + "\010schedule\030\004 \001(\t\022\025\n\r"
          + "model_version\030\005 \001(\t\022U\n"
          + "\025evaluation_job_config\030\006"
          + " \001(\01326.google.cloud.datalabeling.v1beta1.EvaluationJobConfig\022\033\n"
          + "\023annotation_spec_set\030\007 \001(\t\022\"\n"
          + "\032label_missing_ground_truth\030\010 \001(\010\022<\n"
          + "\010attempts\030\t \003(\0132*.google.cloud.datalabeling.v1beta1.Attempt\022/\n"
          + "\013create_time\030\n"
          ...
          + ")datalabeling.googl"
          + "eapis.com/EvaluationJob\0222projects/{project}/evaluationJobs/{evaluation_job}\"\215\007\n"
          + "\023EvaluationJobConfig\022c\n"
          + "\033image_classification_config\030\004 \001(\0132<.google.cloud.datalabe"
          + "ling.v1beta1.ImageClassificationConfigH\000\022U\n"
          + "\024bounding_poly_config\030\005 \001(\01325.google."
          + "cloud.datalabeling.v1beta1.BoundingPolyConfigH\000\022a\n"
          + "\032text_classification_config\030\010 "
          + "\001(\0132;.google.cloud.datalabeling.v1beta1.TextClassificationConfigH\000\022D\n"
          + "\014input_config\030\001"
          + " \001(\0132..google.cloud.datalabeling.v1beta1.InputConfig\022N\n"
          + "\021evaluation_config\030\002 "
          + "\001(\01323.google.cloud.datalabeling.v1beta1.EvaluationConfig\022Y\n"
          + "\027human_annotation_config\030\003"
          + " \001(\01328.google.cloud.datalabeling.v1beta1.HumanAnnotationConfig\022l\n"
          + "\024bigquery_import_keys\030\t \003(\0132N.google.cloud.datalab"
          + "eling.v1beta1.EvaluationJobConfig.BigqueryImportKeysEntry\022\025\n\r"
          + "example_count\030\n"
          + " \001(\005\022!\n"
          + "\031example_sample_percentage\030\013 \001(\001\022`\n"
          + "\033evaluation_job_alert_config\030\r"
          + " \001(\0132;.google.cloud.datalabeling.v1beta1.EvaluationJobAlertConfig\0329\n"
          + "\027BigqueryImportKeysEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001B!\n"
          + "\037human_annotation_request_config\"X\n"
          + "\030EvaluationJobAlertConfig\022\r\n"
          + "\005email\030\001 \001(\t\022-\n"
          + "%min_acceptable_mean_average_precision\030\002 \001(\001\"i\n"
          + "\007Attempt\0220\n"
          + "\014attempt_time\030\001 \001(\0132\032.google.protobuf.Timestamp\022,\n"
          + "\020partial_failures\030\002 \003(\0132\022.google.rpc.StatusB\343\001\n"
          + "%com.google.cloud.datalabeling.v1beta1P\001ZIcloud.goog"
          + "le.com/go/datalabeling/apiv1beta1/datalabelingpb;datalabelingpb\252\002!Google.Cloud.D"
          + "ataLabeling.V1Beta1\312\002!Google\\Cloud\\DataL"
          + "abeling\\V1beta1\352\002$Google::Cloud::DataLabeling::V1beta1b\006proto3"
    };
    descriptor =
