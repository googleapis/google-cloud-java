...
public final class EvaluationConfig extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (verticalOptionCase_ == 1) {
      output.writeMessage(
          1, (com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptions) verticalOption_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.datalabeling.v1beta1.EvaluationConfig other =
        (com.google.cloud.datalabeling.v1beta1.EvaluationConfig) obj;

    if (!getVerticalOptionCase().equals(other.getVerticalOptionCase())) return false;
    switch (verticalOptionCase_) {
      case 1:
        if (!getBoundingBoxEvaluationOptions().equals(other.getBoundingBoxEvaluationOptions()))
          return false;
        break;
      case 0:
      default:
  ...
  public static Builder newBuilder(
      com.google.cloud.datalabeling.v1beta1.EvaluationConfig prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetBoundingBoxEvaluationOptionsFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public Builder setBoundingBoxEvaluationOptions(
        com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptions value) {
      if (boundingBoxEvaluationOptionsBuilder_ == null) {
        if (value == null) {
     ...
     * </code>
     */
    public Builder mergeBoundingBoxEvaluationOptions(
        com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptions value) {
      if (boundingBoxEvaluationOptionsBuilder_ == null) {
        if (verticalOptionCase_ == 1
            && verticalOption_
     ...
     * </code>
     */
    public com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptions.Builder
        getBoundingBoxEvaluationOptionsBuilder() {
      return internalGetBoundingBoxEvaluationOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptions.Builder,
            com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptionsOrBuilder>
        internalGetBoundingBoxEvaluationOptionsFieldBuilder() {
      if (boundingBoxEvaluationOptionsBuilder_ == null) {
        if (!(verticalOptionCase_ == 1)) {
          verticalOption_ =
              com.google.cloud.datalabeling.v1beta1.BoundingBoxEvaluationOptions
