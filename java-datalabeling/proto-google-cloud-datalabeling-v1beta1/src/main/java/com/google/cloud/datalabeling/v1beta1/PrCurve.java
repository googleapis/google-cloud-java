...
public final class PrCurve extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private PrCurve(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class ConfidenceMetricsEntry extends com.google.protobuf.GeneratedMessage
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      public Builder mergeFrom(
        ...
        if (java.lang.Float.floatToRawIntBits(other.getRecallAt1()) != 0) {
          setRecallAt1(other.getRecallAt1());
        }
        if (java.lang.Float.floatToRawIntBits(other.getPrecisionAt1()) != 0) {
          setPrecisionAt1(other.getPrecisionAt1());
        }
        if (java.lang.Float.floatToRawIntBits(other.getF1ScoreAt1()) != 0) {
          setF1ScoreAt1(other.getF1ScoreAt1());
        }
        if (java.lang.Float.floatToRawIntBits(other.getRecallAt5()) != 0) {
          setRecallAt5(other.getRecallAt5());
        }
        if (java.lang.Float.floatToRawIntBits(other.getPrecisionAt5()) != 0) {
          setPrecisionAt5(other.getPrecisionAt5());
        }
        if (java.lang.Float.floatToRawIntBits(other.getF1ScoreAt5()) != 0) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetAnnotationSpecFieldBuilder();
    ...
    public Builder mergeFrom(com.google.cloud.datalabeling.v1beta1.PrCurve other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getAreaUnderCurve()) != 0) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getMeanAveragePrecision()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetAnnotationSpecFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
            case 21:
    ...
    public com.google.cloud.datalabeling.v1beta1.AnnotationSpec.Builder getAnnotationSpecBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetAnnotationSpecFieldBuilder().getBuilder();
    }
