 ...
 */
public final class SearchEvaluationsResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SearchEvaluationsResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.datalabeling.v1beta1.Evaluation m =
                    input.readMessage(
