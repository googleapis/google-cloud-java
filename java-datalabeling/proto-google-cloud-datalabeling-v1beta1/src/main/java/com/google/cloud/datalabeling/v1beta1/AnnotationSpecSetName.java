...
public class AnnotationSpecSetName implements ResourceName {
  ...
  public static @Nullable AnnotationSpecSetName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AnnotationSpecSetName> values) {
