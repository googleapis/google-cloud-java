...
```Groovy
implementation 'com.google.cloud:google-cloud-datalabeling:0.122.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datalabeling" % "0.122.1"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-datalabeling/tree/master/samples) directory.
