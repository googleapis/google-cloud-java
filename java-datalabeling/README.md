...
```Groovy
implementation 'com.google.cloud:google-cloud-datalabeling:0.122.7'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datalabeling" % "0.122.7"
```
