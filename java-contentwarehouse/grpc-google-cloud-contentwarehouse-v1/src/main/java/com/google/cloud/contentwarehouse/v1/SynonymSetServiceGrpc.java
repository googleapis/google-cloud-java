...
public final class SynonymSetServiceGrpc {
          ...
          SynonymSetServiceGrpc.getCreateSynonymSetMethod =
              getCreateSynonymSetMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new SynonymSetServiceMethodDescriptorSupplier("CreateSynonymSet"))
                      .build();
        }
      }
    }
                  ...
                  io.grpc.MethodDescriptor
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.contentwarehouse.v1.SynonymSet.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SynonymSetServiceMethodDescriptorSupplier("GetSynonymSet"))
                      .build();
        }
      }
    }
                  ...
                  io.grpc.MethodDescriptor
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.contentwarehouse.v1.SynonymSet.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SynonymSetServiceMethodDescriptorSupplier("UpdateSynonymSet"))
                      .build();
        }
      }
    }
          ...
          SynonymSetServiceGrpc.getDeleteSynonymSetMethod =
              getDeleteSynonymSetMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new SynonymSetServiceMethodDescriptorSupplier("DeleteSynonymSet"))
                      .build();
        }
      }
    }
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.contentwarehouse.v1.ListSynonymSetsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new SynonymSetServiceMethodDescriptorSupplier("ListSynonymSets"))
                      .build();
        }
      }
    }
  ...
  public static SynonymSetServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SynonymSetServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SynonymSetServiceStub>() {
          @java.lang.Override
          public SynonymSetServiceStub newStub(
   ...
   */
  public static SynonymSetServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SynonymSetServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SynonymSetServiceBlockingStub>() {
          @java.lang.Override
          public SynonymSetServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static SynonymSetServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SynonymSetServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SynonymSetServiceFutureStub>() {
          @java.lang.Override
          public SynonymSetServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public abstract static class SynonymSetServiceImplBase implements io.grpc.BindableService {
    ...
    public void createSynonymSet(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getCreateSynonymSetMethod(), responseObserver);
    }
    ...
    public void getSynonymSet(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.contentwarehouse.v1.SynonymSet>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getGetSynonymSetMethod(), responseObserver);
    }
    ...
    public void updateSynonymSet(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.contentwarehouse.v1.SynonymSet>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getUpdateSynonymSetMethod(), responseObserver);
    }
    ...
    public void deleteSynonymSet(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getDeleteSynonymSetMethod(), responseObserver);
    }
  ...
  public static final class SynonymSetServiceStub
    ...
    private SynonymSetServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void createSynonymSet(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateSynonymSetMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void getSynonymSet(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.contentwarehouse.v1.SynonymSet>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetSynonymSetMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void updateSynonymSet(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.contentwarehouse.v1.SynonymSet>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUpdateSynonymSetMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void deleteSynonymSet(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteSynonymSetMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void listSynonymSets(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.contentwarehouse.v1.ListSynonymSetsResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListSynonymSetsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class SynonymSetServiceFutureStub
    ...
    private SynonymSetServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.contentwarehouse.v1.SynonymSet>
        createSynonymSet(com.google.cloud.contentwarehouse.v1.CreateSynonymSetRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.contentwarehouse.v1.SynonymSet>
        getSynonymSet(com.google.cloud.contentwarehouse.v1.GetSynonymSetRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.contentwarehouse.v1.SynonymSet>
        updateSynonymSet(com.google.cloud.contentwarehouse.v1.UpdateSynonymSetRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.protobuf.Empty>
        deleteSynonymSet(com.google.cloud.contentwarehouse.v1.DeleteSynonymSetRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.contentwarehouse.v1.ListSynonymSetsResponse>
        listSynonymSets(com.google.cloud.contentwarehouse.v1.ListSynonymSetsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_UPDATE_SYNONYM_SET:
          serviceImpl.updateSynonymSet(
              (com.google.cloud.contentwarehouse.v1.UpdateSynonymSetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.contentwarehouse.v1.SynonymSet>)
                  responseObserver);
          break;
        case METHODID_DELETE_SYNONYM_SET:
          serviceImpl.deleteSynonymSet(
              (com.google.cloud.contentwarehouse.v1.DeleteSynonymSetRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        case METHODID_LIST_SYNONYM_SETS:
          serviceImpl.listSynonymSets(
              (com.google.cloud.contentwarehouse.v1.ListSynonymSetsRequest) request,
