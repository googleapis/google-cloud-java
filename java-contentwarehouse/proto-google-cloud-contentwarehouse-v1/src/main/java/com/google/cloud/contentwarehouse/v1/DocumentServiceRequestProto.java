...
public final class DocumentServiceRequestProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "?google/cloud/contentwarehouse/v1/document_service_request.proto\022 google.cloud."
          + "contentwarehouse.v1\032\037google/api/field_be"
          + "havior.proto\032\031google/api/resource.proto\032"
          + "-google/cloud/contentwarehouse/v1/common.proto\032/google/cloud/contentwarehouse/v1"
          + "/document.proto\032.google/cloud/contentwarehouse/v1/filters.proto\0320google/cloud/co"
          + "ntentwarehouse/v1/histogram.proto\032\032google/iam/v1/policy.proto\032"
          + " google/protobuf/field_mask.proto\"\247\002\n"
          + "\025CloudAIDocumentOption\022#\n"
          + "\033enable_entities_conversions\030\001 \001(\010\022\230\001\n"
          + "*customized_entities_properties_conversions\030\002"
          + " \003(\0132d.google.cloud.contentwareho"
          + "use.v1.CloudAIDocumentOption.CustomizedEntitiesPropertiesConversionsEntry\032N\n"
          + ",CustomizedEntitiesPropertiesConversionsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\"\234\003\n"
          + "\025CreateDocumentRequest\022@\n"
          + "\006parent\030\001 \001(\tB0\340A\002\372A*\n"
          + "(contentwarehouse.googleapis.com/Location\022A\n"
          + "\010document\030\002"
          + " \001(\0132*.google.cloud.contentwarehouse.v1.DocumentB\003\340A\002\022K\n"
          + "\020request_metadata\030\003"
          + " \001(\01321.google.cloud.contentwarehouse.v1.RequestMetadata\022%\n"
          + "\006policy\030\004 \001(\0132\025.google.iam.v1.Policy\022Y\n"
          + "\030cloud_ai_document_option\030\005 \001(\01327.google.cloud.co"
          + "ntentwarehouse.v1.CloudAIDocumentOption\022/\n"
          + "\013create_mask\030\006 \001(\0132\032.google.protobuf.FieldMask\"\241\001\n"
          + "\022GetDocumentRequest\022>\n"
          + "\004name\030\001 \001(\tB0\340A\002\372A*\n"
          + "(contentwarehouse.googleapis.com/Document\022K\n"
          + "\020request_metadata\030\002 \001("
          + "\01321.google.cloud.contentwarehouse.v1.RequestMetadata\"\213\003\n"
          + "\025UpdateDocumentRequest\022>\n"
          + "\004name\030\001 \001(\tB0\340A\002\372A*\n"
          + "(contentwarehouse.googleapis.com/Document\022A\n"
          + "\010document\030\002 \001(\013"
          + "2*.google.cloud.contentwarehouse.v1.DocumentB\003\340A\002\022K\n"
          + "\020request_metadata\030\003 \001(\01321.go"
          + "ogle.cloud.contentwarehouse.v1.RequestMetadata\022Y\n"
          + "\030cloud_ai_document_option\030\005 \001(\013"
          + "27.google.cloud.contentwarehouse.v1.CloudAIDocumentOption\022G\n"
          + "\016update_options\030\006 \001("
          + "\0132/.google.cloud.contentwarehouse.v1.UpdateOptions\"\244\001\n"
          + "\025DeleteDocumentRequest\022>\n"
          + "\004name\030\001 \001(\tB0\340A\002\372A*\n"
          + "(contentwarehouse.googleapis.com/Document\022K\n"
          + "\020request_metadata\030\002"
          + " \001(\01321.google.cloud.contentwarehouse.v1.RequestMetadata\"\371\004\n"
          + "\026SearchDocumentsRequest\022@\n"
          + "\006parent\030\001 \001(\tB0\340A\002\372A*\n"
          + "(contentwarehouse.googleapis.com/Location\022K\n"
          + "\020request_metadata\030\003"
          + " \001(\01321.google.cloud.contentwarehouse.v1.RequestMetadata\022G\n"
          + "\016document_query\030\004"
          + " \001(\0132/.google.cloud.contentwarehouse.v1.DocumentQuery\022\016\n"
          ...
          + "20.google.cloud.contentwarehouse.v1.HistogramQuery\022\032\n"
          + "\022require_total_size\030\n"
          + " \001(\010\022c\n"
          + "\021total_result_size\030\014 \001(\0162H.google.cloud"
          + ".contentwarehouse.v1.SearchDocumentsRequest.TotalResultSize\022\025\n\r"
          + "qa_size_limit\030\013 \001(\005\"Y\n"
          + "\017TotalResultSize\022!\n"
          + "\035TOTAL_RESULT_SIZE_UNSPECIFIED\020\000\022\022\n"
          + "\016ESTIMATED_SIZE\020\001\022\017\n"
          + "\013ACTUAL_SIZE\020\002\"\256\001\n"
          + "\023LockDocumentRequest\022>\n"
          + "\004name\030\001 \001(\tB0\340A\002\372A*\n"
          + "(contentwarehouse.googleapis.com/Document\022\025\n\r"
          + "collection_id\030\002 \001(\t\022@\n"
          + "\014locking_user\030\003"
          + " \001(\0132*.google.cloud.contentwarehouse.v1.UserInfo\"\214\001\n"
          + "\017FetchAclRequest\022\025\n"
          + "\010resource\030\001 \001(\tB\003\340A\002\022K\n"
          + "\020request_metadata\030\002"
          + " \001(\01321.google.cloud.contentwarehouse.v1.RequestMetadata\022\025\n\r"
          + "project_owner\030\003 \001(\010\"\266\001\n\r"
          + "SetAclRequest\022\025\n"
          + "\010resource\030\001 \001(\tB\003\340A\002\022*\n"
          + "\006policy\030\002 \001(\0132\025.google.iam.v1.PolicyB\003\340A\002\022K\n"
          + "\020request_metadata\030\003"
          + " \001(\01321.google.cloud.contentwarehouse.v1.RequestMetadata\022\025\n\r"
          + "project_owner\030\004 \001(\010B\203\002\n"
          + "$com.google.cloud.contentwarehouse.v1B\033DocumentServiceRequestProtoP\001ZPcloud.go"
          + "ogle.com/go/contentwarehouse/apiv1/contentwarehousepb;contentwarehousepb\252\002"
          + " Google.Cloud.ContentWarehouse.V1\312\002 Google\\Clo"
          + "ud\\ContentWarehouse\\V1\352\002#Google::Cloud::ContentWarehouse::V1b\006proto3"
    };
    descriptor =
