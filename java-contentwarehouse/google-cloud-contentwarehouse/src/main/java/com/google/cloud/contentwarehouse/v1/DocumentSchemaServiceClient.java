...
public class DocumentSchemaServiceClient implements BackgroundResource {
   ...
   * non-empty and does not equal the existing name. Supports only appending new properties and
   ...
   *     DocumentSchemaServiceClient.create()) {
   *   DocumentSchema documentSchema = DocumentSchema.newBuilder().build();
   *   DocumentSchema response = documentSchemaServiceClient.updateDocumentSchema(documentSchema);
   * }
   * }</pre>
   *
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final DocumentSchema updateDocumentSchema(DocumentSchema documentSchema) {
    UpdateDocumentSchemaRequest request =
        UpdateDocumentSchemaRequest.newBuilder().setDocumentSchema(documentSchema).build();
