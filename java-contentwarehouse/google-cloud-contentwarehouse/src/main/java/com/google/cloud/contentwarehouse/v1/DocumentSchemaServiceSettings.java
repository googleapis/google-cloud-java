...
/**
 * Settings class to configure an instance of {@link DocumentSchemaServiceClient}.
 *
...
public class DocumentSchemaServiceSettings extends ClientSettings<DocumentSchemaServiceSettings> {
  ...
  public UnaryCallSettings<CreateDocumentSchemaRequest, DocumentSchema>
      createDocumentSchemaSettings() {
    return ((DocumentSchemaServiceStubSettings) getStubSettings()).createDocumentSchemaSettings();
  }
  ...
  public UnaryCallSettings<UpdateDocumentSchemaRequest, DocumentSchema>
    ...
    return ((DocumentSchemaServiceStubSettings) getStubSettings()).updateDocumentSchemaSettings();
  }
  ...
  public UnaryCallSettings<GetDocumentSchemaRequest, DocumentSchema> getDocumentSchemaSettings() {
    return ((DocumentSchemaServiceStubSettings) getStubSettings()).getDocumentSchemaSettings();
  }
  ...
  public UnaryCallSettings<DeleteDocumentSchemaRequest, Empty> deleteDocumentSchemaSettings() {
    return ((DocumentSchemaServiceStubSettings) getStubSettings()).deleteDocumentSchemaSettings();
  }
  ...
  public PagedCallSettings<
    ...
    return ((DocumentSchemaServiceStubSettings) getStubSettings()).listDocumentSchemasSettings();
  }

  public static final DocumentSchemaServiceSettings create(DocumentSchemaServiceStubSettings stub)
      throws IOException {
    return new DocumentSchemaServiceSettings.Builder(stub.toBuilder()).build();
  }

  /** Returns a builder for the default ExecutorProvider for this service. */
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return DocumentSchemaServiceStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return DocumentSchemaServiceStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return DocumentSchemaServiceStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return DocumentSchemaServiceStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return DocumentSchemaServiceStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return DocumentSchemaServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }

  public static TransportChannelProvider defaultTransportChannelProvider() {
    return DocumentSchemaServiceStubSettings.defaultTransportChannelProvider();
  }

  @BetaApi("The surface for customizing headers is not stable yet and may change in the future.")
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return DocumentSchemaServiceStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected DocumentSchemaServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for DocumentSchemaServiceSettings. */
  public static class Builder
      extends ClientSettings.Builder<DocumentSchemaServiceSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(DocumentSchemaServiceStubSettings.newBuilder(clientContext));
    }
    ...
    public DocumentSchemaServiceStubSettings.Builder getStubSettingsBuilder() {
      return ((DocumentSchemaServiceStubSettings.Builder) getStubSettings());
    }
    ...
    public UnaryCallSettings.Builder<CreateDocumentSchemaRequest, DocumentSchema>
        createDocumentSchemaSettings() {
      return getStubSettingsBuilder().createDocumentSchemaSettings();
    }
    ...
    public UnaryCallSettings.Builder<UpdateDocumentSchemaRequest, DocumentSchema>
        updateDocumentSchemaSettings() {
      return getStubSettingsBuilder().updateDocumentSchemaSettings();
    }
    ...
    public UnaryCallSettings.Builder<GetDocumentSchemaRequest, DocumentSchema>
      ...
      return getStubSettingsBuilder().getDocumentSchemaSettings();
    }
    ...
    public PagedCallSettings.Builder<
        ...
        listDocumentSchemasSettings() {
      return getStubSettingsBuilder().listDocumentSchemasSettings();
    }

    @Override
    public DocumentSchemaServiceSettings build() throws IOException {
      return new DocumentSchemaServiceSettings(this);
    }
  }
}
