...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.tpu.v2alpha1.GetGuestAttributesResponse result) {
      if (guestAttributesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.tpu.v2alpha1.GuestAttributes m =
                  input.readMessage(
                      com.google.cloud.tpu.v2alpha1.GuestAttributes.parser(),
                      extensionRegistry);
              if (guestAttributesBuilder_ == null) {
                ensureGuestAttributesIsMutable();
