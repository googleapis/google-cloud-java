...
public interface InterconnectDiagnosticsOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatus> 
      getLinksList();
  /**
   * <pre>
   * A list of LinkStatus objects, used to describe the status for each link on
   ...
   * <code>repeated .google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatus links = 3;</code>
   */
  java.util.List<? extends com.google.cloud.edgenetwork.v1.InterconnectDiagnostics.LinkStatusOrBuilder> 
