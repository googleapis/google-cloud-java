...
public class ZoneName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_ZONE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/zones/{zone}");
  ...
  public static ZoneName of(String project, String location, String zone) {
    return newBuilder().setProject(project).setLocation(location).setZone(zone).build();
  }

  public static String format(String project, String location, String zone) {
    return newBuilder().setProject(project).setLocation(location).setZone(zone).build().toString();
  }
  ...
  public static ZoneName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_ZONE.validatedMatch(
            formattedString, "ZoneName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("zone"));
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_ZONE.instantiate(
        "project", project, "location", location, "zone", zone);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/zones/{zone}. */
