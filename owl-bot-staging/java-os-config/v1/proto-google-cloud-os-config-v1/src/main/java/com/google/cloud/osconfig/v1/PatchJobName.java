...
public class PatchJobName implements ResourceName {
  private static final PathTemplate PROJECT_PATCH_JOB =
  ...
  public static PatchJobName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_PATCH_JOB.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_PATCH_JOB.matches(formattedString);
  }
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (patchJob != null) {
            fieldMapBuilder.put("patch_job", patchJob);
          }
  ...
  public String toString() {
    return PROJECT_PATCH_JOB.instantiate("project", project, "patch_job", patchJob);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          && Objects.equals(this.patchJob, that.patchJob);
    }
    return false;
  }
