 ...
 *  projects.locations.osPolicyAssignments.operations.cancel](https://cloud.google.com/compute/docs/osconfig/rest/v1alpha/projects.locations.osPolicyAssignments.operations/cancel).</p></td>
 *      <td>
 ...
 *
 *  For each OS policy assignment, the latest revision is returned.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>List the OS policy assignment revisions for a given OS policy assignment.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    </tr>
 *    <tr>
 *      <td>GetInstanceOSPoliciesCompliance</td>
 *      <td><p>Get OS policies compliance data for the specified Compute Engine VM
 *  instance.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>getInstanceOSPoliciesCompliance(GetInstanceOSPoliciesComplianceRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getInstanceOSPoliciesCompliance(InstanceOSPoliciesComplianceName name)
 *           <li>getInstanceOSPoliciesCompliance(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>getInstanceOSPoliciesComplianceCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ListInstanceOSPoliciesCompliances</td>
 *      <td><p>List OS policies compliance data for all Compute Engine VM instances in the
 *  specified zone.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listInstanceOSPoliciesCompliances(ListInstanceOSPoliciesCompliancesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listInstanceOSPoliciesCompliances(LocationName parent)
 *           <li>listInstanceOSPoliciesCompliances(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listInstanceOSPoliciesCompliancesPagedCallable()
 *           <li>listInstanceOSPoliciesCompliancesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetOSPolicyAssignmentReport</td>
 *      <td><p>Get the OS policy asssignment report for the specified Compute Engine VM
 *  instance.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>List OS policy asssignment reports for all Compute Engine VM instances in
 *  the specified zone.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>GetInventory</td>
 *      <td><p>Get inventory data for the specified VM instance. If the VM has no
 *  associated inventory, the message `NOT_FOUND` is returned.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>List inventory data for all VM instances in the specified zone.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Gets the vulnerability report for the specified VM instance. Only VMs with
 *  inventory data have vulnerability reports associated with them.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>List vulnerability reports for all VM instances in the specified zone.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
