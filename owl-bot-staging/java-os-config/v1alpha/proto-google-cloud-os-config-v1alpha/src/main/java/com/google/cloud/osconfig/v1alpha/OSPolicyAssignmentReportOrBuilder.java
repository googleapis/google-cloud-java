...
public interface OSPolicyAssignmentReportOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance os_policy_compliances = 4;</code>
   */
   ...
   * <code>repeated .google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance os_policy_compliances = 4;</code>
   */
  com.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance getOsPolicyCompliances(int index);
  /**
   * <pre>
   * Compliance data for each `OSPolicy` that is applied to the VM.
   * </pre>
   ...
   * <code>repeated .google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance os_policy_compliances = 4;</code>
   */
  java.util.List<? extends com.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyComplianceOrBuilder> 
   ...
   * <code>repeated .google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyCompliance os_policy_compliances = 4;</code>
   */
  com.google.cloud.osconfig.v1alpha.OSPolicyAssignmentReport.OSPolicyComplianceOrBuilder getOsPolicyCompliancesOrBuilder(
      int index);
