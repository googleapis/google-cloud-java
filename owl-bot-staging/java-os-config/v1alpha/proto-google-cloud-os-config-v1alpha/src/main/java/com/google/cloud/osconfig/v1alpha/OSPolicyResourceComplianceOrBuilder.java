...
@java.lang.Deprecated public interface OSPolicyResourceComplianceOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep config_steps = 2;</code>
   */
  java.util.List<com.google.cloud.osconfig.v1alpha.OSPolicyResourceConfigStep> 
      getConfigStepsList();
  /**
   * <pre>
   * Ordered list of configuration steps taken by the agent for the OS policy
