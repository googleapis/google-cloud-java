...
public class InstanceOSPoliciesComplianceName implements ResourceName {
  ...
  public static InstanceOSPoliciesComplianceName of(
  ...
  public static InstanceOSPoliciesComplianceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_INSTANCE.validatedMatch(
            formattedString,
            "InstanceOSPoliciesComplianceName.parse: formattedString not in valid format");
  ...
  public static List<InstanceOSPoliciesComplianceName> parseList(List<String> formattedStrings) {
    List<InstanceOSPoliciesComplianceName> list = new ArrayList<>(formattedStrings.size());
