...
public interface OSPolicyOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.osconfig.v1alpha.OSPolicy.Mode mode = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup resource_groups = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.cloud.osconfig.v1alpha.OSPolicy.ResourceGroup> 
