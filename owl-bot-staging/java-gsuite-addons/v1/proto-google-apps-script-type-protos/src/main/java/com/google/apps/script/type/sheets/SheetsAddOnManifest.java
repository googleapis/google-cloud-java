      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            onFileScopeGrantedTrigger_ = input.readMessage(com.google.apps.script.type.sheets.SheetsExtensionPoint.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.apps.script.type.sheets.SheetsAddOnManifest) e.getUnfinishedMessage();
