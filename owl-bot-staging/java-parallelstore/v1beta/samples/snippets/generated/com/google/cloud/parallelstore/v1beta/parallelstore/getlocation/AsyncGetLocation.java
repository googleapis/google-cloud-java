...
public class AsyncGetLocation {
  ...
  public static void asyncGetLocation() throws Exception {
    ...
    try (ParallelstoreClient parallelstoreClient = ParallelstoreClient.create()) {
      ...
      ApiFuture<Location> future = parallelstoreClient.getLocationCallable().futureCall(request);
      // Do something.
      Location response = future.get();
    }
  }
}
// [END parallelstore_v1beta_generated_Parallelstore_GetLocation_async]
