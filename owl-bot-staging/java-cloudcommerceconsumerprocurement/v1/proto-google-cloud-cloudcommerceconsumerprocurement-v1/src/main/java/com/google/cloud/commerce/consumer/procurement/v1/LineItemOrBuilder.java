...
public interface LineItemOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.commerce.consumer.procurement.v1.LineItem)
   ...
   * </pre>
   *
   * <code>.google.cloud.commerce.consumer.procurement.v1.LineItemInfo line_item_info = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * <code>.google.cloud.commerce.consumer.procurement.v1.LineItemInfo line_item_info = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.commerce.consumer.procurement.v1.LineItemInfoOrBuilder getLineItemInfoOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.commerce.consumer.procurement.v1.LineItemChange pending_change = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * <code>.google.cloud.commerce.consumer.procurement.v1.LineItemChange pending_change = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.commerce.consumer.procurement.v1.LineItemChangeOrBuilder getPendingChangeOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.commerce.consumer.procurement.v1.LineItemChange change_history = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * <code>repeated .google.cloud.commerce.consumer.procurement.v1.LineItemChange change_history = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.cloud.commerce.consumer.procurement.v1.LineItemChangeOrBuilder> 
   ...
   * <code>repeated .google.cloud.commerce.consumer.procurement.v1.LineItemChange change_history = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.commerce.consumer.procurement.v1.LineItemChangeOrBuilder getChangeHistoryOrBuilder(
      int index);
}
