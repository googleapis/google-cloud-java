...
public interface LineItemInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.commerce.consumer.procurement.v1.LineItemInfo)
   ...
   */
  java.util.List<com.google.cloud.commerce.consumer.procurement.v1.Parameter> 
      getParametersList();
  /**
   * <pre>
   * Optional. User-provided parameters.
   ...
   * <code>.google.cloud.commerce.consumer.procurement.v1.Subscription subscription = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.commerce.consumer.procurement.v1.SubscriptionOrBuilder getSubscriptionOrBuilder();
}
