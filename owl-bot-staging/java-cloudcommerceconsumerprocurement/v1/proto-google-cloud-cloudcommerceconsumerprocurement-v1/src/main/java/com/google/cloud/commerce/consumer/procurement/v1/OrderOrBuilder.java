...
public interface OrderOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.commerce.consumer.procurement.v1.LineItem line_items = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.commerce.consumer.procurement.v1.LineItem cancelled_line_items = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.commerce.consumer.procurement.v1.LineItem> 
   ...
   * <code>repeated .google.cloud.commerce.consumer.procurement.v1.LineItem cancelled_line_items = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.commerce.consumer.procurement.v1.LineItemOrBuilder getCancelledLineItemsOrBuilder(
      int index);
