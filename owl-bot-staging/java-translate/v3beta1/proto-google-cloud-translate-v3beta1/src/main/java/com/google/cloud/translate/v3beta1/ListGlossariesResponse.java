...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.translate.v3beta1.ListGlossariesResponse result) {
      if (glossariesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.translate.v3beta1.Glossary m =
                  input.readMessage(
                      com.google.cloud.translate.v3beta1.Glossary.parser(),
                      extensionRegistry);
              if (glossariesBuilder_ == null) {
                ensureGlossariesIsMutable();
                glossaries_.add(m);
