...
public interface ListAdaptiveMtFilesResponseOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.translation.v3.AdaptiveMtFile adaptive_mt_files = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.translate.v3.AdaptiveMtFile> 
   ...
   * <code>repeated .google.cloud.translation.v3.AdaptiveMtFile adaptive_mt_files = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.translate.v3.AdaptiveMtFileOrBuilder getAdaptiveMtFilesOrBuilder(
      int index);
