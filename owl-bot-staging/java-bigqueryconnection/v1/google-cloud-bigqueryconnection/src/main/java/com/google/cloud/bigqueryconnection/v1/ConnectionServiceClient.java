 ...
 *      <ul>
 *           <li><p> createConnection(LocationName parent, Connection connection, String connectionId)
 *           <li><p> createConnection(String parent, Connection connection, String connectionId)
 *      </ul>
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> updateConnection(ConnectionName name, Connection connection, FieldMask updateMask)
 *           <li><p> updateConnection(String name, Connection connection, FieldMask updateMask)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
