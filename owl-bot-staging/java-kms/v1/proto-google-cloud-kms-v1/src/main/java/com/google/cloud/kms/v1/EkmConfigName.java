...
public class EkmConfigName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/ekmConfig");
  ...
  public static EkmConfigName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION.validatedMatch(
            formattedString, "EkmConfigName.parse: formattedString not in valid format");
  ...
  public static List<EkmConfigName> parseList(List<String> formattedStrings) {
    List<EkmConfigName> list = new ArrayList<>(formattedStrings.size());
