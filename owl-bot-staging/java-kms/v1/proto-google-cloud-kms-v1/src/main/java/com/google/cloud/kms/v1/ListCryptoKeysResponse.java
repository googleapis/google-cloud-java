...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getCryptoKeysList()
        .equals(other.getCryptoKeysList())) return false;
    if (!getNextPageToken()
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.kms.v1.ListCryptoKeysResponse result) {
      if (cryptoKeysBuilder_ == null) {
    ...
    private void buildPartial0(com.google.cloud.kms.v1.ListCryptoKeysResponse result) {
