...
public class EkmConnectionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_EKM_CONNECTION =
  ...
  private EkmConnectionName(Builder builder) {
    ...
    ekmConnection = Preconditions.checkNotNull(builder.getEkmConnection());
  }
  ...
  public static EkmConnectionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_EKM_CONNECTION.validatedMatch(
            formattedString, "EkmConnectionName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("ekm_connection"));
  }

  public static List<EkmConnectionName> parseList(List<String> formattedStrings) {
    List<EkmConnectionName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (ekmConnection != null) {
            fieldMapBuilder.put("ekm_connection", ekmConnection);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_EKM_CONNECTION.instantiate(
        "project", project, "location", location, "ekm_connection", ekmConnection);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.ekmConnection, that.ekmConnection);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(ekmConnection);
    return h;
  }
