...
public interface LoadBalancerInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkmanagement.v1beta1.LoadBalancerInfo)
   ...
   * </pre>
   *
   * <code>.google.cloud.networkmanagement.v1beta1.LoadBalancerInfo.LoadBalancerType load_balancer_type = 1;</code>
   ...
   * @deprecated google.cloud.networkmanagement.v1beta1.LoadBalancerInfo.health_check_uri is deprecated.
   *     See google/cloud/networkmanagement/v1beta1/trace.proto;l=656
   * @return The healthCheckUri.
   */
  @java.lang.Deprecated java.lang.String getHealthCheckUri();
  /**
   * <pre>
   * URI of the health check for the load balancer. Deprecated and no longer
   * populated as different load balancer backends might have different health
   ...
   */
  java.util.List<com.google.cloud.networkmanagement.v1beta1.LoadBalancerBackend> 
      getBackendsList();
  /**
   * <pre>
   * Information for the loadbalancer backends.
   ...
   * <code>repeated .google.cloud.networkmanagement.v1beta1.LoadBalancerBackend backends = 3;</code>
   */
  com.google.cloud.networkmanagement.v1beta1.LoadBalancerBackendOrBuilder getBackendsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.networkmanagement.v1beta1.LoadBalancerInfo.BackendType backend_type = 4;</code>
   ...
   */
  com.google.cloud.networkmanagement.v1beta1.LoadBalancerInfo.BackendType getBackendType();
