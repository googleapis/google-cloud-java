...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.networkmanagement.v1.TraceProto.internal_static_google_cloud_networkmanagement_v1_RouteInfo_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.networkmanagement.v1.TraceProto.internal_static_google_cloud_networkmanagement_v1_RouteInfo_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.networkmanagement.v1.RouteInfo.class, com.google.cloud.networkmanagement.v1.RouteInfo.Builder.class);
  }
  ...
  public enum RouteType
    ...
    public static RouteType forNumber(int value) {
      switch (value) {
        ...
        case 4: return PEERING_SUBNET;
        case 5: return PEERING_STATIC;
        case 6: return PEERING_DYNAMIC;
        case 7: return POLICY_BASED;
        default: return null;
      }
    }
  ...
  public enum NextHopType
    ...
    public static NextHopType forNumber(int value) {
      switch (value) {
        ...
        case 12: return NEXT_HOP_NCC_HUB;
        default: return null;
      }
    }
  ...
  public enum RouteScope
    ...
    public static RouteScope forNumber(int value) {
      switch (value) {
        case 0: return ROUTE_SCOPE_UNSPECIFIED;
        case 1: return NETWORK;
        case 2: return NCC_HUB;
        default: return null;
      }
    }

    public static com.google.protobuf.Internal.EnumLiteMap<RouteScope>
        internalGetValueMap() {
      return internalValueMap;
    }
    private static final com.google.protobuf.Internal.EnumLiteMap<
        RouteScope> internalValueMap =
    ...
    public static RouteScope valueOf(
        com.google.protobuf.Descriptors.EnumValueDescriptor desc) {
      if (desc.getType() != getDescriptor()) {
        throw new java.lang.IllegalArgumentException(
          "EnumValueDescriptor is not for this type.");
   ...
   */
  @java.lang.Override public com.google.cloud.networkmanagement.v1.RouteInfo.RouteType getRouteType() {
    com.google.cloud.networkmanagement.v1.RouteInfo.RouteType result = com.google.cloud.networkmanagement.v1.RouteInfo.RouteType.forNumber(routeType_);
    return result == null ? com.google.cloud.networkmanagement.v1.RouteInfo.RouteType.UNRECOGNIZED : result;
  }
   ...
   */
  @java.lang.Override public int getNextHopTypeValue() {
    return nextHopType_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override public com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType getNextHopType() {
    com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType result = com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType.forNumber(nextHopType_);
    return result == null ? com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType.UNRECOGNIZED : result;
  }
   ...
   */
  @java.lang.Override public int getRouteScopeValue() {
    return routeScope_;
  }
  /**
   * <pre>
   ...
   */
  @java.lang.Override public com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope getRouteScope() {
    com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope result = com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope.forNumber(routeScope_);
    return result == null ? com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope.UNRECOGNIZED : result;
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (routeType_ != com.google.cloud.networkmanagement.v1.RouteInfo.RouteType.ROUTE_TYPE_UNSPECIFIED.getNumber()) {
      output.writeEnum(8, routeType_);
    }
    if (nextHopType_ != com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType.NEXT_HOP_TYPE_UNSPECIFIED.getNumber()) {
    ...
    if (routeScope_ != com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope.ROUTE_SCOPE_UNSPECIFIED.getNumber()) {
  ...
  public int getSerializedSize() {
    ...
    if (routeType_ != com.google.cloud.networkmanagement.v1.RouteInfo.RouteType.ROUTE_TYPE_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(8, routeType_);
    }
    if (nextHopType_ != com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType.NEXT_HOP_TYPE_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(9, nextHopType_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(srcIpRange_)) {
    ...
    if (routeScope_ != com.google.cloud.networkmanagement.v1.RouteInfo.RouteScope.ROUTE_SCOPE_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(14, routeScope_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.networkmanagement.v1.RouteInfo other = (com.google.cloud.networkmanagement.v1.RouteInfo) obj;
    ...
    if (!getDestIpRange()
        .equals(other.getDestIpRange())) return false;
    if (!getNextHop()
    ...
    if (!getInstanceTagsList()
        .equals(other.getInstanceTagsList())) return false;
    if (!getSrcIpRange()
        .equals(other.getSrcIpRange())) return false;
    if (!getDestPortRangesList()
        .equals(other.getDestPortRangesList())) return false;
    if (!getSrcPortRangesList()
        .equals(other.getSrcPortRangesList())) return false;
    if (!getProtocolsList()
        .equals(other.getProtocolsList())) return false;
    if (hasNccHubUri() != other.hasNccHubUri()) return false;
    if (hasNccHubUri()) {
      if (!getNccHubUri()
          .equals(other.getNccHubUri())) return false;
    }
    if (hasNccSpokeUri() != other.hasNccSpokeUri()) return false;
    if (hasNccSpokeUri()) {
      if (!getNccSpokeUri()
          .equals(other.getNccSpokeUri())) return false;
    }
  ...
  public static com.google.cloud.networkmanagement.v1.RouteInfo parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.networkmanagement.v1.RouteInfo buildPartial() {
      com.google.cloud.networkmanagement.v1.RouteInfo result = new com.google.cloud.networkmanagement.v1.RouteInfo(this);
    ...
    public Builder mergeFrom(com.google.cloud.networkmanagement.v1.RouteInfo other) {
      if (other == com.google.cloud.networkmanagement.v1.RouteInfo.getDefaultInstance()) return this;
     ...
     * @return This builder for chaining.
     */
    public Builder setNextHopType(com.google.cloud.networkmanagement.v1.RouteInfo.NextHopType value) {
      if (value == null) {
        throw new NullPointerException();
      }
      bitField0_ |= 0x00000002;
     ...
     * @return This builder for chaining.
     */
    public Builder setDestIpRangeBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      destIpRange_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setInstanceTags(
     ...
     * @return This builder for chaining.
     */
    public Builder addInstanceTags(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureInstanceTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllInstanceTags(
        java.lang.Iterable<java.lang.String> values) {
      ensureInstanceTagsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, instanceTags_);
      bitField0_ |= 0x00000200;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addInstanceTagsBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureInstanceTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder setDestPortRanges(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureDestPortRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addDestPortRanges(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureDestPortRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllDestPortRanges(
        java.lang.Iterable<java.lang.String> values) {
      ensureDestPortRangesIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, destPortRanges_);
      bitField0_ |= 0x00000800;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addDestPortRangesBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureDestPortRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder setSrcPortRanges(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureSrcPortRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addSrcPortRanges(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureSrcPortRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllSrcPortRanges(
        java.lang.Iterable<java.lang.String> values) {
      ensureSrcPortRangesIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, srcPortRanges_);
      bitField0_ |= 0x00001000;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addSrcPortRangesBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureSrcPortRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder setNccHubUriBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      nccHubUri_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setNccSpokeUriBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      nccSpokeUri_ = value;
