      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            payload_ =
                input.readMessage(com.google.cloud.automl.v1.TextSnippet.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 34: {
            ...
            payload_ =
                input.readMessage(com.google.cloud.automl.v1.Document.parser(), extensionRegistry);
            if (subBuilder != null) {
