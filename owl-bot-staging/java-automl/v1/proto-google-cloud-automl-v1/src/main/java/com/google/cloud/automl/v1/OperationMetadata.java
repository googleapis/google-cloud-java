      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              input.readMessage(
                  getCreateModelDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 10;
              break;
            } // case 82
            ...
            case 122: {
              input.readMessage(
                  getImportDataDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 15;
              break;
            } // case 122
            case 130: {
              input.readMessage(
                  getBatchPredictDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 16;
              break;
            } // case 130
            case 170: {
              input.readMessage(
                  getExportDataDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 21;
              break;
            } // case 170
            case 178: {
              input.readMessage(
                  getExportModelDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 22;
              break;
            } // case 178
            case 194: {
              input.readMessage(
                  getDeployModelDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 24;
              break;
            } // case 194
            case 202: {
              input.readMessage(
                  getUndeployModelDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 25;
              break;
            } // case 202
            case 242: {
              input.readMessage(
                  getCreateDatasetDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 30;
              break;
            } // case 242
