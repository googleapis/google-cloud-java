        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              modelEvaluation_ = new java.util.ArrayList<com.google.cloud.automl.v1beta1.ModelEvaluation>();
              mutable_bitField0_ |= 0x00000001;
            }
            modelEvaluation_.add(
                input.readMessage(com.google.cloud.automl.v1beta1.ModelEvaluation.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.automl.v1beta1.ListModelEvaluationsResponse) e.getUnfinishedMessage();
