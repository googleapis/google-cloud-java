...
java.lang.String defaultValue);
   ...
   */
  java.util.List<com.google.cloud.lifesciences.v2beta.Disk> 
      getDisksList();
  /**
   * <pre>
   * The list of disks to create and attach to the VM.
   ...
   */
  java.util.List<com.google.cloud.lifesciences.v2beta.Accelerator> 
      getAcceleratorsList();
  /**
   * <pre>
   * The list of accelerators to attach to the VM.
   ...
   *     See google/cloud/lifesciences/v2beta/workflows.proto;l=411
   ...
   */
  java.util.List<com.google.cloud.lifesciences.v2beta.Volume> 
      getVolumesList();
  /**
   * <pre>
   * The list of disks and other storage to create or attach to the VM.
