      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            if (trackInfoCase_ == 3) {
              subBuilder = ((com.google.cloud.videointelligence.v1p2beta1.VideoSegment) trackInfo_).toBuilder();
            }
            trackInfo_ =
                input.readMessage(com.google.cloud.videointelligence.v1p2beta1.VideoSegment.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.videointelligence.v1p2beta1.VideoSegment) trackInfo_);
