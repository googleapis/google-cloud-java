...
public final class StreamingVideoIntelligenceServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.videointelligence.v1p3beta1.StreamingVideoIntelligenceService";
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default io.grpc.stub.StreamObserver<com.google.cloud.videointelligence.v1p3beta1.StreamingAnnotateVideoRequest> streamingAnnotateVideo(
   ...
   * </pre>
   */
  public static abstract class StreamingVideoIntelligenceServiceImplBase
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service StreamingVideoIntelligenceService.
   * <pre>
   * Service that implements streaming Video Intelligence API.
   * </pre>
   */
