...
public interface TextSegmentOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.videointelligence.v1p3beta1.TextFrame> 
      getFramesList();
  /**
   * <pre>
   * Information related to the frames where OCR detected text appears.
   ...
   * <code>repeated .google.cloud.videointelligence.v1p3beta1.TextFrame frames = 3;</code>
   */
  com.google.cloud.videointelligence.v1p3beta1.TextFrameOrBuilder getFramesOrBuilder(
      int index);
}
