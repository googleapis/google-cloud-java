...
public interface LabelAnnotationOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.videointelligence.v1p3beta1.Entity> 
   ...
   */
  java.util.List<com.google.cloud.videointelligence.v1p3beta1.LabelSegment> 
      getSegmentsList();
  /**
   * <pre>
   * All video segments where a label was detected.
   ...
   */
  java.util.List<com.google.cloud.videointelligence.v1p3beta1.LabelFrame> 
      getFramesList();
  /**
   * <pre>
   * All video frames where a label was detected.
   ...
   * <code>repeated .google.cloud.videointelligence.v1p3beta1.LabelFrame frames = 4;</code>
   */
  com.google.cloud.videointelligence.v1p3beta1.LabelFrameOrBuilder getFramesOrBuilder(
      int index);
}
