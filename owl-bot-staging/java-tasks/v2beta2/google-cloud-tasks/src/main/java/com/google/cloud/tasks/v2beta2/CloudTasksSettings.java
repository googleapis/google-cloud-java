...
public class CloudTasksSettings extends ClientSettings<CloudTasksSettings> {
  ...
  public UnaryCallSettings<LeaseTasksRequest, LeaseTasksResponse> leaseTasksSettings() {
    return ((CloudTasksStubSettings) getStubSettings()).leaseTasksSettings();
  }
  ...
  public UnaryCallSettings<AcknowledgeTaskRequest, Empty> acknowledgeTaskSettings() {
    return ((CloudTasksStubSettings) getStubSettings()).acknowledgeTaskSettings();
  }
  ...
  public UnaryCallSettings<RenewLeaseRequest, Task> renewLeaseSettings() {
    return ((CloudTasksStubSettings) getStubSettings()).renewLeaseSettings();
  }
  ...
  public UnaryCallSettings<CancelLeaseRequest, Task> cancelLeaseSettings() {
    return ((CloudTasksStubSettings) getStubSettings()).cancelLeaseSettings();
  }
  ...
  public static class Builder extends ClientSettings.Builder<CloudTasksSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<LeaseTasksRequest, LeaseTasksResponse> leaseTasksSettings() {
      return getStubSettingsBuilder().leaseTasksSettings();
    }
    ...
    public UnaryCallSettings.Builder<AcknowledgeTaskRequest, Empty> acknowledgeTaskSettings() {
      return getStubSettingsBuilder().acknowledgeTaskSettings();
    }
    ...
    public UnaryCallSettings.Builder<CancelLeaseRequest, Task> cancelLeaseSettings() {
      return getStubSettingsBuilder().cancelLeaseSettings();
    }
