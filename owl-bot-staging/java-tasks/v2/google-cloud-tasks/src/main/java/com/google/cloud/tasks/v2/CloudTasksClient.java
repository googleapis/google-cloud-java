 ...
 *  [PAUSED][google.cloud.tasks.v2.Queue.State.PAUSED].</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>GetIamPolicy</td>
 *      <td><p>Gets the access control policy for a [Queue][google.cloud.tasks.v2.Queue].
 ...
 *    <tr>
 *      <td>SetIamPolicy</td>
 *      <td><p>Sets the access control policy for a [Queue][google.cloud.tasks.v2.Queue].
