...
public interface ListTasksResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.tasks.v2.Task> 
      getTasksList();
  /**
   * <pre>
   * The list of tasks.
   ...
   * <code>repeated .google.cloud.tasks.v2.Task tasks = 1;</code>
   */
  java.util.List<? extends com.google.cloud.tasks.v2.TaskOrBuilder> 
   ...
   * <code>repeated .google.cloud.tasks.v2.Task tasks = 1;</code>
   */
  com.google.cloud.tasks.v2.TaskOrBuilder getTasksOrBuilder(
      int index);
