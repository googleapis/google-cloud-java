...
public final class PipelineServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.contentwarehouse.v1.PipelineService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.contentwarehouse.v1.RunPipelineRequest,
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.contentwarehouse.v1.RunPipelineRequest,
      com.google.longrunning.Operation> getRunPipelineMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.contentwarehouse.v1.RunPipelineRequest, com.google.longrunning.Operation> getRunPipelineMethod;
    if ((getRunPipelineMethod = PipelineServiceGrpc.getRunPipelineMethod) == null) {
      synchronized (PipelineServiceGrpc.class) {
        if ((getRunPipelineMethod = PipelineServiceGrpc.getRunPipelineMethod) == null) {
          PipelineServiceGrpc.getRunPipelineMethod = getRunPipelineMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.contentwarehouse.v1.RunPipelineRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RunPipeline"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.contentwarehouse.v1.RunPipelineRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new PipelineServiceMethodDescriptorSupplier("RunPipeline"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void runPipeline(com.google.cloud.contentwarehouse.v1.RunPipelineRequest request,
  ...
  public static final class PipelineServiceStub
     ...
     * </pre>
     */
    public void runPipeline(com.google.cloud.contentwarehouse.v1.RunPipelineRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
  ...
  public static final class PipelineServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.longrunning.Operation runPipeline(com.google.cloud.contentwarehouse.v1.RunPipelineRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RUN_PIPELINE:
          serviceImpl.runPipeline((com.google.cloud.contentwarehouse.v1.RunPipelineRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
