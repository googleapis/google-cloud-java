 ...
 */
public final class CustomWeightsMetadata extends
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.contentwarehouse.v1.FiltersProto.internal_static_google_cloud_contentwarehouse_v1_CustomWeightsMetadata_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.contentwarehouse.v1.FiltersProto.internal_static_google_cloud_contentwarehouse_v1_CustomWeightsMetadata_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata.class, com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata.Builder.class);
  }

  public static final int WEIGHTED_SCHEMA_PROPERTIES_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty> weightedSchemaProperties_;
  /**
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty> getWeightedSchemaPropertiesList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.cloud.contentwarehouse.v1.WeightedSchemaPropertyOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty getWeightedSchemaProperties(int index) {
   ...
   */
  @java.lang.Override
  public com.google.cloud.contentwarehouse.v1.WeightedSchemaPropertyOrBuilder getWeightedSchemaPropertiesOrBuilder(
      int index) {
    return weightedSchemaProperties_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < weightedSchemaProperties_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, weightedSchemaProperties_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata other = (com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata) obj;

    if (!getWeightedSchemaPropertiesList()
        .equals(other.getWeightedSchemaPropertiesList())) return false;
  ...
  public static com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata prototype) {
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata buildPartial() {
      com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata result = new com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata(this);
    ...
    private void buildPartialRepeatedFields(com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata result) {
      if (weightedSchemaPropertiesBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)) {
          weightedSchemaProperties_ = java.util.Collections.unmodifiableList(weightedSchemaProperties_);
          bitField0_ = (bitField0_ & ~0x00000001);
        }
    ...
    public Builder mergeFrom(com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata other) {
      if (other == com.google.cloud.contentwarehouse.v1.CustomWeightsMetadata.getDefaultInstance()) return this;
      if (weightedSchemaPropertiesBuilder_ == null) {
          ...
          if (weightedSchemaPropertiesBuilder_.isEmpty()) {
            ...
            weightedSchemaPropertiesBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getWeightedSchemaPropertiesFieldBuilder() : null;
          } else {
    ...
    private void ensureWeightedSchemaPropertiesIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        weightedSchemaProperties_ = new java.util.ArrayList<com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty>(weightedSchemaProperties_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty, com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder, com.google.cloud.contentwarehouse.v1.WeightedSchemaPropertyOrBuilder> weightedSchemaPropertiesBuilder_;
     ...
     */
    public Builder setWeightedSchemaProperties(
        int index, com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder builderForValue) {
      if (weightedSchemaPropertiesBuilder_ == null) {
        ensureWeightedSchemaPropertiesIsMutable();
     ...
     * <code>repeated .google.cloud.contentwarehouse.v1.WeightedSchemaProperty weighted_schema_properties = 1;</code>
     */
    public Builder addWeightedSchemaProperties(com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty value) {
      if (weightedSchemaPropertiesBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllWeightedSchemaProperties(
        java.lang.Iterable<? extends com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty> values) {
      if (weightedSchemaPropertiesBuilder_ == null) {
        ensureWeightedSchemaPropertiesIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, weightedSchemaProperties_);
        onChanged();
      } else {
     ...
     * <code>repeated .google.cloud.contentwarehouse.v1.WeightedSchemaProperty weighted_schema_properties = 1;</code>
     */
    public com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder getWeightedSchemaPropertiesBuilder(
        int index) {
    ...
    public com.google.cloud.contentwarehouse.v1.WeightedSchemaPropertyOrBuilder getWeightedSchemaPropertiesOrBuilder(
        int index) {
      if (weightedSchemaPropertiesBuilder_ == null) {
        return weightedSchemaProperties_.get(index);  } else {
     ...
     * <code>repeated .google.cloud.contentwarehouse.v1.WeightedSchemaProperty weighted_schema_properties = 1;</code>
     */
    public com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder addWeightedSchemaPropertiesBuilder() {
      return getWeightedSchemaPropertiesFieldBuilder().addBuilder(
    ...
    public com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder addWeightedSchemaPropertiesBuilder(
        int index) {
      return getWeightedSchemaPropertiesFieldBuilder().addBuilder(
          index, com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.getDefaultInstance());
    }
    /**
     * <pre>
     * List of schema and property name. Allows a maximum of 10 schemas to be
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty, com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder, com.google.cloud.contentwarehouse.v1.WeightedSchemaPropertyOrBuilder> 
        getWeightedSchemaPropertiesFieldBuilder() {
      if (weightedSchemaPropertiesBuilder_ == null) {
        weightedSchemaPropertiesBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty, com.google.cloud.contentwarehouse.v1.WeightedSchemaProperty.Builder, com.google.cloud.contentwarehouse.v1.WeightedSchemaPropertyOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<CustomWeightsMetadata>
      PARSER = new com.google.protobuf.AbstractParser<CustomWeightsMetadata>() {
    @java.lang.Override
