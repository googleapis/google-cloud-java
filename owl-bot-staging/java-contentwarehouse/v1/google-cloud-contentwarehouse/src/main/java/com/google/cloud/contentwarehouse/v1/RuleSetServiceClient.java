 ...
 *    <tr>
 *      <td>GetRuleSet</td>
 *      <td><p>Gets a ruleset. Returns NOT_FOUND if the ruleset does not exist.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>UpdateRuleSet</td>
 *      <td><p>Updates a ruleset. Returns INVALID_ARGUMENT if the name of the ruleset
 ...
 *    <tr>
 *      <td>DeleteRuleSet</td>
 *      <td><p>Deletes a ruleset. Returns NOT_FOUND if the document does not exist.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
