...
public interface ListActiveDirectoriesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.netapp.v1.ListActiveDirectoriesResponse)
   ...
   */
  java.util.List<com.google.cloud.netapp.v1.ActiveDirectory> 
      getActiveDirectoriesList();
  /**
   * <pre>
   * The list of active directories.
   * </pre>
   ...
   * <code>repeated .google.cloud.netapp.v1.ActiveDirectory active_directories = 1;</code>
   */
  com.google.cloud.netapp.v1.ActiveDirectoryOrBuilder getActiveDirectoriesOrBuilder(
      int index);
