...
public interface UpdateActiveDirectoryRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.netapp.v1.UpdateActiveDirectoryRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.netapp.v1.ActiveDirectory active_directory = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.netapp.v1.ActiveDirectory active_directory = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.netapp.v1.ActiveDirectoryOrBuilder getActiveDirectoryOrBuilder();
}
