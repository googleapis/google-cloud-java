...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.datalabeling.v1beta1.ListDatasetsResponse result) {
      if (datasetsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.datalabeling.v1beta1.Dataset m =
                  input.readMessage(
                      com.google.cloud.datalabeling.v1beta1.Dataset.parser(),
                      extensionRegistry);
              if (datasetsBuilder_ == null) {
                ensureDatasetsIsMutable();
                datasets_.add(m);
