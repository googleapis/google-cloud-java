...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.cloud.datalabeling.v1beta1.EvaluationMetrics result) {
      result.metricsCase_ = metricsCase_;
      result.metrics_ = this.metrics_;
      if (metricsCase_ == 1 &&
          classificationMetricsBuilder_ != null) {
        result.metrics_ = classificationMetricsBuilder_.build();
      }
      if (metricsCase_ == 2 &&
          objectDetectionMetricsBuilder_ != null) {
