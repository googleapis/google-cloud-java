...
public interface EvaluationJobOrBuilder extends
   ...
   * <code>.google.cloud.datalabeling.v1beta1.EvaluationJobConfig evaluation_job_config = 6;</code>
   */
  com.google.cloud.datalabeling.v1beta1.EvaluationJobConfigOrBuilder getEvaluationJobConfigOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.datalabeling.v1beta1.Attempt> 
      getAttemptsList();
  /**
   * <pre>
   * Output only. Every time the evaluation job runs and an error occurs, the
