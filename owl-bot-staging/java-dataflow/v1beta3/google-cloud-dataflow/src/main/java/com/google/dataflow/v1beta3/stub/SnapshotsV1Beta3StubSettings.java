...
/**
 * Settings class to configure an instance of {@link SnapshotsV1Beta3Stub}.
 *
...
public class SnapshotsV1Beta3StubSettings extends StubSettings<SnapshotsV1Beta3StubSettings> {
  ...
  private final UnaryCallSettings<DeleteSnapshotRequest, DeleteSnapshotResponse>
      deleteSnapshotSettings;
  private final UnaryCallSettings<ListSnapshotsRequest, ListSnapshotsResponse>
  ...
  public SnapshotsV1Beta3Stub createStub() throws IOException {
    ...
    if (getTransportChannelProvider()
      ...
      return HttpJsonSnapshotsV1Beta3Stub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(SnapshotsV1Beta3StubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return SnapshotsV1Beta3StubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  public static class Builder extends StubSettings.Builder<SnapshotsV1Beta3StubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetSnapshotRequest, Snapshot> getSnapshotSettings;
    private final UnaryCallSettings.Builder<DeleteSnapshotRequest, DeleteSnapshotResponse>
        deleteSnapshotSettings;
    private final UnaryCallSettings.Builder<ListSnapshotsRequest, ListSnapshotsResponse>
        listSnapshotsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      listSnapshotsSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getSnapshotSettings, deleteSnapshotSettings, listSnapshotsSettings);
      initDefaults(this);
    }
