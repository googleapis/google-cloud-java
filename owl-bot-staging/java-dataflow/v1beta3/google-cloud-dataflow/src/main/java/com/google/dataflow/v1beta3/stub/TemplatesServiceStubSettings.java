...
/**
 * Settings class to configure an instance of {@link TemplatesServiceStub}.
 *
...
public class TemplatesServiceStubSettings extends StubSettings<TemplatesServiceStubSettings> {
  ...
  private final UnaryCallSettings<LaunchTemplateRequest, LaunchTemplateResponse>
  ...
  public UnaryCallSettings<CreateJobFromTemplateRequest, Job> createJobFromTemplateSettings() {
    return createJobFromTemplateSettings;
  }
  ...
  public TemplatesServiceStub createStub() throws IOException {
    ...
    if (getTransportChannelProvider()
      ...
      return HttpJsonTemplatesServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(TemplatesServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return TemplatesServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected TemplatesServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    createJobFromTemplateSettings = settingsBuilder.createJobFromTemplateSettings().build();
    launchTemplateSettings = settingsBuilder.launchTemplateSettings().build();
    getTemplateSettings = settingsBuilder.getTemplateSettings().build();
  }

  /** Builder for TemplatesServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<TemplatesServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<CreateJobFromTemplateRequest, Job>
        createJobFromTemplateSettings;
    private final UnaryCallSettings.Builder<LaunchTemplateRequest, LaunchTemplateResponse>
        launchTemplateSettings;
    private final UnaryCallSettings.Builder<GetTemplateRequest, GetTemplateResponse>
        getTemplateSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      createJobFromTemplateSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      launchTemplateSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      getTemplateSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              createJobFromTemplateSettings, launchTemplateSettings, getTemplateSettings);
      initDefaults(this);
    }
    ...
    protected Builder(TemplatesServiceStubSettings settings) {
      ...
      createJobFromTemplateSettings = settings.createJobFromTemplateSettings.toBuilder();
      launchTemplateSettings = settings.launchTemplateSettings.toBuilder();
