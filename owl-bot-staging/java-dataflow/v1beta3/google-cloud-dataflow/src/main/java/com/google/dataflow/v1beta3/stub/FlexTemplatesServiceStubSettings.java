...
/**
 * Settings class to configure an instance of {@link FlexTemplatesServiceStub}.
 *
...
public class FlexTemplatesServiceStubSettings
  ...
  protected FlexTemplatesServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<FlexTemplatesServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<LaunchFlexTemplateRequest, LaunchFlexTemplateResponse>
        launchFlexTemplateSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      launchFlexTemplateSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(launchFlexTemplateSettings);
      initDefaults(this);
    }

    protected Builder(FlexTemplatesServiceStubSettings settings) {
      super(settings);

      launchFlexTemplateSettings = settings.launchFlexTemplateSettings.toBuilder();
    ...
    @Override
    public FlexTemplatesServiceStubSettings build() throws IOException {
      return new FlexTemplatesServiceStubSettings(this);
    }
  }
}
