...
public interface TopologyConfigOrBuilder extends
   ...
   */
  java.util.List<com.google.dataflow.v1beta3.ComputationTopology> 
      getComputationsList();
  /**
   * <pre>
   * The computations associated with a streaming Dataflow job.
   ...
   * <code>repeated .google.dataflow.v1beta3.ComputationTopology computations = 1;</code>
   */
  com.google.dataflow.v1beta3.ComputationTopologyOrBuilder getComputationsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.dataflow.v1beta3.DataDiskAssignment> 
   ...
   * <code>map&lt;string, string&gt; user_stage_to_computation_name_map = 3;</code>
   */
  boolean containsUserStageToComputationNameMap(
