 ...
 */
public final class StreamLocation extends
...
private static final long serialVersionUID = 0L;
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.dataflow.v1beta3.StreamingProto.internal_static_google_dataflow_v1beta3_StreamLocation_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.dataflow.v1beta3.StreamLocation.class, com.google.dataflow.v1beta3.StreamLocation.Builder.class);
  }
  ...
  public enum LocationCase
    ...
    public static LocationCase forNumber(int value) {
      switch (value) {
        case 1: return STREAMING_STAGE_LOCATION;
        case 2: return PUBSUB_LOCATION;
        case 3: return SIDE_INPUT_LOCATION;
        case 4: return CUSTOM_SOURCE_LOCATION;
   ...
   */
  @java.lang.Override
  public com.google.dataflow.v1beta3.StreamingStageLocationOrBuilder getStreamingStageLocationOrBuilder() {
    if (locationCase_ == 1) {
       return (com.google.dataflow.v1beta3.StreamingStageLocation) location_;
    }
    return com.google.dataflow.v1beta3.StreamingStageLocation.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.google.dataflow.v1beta3.StreamingSideInputLocationOrBuilder getSideInputLocationOrBuilder() {
    if (locationCase_ == 3) {
       return (com.google.dataflow.v1beta3.StreamingSideInputLocation) location_;
    }
    return com.google.dataflow.v1beta3.StreamingSideInputLocation.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.google.dataflow.v1beta3.CustomSourceLocationOrBuilder getCustomSourceLocationOrBuilder() {
    if (locationCase_ == 4) {
       return (com.google.dataflow.v1beta3.CustomSourceLocation) location_;
    }
    return com.google.dataflow.v1beta3.CustomSourceLocation.getDefaultInstance();
  ...
  public int getSerializedSize() {
    ...
    if (locationCase_ == 1) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, (com.google.dataflow.v1beta3.StreamingStageLocation) location_);
    }
    if (locationCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (com.google.dataflow.v1beta3.PubsubLocation) location_);
    }
    if (locationCase_ == 3) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, (com.google.dataflow.v1beta3.StreamingSideInputLocation) location_);
    }
    if (locationCase_ == 4) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.dataflow.v1beta3.StreamLocation other = (com.google.dataflow.v1beta3.StreamLocation) obj;

    if (!getLocationCase().equals(other.getLocationCase())) return false;
    switch (locationCase_) {
      case 1:
        if (!getStreamingStageLocation()
            .equals(other.getStreamingStageLocation())) return false;
        break;
      case 2:
        if (!getPubsubLocation()
            .equals(other.getPubsubLocation())) return false;
        break;
      case 3:
        if (!getSideInputLocation()
            .equals(other.getSideInputLocation())) return false;
        break;
      case 4:
        if (!getCustomSourceLocation()
            .equals(other.getCustomSourceLocation())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static com.google.dataflow.v1beta3.StreamLocation parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
     ...
     * <code>.google.dataflow.v1beta3.StreamingStageLocation streaming_stage_location = 1;</code>
     */
    public Builder setStreamingStageLocation(com.google.dataflow.v1beta3.StreamingStageLocation value) {
      if (streamingStageLocationBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.google.dataflow.v1beta3.StreamingStageLocation streaming_stage_location = 1;</code>
     */
    public Builder mergeStreamingStageLocation(com.google.dataflow.v1beta3.StreamingStageLocation value) {
      if (streamingStageLocationBuilder_ == null) {
        if (locationCase_ == 1 &&
            location_ != com.google.dataflow.v1beta3.StreamingStageLocation.getDefaultInstance()) {
          location_ = com.google.dataflow.v1beta3.StreamingStageLocation.newBuilder((com.google.dataflow.v1beta3.StreamingStageLocation) location_)
     ...
     * <code>.google.dataflow.v1beta3.StreamingStageLocation streaming_stage_location = 1;</code>
     */
    public com.google.dataflow.v1beta3.StreamingStageLocation.Builder getStreamingStageLocationBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.StreamingStageLocation, com.google.dataflow.v1beta3.StreamingStageLocation.Builder, com.google.dataflow.v1beta3.StreamingStageLocationOrBuilder> 
        getStreamingStageLocationFieldBuilder() {
      if (streamingStageLocationBuilder_ == null) {
        if (!(locationCase_ == 1)) {
          location_ = com.google.dataflow.v1beta3.StreamingStageLocation.getDefaultInstance();
        }
        streamingStageLocationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.dataflow.v1beta3.StreamingStageLocation, com.google.dataflow.v1beta3.StreamingStageLocation.Builder, com.google.dataflow.v1beta3.StreamingStageLocationOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.PubsubLocation, com.google.dataflow.v1beta3.PubsubLocation.Builder, com.google.dataflow.v1beta3.PubsubLocationOrBuilder> pubsubLocationBuilder_;
    /**
     * <pre>
     * The stream is a pubsub stream.
     * </pre>
    ...
    public Builder mergePubsubLocation(com.google.dataflow.v1beta3.PubsubLocation value) {
      if (pubsubLocationBuilder_ == null) {
        if (locationCase_ == 2 &&
          ...
          location_ = com.google.dataflow.v1beta3.PubsubLocation.newBuilder((com.google.dataflow.v1beta3.PubsubLocation) location_)
              .mergeFrom(value).buildPartial();
        } else {
          location_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.PubsubLocation, com.google.dataflow.v1beta3.PubsubLocation.Builder, com.google.dataflow.v1beta3.PubsubLocationOrBuilder> 
        getPubsubLocationFieldBuilder() {
      if (pubsubLocationBuilder_ == null) {
        if (!(locationCase_ == 2)) {
          location_ = com.google.dataflow.v1beta3.PubsubLocation.getDefaultInstance();
        }
        pubsubLocationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.dataflow.v1beta3.PubsubLocation, com.google.dataflow.v1beta3.PubsubLocation.Builder, com.google.dataflow.v1beta3.PubsubLocationOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.StreamingSideInputLocation, com.google.dataflow.v1beta3.StreamingSideInputLocation.Builder, com.google.dataflow.v1beta3.StreamingSideInputLocationOrBuilder> sideInputLocationBuilder_;
    /**
     * <pre>
     * The stream is a streaming side input.
     * </pre>
     ...
     * <code>.google.dataflow.v1beta3.StreamingSideInputLocation side_input_location = 3;</code>
     */
    public Builder setSideInputLocation(com.google.dataflow.v1beta3.StreamingSideInputLocation value) {
      if (sideInputLocationBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.dataflow.v1beta3.StreamingSideInputLocation side_input_location = 3;</code>
     */
    public Builder mergeSideInputLocation(com.google.dataflow.v1beta3.StreamingSideInputLocation value) {
      if (sideInputLocationBuilder_ == null) {
        if (locationCase_ == 3 &&
            location_ != com.google.dataflow.v1beta3.StreamingSideInputLocation.getDefaultInstance()) {
          location_ = com.google.dataflow.v1beta3.StreamingSideInputLocation.newBuilder((com.google.dataflow.v1beta3.StreamingSideInputLocation) location_)
              .mergeFrom(value).buildPartial();
        } else {
          location_ = value;
        }
     ...
     * <code>.google.dataflow.v1beta3.StreamingSideInputLocation side_input_location = 3;</code>
     */
    public com.google.dataflow.v1beta3.StreamingSideInputLocation.Builder getSideInputLocationBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.StreamingSideInputLocation, com.google.dataflow.v1beta3.StreamingSideInputLocation.Builder, com.google.dataflow.v1beta3.StreamingSideInputLocationOrBuilder> 
        getSideInputLocationFieldBuilder() {
      if (sideInputLocationBuilder_ == null) {
        if (!(locationCase_ == 3)) {
          location_ = com.google.dataflow.v1beta3.StreamingSideInputLocation.getDefaultInstance();
        }
        sideInputLocationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.dataflow.v1beta3.StreamingSideInputLocation, com.google.dataflow.v1beta3.StreamingSideInputLocation.Builder, com.google.dataflow.v1beta3.StreamingSideInputLocationOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.CustomSourceLocation, com.google.dataflow.v1beta3.CustomSourceLocation.Builder, com.google.dataflow.v1beta3.CustomSourceLocationOrBuilder> customSourceLocationBuilder_;
    /**
     * <pre>
     * The stream is a custom source.
     * </pre>
     ...
     * <code>.google.dataflow.v1beta3.CustomSourceLocation custom_source_location = 4;</code>
     */
    public Builder mergeCustomSourceLocation(com.google.dataflow.v1beta3.CustomSourceLocation value) {
      if (customSourceLocationBuilder_ == null) {
        if (locationCase_ == 4 &&
            location_ != com.google.dataflow.v1beta3.CustomSourceLocation.getDefaultInstance()) {
          location_ = com.google.dataflow.v1beta3.CustomSourceLocation.newBuilder((com.google.dataflow.v1beta3.CustomSourceLocation) location_)
              .mergeFrom(value).buildPartial();
        } else {
          location_ = value;
        }
     ...
     * <code>.google.dataflow.v1beta3.CustomSourceLocation custom_source_location = 4;</code>
     */
    public com.google.dataflow.v1beta3.CustomSourceLocation.Builder getCustomSourceLocationBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.dataflow.v1beta3.CustomSourceLocation, com.google.dataflow.v1beta3.CustomSourceLocation.Builder, com.google.dataflow.v1beta3.CustomSourceLocationOrBuilder> 
        getCustomSourceLocationFieldBuilder() {
      if (customSourceLocationBuilder_ == null) {
        if (!(locationCase_ == 4)) {
          location_ = com.google.dataflow.v1beta3.CustomSourceLocation.getDefaultInstance();
        }
        customSourceLocationBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.dataflow.v1beta3.CustomSourceLocation, com.google.dataflow.v1beta3.CustomSourceLocation.Builder, com.google.dataflow.v1beta3.CustomSourceLocationOrBuilder>(
