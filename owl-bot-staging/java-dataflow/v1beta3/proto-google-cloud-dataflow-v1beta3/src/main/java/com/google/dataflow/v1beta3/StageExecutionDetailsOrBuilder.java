...
public interface StageExecutionDetailsOrBuilder extends
   ...
   */
  java.util.List<com.google.dataflow.v1beta3.WorkerDetails> 
      getWorkersList();
  /**
   * <pre>
   * Workers that have done work on the stage.
   ...
   * <code>repeated .google.dataflow.v1beta3.WorkerDetails workers = 1;</code>
   */
  com.google.dataflow.v1beta3.WorkerDetailsOrBuilder getWorkersOrBuilder(
      int index);
