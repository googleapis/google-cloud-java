...
public final class QuotaServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.shopping.merchant.quota.v1beta.QuotaService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest,
      com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse> getListQuotaGroupsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest,
      com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse> getListQuotaGroupsMethod() {
    io.grpc.MethodDescriptor<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest, com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse> getListQuotaGroupsMethod;
    if ((getListQuotaGroupsMethod = QuotaServiceGrpc.getListQuotaGroupsMethod) == null) {
      synchronized (QuotaServiceGrpc.class) {
        if ((getListQuotaGroupsMethod = QuotaServiceGrpc.getListQuotaGroupsMethod) == null) {
          QuotaServiceGrpc.getListQuotaGroupsMethod = getListQuotaGroupsMethod =
              io.grpc.MethodDescriptor.<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest, com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse>newBuilder()
              ...
              .setSchemaDescriptor(new QuotaServiceMethodDescriptorSupplier("ListQuotaGroups"))
              .build();
        }
      }
    }
  ...
  public static QuotaServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<QuotaServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<QuotaServiceStub>() {
        @java.lang.Override
        public QuotaServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static QuotaServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<QuotaServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<QuotaServiceBlockingStub>() {
        @java.lang.Override
        public QuotaServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static QuotaServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<QuotaServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<QuotaServiceFutureStub>() {
        @java.lang.Override
        public QuotaServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void listQuotaGroups(com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListQuotaGroupsMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class QuotaServiceImplBase
  ...
  public static final class QuotaServiceStub
    ...
    private QuotaServiceStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected QuotaServiceStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new QuotaServiceStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public void listQuotaGroups(com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListQuotaGroupsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class QuotaServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse listQuotaGroups(com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest request) {
  ...
  public static final class QuotaServiceFutureStub
    ...
    private QuotaServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse> listQuotaGroups(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_QUOTA_GROUPS:
          serviceImpl.listQuotaGroups((com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.shopping.merchant.quota.v1beta.ListQuotaGroupsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class QuotaServiceBaseDescriptorSupplier
