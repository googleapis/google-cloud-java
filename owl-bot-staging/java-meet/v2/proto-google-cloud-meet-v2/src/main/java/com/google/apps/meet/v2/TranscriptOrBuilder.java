...
public interface TranscriptOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.apps.meet.v2.DocsDestination docs_destination = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.apps.meet.v2.Transcript.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
