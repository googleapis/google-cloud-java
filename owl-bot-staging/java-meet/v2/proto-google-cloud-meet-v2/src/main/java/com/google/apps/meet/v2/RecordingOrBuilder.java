...
public interface RecordingOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.apps.meet.v2.DriveDestination drive_destination = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.apps.meet.v2.Recording.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
