...
public interface SecretVersionOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.secretmanager.v1beta2.SecretVersion.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp scheduled_destroy_time = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.secretmanager.v1beta2.CustomerManagedEncryptionStatus customer_managed_encryption = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.secretmanager.v1beta2.CustomerManagedEncryptionStatus getCustomerManagedEncryption();
  /**
   * <pre>
   * Output only. The customer-managed encryption status of the
   * [SecretVersion][google.cloud.secretmanager.v1beta2.SecretVersion]. Only
   ...
   * <code>.google.cloud.secretmanager.v1beta2.CustomerManagedEncryptionStatus customer_managed_encryption = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.secretmanager.v1beta2.CustomerManagedEncryptionStatusOrBuilder getCustomerManagedEncryptionOrBuilder();
}
