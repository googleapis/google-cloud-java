...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.cloud.dialogflow.v2beta1.ConversationEvent.Type getType() {
    com.google.cloud.dialogflow.v2beta1.ConversationEvent.Type result = com.google.cloud.dialogflow.v2beta1.ConversationEvent.Type.forNumber(type_);
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.dialogflow.v2beta1.ConversationEvent result) {
    ...
    private void buildPartialOneofs(com.google.cloud.dialogflow.v2beta1.ConversationEvent result) {
      result.payloadCase_ = payloadCase_;
      result.payload_ = this.payload_;
      if (payloadCase_ == 4 &&
          newMessagePayloadBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getNewMessagePayloadFieldBuilder().getBuilder(),
                  extensionRegistry);
              payloadCase_ = 4;
              break;
            } // case 34
