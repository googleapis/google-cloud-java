...
public interface ImportDocumentsRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.v2beta1.GcsSources gcs_source = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.v2beta1.ImportDocumentTemplate document_template = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.dialogflow.v2beta1.ImportDocumentTemplate document_template = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.dialogflow.v2beta1.ImportDocumentTemplateOrBuilder getDocumentTemplateOrBuilder();
