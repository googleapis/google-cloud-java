        ...
        switch (tag) {
          ...
          case 34: {
            ...
            if (operationMetadataCase_ == 4) {
              subBuilder = ((com.google.cloud.dialogflow.v2beta1.ExportOperationMetadata) operationMetadata_).toBuilder();
            }
            operationMetadata_ =
                input.readMessage(com.google.cloud.dialogflow.v2beta1.ExportOperationMetadata.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.dialogflow.v2beta1.ExportOperationMetadata) operationMetadata_);
