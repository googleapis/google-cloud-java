...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.dialogflow.v2beta1.ListDocumentsResponse result) {
      if (documentsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.dialogflow.v2beta1.Document m =
                  input.readMessage(
                      com.google.cloud.dialogflow.v2beta1.Document.parser(),
                      extensionRegistry);
              if (documentsBuilder_ == null) {
                ensureDocumentsIsMutable();
                documents_.add(m);
