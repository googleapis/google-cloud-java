...
@java.lang.Deprecated public interface SuggestionOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.dialogflow.v2beta1.Suggestion.Article> 
      getArticlesList();
  /**
   * <pre>
   * Output only. Articles ordered by score in descending order.
   ...
   * <code>repeated .google.cloud.dialogflow.v2beta1.Suggestion.Article articles = 2;</code>
   */
  com.google.cloud.dialogflow.v2beta1.Suggestion.ArticleOrBuilder getArticlesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.dialogflow.v2beta1.Suggestion.FaqAnswer> 
      getFaqAnswersList();
  /**
   * <pre>
   * Output only. Answers extracted from FAQ documents.
