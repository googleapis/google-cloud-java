...
public interface SearchKnowledgeRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.v2beta1.TextInput query = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>string conversation_profile = 2 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
