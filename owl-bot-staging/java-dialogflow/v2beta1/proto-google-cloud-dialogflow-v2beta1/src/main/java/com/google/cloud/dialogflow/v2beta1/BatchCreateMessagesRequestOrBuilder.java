...
public interface BatchCreateMessagesRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.dialogflow.v2beta1.CreateMessageRequest> 
      getRequestsList();
  /**
   * <pre>
   * Required. A maximum of 1000 Messages can be created in a batch.
   ...
   * <code>repeated .google.cloud.dialogflow.v2beta1.CreateMessageRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.dialogflow.v2beta1.CreateMessageRequestOrBuilder getRequestsOrBuilder(
      int index);
}
