 ...
 *      <td><p>Creates a new participant in a conversation.</p></td>
 *      <td>
 ...
 *      <td><p>Retrieves a conversation participant.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Returns the list of all participants in the specified conversation.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Updates the specified participant.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Adds a text (chat, for example), or audio (phone recording, for example)
 *  message from a participant into the conversation.
 *
 *  Note: Always use agent versions for production traffic
 *  sent to virtual agents. See [Versions and
 *  environments](https://cloud.google.com/dialogflow/es/docs/agents-versions).</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>analyzeContent(ParticipantName participant, AudioInput audioInput)
 ...
 *           <li>analyzeContent(String participant, AudioInput audioInput)
 ...
 *      <td><p>Adds a text (e.g., chat) or audio (e.g., phone recording) message from a
 ...
 *      <td><p>Gets suggested articles for a participant based on specific historical
 *  messages.
 *
 *  Note that
 ...
 *      <td><p>Gets suggested faq answers for a participant based on specific historical
 *  messages.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Gets smart replies for a participant based on specific historical
 *  messages.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Deprecated: Use inline suggestion, event based suggestion or
 ...
 *  request]` and empty page_token.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listSuggestions(ListSuggestionsRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listSuggestionsPagedCallable()
 *           <li>listSuggestionsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>CompileSuggestion</td>
 *      <td><p>Deprecated. use
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>compileSuggestion(CompileSuggestionRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>compileSuggestionCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
