...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.cloud.dialogflow.v2.BatchUpdateIntentsRequest result) {
      result.intentBatchCase_ = intentBatchCase_;
      result.intentBatch_ = this.intentBatch_;
      if (intentBatchCase_ == 3 &&
          intentBatchInlineBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getIntentBatchInlineFieldBuilder().getBuilder(),
                  extensionRegistry);
              intentBatchCase_ = 3;
              break;
            } // case 26
