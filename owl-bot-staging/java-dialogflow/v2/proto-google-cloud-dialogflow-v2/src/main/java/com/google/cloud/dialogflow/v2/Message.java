  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeMessageAnnotation(com.google.cloud.dialogflow.v2.MessageAnnotation value) {
      if (messageAnnotationBuilder_ == null) {
        if (messageAnnotation_ != null) {
          messageAnnotation_ =
            com.google.cloud.dialogflow.v2.MessageAnnotation.newBuilder(messageAnnotation_).mergeFrom(value).buildPartial();
        } else {
          messageAnnotation_ = value;
        }
        onChanged();
    ...
    public Builder mergeSentimentAnalysis(com.google.cloud.dialogflow.v2.SentimentAnalysisResult value) {
      if (sentimentAnalysisBuilder_ == null) {
        if (sentimentAnalysis_ != null) {
          sentimentAnalysis_ =
            com.google.cloud.dialogflow.v2.SentimentAnalysisResult.newBuilder(sentimentAnalysis_).mergeFrom(value).buildPartial();
        } else {
          sentimentAnalysis_ = value;
        }
        onChanged();
