...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.dialogflow.v2.SuggestFaqAnswersResponse result) {
      if (faqAnswersBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.dialogflow.v2.FaqAnswer m =
                  input.readMessage(
                      com.google.cloud.dialogflow.v2.FaqAnswer.parser(),
                      extensionRegistry);
              if (faqAnswersBuilder_ == null) {
                ensureFaqAnswersIsMutable();
                faqAnswers_.add(m);
