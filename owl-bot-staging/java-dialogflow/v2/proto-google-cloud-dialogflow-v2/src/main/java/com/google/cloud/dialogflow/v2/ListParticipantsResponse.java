        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              participants_ = new java.util.ArrayList<com.google.cloud.dialogflow.v2.Participant>();
              mutable_bitField0_ |= 0x00000001;
            }
            participants_.add(
                input.readMessage(com.google.cloud.dialogflow.v2.Participant.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dialogflow.v2.ListParticipantsResponse) e.getUnfinishedMessage();
