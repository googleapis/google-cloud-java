...
public interface ListDocumentsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.v2.ListDocumentsResponse)
   ...
   */
  java.util.List<com.google.cloud.dialogflow.v2.Document> 
      getDocumentsList();
  /**
   * <pre>
   * The list of documents.
   ...
   * <code>repeated .google.cloud.dialogflow.v2.Document documents = 1;</code>
   */
  com.google.cloud.dialogflow.v2.DocumentOrBuilder getDocumentsOrBuilder(
      int index);
