...
public interface FulfillmentOrBuilder extends
   ...
   * <code>.google.cloud.dialogflow.v2.Fulfillment.GenericWebService generic_web_service = 3;</code>
   */
  com.google.cloud.dialogflow.v2.Fulfillment.GenericWebServiceOrBuilder getGenericWebServiceOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.dialogflow.v2.Fulfillment.Feature> 
      getFeaturesList();
  /**
   * <pre>
   * Optional. The field defines whether the fulfillment is enabled for certain features.
   ...
   * <code>repeated .google.cloud.dialogflow.v2.Fulfillment.Feature features = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.dialogflow.v2.Fulfillment.FeatureOrBuilder getFeaturesOrBuilder(
      int index);
