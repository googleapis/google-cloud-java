...
public final class GcsProto {
  ...
  static {
    ...
    internal_static_google_cloud_dialogflow_v2_GcsSources_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_v2_GcsSources_descriptor,
        new java.lang.String[] { "Uris", });
    internal_static_google_cloud_dialogflow_v2_GcsDestination_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_dialogflow_v2_GcsDestination_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_v2_GcsDestination_descriptor,
