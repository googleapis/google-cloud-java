...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.dialogflow.v2.CreateConversationRequest result) {
    ...
    public Builder mergeConversation(com.google.cloud.dialogflow.v2.Conversation value) {
      if (conversationBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          conversation_ != null &&
          conversation_ != com.google.cloud.dialogflow.v2.Conversation.getDefaultInstance()) {
