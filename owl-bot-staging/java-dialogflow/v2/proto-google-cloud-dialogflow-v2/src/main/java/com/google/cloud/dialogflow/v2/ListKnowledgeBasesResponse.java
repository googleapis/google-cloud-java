        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              knowledgeBases_ = new java.util.ArrayList<com.google.cloud.dialogflow.v2.KnowledgeBase>();
              mutable_bitField0_ |= 0x00000001;
            }
            knowledgeBases_.add(
                input.readMessage(com.google.cloud.dialogflow.v2.KnowledgeBase.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dialogflow.v2.ListKnowledgeBasesResponse) e.getUnfinishedMessage();
