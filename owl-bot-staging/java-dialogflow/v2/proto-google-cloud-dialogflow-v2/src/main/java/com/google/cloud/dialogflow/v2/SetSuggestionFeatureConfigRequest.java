    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            com.google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.Builder subBuilder = null;
            if (suggestionFeatureConfig_ != null) {
              subBuilder = suggestionFeatureConfig_.toBuilder();
            }
            suggestionFeatureConfig_ = input.readMessage(com.google.cloud.dialogflow.v2.HumanAgentAssistantConfig.SuggestionFeatureConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dialogflow.v2.SetSuggestionFeatureConfigRequest) e.getUnfinishedMessage();
