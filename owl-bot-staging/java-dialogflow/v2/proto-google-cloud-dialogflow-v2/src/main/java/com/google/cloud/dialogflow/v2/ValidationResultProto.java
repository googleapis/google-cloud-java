...
public final class ValidationResultProto {
  ...
  static {
    ...
    internal_static_google_cloud_dialogflow_v2_ValidationError_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_v2_ValidationError_descriptor,
        new java.lang.String[] { "Severity", "Entries", "ErrorMessage", });
    internal_static_google_cloud_dialogflow_v2_ValidationResult_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_dialogflow_v2_ValidationResult_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_v2_ValidationResult_descriptor,
