...
public interface ListRuntimesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.notebooks.v1.ListRuntimesResponse)
   ...
   */
  java.util.List<com.google.cloud.notebooks.v1.Runtime> 
      getRuntimesList();
  /**
   * <pre>
   * A list of returned Runtimes.
   ...
   * <code>repeated .google.cloud.notebooks.v1.Runtime runtimes = 1;</code>
   */
  com.google.cloud.notebooks.v1.RuntimeOrBuilder getRuntimesOrBuilder(
      int index);
