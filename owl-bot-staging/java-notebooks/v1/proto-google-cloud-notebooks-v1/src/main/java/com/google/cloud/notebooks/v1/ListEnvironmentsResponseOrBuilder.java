...
public interface ListEnvironmentsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.notebooks.v1.ListEnvironmentsResponse)
   ...
   */
  java.util.List<com.google.cloud.notebooks.v1.Environment> 
      getEnvironmentsList();
  /**
   * <pre>
   * A list of returned environments.
   ...
   * <code>repeated .google.cloud.notebooks.v1.Environment environments = 1;</code>
   */
  com.google.cloud.notebooks.v1.EnvironmentOrBuilder getEnvironmentsOrBuilder(
      int index);
