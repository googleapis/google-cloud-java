...
com.google.cloud.config.v1.TerraformOutput defaultValue) {
  ...
  public static final class Builder extends
    ...
    private static final class OutputsConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, com.google.cloud.config.v1.TerraformOutputOrBuilder, com.google.cloud.config.v1.TerraformOutput> {
      @java.lang.Override
      public com.google.cloud.config.v1.TerraformOutput build(com.google.cloud.config.v1.TerraformOutputOrBuilder val) {
        if (val instanceof com.google.cloud.config.v1.TerraformOutput) { return (com.google.cloud.config.v1.TerraformOutput) val; }
        return ((com.google.cloud.config.v1.TerraformOutput.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, com.google.cloud.config.v1.TerraformOutput> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, com.google.cloud.config.v1.TerraformOutputOrBuilder, com.google.cloud.config.v1.TerraformOutput, com.google.cloud.config.v1.TerraformOutput.Builder> outputs_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, com.google.cloud.config.v1.TerraformOutputOrBuilder, com.google.cloud.config.v1.TerraformOutput, com.google.cloud.config.v1.TerraformOutput.Builder>
        internalGetOutputs() {
      if (outputs_ == null) {
...
com.google.cloud.config.v1.TerraformOutput defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, com.google.cloud.config.v1.TerraformOutputOrBuilder> map = internalGetMutableOutputs().ensureBuilderMap();
    ...
    public Builder putAllOutputs(
      ...
      for (java.util.Map.Entry<java.lang.String, com.google.cloud.config.v1.TerraformOutput> e : values.entrySet()) {
    ...
    public com.google.cloud.config.v1.TerraformOutput.Builder putOutputsBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, com.google.cloud.config.v1.TerraformOutputOrBuilder> builderMap = internalGetMutableOutputs().ensureBuilderMap();
