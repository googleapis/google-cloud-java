...
public interface UpdateDeploymentRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.config.v1.UpdateDeploymentRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.config.v1.Deployment deployment = 2 [(.google.api.field_behavior) = REQUIRED];</code>
