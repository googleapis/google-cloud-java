...
public interface ResourceOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.config.v1.ResourceTerraformInfo terraform_info = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>map&lt;string, .google.cloud.config.v1.ResourceCAIInfo&gt; cai_assets = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * <code>map&lt;string, .google.cloud.config.v1.ResourceCAIInfo&gt; cai_assets = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  boolean containsCaiAssets(
      java.lang.String key);
  /**
   * Use {@link #getCaiAssetsMap()} instead.
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, com.google.cloud.config.v1.ResourceCAIInfo>
  getCaiAssets();
  /**
   * <pre>
   * Output only. Map of Cloud Asset Inventory (CAI) type to CAI info (e.g. CAI
...
com.google.cloud.config.v1.ResourceCAIInfo defaultValue);
   ...
   * <code>map&lt;string, .google.cloud.config.v1.ResourceCAIInfo&gt; cai_assets = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.config.v1.ResourceCAIInfo getCaiAssetsOrThrow(
      java.lang.String key);
   ...
   * </pre>
   *
   * <code>.google.cloud.config.v1.Resource.Intent intent = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.config.v1.Resource.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
