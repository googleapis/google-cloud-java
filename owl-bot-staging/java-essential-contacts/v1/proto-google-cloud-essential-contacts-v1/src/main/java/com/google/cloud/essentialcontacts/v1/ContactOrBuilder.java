...
public interface ContactOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.essentialcontacts.v1.NotificationCategory notification_category_subscriptions = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   * @return A list containing the notificationCategorySubscriptions.
   */
  java.util.List<com.google.cloud.essentialcontacts.v1.NotificationCategory> getNotificationCategorySubscriptionsList();
  /**
   * <pre>
   * Required. The categories of notifications that the contact will receive
   * communications for.
   ...
   */
  com.google.cloud.essentialcontacts.v1.NotificationCategory getNotificationCategorySubscriptions(int index);
  /**
   * <pre>
   * Required. The categories of notifications that the contact will receive
   * communications for.
