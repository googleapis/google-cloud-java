...
public interface ComputeContactsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.essentialcontacts.v1.NotificationCategory> getNotificationCategoriesList();
  /**
   * <pre>
   * The categories of notifications to compute contacts for. If ALL is included
   * in this list, contacts subscribed to any notification category will be
