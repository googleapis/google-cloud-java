...
public interface EventOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.servicehealth.v1.Event.EventCategory category = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.servicehealth.v1.Event.DetailedCategory detailed_category = 21 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.servicehealth.v1.Event.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.servicehealth.v1.Event.DetailedState detailed_state = 19 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  java.util.List<com.google.cloud.servicehealth.v1.EventImpact> 
      getEventImpactsList();
  /**
   * <pre>
   * Google Cloud products and locations impacted by the event.
   ...
   * <code>repeated .google.cloud.servicehealth.v1.EventImpact event_impacts = 20;</code>
   */
  com.google.cloud.servicehealth.v1.EventImpactOrBuilder getEventImpactsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.servicehealth.v1.Event.Relevance relevance = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.servicehealth.v1.EventUpdate updates = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.servicehealth.v1.EventUpdate> 
      getUpdatesList();
  /**
   * <pre>
   * Output only. Event updates are correspondence from Google.
   ...
   * <code>repeated .google.cloud.servicehealth.v1.EventUpdate updates = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.servicehealth.v1.EventUpdateOrBuilder getUpdatesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp next_update_time = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
