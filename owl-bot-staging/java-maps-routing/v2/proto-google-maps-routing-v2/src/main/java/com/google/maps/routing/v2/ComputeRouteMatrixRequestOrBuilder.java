...
public interface ComputeRouteMatrixRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.maps.routing.v2.RouteMatrixOrigin> 
      getOriginsList();
  /**
   * <pre>
   * Required. Array of origins, which determines the rows of the response
   ...
   * <code>repeated .google.maps.routing.v2.RouteMatrixOrigin origins = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.maps.routing.v2.RouteMatrixOriginOrBuilder getOriginsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.maps.routing.v2.RouteMatrixDestination> 
      getDestinationsList();
  /**
   * <pre>
   * Required. Array of destinations, which determines the columns of the
   ...
   */
  java.util.List<com.google.maps.routing.v2.ComputeRouteMatrixRequest.ExtraComputation> getExtraComputationsList();
  /**
   * <pre>
   * Optional. A list of extra computations which may be used to complete the
   * request. Note: These extra computations may return extra fields on the
   ...
   */
  com.google.maps.routing.v2.ComputeRouteMatrixRequest.ExtraComputation getExtraComputations(int index);
  /**
   * <pre>
   * Optional. A list of extra computations which may be used to complete the
   * request. Note: These extra computations may return extra fields on the
