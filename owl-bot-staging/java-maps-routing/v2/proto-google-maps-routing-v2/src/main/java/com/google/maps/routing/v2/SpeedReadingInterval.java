...
private static final long serialVersionUID = 0L;
  ...
  public enum SpeedTypeCase
    ...
    public static SpeedTypeCase forNumber(int value) {
      switch (value) {
        case 3: return SPEED;
        case 0: return SPEEDTYPE_NOT_SET;
        default: return null;
      }
    }
  ...
  public com.google.maps.routing.v2.SpeedReadingInterval.Speed getSpeed() {
    if (speedTypeCase_ == 3) {
      com.google.maps.routing.v2.SpeedReadingInterval.Speed result = com.google.maps.routing.v2.SpeedReadingInterval.Speed.forNumber(
  ...
  public int getSerializedSize() {
    ...
    if (speedTypeCase_ == 3) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(3, ((java.lang.Integer) speedType_));
    }
