...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, getGeocoderStatus());
    }
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeInt32Size(2, intermediateWaypointRequestIndex_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < type_.size(); i++) {
    ...
    if (partialMatch_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(4, partialMatch_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(placeId_)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.maps.routing.v2.GeocodedWaypoint other = (com.google.maps.routing.v2.GeocodedWaypoint) obj;

    if (hasGeocoderStatus() != other.hasGeocoderStatus()) return false;
    if (hasGeocoderStatus()) {
      if (!getGeocoderStatus()
          .equals(other.getGeocoderStatus())) return false;
    }
    if (hasIntermediateWaypointRequestIndex() != other.hasIntermediateWaypointRequestIndex()) return false;
    if (hasIntermediateWaypointRequestIndex()) {
      if (getIntermediateWaypointRequestIndex()
          != other.getIntermediateWaypointRequestIndex()) return false;
    }
    if (!getTypeList()
        .equals(other.getTypeList())) return false;
    if (getPartialMatch()
        != other.getPartialMatch()) return false;
    if (!getPlaceId()
  ...
  public static com.google.maps.routing.v2.GeocodedWaypoint parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
     ...
     * <code>.google.rpc.Status geocoder_status = 1;</code>
     */
    public Builder setGeocoderStatus(
    ...
    public com.google.rpc.StatusOrBuilder getGeocoderStatusOrBuilder() {
      if (geocoderStatusBuilder_ != null) {
        ...
        return geocoderStatus_ == null ?
            com.google.rpc.Status.getDefaultInstance() : geocoderStatus_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        ...
        getGeocoderStatusFieldBuilder() {
      if (geocoderStatusBuilder_ == null) {
        geocoderStatusBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.rpc.Status, com.google.rpc.Status.Builder, com.google.rpc.StatusOrBuilder>(
                getGeocoderStatus(),
  ...
  private static final com.google.protobuf.Parser<GeocodedWaypoint>
      PARSER = new com.google.protobuf.AbstractParser<GeocodedWaypoint>() {
    @java.lang.Override
