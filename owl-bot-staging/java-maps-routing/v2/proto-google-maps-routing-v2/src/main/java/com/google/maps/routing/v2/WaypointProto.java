...
public final class WaypointProto {
  ...
  static {
    ...
    internal_static_google_maps_routing_v2_Waypoint_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_maps_routing_v2_Waypoint_descriptor,
        new java.lang.String[] { "Location", "PlaceId", "Address", "Via", "VehicleStopover", "SideOfRoad", "LocationType", });
    com.google.maps.routing.v2.LocationProto.getDescriptor();
  }
