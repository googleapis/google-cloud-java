...
public final class TransitProto {
  ...
  static {
    ...
    internal_static_google_maps_routing_v2_TransitAgency_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_maps_routing_v2_TransitAgency_descriptor,
        new java.lang.String[] { "Name", "PhoneNumber", "Uri", });
    internal_static_google_maps_routing_v2_TransitLine_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_maps_routing_v2_TransitLine_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_maps_routing_v2_TransitLine_descriptor,
        new java.lang.String[] { "Agencies", "Name", "Uri", "Color", "IconUri", "NameShort", "TextColor", "Vehicle", });
    internal_static_google_maps_routing_v2_TransitStop_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_maps_routing_v2_TransitStop_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_maps_routing_v2_TransitStop_descriptor,
        new java.lang.String[] { "Name", "Location", });
    internal_static_google_maps_routing_v2_TransitVehicle_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_maps_routing_v2_TransitVehicle_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_maps_routing_v2_TransitVehicle_descriptor,
        new java.lang.String[] { "Name", "Type", "IconUri", "LocalIconUri", });
    com.google.maps.routing.v2.LocationProto.getDescriptor();
    com.google.type.LocalizedTextProto.getDescriptor();
  }
