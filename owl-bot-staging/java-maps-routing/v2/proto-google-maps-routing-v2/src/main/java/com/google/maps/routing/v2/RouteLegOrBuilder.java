...
public interface RouteLegOrBuilder extends
   ...
   */
  java.util.List<com.google.maps.routing.v2.RouteLegStep> 
      getStepsList();
  /**
   * <pre>
   * An array of steps denoting segments within this leg. Each step represents
   ...
   * <code>.google.maps.routing.v2.RouteLeg.RouteLegLocalizedValues localized_values = 9;</code>
   */
  com.google.maps.routing.v2.RouteLeg.RouteLegLocalizedValuesOrBuilder getLocalizedValuesOrBuilder();
