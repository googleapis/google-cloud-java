...
public interface TransitLineOrBuilder extends
   ...
   */
  java.util.List<com.google.maps.routing.v2.TransitAgency> 
      getAgenciesList();
  /**
   * <pre>
   * The transit agency (or agencies) that operates this transit line.
   ...
   * <code>repeated .google.maps.routing.v2.TransitAgency agencies = 1;</code>
   */
  com.google.maps.routing.v2.TransitAgencyOrBuilder getAgenciesOrBuilder(
      int index);
