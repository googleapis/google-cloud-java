...
public interface ComputeRoutesRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp arrival_time = 19 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.maps.routing.v2.ComputeRoutesRequest.ExtraComputation extra_computations = 15 [(.google.api.field_behavior) = OPTIONAL];</code>
   * @return A list containing the extraComputations.
   */
  java.util.List<com.google.maps.routing.v2.ComputeRoutesRequest.ExtraComputation> getExtraComputationsList();
  /**
   * <pre>
   * Optional. A list of extra computations which may be used to complete the
   * request. Note: These extra computations may return extra fields on the
   ...
   * </pre>
   *
   * <code>.google.maps.routing.v2.TrafficModel traffic_model = 18 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.maps.routing.v2.TransitPreferences transit_preferences = 20 [(.google.api.field_behavior) = OPTIONAL];</code>
