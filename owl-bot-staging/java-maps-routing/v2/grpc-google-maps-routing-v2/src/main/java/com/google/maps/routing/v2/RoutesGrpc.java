...
public final class RoutesGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.maps.routing.v2.ComputeRoutesRequest,
      com.google.maps.routing.v2.ComputeRoutesResponse> getComputeRoutesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.maps.routing.v2.ComputeRoutesRequest,
      com.google.maps.routing.v2.ComputeRoutesResponse> getComputeRoutesMethod() {
    io.grpc.MethodDescriptor<com.google.maps.routing.v2.ComputeRoutesRequest, com.google.maps.routing.v2.ComputeRoutesResponse> getComputeRoutesMethod;
    if ((getComputeRoutesMethod = RoutesGrpc.getComputeRoutesMethod) == null) {
      synchronized (RoutesGrpc.class) {
        if ((getComputeRoutesMethod = RoutesGrpc.getComputeRoutesMethod) == null) {
          RoutesGrpc.getComputeRoutesMethod = getComputeRoutesMethod =
              io.grpc.MethodDescriptor.<com.google.maps.routing.v2.ComputeRoutesRequest, com.google.maps.routing.v2.ComputeRoutesResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.maps.routing.v2.ComputeRoutesResponse.getDefaultInstance()))
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.maps.routing.v2.ComputeRouteMatrixRequest,
      com.google.maps.routing.v2.RouteMatrixElement> getComputeRouteMatrixMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.maps.routing.v2.ComputeRouteMatrixRequest,
      com.google.maps.routing.v2.RouteMatrixElement> getComputeRouteMatrixMethod() {
    io.grpc.MethodDescriptor<com.google.maps.routing.v2.ComputeRouteMatrixRequest, com.google.maps.routing.v2.RouteMatrixElement> getComputeRouteMatrixMethod;
    if ((getComputeRouteMatrixMethod = RoutesGrpc.getComputeRouteMatrixMethod) == null) {
      synchronized (RoutesGrpc.class) {
        if ((getComputeRouteMatrixMethod = RoutesGrpc.getComputeRouteMatrixMethod) == null) {
          RoutesGrpc.getComputeRouteMatrixMethod = getComputeRouteMatrixMethod =
              io.grpc.MethodDescriptor.<com.google.maps.routing.v2.ComputeRouteMatrixRequest, com.google.maps.routing.v2.RouteMatrixElement>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.SERVER_STREAMING)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ComputeRouteMatrix"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.maps.routing.v2.ComputeRouteMatrixRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
   ...
   */
  public static RoutesBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<RoutesBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<RoutesBlockingStub>() {
        @java.lang.Override
        public RoutesBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static RoutesFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<RoutesFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<RoutesFutureStub>() {
        @java.lang.Override
        public RoutesFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void computeRoutes(com.google.maps.routing.v2.ComputeRoutesRequest request,
        io.grpc.stub.StreamObserver<com.google.maps.routing.v2.ComputeRoutesResponse> responseObserver) {
     ...
     * </pre>
     */
    default void computeRouteMatrix(com.google.maps.routing.v2.ComputeRouteMatrixRequest request,
        io.grpc.stub.StreamObserver<com.google.maps.routing.v2.RouteMatrixElement> responseObserver) {
   ...
   * </pre>
   */
  public static abstract class RoutesImplBase
   ...
   * </pre>
   */
  public static final class RoutesStub
      extends io.grpc.stub.AbstractAsyncStub<RoutesStub> {
    private RoutesStub(
     ...
     * </pre>
     */
    public void computeRoutes(com.google.maps.routing.v2.ComputeRoutesRequest request,
        io.grpc.stub.StreamObserver<com.google.maps.routing.v2.ComputeRoutesResponse> responseObserver) {
     ...
     * </pre>
     */
    public void computeRouteMatrix(com.google.maps.routing.v2.ComputeRouteMatrixRequest request,
        io.grpc.stub.StreamObserver<com.google.maps.routing.v2.RouteMatrixElement> responseObserver) {
  ...
  public static final class RoutesBlockingStub
    ...
    private RoutesBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RoutesBlockingStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RoutesBlockingStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.maps.routing.v2.ComputeRoutesResponse computeRoutes(com.google.maps.routing.v2.ComputeRoutesRequest request) {
  ...
  public static final class RoutesFutureStub
    ...
    private RoutesFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RoutesFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RoutesFutureStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.maps.routing.v2.ComputeRoutesResponse> computeRoutes(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_COMPUTE_ROUTES:
          serviceImpl.computeRoutes((com.google.maps.routing.v2.ComputeRoutesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.maps.routing.v2.ComputeRoutesResponse>) responseObserver);
          break;
        case METHODID_COMPUTE_ROUTE_MATRIX:
          serviceImpl.computeRouteMatrix((com.google.maps.routing.v2.ComputeRouteMatrixRequest) request,
              (io.grpc.stub.StreamObserver<com.google.maps.routing.v2.RouteMatrixElement>) responseObserver);
          break;
        default:
  ...
  private static abstract class RoutesBaseDescriptorSupplier
  ...
  private static final class RoutesFileDescriptorSupplier
      extends RoutesBaseDescriptorSupplier {
    RoutesFileDescriptorSupplier() {}
  }

  private static final class RoutesMethodDescriptorSupplier
      extends RoutesBaseDescriptorSupplier
