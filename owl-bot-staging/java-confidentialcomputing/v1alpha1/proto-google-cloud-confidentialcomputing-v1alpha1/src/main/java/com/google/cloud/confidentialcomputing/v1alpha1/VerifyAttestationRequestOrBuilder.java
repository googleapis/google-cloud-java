...
public interface VerifyAttestationRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.confidentialcomputing.v1alpha1.VerifyAttestationRequest)
   ...
   * </pre>
   *
   * <code>string challenge = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.confidentialcomputing.v1alpha1.GcpCredentials gcp_credentials = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.confidentialcomputing.v1alpha1.TpmAttestation tpm_attestation = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.confidentialcomputing.v1alpha1.TpmAttestation tpm_attestation = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.confidentialcomputing.v1alpha1.TpmAttestationOrBuilder getTpmAttestationOrBuilder();
}
