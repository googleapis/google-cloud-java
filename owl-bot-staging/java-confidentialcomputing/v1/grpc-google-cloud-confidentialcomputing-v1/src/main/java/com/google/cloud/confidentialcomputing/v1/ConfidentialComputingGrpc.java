...
public final class ConfidentialComputingGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.confidentialcomputing.v1.ConfidentialComputing";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest,
      com.google.cloud.confidentialcomputing.v1.Challenge> getCreateChallengeMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest,
      com.google.cloud.confidentialcomputing.v1.Challenge> getCreateChallengeMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest, com.google.cloud.confidentialcomputing.v1.Challenge> getCreateChallengeMethod;
    if ((getCreateChallengeMethod = ConfidentialComputingGrpc.getCreateChallengeMethod) == null) {
      synchronized (ConfidentialComputingGrpc.class) {
        if ((getCreateChallengeMethod = ConfidentialComputingGrpc.getCreateChallengeMethod) == null) {
          ConfidentialComputingGrpc.getCreateChallengeMethod = getCreateChallengeMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest, com.google.cloud.confidentialcomputing.v1.Challenge>newBuilder()
              ...
              .setSchemaDescriptor(new ConfidentialComputingMethodDescriptorSupplier("CreateChallenge"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest,
      com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse> getVerifyAttestationMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest,
      com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse> getVerifyAttestationMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest, com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse> getVerifyAttestationMethod;
    if ((getVerifyAttestationMethod = ConfidentialComputingGrpc.getVerifyAttestationMethod) == null) {
      synchronized (ConfidentialComputingGrpc.class) {
        if ((getVerifyAttestationMethod = ConfidentialComputingGrpc.getVerifyAttestationMethod) == null) {
          ConfidentialComputingGrpc.getVerifyAttestationMethod = getVerifyAttestationMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest, com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "VerifyAttestation"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ConfidentialComputingMethodDescriptorSupplier("VerifyAttestation"))
              .build();
        }
      }
    }
  ...
  public static ConfidentialComputingStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ConfidentialComputingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ConfidentialComputingStub>() {
        @java.lang.Override
        public ConfidentialComputingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static ConfidentialComputingBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ConfidentialComputingBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ConfidentialComputingBlockingStub>() {
        @java.lang.Override
        public ConfidentialComputingBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static ConfidentialComputingFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ConfidentialComputingFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ConfidentialComputingFutureStub>() {
        @java.lang.Override
        public ConfidentialComputingFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void createChallenge(com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.confidentialcomputing.v1.Challenge> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateChallengeMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void verifyAttestation(com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getVerifyAttestationMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class ConfidentialComputingImplBase
  ...
  public static final class ConfidentialComputingStub
    ...
    private ConfidentialComputingStub(
     ...
     * </pre>
     */
    public void createChallenge(com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.confidentialcomputing.v1.Challenge> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateChallengeMethod(), getCallOptions()), request, responseObserver);
    }
     ...
     * </pre>
     */
    public void verifyAttestation(com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getVerifyAttestationMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ConfidentialComputingBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse verifyAttestation(com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ConfidentialComputingFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.confidentialcomputing.v1.Challenge> createChallenge(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse> verifyAttestation(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_CHALLENGE:
          serviceImpl.createChallenge((com.google.cloud.confidentialcomputing.v1.CreateChallengeRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.confidentialcomputing.v1.Challenge>) responseObserver);
          break;
        case METHODID_VERIFY_ATTESTATION:
          serviceImpl.verifyAttestation((com.google.cloud.confidentialcomputing.v1.VerifyAttestationRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.confidentialcomputing.v1.VerifyAttestationResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ConfidentialComputingBaseDescriptorSupplier
