...
public final class ServiceProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "256_SHA256\020\003*<\n\tTokenType\022\032\n\026TOKEN_TYPE_" +
      "UNSPECIFIED\020\000\022\023\n\017TOKEN_TYPE_OIDC\020\0012\267\004\n\025C" +
      "onfidentialComputing\022\330\001\n\017CreateChallenge" +
      "\022=.google.cloud.confidentialcomputing.v1" +
      ".CreateChallengeRequest\0320.google.cloud.c" +
      "onfidentialcomputing.v1.Challenge\"T\332A\020pa" +
      "rent,challenge\202\323\344\223\002;\"./v1/{parent=projec" +
      "ts/*/locations/*}/challenges:\tchallenge\022" +
      "\350\001\n\021VerifyAttestation\022?.google.cloud.con" +
      "fidentialcomputing.v1.VerifyAttestationR" +
      "equest\032@.google.cloud.confidentialcomput" +
      "ing.v1.VerifyAttestationResponse\"P\202\323\344\223\002J" +
      "\"E/v1/{challenge=projects/*/locations/*/" +
      "challenges/*}:verifyAttestation:\001*\032X\312A$c" +
      "onfidentialcomputing.googleapis.com\322A.ht" +
      "tps://www.googleapis.com/auth/cloud-plat" +
      "formB\227\002\n)com.google.cloud.confidentialco" +
      "mputing.v1B\014ServiceProtoP\001Z_cloud.google" +
      ".com/go/confidentialcomputing/apiv1/conf" +
      "identialcomputingpb;confidentialcomputin" +
      "gpb\252\002%Google.Cloud.ConfidentialComputing" +
      ".V1\312\002%Google\\Cloud\\ConfidentialComputing" +
      "\\V1\352\002(Google::Cloud::ConfidentialComputi" +
      "ng::V1b\006proto3"
    };
    ...
    internal_static_google_cloud_confidentialcomputing_v1_Challenge_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_Challenge_descriptor,
        new java.lang.String[] { "Name", "CreateTime", "ExpireTime", "Used", "TpmNonce", });
    internal_static_google_cloud_confidentialcomputing_v1_CreateChallengeRequest_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_confidentialcomputing_v1_CreateChallengeRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_CreateChallengeRequest_descriptor,
        new java.lang.String[] { "Parent", "Challenge", });
    internal_static_google_cloud_confidentialcomputing_v1_VerifyAttestationRequest_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_confidentialcomputing_v1_VerifyAttestationRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_VerifyAttestationRequest_descriptor,
        new java.lang.String[] { "Challenge", "GcpCredentials", "TpmAttestation", "ConfidentialSpaceInfo", "TokenOptions", });
    internal_static_google_cloud_confidentialcomputing_v1_VerifyAttestationResponse_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_confidentialcomputing_v1_VerifyAttestationResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_VerifyAttestationResponse_descriptor,
        new java.lang.String[] { "OidcClaimsToken", "PartialErrors", });
    internal_static_google_cloud_confidentialcomputing_v1_GcpCredentials_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_cloud_confidentialcomputing_v1_GcpCredentials_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_GcpCredentials_descriptor,
        new java.lang.String[] { "ServiceAccountIdTokens", });
    internal_static_google_cloud_confidentialcomputing_v1_TokenOptions_descriptor =
      getDescriptor().getMessageTypes().get(5);
    internal_static_google_cloud_confidentialcomputing_v1_TokenOptions_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_TokenOptions_descriptor,
        new java.lang.String[] { "Audience", "Nonce", "TokenType", });
    internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_descriptor =
      getDescriptor().getMessageTypes().get(6);
    internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_descriptor,
        new java.lang.String[] { "Quotes", "TcgEventLog", "CanonicalEventLog", "AkCert", "CertChain", });
    internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_descriptor =
      internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_descriptor,
        new java.lang.String[] { "HashAlgo", "PcrValues", "RawQuote", "RawSignature", });
    internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_PcrValuesEntry_descriptor =
      internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_PcrValuesEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_TpmAttestation_Quote_PcrValuesEntry_descriptor,
        new java.lang.String[] { "Key", "Value", });
    internal_static_google_cloud_confidentialcomputing_v1_ConfidentialSpaceInfo_descriptor =
      getDescriptor().getMessageTypes().get(7);
    internal_static_google_cloud_confidentialcomputing_v1_ConfidentialSpaceInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_ConfidentialSpaceInfo_descriptor,
        new java.lang.String[] { "SignedEntities", });
    internal_static_google_cloud_confidentialcomputing_v1_SignedEntity_descriptor =
      getDescriptor().getMessageTypes().get(8);
    internal_static_google_cloud_confidentialcomputing_v1_SignedEntity_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_SignedEntity_descriptor,
        new java.lang.String[] { "ContainerImageSignatures", });
    internal_static_google_cloud_confidentialcomputing_v1_ContainerImageSignature_descriptor =
      getDescriptor().getMessageTypes().get(9);
    internal_static_google_cloud_confidentialcomputing_v1_ContainerImageSignature_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_confidentialcomputing_v1_ContainerImageSignature_descriptor,
        new java.lang.String[] { "Payload", "Signature", "PublicKey", "SigAlg", });
    com.google.protobuf.ExtensionRegistry registry =
