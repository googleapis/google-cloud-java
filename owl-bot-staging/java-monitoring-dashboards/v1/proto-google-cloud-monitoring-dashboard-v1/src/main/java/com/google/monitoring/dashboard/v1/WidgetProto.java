...
public final class WidgetProto {
  ...
  static {
    ...
    internal_static_google_monitoring_dashboard_v1_Widget_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_monitoring_dashboard_v1_Widget_descriptor,
        new java.lang.String[] { "Title", "XyChart", "Scorecard", "Text", "Blank", "AlertChart", "TimeSeriesTable", "CollapsibleGroup", "LogsPanel", "IncidentList", "PieChart", "ErrorReportingPanel", "SectionHeader", "SingleViewGroup", "Id", "Content", });
    com.google.protobuf.ExtensionRegistry registry =
