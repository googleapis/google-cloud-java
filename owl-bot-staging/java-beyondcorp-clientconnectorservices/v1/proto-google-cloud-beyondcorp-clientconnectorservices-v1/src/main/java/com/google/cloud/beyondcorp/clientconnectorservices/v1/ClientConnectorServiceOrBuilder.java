...
public interface ClientConnectorServiceOrBuilder extends
   ...
   * @return The ingress.
   */
  com.google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress getIngress();
  /**
   * <pre>
   * Required. The details of the ingress settings.
   * </pre>
   ...
   * <code>.google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Ingress ingress = 6 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.IngressOrBuilder getIngressOrBuilder();
   ...
   * <code>.google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.Egress egress = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.beyondcorp.clientconnectorservices.v1.ClientConnectorService.EgressOrBuilder getEgressOrBuilder();
