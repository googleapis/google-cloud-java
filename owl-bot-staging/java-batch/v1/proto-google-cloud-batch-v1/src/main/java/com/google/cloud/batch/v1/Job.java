      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              com.google.cloud.batch.v1.TaskGroup m =
                  input.readMessage(
                      com.google.cloud.batch.v1.TaskGroup.parser(),
                      extensionRegistry);
              if (taskGroupsBuilder_ == null) {
                ensureTaskGroupsIsMutable();
                taskGroups_.add(m);
            ...
            case 114: {
              com.google.cloud.batch.v1.JobNotification m =
                  input.readMessage(
                      com.google.cloud.batch.v1.JobNotification.parser(),
                      extensionRegistry);
              if (notificationsBuilder_ == null) {
                ensureNotificationsIsMutable();
