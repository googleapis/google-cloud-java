...
public interface JobOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.batch.v1alpha.TaskGroup> 
      getTaskGroupsList();
  /**
   * <pre>
   * Required. TaskGroups in the Job. Only one TaskGroup is supported now.
   ...
   * <code>repeated .google.cloud.batch.v1alpha.TaskGroup task_groups = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.batch.v1alpha.TaskGroupOrBuilder getTaskGroupsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.batch.v1alpha.JobDependency> 
      getDependenciesList();
  /**
   * <pre>
   * At least one of the dependencies must be satisfied before the Job is
   ...
   * <code>repeated .google.cloud.batch.v1alpha.JobDependency dependencies = 6;</code>
   */
  com.google.cloud.batch.v1alpha.JobDependencyOrBuilder getDependenciesOrBuilder(
      int index);
...
java.lang.String defaultValue);
   ...
   * <code>.google.cloud.batch.v1alpha.JobNotification notification = 10 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.batch.v1alpha.JobNotificationOrBuilder getNotificationOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.batch.v1alpha.JobNotification> 
