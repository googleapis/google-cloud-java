...
public final class JobProto {
  ...
  static {
    ...
    internal_static_google_cloud_batch_v1alpha_TaskGroup_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_batch_v1alpha_TaskGroup_descriptor,
        new java.lang.String[] { "Name", "TaskSpec", "TaskCount", "Parallelism", "SchedulingPolicy", "AllocationPolicy", "Labels", "TaskEnvironments", "TaskCountPerNode", "RequireHostsFile", "PermissiveSsh", "RunAsNonRoot", "ServiceAccount", });
    internal_static_google_cloud_batch_v1alpha_TaskGroup_LabelsEntry_descriptor =
