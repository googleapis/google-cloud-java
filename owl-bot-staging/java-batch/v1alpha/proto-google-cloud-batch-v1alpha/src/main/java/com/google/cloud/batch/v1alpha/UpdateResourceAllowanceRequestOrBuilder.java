...
public interface UpdateResourceAllowanceRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.batch.v1alpha.UpdateResourceAllowanceRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.batch.v1alpha.ResourceAllowance resource_allowance = 1 [(.google.api.field_behavior) = REQUIRED];</code>
