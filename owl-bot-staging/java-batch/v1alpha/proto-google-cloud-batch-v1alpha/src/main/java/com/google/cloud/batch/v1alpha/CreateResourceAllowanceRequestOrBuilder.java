...
public interface CreateResourceAllowanceRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.batch.v1alpha.ResourceAllowance resource_allowance = 3 [(.google.api.field_behavior) = REQUIRED];</code>
