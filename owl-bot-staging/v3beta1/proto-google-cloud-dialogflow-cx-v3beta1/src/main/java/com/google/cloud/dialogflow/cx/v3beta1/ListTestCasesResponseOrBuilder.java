...
public interface ListTestCasesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3beta1.ListTestCasesResponse)
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3beta1.TestCase> 
      getTestCasesList();
  /**
   * <pre>
   * The list of test cases. There will be a maximum number of items returned
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3beta1.TestCase test_cases = 1;</code>
   */
  com.google.cloud.dialogflow.cx.v3beta1.TestCaseOrBuilder getTestCasesOrBuilder(
      int index);
