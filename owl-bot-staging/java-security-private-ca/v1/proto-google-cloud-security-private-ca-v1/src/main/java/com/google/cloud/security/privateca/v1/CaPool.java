...
private static final long serialVersionUID = 0L;
  ...
  public interface PublishingOptionsOrBuilder extends
     ...
     * </pre>
     *
     * <code>.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat encoding_format = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
  ...
  private static final long serialVersionUID = 0L;
     ...
     * </pre>
     *
     * Protobuf enum {@code google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat}
     */
    public enum EncodingFormat
      ...
      public static EncodingFormat forNumber(int value) {
        switch (value) {
          case 0: return ENCODING_FORMAT_UNSPECIFIED;
          case 1: return PEM;
          case 2: return DER;
          default: return null;
        }
      ...
      public static final com.google.protobuf.Descriptors.EnumDescriptor
          getDescriptor() {
        return com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.getDescriptor().getEnumTypes().get(0);
      }
     ...
     * @return The enum numeric value on the wire for encodingFormat.
     */
    @java.lang.Override public int getEncodingFormatValue() {
     ...
     * @return The encodingFormat.
     */
    @java.lang.Override public com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat getEncodingFormat() {
      com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat result = com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat.forNumber(encodingFormat_);
      return result == null ? com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat.UNRECOGNIZED : result;
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output)
      ...
      if (encodingFormat_ != com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat.ENCODING_FORMAT_UNSPECIFIED.getNumber()) {
    ...
    public int getSerializedSize() {
      ...
      if (encodingFormat_ != com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat.ENCODING_FORMAT_UNSPECIFIED.getNumber()) {
        size += com.google.protobuf.CodedOutputStream
          .computeEnumSize(3, encodingFormat_);
      }
    ...
    public static final class Builder extends
      ...
      private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool.PublishingOptions result) {
       ...
       */
      @java.lang.Override
      public com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat getEncodingFormat() {
        com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat result = com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat.forNumber(encodingFormat_);
        return result == null ? com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat.UNRECOGNIZED : result;
      }
      /**
       ...
       * @return This builder for chaining.
       */
      public Builder setEncodingFormat(com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.EncodingFormat value) {
        if (value == null) {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public interface AllowedKeyTypeOrBuilder extends
      ...
      com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.KeyTypeCase getKeyTypeCase();
    }
    /**
     * <pre>
    ...
    private static final long serialVersionUID = 0L;
      ...
      private static final long serialVersionUID = 0L;
        ...
        public static final class Builder extends
          ...
          private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.RsaKeyType result) {
            int from_bitField0_ = bitField0_;
            if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      private static final long serialVersionUID = 0L;
        ...
        @java.lang.Override public com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.EcKeyType.EcSignatureAlgorithm getSignatureAlgorithm() {
          com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.EcKeyType.EcSignatureAlgorithm result = com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.EcKeyType.EcSignatureAlgorithm.forNumber(signatureAlgorithm_);
        ...
        public static final class Builder extends
          ...
          private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.EcKeyType result) {
            int from_bitField0_ = bitField0_;
            if (((from_bitField0_ & 0x00000001) != 0)) {
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType result) {
          int from_bitField0_ = bitField0_;
        }

        private void buildPartialOneofs(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType result) {
          ...
          try {
            ...
            while (!done) {
              ...
              switch (tag) {
                ...
                case 18: {
                  input.readMessage(
                      getEllipticCurveFieldBuilder().getBuilder(),
                      extensionRegistry);
                  keyTypeCase_ = 2;
                  break;
                } // case 18
    ...
    private static final long serialVersionUID = 0L;
      ...
      public static final class Builder extends
        ...
        private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.IssuanceModes result) {
          int from_bitField0_ = bitField0_;
          if (((from_bitField0_ & 0x00000001) != 0)) {
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy result) {
        if (allowedKeyTypesBuilder_ == null) {
          if (((bitField0_ & 0x00000001) != 0)) {
      ...
      private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy result) {
        int from_bitField0_ = bitField0_;
        int to_bitField0_ = 0;
        if (((from_bitField0_ & 0x00000002) != 0)) {
        ...
        if (((from_bitField0_ & 0x00000008) != 0)) {
          result.baselineValues_ = baselineValuesBuilder_ == null
              ? baselineValues_
              : baselineValuesBuilder_.build();
          to_bitField0_ |= 0x00000004;
        }
        if (((from_bitField0_ & 0x00000010) != 0)) {
          result.identityConstraints_ = identityConstraintsBuilder_ == null
              ? identityConstraints_
              : identityConstraintsBuilder_.build();
          to_bitField0_ |= 0x00000008;
        }
        if (((from_bitField0_ & 0x00000020) != 0)) {
          result.passthroughExtensions_ = passthroughExtensionsBuilder_ == null
            ...
            switch (tag) {
              ...
              case 10: {
                com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType m =
                    input.readMessage(
                        com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.AllowedKeyType.parser(),
                        extensionRegistry);
                if (allowedKeyTypesBuilder_ == null) {
                  ensureAllowedKeyTypesIsMutable();
              ...
              case 34: {
                input.readMessage(
                    getBaselineValuesFieldBuilder().getBuilder(),
                    extensionRegistry);
              ...
              case 42: {
                input.readMessage(
                    getIdentityConstraintsFieldBuilder().getBuilder(),
                    extensionRegistry);
              ...
              case 50: {
                input.readMessage(
                    getPassthroughExtensionsFieldBuilder().getBuilder(),
                    extensionRegistry);
      ...
      public Builder mergeAllowedIssuanceModes(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.IssuanceModes value) {
        if (allowedIssuanceModesBuilder_ == null) {
          if (((bitField0_ & 0x00000004) != 0) &&
            allowedIssuanceModes_ != null &&
            allowedIssuanceModes_ != com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.IssuanceModes.getDefaultInstance()) {
      ...
      public Builder mergeBaselineValues(com.google.cloud.security.privateca.v1.X509Parameters value) {
        if (baselineValuesBuilder_ == null) {
          if (((bitField0_ & 0x00000008) != 0) &&
            baselineValues_ != null &&
            baselineValues_ != com.google.cloud.security.privateca.v1.X509Parameters.getDefaultInstance()) {
      ...
      public Builder mergeIdentityConstraints(com.google.cloud.security.privateca.v1.CertificateIdentityConstraints value) {
        if (identityConstraintsBuilder_ == null) {
          if (((bitField0_ & 0x00000010) != 0) &&
            identityConstraints_ != null &&
            identityConstraints_ != com.google.cloud.security.privateca.v1.CertificateIdentityConstraints.getDefaultInstance()) {
      ...
      public Builder mergePassthroughExtensions(com.google.cloud.security.privateca.v1.CertificateExtensionConstraints value) {
        if (passthroughExtensionsBuilder_ == null) {
          if (((bitField0_ & 0x00000020) != 0) &&
            passthroughExtensions_ != null &&
            passthroughExtensions_ != com.google.cloud.security.privateca.v1.CertificateExtensionConstraints.getDefaultInstance()) {
...
java.lang.String defaultValue) {
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.security.privateca.v1.CaPool result) {
      ...
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.issuancePolicy_ = issuancePolicyBuilder_ == null
            ? issuancePolicy_
            : issuancePolicyBuilder_.build();
        to_bitField0_ |= 0x00000001;
      }
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.publishingOptions_ = publishingOptionsBuilder_ == null
            ? publishingOptions_
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getIssuancePolicyFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000004;
              break;
            } // case 26
            case 34: {
              input.readMessage(
                  getPublishingOptionsFieldBuilder().getBuilder(),
                  extensionRegistry);
              bitField0_ |= 0x00000008;
              break;
            } // case 34
    ...
    public Builder mergeIssuancePolicy(com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy value) {
      if (issuancePolicyBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          issuancePolicy_ != null &&
          issuancePolicy_ != com.google.cloud.security.privateca.v1.CaPool.IssuancePolicy.getDefaultInstance()) {
    ...
    public Builder mergePublishingOptions(com.google.cloud.security.privateca.v1.CaPool.PublishingOptions value) {
      if (publishingOptionsBuilder_ == null) {
        if (((bitField0_ & 0x00000008) != 0) &&
          publishingOptions_ != null &&
          publishingOptions_ != com.google.cloud.security.privateca.v1.CaPool.PublishingOptions.getDefaultInstance()) {
