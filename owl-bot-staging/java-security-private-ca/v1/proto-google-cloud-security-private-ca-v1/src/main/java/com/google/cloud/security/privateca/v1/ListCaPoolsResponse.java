...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.security.privateca.v1.ListCaPoolsResponse result) {
      if (caPoolsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.security.privateca.v1.CaPool m =
                  input.readMessage(
                      com.google.cloud.security.privateca.v1.CaPool.parser(),
                      extensionRegistry);
              if (caPoolsBuilder_ == null) {
                ensureCaPoolsIsMutable();
                caPools_.add(m);
