...
public class PolicyTroubleshooterSettings extends ClientSettings<PolicyTroubleshooterSettings> {
  ...
  public UnaryCallSettings<TroubleshootIamPolicyRequest, TroubleshootIamPolicyResponse>
      troubleshootIamPolicySettings() {
    return ((PolicyTroubleshooterStubSettings) getStubSettings()).troubleshootIamPolicySettings();
  }

  public static final PolicyTroubleshooterSettings create(PolicyTroubleshooterStubSettings stub)
      throws IOException {
    return new PolicyTroubleshooterSettings.Builder(stub.toBuilder()).build();
  }

  /** Returns a builder for the default ExecutorProvider for this service. */
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return PolicyTroubleshooterStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return PolicyTroubleshooterStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return PolicyTroubleshooterStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return PolicyTroubleshooterStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return PolicyTroubleshooterStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return PolicyTroubleshooterStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return PolicyTroubleshooterStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected PolicyTroubleshooterSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for PolicyTroubleshooterSettings. */
  public static class Builder
      extends ClientSettings.Builder<PolicyTroubleshooterSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(PolicyTroubleshooterStubSettings.newBuilder(clientContext));
    }
    ...
    public PolicyTroubleshooterStubSettings.Builder getStubSettingsBuilder() {
      return ((PolicyTroubleshooterStubSettings.Builder) getStubSettings());
    }
    ...
    @Override
    public PolicyTroubleshooterSettings build() throws IOException {
      return new PolicyTroubleshooterSettings(this);
    }
  }
}
