...
public interface DenyPolicyExplanationOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResource explained_resources = 2;</code>
   */
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResource explained_resources = 2;</code>
   */
  com.google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResource getExplainedResources(int index);
  /**
   * <pre>
   * List of resources with IAM deny policies that were evaluated to check the
   * principal's denied permissions, with annotations to indicate how each
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResource explained_resources = 2;</code>
   */
  java.util.List<? extends com.google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResourceOrBuilder> 
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResource explained_resources = 2;</code>
   */
  com.google.cloud.policytroubleshooter.iam.v3.ExplainedDenyResourceOrBuilder getExplainedResourcesOrBuilder(
      int index);
