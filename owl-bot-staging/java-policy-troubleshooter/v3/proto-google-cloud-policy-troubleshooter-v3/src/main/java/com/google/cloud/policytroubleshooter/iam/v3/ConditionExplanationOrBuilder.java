...
public interface ConditionExplanationOrBuilder extends
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ConditionExplanation.EvaluationState evaluation_states = 2;</code>
   */
  com.google.cloud.policytroubleshooter.iam.v3.ConditionExplanation.EvaluationState getEvaluationStates(int index);
  /**
   * <pre>
   * The value of each statement of the condition expression. The value can be
   * `true`, `false`, or `null`. The value is `null` if the statement can't be
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ConditionExplanation.EvaluationState evaluation_states = 2;</code>
   */
  java.util.List<? extends com.google.cloud.policytroubleshooter.iam.v3.ConditionExplanation.EvaluationStateOrBuilder> 
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.ConditionExplanation.EvaluationState evaluation_states = 2;</code>
   */
  com.google.cloud.policytroubleshooter.iam.v3.ConditionExplanation.EvaluationStateOrBuilder getEvaluationStatesOrBuilder(
      int index);
}
