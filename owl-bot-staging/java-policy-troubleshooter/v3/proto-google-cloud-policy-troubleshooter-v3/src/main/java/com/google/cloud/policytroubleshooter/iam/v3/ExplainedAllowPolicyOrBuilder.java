...
public interface ExplainedAllowPolicyOrBuilder extends
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.AllowBindingExplanation binding_explanations = 3;</code>
   */
  com.google.cloud.policytroubleshooter.iam.v3.AllowBindingExplanation getBindingExplanations(int index);
  /**
   * <pre>
   * Details about how each role binding in the policy affects the principal's
   * ability, or inability, to use the permission for the resource. The order of
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.AllowBindingExplanation binding_explanations = 3;</code>
   */
  java.util.List<? extends com.google.cloud.policytroubleshooter.iam.v3.AllowBindingExplanationOrBuilder> 
   ...
   * <code>repeated .google.cloud.policytroubleshooter.iam.v3.AllowBindingExplanation binding_explanations = 3;</code>
   */
  com.google.cloud.policytroubleshooter.iam.v3.AllowBindingExplanationOrBuilder getBindingExplanationsOrBuilder(
      int index);
