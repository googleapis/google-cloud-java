...
public final class SshKeyProto {
  ...
  static {
    ...
    internal_static_google_cloud_baremetalsolution_v2_SSHKey_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_baremetalsolution_v2_SSHKey_descriptor,
        new java.lang.String[] { "Name", "PublicKey", });
    internal_static_google_cloud_baremetalsolution_v2_ListSSHKeysRequest_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_baremetalsolution_v2_ListSSHKeysRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_baremetalsolution_v2_ListSSHKeysRequest_descriptor,
        new java.lang.String[] { "Parent", "PageSize", "PageToken", });
    internal_static_google_cloud_baremetalsolution_v2_ListSSHKeysResponse_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_baremetalsolution_v2_ListSSHKeysResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_baremetalsolution_v2_ListSSHKeysResponse_descriptor,
        new java.lang.String[] { "SshKeys", "NextPageToken", });
    internal_static_google_cloud_baremetalsolution_v2_CreateSSHKeyRequest_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_baremetalsolution_v2_CreateSSHKeyRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_baremetalsolution_v2_CreateSSHKeyRequest_descriptor,
        new java.lang.String[] { "Parent", "SshKey", "SshKeyId", });
    internal_static_google_cloud_baremetalsolution_v2_DeleteSSHKeyRequest_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_cloud_baremetalsolution_v2_DeleteSSHKeyRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_baremetalsolution_v2_DeleteSSHKeyRequest_descriptor,
