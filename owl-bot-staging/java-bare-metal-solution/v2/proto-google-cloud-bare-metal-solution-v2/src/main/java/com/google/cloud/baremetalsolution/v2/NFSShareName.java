...
public class NFSShareName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_NFS_SHARE =
  ...
  private NFSShareName(Builder builder) {
    ...
    nfsShare = Preconditions.checkNotNull(builder.getNfsShare());
  }
  ...
  public static NFSShareName of(String project, String location, String nfsShare) {
    return newBuilder().setProject(project).setLocation(location).setNfsShare(nfsShare).build();
  }
  ...
  public static NFSShareName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_NFS_SHARE.validatedMatch(
            formattedString, "NFSShareName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("nfs_share"));
  }

  public static List<NFSShareName> parseList(List<String> formattedStrings) {
    List<NFSShareName> list = new ArrayList<>(formattedStrings.size());
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (nfsShare != null) {
            fieldMapBuilder.put("nfs_share", nfsShare);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_NFS_SHARE.instantiate(
        "project", project, "location", location, "nfs_share", nfsShare);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.nfsShare, that.nfsShare);
    }
    return false;
  }
