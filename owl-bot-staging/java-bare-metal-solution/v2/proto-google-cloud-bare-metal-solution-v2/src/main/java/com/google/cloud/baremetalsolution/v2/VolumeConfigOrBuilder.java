...
public interface VolumeConfigOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.baremetalsolution.v2.VolumeConfig.LunRange> 
      getLunRangesList();
  /**
   * <pre>
   * LUN ranges to be configured. Set only when protocol is PROTOCOL_FC.
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.baremetalsolution.v2.VolumeConfig.NfsExport nfs_exports = 9;</code>
   */
  java.util.List<com.google.cloud.baremetalsolution.v2.VolumeConfig.NfsExport> 
      getNfsExportsList();
  /**
   * <pre>
   * NFS exports. Set only when protocol is PROTOCOL_NFS.
