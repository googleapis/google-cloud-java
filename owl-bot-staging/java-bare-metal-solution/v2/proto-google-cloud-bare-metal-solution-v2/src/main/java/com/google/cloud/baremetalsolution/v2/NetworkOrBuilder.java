...
java.lang.String defaultValue);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.baremetalsolution.v2.NetworkMountPoint mount_points = 15 [(.google.api.field_behavior) = INPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.baremetalsolution.v2.NetworkMountPoint> 
      getMountPointsList();
  /**
   * <pre>
   * Input only. List of mount points to attach the network to.
