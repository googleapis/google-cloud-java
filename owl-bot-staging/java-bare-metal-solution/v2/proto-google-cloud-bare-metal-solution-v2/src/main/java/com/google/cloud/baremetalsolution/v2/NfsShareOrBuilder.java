...
public interface NfsShareOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.baremetalsolution.v2.NfsShare.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>string volume = 4 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }</code>
   * @return The volume.
   */
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.baremetalsolution.v2.NfsShare.AllowedClient allowed_clients = 5;</code>
   */
...
java.lang.String defaultValue);
   ...
   * </pre>
   *
   * <code>.google.cloud.baremetalsolution.v2.NfsShare.StorageType storage_type = 9 [(.google.api.field_behavior) = IMMUTABLE];</code>
