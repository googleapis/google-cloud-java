...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(7, insecureKubeletReadonlyPortEnabled_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasInsecureKubeletReadonlyPortEnabled() != other.hasInsecureKubeletReadonlyPortEnabled()) return false;
    if (hasInsecureKubeletReadonlyPortEnabled()) {
      if (getInsecureKubeletReadonlyPortEnabled()
          != other.getInsecureKubeletReadonlyPortEnabled()) return false;
    }
