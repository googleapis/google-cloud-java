...
public interface DatabaseEncryptionOrBuilder extends
   ...
   * </pre>
   *
   * <code>optional .google.container.v1.DatabaseEncryption.CurrentState current_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.container.v1.DatabaseEncryption.OperationError last_operation_errors = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * <code>repeated .google.container.v1.DatabaseEncryption.OperationError last_operation_errors = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.container.v1.DatabaseEncryption.OperationErrorOrBuilder getLastOperationErrorsOrBuilder(
      int index);
}
