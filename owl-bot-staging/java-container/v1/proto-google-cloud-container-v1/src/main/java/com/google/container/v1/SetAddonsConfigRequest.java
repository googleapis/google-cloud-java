...
private static final long serialVersionUID = 0L;
   ...
   *     See google/container/v1/cluster_service.proto;l=2861
   ...
   *     See google/container/v1/cluster_service.proto;l=2867
   * @return The zone.
   */
  @java.lang.Override
   ...
   *     See google/container/v1/cluster_service.proto;l=2871
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.container.v1.SetAddonsConfigRequest result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.addonsConfig_ = addonsConfigBuilder_ == null
            ? addonsConfig_
            : addonsConfigBuilder_.build();
      }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getAddonsConfigFieldBuilder().getBuilder(),
                  extensionRegistry);
