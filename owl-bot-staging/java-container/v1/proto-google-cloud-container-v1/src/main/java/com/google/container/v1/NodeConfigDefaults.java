      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            loggingConfig_ = input.readMessage(com.google.container.v1.NodePoolLoggingConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeLoggingConfig(com.google.container.v1.NodePoolLoggingConfig value) {
      if (loggingConfigBuilder_ == null) {
        if (loggingConfig_ != null) {
          loggingConfig_ =
            com.google.container.v1.NodePoolLoggingConfig.newBuilder(loggingConfig_).mergeFrom(value).buildPartial();
        } else {
          loggingConfig_ = value;
        }
        onChanged();
