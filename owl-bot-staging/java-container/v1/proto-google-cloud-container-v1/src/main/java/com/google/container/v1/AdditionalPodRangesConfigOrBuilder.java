...
public interface AdditionalPodRangesConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.container.v1.RangeInfo pod_range_info = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.container.v1.RangeInfo> 
      getPodRangeInfoList();
  /**
   * <pre>
   * Output only. [Output only] Information for additional pod range.
   ...
   * <code>repeated .google.container.v1.RangeInfo pod_range_info = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.container.v1.RangeInfoOrBuilder getPodRangeInfoOrBuilder(
      int index);
}
