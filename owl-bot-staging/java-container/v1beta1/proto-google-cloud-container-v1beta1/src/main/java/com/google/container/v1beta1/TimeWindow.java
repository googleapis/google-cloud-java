...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.container.v1beta1.TimeWindow result) {
    ...
    private void buildPartialOneofs(com.google.container.v1beta1.TimeWindow result) {
      result.optionsCase_ = optionsCase_;
      result.options_ = this.options_;
      if (optionsCase_ == 3 &&
          maintenanceExclusionOptionsBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getMaintenanceExclusionOptionsFieldBuilder().getBuilder(),
                  extensionRegistry);
              optionsCase_ = 3;
              break;
            } // case 26
