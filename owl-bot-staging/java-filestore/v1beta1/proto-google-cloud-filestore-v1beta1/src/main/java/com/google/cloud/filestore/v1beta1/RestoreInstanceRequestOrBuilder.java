...
public interface RestoreInstanceRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>string source_snapshot = 3 [deprecated = true, (.google.api.resource_reference) = { ... }</code>
   * @deprecated google.cloud.filestore.v1beta1.RestoreInstanceRequest.source_snapshot is deprecated.
   *     See google/cloud/filestore/v1beta1/cloud_filestore_service.proto;l=773
   * @return Whether the sourceSnapshot field is set.
   */
  @java.lang.Deprecated boolean hasSourceSnapshot();
  /**
   * <pre>
   * The resource name of the snapshot, in the format
   * `projects/{project_id}/locations/{location_id}/snapshots/{snapshot_id}`.
   ...
   */
  @java.lang.Deprecated java.lang.String getSourceSnapshot();
  /**
   * <pre>
   * The resource name of the snapshot, in the format
   * `projects/{project_id}/locations/{location_id}/snapshots/{snapshot_id}`.
