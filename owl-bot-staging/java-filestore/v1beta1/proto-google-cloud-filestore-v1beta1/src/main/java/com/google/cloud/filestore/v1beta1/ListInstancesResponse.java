...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.filestore.v1beta1.ListInstancesResponse result) {
      if (instancesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.filestore.v1beta1.Instance m =
                  input.readMessage(
                      com.google.cloud.filestore.v1beta1.Instance.parser(),
                      extensionRegistry);
              if (instancesBuilder_ == null) {
                ensureInstancesIsMutable();
                instances_.add(m);
