...
java.lang.String defaultValue);
   ...
   */
  java.util.List<com.google.cloud.filestore.v1beta1.Instance.SuspensionReason> getSuspensionReasonsList();
  /**
   * <pre>
   * Output only. Field indicates all the reasons the instance is in "SUSPENDED"
   * state.
   ...
   * <code>.google.cloud.filestore.v1beta1.DirectoryServicesConfig directory_services = 24;</code>
   */
  com.google.cloud.filestore.v1beta1.DirectoryServicesConfigOrBuilder getDirectoryServicesOrBuilder();
}
