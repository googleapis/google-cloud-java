...
java.lang.String defaultValue);
   ...
   */
  java.util.List<com.google.cloud.filestore.v1.FileShareConfig> 
      getFileSharesList();
  /**
   * <pre>
   * File system shares on the instance.
   ...
   */
  java.util.List<com.google.cloud.filestore.v1.NetworkConfig> 
      getNetworksList();
  /**
   * <pre>
   * VPC networks to which the instance is connected.
   ...
   */
  java.util.List<com.google.cloud.filestore.v1.Instance.SuspensionReason> getSuspensionReasonsList();
  /**
   * <pre>
   * Output only. Field indicates all the reasons the instance is in "SUSPENDED"
   * state.
