...
public interface MetadataImportOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1alpha.MetadataImport)
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1alpha.MetadataImport.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
