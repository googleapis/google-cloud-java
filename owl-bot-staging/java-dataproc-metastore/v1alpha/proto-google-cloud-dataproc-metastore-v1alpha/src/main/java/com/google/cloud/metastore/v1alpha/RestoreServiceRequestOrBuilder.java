...
public interface RestoreServiceRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1alpha.RestoreServiceRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1alpha.Restore.RestoreType restore_type = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.cloud.metastore.v1alpha.Restore.RestoreType getRestoreType();
