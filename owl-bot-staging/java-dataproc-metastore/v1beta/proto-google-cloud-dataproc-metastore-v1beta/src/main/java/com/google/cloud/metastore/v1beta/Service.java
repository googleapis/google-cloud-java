...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.cloud.metastore.v1beta.Service.DatabaseType getDatabaseType() {
    @SuppressWarnings("deprecation")
    com.google.cloud.metastore.v1beta.Service.DatabaseType result = com.google.cloud.metastore.v1beta.Service.DatabaseType.valueOf(databaseType_);
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeEncryptionConfig(com.google.cloud.metastore.v1beta.EncryptionConfig value) {
      if (encryptionConfigBuilder_ == null) {
        if (encryptionConfig_ != null) {
          encryptionConfig_ =
            com.google.cloud.metastore.v1beta.EncryptionConfig.newBuilder(encryptionConfig_).mergeFrom(value).buildPartial();
        } else {
          encryptionConfig_ = value;
        }
        onChanged();
    ...
    public Builder mergeNetworkConfig(com.google.cloud.metastore.v1beta.NetworkConfig value) {
      if (networkConfigBuilder_ == null) {
        if (networkConfig_ != null) {
          networkConfig_ =
            com.google.cloud.metastore.v1beta.NetworkConfig.newBuilder(networkConfig_).mergeFrom(value).buildPartial();
        } else {
          networkConfig_ = value;
        }
        onChanged();
    ...
    public Builder mergeTelemetryConfig(com.google.cloud.metastore.v1beta.TelemetryConfig value) {
      if (telemetryConfigBuilder_ == null) {
        if (telemetryConfig_ != null) {
          telemetryConfig_ =
            com.google.cloud.metastore.v1beta.TelemetryConfig.newBuilder(telemetryConfig_).mergeFrom(value).buildPartial();
        } else {
          telemetryConfig_ = value;
        }
        onChanged();
