...
public interface MetadataExportOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1.MetadataExport)
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1.MetadataExport.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1.DatabaseDumpSpec.Type database_dump_type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
