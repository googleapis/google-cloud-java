...
public interface RestoreOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1.Restore)
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1.Restore.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The state.
   */
  com.google.cloud.metastore.v1.Restore.State getState();
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1.Restore.RestoreType type = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The type.
   */
  com.google.cloud.metastore.v1.Restore.RestoreType getType();
