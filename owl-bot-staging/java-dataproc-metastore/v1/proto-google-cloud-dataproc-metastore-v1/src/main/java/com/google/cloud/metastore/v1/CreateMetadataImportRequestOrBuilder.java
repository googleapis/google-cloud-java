...
public interface CreateMetadataImportRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.metastore.v1.CreateMetadataImportRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.metastore.v1.MetadataImport metadata_import = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.metastore.v1.MetadataImport metadata_import = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.metastore.v1.MetadataImportOrBuilder getMetadataImportOrBuilder();
