 ...
 * </pre>
 *
 * Protobuf type {@code google.cloud.run.v2.ListJobsResponse}
 */
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.run.v2.JobProto.internal_static_google_cloud_run_v2_ListJobsResponse_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.run.v2.JobProto.internal_static_google_cloud_run_v2_ListJobsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.run.v2.ListJobsResponse.class, com.google.cloud.run.v2.ListJobsResponse.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.cloud.run.v2.JobOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.google.cloud.run.v2.JobOrBuilder getJobsOrBuilder(
      int index) {
    return jobs_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.cloud.run.v2.ListJobsResponse)) {
      return super.equals(obj);
    }
    com.google.cloud.run.v2.ListJobsResponse other = (com.google.cloud.run.v2.ListJobsResponse) obj;
  ...
  public static com.google.cloud.run.v2.ListJobsResponse parseFrom(
  ...
  public static com.google.cloud.run.v2.ListJobsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.google.cloud.run.v2.ListJobsResponse parseFrom(
  ...
  public static com.google.cloud.run.v2.ListJobsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.run.v2.ListJobsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.google.cloud.run.v2.ListJobsResponse parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.cloud.run.v2.ListJobsResponse prototype) {
  ...
  public static final class Builder extends
      ...
      // @@protoc_insertion_point(builder_implements:google.cloud.run.v2.ListJobsResponse)
    ...
    // Construct using com.google.cloud.run.v2.ListJobsResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.google.cloud.run.v2.ListJobsResponse getDefaultInstanceForType() {
      return com.google.cloud.run.v2.ListJobsResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.run.v2.ListJobsResponse build() {
      com.google.cloud.run.v2.ListJobsResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.google.cloud.run.v2.ListJobsResponse buildPartial() {
      com.google.cloud.run.v2.ListJobsResponse result = new com.google.cloud.run.v2.ListJobsResponse(this);
    ...
    private void buildPartialRepeatedFields(com.google.cloud.run.v2.ListJobsResponse result) {
      if (jobsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.cloud.run.v2.ListJobsResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.run.v2.ListJobsResponse) {
        return mergeFrom((com.google.cloud.run.v2.ListJobsResponse)other);
      } else {
    ...
    public Builder mergeFrom(com.google.cloud.run.v2.ListJobsResponse other) {
      if (other == com.google.cloud.run.v2.ListJobsResponse.getDefaultInstance()) return this;
      if (jobsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.run.v2.Job m =
                  input.readMessage(
                      com.google.cloud.run.v2.Job.parser(),
                      extensionRegistry);
              if (jobsBuilder_ == null) {
                ensureJobsIsMutable();
                jobs_.add(m);
    ...
    private void ensureJobsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        jobs_ = new java.util.ArrayList<com.google.cloud.run.v2.Job>(jobs_);
    ...
    public Builder setJobs(
        int index, com.google.cloud.run.v2.Job value) {
      if (jobsBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder setJobs(
        int index, com.google.cloud.run.v2.Job.Builder builderForValue) {
      if (jobsBuilder_ == null) {
        ensureJobsIsMutable();
     ...
     * <code>repeated .google.cloud.run.v2.Job jobs = 1;</code>
     */
    public Builder addJobs(com.google.cloud.run.v2.Job value) {
      if (jobsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllJobs(
        java.lang.Iterable<? extends com.google.cloud.run.v2.Job> values) {
      if (jobsBuilder_ == null) {
        ensureJobsIsMutable();
     ...
     * <code>repeated .google.cloud.run.v2.Job jobs = 1;</code>
     */
    public com.google.cloud.run.v2.Job.Builder getJobsBuilder(
        int index) {
    ...
    public com.google.cloud.run.v2.Job.Builder addJobsBuilder(
        int index) {
      return getJobsFieldBuilder().addBuilder(
          index, com.google.cloud.run.v2.Job.getDefaultInstance());
    }
    /**
     * <pre>
     * The resulting list of Jobs.
     ...
     * <code>repeated .google.cloud.run.v2.Job jobs = 1;</code>
     */
    public java.util.List<com.google.cloud.run.v2.Job.Builder> 
         getJobsBuilderList() {
    ...
    // @@protoc_insertion_point(builder_scope:google.cloud.run.v2.ListJobsResponse)
  }

  // @@protoc_insertion_point(class_scope:google.cloud.run.v2.ListJobsResponse)
  private static final com.google.cloud.run.v2.ListJobsResponse DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.google.cloud.run.v2.ListJobsResponse();
  }

  public static com.google.cloud.run.v2.ListJobsResponse getDefaultInstance() {
