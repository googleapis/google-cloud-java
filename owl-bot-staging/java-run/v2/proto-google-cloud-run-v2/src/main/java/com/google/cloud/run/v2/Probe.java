...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (probeTypeCase_ == 7) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(7, (com.google.cloud.run.v2.GRPCAction) probeType_);
    }
  ...
  public static final class Builder extends
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.run.v2.HTTPGetAction, com.google.cloud.run.v2.HTTPGetAction.Builder, com.google.cloud.run.v2.HTTPGetActionOrBuilder> httpGetBuilder_;
    /**
     * <pre>
     * HTTPGet specifies the http request to perform.
     * Exactly one of httpGet, tcpSocket, or grpc must be specified.
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.run.v2.GRPCAction, com.google.cloud.run.v2.GRPCAction.Builder, com.google.cloud.run.v2.GRPCActionOrBuilder> grpcBuilder_;
    /**
     * <pre>
     * GRPC specifies an action involving a gRPC port.
     * Exactly one of httpGet, tcpSocket, or grpc must be specified.
    ...
    public Builder setGrpc(
        com.google.cloud.run.v2.GRPCAction.Builder builderForValue) {
      if (grpcBuilder_ == null) {
        probeType_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeGrpc(com.google.cloud.run.v2.GRPCAction value) {
      if (grpcBuilder_ == null) {
        if (probeTypeCase_ == 7 &&
          ...
          probeType_ = com.google.cloud.run.v2.GRPCAction.newBuilder((com.google.cloud.run.v2.GRPCAction) probeType_)
              .mergeFrom(value).buildPartial();
        } else {
          probeType_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.run.v2.GRPCAction, com.google.cloud.run.v2.GRPCAction.Builder, com.google.cloud.run.v2.GRPCActionOrBuilder> 
        getGrpcFieldBuilder() {
      if (grpcBuilder_ == null) {
        if (!(probeTypeCase_ == 7)) {
          probeType_ = com.google.cloud.run.v2.GRPCAction.getDefaultInstance();
