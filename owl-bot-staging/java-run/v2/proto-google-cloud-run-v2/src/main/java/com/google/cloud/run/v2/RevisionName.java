...
public class RevisionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_SERVICE_REVISION =
  ...
  public static RevisionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_SERVICE_REVISION.validatedMatch(
  ...
  public String toString() {
    return PROJECT_LOCATION_SERVICE_REVISION.instantiate(
