...
public final class TasksGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.run.v2.GetTaskRequest,
      com.google.cloud.run.v2.Task> getGetTaskMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.run.v2.GetTaskRequest,
      com.google.cloud.run.v2.Task> getGetTaskMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.run.v2.GetTaskRequest, com.google.cloud.run.v2.Task> getGetTaskMethod;
      ...
      synchronized (TasksGrpc.class) {
        if ((getGetTaskMethod = TasksGrpc.getGetTaskMethod) == null) {
          TasksGrpc.getGetTaskMethod = getGetTaskMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.run.v2.GetTaskRequest, com.google.cloud.run.v2.Task>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.run.v2.ListTasksRequest,
      com.google.cloud.run.v2.ListTasksResponse> getListTasksMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.run.v2.ListTasksRequest,
      com.google.cloud.run.v2.ListTasksResponse> getListTasksMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.run.v2.ListTasksRequest, com.google.cloud.run.v2.ListTasksResponse> getListTasksMethod;
    if ((getListTasksMethod = TasksGrpc.getListTasksMethod) == null) {
      synchronized (TasksGrpc.class) {
        if ((getListTasksMethod = TasksGrpc.getListTasksMethod) == null) {
          TasksGrpc.getListTasksMethod = getListTasksMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.run.v2.ListTasksRequest, com.google.cloud.run.v2.ListTasksResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  public static abstract class TasksImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getTask(com.google.cloud.run.v2.GetTaskRequest request,
     ...
     * </pre>
     */
    public void listTasks(com.google.cloud.run.v2.ListTasksRequest request,
   ...
   * </pre>
   */
  public static final class TasksBlockingStub extends io.grpc.stub.AbstractBlockingStub<TasksBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.run.v2.ListTasksResponse listTasks(com.google.cloud.run.v2.ListTasksRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
   ...
   * </pre>
   */
  public static final class TasksFutureStub extends io.grpc.stub.AbstractFutureStub<TasksFutureStub> {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_TASK:
          serviceImpl.getTask((com.google.cloud.run.v2.GetTaskRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.run.v2.Task>) responseObserver);
          break;
        case METHODID_LIST_TASKS:
          serviceImpl.listTasks((com.google.cloud.run.v2.ListTasksRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.run.v2.ListTasksResponse>) responseObserver);
          break;
        default:
