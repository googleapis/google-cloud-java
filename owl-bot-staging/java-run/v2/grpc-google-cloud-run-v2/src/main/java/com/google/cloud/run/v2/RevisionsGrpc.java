...
public final class RevisionsGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.run.v2.GetRevisionRequest,
      com.google.cloud.run.v2.Revision> getGetRevisionMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.run.v2.GetRevisionRequest,
      com.google.cloud.run.v2.Revision> getGetRevisionMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.run.v2.GetRevisionRequest, com.google.cloud.run.v2.Revision> getGetRevisionMethod;
    if ((getGetRevisionMethod = RevisionsGrpc.getGetRevisionMethod) == null) {
      synchronized (RevisionsGrpc.class) {
        if ((getGetRevisionMethod = RevisionsGrpc.getGetRevisionMethod) == null) {
          RevisionsGrpc.getGetRevisionMethod = getGetRevisionMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.run.v2.GetRevisionRequest, com.google.cloud.run.v2.Revision>newBuilder()
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.run.v2.ListRevisionsRequest,
      com.google.cloud.run.v2.ListRevisionsResponse> getListRevisionsMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.run.v2.ListRevisionsRequest,
      com.google.cloud.run.v2.ListRevisionsResponse> getListRevisionsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.run.v2.ListRevisionsRequest, com.google.cloud.run.v2.ListRevisionsResponse> getListRevisionsMethod;
    if ((getListRevisionsMethod = RevisionsGrpc.getListRevisionsMethod) == null) {
      synchronized (RevisionsGrpc.class) {
        if ((getListRevisionsMethod = RevisionsGrpc.getListRevisionsMethod) == null) {
          RevisionsGrpc.getListRevisionsMethod = getListRevisionsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.run.v2.ListRevisionsRequest, com.google.cloud.run.v2.ListRevisionsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.run.v2.DeleteRevisionRequest,
      com.google.longrunning.Operation> getDeleteRevisionMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.run.v2.DeleteRevisionRequest,
      com.google.longrunning.Operation> getDeleteRevisionMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.run.v2.DeleteRevisionRequest, com.google.longrunning.Operation> getDeleteRevisionMethod;
    if ((getDeleteRevisionMethod = RevisionsGrpc.getDeleteRevisionMethod) == null) {
      synchronized (RevisionsGrpc.class) {
        if ((getDeleteRevisionMethod = RevisionsGrpc.getDeleteRevisionMethod) == null) {
          RevisionsGrpc.getDeleteRevisionMethod = getDeleteRevisionMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.run.v2.DeleteRevisionRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
   ...
   */
  public static RevisionsBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<RevisionsBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<RevisionsBlockingStub>() {
        @java.lang.Override
        public RevisionsBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static RevisionsFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<RevisionsFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<RevisionsFutureStub>() {
        @java.lang.Override
        public RevisionsFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getRevision(com.google.cloud.run.v2.GetRevisionRequest request,
     ...
     * </pre>
     */
    default void listRevisions(com.google.cloud.run.v2.ListRevisionsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.run.v2.ListRevisionsResponse> responseObserver) {
     ...
     * </pre>
     */
    default void deleteRevision(com.google.cloud.run.v2.DeleteRevisionRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteRevisionMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class RevisionsImplBase
   ...
   * </pre>
   */
  public static final class RevisionsStub
      extends io.grpc.stub.AbstractAsyncStub<RevisionsStub> {
    private RevisionsStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RevisionsStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RevisionsStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public void getRevision(com.google.cloud.run.v2.GetRevisionRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.run.v2.Revision> responseObserver) {
     ...
     * </pre>
     */
    public void listRevisions(com.google.cloud.run.v2.ListRevisionsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.run.v2.ListRevisionsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
     ...
     * </pre>
     */
    public void deleteRevision(com.google.cloud.run.v2.DeleteRevisionRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteRevisionMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class RevisionsBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.run.v2.Revision getRevision(com.google.cloud.run.v2.GetRevisionRequest request) {
     ...
     * </pre>
     */
    public com.google.cloud.run.v2.ListRevisionsResponse listRevisions(com.google.cloud.run.v2.ListRevisionsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
     ...
     * </pre>
     */
    public com.google.longrunning.Operation deleteRevision(com.google.cloud.run.v2.DeleteRevisionRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class RevisionsFutureStub
    ...
    private RevisionsFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RevisionsFutureStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RevisionsFutureStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.run.v2.Revision> getRevision(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.run.v2.ListRevisionsResponse> listRevisions(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation> deleteRevision(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_REVISION:
          serviceImpl.getRevision((com.google.cloud.run.v2.GetRevisionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.run.v2.Revision>) responseObserver);
          break;
        case METHODID_LIST_REVISIONS:
          serviceImpl.listRevisions((com.google.cloud.run.v2.ListRevisionsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.run.v2.ListRevisionsResponse>) responseObserver);
          break;
        case METHODID_DELETE_REVISION:
          serviceImpl.deleteRevision((com.google.cloud.run.v2.DeleteRevisionRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.google.longrunning.Operation>(
                service, METHODID_DELETE_REVISION)))
        .build();
  }

  private static abstract class RevisionsBaseDescriptorSupplier
