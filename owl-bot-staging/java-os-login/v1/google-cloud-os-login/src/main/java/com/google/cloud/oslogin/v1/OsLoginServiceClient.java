 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>deletePosixAccount(PosixAccountName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>deleteSshPublicKey(SshPublicKeyName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getSshPublicKey(SshPublicKeyName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>updateSshPublicKey(SshPublicKeyName name, OsLoginProto.SshPublicKey sshPublicKey)
 *           <li>updateSshPublicKey(String name, OsLoginProto.SshPublicKey sshPublicKey)
 *           <li>updateSshPublicKey(SshPublicKeyName name, OsLoginProto.SshPublicKey sshPublicKey, FieldMask updateMask)
