 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> deletePosixAccount(PosixAccountName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> deleteSshPublicKey(SshPublicKeyName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> getSshPublicKey(SshPublicKeyName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> updateSshPublicKey(SshPublicKeyName name, OsLoginProto.SshPublicKey sshPublicKey)
 *           <li><p> updateSshPublicKey(String name, OsLoginProto.SshPublicKey sshPublicKey)
 *           <li><p> updateSshPublicKey(SshPublicKeyName name, OsLoginProto.SshPublicKey sshPublicKey, FieldMask updateMask)
