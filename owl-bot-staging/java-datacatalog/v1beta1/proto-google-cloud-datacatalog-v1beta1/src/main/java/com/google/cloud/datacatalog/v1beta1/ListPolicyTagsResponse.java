        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              policyTags_ = new java.util.ArrayList<com.google.cloud.datacatalog.v1beta1.PolicyTag>();
              mutable_bitField0_ |= 0x00000001;
            }
            policyTags_.add(
                input.readMessage(com.google.cloud.datacatalog.v1beta1.PolicyTag.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.datacatalog.v1beta1.ListPolicyTagsResponse) e.getUnfinishedMessage();
