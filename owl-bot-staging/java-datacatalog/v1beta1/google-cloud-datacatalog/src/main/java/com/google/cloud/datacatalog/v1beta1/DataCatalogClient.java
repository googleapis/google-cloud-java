 ...
 *    <tr>
 *      <td>SearchCatalog</td>
 *      <td><p>Searches Data Catalog for multiple resources like entries, tags that
 *  match a query.
 *
 ...
 *      <td><p>A maximum of 10,000 entry groups may be created per organization across all
 *  locations.
 *
 ...
 *      <td><p>Updates an EntryGroup. The user should enable the Data Catalog API in the
 ...
 *      <td><p>Deletes an EntryGroup. Only entry groups that do not contain entries can be
 ...
 *    <tr>
 *      <td>CreateEntry</td>
 *      <td><p>Creates an entry. Only entries of 'FILESET' type or user-specified type can
 *  be created.
 *
 *  Users should enable the Data Catalog API in the project identified by
 *  the `parent` parameter (see [Data Catalog Resource Project]
 ...
 *  more information).
 *
 *  A maximum of 100,000 entries may be created per entry group.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>DeleteEntry</td>
 *      <td><p>Deletes an existing entry. Only entries created through
 ...
 *    <tr>
 *      <td>LookupEntry</td>
 *      <td><p>Get an entry by target resource name. This method allows clients to use
 *  the resource name from the source Google Cloud Platform service to get the
 *  Data Catalog Entry.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Creates a tag template. The user should enable the Data Catalog API in
 ...
 *      <td><p>Updates a tag template. This method cannot be used to update the fields of
 ...
 *      <td><p>Deletes a tag template and all tags using the template.
 *  Users should enable the Data Catalog API in the project identified by
 *  the `name` parameter (see [Data Catalog Resource Project]
 *  (https://cloud.google.com/data-catalog/docs/concepts/resource-project) for
 *  more information).</p></td>
 ...
 *      <td><p>Creates a field in a tag template. The user should enable the Data Catalog
 ...
 *      <td><p>Updates a field in a tag template. This method cannot be used to update the
 ...
 *      <td><p>Renames a field in a tag template. The user should enable the Data Catalog
 ...
 *      <td><p>Renames an enum value in a tag template. The enum values have to be unique
 *  within one enum field. Thus, an enum value cannot be renamed with a name
 *  used in any other enum value within the same enum field.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Deletes a field in a tag template and all uses of that field.
 *  Users should enable the Data Catalog API in the project identified by
 *  the `name` parameter (see [Data Catalog Resource Project]
 *  (https://cloud.google.com/data-catalog/docs/concepts/resource-project) for
 *  more information).</p></td>
 ...
 *    <tr>
 *      <td>CreateTag</td>
 *      <td><p>Creates a tag on an [Entry][google.cloud.datacatalog.v1beta1.Entry].
 *  Note: The project identified by the `parent` parameter for the
 *  [tag](https://cloud.google.com/data-catalog/docs/reference/rest/v1beta1/projects.locations.entryGroups.entries.tags/create#path-parameters)
 *  and the
 *  [tag
 *  template](https://cloud.google.com/data-catalog/docs/reference/rest/v1beta1/projects.locations.tagTemplates/create#path-parameters)
 *  used to create the tag must be from the same organization.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>ListTags</td>
 *      <td><p>Lists tags assigned to an [Entry][google.cloud.datacatalog.v1beta1.Entry].
 ...
 *    <tr>
 *      <td>GetIamPolicy</td>
 *      <td><p>Gets the access control policy for a resource. A `NOT_FOUND` error
