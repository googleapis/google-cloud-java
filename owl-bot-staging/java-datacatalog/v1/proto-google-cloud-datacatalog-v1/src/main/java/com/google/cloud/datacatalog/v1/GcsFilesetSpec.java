        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              sampleGcsFileSpecs_ = new java.util.ArrayList<com.google.cloud.datacatalog.v1.GcsFileSpec>();
              mutable_bitField0_ |= 0x00000002;
            }
            sampleGcsFileSpecs_.add(
                input.readMessage(com.google.cloud.datacatalog.v1.GcsFileSpec.parser(), extensionRegistry));
            break;
          }
          default: {
