...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(parentInstanceDisplayName_)) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(2, parentInstanceDisplayName_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(parentModelId_)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.datacatalog.v1.LookerSystemSpec other = (com.google.cloud.datacatalog.v1.LookerSystemSpec) obj;

    if (!getParentInstanceId()
        .equals(other.getParentInstanceId())) return false;
    if (!getParentInstanceDisplayName()
        .equals(other.getParentInstanceDisplayName())) return false;
    if (!getParentModelId()
        .equals(other.getParentModelId())) return false;
    if (!getParentModelDisplayName()
        .equals(other.getParentModelDisplayName())) return false;
    if (!getParentViewId()
        .equals(other.getParentViewId())) return false;
    if (!getParentViewDisplayName()
        .equals(other.getParentViewDisplayName())) return false;
  ...
  public static com.google.cloud.datacatalog.v1.LookerSystemSpec parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.datacatalog.v1.LookerSystemSpec parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
     ...
     */
    public Builder setParentInstanceId(
     ...
     * @return This builder for chaining.
     */
    public Builder setParentInstanceIdBytes(
     ...
     * @return This builder for chaining.
     */
    public Builder setParentInstanceDisplayName(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
     ...
     * @return This builder for chaining.
     */
    public Builder setParentInstanceDisplayNameBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      parentInstanceDisplayName_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setParentModelId(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
     ...
     * @return This builder for chaining.
     */
    public Builder setParentModelIdBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      parentModelId_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setParentModelDisplayName(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
     ...
     * @return This builder for chaining.
     */
    public Builder setParentModelDisplayNameBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      parentModelDisplayName_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setParentViewId(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      parentViewId_ = value;
      bitField0_ |= 0x00000010;
     ...
     * @return This builder for chaining.
     */
    public Builder setParentViewIdBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      parentViewId_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setParentViewDisplayName(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
     ...
     * @return This builder for chaining.
     */
    public Builder setParentViewDisplayNameBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      parentViewDisplayName_ = value;
  ...
  private static final com.google.protobuf.Parser<LookerSystemSpec>
      PARSER = new com.google.protobuf.AbstractParser<LookerSystemSpec>() {
    @java.lang.Override
