        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              entryGroups_ = new java.util.ArrayList<com.google.cloud.datacatalog.v1.EntryGroup>();
              mutable_bitField0_ |= 0x00000001;
            }
            entryGroups_.add(
                input.readMessage(com.google.cloud.datacatalog.v1.EntryGroup.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.datacatalog.v1.ListEntryGroupsResponse) e.getUnfinishedMessage();
