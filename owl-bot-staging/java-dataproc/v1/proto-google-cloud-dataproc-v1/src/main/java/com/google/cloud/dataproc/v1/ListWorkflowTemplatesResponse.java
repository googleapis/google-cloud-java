...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.dataproc.v1.ListWorkflowTemplatesResponse result) {
      if (templatesBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.dataproc.v1.WorkflowTemplate m =
                  input.readMessage(
                      com.google.cloud.dataproc.v1.WorkflowTemplate.parser(),
                      extensionRegistry);
              if (templatesBuilder_ == null) {
                ensureTemplatesIsMutable();
                templates_.add(m);
