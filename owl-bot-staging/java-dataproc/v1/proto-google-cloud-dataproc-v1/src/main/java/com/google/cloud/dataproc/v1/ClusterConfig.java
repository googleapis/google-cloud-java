...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 170: {
            ...
            dataprocMetricConfig_ = input.readMessage(com.google.cloud.dataproc.v1.DataprocMetricConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public int getSerializedSize() {
    ...
    if (dataprocMetricConfig_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(21, getDataprocMetricConfig());
    }
