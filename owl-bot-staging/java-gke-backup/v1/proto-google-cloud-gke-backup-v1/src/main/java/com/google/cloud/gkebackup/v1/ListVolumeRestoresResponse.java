...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.gkebackup.v1.ListVolumeRestoresResponse result) {
      if (volumeRestoresBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.gkebackup.v1.VolumeRestore m =
                  input.readMessage(
                      com.google.cloud.gkebackup.v1.VolumeRestore.parser(),
                      extensionRegistry);
              if (volumeRestoresBuilder_ == null) {
                ensureVolumeRestoresIsMutable();
