...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.gkebackup.v1.ListVolumeBackupsResponse result) {
      if (volumeBackupsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.gkebackup.v1.VolumeBackup m =
                  input.readMessage(
                      com.google.cloud.gkebackup.v1.VolumeBackup.parser(),
                      extensionRegistry);
              if (volumeBackupsBuilder_ == null) {
                ensureVolumeBackupsIsMutable();
