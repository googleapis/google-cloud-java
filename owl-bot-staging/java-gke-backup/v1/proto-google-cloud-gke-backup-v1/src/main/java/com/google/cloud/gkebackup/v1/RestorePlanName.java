...
public class RestorePlanName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RESTORE_PLAN =
  ...
  private RestorePlanName(Builder builder) {
  ...
  public static RestorePlanName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_RESTORE_PLAN.validatedMatch(
            formattedString, "RestorePlanName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("restore_plan"));
  }

  public static List<RestorePlanName> parseList(List<String> formattedStrings) {
    List<RestorePlanName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<RestorePlanName> values) {
    ...
    for (RestorePlanName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_RESTORE_PLAN.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_RESTORE_PLAN.instantiate(
        "project", project, "location", location, "restore_plan", restorePlan);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      RestorePlanName that = ((RestorePlanName) o);
  ...
  public static class Builder {
    ...
    private Builder(RestorePlanName restorePlanName) {
      this.project = restorePlanName.project;
      this.location = restorePlanName.location;
      this.restorePlan = restorePlanName.restorePlan;
    }

    public RestorePlanName build() {
      return new RestorePlanName(this);
    }
  }
}
