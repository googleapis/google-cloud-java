...
public class ApiName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_API =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/apis/{api}");
  ...
  public static ApiName of(String project, String location, String api) {
    return newBuilder().setProject(project).setLocation(location).setApi(api).build();
  }

  public static String format(String project, String location, String api) {
    return newBuilder().setProject(project).setLocation(location).setApi(api).build().toString();
  }
  ...
  public static ApiName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_API.validatedMatch(
            formattedString, "ApiName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("api"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_API.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_API.instantiate("project", project, "location", location, "api", api);
  }
  ...
  public static class Builder {
    ...
    private Builder(ApiName apiName) {
      ...
      this.location = apiName.location;
