...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.apigeeregistry.v1.ListArtifactsResponse result) {
      if (artifactsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.apigeeregistry.v1.Artifact m =
                  input.readMessage(
                      com.google.cloud.apigeeregistry.v1.Artifact.parser(),
                      extensionRegistry);
              if (artifactsBuilder_ == null) {
                ensureArtifactsIsMutable();
                artifacts_.add(m);
