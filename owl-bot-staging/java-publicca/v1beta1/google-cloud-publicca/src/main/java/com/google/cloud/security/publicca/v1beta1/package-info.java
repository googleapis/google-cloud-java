 ...
 *
 * <p>======================= PublicCertificateAuthorityServiceClient =======================
 *
 * <p>Service Description: Manages the resources required for ACME [external account
 * binding](https://tools.ietf.org/html/rfc8555#section-7.3.4) for the public certificate authority
 * service.
 *
 * <p>Sample for PublicCertificateAuthorityServiceClient:
 *
 * <pre>{@code
