...
public final class PublicCertificateAuthorityServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest,
      com.google.cloud.security.publicca.v1beta1.ExternalAccountKey> getCreateExternalAccountKeyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "CreateExternalAccountKey",
      requestType = com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest.class,
      responseType = com.google.cloud.security.publicca.v1beta1.ExternalAccountKey.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest,
      com.google.cloud.security.publicca.v1beta1.ExternalAccountKey> getCreateExternalAccountKeyMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest, com.google.cloud.security.publicca.v1beta1.ExternalAccountKey> getCreateExternalAccountKeyMethod;
    if ((getCreateExternalAccountKeyMethod = PublicCertificateAuthorityServiceGrpc.getCreateExternalAccountKeyMethod) == null) {
      synchronized (PublicCertificateAuthorityServiceGrpc.class) {
        if ((getCreateExternalAccountKeyMethod = PublicCertificateAuthorityServiceGrpc.getCreateExternalAccountKeyMethod) == null) {
          PublicCertificateAuthorityServiceGrpc.getCreateExternalAccountKeyMethod = getCreateExternalAccountKeyMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest, com.google.cloud.security.publicca.v1beta1.ExternalAccountKey>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateExternalAccountKey"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.security.publicca.v1beta1.ExternalAccountKey.getDefaultInstance()))
              .setSchemaDescriptor(new PublicCertificateAuthorityServiceMethodDescriptorSupplier("CreateExternalAccountKey"))
              .build();
        }
      }
    }
  ...
  public static PublicCertificateAuthorityServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PublicCertificateAuthorityServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PublicCertificateAuthorityServiceStub>() {
        @java.lang.Override
        public PublicCertificateAuthorityServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static PublicCertificateAuthorityServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<PublicCertificateAuthorityServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PublicCertificateAuthorityServiceBlockingStub>() {
        @java.lang.Override
        public PublicCertificateAuthorityServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static PublicCertificateAuthorityServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PublicCertificateAuthorityServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<PublicCertificateAuthorityServiceFutureStub>() {
        @java.lang.Override
        public PublicCertificateAuthorityServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class PublicCertificateAuthorityServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void createExternalAccountKey(com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.security.publicca.v1beta1.ExternalAccountKey> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateExternalAccountKeyMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class PublicCertificateAuthorityServiceStub extends io.grpc.stub.AbstractAsyncStub<PublicCertificateAuthorityServiceStub> {
    ...
    public void createExternalAccountKey(com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateExternalAccountKeyMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class PublicCertificateAuthorityServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<PublicCertificateAuthorityServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.security.publicca.v1beta1.ExternalAccountKey createExternalAccountKey(com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest request) {
   ...
   * </pre>
   */
  public static final class PublicCertificateAuthorityServiceFutureStub extends io.grpc.stub.AbstractFutureStub<PublicCertificateAuthorityServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.security.publicca.v1beta1.ExternalAccountKey> createExternalAccountKey(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CREATE_EXTERNAL_ACCOUNT_KEY:
          serviceImpl.createExternalAccountKey((com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.security.publicca.v1beta1.ExternalAccountKey>) responseObserver);
          break;
        default:
  ...
  private static abstract class PublicCertificateAuthorityServiceBaseDescriptorSupplier
      ...
      synchronized (PublicCertificateAuthorityServiceGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new PublicCertificateAuthorityServiceFileDescriptorSupplier())
