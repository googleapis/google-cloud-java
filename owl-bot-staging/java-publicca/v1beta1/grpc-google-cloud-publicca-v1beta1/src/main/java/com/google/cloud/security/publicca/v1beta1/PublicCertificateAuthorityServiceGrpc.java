...
public final class PublicCertificateAuthorityServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.security.publicca.v1beta1.PublicCertificateAuthorityService";
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void createExternalAccountKey(com.google.cloud.security.publicca.v1beta1.CreateExternalAccountKeyRequest request,
   ...
   * </pre>
   */
  public static abstract class PublicCertificateAuthorityServiceImplBase
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service PublicCertificateAuthorityService.
   * <pre>
   * Manages the resources required for ACME [external account
   * binding](https://tools.ietf.org/html/rfc8555#section-7.3.4) for
   * the public certificate authority service.
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service PublicCertificateAuthorityService.
   * <pre>
   * Manages the resources required for ACME [external account
   * binding](https://tools.ietf.org/html/rfc8555#section-7.3.4) for
   * the public certificate authority service.
