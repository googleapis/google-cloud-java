...
private static final long serialVersionUID = 0L;
  ...
  checkByteStringIsUtf8(value);
    ...
    @java.lang.Override public com.google.cloud.edgecontainer.v1.VpnConnection.Details.State getState() {
      ...
      com.google.cloud.edgecontainer.v1.VpnConnection.Details.State result = com.google.cloud.edgecontainer.v1.VpnConnection.Details.State.valueOf(state_);
  ...
  checkByteStringIsUtf8(value);
      ...
      public Builder mergeCloudRouter(com.google.cloud.edgecontainer.v1.VpnConnection.Details.CloudRouter value) {
        if (cloudRouterBuilder_ == null) {
          if (cloudRouter_ != null) {
            cloudRouter_ =
              com.google.cloud.edgecontainer.v1.VpnConnection.Details.CloudRouter.newBuilder(cloudRouter_).mergeFrom(value).buildPartial();
          } else {
            cloudRouter_ = value;
          }
          onChanged();
  ...
  @java.lang.Override @java.lang.Deprecated public com.google.cloud.edgecontainer.v1.VpnConnection.BgpRoutingMode getBgpRoutingMode() {
    @SuppressWarnings("deprecation")
    com.google.cloud.edgecontainer.v1.VpnConnection.BgpRoutingMode result = com.google.cloud.edgecontainer.v1.VpnConnection.BgpRoutingMode.valueOf(bgpRoutingMode_);
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeVpcProject(com.google.cloud.edgecontainer.v1.VpnConnection.VpcProject value) {
      if (vpcProjectBuilder_ == null) {
        if (vpcProject_ != null) {
          vpcProject_ =
            com.google.cloud.edgecontainer.v1.VpnConnection.VpcProject.newBuilder(vpcProject_).mergeFrom(value).buildPartial();
        } else {
          vpcProject_ = value;
        }
        onChanged();
    ...
    public Builder mergeDetails(com.google.cloud.edgecontainer.v1.VpnConnection.Details value) {
      if (detailsBuilder_ == null) {
        if (details_ != null) {
          details_ =
            com.google.cloud.edgecontainer.v1.VpnConnection.Details.newBuilder(details_).mergeFrom(value).buildPartial();
        } else {
          details_ = value;
        }
        onChanged();
