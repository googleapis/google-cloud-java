...
public interface ServerConfigOrBuilder extends
   ...
   * <code>map&lt;string, .google.cloud.edgecontainer.v1.ChannelConfig&gt; channels = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  boolean containsChannels(
      java.lang.String key);
  /**
   * Use {@link #getChannelsMap()} instead.
   */
  @java.lang.Deprecated
  java.util.Map<java.lang.String, com.google.cloud.edgecontainer.v1.ChannelConfig>
  getChannels();
  /**
   * <pre>
   * Output only. Mapping from release channel to channel config.
...
com.google.cloud.edgecontainer.v1.ChannelConfig defaultValue);
   ...
   * <code>map&lt;string, .google.cloud.edgecontainer.v1.ChannelConfig&gt; channels = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.edgecontainer.v1.ChannelConfig getChannelsOrThrow(
      java.lang.String key);
   ...
   */
  java.util.List<com.google.cloud.edgecontainer.v1.Version> 
      getVersionsList();
  /**
   * <pre>
   * Output only. Supported versions, e.g.: ["1.4.0", "1.5.0"].
   ...
   * <code>repeated .google.cloud.edgecontainer.v1.Version versions = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.edgecontainer.v1.VersionOrBuilder getVersionsOrBuilder(
      int index);
