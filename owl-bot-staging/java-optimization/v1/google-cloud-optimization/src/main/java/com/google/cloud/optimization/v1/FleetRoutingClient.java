 ...
 *    <tr>
 *      <td>OptimizeTours</td>
 *      <td><p>Sends an `OptimizeToursRequest` containing a `ShipmentModel` and returns an
 ...
 *      <td><p>Optimizes vehicle tours for one or more `OptimizeToursRequest`
 *  messages as a batch.
 *
 ...
 *  vehicles minimizing the overall cost.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
