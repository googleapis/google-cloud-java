...
public interface ShipmentOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.optimization.v1.Shipment.VisitRequest> 
      getPickupsList();
  /**
   * <pre>
   * Set of pickup alternatives associated to the shipment. If not specified,
...
com.google.cloud.optimization.v1.Shipment.Load defaultValue);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.optimization.v1.CapacityQuantity demands = 3 [deprecated = true];</code>
   */
