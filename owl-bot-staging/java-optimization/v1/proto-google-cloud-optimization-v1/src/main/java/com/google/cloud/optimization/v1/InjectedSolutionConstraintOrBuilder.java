...
public interface InjectedSolutionConstraintOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.optimization.v1.SkippedShipment> 
   ...
   * <code>repeated .google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxation constraint_relaxations = 3;</code>
   */
  com.google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxation getConstraintRelaxations(int index);
  /**
   * <pre>
   * For zero or more groups of vehicles, specifies when and how much to relax
   * constraints. If this field is empty, all non-empty vehicle routes are
   ...
   * <code>repeated .google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxation constraint_relaxations = 3;</code>
   */
  java.util.List<? extends com.google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxationOrBuilder> 
   ...
   * <code>repeated .google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxation constraint_relaxations = 3;</code>
   */
  com.google.cloud.optimization.v1.InjectedSolutionConstraint.ConstraintRelaxationOrBuilder getConstraintRelaxationsOrBuilder(
      int index);
}
