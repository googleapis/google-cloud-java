      ...
      if (trainingDatasetValidationBuilder_ == null) {
        if (trainingDatasetValidation_ != null) {
          trainingDatasetValidation_ =
            com.google.cloud.documentai.v1beta3.TrainProcessorVersionMetadata.DatasetValidation.newBuilder(trainingDatasetValidation_).mergeFrom(value).buildPartial();
        } else {
          trainingDatasetValidation_ = value;
        }
        onChanged();
      ...
      if (testDatasetValidationBuilder_ == null) {
        if (testDatasetValidation_ != null) {
          testDatasetValidation_ =
            com.google.cloud.documentai.v1beta3.TrainProcessorVersionMetadata.DatasetValidation.newBuilder(testDatasetValidation_).mergeFrom(value).buildPartial();
        } else {
          testDatasetValidation_ = value;
        }
        onChanged();
