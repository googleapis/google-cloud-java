...
public interface DatasetSchemaOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.documentai.v1beta3.DocumentSchema document_schema = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
