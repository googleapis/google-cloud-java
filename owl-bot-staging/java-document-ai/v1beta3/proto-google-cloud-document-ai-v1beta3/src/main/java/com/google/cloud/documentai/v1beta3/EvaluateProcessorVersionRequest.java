...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.documentai.v1beta3.EvaluateProcessorVersionRequest result) {
    ...
    public Builder mergeEvaluationDocuments(com.google.cloud.documentai.v1beta3.BatchDocumentsInputConfig value) {
      if (evaluationDocumentsBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          evaluationDocuments_ != null &&
          evaluationDocuments_ != com.google.cloud.documentai.v1beta3.BatchDocumentsInputConfig.getDefaultInstance()) {
