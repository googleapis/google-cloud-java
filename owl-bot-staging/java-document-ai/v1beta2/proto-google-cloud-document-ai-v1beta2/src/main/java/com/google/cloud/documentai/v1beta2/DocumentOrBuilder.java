...
public interface DocumentOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<com.google.cloud.documentai.v1beta2.Document.Style> 
      getTextStylesList();
  /**
   * <pre>
   * Styles for the
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.documentai.v1beta2.Document.Style getTextStyles(int index);
  /**
   * <pre>
   * Styles for the
   * [Document.text][google.cloud.documentai.v1beta2.Document.text].
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<? extends com.google.cloud.documentai.v1beta2.Document.StyleOrBuilder> 
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.documentai.v1beta2.Document.StyleOrBuilder getTextStylesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta2.Document.Page> 
      getPagesList();
  /**
   * <pre>
   * Visual page layout for the
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Page pages = 6;</code>
   */
  com.google.cloud.documentai.v1beta2.Document.PageOrBuilder getPagesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta2.Document.Entity> 
      getEntitiesList();
  /**
   * <pre>
   * A list of entities detected on
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Entity entities = 7;</code>
   */
  com.google.cloud.documentai.v1beta2.Document.EntityOrBuilder getEntitiesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.documentai.v1beta2.Document.EntityRelation entity_relations = 8;</code>
   */
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta2.Document.TextChange> 
      getTextChangesList();
  /**
   * <pre>
   * Placeholder.  A list of text corrections made to
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta2.Document.Label> 
      getLabelsList();
  /**
   * <pre>
   * [Label][google.cloud.documentai.v1beta2.Document.Label]s for this document.
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Label labels = 11;</code>
   */
  com.google.cloud.documentai.v1beta2.Document.LabelOrBuilder getLabelsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1beta2.Document.Revision> 
      getRevisionsList();
  /**
   * <pre>
   * Placeholder. Revision history of this document.
   ...
   * <code>repeated .google.cloud.documentai.v1beta2.Document.Revision revisions = 13;</code>
   */
  com.google.cloud.documentai.v1beta2.Document.RevisionOrBuilder getRevisionsOrBuilder(
      int index);
