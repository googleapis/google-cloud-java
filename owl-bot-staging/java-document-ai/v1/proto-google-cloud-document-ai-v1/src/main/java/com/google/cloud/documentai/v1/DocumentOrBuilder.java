...
public interface DocumentOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.documentai.v1.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<com.google.cloud.documentai.v1.Document.Style> 
      getTextStylesList();
  /**
   * <pre>
   * Styles for the [Document.text][google.cloud.documentai.v1.Document.text].
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.documentai.v1.Document.Style getTextStyles(int index);
  /**
   * <pre>
   * Styles for the [Document.text][google.cloud.documentai.v1.Document.text].
   * </pre>
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<? extends com.google.cloud.documentai.v1.Document.StyleOrBuilder> 
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.Style text_styles = 5 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.documentai.v1.Document.StyleOrBuilder getTextStylesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1.Document.Page> 
      getPagesList();
  /**
   * <pre>
   * Visual page layout for the [Document][google.cloud.documentai.v1.Document].
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.Page pages = 6;</code>
   */
  com.google.cloud.documentai.v1.Document.PageOrBuilder getPagesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1.Document.Entity> 
      getEntitiesList();
  /**
   * <pre>
   * A list of entities detected on
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.Entity entities = 7;</code>
   */
  com.google.cloud.documentai.v1.Document.EntityOrBuilder getEntitiesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1.Document.EntityRelation> 
   ...
   */
  java.util.List<com.google.cloud.documentai.v1.Document.TextChange> 
      getTextChangesList();
  /**
   * <pre>
   * Placeholder.  A list of text corrections made to
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.TextChange text_changes = 14;</code>
   */
  com.google.cloud.documentai.v1.Document.TextChangeOrBuilder getTextChangesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.documentai.v1.Document.Revision> 
      getRevisionsList();
  /**
   * <pre>
   * Placeholder. Revision history of this document.
   ...
   * <code>repeated .google.cloud.documentai.v1.Document.Revision revisions = 13;</code>
   */
  com.google.cloud.documentai.v1.Document.RevisionOrBuilder getRevisionsOrBuilder(
      int index);
