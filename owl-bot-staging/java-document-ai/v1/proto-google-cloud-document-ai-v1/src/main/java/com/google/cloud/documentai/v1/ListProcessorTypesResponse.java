...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.documentai.v1.ListProcessorTypesResponse result) {
      if (processorTypesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.documentai.v1.ProcessorType m =
                  input.readMessage(
                      com.google.cloud.documentai.v1.ProcessorType.parser(),
                      extensionRegistry);
              if (processorTypesBuilder_ == null) {
                ensureProcessorTypesIsMutable();
