...
public class ProcessorTypeName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_PROCESSOR_TYPE =
  ...
  private ProcessorTypeName(Builder builder) {
    ...
    processorType = Preconditions.checkNotNull(builder.getProcessorType());
  }
  ...
  public static ProcessorTypeName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_PROCESSOR_TYPE.validatedMatch(
            formattedString, "ProcessorTypeName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("processor_type"));
  }

  public static List<ProcessorTypeName> parseList(List<String> formattedStrings) {
    List<ProcessorTypeName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (processorType != null) {
            fieldMapBuilder.put("processor_type", processorType);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_PROCESSOR_TYPE.instantiate(
        "project", project, "location", location, "processor_type", processorType);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.processorType, that.processorType);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(processorType);
    return h;
  }
