...
public class UserName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CLUSTER_USER =
  ...
  public static UserName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CLUSTER_USER.validatedMatch(
  ...
  public String toString() {
    return PROJECT_LOCATION_CLUSTER_USER.instantiate(
        "project", project, "location", location, "cluster", cluster, "user", user);
  }
