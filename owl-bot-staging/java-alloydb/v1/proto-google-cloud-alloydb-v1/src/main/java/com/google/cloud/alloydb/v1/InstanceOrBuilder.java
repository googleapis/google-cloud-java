...
java.lang.String defaultValue);
   ...
   */
  java.util.List<com.google.cloud.alloydb.v1.Instance.Node> 
      getNodesList();
  /**
   * <pre>
   * Output only. List of available read-only VMs in this instance, including
   ...
   * <code>repeated .google.cloud.alloydb.v1.Instance.Node nodes = 20 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.alloydb.v1.Instance.NodeOrBuilder getNodesOrBuilder(
      int index);
   ...
   * <code>.google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfig query_insights_config = 21;</code>
   */
  com.google.cloud.alloydb.v1.Instance.QueryInsightsInstanceConfigOrBuilder getQueryInsightsConfigOrBuilder();
...
java.lang.String defaultValue);
   ...
   * <code>.google.cloud.alloydb.v1.Instance.ClientConnectionConfig client_connection_config = 23 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.alloydb.v1.Instance.ClientConnectionConfigOrBuilder getClientConnectionConfigOrBuilder();
}
