...
public interface UpdateBackupRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1beta.UpdateBackupRequest)
   ...
   * @return The backup.
   */
  com.google.cloud.alloydb.v1beta.Backup getBackup();
  /**
   * <pre>
   * Required. The resource being updated
   * </pre>
   ...
   * <code>.google.cloud.alloydb.v1beta.Backup backup = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.alloydb.v1beta.BackupOrBuilder getBackupOrBuilder();
