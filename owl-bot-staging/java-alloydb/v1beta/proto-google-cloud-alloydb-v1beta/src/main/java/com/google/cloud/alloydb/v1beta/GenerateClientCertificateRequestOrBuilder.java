...
public interface GenerateClientCertificateRequestOrBuilder extends
   ...
   * @return The pemCsr.
   */
  @java.lang.Deprecated java.lang.String getPemCsr();
  /**
   * <pre>
   * Optional. A pem-encoded X.509 certificate signing request (CSR).
   * </pre>
   ...
   * </pre>
   *
   * <code>.google.protobuf.Duration cert_duration = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
