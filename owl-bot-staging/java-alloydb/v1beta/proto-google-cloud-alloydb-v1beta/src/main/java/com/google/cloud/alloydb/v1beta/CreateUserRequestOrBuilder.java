...
public interface CreateUserRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1beta.CreateUserRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.alloydb.v1beta.User user = 3 [(.google.api.field_behavior) = REQUIRED];</code>
