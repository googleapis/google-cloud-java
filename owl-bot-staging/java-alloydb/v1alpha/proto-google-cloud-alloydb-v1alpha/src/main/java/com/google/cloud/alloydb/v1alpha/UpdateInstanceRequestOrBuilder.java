...
public interface UpdateInstanceRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.UpdateInstanceRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.alloydb.v1alpha.Instance instance = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.alloydb.v1alpha.Instance instance = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.alloydb.v1alpha.InstanceOrBuilder getInstanceOrBuilder();
