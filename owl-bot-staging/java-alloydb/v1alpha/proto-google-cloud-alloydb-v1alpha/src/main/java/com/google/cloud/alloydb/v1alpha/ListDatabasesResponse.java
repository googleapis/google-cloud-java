...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.alloydb.v1alpha.ServiceProto.internal_static_google_cloud_alloydb_v1alpha_ListDatabasesResponse_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.cloud.alloydb.v1alpha.ServiceProto.internal_static_google_cloud_alloydb_v1alpha_ListDatabasesResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.alloydb.v1alpha.ListDatabasesResponse.class, com.google.cloud.alloydb.v1alpha.ListDatabasesResponse.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.alloydb.v1alpha.DatabaseOrBuilder getDatabasesOrBuilder(
      int index) {
    return databases_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.alloydb.v1alpha.ListDatabasesResponse other = (com.google.cloud.alloydb.v1alpha.ListDatabasesResponse) obj;
  ...
  public static com.google.cloud.alloydb.v1alpha.ListDatabasesResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.alloydb.v1alpha.ListDatabasesResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.cloud.alloydb.v1alpha.ListDatabasesResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.alloydb.v1alpha.ListDatabasesResponse buildPartial() {
      com.google.cloud.alloydb.v1alpha.ListDatabasesResponse result = new com.google.cloud.alloydb.v1alpha.ListDatabasesResponse(this);
    ...
    private void buildPartialRepeatedFields(com.google.cloud.alloydb.v1alpha.ListDatabasesResponse result) {
      if (databasesBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.cloud.alloydb.v1alpha.ListDatabasesResponse other) {
      if (other == com.google.cloud.alloydb.v1alpha.ListDatabasesResponse.getDefaultInstance()) return this;
      if (databasesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.alloydb.v1alpha.Database m =
                  input.readMessage(
                      com.google.cloud.alloydb.v1alpha.Database.parser(),
                      extensionRegistry);
              if (databasesBuilder_ == null) {
                ensureDatabasesIsMutable();
                databases_.add(m);
    ...
    public Builder setDatabases(
        int index, com.google.cloud.alloydb.v1alpha.Database value) {
      if (databasesBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder addDatabases(
        com.google.cloud.alloydb.v1alpha.Database.Builder builderForValue) {
      if (databasesBuilder_ == null) {
        ensureDatabasesIsMutable();
     ...
     * <code>repeated .google.cloud.alloydb.v1alpha.Database databases = 1;</code>
     */
    public com.google.cloud.alloydb.v1alpha.Database.Builder getDatabasesBuilder(
        int index) {
    ...
    public com.google.cloud.alloydb.v1alpha.Database.Builder addDatabasesBuilder(
        int index) {
      return getDatabasesFieldBuilder().addBuilder(
          index, com.google.cloud.alloydb.v1alpha.Database.getDefaultInstance());
    }
    /**
     * <pre>
     * The list of databases
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.alloydb.v1alpha.Database, com.google.cloud.alloydb.v1alpha.Database.Builder, com.google.cloud.alloydb.v1alpha.DatabaseOrBuilder> 
