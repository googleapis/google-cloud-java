...
public interface UpdateUserRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.UpdateUserRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.alloydb.v1alpha.User user = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * @return The user.
   */
  com.google.cloud.alloydb.v1alpha.User getUser();
  /**
   * <pre>
   * Required. The resource being updated
   * </pre>
   ...
   * <code>.google.cloud.alloydb.v1alpha.User user = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.alloydb.v1alpha.UserOrBuilder getUserOrBuilder();
