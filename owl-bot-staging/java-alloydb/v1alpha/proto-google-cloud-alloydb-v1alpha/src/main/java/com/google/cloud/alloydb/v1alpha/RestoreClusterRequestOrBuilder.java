...
public interface RestoreClusterRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.RestoreClusterRequest)
   ...
   * <code>.google.cloud.alloydb.v1alpha.BackupSource backup_source = 4;</code>
   */
  com.google.cloud.alloydb.v1alpha.BackupSourceOrBuilder getBackupSourceOrBuilder();
   ...
   */
  com.google.cloud.alloydb.v1alpha.ContinuousBackupSource getContinuousBackupSource();
  /**
   * <pre>
   * ContinuousBackup source. Continuous backup needs to be enabled in the
   * source cluster for this operation to succeed.
   ...
   * <code>.google.cloud.alloydb.v1alpha.Cluster cluster = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.alloydb.v1alpha.ClusterOrBuilder getClusterOrBuilder();
  ...
  public com.google.cloud.alloydb.v1alpha.RestoreClusterRequest.SourceCase getSourceCase();
}
