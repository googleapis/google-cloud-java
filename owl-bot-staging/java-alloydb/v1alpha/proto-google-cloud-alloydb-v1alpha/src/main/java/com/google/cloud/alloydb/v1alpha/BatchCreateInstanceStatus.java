...
private static final long serialVersionUID = 0L;
   ...
   * @return The state.
   */
  @java.lang.Override public com.google.cloud.alloydb.v1alpha.BatchCreateInstanceStatus.State getState() {
    com.google.cloud.alloydb.v1alpha.BatchCreateInstanceStatus.State result = com.google.cloud.alloydb.v1alpha.BatchCreateInstanceStatus.State.forNumber(state_);
    return result == null ? com.google.cloud.alloydb.v1alpha.BatchCreateInstanceStatus.State.UNRECOGNIZED : result;
  }
  ...
  public static final class Builder extends
     ...
     * @return This builder for chaining.
     */
    public Builder setState(com.google.cloud.alloydb.v1alpha.BatchCreateInstanceStatus.State value) {
      if (value == null) {
