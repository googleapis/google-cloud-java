...
public interface ContinuousBackupInfoOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.alloydb.v1alpha.ContinuousBackupInfo)
   ...
   * </pre>
   *
   * <code>.google.cloud.alloydb.v1alpha.EncryptionInfo encryption_info = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp enabled_time = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.type.DayOfWeek schedule = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp earliest_restorable_time = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
