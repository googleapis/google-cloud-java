...
public interface AzureAuthorizationOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.gkemulticloud.v1.AzureClusterUser admin_users = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.gkemulticloud.v1.AzureClusterGroup admin_groups = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.cloud.gkemulticloud.v1.AzureClusterGroup> 
      getAdminGroupsList();
  /**
   * <pre>
   * Optional. Groups of users that can perform operations as a cluster admin. A
   ...
   * <code>repeated .google.cloud.gkemulticloud.v1.AzureClusterGroup admin_groups = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.gkemulticloud.v1.AzureClusterGroupOrBuilder getAdminGroupsOrBuilder(
      int index);
}
