...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.cloud.gkemulticloud.v1.AwsNodePool.State getState() {
    ...
    com.google.cloud.gkemulticloud.v1.AwsNodePool.State result = com.google.cloud.gkemulticloud.v1.AwsNodePool.State.valueOf(state_);
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeConfig(com.google.cloud.gkemulticloud.v1.AwsNodeConfig value) {
      if (configBuilder_ == null) {
        if (config_ != null) {
          config_ =
            com.google.cloud.gkemulticloud.v1.AwsNodeConfig.newBuilder(config_).mergeFrom(value).buildPartial();
        } else {
          config_ = value;
        }
        onChanged();
    ...
    public Builder mergeAutoscaling(com.google.cloud.gkemulticloud.v1.AwsNodePoolAutoscaling value) {
      if (autoscalingBuilder_ == null) {
        if (autoscaling_ != null) {
          autoscaling_ =
            com.google.cloud.gkemulticloud.v1.AwsNodePoolAutoscaling.newBuilder(autoscaling_).mergeFrom(value).buildPartial();
        } else {
          autoscaling_ = value;
        }
        onChanged();
