...
public class AwsClusterName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_AWS_CLUSTER =
  ...
  public static AwsClusterName of(String project, String location, String awsCluster) {
    return newBuilder().setProject(project).setLocation(location).setAwsCluster(awsCluster).build();
  }
  ...
  public static AwsClusterName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_AWS_CLUSTER.validatedMatch(
            formattedString, "AwsClusterName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("aws_cluster"));
  }

  public static List<AwsClusterName> parseList(List<String> formattedStrings) {
    List<AwsClusterName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return PROJECT_LOCATION_AWS_CLUSTER.instantiate(
        "project", project, "location", location, "aws_cluster", awsCluster);
  }
