        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              awsNodePools_ = new java.util.ArrayList<com.google.cloud.gkemulticloud.v1.AwsNodePool>();
              mutable_bitField0_ |= 0x00000001;
            }
            awsNodePools_.add(
                input.readMessage(com.google.cloud.gkemulticloud.v1.AwsNodePool.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.gkemulticloud.v1.ListAwsNodePoolsResponse) e.getUnfinishedMessage();
