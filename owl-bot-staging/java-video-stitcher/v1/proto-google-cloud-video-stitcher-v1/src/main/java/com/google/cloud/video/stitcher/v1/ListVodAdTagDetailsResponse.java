        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              vodAdTagDetails_ = new java.util.ArrayList<com.google.cloud.video.stitcher.v1.VodAdTagDetail>();
              mutable_bitField0_ |= 0x00000001;
            }
            vodAdTagDetails_.add(
                input.readMessage(com.google.cloud.video.stitcher.v1.VodAdTagDetail.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.video.stitcher.v1.ListVodAdTagDetailsResponse) e.getUnfinishedMessage();
