      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            slate_ = input.readMessage(com.google.cloud.video.stitcher.v1.Slate.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.video.stitcher.v1.CreateSlateRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeSlate(com.google.cloud.video.stitcher.v1.Slate value) {
      if (slateBuilder_ == null) {
        if (slate_ != null) {
          slate_ =
            com.google.cloud.video.stitcher.v1.Slate.newBuilder(slate_).mergeFrom(value).buildPartial();
        } else {
          slate_ = value;
        }
        onChanged();
