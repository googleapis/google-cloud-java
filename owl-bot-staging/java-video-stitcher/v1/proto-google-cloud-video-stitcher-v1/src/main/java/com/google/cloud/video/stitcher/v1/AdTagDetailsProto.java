...
public final class AdTagDetailsProto {
  ...
  static {
    ...
    internal_static_google_cloud_video_stitcher_v1_LiveAdTagDetail_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_video_stitcher_v1_LiveAdTagDetail_descriptor,
        new java.lang.String[] { "Name", "AdRequests", });
    internal_static_google_cloud_video_stitcher_v1_VodAdTagDetail_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_video_stitcher_v1_VodAdTagDetail_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_video_stitcher_v1_VodAdTagDetail_descriptor,
        new java.lang.String[] { "Name", "AdRequests", });
    internal_static_google_cloud_video_stitcher_v1_AdRequest_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_video_stitcher_v1_AdRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_video_stitcher_v1_AdRequest_descriptor,
        new java.lang.String[] { "Uri", "RequestMetadata", "ResponseMetadata", });
    internal_static_google_cloud_video_stitcher_v1_RequestMetadata_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_video_stitcher_v1_RequestMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_video_stitcher_v1_RequestMetadata_descriptor,
        new java.lang.String[] { "Headers", });
    internal_static_google_cloud_video_stitcher_v1_ResponseMetadata_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_cloud_video_stitcher_v1_ResponseMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_video_stitcher_v1_ResponseMetadata_descriptor,
        new java.lang.String[] { "Error", "Headers", "StatusCode", "SizeBytes", "Duration", "Body", });
    com.google.protobuf.ExtensionRegistry registry =
