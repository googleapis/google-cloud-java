...
/**
 * Settings class to configure an instance of {@link QuotaControllerStub}.
 *
...
public class QuotaControllerStubSettings extends StubSettings<QuotaControllerStubSettings> {
  ...
  private final UnaryCallSettings<AllocateQuotaRequest, AllocateQuotaResponse>
      allocateQuotaSettings;
  ...
  protected QuotaControllerStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    allocateQuotaSettings = settingsBuilder.allocateQuotaSettings().build();
  }

  /** Builder for QuotaControllerStubSettings. */
  public static class Builder extends StubSettings.Builder<QuotaControllerStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<AllocateQuotaRequest, AllocateQuotaResponse>
        allocateQuotaSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      allocateQuotaSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(allocateQuotaSettings);
      initDefaults(this);
    }

    protected Builder(QuotaControllerStubSettings settings) {
      super(settings);

      allocateQuotaSettings = settings.allocateQuotaSettings.toBuilder();
