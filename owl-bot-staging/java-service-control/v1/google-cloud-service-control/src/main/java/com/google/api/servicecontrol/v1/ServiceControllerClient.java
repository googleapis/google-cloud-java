 ...
 *    <tr>
 *      <td>Check</td>
 *      <td><p>Checks whether an operation on a service should be allowed to proceed
 ...
 *  [Cloud IAM](https://cloud.google.com/iam).</p></td>
 *      <td>
 ...
 *    <tr>
 *      <td>Report</td>
 *      <td><p>Reports operation results to Google Service Control, such as logs and
 ...
 *  on the specified service. For more information, see
 *  [Google Cloud IAM](https://cloud.google.com/iam).</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
