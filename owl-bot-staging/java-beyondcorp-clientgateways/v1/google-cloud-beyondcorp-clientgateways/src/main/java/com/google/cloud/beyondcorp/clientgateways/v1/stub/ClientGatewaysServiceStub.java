...
/**
 * Base stub class for the ClientGatewaysService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator-java")
public abstract class ClientGatewaysServiceStub implements BackgroundResource {
  ...
  public UnaryCallable<ListClientGatewaysRequest, ListClientGatewaysPagedResponse>
    ...
    throw new UnsupportedOperationException("Not implemented: listClientGatewaysPagedCallable()");
  }

  public UnaryCallable<ListClientGatewaysRequest, ListClientGatewaysResponse>
      listClientGatewaysCallable() {
    throw new UnsupportedOperationException("Not implemented: listClientGatewaysCallable()");
  }

  public UnaryCallable<GetClientGatewayRequest, ClientGateway> getClientGatewayCallable() {
    throw new UnsupportedOperationException("Not implemented: getClientGatewayCallable()");
  }
  ...
  public OperationCallable<
    ...
    throw new UnsupportedOperationException(
        "Not implemented: createClientGatewayOperationCallable()");
  }

  public UnaryCallable<CreateClientGatewayRequest, Operation> createClientGatewayCallable() {
    throw new UnsupportedOperationException("Not implemented: createClientGatewayCallable()");
  }
  ...
  public OperationCallable<DeleteClientGatewayRequest, Empty, ClientGatewayOperationMetadata>
    ...
    throw new UnsupportedOperationException(
        "Not implemented: deleteClientGatewayOperationCallable()");
  }

  public UnaryCallable<DeleteClientGatewayRequest, Operation> deleteClientGatewayCallable() {
    throw new UnsupportedOperationException("Not implemented: deleteClientGatewayCallable()");
  }
