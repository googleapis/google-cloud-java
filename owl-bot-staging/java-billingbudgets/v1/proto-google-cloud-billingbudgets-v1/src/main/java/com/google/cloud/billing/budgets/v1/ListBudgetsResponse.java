...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.billing.budgets.v1.ListBudgetsResponse result) {
      if (budgetsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.billing.budgets.v1.Budget m =
                  input.readMessage(
                      com.google.cloud.billing.budgets.v1.Budget.parser(),
                      extensionRegistry);
              if (budgetsBuilder_ == null) {
                ensureBudgetsIsMutable();
                budgets_.add(m);
