...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.bigquery.datatransfer.v1.ListTransferConfigsResponse result) {
      if (transferConfigsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.cloud.bigquery.datatransfer.v1.ListTransferConfigsResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.bigquery.datatransfer.v1.TransferConfig m =
                  input.readMessage(
                      com.google.cloud.bigquery.datatransfer.v1.TransferConfig.parser(),
                      extensionRegistry);
              if (transferConfigsBuilder_ == null) {
                ensureTransferConfigsIsMutable();
                transferConfigs_.add(m);
              } else {
                transferConfigsBuilder_.addMessage(m);
              }
              break;
            } // case 10
            case 18: {
