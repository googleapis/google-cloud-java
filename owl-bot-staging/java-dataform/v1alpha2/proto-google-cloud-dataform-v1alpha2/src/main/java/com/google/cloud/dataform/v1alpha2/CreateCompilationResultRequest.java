      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            compilationResult_ = input.readMessage(com.google.cloud.dataform.v1alpha2.CompilationResult.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dataform.v1alpha2.CreateCompilationResultRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeCompilationResult(com.google.cloud.dataform.v1alpha2.CompilationResult value) {
      if (compilationResultBuilder_ == null) {
        if (compilationResult_ != null) {
          compilationResult_ =
            com.google.cloud.dataform.v1alpha2.CompilationResult.newBuilder(compilationResult_).mergeFrom(value).buildPartial();
        } else {
          compilationResult_ = value;
        }
        onChanged();
