...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.dataform.v1alpha2.ListRepositoriesResponse result) {
      if (repositoriesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.dataform.v1alpha2.Repository m =
                  input.readMessage(
                      com.google.cloud.dataform.v1alpha2.Repository.parser(),
                      extensionRegistry);
              if (repositoriesBuilder_ == null) {
                ensureRepositoriesIsMutable();
                repositories_.add(m);
