...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>string workflow_config = 6 [(.google.api.field_behavior) = IMMUTABLE, (.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.dataform.v1beta1.InvocationConfig invocation_config = 3 [(.google.api.field_behavior) = IMMUTABLE];</code>
    ...
    switch (compilationSourceCase_) {
      ...
      case 6:
        if (!getWorkflowConfig()
            .equals(other.getWorkflowConfig())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends
     ...
     * @return This builder for chaining.
     */
    public Builder setWorkflowConfigBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      compilationSourceCase_ = 6;
