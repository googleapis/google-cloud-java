...
public interface CompilationResultOrBuilder extends
   ...
   */
  com.google.cloud.dataform.v1beta1.CompilationResult.CodeCompilationConfig getCodeCompilationConfig();
  /**
   * <pre>
   * Immutable. If set, fields of `code_compilation_overrides` override the default
   * compilation settings that are specified in dataform.json.
   ...
   * <code>.google.cloud.dataform.v1beta1.CompilationResult.CodeCompilationConfig code_compilation_config = 4 [(.google.api.field_behavior) = IMMUTABLE];</code>
   */
  com.google.cloud.dataform.v1beta1.CompilationResult.CodeCompilationConfigOrBuilder getCodeCompilationConfigOrBuilder();
   ...
   * <code>repeated .google.cloud.dataform.v1beta1.CompilationResult.CompilationError compilation_errors = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dataform.v1beta1.CompilationResult.CompilationError getCompilationErrors(int index);
  /**
   * <pre>
   * Output only. Errors encountered during project compilation.
   * </pre>
   ...
   * <code>repeated .google.cloud.dataform.v1beta1.CompilationResult.CompilationError compilation_errors = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.cloud.dataform.v1beta1.CompilationResult.CompilationErrorOrBuilder> 
   ...
   * <code>repeated .google.cloud.dataform.v1beta1.CompilationResult.CompilationError compilation_errors = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dataform.v1beta1.CompilationResult.CompilationErrorOrBuilder getCompilationErrorsOrBuilder(
      int index);
