        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              workflowInvocationActions_ = new java.util.ArrayList<com.google.cloud.dataform.v1beta1.WorkflowInvocationAction>();
              mutable_bitField0_ |= 0x00000001;
            }
            workflowInvocationActions_.add(
                input.readMessage(com.google.cloud.dataform.v1beta1.WorkflowInvocationAction.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dataform.v1beta1.QueryWorkflowInvocationActionsResponse) e.getUnfinishedMessage();
