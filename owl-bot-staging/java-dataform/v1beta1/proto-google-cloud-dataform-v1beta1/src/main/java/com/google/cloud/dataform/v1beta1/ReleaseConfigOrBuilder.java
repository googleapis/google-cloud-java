...
public interface ReleaseConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dataform.v1beta1.CodeCompilationConfig code_compilation_config = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * <code>.google.cloud.dataform.v1beta1.CodeCompilationConfig code_compilation_config = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.dataform.v1beta1.CodeCompilationConfigOrBuilder getCodeCompilationConfigOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecord recent_scheduled_release_records = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * <code>repeated .google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecord recent_scheduled_release_records = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecord getRecentScheduledReleaseRecords(int index);
  /**
   * <pre>
   * Output only. Records of the 10 most recent scheduled release attempts,
   * ordered in in descending order of `release_time`. Updated whenever
   ...
   * <code>repeated .google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecord recent_scheduled_release_records = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<? extends com.google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecordOrBuilder> 
   ...
   * <code>repeated .google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecord recent_scheduled_release_records = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dataform.v1beta1.ReleaseConfig.ScheduledReleaseRecordOrBuilder getRecentScheduledReleaseRecordsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>string release_compilation_result = 6 [(.google.api.field_behavior) = OPTIONAL, (.google.api.resource_reference) = { ... }</code>
