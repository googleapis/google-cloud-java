      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            interval_ = input.readMessage(com.google.cloud.bigquery.migration.v2.TimeInterval.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 18: {
            ...
            value_ = input.readMessage(com.google.cloud.bigquery.migration.v2.TypedValue.parser(), extensionRegistry);
            if (subBuilder != null) {
