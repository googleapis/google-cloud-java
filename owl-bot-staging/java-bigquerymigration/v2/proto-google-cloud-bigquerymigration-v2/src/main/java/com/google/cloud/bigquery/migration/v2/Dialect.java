        ...
        switch (tag) {
          ...
          case 114: {
            ...
            if (dialectValueCase_ == 14) {
              subBuilder = ((com.google.cloud.bigquery.migration.v2.MySQLDialect) dialectValue_).toBuilder();
            }
            dialectValue_ =
                input.readMessage(com.google.cloud.bigquery.migration.v2.MySQLDialect.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.bigquery.migration.v2.MySQLDialect) dialectValue_);
              dialectValue_ = subBuilder.buildPartial();
            }
