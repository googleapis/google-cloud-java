...
public interface ResourceErrorDetailOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.bigquery.migration.v2.ErrorDetail error_details = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.cloud.bigquery.migration.v2.ErrorDetail> 
      getErrorDetailsList();
  /**
   * <pre>
   * Required. The error details for the resource.
   ...
   * <code>repeated .google.cloud.bigquery.migration.v2.ErrorDetail error_details = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.bigquery.migration.v2.ErrorDetailOrBuilder getErrorDetailsOrBuilder(
      int index);
