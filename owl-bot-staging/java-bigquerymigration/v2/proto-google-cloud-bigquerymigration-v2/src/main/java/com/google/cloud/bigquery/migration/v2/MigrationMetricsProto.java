...
public final class MigrationMetricsProto {
  ...
  static {
    ...
    internal_static_google_cloud_bigquery_migration_v2_TimeSeries_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_migration_v2_TimeSeries_descriptor,
        new java.lang.String[] { "Metric", "ValueType", "MetricKind", "Points", });
    internal_static_google_cloud_bigquery_migration_v2_Point_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_bigquery_migration_v2_Point_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_migration_v2_Point_descriptor,
        new java.lang.String[] { "Interval", "Value", });
    internal_static_google_cloud_bigquery_migration_v2_TimeInterval_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_bigquery_migration_v2_TimeInterval_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_migration_v2_TimeInterval_descriptor,
        new java.lang.String[] { "StartTime", "EndTime", });
    internal_static_google_cloud_bigquery_migration_v2_TypedValue_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_bigquery_migration_v2_TypedValue_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_bigquery_migration_v2_TypedValue_descriptor,
