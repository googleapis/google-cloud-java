...
com.google.cloud.bigquery.migration.v2alpha.MigrationTask defaultValue) {
  ...
  @java.lang.Override public com.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State getState() {
    com.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State result = com.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State.forNumber(state_);
  ...
  public static final class Builder extends
    ...
    private static final class TasksConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder, com.google.cloud.bigquery.migration.v2alpha.MigrationTask> {
      @java.lang.Override
      public com.google.cloud.bigquery.migration.v2alpha.MigrationTask build(com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder val) {
        if (val instanceof com.google.cloud.bigquery.migration.v2alpha.MigrationTask) { return (com.google.cloud.bigquery.migration.v2alpha.MigrationTask) val; }
        return ((com.google.cloud.bigquery.migration.v2alpha.MigrationTask.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTask> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder, com.google.cloud.bigquery.migration.v2alpha.MigrationTask, com.google.cloud.bigquery.migration.v2alpha.MigrationTask.Builder> tasks_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder, com.google.cloud.bigquery.migration.v2alpha.MigrationTask, com.google.cloud.bigquery.migration.v2alpha.MigrationTask.Builder>
        internalGetTasks() {
      if (tasks_ == null) {
...
com.google.cloud.bigquery.migration.v2alpha.MigrationTask defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder> map = internalGetMutableTasks().ensureBuilderMap();
    ...
    public Builder putAllTasks(
      ...
      for (java.util.Map.Entry<java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTask> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .google.cloud.bigquery.migration.v2alpha.MigrationTask&gt; tasks = 2;</code>
     */
    public com.google.cloud.bigquery.migration.v2alpha.MigrationTask.Builder putTasksBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder> builderMap = internalGetMutableTasks().ensureBuilderMap();
      com.google.cloud.bigquery.migration.v2alpha.MigrationTaskOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = com.google.cloud.bigquery.migration.v2alpha.MigrationTask.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof com.google.cloud.bigquery.migration.v2alpha.MigrationTask) {
        entry = ((com.google.cloud.bigquery.migration.v2alpha.MigrationTask) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (com.google.cloud.bigquery.migration.v2alpha.MigrationTask.Builder) entry;
    }
