...
public interface TranslateQueryResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.bigquery.migration.v2alpha.SqlTranslationError> 
      getErrorsList();
  /**
   * <pre>
   * The list of errors encountered during the translation, if present.
   ...
   * <code>repeated .google.cloud.bigquery.migration.v2alpha.SqlTranslationWarning warnings = 3;</code>
   */
  java.util.List<? extends com.google.cloud.bigquery.migration.v2alpha.SqlTranslationWarningOrBuilder> 
