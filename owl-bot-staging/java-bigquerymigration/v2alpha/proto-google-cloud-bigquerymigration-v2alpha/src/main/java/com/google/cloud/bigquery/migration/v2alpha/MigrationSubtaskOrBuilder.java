...
public interface MigrationSubtaskOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.bigquery.migration.v2alpha.MigrationSubtask)
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.migration.v2alpha.MigrationSubtask.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The state.
   */
  com.google.cloud.bigquery.migration.v2alpha.MigrationSubtask.State getState();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail resource_error_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * <code>repeated .google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail resource_error_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail getResourceErrorDetails(int index);
  /**
   * <pre>
   * Output only. Provides details to errors and issues encountered while processing the
   * subtask. Presence of error details does not mean that the subtask failed.
   ...
   * <code>repeated .google.cloud.bigquery.migration.v2alpha.ResourceErrorDetail resource_error_details = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.bigquery.migration.v2alpha.ResourceErrorDetailOrBuilder getResourceErrorDetailsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.bigquery.migration.v2alpha.TimeSeries> 
      getMetricsList();
  /**
   * <pre>
   * The metrics for the subtask.
   ...
   * <code>repeated .google.cloud.bigquery.migration.v2alpha.TimeSeries metrics = 11;</code>
   */
  com.google.cloud.bigquery.migration.v2alpha.TimeSeriesOrBuilder getMetricsOrBuilder(
      int index);
}
