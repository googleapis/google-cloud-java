...
public interface MigrationWorkflowOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.bigquery.migration.v2alpha.MigrationWorkflow)
   ...
   * </pre>
   *
   * <code>map&lt;string, .google.cloud.bigquery.migration.v2alpha.MigrationTask&gt; tasks = 2;</code>
   */
  int getTasksCount();
  /**
   * <pre>
...
com.google.cloud.bigquery.migration.v2alpha.MigrationTask defaultValue);
  ...
  com.google.cloud.bigquery.migration.v2alpha.MigrationTask getTasksOrThrow(
      java.lang.String key);
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The state.
   */
  com.google.cloud.bigquery.migration.v2alpha.MigrationWorkflow.State getState();
