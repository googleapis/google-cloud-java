...
public final class SqlTranslationServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest,
      com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse> getTranslateQueryMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest,
      com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse> getTranslateQueryMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest, com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse> getTranslateQueryMethod;
    if ((getTranslateQueryMethod = SqlTranslationServiceGrpc.getTranslateQueryMethod) == null) {
      synchronized (SqlTranslationServiceGrpc.class) {
        if ((getTranslateQueryMethod = SqlTranslationServiceGrpc.getTranslateQueryMethod) == null) {
          SqlTranslationServiceGrpc.getTranslateQueryMethod = getTranslateQueryMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest, com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse.getDefaultInstance()))
              .setSchemaDescriptor(new SqlTranslationServiceMethodDescriptorSupplier("TranslateQuery"))
              .build();
        }
      }
    }
  ...
  public static SqlTranslationServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SqlTranslationServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SqlTranslationServiceStub>() {
        @java.lang.Override
        public SqlTranslationServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static SqlTranslationServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<SqlTranslationServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SqlTranslationServiceBlockingStub>() {
        @java.lang.Override
        public SqlTranslationServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static SqlTranslationServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SqlTranslationServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SqlTranslationServiceFutureStub>() {
        @java.lang.Override
        public SqlTranslationServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class SqlTranslationServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void translateQuery(com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getTranslateQueryMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class SqlTranslationServiceStub extends io.grpc.stub.AbstractAsyncStub<SqlTranslationServiceStub> {
    private SqlTranslationServiceStub(
    ...
    public void translateQuery(com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getTranslateQueryMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class SqlTranslationServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<SqlTranslationServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse translateQuery(com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest request) {
   ...
   * </pre>
   */
  public static final class SqlTranslationServiceFutureStub extends io.grpc.stub.AbstractFutureStub<SqlTranslationServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse> translateQuery(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_TRANSLATE_QUERY:
          serviceImpl.translateQuery((com.google.cloud.bigquery.migration.v2alpha.TranslateQueryRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.bigquery.migration.v2alpha.TranslateQueryResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class SqlTranslationServiceBaseDescriptorSupplier
