...
public class CertificateMapEntryName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CERTIFICATE_MAP_CERTIFICATE_MAP_ENTRY =
  ...
  private CertificateMapEntryName(Builder builder) {
    ...
    certificateMap = Preconditions.checkNotNull(builder.getCertificateMap());
    certificateMapEntry = Preconditions.checkNotNull(builder.getCertificateMapEntry());
  }
  ...
  public static CertificateMapEntryName of(
  ...
  public static CertificateMapEntryName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CERTIFICATE_MAP_CERTIFICATE_MAP_ENTRY.validatedMatch(
            formattedString, "CertificateMapEntryName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("certificate_map"),
        matchMap.get("certificate_map_entry"));
  }

  public static List<CertificateMapEntryName> parseList(List<String> formattedStrings) {
    List<CertificateMapEntryName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (certificateMap != null) {
            fieldMapBuilder.put("certificate_map", certificateMap);
          }
          if (certificateMapEntry != null) {
            fieldMapBuilder.put("certificate_map_entry", certificateMapEntry);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_CERTIFICATE_MAP_CERTIFICATE_MAP_ENTRY.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.certificateMap, that.certificateMap)
          && Objects.equals(this.certificateMapEntry, that.certificateMapEntry);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(certificateMap);
    h *= 1000003;
    h ^= Objects.hashCode(certificateMapEntry);
    return h;
  }
