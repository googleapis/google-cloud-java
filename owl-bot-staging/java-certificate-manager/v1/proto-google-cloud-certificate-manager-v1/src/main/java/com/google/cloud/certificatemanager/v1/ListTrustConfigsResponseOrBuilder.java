...
public interface ListTrustConfigsResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.certificatemanager.v1.TrustConfig> 
      getTrustConfigsList();
  /**
   * <pre>
   * A list of TrustConfigs for the parent resource.
   ...
   * <code>repeated .google.cloud.certificatemanager.v1.TrustConfig trust_configs = 1;</code>
   */
  com.google.cloud.certificatemanager.v1.TrustConfigOrBuilder getTrustConfigsOrBuilder(
      int index);
