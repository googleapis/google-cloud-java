...
public interface DevicePolicyOrBuilder extends
   ...
   */
  java.util.List<com.google.identity.accesscontextmanager.type.DeviceEncryptionStatus> getAllowedEncryptionStatusesList();
  /**
   * <pre>
   * Allowed encryptions statuses, an empty list allows all statuses.
   * </pre>
   ...
   */
  com.google.identity.accesscontextmanager.type.DeviceEncryptionStatus getAllowedEncryptionStatuses(int index);
  /**
   * <pre>
   * Allowed encryptions statuses, an empty list allows all statuses.
   * </pre>
   ...
   */
  java.util.List<com.google.identity.accesscontextmanager.v1.OsConstraint> 
   ...
   */
  java.util.List<com.google.identity.accesscontextmanager.type.DeviceManagementLevel> getAllowedDeviceManagementLevelsList();
  /**
   * <pre>
   * Allowed device management levels, an empty list allows all management
   * levels.
   ...
   */
  com.google.identity.accesscontextmanager.type.DeviceManagementLevel getAllowedDeviceManagementLevels(int index);
  /**
   * <pre>
   * Allowed device management levels, an empty list allows all management
   * levels.
