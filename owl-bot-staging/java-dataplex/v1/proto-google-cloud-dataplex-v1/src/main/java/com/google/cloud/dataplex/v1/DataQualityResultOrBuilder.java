...
public interface DataQualityResultOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.dataplex.v1.DataQualityColumnResult columns = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.dataplex.v1.DataQualityColumnResult> 
      getColumnsList();
  /**
   * <pre>
   * Output only. A list of results at the column level.
   ...
   * <code>repeated .google.cloud.dataplex.v1.DataQualityColumnResult columns = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dataplex.v1.DataQualityColumnResultOrBuilder getColumnsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.dataplex.v1.DataQualityResult.PostScanActionsResult post_scan_actions_result = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * <code>.google.cloud.dataplex.v1.DataQualityResult.PostScanActionsResult post_scan_actions_result = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.dataplex.v1.DataQualityResult.PostScanActionsResultOrBuilder getPostScanActionsResultOrBuilder();
}
