...
public class DataAttributeBindingName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_DATA_ATTRIBUTE_BINDING_ID =
  ...
  protected DataAttributeBindingName() {
    project = null;
    location = null;
    dataAttributeBindingId = null;
  }

  private DataAttributeBindingName(Builder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
    dataAttributeBindingId = Preconditions.checkNotNull(builder.getDataAttributeBindingId());
  }
  ...
  public static DataAttributeBindingName of(
      String project, String location, String dataAttributeBindingId) {
    return newBuilder()
        .setProject(project)
  ...
  public static DataAttributeBindingName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_DATA_ATTRIBUTE_BINDING_ID.validatedMatch(
            formattedString, "DataAttributeBindingName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("data_attribute_binding_id"));
  }

  public static List<DataAttributeBindingName> parseList(List<String> formattedStrings) {
    List<DataAttributeBindingName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (dataAttributeBindingId != null) {
            fieldMapBuilder.put("data_attribute_binding_id", dataAttributeBindingId);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_DATA_ATTRIBUTE_BINDING_ID.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.dataAttributeBindingId, that.dataAttributeBindingId);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(dataAttributeBindingId);
    return h;
  }
