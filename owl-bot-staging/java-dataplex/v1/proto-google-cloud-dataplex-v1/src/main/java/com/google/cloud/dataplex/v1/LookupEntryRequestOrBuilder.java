...
public interface LookupEntryRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dataplex.v1.EntryView view = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>string entry = 5 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
   * @return The entry.
   */
