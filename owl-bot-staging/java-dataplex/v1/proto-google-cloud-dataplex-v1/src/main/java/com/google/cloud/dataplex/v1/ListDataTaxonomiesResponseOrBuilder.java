...
public interface ListDataTaxonomiesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataplex.v1.ListDataTaxonomiesResponse)
   ...
   */
  java.util.List<com.google.cloud.dataplex.v1.DataTaxonomy> 
      getDataTaxonomiesList();
  /**
   * <pre>
   * DataTaxonomies under the given parent location.
   * </pre>
   ...
   * <code>repeated .google.cloud.dataplex.v1.DataTaxonomy data_taxonomies = 1;</code>
   */
  com.google.cloud.dataplex.v1.DataTaxonomyOrBuilder getDataTaxonomiesOrBuilder(
      int index);
