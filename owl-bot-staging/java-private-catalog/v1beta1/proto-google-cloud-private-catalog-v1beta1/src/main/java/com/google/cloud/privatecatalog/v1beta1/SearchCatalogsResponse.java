        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              catalogs_ = new java.util.ArrayList<com.google.cloud.privatecatalog.v1beta1.Catalog>();
              mutable_bitField0_ |= 0x00000001;
            }
            catalogs_.add(
                input.readMessage(com.google.cloud.privatecatalog.v1beta1.Catalog.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse) e.getUnfinishedMessage();
