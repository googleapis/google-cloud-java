...
public final class HubProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "cloud-platformB\302\003\n\'com.google.cloud.netw" +
      "orkconnectivity.v1B\010HubProtoP\001ZYcloud.go" +
      "ogle.com/go/networkconnectivity/apiv1/ne" +
      "tworkconnectivitypb;networkconnectivityp" +
      "b\252\002#Google.Cloud.NetworkConnectivity.V1\312" +
      "\002#Google\\Cloud\\NetworkConnectivity\\V1\352\002&" +
      "Google::Cloud::NetworkConnectivity::V1\352A" +
      "`\n compute.googleapis.com/VpnTunnel\022<pro" +
      "jects/{project}/regions/{region}/vpnTunn" +
      "els/{resource_id}\352AW\n\037compute.googleapis" +
    ...
    internal_static_google_cloud_networkconnectivity_v1_Hub_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_networkconnectivity_v1_Hub_descriptor,
        new java.lang.String[] { "Name", "CreateTime", "UpdateTime", "Labels", "Description", "UniqueId", "State", "RoutingVpcs", });
    internal_static_google_cloud_networkconnectivity_v1_Hub_LabelsEntry_descriptor =
