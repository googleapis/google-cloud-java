...
public class PolicyBasedRouteName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_POLICY_BASED_ROUTE =
  ...
  public static PolicyBasedRouteName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_POLICY_BASED_ROUTE.validatedMatch(
            formattedString, "PolicyBasedRouteName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("policy_based_route"));
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_POLICY_BASED_ROUTE.instantiate(
        "project", project, "location", location, "policy_based_route", policyBasedRoute);
  }
  ...
  /** Builder for projects/{project}/{location}/global/PolicyBasedRoutes/{policy_based_route}. */
