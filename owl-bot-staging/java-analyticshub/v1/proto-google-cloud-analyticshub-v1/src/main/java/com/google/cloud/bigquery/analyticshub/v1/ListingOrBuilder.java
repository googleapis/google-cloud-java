...
public interface ListingOrBuilder extends
   ...
   */
  com.google.cloud.bigquery.analyticshub.v1.Listing.RestrictedExportConfig getRestrictedExportConfig();
  /**
   * <pre>
   * Optional. If set, restricted export configuration will be propagated and
   * enforced on the linked dataset.
   ...
   * <code>.google.cloud.bigquery.analyticshub.v1.Listing.RestrictedExportConfig restricted_export_config = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.bigquery.analyticshub.v1.Listing.RestrictedExportConfigOrBuilder getRestrictedExportConfigOrBuilder();
