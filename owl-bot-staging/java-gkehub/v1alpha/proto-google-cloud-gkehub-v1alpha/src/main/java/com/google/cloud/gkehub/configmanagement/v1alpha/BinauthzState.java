...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion.Builder subBuilder = null;
            if (version_ != null) {
              subBuilder = version_.toBuilder();
            }
            version_ = input.readMessage(com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  @java.lang.Override public com.google.cloud.gkehub.configmanagement.v1alpha.DeploymentState getWebhook() {
    ...
    com.google.cloud.gkehub.configmanagement.v1alpha.DeploymentState result = com.google.cloud.gkehub.configmanagement.v1alpha.DeploymentState.valueOf(webhook_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzState parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzState) e.getUnfinishedMessage();
    ...
    public Builder mergeVersion(com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion value) {
      if (versionBuilder_ == null) {
        if (version_ != null) {
          version_ =
            com.google.cloud.gkehub.configmanagement.v1alpha.BinauthzVersion.newBuilder(version_).mergeFrom(value).buildPartial();
        } else {
          version_ = value;
        }
        onChanged();
