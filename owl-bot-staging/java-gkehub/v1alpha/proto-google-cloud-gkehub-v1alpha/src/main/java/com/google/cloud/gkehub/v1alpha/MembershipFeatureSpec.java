...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.gkehub.v1alpha.MembershipFeatureSpec result) {
      int from_bitField0_ = bitField0_;
    }

    private void buildPartialOneofs(com.google.cloud.gkehub.v1alpha.MembershipFeatureSpec result) {
      result.featureSpecCase_ = featureSpecCase_;
      result.featureSpec_ = this.featureSpec_;
      if (featureSpecCase_ == 106 &&
          configmanagementBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 850: {
              input.readMessage(
                  getConfigmanagementFieldBuilder().getBuilder(),
                  extensionRegistry);
