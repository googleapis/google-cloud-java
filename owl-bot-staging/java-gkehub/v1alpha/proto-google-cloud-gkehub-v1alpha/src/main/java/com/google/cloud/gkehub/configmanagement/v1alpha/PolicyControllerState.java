...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.gkehub.configmanagement.v1alpha.PolicyControllerState result) {
    ...
    public Builder mergeVersion(com.google.cloud.gkehub.configmanagement.v1alpha.PolicyControllerVersion value) {
      if (versionBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          version_ != null &&
          version_ != com.google.cloud.gkehub.configmanagement.v1alpha.PolicyControllerVersion.getDefaultInstance()) {
    ...
    public Builder mergeDeploymentState(com.google.cloud.gkehub.configmanagement.v1alpha.GatekeeperDeploymentState value) {
      if (deploymentStateBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          deploymentState_ != null &&
          deploymentState_ != com.google.cloud.gkehub.configmanagement.v1alpha.GatekeeperDeploymentState.getDefaultInstance()) {
