...
public interface KubernetesResourceOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.gkehub.v1.KubernetesResource)
   ...
   */
  java.util.List<com.google.cloud.gkehub.v1.ResourceManifest> 
   ...
   * <code>repeated .google.cloud.gkehub.v1.ResourceManifest membership_resources = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.gkehub.v1.ResourceManifestOrBuilder getMembershipResourcesOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.gkehub.v1.ResourceManifest connect_resources = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.gkehub.v1.ResourceManifestOrBuilder getConnectResourcesOrBuilder(
      int index);
   ...
   * <code>.google.cloud.gkehub.v1.ResourceOptions resource_options = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.gkehub.v1.ResourceOptionsOrBuilder getResourceOptionsOrBuilder();
}
