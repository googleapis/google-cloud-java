...
public interface FileOrBuilder extends
   ...
   */
  java.util.List<com.google.devtools.artifactregistry.v1.Hash> 
      getHashesList();
  /**
   * <pre>
   * The hashes of the file content.
   ...
   * <code>repeated .google.devtools.artifactregistry.v1.Hash hashes = 4;</code>
   */
  com.google.devtools.artifactregistry.v1.HashOrBuilder getHashesOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp fetch_time = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
