...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.devtools.artifactregistry.v1beta2.UpdateProjectSettingsRequest result) {
      int from_bitField0_ = bitField0_;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.projectSettings_ = projectSettingsBuilder_ == null
            ? projectSettings_
            : projectSettingsBuilder_.build();
      }
    ...
    public Builder mergeProjectSettings(com.google.devtools.artifactregistry.v1beta2.ProjectSettings value) {
      if (projectSettingsBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          projectSettings_ != null &&
          projectSettings_ != com.google.devtools.artifactregistry.v1beta2.ProjectSettings.getDefaultInstance()) {
