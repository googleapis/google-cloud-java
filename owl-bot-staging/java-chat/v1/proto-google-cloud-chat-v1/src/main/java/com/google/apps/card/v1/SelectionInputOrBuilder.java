...
public interface SelectionInputOrBuilder extends
   ...
   */
  java.util.List<com.google.apps.card.v1.SelectionInput.SelectionItem> 
      getItemsList();
  /**
   * <pre>
   * An array of selectable items. For example, an array of radio buttons or
   ...
   * <code>repeated .google.apps.card.v1.SelectionInput.SelectionItem items = 4;</code>
   */
  com.google.apps.card.v1.SelectionInput.SelectionItemOrBuilder getItemsOrBuilder(
      int index);
   ...
   * <code>.google.apps.card.v1.SelectionInput.PlatformDataSource platform_data_source = 9;</code>
   */
  com.google.apps.card.v1.SelectionInput.PlatformDataSourceOrBuilder getPlatformDataSourceOrBuilder();
