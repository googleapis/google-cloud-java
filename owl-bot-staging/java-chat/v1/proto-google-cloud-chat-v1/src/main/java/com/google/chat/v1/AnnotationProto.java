...
public final class AnnotationProto {
  ...
  static {
    ...
    internal_static_google_chat_v1_Annotation_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_chat_v1_Annotation_descriptor,
        new java.lang.String[] { "Type", "StartIndex", "Length", "UserMention", "SlashCommand", "RichLinkMetadata", "Metadata", });
    internal_static_google_chat_v1_UserMentionMetadata_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_chat_v1_UserMentionMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_chat_v1_UserMentionMetadata_descriptor,
        new java.lang.String[] { "User", "Type", });
    internal_static_google_chat_v1_SlashCommandMetadata_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_chat_v1_SlashCommandMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_chat_v1_SlashCommandMetadata_descriptor,
        new java.lang.String[] { "Bot", "Type", "CommandName", "CommandId", "TriggersDialog", });
    internal_static_google_chat_v1_RichLinkMetadata_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_chat_v1_RichLinkMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_chat_v1_RichLinkMetadata_descriptor,
        new java.lang.String[] { "Uri", "RichLinkType", "DriveLinkData", "Data", });
    internal_static_google_chat_v1_DriveLinkData_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_chat_v1_DriveLinkData_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_chat_v1_DriveLinkData_descriptor,
        new java.lang.String[] { "DriveDataRef", "MimeType", });
    com.google.chat.v1.AttachmentProto.getDescriptor();
    com.google.chat.v1.UserProto.getDescriptor();
  }
