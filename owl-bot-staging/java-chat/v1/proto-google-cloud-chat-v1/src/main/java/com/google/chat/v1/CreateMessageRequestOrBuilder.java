...
public interface CreateMessageRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>string thread_key = 6 [deprecated = true, (.google.api.field_behavior) = OPTIONAL];</code>
   * @deprecated google.chat.v1.CreateMessageRequest.thread_key is deprecated.
   *     See google/chat/v1/message.proto;l=548
   * @return The threadKey.
   */
  @java.lang.Deprecated java.lang.String getThreadKey();
  /**
   * <pre>
   * Optional. Deprecated: Use
   * [thread.thread_key][google.chat.v1.Thread.thread_key] instead. ID for the
   ...
   * </pre>
   *
   * <code>.google.chat.v1.CreateMessageRequest.MessageReplyOption message_reply_option = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
