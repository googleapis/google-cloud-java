      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 58: {
            ...
            time_ =
                input.readMessage(com.google.cloud.asset.v1.TimeWindow.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 74: {
            ...
            outputConfig_ = input.readMessage(com.google.cloud.asset.v1.QueryAssetsOutputConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
