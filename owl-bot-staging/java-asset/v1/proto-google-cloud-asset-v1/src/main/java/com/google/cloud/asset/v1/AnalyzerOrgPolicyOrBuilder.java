...
public interface AnalyzerOrgPolicyOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.asset.v1.AnalyzerOrgPolicy.Rule> 
      getRulesList();
  /**
   * <pre>
   * List of rules for this organization policy.
   ...
   * <code>repeated .google.cloud.asset.v1.AnalyzerOrgPolicy.Rule rules = 2;</code>
   */
  com.google.cloud.asset.v1.AnalyzerOrgPolicy.RuleOrBuilder getRulesOrBuilder(
      int index);
