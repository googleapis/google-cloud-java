 ...
 *      <td><p>Searches all the resources within a given accessible Resource Manager scope
 ...
 *      <td><p>Searches all the IAM policies within a given accessible Resource Manager
 ...
 *  requested scope, otherwise the request will be rejected.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
