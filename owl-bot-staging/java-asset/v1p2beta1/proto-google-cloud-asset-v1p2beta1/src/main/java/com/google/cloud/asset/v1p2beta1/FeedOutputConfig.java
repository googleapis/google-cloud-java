        ...
        switch (tag) {
          ...
          case 10: {
            ...
            if (destinationCase_ == 1) {
              subBuilder = ((com.google.cloud.asset.v1p2beta1.PubsubDestination) destination_).toBuilder();
            }
            destination_ =
                input.readMessage(com.google.cloud.asset.v1p2beta1.PubsubDestination.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.asset.v1p2beta1.PubsubDestination) destination_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.asset.v1p2beta1.FeedOutputConfig) e.getUnfinishedMessage();
