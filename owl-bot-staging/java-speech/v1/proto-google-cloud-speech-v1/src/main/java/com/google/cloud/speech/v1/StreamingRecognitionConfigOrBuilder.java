...
public interface StreamingRecognitionConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.speech.v1.StreamingRecognitionConfig.VoiceActivityTimeout voice_activity_timeout = 6;</code>
   ...
   */
  com.google.cloud.speech.v1.StreamingRecognitionConfig.VoiceActivityTimeout getVoiceActivityTimeout();
  /**
   * <pre>
   * If set, the server will automatically close the stream after the specified
   * duration has elapsed after the last VOICE_ACTIVITY speech event has been
   ...
   * <code>.google.cloud.speech.v1.StreamingRecognitionConfig.VoiceActivityTimeout voice_activity_timeout = 6;</code>
   */
  com.google.cloud.speech.v1.StreamingRecognitionConfig.VoiceActivityTimeoutOrBuilder getVoiceActivityTimeoutOrBuilder();
}
