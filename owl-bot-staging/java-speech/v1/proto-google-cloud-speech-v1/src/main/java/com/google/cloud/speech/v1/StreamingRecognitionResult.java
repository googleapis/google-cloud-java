...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.speech.v1.StreamingRecognitionResult result) {
      if (alternativesBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)) {
    ...
    private void buildPartial0(com.google.cloud.speech.v1.StreamingRecognitionResult result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.resultEndTime_ = resultEndTimeBuilder_ == null
            ? resultEndTime_
            : resultEndTimeBuilder_.build();
