...
public interface StreamingRecognitionConfigOrBuilder extends
   ...
   */
  com.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeout getVoiceActivityTimeout();
  /**
   * <pre>
   * If set, the server will automatically close the stream after the specified
   * duration has elapsed after the last VOICE_ACTIVITY speech event has been
   ...
   * <code>.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeout voice_activity_timeout = 6;</code>
   */
  com.google.cloud.speech.v1p1beta1.StreamingRecognitionConfig.VoiceActivityTimeoutOrBuilder getVoiceActivityTimeoutOrBuilder();
}
