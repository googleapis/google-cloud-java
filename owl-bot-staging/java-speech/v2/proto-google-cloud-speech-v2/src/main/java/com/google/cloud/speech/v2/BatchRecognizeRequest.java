        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              files_ = new java.util.ArrayList<com.google.cloud.speech.v2.BatchRecognizeFileMetadata>();
              mutable_bitField0_ |= 0x00000001;
            }
            files_.add(
                input.readMessage(com.google.cloud.speech.v2.BatchRecognizeFileMetadata.parser(), extensionRegistry));
            break;
          }
          case 34: {
