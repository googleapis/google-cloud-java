...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getVttFormatUri()
        .equals(other.getVttFormatUri())) return false;
    if (!getSrtFormatUri()
        .equals(other.getSrtFormatUri())) return false;
  ...
  public static final class Builder extends
     ...
     * @return This builder for chaining.
     */
    public Builder setVttFormatUri(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      vttFormatUri_ = value;
      bitField0_ |= 0x00000002;
     ...
     * @return This builder for chaining.
     */
    public Builder setVttFormatUriBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      vttFormatUri_ = value;
     ...
     * @return This builder for chaining.
     */
    public Builder setSrtFormatUri(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      srtFormatUri_ = value;
      bitField0_ |= 0x00000004;
     ...
     * @return This builder for chaining.
     */
    public Builder setSrtFormatUriBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      srtFormatUri_ = value;
