      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            features_ = input.readMessage(com.google.cloud.speech.v2.RecognitionFeatures.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 50: {
            ...
            adaptation_ = input.readMessage(com.google.cloud.speech.v2.SpeechAdaptation.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 58: {
            ...
            if (decodingConfigCase_ == 7) {
              subBuilder = ((com.google.cloud.speech.v2.AutoDetectDecodingConfig) decodingConfig_).toBuilder();
            }
            decodingConfig_ =
                input.readMessage(com.google.cloud.speech.v2.AutoDetectDecodingConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.speech.v2.AutoDetectDecodingConfig) decodingConfig_);
          ...
          case 66: {
            ...
            if (decodingConfigCase_ == 8) {
              subBuilder = ((com.google.cloud.speech.v2.ExplicitDecodingConfig) decodingConfig_).toBuilder();
            }
            decodingConfig_ =
                input.readMessage(com.google.cloud.speech.v2.ExplicitDecodingConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.speech.v2.ExplicitDecodingConfig) decodingConfig_);
              decodingConfig_ = subBuilder.buildPartial();
            }
  ...
  public static final class Builder extends
    ...
    public Builder mergeFeatures(com.google.cloud.speech.v2.RecognitionFeatures value) {
      if (featuresBuilder_ == null) {
        if (features_ != null) {
          features_ =
            com.google.cloud.speech.v2.RecognitionFeatures.newBuilder(features_).mergeFrom(value).buildPartial();
        } else {
          features_ = value;
        }
        onChanged();
    ...
    public Builder mergeAdaptation(com.google.cloud.speech.v2.SpeechAdaptation value) {
      if (adaptationBuilder_ == null) {
        if (adaptation_ != null) {
          adaptation_ =
            com.google.cloud.speech.v2.SpeechAdaptation.newBuilder(adaptation_).mergeFrom(value).buildPartial();
        } else {
          adaptation_ = value;
        }
        onChanged();
