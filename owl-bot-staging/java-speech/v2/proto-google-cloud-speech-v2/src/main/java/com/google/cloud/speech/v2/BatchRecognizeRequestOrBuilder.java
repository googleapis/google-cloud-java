...
public interface BatchRecognizeRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.speech.v2.BatchRecognizeFileMetadata> 
      getFilesList();
  /**
   * <pre>
   * Audio files with file metadata for ASR.
   ...
   * <code>repeated .google.cloud.speech.v2.BatchRecognizeFileMetadata files = 3;</code>
   */
  com.google.cloud.speech.v2.BatchRecognizeFileMetadataOrBuilder getFilesOrBuilder(
      int index);
}
