...
public interface SpeechRecognitionAlternativeOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.speech.v2.WordInfo> 
      getWordsList();
  /**
   * <pre>
   * A list of word-specific information for each recognized word.
   ...
   * <code>repeated .google.cloud.speech.v2.WordInfo words = 3;</code>
   */
  java.util.List<? extends com.google.cloud.speech.v2.WordInfoOrBuilder> 
   ...
   * <code>repeated .google.cloud.speech.v2.WordInfo words = 3;</code>
   */
  com.google.cloud.speech.v2.WordInfoOrBuilder getWordsOrBuilder(
      int index);
}
