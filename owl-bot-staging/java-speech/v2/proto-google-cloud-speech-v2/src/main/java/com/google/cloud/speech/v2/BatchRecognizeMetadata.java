  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.speech.v2.BatchRecognizeMetadata result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.transcriptionMetadata_ = internalGetTranscriptionMetadata().build(TranscriptionMetadataDefaultEntryHolder.defaultEntry);
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              internalGetMutableTranscriptionMetadata().ensureBuilderMap().put(
    ...
    private static final class TranscriptionMetadataConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata> {
      @java.lang.Override
      public com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata build(com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder val) {
        if (val instanceof com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata) { return (com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata) val; }
        return ((com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata> defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata.Builder> transcriptionMetadata_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata.Builder>
        internalGetTranscriptionMetadata() {
      if (transcriptionMetadata_ == null) {
    ...
    private com.google.protobuf.MapFieldBuilder<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata.Builder>
      ...
      if (transcriptionMetadata_ == null) {
        transcriptionMetadata_ = new com.google.protobuf.MapFieldBuilder<>(transcriptionMetadataConverter);
      }
      bitField0_ |= 0x00000001;
      onChanged();
      return transcriptionMetadata_;
...
com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder> map = internalGetMutableTranscriptionMetadata().ensureBuilderMap();
      return map.containsKey(key) ? transcriptionMetadataConverter.build(map.get(key)) : defaultValue;
    }
    /**
     * <pre>
     * Map from provided filename to the transcription metadata for that file.
    ...
    public Builder removeTranscriptionMetadata(
        java.lang.String key) {
      if (key == null) { throw new NullPointerException("map key"); }
      internalGetMutableTranscriptionMetadata().ensureBuilderMap()
          .remove(key);
      return this;
    }
    /**
    ...
    public Builder putAllTranscriptionMetadata(
      ...
      for (java.util.Map.Entry<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata&gt; transcription_metadata = 1;</code>
     */
    public com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata.Builder putTranscriptionMetadataBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder> builderMap = internalGetMutableTranscriptionMetadata().ensureBuilderMap();
      com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadataOrBuilder entry = builderMap.get(key);
      if (entry == null) {
      ...
      if (entry instanceof com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata) {
        entry = ((com.google.cloud.speech.v2.BatchRecognizeTranscriptionMetadata) entry).toBuilder();
        builderMap.put(key, entry);
      }
