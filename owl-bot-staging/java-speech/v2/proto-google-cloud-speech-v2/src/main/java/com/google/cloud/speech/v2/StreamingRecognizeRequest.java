...
private static final long serialVersionUID = 0L;
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 50: {
            com.google.cloud.speech.v2.StreamingRecognitionConfig.Builder subBuilder = null;
            if (streamingRequestCase_ == 6) {
              subBuilder = ((com.google.cloud.speech.v2.StreamingRecognitionConfig) streamingRequest_).toBuilder();
            }
            streamingRequest_ =
                input.readMessage(com.google.cloud.speech.v2.StreamingRecognitionConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.speech.v2.StreamingRecognitionConfig) streamingRequest_);
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.speech.v2.StreamingRecognizeRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.speech.v2.StreamingRecognizeRequest) e.getUnfinishedMessage();
