...
public interface BatchRecognizeFileResultOrBuilder extends
   ...
   * @deprecated google.cloud.speech.v2.BatchRecognizeFileResult.uri is deprecated.
   *     See google/cloud/speech/v2/cloud_speech.proto;l=1406
   * @return The uri.
   */
   ...
   * @deprecated google.cloud.speech.v2.BatchRecognizeFileResult.transcript is deprecated.
   *     See google/cloud/speech/v2/cloud_speech.proto;l=1409
   * @return Whether the transcript field is set.
   */
  @java.lang.Deprecated boolean hasTranscript();
  /**
   * <pre>
   * Deprecated. Use `inline_result.transcript` instead.
   * </pre>
   ...
   */
  @java.lang.Deprecated com.google.cloud.speech.v2.BatchRecognizeResults getTranscript();
  /**
   * <pre>
   * Deprecated. Use `inline_result.transcript` instead.
   * </pre>
   ...
   * <code>.google.cloud.speech.v2.BatchRecognizeResults transcript = 4 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.speech.v2.BatchRecognizeResultsOrBuilder getTranscriptOrBuilder();
