 ...
 *      <td><p>Lists the domain mappings on an application.</p></td>
 *      <td>
 ...
 *      <td><p>Gets the specified domain mapping.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Maps a domain to an application. A user must be authorized to administer a
 *  domain in order to map it to an application. For a list of available
 *  authorized domains, see [`AuthorizedDomains.ListAuthorizedDomains`]().</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Updates the specified domain mapping. To map an SSL certificate to a
 ...
 *  in order to update a `DomainMapping` resource.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Deletes the specified domain mapping. A user must be authorized to
