...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasAggregationWindowLength()) {
      if (!getAggregationWindowLength()
          .equals(other.getAggregationWindowLength())) return false;
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.appengine.v1.CpuUtilization result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.aggregationWindowLength_ = aggregationWindowLengthBuilder_ == null
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getAggregationWindowLengthFieldBuilder().getBuilder(),
                  extensionRegistry);
