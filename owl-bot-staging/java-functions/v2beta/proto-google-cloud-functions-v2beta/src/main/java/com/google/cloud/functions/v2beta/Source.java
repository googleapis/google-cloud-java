      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            if (sourceCase_ == 1) {
              subBuilder = ((com.google.cloud.functions.v2beta.StorageSource) source_).toBuilder();
            }
            source_ =
                input.readMessage(com.google.cloud.functions.v2beta.StorageSource.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 18: {
            ...
            source_ =
                input.readMessage(com.google.cloud.functions.v2beta.RepoSource.parser(), extensionRegistry);
            if (subBuilder != null) {
