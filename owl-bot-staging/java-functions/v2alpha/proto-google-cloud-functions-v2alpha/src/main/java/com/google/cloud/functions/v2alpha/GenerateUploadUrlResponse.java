...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.functions.v2alpha.GenerateUploadUrlResponse result) {
    ...
    public Builder mergeStorageSource(com.google.cloud.functions.v2alpha.StorageSource value) {
      if (storageSourceBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          storageSource_ != null &&
          storageSource_ != com.google.cloud.functions.v2alpha.StorageSource.getDefaultInstance()) {
