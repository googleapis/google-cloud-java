...
public interface EventTriggerOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.functions.v2.EventFilter> 
      getEventFiltersList();
  /**
   * <pre>
   * Criteria used to filter events.
   ...
   * </pre>
   *
   * <code>.google.cloud.functions.v2.EventTrigger.RetryPolicy retry_policy = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
