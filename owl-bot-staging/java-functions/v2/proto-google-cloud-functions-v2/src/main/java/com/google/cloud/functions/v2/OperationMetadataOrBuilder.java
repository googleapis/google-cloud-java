...
public interface OperationMetadataOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.functions.v2.Stage> 
      getStagesList();
  /**
   * <pre>
   * Mechanism for reporting in-progress stages
   ...
   * <code>repeated .google.cloud.functions.v2.Stage stages = 9;</code>
   */
  java.util.List<? extends com.google.cloud.functions.v2.StageOrBuilder> 
   ...
   * <code>repeated .google.cloud.functions.v2.Stage stages = 9;</code>
   */
  com.google.cloud.functions.v2.StageOrBuilder getStagesOrBuilder(
      int index);
}
