        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              customMetrics_ = new java.util.ArrayList<com.google.analytics.admin.v1beta.CustomMetric>();
              mutable_bitField0_ |= 0x00000001;
            }
            customMetrics_.add(
                input.readMessage(com.google.analytics.admin.v1beta.CustomMetric.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.analytics.admin.v1beta.ListCustomMetricsResponse) e.getUnfinishedMessage();
