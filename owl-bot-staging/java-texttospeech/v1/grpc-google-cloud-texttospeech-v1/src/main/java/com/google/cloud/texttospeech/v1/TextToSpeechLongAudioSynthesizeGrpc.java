...
public final class TextToSpeechLongAudioSynthesizeGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest,
      com.google.longrunning.Operation> getSynthesizeLongAudioMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest,
      com.google.longrunning.Operation> getSynthesizeLongAudioMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest, com.google.longrunning.Operation> getSynthesizeLongAudioMethod;
    if ((getSynthesizeLongAudioMethod = TextToSpeechLongAudioSynthesizeGrpc.getSynthesizeLongAudioMethod) == null) {
      synchronized (TextToSpeechLongAudioSynthesizeGrpc.class) {
        if ((getSynthesizeLongAudioMethod = TextToSpeechLongAudioSynthesizeGrpc.getSynthesizeLongAudioMethod) == null) {
          TextToSpeechLongAudioSynthesizeGrpc.getSynthesizeLongAudioMethod = getSynthesizeLongAudioMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "SynthesizeLongAudio"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new TextToSpeechLongAudioSynthesizeMethodDescriptorSupplier("SynthesizeLongAudio"))
              .build();
        }
      }
    }
  ...
  public static TextToSpeechLongAudioSynthesizeStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<TextToSpeechLongAudioSynthesizeStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<TextToSpeechLongAudioSynthesizeStub>() {
        @java.lang.Override
        public TextToSpeechLongAudioSynthesizeStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static TextToSpeechLongAudioSynthesizeBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<TextToSpeechLongAudioSynthesizeBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<TextToSpeechLongAudioSynthesizeBlockingStub>() {
        @java.lang.Override
        public TextToSpeechLongAudioSynthesizeBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static TextToSpeechLongAudioSynthesizeFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<TextToSpeechLongAudioSynthesizeFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<TextToSpeechLongAudioSynthesizeFutureStub>() {
        @java.lang.Override
        public TextToSpeechLongAudioSynthesizeFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static abstract class TextToSpeechLongAudioSynthesizeImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void synthesizeLongAudio(com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getSynthesizeLongAudioMethod(), responseObserver);
    }
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
              new MethodHandlers<
                ...
                com.google.longrunning.Operation>(
                  this, METHODID_SYNTHESIZE_LONG_AUDIO)))
          .build();
    }
  }
   ...
   * </pre>
   */
  public static final class TextToSpeechLongAudioSynthesizeStub extends io.grpc.stub.AbstractAsyncStub<TextToSpeechLongAudioSynthesizeStub> {
    ...
    public void synthesizeLongAudio(com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getSynthesizeLongAudioMethod(), getCallOptions()), request, responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class TextToSpeechLongAudioSynthesizeBlockingStub extends io.grpc.stub.AbstractBlockingStub<TextToSpeechLongAudioSynthesizeBlockingStub> {
     ...
     * </pre>
     */
    public com.google.longrunning.Operation synthesizeLongAudio(com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest request) {
   ...
   * </pre>
   */
  public static final class TextToSpeechLongAudioSynthesizeFutureStub extends io.grpc.stub.AbstractFutureStub<TextToSpeechLongAudioSynthesizeFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation> synthesizeLongAudio(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SYNTHESIZE_LONG_AUDIO:
          serviceImpl.synthesizeLongAudio((com.google.cloud.texttospeech.v1.SynthesizeLongAudioRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
  ...
  private static abstract class TextToSpeechLongAudioSynthesizeBaseDescriptorSupplier
  ...
  private static final class TextToSpeechLongAudioSynthesizeMethodDescriptorSupplier
    ...
    TextToSpeechLongAudioSynthesizeMethodDescriptorSupplier(String methodName) {
      ...
      synchronized (TextToSpeechLongAudioSynthesizeGrpc.class) {
        ...
        if (result == null) {
          serviceDescriptor = result = io.grpc.ServiceDescriptor.newBuilder(SERVICE_NAME)
              .setSchemaDescriptor(new TextToSpeechLongAudioSynthesizeFileDescriptorSupplier())
