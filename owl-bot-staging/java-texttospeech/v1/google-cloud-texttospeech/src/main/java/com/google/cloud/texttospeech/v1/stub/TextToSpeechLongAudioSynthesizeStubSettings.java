...
/**
 * Settings class to configure an instance of {@link TextToSpeechLongAudioSynthesizeStub}.
 *
...
public class TextToSpeechLongAudioSynthesizeStubSettings
  ...
  private final UnaryCallSettings<SynthesizeLongAudioRequest, Operation>
      synthesizeLongAudioSettings;
  ...
  public UnaryCallSettings<SynthesizeLongAudioRequest, Operation> synthesizeLongAudioSettings() {
    return synthesizeLongAudioSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(TextToSpeechLongAudioSynthesizeStubSettings.class))
        .setTransportToken(
  ...
  protected TextToSpeechLongAudioSynthesizeStubSettings(Builder settingsBuilder)
      throws IOException {
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<SynthesizeLongAudioRequest, Operation>
        synthesizeLongAudioSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      synthesizeLongAudioSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      synthesizeLongAudioOperationSettings = OperationCallSettings.newBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(synthesizeLongAudioSettings);
      initDefaults(this);
    }
    ...
    protected Builder(TextToSpeechLongAudioSynthesizeStubSettings settings) {
      ...
      synthesizeLongAudioSettings = settings.synthesizeLongAudioSettings.toBuilder();
      synthesizeLongAudioOperationSettings =
          settings.synthesizeLongAudioOperationSettings.toBuilder();
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<SynthesizeLongAudioRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("no_retry_1_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("no_retry_1_params"))
                  .build())
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.create(
                  SynthesizeLongAudioResponse.class))
          .setMetadataTransformer(
              ProtoOperationTransformers.MetadataTransformer.create(
                  SynthesizeLongAudioMetadata.class))
          .setPollingAlgorithm(
