...
import com.google.cloud.vpcaccess.v1.VpcAccessServiceGrpc.VpcAccessServiceImplBase;
...
public class MockVpcAccessServiceImpl extends VpcAccessServiceImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockVpcAccessServiceImpl() {
  ...
  public void createConnector(
      CreateConnectorRequest request, StreamObserver<Operation> responseObserver) {
  ...
  public void deleteConnector(
      DeleteConnectorRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
