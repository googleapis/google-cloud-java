...
public interface PartnerOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.cloudcontrolspartner.v1beta.Sku> 
      getSkusList();
  /**
   * <pre>
   * List of SKUs the partner is offering
   ...
   * <code>repeated .google.cloud.cloudcontrolspartner.v1beta.Sku skus = 3;</code>
   */
  com.google.cloud.cloudcontrolspartner.v1beta.SkuOrBuilder getSkusOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.cloudcontrolspartner.v1beta.EkmMetadata> 
      getEkmSolutionsList();
  /**
   * <pre>
   * List of Google Cloud supported EKM partners supported by the partner
