...
public final class AccessApprovalRequestsProto {
  ...
  static {
    ...
    internal_static_google_cloud_cloudcontrolspartner_v1_AccessApprovalRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_cloudcontrolspartner_v1_AccessApprovalRequest_descriptor,
        new java.lang.String[] { "Name", "RequestTime", "RequestedReason", "RequestedExpirationTime", });
    internal_static_google_cloud_cloudcontrolspartner_v1_ListAccessApprovalRequestsRequest_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_cloudcontrolspartner_v1_ListAccessApprovalRequestsRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_cloudcontrolspartner_v1_ListAccessApprovalRequestsRequest_descriptor,
        new java.lang.String[] { "Parent", "PageSize", "PageToken", "Filter", "OrderBy", });
    internal_static_google_cloud_cloudcontrolspartner_v1_ListAccessApprovalRequestsResponse_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_cloudcontrolspartner_v1_ListAccessApprovalRequestsResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_cloudcontrolspartner_v1_ListAccessApprovalRequestsResponse_descriptor,
        new java.lang.String[] { "AccessApprovalRequests", "NextPageToken", "Unreachable", });
    internal_static_google_cloud_cloudcontrolspartner_v1_AccessReason_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_cloudcontrolspartner_v1_AccessReason_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_cloudcontrolspartner_v1_AccessReason_descriptor,
