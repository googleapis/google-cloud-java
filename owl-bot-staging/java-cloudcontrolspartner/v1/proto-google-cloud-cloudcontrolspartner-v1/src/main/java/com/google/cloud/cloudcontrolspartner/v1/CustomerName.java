...
public class CustomerName implements ResourceName {
  private static final PathTemplate ORGANIZATION_LOCATION_CUSTOMER =
  ...
  public static CustomerName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        ORGANIZATION_LOCATION_CUSTOMER.validatedMatch(
            formattedString, "CustomerName.parse: formattedString not in valid format");
    return of(matchMap.get("organization"), matchMap.get("location"), matchMap.get("customer"));
  }
  ...
  public String toString() {
    return ORGANIZATION_LOCATION_CUSTOMER.instantiate(
        "organization", organization, "location", location, "customer", customer);
  }
  ...
  /** Builder for organizations/{organization}/locations/{location}/customers/{customer}. */
