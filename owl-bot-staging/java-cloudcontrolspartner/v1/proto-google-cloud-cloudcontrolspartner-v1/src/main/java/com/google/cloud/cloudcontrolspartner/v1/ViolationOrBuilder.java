...
public interface ViolationOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.cloudcontrolspartner.v1.Violation.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>string non_compliant_org_policy = 8 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.cloudcontrolspartner.v1.Violation.Remediation remediation = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
