...
public interface PartnerOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.cloudcontrolspartner.v1.Sku> 
      getSkusList();
  /**
   * <pre>
   * List of SKUs the partner is offering
   ...
   * <code>repeated .google.cloud.cloudcontrolspartner.v1.Sku skus = 3;</code>
   */
  com.google.cloud.cloudcontrolspartner.v1.SkuOrBuilder getSkusOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.cloudcontrolspartner.v1.EkmMetadata> 
      getEkmSolutionsList();
  /**
   * <pre>
   * List of Google Cloud supported EKM partners supported by the partner
   ...
   * <code>repeated .google.cloud.cloudcontrolspartner.v1.EkmMetadata ekm_solutions = 4;</code>
   */
  com.google.cloud.cloudcontrolspartner.v1.EkmMetadataOrBuilder getEkmSolutionsOrBuilder(
      int index);
