      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            company_ = input.readMessage(com.google.cloud.talent.v4.Company.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeCompany(com.google.cloud.talent.v4.Company value) {
      if (companyBuilder_ == null) {
        if (company_ != null) {
          company_ =
            com.google.cloud.talent.v4.Company.newBuilder(company_).mergeFrom(value).buildPartial();
        } else {
          company_ = value;
        }
        onChanged();
