...
public interface CompensationInfoOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.talent.v4.CompensationInfo.CompensationEntry> 
      getEntriesList();
  /**
   * <pre>
   * Job compensation information.
   ...
   */
  com.google.cloud.talent.v4.CompensationInfo.CompensationRange getAnnualizedBaseCompensationRange();
  /**
   * <pre>
   * Output only. Annualized base compensation range. Computed as base compensation entry's
   * [CompensationEntry.amount][google.cloud.talent.v4.CompensationInfo.CompensationEntry.amount] times
