...
public interface AudioStreamOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.video.livestream.v1.AudioStream.AudioMapping> 
      getMappingList();
  /**
   * <pre>
   * The mapping for the input streams and audio channels.
   ...
   * <code>repeated .google.cloud.video.livestream.v1.AudioStream.AudioMapping mapping = 5;</code>
   */
  com.google.cloud.video.livestream.v1.AudioStream.AudioMappingOrBuilder getMappingOrBuilder(
      int index);
