...
import com.google.cloud.video.livestream.v1.LivestreamServiceGrpc.LivestreamServiceImplBase;
...
public class MockLivestreamServiceImpl extends LivestreamServiceImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockLivestreamServiceImpl() {
  ...
  public void startChannel(
      StartChannelRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method StartChannel, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void createInput(CreateInputRequest request, StreamObserver<Operation> responseObserver) {
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateInput, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void listInputs(
      ListInputsRequest request, StreamObserver<ListInputsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListInputsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListInputsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListInputs, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListInputsResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void getInput(GetInputRequest request, StreamObserver<Input> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Input) {
      requests.add(request);
      responseObserver.onNext(((Input) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetInput, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Input.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void deleteInput(DeleteInputRequest request, StreamObserver<Operation> responseObserver) {
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteInput, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void createEvent(CreateEventRequest request, StreamObserver<Event> responseObserver) {
    ...
    if (response instanceof Event) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateEvent, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Event.class.getName(),
                  Exception.class.getName())));
    }
