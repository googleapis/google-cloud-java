...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.contactcenterinsights.v1.ConversationDataSource result) {
      int from_bitField0_ = bitField0_;
    }

    private void buildPartialOneofs(com.google.cloud.contactcenterinsights.v1.ConversationDataSource result) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getDialogflowSourceFieldBuilder().getBuilder(),
                  extensionRegistry);
              sourceCase_ = 3;
              break;
            } // case 26
