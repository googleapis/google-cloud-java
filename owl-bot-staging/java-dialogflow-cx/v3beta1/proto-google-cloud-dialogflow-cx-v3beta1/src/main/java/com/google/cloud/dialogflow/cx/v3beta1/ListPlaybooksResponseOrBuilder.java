...
public interface ListPlaybooksResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3beta1.ListPlaybooksResponse)
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3beta1.Playbook> 
      getPlaybooksList();
  /**
   * <pre>
   * The list of playbooks. There will be a maximum number of items returned
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3beta1.Playbook playbooks = 1;</code>
   */
  com.google.cloud.dialogflow.cx.v3beta1.PlaybookOrBuilder getPlaybooksOrBuilder(
      int index);
