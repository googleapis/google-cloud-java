        ...
        switch (tag) {
          ...
          case 18: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              flowValidationResults_ = new java.util.ArrayList<com.google.cloud.dialogflow.cx.v3beta1.FlowValidationResult>();
              mutable_bitField0_ |= 0x00000001;
            }
            flowValidationResults_.add(
                input.readMessage(com.google.cloud.dialogflow.cx.v3beta1.FlowValidationResult.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dialogflow.cx.v3beta1.AgentValidationResult) e.getUnfinishedMessage();
