      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            continuousTestResult_ = input.readMessage(com.google.cloud.dialogflow.cx.v3beta1.ContinuousTestResult.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dialogflow.cx.v3beta1.RunContinuousTestResponse) e.getUnfinishedMessage();
