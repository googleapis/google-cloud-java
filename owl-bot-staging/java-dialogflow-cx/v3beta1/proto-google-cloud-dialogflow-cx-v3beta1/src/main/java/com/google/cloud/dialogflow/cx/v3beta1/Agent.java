      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 106: {
            ...
            speechToTextSettings_ = input.readMessage(com.google.cloud.dialogflow.cx.v3beta1.SpeechToTextSettings.parser(), extensionRegistry);
            if (subBuilder != null) {
      ...
      if (speechToTextSettingsBuilder_ == null) {
        if (speechToTextSettings_ != null) {
          speechToTextSettings_ =
            com.google.cloud.dialogflow.cx.v3beta1.SpeechToTextSettings.newBuilder(speechToTextSettings_).mergeFrom(value).buildPartial();
        } else {
          speechToTextSettings_ = value;
        }
        onChanged();
