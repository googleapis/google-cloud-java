...
public interface ListToolsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3beta1.ListToolsResponse)
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3beta1.Tool> 
      getToolsList();
  /**
   * <pre>
   * The list of Tools. There will be a maximum number of items returned
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3beta1.Tool tools = 1;</code>
   */
  com.google.cloud.dialogflow.cx.v3beta1.ToolOrBuilder getToolsOrBuilder(
      int index);
