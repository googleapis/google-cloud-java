...
public interface AnswerFeedbackOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3beta1.AnswerFeedback.Rating rating = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3beta1.AnswerFeedback.RatingReason rating_reason = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * <code>.google.cloud.dialogflow.cx.v3beta1.AnswerFeedback.RatingReason rating_reason = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.dialogflow.cx.v3beta1.AnswerFeedback.RatingReasonOrBuilder getRatingReasonOrBuilder();
