...
public final class FulfillmentProto {
  ...
  static {
    ...
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_descriptor,
        new java.lang.String[] { "Messages", "Webhook", "ReturnPartialResponses", "Tag", "SetParameterActions", "ConditionalCases", "AdvancedSettings", "EnableGenerativeFallback", });
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_SetParameterAction_descriptor =
      internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_SetParameterAction_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_SetParameterAction_descriptor,
        new java.lang.String[] { "Parameter", "Value", });
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_descriptor =
      internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_descriptor.getNestedTypes().get(1);
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_descriptor,
        new java.lang.String[] { "Cases", });
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_descriptor =
      internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_descriptor,
        new java.lang.String[] { "Condition", "CaseContent", });
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_CaseContent_descriptor =
      internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_CaseContent_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_dialogflow_cx_v3_Fulfillment_ConditionalCases_Case_CaseContent_descriptor,
