...
public interface MatchIntentResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3.Match> 
      getMatchesList();
  /**
   * <pre>
   * Match results, if more than one, ordered descendingly by the confidence
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3.Match matches = 4;</code>
   */
  com.google.cloud.dialogflow.cx.v3.MatchOrBuilder getMatchesOrBuilder(
      int index);
  ...
  public com.google.cloud.dialogflow.cx.v3.MatchIntentResponse.QueryCase getQueryCase();
}
