...
public interface GeneratorOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3.Phrase prompt_text = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.dialogflow.cx.v3.Generator.Placeholder placeholders = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3.Generator.Placeholder> 
      getPlaceholdersList();
  /**
   * <pre>
   * Optional. List of custom placeholders in the prompt text.
