...
public interface ValidationMessageOrBuilder extends
   ...
   * @deprecated google.cloud.dialogflow.cx.v3.ValidationMessage.resources is deprecated.
   *     See google/cloud/dialogflow/cx/v3/validation_message.proto;l=93
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3.ResourceName> 
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3.ResourceName resource_names = 6;</code>
   */
  com.google.cloud.dialogflow.cx.v3.ResourceNameOrBuilder getResourceNamesOrBuilder(
      int index);
