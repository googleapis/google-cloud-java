...
public interface QueryResultOrBuilder extends
   ...
   * @deprecated google.cloud.dialogflow.cx.v3.QueryResult.intent is deprecated.
   *     See google/cloud/dialogflow/cx/v3/session.proto;l=956
   ...
   * @deprecated google.cloud.dialogflow.cx.v3.QueryResult.intent_detection_confidence is deprecated.
   *     See google/cloud/dialogflow/cx/v3/session.proto;l=967
