...
public interface ExperimentOrBuilder extends
   ...
   */
  com.google.cloud.dialogflow.cx.v3.RolloutConfig getRolloutConfig();
  /**
   * <pre>
   * The configuration for auto rollout. If set, there should be exactly two
   * variants in the experiment (control variant being the default version of
   ...
   * <code>.google.cloud.dialogflow.cx.v3.RolloutConfig rollout_config = 14;</code>
   */
  com.google.cloud.dialogflow.cx.v3.RolloutConfigOrBuilder getRolloutConfigOrBuilder();
   ...
   */
  com.google.cloud.dialogflow.cx.v3.RolloutState getRolloutState();
  /**
   * <pre>
   * State of the auto rollout process.
   * </pre>
   ...
   * <code>.google.cloud.dialogflow.cx.v3.RolloutState rollout_state = 15;</code>
   */
  com.google.cloud.dialogflow.cx.v3.RolloutStateOrBuilder getRolloutStateOrBuilder();
