        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              deployments_ = new java.util.ArrayList<com.google.cloud.dialogflow.cx.v3.Deployment>();
              mutable_bitField0_ |= 0x00000001;
            }
            deployments_.add(
                input.readMessage(com.google.cloud.dialogflow.cx.v3.Deployment.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.dialogflow.cx.v3.ListDeploymentsResponse) e.getUnfinishedMessage();
