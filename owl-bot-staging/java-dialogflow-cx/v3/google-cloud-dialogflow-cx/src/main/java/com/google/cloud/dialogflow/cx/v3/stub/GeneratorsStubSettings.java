...
/**
 * Settings class to configure an instance of {@link GeneratorsStub}.
 *
...
public class GeneratorsStubSettings extends StubSettings<GeneratorsStubSettings> {
  ...
  private static final PagedListDescriptor<ListGeneratorsRequest, ListGeneratorsResponse, Generator>
      LIST_GENERATORS_PAGE_STR_DESC =
          new PagedListDescriptor<ListGeneratorsRequest, ListGeneratorsResponse, Generator>() {
            @Override
            ...
            public ListGeneratorsRequest injectToken(ListGeneratorsRequest payload, String token) {
              return ListGeneratorsRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListGeneratorsRequest injectPageSize(
                ListGeneratorsRequest payload, int pageSize) {
              return ListGeneratorsRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
            ...
            public Iterable<Generator> extractResources(ListGeneratorsResponse payload) {
              return payload.getGeneratorsList() == null
                  ? ImmutableList.<Generator>of()
                  : payload.getGeneratorsList();
            }
          };
  ...
  private static final PagedListResponseFactory<
          ListGeneratorsRequest, ListGeneratorsResponse, ListGeneratorsPagedResponse>
      LIST_GENERATORS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListGeneratorsRequest, ListGeneratorsResponse, ListGeneratorsPagedResponse>() {
            @Override
            public ApiFuture<ListGeneratorsPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListGeneratorsRequest, ListGeneratorsResponse> callable,
                ListGeneratorsRequest request,
                ApiCallContext context,
                ApiFuture<ListGeneratorsResponse> futureResponse) {
              PageContext<ListGeneratorsRequest, ListGeneratorsResponse, Generator> pageContext =
                  PageContext.create(callable, LIST_GENERATORS_PAGE_STR_DESC, request, context);
              return ListGeneratorsPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<UpdateGeneratorRequest, Generator> updateGeneratorSettings() {
    return updateGeneratorSettings;
  }
  ...
  public UnaryCallSettings<DeleteGeneratorRequest, Empty> deleteGeneratorSettings() {
    return deleteGeneratorSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(GeneratorsStubSettings.class))
        .setTransportToken(
  ...
  protected GeneratorsStubSettings(Builder settingsBuilder) throws IOException {
    ...
    listGeneratorsSettings = settingsBuilder.listGeneratorsSettings().build();
    getGeneratorSettings = settingsBuilder.getGeneratorSettings().build();
    createGeneratorSettings = settingsBuilder.createGeneratorSettings().build();
    updateGeneratorSettings = settingsBuilder.updateGeneratorSettings().build();
    deleteGeneratorSettings = settingsBuilder.deleteGeneratorSettings().build();
    listLocationsSettings = settingsBuilder.listLocationsSettings().build();
    getLocationSettings = settingsBuilder.getLocationSettings().build();
  }

  /** Builder for GeneratorsStubSettings. */
  public static class Builder extends StubSettings.Builder<GeneratorsStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final PagedCallSettings.Builder<
            ListGeneratorsRequest, ListGeneratorsResponse, ListGeneratorsPagedResponse>
        listGeneratorsSettings;
    private final UnaryCallSettings.Builder<GetGeneratorRequest, Generator> getGeneratorSettings;
    private final UnaryCallSettings.Builder<CreateGeneratorRequest, Generator>
        createGeneratorSettings;
    private final UnaryCallSettings.Builder<UpdateGeneratorRequest, Generator>
    ...
    protected Builder(ClientContext clientContext) {
      ...
      listGeneratorsSettings = PagedCallSettings.newBuilder(LIST_GENERATORS_PAGE_STR_FACT);
      getGeneratorSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      createGeneratorSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      updateGeneratorSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      deleteGeneratorSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(GeneratorsStubSettings settings) {
      ...
      listGeneratorsSettings = settings.listGeneratorsSettings.toBuilder();
      getGeneratorSettings = settings.getGeneratorSettings.toBuilder();
      createGeneratorSettings = settings.createGeneratorSettings.toBuilder();
      updateGeneratorSettings = settings.updateGeneratorSettings.toBuilder();
      deleteGeneratorSettings = settings.deleteGeneratorSettings.toBuilder();
