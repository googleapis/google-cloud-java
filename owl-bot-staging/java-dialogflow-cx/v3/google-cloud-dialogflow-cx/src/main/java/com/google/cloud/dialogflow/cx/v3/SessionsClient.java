 ...
 *    <tr>
 *      <td>DetectIntent</td>
 *      <td><p>Processes a natural language query and returns structured, actionable data
 ...
 *  See [Versions and
 *  environments](https://cloud.google.com/dialogflow/cx/docs/concept/version).</p></td>
 *      <td>
 ...
 *      <td><p>Processes a natural language query in audio format in a streaming fashion
 ...
 *    <tr>
 *      <td>MatchIntent</td>
 *      <td><p>Returns preliminary intent match results, doesn't change the session
 *  status.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>FulfillIntent</td>
 *      <td><p>Fulfills a matched intent returned by
 ...
 *  Otherwise, the behavior is undefined.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Updates the feedback received from the user for a single turn of the bot
 *  response.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
