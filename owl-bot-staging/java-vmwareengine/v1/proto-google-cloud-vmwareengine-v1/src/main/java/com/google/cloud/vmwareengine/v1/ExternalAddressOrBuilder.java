...
public interface ExternalAddressOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmwareengine.v1.ExternalAddress)
   ...
   * </pre>
   *
   * <code>.google.cloud.vmwareengine.v1.ExternalAddress.State state = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
