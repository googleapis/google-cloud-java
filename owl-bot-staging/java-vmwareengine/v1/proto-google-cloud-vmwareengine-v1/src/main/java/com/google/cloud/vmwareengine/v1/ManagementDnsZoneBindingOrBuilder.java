...
public interface ManagementDnsZoneBindingOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding.State state = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
