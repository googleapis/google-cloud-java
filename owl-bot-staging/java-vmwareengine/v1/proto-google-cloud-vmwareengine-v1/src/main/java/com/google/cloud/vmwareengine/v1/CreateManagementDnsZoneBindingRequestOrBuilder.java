...
public interface CreateManagementDnsZoneBindingRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmwareengine.v1.CreateManagementDnsZoneBindingRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding management_dns_zone_binding = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.vmwareengine.v1.ManagementDnsZoneBinding management_dns_zone_binding = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.vmwareengine.v1.ManagementDnsZoneBindingOrBuilder getManagementDnsZoneBindingOrBuilder();
   ...
   * </pre>
   *
   * <code>string management_dns_zone_binding_id = 3 [(.google.api.field_behavior) = REQUIRED];</code>
