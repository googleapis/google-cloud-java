...
public interface NetworkConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>string vmware_engine_network = 5 [(.google.api.field_behavior) = OPTIONAL, (.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>string vmware_engine_network_canonical = 6 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>int32 management_ip_address_layout_version = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
