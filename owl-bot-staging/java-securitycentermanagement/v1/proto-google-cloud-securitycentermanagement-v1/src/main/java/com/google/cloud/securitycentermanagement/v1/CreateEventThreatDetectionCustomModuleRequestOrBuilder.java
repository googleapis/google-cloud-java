...
public interface CreateEventThreatDetectionCustomModuleRequestOrBuilder extends
   ...
   */
  com.google.cloud.securitycentermanagement.v1.EventThreatDetectionCustomModule getEventThreatDetectionCustomModule();
  /**
   * <pre>
   * Required. The module to create. The
   * event_threat_detection_custom_module.name will be ignored and server
   ...
   * <code>.google.cloud.securitycentermanagement.v1.EventThreatDetectionCustomModule event_threat_detection_custom_module = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.securitycentermanagement.v1.EventThreatDetectionCustomModuleOrBuilder getEventThreatDetectionCustomModuleOrBuilder();
