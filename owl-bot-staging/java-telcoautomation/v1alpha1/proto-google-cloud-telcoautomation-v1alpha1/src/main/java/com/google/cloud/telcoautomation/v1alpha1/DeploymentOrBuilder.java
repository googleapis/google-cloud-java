...
public interface DeploymentOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1alpha1.Deployment)
   ...
   * </pre>
   *
   * <code>string source_blueprint_revision = 3 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.telcoautomation.v1alpha1.Deployment.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The state.
   */
  com.google.cloud.telcoautomation.v1alpha1.Deployment.State getState();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.telcoautomation.v1alpha1.File files = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
