...
public interface MasterAuthorizedNetworksConfigOrBuilder extends
   ...
   * <code>repeated .google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig.CidrBlock cidr_blocks = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig.CidrBlock getCidrBlocks(int index);
  /**
   * <pre>
   * Optional. cidr_blocks define up to 50 external networks that could access
   * Kubernetes master through HTTPS.
   ...
   * <code>repeated .google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig.CidrBlock cidr_blocks = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig.CidrBlockOrBuilder> 
