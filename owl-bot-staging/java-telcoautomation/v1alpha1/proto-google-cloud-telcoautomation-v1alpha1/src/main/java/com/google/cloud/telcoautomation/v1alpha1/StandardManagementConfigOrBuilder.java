...
public interface StandardManagementConfigOrBuilder extends
   ...
   */
  com.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig getMasterAuthorizedNetworksConfig();
  /**
   * <pre>
   * Optional. Master Authorized Network that supports multiple CIDR blocks.
   * Allows access to the k8s master from multiple blocks. It cannot be set at
   ...
   * <code>.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfig master_authorized_networks_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.telcoautomation.v1alpha1.MasterAuthorizedNetworksConfigOrBuilder getMasterAuthorizedNetworksConfigOrBuilder();
}
