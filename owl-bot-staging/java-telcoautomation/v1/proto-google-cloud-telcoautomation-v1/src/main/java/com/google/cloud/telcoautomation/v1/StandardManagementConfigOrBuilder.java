...
public interface StandardManagementConfigOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1.StandardManagementConfig)
   ...
   * </pre>
   *
   * <code>.google.cloud.telcoautomation.v1.MasterAuthorizedNetworksConfig master_authorized_networks_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.cloud.telcoautomation.v1.MasterAuthorizedNetworksConfig getMasterAuthorizedNetworksConfig();
  /**
   * <pre>
   * Optional. Master Authorized Network that supports multiple CIDR blocks.
   * Allows access to the k8s master from multiple blocks. It cannot be set at
   ...
   * <code>.google.cloud.telcoautomation.v1.MasterAuthorizedNetworksConfig master_authorized_networks_config = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.telcoautomation.v1.MasterAuthorizedNetworksConfigOrBuilder getMasterAuthorizedNetworksConfigOrBuilder();
}
