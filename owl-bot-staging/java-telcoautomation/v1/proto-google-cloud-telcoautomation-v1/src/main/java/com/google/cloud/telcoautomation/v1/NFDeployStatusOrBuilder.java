...
public interface NFDeployStatusOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.telcoautomation.v1.NFDeploySiteStatus sites = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.telcoautomation.v1.NFDeploySiteStatus> 
      getSitesList();
  /**
   * <pre>
   * Output only. Per-Site Status.
   ...
   * <code>repeated .google.cloud.telcoautomation.v1.NFDeploySiteStatus sites = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.telcoautomation.v1.NFDeploySiteStatusOrBuilder getSitesOrBuilder(
      int index);
}
