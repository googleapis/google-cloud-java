...
public interface ListEdgeSlmsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1.ListEdgeSlmsResponse)
   ...
   */
  java.util.List<com.google.cloud.telcoautomation.v1.EdgeSlm> 
      getEdgeSlmsList();
  /**
   * <pre>
   * The list of EdgeSlm
   ...
   * <code>repeated .google.cloud.telcoautomation.v1.EdgeSlm edge_slms = 1;</code>
   */
  com.google.cloud.telcoautomation.v1.EdgeSlmOrBuilder getEdgeSlmsOrBuilder(
      int index);
