...
public interface BlueprintOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1.Blueprint)
   ...
   * </pre>
   *
   * <code>.google.cloud.telcoautomation.v1.Blueprint.ApprovalState approval_state = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.telcoautomation.v1.Blueprint.ApprovalState getApprovalState();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.telcoautomation.v1.File files = 9 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
