...
public class OrchestrationClusterName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_ORCHESTRATION_CLUSTER =
  ...
  public static OrchestrationClusterName of(
      String project, String location, String orchestrationCluster) {
    return newBuilder()
        .setProject(project)
  ...
  public static OrchestrationClusterName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_ORCHESTRATION_CLUSTER.validatedMatch(
            formattedString, "OrchestrationClusterName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("orchestration_cluster"));
  }

  public static List<OrchestrationClusterName> parseList(List<String> formattedStrings) {
    List<OrchestrationClusterName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return PROJECT_LOCATION_ORCHESTRATION_CLUSTER.instantiate(
        "project", project, "location", location, "orchestration_cluster", orchestrationCluster);
  }
