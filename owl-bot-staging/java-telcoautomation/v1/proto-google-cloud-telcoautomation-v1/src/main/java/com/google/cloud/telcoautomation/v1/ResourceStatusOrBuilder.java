...
public interface ResourceStatusOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1.ResourceStatus)
   ...
   * </pre>
   *
   * <code>.google.cloud.telcoautomation.v1.ResourceType resource_type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.telcoautomation.v1.ResourceType getResourceType();
   ...
   * </pre>
   *
   * <code>.google.cloud.telcoautomation.v1.Status status = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The status.
   */
  com.google.cloud.telcoautomation.v1.Status getStatus();
   ...
   * </pre>
   *
   * <code>.google.cloud.telcoautomation.v1.NFDeployStatus nf_deploy_status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
