...
public interface AutomationOrBuilder extends
...
java.lang.String defaultValue);
   ...
   */
  java.util.List<com.google.cloud.deploy.v1.AutomationRule> 
      getRulesList();
  /**
   * <pre>
   * Required. List of Automation rules associated with the Automation resource.
   ...
   * <code>repeated .google.cloud.deploy.v1.AutomationRule rules = 14 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.deploy.v1.AutomationRuleOrBuilder getRulesOrBuilder(
      int index);
}
