...
public interface RepairRolloutRuleOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.deploy.v1.RepairMode> 
      getRepairModesList();
  /**
   * <pre>
   * Required. Defines the types of automatic repair actions for failed jobs.
   ...
   * <code>repeated .google.cloud.deploy.v1.RepairMode repair_modes = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.deploy.v1.RepairModeOrBuilder getRepairModesOrBuilder(
      int index);
