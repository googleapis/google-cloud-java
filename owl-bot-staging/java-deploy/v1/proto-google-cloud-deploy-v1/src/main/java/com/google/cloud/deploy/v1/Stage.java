...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < deployParameters_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(6, deployParameters_.get(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getDeployParametersList()
        .equals(other.getDeployParametersList())) return false;
  ...
  public static final class Builder extends
          ...
          if (deployParametersBuilder_.isEmpty()) {
            ...
            deployParametersBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getDeployParametersFieldBuilder() : null;
          } else {
          ...
          switch (tag) {
            ...
            case 50: {
              com.google.cloud.deploy.v1.DeployParameters m =
                  input.readMessage(
                      com.google.cloud.deploy.v1.DeployParameters.parser(),
                      extensionRegistry);
              if (deployParametersBuilder_ == null) {
                ensureDeployParametersIsMutable();
    ...
    private void ensureDeployParametersIsMutable() {
      if (!((bitField0_ & 0x00000008) != 0)) {
        deployParameters_ = new java.util.ArrayList<com.google.cloud.deploy.v1.DeployParameters>(deployParameters_);
        bitField0_ |= 0x00000008;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.deploy.v1.DeployParameters, com.google.cloud.deploy.v1.DeployParameters.Builder, com.google.cloud.deploy.v1.DeployParametersOrBuilder> deployParametersBuilder_;
    ...
    public com.google.cloud.deploy.v1.DeployParametersOrBuilder getDeployParametersOrBuilder(
        int index) {
      if (deployParametersBuilder_ == null) {
        return deployParameters_.get(index);  } else {
    ...
    public com.google.cloud.deploy.v1.DeployParameters.Builder addDeployParametersBuilder() {
      return getDeployParametersFieldBuilder().addBuilder(
          com.google.cloud.deploy.v1.DeployParameters.getDefaultInstance());
    }
    /**
     * <pre>
     * Optional. The deploy parameters to use for the target in this stage.
    ...
    public com.google.cloud.deploy.v1.DeployParameters.Builder addDeployParametersBuilder(
        int index) {
      return getDeployParametersFieldBuilder().addBuilder(
          index, com.google.cloud.deploy.v1.DeployParameters.getDefaultInstance());
    }
    /**
     * <pre>
     * Optional. The deploy parameters to use for the target in this stage.
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.deploy.v1.DeployParameters, com.google.cloud.deploy.v1.DeployParameters.Builder, com.google.cloud.deploy.v1.DeployParametersOrBuilder> 
        getDeployParametersFieldBuilder() {
      if (deployParametersBuilder_ == null) {
        deployParametersBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.google.cloud.deploy.v1.DeployParameters, com.google.cloud.deploy.v1.DeployParameters.Builder, com.google.cloud.deploy.v1.DeployParametersOrBuilder>(
                deployParameters_,
