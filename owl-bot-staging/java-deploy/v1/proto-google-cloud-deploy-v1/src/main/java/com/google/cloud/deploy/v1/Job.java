...
private static final long serialVersionUID = 0L;
  ...
  public enum JobTypeCase
    ...
    public static JobTypeCase forNumber(int value) {
      switch (value) {
        ...
        case 9: return PREDEPLOY_JOB;
        case 10: return POSTDEPLOY_JOB;
        case 6: return CREATE_CHILD_ROLLOUT_JOB;
        case 7: return ADVANCE_CHILD_ROLLOUT_JOB;
  ...
  @java.lang.Override public com.google.cloud.deploy.v1.Job.State getState() {
    com.google.cloud.deploy.v1.Job.State result = com.google.cloud.deploy.v1.Job.State.forNumber(state_);
   ...
   */
  @java.lang.Override
  public com.google.cloud.deploy.v1.CreateChildRolloutJobOrBuilder getCreateChildRolloutJobOrBuilder() {
    if (jobTypeCase_ == 6) {
       return (com.google.cloud.deploy.v1.CreateChildRolloutJob) jobType_;
    }
    return com.google.cloud.deploy.v1.CreateChildRolloutJob.getDefaultInstance();
  ...
  public int getSerializedSize() {
    ...
    if (jobTypeCase_ == 6) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(6, (com.google.cloud.deploy.v1.CreateChildRolloutJob) jobType_);
    }
    if (jobTypeCase_ == 7) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(7, (com.google.cloud.deploy.v1.AdvanceChildRolloutJob) jobType_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(skipMessage_)) {
    ...
    if (jobTypeCase_ == 9) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(9, (com.google.cloud.deploy.v1.PredeployJob) jobType_);
    }
    if (jobTypeCase_ == 10) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(10, (com.google.cloud.deploy.v1.PostdeployJob) jobType_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (jobTypeCase_) {
      ...
      case 10:
        ...
        break;
      case 6:
        if (!getCreateChildRolloutJob()
            .equals(other.getCreateChildRolloutJob())) return false;
        break;
      case 7:
        if (!getAdvanceChildRolloutJob()
            .equals(other.getAdvanceChildRolloutJob())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.cloud.deploy.v1.Job result) {
      ...
      if (jobTypeCase_ == 6 &&
          createChildRolloutJobBuilder_ != null) {
        result.jobType_ = createChildRolloutJobBuilder_.build();
      }
      if (jobTypeCase_ == 7 &&
          advanceChildRolloutJobBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50: {
              input.readMessage(
                  getCreateChildRolloutJobFieldBuilder().getBuilder(),
                  extensionRegistry);
              jobTypeCase_ = 6;
              break;
            } // case 50
            case 58: {
              input.readMessage(
                  getAdvanceChildRolloutJobFieldBuilder().getBuilder(),
                  extensionRegistry);
              jobTypeCase_ = 7;
              break;
            } // case 58
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.PredeployJob, com.google.cloud.deploy.v1.PredeployJob.Builder, com.google.cloud.deploy.v1.PredeployJobOrBuilder> predeployJobBuilder_;
    /**
     * <pre>
     * Output only. A predeploy Job.
     * </pre>
    ...
    public Builder mergePredeployJob(com.google.cloud.deploy.v1.PredeployJob value) {
      if (predeployJobBuilder_ == null) {
        if (jobTypeCase_ == 9 &&
          ...
          jobType_ = com.google.cloud.deploy.v1.PredeployJob.newBuilder((com.google.cloud.deploy.v1.PredeployJob) jobType_)
              .mergeFrom(value).buildPartial();
        } else {
          jobType_ = value;
        }
    ...
    public Builder mergePostdeployJob(com.google.cloud.deploy.v1.PostdeployJob value) {
      if (postdeployJobBuilder_ == null) {
        if (jobTypeCase_ == 10 &&
          ...
          jobType_ = com.google.cloud.deploy.v1.PostdeployJob.newBuilder((com.google.cloud.deploy.v1.PostdeployJob) jobType_)
              .mergeFrom(value).buildPartial();
        } else {
          jobType_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.PostdeployJob, com.google.cloud.deploy.v1.PostdeployJob.Builder, com.google.cloud.deploy.v1.PostdeployJobOrBuilder> 
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.CreateChildRolloutJob, com.google.cloud.deploy.v1.CreateChildRolloutJob.Builder, com.google.cloud.deploy.v1.CreateChildRolloutJobOrBuilder> createChildRolloutJobBuilder_;
    /**
     * <pre>
     * Output only. A createChildRollout Job.
     * </pre>
    ...
    public Builder mergeCreateChildRolloutJob(com.google.cloud.deploy.v1.CreateChildRolloutJob value) {
      if (createChildRolloutJobBuilder_ == null) {
        if (jobTypeCase_ == 6 &&
          ...
          jobType_ = com.google.cloud.deploy.v1.CreateChildRolloutJob.newBuilder((com.google.cloud.deploy.v1.CreateChildRolloutJob) jobType_)
              .mergeFrom(value).buildPartial();
        } else {
          jobType_ = value;
        }
     ...
     * <code>.google.cloud.deploy.v1.CreateChildRolloutJob create_child_rollout_job = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public com.google.cloud.deploy.v1.CreateChildRolloutJob.Builder getCreateChildRolloutJobBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.CreateChildRolloutJob, com.google.cloud.deploy.v1.CreateChildRolloutJob.Builder, com.google.cloud.deploy.v1.CreateChildRolloutJobOrBuilder> 
        getCreateChildRolloutJobFieldBuilder() {
      if (createChildRolloutJobBuilder_ == null) {
        if (!(jobTypeCase_ == 6)) {
          jobType_ = com.google.cloud.deploy.v1.CreateChildRolloutJob.getDefaultInstance();
        }
        createChildRolloutJobBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.CreateChildRolloutJob, com.google.cloud.deploy.v1.CreateChildRolloutJob.Builder, com.google.cloud.deploy.v1.CreateChildRolloutJobOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.AdvanceChildRolloutJob, com.google.cloud.deploy.v1.AdvanceChildRolloutJob.Builder, com.google.cloud.deploy.v1.AdvanceChildRolloutJobOrBuilder> advanceChildRolloutJobBuilder_;
    /**
     * <pre>
     * Output only. An advanceChildRollout Job.
     * </pre>
     ...
     * <code>.google.cloud.deploy.v1.AdvanceChildRolloutJob advance_child_rollout_job = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public Builder setAdvanceChildRolloutJob(com.google.cloud.deploy.v1.AdvanceChildRolloutJob value) {
      if (advanceChildRolloutJobBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.cloud.deploy.v1.AdvanceChildRolloutJob advance_child_rollout_job = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public Builder mergeAdvanceChildRolloutJob(com.google.cloud.deploy.v1.AdvanceChildRolloutJob value) {
      if (advanceChildRolloutJobBuilder_ == null) {
        if (jobTypeCase_ == 7 &&
            jobType_ != com.google.cloud.deploy.v1.AdvanceChildRolloutJob.getDefaultInstance()) {
          jobType_ = com.google.cloud.deploy.v1.AdvanceChildRolloutJob.newBuilder((com.google.cloud.deploy.v1.AdvanceChildRolloutJob) jobType_)
              .mergeFrom(value).buildPartial();
        } else {
          jobType_ = value;
        }
     ...
     * <code>.google.cloud.deploy.v1.AdvanceChildRolloutJob advance_child_rollout_job = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public com.google.cloud.deploy.v1.AdvanceChildRolloutJob.Builder getAdvanceChildRolloutJobBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.AdvanceChildRolloutJob, com.google.cloud.deploy.v1.AdvanceChildRolloutJob.Builder, com.google.cloud.deploy.v1.AdvanceChildRolloutJobOrBuilder> 
        getAdvanceChildRolloutJobFieldBuilder() {
      if (advanceChildRolloutJobBuilder_ == null) {
        if (!(jobTypeCase_ == 7)) {
          jobType_ = com.google.cloud.deploy.v1.AdvanceChildRolloutJob.getDefaultInstance();
        }
        advanceChildRolloutJobBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.AdvanceChildRolloutJob, com.google.cloud.deploy.v1.AdvanceChildRolloutJob.Builder, com.google.cloud.deploy.v1.AdvanceChildRolloutJobOrBuilder>(
