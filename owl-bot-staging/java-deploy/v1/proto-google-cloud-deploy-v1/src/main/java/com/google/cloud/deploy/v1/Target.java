...
java.lang.String defaultValue) {
  ...
  public int getSerializedSize() {
    ...
    if (deploymentTargetCase_ == 18) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(18, (com.google.cloud.deploy.v1.CloudRunLocation) deploymentTarget_);
    }
    if (deploymentTargetCase_ == 19) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(19, (com.google.cloud.deploy.v1.MultiTarget) deploymentTarget_);
    }
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      deployParameters__ = DeployParametersDefaultEntryHolder.defaultEntry.newBuilderForType()
          ...
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(20, deployParameters__);
    }
    if (deploymentTargetCase_ == 21) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(21, (com.google.cloud.deploy.v1.CustomTarget) deploymentTarget_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    switch (deploymentTargetCase_) {
      ...
      case 21:
        if (!getCustomTarget()
            .equals(other.getCustomTarget())) return false;
        break;
      case 0:
      default:
    }
...
java.lang.String defaultValue) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.CloudRunLocation, com.google.cloud.deploy.v1.CloudRunLocation.Builder, com.google.cloud.deploy.v1.CloudRunLocationOrBuilder> runBuilder_;
    /**
     * <pre>
     * Optional. Information specifying a Cloud Run deployment target.
     * </pre>
    ...
    public Builder setRun(
        com.google.cloud.deploy.v1.CloudRunLocation.Builder builderForValue) {
      if (runBuilder_ == null) {
        deploymentTarget_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeRun(com.google.cloud.deploy.v1.CloudRunLocation value) {
      if (runBuilder_ == null) {
        if (deploymentTargetCase_ == 18 &&
          ...
          deploymentTarget_ = com.google.cloud.deploy.v1.CloudRunLocation.newBuilder((com.google.cloud.deploy.v1.CloudRunLocation) deploymentTarget_)
              .mergeFrom(value).buildPartial();
        } else {
          deploymentTarget_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.CloudRunLocation, com.google.cloud.deploy.v1.CloudRunLocation.Builder, com.google.cloud.deploy.v1.CloudRunLocationOrBuilder> 
        getRunFieldBuilder() {
      if (runBuilder_ == null) {
        if (!(deploymentTargetCase_ == 18)) {
          deploymentTarget_ = com.google.cloud.deploy.v1.CloudRunLocation.getDefaultInstance();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.MultiTarget, com.google.cloud.deploy.v1.MultiTarget.Builder, com.google.cloud.deploy.v1.MultiTargetOrBuilder> multiTargetBuilder_;
    /**
     * <pre>
     * Optional. Information specifying a multiTarget.
     * </pre>
    ...
    public Builder setMultiTarget(
        com.google.cloud.deploy.v1.MultiTarget.Builder builderForValue) {
      if (multiTargetBuilder_ == null) {
        deploymentTarget_ = builderForValue.build();
        onChanged();
      } else {
    ...
    public Builder mergeMultiTarget(com.google.cloud.deploy.v1.MultiTarget value) {
      if (multiTargetBuilder_ == null) {
        if (deploymentTargetCase_ == 19 &&
          ...
          deploymentTarget_ = com.google.cloud.deploy.v1.MultiTarget.newBuilder((com.google.cloud.deploy.v1.MultiTarget) deploymentTarget_)
              .mergeFrom(value).buildPartial();
        } else {
          deploymentTarget_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.MultiTarget, com.google.cloud.deploy.v1.MultiTarget.Builder, com.google.cloud.deploy.v1.MultiTargetOrBuilder> 
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.CustomTarget, com.google.cloud.deploy.v1.CustomTarget.Builder, com.google.cloud.deploy.v1.CustomTargetOrBuilder> customTargetBuilder_;
    /**
     * <pre>
     * Optional. Information specifying a Custom Target.
     * </pre>
    ...
    public Builder mergeCustomTarget(com.google.cloud.deploy.v1.CustomTarget value) {
      if (customTargetBuilder_ == null) {
        if (deploymentTargetCase_ == 21 &&
          ...
          deploymentTarget_ = com.google.cloud.deploy.v1.CustomTarget.newBuilder((com.google.cloud.deploy.v1.CustomTarget) deploymentTarget_)
              .mergeFrom(value).buildPartial();
        } else {
          deploymentTarget_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.CustomTarget, com.google.cloud.deploy.v1.CustomTarget.Builder, com.google.cloud.deploy.v1.CustomTargetOrBuilder> 
        getCustomTargetFieldBuilder() {
      if (customTargetBuilder_ == null) {
        if (!(deploymentTargetCase_ == 21)) {
          deploymentTarget_ = com.google.cloud.deploy.v1.CustomTarget.getDefaultInstance();
        }
        customTargetBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.CustomTarget, com.google.cloud.deploy.v1.CustomTarget.Builder, com.google.cloud.deploy.v1.CustomTargetOrBuilder>(
