...
private static final long serialVersionUID = 0L;
  ...
  public com.google.cloud.deploy.v1.Job getPredeployJob() {
    return predeployJob_ == null ? com.google.cloud.deploy.v1.Job.getDefaultInstance() : predeployJob_;
  }
  /**
   * <pre>
   * Output only. The predeploy Job, which is the first job on the phase.
  ...
  public com.google.cloud.deploy.v1.Job getPostdeployJob() {
    return postdeployJob_ == null ? com.google.cloud.deploy.v1.Job.getDefaultInstance() : postdeployJob_;
  }
  /**
   * <pre>
   * Output only. The postdeploy Job, which is the last job on the phase.
  ...
  public int getSerializedSize() {
    ...
    if (predeployJob_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, getPredeployJob());
    }
    if (postdeployJob_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(4, getPostdeployJob());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasPredeployJob()) {
      if (!getPredeployJob()
          .equals(other.getPredeployJob())) return false;
    }
    if (hasPostdeployJob() != other.hasPostdeployJob()) return false;
    if (hasPostdeployJob()) {
      if (!getPostdeployJob()
          .equals(other.getPostdeployJob())) return false;
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.deploy.v1.DeploymentJobs result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.deployJob_ = deployJobBuilder_ == null
            ? deployJob_
            : deployJobBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.verifyJob_ = verifyJobBuilder_ == null
            ? verifyJob_
            : verifyJobBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.predeployJob_ = predeployJobBuilder_ == null
            ? predeployJob_
            : predeployJobBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.postdeployJob_ = postdeployJobBuilder_ == null
            ? postdeployJob_
            : postdeployJobBuilder_.build();
      }
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getPredeployJobFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 34: {
              input.readMessage(
                  getPostdeployJobFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    private com.google.cloud.deploy.v1.Job predeployJob_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.Job, com.google.cloud.deploy.v1.Job.Builder, com.google.cloud.deploy.v1.JobOrBuilder> predeployJobBuilder_;
    /**
     * <pre>
     * Output only. The predeploy Job, which is the first job on the phase.
     * </pre>
    ...
    public com.google.cloud.deploy.v1.JobOrBuilder getPredeployJobOrBuilder() {
      if (predeployJobBuilder_ != null) {
        ...
        return predeployJob_ == null ?
            com.google.cloud.deploy.v1.Job.getDefaultInstance() : predeployJob_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (predeployJobBuilder_ == null) {
        predeployJobBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.Job, com.google.cloud.deploy.v1.Job.Builder, com.google.cloud.deploy.v1.JobOrBuilder>(
                getPredeployJob(),
                getParentForChildren(),
                isClean());
    ...
    public com.google.cloud.deploy.v1.JobOrBuilder getPostdeployJobOrBuilder() {
      if (postdeployJobBuilder_ != null) {
        ...
        return postdeployJob_ == null ?
            com.google.cloud.deploy.v1.Job.getDefaultInstance() : postdeployJob_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (postdeployJobBuilder_ == null) {
        postdeployJobBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.Job, com.google.cloud.deploy.v1.Job.Builder, com.google.cloud.deploy.v1.JobOrBuilder>(
                getPostdeployJob(),
                getParentForChildren(),
                isClean());
