...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>repeated string advance_automation_runs = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>repeated string repair_automation_runs = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < advanceAutomationRuns_.size(); i++) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 2, advanceAutomationRuns_.getRaw(i));
    }
    for (int i = 0; i < repairAutomationRuns_.size(); i++) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 3, repairAutomationRuns_.getRaw(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.deploy.v1.AutomationRolloutMetadata other = (com.google.cloud.deploy.v1.AutomationRolloutMetadata) obj;

    if (!getPromoteAutomationRun()
        .equals(other.getPromoteAutomationRun())) return false;
    if (!getAdvanceAutomationRunsList()
        .equals(other.getAdvanceAutomationRunsList())) return false;
    if (!getRepairAutomationRunsList()
        .equals(other.getRepairAutomationRunsList())) return false;
  ...
  public static com.google.cloud.deploy.v1.AutomationRolloutMetadata parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.deploy.v1.AutomationRolloutMetadata parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
     ...
     */
    public Builder setPromoteAutomationRun(
     ...
     * @return This builder for chaining.
     */
    public Builder setPromoteAutomationRunBytes(
    ...
    private void ensureAdvanceAutomationRunsIsMutable() {
      if (!advanceAutomationRuns_.isModifiable()) {
        advanceAutomationRuns_ = new com.google.protobuf.LazyStringArrayList(advanceAutomationRuns_);
      }
      bitField0_ |= 0x00000002;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setAdvanceAutomationRuns(
     ...
     * @return This builder for chaining.
     */
    public Builder addAdvanceAutomationRuns(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureAdvanceAutomationRunsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllAdvanceAutomationRuns(
        java.lang.Iterable<java.lang.String> values) {
      ensureAdvanceAutomationRunsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, advanceAutomationRuns_);
      bitField0_ |= 0x00000002;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addAdvanceAutomationRunsBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureAdvanceAutomationRunsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder setRepairAutomationRuns(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureRepairAutomationRunsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addRepairAutomationRuns(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureRepairAutomationRunsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllRepairAutomationRuns(
        java.lang.Iterable<java.lang.String> values) {
      ensureRepairAutomationRunsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, repairAutomationRuns_);
      bitField0_ |= 0x00000004;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addRepairAutomationRunsBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureRepairAutomationRunsIsMutable();
  ...
  private static final com.google.protobuf.Parser<AutomationRolloutMetadata>
      PARSER = new com.google.protobuf.AbstractParser<AutomationRolloutMetadata>() {
    @java.lang.Override
