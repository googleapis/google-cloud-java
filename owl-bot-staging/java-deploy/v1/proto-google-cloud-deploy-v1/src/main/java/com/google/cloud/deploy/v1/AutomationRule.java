 ...
 */
public final class AutomationRule extends
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.deploy.v1.CloudDeployProto.internal_static_google_cloud_deploy_v1_AutomationRule_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.deploy.v1.CloudDeployProto.internal_static_google_cloud_deploy_v1_AutomationRule_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.deploy.v1.AutomationRule.class, com.google.cloud.deploy.v1.AutomationRule.Builder.class);
  }
  ...
  public enum RuleCase
    ...
    public static RuleCase forNumber(int value) {
      switch (value) {
        case 1: return PROMOTE_RELEASE_RULE;
        case 2: return ADVANCE_ROLLOUT_RULE;
        case 3: return REPAIR_ROLLOUT_RULE;
  ...
  public int getSerializedSize() {
    ...
    if (ruleCase_ == 1) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, (com.google.cloud.deploy.v1.PromoteReleaseRule) rule_);
    }
    if (ruleCase_ == 2) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, (com.google.cloud.deploy.v1.AdvanceRolloutRule) rule_);
    }
    if (ruleCase_ == 3) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(3, (com.google.cloud.deploy.v1.RepairRolloutRule) rule_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.deploy.v1.AutomationRule other = (com.google.cloud.deploy.v1.AutomationRule) obj;

    if (!getRuleCase().equals(other.getRuleCase())) return false;
    switch (ruleCase_) {
      case 1:
        if (!getPromoteReleaseRule()
            .equals(other.getPromoteReleaseRule())) return false;
        break;
      case 2:
        if (!getAdvanceRolloutRule()
            .equals(other.getAdvanceRolloutRule())) return false;
        break;
      case 3:
        if (!getRepairRolloutRule()
            .equals(other.getRepairRolloutRule())) return false;
        break;
      case 0:
      default:
    }
  ...
  public static com.google.cloud.deploy.v1.AutomationRule parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.deploy.v1.AutomationRule buildPartial() {
      com.google.cloud.deploy.v1.AutomationRule result = new com.google.cloud.deploy.v1.AutomationRule(this);
    ...
    private void buildPartialOneofs(com.google.cloud.deploy.v1.AutomationRule result) {
      ...
      if (ruleCase_ == 1 &&
          promoteReleaseRuleBuilder_ != null) {
        result.rule_ = promoteReleaseRuleBuilder_.build();
      }
      if (ruleCase_ == 2 &&
          advanceRolloutRuleBuilder_ != null) {
        result.rule_ = advanceRolloutRuleBuilder_.build();
      }
      if (ruleCase_ == 3 &&
          repairRolloutRuleBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getPromoteReleaseRuleFieldBuilder().getBuilder(),
                  extensionRegistry);
              ruleCase_ = 1;
              break;
            } // case 10
            case 18: {
              input.readMessage(
                  getAdvanceRolloutRuleFieldBuilder().getBuilder(),
                  extensionRegistry);
              ruleCase_ = 2;
              break;
            } // case 18
            case 26: {
              input.readMessage(
                  getRepairRolloutRuleFieldBuilder().getBuilder(),
                  extensionRegistry);
              ruleCase_ = 3;
              break;
            } // case 26
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.PromoteReleaseRule, com.google.cloud.deploy.v1.PromoteReleaseRule.Builder, com.google.cloud.deploy.v1.PromoteReleaseRuleOrBuilder> promoteReleaseRuleBuilder_;
    /**
     * <pre>
     * Optional. `PromoteReleaseRule` will automatically promote a release from
     * the current target to a specified target.
    ...
    public Builder mergePromoteReleaseRule(com.google.cloud.deploy.v1.PromoteReleaseRule value) {
      if (promoteReleaseRuleBuilder_ == null) {
        if (ruleCase_ == 1 &&
          ...
          rule_ = com.google.cloud.deploy.v1.PromoteReleaseRule.newBuilder((com.google.cloud.deploy.v1.PromoteReleaseRule) rule_)
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.PromoteReleaseRule, com.google.cloud.deploy.v1.PromoteReleaseRule.Builder, com.google.cloud.deploy.v1.PromoteReleaseRuleOrBuilder> 
        getPromoteReleaseRuleFieldBuilder() {
      if (promoteReleaseRuleBuilder_ == null) {
        if (!(ruleCase_ == 1)) {
          rule_ = com.google.cloud.deploy.v1.PromoteReleaseRule.getDefaultInstance();
        }
        promoteReleaseRuleBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.PromoteReleaseRule, com.google.cloud.deploy.v1.PromoteReleaseRule.Builder, com.google.cloud.deploy.v1.PromoteReleaseRuleOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.AdvanceRolloutRule, com.google.cloud.deploy.v1.AdvanceRolloutRule.Builder, com.google.cloud.deploy.v1.AdvanceRolloutRuleOrBuilder> advanceRolloutRuleBuilder_;
    /**
     * <pre>
     * Optional. The `AdvanceRolloutRule` will automatically advance a
     * successful Rollout.
    ...
    public Builder mergeAdvanceRolloutRule(com.google.cloud.deploy.v1.AdvanceRolloutRule value) {
      if (advanceRolloutRuleBuilder_ == null) {
        if (ruleCase_ == 2 &&
          ...
          rule_ = com.google.cloud.deploy.v1.AdvanceRolloutRule.newBuilder((com.google.cloud.deploy.v1.AdvanceRolloutRule) rule_)
              .mergeFrom(value).buildPartial();
        } else {
          rule_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.AdvanceRolloutRule, com.google.cloud.deploy.v1.AdvanceRolloutRule.Builder, com.google.cloud.deploy.v1.AdvanceRolloutRuleOrBuilder> 
        getAdvanceRolloutRuleFieldBuilder() {
      if (advanceRolloutRuleBuilder_ == null) {
        if (!(ruleCase_ == 2)) {
          rule_ = com.google.cloud.deploy.v1.AdvanceRolloutRule.getDefaultInstance();
        }
        advanceRolloutRuleBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.AdvanceRolloutRule, com.google.cloud.deploy.v1.AdvanceRolloutRule.Builder, com.google.cloud.deploy.v1.AdvanceRolloutRuleOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.RepairRolloutRule, com.google.cloud.deploy.v1.RepairRolloutRule.Builder, com.google.cloud.deploy.v1.RepairRolloutRuleOrBuilder> repairRolloutRuleBuilder_;
    /**
     * <pre>
     * Optional. The `RepairRolloutRule` will automatically repair a failed
     * rollout.
    ...
    public Builder mergeRepairRolloutRule(com.google.cloud.deploy.v1.RepairRolloutRule value) {
      if (repairRolloutRuleBuilder_ == null) {
        if (ruleCase_ == 3 &&
          ...
          rule_ = com.google.cloud.deploy.v1.RepairRolloutRule.newBuilder((com.google.cloud.deploy.v1.RepairRolloutRule) rule_)
              .mergeFrom(value).buildPartial();
        } else {
          rule_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.cloud.deploy.v1.RepairRolloutRule, com.google.cloud.deploy.v1.RepairRolloutRule.Builder, com.google.cloud.deploy.v1.RepairRolloutRuleOrBuilder> 
        getRepairRolloutRuleFieldBuilder() {
      if (repairRolloutRuleBuilder_ == null) {
        if (!(ruleCase_ == 3)) {
          rule_ = com.google.cloud.deploy.v1.RepairRolloutRule.getDefaultInstance();
        }
        repairRolloutRuleBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.cloud.deploy.v1.RepairRolloutRule, com.google.cloud.deploy.v1.RepairRolloutRule.Builder, com.google.cloud.deploy.v1.RepairRolloutRuleOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<AutomationRule>
      PARSER = new com.google.protobuf.AbstractParser<AutomationRule>() {
    @java.lang.Override
