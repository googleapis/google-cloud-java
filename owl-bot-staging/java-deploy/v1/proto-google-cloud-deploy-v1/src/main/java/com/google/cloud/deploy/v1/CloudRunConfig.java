...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getCanaryRevisionTagsList()
        .equals(other.getCanaryRevisionTagsList())) return false;
    if (!getPriorRevisionTagsList()
        .equals(other.getPriorRevisionTagsList())) return false;
    if (!getStableRevisionTagsList()
        .equals(other.getStableRevisionTagsList())) return false;
  ...
  public static final class Builder extends
     ...
     * @return This builder for chaining.
     */
    public Builder setCanaryRevisionTags(
     ...
     * @return This builder for chaining.
     */
    public Builder addCanaryRevisionTags(
     ...
     * @return This builder for chaining.
     */
    public Builder addAllCanaryRevisionTags(
        java.lang.Iterable<java.lang.String> values) {
      ensureCanaryRevisionTagsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, canaryRevisionTags_);
      bitField0_ |= 0x00000002;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addCanaryRevisionTagsBytes(
     ...
     * @return This builder for chaining.
     */
    public Builder setPriorRevisionTags(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensurePriorRevisionTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addPriorRevisionTags(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensurePriorRevisionTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllPriorRevisionTags(
        java.lang.Iterable<java.lang.String> values) {
      ensurePriorRevisionTagsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, priorRevisionTags_);
      bitField0_ |= 0x00000004;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addPriorRevisionTagsBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensurePriorRevisionTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder setStableRevisionTags(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureStableRevisionTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addStableRevisionTags(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureStableRevisionTagsIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllStableRevisionTags(
        java.lang.Iterable<java.lang.String> values) {
      ensureStableRevisionTagsIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, stableRevisionTags_);
      bitField0_ |= 0x00000008;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addStableRevisionTagsBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureStableRevisionTagsIsMutable();
