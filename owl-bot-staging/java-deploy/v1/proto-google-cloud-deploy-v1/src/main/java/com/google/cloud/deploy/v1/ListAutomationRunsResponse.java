 ...
 */
public final class ListAutomationRunsResponse extends
...
private static final long serialVersionUID = 0L;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.deploy.v1.CloudDeployProto.internal_static_google_cloud_deploy_v1_ListAutomationRunsResponse_descriptor;
  }
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.deploy.v1.CloudDeployProto.internal_static_google_cloud_deploy_v1_ListAutomationRunsResponse_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.cloud.deploy.v1.ListAutomationRunsResponse.class, com.google.cloud.deploy.v1.ListAutomationRunsResponse.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.deploy.v1.AutomationRunOrBuilder getAutomationRunsOrBuilder(
      int index) {
    return automationRuns_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < automationRuns_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, automationRuns_.get(i));
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(nextPageToken_)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.deploy.v1.ListAutomationRunsResponse other = (com.google.cloud.deploy.v1.ListAutomationRunsResponse) obj;

    if (!getAutomationRunsList()
        .equals(other.getAutomationRunsList())) return false;
    if (!getNextPageToken()
  ...
  public static com.google.cloud.deploy.v1.ListAutomationRunsResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.deploy.v1.ListAutomationRunsResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.cloud.deploy.v1.ListAutomationRunsResponse prototype) {
  ...
  public static final class Builder extends
    ...
    public com.google.cloud.deploy.v1.ListAutomationRunsResponse buildPartial() {
      com.google.cloud.deploy.v1.ListAutomationRunsResponse result = new com.google.cloud.deploy.v1.ListAutomationRunsResponse(this);
    ...
    private void buildPartialRepeatedFields(com.google.cloud.deploy.v1.ListAutomationRunsResponse result) {
      if (automationRunsBuilder_ == null) {
    ...
    public Builder mergeFrom(com.google.cloud.deploy.v1.ListAutomationRunsResponse other) {
      if (other == com.google.cloud.deploy.v1.ListAutomationRunsResponse.getDefaultInstance()) return this;
      if (automationRunsBuilder_ == null) {
          ...
          if (automationRunsBuilder_.isEmpty()) {
            ...
            automationRunsBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getAutomationRunsFieldBuilder() : null;
          } else {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.deploy.v1.AutomationRun m =
                  input.readMessage(
                      com.google.cloud.deploy.v1.AutomationRun.parser(),
                      extensionRegistry);
              if (automationRunsBuilder_ == null) {
                ensureAutomationRunsIsMutable();
    ...
    private void ensureAutomationRunsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        automationRuns_ = new java.util.ArrayList<com.google.cloud.deploy.v1.AutomationRun>(automationRuns_);
        bitField0_ |= 0x00000001;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.deploy.v1.AutomationRun, com.google.cloud.deploy.v1.AutomationRun.Builder, com.google.cloud.deploy.v1.AutomationRunOrBuilder> automationRunsBuilder_;
    ...
    public Builder setAutomationRuns(
        int index, com.google.cloud.deploy.v1.AutomationRun value) {
      if (automationRunsBuilder_ == null) {
        if (value == null) {
     ...
     * <code>repeated .google.cloud.deploy.v1.AutomationRun automation_runs = 1;</code>
     */
    public com.google.cloud.deploy.v1.AutomationRun.Builder getAutomationRunsBuilder(
        int index) {
    ...
    public com.google.cloud.deploy.v1.AutomationRunOrBuilder getAutomationRunsOrBuilder(
        int index) {
      if (automationRunsBuilder_ == null) {
        return automationRuns_.get(index);  } else {
    ...
    public com.google.cloud.deploy.v1.AutomationRun.Builder addAutomationRunsBuilder() {
      return getAutomationRunsFieldBuilder().addBuilder(
    ...
    public com.google.cloud.deploy.v1.AutomationRun.Builder addAutomationRunsBuilder(
        int index) {
      return getAutomationRunsFieldBuilder().addBuilder(
          index, com.google.cloud.deploy.v1.AutomationRun.getDefaultInstance());
    }
    /**
     * <pre>
     * The `AutomationRuns` objects.
  ...
  private static final com.google.protobuf.Parser<ListAutomationRunsResponse>
      PARSER = new com.google.protobuf.AbstractParser<ListAutomationRunsResponse>() {
    @java.lang.Override
