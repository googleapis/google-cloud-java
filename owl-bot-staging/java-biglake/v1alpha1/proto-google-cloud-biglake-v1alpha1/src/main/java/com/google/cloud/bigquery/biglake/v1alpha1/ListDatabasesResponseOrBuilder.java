...
public interface ListDatabasesResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.bigquery.biglake.v1alpha1.ListDatabasesResponse)
   ...
   */
  java.util.List<com.google.cloud.bigquery.biglake.v1alpha1.Database> 
      getDatabasesList();
  /**
   * <pre>
   * The databases from the specified catalog.
   ...
   * <code>repeated .google.cloud.bigquery.biglake.v1alpha1.Database databases = 1;</code>
   */
  com.google.cloud.bigquery.biglake.v1alpha1.DatabaseOrBuilder getDatabasesOrBuilder(
      int index);
