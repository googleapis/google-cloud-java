...
public interface CreateDatabaseRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.bigquery.biglake.v1alpha1.CreateDatabaseRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.bigquery.biglake.v1alpha1.Database database = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.bigquery.biglake.v1alpha1.Database database = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.bigquery.biglake.v1alpha1.DatabaseOrBuilder getDatabaseOrBuilder();
