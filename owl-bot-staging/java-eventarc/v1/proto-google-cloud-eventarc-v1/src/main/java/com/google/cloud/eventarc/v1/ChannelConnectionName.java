...
public class ChannelConnectionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CHANNEL_CONNECTION =
  ...
  private ChannelConnectionName(Builder builder) {
    ...
    channelConnection = Preconditions.checkNotNull(builder.getChannelConnection());
  }
  ...
  public static ChannelConnectionName of(
  ...
  public static ChannelConnectionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CHANNEL_CONNECTION.validatedMatch(
            formattedString, "ChannelConnectionName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("channel_connection"));
  }

  public static List<ChannelConnectionName> parseList(List<String> formattedStrings) {
    List<ChannelConnectionName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (channelConnection != null) {
            fieldMapBuilder.put("channel_connection", channelConnection);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_CHANNEL_CONNECTION.instantiate(
        "project", project, "location", location, "channel_connection", channelConnection);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.channelConnection, that.channelConnection);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(channelConnection);
    return h;
  }
