...
public interface SearchProtectedResourcesRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>string scope = 2 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
   * @return The scope.
   */
   ...
   * </pre>
   *
   * <code>string crypto_key = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
