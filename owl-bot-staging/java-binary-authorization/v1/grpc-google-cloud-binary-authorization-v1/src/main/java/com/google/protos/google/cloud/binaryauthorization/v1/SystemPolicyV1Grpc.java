...
public final class SystemPolicyV1Grpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest,
      com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy> getGetSystemPolicyMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetSystemPolicy",
      requestType = com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest.class,
      responseType = com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest,
      com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy> getGetSystemPolicyMethod() {
    io.grpc.MethodDescriptor<com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest, com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy> getGetSystemPolicyMethod;
    if ((getGetSystemPolicyMethod = SystemPolicyV1Grpc.getGetSystemPolicyMethod) == null) {
      synchronized (SystemPolicyV1Grpc.class) {
        if ((getGetSystemPolicyMethod = SystemPolicyV1Grpc.getGetSystemPolicyMethod) == null) {
          SystemPolicyV1Grpc.getGetSystemPolicyMethod = getGetSystemPolicyMethod =
              io.grpc.MethodDescriptor.<com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest, com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetSystemPolicy"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy.getDefaultInstance()))
              .setSchemaDescriptor(new SystemPolicyV1MethodDescriptorSupplier("GetSystemPolicy"))
              .build();
        }
      }
    }
  ...
  public static SystemPolicyV1Stub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SystemPolicyV1Stub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SystemPolicyV1Stub>() {
        @java.lang.Override
        public SystemPolicyV1Stub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static SystemPolicyV1BlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<SystemPolicyV1BlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SystemPolicyV1BlockingStub>() {
        @java.lang.Override
        public SystemPolicyV1BlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static SystemPolicyV1FutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SystemPolicyV1FutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<SystemPolicyV1FutureStub>() {
        @java.lang.Override
        public SystemPolicyV1FutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static abstract class SystemPolicyV1ImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void getSystemPolicy(com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest request,
   ...
   * </pre>
   */
  public static final class SystemPolicyV1Stub extends io.grpc.stub.AbstractAsyncStub<SystemPolicyV1Stub> {
    private SystemPolicyV1Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected SystemPolicyV1Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new SystemPolicyV1Stub(channel, callOptions);
    }
   ...
   * </pre>
   */
  public static final class SystemPolicyV1BlockingStub extends io.grpc.stub.AbstractBlockingStub<SystemPolicyV1BlockingStub> {
     ...
     * </pre>
     */
    public com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy getSystemPolicy(com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest request) {
   ...
   * </pre>
   */
  public static final class SystemPolicyV1FutureStub extends io.grpc.stub.AbstractFutureStub<SystemPolicyV1FutureStub> {
    private SystemPolicyV1FutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy> getSystemPolicy(
        com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_SYSTEM_POLICY:
          serviceImpl.getSystemPolicy((com.google.protos.google.cloud.binaryauthorization.v1.Service.GetSystemPolicyRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protos.google.cloud.binaryauthorization.v1.Resources.Policy>) responseObserver);
          break;
        default:
  ...
  private static abstract class SystemPolicyV1BaseDescriptorSupplier
