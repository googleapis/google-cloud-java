...
public interface CustomConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.securityposture.v1.CustomConfig.CustomOutputSpec custom_output = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * <code>.google.cloud.securityposture.v1.CustomConfig.CustomOutputSpec custom_output = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.securityposture.v1.CustomConfig.CustomOutputSpecOrBuilder getCustomOutputOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.securityposture.v1.CustomConfig.ResourceSelector resource_selector = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.securityposture.v1.CustomConfig.ResourceSelector resource_selector = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.securityposture.v1.CustomConfig.ResourceSelectorOrBuilder getResourceSelectorOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.securityposture.v1.CustomConfig.Severity severity = 4 [(.google.api.field_behavior) = REQUIRED];</code>
