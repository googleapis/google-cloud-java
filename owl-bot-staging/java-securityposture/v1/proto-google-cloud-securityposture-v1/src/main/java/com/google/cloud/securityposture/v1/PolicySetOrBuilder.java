...
public interface PolicySetOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.securityposture.v1.Policy policies = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.cloud.securityposture.v1.Policy> 
      getPoliciesList();
  /**
   * <pre>
   * Required. List of policies.
   ...
   * <code>repeated .google.cloud.securityposture.v1.Policy policies = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.securityposture.v1.PolicyOrBuilder getPoliciesOrBuilder(
      int index);
}
