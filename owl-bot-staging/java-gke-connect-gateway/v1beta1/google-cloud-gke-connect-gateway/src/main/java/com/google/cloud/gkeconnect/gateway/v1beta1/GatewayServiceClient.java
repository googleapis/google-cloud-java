 ...
 *    <tr>
 *      <td>GetResource</td>
 *      <td><p>GetResource performs an HTTP GET request on the Kubernetes API Server.</p></td>
 *      <td>
 ...
 *    <tr>
 *      <td>PostResource</td>
 *      <td><p>PostResource performs an HTTP POST on the Kubernetes API Server.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>DeleteResource performs an HTTP DELETE on the Kubernetes API Server.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>PutResource</td>
 *      <td><p>PutResource performs an HTTP PUT on the Kubernetes API Server.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>PatchResource</td>
 *      <td><p>PatchResource performs an HTTP PATCH on the Kubernetes API Server.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
