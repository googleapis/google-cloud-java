...
public interface ReplicationCycleOrBuilder extends
   ...
   */
  @java.lang.Deprecated int getProgressPercent();
   ...
   */
  java.util.List<com.google.cloud.vmmigration.v1.CycleStep> 
      getStepsList();
  /**
   * <pre>
   * The cycle's steps list representing its progress.
   ...
   * <code>repeated .google.cloud.vmmigration.v1.CycleStep steps = 9;</code>
   */
  com.google.cloud.vmmigration.v1.CycleStepOrBuilder getStepsOrBuilder(
      int index);
