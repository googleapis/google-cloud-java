...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.cloud.vmmigration.v1.ReplicationCycle.State getState() {
    ...
    com.google.cloud.vmmigration.v1.ReplicationCycle.State result = com.google.cloud.vmmigration.v1.ReplicationCycle.State.valueOf(state_);
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeTotalPauseDuration(com.google.protobuf.Duration value) {
      if (totalPauseDurationBuilder_ == null) {
        if (totalPauseDuration_ != null) {
          totalPauseDuration_ =
            com.google.protobuf.Duration.newBuilder(totalPauseDuration_).mergeFrom(value).buildPartial();
        } else {
          totalPauseDuration_ = value;
        }
        onChanged();
