...
public class GroupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_GROUP =
  ...
  public static GroupName of(String project, String location, String group) {
    return newBuilder().setProject(project).setLocation(location).setGroup(group).build();
  }
  ...
  public static GroupName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_GROUP.validatedMatch(
            formattedString, "GroupName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("group"));
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_GROUP.instantiate(
