...
public interface ListMigratingVmsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vmmigration.v1.ListMigratingVmsResponse)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.vmmigration.v1.MigratingVm migrating_vms = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.vmmigration.v1.MigratingVm> 
      getMigratingVmsList();
  /**
   * <pre>
   * Output only. The list of Migrating VMs response.
