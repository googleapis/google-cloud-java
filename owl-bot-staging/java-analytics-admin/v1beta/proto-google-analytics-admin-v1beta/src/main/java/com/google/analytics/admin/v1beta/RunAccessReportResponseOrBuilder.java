...
public interface RunAccessReportResponseOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.admin.v1beta.AccessDimensionHeader dimension_headers = 1;</code>
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessDimensionHeader> 
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessMetricHeader> 
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessRow> 
      getRowsList();
  /**
   * <pre>
   * Rows of dimension value combinations and metric values in the report.
   ...
   * <code>repeated .google.analytics.admin.v1beta.AccessRow rows = 3;</code>
   */
  com.google.analytics.admin.v1beta.AccessRowOrBuilder getRowsOrBuilder(
      int index);
