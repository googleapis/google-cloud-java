      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            firebaseLink_ = input.readMessage(com.google.analytics.admin.v1beta.FirebaseLink.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.analytics.admin.v1beta.CreateFirebaseLinkRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeFirebaseLink(com.google.analytics.admin.v1beta.FirebaseLink value) {
      if (firebaseLinkBuilder_ == null) {
        if (firebaseLink_ != null) {
          firebaseLink_ =
            com.google.analytics.admin.v1beta.FirebaseLink.newBuilder(firebaseLink_).mergeFrom(value).buildPartial();
        } else {
          firebaseLink_ = value;
        }
        onChanged();
