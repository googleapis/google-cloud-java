...
public interface RunAccessReportRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessDimension> 
      getDimensionsList();
  /**
   * <pre>
   * The dimensions requested and displayed in the response. Requests are
   ...
   * <code>repeated .google.analytics.admin.v1beta.AccessDimension dimensions = 2;</code>
   */
  com.google.analytics.admin.v1beta.AccessDimensionOrBuilder getDimensionsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessMetric> 
      getMetricsList();
  /**
   * <pre>
   * The metrics requested and displayed in the response. Requests are allowed
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessDateRange> 
      getDateRangesList();
  /**
   * <pre>
   * Date ranges of access records to read. If multiple date ranges are
   ...
   * <code>repeated .google.analytics.admin.v1beta.AccessDateRange date_ranges = 4;</code>
   */
  com.google.analytics.admin.v1beta.AccessDateRangeOrBuilder getDateRangesOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.AccessOrderBy> 
      getOrderBysList();
  /**
   * <pre>
   * Specifies how rows are ordered in the response.
   ...
   * <code>repeated .google.analytics.admin.v1beta.AccessOrderBy order_bys = 10;</code>
   */
  com.google.analytics.admin.v1beta.AccessOrderByOrBuilder getOrderBysOrBuilder(
      int index);
