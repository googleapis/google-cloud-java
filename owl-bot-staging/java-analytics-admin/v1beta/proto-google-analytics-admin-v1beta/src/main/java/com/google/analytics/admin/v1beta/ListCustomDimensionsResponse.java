        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              customDimensions_ = new java.util.ArrayList<com.google.analytics.admin.v1beta.CustomDimension>();
              mutable_bitField0_ |= 0x00000001;
            }
            customDimensions_.add(
                input.readMessage(com.google.analytics.admin.v1beta.CustomDimension.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.analytics.admin.v1beta.ListCustomDimensionsResponse) e.getUnfinishedMessage();
