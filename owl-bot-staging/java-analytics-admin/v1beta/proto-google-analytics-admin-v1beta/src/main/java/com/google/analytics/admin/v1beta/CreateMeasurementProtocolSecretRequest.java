...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.analytics.admin.v1beta.CreateMeasurementProtocolSecretRequest result) {
      int from_bitField0_ = bitField0_;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.parent_ = parent_;
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.measurementProtocolSecret_ = measurementProtocolSecretBuilder_ == null
    ...
    public Builder mergeMeasurementProtocolSecret(com.google.analytics.admin.v1beta.MeasurementProtocolSecret value) {
      if (measurementProtocolSecretBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          measurementProtocolSecret_ != null &&
          measurementProtocolSecret_ != com.google.analytics.admin.v1beta.MeasurementProtocolSecret.getDefaultInstance()) {
