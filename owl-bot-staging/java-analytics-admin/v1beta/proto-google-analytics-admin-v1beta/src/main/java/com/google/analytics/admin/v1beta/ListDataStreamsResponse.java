...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.analytics.admin.v1beta.ListDataStreamsResponse result) {
      if (dataStreamsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.analytics.admin.v1beta.DataStream m =
                  input.readMessage(
                      com.google.analytics.admin.v1beta.DataStream.parser(),
                      extensionRegistry);
              if (dataStreamsBuilder_ == null) {
                ensureDataStreamsIsMutable();
                dataStreams_.add(m);
