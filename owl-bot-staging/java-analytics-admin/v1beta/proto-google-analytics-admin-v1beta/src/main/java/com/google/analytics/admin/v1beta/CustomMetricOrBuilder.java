...
public interface CustomMetricOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1beta.CustomMetric)
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1beta.CustomMetric.MeasurementUnit measurement_unit = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1beta.CustomMetric.MetricScope scope = 6 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * @return The scope.
   */
  com.google.analytics.admin.v1beta.CustomMetric.MetricScope getScope();
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.admin.v1beta.CustomMetric.RestrictedMetricType restricted_metric_type = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   * @return A list containing the restrictedMetricType.
   */
  java.util.List<com.google.analytics.admin.v1beta.CustomMetric.RestrictedMetricType> getRestrictedMetricTypeList();
  /**
   * <pre>
   * Optional. Types of restricted data that this metric may contain. Required for metrics
   * with CURRENCY measurement unit. Must be empty for metrics with a
   ...
   */
  com.google.analytics.admin.v1beta.CustomMetric.RestrictedMetricType getRestrictedMetricType(int index);
  /**
   * <pre>
   * Optional. Types of restricted data that this metric may contain. Required for metrics
   * with CURRENCY measurement unit. Must be empty for metrics with a
