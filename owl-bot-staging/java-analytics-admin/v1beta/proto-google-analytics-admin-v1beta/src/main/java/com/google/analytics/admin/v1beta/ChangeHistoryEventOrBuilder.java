...
public interface ChangeHistoryEventOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.admin.v1beta.ChangeHistoryChange> 
      getChangesList();
  /**
   * <pre>
   * A list of changes made in this change history event that fit the filters
   ...
   * <code>repeated .google.analytics.admin.v1beta.ChangeHistoryChange changes = 6;</code>
   */
  com.google.analytics.admin.v1beta.ChangeHistoryChangeOrBuilder getChangesOrBuilder(
      int index);
}
