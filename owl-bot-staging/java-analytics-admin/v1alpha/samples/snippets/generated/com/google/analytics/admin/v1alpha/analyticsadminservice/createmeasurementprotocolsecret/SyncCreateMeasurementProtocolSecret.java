...
public class SyncCreateMeasurementProtocolSecret {

  public static void main(String[] args) throws Exception {
    syncCreateMeasurementProtocolSecret();
  }

  public static void syncCreateMeasurementProtocolSecret() throws Exception {
