...
public class SyncDeleteRollupPropertySourceLink {

  public static void main(String[] args) throws Exception {
    syncDeleteRollupPropertySourceLink();
  }

  public static void syncDeleteRollupPropertySourceLink() throws Exception {
