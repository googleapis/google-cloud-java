...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.analytics.admin.v1alpha.CreateCustomDimensionRequest result) {
    ...
    public Builder mergeCustomDimension(com.google.analytics.admin.v1alpha.CustomDimension value) {
      if (customDimensionBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          customDimension_ != null &&
          customDimension_ != com.google.analytics.admin.v1alpha.CustomDimension.getDefaultInstance()) {
