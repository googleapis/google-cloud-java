...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (scrollsEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(3, scrollsEnabled_);
    }
    if (outboundClicksEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(4, outboundClicksEnabled_);
    }
    if (siteSearchEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(5, siteSearchEnabled_);
    }
    if (videoEngagementEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(6, videoEngagementEnabled_);
    }
    if (fileDownloadsEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(7, fileDownloadsEnabled_);
    }
    if (pageChangesEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(8, pageChangesEnabled_);
    }
    if (formInteractionsEnabled_ != false) {
      size += com.google.protobuf.CodedOutputStream
        .computeBoolSize(9, formInteractionsEnabled_);
    }
    if (!com.google.protobuf.GeneratedMessageV3.isStringEmpty(searchQueryParameter_)) {
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (getFormInteractionsEnabled()
        != other.getFormInteractionsEnabled()) return false;
