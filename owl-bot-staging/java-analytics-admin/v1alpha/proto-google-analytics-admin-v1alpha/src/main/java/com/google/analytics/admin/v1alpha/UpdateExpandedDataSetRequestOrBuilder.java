...
public interface UpdateExpandedDataSetRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.UpdateExpandedDataSetRequest)
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1alpha.ExpandedDataSet expanded_data_set = 1 [(.google.api.field_behavior) = REQUIRED];</code>
