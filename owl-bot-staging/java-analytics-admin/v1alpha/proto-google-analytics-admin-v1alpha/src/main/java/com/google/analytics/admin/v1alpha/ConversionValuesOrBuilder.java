...
public interface ConversionValuesOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1alpha.CoarseValue coarse_value = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  java.util.List<com.google.analytics.admin.v1alpha.EventMapping> 
