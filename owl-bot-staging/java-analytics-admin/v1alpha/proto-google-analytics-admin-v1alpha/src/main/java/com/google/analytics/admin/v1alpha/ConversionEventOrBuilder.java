...
public interface ConversionEventOrBuilder extends
   ...
   */
  com.google.analytics.admin.v1alpha.ConversionEvent.DefaultConversionValue getDefaultConversionValue();
  /**
   * <pre>
   * Optional. Defines a default value/currency for a conversion event.
   * </pre>
   ...
   * <code>optional .google.analytics.admin.v1alpha.ConversionEvent.DefaultConversionValue default_conversion_value = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.analytics.admin.v1alpha.ConversionEvent.DefaultConversionValueOrBuilder getDefaultConversionValueOrBuilder();
}
