...
public interface UpdateChannelGroupRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1alpha.ChannelGroup channel_group = 1 [(.google.api.field_behavior) = REQUIRED];</code>
