...
public interface AccountSummaryOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.AccountSummary)
   ...
   */
  java.util.List<com.google.analytics.admin.v1alpha.PropertySummary> 
   ...
   * <code>repeated .google.analytics.admin.v1alpha.PropertySummary property_summaries = 4;</code>
   */
  com.google.analytics.admin.v1alpha.PropertySummaryOrBuilder getPropertySummariesOrBuilder(
      int index);
}
