...
public interface SearchChangeHistoryEventsRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.analytics.admin.v1alpha.SearchChangeHistoryEventsRequest)
   ...
   */
  java.util.List<com.google.analytics.admin.v1alpha.ChangeHistoryResourceType> getResourceTypeList();
  /**
   * <pre>
   * Optional. If set, only return changes if they are for a resource that matches at
   * least one of these types.
