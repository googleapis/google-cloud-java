 ...
 */
public final class ExpandedDataSetFilterExpressionList extends
...
private static final long serialVersionUID = 0L;
  ...
  private ExpandedDataSetFilterExpressionList(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.admin.v1alpha.ExpandedDataSetProto.internal_static_google_analytics_admin_v1alpha_ExpandedDataSetFilterExpressionList_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.admin.v1alpha.ExpandedDataSetProto.internal_static_google_analytics_admin_v1alpha_ExpandedDataSetFilterExpressionList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList.class, com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList.Builder.class);
  }

  public static final int FILTER_EXPRESSIONS_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression> filterExpressions_;
  /**
   * <pre>
   * A list of ExpandedDataSet filter expressions.
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression> getFilterExpressionsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression getFilterExpressions(int index) {
   ...
   */
  @java.lang.Override
  public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionOrBuilder getFilterExpressionsOrBuilder(
      int index) {
    return filterExpressions_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList other = (com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList) obj;
  ...
  public static com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList parseFrom(
  ...
  public static com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList getDefaultInstanceForType() {
    ...
    public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList build() {
      com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList result = buildPartial();
    ...
    public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList buildPartial() {
      com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList result = new com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList(this);
    ...
    private void buildPartialRepeatedFields(com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList result) {
      if (filterExpressionsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList) {
        return mergeFrom((com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList)other);
      } else {
    ...
    public Builder mergeFrom(com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList other) {
      if (other == com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList.getDefaultInstance()) return this;
      if (filterExpressionsBuilder_ == null) {
    ...
    private void ensureFilterExpressionsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        filterExpressions_ = new java.util.ArrayList<com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression>(filterExpressions_);
     ...
     */
    public Builder setFilterExpressions(
        int index, com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression.Builder builderForValue) {
      if (filterExpressionsBuilder_ == null) {
        ensureFilterExpressionsIsMutable();
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression filter_expressions = 1;</code>
     */
    public Builder addFilterExpressions(com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression value) {
      if (filterExpressionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addAllFilterExpressions(
        java.lang.Iterable<? extends com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression> values) {
      if (filterExpressionsBuilder_ == null) {
        ensureFilterExpressionsIsMutable();
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression filter_expressions = 1;</code>
     */
    public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression.Builder getFilterExpressionsBuilder(
        int index) {
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression filter_expressions = 1;</code>
     */
    public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression.Builder addFilterExpressionsBuilder() {
    ...
    public com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression.Builder addFilterExpressionsBuilder(
        int index) {
      return getFilterExpressionsFieldBuilder().addBuilder(
          index, com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression.getDefaultInstance());
    }
    /**
     * <pre>
     * A list of ExpandedDataSet filter expressions.
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression filter_expressions = 1;</code>
     */
    public java.util.List<com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpression.Builder> 
  ...
  private static final com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList();
  }

  public static com.google.analytics.admin.v1alpha.ExpandedDataSetFilterExpressionList getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<ExpandedDataSetFilterExpressionList>
      PARSER = new com.google.protobuf.AbstractParser<ExpandedDataSetFilterExpressionList>() {
    @java.lang.Override
