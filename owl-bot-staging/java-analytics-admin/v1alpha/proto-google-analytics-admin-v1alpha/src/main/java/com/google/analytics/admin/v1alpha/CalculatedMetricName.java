...
public class CalculatedMetricName implements ResourceName {
  private static final PathTemplate PROPERTY_CALCULATED_METRIC =
  ...
  private CalculatedMetricName(Builder builder) {
    ...
    calculatedMetric = Preconditions.checkNotNull(builder.getCalculatedMetric());
  }
  ...
  public static CalculatedMetricName of(String property, String calculatedMetric) {
    return newBuilder().setProperty(property).setCalculatedMetric(calculatedMetric).build();
  }
  ...
  public static CalculatedMetricName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROPERTY_CALCULATED_METRIC.validatedMatch(
            formattedString, "CalculatedMetricName.parse: formattedString not in valid format");
    return of(matchMap.get("property"), matchMap.get("calculated_metric"));
  }

  public static List<CalculatedMetricName> parseList(List<String> formattedStrings) {
    List<CalculatedMetricName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (calculatedMetric != null) {
            fieldMapBuilder.put("calculated_metric", calculatedMetric);
          }
  ...
  public String toString() {
    return PROPERTY_CALCULATED_METRIC.instantiate(
        "property", property, "calculated_metric", calculatedMetric);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.property, that.property)
          && Objects.equals(this.calculatedMetric, that.calculatedMetric);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(calculatedMetric);
    return h;
  }

  /** Builder for properties/{property}/calculatedMetrics/{calculated_metric}. */
