 ...
 */
public final class ChannelGroupFilterExpressionList extends
...
private static final long serialVersionUID = 0L;
  ...
  private ChannelGroupFilterExpressionList(com.google.protobuf.GeneratedMessageV3.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.admin.v1alpha.ChannelGroupProto.internal_static_google_analytics_admin_v1alpha_ChannelGroupFilterExpressionList_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.admin.v1alpha.ChannelGroupProto.internal_static_google_analytics_admin_v1alpha_ChannelGroupFilterExpressionList_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList.class, com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList.Builder.class);
  }

  public static final int FILTER_EXPRESSIONS_FIELD_NUMBER = 1;
  @SuppressWarnings("serial")
  private java.util.List<com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression> filterExpressions_;
  /**
   * <pre>
   * A list of Channel Group filter expressions.
   * </pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression> getFilterExpressionsList() {
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionOrBuilder> 
   ...
   */
  @java.lang.Override
  public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression getFilterExpressions(int index) {
   ...
   */
  @java.lang.Override
  public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionOrBuilder getFilterExpressionsOrBuilder(
      int index) {
    return filterExpressions_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList other = (com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList) obj;
  ...
  public static com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  public static com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList parseFrom(
  ...
  public static com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
        .parseDelimitedWithIOException(PARSER, input);
  }

  public static com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList parseDelimitedFrom(
      java.io.InputStream input,
      com.google.protobuf.ExtensionRegistryLite extensionRegistry)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList prototype) {
  ...
  public static final class Builder extends
    ...
    // Construct using com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList getDefaultInstanceForType() {
    ...
    public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList buildPartial() {
      com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList result = new com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList(this);
    ...
    private void buildPartialRepeatedFields(com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList result) {
      if (filterExpressionsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList) {
        return mergeFrom((com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList)other);
      } else {
    ...
    public Builder mergeFrom(com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList other) {
      if (other == com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList.getDefaultInstance()) return this;
      if (filterExpressionsBuilder_ == null) {
    ...
    private void ensureFilterExpressionsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        filterExpressions_ = new java.util.ArrayList<com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression>(filterExpressions_);
     ...
     */
    public Builder setFilterExpressions(
        int index, com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression.Builder builderForValue) {
      if (filterExpressionsBuilder_ == null) {
        ensureFilterExpressionsIsMutable();
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ChannelGroupFilterExpression filter_expressions = 1;</code>
     */
    public Builder addFilterExpressions(com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression value) {
      if (filterExpressionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ChannelGroupFilterExpression filter_expressions = 1;</code>
     */
    public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression.Builder getFilterExpressionsBuilder(
        int index) {
     ...
     * <code>repeated .google.analytics.admin.v1alpha.ChannelGroupFilterExpression filter_expressions = 1;</code>
     */
    public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression.Builder addFilterExpressionsBuilder() {
    ...
    public com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression.Builder addFilterExpressionsBuilder(
        int index) {
      return getFilterExpressionsFieldBuilder().addBuilder(
          index, com.google.analytics.admin.v1alpha.ChannelGroupFilterExpression.getDefaultInstance());
    }
    /**
     * <pre>
     * A list of Channel Group filter expressions.
  ...
  private static final com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList DEFAULT_INSTANCE;
  static {
    DEFAULT_INSTANCE = new com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList();
  }

  public static com.google.analytics.admin.v1alpha.ChannelGroupFilterExpressionList getDefaultInstance() {
    return DEFAULT_INSTANCE;
  }

  private static final com.google.protobuf.Parser<ChannelGroupFilterExpressionList>
      PARSER = new com.google.protobuf.AbstractParser<ChannelGroupFilterExpressionList>() {
    @java.lang.Override
