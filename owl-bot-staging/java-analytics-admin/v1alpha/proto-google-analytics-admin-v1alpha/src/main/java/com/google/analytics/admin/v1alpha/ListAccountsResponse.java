...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.analytics.admin.v1alpha.ListAccountsResponse result) {
      if (accountsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.analytics.admin.v1alpha.Account m =
                  input.readMessage(
                      com.google.analytics.admin.v1alpha.Account.parser(),
                      extensionRegistry);
              if (accountsBuilder_ == null) {
                ensureAccountsIsMutable();
                accounts_.add(m);
