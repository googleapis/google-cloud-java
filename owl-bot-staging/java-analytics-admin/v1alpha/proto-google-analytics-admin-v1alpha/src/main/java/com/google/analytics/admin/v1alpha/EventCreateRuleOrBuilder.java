...
public interface EventCreateRuleOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.admin.v1alpha.MatchingCondition> 
   ...
   */
  java.util.List<com.google.analytics.admin.v1alpha.ParameterMutation> 
