...
public interface MatchingConditionOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1alpha.MatchingCondition.ComparisonType comparison_type = 2 [(.google.api.field_behavior) = REQUIRED];</code>
