...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.analytics.admin.v1alpha.ListPropertiesResponse result) {
      if (propertiesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.analytics.admin.v1alpha.Property m =
                  input.readMessage(
                      com.google.analytics.admin.v1alpha.Property.parser(),
                      extensionRegistry);
              if (propertiesBuilder_ == null) {
                ensurePropertiesIsMutable();
                properties_.add(m);
