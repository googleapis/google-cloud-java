...
public interface CalculatedMetricOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1alpha.CalculatedMetric.MetricUnit metric_unit = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.admin.v1alpha.CalculatedMetric.RestrictedMetricType restricted_metric_type = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return A list containing the restrictedMetricType.
   */
  java.util.List<com.google.analytics.admin.v1alpha.CalculatedMetric.RestrictedMetricType> getRestrictedMetricTypeList();
  /**
   * <pre>
   * Output only. Types of restricted data that this metric contains.
   * </pre>
   ...
   */
  com.google.analytics.admin.v1alpha.CalculatedMetric.RestrictedMetricType getRestrictedMetricType(int index);
  /**
   * <pre>
   * Output only. Types of restricted data that this metric contains.
   * </pre>
