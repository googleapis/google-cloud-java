...
public interface UpdateEventCreateRuleRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.analytics.admin.v1alpha.EventCreateRule event_create_rule = 1 [(.google.api.field_behavior) = REQUIRED];</code>
