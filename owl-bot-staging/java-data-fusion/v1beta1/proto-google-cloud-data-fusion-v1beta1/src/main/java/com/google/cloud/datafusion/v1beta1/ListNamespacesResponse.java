...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.datafusion.v1beta1.ListNamespacesResponse result) {
      if (namespacesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.datafusion.v1beta1.Namespace m =
                  input.readMessage(
                      com.google.cloud.datafusion.v1beta1.Namespace.parser(),
                      extensionRegistry);
              if (namespacesBuilder_ == null) {
                ensureNamespacesIsMutable();
                namespaces_.add(m);
