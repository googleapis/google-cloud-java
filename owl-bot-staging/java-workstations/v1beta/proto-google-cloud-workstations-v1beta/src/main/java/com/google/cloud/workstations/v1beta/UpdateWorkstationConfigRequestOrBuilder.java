...
public interface UpdateWorkstationConfigRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.workstations.v1beta.WorkstationConfig workstation_config = 1 [(.google.api.field_behavior) = REQUIRED];</code>
