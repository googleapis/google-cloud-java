...
public interface ListUsableWorkstationsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.workstations.v1beta.ListUsableWorkstationsResponse)
   ...
   */
  java.util.List<com.google.cloud.workstations.v1beta.Workstation> 
      getWorkstationsList();
  /**
   * <pre>
   * The requested workstations.
   ...
   * <code>repeated .google.cloud.workstations.v1beta.Workstation workstations = 1;</code>
   */
  com.google.cloud.workstations.v1beta.WorkstationOrBuilder getWorkstationsOrBuilder(
      int index);
