...
public interface RowOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.DimensionValue> 
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.MetricValue> 
      getMetricValuesList();
  /**
   * <pre>
   * List of requested visible metric values.
   ...
   * <code>repeated .google.analytics.data.v1alpha.MetricValue metric_values = 2;</code>
   */
  com.google.analytics.data.v1alpha.MetricValueOrBuilder getMetricValuesOrBuilder(
      int index);
}
