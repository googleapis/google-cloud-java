 ...
 */
public final class SessionSegmentExclusion extends
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            sessionExclusionCriteria_ = input.readMessage(com.google.analytics.data.v1alpha.SessionSegmentCriteria.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_SessionSegmentExclusion_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_SessionSegmentExclusion_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.data.v1alpha.SessionSegmentExclusion.class, com.google.analytics.data.v1alpha.SessionSegmentExclusion.Builder.class);
  }
   ...
   */
  @java.lang.Override public int getSessionExclusionDurationValue() {
   ...
   */
  @java.lang.Override public com.google.analytics.data.v1alpha.SessionExclusionDuration getSessionExclusionDuration() {
    @SuppressWarnings("deprecation")
    com.google.analytics.data.v1alpha.SessionExclusionDuration result = com.google.analytics.data.v1alpha.SessionExclusionDuration.valueOf(sessionExclusionDuration_);
    return result == null ? com.google.analytics.data.v1alpha.SessionExclusionDuration.UNRECOGNIZED : result;
  }
  ...
  public com.google.analytics.data.v1alpha.SessionSegmentCriteria getSessionExclusionCriteria() {
    return sessionExclusionCriteria_ == null ? com.google.analytics.data.v1alpha.SessionSegmentCriteria.getDefaultInstance() : sessionExclusionCriteria_;
  }
  /**
   * <pre>
   * If a session meets this condition, the session is excluded from
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder getSessionExclusionCriteriaOrBuilder() {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    if (sessionExclusionDuration_ != com.google.analytics.data.v1alpha.SessionExclusionDuration.SESSION_EXCLUSION_DURATION_UNSPECIFIED.getNumber()) {
  ...
  public int getSerializedSize() {
    ...
    if (sessionExclusionDuration_ != com.google.analytics.data.v1alpha.SessionExclusionDuration.SESSION_EXCLUSION_DURATION_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream
        .computeEnumSize(1, sessionExclusionDuration_);
    }
    if (sessionExclusionCriteria_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(2, getSessionExclusionCriteria());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.data.v1alpha.SessionSegmentExclusion other = (com.google.analytics.data.v1alpha.SessionSegmentExclusion) obj;
    ...
    if (hasSessionExclusionCriteria()) {
      if (!getSessionExclusionCriteria()
          .equals(other.getSessionExclusionCriteria())) return false;
    }
  ...
  public static com.google.analytics.data.v1alpha.SessionSegmentExclusion parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.analytics.data.v1alpha.SessionSegmentExclusion parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.analytics.data.v1alpha.SessionSegmentExclusion prototype) {
  ...
  public static final class Builder extends
    ...
    public com.google.analytics.data.v1alpha.SessionSegmentExclusion buildPartial() {
      com.google.analytics.data.v1alpha.SessionSegmentExclusion result = new com.google.analytics.data.v1alpha.SessionSegmentExclusion(this);
    ...
    public Builder mergeFrom(com.google.analytics.data.v1alpha.SessionSegmentExclusion other) {
      if (other == com.google.analytics.data.v1alpha.SessionSegmentExclusion.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.analytics.data.v1alpha.SessionSegmentExclusion) e.getUnfinishedMessage();
     ...
     * @return This builder for chaining.
     */
    public Builder setSessionExclusionDuration(com.google.analytics.data.v1alpha.SessionExclusionDuration value) {
      if (value == null) {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SessionSegmentCriteria, com.google.analytics.data.v1alpha.SessionSegmentCriteria.Builder, com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder> sessionExclusionCriteriaBuilder_;
    /**
     * <pre>
     * If a session meets this condition, the session is excluded from
     * membership in the segment for the `sessionExclusionDuration`.
     ...
     * <code>.google.analytics.data.v1alpha.SessionSegmentCriteria session_exclusion_criteria = 2;</code>
     */
    public Builder setSessionExclusionCriteria(com.google.analytics.data.v1alpha.SessionSegmentCriteria value) {
      if (sessionExclusionCriteriaBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.analytics.data.v1alpha.SessionSegmentCriteria session_exclusion_criteria = 2;</code>
     */
    public Builder mergeSessionExclusionCriteria(com.google.analytics.data.v1alpha.SessionSegmentCriteria value) {
      if (sessionExclusionCriteriaBuilder_ == null) {
        if (sessionExclusionCriteria_ != null) {
          sessionExclusionCriteria_ =
            com.google.analytics.data.v1alpha.SessionSegmentCriteria.newBuilder(sessionExclusionCriteria_).mergeFrom(value).buildPartial();
        } else {
          sessionExclusionCriteria_ = value;
        }
        onChanged();
     ...
     * <code>.google.analytics.data.v1alpha.SessionSegmentCriteria session_exclusion_criteria = 2;</code>
     */
    public com.google.analytics.data.v1alpha.SessionSegmentCriteria.Builder getSessionExclusionCriteriaBuilder() {
    ...
    public com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder getSessionExclusionCriteriaOrBuilder() {
      if (sessionExclusionCriteriaBuilder_ != null) {
        ...
        return sessionExclusionCriteria_ == null ?
            com.google.analytics.data.v1alpha.SessionSegmentCriteria.getDefaultInstance() : sessionExclusionCriteria_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (sessionExclusionCriteriaBuilder_ == null) {
        sessionExclusionCriteriaBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.SessionSegmentCriteria, com.google.analytics.data.v1alpha.SessionSegmentCriteria.Builder, com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder>(
  ...
  private static final com.google.protobuf.Parser<SessionSegmentExclusion>
      PARSER = new com.google.protobuf.AbstractParser<SessionSegmentExclusion>() {
    @java.lang.Override
