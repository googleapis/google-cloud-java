...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getUserSegmentFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 26: {
              input.readMessage(
                  getSessionSegmentFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 34: {
              input.readMessage(
                  getEventSegmentFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.UserSegment, com.google.analytics.data.v1alpha.UserSegment.Builder, com.google.analytics.data.v1alpha.UserSegmentOrBuilder> userSegmentBuilder_;
    /**
     * <pre>
     * User segments are subsets of users who engaged with your site or app.
     * </pre>
    ...
    public Builder mergeUserSegment(com.google.analytics.data.v1alpha.UserSegment value) {
      if (userSegmentBuilder_ == null) {
        if (oneSegmentScopeCase_ == 2 &&
          ...
          oneSegmentScope_ = com.google.analytics.data.v1alpha.UserSegment.newBuilder((com.google.analytics.data.v1alpha.UserSegment) oneSegmentScope_)
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.UserSegment, com.google.analytics.data.v1alpha.UserSegment.Builder, com.google.analytics.data.v1alpha.UserSegmentOrBuilder> 
        getUserSegmentFieldBuilder() {
      if (userSegmentBuilder_ == null) {
        if (!(oneSegmentScopeCase_ == 2)) {
          oneSegmentScope_ = com.google.analytics.data.v1alpha.UserSegment.getDefaultInstance();
        }
        userSegmentBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.UserSegment, com.google.analytics.data.v1alpha.UserSegment.Builder, com.google.analytics.data.v1alpha.UserSegmentOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SessionSegment, com.google.analytics.data.v1alpha.SessionSegment.Builder, com.google.analytics.data.v1alpha.SessionSegmentOrBuilder> sessionSegmentBuilder_;
    /**
     * <pre>
     * Session segments are subsets of the sessions that occurred on your site
     * or app.
