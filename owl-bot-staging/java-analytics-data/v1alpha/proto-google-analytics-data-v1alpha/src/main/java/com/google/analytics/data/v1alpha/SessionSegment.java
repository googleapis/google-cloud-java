...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder getSessionInclusionCriteriaOrBuilder() {
    return sessionInclusionCriteria_ == null ? com.google.analytics.data.v1alpha.SessionSegmentCriteria.getDefaultInstance() : sessionInclusionCriteria_;
  }
  ...
  public com.google.analytics.data.v1alpha.SessionSegmentExclusion getExclusion() {
    return exclusion_ == null ? com.google.analytics.data.v1alpha.SessionSegmentExclusion.getDefaultInstance() : exclusion_;
  }
  /**
   * <pre>
   * Defines which sessions are excluded in this segment. Optional.
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.SessionSegmentExclusionOrBuilder getExclusionOrBuilder() {
    return exclusion_ == null ? com.google.analytics.data.v1alpha.SessionSegmentExclusion.getDefaultInstance() : exclusion_;
  }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, getSessionInclusionCriteria());
    }
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.data.v1alpha.SessionSegment other = (com.google.analytics.data.v1alpha.SessionSegment) obj;

    if (hasSessionInclusionCriteria() != other.hasSessionInclusionCriteria()) return false;
    if (hasSessionInclusionCriteria()) {
      if (!getSessionInclusionCriteria()
          .equals(other.getSessionInclusionCriteria())) return false;
    }
  ...
  public static com.google.analytics.data.v1alpha.SessionSegment parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.analytics.data.v1alpha.SessionSegment parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.analytics.data.v1alpha.SessionSegment result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.sessionInclusionCriteria_ = sessionInclusionCriteriaBuilder_ == null
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getSessionInclusionCriteriaFieldBuilder().getBuilder(),
                  extensionRegistry);
     ...
     * <code>.google.analytics.data.v1alpha.SessionSegmentCriteria session_inclusion_criteria = 1;</code>
     */
    public Builder setSessionInclusionCriteria(com.google.analytics.data.v1alpha.SessionSegmentCriteria value) {
      if (sessionInclusionCriteriaBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.google.analytics.data.v1alpha.SessionSegmentCriteria session_inclusion_criteria = 1;</code>
     */
    public Builder mergeSessionInclusionCriteria(com.google.analytics.data.v1alpha.SessionSegmentCriteria value) {
      if (sessionInclusionCriteriaBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          sessionInclusionCriteria_ != null &&
          sessionInclusionCriteria_ != com.google.analytics.data.v1alpha.SessionSegmentCriteria.getDefaultInstance()) {
     ...
     * <code>.google.analytics.data.v1alpha.SessionSegmentCriteria session_inclusion_criteria = 1;</code>
     */
    public com.google.analytics.data.v1alpha.SessionSegmentCriteria.Builder getSessionInclusionCriteriaBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
    ...
    public com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder getSessionInclusionCriteriaOrBuilder() {
      if (sessionInclusionCriteriaBuilder_ != null) {
        ...
        return sessionInclusionCriteria_ == null ?
            com.google.analytics.data.v1alpha.SessionSegmentCriteria.getDefaultInstance() : sessionInclusionCriteria_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SessionSegmentCriteria, com.google.analytics.data.v1alpha.SessionSegmentCriteria.Builder, com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder> 
        getSessionInclusionCriteriaFieldBuilder() {
      if (sessionInclusionCriteriaBuilder_ == null) {
        sessionInclusionCriteriaBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.SessionSegmentCriteria, com.google.analytics.data.v1alpha.SessionSegmentCriteria.Builder, com.google.analytics.data.v1alpha.SessionSegmentCriteriaOrBuilder>(
    ...
    private com.google.analytics.data.v1alpha.SessionSegmentExclusion exclusion_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SessionSegmentExclusion, com.google.analytics.data.v1alpha.SessionSegmentExclusion.Builder, com.google.analytics.data.v1alpha.SessionSegmentExclusionOrBuilder> exclusionBuilder_;
    /**
     * <pre>
     * Defines which sessions are excluded in this segment. Optional.
     * </pre>
    ...
    public Builder mergeExclusion(com.google.analytics.data.v1alpha.SessionSegmentExclusion value) {
      if (exclusionBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          exclusion_ != null &&
          exclusion_ != com.google.analytics.data.v1alpha.SessionSegmentExclusion.getDefaultInstance()) {
    ...
    public com.google.analytics.data.v1alpha.SessionSegmentExclusionOrBuilder getExclusionOrBuilder() {
      if (exclusionBuilder_ != null) {
        ...
        return exclusion_ == null ?
            com.google.analytics.data.v1alpha.SessionSegmentExclusion.getDefaultInstance() : exclusion_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SessionSegmentExclusion, com.google.analytics.data.v1alpha.SessionSegmentExclusion.Builder, com.google.analytics.data.v1alpha.SessionSegmentExclusionOrBuilder> 
        getExclusionFieldBuilder() {
      if (exclusionBuilder_ == null) {
  ...
  private static final com.google.protobuf.Parser<SessionSegment>
      PARSER = new com.google.protobuf.AbstractParser<SessionSegment>() {
    @java.lang.Override
