...
public interface QueryAudienceListResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.AudienceRow> 
      getAudienceRowsList();
  /**
   * <pre>
   * Rows for each user in an audience list. The number of rows in this
   ...
   * <code>repeated .google.analytics.data.v1alpha.AudienceRow audience_rows = 2;</code>
   */
  com.google.analytics.data.v1alpha.AudienceRowOrBuilder getAudienceRowsOrBuilder(
      int index);
