 ...
 */
public final class SegmentFilterExpression extends
...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 10: {
            com.google.analytics.data.v1alpha.SegmentFilterExpressionList.Builder subBuilder = null;
            if (exprCase_ == 1) {
              subBuilder = ((com.google.analytics.data.v1alpha.SegmentFilterExpressionList) expr_).toBuilder();
            }
            expr_ =
                input.readMessage(com.google.analytics.data.v1alpha.SegmentFilterExpressionList.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.analytics.data.v1alpha.SegmentFilterExpressionList) expr_);
          ...
          case 26: {
            ...
            if (exprCase_ == 3) {
              subBuilder = ((com.google.analytics.data.v1alpha.SegmentFilterExpression) expr_).toBuilder();
            }
            expr_ =
                input.readMessage(com.google.analytics.data.v1alpha.SegmentFilterExpression.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.analytics.data.v1alpha.SegmentFilterExpression) expr_);
              expr_ = subBuilder.buildPartial();
            }
            exprCase_ = 3;
            break;
          ...
          case 34: {
            com.google.analytics.data.v1alpha.SegmentFilter.Builder subBuilder = null;
            if (exprCase_ == 4) {
              subBuilder = ((com.google.analytics.data.v1alpha.SegmentFilter) expr_).toBuilder();
            }
            expr_ =
                input.readMessage(com.google.analytics.data.v1alpha.SegmentFilter.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.analytics.data.v1alpha.SegmentFilter) expr_);
              expr_ = subBuilder.buildPartial();
            }
            exprCase_ = 4;
            break;
          ...
          case 42: {
            com.google.analytics.data.v1alpha.SegmentEventFilter.Builder subBuilder = null;
            if (exprCase_ == 5) {
              subBuilder = ((com.google.analytics.data.v1alpha.SegmentEventFilter) expr_).toBuilder();
            }
            expr_ =
                input.readMessage(com.google.analytics.data.v1alpha.SegmentEventFilter.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.analytics.data.v1alpha.SegmentEventFilter) expr_);
              expr_ = subBuilder.buildPartial();
            }
            exprCase_ = 5;
            break;
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_SegmentFilterExpression_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.analytics.data.v1alpha.ReportingApiProto.internal_static_google_analytics_data_v1alpha_SegmentFilterExpression_fieldAccessorTable
        .ensureFieldAccessorsInitialized(
            com.google.analytics.data.v1alpha.SegmentFilterExpression.class, com.google.analytics.data.v1alpha.SegmentFilterExpression.Builder.class);
  }
  ...
  public enum ExprCase
    ...
    public static ExprCase forNumber(int value) {
      switch (value) {
        ...
        case 4: return SEGMENT_FILTER;
        case 5: return SEGMENT_EVENT_FILTER;
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.SegmentFilterExpressionListOrBuilder getAndGroupOrBuilder() {
    if (exprCase_ == 1) {
       return (com.google.analytics.data.v1alpha.SegmentFilterExpressionList) expr_;
    }
    return com.google.analytics.data.v1alpha.SegmentFilterExpressionList.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.SegmentFilterExpressionListOrBuilder getOrGroupOrBuilder() {
    if (exprCase_ == 2) {
       return (com.google.analytics.data.v1alpha.SegmentFilterExpressionList) expr_;
    }
    return com.google.analytics.data.v1alpha.SegmentFilterExpressionList.getDefaultInstance();
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.SegmentFilterExpressionOrBuilder getNotExpressionOrBuilder() {
    if (exprCase_ == 3) {
       return (com.google.analytics.data.v1alpha.SegmentFilterExpression) expr_;
    }
    return com.google.analytics.data.v1alpha.SegmentFilterExpression.getDefaultInstance();
  ...
  public static final class Builder extends
    ...
    public com.google.analytics.data.v1alpha.SegmentFilterExpression buildPartial() {
      com.google.analytics.data.v1alpha.SegmentFilterExpression result = new com.google.analytics.data.v1alpha.SegmentFilterExpression(this);
      if (exprCase_ == 1) {
    ...
    public Builder mergeFrom(com.google.analytics.data.v1alpha.SegmentFilterExpression other) {
      if (other == com.google.analytics.data.v1alpha.SegmentFilterExpression.getDefaultInstance()) return this;
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.analytics.data.v1alpha.SegmentFilterExpression parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.analytics.data.v1alpha.SegmentFilterExpression) e.getUnfinishedMessage();
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SegmentFilterExpressionList, com.google.analytics.data.v1alpha.SegmentFilterExpressionList.Builder, com.google.analytics.data.v1alpha.SegmentFilterExpressionListOrBuilder> andGroupBuilder_;
    /**
     * <pre>
     * The SegmentFilterExpression in `andGroup` have an AND relationship.
     * </pre>
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpressionList and_group = 1;</code>
     */
    public Builder setAndGroup(com.google.analytics.data.v1alpha.SegmentFilterExpressionList value) {
      if (andGroupBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpressionList and_group = 1;</code>
     */
    public Builder mergeAndGroup(com.google.analytics.data.v1alpha.SegmentFilterExpressionList value) {
      if (andGroupBuilder_ == null) {
        if (exprCase_ == 1 &&
            expr_ != com.google.analytics.data.v1alpha.SegmentFilterExpressionList.getDefaultInstance()) {
          expr_ = com.google.analytics.data.v1alpha.SegmentFilterExpressionList.newBuilder((com.google.analytics.data.v1alpha.SegmentFilterExpressionList) expr_)
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpressionList and_group = 1;</code>
     */
    public com.google.analytics.data.v1alpha.SegmentFilterExpressionList.Builder getAndGroupBuilder() {
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SegmentFilterExpressionList, com.google.analytics.data.v1alpha.SegmentFilterExpressionList.Builder, com.google.analytics.data.v1alpha.SegmentFilterExpressionListOrBuilder> 
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SegmentFilterExpressionList, com.google.analytics.data.v1alpha.SegmentFilterExpressionList.Builder, com.google.analytics.data.v1alpha.SegmentFilterExpressionListOrBuilder> orGroupBuilder_;
    /**
     * <pre>
     * The SegmentFilterExpression in `orGroup` have an OR relationship.
     * </pre>
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpressionList or_group = 2;</code>
     */
    public Builder mergeOrGroup(com.google.analytics.data.v1alpha.SegmentFilterExpressionList value) {
      if (orGroupBuilder_ == null) {
        if (exprCase_ == 2 &&
            expr_ != com.google.analytics.data.v1alpha.SegmentFilterExpressionList.getDefaultInstance()) {
          expr_ = com.google.analytics.data.v1alpha.SegmentFilterExpressionList.newBuilder((com.google.analytics.data.v1alpha.SegmentFilterExpressionList) expr_)
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpressionList or_group = 2;</code>
     */
    public com.google.analytics.data.v1alpha.SegmentFilterExpressionList.Builder getOrGroupBuilder() {
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpression not_expression = 3;</code>
     */
    public Builder setNotExpression(com.google.analytics.data.v1alpha.SegmentFilterExpression value) {
      if (notExpressionBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpression not_expression = 3;</code>
     */
    public Builder mergeNotExpression(com.google.analytics.data.v1alpha.SegmentFilterExpression value) {
      if (notExpressionBuilder_ == null) {
        if (exprCase_ == 3 &&
            expr_ != com.google.analytics.data.v1alpha.SegmentFilterExpression.getDefaultInstance()) {
          expr_ = com.google.analytics.data.v1alpha.SegmentFilterExpression.newBuilder((com.google.analytics.data.v1alpha.SegmentFilterExpression) expr_)
              .mergeFrom(value).buildPartial();
        } else {
          expr_ = value;
        }
     ...
     * <code>.google.analytics.data.v1alpha.SegmentFilterExpression not_expression = 3;</code>
     */
    public com.google.analytics.data.v1alpha.SegmentFilterExpression.Builder getNotExpressionBuilder() {
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SegmentFilter, com.google.analytics.data.v1alpha.SegmentFilter.Builder, com.google.analytics.data.v1alpha.SegmentFilterOrBuilder> segmentFilterBuilder_;
    /**
     * <pre>
     * A primitive segment filter.
     * </pre>
    ...
    public Builder mergeSegmentFilter(com.google.analytics.data.v1alpha.SegmentFilter value) {
      if (segmentFilterBuilder_ == null) {
        if (exprCase_ == 4 &&
          ...
          expr_ = com.google.analytics.data.v1alpha.SegmentFilter.newBuilder((com.google.analytics.data.v1alpha.SegmentFilter) expr_)
              .mergeFrom(value).buildPartial();
        } else {
          expr_ = value;
        }
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SegmentFilter, com.google.analytics.data.v1alpha.SegmentFilter.Builder, com.google.analytics.data.v1alpha.SegmentFilterOrBuilder> 
        getSegmentFilterFieldBuilder() {
      if (segmentFilterBuilder_ == null) {
        if (!(exprCase_ == 4)) {
          expr_ = com.google.analytics.data.v1alpha.SegmentFilter.getDefaultInstance();
        }
        segmentFilterBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.SegmentFilter, com.google.analytics.data.v1alpha.SegmentFilter.Builder, com.google.analytics.data.v1alpha.SegmentFilterOrBuilder>(
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.SegmentEventFilter, com.google.analytics.data.v1alpha.SegmentEventFilter.Builder, com.google.analytics.data.v1alpha.SegmentEventFilterOrBuilder> segmentEventFilterBuilder_;
    /**
     * <pre>
     * Creates a filter that matches events of a single event name. If a
     * parameter filter expression is specified, only the subset of events that
  ...
  private static final com.google.protobuf.Parser<SegmentFilterExpression>
      PARSER = new com.google.protobuf.AbstractParser<SegmentFilterExpression>() {
    @java.lang.Override
