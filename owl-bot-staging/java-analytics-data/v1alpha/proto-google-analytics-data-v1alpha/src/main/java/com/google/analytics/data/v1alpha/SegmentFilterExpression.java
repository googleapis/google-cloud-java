...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.analytics.data.v1alpha.SegmentFilterExpression result) {
      ...
      if (exprCase_ == 4 &&
          segmentFilterBuilder_ != null) {
        result.expr_ = segmentFilterBuilder_.build();
      }
      if (exprCase_ == 5 &&
          segmentEventFilterBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getSegmentFilterFieldBuilder().getBuilder(),
                  extensionRegistry);
              exprCase_ = 4;
              break;
            } // case 34
            case 42: {
              input.readMessage(
                  getSegmentEventFilterFieldBuilder().getBuilder(),
                  extensionRegistry);
              exprCase_ = 5;
              break;
            } // case 42
