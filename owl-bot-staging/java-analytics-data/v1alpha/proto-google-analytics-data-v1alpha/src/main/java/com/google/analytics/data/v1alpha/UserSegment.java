...
private static final long serialVersionUID = 0L;
  ...
  public com.google.analytics.data.v1alpha.UserSegmentCriteria getUserInclusionCriteria() {
    return userInclusionCriteria_ == null ? com.google.analytics.data.v1alpha.UserSegmentCriteria.getDefaultInstance() : userInclusionCriteria_;
  }
  /**
   * <pre>
   * Defines which users are included in this segment. Optional.
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.UserSegmentCriteriaOrBuilder getUserInclusionCriteriaOrBuilder() {
    return userInclusionCriteria_ == null ? com.google.analytics.data.v1alpha.UserSegmentCriteria.getDefaultInstance() : userInclusionCriteria_;
  }
  ...
  public com.google.analytics.data.v1alpha.UserSegmentExclusion getExclusion() {
    return exclusion_ == null ? com.google.analytics.data.v1alpha.UserSegmentExclusion.getDefaultInstance() : exclusion_;
  }
  /**
   * <pre>
   * Defines which users are excluded in this segment. Optional.
  ...
  public int getSerializedSize() {
    ...
    if (userInclusionCriteria_ != null) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, getUserInclusionCriteria());
    }
    if (exclusion_ != null) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.data.v1alpha.UserSegment other = (com.google.analytics.data.v1alpha.UserSegment) obj;

    if (hasUserInclusionCriteria() != other.hasUserInclusionCriteria()) return false;
    if (hasUserInclusionCriteria()) {
      if (!getUserInclusionCriteria()
          .equals(other.getUserInclusionCriteria())) return false;
    }
    if (hasExclusion() != other.hasExclusion()) return false;
    if (hasExclusion()) {
      if (!getExclusion()
          .equals(other.getExclusion())) return false;
    }
  ...
  public static com.google.analytics.data.v1alpha.UserSegment parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.analytics.data.v1alpha.UserSegment result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.userInclusionCriteria_ = userInclusionCriteriaBuilder_ == null
            ? userInclusionCriteria_
            : userInclusionCriteriaBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.exclusion_ = exclusionBuilder_ == null
            ? exclusion_
            : exclusionBuilder_.build();
      }
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getUserInclusionCriteriaFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 18: {
              input.readMessage(
                  getExclusionFieldBuilder().getBuilder(),
                  extensionRegistry);
     ...
     * <code>.google.analytics.data.v1alpha.UserSegmentCriteria user_inclusion_criteria = 1;</code>
     */
    public Builder setUserInclusionCriteria(com.google.analytics.data.v1alpha.UserSegmentCriteria value) {
      if (userInclusionCriteriaBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.google.analytics.data.v1alpha.UserSegmentCriteria user_inclusion_criteria = 1;</code>
     */
    public Builder mergeUserInclusionCriteria(com.google.analytics.data.v1alpha.UserSegmentCriteria value) {
      if (userInclusionCriteriaBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          userInclusionCriteria_ != null &&
          userInclusionCriteria_ != com.google.analytics.data.v1alpha.UserSegmentCriteria.getDefaultInstance()) {
     ...
     * <code>.google.analytics.data.v1alpha.UserSegmentCriteria user_inclusion_criteria = 1;</code>
     */
    public com.google.analytics.data.v1alpha.UserSegmentCriteria.Builder getUserInclusionCriteriaBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
    ...
    public com.google.analytics.data.v1alpha.UserSegmentCriteriaOrBuilder getUserInclusionCriteriaOrBuilder() {
      if (userInclusionCriteriaBuilder_ != null) {
        ...
        return userInclusionCriteria_ == null ?
            com.google.analytics.data.v1alpha.UserSegmentCriteria.getDefaultInstance() : userInclusionCriteria_;
      }
    }
    /**
     * <pre>
    ...
    private com.google.protobuf.SingleFieldBuilderV3<
      ...
      if (userInclusionCriteriaBuilder_ == null) {
        userInclusionCriteriaBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.UserSegmentCriteria, com.google.analytics.data.v1alpha.UserSegmentCriteria.Builder, com.google.analytics.data.v1alpha.UserSegmentCriteriaOrBuilder>(
    ...
    public Builder mergeExclusion(com.google.analytics.data.v1alpha.UserSegmentExclusion value) {
      if (exclusionBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          exclusion_ != null &&
          exclusion_ != com.google.analytics.data.v1alpha.UserSegmentExclusion.getDefaultInstance()) {
    ...
    public com.google.analytics.data.v1alpha.UserSegmentExclusionOrBuilder getExclusionOrBuilder() {
      if (exclusionBuilder_ != null) {
        ...
        return exclusion_ == null ?
            com.google.analytics.data.v1alpha.UserSegmentExclusion.getDefaultInstance() : exclusion_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.UserSegmentExclusion, com.google.analytics.data.v1alpha.UserSegmentExclusion.Builder, com.google.analytics.data.v1alpha.UserSegmentExclusionOrBuilder> 
  ...
  private static final com.google.protobuf.Parser<UserSegment>
      PARSER = new com.google.protobuf.AbstractParser<UserSegment>() {
    @java.lang.Override
