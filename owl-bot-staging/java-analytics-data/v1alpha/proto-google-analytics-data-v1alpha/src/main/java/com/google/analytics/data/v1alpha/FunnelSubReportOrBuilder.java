...
public interface FunnelSubReportOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.DimensionHeader> 
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.MetricHeader> 
   ...
   */
  java.util.List<com.google.analytics.data.v1alpha.Row> 
      getRowsList();
  /**
   * <pre>
   * Rows of dimension value combinations and metric values in the report.
   ...
   * <code>repeated .google.analytics.data.v1alpha.Row rows = 3;</code>
   */
  com.google.analytics.data.v1alpha.RowOrBuilder getRowsOrBuilder(
      int index);
