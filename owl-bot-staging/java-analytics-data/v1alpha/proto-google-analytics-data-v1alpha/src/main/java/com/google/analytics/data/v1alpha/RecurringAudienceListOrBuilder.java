...
public interface RecurringAudienceListOrBuilder extends
   ...
   * </pre>
   *
   * <code>string name = 1 [(.google.api.field_behavior) = IDENTIFIER, (.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return The name.
   */
   ...
   * </pre>
   *
   * <code>repeated .google.analytics.data.v1alpha.AudienceDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.analytics.data.v1alpha.AudienceDimension> 
      getDimensionsList();
  /**
   * <pre>
   * Required. The dimensions requested and displayed in the audience list
   ...
   * <code>repeated .google.analytics.data.v1alpha.AudienceDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.analytics.data.v1alpha.AudienceDimensionOrBuilder getDimensionsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>optional int32 active_days_remaining = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>optional .google.analytics.data.v1alpha.WebhookNotification webhook_notification = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
