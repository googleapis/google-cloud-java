...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.analytics.data.v1alpha.FunnelFilterExpression result) {
      ...
      if (exprCase_ == 4 &&
          funnelFieldFilterBuilder_ != null) {
        result.expr_ = funnelFieldFilterBuilder_.build();
      }
      if (exprCase_ == 5 &&
          funnelEventFilterBuilder_ != null) {
