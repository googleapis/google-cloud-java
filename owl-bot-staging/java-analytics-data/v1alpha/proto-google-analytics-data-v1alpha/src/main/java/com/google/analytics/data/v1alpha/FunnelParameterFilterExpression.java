...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.analytics.data.v1alpha.FunnelParameterFilterExpression result) {
      int from_bitField0_ = bitField0_;
    }

    private void buildPartialOneofs(com.google.analytics.data.v1alpha.FunnelParameterFilterExpression result) {
      ...
      if (exprCase_ == 4 &&
          funnelParameterFilterBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getFunnelParameterFilterFieldBuilder().getBuilder(),
                  extensionRegistry);
              exprCase_ = 4;
              break;
            } // case 34
