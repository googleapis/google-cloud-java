...
private static final long serialVersionUID = 0L;
  ...
  public com.google.analytics.data.v1alpha.EventSegmentCriteria getEventInclusionCriteria() {
    return eventInclusionCriteria_ == null ? com.google.analytics.data.v1alpha.EventSegmentCriteria.getDefaultInstance() : eventInclusionCriteria_;
  }
  /**
   * <pre>
   * Defines which events are included in this segment. Optional.
   ...
   */
  @java.lang.Override
  public com.google.analytics.data.v1alpha.EventSegmentCriteriaOrBuilder getEventInclusionCriteriaOrBuilder() {
    return eventInclusionCriteria_ == null ? com.google.analytics.data.v1alpha.EventSegmentCriteria.getDefaultInstance() : eventInclusionCriteria_;
  }
  ...
  public com.google.analytics.data.v1alpha.EventSegmentExclusion getExclusion() {
    return exclusion_ == null ? com.google.analytics.data.v1alpha.EventSegmentExclusion.getDefaultInstance() : exclusion_;
  }
  /**
   * <pre>
   * Defines which events are excluded in this segment. Optional.
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(1, getEventInclusionCriteria());
    }
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.analytics.data.v1alpha.EventSegment other = (com.google.analytics.data.v1alpha.EventSegment) obj;

    if (hasEventInclusionCriteria() != other.hasEventInclusionCriteria()) return false;
    if (hasEventInclusionCriteria()) {
      if (!getEventInclusionCriteria()
          .equals(other.getEventInclusionCriteria())) return false;
    }
  ...
  public static com.google.analytics.data.v1alpha.EventSegment parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.analytics.data.v1alpha.EventSegment result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.eventInclusionCriteria_ = eventInclusionCriteriaBuilder_ == null
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              input.readMessage(
                  getEventInclusionCriteriaFieldBuilder().getBuilder(),
                  extensionRegistry);
     ...
     * <code>.google.analytics.data.v1alpha.EventSegmentCriteria event_inclusion_criteria = 1;</code>
     */
    public Builder setEventInclusionCriteria(com.google.analytics.data.v1alpha.EventSegmentCriteria value) {
      if (eventInclusionCriteriaBuilder_ == null) {
        if (value == null) {
     ...
     * <code>.google.analytics.data.v1alpha.EventSegmentCriteria event_inclusion_criteria = 1;</code>
     */
    public Builder mergeEventInclusionCriteria(com.google.analytics.data.v1alpha.EventSegmentCriteria value) {
      if (eventInclusionCriteriaBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          eventInclusionCriteria_ != null &&
          eventInclusionCriteria_ != com.google.analytics.data.v1alpha.EventSegmentCriteria.getDefaultInstance()) {
     ...
     * <code>.google.analytics.data.v1alpha.EventSegmentCriteria event_inclusion_criteria = 1;</code>
     */
    public com.google.analytics.data.v1alpha.EventSegmentCriteria.Builder getEventInclusionCriteriaBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
    ...
    public com.google.analytics.data.v1alpha.EventSegmentCriteriaOrBuilder getEventInclusionCriteriaOrBuilder() {
      if (eventInclusionCriteriaBuilder_ != null) {
        ...
        return eventInclusionCriteria_ == null ?
            com.google.analytics.data.v1alpha.EventSegmentCriteria.getDefaultInstance() : eventInclusionCriteria_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.EventSegmentCriteria, com.google.analytics.data.v1alpha.EventSegmentCriteria.Builder, com.google.analytics.data.v1alpha.EventSegmentCriteriaOrBuilder> 
        getEventInclusionCriteriaFieldBuilder() {
      if (eventInclusionCriteriaBuilder_ == null) {
        eventInclusionCriteriaBuilder_ = new com.google.protobuf.SingleFieldBuilderV3<
            com.google.analytics.data.v1alpha.EventSegmentCriteria, com.google.analytics.data.v1alpha.EventSegmentCriteria.Builder, com.google.analytics.data.v1alpha.EventSegmentCriteriaOrBuilder>(
    ...
    private com.google.analytics.data.v1alpha.EventSegmentExclusion exclusion_;
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.EventSegmentExclusion, com.google.analytics.data.v1alpha.EventSegmentExclusion.Builder, com.google.analytics.data.v1alpha.EventSegmentExclusionOrBuilder> exclusionBuilder_;
    /**
     * <pre>
     * Defines which events are excluded in this segment. Optional.
     * </pre>
    ...
    public Builder mergeExclusion(com.google.analytics.data.v1alpha.EventSegmentExclusion value) {
      if (exclusionBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          exclusion_ != null &&
          exclusion_ != com.google.analytics.data.v1alpha.EventSegmentExclusion.getDefaultInstance()) {
    ...
    public com.google.analytics.data.v1alpha.EventSegmentExclusionOrBuilder getExclusionOrBuilder() {
      if (exclusionBuilder_ != null) {
        ...
        return exclusion_ == null ?
            com.google.analytics.data.v1alpha.EventSegmentExclusion.getDefaultInstance() : exclusion_;
      }
    }
    /**
     * <pre>
     ...
     */
    private com.google.protobuf.SingleFieldBuilderV3<
        com.google.analytics.data.v1alpha.EventSegmentExclusion, com.google.analytics.data.v1alpha.EventSegmentExclusion.Builder, com.google.analytics.data.v1alpha.EventSegmentExclusionOrBuilder> 
        getExclusionFieldBuilder() {
      if (exclusionBuilder_ == null) {
  ...
  private static final com.google.protobuf.Parser<EventSegment>
      PARSER = new com.google.protobuf.AbstractParser<EventSegment>() {
    @java.lang.Override
