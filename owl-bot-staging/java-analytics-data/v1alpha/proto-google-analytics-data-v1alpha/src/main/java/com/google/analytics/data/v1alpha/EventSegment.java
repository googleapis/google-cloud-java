  ...
  public static final class Builder extends
      ...
      if (eventInclusionCriteriaBuilder_ == null) {
        if (eventInclusionCriteria_ != null) {
          eventInclusionCriteria_ =
            com.google.analytics.data.v1alpha.EventSegmentCriteria.newBuilder(eventInclusionCriteria_).mergeFrom(value).buildPartial();
        } else {
          eventInclusionCriteria_ = value;
        }
        onChanged();
    ...
    public Builder mergeExclusion(com.google.analytics.data.v1alpha.EventSegmentExclusion value) {
      if (exclusionBuilder_ == null) {
        if (exclusion_ != null) {
          exclusion_ =
            com.google.analytics.data.v1alpha.EventSegmentExclusion.newBuilder(exclusion_).mergeFrom(value).buildPartial();
        } else {
          exclusion_ = value;
        }
        onChanged();
