...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              userSequenceSteps_ = new java.util.ArrayList<com.google.analytics.data.v1alpha.UserSequenceStep>();
  ...
  @java.lang.Override public com.google.analytics.data.v1alpha.UserCriteriaScoping getSequenceScoping() {
    ...
    com.google.analytics.data.v1alpha.UserCriteriaScoping result = com.google.analytics.data.v1alpha.UserCriteriaScoping.valueOf(sequenceScoping_);
