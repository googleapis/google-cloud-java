...
public interface AudienceExportOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1beta.AudienceDimension> 
      getDimensionsList();
  /**
   * <pre>
   * Required. The dimensions requested and displayed in the query response.
   ...
   * <code>repeated .google.analytics.data.v1beta.AudienceDimension dimensions = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.analytics.data.v1beta.AudienceDimensionOrBuilder getDimensionsOrBuilder(
      int index);
