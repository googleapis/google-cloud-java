...
public interface MetadataOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1beta.DimensionMetadata> 
      getDimensionsList();
  /**
   * <pre>
   * The dimension descriptions.
   ...
   * <code>repeated .google.analytics.data.v1beta.DimensionMetadata dimensions = 1;</code>
   */
  com.google.analytics.data.v1beta.DimensionMetadataOrBuilder getDimensionsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.analytics.data.v1beta.MetricMetadata> 
      getMetricsList();
  /**
   * <pre>
   * The metric descriptions.
   ...
   * <code>repeated .google.analytics.data.v1beta.MetricMetadata metrics = 2;</code>
   */
  com.google.analytics.data.v1beta.MetricMetadataOrBuilder getMetricsOrBuilder(
      int index);
}
