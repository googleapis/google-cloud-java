...
public interface QueryAudienceExportResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.analytics.data.v1beta.AudienceRow> 
      getAudienceRowsList();
  /**
   * <pre>
   * Rows for each user in an audience export. The number of rows in this
   ...
   * <code>repeated .google.analytics.data.v1beta.AudienceRow audience_rows = 2;</code>
   */
  com.google.analytics.data.v1beta.AudienceRowOrBuilder getAudienceRowsOrBuilder(
      int index);
