...
/**
 * gRPC stub implementation for the ExportService service API.
 *
...
public class GrpcExportServiceStub extends ExportServiceStub {
  ...
  public static final GrpcExportServiceStub create(ExportServiceStubSettings settings)
      throws IOException {
    return new GrpcExportServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcExportServiceStub create(ClientContext clientContext) throws IOException {
    return new GrpcExportServiceStub(ExportServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcExportServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcExportServiceStub(
        ExportServiceStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcExportServiceStub, using the given settings. This is protected so
   * that it is easy to make a subclass, but otherwise, the static factory methods should be
   * preferred.
   */
  protected GrpcExportServiceStub(ExportServiceStubSettings settings, ClientContext clientContext)
      throws IOException {
    this(settings, clientContext, new GrpcExportServiceCallableFactory());
  }
   ...
   * preferred.
   */
  protected GrpcExportServiceStub(
