...
public interface ClusterOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.redis.cluster.v1beta1.Cluster)
   ...
   * </pre>
   *
   * <code>.google.cloud.redis.cluster.v1beta1.Cluster.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.redis.cluster.v1beta1.AuthorizationMode authorization_mode = 11 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.cloud.redis.cluster.v1beta1.AuthorizationMode getAuthorizationMode();
   ...
   * </pre>
   *
   * <code>.google.cloud.redis.cluster.v1beta1.TransitEncryptionMode transit_encryption_mode = 12 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.cloud.redis.cluster.v1beta1.TransitEncryptionMode getTransitEncryptionMode();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.redis.cluster.v1beta1.PscConfig psc_configs = 15 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.cloud.redis.cluster.v1beta1.PscConfig> 
      getPscConfigsList();
  /**
   * <pre>
   * Required. Each PscConfig configures the consumer network where IPs will
   ...
   * <code>repeated .google.cloud.redis.cluster.v1beta1.PscConfig psc_configs = 15 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.redis.cluster.v1beta1.PscConfigOrBuilder getPscConfigsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.redis.cluster.v1beta1.DiscoveryEndpoint discovery_endpoints = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
   ...
   * <code>repeated .google.cloud.redis.cluster.v1beta1.DiscoveryEndpoint discovery_endpoints = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.redis.cluster.v1beta1.DiscoveryEndpointOrBuilder getDiscoveryEndpointsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.redis.cluster.v1beta1.PscConnection psc_connections = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.redis.cluster.v1beta1.PscConnection> 
   ...
   * </pre>
   *
   * <code>.google.cloud.redis.cluster.v1beta1.Cluster.StateInfo state_info = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
