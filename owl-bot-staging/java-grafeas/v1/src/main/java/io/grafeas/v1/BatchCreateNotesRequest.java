...
io.grafeas.v1.Note defaultValue) {
  ...
  public static final class Builder extends
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              ...
              internalGetMutableNotes().ensureBuilderMap().put(
    ...
    private static final class NotesConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, io.grafeas.v1.NoteOrBuilder, io.grafeas.v1.Note> {
      @java.lang.Override
      public io.grafeas.v1.Note build(io.grafeas.v1.NoteOrBuilder val) {
        if (val instanceof io.grafeas.v1.Note) { return (io.grafeas.v1.Note) val; }
        return ((io.grafeas.v1.Note.Builder) val).build();
      }
    ...
    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, io.grafeas.v1.NoteOrBuilder, io.grafeas.v1.Note, io.grafeas.v1.Note.Builder> notes_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, io.grafeas.v1.NoteOrBuilder, io.grafeas.v1.Note, io.grafeas.v1.Note.Builder>
        internalGetNotes() {
      if (notes_ == null) {
...
io.grafeas.v1.Note defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, io.grafeas.v1.NoteOrBuilder> map = internalGetMutableNotes().ensureBuilderMap();
    ...
    public Builder putAllNotes(
      ...
      for (java.util.Map.Entry<java.lang.String, io.grafeas.v1.Note> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .grafeas.v1.Note&gt; notes = 2 [(.google.api.field_behavior) = REQUIRED];</code>
     */
    public io.grafeas.v1.Note.Builder putNotesBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, io.grafeas.v1.NoteOrBuilder> builderMap = internalGetMutableNotes().ensureBuilderMap();
      io.grafeas.v1.NoteOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = io.grafeas.v1.Note.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof io.grafeas.v1.Note) {
        entry = ((io.grafeas.v1.Note) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (io.grafeas.v1.Note.Builder) entry;
    }
    @java.lang.Override
