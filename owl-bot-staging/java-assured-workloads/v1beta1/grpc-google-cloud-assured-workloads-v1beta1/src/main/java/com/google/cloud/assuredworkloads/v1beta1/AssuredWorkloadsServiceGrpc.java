...
public final class AssuredWorkloadsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest,
      com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse> getRestrictAllowedServicesMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest,
      com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse> getRestrictAllowedServicesMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest, com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse> getRestrictAllowedServicesMethod;
    if ((getRestrictAllowedServicesMethod = AssuredWorkloadsServiceGrpc.getRestrictAllowedServicesMethod) == null) {
      synchronized (AssuredWorkloadsServiceGrpc.class) {
        if ((getRestrictAllowedServicesMethod = AssuredWorkloadsServiceGrpc.getRestrictAllowedServicesMethod) == null) {
          AssuredWorkloadsServiceGrpc.getRestrictAllowedServicesMethod = getRestrictAllowedServicesMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest, com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RestrictAllowedServices"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse.getDefaultInstance()))
              .setSchemaDescriptor(new AssuredWorkloadsServiceMethodDescriptorSupplier("RestrictAllowedServices"))
              .build();
        }
      }
    }
  ...
  public static abstract class AssuredWorkloadsServiceImplBase implements io.grpc.BindableService {
     ...
     * </pre>
     */
    public void restrictAllowedServices(com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRestrictAllowedServicesMethod(), responseObserver);
    }
  ...
  public static final class AssuredWorkloadsServiceStub extends io.grpc.stub.AbstractAsyncStub<AssuredWorkloadsServiceStub> {
    ...
    public void restrictAllowedServices(com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getRestrictAllowedServicesMethod(), getCallOptions()), request, responseObserver);
    }
  ...
  public static final class AssuredWorkloadsServiceBlockingStub extends io.grpc.stub.AbstractBlockingStub<AssuredWorkloadsServiceBlockingStub> {
     ...
     * </pre>
     */
    public com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse restrictAllowedServices(com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AssuredWorkloadsServiceFutureStub extends io.grpc.stub.AbstractFutureStub<AssuredWorkloadsServiceFutureStub> {
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse> restrictAllowedServices(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_RESTRICT_ALLOWED_SERVICES:
          serviceImpl.restrictAllowedServices((com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.assuredworkloads.v1beta1.RestrictAllowedServicesResponse>) responseObserver);
          break;
