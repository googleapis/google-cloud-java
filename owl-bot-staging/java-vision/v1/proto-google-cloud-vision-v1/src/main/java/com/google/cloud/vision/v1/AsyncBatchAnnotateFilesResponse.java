...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponse result) {
      if (responsesBuilder_ == null) {
    ...
    private void buildPartial0(com.google.cloud.vision.v1.AsyncBatchAnnotateFilesResponse result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.vision.v1.AsyncAnnotateFileResponse m =
                  input.readMessage(
