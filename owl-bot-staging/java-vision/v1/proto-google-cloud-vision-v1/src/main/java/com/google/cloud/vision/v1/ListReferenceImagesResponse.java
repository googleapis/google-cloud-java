...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.vision.v1.ListReferenceImagesResponse result) {
      if (referenceImagesBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.vision.v1.ReferenceImage m =
                  input.readMessage(
                      com.google.cloud.vision.v1.ReferenceImage.parser(),
                      extensionRegistry);
              if (referenceImagesBuilder_ == null) {
                ensureReferenceImagesIsMutable();
