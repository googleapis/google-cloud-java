...
public interface SafeSearchAnnotationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vision.v1p4beta1.SafeSearchAnnotation)
   ...
   * @return The adult.
   */
  com.google.cloud.vision.v1p4beta1.Likelihood getAdult();
   ...
   * @return The spoof.
   */
  com.google.cloud.vision.v1p4beta1.Likelihood getSpoof();
   ...
   * @return The medical.
   */
  com.google.cloud.vision.v1p4beta1.Likelihood getMedical();
   ...
   * @return The violence.
   */
  com.google.cloud.vision.v1p4beta1.Likelihood getViolence();
   ...
   * @return The racy.
   */
  com.google.cloud.vision.v1p4beta1.Likelihood getRacy();
}
