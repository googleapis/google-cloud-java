...
public final class ProductSearchProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "oud.vision.v1p4beta1.ProductSearchResult" +
      "s.ObjectAnnotationB~\n!com.google.cloud.v" +
      "ision.v1p4beta1B\022ProductSearchProtoP\001Z9c" +
    ...
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchParams_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_ProductSearchParams_descriptor,
        new java.lang.String[] { "BoundingPoly", "ProductSet", "ProductCategories", "Filter", });
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_descriptor,
        new java.lang.String[] { "IndexTime", "Results", "ProductGroupedResults", });
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_Result_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_Result_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_Result_descriptor,
        new java.lang.String[] { "Product", "Score", "Image", });
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_ObjectAnnotation_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_descriptor.getNestedTypes().get(1);
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_ObjectAnnotation_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_ObjectAnnotation_descriptor,
        new java.lang.String[] { "Mid", "LanguageCode", "Name", "Score", });
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_GroupedResult_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_descriptor.getNestedTypes().get(2);
    internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_GroupedResult_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_ProductSearchResults_GroupedResult_descriptor,
