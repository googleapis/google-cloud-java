...
public interface AsyncBatchAnnotateFilesResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.vision.v1p4beta1.AsyncAnnotateFileResponse> 
      getResponsesList();
  /**
   * <pre>
   * The list of file annotation responses, one for each request in
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.AsyncAnnotateFileResponse responses = 1;</code>
   */
  java.util.List<? extends com.google.cloud.vision.v1p4beta1.AsyncAnnotateFileResponseOrBuilder> 
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.AsyncAnnotateFileResponse responses = 1;</code>
   */
  com.google.cloud.vision.v1p4beta1.AsyncAnnotateFileResponseOrBuilder getResponsesOrBuilder(
      int index);
}
