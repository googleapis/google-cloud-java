...
public final class WebDetectionProto {
  ...
  static {
    ...
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_WebDetection_descriptor,
    ...
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebEntity_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_WebDetection_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebEntity_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebEntity_descriptor,
        new java.lang.String[] { "EntityId", "Score", "Description", });
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebImage_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_WebDetection_descriptor.getNestedTypes().get(1);
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebImage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebImage_descriptor,
        new java.lang.String[] { "Url", "Score", });
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebPage_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_WebDetection_descriptor.getNestedTypes().get(2);
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebPage_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebPage_descriptor,
        new java.lang.String[] { "Url", "Score", "PageTitle", "FullMatchingImages", "PartialMatchingImages", });
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebLabel_descriptor =
      internal_static_google_cloud_vision_v1p4beta1_WebDetection_descriptor.getNestedTypes().get(3);
    internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebLabel_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p4beta1_WebDetection_WebLabel_descriptor,
