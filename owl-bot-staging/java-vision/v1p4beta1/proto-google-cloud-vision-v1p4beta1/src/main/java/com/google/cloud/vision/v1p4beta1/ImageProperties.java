      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            dominantColors_ = input.readMessage(com.google.cloud.vision.v1p4beta1.DominantColorsAnnotation.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.vision.v1p4beta1.ImageProperties) e.getUnfinishedMessage();
