...
public interface AnnotateImageRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vision.v1p4beta1.AnnotateImageRequest)
   ...
   */
  java.util.List<com.google.cloud.vision.v1p4beta1.Feature> 
      getFeaturesList();
  /**
   * <pre>
   * Requested features.
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.Feature features = 2;</code>
   */
  com.google.cloud.vision.v1p4beta1.FeatureOrBuilder getFeaturesOrBuilder(
      int index);
