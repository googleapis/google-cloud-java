...
public interface CreateReferenceImageRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vision.v1p4beta1.CreateReferenceImageRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.vision.v1p4beta1.ReferenceImage reference_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.vision.v1p4beta1.ReferenceImage reference_image = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.vision.v1p4beta1.ReferenceImageOrBuilder getReferenceImageOrBuilder();
