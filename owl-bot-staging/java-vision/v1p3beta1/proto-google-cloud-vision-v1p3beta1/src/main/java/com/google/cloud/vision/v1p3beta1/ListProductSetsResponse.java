...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.vision.v1p3beta1.ListProductSetsResponse result) {
      if (productSetsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.vision.v1p3beta1.ProductSet m =
                  input.readMessage(
                      com.google.cloud.vision.v1p3beta1.ProductSet.parser(),
                      extensionRegistry);
              if (productSetsBuilder_ == null) {
                ensureProductSetsIsMutable();
                productSets_.add(m);
