  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (referenceImageBuilder_ != null) {
        referenceImageBuilder_.dispose();
    ...
    private void buildPartial0(com.google.cloud.vision.v1p3beta1.CreateReferenceImageRequest result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.referenceImage_ = referenceImageBuilder_ == null
            ? referenceImage_
            : referenceImageBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18: {
              input.readMessage(
                  getReferenceImageFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public Builder mergeReferenceImage(com.google.cloud.vision.v1p3beta1.ReferenceImage value) {
      if (referenceImageBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          referenceImage_ != null &&
          referenceImage_ != com.google.cloud.vision.v1p3beta1.ReferenceImage.getDefaultInstance()) {
          getReferenceImageBuilder().mergeFrom(value);
        } else {
          referenceImage_ = value;
        }
      } else {
