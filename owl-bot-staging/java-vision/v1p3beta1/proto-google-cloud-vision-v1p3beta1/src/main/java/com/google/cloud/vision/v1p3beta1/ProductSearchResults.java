        ...
        switch (tag) {
          ...
          case 50: {
            if (!((mutable_bitField0_ & 0x00000002) != 0)) {
              productGroupedResults_ = new java.util.ArrayList<com.google.cloud.vision.v1p3beta1.ProductSearchResults.GroupedResult>();
              mutable_bitField0_ |= 0x00000002;
            }
            productGroupedResults_.add(
                input.readMessage(com.google.cloud.vision.v1p3beta1.ProductSearchResults.GroupedResult.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.google.cloud.vision.v1p3beta1.ProductSearchResults.ObjectAnnotation parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.google.cloud.vision.v1p3beta1.ProductSearchResults.ObjectAnnotation) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              if (!((mutable_bitField0_ & 0x00000002) != 0)) {
                objectAnnotations_ = new java.util.ArrayList<com.google.cloud.vision.v1p3beta1.ProductSearchResults.ObjectAnnotation>();
                mutable_bitField0_ |= 0x00000002;
              }
