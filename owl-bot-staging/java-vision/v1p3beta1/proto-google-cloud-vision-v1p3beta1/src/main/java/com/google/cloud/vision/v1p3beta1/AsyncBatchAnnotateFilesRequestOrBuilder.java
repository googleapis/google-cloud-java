...
public interface AsyncBatchAnnotateFilesRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest requests = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
   ...
   * <code>repeated .google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequest requests = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.vision.v1p3beta1.AsyncAnnotateFileRequestOrBuilder getRequestsOrBuilder(
      int index);
}
