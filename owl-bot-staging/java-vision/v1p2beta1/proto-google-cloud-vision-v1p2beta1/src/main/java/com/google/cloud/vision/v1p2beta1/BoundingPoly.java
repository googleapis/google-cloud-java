        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.cloud.vision.v1p2beta1.Vertex m =
                  input.readMessage(
                      com.google.cloud.vision.v1p2beta1.Vertex.parser(),
                      extensionRegistry);
              if (verticesBuilder_ == null) {
                ensureVerticesIsMutable();
                vertices_.add(m);
            ...
            case 18: {
              com.google.cloud.vision.v1p2beta1.NormalizedVertex m =
                  input.readMessage(
                      com.google.cloud.vision.v1p2beta1.NormalizedVertex.parser(),
                      extensionRegistry);
              if (normalizedVerticesBuilder_ == null) {
                ensureNormalizedVerticesIsMutable();
