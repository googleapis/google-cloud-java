...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.vision.v1p1beta1.DominantColorsAnnotation result) {
      if (colorsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.vision.v1p1beta1.ColorInfo m =
                  input.readMessage(
                      com.google.cloud.vision.v1p1beta1.ColorInfo.parser(),
                      extensionRegistry);
              if (colorsBuilder_ == null) {
                ensureColorsIsMutable();
                colors_.add(m);
