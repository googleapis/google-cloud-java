...
public final class EndpointProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "e/protobuf/timestamp.proto\"\246\004\n\010Endpoint\022" +
      ...
      "cedirectory.googleapis.com/Endpoint\022fpro" +
      "jects/{project}/locations/{location}/nam" +
      "espaces/{namespace}/services/{service}/e" +
      "ndpoints/{endpoint}B\365\002\n)com.google.cloud" +
      ".servicedirectory.v1beta1B\rEndpointProto" +
      "P\001ZUcloud.google.com/go/servicedirectory" +
      "/apiv1beta1/servicedirectorypb;servicedi" +
      "rectorypb\370\001\001\252\002%Google.Cloud.ServiceDirec" +
      "tory.V1Beta1\312\002%Google\\Cloud\\ServiceDirec" +
      "tory\\V1beta1\352\002(Google::Cloud::ServiceDir" +
      "ectory::V1beta1\352Aa\n\'servicedirectory.goo" +
      "gleapis.com/Network\0226projects/{project}/" +
      "locations/global/networks/{network}b\006pro" +
      "to3"
    };
