...
private static final long serialVersionUID = 0L;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasTimespanConfig()) {
      if (!getTimespanConfig()
          .equals(other.getTimespanConfig())) return false;
    }
    if (!getTypeCase().equals(other.getTypeCase())) return false;
    switch (typeCase_) {
      case 2:
        if (!getDatastoreOptions()
            .equals(other.getDatastoreOptions())) return false;
        break;
      case 3:
        if (!getCloudStorageOptions()
            .equals(other.getCloudStorageOptions())) return false;
        break;
      case 4:
