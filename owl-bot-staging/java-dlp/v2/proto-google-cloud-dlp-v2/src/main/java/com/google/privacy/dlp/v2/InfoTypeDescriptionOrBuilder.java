...
public interface InfoTypeDescriptionOrBuilder extends
   ...
   */
  java.util.List<com.google.privacy.dlp.v2.VersionDescription> 
      getVersionsList();
  /**
   * <pre>
   * A list of available versions for the infotype.
   ...
   * <code>repeated .google.privacy.dlp.v2.VersionDescription versions = 9;</code>
   */
  com.google.privacy.dlp.v2.VersionDescriptionOrBuilder getVersionsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.privacy.dlp.v2.InfoTypeCategory> 
      getCategoriesList();
  /**
   * <pre>
   * The category of the infoType.
   ...
   * <code>repeated .google.privacy.dlp.v2.InfoTypeCategory categories = 10;</code>
   */
  com.google.privacy.dlp.v2.InfoTypeCategoryOrBuilder getCategoriesOrBuilder(
      int index);
}
