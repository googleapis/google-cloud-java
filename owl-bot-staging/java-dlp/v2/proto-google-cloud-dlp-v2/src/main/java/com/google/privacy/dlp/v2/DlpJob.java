...
private static final long serialVersionUID = 0L;
  ...
  @java.lang.Override public com.google.privacy.dlp.v2.DlpJob.JobState getState() {
    com.google.privacy.dlp.v2.DlpJob.JobState result = com.google.privacy.dlp.v2.DlpJob.JobState.forNumber(state_);
   ...
   */
  @java.lang.Override
  public com.google.privacy.dlp.v2.ActionDetailsOrBuilder getActionDetailsOrBuilder(
      int index) {
    return actionDetails_.get(index);
  }
  ...
  public int getSerializedSize() {
    ...
    for (int i = 0; i < actionDetails_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(12, actionDetails_.get(i));
    }
    if (((bitField0_ & 0x00000008) != 0)) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(15, getLastModified());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getActionDetailsList()
        .equals(other.getActionDetailsList())) return false;
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.privacy.dlp.v2.DlpJob result) {
      ...
      if (detailsCase_ == 4 &&
          riskDetailsBuilder_ != null) {
        result.details_ = riskDetailsBuilder_.build();
      }
      if (detailsCase_ == 5 &&
          inspectDetailsBuilder_ != null) {
        ...
        if (!other.actionDetails_.isEmpty()) {
          if (actionDetailsBuilder_.isEmpty()) {
            ...
            actionDetailsBuilder_ = 
              com.google.protobuf.GeneratedMessageV3.alwaysUseFieldBuilders ?
                 getActionDetailsFieldBuilder() : null;
          } else {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34: {
              input.readMessage(
                  getRiskDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 4;
              break;
            } // case 34
            case 42: {
              input.readMessage(
                  getInspectDetailsFieldBuilder().getBuilder(),
                  extensionRegistry);
              detailsCase_ = 5;
              break;
            } // case 42
            ...
            case 98: {
              com.google.privacy.dlp.v2.ActionDetails m =
                  input.readMessage(
                      com.google.privacy.dlp.v2.ActionDetails.parser(),
                      extensionRegistry);
              if (actionDetailsBuilder_ == null) {
                ensureActionDetailsIsMutable();
    ...
    private void ensureActionDetailsIsMutable() {
      if (!((bitField0_ & 0x00000800) != 0)) {
        actionDetails_ = new java.util.ArrayList<com.google.privacy.dlp.v2.ActionDetails>(actionDetails_);
        bitField0_ |= 0x00000800;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.privacy.dlp.v2.ActionDetails, com.google.privacy.dlp.v2.ActionDetails.Builder, com.google.privacy.dlp.v2.ActionDetailsOrBuilder> actionDetailsBuilder_;
    ...
    public Builder setActionDetails(
        int index, com.google.privacy.dlp.v2.ActionDetails value) {
      if (actionDetailsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.privacy.dlp.v2.ActionDetails action_details = 12;</code>
     */
    public com.google.privacy.dlp.v2.ActionDetails.Builder getActionDetailsBuilder(
        int index) {
    ...
    public com.google.privacy.dlp.v2.ActionDetailsOrBuilder getActionDetailsOrBuilder(
        int index) {
      if (actionDetailsBuilder_ == null) {
        return actionDetails_.get(index);  } else {
    ...
    public com.google.privacy.dlp.v2.ActionDetails.Builder addActionDetailsBuilder() {
      return getActionDetailsFieldBuilder().addBuilder(
          com.google.privacy.dlp.v2.ActionDetails.getDefaultInstance());
    }
    /**
     * <pre>
     * Events that should occur after the job has completed.
    ...
    public com.google.privacy.dlp.v2.ActionDetails.Builder addActionDetailsBuilder(
        int index) {
      return getActionDetailsFieldBuilder().addBuilder(
          index, com.google.privacy.dlp.v2.ActionDetails.getDefaultInstance());
    }
    /**
     * <pre>
     * Events that should occur after the job has completed.
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.privacy.dlp.v2.ActionDetails, com.google.privacy.dlp.v2.ActionDetails.Builder, com.google.privacy.dlp.v2.ActionDetailsOrBuilder> 
        getActionDetailsFieldBuilder() {
      if (actionDetailsBuilder_ == null) {
        actionDetailsBuilder_ = new com.google.protobuf.RepeatedFieldBuilderV3<
            com.google.privacy.dlp.v2.ActionDetails, com.google.privacy.dlp.v2.ActionDetails.Builder, com.google.privacy.dlp.v2.ActionDetailsOrBuilder>(
                actionDetails_,
