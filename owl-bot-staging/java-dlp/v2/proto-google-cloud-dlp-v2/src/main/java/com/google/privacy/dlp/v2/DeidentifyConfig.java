        ...
        switch (tag) {
          ...
          case 34: {
            ...
            if (transformationCase_ == 4) {
              subBuilder = ((com.google.privacy.dlp.v2.ImageTransformations) transformation_).toBuilder();
            }
            transformation_ =
                input.readMessage(com.google.privacy.dlp.v2.ImageTransformations.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.privacy.dlp.v2.ImageTransformations) transformation_);
              transformation_ = subBuilder.buildPartial();
            }
