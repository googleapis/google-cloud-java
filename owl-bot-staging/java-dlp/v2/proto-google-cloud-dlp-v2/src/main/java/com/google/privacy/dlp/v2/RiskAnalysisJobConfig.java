...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.privacy.dlp.v2.RiskAnalysisJobConfig result) {
      if (actionsBuilder_ == null) {
    ...
    private void buildPartial0(com.google.privacy.dlp.v2.RiskAnalysisJobConfig result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.privacyMetric_ = privacyMetricBuilder_ == null
            ? privacyMetric_
            : privacyMetricBuilder_.build();
      }
