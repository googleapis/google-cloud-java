...
public interface DiscoveryConfigOrBuilder extends
   ...
   */
  java.util.List<com.google.privacy.dlp.v2.DataProfileAction> 
      getActionsList();
  /**
   * <pre>
   * Actions to execute at the completion of scanning.
   ...
   * <code>repeated .google.privacy.dlp.v2.DataProfileAction actions = 4;</code>
   */
  com.google.privacy.dlp.v2.DataProfileActionOrBuilder getActionsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.privacy.dlp.v2.DiscoveryTarget> 
      getTargetsList();
  /**
   * <pre>
   * Target to match against for determining what to scan and how frequently.
   ...
   * <code>repeated .google.privacy.dlp.v2.DiscoveryTarget targets = 5;</code>
   */
  com.google.privacy.dlp.v2.DiscoveryTargetOrBuilder getTargetsOrBuilder(
      int index);
