      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            if (typeCase_ == 1) {
              subBuilder = ((com.google.privacy.dlp.v2.LargeCustomDictionaryStats) type_).toBuilder();
            }
            type_ =
                input.readMessage(com.google.privacy.dlp.v2.LargeCustomDictionaryStats.parser(), extensionRegistry);
            if (subBuilder != null) {
