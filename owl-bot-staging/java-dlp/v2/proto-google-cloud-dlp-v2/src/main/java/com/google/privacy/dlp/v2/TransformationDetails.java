        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              transformation_ = new java.util.ArrayList<com.google.privacy.dlp.v2.TransformationDescription>();
      ...
      if (transformationLocationBuilder_ == null) {
        if (transformationLocation_ != null) {
          transformationLocation_ =
            com.google.privacy.dlp.v2.TransformationLocation.newBuilder(transformationLocation_).mergeFrom(value).buildPartial();
        } else {
          transformationLocation_ = value;
        }
        onChanged();
