...
public class DataPolicyServiceStubSettings extends StubSettings<DataPolicyServiceStubSettings> {
  ...
  /** Returns the object with the settings used for calls to renameDataPolicy. */
  public UnaryCallSettings<RenameDataPolicyRequest, DataPolicy> renameDataPolicySettings() {
    return renameDataPolicySettings;
  }
  ...
  protected DataPolicyServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    renameDataPolicySettings = settingsBuilder.renameDataPolicySettings().build();
  ...
  public static class Builder extends StubSettings.Builder<DataPolicyServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<RenameDataPolicyRequest, DataPolicy>
    ...
    protected Builder(ClientContext clientContext) {
      ...
      renameDataPolicySettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(DataPolicyServiceStubSettings settings) {
      ...
      renameDataPolicySettings = settings.renameDataPolicySettings.toBuilder();
    ...
    /** Returns the builder for the settings used for calls to renameDataPolicy. */
    public UnaryCallSettings.Builder<RenameDataPolicyRequest, DataPolicy>
        renameDataPolicySettings() {
      return renameDataPolicySettings;
    }
