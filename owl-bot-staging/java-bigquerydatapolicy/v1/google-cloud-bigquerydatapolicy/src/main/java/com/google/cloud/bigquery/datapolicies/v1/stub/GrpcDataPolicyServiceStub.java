...
public class GrpcDataPolicyServiceStub extends DataPolicyServiceStub {
  ...
  private static final MethodDescriptor<RenameDataPolicyRequest, DataPolicy>
      renameDataPolicyMethodDescriptor =
          MethodDescriptor.<RenameDataPolicyRequest, DataPolicy>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
  ...
  protected GrpcDataPolicyServiceStub(
    ...
    GrpcCallSettings<UpdateDataPolicyRequest, DataPolicy> updateDataPolicyTransportSettings =
        GrpcCallSettings.<UpdateDataPolicyRequest, DataPolicy>newBuilder()
            ...
            .build();
    GrpcCallSettings<RenameDataPolicyRequest, DataPolicy> renameDataPolicyTransportSettings =
        GrpcCallSettings.<RenameDataPolicyRequest, DataPolicy>newBuilder()
