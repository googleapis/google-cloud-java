...
public interface ListDataPoliciesResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.bigquery.datapolicies.v1.DataPolicy> 
      getDataPoliciesList();
  /**
   * <pre>
   * Data policies that belong to the requested project.
   ...
   * <code>repeated .google.cloud.bigquery.datapolicies.v1.DataPolicy data_policies = 1;</code>
   */
  com.google.cloud.bigquery.datapolicies.v1.DataPolicyOrBuilder getDataPoliciesOrBuilder(
      int index);
