...
public class AnnotationName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_ANNOTATION =
  ...
  public static AnnotationName of(String project, String location, String annotation) {
    return newBuilder().setProject(project).setLocation(location).setAnnotation(annotation).build();
  }

  public static String format(String project, String location, String annotation) {
    return newBuilder()
        .setProject(project)
  ...
  public static AnnotationName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_ANNOTATION.validatedMatch(
            formattedString, "AnnotationName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("annotation"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_ANNOTATION.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_ANNOTATION.instantiate(
        "project", project, "location", location, "annotation", annotation);
  }
