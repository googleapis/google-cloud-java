...
public interface PolicySpecOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.orgpolicy.v2.PolicySpec.PolicyRule> 
      getRulesList();
  /**
   * <pre>
   * Up to 10 PolicyRules are allowed.
   ...
   * <code>repeated .google.cloud.orgpolicy.v2.PolicySpec.PolicyRule rules = 3;</code>
   */
  com.google.cloud.orgpolicy.v2.PolicySpec.PolicyRuleOrBuilder getRulesOrBuilder(
      int index);
