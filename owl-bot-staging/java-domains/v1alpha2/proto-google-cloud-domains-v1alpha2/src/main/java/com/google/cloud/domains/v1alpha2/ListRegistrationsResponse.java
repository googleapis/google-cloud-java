...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.domains.v1alpha2.ListRegistrationsResponse result) {
      if (registrationsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.domains.v1alpha2.Registration m =
                  input.readMessage(
                      com.google.cloud.domains.v1alpha2.Registration.parser(),
                      extensionRegistry);
              if (registrationsBuilder_ == null) {
                ensureRegistrationsIsMutable();
