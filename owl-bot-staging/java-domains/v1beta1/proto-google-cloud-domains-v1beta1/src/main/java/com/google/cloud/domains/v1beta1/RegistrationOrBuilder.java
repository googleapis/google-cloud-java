...
public interface RegistrationOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.domains.v1beta1.Registration)
   ...
   * </pre>
   *
   * <code>string domain_name = 2 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp expire_time = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.domains.v1beta1.Registration.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * @return The state.
   */
  com.google.cloud.domains.v1beta1.Registration.State getState();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.domains.v1beta1.Registration.Issue issues = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return A list containing the issues.
   */
  java.util.List<com.google.cloud.domains.v1beta1.Registration.Issue> getIssuesList();
  /**
   * <pre>
   * Output only. The set of issues with the `Registration` that require attention.
   * </pre>
   ...
   */
  com.google.cloud.domains.v1beta1.Registration.Issue getIssues(int index);
  /**
   * <pre>
   * Output only. The set of issues with the `Registration` that require attention.
   * </pre>
...
java.lang.String defaultValue);
   ...
   * </pre>
   *
   * <code>.google.cloud.domains.v1beta1.ContactSettings contact_settings = 12 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   */
  com.google.cloud.domains.v1beta1.ContactSettings getContactSettings();
  /**
   * <pre>
   * Required. Settings for contact information linked to the `Registration`. You cannot
   * update these with the `UpdateRegistration` method. To update these
   ...
   * <code>.google.cloud.domains.v1beta1.ContactSettings contact_settings = 12 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.domains.v1beta1.ContactSettingsOrBuilder getContactSettingsOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.domains.v1beta1.ContactSettings pending_contact_settings = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.domains.v1beta1.ContactSettings getPendingContactSettings();
  /**
   * <pre>
   * Output only. Pending contact settings for the `Registration`. Updates to the
   * `contact_settings` field that change its `registrant_contact` or `privacy`
   ...
   * <code>.google.cloud.domains.v1beta1.ContactSettings pending_contact_settings = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.domains.v1beta1.ContactSettingsOrBuilder getPendingContactSettingsOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.domains.v1beta1.ContactPrivacy supported_privacy = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
