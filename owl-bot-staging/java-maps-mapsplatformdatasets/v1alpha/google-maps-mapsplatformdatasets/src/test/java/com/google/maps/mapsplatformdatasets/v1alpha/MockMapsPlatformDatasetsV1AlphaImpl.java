...
import com.google.maps.mapsplatformdatasets.v1alpha.MapsPlatformDatasetsV1AlphaGrpc.MapsPlatformDatasetsV1AlphaImplBase;
...
public class MockMapsPlatformDatasetsV1AlphaImpl extends MapsPlatformDatasetsV1AlphaImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockMapsPlatformDatasetsV1AlphaImpl() {
  ...
  public void deleteDatasetVersion(
      DeleteDatasetVersionRequest request, StreamObserver<Empty> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Empty) {
      requests.add(request);
      responseObserver.onNext(((Empty) response));
