  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.api.ClientLibrarySettings result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        result.javaSettings_ = javaSettingsBuilder_ == null
            ? javaSettings_
            : javaSettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000010) != 0)) {
        result.cppSettings_ = cppSettingsBuilder_ == null
            ? cppSettings_
            : cppSettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000020) != 0)) {
        result.phpSettings_ = phpSettingsBuilder_ == null
            ? phpSettings_
            : phpSettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000040) != 0)) {
        result.pythonSettings_ = pythonSettingsBuilder_ == null
            ? pythonSettings_
            : pythonSettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000080) != 0)) {
        result.nodeSettings_ = nodeSettingsBuilder_ == null
            ? nodeSettings_
            : nodeSettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000100) != 0)) {
        result.dotnetSettings_ = dotnetSettingsBuilder_ == null
            ? dotnetSettings_
            : dotnetSettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000200) != 0)) {
        result.rubySettings_ = rubySettingsBuilder_ == null
            ? rubySettings_
            : rubySettingsBuilder_.build();
      }
      if (((from_bitField0_ & 0x00000400) != 0)) {
        result.goSettings_ = goSettingsBuilder_ == null
            ? goSettings_
            : goSettingsBuilder_.build();
      }
    }
