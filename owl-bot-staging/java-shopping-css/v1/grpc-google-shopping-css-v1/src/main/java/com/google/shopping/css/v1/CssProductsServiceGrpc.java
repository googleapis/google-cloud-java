...
public final class CssProductsServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.shopping.css.v1.GetCssProductRequest,
      com.google.shopping.css.v1.CssProduct> getGetCssProductMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.shopping.css.v1.GetCssProductRequest,
      com.google.shopping.css.v1.CssProduct> getGetCssProductMethod() {
    io.grpc.MethodDescriptor<com.google.shopping.css.v1.GetCssProductRequest, com.google.shopping.css.v1.CssProduct> getGetCssProductMethod;
    if ((getGetCssProductMethod = CssProductsServiceGrpc.getGetCssProductMethod) == null) {
      synchronized (CssProductsServiceGrpc.class) {
        if ((getGetCssProductMethod = CssProductsServiceGrpc.getGetCssProductMethod) == null) {
          CssProductsServiceGrpc.getGetCssProductMethod = getGetCssProductMethod =
              io.grpc.MethodDescriptor.<com.google.shopping.css.v1.GetCssProductRequest, com.google.shopping.css.v1.CssProduct>newBuilder()
              ...
              .setSchemaDescriptor(new CssProductsServiceMethodDescriptorSupplier("GetCssProduct"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.shopping.css.v1.ListCssProductsRequest,
      com.google.shopping.css.v1.ListCssProductsResponse> getListCssProductsMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.shopping.css.v1.ListCssProductsRequest,
      com.google.shopping.css.v1.ListCssProductsResponse> getListCssProductsMethod() {
    io.grpc.MethodDescriptor<com.google.shopping.css.v1.ListCssProductsRequest, com.google.shopping.css.v1.ListCssProductsResponse> getListCssProductsMethod;
    if ((getListCssProductsMethod = CssProductsServiceGrpc.getListCssProductsMethod) == null) {
      synchronized (CssProductsServiceGrpc.class) {
        if ((getListCssProductsMethod = CssProductsServiceGrpc.getListCssProductsMethod) == null) {
          CssProductsServiceGrpc.getListCssProductsMethod = getListCssProductsMethod =
              io.grpc.MethodDescriptor.<com.google.shopping.css.v1.ListCssProductsRequest, com.google.shopping.css.v1.ListCssProductsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListCssProducts"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.shopping.css.v1.ListCssProductsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.shopping.css.v1.ListCssProductsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new CssProductsServiceMethodDescriptorSupplier("ListCssProducts"))
              .build();
        }
      }
    }
  ...
  public static CssProductsServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CssProductsServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CssProductsServiceStub>() {
        @java.lang.Override
        public CssProductsServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static CssProductsServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<CssProductsServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CssProductsServiceBlockingStub>() {
        @java.lang.Override
        public CssProductsServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static CssProductsServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CssProductsServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<CssProductsServiceFutureStub>() {
        @java.lang.Override
        public CssProductsServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getCssProduct(com.google.shopping.css.v1.GetCssProductRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.css.v1.CssProduct> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetCssProductMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void listCssProducts(com.google.shopping.css.v1.ListCssProductsRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.css.v1.ListCssProductsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListCssProductsMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class CssProductsServiceImplBase
  ...
  public static final class CssProductsServiceStub
    ...
    private CssProductsServiceStub(
     ...
     * </pre>
     */
    public void getCssProduct(com.google.shopping.css.v1.GetCssProductRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.css.v1.CssProduct> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetCssProductMethod(), getCallOptions()), request, responseObserver);
    }
     ...
     * </pre>
     */
    public void listCssProducts(com.google.shopping.css.v1.ListCssProductsRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.css.v1.ListCssProductsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListCssProductsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class CssProductsServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.shopping.css.v1.CssProduct getCssProduct(com.google.shopping.css.v1.GetCssProductRequest request) {
     ...
     * </pre>
     */
    public com.google.shopping.css.v1.ListCssProductsResponse listCssProducts(com.google.shopping.css.v1.ListCssProductsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class CssProductsServiceFutureStub
    ...
    private CssProductsServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.shopping.css.v1.CssProduct> getCssProduct(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.shopping.css.v1.ListCssProductsResponse> listCssProducts(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CSS_PRODUCT:
          serviceImpl.getCssProduct((com.google.shopping.css.v1.GetCssProductRequest) request,
              (io.grpc.stub.StreamObserver<com.google.shopping.css.v1.CssProduct>) responseObserver);
          break;
        case METHODID_LIST_CSS_PRODUCTS:
          serviceImpl.listCssProducts((com.google.shopping.css.v1.ListCssProductsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.shopping.css.v1.ListCssProductsResponse>) responseObserver);
          break;
        default:
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.google.shopping.css.v1.CssProduct>(
                service, METHODID_GET_CSS_PRODUCT)))
        .addMethod(
  ...
  private static abstract class CssProductsServiceBaseDescriptorSupplier
