...
/**
 * Settings class to configure an instance of {@link AccountLabelsServiceClient}.
 *
...
public class AccountLabelsServiceSettings extends ClientSettings<AccountLabelsServiceSettings> {
  ...
  public PagedCallSettings<
    ...
    return ((AccountLabelsServiceStubSettings) getStubSettings()).listAccountLabelsSettings();
  }
  ...
  public UnaryCallSettings<CreateAccountLabelRequest, AccountLabel> createAccountLabelSettings() {
    return ((AccountLabelsServiceStubSettings) getStubSettings()).createAccountLabelSettings();
  }
  ...
  public UnaryCallSettings<UpdateAccountLabelRequest, AccountLabel> updateAccountLabelSettings() {
    return ((AccountLabelsServiceStubSettings) getStubSettings()).updateAccountLabelSettings();
  }
  ...
  public UnaryCallSettings<DeleteAccountLabelRequest, Empty> deleteAccountLabelSettings() {
    return ((AccountLabelsServiceStubSettings) getStubSettings()).deleteAccountLabelSettings();
  }

  public static final AccountLabelsServiceSettings create(AccountLabelsServiceStubSettings stub)
      throws IOException {
    return new AccountLabelsServiceSettings.Builder(stub.toBuilder()).build();
  }
  ...
  public static List<String> getDefaultServiceScopes() {
    return AccountLabelsServiceStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return AccountLabelsServiceStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return AccountLabelsServiceStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return AccountLabelsServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return AccountLabelsServiceStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected AccountLabelsServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for AccountLabelsServiceSettings. */
  public static class Builder
      extends ClientSettings.Builder<AccountLabelsServiceSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(AccountLabelsServiceStubSettings.newBuilder(clientContext));
    }
    ...
    public AccountLabelsServiceStubSettings.Builder getStubSettingsBuilder() {
      return ((AccountLabelsServiceStubSettings.Builder) getStubSettings());
    }
    ...
    public PagedCallSettings.Builder<
            ListAccountLabelsRequest, ListAccountLabelsResponse, ListAccountLabelsPagedResponse>
        listAccountLabelsSettings() {
      return getStubSettingsBuilder().listAccountLabelsSettings();
    }
    ...
    public UnaryCallSettings.Builder<CreateAccountLabelRequest, AccountLabel>
        createAccountLabelSettings() {
      return getStubSettingsBuilder().createAccountLabelSettings();
    }
    ...
    public UnaryCallSettings.Builder<UpdateAccountLabelRequest, AccountLabel>
      ...
      return getStubSettingsBuilder().updateAccountLabelSettings();
    }
    ...
    public UnaryCallSettings.Builder<DeleteAccountLabelRequest, Empty>
      ...
      return getStubSettingsBuilder().deleteAccountLabelSettings();
    }

    @Override
    public AccountLabelsServiceSettings build() throws IOException {
      return new AccountLabelsServiceSettings(this);
    }
  }
}
