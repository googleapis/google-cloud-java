...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.resourcemanager.v3.ListTagKeysResponse result) {
      if (tagKeysBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.resourcemanager.v3.TagKey m =
                  input.readMessage(
                      com.google.cloud.resourcemanager.v3.TagKey.parser(),
                      extensionRegistry);
              if (tagKeysBuilder_ == null) {
                ensureTagKeysIsMutable();
                tagKeys_.add(m);
