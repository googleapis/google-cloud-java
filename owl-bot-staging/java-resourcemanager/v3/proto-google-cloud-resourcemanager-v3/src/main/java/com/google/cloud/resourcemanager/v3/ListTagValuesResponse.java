...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.resourcemanager.v3.ListTagValuesResponse result) {
      if (tagValuesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.resourcemanager.v3.TagValue m =
                  input.readMessage(
                      com.google.cloud.resourcemanager.v3.TagValue.parser(),
                      extensionRegistry);
              if (tagValuesBuilder_ == null) {
                ensureTagValuesIsMutable();
                tagValues_.add(m);
