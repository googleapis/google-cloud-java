...
import com.google.cloud.resourcemanager.v3.FoldersGrpc.FoldersImplBase;
...
public class MockFoldersImpl extends FoldersImplBase {
  ...
  public void searchFolders(
    ...
    if (response instanceof SearchFoldersResponse) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method SearchFolders, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  SearchFoldersResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void updateFolder(
      UpdateFolderRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deleteFolder(
      DeleteFolderRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void undeleteFolder(
      UndeleteFolderRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UndeleteFolder, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
