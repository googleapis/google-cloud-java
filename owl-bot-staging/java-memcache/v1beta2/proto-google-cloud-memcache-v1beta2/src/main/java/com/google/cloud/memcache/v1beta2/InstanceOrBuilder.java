...
public interface InstanceOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.memcache.v1beta2.Instance)
...
java.lang.String defaultValue);
   ...
   * <code>.google.cloud.memcache.v1beta2.Instance.NodeConfig node_config = 7 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.memcache.v1beta2.Instance.NodeConfigOrBuilder getNodeConfigOrBuilder();
   ...
   */
  com.google.cloud.memcache.v1beta2.MemcacheVersion getMemcacheVersion();
   ...
   */
  java.util.List<com.google.cloud.memcache.v1beta2.Instance.Node> 
   ...
   * <code>repeated .google.cloud.memcache.v1beta2.Instance.Node memcache_nodes = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.memcache.v1beta2.Instance.NodeOrBuilder getMemcacheNodesOrBuilder(
      int index);
   ...
   * @return The state.
   */
  com.google.cloud.memcache.v1beta2.Instance.State getState();
   ...
   * <code>repeated .google.cloud.memcache.v1beta2.Instance.InstanceMessage instance_messages = 19;</code>
   */
  com.google.cloud.memcache.v1beta2.Instance.InstanceMessageOrBuilder getInstanceMessagesOrBuilder(
      int index);
