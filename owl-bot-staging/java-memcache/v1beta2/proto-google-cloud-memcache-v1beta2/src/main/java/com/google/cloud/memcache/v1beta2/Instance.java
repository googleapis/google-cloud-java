  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeMaintenancePolicy(com.google.cloud.memcache.v1beta2.MaintenancePolicy value) {
      if (maintenancePolicyBuilder_ == null) {
        if (maintenancePolicy_ != null) {
          maintenancePolicy_ =
            com.google.cloud.memcache.v1beta2.MaintenancePolicy.newBuilder(maintenancePolicy_).mergeFrom(value).buildPartial();
        } else {
          maintenancePolicy_ = value;
        }
        onChanged();
      ...
      if (maintenanceScheduleBuilder_ == null) {
        if (maintenanceSchedule_ != null) {
          maintenanceSchedule_ =
            com.google.cloud.memcache.v1beta2.MaintenanceSchedule.newBuilder(maintenanceSchedule_).mergeFrom(value).buildPartial();
        } else {
          maintenanceSchedule_ = value;
        }
        onChanged();
