...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.memcache.v1beta2.ListInstancesResponse result) {
      if (resourcesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.memcache.v1beta2.Instance m =
                  input.readMessage(
                      com.google.cloud.memcache.v1beta2.Instance.parser(),
                      extensionRegistry);
              if (resourcesBuilder_ == null) {
                ensureResourcesIsMutable();
                resources_.add(m);
