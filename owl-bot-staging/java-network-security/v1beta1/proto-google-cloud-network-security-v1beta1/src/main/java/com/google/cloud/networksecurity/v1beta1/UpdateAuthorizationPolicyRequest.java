...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.networksecurity.v1beta1.UpdateAuthorizationPolicyRequest result) {
    ...
    public Builder mergeAuthorizationPolicy(com.google.cloud.networksecurity.v1beta1.AuthorizationPolicy value) {
      if (authorizationPolicyBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          authorizationPolicy_ != null &&
          authorizationPolicy_ != com.google.cloud.networksecurity.v1beta1.AuthorizationPolicy.getDefaultInstance()) {
