...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.networksecurity.v1beta1.UpdateServerTlsPolicyRequest result) {
    ...
    public Builder mergeServerTlsPolicy(com.google.cloud.networksecurity.v1beta1.ServerTlsPolicy value) {
      if (serverTlsPolicyBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          serverTlsPolicy_ != null &&
          serverTlsPolicy_ != com.google.cloud.networksecurity.v1beta1.ServerTlsPolicy.getDefaultInstance()) {
