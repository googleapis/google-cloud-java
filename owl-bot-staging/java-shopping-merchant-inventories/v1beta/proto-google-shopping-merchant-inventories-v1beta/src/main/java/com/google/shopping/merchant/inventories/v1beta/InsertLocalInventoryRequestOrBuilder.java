...
public interface InsertLocalInventoryRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.shopping.merchant.inventories.v1beta.LocalInventory local_inventory = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.shopping.merchant.inventories.v1beta.LocalInventory local_inventory = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.shopping.merchant.inventories.v1beta.LocalInventoryOrBuilder getLocalInventoryOrBuilder();
}
