...
public interface ScanConfigOrBuilder extends
   ...
   * <code>.google.cloud.websecurityscanner.v1beta.ScanConfig.Authentication authentication = 5;</code>
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.AuthenticationOrBuilder getAuthenticationOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.websecurityscanner.v1beta.ScanConfig.TargetPlatform> getTargetPlatformsList();
  /**
   * <pre>
   * Set of Cloud Platforms targeted by the scan. If empty, APP_ENGINE will be
   * used as a default.
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.TargetPlatform getTargetPlatforms(int index);
  /**
   * <pre>
   * Set of Cloud Platforms targeted by the scan. If empty, APP_ENGINE will be
   * used as a default.
   ...
   */
  com.google.cloud.websecurityscanner.v1beta.ScanConfig.ExportToSecurityCommandCenter getExportToSecurityCommandCenter();
