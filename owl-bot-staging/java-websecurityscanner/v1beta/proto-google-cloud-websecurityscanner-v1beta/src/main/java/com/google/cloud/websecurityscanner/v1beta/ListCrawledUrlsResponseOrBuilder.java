...
public interface ListCrawledUrlsResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.websecurityscanner.v1beta.CrawledUrl> 
      getCrawledUrlsList();
  /**
   * <pre>
   * The list of CrawledUrls returned.
   ...
   * <code>repeated .google.cloud.websecurityscanner.v1beta.CrawledUrl crawled_urls = 1;</code>
   */
  com.google.cloud.websecurityscanner.v1beta.CrawledUrlOrBuilder getCrawledUrlsOrBuilder(
      int index);
