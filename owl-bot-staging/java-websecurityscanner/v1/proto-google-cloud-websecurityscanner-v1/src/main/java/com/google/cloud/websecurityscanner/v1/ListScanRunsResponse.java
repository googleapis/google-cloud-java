...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.websecurityscanner.v1.ListScanRunsResponse result) {
      if (scanRunsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.websecurityscanner.v1.ScanRun m =
                  input.readMessage(
                      com.google.cloud.websecurityscanner.v1.ScanRun.parser(),
                      extensionRegistry);
              if (scanRunsBuilder_ == null) {
                ensureScanRunsIsMutable();
                scanRuns_.add(m);
