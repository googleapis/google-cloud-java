      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 146: {
            ...
            xxe_ = input.readMessage(com.google.cloud.websecurityscanner.v1.Xxe.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeXxe(com.google.cloud.websecurityscanner.v1.Xxe value) {
      if (xxeBuilder_ == null) {
        if (xxe_ != null) {
          xxe_ =
            com.google.cloud.websecurityscanner.v1.Xxe.newBuilder(xxe_).mergeFrom(value).buildPartial();
        } else {
          xxe_ = value;
        }
        onChanged();
