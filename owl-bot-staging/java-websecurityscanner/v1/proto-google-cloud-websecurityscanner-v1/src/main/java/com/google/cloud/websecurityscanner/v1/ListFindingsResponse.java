...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.websecurityscanner.v1.ListFindingsResponse result) {
      if (findingsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.websecurityscanner.v1.Finding m =
                  input.readMessage(
                      com.google.cloud.websecurityscanner.v1.Finding.parser(),
                      extensionRegistry);
              if (findingsBuilder_ == null) {
                ensureFindingsIsMutable();
                findings_.add(m);
