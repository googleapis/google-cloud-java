...
/**
 * Settings class to configure an instance of {@link AnalyticsServiceStub}.
 *
...
public class AnalyticsServiceStubSettings extends StubSettings<AnalyticsServiceStubSettings> {
  ...
  private final UnaryCallSettings<ExportAnalyticsMetricsRequest, Operation>
      exportAnalyticsMetricsSettings;
  ...
  public AnalyticsServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcAnalyticsServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonAnalyticsServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(AnalyticsServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return AnalyticsServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected AnalyticsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends StubSettings.Builder<AnalyticsServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<ExportAnalyticsMetricsRequest, Operation>
        exportAnalyticsMetricsSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      exportAnalyticsMetricsOperationSettings = OperationCallSettings.newBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(exportAnalyticsMetricsSettings);
      initDefaults(this);
    }

    protected Builder(AnalyticsServiceStubSettings settings) {
      super(settings);

      exportAnalyticsMetricsSettings = settings.exportAnalyticsMetricsSettings.toBuilder();
      exportAnalyticsMetricsOperationSettings =
          settings.exportAnalyticsMetricsOperationSettings.toBuilder();
    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setInitialCallSettings(
              UnaryCallSettings
                  .<ExportAnalyticsMetricsRequest, OperationSnapshot>newUnaryCallSettingsBuilder()
                  .setRetryableCodes(RETRYABLE_CODE_DEFINITIONS.get("retry_policy_2_codes"))
                  .setRetrySettings(RETRY_PARAM_DEFINITIONS.get("retry_policy_2_params"))
                  .build())
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.create(
                  ExportAnalyticsMetricsResponse.class))
    ...
    @Override
    public AnalyticsServiceStubSettings build() throws IOException {
      return new AnalyticsServiceStubSettings(this);
    }
  }
}
