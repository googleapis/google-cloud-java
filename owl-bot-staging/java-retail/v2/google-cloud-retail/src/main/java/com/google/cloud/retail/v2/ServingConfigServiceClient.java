...
public class ServingConfigServiceClient implements BackgroundResource {
   ...
   *
   * <p>A maximum of 100 [ServingConfig][google.cloud.retail.v2.ServingConfig]s are allowed in a
   ...
   *     supported:
   *     <ul>
   *       <li> [ServingConfig.name][google.cloud.retail.v2.ServingConfig.name]
   *     </ul>
  ...
  public static class ListServingConfigsPagedResponse
      extends AbstractPagedListResponse<
          ...
          ListServingConfigsPage, ListServingConfigsFixedSizeCollection> {
