      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10: {
            ...
            attributesConfig_ = input.readMessage(com.google.cloud.retail.v2.AttributesConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.retail.v2.UpdateAttributesConfigRequest) e.getUnfinishedMessage();
