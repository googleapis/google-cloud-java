...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.retail.v2.ImportUserEventsResponse result) {
      if (errorSamplesBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)) {
    ...
    public Builder mergeImportSummary(com.google.cloud.retail.v2.UserEventImportSummary value) {
      if (importSummaryBuilder_ == null) {
        if (((bitField0_ & 0x00000004) != 0) &&
          importSummary_ != null &&
          importSummary_ != com.google.cloud.retail.v2.UserEventImportSummary.getDefaultInstance()) {
