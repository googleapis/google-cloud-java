...
public interface SearchResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2.SearchResponse.SearchResult> 
      getResultsList();
  /**
   * <pre>
   * A list of matched items. The order represents the ranking.
   ...
   * <code>repeated .google.cloud.retail.v2.SearchResponse.SearchResult results = 1;</code>
   */
  com.google.cloud.retail.v2.SearchResponse.SearchResultOrBuilder getResultsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.retail.v2.SearchResponse.Facet> 
      getFacetsList();
  /**
   * <pre>
   * Results of facets requested by user.
   ...
   * <code>repeated .google.cloud.retail.v2.SearchResponse.Facet facets = 2;</code>
   */
  com.google.cloud.retail.v2.SearchResponse.FacetOrBuilder getFacetsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec invalid_condition_boost_specs = 14;</code>
   */
  com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec getInvalidConditionBoostSpecs(int index);
  /**
   * <pre>
   * The invalid
   * [SearchRequest.BoostSpec.condition_boost_specs][google.cloud.retail.v2.SearchRequest.BoostSpec.condition_boost_specs]
   ...
   * <code>repeated .google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec invalid_condition_boost_specs = 14;</code>
   */
  java.util.List<? extends com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpecOrBuilder> 
   ...
   * <code>repeated .google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpec invalid_condition_boost_specs = 14;</code>
   */
  com.google.cloud.retail.v2.SearchRequest.BoostSpec.ConditionBoostSpecOrBuilder getInvalidConditionBoostSpecsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.retail.v2.ExperimentInfo> 
   ...
   * <code>repeated .google.cloud.retail.v2.ExperimentInfo experiment_info = 17;</code>
   */
  com.google.cloud.retail.v2.ExperimentInfoOrBuilder getExperimentInfoOrBuilder(
      int index);
}
