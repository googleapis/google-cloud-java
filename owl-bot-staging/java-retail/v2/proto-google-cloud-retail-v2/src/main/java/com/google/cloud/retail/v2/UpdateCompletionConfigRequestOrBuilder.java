...
public interface UpdateCompletionConfigRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2.UpdateCompletionConfigRequest)
   ...
   */
  com.google.cloud.retail.v2.CompletionConfig getCompletionConfig();
  /**
   * <pre>
   * Required. The [CompletionConfig][google.cloud.retail.v2.CompletionConfig]
   * to update.
   ...
   * <code>.google.cloud.retail.v2.CompletionConfig completion_config = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.retail.v2.CompletionConfigOrBuilder getCompletionConfigOrBuilder();
