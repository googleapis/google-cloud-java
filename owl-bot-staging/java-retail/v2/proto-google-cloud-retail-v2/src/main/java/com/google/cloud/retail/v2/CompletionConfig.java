      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42: {
            ...
            suggestionsInputConfig_ = input.readMessage(com.google.cloud.retail.v2.CompletionDataInputConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 58: {
            ...
            denylistInputConfig_ = input.readMessage(com.google.cloud.retail.v2.CompletionDataInputConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 74: {
            ...
            allowlistInputConfig_ = input.readMessage(com.google.cloud.retail.v2.CompletionDataInputConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
