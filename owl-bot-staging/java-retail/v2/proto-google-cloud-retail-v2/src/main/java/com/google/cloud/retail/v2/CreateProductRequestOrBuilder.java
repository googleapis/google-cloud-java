...
public interface CreateProductRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2.CreateProductRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2.Product product = 2 [(.google.api.field_behavior) = REQUIRED];</code>
