...
public interface PriceInfoOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2.PriceInfo.PriceRange price_range = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.retail.v2.PriceInfo.PriceRange getPriceRange();
  /**
   * <pre>
   * Output only. The price range of all the child
   * [Product.Type.VARIANT][google.cloud.retail.v2.Product.Type.VARIANT]
   ...
   * <code>.google.cloud.retail.v2.PriceInfo.PriceRange price_range = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.retail.v2.PriceInfo.PriceRangeOrBuilder getPriceRangeOrBuilder();
}
