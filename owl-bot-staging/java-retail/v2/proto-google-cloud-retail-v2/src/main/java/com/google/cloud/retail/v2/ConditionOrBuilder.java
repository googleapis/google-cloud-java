...
public interface ConditionOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2.Condition.QueryTerm> 
      getQueryTermsList();
  /**
   * <pre>
   * A list (up to 10 entries) of terms to match the query on. If not
   ...
   * <code>repeated .google.cloud.retail.v2.Condition.QueryTerm query_terms = 1;</code>
   */
  com.google.cloud.retail.v2.Condition.QueryTermOrBuilder getQueryTermsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.retail.v2.Condition.TimeRange> 
   ...
   * <code>repeated .google.cloud.retail.v2.Condition.TimeRange active_time_range = 3;</code>
   */
  com.google.cloud.retail.v2.Condition.TimeRangeOrBuilder getActiveTimeRangeOrBuilder(
      int index);
}
