...
public final class CompletionServiceProto {
  ...
  static {
    ...
    internal_static_google_cloud_retail_v2beta_CompleteQueryRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_retail_v2beta_CompleteQueryRequest_descriptor,
        new java.lang.String[] { "Catalog", "Query", "VisitorId", "LanguageCodes", "DeviceType", "Dataset", "MaxSuggestions", "Entity", });
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_descriptor,
        new java.lang.String[] { "CompletionResults", "AttributionToken", "RecentSearchResults", });
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_descriptor =
      internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_descriptor,
        new java.lang.String[] { "Suggestion", "Attributes", });
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_AttributesEntry_descriptor =
      internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_AttributesEntry_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_CompletionResult_AttributesEntry_descriptor,
        new java.lang.String[] { "Key", "Value", });
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_RecentSearchResult_descriptor =
      internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_descriptor.getNestedTypes().get(1);
    internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_RecentSearchResult_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_retail_v2beta_CompleteQueryResponse_RecentSearchResult_descriptor,
