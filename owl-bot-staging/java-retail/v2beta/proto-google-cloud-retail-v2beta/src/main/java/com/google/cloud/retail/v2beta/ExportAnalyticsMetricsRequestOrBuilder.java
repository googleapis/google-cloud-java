...
public interface ExportAnalyticsMetricsRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2beta.OutputConfig output_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
