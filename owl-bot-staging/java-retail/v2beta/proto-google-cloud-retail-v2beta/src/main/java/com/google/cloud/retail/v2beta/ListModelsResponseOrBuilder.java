...
public interface ListModelsResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2beta.Model> 
      getModelsList();
  /**
   * <pre>
   * List of Models.
   ...
   * <code>repeated .google.cloud.retail.v2beta.Model models = 1;</code>
   */
  java.util.List<? extends com.google.cloud.retail.v2beta.ModelOrBuilder> 
   ...
   * <code>repeated .google.cloud.retail.v2beta.Model models = 1;</code>
   */
  com.google.cloud.retail.v2beta.ModelOrBuilder getModelsOrBuilder(
      int index);
