...
public interface ListCatalogsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.retail.v2beta.ListCatalogsResponse)
   ...
   */
  java.util.List<com.google.cloud.retail.v2beta.Catalog> 
      getCatalogsList();
  /**
   * <pre>
   * All the customer's [Catalog][google.cloud.retail.v2beta.Catalog]s.
   ...
   * <code>repeated .google.cloud.retail.v2beta.Catalog catalogs = 1;</code>
   */
  com.google.cloud.retail.v2beta.CatalogOrBuilder getCatalogsOrBuilder(
      int index);
