...
public interface CreateServingConfigRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2beta.ServingConfig serving_config = 2 [(.google.api.field_behavior) = REQUIRED];</code>
