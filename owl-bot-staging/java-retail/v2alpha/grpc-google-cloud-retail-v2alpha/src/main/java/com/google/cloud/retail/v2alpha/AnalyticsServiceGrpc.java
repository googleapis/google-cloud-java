...
public final class AnalyticsServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.retail.v2alpha.AnalyticsService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest,
      com.google.longrunning.Operation> getExportAnalyticsMetricsMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "ExportAnalyticsMetrics",
      requestType = com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest.class,
      responseType = com.google.longrunning.Operation.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest,
      com.google.longrunning.Operation> getExportAnalyticsMetricsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest, com.google.longrunning.Operation> getExportAnalyticsMetricsMethod;
    if ((getExportAnalyticsMetricsMethod = AnalyticsServiceGrpc.getExportAnalyticsMetricsMethod) == null) {
      synchronized (AnalyticsServiceGrpc.class) {
        if ((getExportAnalyticsMetricsMethod = AnalyticsServiceGrpc.getExportAnalyticsMetricsMethod) == null) {
          AnalyticsServiceGrpc.getExportAnalyticsMetricsMethod = getExportAnalyticsMetricsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest, com.google.longrunning.Operation>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ExportAnalyticsMetrics"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.longrunning.Operation.getDefaultInstance()))
              .setSchemaDescriptor(new AnalyticsServiceMethodDescriptorSupplier("ExportAnalyticsMetrics"))
              .build();
        }
      }
    }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void exportAnalyticsMetrics(com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getExportAnalyticsMetricsMethod(), responseObserver);
    }
  }
  ...
  public static final class AnalyticsServiceStub
     ...
     * </pre>
     */
    public void exportAnalyticsMetrics(com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest request,
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getExportAnalyticsMetricsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AnalyticsServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.longrunning.Operation exportAnalyticsMetrics(com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest request) {
  ...
  public static final class AnalyticsServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation> exportAnalyticsMetrics(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EXPORT_ANALYTICS_METRICS:
          serviceImpl.exportAnalyticsMetrics((com.google.cloud.retail.v2alpha.ExportAnalyticsMetricsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.longrunning.Operation>) responseObserver);
          break;
        default:
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.google.longrunning.Operation>(
                service, METHODID_EXPORT_ANALYTICS_METRICS)))
        .build();
  }
  ...
  private static abstract class AnalyticsServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.cloud.retail.v2alpha.AnalyticsServiceProto.getDescriptor();
    }
