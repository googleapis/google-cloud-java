...
public interface PredictResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2alpha.PredictResponse.PredictionResult> 
      getResultsList();
  /**
   * <pre>
   * A list of recommended products. The order represents the ranking (from the
   ...
   * <code>repeated .google.cloud.retail.v2alpha.PredictResponse.PredictionResult results = 1;</code>
   */
  java.util.List<? extends com.google.cloud.retail.v2alpha.PredictResponse.PredictionResultOrBuilder> 
