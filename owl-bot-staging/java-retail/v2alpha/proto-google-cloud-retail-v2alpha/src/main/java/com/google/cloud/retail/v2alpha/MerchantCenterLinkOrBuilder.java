...
public interface MerchantCenterLinkOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.retail.v2alpha.MerchantCenterFeedFilter> 
      getFeedsList();
  /**
   * <pre>
   * Criteria for the Merchant Center feeds to be ingested via the link.
   ...
   * <code>repeated .google.cloud.retail.v2alpha.MerchantCenterFeedFilter feeds = 6;</code>
   */
  com.google.cloud.retail.v2alpha.MerchantCenterFeedFilterOrBuilder getFeedsOrBuilder(
      int index);
}
