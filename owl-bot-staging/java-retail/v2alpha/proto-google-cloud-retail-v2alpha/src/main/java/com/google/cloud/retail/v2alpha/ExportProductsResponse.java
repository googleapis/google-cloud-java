      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            outputResult_ = input.readMessage(com.google.cloud.retail.v2alpha.OutputResult.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeOutputResult(com.google.cloud.retail.v2alpha.OutputResult value) {
      if (outputResultBuilder_ == null) {
        if (outputResult_ != null) {
          outputResult_ =
            com.google.cloud.retail.v2alpha.OutputResult.newBuilder(outputResult_).mergeFrom(value).buildPartial();
        } else {
          outputResult_ = value;
        }
        onChanged();
