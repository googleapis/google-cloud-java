...
public interface CreateMerchantCenterAccountLinkRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.retail.v2alpha.MerchantCenterAccountLink merchant_center_account_link = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.retail.v2alpha.MerchantCenterAccountLink merchant_center_account_link = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.retail.v2alpha.MerchantCenterAccountLinkOrBuilder getMerchantCenterAccountLinkOrBuilder();
}
