...
public interface SearchResponseOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.retail.v2alpha.SearchRequest.BoostSpec.ConditionBoostSpec invalid_condition_boost_specs = 14;</code>
   */
   ...
   * <code>repeated .google.cloud.retail.v2alpha.SearchRequest.BoostSpec.ConditionBoostSpec invalid_condition_boost_specs = 14;</code>
   */
  com.google.cloud.retail.v2alpha.SearchRequest.BoostSpec.ConditionBoostSpec getInvalidConditionBoostSpecs(int index);
  /**
   * <pre>
   * The invalid
   * [SearchRequest.BoostSpec.condition_boost_specs][google.cloud.retail.v2alpha.SearchRequest.BoostSpec.condition_boost_specs]
   ...
   * <code>repeated .google.cloud.retail.v2alpha.SearchRequest.BoostSpec.ConditionBoostSpec invalid_condition_boost_specs = 14;</code>
   */
  com.google.cloud.retail.v2alpha.SearchRequest.BoostSpec.ConditionBoostSpecOrBuilder getInvalidConditionBoostSpecsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.retail.v2alpha.ExperimentInfo> 
   ...
   * <code>repeated .google.cloud.retail.v2alpha.ExperimentInfo experiment_info = 17;</code>
   */
  com.google.cloud.retail.v2alpha.ExperimentInfoOrBuilder getExperimentInfoOrBuilder(
      int index);
}
