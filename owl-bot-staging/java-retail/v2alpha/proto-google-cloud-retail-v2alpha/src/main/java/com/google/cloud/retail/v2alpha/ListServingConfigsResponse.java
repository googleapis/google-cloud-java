        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              servingConfigs_ = new java.util.ArrayList<com.google.cloud.retail.v2alpha.ServingConfig>();
              mutable_bitField0_ |= 0x00000001;
            }
            servingConfigs_.add(
                input.readMessage(com.google.cloud.retail.v2alpha.ServingConfig.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.retail.v2alpha.ListServingConfigsResponse) e.getUnfinishedMessage();
