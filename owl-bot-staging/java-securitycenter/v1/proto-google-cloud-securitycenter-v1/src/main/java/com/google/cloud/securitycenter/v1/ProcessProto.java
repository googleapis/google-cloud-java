...
public final class ProcessProto {
  ...
  static {
    ...
    internal_static_google_cloud_securitycenter_v1_Process_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_securitycenter_v1_Process_descriptor,
        new java.lang.String[] { "Name", "Binary", "Libraries", "Script", "Args", "ArgumentsTruncated", "EnvVariables", "EnvVariablesTruncated", "Pid", "ParentPid", });
    internal_static_google_cloud_securitycenter_v1_EnvironmentVariable_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_securitycenter_v1_EnvironmentVariable_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_securitycenter_v1_EnvironmentVariable_descriptor,
