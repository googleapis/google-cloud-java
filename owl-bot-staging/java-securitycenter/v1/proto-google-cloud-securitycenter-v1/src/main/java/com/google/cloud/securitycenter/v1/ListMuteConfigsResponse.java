...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.securitycenter.v1.ListMuteConfigsResponse result) {
      if (muteConfigsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.securitycenter.v1.MuteConfig m =
                  input.readMessage(
                      com.google.cloud.securitycenter.v1.MuteConfig.parser(),
                      extensionRegistry);
              if (muteConfigsBuilder_ == null) {
                ensureMuteConfigsIsMutable();
                muteConfigs_.add(m);
