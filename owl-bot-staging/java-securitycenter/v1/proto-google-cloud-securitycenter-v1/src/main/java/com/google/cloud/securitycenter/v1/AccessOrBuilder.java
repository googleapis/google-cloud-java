...
public interface AccessOrBuilder extends
   ...
   * <code>repeated .google.cloud.securitycenter.v1.ServiceAccountDelegationInfo service_account_delegation_info = 9;</code>
   */
  com.google.cloud.securitycenter.v1.ServiceAccountDelegationInfo getServiceAccountDelegationInfo(int index);
  /**
   * <pre>
   * Identity delegation history of an authenticated service account that makes
   * the request. It contains information on the real authorities that try to
   ...
   * <code>repeated .google.cloud.securitycenter.v1.ServiceAccountDelegationInfo service_account_delegation_info = 9;</code>
   */
  com.google.cloud.securitycenter.v1.ServiceAccountDelegationInfoOrBuilder getServiceAccountDelegationInfoOrBuilder(
      int index);
