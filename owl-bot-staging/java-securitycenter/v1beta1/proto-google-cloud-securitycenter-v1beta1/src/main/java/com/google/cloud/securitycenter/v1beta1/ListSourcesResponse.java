...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.securitycenter.v1beta1.ListSourcesResponse result) {
      if (sourcesBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.securitycenter.v1beta1.Source m =
                  input.readMessage(
                      com.google.cloud.securitycenter.v1beta1.Source.parser(),
                      extensionRegistry);
              if (sourcesBuilder_ == null) {
                ensureSourcesIsMutable();
                sources_.add(m);
