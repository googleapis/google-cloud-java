...
public interface MitreAttackOrBuilder extends
   ...
   */
  com.google.cloud.securitycenter.v2.MitreAttack.Tactic getPrimaryTactic();
   ...
   */
  java.util.List<com.google.cloud.securitycenter.v2.MitreAttack.Technique> getPrimaryTechniquesList();
  /**
   * <pre>
   * The MITRE ATT&amp;CK technique most closely represented by this finding, if
   * any. primary_techniques is a repeated field because there are multiple
   ...
   */
  com.google.cloud.securitycenter.v2.MitreAttack.Technique getPrimaryTechniques(int index);
  /**
   * <pre>
   * The MITRE ATT&amp;CK technique most closely represented by this finding, if
   * any. primary_techniques is a repeated field because there are multiple
   ...
   */
  java.util.List<com.google.cloud.securitycenter.v2.MitreAttack.Tactic> getAdditionalTacticsList();
  /**
   * <pre>
   * Additional MITRE ATT&amp;CK tactics related to this finding, if any.
   * </pre>
   ...
   */
  com.google.cloud.securitycenter.v2.MitreAttack.Tactic getAdditionalTactics(int index);
  /**
   * <pre>
   * Additional MITRE ATT&amp;CK tactics related to this finding, if any.
   * </pre>
   ...
   */
  java.util.List<com.google.cloud.securitycenter.v2.MitreAttack.Technique> getAdditionalTechniquesList();
  /**
   * <pre>
   * Additional MITRE ATT&amp;CK techniques related to this finding, if any, along
   * with any of their respective parent techniques.
   ...
   */
  com.google.cloud.securitycenter.v2.MitreAttack.Technique getAdditionalTechniques(int index);
  /**
   * <pre>
   * Additional MITRE ATT&amp;CK techniques related to this finding, if any, along
   * with any of their respective parent techniques.
