...
public final class ExfiltrationProto {
  ...
  static {
    ...
    internal_static_google_cloud_securitycenter_v2_Exfiltration_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_securitycenter_v2_Exfiltration_descriptor,
        new java.lang.String[] { "Sources", "Targets", "TotalExfiltratedBytes", });
    internal_static_google_cloud_securitycenter_v2_ExfilResource_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_securitycenter_v2_ExfilResource_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_securitycenter_v2_ExfilResource_descriptor,
