...
public final class ValuedResourceProto {
  ...
  static {
    ...
    internal_static_google_cloud_securitycenter_v2_ValuedResource_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_securitycenter_v2_ValuedResource_descriptor,
        new java.lang.String[] { "Name", "Resource", "ResourceType", "DisplayName", "ResourceValue", "ExposedScore", "ResourceValueConfigsUsed", });
    internal_static_google_cloud_securitycenter_v2_ResourceValueConfigMetadata_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_securitycenter_v2_ResourceValueConfigMetadata_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_securitycenter_v2_ResourceValueConfigMetadata_descriptor,
