      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            if (eventCase_ == 2) {
              subBuilder = ((com.google.cloud.securitycenter.v1p1beta1.Finding) event_).toBuilder();
            }
            event_ =
                input.readMessage(com.google.cloud.securitycenter.v1p1beta1.Finding.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 26: {
            ...
            resource_ = input.readMessage(com.google.cloud.securitycenter.v1p1beta1.Resource.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.securitycenter.v1p1beta1.NotificationMessage) e.getUnfinishedMessage();
