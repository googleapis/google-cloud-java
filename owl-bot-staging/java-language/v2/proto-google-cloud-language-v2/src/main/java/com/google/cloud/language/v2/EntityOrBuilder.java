...
public interface EntityOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.language.v2.Entity)
   ...
   * @return The type.
   */
  com.google.cloud.language.v2.Entity.Type getType();
...
java.lang.String defaultValue);
   ...
   */
  java.util.List<com.google.cloud.language.v2.EntityMention> 
      getMentionsList();
  /**
   * <pre>
   * The mentions of this entity in the input document. The API currently
   ...
   * <code>repeated .google.cloud.language.v2.EntityMention mentions = 5;</code>
   */
  com.google.cloud.language.v2.EntityMentionOrBuilder getMentionsOrBuilder(
      int index);
