      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 82: {
              com.google.cloud.language.v1beta2.ClassificationModelOptions.Builder subBuilder = null;
              if (classificationModelOptions_ != null) {
                subBuilder = classificationModelOptions_.toBuilder();
              }
              classificationModelOptions_ = input.readMessage(com.google.cloud.language.v1beta2.ClassificationModelOptions.parser(), extensionRegistry);
              if (subBuilder != null) {
