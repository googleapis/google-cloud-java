      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 26: {
            ...
            classificationModelOptions_ = input.readMessage(com.google.cloud.language.v1.ClassificationModelOptions.parser(), extensionRegistry);
            if (subBuilder != null) {
      ...
      if (classificationModelOptionsBuilder_ == null) {
        if (classificationModelOptions_ != null) {
          classificationModelOptions_ =
            com.google.cloud.language.v1.ClassificationModelOptions.newBuilder(classificationModelOptions_).mergeFrom(value).buildPartial();
        } else {
          classificationModelOptions_ = value;
        }
        onChanged();
