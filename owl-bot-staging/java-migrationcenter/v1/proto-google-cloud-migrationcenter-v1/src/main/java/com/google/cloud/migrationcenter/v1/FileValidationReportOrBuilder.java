...
public interface FileValidationReportOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.migrationcenter.v1.ImportRowError> 
      getRowErrorsList();
  /**
   * <pre>
   * Partial list of rows that encountered validation error.
   ...
   * <code>repeated .google.cloud.migrationcenter.v1.ImportError file_errors = 4;</code>
   */
  com.google.cloud.migrationcenter.v1.ImportErrorOrBuilder getFileErrorsOrBuilder(
      int index);
}
