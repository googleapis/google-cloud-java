...
public interface WorkloadsConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.DagProcessorResource dag_processor = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   */
  com.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.DagProcessorResource getDagProcessor();
  /**
   * <pre>
   * Optional. Resources used by Airflow DAG processors.
   *
   ...
   * <code>.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.DagProcessorResource dag_processor = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.orchestration.airflow.service.v1beta1.WorkloadsConfig.DagProcessorResourceOrBuilder getDagProcessorOrBuilder();
}
