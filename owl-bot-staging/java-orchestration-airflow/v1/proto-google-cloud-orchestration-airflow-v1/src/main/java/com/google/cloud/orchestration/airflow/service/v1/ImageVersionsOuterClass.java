...
public final class ImageVersionsOuterClass {
  ...
  static {
    ...
    internal_static_google_cloud_orchestration_airflow_service_v1_ListImageVersionsRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_orchestration_airflow_service_v1_ListImageVersionsRequest_descriptor,
        new java.lang.String[] { "Parent", "PageSize", "PageToken", "IncludePastReleases", });
    internal_static_google_cloud_orchestration_airflow_service_v1_ListImageVersionsResponse_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_orchestration_airflow_service_v1_ListImageVersionsResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_orchestration_airflow_service_v1_ListImageVersionsResponse_descriptor,
        new java.lang.String[] { "ImageVersions", "NextPageToken", });
    internal_static_google_cloud_orchestration_airflow_service_v1_ImageVersion_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_orchestration_airflow_service_v1_ImageVersion_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_orchestration_airflow_service_v1_ImageVersion_descriptor,
