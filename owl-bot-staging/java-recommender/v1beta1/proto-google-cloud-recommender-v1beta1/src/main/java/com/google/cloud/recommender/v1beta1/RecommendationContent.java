...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.recommender.v1beta1.RecommendationContent result) {
      if (operationGroupsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 18: {
              com.google.cloud.recommender.v1beta1.OperationGroup m =
                  input.readMessage(
                      com.google.cloud.recommender.v1beta1.OperationGroup.parser(),
                      extensionRegistry);
              if (operationGroupsBuilder_ == null) {
                ensureOperationGroupsIsMutable();
