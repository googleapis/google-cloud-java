...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.recommender.v1beta1.ListInsightsResponse result) {
      if (insightsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.recommender.v1beta1.Insight m =
                  input.readMessage(
                      com.google.cloud.recommender.v1beta1.Insight.parser(),
                      extensionRegistry);
              if (insightsBuilder_ == null) {
                ensureInsightsIsMutable();
                insights_.add(m);
