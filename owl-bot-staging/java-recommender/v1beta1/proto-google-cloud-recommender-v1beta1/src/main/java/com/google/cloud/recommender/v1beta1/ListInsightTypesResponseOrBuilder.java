...
public interface ListInsightTypesResponseOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.recommender.v1beta1.InsightType> 
      getInsightTypesList();
  /**
   * <pre>
   * The set of recommenders available
   ...
   * <code>repeated .google.cloud.recommender.v1beta1.InsightType insight_types = 1;</code>
   */
  com.google.cloud.recommender.v1beta1.InsightTypeOrBuilder getInsightTypesOrBuilder(
      int index);
