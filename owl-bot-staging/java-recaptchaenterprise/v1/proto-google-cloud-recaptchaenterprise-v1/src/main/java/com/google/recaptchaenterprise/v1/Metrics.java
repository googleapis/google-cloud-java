...
private static final long serialVersionUID = 0L;
   ...
   * </pre>
   *
   * <code>string name = 4 [(.google.api.field_behavior) = IDENTIFIER, (.google.api.field_behavior) = OUTPUT_ONLY];</code>
   * @return The name.
   */
  @java.lang.Override
          ...
          switch (tag) {
            ...
            case 18: {
              com.google.recaptchaenterprise.v1.ScoreMetrics m =
                  input.readMessage(
                      com.google.recaptchaenterprise.v1.ScoreMetrics.parser(),
                      extensionRegistry);
              if (scoreMetricsBuilder_ == null) {
                ensureScoreMetricsIsMutable();
                scoreMetrics_.add(m);
