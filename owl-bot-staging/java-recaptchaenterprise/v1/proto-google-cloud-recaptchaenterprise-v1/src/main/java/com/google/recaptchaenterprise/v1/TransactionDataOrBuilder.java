...
public interface TransactionDataOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1.TransactionData.Address shipping_address = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1.TransactionData.Address billing_address = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1.TransactionData.User user = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.recaptchaenterprise.v1.TransactionData.User merchants = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.recaptchaenterprise.v1.TransactionData.User> 
      getMerchantsList();
  /**
   * <pre>
   * Optional. Information about the user or users fulfilling the transaction.
   ...
   * <code>repeated .google.cloud.recaptchaenterprise.v1.TransactionData.User merchants = 13 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.recaptchaenterprise.v1.TransactionData.UserOrBuilder getMerchantsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.recaptchaenterprise.v1.TransactionData.Item items = 14 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.recaptchaenterprise.v1.TransactionData.Item> 
      getItemsList();
  /**
   * <pre>
   * Optional. Items purchased in this transaction.
   ...
   * <code>repeated .google.cloud.recaptchaenterprise.v1.TransactionData.Item items = 14 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.recaptchaenterprise.v1.TransactionData.ItemOrBuilder getItemsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1.TransactionData.GatewayInfo gateway_info = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
