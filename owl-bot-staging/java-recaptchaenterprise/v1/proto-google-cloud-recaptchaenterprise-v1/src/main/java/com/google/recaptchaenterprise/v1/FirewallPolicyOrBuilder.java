...
public interface FirewallPolicyOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.recaptchaenterprise.v1.FirewallAction actions = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.recaptchaenterprise.v1.FirewallAction> 
      getActionsList();
  /**
   * <pre>
   * Optional. The actions that the caller should take regarding user access.
   ...
   * <code>repeated .google.cloud.recaptchaenterprise.v1.FirewallAction actions = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.recaptchaenterprise.v1.FirewallActionOrBuilder getActionsOrBuilder(
      int index);
}
