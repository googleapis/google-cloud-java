...
public interface AnnotateAssessmentRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Annotation annotation = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Reason reasons = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   * @return A list containing the reasons.
   */
  java.util.List<com.google.recaptchaenterprise.v1beta1.AnnotateAssessmentRequest.Reason> getReasonsList();
  /**
   * <pre>
   * Optional. Reasons for the annotation that are assigned to the event.
   * </pre>
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionEvent transaction_event = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
