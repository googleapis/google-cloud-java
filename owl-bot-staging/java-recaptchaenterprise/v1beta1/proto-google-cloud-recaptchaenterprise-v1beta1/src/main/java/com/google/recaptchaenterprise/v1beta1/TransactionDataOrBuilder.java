...
public interface TransactionDataOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.Address shipping_address = 6;</code>
   ...
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.Address shipping_address = 6;</code>
   */
  com.google.recaptchaenterprise.v1beta1.TransactionData.AddressOrBuilder getShippingAddressOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.Address billing_address = 7;</code>
   ...
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.Address billing_address = 7;</code>
   */
  com.google.recaptchaenterprise.v1beta1.TransactionData.AddressOrBuilder getBillingAddressOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.recaptchaenterprise.v1beta1.TransactionData.User merchants = 13;</code>
   */
  java.util.List<com.google.recaptchaenterprise.v1beta1.TransactionData.User> 
      getMerchantsList();
  /**
   * <pre>
   * Information about the user or users fulfilling the transaction.
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.recaptchaenterprise.v1beta1.TransactionData.Item items = 14;</code>
   */
  java.util.List<com.google.recaptchaenterprise.v1beta1.TransactionData.Item> 
      getItemsList();
  /**
   * <pre>
   * Items purchased in this transaction.
   ...
   * <code>repeated .google.cloud.recaptchaenterprise.v1beta1.TransactionData.Item items = 14;</code>
   */
  com.google.recaptchaenterprise.v1beta1.TransactionData.ItemOrBuilder getItemsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.GatewayInfo gateway_info = 10;</code>
   ...
   * <code>.google.cloud.recaptchaenterprise.v1beta1.TransactionData.GatewayInfo gateway_info = 10;</code>
   */
  com.google.recaptchaenterprise.v1beta1.TransactionData.GatewayInfoOrBuilder getGatewayInfoOrBuilder();
}
