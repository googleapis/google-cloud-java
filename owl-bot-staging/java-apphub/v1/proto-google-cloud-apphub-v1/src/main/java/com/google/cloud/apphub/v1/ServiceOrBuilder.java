...
public interface ServiceOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.apphub.v1.ServiceReference service_reference = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.apphub.v1.ServiceProperties service_properties = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.apphub.v1.Attributes attributes = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>string discovered_service = 7 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE, (.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>string uid = 10 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.field_info) = { ... }</code>
   * @return The uid.
   */
   ...
   * </pre>
   *
   * <code>.google.cloud.apphub.v1.Service.State state = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
