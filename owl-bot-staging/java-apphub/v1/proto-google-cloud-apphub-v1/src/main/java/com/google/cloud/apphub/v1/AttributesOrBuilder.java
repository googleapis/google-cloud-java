...
public interface AttributesOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.apphub.v1.ContactInfo> 
   ...
   * <code>repeated .google.cloud.apphub.v1.ContactInfo developer_owners = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.apphub.v1.ContactInfoOrBuilder getDeveloperOwnersOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.apphub.v1.ContactInfo operator_owners = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.apphub.v1.ContactInfoOrBuilder getOperatorOwnersOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.apphub.v1.ContactInfo business_owners = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.apphub.v1.ContactInfoOrBuilder getBusinessOwnersOrBuilder(
      int index);
}
