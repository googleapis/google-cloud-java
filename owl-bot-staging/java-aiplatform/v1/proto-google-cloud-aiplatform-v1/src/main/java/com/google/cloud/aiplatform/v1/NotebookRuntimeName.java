...
public class NotebookRuntimeName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_NOTEBOOK_RUNTIME =
  ...
  private NotebookRuntimeName(Builder builder) {
    ...
    notebookRuntime = Preconditions.checkNotNull(builder.getNotebookRuntime());
  }
  ...
  public static NotebookRuntimeName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_NOTEBOOK_RUNTIME.validatedMatch(
            formattedString, "NotebookRuntimeName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("notebook_runtime"));
  }

  public static List<NotebookRuntimeName> parseList(List<String> formattedStrings) {
    List<NotebookRuntimeName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (notebookRuntime != null) {
            fieldMapBuilder.put("notebook_runtime", notebookRuntime);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_NOTEBOOK_RUNTIME.instantiate(
        "project", project, "location", location, "notebook_runtime", notebookRuntime);
  }
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.notebookRuntime, that.notebookRuntime);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(notebookRuntime);
    return h;
  }
