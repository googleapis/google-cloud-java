      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            customJob_ = input.readMessage(com.google.cloud.aiplatform.v1.CustomJob.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1.CreateCustomJobRequest) e.getUnfinishedMessage();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeCustomJob(com.google.cloud.aiplatform.v1.CustomJob value) {
      if (customJobBuilder_ == null) {
        if (customJob_ != null) {
          customJob_ =
            com.google.cloud.aiplatform.v1.CustomJob.newBuilder(customJob_).mergeFrom(value).buildPartial();
        } else {
          customJob_ = value;
        }
        onChanged();
