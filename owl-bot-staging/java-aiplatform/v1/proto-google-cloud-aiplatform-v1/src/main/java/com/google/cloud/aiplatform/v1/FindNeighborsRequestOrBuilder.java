...
public interface FindNeighborsRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.FindNeighborsRequest.Query> 
      getQueriesList();
  /**
   * <pre>
   * The list of queries.
   ...
   * <code>repeated .google.cloud.aiplatform.v1.FindNeighborsRequest.Query queries = 3;</code>
   */
  com.google.cloud.aiplatform.v1.FindNeighborsRequest.QueryOrBuilder getQueriesOrBuilder(
      int index);
