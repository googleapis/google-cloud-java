        ...
        switch (tag) {
          ...
          case 10: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              trainingPipelines_ = new java.util.ArrayList<com.google.cloud.aiplatform.v1.TrainingPipeline>();
              mutable_bitField0_ |= 0x00000001;
            }
            trainingPipelines_.add(
                input.readMessage(com.google.cloud.aiplatform.v1.TrainingPipeline.parser(), extensionRegistry));
            break;
          }
          case 18: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1.ListTrainingPipelinesResponse) e.getUnfinishedMessage();
