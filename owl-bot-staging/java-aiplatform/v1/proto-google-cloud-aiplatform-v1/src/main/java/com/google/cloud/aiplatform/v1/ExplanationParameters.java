...
private static final long serialVersionUID = 0L;
  ...
  public int getSerializedSize() {
    ...
    if (methodCase_ == 7) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(7, (com.google.cloud.aiplatform.v1.Examples) method_);
    }
    ...
    public Builder mergeExamples(com.google.cloud.aiplatform.v1.Examples value) {
      if (examplesBuilder_ == null) {
        if (methodCase_ == 7 &&
          ...
          method_ = com.google.cloud.aiplatform.v1.Examples.newBuilder((com.google.cloud.aiplatform.v1.Examples) method_)
              .mergeFrom(value).buildPartial();
        } else {
          method_ = value;
        }
