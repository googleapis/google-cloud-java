...
public interface CreateDeploymentResourcePoolRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.CreateDeploymentResourcePoolRequest)
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.DeploymentResourcePool deployment_resource_pool = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.aiplatform.v1.DeploymentResourcePool deployment_resource_pool = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1.DeploymentResourcePoolOrBuilder getDeploymentResourcePoolOrBuilder();
