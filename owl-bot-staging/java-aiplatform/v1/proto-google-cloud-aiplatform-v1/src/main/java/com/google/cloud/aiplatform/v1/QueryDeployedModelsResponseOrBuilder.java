...
public interface QueryDeployedModelsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.QueryDeployedModelsResponse)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.DeployedModel deployed_models = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<com.google.cloud.aiplatform.v1.DeployedModel> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.DeployedModel deployed_models = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.aiplatform.v1.DeployedModel getDeployedModels(int index);
  /**
   * <pre>
   * DEPRECATED Use deployed_model_refs instead.
   * </pre>
   ...
   * <code>repeated .google.cloud.aiplatform.v1.DeployedModel deployed_models = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated java.util.List<? extends com.google.cloud.aiplatform.v1.DeployedModelOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.DeployedModel deployed_models = 1 [deprecated = true];</code>
   */
  @java.lang.Deprecated com.google.cloud.aiplatform.v1.DeployedModelOrBuilder getDeployedModelsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.aiplatform.v1.DeployedModelRef deployed_model_refs = 3;</code>
   */
  com.google.cloud.aiplatform.v1.DeployedModelRefOrBuilder getDeployedModelRefsOrBuilder(
      int index);
