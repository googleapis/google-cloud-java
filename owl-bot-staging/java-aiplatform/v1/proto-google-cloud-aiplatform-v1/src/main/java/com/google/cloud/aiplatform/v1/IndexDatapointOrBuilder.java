...
public interface IndexDatapointOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.IndexDatapoint.Restriction restricts = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1.IndexDatapoint.Restriction> 
      getRestrictsList();
  /**
   * <pre>
   * Optional. List of Restrict of the datapoint, used to perform "restricted
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.IndexDatapoint.NumericRestriction numeric_restricts = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
   ...
   * <code>repeated .google.cloud.aiplatform.v1.IndexDatapoint.NumericRestriction numeric_restricts = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1.IndexDatapoint.NumericRestrictionOrBuilder> 
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.IndexDatapoint.CrowdingTag crowding_tag = 5 [(.google.api.field_behavior) = OPTIONAL];</code>
