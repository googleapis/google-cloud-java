        ...
        switch (tag) {
          ...
          case 26: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              restrictions_ = new java.util.ArrayList<com.google.cloud.aiplatform.v1.ExamplesRestrictionsNamespace>();
              mutable_bitField0_ |= 0x00000001;
            }
            restrictions_.add(
                input.readMessage(com.google.cloud.aiplatform.v1.ExamplesRestrictionsNamespace.parser(), extensionRegistry));
            break;
          }
          case 32: {
