...
private static final long serialVersionUID = 0L;
  ...
  private static final long serialVersionUID = 0L;
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.ContainerDetail result) {
      ...
      private void buildPartial0(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.ContainerDetail result) {
  ...
  public interface CustomJobDetailOrBuilder extends
   ...
   */
  public static final class CustomJobDetail extends
      com.google.protobuf.GeneratedMessageV3 implements
  ...
  private static final long serialVersionUID = 0L;
    ...
    public boolean equals(final java.lang.Object obj) {
      ...
      if (!getFailedJobsList()
          .equals(other.getFailedJobsList())) return false;
      if (!getUnknownFields().equals(other.getUnknownFields())) return false;
      return true;
    }
    ...
    public static final class Builder extends
      ...
      private void buildPartialRepeatedFields(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail result) {
      ...
      private void buildPartial0(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail result) {
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          result.job_ = job_;
        }
      ...
      private com.google.protobuf.LazyStringList failedJobs_ = com.google.protobuf.LazyStringArrayList.EMPTY;
       ...
       * @return This builder for chaining.
       */
      public Builder addAllFailedJobs(
          java.lang.Iterable<java.lang.String> values) {
        ensureFailedJobsIsMutable();
        com.google.protobuf.AbstractMessageLite.Builder.addAll(
            values, failedJobs_);
       ...
       * @return This builder for chaining.
       */
      public Builder addFailedJobsBytes(
          com.google.protobuf.ByteString value) {
        if (value == null) { throw new NullPointerException(); }
        checkByteStringIsUtf8(value);
        ensureFailedJobsIsMutable();
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail custom_job_detail = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  @java.lang.Override
  public com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail getCustomJobDetail() {
    if (detailsCase_ == 2) {
   ...
   */
  @java.lang.Override
  public com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetailOrBuilder getCustomJobDetailOrBuilder() {
    if (detailsCase_ == 2) {
       return (com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail) details_;
    }
    return com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail.getDefaultInstance();
  ...
  public static final class Builder extends
    ...
    private void buildPartialOneofs(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail result) {
     ...
     * <code>.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail custom_job_detail = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public Builder setCustomJobDetail(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail value) {
      if (customJobDetailBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail custom_job_detail = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public Builder mergeCustomJobDetail(com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail value) {
      if (customJobDetailBuilder_ == null) {
        if (detailsCase_ == 2 &&
     ...
     * <code>.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail custom_job_detail = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public com.google.cloud.aiplatform.v1.PipelineTaskExecutorDetail.CustomJobDetail.Builder getCustomJobDetailBuilder() {
