...
public interface ScheduleOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.Schedule)
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.CreatePipelineJobRequest create_pipeline_job_request = 14;</code>
   ...
   * <code>.google.cloud.aiplatform.v1.CreatePipelineJobRequest create_pipeline_job_request = 14;</code>
   */
  com.google.cloud.aiplatform.v1.CreatePipelineJobRequestOrBuilder getCreatePipelineJobRequestOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.Schedule.State state = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.Schedule.RunResponse last_scheduled_run_response = 18 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.aiplatform.v1.Schedule.RunResponse getLastScheduledRunResponse();
  /**
   * <pre>
   * Output only. Response of the last scheduled run.
   * This is the response for starting the scheduled requests and not the
  ...
  com.google.cloud.aiplatform.v1.Schedule.TimeSpecificationCase getTimeSpecificationCase();

  com.google.cloud.aiplatform.v1.Schedule.RequestCase getRequestCase();
}
