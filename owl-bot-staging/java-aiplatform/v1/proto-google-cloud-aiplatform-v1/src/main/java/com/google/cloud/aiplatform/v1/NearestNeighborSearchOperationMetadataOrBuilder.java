...
public interface NearestNeighborSearchOperationMetadataOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStats> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStats content_validation_stats = 1;</code>
   */
  com.google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStats getContentValidationStats(int index);
  /**
   * <pre>
   * The validation stats of the content (per file) to be inserted or
   * updated on the Matching Engine Index resource. Populated if
   ...
   * <code>repeated .google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStats content_validation_stats = 1;</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStatsOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStats content_validation_stats = 1;</code>
   */
  com.google.cloud.aiplatform.v1.NearestNeighborSearchOperationMetadata.ContentValidationStatsOrBuilder getContentValidationStatsOrBuilder(
      int index);
