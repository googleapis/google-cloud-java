...
public interface AutoMlTablesInputsOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.Transformation> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.Transformation transformations = 3;</code>
   */
  com.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.Transformation getTransformations(int index);
  /**
   * <pre>
   * Each transformation will apply transform function to given input column.
   * And the result will be used for training.
   ...
   * <code>repeated .google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.Transformation transformations = 3;</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.TransformationOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.Transformation transformations = 3;</code>
   */
  com.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.TransformationOrBuilder getTransformationsOrBuilder(
      int index);
   ...
   */
  com.google.cloud.aiplatform.v1.schema.trainingjob.definition.ExportEvaluatedDataItemsConfig getExportEvaluatedDataItemsConfig();
  /**
   * <pre>
   * Configuration for exporting test set predictions to a BigQuery table. If
   * this configuration is absent, then the export is not performed.
  ...
  public com.google.cloud.aiplatform.v1.schema.trainingjob.definition.AutoMlTablesInputs.AdditionalOptimizationObjectiveConfigCase getAdditionalOptimizationObjectiveConfigCase();
}
