...
public class IndexName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_INDEX =
  ...
  public static IndexName of(String project, String location, String index) {
    return newBuilder().setProject(project).setLocation(location).setIndex(index).build();
  }
  ...
  public static IndexName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_INDEX.validatedMatch(
            formattedString, "IndexName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("index"));
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_INDEX.instantiate(
