...
public interface TimeSeriesDataOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.TensorboardTimeSeries.ValueType value_type = 2 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.TimeSeriesDataPoint values = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
   ...
   * <code>repeated .google.cloud.aiplatform.v1.TimeSeriesDataPoint values = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1.TimeSeriesDataPointOrBuilder getValuesOrBuilder(
      int index);
}
