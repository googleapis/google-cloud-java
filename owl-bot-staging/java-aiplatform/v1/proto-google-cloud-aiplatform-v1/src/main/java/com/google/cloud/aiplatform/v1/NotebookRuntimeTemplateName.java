...
public class NotebookRuntimeTemplateName implements ResourceName {
  ...
  protected NotebookRuntimeTemplateName() {
    project = null;
    location = null;
    notebookRuntimeTemplate = null;
  }

  private NotebookRuntimeTemplateName(Builder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
    notebookRuntimeTemplate = Preconditions.checkNotNull(builder.getNotebookRuntimeTemplate());
  }
  ...
  public static NotebookRuntimeTemplateName of(
      String project, String location, String notebookRuntimeTemplate) {
    return newBuilder()
        .setProject(project)
  ...
  public static NotebookRuntimeTemplateName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_NOTEBOOK_RUNTIME_TEMPLATE.validatedMatch(
            formattedString,
            "NotebookRuntimeTemplateName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("notebook_runtime_template"));
  }

  public static List<NotebookRuntimeTemplateName> parseList(List<String> formattedStrings) {
    List<NotebookRuntimeTemplateName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (notebookRuntimeTemplate != null) {
            fieldMapBuilder.put("notebook_runtime_template", notebookRuntimeTemplate);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_NOTEBOOK_RUNTIME_TEMPLATE.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.notebookRuntimeTemplate, that.notebookRuntimeTemplate);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(notebookRuntimeTemplate);
    return h;
  }
