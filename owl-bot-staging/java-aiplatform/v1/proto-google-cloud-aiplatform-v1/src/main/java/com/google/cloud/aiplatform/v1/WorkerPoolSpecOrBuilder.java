...
public interface WorkerPoolSpecOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.MachineSpec machine_spec = 1 [(.google.api.field_behavior) = OPTIONAL, (.google.api.field_behavior) = IMMUTABLE];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.NfsMount nfs_mounts = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1.NfsMount> 
      getNfsMountsList();
  /**
   * <pre>
   * Optional. List of NFS mount spec.
   ...
   * <code>repeated .google.cloud.aiplatform.v1.NfsMount nfs_mounts = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1.NfsMountOrBuilder getNfsMountsOrBuilder(
      int index);
