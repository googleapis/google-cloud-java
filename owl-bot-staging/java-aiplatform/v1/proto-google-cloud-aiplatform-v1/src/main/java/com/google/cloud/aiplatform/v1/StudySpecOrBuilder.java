...
public interface StudySpecOrBuilder extends
   ...
   */
  com.google.cloud.aiplatform.v1.StudySpec.DecayCurveAutomatedStoppingSpec getDecayCurveStoppingSpec();
  /**
   * <pre>
   * The automated early stopping spec using decay curve rule.
   * </pre>
   ...
   * <code>.google.cloud.aiplatform.v1.StudySpec.DecayCurveAutomatedStoppingSpec decay_curve_stopping_spec = 4;</code>
   */
  com.google.cloud.aiplatform.v1.StudySpec.DecayCurveAutomatedStoppingSpecOrBuilder getDecayCurveStoppingSpecOrBuilder();
   ...
   * <code>.google.cloud.aiplatform.v1.StudySpec.MedianAutomatedStoppingSpec median_automated_stopping_spec = 5;</code>
   */
  com.google.cloud.aiplatform.v1.StudySpec.MedianAutomatedStoppingSpecOrBuilder getMedianAutomatedStoppingSpecOrBuilder();
   ...
   */
  com.google.cloud.aiplatform.v1.StudySpec.ConvexAutomatedStoppingSpec getConvexAutomatedStoppingSpec();
  /**
   * <pre>
   * The automated early stopping spec using convex stopping rule.
   * </pre>
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.StudySpec.MetricSpec> 
      getMetricsList();
  /**
   * <pre>
   * Required. Metric specs for the Study.
   ...
   * <code>repeated .google.cloud.aiplatform.v1.StudySpec.MetricSpec metrics = 1 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1.StudySpec.MetricSpecOrBuilder getMetricsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.StudySpec.ParameterSpec> 
      getParametersList();
  /**
   * <pre>
   * Required. The set of parameters to tune.
  ...
  public com.google.cloud.aiplatform.v1.StudySpec.AutomatedStoppingSpecCase getAutomatedStoppingSpecCase();
}
