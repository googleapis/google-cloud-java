...
public interface CountTokensRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.CountTokensRequest)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.Content contents = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
   ...
   * <code>repeated .google.cloud.aiplatform.v1.Content contents = 4 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1.ContentOrBuilder getContentsOrBuilder(
      int index);
}
