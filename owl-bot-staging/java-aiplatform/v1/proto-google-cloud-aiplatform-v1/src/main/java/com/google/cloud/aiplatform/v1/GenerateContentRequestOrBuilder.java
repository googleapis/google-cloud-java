...
public interface GenerateContentRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.Content contents = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
   ...
   * </pre>
   *
   * <code>optional .google.cloud.aiplatform.v1.Content system_instruction = 8 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.Tool tools = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1.Tool> 
      getToolsList();
  /**
   * <pre>
   * Optional. A list of `Tools` the model may use to generate the next
   ...
   * <code>repeated .google.cloud.aiplatform.v1.Tool tools = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1.ToolOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.Tool tools = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1.ToolOrBuilder getToolsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1.SafetySetting safety_settings = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1.SafetySetting> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1.SafetySetting safety_settings = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1.SafetySettingOrBuilder getSafetySettingsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1.GenerationConfig generation_config = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
