...
public interface SearchDataItemsRequestOrBuilder extends
   ...
   * <code>.google.cloud.aiplatform.v1.SearchDataItemsRequest.OrderByAnnotation order_by_annotation = 13;</code>
   */
  com.google.cloud.aiplatform.v1.SearchDataItemsRequest.OrderByAnnotationOrBuilder getOrderByAnnotationOrBuilder();
   ...
   */
  @java.lang.Deprecated java.lang.String getSavedQuery();
  /**
   * <pre>
   * The resource name of a SavedQuery(annotation set in UI).
   * Format:
   ...
   */
  @java.lang.Deprecated java.lang.String getAnnotationsFilter();
  /**
   * <pre>
   * An expression for filtering the Annotations that will be returned per
   * DataItem.
   ...
   * @return The orderBy.
   */
  @java.lang.Deprecated java.lang.String getOrderBy();
  /**
   * <pre>
   * A comma-separated list of fields to order by, sorted in ascending order.
   * Use "desc" after a field name for descending.
