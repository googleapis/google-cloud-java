...
import com.google.cloud.aiplatform.v1.stub.MatchServiceStub;
 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the MatchServiceClient object to clean up resources such
 ...
 *    <tr>
 *      <td>FindNeighbors</td>
 *      <td><p>Finds the nearest neighbors of each vector within the request.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>findNeighbors(FindNeighborsRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>findNeighborsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ReadIndexDatapoints</td>
 *      <td><p>Reads the datapoints/vectors of the given IDs.
 *  A maximum of 1000 datapoints can be retrieved in a batch.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>readIndexDatapoints(ReadIndexDatapointsRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>readIndexDatapointsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 ...
 *
 * <p>This class can be customized by passing in a custom instance of MatchServiceSettings to
 * create(). For example:
 *
...
public class MatchServiceClient implements BackgroundResource {
  private final MatchServiceSettings settings;
  private final MatchServiceStub stub;

  /** Constructs an instance of MatchServiceClient with default settings. */
  public static final MatchServiceClient create() throws IOException {
    return create(MatchServiceSettings.newBuilder().build());
  }

  /**
   * Constructs an instance of MatchServiceClient, using the given settings. The channels are
   * created based on the settings passed in, or defaults for any settings that are not set.
   */
  public static final MatchServiceClient create(MatchServiceSettings settings) throws IOException {
    return new MatchServiceClient(settings);
  }

  /**
   * Constructs an instance of MatchServiceClient, using the given stub for making calls. This is
   * for advanced usage - prefer using create(MatchServiceSettings).
   */
  public static final MatchServiceClient create(MatchServiceStub stub) {
    return new MatchServiceClient(stub);
  }

  /**
   * Constructs an instance of MatchServiceClient, using the given settings. This is protected so
   * that it is easy to make a subclass, but otherwise, the static factory methods should be
   * preferred.
   */
  protected MatchServiceClient(MatchServiceSettings settings) throws IOException {
    this.settings = settings;
    this.stub = ((MatchServiceStubSettings) settings.getStubSettings()).createStub();
  }

  protected MatchServiceClient(MatchServiceStub stub) {
    this.settings = null;
    this.stub = stub;
  }

  public final MatchServiceSettings getSettings() {
    return settings;
  }

  public MatchServiceStub getStub() {
    return stub;
  }
  ...
  public final FindNeighborsResponse findNeighbors(FindNeighborsRequest request) {
    return findNeighborsCallable().call(request);
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<FindNeighborsRequest, FindNeighborsResponse> findNeighborsCallable() {
    return stub.findNeighborsCallable();
  }
  ...
  public final ReadIndexDatapointsResponse readIndexDatapoints(ReadIndexDatapointsRequest request) {
    return readIndexDatapointsCallable().call(request);
  }
   ...
   * }</pre>
   */
  public final UnaryCallable<ReadIndexDatapointsRequest, ReadIndexDatapointsResponse>
      readIndexDatapointsCallable() {
    return stub.readIndexDatapointsCallable();
  }
