 ...
 *    <tr>
 *      <td>ReadFeatureValues</td>
 *      <td><p>Reads Feature values of a specific entity of an EntityType. For reading
 *  feature values of multiple entities of an EntityType, please use
 *  StreamingReadFeatureValues.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>readFeatureValues(ReadFeatureValuesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>readFeatureValues(EntityTypeName entityType)
 *           <li>readFeatureValues(String entityType)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>readFeatureValuesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>StreamingReadFeatureValues</td>
 *      <td><p>Reads Feature values for multiple entities. Depending on their size, data
 *  for different entities may be broken
 *  up across multiple responses.</p></td>
 *      <td>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>streamingReadFeatureValuesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>WriteFeatureValues</td>
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>writeFeatureValues(WriteFeatureValuesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>writeFeatureValues(EntityTypeName entityType, List<WriteFeatureValuesPayload> payloads)
 *           <li>writeFeatureValues(String entityType, List<WriteFeatureValuesPayload> payloads)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>writeFeatureValuesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
