 ...
 *    <tr>
 *      <td>CreateIndexEndpoint</td>
 *      <td><p>Creates an IndexEndpoint.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>createIndexEndpointAsync(CreateIndexEndpointRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>createIndexEndpointAsync(LocationName parent, IndexEndpoint indexEndpoint)
 *           <li>createIndexEndpointAsync(String parent, IndexEndpoint indexEndpoint)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>createIndexEndpointOperationCallable()
 *           <li>createIndexEndpointCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetIndexEndpoint</td>
 *      <td><p>Gets an IndexEndpoint.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>getIndexEndpoint(GetIndexEndpointRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getIndexEndpoint(IndexEndpointName name)
 *           <li>getIndexEndpoint(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>getIndexEndpointCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ListIndexEndpoints</td>
 *      <td><p>Lists IndexEndpoints in a Location.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listIndexEndpoints(ListIndexEndpointsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listIndexEndpoints(LocationName parent)
 *           <li>listIndexEndpoints(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listIndexEndpointsPagedCallable()
 *           <li>listIndexEndpointsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>UpdateIndexEndpoint</td>
 *      <td><p>Updates an IndexEndpoint.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>updateIndexEndpoint(UpdateIndexEndpointRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>updateIndexEndpoint(IndexEndpoint indexEndpoint, FieldMask updateMask)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>updateIndexEndpointCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>DeleteIndexEndpoint</td>
 *      <td><p>Deletes an IndexEndpoint.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>deleteIndexEndpointAsync(DeleteIndexEndpointRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>deleteIndexEndpointAsync(IndexEndpointName name)
 *           <li>deleteIndexEndpointAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>deleteIndexEndpointOperationCallable()
 *           <li>deleteIndexEndpointCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>DeployIndex</td>
 *      <td><p>Deploys an Index into this IndexEndpoint, creating a DeployedIndex within
 *  it.
 *  Only non-empty Indexes can be deployed.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>deployIndexAsync(DeployIndexRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>deployIndexAsync(IndexEndpointName indexEndpoint, DeployedIndex deployedIndex)
 *           <li>deployIndexAsync(String indexEndpoint, DeployedIndex deployedIndex)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>deployIndexOperationCallable()
 *           <li>deployIndexCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>UndeployIndex</td>
 *      <td><p>Undeploys an Index from an IndexEndpoint, removing a DeployedIndex from it,
 *  and freeing all resources it's using.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>undeployIndexAsync(UndeployIndexRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>undeployIndexAsync(IndexEndpointName indexEndpoint, String deployedIndexId)
 *           <li>undeployIndexAsync(String indexEndpoint, String deployedIndexId)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>undeployIndexOperationCallable()
 *           <li>undeployIndexCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>MutateDeployedIndex</td>
 *      <td><p>Update an existing DeployedIndex under an IndexEndpoint.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>mutateDeployedIndexAsync(MutateDeployedIndexRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>mutateDeployedIndexAsync(IndexEndpointName indexEndpoint, DeployedIndex deployedIndex)
 *           <li>mutateDeployedIndexAsync(String indexEndpoint, DeployedIndex deployedIndex)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>mutateDeployedIndexOperationCallable()
 *           <li>mutateDeployedIndexCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
