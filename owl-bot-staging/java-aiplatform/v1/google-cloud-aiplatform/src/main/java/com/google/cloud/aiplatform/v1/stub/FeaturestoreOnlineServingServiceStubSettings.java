...
/**
 * Settings class to configure an instance of {@link FeaturestoreOnlineServingServiceStub}.
 *
...
public class FeaturestoreOnlineServingServiceStubSettings
  ...
  private final UnaryCallSettings<ReadFeatureValuesRequest, ReadFeatureValuesResponse>
      readFeatureValuesSettings;
  ...
  public UnaryCallSettings<ReadFeatureValuesRequest, ReadFeatureValuesResponse>
      readFeatureValuesSettings() {
    return readFeatureValuesSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(FeaturestoreOnlineServingServiceStubSettings.class))
        .setTransportToken(
  ...
  protected FeaturestoreOnlineServingServiceStubSettings(Builder settingsBuilder)
      throws IOException {
  ...
  public static class Builder
    ...
    private final UnaryCallSettings.Builder<ReadFeatureValuesRequest, ReadFeatureValuesResponse>
        readFeatureValuesSettings;
