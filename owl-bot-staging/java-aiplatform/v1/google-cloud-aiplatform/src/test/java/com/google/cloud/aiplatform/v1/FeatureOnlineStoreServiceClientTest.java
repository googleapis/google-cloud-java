...
public class FeatureOnlineStoreServiceClientTest {
  private static MockFeatureOnlineStoreService mockFeatureOnlineStoreService;
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private FeatureOnlineStoreServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockFeatureOnlineStoreService = new MockFeatureOnlineStoreService();
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(
                mockFeatureOnlineStoreService, mockLocations, mockIAMPolicy));
  ...
  public void setUp() throws IOException {
    ...
    FeatureOnlineStoreServiceSettings settings =
        FeatureOnlineStoreServiceSettings.newBuilder()
            ...
            .build();
    client = FeatureOnlineStoreServiceClient.create(settings);
  }
  ...
  @Test
  public void fetchFeatureValuesExceptionTest() throws Exception {
  ...
  @Test
  public void fetchFeatureValuesExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockFeatureOnlineStoreService.addException(exception);
