...
public interface NasTrialOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.NasTrial)
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.NasTrial.State state = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.Measurement final_measurement = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
