      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            dedicatedResources_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.DedicatedResources.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.DeploymentResourcePool) e.getUnfinishedMessage();
