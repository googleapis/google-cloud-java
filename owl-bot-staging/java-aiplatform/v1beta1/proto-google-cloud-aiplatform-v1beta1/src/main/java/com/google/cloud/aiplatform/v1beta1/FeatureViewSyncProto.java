...
public final class FeatureViewSyncProto {
  ...
  static {
    ...
    internal_static_google_cloud_aiplatform_v1beta1_FeatureViewSync_SyncSummary_descriptor =
      internal_static_google_cloud_aiplatform_v1beta1_FeatureViewSync_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_aiplatform_v1beta1_FeatureViewSync_SyncSummary_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_FeatureViewSync_SyncSummary_descriptor,
