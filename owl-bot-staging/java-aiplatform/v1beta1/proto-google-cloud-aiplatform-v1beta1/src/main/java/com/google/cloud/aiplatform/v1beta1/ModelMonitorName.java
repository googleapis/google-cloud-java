...
public class ModelMonitorName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_MODEL_MONITOR =
  ...
  public static ModelMonitorName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_MODEL_MONITOR.validatedMatch(
            formattedString, "ModelMonitorName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("model_monitor"));
  }

  public static List<ModelMonitorName> parseList(List<String> formattedStrings) {
    List<ModelMonitorName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return PROJECT_LOCATION_MODEL_MONITOR.instantiate(
        "project", project, "location", location, "model_monitor", modelMonitor);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/modelMonitors/{model_monitor}. */
