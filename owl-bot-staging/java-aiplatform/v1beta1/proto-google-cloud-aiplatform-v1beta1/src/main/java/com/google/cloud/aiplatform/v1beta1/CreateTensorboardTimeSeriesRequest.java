...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            tensorboardTimeSeries_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.aiplatform.v1beta1.CreateTensorboardTimeSeriesRequest parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.CreateTensorboardTimeSeriesRequest) e.getUnfinishedMessage();
      ...
      if (tensorboardTimeSeriesBuilder_ == null) {
        if (tensorboardTimeSeries_ != null) {
          tensorboardTimeSeries_ =
            com.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.newBuilder(tensorboardTimeSeries_).mergeFrom(value).buildPartial();
        } else {
          tensorboardTimeSeries_ = value;
        }
        onChanged();
