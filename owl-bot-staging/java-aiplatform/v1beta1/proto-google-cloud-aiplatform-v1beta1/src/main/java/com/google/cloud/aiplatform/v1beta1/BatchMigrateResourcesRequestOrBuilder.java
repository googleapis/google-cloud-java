...
public interface BatchMigrateResourcesRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.BatchMigrateResourcesRequest)
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.MigrateResourceRequest migrate_resource_requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1beta1.MigrateResourceRequestOrBuilder getMigrateResourceRequestsOrBuilder(
      int index);
}
