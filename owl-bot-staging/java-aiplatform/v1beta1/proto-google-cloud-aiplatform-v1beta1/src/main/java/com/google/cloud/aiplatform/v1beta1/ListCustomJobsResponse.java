...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.aiplatform.v1beta1.ListCustomJobsResponse result) {
      if (customJobsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.aiplatform.v1beta1.CustomJob m =
                  input.readMessage(
                      com.google.cloud.aiplatform.v1beta1.CustomJob.parser(),
                      extensionRegistry);
              if (customJobsBuilder_ == null) {
                ensureCustomJobsIsMutable();
                customJobs_.add(m);
