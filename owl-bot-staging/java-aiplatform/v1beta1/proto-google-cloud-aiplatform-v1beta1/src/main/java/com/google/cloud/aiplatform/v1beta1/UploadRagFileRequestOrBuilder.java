...
public interface UploadRagFileRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.RagFile rag_file = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.UploadRagFileConfig upload_rag_file_config = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   ...
   * <code>.google.cloud.aiplatform.v1beta1.UploadRagFileConfig upload_rag_file_config = 5 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.aiplatform.v1beta1.UploadRagFileConfigOrBuilder getUploadRagFileConfigOrBuilder();
}
