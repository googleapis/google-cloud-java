...
public final class ScheduleProto {
  ...
  static {
    ...
    internal_static_google_cloud_aiplatform_v1beta1_Schedule_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_Schedule_descriptor,
        new java.lang.String[] { "Cron", "CreatePipelineJobRequest", "CreateModelMonitoringJobRequest", "Name", "DisplayName", "StartTime", "EndTime", "MaxRunCount", "StartedRunCount", "State", "CreateTime", "UpdateTime", "NextRunTime", "LastPauseTime", "LastResumeTime", "MaxConcurrentRunCount", "AllowQueueing", "CatchUp", "LastScheduledRunResponse", "TimeSpecification", "Request", });
    internal_static_google_cloud_aiplatform_v1beta1_Schedule_RunResponse_descriptor =
