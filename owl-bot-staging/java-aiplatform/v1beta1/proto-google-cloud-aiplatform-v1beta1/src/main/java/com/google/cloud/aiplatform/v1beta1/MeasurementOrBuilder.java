...
public interface MeasurementOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.Measurement.Metric> 
      getMetricsList();
  /**
   * <pre>
   * Output only. A list of metrics got by evaluating the objective functions
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.Measurement.Metric metrics = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.aiplatform.v1beta1.Measurement.MetricOrBuilder getMetricsOrBuilder(
      int index);
}
