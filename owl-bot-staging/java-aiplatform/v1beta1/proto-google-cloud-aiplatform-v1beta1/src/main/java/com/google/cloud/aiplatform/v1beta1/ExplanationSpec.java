      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18: {
            ...
            metadata_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.ExplanationMetadata.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.aiplatform.v1beta1.ExplanationSpec) e.getUnfinishedMessage();
    ...
    public Builder mergeMetadata(com.google.cloud.aiplatform.v1beta1.ExplanationMetadata value) {
      if (metadataBuilder_ == null) {
        if (metadata_ != null) {
          metadata_ =
            com.google.cloud.aiplatform.v1beta1.ExplanationMetadata.newBuilder(metadata_).mergeFrom(value).buildPartial();
        } else {
          metadata_ = value;
        }
        onChanged();
