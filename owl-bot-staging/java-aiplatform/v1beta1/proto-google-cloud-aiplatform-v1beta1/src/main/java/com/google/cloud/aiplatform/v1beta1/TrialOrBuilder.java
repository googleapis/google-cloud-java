...
public interface TrialOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.Trial)
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.Trial.State state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1beta1.Trial.Parameter parameters = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.Trial.Parameter> 
      getParametersList();
  /**
   * <pre>
   * Output only. The parameters of the Trial.
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.Trial.Parameter parameters = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.aiplatform.v1beta1.Trial.ParameterOrBuilder getParametersOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.Measurement final_measurement = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.aiplatform.v1beta1.Measurement measurements = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.Measurement> 
      getMeasurementsList();
  /**
   * <pre>
   * Output only. A list of measurements that are strictly lexicographically
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.Measurement measurements = 6 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.aiplatform.v1beta1.MeasurementOrBuilder getMeasurementsOrBuilder(
      int index);
