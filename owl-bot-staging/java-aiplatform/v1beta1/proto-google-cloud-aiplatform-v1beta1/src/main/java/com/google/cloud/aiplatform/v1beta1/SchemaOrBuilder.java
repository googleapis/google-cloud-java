...
public interface SchemaOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.Schema)
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.Type type = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * @return The type.
   */
  com.google.cloud.aiplatform.v1beta1.Type getType();
   ...
   * </pre>
   *
   * <code>.google.cloud.aiplatform.v1beta1.Schema items = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * <code>.google.cloud.aiplatform.v1beta1.Schema items = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1beta1.SchemaOrBuilder getItemsOrBuilder();
   ...
   * </pre>
   *
   * <code>map&lt;string, .google.cloud.aiplatform.v1beta1.Schema&gt; properties = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  ...
  java.util.Map<java.lang.String, com.google.cloud.aiplatform.v1beta1.Schema>
  getProperties();
  /**
   * <pre>
   * Optional. SCHEMA FIELDS FOR TYPE OBJECT
   ...
   */
  /* nullable */
com.google.cloud.aiplatform.v1beta1.Schema getPropertiesOrDefault(
      java.lang.String key,
      /* nullable */
com.google.cloud.aiplatform.v1beta1.Schema defaultValue);
   ...
   * <code>map&lt;string, .google.cloud.aiplatform.v1beta1.Schema&gt; properties = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1beta1.Schema getPropertiesOrThrow(
      java.lang.String key);
