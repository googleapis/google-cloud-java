...
public interface IndexDatapointOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.IndexDatapoint.Restriction> 
      getRestrictsList();
  /**
   * <pre>
   * Optional. List of Restrict of the datapoint, used to perform "restricted
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.IndexDatapoint.NumericRestriction numeric_restricts = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1beta1.IndexDatapoint.NumericRestriction getNumericRestricts(int index);
  /**
   * <pre>
   * Optional. List of Restrict of the datapoint, used to perform "restricted
   * searches" where boolean rule are used to filter the subset of the database
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.IndexDatapoint.NumericRestriction numeric_restricts = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1beta1.IndexDatapoint.NumericRestrictionOrBuilder> 
