...
public interface CopyModelRequestOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.CopyModelRequest)
   ...
   * </pre>
   *
   * <code>string parent_model = 5 [(.google.api.field_behavior) = OPTIONAL, (.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>string source_model = 2 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
  ...
  public com.google.cloud.aiplatform.v1beta1.CopyModelRequest.DestinationModelCase getDestinationModelCase();
}
