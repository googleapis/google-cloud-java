        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50: {
              ...
              defaultSkewThreshold_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.ThresholdConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              ...
              defaultDriftThreshold_ = input.readMessage(com.google.cloud.aiplatform.v1beta1.ThresholdConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
