...
public final class VertexRagDataProto {
  ...
  static {
    ...
    internal_static_google_cloud_aiplatform_v1beta1_RagCorpus_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_RagCorpus_descriptor,
        new java.lang.String[] { "Name", "DisplayName", "Description", "CreateTime", "UpdateTime", });
    internal_static_google_cloud_aiplatform_v1beta1_RagFile_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_aiplatform_v1beta1_RagFile_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_RagFile_descriptor,
        new java.lang.String[] { "GcsSource", "GoogleDriveSource", "DirectUploadSource", "Name", "DisplayName", "Description", "SizeBytes", "RagFileType", "CreateTime", "UpdateTime", "RagFileSource", });
    internal_static_google_cloud_aiplatform_v1beta1_RagFileChunkingConfig_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_aiplatform_v1beta1_RagFileChunkingConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_RagFileChunkingConfig_descriptor,
        new java.lang.String[] { "ChunkSize", "ChunkOverlap", });
    internal_static_google_cloud_aiplatform_v1beta1_UploadRagFileConfig_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_google_cloud_aiplatform_v1beta1_UploadRagFileConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_UploadRagFileConfig_descriptor,
        new java.lang.String[] { "RagFileChunkingConfig", });
    internal_static_google_cloud_aiplatform_v1beta1_ImportRagFilesConfig_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_google_cloud_aiplatform_v1beta1_ImportRagFilesConfig_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_ImportRagFilesConfig_descriptor,
        new java.lang.String[] { "GcsSource", "GoogleDriveSource", "RagFileChunkingConfig", "ImportSource", });
    com.google.protobuf.ExtensionRegistry registry =
