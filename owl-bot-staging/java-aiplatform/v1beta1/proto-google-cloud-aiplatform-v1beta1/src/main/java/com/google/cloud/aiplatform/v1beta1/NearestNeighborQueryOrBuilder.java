...
public interface NearestNeighborQueryOrBuilder extends
   ...
   * <code>.google.cloud.aiplatform.v1beta1.NearestNeighborQuery.Embedding embedding = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1beta1.NearestNeighborQuery.EmbeddingOrBuilder getEmbeddingOrBuilder();
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.NearestNeighborQuery.StringFilter string_filters = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1beta1.NearestNeighborQuery.StringFilterOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.NearestNeighborQuery.StringFilter string_filters = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1beta1.NearestNeighborQuery.StringFilterOrBuilder getStringFiltersOrBuilder(
      int index);
   ...
   * <code>.google.cloud.aiplatform.v1beta1.NearestNeighborQuery.Parameters parameters = 7 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.aiplatform.v1beta1.NearestNeighborQuery.ParametersOrBuilder getParametersOrBuilder();
