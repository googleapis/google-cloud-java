...
public interface ListNasJobsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.ListNasJobsResponse)
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.NasJob> 
      getNasJobsList();
  /**
   * <pre>
   * List of NasJobs in the requested page.
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.NasJob nas_jobs = 1;</code>
   */
  com.google.cloud.aiplatform.v1beta1.NasJobOrBuilder getNasJobsOrBuilder(
      int index);
