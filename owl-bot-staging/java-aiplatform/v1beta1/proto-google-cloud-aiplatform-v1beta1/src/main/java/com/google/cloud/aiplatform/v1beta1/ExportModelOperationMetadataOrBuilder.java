...
public interface ExportModelOperationMetadataOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.ExportModelOperationMetadata)
   ...
   */
  com.google.cloud.aiplatform.v1beta1.ExportModelOperationMetadata.OutputInfo getOutputInfo();
  /**
   * <pre>
   * Output only. Information further describing the output of this Model
   * export.
   ...
   * <code>.google.cloud.aiplatform.v1beta1.ExportModelOperationMetadata.OutputInfo output_info = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.aiplatform.v1beta1.ExportModelOperationMetadata.OutputInfoOrBuilder getOutputInfoOrBuilder();
}
