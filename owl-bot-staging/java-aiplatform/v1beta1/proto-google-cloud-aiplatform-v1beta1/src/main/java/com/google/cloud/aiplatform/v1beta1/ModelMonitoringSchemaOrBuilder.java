...
public interface ModelMonitoringSchemaOrBuilder extends
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema feature_fields = 1;</code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchemaOrBuilder> 
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema feature_fields = 1;</code>
   */
  com.google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchemaOrBuilder getFeatureFieldsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema prediction_fields = 2;</code>
   */
  com.google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema getPredictionFields(int index);
  /**
   * <pre>
   * Prediction output names of the model. The requirements are the same as the
   * [feature_fields][google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.feature_fields].
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema prediction_fields = 2;</code>
   */
  com.google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchemaOrBuilder getPredictionFieldsOrBuilder(
      int index);
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema ground_truth_fields = 3;</code>
   */
  com.google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema getGroundTruthFields(int index);
  /**
   * <pre>
   * Target /ground truth names of the model.
   * </pre>
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchema ground_truth_fields = 3;</code>
   */
  com.google.cloud.aiplatform.v1beta1.ModelMonitoringSchema.FieldSchemaOrBuilder getGroundTruthFieldsOrBuilder(
      int index);
