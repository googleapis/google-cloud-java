...
public final class ReasoningEngineExecutionServiceProto {
  ...
  static {
    ...
    internal_static_google_cloud_aiplatform_v1beta1_QueryReasoningEngineRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_QueryReasoningEngineRequest_descriptor,
        new java.lang.String[] { "Name", "Input", });
    internal_static_google_cloud_aiplatform_v1beta1_QueryReasoningEngineResponse_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_aiplatform_v1beta1_QueryReasoningEngineResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_aiplatform_v1beta1_QueryReasoningEngineResponse_descriptor,
