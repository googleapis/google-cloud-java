...
public final class ModelGardenServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.aiplatform.v1beta1.ModelGardenService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest,
      com.google.cloud.aiplatform.v1beta1.PublisherModel> getGetPublisherModelMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest,
      com.google.cloud.aiplatform.v1beta1.PublisherModel> getGetPublisherModelMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest, com.google.cloud.aiplatform.v1beta1.PublisherModel> getGetPublisherModelMethod;
    if ((getGetPublisherModelMethod = ModelGardenServiceGrpc.getGetPublisherModelMethod) == null) {
      synchronized (ModelGardenServiceGrpc.class) {
        if ((getGetPublisherModelMethod = ModelGardenServiceGrpc.getGetPublisherModelMethod) == null) {
          ModelGardenServiceGrpc.getGetPublisherModelMethod = getGetPublisherModelMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest, com.google.cloud.aiplatform.v1beta1.PublisherModel>newBuilder()
              ...
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.aiplatform.v1beta1.PublisherModel.getDefaultInstance()))
              .setSchemaDescriptor(new ModelGardenServiceMethodDescriptorSupplier("GetPublisherModel"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest,
      com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse> getListPublisherModelsMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest,
      com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse> getListPublisherModelsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest, com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse> getListPublisherModelsMethod;
    if ((getListPublisherModelsMethod = ModelGardenServiceGrpc.getListPublisherModelsMethod) == null) {
      synchronized (ModelGardenServiceGrpc.class) {
        if ((getListPublisherModelsMethod = ModelGardenServiceGrpc.getListPublisherModelsMethod) == null) {
          ModelGardenServiceGrpc.getListPublisherModelsMethod = getListPublisherModelsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest, com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListPublisherModels"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new ModelGardenServiceMethodDescriptorSupplier("ListPublisherModels"))
              .build();
        }
      }
    }
  ...
  public static ModelGardenServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ModelGardenServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ModelGardenServiceStub>() {
        @java.lang.Override
        public ModelGardenServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static ModelGardenServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<ModelGardenServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ModelGardenServiceBlockingStub>() {
        @java.lang.Override
        public ModelGardenServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static ModelGardenServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ModelGardenServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<ModelGardenServiceFutureStub>() {
        @java.lang.Override
        public ModelGardenServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void getPublisherModel(com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.PublisherModel> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetPublisherModelMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void listPublisherModels(com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListPublisherModelsMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class ModelGardenServiceImplBase
  ...
  public static final class ModelGardenServiceStub
    ...
    private ModelGardenServiceStub(
     ...
     * </pre>
     */
    public void getPublisherModel(com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.PublisherModel> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetPublisherModelMethod(), getCallOptions()), request, responseObserver);
    }
     ...
     * </pre>
     */
    public void listPublisherModels(com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListPublisherModelsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class ModelGardenServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.aiplatform.v1beta1.PublisherModel getPublisherModel(com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest request) {
     ...
     * </pre>
     */
    public com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse listPublisherModels(com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class ModelGardenServiceFutureStub
    ...
    private ModelGardenServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.aiplatform.v1beta1.PublisherModel> getPublisherModel(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_PUBLISHER_MODEL:
          serviceImpl.getPublisherModel((com.google.cloud.aiplatform.v1beta1.GetPublisherModelRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.PublisherModel>) responseObserver);
          break;
        case METHODID_LIST_PUBLISHER_MODELS:
          serviceImpl.listPublisherModels((com.google.cloud.aiplatform.v1beta1.ListPublisherModelsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.ListPublisherModelsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class ModelGardenServiceBaseDescriptorSupplier
