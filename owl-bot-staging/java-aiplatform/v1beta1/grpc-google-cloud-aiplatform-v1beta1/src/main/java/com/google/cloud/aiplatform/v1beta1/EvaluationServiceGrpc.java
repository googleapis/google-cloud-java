...
public final class EvaluationServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.aiplatform.v1beta1.EvaluationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest,
      com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse> getEvaluateInstancesMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest,
      com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse> getEvaluateInstancesMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest, com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse> getEvaluateInstancesMethod;
    if ((getEvaluateInstancesMethod = EvaluationServiceGrpc.getEvaluateInstancesMethod) == null) {
      synchronized (EvaluationServiceGrpc.class) {
        if ((getEvaluateInstancesMethod = EvaluationServiceGrpc.getEvaluateInstancesMethod) == null) {
          EvaluationServiceGrpc.getEvaluateInstancesMethod = getEvaluateInstancesMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest, com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse>newBuilder()
              ...
              .setSchemaDescriptor(new EvaluationServiceMethodDescriptorSupplier("EvaluateInstances"))
              .build();
        }
      }
    }
  ...
  public static EvaluationServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<EvaluationServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<EvaluationServiceStub>() {
        @java.lang.Override
        public EvaluationServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static EvaluationServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<EvaluationServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<EvaluationServiceBlockingStub>() {
        @java.lang.Override
        public EvaluationServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static EvaluationServiceFutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<EvaluationServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<EvaluationServiceFutureStub>() {
        @java.lang.Override
        public EvaluationServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void evaluateInstances(com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getEvaluateInstancesMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class EvaluationServiceImplBase
  ...
  public static final class EvaluationServiceStub
     ...
     * </pre>
     */
    public void evaluateInstances(com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getEvaluateInstancesMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class EvaluationServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse evaluateInstances(com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest request) {
  ...
  public static final class EvaluationServiceFutureStub
    ...
    private EvaluationServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse> evaluateInstances(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_EVALUATE_INSTANCES:
          serviceImpl.evaluateInstances((com.google.cloud.aiplatform.v1beta1.EvaluateInstancesRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.EvaluateInstancesResponse>) responseObserver);
          break;
        default:
