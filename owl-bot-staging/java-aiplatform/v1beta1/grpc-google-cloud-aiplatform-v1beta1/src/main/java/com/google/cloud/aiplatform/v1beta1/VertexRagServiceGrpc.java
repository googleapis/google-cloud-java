...
public final class VertexRagServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.aiplatform.v1beta1.VertexRagService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest,
      com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse> getRetrieveContextsMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest,
      com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse> getRetrieveContextsMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest, com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse> getRetrieveContextsMethod;
    if ((getRetrieveContextsMethod = VertexRagServiceGrpc.getRetrieveContextsMethod) == null) {
      synchronized (VertexRagServiceGrpc.class) {
        if ((getRetrieveContextsMethod = VertexRagServiceGrpc.getRetrieveContextsMethod) == null) {
          VertexRagServiceGrpc.getRetrieveContextsMethod = getRetrieveContextsMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest, com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "RetrieveContexts"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse.getDefaultInstance()))
              .setSchemaDescriptor(new VertexRagServiceMethodDescriptorSupplier("RetrieveContexts"))
              .build();
        }
      }
    }
  ...
  public static VertexRagServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VertexRagServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<VertexRagServiceStub>() {
        @java.lang.Override
        public VertexRagServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static VertexRagServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<VertexRagServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<VertexRagServiceBlockingStub>() {
        @java.lang.Override
        public VertexRagServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static VertexRagServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VertexRagServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<VertexRagServiceFutureStub>() {
        @java.lang.Override
        public VertexRagServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void retrieveContexts(com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getRetrieveContextsMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class VertexRagServiceImplBase
  ...
  public static final class VertexRagServiceStub
    ...
    private VertexRagServiceStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected VertexRagServiceStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new VertexRagServiceStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public void retrieveContexts(com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getRetrieveContextsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class VertexRagServiceBlockingStub
    ...
    private VertexRagServiceBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse retrieveContexts(com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest request) {
  ...
  public static final class VertexRagServiceFutureStub
    ...
    private VertexRagServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse> retrieveContexts(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RETRIEVE_CONTEXTS:
          serviceImpl.retrieveContexts((com.google.cloud.aiplatform.v1beta1.RetrieveContextsRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.RetrieveContextsResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class VertexRagServiceBaseDescriptorSupplier
