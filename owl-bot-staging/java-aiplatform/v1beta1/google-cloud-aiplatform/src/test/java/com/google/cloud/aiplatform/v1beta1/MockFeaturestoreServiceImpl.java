...
import com.google.cloud.aiplatform.v1beta1.FeaturestoreServiceGrpc.FeaturestoreServiceImplBase;
...
public class MockFeaturestoreServiceImpl extends FeaturestoreServiceImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockFeaturestoreServiceImpl() {
  ...
  public void createFeaturestore(
      CreateFeaturestoreRequest request, StreamObserver<Operation> responseObserver) {
    ...
    if (response instanceof Operation) {
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateFeaturestore, expected %s or %s",
  ...
  public void getFeaturestore(
      GetFeaturestoreRequest request, StreamObserver<Featurestore> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Featurestore) {
      requests.add(request);
      responseObserver.onNext(((Featurestore) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method GetFeaturestore, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Featurestore.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void listFeaturestores(
      ...
      StreamObserver<ListFeaturestoresResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListFeaturestoresResponse) {
      requests.add(request);
      responseObserver.onNext(((ListFeaturestoresResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListFeaturestores, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListFeaturestoresResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void updateFeaturestore(
      UpdateFeaturestoreRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UpdateFeaturestore, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void deleteFeaturestore(
      DeleteFeaturestoreRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteFeaturestore, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void createEntityType(
      CreateEntityTypeRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deleteEntityType(
      DeleteEntityTypeRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void updateFeature(
      UpdateFeatureRequest request, StreamObserver<Feature> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Feature) {
      requests.add(request);
      responseObserver.onNext(((Feature) response));
  ...
  public void importFeatureValues(
      ImportFeatureValuesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ImportFeatureValues, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void batchReadFeatureValues(
      BatchReadFeatureValuesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void exportFeatureValues(
      ExportFeatureValuesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ExportFeatureValues, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void deleteFeatureValues(
      DeleteFeatureValuesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteFeatureValues, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void searchFeatures(
      SearchFeaturesRequest request, StreamObserver<SearchFeaturesResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof SearchFeaturesResponse) {
      requests.add(request);
      responseObserver.onNext(((SearchFeaturesResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method SearchFeatures, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  SearchFeaturesResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
}
