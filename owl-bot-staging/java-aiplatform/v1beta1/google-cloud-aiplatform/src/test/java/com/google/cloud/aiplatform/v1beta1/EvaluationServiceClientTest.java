...
public class EvaluationServiceClientTest {
  ...
  public static void startStaticServer() {
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(mockEvaluationService, mockLocations, mockIAMPolicy));
  ...
  public void evaluateInstancesTest() throws Exception {
    ...
    EvaluateInstancesRequest actualRequest = ((EvaluateInstancesRequest) actualRequests.get(0));

    Assert.assertEquals(request.getExactMatchInput(), actualRequest.getExactMatchInput());
    Assert.assertEquals(request.getBleuInput(), actualRequest.getBleuInput());
    Assert.assertEquals(request.getRougeInput(), actualRequest.getRougeInput());
    Assert.assertEquals(request.getFluencyInput(), actualRequest.getFluencyInput());
    Assert.assertEquals(request.getCoherenceInput(), actualRequest.getCoherenceInput());
    ...
    Assert.assertEquals(
        request.getPairwiseSummarizationQualityInput(),
        actualRequest.getPairwiseSummarizationQualityInput());
    Assert.assertEquals(
        request.getSummarizationHelpfulnessInput(),
        actualRequest.getSummarizationHelpfulnessInput());
    Assert.assertEquals(
        request.getSummarizationVerbosityInput(), actualRequest.getSummarizationVerbosityInput());
    Assert.assertEquals(
        request.getQuestionAnsweringQualityInput(),
        actualRequest.getQuestionAnsweringQualityInput());
    Assert.assertEquals(
        request.getPairwiseQuestionAnsweringQualityInput(),
        actualRequest.getPairwiseQuestionAnsweringQualityInput());
    Assert.assertEquals(
        request.getQuestionAnsweringRelevanceInput(),
        actualRequest.getQuestionAnsweringRelevanceInput());
    Assert.assertEquals(
        request.getQuestionAnsweringHelpfulnessInput(),
        actualRequest.getQuestionAnsweringHelpfulnessInput());
    Assert.assertEquals(
  ...
  @Test
  public void evaluateInstancesExceptionTest() throws Exception {
