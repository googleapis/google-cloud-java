...
/**
 * Settings class to configure an instance of {@link LlmUtilityServiceStub}.
 *
...
public class LlmUtilityServiceStubSettings extends StubSettings<LlmUtilityServiceStubSettings> {
  ...
  public LlmUtilityServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcLlmUtilityServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(LlmUtilityServiceStubSettings.class))
        .setTransportToken(
