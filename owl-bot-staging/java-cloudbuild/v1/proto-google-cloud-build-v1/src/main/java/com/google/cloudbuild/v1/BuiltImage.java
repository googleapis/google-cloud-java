      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 34: {
            ...
            if (pushTiming_ != null) {
              subBuilder = pushTiming_.toBuilder();
            }
            pushTiming_ = input.readMessage(com.google.cloudbuild.v1.TimeSpan.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom(pushTiming_);
              pushTiming_ = subBuilder.buildPartial();
            }
