...
public interface BatchCreateRepositoriesRequestOrBuilder extends
   ...
   */
  java.util.List<google.devtools.cloudbuild.v2.CreateRepositoryRequest> 
      getRequestsList();
  /**
   * <pre>
   * Required. The request messages specifying the repositories to create.
   ...
   * <code>repeated .google.devtools.cloudbuild.v2.CreateRepositoryRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  google.devtools.cloudbuild.v2.CreateRepositoryRequest getRequests(int index);
  /**
   * <pre>
   * Required. The request messages specifying the repositories to create.
   * </pre>
   ...
   * <code>repeated .google.devtools.cloudbuild.v2.CreateRepositoryRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<? extends google.devtools.cloudbuild.v2.CreateRepositoryRequestOrBuilder> 
   ...
   * <code>repeated .google.devtools.cloudbuild.v2.CreateRepositoryRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  google.devtools.cloudbuild.v2.CreateRepositoryRequestOrBuilder getRequestsOrBuilder(
      int index);
}
