...
public interface GitHubEnterpriseConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>string webhook_secret_secret_version = 5 [(.google.api.resource_reference) = { ... }</code>
   ...
   * </pre>
   *
   * <code>.google.devtools.cloudbuild.v2.ServiceDirectoryConfig service_directory_config = 10;</code>
   ...
   */
  google.devtools.cloudbuild.v2.ServiceDirectoryConfig getServiceDirectoryConfig();
  /**
   * <pre>
   * Configuration for using Service Directory to privately connect to a GitHub
   * Enterprise server. This should only be set if the GitHub Enterprise server
   ...
   * <code>.google.devtools.cloudbuild.v2.ServiceDirectoryConfig service_directory_config = 10;</code>
   */
  google.devtools.cloudbuild.v2.ServiceDirectoryConfigOrBuilder getServiceDirectoryConfigOrBuilder();
