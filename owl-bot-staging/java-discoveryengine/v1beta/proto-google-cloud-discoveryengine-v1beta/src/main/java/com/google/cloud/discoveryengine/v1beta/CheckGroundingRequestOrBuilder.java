...
public interface CheckGroundingRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>string grounding_config = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1beta.GroundingFact> 
      getFactsList();
  /**
   * <pre>
   * List of facts for the grounding check.
   ...
   * <code>repeated .google.cloud.discoveryengine.v1beta.GroundingFact facts = 3;</code>
   */
  com.google.cloud.discoveryengine.v1beta.GroundingFactOrBuilder getFactsOrBuilder(
      int index);
