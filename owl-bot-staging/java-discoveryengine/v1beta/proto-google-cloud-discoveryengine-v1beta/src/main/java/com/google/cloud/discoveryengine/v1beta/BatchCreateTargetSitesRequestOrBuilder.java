...
public interface BatchCreateTargetSitesRequestOrBuilder extends
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.discoveryengine.v1beta.CreateTargetSiteRequest requests = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  java.util.List<com.google.cloud.discoveryengine.v1beta.CreateTargetSiteRequest> 
      getRequestsList();
  /**
   * <pre>
   * Required. The request message specifying the resources to create.
