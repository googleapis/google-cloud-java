...
private static final long serialVersionUID = 0L;
   ...
   */
  @java.lang.Override
  public com.google.cloud.discoveryengine.v1beta.SchemaOrBuilder getSchemasOrBuilder(
      int index) {
    return schemas_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    com.google.cloud.discoveryengine.v1beta.ListSchemasResponse other = (com.google.cloud.discoveryengine.v1beta.ListSchemasResponse) obj;
  ...
  public static com.google.cloud.discoveryengine.v1beta.ListSchemasResponse parseFrom(java.io.InputStream input)
      throws java.io.IOException {
  ...
  public static com.google.cloud.discoveryengine.v1beta.ListSchemasResponse parseDelimitedFrom(java.io.InputStream input)
      throws java.io.IOException {
    return com.google.protobuf.GeneratedMessageV3
  ...
  public static Builder newBuilder(com.google.cloud.discoveryengine.v1beta.ListSchemasResponse prototype) {
  ...
  public static final class Builder extends
    ...
    private void ensureSchemasIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        schemas_ = new java.util.ArrayList<com.google.cloud.discoveryengine.v1beta.Schema>(schemas_);
    ...
    public Builder setSchemas(
        int index, com.google.cloud.discoveryengine.v1beta.Schema value) {
      if (schemasBuilder_ == null) {
        if (value == null) {
     ...
     * <code>repeated .google.cloud.discoveryengine.v1beta.Schema schemas = 1;</code>
     */
    public com.google.cloud.discoveryengine.v1beta.Schema.Builder getSchemasBuilder(
        int index) {
    ...
    public com.google.cloud.discoveryengine.v1beta.Schema.Builder addSchemasBuilder(
        int index) {
      return getSchemasFieldBuilder().addBuilder(
          index, com.google.cloud.discoveryengine.v1beta.Schema.getDefaultInstance());
    }
    /**
     * <pre>
     * The [Schema][google.cloud.discoveryengine.v1beta.Schema]s.
