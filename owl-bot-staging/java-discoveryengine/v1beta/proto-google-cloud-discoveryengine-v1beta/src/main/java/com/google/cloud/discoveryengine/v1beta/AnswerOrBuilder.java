...
public interface AnswerOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1beta.Answer)
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1beta.Answer.Citation> 
      getCitationsList();
  /**
   * <pre>
   * Citations.
   ...
   * <code>repeated .google.cloud.discoveryengine.v1beta.Answer.Citation citations = 4;</code>
   */
  com.google.cloud.discoveryengine.v1beta.Answer.CitationOrBuilder getCitationsOrBuilder(
      int index);
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1beta.Answer.Reference> 
      getReferencesList();
  /**
   * <pre>
   * References.
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1beta.Answer.Step> 
      getStepsList();
  /**
   * <pre>
   * Answer generation steps.
   ...
   * <code>repeated .google.cloud.discoveryengine.v1beta.Answer.Step steps = 7;</code>
   */
  com.google.cloud.discoveryengine.v1beta.Answer.StepOrBuilder getStepsOrBuilder(
      int index);
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo query_understanding_info = 10;</code>
   ...
   * <code>.google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfo query_understanding_info = 10;</code>
   */
  com.google.cloud.discoveryengine.v1beta.Answer.QueryUnderstandingInfoOrBuilder getQueryUnderstandingInfoOrBuilder();
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReason answer_skipped_reasons = 11;</code>
   * @return A list containing the answerSkippedReasons.
   */
  java.util.List<com.google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReason> getAnswerSkippedReasonsList();
  /**
   * <pre>
   * Additional answer-skipped reasons. This provides the reason for ignored
   * cases. If nothing is skipped, this field is not set.
   ...
   */
  com.google.cloud.discoveryengine.v1beta.Answer.AnswerSkippedReason getAnswerSkippedReasons(int index);
  /**
   * <pre>
   * Additional answer-skipped reasons. This provides the reason for ignored
   * cases. If nothing is skipped, this field is not set.
