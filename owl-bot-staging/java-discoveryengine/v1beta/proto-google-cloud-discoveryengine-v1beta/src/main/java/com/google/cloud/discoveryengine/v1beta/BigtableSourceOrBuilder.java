...
public interface BigtableSourceOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1beta.BigtableOptions bigtable_options = 4 [(.google.api.field_behavior) = REQUIRED];</code>
