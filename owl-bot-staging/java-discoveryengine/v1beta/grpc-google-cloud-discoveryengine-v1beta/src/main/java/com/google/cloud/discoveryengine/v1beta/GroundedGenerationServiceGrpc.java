...
public final class GroundedGenerationServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.discoveryengine.v1beta.GroundedGenerationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest,
      com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse> getCheckGroundingMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest,
      com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse> getCheckGroundingMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest, com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse> getCheckGroundingMethod;
    if ((getCheckGroundingMethod = GroundedGenerationServiceGrpc.getCheckGroundingMethod) == null) {
      synchronized (GroundedGenerationServiceGrpc.class) {
        if ((getCheckGroundingMethod = GroundedGenerationServiceGrpc.getCheckGroundingMethod) == null) {
          GroundedGenerationServiceGrpc.getCheckGroundingMethod = getCheckGroundingMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest, com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse>newBuilder()
              ...
              .setSchemaDescriptor(new GroundedGenerationServiceMethodDescriptorSupplier("CheckGrounding"))
              .build();
        }
      }
    }
  ...
  public static GroundedGenerationServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GroundedGenerationServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<GroundedGenerationServiceStub>() {
        @java.lang.Override
        public GroundedGenerationServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static GroundedGenerationServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<GroundedGenerationServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<GroundedGenerationServiceBlockingStub>() {
        @java.lang.Override
        public GroundedGenerationServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static GroundedGenerationServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GroundedGenerationServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<GroundedGenerationServiceFutureStub>() {
        @java.lang.Override
        public GroundedGenerationServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void checkGrounding(com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCheckGroundingMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class GroundedGenerationServiceImplBase
  ...
  public static final class GroundedGenerationServiceStub
     ...
     * </pre>
     */
    public void checkGrounding(com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCheckGroundingMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GroundedGenerationServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse checkGrounding(com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest request) {
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service GroundedGenerationService.
   * <pre>
   * Service for grounded generation.
   * </pre>
   */
  public static final class GroundedGenerationServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse> checkGrounding(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_CHECK_GROUNDING:
          serviceImpl.checkGrounding((com.google.cloud.discoveryengine.v1beta.CheckGroundingRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1beta.CheckGroundingResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class GroundedGenerationServiceBaseDescriptorSupplier
