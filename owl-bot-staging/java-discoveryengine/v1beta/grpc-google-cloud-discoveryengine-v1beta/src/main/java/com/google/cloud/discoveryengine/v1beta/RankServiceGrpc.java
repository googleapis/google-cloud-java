...
public final class RankServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.discoveryengine.v1beta.RankService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1beta.RankRequest,
      com.google.cloud.discoveryengine.v1beta.RankResponse> getRankMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "Rank",
      requestType = com.google.cloud.discoveryengine.v1beta.RankRequest.class,
      responseType = com.google.cloud.discoveryengine.v1beta.RankResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1beta.RankRequest,
      com.google.cloud.discoveryengine.v1beta.RankResponse> getRankMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1beta.RankRequest, com.google.cloud.discoveryengine.v1beta.RankResponse> getRankMethod;
    if ((getRankMethod = RankServiceGrpc.getRankMethod) == null) {
      synchronized (RankServiceGrpc.class) {
        if ((getRankMethod = RankServiceGrpc.getRankMethod) == null) {
          RankServiceGrpc.getRankMethod = getRankMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1beta.RankRequest, com.google.cloud.discoveryengine.v1beta.RankResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Rank"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1beta.RankRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1beta.RankResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void rank(com.google.cloud.discoveryengine.v1beta.RankRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1beta.RankResponse> responseObserver) {
   ...
   * </pre>
   */
  public static abstract class RankServiceImplBase
  ...
  public static final class RankServiceStub
     ...
     * </pre>
     */
    public void rank(com.google.cloud.discoveryengine.v1beta.RankRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1beta.RankResponse> responseObserver) {
  ...
  public static final class RankServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1beta.RankResponse rank(com.google.cloud.discoveryengine.v1beta.RankRequest request) {
  ...
  public static final class RankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.discoveryengine.v1beta.RankResponse> rank(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RANK:
          serviceImpl.rank((com.google.cloud.discoveryengine.v1beta.RankRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1beta.RankResponse>) responseObserver);
          break;
        default:
  ...
  private static abstract class RankServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.cloud.discoveryengine.v1beta.RankServiceProto.getDescriptor();
    }
