...
import com.google.cloud.discoveryengine.v1.stub.EngineServiceStub;
 ...
 *      <td><p> Creates a [Engine][google.cloud.discoveryengine.v1.Engine].</td>
 *      <td>
 ...
 *      <td><p> Deletes a [Engine][google.cloud.discoveryengine.v1.Engine].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Updates an [Engine][google.cloud.discoveryengine.v1.Engine]</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td><p> GetEngine</td>
 *      <td><p> Gets a [Engine][google.cloud.discoveryengine.v1.Engine].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td><p> ListEngines</td>
 *      <td><p> Lists all the [Engine][google.cloud.discoveryengine.v1.Engine]s associated with the project.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class EngineServiceClient implements BackgroundResource {
   ...
   *     [Engine][google.cloud.discoveryengine.v1.Engine], which will become the final component of
   *     the [Engine][google.cloud.discoveryengine.v1.Engine]'s resource name.
   ...
   * }</pre>
   *
   * @param name Required. Full resource name of [Engine][google.cloud.discoveryengine.v1.Engine],
   *     such as
   *     `projects/{project}/locations/{location}/collections/{collection_id}/engines/{engine_id}`.
   *     <p>If the caller does not have permission to delete the
   *     [Engine][google.cloud.discoveryengine.v1.Engine], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>If the [Engine][google.cloud.discoveryengine.v1.Engine] to delete does not exist, a
   ...
   *     [Engine][google.cloud.discoveryengine.v1.Engine], regardless of whether or not it exists, a
   *     PERMISSION_DENIED error is returned.
   *     <p>If the [Engine][google.cloud.discoveryengine.v1.Engine] to update does not exist, a
   *     NOT_FOUND error is returned.
