...
public final class RecommendationServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.discoveryengine.v1alpha.RecommendationService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.RecommendRequest,
      com.google.cloud.discoveryengine.v1alpha.RecommendResponse> getRecommendMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.RecommendRequest,
      com.google.cloud.discoveryengine.v1alpha.RecommendResponse> getRecommendMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.RecommendRequest, com.google.cloud.discoveryengine.v1alpha.RecommendResponse> getRecommendMethod;
      ...
      synchronized (RecommendationServiceGrpc.class) {
        if ((getRecommendMethod = RecommendationServiceGrpc.getRecommendMethod) == null) {
          RecommendationServiceGrpc.getRecommendMethod = getRecommendMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1alpha.RecommendRequest, com.google.cloud.discoveryengine.v1alpha.RecommendResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Recommend"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.RecommendRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.RecommendResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void recommend(com.google.cloud.discoveryengine.v1alpha.RecommendRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.RecommendResponse> responseObserver) {
  ...
  public static final class RecommendationServiceStub
     ...
     * </pre>
     */
    public void recommend(com.google.cloud.discoveryengine.v1alpha.RecommendRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.RecommendResponse> responseObserver) {
  ...
  public static final class RecommendationServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1alpha.RecommendResponse recommend(com.google.cloud.discoveryengine.v1alpha.RecommendRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RECOMMEND:
          serviceImpl.recommend((com.google.cloud.discoveryengine.v1alpha.RecommendRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.RecommendResponse>) responseObserver);
          break;
        default:
