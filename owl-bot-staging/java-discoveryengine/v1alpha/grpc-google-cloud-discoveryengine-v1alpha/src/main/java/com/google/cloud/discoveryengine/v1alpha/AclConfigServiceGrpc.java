...
public final class AclConfigServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.discoveryengine.v1alpha.AclConfigService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest,
      com.google.cloud.discoveryengine.v1alpha.AclConfig> getUpdateAclConfigMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest,
      com.google.cloud.discoveryengine.v1alpha.AclConfig> getUpdateAclConfigMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest, com.google.cloud.discoveryengine.v1alpha.AclConfig> getUpdateAclConfigMethod;
    if ((getUpdateAclConfigMethod = AclConfigServiceGrpc.getUpdateAclConfigMethod) == null) {
      synchronized (AclConfigServiceGrpc.class) {
        if ((getUpdateAclConfigMethod = AclConfigServiceGrpc.getUpdateAclConfigMethod) == null) {
          AclConfigServiceGrpc.getUpdateAclConfigMethod = getUpdateAclConfigMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest, com.google.cloud.discoveryengine.v1alpha.AclConfig>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateAclConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.AclConfig.getDefaultInstance()))
              .setSchemaDescriptor(new AclConfigServiceMethodDescriptorSupplier("UpdateAclConfig"))
              .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest,
      com.google.cloud.discoveryengine.v1alpha.AclConfig> getGetAclConfigMethod;
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      responseType = com.google.cloud.discoveryengine.v1alpha.AclConfig.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest,
      com.google.cloud.discoveryengine.v1alpha.AclConfig> getGetAclConfigMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest, com.google.cloud.discoveryengine.v1alpha.AclConfig> getGetAclConfigMethod;
    if ((getGetAclConfigMethod = AclConfigServiceGrpc.getGetAclConfigMethod) == null) {
      synchronized (AclConfigServiceGrpc.class) {
        if ((getGetAclConfigMethod = AclConfigServiceGrpc.getGetAclConfigMethod) == null) {
          AclConfigServiceGrpc.getGetAclConfigMethod = getGetAclConfigMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest, com.google.cloud.discoveryengine.v1alpha.AclConfig>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetAclConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.AclConfig.getDefaultInstance()))
              .setSchemaDescriptor(new AclConfigServiceMethodDescriptorSupplier("GetAclConfig"))
              .build();
        }
      }
    }
  ...
  public static AclConfigServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AclConfigServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<AclConfigServiceStub>() {
        @java.lang.Override
        public AclConfigServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static AclConfigServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<AclConfigServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<AclConfigServiceBlockingStub>() {
        @java.lang.Override
        public AclConfigServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   */
  public static AclConfigServiceFutureStub newFutureStub(
      io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AclConfigServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<AclConfigServiceFutureStub>() {
        @java.lang.Override
        public AclConfigServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void updateAclConfig(com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.AclConfig> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateAclConfigMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void getAclConfig(com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.AclConfig> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetAclConfigMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class AclConfigServiceImplBase
  ...
  public static final class AclConfigServiceStub
    ...
    private AclConfigServiceStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected AclConfigServiceStub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new AclConfigServiceStub(channel, callOptions);
    }
     ...
     * </pre>
     */
    public void updateAclConfig(com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.AclConfig> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUpdateAclConfigMethod(), getCallOptions()), request, responseObserver);
    }
     ...
     * </pre>
     */
    public void getAclConfig(com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.AclConfig> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetAclConfigMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class AclConfigServiceBlockingStub
    ...
    private AclConfigServiceBlockingStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1alpha.AclConfig updateAclConfig(com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest request) {
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1alpha.AclConfig getAclConfig(com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest request) {
      return io.grpc.stub.ClientCalls.blockingUnaryCall(
  ...
  public static final class AclConfigServiceFutureStub
    ...
    private AclConfigServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.discoveryengine.v1alpha.AclConfig> updateAclConfig(
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.discoveryengine.v1alpha.AclConfig> getAclConfig(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_UPDATE_ACL_CONFIG:
          serviceImpl.updateAclConfig((com.google.cloud.discoveryengine.v1alpha.UpdateAclConfigRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.AclConfig>) responseObserver);
          break;
        case METHODID_GET_ACL_CONFIG:
          serviceImpl.getAclConfig((com.google.cloud.discoveryengine.v1alpha.GetAclConfigRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.AclConfig>) responseObserver);
          break;
        default:
  ...
  private static abstract class AclConfigServiceBaseDescriptorSupplier
