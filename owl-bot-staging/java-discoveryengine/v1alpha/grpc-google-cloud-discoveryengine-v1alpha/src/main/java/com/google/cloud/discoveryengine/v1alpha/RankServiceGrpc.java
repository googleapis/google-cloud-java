...
public final class RankServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.discoveryengine.v1alpha.RankService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.RankRequest,
      com.google.cloud.discoveryengine.v1alpha.RankResponse> getRankMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.RankRequest,
      com.google.cloud.discoveryengine.v1alpha.RankResponse> getRankMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.RankRequest, com.google.cloud.discoveryengine.v1alpha.RankResponse> getRankMethod;
      ...
      synchronized (RankServiceGrpc.class) {
        if ((getRankMethod = RankServiceGrpc.getRankMethod) == null) {
          RankServiceGrpc.getRankMethod = getRankMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1alpha.RankRequest, com.google.cloud.discoveryengine.v1alpha.RankResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Rank"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.RankRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.RankResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void rank(com.google.cloud.discoveryengine.v1alpha.RankRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.RankResponse> responseObserver) {
  ...
  public static final class RankServiceStub
     ...
     * </pre>
     */
    public void rank(com.google.cloud.discoveryengine.v1alpha.RankRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.RankResponse> responseObserver) {
  ...
  public static final class RankServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1alpha.RankResponse rank(com.google.cloud.discoveryengine.v1alpha.RankRequest request) {
  ...
  public static final class RankServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.discoveryengine.v1alpha.RankResponse> rank(
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_RANK:
          serviceImpl.rank((com.google.cloud.discoveryengine.v1alpha.RankRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.RankResponse>) responseObserver);
          break;
        default:
