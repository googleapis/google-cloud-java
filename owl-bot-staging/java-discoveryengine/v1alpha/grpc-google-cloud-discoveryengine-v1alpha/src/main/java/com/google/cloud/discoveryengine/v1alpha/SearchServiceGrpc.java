...
public final class SearchServiceGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.cloud.discoveryengine.v1alpha.SearchService";

  // Static method descriptors that strictly reflect the proto.
  private static volatile io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.SearchRequest,
      com.google.cloud.discoveryengine.v1alpha.SearchResponse> getSearchMethod;
  ...
  public static io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.SearchRequest,
      com.google.cloud.discoveryengine.v1alpha.SearchResponse> getSearchMethod() {
    io.grpc.MethodDescriptor<com.google.cloud.discoveryengine.v1alpha.SearchRequest, com.google.cloud.discoveryengine.v1alpha.SearchResponse> getSearchMethod;
      ...
      synchronized (SearchServiceGrpc.class) {
        if ((getSearchMethod = SearchServiceGrpc.getSearchMethod) == null) {
          SearchServiceGrpc.getSearchMethod = getSearchMethod =
              io.grpc.MethodDescriptor.<com.google.cloud.discoveryengine.v1alpha.SearchRequest, com.google.cloud.discoveryengine.v1alpha.SearchResponse>newBuilder()
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "Search"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.SearchRequest.getDefaultInstance()))
              .setResponseMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
                  com.google.cloud.discoveryengine.v1alpha.SearchResponse.getDefaultInstance()))
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void search(com.google.cloud.discoveryengine.v1alpha.SearchRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceStub
     ...
     * </pre>
     */
    public void search(com.google.cloud.discoveryengine.v1alpha.SearchRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.SearchResponse> responseObserver) {
  ...
  public static final class SearchServiceBlockingStub
     ...
     * </pre>
     */
    public com.google.cloud.discoveryengine.v1alpha.SearchResponse search(com.google.cloud.discoveryengine.v1alpha.SearchRequest request) {
  ...
  public static final class SearchServiceFutureStub
     ...
     * </pre>
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.cloud.discoveryengine.v1alpha.SearchResponse> search(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_SEARCH:
          serviceImpl.search((com.google.cloud.discoveryengine.v1alpha.SearchRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.discoveryengine.v1alpha.SearchResponse>) responseObserver);
          break;
        default:
