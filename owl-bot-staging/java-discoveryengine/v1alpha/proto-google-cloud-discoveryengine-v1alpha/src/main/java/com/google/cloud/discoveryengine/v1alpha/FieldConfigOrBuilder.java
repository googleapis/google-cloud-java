...
public interface FieldConfigOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.FieldType field_type = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.IndexableOption indexable_option = 3;</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.DynamicFacetableOption dynamic_facetable_option = 4;</code>
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.FieldConfig.DynamicFacetableOption getDynamicFacetableOption();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.SearchableOption searchable_option = 5;</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.RetrievableOption retrievable_option = 6;</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.CompletableOption completable_option = 8;</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.FieldConfig.FilterableOption recs_filterable_option = 9;</code>
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.discoveryengine.v1alpha.FieldConfig.AdvancedSiteSearchDataSource advanced_site_search_data_sources = 10;</code>
   * @return A list containing the advancedSiteSearchDataSources.
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.FieldConfig.AdvancedSiteSearchDataSource> getAdvancedSiteSearchDataSourcesList();
  /**
   * <pre>
   * If this field is set, only the corresponding source will be indexed for
   * this field. Otherwise, the values from different sources are merged.
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.FieldConfig.AdvancedSiteSearchDataSource getAdvancedSiteSearchDataSources(int index);
  /**
   * <pre>
   * If this field is set, only the corresponding source will be indexed for
   * this field. Otherwise, the values from different sources are merged.
   ...
   *
   * <code>repeated .google.cloud.discoveryengine.v1alpha.FieldConfig.AdvancedSiteSearchDataSource advanced_site_search_data_sources = 10;</code>
   * @return A list containing the enum numeric values on the wire for advancedSiteSearchDataSources.
   */
