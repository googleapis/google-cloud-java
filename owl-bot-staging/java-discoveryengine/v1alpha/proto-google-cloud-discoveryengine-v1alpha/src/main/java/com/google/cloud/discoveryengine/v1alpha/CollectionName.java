...
public class CollectionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_COLLECTION =
  ...
  public static CollectionName of(String project, String location, String collection) {
    return newBuilder().setProject(project).setLocation(location).setCollection(collection).build();
  }

  public static String format(String project, String location, String collection) {
    return newBuilder()
        .setProject(project)
  ...
  public static CollectionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_COLLECTION.validatedMatch(
            formattedString, "CollectionName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("collection"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_COLLECTION.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_COLLECTION.instantiate(
  ...
  public static class Builder {
    ...
    private Builder(CollectionName collectionName) {
      this.project = collectionName.project;
