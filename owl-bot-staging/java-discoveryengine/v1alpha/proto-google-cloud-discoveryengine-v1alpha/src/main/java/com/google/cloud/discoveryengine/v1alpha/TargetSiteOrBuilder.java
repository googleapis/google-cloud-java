...
public interface TargetSiteOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.TargetSite)
   ...
   * </pre>
   *
   * <code>string provided_uri_pattern = 2 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = INPUT_ONLY];</code>
   ...
   * @return The type.
   */
  com.google.cloud.discoveryengine.v1alpha.TargetSite.Type getType();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.SiteVerificationInfo site_verification_info = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.SiteVerificationInfo site_verification_info = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.discoveryengine.v1alpha.SiteVerificationInfoOrBuilder getSiteVerificationInfoOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.TargetSite.IndexingStatus indexing_status = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.TargetSite.IndexingStatus getIndexingStatus();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.TargetSite.FailureReason failure_reason = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
