...
public interface CheckGroundingRequestOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.GroundingFact> 
      getFactsList();
  /**
   * <pre>
   * List of facts for the grounding check.
   ...
   * <code>repeated .google.cloud.discoveryengine.v1alpha.GroundingFact facts = 3;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.GroundingFactOrBuilder getFactsOrBuilder(
      int index);
