...
public interface EngineOrBuilder extends
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.SimilarDocumentsEngineConfig similar_documents_config = 9;</code>
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.SimilarDocumentsEngineConfig getSimilarDocumentsConfig();
  /**
   * <pre>
   * Additional config specs for a `similar-items` engine.
   * </pre>
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.SimilarDocumentsEngineConfig similar_documents_config = 9;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.SimilarDocumentsEngineConfigOrBuilder getSimilarDocumentsConfigOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.ChatEngineConfig chat_engine_config = 11;</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.SearchEngineConfig search_engine_config = 13;</code>
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.SearchEngineConfig search_engine_config = 13;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.SearchEngineConfigOrBuilder getSearchEngineConfigOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.MediaRecommendationEngineConfig media_recommendation_engine_config = 14;</code>
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.MediaRecommendationEngineConfig getMediaRecommendationEngineConfig();
  /**
   * <pre>
   * Configurations for the Media Engine. Only applicable on the data
   * stores with
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.MediaRecommendationEngineConfig media_recommendation_engine_config = 14;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.MediaRecommendationEngineConfigOrBuilder getMediaRecommendationEngineConfigOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.RecommendationMetadata recommendation_metadata = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.RecommendationMetadata getRecommendationMetadata();
  /**
   * <pre>
   * Output only. Additional information of a recommendation engine. Only
   * applicable if
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.RecommendationMetadata recommendation_metadata = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.RecommendationMetadataOrBuilder getRecommendationMetadataOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.ChatEngineMetadata chat_engine_metadata = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.Engine.ChatEngineMetadata chat_engine_metadata = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Engine.ChatEngineMetadataOrBuilder getChatEngineMetadataOrBuilder();
   ...
   * </pre>
   *
   * <code>.google.cloud.discoveryengine.v1alpha.SolutionType solution_type = 6 [(.google.api.field_behavior) = REQUIRED];</code>
