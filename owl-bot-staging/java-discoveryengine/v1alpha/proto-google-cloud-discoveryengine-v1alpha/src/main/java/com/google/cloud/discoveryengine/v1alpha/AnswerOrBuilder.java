...
public interface AnswerOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.Answer.Citation> 
      getCitationsList();
  /**
   * <pre>
   * Citations.
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.Answer.Reference> 
      getReferencesList();
  /**
   * <pre>
   * References.
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.Answer.Step> 
      getStepsList();
  /**
   * <pre>
   * Answer generation steps.
   ...
   * <code>repeated .google.cloud.discoveryengine.v1alpha.Answer.Step steps = 7;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Answer.StepOrBuilder getStepsOrBuilder(
      int index);
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfo getQueryUnderstandingInfo();
  /**
   * <pre>
   * Query understanding information.
   * </pre>
   ...
   * <code>.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfo query_understanding_info = 10;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.Answer.QueryUnderstandingInfoOrBuilder getQueryUnderstandingInfoOrBuilder();
   ...
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.Answer.AnswerSkippedReason> getAnswerSkippedReasonsList();
  /**
   * <pre>
   * Additional answer-skipped reasons. This provides the reason for ignored
   * cases. If nothing is skipped, this field is not set.
   ...
   */
  com.google.cloud.discoveryengine.v1alpha.Answer.AnswerSkippedReason getAnswerSkippedReasons(int index);
  /**
   * <pre>
   * Additional answer-skipped reasons. This provides the reason for ignored
   * cases. If nothing is skipped, this field is not set.
