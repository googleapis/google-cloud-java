...
public interface RecommendResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.discoveryengine.v1alpha.RecommendResponse)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResult results = 1;</code>
   */
  java.util.List<com.google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResult> 
      getResultsList();
  /**
   * <pre>
   * A list of recommended Documents. The order represents the ranking (from the
   ...
   * <code>repeated .google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResult results = 1;</code>
   */
  com.google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResult getResults(int index);
  /**
   * <pre>
   * A list of recommended Documents. The order represents the ranking (from the
   * most relevant Document to the least).
   ...
   * <code>repeated .google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResult results = 1;</code>
   */
  java.util.List<? extends com.google.cloud.discoveryengine.v1alpha.RecommendResponse.RecommendationResultOrBuilder> 
