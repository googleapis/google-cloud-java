...
public final class RankServiceProto {
  ...
  static {
    ...
    internal_static_google_cloud_discoveryengine_v1alpha_RankingRecord_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_discoveryengine_v1alpha_RankingRecord_descriptor,
        new java.lang.String[] { "Id", "Title", "Content", "Score", });
    internal_static_google_cloud_discoveryengine_v1alpha_RankRequest_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_discoveryengine_v1alpha_RankRequest_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_discoveryengine_v1alpha_RankRequest_descriptor,
        new java.lang.String[] { "RankingConfig", "Model", "TopN", "Query", "Records", "IgnoreRecordDetailsInResponse", });
    internal_static_google_cloud_discoveryengine_v1alpha_RankResponse_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_google_cloud_discoveryengine_v1alpha_RankResponse_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_discoveryengine_v1alpha_RankResponse_descriptor,
