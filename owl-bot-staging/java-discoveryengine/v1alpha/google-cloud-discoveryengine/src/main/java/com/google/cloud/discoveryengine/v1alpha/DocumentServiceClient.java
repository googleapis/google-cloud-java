 ...
 *    <tr>
 *      <td>ListDocuments</td>
 *      <td><p> Gets a list of [Document][google.cloud.discoveryengine.v1alpha.Document]s.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Creates a [Document][google.cloud.discoveryengine.v1alpha.Document].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Updates a [Document][google.cloud.discoveryengine.v1alpha.Document].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Deletes a [Document][google.cloud.discoveryengine.v1alpha.Document].</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p> Permanently deletes all selected [Document][google.cloud.discoveryengine.v1alpha.Document]s in a branch.
 * <p>  This process is asynchronous. Depending on the number of [Document][google.cloud.discoveryengine.v1alpha.Document]s to be deleted, this operation can take hours to complete. Before the delete operation completes, some [Document][google.cloud.discoveryengine.v1alpha.Document]s might still be returned by [DocumentService.GetDocument][google.cloud.discoveryengine.v1alpha.DocumentService.GetDocument] or [DocumentService.ListDocuments][google.cloud.discoveryengine.v1alpha.DocumentService.ListDocuments].
 * <p>  To get a list of the [Document][google.cloud.discoveryengine.v1alpha.Document]s to be deleted, set [PurgeDocumentsRequest.force][google.cloud.discoveryengine.v1alpha.PurgeDocumentsRequest.force] to false.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class DocumentServiceClient implements BackgroundResource {
   ...
   *     [Document][google.cloud.discoveryengine.v1alpha.Document], regardless of whether or not it
   *     exists, a `PERMISSION_DENIED` error is returned.
   *     <p>If the [Document][google.cloud.discoveryengine.v1alpha.Document] to delete does not
   *     exist, a `NOT_FOUND` error is returned.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
   ...
   *
   * <p>To get a list of the [Document][google.cloud.discoveryengine.v1alpha.Document]s to be
   * deleted, set
