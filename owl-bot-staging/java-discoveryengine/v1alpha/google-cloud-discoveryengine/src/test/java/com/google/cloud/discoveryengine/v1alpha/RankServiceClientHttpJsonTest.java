...
public class RankServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static RankServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRankServiceStub.getMethodDescriptors(),
            RankServiceSettings.getDefaultEndpoint());
    RankServiceSettings settings =
        RankServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                RankServiceSettings.defaultHttpJsonTransportProviderBuilder()
