  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasNotificationChannel()) {
      if (!getNotificationChannel()
          .equals(other.getNotificationChannel())) return false;
    }
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.monitoring.v3.UpdateNotificationChannelRequest result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.notificationChannel_ = notificationChannelBuilder_ == null
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26: {
              input.readMessage(
                  getNotificationChannelFieldBuilder().getBuilder(),
                  extensionRegistry);
    ...
    public Builder mergeNotificationChannel(com.google.monitoring.v3.NotificationChannel value) {
      if (notificationChannelBuilder_ == null) {
        if (((bitField0_ & 0x00000002) != 0) &&
          notificationChannel_ != null &&
          notificationChannel_ != com.google.monitoring.v3.NotificationChannel.getDefaultInstance()) {
