...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.monitoring.v3.TypedValue result) {
      int from_bitField0_ = bitField0_;
    }

    private void buildPartialOneofs(com.google.monitoring.v3.TypedValue result) {
      result.valueCase_ = valueCase_;
      result.value_ = this.value_;
      if (valueCase_ == 5 &&
          distributionValueBuilder_ != null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42: {
              input.readMessage(
                  getDistributionValueFieldBuilder().getBuilder(),
                  extensionRegistry);
              valueCase_ = 5;
              break;
            } // case 42
