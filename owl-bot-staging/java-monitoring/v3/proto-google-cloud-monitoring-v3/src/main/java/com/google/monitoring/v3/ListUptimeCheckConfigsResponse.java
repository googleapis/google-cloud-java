...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.monitoring.v3.ListUptimeCheckConfigsResponse result) {
      if (uptimeCheckConfigsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.monitoring.v3.UptimeCheckConfig m =
                  input.readMessage(
                      com.google.monitoring.v3.UptimeCheckConfig.parser(),
                      extensionRegistry);
              if (uptimeCheckConfigsBuilder_ == null) {
                ensureUptimeCheckConfigsIsMutable();
