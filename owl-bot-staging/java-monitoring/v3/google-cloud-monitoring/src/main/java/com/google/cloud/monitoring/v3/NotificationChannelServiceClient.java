 ...
 *      <ul>
 *           <li>listNotificationChannelDescriptors(FolderName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listNotificationChannels(FolderName name)
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>createNotificationChannel(FolderName name, NotificationChannel notificationChannel)
