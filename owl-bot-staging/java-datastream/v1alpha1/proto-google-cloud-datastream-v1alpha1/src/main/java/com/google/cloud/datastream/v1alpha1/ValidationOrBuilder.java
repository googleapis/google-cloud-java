...
public interface ValidationOrBuilder extends
   ...
   */
  java.util.List<com.google.cloud.datastream.v1alpha1.ValidationMessage> 
      getMessageList();
  /**
   * <pre>
   * Messages reflecting the validation results.
   ...
   * <code>repeated .google.cloud.datastream.v1alpha1.ValidationMessage message = 3;</code>
   */
  com.google.cloud.datastream.v1alpha1.ValidationMessageOrBuilder getMessageOrBuilder(
      int index);
