        ...
        switch (tag) {
          ...
          case 818: {
            ...
            if (sourceStreamConfigCase_ == 102) {
              subBuilder = ((com.google.cloud.datastream.v1.PostgresqlSourceConfig) sourceStreamConfig_).toBuilder();
            }
            sourceStreamConfig_ =
                input.readMessage(com.google.cloud.datastream.v1.PostgresqlSourceConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.datastream.v1.PostgresqlSourceConfig) sourceStreamConfig_);
              sourceStreamConfig_ = subBuilder.buildPartial();
            }
