        ...
        switch (tag) {
          ...
          case 810: {
            ...
            if (destinationStreamConfigCase_ == 101) {
              subBuilder = ((com.google.cloud.datastream.v1.BigQueryDestinationConfig) destinationStreamConfig_).toBuilder();
            }
            destinationStreamConfig_ =
                input.readMessage(com.google.cloud.datastream.v1.BigQueryDestinationConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
              subBuilder.mergeFrom((com.google.cloud.datastream.v1.BigQueryDestinationConfig) destinationStreamConfig_);
              destinationStreamConfig_ = subBuilder.buildPartial();
            }
