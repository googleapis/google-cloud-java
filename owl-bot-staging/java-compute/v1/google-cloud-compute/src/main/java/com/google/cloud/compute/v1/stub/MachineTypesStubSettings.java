...
/**
 * Settings class to configure an instance of {@link MachineTypesStub}.
 *
...
public class MachineTypesStubSettings extends StubSettings<MachineTypesStubSettings> {
  ...
  private final PagedCallSettings<ListMachineTypesRequest, MachineTypeList, ListPagedResponse>
      listSettings;
  ...
  private static final PagedListDescriptor<
      ...
      AGGREGATED_LIST_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public AggregatedListMachineTypesRequest injectToken(
                AggregatedListMachineTypesRequest payload, String token) {
              return AggregatedListMachineTypesRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public AggregatedListMachineTypesRequest injectPageSize(
                AggregatedListMachineTypesRequest payload, int pageSize) {
              return AggregatedListMachineTypesRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<Map.Entry<String, MachineTypesScopedList>> extractResources(
                MachineTypeAggregatedList payload) {
              return payload.getItemsMap() == null
                  ? Collections.<Map.Entry<String, MachineTypesScopedList>>emptySet()
                  : payload.getItemsMap().entrySet();
            }
          };

  private static final PagedListDescriptor<ListMachineTypesRequest, MachineTypeList, MachineType>
      LIST_PAGE_STR_DESC =
          new PagedListDescriptor<ListMachineTypesRequest, MachineTypeList, MachineType>() {
            @Override
            public String emptyToken() {
              return "";
            }
            ...
            @Override
            public ListMachineTypesRequest injectToken(
                ListMachineTypesRequest payload, String token) {
              return ListMachineTypesRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListMachineTypesRequest injectPageSize(
                ListMachineTypesRequest payload, int pageSize) {
              return ListMachineTypesRequest.newBuilder(payload).setMaxResults(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListMachineTypesRequest, MachineTypeList, ListPagedResponse>
      LIST_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListMachineTypesRequest, MachineTypeList, ListPagedResponse>() {
            @Override
            public ApiFuture<ListPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListMachineTypesRequest, MachineTypeList> callable,
                ListMachineTypesRequest request,
                ApiCallContext context,
                ApiFuture<MachineTypeList> futureResponse) {
              PageContext<ListMachineTypesRequest, MachineTypeList, MachineType> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<MachineTypesStubSettings, Builder> {
