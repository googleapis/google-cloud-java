...
public class InstanceGroupsClient implements BackgroundResource {
  ...
  public static class AggregatedListPagedResponse
      extends AbstractPagedListResponse<
          ...
          Map.Entry<String, InstanceGroupsScopedList>, AggregatedListPage,
  ...
  public static class ListPagedResponse
      extends AbstractPagedListResponse<
          ListInstanceGroupsRequest, InstanceGroupList, InstanceGroup, ListPage,
  ...
  public static class ListInstancesPagedResponse
      extends AbstractPagedListResponse<
          ...
          ListInstancesPage, ListInstancesFixedSizeCollection> {
