...
public class ZoneOperationsClientTest {
  private static MockHttpService mockService;
  private static ZoneOperationsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonZoneOperationsStub.getMethodDescriptors(),
            ZoneOperationsSettings.getDefaultEndpoint());
    ZoneOperationsSettings settings =
        ZoneOperationsSettings.newBuilder()
            .setTransportChannelProvider(
                ZoneOperationsSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = ZoneOperationsClient.create(settings);
  }
