...
import com.google.cloud.compute.v1.stub.HttpJsonRegionInstanceTemplatesStub;
...
public class RegionInstanceTemplatesClientTest {
  private static MockHttpService mockService;
  private static RegionInstanceTemplatesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRegionInstanceTemplatesStub.getMethodDescriptors(),
            RegionInstanceTemplatesSettings.getDefaultEndpoint());
    RegionInstanceTemplatesSettings settings =
        RegionInstanceTemplatesSettings.newBuilder()
            .setTransportChannelProvider(
                RegionInstanceTemplatesSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = RegionInstanceTemplatesClient.create(settings);
  }
  ...
  public void deleteTest() throws Exception {
    ...
    Operation actualResponse = client.deleteAsync(project, region, instanceTemplate).get();
  ...
  public void deleteExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String instanceTemplate = "instanceTemplate-5147";
      client.deleteAsync(project, region, instanceTemplate).get();
  ...
  public void getTest() throws Exception {
    ...
    InstanceTemplate actualResponse = client.get(project, region, instanceTemplate);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      String instanceTemplate = "instanceTemplate-5147";
      client.get(project, region, instanceTemplate);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, region, instanceTemplateResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      ...
      String region = "region-9622";
      InstanceTemplate instanceTemplateResource = InstanceTemplate.newBuilder().build();
      client.insertAsync(project, region, instanceTemplateResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
