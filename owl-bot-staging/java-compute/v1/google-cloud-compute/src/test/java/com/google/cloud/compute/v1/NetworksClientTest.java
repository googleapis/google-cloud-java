...
public class NetworksClientTest {
  ...
  private static NetworksClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonNetworksStub.getMethodDescriptors(), NetworksSettings.getDefaultEndpoint());
    NetworksSettings settings =
        NetworksSettings.newBuilder()
            .setTransportChannelProvider(
                NetworksSettings.defaultHttpJsonTransportProviderBuilder()
                    .setHttpTransport(mockService)
                    .build())
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = NetworksClient.create(settings);
  }
  ...
  @Test
  public void addPeeringTest() throws Exception {
  ...
  @Test
  public void addPeeringExceptionTest() throws Exception {
  ...
  public void getTest() throws Exception {
    Network expectedResponse =
        Network.newBuilder()
            .setIPv4Range("iPv4Range100411000")
  ...
  public void getEffectiveFirewallsTest() throws Exception {
    NetworksGetEffectiveFirewallsResponse expectedResponse =
        NetworksGetEffectiveFirewallsResponse.newBuilder()
            .addAllFirewallPolicys(
                new ArrayList<NetworksGetEffectiveFirewallsResponseEffectiveFirewallPolicy>())
  ...
  public void listPeeringRoutesTest() throws Exception {
    ExchangedPeeringRoute responsesElement = ExchangedPeeringRoute.newBuilder().build();
  ...
  @Test
  public void removePeeringTest() throws Exception {
    Operation expectedResponse =
        Operation.newBuilder()
            .setClientOperationId("clientOperationId-1230366697")
            .setCreationTimestamp("creationTimestamp-370203401")
  ...
  @Test
  public void removePeeringExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void switchToCustomModeTest() throws Exception {
    Operation expectedResponse =
        Operation.newBuilder()
            .setClientOperationId("clientOperationId-1230366697")
            .setCreationTimestamp("creationTimestamp-370203401")
  ...
  @Test
  public void switchToCustomModeExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
  ...
  @Test
  public void updatePeeringTest() throws Exception {
    Operation expectedResponse =
        Operation.newBuilder()
            .setClientOperationId("clientOperationId-1230366697")
            .setCreationTimestamp("creationTimestamp-370203401")
  ...
  @Test
  public void updatePeeringExceptionTest() throws Exception {
    ApiException exception =
        ApiExceptionFactory.createException(
            new Exception(), FakeStatusCode.of(StatusCode.Code.INVALID_ARGUMENT), false);
    mockService.addException(exception);
