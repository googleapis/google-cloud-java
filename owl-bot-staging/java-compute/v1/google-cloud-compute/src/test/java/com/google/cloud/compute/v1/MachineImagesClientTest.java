...
import com.google.cloud.compute.v1.stub.HttpJsonMachineImagesStub;
...
public class MachineImagesClientTest {
  private static MockHttpService mockService;
  private static MachineImagesClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonMachineImagesStub.getMethodDescriptors(),
            MachineImagesSettings.getDefaultEndpoint());
    MachineImagesSettings settings =
        MachineImagesSettings.newBuilder()
            .setTransportChannelProvider(
                MachineImagesSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void deleteTest() throws Exception {
    ...
    String machineImage = "machineImage-2214";

    Operation actualResponse = client.deleteAsync(project, machineImage).get();
  ...
  public void getTest() throws Exception {
    MachineImage expectedResponse =
        MachineImage.newBuilder()
            .setCreationTimestamp("creationTimestamp-370203401")
            .setDescription("description-1724546052")
            .setGuestFlush(true)
            .setId(3355)
            .setInstanceProperties(InstanceProperties.newBuilder().build())
            .setKind("kind3292052")
            ...
            .setSelfLink("selfLink1191800166")
            .addAllSourceDiskEncryptionKeys(new ArrayList<SourceDiskEncryptionKey>())
            .setSourceInstance("sourceInstance-808380976")
            .setSourceInstanceProperties(SourceInstanceProperties.newBuilder().build())
            .setStatus("status-892481550")
            .addAllStorageLocations(new ArrayList<String>())
            .setTotalStorageBytes(-1528757268)
            .build();
    mockService.addResponse(expectedResponse);
    ...
    MachineImage actualResponse = client.get(project, machineImage);
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void getExceptionTest() throws Exception {
    ...
    try {
      String project = "project-6911";
      String machineImage = "machineImage-2214";
      client.get(project, machineImage);
      Assert.fail("No exception raised");
  ...
  public void insertTest() throws Exception {
    ...
    Operation actualResponse = client.insertAsync(project, machineImageResource).get();
    Assert.assertEquals(expectedResponse, actualResponse);
  ...
  public void insertExceptionTest() throws Exception {
    ...
    try {
      String project = "project-6911";
      MachineImage machineImageResource = MachineImage.newBuilder().build();
      client.insertAsync(project, machineImageResource).get();
      Assert.fail("No exception raised");
    } catch (ExecutionException e) {
    }
  }
  ...
  public void listTest() throws Exception {
    ...
    MachineImageList expectedResponse =
        MachineImageList.newBuilder()
            .setNextPageToken("")
