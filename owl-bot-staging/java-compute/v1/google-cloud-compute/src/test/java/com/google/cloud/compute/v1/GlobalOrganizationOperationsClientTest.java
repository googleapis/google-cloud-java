...
public class GlobalOrganizationOperationsClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonGlobalOrganizationOperationsStub.getMethodDescriptors(),
            GlobalOrganizationOperationsSettings.getDefaultEndpoint());
    GlobalOrganizationOperationsSettings settings =
        GlobalOrganizationOperationsSettings.newBuilder()
            ...
            .build();
    client = GlobalOrganizationOperationsClient.create(settings);
  }
