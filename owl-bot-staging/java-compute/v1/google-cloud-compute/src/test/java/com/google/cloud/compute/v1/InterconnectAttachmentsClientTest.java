...
public class InterconnectAttachmentsClientTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonInterconnectAttachmentsStub.getMethodDescriptors(),
            InterconnectAttachmentsSettings.getDefaultEndpoint());
    InterconnectAttachmentsSettings settings =
  ...
  public void aggregatedListTest() throws Exception {
    InterconnectAttachmentsScopedList responsesElement =
    ...
    List<Map.Entry<String, InterconnectAttachmentsScopedList>> resources =
  ...
  public void getTest() throws Exception {
    InterconnectAttachment expectedResponse =
        InterconnectAttachment.newBuilder()
            ...
            .setCustomerRouterIpv6InterfaceId("customerRouterIpv6InterfaceId324594694")
