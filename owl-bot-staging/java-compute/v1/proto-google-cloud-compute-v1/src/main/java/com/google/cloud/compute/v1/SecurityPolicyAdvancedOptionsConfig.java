      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 892560842: {
            com.google.cloud.compute.v1.SecurityPolicyAdvancedOptionsConfigJsonCustomConfig.Builder subBuilder = null;
            if (((bitField0_ & 0x00000001) != 0)) {
              subBuilder = jsonCustomConfig_.toBuilder();
            }
            jsonCustomConfig_ = input.readMessage(com.google.cloud.compute.v1.SecurityPolicyAdvancedOptionsConfigJsonCustomConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
    ...
    public Builder mergeJsonCustomConfig(com.google.cloud.compute.v1.SecurityPolicyAdvancedOptionsConfigJsonCustomConfig value) {
      if (jsonCustomConfigBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          ...
          jsonCustomConfig_ =
            com.google.cloud.compute.v1.SecurityPolicyAdvancedOptionsConfigJsonCustomConfig.newBuilder(jsonCustomConfig_).mergeFrom(value).buildPartial();
        } else {
          jsonCustomConfig_ = value;
        }
        onChanged();
