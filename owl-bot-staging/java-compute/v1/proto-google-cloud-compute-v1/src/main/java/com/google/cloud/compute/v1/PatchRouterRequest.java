...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.compute.v1.PatchRouterRequest result) {
      ...
      if (((from_bitField0_ & 0x00000010) != 0)) {
        result.routerResource_ = routerResourceBuilder_ == null
            ? routerResource_
            : routerResourceBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 1241776674: {
              input.readMessage(
                  getRouterResourceFieldBuilder().getBuilder(),
                  extensionRegistry);
