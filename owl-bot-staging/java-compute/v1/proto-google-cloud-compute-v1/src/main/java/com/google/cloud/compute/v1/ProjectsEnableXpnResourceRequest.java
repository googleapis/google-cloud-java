...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.compute.v1.ProjectsEnableXpnResourceRequest result) {
      int from_bitField0_ = bitField0_;
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.xpnResource_ = xpnResourceBuilder_ == null
            ? xpnResource_
            : xpnResourceBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 1067077050: {
              input.readMessage(
                  getXpnResourceFieldBuilder().getBuilder(),
                  extensionRegistry);
