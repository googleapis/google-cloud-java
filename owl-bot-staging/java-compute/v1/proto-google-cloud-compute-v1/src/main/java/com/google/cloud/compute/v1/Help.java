...
private static final long serialVersionUID = 0L;
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 823819722: {
            ...
            links_.add(
                input.readMessage(com.google.cloud.compute.v1.HelpLink.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final com.google.protobuf.Descriptors.Descriptor
      getDescriptor() {
    return com.google.cloud.compute.v1.Compute.internal_static_google_cloud_compute_v1_Help_descriptor;
  }

  @java.lang.Override
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
      internalGetFieldAccessorTable() {
    return com.google.cloud.compute.v1.Compute.internal_static_google_cloud_compute_v1_Help_fieldAccessorTable
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.HelpLinkOrBuilder getLinksOrBuilder(
      int index) {
    return links_.get(index);
  }
  ...
  public static final class Builder extends
    ...
    public Builder setLinks(
        int index, com.google.cloud.compute.v1.HelpLink value) {
      if (linksBuilder_ == null) {
        if (value == null) {
     ...
     */
    public Builder addLinks(
        com.google.cloud.compute.v1.HelpLink.Builder builderForValue) {
      if (linksBuilder_ == null) {
        ensureLinksIsMutable();
     ...
     * <code>repeated .google.cloud.compute.v1.HelpLink links = 102977465;</code>
     */
    public com.google.cloud.compute.v1.HelpLink.Builder getLinksBuilder(
        int index) {
    ...
    public com.google.cloud.compute.v1.HelpLink.Builder addLinksBuilder() {
      return getLinksFieldBuilder().addBuilder(
          com.google.cloud.compute.v1.HelpLink.getDefaultInstance());
    }
    /**
     * <pre>
     * URL(s) pointing to additional information on handling the current error.
    ...
    public com.google.cloud.compute.v1.HelpLink.Builder addLinksBuilder(
        int index) {
      return getLinksFieldBuilder().addBuilder(
          index, com.google.cloud.compute.v1.HelpLink.getDefaultInstance());
    }
    /**
     * <pre>
     * URL(s) pointing to additional information on handling the current error.
     ...
     * <code>repeated .google.cloud.compute.v1.HelpLink links = 102977465;</code>
     */
    public java.util.List<com.google.cloud.compute.v1.HelpLink.Builder> 
         getLinksBuilderList() {
      return getLinksFieldBuilder().getBuilderList();
    }
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.HelpLink, com.google.cloud.compute.v1.HelpLink.Builder, com.google.cloud.compute.v1.HelpLinkOrBuilder> 
        getLinksFieldBuilder() {
      if (linksBuilder_ == null) {
