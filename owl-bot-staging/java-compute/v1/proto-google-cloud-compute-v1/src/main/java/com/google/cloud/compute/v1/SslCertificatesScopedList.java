...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.compute.v1.SslCertificatesScopedList result) {
      if (sslCertificatesBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)) {
    ...
    private void buildPartial0(com.google.cloud.compute.v1.SslCertificatesScopedList result) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case -1366914950: {
              ...
              if (sslCertificatesBuilder_ == null) {
                ensureSslCertificatesIsMutable();
                sslCertificates_.add(m);
              } else {
                sslCertificatesBuilder_.addMessage(m);
              }
              break;
            } // case -1366914950
            default: {
