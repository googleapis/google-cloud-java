      ...
      while (!done) {
        ...
        switch (tag) {
          case 0:
            ...
            break;
          case 31273394: {
            com.google.cloud.compute.v1.LocationPolicyLocationConstraints.Builder subBuilder = null;
            if (((bitField0_ & 0x00000001) != 0)) {
              subBuilder = constraints_.toBuilder();
            }
            constraints_ = input.readMessage(com.google.cloud.compute.v1.LocationPolicyLocationConstraints.parser(), extensionRegistry);
            if (subBuilder != null) {
