...
private static final long serialVersionUID = 0L;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < sourceNatDrainRanges_.size(); i++) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 84802815, sourceNatDrainRanges_.getRaw(i));
    }
    for (int i = 0; i < sourceNatActiveRanges_.size(); i++) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 190556269, sourceNatActiveRanges_.getRaw(i));
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getSourceNatActiveRangesList()
        .equals(other.getSourceNatActiveRangesList())) return false;
    if (!getSourceNatDrainIpsList()
        .equals(other.getSourceNatDrainIpsList())) return false;
    if (!getSourceNatDrainRangesList()
        .equals(other.getSourceNatDrainRangesList())) return false;
  ...
  public static final class Builder extends
    ...
    private void ensureSourceNatActiveRangesIsMutable() {
      if (!sourceNatActiveRanges_.isModifiable()) {
        sourceNatActiveRanges_ = new com.google.protobuf.LazyStringArrayList(sourceNatActiveRanges_);
      }
      bitField0_ |= 0x00000002;
    }
    /**
     ...
     * @return This builder for chaining.
     */
    public Builder setSourceNatActiveRanges(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureSourceNatActiveRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addSourceNatActiveRanges(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureSourceNatActiveRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllSourceNatActiveRanges(
        java.lang.Iterable<java.lang.String> values) {
      ensureSourceNatActiveRangesIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, sourceNatActiveRanges_);
      bitField0_ |= 0x00000002;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addSourceNatActiveRangesBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureSourceNatActiveRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder setSourceNatDrainRanges(
        int index, java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureSourceNatDrainRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addSourceNatDrainRanges(
        java.lang.String value) {
      if (value == null) { throw new NullPointerException(); }
      ensureSourceNatDrainRangesIsMutable();
     ...
     * @return This builder for chaining.
     */
    public Builder addAllSourceNatDrainRanges(
        java.lang.Iterable<java.lang.String> values) {
      ensureSourceNatDrainRangesIsMutable();
      com.google.protobuf.AbstractMessageLite.Builder.addAll(
          values, sourceNatDrainRanges_);
      bitField0_ |= 0x00000008;
      onChanged();
      return this;
    }
     ...
     * @return This builder for chaining.
     */
    public Builder addSourceNatDrainRangesBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      ensureSourceNatDrainRangesIsMutable();
