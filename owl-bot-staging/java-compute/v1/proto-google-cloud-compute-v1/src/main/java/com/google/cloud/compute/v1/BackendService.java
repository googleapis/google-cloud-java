...
private static final long serialVersionUID = 0L;
  ...
  public enum CompressionMode
    ...
    public static CompressionMode forNumber(int value) {
      switch (value) {
        case 0: return UNDEFINED_COMPRESSION_MODE;
        case 165298699: return AUTOMATIC;
  ...
  public enum LocalityLbPolicy
    ...
    public static LocalityLbPolicy forNumber(int value) {
      switch (value) {
        ...
        case 254930962: return WEIGHTED_MAGLEV;
        default: return null;
      }
    }
    ...
    static final com.google.protobuf.MapEntry<
        java.lang.String, java.lang.String> defaultEntry =
            ...
            .<java.lang.String, java.lang.String>newDefaultInstance(
                com.google.cloud.compute.v1.Compute.internal_static_google_cloud_compute_v1_BackendService_MetadatasEntry_descriptor, 
  ...
  private com.google.protobuf.MapField<
      java.lang.String, java.lang.String> metadatas_;
   ...
   */
  @java.lang.Override
  public boolean containsMetadatas(
...
java.lang.String defaultValue) {
   ...
   */
  @java.lang.Override
  public java.lang.String getMetadatasOrThrow(
      java.lang.String key) {
    if (key == null) { throw new NullPointerException("map key"); }
    java.util.Map<java.lang.String, java.lang.String> map =
        internalGetMetadatas().getMap();
   ...
   */
  @java.lang.Override
  public com.google.cloud.compute.v1.BackendServiceUsedByOrBuilder getUsedByOrBuilder(
      int index) {
    return usedBy_.get(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output)
    ...
    for (int i = 0; i < serviceBindings_.size(); i++) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 133581016, serviceBindings_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    for (java.util.Map.Entry<java.lang.String, java.lang.String> entry
      ...
      metadatas__ = MetadatasDefaultEntryHolder.defaultEntry.newBuilderForType()
          .setKey(entry.getKey())
          .setValue(entry.getValue())
          .build();
      size += com.google.protobuf.CodedOutputStream
          .computeMessageSize(8514340, metadatas__);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < customRequestHeaders_.size(); i++) {
    ...
    for (int i = 0; i < usedBy_.size(); i++) {
      size += com.google.protobuf.CodedOutputStream
        .computeMessageSize(389320729, usedBy_.get(i));
    }
    if (((bitField0_ & 0x00000004) != 0)) {
      size += com.google.protobuf.CodedOutputStream
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasCompressionMode()) {
      if (!getCompressionMode()
          .equals(other.getCompressionMode())) return false;
    }
    ...
    if (!internalGetMetadatas().equals(
        other.internalGetMetadatas())) return false;
    ...
    if (hasServiceLbPolicy()) {
      if (!getServiceLbPolicy()
          .equals(other.getServiceLbPolicy())) return false;
    }
    ...
    if (!getUsedByList()
        .equals(other.getUsedByList())) return false;
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.compute.v1.BackendService result) {
      ...
      if (((from_bitField0_ & 0x00000004) != 0)) {
        result.cdnPolicy_ = cdnPolicyBuilder_ == null
            ? cdnPolicy_
            : cdnPolicyBuilder_.build();
      ...
      if (((from_bitField0_ & 0x00000020) != 0)) {
        result.connectionDraining_ = connectionDrainingBuilder_ == null
            ? connectionDraining_
            : connectionDrainingBuilder_.build();
        to_bitField0_ |= 0x00000010;
      }
      if (((from_bitField0_ & 0x00000040) != 0)) {
        result.connectionTrackingPolicy_ = connectionTrackingPolicyBuilder_ == null
            ? connectionTrackingPolicy_
            : connectionTrackingPolicyBuilder_.build();
        to_bitField0_ |= 0x00000020;
      }
      if (((from_bitField0_ & 0x00000080) != 0)) {
        result.consistentHash_ = consistentHashBuilder_ == null
            ? consistentHash_
            : consistentHashBuilder_.build();
      ...
      if (((from_bitField0_ & 0x00004000) != 0)) {
        result.failoverPolicy_ = failoverPolicyBuilder_ == null
            ? failoverPolicy_
            : failoverPolicyBuilder_.build();
    ...
    private void buildPartial1(com.google.cloud.compute.v1.BackendService result) {
      ...
      if (((from_bitField1_ & 0x00000080) != 0)) {
        result.subsetting_ = subsettingBuilder_ == null
            ? subsetting_
            : subsettingBuilder_.build();
    ...
    public Builder mergeFrom(com.google.cloud.compute.v1.BackendService other) {
      ...
      internalGetMutableMetadatas().mergeFrom(
          other.internalGetMetadatas());
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 68114722: {
              com.google.protobuf.MapEntry<java.lang.String, java.lang.String>
              metadatas__ = input.readMessage(
                  MetadatasDefaultEntryHolder.defaultEntry.getParserForType(), extensionRegistry);
              internalGetMutableMetadatas().getMutableMap().put(
                  metadatas__.getKey(), metadatas__.getValue());
              bitField0_ |= 0x02000000;
              break;
            } // case 68114722
            case 223823938: {
            ...
            case 845269242: {
              input.readMessage(
                  getFailoverPolicyFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 1127860458: {
              com.google.cloud.compute.v1.BackendServiceLocalityLoadBalancingPolicyConfig m =
                  input.readMessage(
                      com.google.cloud.compute.v1.BackendServiceLocalityLoadBalancingPolicyConfig.parser(),
                      extensionRegistry);
              if (localityLbPoliciesBuilder_ == null) {
                ensureLocalityLbPoliciesIsMutable();
            ...
            case 1151959754: {
              input.readMessage(
                  getConnectionTrackingPolicyFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case 1711811618: {
              input.readMessage(
                  getCdnPolicyFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case -692699006: {
              input.readMessage(
                  getSubsettingFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case -606193318: {
              input.readMessage(
                  getConnectionDrainingFieldBuilder().getBuilder(),
                  extensionRegistry);
            ...
            case -208248070: {
              com.google.cloud.compute.v1.Backend m =
                  input.readMessage(
                      com.google.cloud.compute.v1.Backend.parser(),
                      extensionRegistry);
              if (backendsBuilder_ == null) {
                ensureBackendsIsMutable();
                backends_.add(m);
     ...
     * @return This builder for chaining.
     */
    public Builder setCompressionMode(
     ...
     * @return This builder for chaining.
     */
    public Builder setCompressionModeBytes(
    ...
    private com.google.protobuf.MapField<java.lang.String, java.lang.String>
      ...
      if (metadatas_ == null) {
        metadatas_ = com.google.protobuf.MapField.newMapField(
            MetadatasDefaultEntryHolder.defaultEntry);
      }
...
java.lang.String defaultValue) {
    ...
    public Builder clearMetadatas() {
      ...
      internalGetMutableMetadatas().getMutableMap()
          .clear();
      return this;
    }
    /**
     ...
     * <code>map&lt;string, string&gt; metadatas = 8514340;</code>
     */
    public Builder removeMetadatas(
        java.lang.String key) {
      if (key == null) { throw new NullPointerException("map key"); }
      internalGetMutableMetadatas().getMutableMap()
          .remove(key);
     ...
     * <code>map&lt;string, string&gt; metadatas = 8514340;</code>
     */
    public Builder putAllMetadatas(
     ...
     * @return This builder for chaining.
     */
    public Builder setServiceLbPolicyBytes(
        com.google.protobuf.ByteString value) {
      if (value == null) { throw new NullPointerException(); }
      checkByteStringIsUtf8(value);
      serviceLbPolicy_ = value;
    ...
    private void ensureUsedByIsMutable() {
      if (!((bitField1_ & 0x00000200) != 0)) {
        usedBy_ = new java.util.ArrayList<com.google.cloud.compute.v1.BackendServiceUsedBy>(usedBy_);
        bitField1_ |= 0x00000200;
       }
    }

    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.BackendServiceUsedBy, com.google.cloud.compute.v1.BackendServiceUsedBy.Builder, com.google.cloud.compute.v1.BackendServiceUsedByOrBuilder> usedByBuilder_;
    ...
    public Builder setUsedBy(
        int index, com.google.cloud.compute.v1.BackendServiceUsedBy value) {
      if (usedByBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.compute.v1.BackendServiceUsedBy used_by = 389320729;</code>
     */
    public com.google.cloud.compute.v1.BackendServiceUsedBy.Builder getUsedByBuilder(
        int index) {
    ...
    public com.google.cloud.compute.v1.BackendServiceUsedBy.Builder addUsedByBuilder() {
      return getUsedByFieldBuilder().addBuilder(
          com.google.cloud.compute.v1.BackendServiceUsedBy.getDefaultInstance());
    }
    /**
     * <code>repeated .google.cloud.compute.v1.BackendServiceUsedBy used_by = 389320729;</code>
     */
    public com.google.cloud.compute.v1.BackendServiceUsedBy.Builder addUsedByBuilder(
        int index) {
      return getUsedByFieldBuilder().addBuilder(
          index, com.google.cloud.compute.v1.BackendServiceUsedBy.getDefaultInstance());
    }
    /**
     * <code>repeated .google.cloud.compute.v1.BackendServiceUsedBy used_by = 389320729;</code>
     */
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
        com.google.cloud.compute.v1.BackendServiceUsedBy, com.google.cloud.compute.v1.BackendServiceUsedBy.Builder, com.google.cloud.compute.v1.BackendServiceUsedByOrBuilder> 
        getUsedByFieldBuilder() {
      if (usedByBuilder_ == null) {
