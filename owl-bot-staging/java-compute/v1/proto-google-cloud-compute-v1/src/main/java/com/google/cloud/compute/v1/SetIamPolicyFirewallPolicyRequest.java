  ...
  public static final class Builder extends
    ...
    public Builder clear() {
      ...
      if (globalOrganizationSetPolicyRequestResourceBuilder_ != null) {
        globalOrganizationSetPolicyRequestResourceBuilder_.dispose();
    ...
    private void buildPartial0(com.google.cloud.compute.v1.SetIamPolicyFirewallPolicyRequest result) {
      int from_bitField0_ = bitField0_;
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.globalOrganizationSetPolicyRequestResource_ = globalOrganizationSetPolicyRequestResourceBuilder_ == null
    ...
    public Builder mergeGlobalOrganizationSetPolicyRequestResource(com.google.cloud.compute.v1.GlobalOrganizationSetPolicyRequest value) {
      if (globalOrganizationSetPolicyRequestResourceBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0) &&
          globalOrganizationSetPolicyRequestResource_ != null &&
          globalOrganizationSetPolicyRequestResource_ != com.google.cloud.compute.v1.GlobalOrganizationSetPolicyRequest.getDefaultInstance()) {
          getGlobalOrganizationSetPolicyRequestResourceBuilder().mergeFrom(value);
        } else {
          globalOrganizationSetPolicyRequestResource_ = value;
        }
      } else {
