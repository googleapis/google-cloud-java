...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.compute.v1.ServiceAttachmentsScopedList result) {
      if (serviceAttachmentsBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)) {
          ...
          switch (tag) {
            ...
            case -1837872846: {
              com.google.cloud.compute.v1.ServiceAttachment m =
                  input.readMessage(
                      com.google.cloud.compute.v1.ServiceAttachment.parser(),
                      extensionRegistry);
              if (serviceAttachmentsBuilder_ == null) {
                ensureServiceAttachmentsIsMutable();
