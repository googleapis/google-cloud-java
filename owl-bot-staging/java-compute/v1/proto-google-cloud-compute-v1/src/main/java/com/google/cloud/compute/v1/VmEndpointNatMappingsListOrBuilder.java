...
public interface VmEndpointNatMappingsListOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.compute.v1.VmEndpointNatMappingsList)
   ...
   */
  java.util.List<com.google.cloud.compute.v1.VmEndpointNatMappings> 
      getResultList();
  /**
   * <pre>
   * [Output Only] A list of Nat mapping information of VM endpoints.
   ...
   * <code>repeated .google.cloud.compute.v1.VmEndpointNatMappings result = 139315229;</code>
   */
  com.google.cloud.compute.v1.VmEndpointNatMappingsOrBuilder getResultOrBuilder(
      int index);
