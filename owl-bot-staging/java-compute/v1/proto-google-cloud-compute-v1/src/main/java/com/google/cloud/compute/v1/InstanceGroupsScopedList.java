        ...
        switch (tag) {
          ...
          case -1363212814: {
            if (!((mutable_bitField0_ & 0x00000001) != 0)) {
              instanceGroups_ = new java.util.ArrayList<com.google.cloud.compute.v1.InstanceGroup>();
              mutable_bitField0_ |= 0x00000001;
            }
            instanceGroups_.add(
                input.readMessage(com.google.cloud.compute.v1.InstanceGroup.parser(), extensionRegistry));
            break;
          }
          default: {
  ...
  public static final class Builder extends
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage = (com.google.cloud.compute.v1.InstanceGroupsScopedList) e.getUnfinishedMessage();
