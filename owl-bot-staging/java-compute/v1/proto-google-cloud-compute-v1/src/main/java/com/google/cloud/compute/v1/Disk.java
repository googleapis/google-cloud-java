      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 626510898: {
            ...
            params_ = input.readMessage(com.google.cloud.compute.v1.DiskParams.parser(), extensionRegistry);
            if (subBuilder != null) {
    ...
    public Builder mergeParams(com.google.cloud.compute.v1.DiskParams value) {
      if (paramsBuilder_ == null) {
        if (((bitField0_ & 0x00010000) != 0) &&
          ...
          params_ =
            com.google.cloud.compute.v1.DiskParams.newBuilder(params_).mergeFrom(value).buildPartial();
        } else {
          params_ = value;
        }
        onChanged();
