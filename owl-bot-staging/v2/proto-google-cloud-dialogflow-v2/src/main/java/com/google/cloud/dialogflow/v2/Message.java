      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 58: {
            ...
            messageAnnotation_ = input.readMessage(com.google.cloud.dialogflow.v2.MessageAnnotation.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 66: {
            ...
            sentimentAnalysis_ = input.readMessage(com.google.cloud.dialogflow.v2.SentimentAnalysisResult.parser(), extensionRegistry);
            if (subBuilder != null) {
