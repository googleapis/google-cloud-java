    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 82: {
            com.google.cloud.dialogflow.v2.SentimentAnalysisRequestConfig.Builder subBuilder = null;
            if (sentimentAnalysisRequestConfig_ != null) {
              subBuilder = sentimentAnalysisRequestConfig_.toBuilder();
            }
            sentimentAnalysisRequestConfig_ = input.readMessage(com.google.cloud.dialogflow.v2.SentimentAnalysisRequestConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
