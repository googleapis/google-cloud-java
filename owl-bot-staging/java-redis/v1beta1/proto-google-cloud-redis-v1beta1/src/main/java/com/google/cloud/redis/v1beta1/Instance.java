...
private static final long serialVersionUID = 0L;
        ...
        switch (tag) {
          ...
          case 202: {
            if (!((mutable_bitField0_ & 0x00000004) != 0)) {
              serverCaCerts_ = new java.util.ArrayList<com.google.cloud.redis.v1beta1.TlsCertificate>();
              mutable_bitField0_ |= 0x00000004;
            }
            serverCaCerts_.add(
                input.readMessage(com.google.cloud.redis.v1beta1.TlsCertificate.parser(), extensionRegistry));
            break;
          }
          case 208: {
            int rawValue = input.readEnum();
          ...
          case 218: {
            ...
            maintenancePolicy_ = input.readMessage(com.google.cloud.redis.v1beta1.MaintenancePolicy.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 226: {
            ...
            maintenanceSchedule_ = input.readMessage(com.google.cloud.redis.v1beta1.MaintenanceSchedule.parser(), extensionRegistry);
            if (subBuilder != null) {
          ...
          case 298: {
            ...
            persistenceConfig_ = input.readMessage(com.google.cloud.redis.v1beta1.PersistenceConfig.parser(), extensionRegistry);
            if (subBuilder != null) {
  ...
  @java.lang.Override public com.google.cloud.redis.v1beta1.Instance.TransitEncryptionMode getTransitEncryptionMode() {
    @SuppressWarnings("deprecation")
    com.google.cloud.redis.v1beta1.Instance.TransitEncryptionMode result = com.google.cloud.redis.v1beta1.Instance.TransitEncryptionMode.valueOf(transitEncryptionMode_);
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergeMaintenancePolicy(com.google.cloud.redis.v1beta1.MaintenancePolicy value) {
      if (maintenancePolicyBuilder_ == null) {
        if (maintenancePolicy_ != null) {
          maintenancePolicy_ =
            com.google.cloud.redis.v1beta1.MaintenancePolicy.newBuilder(maintenancePolicy_).mergeFrom(value).buildPartial();
        } else {
          maintenancePolicy_ = value;
        }
        onChanged();
      ...
      if (maintenanceScheduleBuilder_ == null) {
        if (maintenanceSchedule_ != null) {
          maintenanceSchedule_ =
            com.google.cloud.redis.v1beta1.MaintenanceSchedule.newBuilder(maintenanceSchedule_).mergeFrom(value).buildPartial();
        } else {
          maintenanceSchedule_ = value;
        }
        onChanged();
  ...
  checkByteStringIsUtf8(value);
    ...
    public Builder mergePersistenceConfig(com.google.cloud.redis.v1beta1.PersistenceConfig value) {
      if (persistenceConfigBuilder_ == null) {
        if (persistenceConfig_ != null) {
          persistenceConfig_ =
            com.google.cloud.redis.v1beta1.PersistenceConfig.newBuilder(persistenceConfig_).mergeFrom(value).buildPartial();
        } else {
          persistenceConfig_ = value;
        }
        onChanged();
