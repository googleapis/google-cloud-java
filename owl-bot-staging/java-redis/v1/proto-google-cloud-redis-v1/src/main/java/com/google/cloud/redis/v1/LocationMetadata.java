...
com.google.cloud.redis.v1.ZoneMetadata defaultValue) {
  ...
  public static final class Builder extends
    ...
    private void buildPartial0(com.google.cloud.redis.v1.LocationMetadata result) {
      int from_bitField0_ = bitField0_;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.availableZones_ = internalGetAvailableZones().build(AvailableZonesDefaultEntryHolder.defaultEntry);
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10: {
              ...
              internalGetMutableAvailableZones().ensureBuilderMap().put(
    ...
    private static final class AvailableZonesConverter implements com.google.protobuf.MapFieldBuilder.Converter<java.lang.String, com.google.cloud.redis.v1.ZoneMetadataOrBuilder, com.google.cloud.redis.v1.ZoneMetadata> {
      @java.lang.Override
      public com.google.cloud.redis.v1.ZoneMetadata build(com.google.cloud.redis.v1.ZoneMetadataOrBuilder val) {
        if (val instanceof com.google.cloud.redis.v1.ZoneMetadata) { return (com.google.cloud.redis.v1.ZoneMetadata) val; }
        return ((com.google.cloud.redis.v1.ZoneMetadata.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, com.google.cloud.redis.v1.ZoneMetadata> defaultEntry() {
        return AvailableZonesDefaultEntryHolder.defaultEntry;
      }
    };
    private static final AvailableZonesConverter availableZonesConverter = new AvailableZonesConverter();

    private com.google.protobuf.MapFieldBuilder<
        java.lang.String, com.google.cloud.redis.v1.ZoneMetadataOrBuilder, com.google.cloud.redis.v1.ZoneMetadata, com.google.cloud.redis.v1.ZoneMetadata.Builder> availableZones_;
    private com.google.protobuf.MapFieldBuilder<java.lang.String, com.google.cloud.redis.v1.ZoneMetadataOrBuilder, com.google.cloud.redis.v1.ZoneMetadata, com.google.cloud.redis.v1.ZoneMetadata.Builder>
        internalGetAvailableZones() {
      if (availableZones_ == null) {
...
com.google.cloud.redis.v1.ZoneMetadata defaultValue) {
      if (key == null) { throw new NullPointerException("map key"); }
      java.util.Map<java.lang.String, com.google.cloud.redis.v1.ZoneMetadataOrBuilder> map = internalGetMutableAvailableZones().ensureBuilderMap();
    ...
    public Builder putAllAvailableZones(
      ...
      for (java.util.Map.Entry<java.lang.String, com.google.cloud.redis.v1.ZoneMetadata> e : values.entrySet()) {
     ...
     * <code>map&lt;string, .google.cloud.redis.v1.ZoneMetadata&gt; available_zones = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
     */
    public com.google.cloud.redis.v1.ZoneMetadata.Builder putAvailableZonesBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, com.google.cloud.redis.v1.ZoneMetadataOrBuilder> builderMap = internalGetMutableAvailableZones().ensureBuilderMap();
      com.google.cloud.redis.v1.ZoneMetadataOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = com.google.cloud.redis.v1.ZoneMetadata.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof com.google.cloud.redis.v1.ZoneMetadata) {
        entry = ((com.google.cloud.redis.v1.ZoneMetadata) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (com.google.cloud.redis.v1.ZoneMetadata.Builder) entry;
    }
    @java.lang.Override
