...
public final class AccessApprovalProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "al.v1.ListApprovalRequestsResponse\"\226\001\332A\006" +
      "parent\202\323\344\223\002\206\001\022(/v1/{parent=projects/*}/a" +
      "pprovalRequestsZ)\022\'/v1/{parent=folders/*" +
      "}/approvalRequestsZ/\022-/v1/{parent=organi" +
      "zations/*}/approvalRequests\022\227\002\n\022GetAppro" +
      ...
      "\001\332A\004name\202\323\344\223\002\206\001\022(/v1/{name=projects/*/ap" +
      "provalRequests/*}Z)\022\'/v1/{name=folders/*" +
      "/approvalRequests/*}Z/\022-/v1/{name=organi" +
      "zations/*/approvalRequests/*}\022\271\002\n\026Approv" +
      ...
      "1.AccessApprovalSettings\"\240\001\332A\004name\202\323\344\223\002\222" +
      "\001\022,/v1/{name=projects/*/accessApprovalSe" +
      "ttings}Z-\022+/v1/{name=folders/*/accessApp" +
      "rovalSettings}Z3\0221/v1/{name=organization" +
      "s/*/accessApprovalSettings}\022\207\003\n\034UpdateAc" +
      ...
      "v1.AccessApprovalSettings\"\351\001\332A\024settings," +
      "update_mask\202\323\344\223\002\313\00125/v1/{settings.name=p" +
      "rojects/*/accessApprovalSettings}:\010setti" +
      "ngsZ@24/v1/{settings.name=folders/*/acce" +
      "ssApprovalSettings}:\010settingsZF2:/v1/{se" +
      "ttings.name=organizations/*/accessApprov" +
      "alSettings}:\010settings\022\236\002\n\034DeleteAccessAp" +
      "provalSettings\022C.google.cloud.accessappr" +
      "oval.v1.DeleteAccessApprovalSettingsMess" +
      "age\032\026.google.protobuf.Empty\"\240\001\332A\004name\202\323\344" +
      "\223\002\222\001*,/v1/{name=projects/*/accessApprova" +
      "lSettings}Z-*+/v1/{name=folders/*/access" +
      "ApprovalSettings}Z3*1/v1/{name=organizat" +
      "ions/*/accessApprovalSettings}\022\261\002\n\037GetAc" +
      ...
      "\"\207\001\332A\004name\202\323\344\223\002z\022$/v1/{name=projects/*/s" +
      "erviceAccount}Z%\022#/v1/{name=folders/*/se" +
      "rviceAccount}Z+\022)/v1/{name=organizations" +
      "/*/serviceAccount}\032Q\312A\035accessapproval.go" +
