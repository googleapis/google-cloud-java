...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.billing.v1.ListBillingAccountsResponse result) {
      if (billingAccountsBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.billing.v1.BillingAccount m =
                  input.readMessage(
                      com.google.cloud.billing.v1.BillingAccount.parser(),
                      extensionRegistry);
              if (billingAccountsBuilder_ == null) {
                ensureBillingAccountsIsMutable();
