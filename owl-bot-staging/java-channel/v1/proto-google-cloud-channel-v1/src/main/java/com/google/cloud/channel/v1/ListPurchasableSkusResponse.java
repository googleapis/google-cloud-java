...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.cloud.channel.v1.ListPurchasableSkusResponse result) {
      if (purchasableSkusBuilder_ == null) {
          ...
          switch (tag) {
            ...
            case 10: {
              com.google.cloud.channel.v1.PurchasableSku m =
                  input.readMessage(
                      com.google.cloud.channel.v1.PurchasableSku.parser(),
                      extensionRegistry);
              if (purchasableSkusBuilder_ == null) {
                ensurePurchasableSkusIsMutable();
