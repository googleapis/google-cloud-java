...
public final class EntitlementChangesProto {
  ...
  static {
    ...
    internal_static_google_cloud_channel_v1_EntitlementChange_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_channel_v1_EntitlementChange_descriptor,
        new java.lang.String[] { "SuspensionReason", "CancellationReason", "ActivationReason", "OtherChangeReason", "Entitlement", "Offer", "ProvisionedService", "ChangeType", "CreateTime", "OperatorType", "Parameters", "Operator", "ChangeReason", });
    com.google.protobuf.ExtensionRegistry registry =
