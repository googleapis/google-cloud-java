...
```Groovy
implementation 'com.google.cloud:google-cloud-tasks:2.0.5'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-tasks" % "2.0.5"
```
...
Samples are in the [`samples/`](https://github.com/googleapis/java-tasks/tree/master/samples) directory.
