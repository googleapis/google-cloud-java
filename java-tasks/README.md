...
```Groovy
implementation 'com.google.cloud:google-cloud-tasks:2.42.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-tasks" % "2.42.0"
```
...
Cloud Tasks uses both gRPC and HTTP/JSON for the transport layer.
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-tasks/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-tasks/2.42.0
