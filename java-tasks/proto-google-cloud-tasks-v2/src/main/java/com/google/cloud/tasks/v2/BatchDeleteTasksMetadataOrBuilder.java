...
public interface BatchDeleteTasksMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.tasks.v2.BatchDeleteTasksMetadata)
   ...
   * @return The state.
   */
  com.google.cloud.tasks.v2.BatchDeleteTasksMetadata.State getState();
