...
public interface BatchCreateTasksRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.tasks.v2.BatchCreateTasksRequest)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.tasks.v2.CreateTaskRequest> getRequestsList();
   ...
   * </code>
   */
  com.google.cloud.tasks.v2.CreateTaskRequest getRequests(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.tasks.v2.CreateTaskRequestOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.tasks.v2.CreateTaskRequestOrBuilder getRequestsOrBuilder(int index);
