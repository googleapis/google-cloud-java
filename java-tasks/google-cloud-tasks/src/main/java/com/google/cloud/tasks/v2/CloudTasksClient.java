 ...
 *      <td><p> Creates a batch of tasks and adds them to a queue.
 ...
 * <p>  Gets the Customer Managed Encryption Key configured with the Cloud Tasks location. By default there is no kms_key configured.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class CloudTasksClient implements BackgroundResource {
   ...
   *
   * <p>Gets the Customer Managed Encryption Key configured with the Cloud Tasks location. By
