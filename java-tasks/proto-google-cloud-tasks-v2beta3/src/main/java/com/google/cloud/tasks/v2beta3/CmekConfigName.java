...
public class CmekConfigName implements ResourceName {
  ...
  public static @Nullable CmekConfigName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION.validatedMatch(
            formattedString, "CmekConfigName.parse: formattedString not in valid format");
  ...
  public static List<String> toStringList(List<@Nullable CmekConfigName> values) {
