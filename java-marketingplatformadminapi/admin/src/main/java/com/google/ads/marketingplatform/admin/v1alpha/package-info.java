...
/**
 * A client to Google Marketing Platform Admin API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= MarketingplatformAdminServiceClient =======================
 *
 * <p>Service Description: Service Interface for the Google Marketing Platform Admin API.
 *
 * <p>Sample for MarketingplatformAdminServiceClient:
 *
 * <pre>{@code
