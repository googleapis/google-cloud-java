...
```Groovy
implementation 'com.google.ads-marketingplatform:admin:0.40.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.ads-marketingplatform" % "admin" % "0.40.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.ads-marketingplatform/admin/0.40.0
