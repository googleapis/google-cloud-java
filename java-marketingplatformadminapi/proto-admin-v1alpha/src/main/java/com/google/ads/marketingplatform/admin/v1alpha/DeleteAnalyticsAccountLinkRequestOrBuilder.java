...
public interface DeleteAnalyticsAccountLinkRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.marketingplatform.admin.v1alpha.DeleteAnalyticsAccountLinkRequest)
