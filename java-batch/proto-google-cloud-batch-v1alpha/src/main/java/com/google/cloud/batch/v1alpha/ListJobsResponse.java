 ...
 * </pre>
 *
 * Protobuf type {@code google.cloud.batch.v1alpha.ListJobsResponse}
 */
public final class ListJobsResponse extends com.google.protobuf.GeneratedMessageV3
    implements
    // @@protoc_insertion_point(message_implements:google.cloud.batch.v1alpha.ListJobsResponse)
          ...
          case 10:
            {
              if (!((mutable_bitField0_ & 0x00000001) != 0)) {
                jobs_ = new java.util.ArrayList<com.google.cloud.batch.v1alpha.Job>();
                mutable_bitField0_ |= 0x00000001;
              }
              jobs_.add(
                  input.readMessage(
                      com.google.cloud.batch.v1alpha.Job.parser(), extensionRegistry));
              break;
            }
          case 18:
            {
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return com.google.cloud.batch.v1alpha.BatchProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.cloud.batch.v1alpha.ListJobsResponse.class,
            com.google.cloud.batch.v1alpha.ListJobsResponse.Builder.class);
  }

  public static final int JOBS_FIELD_NUMBER = 1;
  private java.util.List<com.google.cloud.batch.v1alpha.Job> jobs_;
  /**
   *
   *
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<com.google.cloud.batch.v1alpha.Job> getJobsList() {
    return jobs_;
  }
  /**
   *
   ...
   */
  @java.lang.Override
  public java.util.List<? extends com.google.cloud.batch.v1alpha.JobOrBuilder>
   ...
   */
  @java.lang.Override
  public com.google.cloud.batch.v1alpha.Job getJobs(int index) {
   ...
   */
  @java.lang.Override
  public com.google.cloud.batch.v1alpha.JobOrBuilder getJobsOrBuilder(int index) {
    return jobs_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.cloud.batch.v1alpha.ListJobsResponse)) {
      return super.equals(obj);
    }
    com.google.cloud.batch.v1alpha.ListJobsResponse other =
        (com.google.cloud.batch.v1alpha.ListJobsResponse) obj;
  ...
  public static com.google.cloud.batch.v1alpha.ListJobsResponse parseFrom(java.nio.ByteBuffer data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }

  public static com.google.cloud.batch.v1alpha.ListJobsResponse parseFrom(
  ...
  public static com.google.cloud.batch.v1alpha.ListJobsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static com.google.cloud.batch.v1alpha.ListJobsResponse parseFrom(java.io.InputStream input)
  ...
  public static com.google.cloud.batch.v1alpha.ListJobsResponse parseDelimitedFrom(
  ...
  public static Builder newBuilder(com.google.cloud.batch.v1alpha.ListJobsResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.cloud.batch.v1alpha.ListJobsResponse)
    ...
    // Construct using com.google.cloud.batch.v1alpha.ListJobsResponse.newBuilder()
    private Builder() {
    ...
    @java.lang.Override
    public com.google.cloud.batch.v1alpha.ListJobsResponse getDefaultInstanceForType() {
      return com.google.cloud.batch.v1alpha.ListJobsResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.batch.v1alpha.ListJobsResponse build() {
      com.google.cloud.batch.v1alpha.ListJobsResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.google.cloud.batch.v1alpha.ListJobsResponse buildPartial() {
      com.google.cloud.batch.v1alpha.ListJobsResponse result =
          new com.google.cloud.batch.v1alpha.ListJobsResponse(this);
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.batch.v1alpha.ListJobsResponse) {
        return mergeFrom((com.google.cloud.batch.v1alpha.ListJobsResponse) other);
      } else {
    ...
    public Builder mergeFrom(com.google.cloud.batch.v1alpha.ListJobsResponse other) {
      if (other == com.google.cloud.batch.v1alpha.ListJobsResponse.getDefaultInstance())
        return this;
      if (jobsBuilder_ == null) {
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.batch.v1alpha.ListJobsResponse parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.batch.v1alpha.ListJobsResponse) e.getUnfinishedMessage();
    ...
    private void ensureJobsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        jobs_ = new java.util.ArrayList<com.google.cloud.batch.v1alpha.Job>(jobs_);
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public Builder setJobs(int index, com.google.cloud.batch.v1alpha.Job value) {
      if (jobsBuilder_ == null) {
        if (value == null) {
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public Builder setJobs(int index, com.google.cloud.batch.v1alpha.Job.Builder builderForValue) {
      if (jobsBuilder_ == null) {
        ensureJobsIsMutable();
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public Builder addJobs(com.google.cloud.batch.v1alpha.Job value) {
      if (jobsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public Builder addJobs(int index, com.google.cloud.batch.v1alpha.Job value) {
      if (jobsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public Builder addJobs(com.google.cloud.batch.v1alpha.Job.Builder builderForValue) {
      if (jobsBuilder_ == null) {
        ensureJobsIsMutable();
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public Builder addJobs(int index, com.google.cloud.batch.v1alpha.Job.Builder builderForValue) {
      if (jobsBuilder_ == null) {
        ensureJobsIsMutable();
    ...
    public Builder addAllJobs(
        java.lang.Iterable<? extends com.google.cloud.batch.v1alpha.Job> values) {
      if (jobsBuilder_ == null) {
        ensureJobsIsMutable();
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public com.google.cloud.batch.v1alpha.Job.Builder getJobsBuilder(int index) {
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public com.google.cloud.batch.v1alpha.Job.Builder addJobsBuilder() {
      return getJobsFieldBuilder()
          .addBuilder(com.google.cloud.batch.v1alpha.Job.getDefaultInstance());
    }
    /**
     *
     *
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public com.google.cloud.batch.v1alpha.Job.Builder addJobsBuilder(int index) {
      return getJobsFieldBuilder()
          .addBuilder(index, com.google.cloud.batch.v1alpha.Job.getDefaultInstance());
    }
    /**
     *
     *
     ...
     * <code>repeated .google.cloud.batch.v1alpha.Job jobs = 1;</code>
     */
    public java.util.List<com.google.cloud.batch.v1alpha.Job.Builder> getJobsBuilderList() {
    ...
    // @@protoc_insertion_point(builder_scope:google.cloud.batch.v1alpha.ListJobsResponse)
  }

  // @@protoc_insertion_point(class_scope:google.cloud.batch.v1alpha.ListJobsResponse)
  private static final com.google.cloud.batch.v1alpha.ListJobsResponse DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new com.google.cloud.batch.v1alpha.ListJobsResponse();
  }

  public static com.google.cloud.batch.v1alpha.ListJobsResponse getDefaultInstance() {
