...
public final class ResourceAllowanceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "3google/cloud/batch/v1alpha/resource_allowance.proto\022\032google.cloud.batch.v1alph"
          ...
          + "tamp.proto\032\032google/type/interval.proto\"\320\004\n"
          + "\021ResourceAllowance\022V\n"
          + "\030usage_resource_allowance\030\004"
          + " \001(\01322.google.cloud.batch.v1alpha.UsageResourceAllowanceH\000\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\010\022\030\n"
          + "\003uid\030\002 \001(\tB\013\340A\003\342\214\317\327\010\002\010\001\0224\n"
          + "\013create_time\030\003 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022N\n"
          + "\006labels\030\005 \003(\01329.google.cloud.b"
          + "atch.v1alpha.ResourceAllowance.LabelsEntryB\003\340A\001\022D\n\r"
          + "notifications\030\006"
          + " \003(\0132(.google.cloud.batch.v1alpha.NotificationB\003\340A\001\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\244\001\352A\240\001\n"
          + "&batch.googleapis.com/ResourceAllowance\022Oprojects/{project}/location"
          + "s/{location}/resourceAllowances/{resourc"
          + "e_allowance}*\022resourceAllowances2\021resourceAllowanceB\024\n"
          + "\022resource_allowance\"\262\001\n"
          + "\026UsageResourceAllowance\022I\n"
          + "\004spec\030\001 \001(\01326.goo"
          + "gle.cloud.batch.v1alpha.UsageResourceAllowanceSpecB\003\340A\002\022M\n"
          + "\006status\030\002 \001(\01328.google"
          + ".cloud.batch.v1alpha.UsageResourceAllowanceStatusB\003\340A\003\"\206\002\n"
          + "\032UsageResourceAllowanceSpec\022\021\n"
          + "\004type\030\001 \001(\tB\003\340A\002\022P\n"
          + "\005limit\030\002 \001(\0132"
          + "<.google.cloud.batch.v1alpha.UsageResourceAllowanceSpec.LimitB\003\340A\002\032\202\001\n"
          + "\005Limit\022J\n"
          + "\017calendar_period\030\001"
          + " \001(\0162*.google.cloud.batch.v1alpha.CalendarPeriodB\003\340A\001H\000\022\027\n"
          + "\005limit\030\002 \001(\001B\003\340A\002H\001\210\001\001B\n\n"
          + "\010durationB\010\n"
          + "\006_limit\"\356\006\n"
          + "\034UsageResourceAllowanceStatus\022F\n"
          + "\005state\030\001"
          + " \001(\01622.google.cloud.batch.v1alpha.ResourceAllowanceStateB\003\340A\003\022_\n"
          + "\014limit_status\030\002 \001(\0132D.google.cloud.batch.v1alpha.Usag"
          + "eResourceAllowanceStatus.LimitStatusB\003\340A\003\022_\n"
          + "\006report\030\003 \001(\0132J.google.cloud.batch.v"
          + "1alpha.UsageResourceAllowanceStatus.ConsumptionReportB\003\340A\003\032\223\001\n"
          + "\013LimitStatus\0228\n"
          + "\024consumption_interval\030\001"
          + " \001(\0132\025.google.type.IntervalB\003\340A\003\022\027\n"
          ...
          + "\024consumption_interval\030\001"
          + " \001(\0132\025.google.type.IntervalB\003\340A\003\022\032\n"
          + "\010consumed\030\002 \001(\001B\003\340A\003H\000\210\001\001B\013\n"
          + "\t_consumed\032\265\002\n"
          + "\021ConsumptionReport\022\221\001\n"
          + "\032latest_period_consumptions\030\001 \003(\0132h.google.clo"
          + "ud.batch.v1alpha.UsageResourceAllowanceS"
          + "tatus.ConsumptionReport.LatestPeriodConsumptionsEntryB\003\340A\003\032\213\001\n"
          + "\035LatestPeriodConsumptionsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022Y\n"
          + "\005value\030\002 \001(\0132J.google.cloud.batch.v1alpha.UsageResou"
          + "rceAllowanceStatus.PeriodConsumption:\0028\001*f\n"
          ...
          + "ud\\Batch\\V1alpha\352\002\035Google::Cloud::Batch::V1alphab\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_batch_v1alpha_ResourceAllowance_LabelsEntry_descriptor =
        internal_static_google_cloud_batch_v1alpha_ResourceAllowance_descriptor.getNestedType(0);
    internal_static_google_cloud_batch_v1alpha_ResourceAllowance_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_ResourceAllowance_LabelsEntry_descriptor,
            new java.lang.String[] {
