...
public interface ListResourceAllowancesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.batch.v1alpha.ListResourceAllowancesResponse)
   ...
   * <code>repeated .google.cloud.batch.v1alpha.ResourceAllowance resource_allowances = 1;</code>
   */
  com.google.cloud.batch.v1alpha.ResourceAllowanceOrBuilder getResourceAllowancesOrBuilder(
      int index);
