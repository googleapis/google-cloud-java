  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "me.proto\032\036google/protobuf/duration.proto\032\037google/protobuf/timestamp.proto\"b\n"
          ...
          + "TaskStatus\022;\n"
          + "\005state\030\001 \001(\0162,.google.cloud.batch.v1alpha.TaskStatus.State\022>\n\r"
          + "status_events\030\002 \003(\0132\'.google.cloud.batch.v1alpha.StatusEvent\022E\n"
          + "\016resource_usage\030\003 \001(\0132-.goo"
          + "gle.cloud.batch.v1alpha.TaskResourceUsage\"q\n"
          + "\005State\022\025\n"
          ...
          + "\010Runnable\022C\n"
          + "\tcontainer\030\001 \001(\0132..google.c"
          + "loud.batch.v1alpha.Runnable.ContainerH\000\022=\n"
          + "\006script\030\002 \001(\0132+.google.cloud.batch.v1alpha.Runnable.ScriptH\000\022?\n"
          + "\007barrier\030\006 \001(\0132"
          + ",.google.cloud.batch.v1alpha.Runnable.BarrierH\000\022\031\n"
          + "\014display_name\030\n"
          ...
          + "\006labels\030\t"
          + " \003(\01320.google.cloud.batch.v1alpha.Runnable.LabelsEntry\032\317\001\n"
          + "\tContainer\022\021\n"
          ...
          + "+.google.cloud.batch.v1alpha.ComputeResource\0223\n"
          ...
          + " \003(\0132+.google.cloud.batch.v1alpha.LifecyclePolicy\022P\n"
          + "\014environments\030\006"
          + " \003(\01326.google.cloud.batch.v1alpha.TaskSpec.EnvironmentsEntryB\002\030\001\0223\n"
          + "\007volumes\030\007 \003(\0132\".google.cloud.batch.v1alpha.Volume\022<\n"
          + "\013environment\030\n"
          ...
          + "\01622.google.cloud.batch.v1alpha.LifecyclePolicy.Action\022U\n"
          + "\020action_condition\030\002 \001(\0132"
          + ";.google.cloud.batch.v1alpha.LifecyclePolicy.ActionCondition\032%\n"
          ...
          + "\006status\030\002 \001(\0132&.google.cloud.batch.v1alpha.TaskStatus:w\352At\n"
          + "\031batch.googleapis.com/Task\022Wprojects/{project}/locations/{location}/job"
          + "s/{job}/taskGroups/{task_group}/tasks/{task}\"\236\003\n"
          + "\013Environment\022I\n"
          + "\tvariables\030\001 \003(\0132"
          + "6.google.cloud.batch.v1alpha.Environment.VariablesEntry\022V\n"
          + "\020secret_variables\030\002 \003("
          + "\0132<.google.cloud.batch.v1alpha.Environment.SecretVariablesEntry\022N\n"
          + "\023encrypted_variables\030\003"
          + " \001(\01321.google.cloud.batch.v1alpha.Environment.KMSEnvMap\0322\n"
          + "\tKMSEnvMap\022\020\n"
          ...
          + "\036com.google.cloud.batch.v1alphaB\tTaskProtoP\001Z4cloud.goo"
          + "gle.com/go/batch/apiv1alpha/batchpb;batc"
          + "hpb\242\002\003GCB\252\002\032Google.Cloud.Batch.V1Alpha\312\002"
          + "\032Google\\Cloud\\Batch\\V1alpha\352\002\035Google::Cloud::Batch::V1alphab\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_batch_v1alpha_Runnable_Container_descriptor =
        internal_static_google_cloud_batch_v1alpha_Runnable_descriptor.getNestedType(0);
    internal_static_google_cloud_batch_v1alpha_Runnable_Container_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Runnable_Container_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Runnable_Script_descriptor =
        internal_static_google_cloud_batch_v1alpha_Runnable_descriptor.getNestedType(1);
    internal_static_google_cloud_batch_v1alpha_Runnable_Script_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Runnable_Script_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Runnable_Barrier_descriptor =
        internal_static_google_cloud_batch_v1alpha_Runnable_descriptor.getNestedType(2);
    internal_static_google_cloud_batch_v1alpha_Runnable_Barrier_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Runnable_Barrier_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Runnable_LabelsEntry_descriptor =
        internal_static_google_cloud_batch_v1alpha_Runnable_descriptor.getNestedType(3);
    internal_static_google_cloud_batch_v1alpha_Runnable_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Runnable_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_TaskSpec_EnvironmentsEntry_descriptor =
        internal_static_google_cloud_batch_v1alpha_TaskSpec_descriptor.getNestedType(0);
    internal_static_google_cloud_batch_v1alpha_TaskSpec_EnvironmentsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_TaskSpec_EnvironmentsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_LifecyclePolicy_ActionCondition_descriptor =
        internal_static_google_cloud_batch_v1alpha_LifecyclePolicy_descriptor.getNestedType(0);
    internal_static_google_cloud_batch_v1alpha_LifecyclePolicy_ActionCondition_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_LifecyclePolicy_ActionCondition_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Task_descriptor = getDescriptor().getMessageType(8);
    internal_static_google_cloud_batch_v1alpha_Task_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Task_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Environment_KMSEnvMap_descriptor =
        internal_static_google_cloud_batch_v1alpha_Environment_descriptor.getNestedType(0);
    internal_static_google_cloud_batch_v1alpha_Environment_KMSEnvMap_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Environment_KMSEnvMap_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Environment_VariablesEntry_descriptor =
        internal_static_google_cloud_batch_v1alpha_Environment_descriptor.getNestedType(1);
    internal_static_google_cloud_batch_v1alpha_Environment_VariablesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Environment_VariablesEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_batch_v1alpha_Environment_SecretVariablesEntry_descriptor =
        internal_static_google_cloud_batch_v1alpha_Environment_descriptor.getNestedType(2);
    internal_static_google_cloud_batch_v1alpha_Environment_SecretVariablesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_batch_v1alpha_Environment_SecretVariablesEntry_descriptor,
            new java.lang.String[] {
