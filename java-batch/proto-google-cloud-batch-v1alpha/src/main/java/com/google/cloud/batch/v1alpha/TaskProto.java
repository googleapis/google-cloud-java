  ...
  static {
    java.lang.String[] descriptorData = {
      "\n%google/cloud/batch/v1alpha/task.proto\022"
          ...
          + "Status\022;\n\005state\030\001 \001(\0162,.google.cloud.bat"
          + "ch.v1alpha.TaskStatus.State\022>\n\rstatus_ev"
          + "ents\030\002 \003(\0132\'.google.cloud.batch.v1alpha."
          + "StatusEvent\022E\n\016resource_usage\030\003 \001(\0132-.go"
          + "ogle.cloud.batch.v1alpha.TaskResourceUsa"
          + "ge\"q\n\005State\022\025\n\021STATE_UNSPECIFIED\020\000\022\013\n\007PE"
          + "NDING\020\001\022\014\n\010ASSIGNED\020\002\022\013\n\007RUNNING\020\003\022\n\n\006FA"
          + "ILED\020\004\022\r\n\tSUCCEEDED\020\005\022\016\n\nUNEXECUTED\020\006\"\'\n"
          + "\021TaskResourceUsage\022\022\n\ncore_hours\030\001 \001(\001\"\271"
          + "\006\n\010Runnable\022C\n\tcontainer\030\001 \001(\0132..google."
          + "cloud.batch.v1alpha.Runnable.ContainerH\000"
          + "\022=\n\006script\030\002 \001(\0132+.google.cloud.batch.v1"
          + "alpha.Runnable.ScriptH\000\022?\n\007barrier\030\006 \001(\013"
          + "2,.google.cloud.batch.v1alpha.Runnable.B"
          + "arrierH\000\022\032\n\014display_name\030\n \001(\tB\004\342A\001\001\022\032\n\022"
          + "ignore_exit_status\030\003 \001(\010\022\022\n\nbackground\030\004"
          + " \001(\010\022\022\n\nalways_run\030\005 \001(\010\022<\n\013environment\030"
          + "\007 \001(\0132\'.google.cloud.batch.v1alpha.Envir"
          + "onment\022*\n\007timeout\030\010 \001(\0132\031.google.protobu"
          + "f.Duration\022@\n\006labels\030\t \003(\01320.google.clou"
          + "d.batch.v1alpha.Runnable.LabelsEntry\032\320\001\n"
          + "\tContainer\022\021\n\timage_uri\030\001 \001(\t\022\020\n\010command"
          + "s\030\002 \003(\t\022\022\n\nentrypoint\030\003 \001(\t\022\017\n\007volumes\030\007"
          + " \003(\t\022\017\n\007options\030\010 \001(\t\022\036\n\026block_external_"
          + "network\030\t \001(\010\022\020\n\010username\030\n \001(\t\022\020\n\010passw"
          + "ord\030\013 \001(\t\022$\n\026enable_image_streaming\030\014 \001("
          + "\010B\004\342A\001\001\0323\n\006Script\022\016\n\004path\030\001 \001(\tH\000\022\016\n\004tex"
          + "t\030\002 \001(\tH\000B\t\n\007command\032\027\n\007Barrier\022\014\n\004name\030"
          + "\001 \001(\t\032-\n\013LabelsEntry\022\013\n\003key\030\001 \001(\t\022\r\n\005val"
          + "ue\030\002 \001(\t:\0028\001B\014\n\nexecutable\"\233\004\n\010TaskSpec\022"
          + "7\n\trunnables\030\010 \003(\0132$.google.cloud.batch."
          + "v1alpha.Runnable\022E\n\020compute_resource\030\003 \001"
          + "(\0132+.google.cloud.batch.v1alpha.ComputeR"
          + "esource\0223\n\020max_run_duration\030\004 \001(\0132\031.goog"
          + "le.protobuf.Duration\022\027\n\017max_retry_count\030"
          + "\005 \001(\005\022G\n\022lifecycle_policies\030\t \003(\0132+.goog"
          + "le.cloud.batch.v1alpha.LifecyclePolicy\022P"
          + "\n\014environments\030\006 \003(\01326.google.cloud.batc"
          + "h.v1alpha.TaskSpec.EnvironmentsEntryB\002\030\001"
          + "\0223\n\007volumes\030\007 \003(\0132\".google.cloud.batch.v"
          + "1alpha.Volume\022<\n\013environment\030\n \001(\0132\'.goo"
          + "gle.cloud.batch.v1alpha.Environment\0323\n\021E"
          + "nvironmentsEntry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002"
          + " \001(\t:\0028\001\"\224\002\n\017LifecyclePolicy\022B\n\006action\030\001"
          + " \001(\01622.google.cloud.batch.v1alpha.Lifecy"
          + "clePolicy.Action\022U\n\020action_condition\030\002 \001"
          + "(\0132;.google.cloud.batch.v1alpha.Lifecycl"
          + "ePolicy.ActionCondition\032%\n\017ActionConditi"
          + "on\022\022\n\nexit_codes\030\001 \003(\005\"?\n\006Action\022\026\n\022ACTI"
          + "ON_UNSPECIFIED\020\000\022\016\n\nRETRY_TASK\020\001\022\r\n\tFAIL"
          + "_TASK\020\002\"\305\001\n\004Task\022\014\n\004name\030\001 \001(\t\0226\n\006status"
          + "\030\002 \001(\0132&.google.cloud.batch.v1alpha.Task"
          + "Status:w\352At\n\031batch.googleapis.com/Task\022W"
          + "projects/{project}/locations/{location}/"
          + "jobs/{job}/taskGroups/{task_group}/tasks"
          + "/{task}\"\236\003\n\013Environment\022I\n\tvariables\030\001 \003"
          + "(\01326.google.cloud.batch.v1alpha.Environm"
          + "ent.VariablesEntry\022V\n\020secret_variables\030\002"
          + " \003(\0132<.google.cloud.batch.v1alpha.Enviro"
          + "nment.SecretVariablesEntry\022N\n\023encrypted_"
          + "variables\030\003 \001(\01321.google.cloud.batch.v1a"
          + "lpha.Environment.KMSEnvMap\0322\n\tKMSEnvMap\022"
          ...
          + "cloud.batch.v1alphaB\tTaskProtoP\001Z4cloud."
