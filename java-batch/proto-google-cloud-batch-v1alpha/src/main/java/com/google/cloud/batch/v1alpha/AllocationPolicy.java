...
public final class AllocationPolicy extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AllocationPolicy(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  private AllocationPolicy() {
    ...
    provisioningModels_ = emptyIntList();
  ...
  public static final class LocationPolicy extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private LocationPolicy(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }

    private LocationPolicy() {
      allowedLocations_ = com.google.protobuf.LazyStringArrayList.emptyList();
      deniedLocations_ = com.google.protobuf.LazyStringArrayList.emptyList();
    }
    ...
    @SuppressWarnings("serial")
    private com.google.protobuf.LazyStringArrayList deniedLocations_ =
        com.google.protobuf.LazyStringArrayList.emptyList();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      for (int i = 0; i < allowedLocations_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, allowedLocations_.getRaw(i));
      }
      for (int i = 0; i < deniedLocations_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, deniedLocations_.getRaw(i));
      }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void buildPartial0(
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          deniedLocations_.makeImmutable();
      ...
      private void ensureDeniedLocationsIsMutable() {
        if (!deniedLocations_.isModifiable()) {
  ...
  public interface DiskOrBuilder
    ...
    com.google.cloud.batch.v1alpha.AllocationPolicy.Disk.DataSourceCase getDataSourceCase();
  }
   ...
   */
  public static final class Disk extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(diskInterface_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 6, diskInterface_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(diskInterface_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(6, diskInterface_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public interface AttachedDiskOrBuilder
    ...
    com.google.cloud.batch.v1alpha.AllocationPolicy.AttachedDisk.AttachedCase getAttachedCase();
  }
   ...
   */
  public static final class AttachedDisk extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private AttachedDisk(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (attachedCase_ == 2) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, attached_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(deviceName_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, deviceName_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (attachedCase_ == 2) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, attached_);
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(deviceName_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, deviceName_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetNewDiskFieldBuilder().getBuilder(), extensionRegistry);
                  attachedCase_ = 1;
                  break;
                } // case 10
              case 18:
      ...
      public com.google.cloud.batch.v1alpha.AllocationPolicy.Disk.Builder getNewDiskBuilder() {
        return internalGetNewDiskFieldBuilder().getBuilder();
      }
      ...
      private com.google.protobuf.SingleFieldBuilder<
              ...
              com.google.cloud.batch.v1alpha.AllocationPolicy.Disk.Builder,
              com.google.cloud.batch.v1alpha.AllocationPolicy.DiskOrBuilder>
          internalGetNewDiskFieldBuilder() {
        if (newDiskBuilder_ == null) {
          if (!(attachedCase_ == 1)) {
  ...
  public static final class Accelerator extends com.google.protobuf.GeneratedMessage
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(driverVersion_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 4, driverVersion_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(driverVersion_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(4, driverVersion_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
   ...
   */
  public static final class InstancePolicy extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private InstancePolicy(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }

    private InstancePolicy() {
      allowedMachineTypes_ = com.google.protobuf.LazyStringArrayList.emptyList();
      machineType_ = "";
      minCpuPlatform_ = "";
    ...
    @SuppressWarnings("serial")
    private com.google.protobuf.LazyStringArrayList allowedMachineTypes_ =
        com.google.protobuf.LazyStringArrayList.emptyList();
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      for (int i = 0; i < allowedMachineTypes_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, allowedMachineTypes_.getRaw(i));
      }
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(reservation_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 7, reservation_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(reservation_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(7, reservation_);
      }
      if (((bitField0_ & 0x00000001) != 0)) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void buildPartial0(
        ...
        int from_bitField0_ = bitField0_;
        if (((from_bitField0_ & 0x00000001) != 0)) {
          allowedMachineTypes_.makeImmutable();
      ...
      private void ensureAllowedMachineTypesIsMutable() {
        if (!allowedMachineTypes_.isModifiable()) {
   ...
   */
  public static final class InstancePolicyOrTemplate extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private InstancePolicyOrTemplate(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (policyTemplateCase_ == 2) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, policyTemplate_);
      }
      if (installGpuDrivers_ != false) {
        output.writeBool(3, installGpuDrivers_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (policyTemplateCase_ == 2) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, policyTemplate_);
      }
      if (installGpuDrivers_ != false) {
        size += com.google.protobuf.CodedOutputStream.computeBoolSize(3, installGpuDrivers_);
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetPolicyFieldBuilder().getBuilder(), extensionRegistry);
   ...
   */
  public static final class NetworkPolicy extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public static final class PlacementPolicy extends com.google.protobuf.GeneratedMessage
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(collocation_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, collocation_);
      }
      if (maxDistance_ != 0L) {
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(collocation_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, collocation_);
      }
      if (maxDistance_ != 0L) {
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.LazyStringArrayList instanceTemplates_ =
      com.google.protobuf.LazyStringArrayList.emptyList();
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList provisioningModels_ = emptyIntList();
  ...
  public com.google.cloud.batch.v1alpha.AllocationPolicy.ProvisioningModel getProvisioningModels(
      int index) {
    return provisioningModels_converter_.convert(provisioningModels_.getInt(index));
  }
  ...
  public int getProvisioningModelsValue(int index) {
    return provisioningModels_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < instanceTemplates_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, instanceTemplates_.getRaw(i));
    }
    ...
    for (int i = 0; i < provisioningModels_.size(); i++) {
      output.writeEnumNoTag(provisioningModels_.getInt(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceAccountEmail_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, serviceAccountEmail_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceAccountEmail_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, serviceAccountEmail_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.cloud.batch.v1alpha.AllocationPolicy result) {
      ...
      if (((from_bitField0_ & 0x00000008) != 0)) {
        instanceTemplates_.makeImmutable();
        result.instanceTemplates_ = instanceTemplates_;
      }
      if (((from_bitField0_ & 0x00000010) != 0)) {
        provisioningModels_.makeImmutable();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 32:
              {
                ...
                ensureProvisioningModelsIsMutable();
                provisioningModels_.addInt(tmpRaw);
                break;
              } // case 32
            case 34:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  provisioningModels_.addInt(input.readEnum());
                }
            ...
            case 82:
              {
                input.readMessage(
                    internalGetPlacementFieldBuilder().getBuilder(), extensionRegistry);
    ...
    private void ensureInstanceTemplatesIsMutable() {
      if (!instanceTemplates_.isModifiable()) {
    ...
    private void ensureProvisioningModelsIsMutable() {
      if (!provisioningModels_.isModifiable()) {
        provisioningModels_ = makeMutableCopy(provisioningModels_);
      }
      bitField0_ |= 0x00000010;
    }
    ...
    public Builder setProvisioningModels(
      ...
      ensureProvisioningModelsIsMutable();
      provisioningModels_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addProvisioningModels(
      ...
      ensureProvisioningModelsIsMutable();
      provisioningModels_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setProvisioningModelsValue(int index, int value) {
      ensureProvisioningModelsIsMutable();
      provisioningModels_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addProvisioningModelsValue(int value) {
      ensureProvisioningModelsIsMutable();
      provisioningModels_.addInt(value);
      onChanged();
      return this;
    }
