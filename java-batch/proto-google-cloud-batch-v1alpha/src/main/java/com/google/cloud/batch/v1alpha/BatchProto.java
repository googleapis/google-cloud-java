  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "source.proto\032$google/cloud/batch/v1alpha/job.proto\0323google/cloud/batch/v1alpha/r"
          + "esource_allowance.proto\032%google/cloud/batch/v1alpha/task.proto\032#google/longrunni"
          ...
          + "\003job\030\003"
          + " \001(\0132\037.google.cloud.batch.v1alpha.JobB\003\340A\002\022\027\n\n"
          ...
          + "\020UpdateJobRequest\0221\n"
          + "\003job\030\001 \001(\0132\037.google.cloud.batch.v1alpha.JobB\003\340A\002\0224\n"
          + "\013update_mask\030\002"
          + " \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\022\037\n\n"
          + "request_id\030\003 \001(\tB\013\340A\001\342\214\317\327\010\002\010\001\"o\n"
          ...
          + "\031batch.googleapis.com/Task\"\360\001\n"
          + "\036CreateResourceAllowanceRequest\022>\n"
          + "\006parent\030\001 \001(\tB.\340A\002\372"
          + "A(\022&batch.googleapis.com/ResourceAllowance\022\035\n"
          + "\025resource_allowance_id\030\002 \001(\t\022N\n"
          + "\022resource_allowance\030\003"
          + " \001(\0132-.google.cloud.batch.v1alpha.ResourceAllowanceB\003\340A\002\022\037\n\n"
          + "request_id\030\004 \001(\tB\013\340A\001\342\214\317\327\010\002\010\001\"[\n"
          + "\033GetResourceAllowanceRequest\022<\n"
          + "\004name\030\001 \001(\tB.\340A\002\372A(\n"
          + "&batch.googleapis.com/ResourceAllowance\"\224\001\n"
          + "\036DeleteResourceAllowanceRequest\022<\n"
          + "\004name\030\001 \001(\tB.\340A\002\372A(\n"
          + "&batch.googleapis.com/ResourceAllowance\022\023\n"
          ...
          + "\035ListResourceAllowancesRequest\022>\n"
          + "\006parent\030\001 \001(\t"
          + "B.\340A\002\372A(\022&batch.googleapis.com/ResourceAllowance\022\026\n"
          + "\tpage_size\030\002 \001(\005B\003\340A\001\022\027\n\n"
          + "page_token\030\003 \001(\tB\003\340A\001\"\232\001\n"
          + "\036ListResourceAllowancesResponse\022J\n"
          + "\023resource_allowances\030\001 \003("
          + "\0132-.google.cloud.batch.v1alpha.ResourceAllowance\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"\307\001\n"
          + "\036UpdateResourceAllowanceRequest\022N\n"
          + "\022resource_allowance\030\001 \001(\0132-."
          + "google.cloud.batch.v1alpha.ResourceAllowanceB\003\340A\002\0224\n"
          + "\013update_mask\030\002"
          + " \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\022\037\n\n"
          ...
          + "\tCreateJob\022,.google.cloud.batch.v1alpha.CreateJobRequest\032\037.googl"
          + "e.cloud.batch.v1alpha.Job\"N\332A\021parent,job"
          + ",job_id\202\323\344\223\0024\"-/v1alpha/{parent=projects/*/locations/*}/jobs:\003job\022\222\001\n"
          + "\006GetJob\022).google.cloud.batch.v1alpha.GetJobRequest\032"
          + "\037.google.cloud.batch.v1alpha.Job\"<\332A\004nam"
          + "e\202\323\344\223\002/\022-/v1alpha/{name=projects/*/locations/*/jobs/*}\022\337\001\n"
          + "\tDeleteJob\022,.google.cl"
          + "oud.batch.v1alpha.DeleteJobRequest\032\035.google.longrunning.Operation\"\204\001\312AE\n"
          + "\025google.protobuf.Empty\022,google.cloud.batch.v1alp"
          + "ha.OperationMetadata\332A\004name\202\323\344\223\002/*-/v1al"
          + "pha/{name=projects/*/locations/*/jobs/*}\022\200\002\n"
          + "\tCancelJob\022,.google.cloud.batch.v1al"
          + "pha.CancelJobRequest\032\035.google.longrunning.Operation\"\245\001\312A\\\n"
          + ",google.cloud.batch.v1alpha.CancelJobResponse\022,google.cloud.ba"
          + "tch.v1alpha.OperationMetadata\332A\004name\202\323\344\223"
          + "\0029\"4/v1alpha/{name=projects/*/locations/*/jobs/*}:cancel:\001*\022\254\001\n"
          + "\tUpdateJob\022,.google.cloud.batch.v1alpha.UpdateJobRequest\032"
          + "\037.google.cloud.batch.v1alpha.Job\"P\332A\017job"
          + ",update_mask\202\323\344\223\002821/v1alpha/{job.name=projects/*/locations/*/jobs/*}:\003job\022\245\001\n"
          + "\010ListJobs\022+.google.cloud.batch.v1alpha.Lis"
          + "tJobsRequest\032,.google.cloud.batch.v1alph"
          + "a.ListJobsResponse\">\332A\006parent\202\323\344\223\002/\022-/v1"
          + "alpha/{parent=projects/*/locations/*}/jobs\022\252\001\n"
          + "\007GetTask\022*.google.cloud.batch.v1alpha.GetTaskRequest\032 .google.cloud.batch."
          + "v1alpha.Task\"Q\332A\004name\202\323\344\223\002D\022B/v1alpha/{n"
          + "ame=projects/*/locations/*/jobs/*/taskGroups/*/tasks/*}\022\275\001\n"
          + "\tListTasks\022,.google.cloud.batch.v1alpha.ListTasksRequest\032-.go"
          + "ogle.cloud.batch.v1alpha.ListTasksRespon"
          + "se\"S\332A\006parent\202\323\344\223\002D\022B/v1alpha/{parent=pr"
          + "ojects/*/locations/*/jobs/*/taskGroups/*}/tasks\022\220\002\n"
          + "\027CreateResourceAllowance\022:.google.cloud.batch.v1alpha.CreateResourceA"
          + "llowanceRequest\032-.google.cloud.batch.v1a"
          + "lpha.ResourceAllowance\"\211\001\332A/parent,resou"
          + "rce_allowance,resource_allowance_id\202\323\344\223\002"
          + "Q\";/v1alpha/{parent=projects/*/locations"
          + "/*}/resourceAllowances:\022resource_allowance\022\312\001\n"
          + "\024GetResourceAllowance\0227.google.cloud.batch.v1alpha.GetResourceAllowanceReq"
          + "uest\032-.google.cloud.batch.v1alpha.Resour"
          + "ceAllowance\"J\332A\004name\202\323\344\223\002=\022;/v1alpha/{na"
          + "me=projects/*/locations/*/resourceAllowances/*}\022\211\002\n"
          + "\027DeleteResourceAllowance\022:.google.cloud.batch.v1alpha.DeleteResourceA"
          + "llowanceRequest\032\035.google.longrunning.Operation\"\222\001\312AE\n"
          + "\025google.protobuf.Empty\022,google.cloud.batch.v1alpha.OperationMetadat"
          + "a\332A\004name\202\323\344\223\002=*;/v1alpha/{name=projects/*/locations/*/resourceAllowances/*}\022\335\001\n"
          + "\026ListResourceAllowances\0229.google.cloud.ba"
          + "tch.v1alpha.ListResourceAllowancesRequest\032:.google.cloud.batch.v1alpha.ListResou"
          + "rceAllowancesResponse\"L\332A\006parent\202\323\344\223\002=\022;"
          + "/v1alpha/{parent=projects/*/locations/*}/resourceAllowances\022\222\002\n"
          + "\027UpdateResourceAllowance\022:.google.cloud.batch.v1alpha.Upd"
          + "ateResourceAllowanceRequest\032-.google.clo"
          + "ud.batch.v1alpha.ResourceAllowance\"\213\001\332A\036"
          + "resource_allowance,update_mask\202\323\344\223\002d2N/v"
          + "1alpha/{resource_allowance.name=projects/*/locations/*/resourceAllowances/*}:\022re"
          + "source_allowance\032H\312A\024batch.googleapis.co"
          + "m\322A.https://www.googleapis.com/auth/cloud-platformB\304\001\n"
          + "\036com.google.cloud.batch.v1alphaB\n"
          + "BatchProtoP\001Z4cloud.google.com/go"
          + "/batch/apiv1alpha/batchpb;batchpb\242\002\003GCB\252"
          + "\002\032Google.Cloud.Batch.V1Alpha\312\002\032Google\\Cl"
          + "oud\\Batch\\V1alpha\352\002\035Google::Cloud::Batch::V1alphab\006proto3"
    };
    descriptor =
