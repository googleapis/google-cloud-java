...
public class ResourceAllowanceName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RESOURCE_ALLOWANCE =
  ...
  protected ResourceAllowanceName() {
    project = null;
    location = null;
    resourceAllowance = null;
  }

  private ResourceAllowanceName(Builder builder) {
    project = Preconditions.checkNotNull(builder.getProject());
    location = Preconditions.checkNotNull(builder.getLocation());
    resourceAllowance = Preconditions.checkNotNull(builder.getResourceAllowance());
  }
  ...
  public static ResourceAllowanceName of(
      String project, String location, String resourceAllowance) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable ResourceAllowanceName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_RESOURCE_ALLOWANCE.validatedMatch(
            formattedString, "ResourceAllowanceName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("resource_allowance"));
  }

  public static List<ResourceAllowanceName> parseList(List<String> formattedStrings) {
    List<ResourceAllowanceName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ResourceAllowanceName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (resourceAllowance != null) {
            fieldMapBuilder.put("resource_allowance", resourceAllowance);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_RESOURCE_ALLOWANCE.instantiate(
        "project", project, "location", location, "resource_allowance", resourceAllowance);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.resourceAllowance, that.resourceAllowance);
    }
    return false;
  }
