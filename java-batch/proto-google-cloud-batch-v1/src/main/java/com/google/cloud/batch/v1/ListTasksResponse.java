...
public final class ListTasksResponse extends com.google.protobuf.GeneratedMessage
  ...
  protected com.google.protobuf.GeneratedMessage.FieldAccessorTable
    ...
    return com.google.cloud.batch.v1.BatchProto
        ...
        .ensureFieldAccessorsInitialized(
            com.google.cloud.batch.v1.ListTasksResponse.class,
            com.google.cloud.batch.v1.ListTasksResponse.Builder.class);
  }
   ...
   */
  @java.lang.Override
  public com.google.cloud.batch.v1.TaskOrBuilder getTasksOrBuilder(int index) {
    return tasks_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof com.google.cloud.batch.v1.ListTasksResponse)) {
      return super.equals(obj);
    }
    com.google.cloud.batch.v1.ListTasksResponse other =
        (com.google.cloud.batch.v1.ListTasksResponse) obj;
  ...
  public static com.google.cloud.batch.v1.ListTasksResponse parseFrom(java.nio.ByteBuffer data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }

  public static com.google.cloud.batch.v1.ListTasksResponse parseFrom(
  ...
  public static com.google.cloud.batch.v1.ListTasksResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static com.google.cloud.batch.v1.ListTasksResponse parseFrom(java.io.InputStream input)
  ...
  public static com.google.cloud.batch.v1.ListTasksResponse parseDelimitedFrom(
  ...
  public static Builder newBuilder(com.google.cloud.batch.v1.ListTasksResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      implements
      // @@protoc_insertion_point(builder_implements:google.cloud.batch.v1.ListTasksResponse)
    ...
    // Construct using com.google.cloud.batch.v1.ListTasksResponse.newBuilder()
    private Builder() {}
    ...
    @java.lang.Override
    public com.google.cloud.batch.v1.ListTasksResponse getDefaultInstanceForType() {
      return com.google.cloud.batch.v1.ListTasksResponse.getDefaultInstance();
    }

    @java.lang.Override
    public com.google.cloud.batch.v1.ListTasksResponse build() {
      com.google.cloud.batch.v1.ListTasksResponse result = buildPartial();
    ...
    @java.lang.Override
    public com.google.cloud.batch.v1.ListTasksResponse buildPartial() {
      com.google.cloud.batch.v1.ListTasksResponse result =
          new com.google.cloud.batch.v1.ListTasksResponse(this);
    ...
    private void buildPartialRepeatedFields(com.google.cloud.batch.v1.ListTasksResponse result) {
      if (tasksBuilder_ == null) {
    ...
    private void buildPartial0(com.google.cloud.batch.v1.ListTasksResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof com.google.cloud.batch.v1.ListTasksResponse) {
        return mergeFrom((com.google.cloud.batch.v1.ListTasksResponse) other);
      } else {
    ...
    public Builder mergeFrom(com.google.cloud.batch.v1.ListTasksResponse other) {
      if (other == com.google.cloud.batch.v1.ListTasksResponse.getDefaultInstance()) return this;
      if (tasksBuilder_ == null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                com.google.cloud.batch.v1.Task m =
                    input.readMessage(com.google.cloud.batch.v1.Task.parser(), extensionRegistry);
                if (tasksBuilder_ == null) {
                  ensureTasksIsMutable();
                  tasks_.add(m);
                } else {
    ...
    private void ensureTasksIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        tasks_ = new java.util.ArrayList<com.google.cloud.batch.v1.Task>(tasks_);
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public Builder setTasks(int index, com.google.cloud.batch.v1.Task value) {
      if (tasksBuilder_ == null) {
        if (value == null) {
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public Builder setTasks(int index, com.google.cloud.batch.v1.Task.Builder builderForValue) {
      if (tasksBuilder_ == null) {
        ensureTasksIsMutable();
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public Builder addTasks(com.google.cloud.batch.v1.Task value) {
      if (tasksBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public Builder addTasks(int index, com.google.cloud.batch.v1.Task value) {
      if (tasksBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public Builder addTasks(com.google.cloud.batch.v1.Task.Builder builderForValue) {
      if (tasksBuilder_ == null) {
        ensureTasksIsMutable();
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public Builder addTasks(int index, com.google.cloud.batch.v1.Task.Builder builderForValue) {
      if (tasksBuilder_ == null) {
        ensureTasksIsMutable();
    ...
    public Builder addAllTasks(
        java.lang.Iterable<? extends com.google.cloud.batch.v1.Task> values) {
      if (tasksBuilder_ == null) {
        ensureTasksIsMutable();
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public java.util.List<? extends com.google.cloud.batch.v1.TaskOrBuilder>
    ...
    public com.google.cloud.batch.v1.Task.Builder addTasksBuilder() {
      return internalGetTasksFieldBuilder()
          .addBuilder(com.google.cloud.batch.v1.Task.getDefaultInstance());
    }
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public com.google.cloud.batch.v1.Task.Builder addTasksBuilder(int index) {
      return internalGetTasksFieldBuilder()
     ...
     * <code>repeated .google.cloud.batch.v1.Task tasks = 1;</code>
     */
    public java.util.List<com.google.cloud.batch.v1.Task.Builder> getTasksBuilderList() {
    ...
    // @@protoc_insertion_point(builder_scope:google.cloud.batch.v1.ListTasksResponse)
  }

  // @@protoc_insertion_point(class_scope:google.cloud.batch.v1.ListTasksResponse)
  private static final com.google.cloud.batch.v1.ListTasksResponse DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new com.google.cloud.batch.v1.ListTasksResponse();
  }

  public static com.google.cloud.batch.v1.ListTasksResponse getDefaultInstance() {
