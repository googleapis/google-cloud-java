  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\003key\030\001 \001(\t\022?\n"
          + "\005value\030\002"
          + " \001(\01320.google.cloud.batch.v1.JobStatus.TaskGroupStatus:\0028\001\"{\n"
          + "\005State\022\025\n"
          ...
          + "\tinstances\030\010"
          + " \003(\0132@.google.cloud.batch.v1.AllocationPolicy.InstancePolicyOrTemplate\022>\n"
          + "\017service_account\030\t \001(\0132%.google.cloud.batch.v1.ServiceAccount\022C\n"
          + "\006labels\030\006 \003(\01323.googl"
          + "e.cloud.batch.v1.AllocationPolicy.LabelsEntry\022F\n"
          + "\007network\030\007"
          + " \001(\01325.google.cloud.batch.v1.AllocationPolicy.NetworkPolicy\022J\n"
          + "\tplacement\030\n"
          ...
          + "gle.cloud.batch.v1.AllocationPolicy.ProvisioningModel\022I\n"
          + "\014accelerators\030\005 \003(\01323.go"
          + "ogle.cloud.batch.v1.AllocationPolicy.Accelerator\022?\n"
          ...
          + ".cloud.batch.v1.AllocationPolicy.NetworkInterface\032<\n"
          ...
          + "\036batch.googleapis.com/TaskGroup\022Jprojects/{project}/locations"
          + "/{location}/jobs/{job}/taskGroups/{task_group}\"/\n"
          + "\016ServiceAccount\022\r\n"
          + "\005email\030\001 \001(\t\022\016\n"
          + "\006scopes\030\002 \003(\tB\251\001\n"
          + "\031com.google.cloud.batch.v1B\010JobProtoP\001Z/cloud.google.com/go/b"
          + "atch/apiv1/batchpb;batchpb\242\002\003GCB\252\002\025Googl"
          + "e.Cloud.Batch.V1\312\002\025Google\\Cloud\\Batch\\V1"
          + "\352\002\030Google::Cloud::Batch::V1b\006proto3"
    };
    descriptor =
