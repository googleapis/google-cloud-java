  ...
  static {
    java.lang.String[] descriptorData = {
      "\n\037google/cloud/batch/v1/job.proto\022\025googl"
          ...
          + "atus.TaskGroupStatus:\0028\001\"\250\001\n\005State\022\025\n\021ST"
          + "ATE_UNSPECIFIED\020\000\022\n\n\006QUEUED\020\001\022\r\n\tSCHEDUL"
          + "ED\020\002\022\013\n\007RUNNING\020\003\022\r\n\tSUCCEEDED\020\004\022\n\n\006FAIL"
          + "ED\020\005\022\030\n\024DELETION_IN_PROGRESS\020\006\022\034\n\030CANCEL"
          + "LATION_IN_PROGRESS\020\007\022\r\n\tCANCELLED\020\010\"\374\002\n\017"
          + "JobNotification\022\024\n\014pubsub_topic\030\001 \001(\t\022?\n"
          + "\007message\030\002 \001(\0132..google.cloud.batch.v1.J"
          + "obNotification.Message\032\304\001\n\007Message\0229\n\004ty"
          + "pe\030\001 \001(\0162+.google.cloud.batch.v1.JobNoti"
          + "fication.Type\022=\n\rnew_job_state\030\002 \001(\0162&.g"
          + "oogle.cloud.batch.v1.JobStatus.State\022?\n\016"
          + "new_task_state\030\003 \001(\0162\'.google.cloud.batc"
          + "h.v1.TaskStatus.State\"K\n\004Type\022\024\n\020TYPE_UN"
          + "SPECIFIED\020\000\022\025\n\021JOB_STATE_CHANGED\020\001\022\026\n\022TA"
          + "SK_STATE_CHANGED\020\002\"\201\017\n\020AllocationPolicy\022"
          + "H\n\010location\030\001 \001(\01326.google.cloud.batch.v"
          + "1.AllocationPolicy.LocationPolicy\022S\n\tins"
          + "tances\030\010 \003(\0132@.google.cloud.batch.v1.All"
          + "ocationPolicy.InstancePolicyOrTemplate\022>"
          + "\n\017service_account\030\t \001(\0132%.google.cloud.b"
          + "atch.v1.ServiceAccount\022C\n\006labels\030\006 \003(\01323"
          + ".google.cloud.batch.v1.AllocationPolicy."
          + "LabelsEntry\022F\n\007network\030\007 \001(\01325.google.cl"
          + "oud.batch.v1.AllocationPolicy.NetworkPol"
          + "icy\022J\n\tplacement\030\n \001(\01327.google.cloud.ba"
          + "tch.v1.AllocationPolicy.PlacementPolicy\022"
          + "\021\n\004tags\030\013 \003(\tB\003\340A\001\032+\n\016LocationPolicy\022\031\n\021"
          + "allowed_locations\030\001 \003(\t\032q\n\004Disk\022\017\n\005image"
          + "\030\004 \001(\tH\000\022\022\n\010snapshot\030\005 \001(\tH\000\022\014\n\004type\030\001 \001"
          + "(\t\022\017\n\007size_gb\030\002 \001(\003\022\026\n\016disk_interface\030\006 "
          + "\001(\tB\r\n\013data_source\032\212\001\n\014AttachedDisk\022@\n\010n"
          + "ew_disk\030\001 \001(\0132,.google.cloud.batch.v1.Al"
          ...
          + "driver_version\030\004 \001(\tB\003\340A\001\032\202\003\n\016InstancePo"
          + "licy\022\024\n\014machine_type\030\002 \001(\t\022\030\n\020min_cpu_pl"
          + "atform\030\003 \001(\t\022U\n\022provisioning_model\030\004 \001(\016"
          + "29.google.cloud.batch.v1.AllocationPolic"
          + "y.ProvisioningModel\022I\n\014accelerators\030\005 \003("
          + "\01323.google.cloud.batch.v1.AllocationPoli"
          + "cy.Accelerator\022?\n\tboot_disk\030\010 \001(\0132,.goog"
          + "le.cloud.batch.v1.AllocationPolicy.Disk\022"
          + "C\n\005disks\030\006 \003(\01324.google.cloud.batch.v1.A"
          + "llocationPolicy.AttachedDisk\022\030\n\013reservat"
          + "ion\030\007 \001(\tB\003\340A\001\032\366\001\n\030InstancePolicyOrTempl"
          ...
          + "u_drivers\030\003 \001(\010\022\036\n\021install_ops_agent\030\004 \001"
          + "(\010B\003\340A\001\022#\n\026block_project_ssh_keys\030\005 \001(\010B"
          ...
          + "google.cloud.batch.v1.AllocationPolicy.N"
          + "etworkInterface\032<\n\017PlacementPolicy\022\023\n\013co"
          + "llocation\030\001 \001(\t\022\024\n\014max_distance\030\002 \001(\003\032-\n"
          + "\013LabelsEntry\022\013\n\003key\030\001 \001(\t\022\r\n\005value\030\002 \001(\t"
          + ":\0028\001\"`\n\021ProvisioningModel\022\"\n\036PROVISIONIN"
          + "G_MODEL_UNSPECIFIED\020\000\022\014\n\010STANDARD\020\001\022\010\n\004S"
          + "POT\020\002\022\017\n\013PREEMPTIBLE\020\003\"\313\004\n\tTaskGroup\022\021\n\004"
          + "name\030\001 \001(\tB\003\340A\003\0227\n\ttask_spec\030\003 \001(\0132\037.goo"
          + "gle.cloud.batch.v1.TaskSpecB\003\340A\002\022\022\n\ntask"
          + "_count\030\004 \001(\003\022\023\n\013parallelism\030\005 \001(\003\022L\n\021sch"
          + "eduling_policy\030\006 \001(\01621.google.cloud.batc"
          + "h.v1.TaskGroup.SchedulingPolicy\022=\n\021task_"
          + "environments\030\t \003(\0132\".google.cloud.batch."
          + "v1.Environment\022\033\n\023task_count_per_node\030\n "
          + "\001(\003\022\032\n\022require_hosts_file\030\013 \001(\010\022\026\n\016permi"
          + "ssive_ssh\030\014 \001(\010\022\034\n\017run_as_non_root\030\016 \001(\010"
          + "B\003\340A\001\"\\\n\020SchedulingPolicy\022!\n\035SCHEDULING_"
          + "POLICY_UNSPECIFIED\020\000\022\027\n\023AS_SOON_AS_POSSI"
          + "BLE\020\001\022\014\n\010IN_ORDER\020\002:o\352Al\n\036batch.googleap"
          + "is.com/TaskGroup\022Jprojects/{project}/loc"
          + "ations/{location}/jobs/{job}/taskGroups/"
          + "{task_group}\"/\n\016ServiceAccount\022\r\n\005email\030"
          + "\001 \001(\t\022\016\n\006scopes\030\002 \003(\tB\251\001\n\031com.google.clo"
          + "ud.batch.v1B\010JobProtoP\001Z/cloud.google.co"
          + "m/go/batch/apiv1/batchpb;batchpb\242\002\003GCB\252\002"
          + "\025Google.Cloud.Batch.V1\312\002\025Google\\Cloud\\Ba"
          + "tch\\V1\352\002\030Google::Cloud::Batch::V1b\006proto"
          + "3"
    };
    descriptor =
