...
public final class Rollout extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42:
            {
              ...
              strategy_ =
                  input.readMessage(
                      com.google.api.servicemanagement.v1.Rollout.TrafficPercentStrategy.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 1602:
            {
              com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy.Builder subBuilder =
                  null;
              ...
              strategy_ =
                  input.readMessage(
                      com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(
                    (com.google.api.servicemanagement.v1.Rollout.DeleteServiceStrategy) strategy_);
            ...
            case 10:
              {
                ...
                com.google.protobuf.MapEntry<java.lang.String, java.lang.Double> percentages__ =
                    input.readMessage(
                        ...
                        extensionRegistry);
                percentages_.getMutableMap().put(percentages__.getKey(), percentages__.getValue());
                break;
              }
            default:
              {
  ...
  public com.google.api.servicemanagement.v1.Rollout.RolloutStatus getStatus() {
    ...
    com.google.api.servicemanagement.v1.Rollout.RolloutStatus result =
        com.google.api.servicemanagement.v1.Rollout.RolloutStatus.valueOf(status_);
    return result == null
