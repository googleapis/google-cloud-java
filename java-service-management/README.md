...
```Groovy
implementation 'com.google.cloud:google-cloud-service-management:2.1.2'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-service-management" % "2.1.2"
```
...
[javadocs]: https://googleapis.dev/java/google-cloud-service-management/latest/index.html
...
[contributing]: https://github.com/googleapis/java-service-management/blob/master/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-service-management/blob/master/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-service-management/blob/master/LICENSE
