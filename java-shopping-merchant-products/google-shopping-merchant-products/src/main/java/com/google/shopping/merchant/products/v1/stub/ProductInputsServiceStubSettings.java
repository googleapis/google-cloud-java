...
/**
 * Settings class to configure an instance of {@link ProductInputsServiceStub}.
 *
 ...
 * ProductInputsServiceStubSettings.Builder productInputsServiceSettingsBuilder =
 *     ProductInputsServiceStubSettings.newBuilder();
 * productInputsServiceSettingsBuilder
 ...
 *             .build());
 * ProductInputsServiceStubSettings productInputsServiceSettings =
 *     productInputsServiceSettingsBuilder.build();
 * }</pre>
 *
...
public class ProductInputsServiceStubSettings
    extends StubSettings<ProductInputsServiceStubSettings> {
  ...
  public UnaryCallSettings<DeleteProductInputRequest, Empty> deleteProductInputSettings() {
    return deleteProductInputSettings;
  }

  public ProductInputsServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcProductInputsServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonProductInputsServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ProductInputsServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ProductInputsServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected ProductInputsServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  protected LibraryMetadata getLibraryMetadata() {
    return LibraryMetadata.newBuilder()
        .setArtifactName("com.google.shopping:google-shopping-merchant-products")
  ...
  public static class Builder
      extends StubSettings.Builder<ProductInputsServiceStubSettings, Builder> {
    ...
    public UnaryCallSettings.Builder<DeleteProductInputRequest, Empty>
        deleteProductInputSettings() {
      return deleteProductInputSettings;
    }

    @Override
    public ProductInputsServiceStubSettings build() throws IOException {
      return new ProductInputsServiceStubSettings(this);
    }
  }
}
