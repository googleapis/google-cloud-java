...
import com.google.shopping.merchant.products.v1.stub.ProductsServiceStub;
...
public class ProductsServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param name Required. The name of the product. Format: `accounts/{account}/products/{product}`
