  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " \001(\01327.g"
          + "oogle.shopping.merchant.products.v1beta.ProductStatusB\003\340A\003:N\352AK\n"
          ...
          + "\372A$\022\"merchantapi.googleapis.com/Product\022\021\n"
          + "\tpage_size\030\002 \001(\005\022\022\n\n"
          + "page_token\030\003 \001(\t\"t\n"
          + "\024ListProductsResponse\022C\n"
          + "\010products\030\001 \003(\013"
          + "21.google.shopping.merchant.products.v1beta.Product\022\027\n"
          + "\017next_page_token\030\002 \001(\t2\347\003\n"
          + "\017ProductsService\022\272\001\n\n"
          + "GetProduct\022;.google.shopping.merchant.products.v1beta.GetPr"
          + "oductRequest\0321.google.shopping.merchant."
          + "products.v1beta.Product\"<\332A\004name\202\323\344\223\002/\022-"
          + "/products/v1beta/{name=accounts/*/products/*}\022\315\001\n"
          + "\014ListProducts\022=.google.shopping.merchant.products.v1beta.ListProductsRe"
          ...
          + ".com\322A\'https://www.googleapis.com/auth/contentB\312\001\n"
          + ",com.google.shopping.merchant.products.v1betaB\r"
          + "ProductsProtoP\001ZNcloud."
          + "google.com/go/shopping/merchant/products/apiv1beta/productspb;productspb\352A8\n"
