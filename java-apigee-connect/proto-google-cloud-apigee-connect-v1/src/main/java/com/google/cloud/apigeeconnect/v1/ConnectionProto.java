  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "i/client.proto\032\037google/api/field_behavior.proto\032\031google/api/resource.proto\"~\n"
          ...
          + "\013connections\030\001 \003(\0132).google.cloud.apigeeconnect.v1.Connection\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"m\n\n"
          + "Connection\022\020\n"
          + "\010endpoint\030\001 \001(\t\0227\n"
          + "\007cluster\030\002 \001(\0132&.google.cloud.apigeeconnect.v1.Cluster\022\024\n"
          ...
          + "ListConnectionsResponse\"@\332A\006parent\202\323\344\223\0021"
          + "\022//v1/{parent=projects/*/endpoints/*}/co"
          + "nnections\032P\312A\034apigeeconnect.googleapis.c"
          + "om\322A.https://www.googleapis.com/auth/cloud-platformB\265\002\n"
          + "!com.google.cloud.apigeeconnect.v1B\017ConnectionProtoP\001ZGcloud.goog"
          + "le.com/go/apigeeconnect/apiv1/apigeeconn"
          + "ectpb;apigeeconnectpb\252\002\035Google.Cloud.Api"
          + "geeConnect.V1\312\002\035Google\\Cloud\\ApigeeConnect\\V1\352\002"
          + " Google::Cloud::ApigeeConnect::V1\352AP\n"
          + "%apigeeconnect.googleapis.com/Endpoint\022\'projects/{project}/endpoints/{endpoi"
          + "nt}b\006proto3"
    };
    descriptor =
