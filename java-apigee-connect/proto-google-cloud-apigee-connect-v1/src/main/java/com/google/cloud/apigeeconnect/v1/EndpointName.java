...
public class EndpointName implements ResourceName {
  private static final PathTemplate PROJECT_ENDPOINT =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/endpoints/{endpoint}");
  ...
  public static EndpointName of(String project, String endpoint) {
    return newBuilder().setProject(project).setEndpoint(endpoint).build();
  }

  public static String format(String project, String endpoint) {
  ...
  public static EndpointName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_ENDPOINT.validatedMatch(
            formattedString, "EndpointName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("endpoint"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_ENDPOINT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_ENDPOINT.instantiate("project", project, "endpoint", endpoint);
  }
