...
public class IndexName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_COLLECTION_INDEX =
  ...
  public static IndexName of(String project, String location, String collection, String index) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String collection, String index) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setCollection(collection)
  ...
  public static IndexName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_COLLECTION_INDEX.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_COLLECTION_INDEX.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_COLLECTION_INDEX.instantiate(
        "project", project, "location", location, "collection", collection, "index", index);
  }
  ...
  /**
   * Builder for projects/{project}/locations/{location}/collections/{collection}/indexes/{index}.
   */
