...
public interface AggregateDataObjectsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vectorsearch.v1.AggregateDataObjectsRequest)
   ...
   *
   * <code>
   * .google.cloud.vectorsearch.v1.AggregationMethod aggregate = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.vectorsearch.v1.AggregationMethod getAggregate();
}
