...
public interface QueryDataObjectsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vectorsearch.v1.QueryDataObjectsRequest)
   ...
   *
   * <code>
   * .google.cloud.vectorsearch.v1.OutputFields output_fields = 7 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
