...
public interface UpdateCollectionRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vectorsearch.v1.UpdateCollectionRequest)
   ...
   *
   * <code>
   * .google.cloud.vectorsearch.v1.Collection collection = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
