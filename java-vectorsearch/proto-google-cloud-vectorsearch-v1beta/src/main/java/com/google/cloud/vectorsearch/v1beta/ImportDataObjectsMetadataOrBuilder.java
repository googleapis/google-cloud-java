...
public interface ImportDataObjectsMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vectorsearch.v1beta.ImportDataObjectsMetadata)
