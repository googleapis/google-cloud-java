...
public interface BatchCreateDataObjectsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vectorsearch.v1beta.BatchCreateDataObjectsResponse)
