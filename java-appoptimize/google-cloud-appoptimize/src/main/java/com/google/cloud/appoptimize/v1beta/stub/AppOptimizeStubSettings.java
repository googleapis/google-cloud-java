...
public class AppOptimizeStubSettings extends StubSettings<AppOptimizeStubSettings> {
  ...
  private final PagedCallSettings<ListReportsRequest, ListReportsResponse, ListReportsPagedResponse>
      listReportsSettings;
  private final UnaryCallSettings<DeleteReportRequest, Empty> deleteReportSettings;
  private final PagedCallSettings<ReadReportRequest, ReadReportResponse, ReadReportPagedResponse>
      readReportSettings;
  ...
  private static final PagedListDescriptor<ReadReportRequest, ReadReportResponse, ListValue>
      READ_REPORT_PAGE_STR_DESC =
          new PagedListDescriptor<ReadReportRequest, ReadReportResponse, ListValue>() {
            @Override
            public String emptyToken() {
              return "";
            }
            ...
            @Override
            public Iterable<ListValue> extractResources(ReadReportResponse payload) {
  ...
  private static final PagedListResponseFactory<
      ...
      READ_REPORT_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ReadReportRequest, ReadReportResponse, ReadReportPagedResponse>() {
            @Override
            public ApiFuture<ReadReportPagedResponse> getFuturePagedResponse(
                UnaryCallable<ReadReportRequest, ReadReportResponse> callable,
                ReadReportRequest request,
                ApiCallContext context,
                ApiFuture<ReadReportResponse> futureResponse) {
              PageContext<ReadReportRequest, ReadReportResponse, ListValue> pageContext =
  ...
  public static class Builder extends StubSettings.Builder<AppOptimizeStubSettings, Builder> {
    ...
    private final PagedCallSettings.Builder<
            ListReportsRequest, ListReportsResponse, ListReportsPagedResponse>
        listReportsSettings;
    private final UnaryCallSettings.Builder<DeleteReportRequest, Empty> deleteReportSettings;
    private final PagedCallSettings.Builder<
            ReadReportRequest, ReadReportResponse, ReadReportPagedResponse>
        readReportSettings;
    private final PagedCallSettings.Builder<
