...
public class ReportName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_REPORT =
  ...
  public static ReportName of(String project, String location, String report) {
    return newBuilder().setProject(project).setLocation(location).setReport(report).build();
  }

  public static String format(String project, String location, String report) {
    return newBuilder()
        .setProject(project)
  ...
  public static ReportName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_REPORT.validatedMatch(
            formattedString, "ReportName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("report"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_REPORT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_REPORT.instantiate(
        "project", project, "location", location, "report", report);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/reports/{report}. */
