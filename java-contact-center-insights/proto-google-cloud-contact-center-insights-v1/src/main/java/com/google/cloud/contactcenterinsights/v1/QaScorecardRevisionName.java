...
public class QaScorecardRevisionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_QA_SCORECARD_REVISION =
  ...
  public static QaScorecardRevisionName of(
      String project, String location, String qaScorecard, String revision) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable QaScorecardRevisionName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_QA_SCORECARD_REVISION.validatedMatch(
            formattedString, "QaScorecardRevisionName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<QaScorecardRevisionName> parseList(List<String> formattedStrings) {
    List<QaScorecardRevisionName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable QaScorecardRevisionName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_QA_SCORECARD_REVISION.instantiate(
        "project",
        project,
        "location",
        location,
