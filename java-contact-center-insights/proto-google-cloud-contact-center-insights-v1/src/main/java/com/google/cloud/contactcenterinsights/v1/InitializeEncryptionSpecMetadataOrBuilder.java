...
public interface InitializeEncryptionSpecMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.contactcenterinsights.v1.InitializeEncryptionSpecMetadata)
   ...
   *
   * <code>
   * .google.cloud.contactcenterinsights.v1.InitializeEncryptionSpecRequest request = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
