...
public interface BulkUploadFeedbackLabelsMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.contactcenterinsights.v1.BulkUploadFeedbackLabelsMetadata)
   ...
   * @return The request.
   */
  com.google.cloud.contactcenterinsights.v1.BulkUploadFeedbackLabelsRequest getRequest();
  /**
   *
   *
   * <pre>
