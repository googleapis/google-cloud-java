...
public final class Settings extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class AnalysisConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private AnalysisConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetAnnotatorSelectorFieldBuilder();
        }
      }
      ...
      public Builder mergeFrom(
        ...
        if (java.lang.Double.doubleToRawLongBits(other.getRuntimeIntegrationAnalysisPercentage())
            != 0) {
          setRuntimeIntegrationAnalysisPercentage(other.getRuntimeIntegrationAnalysisPercentage());
        }
        if (java.lang.Double.doubleToRawLongBits(other.getUploadConversationAnalysisPercentage())
            != 0) {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42:
                {
                  input.readMessage(
                      internalGetAnnotatorSelectorFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.contactcenterinsights.v1.AnnotatorSelector.Builder
        ...
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetAnnotatorSelectorFieldBuilder().getBuilder();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetConversationTtlFieldBuilder();
        internalGetAnalysisConfigFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetConversationTtlFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 58:
              {
                input.readMessage(
                    internalGetAnalysisConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.protobuf.Duration.Builder getConversationTtlBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetConversationTtlFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.contactcenterinsights.v1.Settings.AnalysisConfig.Builder
      ...
      bitField0_ |= 0x00000040;
      onChanged();
      return internalGetAnalysisConfigFieldBuilder().getBuilder();
    }
