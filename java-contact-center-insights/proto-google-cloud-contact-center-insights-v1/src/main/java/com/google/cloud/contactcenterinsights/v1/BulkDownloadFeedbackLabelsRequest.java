...
public final class BulkDownloadFeedbackLabelsRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(conversationFilter_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, conversationFilter_);
    }
    for (int i = 0; i < templateQaScorecardId_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, templateQaScorecardId_.getRaw(i));
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(conversationFilter_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, conversationFilter_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < templateQaScorecardId_.size(); i++) {
