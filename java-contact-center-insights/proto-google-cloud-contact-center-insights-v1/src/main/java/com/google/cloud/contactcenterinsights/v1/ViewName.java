...
public class ViewName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_VIEW =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/views/{view}");
  ...
  public static ViewName of(String project, String location, String view) {
    return newBuilder().setProject(project).setLocation(location).setView(view).build();
  }

  public static String format(String project, String location, String view) {
    return newBuilder().setProject(project).setLocation(location).setView(view).build().toString();
  }

  public static @Nullable ViewName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_VIEW.validatedMatch(
            formattedString, "ViewName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("view"));
  }

  public static List<ViewName> parseList(List<String> formattedStrings) {
    List<ViewName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ViewName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_VIEW.instantiate(
