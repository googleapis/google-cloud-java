...
public final class TuneQaScorecardRevisionMetadata extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TuneQaScorecardRevisionMetadata(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class QaQuestionDatasetValidationResult
    ...
    private QaQuestionDatasetValidationResult() {
      question_ = "";
      datasetValidationWarnings_ = emptyIntList();
    }
    ...
    @SuppressWarnings("serial")
    private com.google.protobuf.Internal.IntList datasetValidationWarnings_ = emptyIntList();
    ...
    public com.google.cloud.contactcenterinsights.v1.DatasetValidationWarning
      ...
      return datasetValidationWarnings_converter_.convert(datasetValidationWarnings_.getInt(index));
    }
    ...
    public int getDatasetValidationWarningsValue(int index) {
      return datasetValidationWarnings_.getInt(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < datasetValidationWarnings_.size(); i++) {
        output.writeEnumNoTag(datasetValidationWarnings_.getInt(i));
      }
        ...
        for (int i = 0; i < datasetValidationWarnings_.size(); i++) {
          dataSize +=
              com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                  datasetValidationWarnings_.getInt(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void buildPartial0(
        ...
        if (((from_bitField0_ & 0x00000002) != 0)) {
          datasetValidationWarnings_.makeImmutable();
              ...
              case 16:
                {
                  ...
                  ensureDatasetValidationWarningsIsMutable();
                  datasetValidationWarnings_.addInt(tmpRaw);
                  break;
                } // case 16
              case 18:
                {
                  ...
                  while (input.getBytesUntilLimit() > 0) {
                    datasetValidationWarnings_.addInt(input.readEnum());
                  }
      ...
      private void ensureDatasetValidationWarningsIsMutable() {
        if (!datasetValidationWarnings_.isModifiable()) {
          datasetValidationWarnings_ = makeMutableCopy(datasetValidationWarnings_);
        }
        bitField0_ |= 0x00000002;
      }
      ...
      public com.google.cloud.contactcenterinsights.v1.DatasetValidationWarning
          getDatasetValidationWarnings(int index) {
        return datasetValidationWarnings_converter_.convert(
            datasetValidationWarnings_.getInt(index));
      }
      ...
      public Builder setDatasetValidationWarnings(
        ...
        ensureDatasetValidationWarningsIsMutable();
        datasetValidationWarnings_.setInt(index, value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder addDatasetValidationWarnings(
        ...
        ensureDatasetValidationWarningsIsMutable();
        datasetValidationWarnings_.addInt(value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder setDatasetValidationWarningsValue(int index, int value) {
        ensureDatasetValidationWarningsIsMutable();
        datasetValidationWarnings_.setInt(index, value);
        onChanged();
        return this;
      }
      ...
      public Builder addDatasetValidationWarningsValue(int value) {
        ensureDatasetValidationWarningsIsMutable();
        datasetValidationWarnings_.addInt(value);
        onChanged();
        return this;
      }
    ...
    public static final class Metrics extends com.google.protobuf.GeneratedMessage
      ...
      public static final class Builder
        ...
        public Builder mergeFrom(
          ...
          if (java.lang.Double.doubleToRawLongBits(other.getAccuracy()) != 0) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetQaQuestionDatasetValidationResultsFieldBuilder();
        internalGetQaQuestionDatasetTuningMetricsFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getTuningCompletionRatio()) != 0) {
    ...
    public com.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionMetadata
      ...
      return internalGetQaQuestionDatasetValidationResultsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionMetadata
      ...
      return internalGetQaQuestionDatasetValidationResultsFieldBuilder()
          .addBuilder(
              com.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionMetadata
                  .QaQuestionDatasetValidationResult.getDefaultInstance());
    }
    ...
    public java.util.List<
      ...
      return internalGetQaQuestionDatasetValidationResultsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionMetadata
      ...
      return internalGetQaQuestionDatasetTuningMetricsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionMetadata
      ...
      return internalGetQaQuestionDatasetTuningMetricsFieldBuilder()
          .addBuilder(
              com.google.cloud.contactcenterinsights.v1.TuneQaScorecardRevisionMetadata
                  .QaQuestionDatasetTuningMetrics.getDefaultInstance());
    }
    ...
    public java.util.List<
      ...
      return internalGetQaQuestionDatasetTuningMetricsFieldBuilder().getBuilderList();
    }
