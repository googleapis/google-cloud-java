...
public interface UpdateUnitKindRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.saasplatform.saasservicemgmt.v1beta1.UpdateUnitKindRequest)
   ...
   * </code>
   *
   * @return Whether the unitKind field is set.
   */
  boolean hasUnitKind();
   ...
   * @return The unitKind.
   */
  com.google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitKind getUnitKind();
   ...
   * </code>
   */
  com.google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitKindOrBuilder getUnitKindOrBuilder();
