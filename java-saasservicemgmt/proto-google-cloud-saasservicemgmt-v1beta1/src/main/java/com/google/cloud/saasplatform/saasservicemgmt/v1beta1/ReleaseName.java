...
public class ReleaseName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RELEASE =
  ...
  public static ReleaseName of(String project, String location, String release) {
    return newBuilder().setProject(project).setLocation(location).setRelease(release).build();
  }

  public static String format(String project, String location, String release) {
    return newBuilder()
        .setProject(project)
  ...
  public static ReleaseName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_RELEASE.validatedMatch(
            formattedString, "ReleaseName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("release"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_RELEASE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_RELEASE.instantiate(
        "project", project, "location", location, "release", release);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/releases/{release}. */
