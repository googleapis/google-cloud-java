...
public interface UnitOperationConditionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitOperationCondition)
   ...
   * @return The status.
   */
  com.google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitOperationCondition.Status getStatus();
   ...
   * @return The type.
   */
  com.google.cloud.saasplatform.saasservicemgmt.v1beta1.UnitOperationCondition.Type getType();
