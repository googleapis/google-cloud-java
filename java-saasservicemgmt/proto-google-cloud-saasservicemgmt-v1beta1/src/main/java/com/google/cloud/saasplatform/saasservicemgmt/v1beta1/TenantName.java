...
public class TenantName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_TENANT =
  ...
  public static TenantName of(String project, String location, String tenant) {
    return newBuilder().setProject(project).setLocation(location).setTenant(tenant).build();
  }

  public static String format(String project, String location, String tenant) {
    return newBuilder()
        .setProject(project)
  ...
  public static TenantName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_TENANT.validatedMatch(
            formattedString, "TenantName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("tenant"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_TENANT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_TENANT.instantiate(
        "project", project, "location", location, "tenant", tenant);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/tenants/{tenant}. */
  public static class Builder {
    ...
    private Builder(TenantName tenantName) {
      ...
      this.location = tenantName.location;
