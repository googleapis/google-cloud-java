...
public interface SaasConditionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.saasplatform.saasservicemgmt.v1beta1.SaasCondition)
   ...
   * @return The status.
   */
  com.google.cloud.saasplatform.saasservicemgmt.v1beta1.SaasCondition.Status getStatus();
   ...
   * @return The type.
   */
  com.google.cloud.saasplatform.saasservicemgmt.v1beta1.SaasCondition.Type getType();
