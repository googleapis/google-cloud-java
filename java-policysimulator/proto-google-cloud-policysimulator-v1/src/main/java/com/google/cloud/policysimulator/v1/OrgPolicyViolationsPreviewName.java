...
public class OrgPolicyViolationsPreviewName implements ResourceName {
  ...
  public static @Nullable OrgPolicyViolationsPreviewName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable OrgPolicyViolationsPreviewName> values) {
