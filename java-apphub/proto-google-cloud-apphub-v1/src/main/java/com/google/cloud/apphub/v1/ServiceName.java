...
public class ServiceName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_APPLICATION_SERVICE =
  ...
  public static ServiceName of(
      String project, String location, String application, String service) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String application, String service) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setApplication(application)
  ...
  public static ServiceName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_APPLICATION_SERVICE.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_APPLICATION_SERVICE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_APPLICATION_SERVICE.instantiate(
        "project", project, "location", location, "application", application, "service", service);
  }
  ...
  public static class Builder {
    ...
    private Builder(ServiceName serviceName) {
      ...
      this.application = serviceName.application;
