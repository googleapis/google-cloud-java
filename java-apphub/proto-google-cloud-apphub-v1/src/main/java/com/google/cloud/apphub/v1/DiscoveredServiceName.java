...
public class DiscoveredServiceName implements ResourceName {
  ...
  public static @Nullable DiscoveredServiceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DiscoveredServiceName> values) {
