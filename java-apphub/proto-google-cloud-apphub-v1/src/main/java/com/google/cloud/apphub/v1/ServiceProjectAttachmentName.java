...
public class ServiceProjectAttachmentName implements ResourceName {
  ...
  public static @Nullable ServiceProjectAttachmentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ServiceProjectAttachmentName> values) {
