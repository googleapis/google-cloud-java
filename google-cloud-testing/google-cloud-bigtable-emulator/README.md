...
```Groovy
compile 'com.google.cloud:google-cloud-bigtable:0.102.0-alpha'
testCompile 'com.google.cloud:google-cloud-bigtable-emulator:0.102.0-alpha'
testCompile 'junit:junit:4.12'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigtable" % "0.102.0-alpha"
libraryDependencies += "com.google.cloud" % "google-cloud-bigtable-emulator" % "0.102.0-alpha" % Test
