...
public final class GitSource extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(repo_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, repo_);
    }
    ...
    if (refCase_ == 4) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, ref_);
    }
    if (refCase_ == 5) {
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(repo_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, repo_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dir_)) {
    ...
    if (refCase_ == 4) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, ref_);
    }
    if (refCase_ == 5) {
