...
public class VersionName implements ResourceName {
  private static final PathTemplate CATALOG_PRODUCT_VERSION =
  ...
  public static VersionName of(String catalog, String product, String version) {
    return newBuilder().setCatalog(catalog).setProduct(product).setVersion(version).build();
  }
  ...
  public static VersionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        CATALOG_PRODUCT_VERSION.validatedMatch(
            formattedString, "VersionName.parse: formattedString not in valid format");
    return of(matchMap.get("catalog"), matchMap.get("product"), matchMap.get("version"));
  }
  ...
  public String toString() {
    return CATALOG_PRODUCT_VERSION.instantiate(
  ...
  /** Builder for catalogs/{catalog}/products/{product}/versions/{version}. */
