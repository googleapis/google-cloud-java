...
public final class PrivateCatalogGrpc {
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new PrivateCatalogMethodDescriptorSupplier("SearchCatalogs"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getSearchProductsMethod = PrivateCatalogGrpc.getSearchProductsMethod) == null) {
      synchronized (PrivateCatalogGrpc.class) {
        if ((getSearchProductsMethod = PrivateCatalogGrpc.getSearchProductsMethod) == null) {
          PrivateCatalogGrpc.getSearchProductsMethod =
              getSearchProductsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.privatecatalog.v1beta1.SearchProductsRequest,
                          com.google.cloud.privatecatalog.v1beta1.SearchProductsResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.privatecatalog.v1beta1.SearchProductsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new PrivateCatalogMethodDescriptorSupplier("SearchProducts"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getSearchVersionsMethod = PrivateCatalogGrpc.getSearchVersionsMethod) == null) {
      synchronized (PrivateCatalogGrpc.class) {
        if ((getSearchVersionsMethod = PrivateCatalogGrpc.getSearchVersionsMethod) == null) {
          PrivateCatalogGrpc.getSearchVersionsMethod =
              getSearchVersionsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.privatecatalog.v1beta1.SearchVersionsRequest,
                          com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new PrivateCatalogMethodDescriptorSupplier("SearchVersions"))
                      .build();
        }
      }
    }
  ...
  public static PrivateCatalogStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PrivateCatalogStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PrivateCatalogStub>() {
          @java.lang.Override
          public PrivateCatalogStub newStub(
   ...
   */
  public static PrivateCatalogBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PrivateCatalogBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PrivateCatalogBlockingStub>() {
          @java.lang.Override
          public PrivateCatalogBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static PrivateCatalogFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PrivateCatalogFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PrivateCatalogFutureStub>() {
          @java.lang.Override
          public PrivateCatalogFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void searchCatalogs(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getSearchCatalogsMethod(), responseObserver);
    }
    ...
    default void searchProducts(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.privatecatalog.v1beta1.SearchProductsResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getSearchProductsMethod(), responseObserver);
    }
  ...
  public static final class PrivateCatalogStub
      extends io.grpc.stub.AbstractAsyncStub<PrivateCatalogStub> {
    private PrivateCatalogStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected PrivateCatalogStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new PrivateCatalogStub(channel, callOptions);
    }
    ...
    public void searchCatalogs(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getSearchCatalogsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void searchProducts(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.privatecatalog.v1beta1.SearchProductsResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getSearchProductsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void searchVersions(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getSearchVersionsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class PrivateCatalogBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<PrivateCatalogBlockingStub> {
   ...
   * </pre>
   */
  public static final class PrivateCatalogFutureStub
      extends io.grpc.stub.AbstractFutureStub<PrivateCatalogFutureStub> {
    private PrivateCatalogFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.privatecatalog.v1beta1.SearchCatalogsResponse>
        searchCatalogs(com.google.cloud.privatecatalog.v1beta1.SearchCatalogsRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.privatecatalog.v1beta1.SearchProductsResponse>
        searchProducts(com.google.cloud.privatecatalog.v1beta1.SearchProductsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.privatecatalog.v1beta1.SearchVersionsResponse>
        searchVersions(com.google.cloud.privatecatalog.v1beta1.SearchVersionsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private static final class PrivateCatalogMethodDescriptorSupplier
    ...
    PrivateCatalogMethodDescriptorSupplier(java.lang.String methodName) {
