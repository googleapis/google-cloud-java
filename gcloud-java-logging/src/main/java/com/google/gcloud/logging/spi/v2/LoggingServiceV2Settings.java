...
public class LoggingServiceV2Settings extends ServiceApiSettings {
  ...
  /**
   * Constructs an instance of LoggingServiceV2Settings with default settings. This is protected so that it
  ...
  /**
   * Returns the PageStreamingApiCallableBuilder for the API method listMonitoredResourceDescriptors.
   *
   * <!-- manual edit -->
   * <!-- end manual edit -->
   */
