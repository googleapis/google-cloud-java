...
public class WorkstationConfigName implements ResourceName {
  ...
  public static @Nullable WorkstationConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable WorkstationConfigName> values) {
