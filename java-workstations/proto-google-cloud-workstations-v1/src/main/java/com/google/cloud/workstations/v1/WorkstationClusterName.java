...
public class WorkstationClusterName implements ResourceName {
  ...
  public static @Nullable WorkstationClusterName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable WorkstationClusterName> values) {
