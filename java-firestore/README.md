...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-firestore" % "3.30.1"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-firestore/3.30.1
