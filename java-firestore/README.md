...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-firestore" % "3.27.2"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-firestore/3.27.2
