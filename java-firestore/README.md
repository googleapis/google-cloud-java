...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-firestore" % "3.47.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-firestore/3.47.0
