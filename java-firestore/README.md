...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-firestore" % "3.31.6"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-firestore/3.31.6
