...
```Groovy
implementation 'com.google.area120:google-area120-tables:0.70.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.area120" % "google-area120-tables" % "0.70.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.area120/google-area120-tables/0.70.0
