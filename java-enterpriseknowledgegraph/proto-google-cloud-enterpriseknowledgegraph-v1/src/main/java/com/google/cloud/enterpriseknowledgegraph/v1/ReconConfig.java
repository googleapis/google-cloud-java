        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    getConnectedComponentsConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 18:
              {
                input.readMessage(
                    getAffinityClusteringConfigFieldBuilder().getBuilder(), extensionRegistry);
