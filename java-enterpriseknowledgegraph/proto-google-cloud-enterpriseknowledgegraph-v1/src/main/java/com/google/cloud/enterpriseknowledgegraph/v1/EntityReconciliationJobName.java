...
public class EntityReconciliationJobName implements ResourceName {
  ...
  public static @Nullable EntityReconciliationJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable EntityReconciliationJobName> values) {
