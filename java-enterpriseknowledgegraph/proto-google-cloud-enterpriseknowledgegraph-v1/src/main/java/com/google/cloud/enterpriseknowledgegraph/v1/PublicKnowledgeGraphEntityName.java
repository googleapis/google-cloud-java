...
public class PublicKnowledgeGraphEntityName implements ResourceName {
  ...
  public static @Nullable PublicKnowledgeGraphEntityName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PublicKnowledgeGraphEntityName> values) {
