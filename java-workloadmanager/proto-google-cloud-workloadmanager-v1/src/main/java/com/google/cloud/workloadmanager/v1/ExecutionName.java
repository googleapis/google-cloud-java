...
public class ExecutionName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_EVALUATION_EXECUTION =
  ...
  public static ExecutionName of(
      String project, String location, String evaluation, String execution) {
    return newBuilder()
        .setProject(project)
  ...
  public static ExecutionName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_EVALUATION_EXECUTION.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_EVALUATION_EXECUTION.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_EVALUATION_EXECUTION.instantiate(
        "project", project, "location", location, "evaluation", evaluation, "execution", execution);
  }
  ...
  public static class Builder {
    ...
    private Builder(ExecutionName executionName) {
      ...
      this.evaluation = executionName.evaluation;
