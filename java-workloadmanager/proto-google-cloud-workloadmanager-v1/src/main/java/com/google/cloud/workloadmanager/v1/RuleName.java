...
public class RuleName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RULE =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/rules/{rule}");
  ...
  public static RuleName of(String project, String location, String rule) {
    return newBuilder().setProject(project).setLocation(location).setRule(rule).build();
  }

  public static String format(String project, String location, String rule) {
  ...
  public static RuleName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_RULE.validatedMatch(
            formattedString, "RuleName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("rule"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_RULE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_RULE.instantiate(
        "project", project, "location", location, "rule", rule);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/rules/{rule}. */
