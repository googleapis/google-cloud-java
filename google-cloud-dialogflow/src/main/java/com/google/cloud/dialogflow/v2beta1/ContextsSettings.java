...
public class ContextsSettings extends ClientSettings<ContextsSettings> {
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return GrpcClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(null, GaxProperties.getLibraryVersion(ContextsSettings.class));
  }
  ...
  private ContextsSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<ContextsSettings, Builder> {
    ...
    private Builder(ContextsSettings settings) {
      super(settings);
