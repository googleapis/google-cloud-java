...
@BetaApi
public class SessionsSettings extends ClientSettings {
  ...
  public SessionsStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcSessionsStub.of(this);
    } else {
    ...
    if (gapicVersion == null) {
      gapicVersion =
          PropertiesProvider.loadProperty(
              SessionsSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private SessionsSettings(Builder settingsBuilder) throws IOException {
    super(
  ...
  public static class Builder extends ClientSettings.Builder {
    ...
    private Builder(SessionsSettings settings) {
      super(settings);
