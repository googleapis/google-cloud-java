...
public class IntentsSettings extends ClientSettings<IntentsSettings> {
  ...
  private static String getGapicVersion() {
    if (gapicVersion == null) {
      gapicVersion =
          PropertiesProvider.loadProperty(IntentsSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
  ...
  private IntentsSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<IntentsSettings, Builder> {
    ...
    private Builder(IntentsSettings settings) {
      super(settings);
