...
public final class AwsProperties extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AwsProperties(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetCrossAccountRoleFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 26:
              {
                input.readMessage(
                    internalGetAccessRoleFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.bigquery.connection.v1.AwsCrossAccountRole.Builder
      ...
      return internalGetCrossAccountRoleFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.bigquery.connection.v1.AwsCrossAccountRole.Builder,
            com.google.cloud.bigquery.connection.v1.AwsCrossAccountRoleOrBuilder>
        internalGetCrossAccountRoleFieldBuilder() {
      if (crossAccountRoleBuilder_ == null) {
        if (!(authenticationMethodCase_ == 2)) {
          authenticationMethod_ =
    ...
    public com.google.cloud.bigquery.connection.v1.AwsAccessRole.Builder getAccessRoleBuilder() {
      return internalGetAccessRoleFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.bigquery.connection.v1.AwsAccessRole.Builder,
            com.google.cloud.bigquery.connection.v1.AwsAccessRoleOrBuilder>
        internalGetAccessRoleFieldBuilder() {
      if (accessRoleBuilder_ == null) {
        if (!(authenticationMethodCase_ == 3)) {
          authenticationMethod_ =
              com.google.cloud.bigquery.connection.v1.AwsAccessRole.getDefaultInstance();
