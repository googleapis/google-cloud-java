 ...
 *      <td><p>Create a new environment.</p></td>
 *      <td>
 ...
 *      <td><p>Get an existing environment.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <td><p>Update an environment.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>updateEnvironmentAsync(String name, Environment environment, FieldMask updateMask)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 ...
 *    </tr>
 *    <tr>
 *      <td>RestartWebServer</td>
 *      <td><p>Restart Airflow web server.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>restartWebServerAsync(RestartWebServerRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>restartWebServerOperationCallable()
 *           <li>restartWebServerCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 ...
 *
 *  In case of problems detailed info can be found in the returned Operation.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>checkUpgradeAsync(CheckUpgradeRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>checkUpgradeOperationCallable()
 *           <li>checkUpgradeCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ExecuteAirflowCommand</td>
 *      <td><p>Executes Airflow CLI command.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>executeAirflowCommand(ExecuteAirflowCommandRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>executeAirflowCommandCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>StopAirflowCommand</td>
 *      <td><p>Stops Airflow CLI command execution.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>stopAirflowCommand(StopAirflowCommandRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>stopAirflowCommandCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>PollAirflowCommand</td>
 *      <td><p>Polls Airflow CLI command execution and fetches logs.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>pollAirflowCommand(PollAirflowCommandRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>pollAirflowCommandCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 ...
 *  in a location specified in the SaveSnapshotRequest.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>saveSnapshotAsync(SaveSnapshotRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>saveSnapshotOperationCallable()
 *           <li>saveSnapshotCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 ...
 *  LoadSnapshotRequest is loaded into the environment.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>loadSnapshotAsync(LoadSnapshotRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>loadSnapshotOperationCallable()
 *           <li>loadSnapshotCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>DatabaseFailover</td>
 *      <td><p>Triggers database failover (only for highly resilient environments).</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>databaseFailoverAsync(DatabaseFailoverRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>databaseFailoverOperationCallable()
 *           <li>databaseFailoverCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>FetchDatabaseProperties</td>
 *      <td><p>Fetches database properties.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>fetchDatabaseProperties(FetchDatabasePropertiesRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>fetchDatabasePropertiesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    </tr>
