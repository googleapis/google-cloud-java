...
public class UserWorkloadsSecretName implements ResourceName {
  ...
  public static @Nullable UserWorkloadsSecretName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable UserWorkloadsSecretName> values) {
