...
public class EnvironmentName implements ResourceName {
  ...
  public static @Nullable EnvironmentName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_ENVIRONMENT.validatedMatch(
            formattedString, "EnvironmentName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("environment"));
  }
  ...
  public static List<String> toStringList(List<@Nullable EnvironmentName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_ENVIRONMENT.instantiate(
