...
import com.google.apps.events.subscriptions.v1.SubscriptionsServiceGrpc.SubscriptionsServiceImplBase;
...
public class MockSubscriptionsServiceImpl extends SubscriptionsServiceImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockSubscriptionsServiceImpl() {
  ...
  public void createSubscription(
      CreateSubscriptionRequest request, StreamObserver<Operation> responseObserver) {
  ...
  public void updateSubscription(
      UpdateSubscriptionRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void reactivateSubscription(
      ReactivateSubscriptionRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
