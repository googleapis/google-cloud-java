...
import com.google.apps.events.subscriptions.v1beta.stub.SubscriptionsServiceStub;
 ...
 * <p>   This method resets your subscription's `State` field to `ACTIVE`. Before  you use this method, you must fix the error that suspended the  subscription. This method will ignore or reject any subscription that  isn't currently in a suspended state. To learn how to use this method, see [Reactivate a Google Workspace  subscription](https://developers.google.com/workspace/events/guides/reactivate-subscription).</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class SubscriptionsServiceClient implements BackgroundResource {
   ...
   * @param updateMask Optional. The field to update. If omitted, updates any fields included in the
   *     request.
   *     <p>You can update one of the following fields in a subscription:
   *     <ul>
   *       <li>[`expire_time`][google.apps.events.subscriptions.v1beta.Subscription.expire_time]:
   *           The timestamp when the subscription expires.
   *       <li>[`ttl`][google.apps.events.subscriptions.v1beta.Subscription.ttl]: The time-to-live
   *           (TTL) or duration of the subscription.
   *       <li>[`event_types`][google.apps.events.subscriptions.v1beta.Subscription.event_types]:
   *           The list of event types to receive about the target resource.
   *     </ul>
   *     <p>To fully replace the subscription (the equivalent of `PUT`), use `&#42;`. Any omitted
   ...
   * method, you must fix the error that suspended the subscription. This method will ignore or
   * reject any subscription that isn't currently in a suspended state. To learn how to use this
