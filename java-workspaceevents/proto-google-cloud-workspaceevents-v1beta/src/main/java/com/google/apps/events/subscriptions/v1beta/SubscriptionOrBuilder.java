...
public interface SubscriptionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.apps.events.subscriptions.v1beta.Subscription)
   ...
   */
  com.google.apps.events.subscriptions.v1beta.Subscription.DriveOptions getDriveOptions();
   ...
   */
  com.google.apps.events.subscriptions.v1beta.PayloadOptions getPayloadOptions();
   ...
   * </code>
   */
  com.google.apps.events.subscriptions.v1beta.PayloadOptionsOrBuilder getPayloadOptionsOrBuilder();
   ...
   */
  com.google.apps.events.subscriptions.v1beta.NotificationEndpoint getNotificationEndpoint();
   ...
   * @return The state.
   */
  com.google.apps.events.subscriptions.v1beta.Subscription.State getState();
   ...
   */
  com.google.apps.events.subscriptions.v1beta.Subscription.ErrorType getSuspensionReason();
  ...
  com.google.apps.events.subscriptions.v1beta.Subscription.SubscriptionOptionsCase
      getSubscriptionOptionsCase();

  com.google.apps.events.subscriptions.v1beta.Subscription.ExpirationCase getExpirationCase();
}
