...
public final class SubscriptionsServiceGrpc {
  ...
  public static SubscriptionsServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<SubscriptionsServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<SubscriptionsServiceBlockingV2Stub>() {
          @java.lang.Override
          public SubscriptionsServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new SubscriptionsServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return SubscriptionsServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class SubscriptionsServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<SubscriptionsServiceBlockingV2Stub> {
    private SubscriptionsServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected SubscriptionsServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new SubscriptionsServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service SubscriptionsService.
   *
   * <pre>
   * A service that manages subscriptions to Google Workspace events.
   * </pre>
