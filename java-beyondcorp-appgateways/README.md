...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-appgateways:0.27.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-appgateways" % "0.27.0"
```
