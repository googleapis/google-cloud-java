...
/**
 * Settings class to configure an instance of {@link DirectAccessServiceStub}.
 *
...
public class DirectAccessServiceStubSettings extends StubSettings<DirectAccessServiceStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<CreateDeviceSessionRequest, DeviceSession>
      createDeviceSessionSettings;
  ...
  private final UnaryCallSettings<UpdateDeviceSessionRequest, DeviceSession>
      updateDeviceSessionSettings;
  private final StreamingCallSettings<AdbMessage, DeviceMessage> adbConnectSettings;

  private static final PagedListDescriptor<
          ListDeviceSessionsRequest, ListDeviceSessionsResponse, DeviceSession>
      LIST_DEVICE_SESSIONS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListDeviceSessionsRequest injectToken(
                ListDeviceSessionsRequest payload, String token) {
              return ListDeviceSessionsRequest.newBuilder(payload).setPageToken(token).build();
            }

            @Override
            public ListDeviceSessionsRequest injectPageSize(
                ListDeviceSessionsRequest payload, int pageSize) {
              return ListDeviceSessionsRequest.newBuilder(payload).setPageSize(pageSize).build();
            }
  ...
  private static final PagedListResponseFactory<
          ListDeviceSessionsRequest, ListDeviceSessionsResponse, ListDeviceSessionsPagedResponse>
      LIST_DEVICE_SESSIONS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListDeviceSessionsRequest,
              ListDeviceSessionsResponse,
              ListDeviceSessionsPagedResponse>() {
            @Override
            public ApiFuture<ListDeviceSessionsPagedResponse> getFuturePagedResponse(
                UnaryCallable<ListDeviceSessionsRequest, ListDeviceSessionsResponse> callable,
                ListDeviceSessionsRequest request,
                ApiCallContext context,
                ApiFuture<ListDeviceSessionsResponse> futureResponse) {
              PageContext<ListDeviceSessionsRequest, ListDeviceSessionsResponse, DeviceSession>
                  pageContext =
                      PageContext.create(
                          callable, LIST_DEVICE_SESSIONS_PAGE_STR_DESC, request, context);
              return ListDeviceSessionsPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<CreateDeviceSessionRequest, DeviceSession>
      createDeviceSessionSettings() {
    return createDeviceSessionSettings;
  }
  ...
  public PagedCallSettings<
          ListDeviceSessionsRequest, ListDeviceSessionsResponse, ListDeviceSessionsPagedResponse>
      listDeviceSessionsSettings() {
    return listDeviceSessionsSettings;
  }
  ...
  public UnaryCallSettings<GetDeviceSessionRequest, DeviceSession> getDeviceSessionSettings() {
    return getDeviceSessionSettings;
  }
  ...
  public UnaryCallSettings<CancelDeviceSessionRequest, Empty> cancelDeviceSessionSettings() {
    return cancelDeviceSessionSettings;
  }
  ...
  public UnaryCallSettings<UpdateDeviceSessionRequest, DeviceSession>
      updateDeviceSessionSettings() {
    return updateDeviceSessionSettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(DirectAccessServiceStubSettings.class))
        .setTransportToken(
  ...
  protected DirectAccessServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    createDeviceSessionSettings = settingsBuilder.createDeviceSessionSettings().build();
    listDeviceSessionsSettings = settingsBuilder.listDeviceSessionsSettings().build();
    getDeviceSessionSettings = settingsBuilder.getDeviceSessionSettings().build();
    cancelDeviceSessionSettings = settingsBuilder.cancelDeviceSessionSettings().build();
    updateDeviceSessionSettings = settingsBuilder.updateDeviceSessionSettings().build();
    adbConnectSettings = settingsBuilder.adbConnectSettings().build();
  }

  /** Builder for DirectAccessServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<DirectAccessServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<CreateDeviceSessionRequest, DeviceSession>
        createDeviceSessionSettings;
    private final PagedCallSettings.Builder<
            ListDeviceSessionsRequest, ListDeviceSessionsResponse, ListDeviceSessionsPagedResponse>
        listDeviceSessionsSettings;
    private final UnaryCallSettings.Builder<GetDeviceSessionRequest, DeviceSession>
        getDeviceSessionSettings;
    private final UnaryCallSettings.Builder<CancelDeviceSessionRequest, Empty>
        cancelDeviceSessionSettings;
    private final UnaryCallSettings.Builder<UpdateDeviceSessionRequest, DeviceSession>
        updateDeviceSessionSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      listDeviceSessionsSettings = PagedCallSettings.newBuilder(LIST_DEVICE_SESSIONS_PAGE_STR_FACT);
      getDeviceSessionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      cancelDeviceSessionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      updateDeviceSessionSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      adbConnectSettings = StreamingCallSettings.newBuilder();
    ...
    protected Builder(DirectAccessServiceStubSettings settings) {
      ...
      createDeviceSessionSettings = settings.createDeviceSessionSettings.toBuilder();
      listDeviceSessionsSettings = settings.listDeviceSessionsSettings.toBuilder();
      getDeviceSessionSettings = settings.getDeviceSessionSettings.toBuilder();
      cancelDeviceSessionSettings = settings.cancelDeviceSessionSettings.toBuilder();
      updateDeviceSessionSettings = settings.updateDeviceSessionSettings.toBuilder();
      adbConnectSettings = settings.adbConnectSettings.toBuilder();
