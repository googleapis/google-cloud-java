...
public final class TextClassificationPredictionInstanceProto {
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        TextClassificationPredictionInstanceProto.class.getName());
  }
  ...
  static {
    java.lang.String[] descriptorData = {
      "\nQgoogle/cloud/aiplatform/v1beta1/schema"
          ...
          + "\tmime_type\030\002 \001(\tB\367\002\n;com.google.cloud.ai"
          + "platform.v1beta1.schema.predict.instance"
          + "B)TextClassificationPredictionInstancePr"
          + "otoP\001ZWcloud.google.com/go/aiplatform/ap"
          + "iv1beta1/schema/predict/instance/instanc"
          + "epb;instancepb\252\0027Google.Cloud.AIPlatform"
          + ".V1Beta1.Schema.Predict.Instance\312\0027Googl"
          + "e\\Cloud\\AIPlatform\\V1beta1\\Schema\\Predic"
          + "t\\Instance\352\002=Google::Cloud::AIPlatform::"
          + "V1beta1::Schema::Predict::Instanceb\006prot"
          + "o3"
    };
    descriptor =
