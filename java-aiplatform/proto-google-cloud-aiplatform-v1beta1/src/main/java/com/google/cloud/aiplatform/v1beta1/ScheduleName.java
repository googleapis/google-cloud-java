...
public class ScheduleName implements ResourceName {
  ...
  public static @Nullable ScheduleName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ScheduleName> values) {
  ...
  /** Builder for projects/{project}/locations/{location}/schedules/{schedule}. */
