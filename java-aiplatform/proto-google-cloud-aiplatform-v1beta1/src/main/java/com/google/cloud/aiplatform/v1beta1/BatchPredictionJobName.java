...
public class BatchPredictionJobName implements ResourceName {
  ...
  public static @Nullable BatchPredictionJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BatchPredictionJobName> values) {
