...
public interface RubricCritiqueResultOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.RubricCritiqueResult)
   ...
   * </pre>
   *
   * <code>string rubric = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
   * @return The rubric.
   */
   ...
   * </pre>
   *
   * <code>bool verdict = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
   * @return The verdict.
   */
  boolean getVerdict();
