...
public interface ListIndexEndpointsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.IndexEndpoint> getIndexEndpointsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.aiplatform.v1beta1.IndexEndpoint index_endpoints = 1;</code>
   */
  com.google.cloud.aiplatform.v1beta1.IndexEndpointOrBuilder getIndexEndpointsOrBuilder(int index);
