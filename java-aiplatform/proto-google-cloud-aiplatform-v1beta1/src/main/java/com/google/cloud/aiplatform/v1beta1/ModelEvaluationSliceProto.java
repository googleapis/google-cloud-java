...
public final class ModelEvaluationSliceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "<google/cloud/aiplatform/v1beta1/model_evaluation_slice.proto\022\037google.cloud.aip"
          ...
          + "ogle/protobuf/timestamp.proto\032\036google/protobuf/wrappers.proto\"\340\t\n"
          + "\024ModelEvaluationSlice\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022O\n"
          + "\005slice\030\002 \001(\013"
          + "2;.google.cloud.aiplatform.v1beta1.ModelEvaluationSlice.SliceB\003\340A\003\022\037\n"
          ...
          + "d.aiplatform.v1beta1.ModelExplanationB\003\340A\003\032\364\005\n"
          + "\005Slice\022\026\n"
          + "\tdimension\030\001 \001(\tB\003\340A\003\022\022\n"
          + "\005value\030\002 \001(\tB\003\340A\003\022^\n\n"
          + "slice_spec\030\003 \001(\0132E.g"
          + "oogle.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpecB\003\340A\003\032\336\004\n"
          + "\tSliceSpec\022c\n"
          + "\007configs\030\001 \003(\0132R.google.cloud.a"
          + "iplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.ConfigsEntry\032\203\002\n"
          + "\013SliceConfig\022\\\n"
          + "\005value\030\001 \001(\0132K.google.cloud.aiplat"
          + "form.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.ValueH\000\022\\\n"
          + "\005range\030\002 \001(\0132K.googl"
          + "e.cloud.aiplatform.v1beta1.ModelEvaluationSlice.Slice.SliceSpec.RangeH\000\0220\n\n"
          ...
          + "\005value\030\002 \001(\0132Q.google.cloud.aiplatform.v1beta1.ModelEvalua"
          + "tionSlice.Slice.SliceSpec.SliceConfig:\0028\001:\224\001\352A\220\001\n"
          + ".aiplatform.googleapis.com/ModelEvaluationSlice\022^projects/{project}/loc"
          + "ations/{location}/models/{model}/evaluations/{evaluation}/slices/{slice}B\360\001\n"
          + "#com.google.cloud.aiplatform.v1beta1B\031ModelE"
          + "valuationSliceProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;ai"
