...
public final class ModelMonitoringSpec extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ModelMonitoringSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetObjectiveSpecFieldBuilder().getBuilder(), extensionRegistry);
