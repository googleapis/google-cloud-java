...
public interface ExportTensorboardTimeSeriesDataResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.ExportTensorboardTimeSeriesDataResponse)
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.TimeSeriesDataPoint getTimeSeriesDataPoints(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.TimeSeriesDataPointOrBuilder getTimeSeriesDataPointsOrBuilder(
      int index);
