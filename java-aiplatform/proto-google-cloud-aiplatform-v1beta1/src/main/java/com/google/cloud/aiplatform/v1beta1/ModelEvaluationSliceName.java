...
public class ModelEvaluationSliceName implements ResourceName {
  ...
  public static @Nullable ModelEvaluationSliceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ModelEvaluationSliceName> values) {
