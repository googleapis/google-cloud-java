...
public interface StreamDirectPredictRequestOrBuilder
   ...
   *
   * <code>
   * repeated .google.cloud.aiplatform.v1beta1.Tensor inputs = 2 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   */
   ...
   *
   * <code>
   * .google.cloud.aiplatform.v1beta1.Tensor parameters = 3 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
