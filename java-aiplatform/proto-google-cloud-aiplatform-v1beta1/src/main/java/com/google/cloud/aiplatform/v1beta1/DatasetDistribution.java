...
public final class DatasetDistribution extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DatasetDistribution(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class DistributionBucket extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private DistributionBucket(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.cloud.aiplatform.v1beta1.DatasetDistribution other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getMedian()) != 0) {
        setMedian(other.getMedian());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getP5()) != 0) {
        setP5(other.getP5());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getP95()) != 0) {
        setP95(other.getP95());
      }
      if (bucketsBuilder_ == null) {
