...
public interface NasJobOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.NasJob)
   ...
   *
   * <code>
   * .google.cloud.aiplatform.v1beta1.NasJobSpec nas_job_spec = 4 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.aiplatform.v1beta1.NasJobSpec getNasJobSpec();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.NasJobSpecOrBuilder getNasJobSpecOrBuilder();
   ...
   *
   * <code>
   * .google.cloud.aiplatform.v1beta1.NasJobOutput nas_job_output = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.aiplatform.v1beta1.NasJobOutput getNasJobOutput();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.NasJobOutputOrBuilder getNasJobOutputOrBuilder();
