...
public interface BatchCreateRagDataSchemasRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.BatchCreateRagDataSchemasRequest)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.CreateRagDataSchemaRequest> getRequestsList();
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.CreateRagDataSchemaRequest getRequests(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1beta1.CreateRagDataSchemaRequestOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.CreateRagDataSchemaRequestOrBuilder getRequestsOrBuilder(
      int index);
}
