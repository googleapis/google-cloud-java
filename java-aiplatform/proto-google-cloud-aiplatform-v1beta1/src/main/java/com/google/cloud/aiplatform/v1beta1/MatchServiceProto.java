...
public final class MatchServiceProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "3google/cloud/aiplatform/v1beta1/match_service.proto\022\037google.cloud.aiplatform.v"
          + "1beta1\032\034google/api/annotations.proto\032\027go"
          + "ogle/api/client.proto\032\037google/api/field_"
          + "behavior.proto\032\031google/api/resource.prot"
          + "o\032+google/cloud/aiplatform/v1beta1/index.proto\"\320\004\n"
          + "\024FindNeighborsRequest\022G\n"
          + "\016index_endpoint\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'aiplatform.googleapis.com/IndexEndpoint\022\031\n"
          + "\021deployed_index_id\030\002 \001(\t\022L\n"
          + "\007queries\030\003 \003(\0132;.google.cl"
          + "oud.aiplatform.v1beta1.FindNeighborsRequest.Query\022\035\n"
          + "\025return_full_datapoint\030\004 \001(\010\032\346\002\n"
          + "\005Query\022S\n"
          + "\003rrf\030\006 \001(\0132?.google.cloud.a"
          + "iplatform.v1beta1.FindNeighborsRequest.Query.RRFB\003\340A\001H\000\022G\n"
          + "\tdatapoint\030\001 \001(\0132/.goo"
          + "gle.cloud.aiplatform.v1beta1.IndexDatapointB\003\340A\002\022\026\n"
          ...
          + "\021nearest_neighbors\030\001 \003(\0132G.google.cloud.aiplatform"
          + ".v1beta1.FindNeighborsResponse.NearestNeighbors\032y\n"
          + "\010Neighbor\022B\n"
          + "\tdatapoint\030\001 \001(\0132/"
          + ".google.cloud.aiplatform.v1beta1.IndexDatapoint\022\020\n"
          + "\010distance\030\002 \001(\001\022\027\n"
          + "\017sparse_distance\030\003 \001(\001\032r\n"
          + "\020NearestNeighbors\022\n\n"
          + "\002id\030\001 \001(\t\022R\n"
          + "\tneighbors\030\002 \003(\0132?.google.cloud.aip"
          + "latform.v1beta1.FindNeighborsResponse.Neighbor\"\215\001\n"
          ...
          + "\0132/.google.cloud.aiplatform.v1beta1.IndexDatapoint2\257\004\n"
          + "\014MatchService\022\332\001\n\r"
          + "FindNeighbors\0225.google.cloud.aiplatform.v1beta1."
          ...
          + "*/locations/*/indexEndpoints/*}:findNeighbors:\001*\022\362\001\n"
          + "\023ReadIndexDatapoints\022;.google.cloud.aiplatform.v1beta1.ReadIndexData"
          ...
          + "com\322A.https://www.googleapis.com/auth/cloud-platformB\350\001\n"
          + "#com.google.cloud.aiplatform.v1beta1B\021MatchServiceProtoP\001ZCcloud"
