...
public interface TensorboardTimeSeriesOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.TensorboardTimeSeries)
   ...
   *
   * <code>
   * .google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.ValueType value_type = 4 [(.google.api.field_behavior) = REQUIRED, (.google.api.field_behavior) = IMMUTABLE];
   * </code>
   *
   ...
   *
   * <code>
   * .google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata metadata = 10 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The metadata.
   */
  com.google.cloud.aiplatform.v1beta1.TensorboardTimeSeries.Metadata getMetadata();
  /**
   *
   *
   * <pre>
