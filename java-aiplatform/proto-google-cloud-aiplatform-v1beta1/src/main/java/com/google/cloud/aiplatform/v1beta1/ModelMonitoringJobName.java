...
public class ModelMonitoringJobName implements ResourceName {
  ...
  public static @Nullable ModelMonitoringJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ModelMonitoringJobName> values) {
