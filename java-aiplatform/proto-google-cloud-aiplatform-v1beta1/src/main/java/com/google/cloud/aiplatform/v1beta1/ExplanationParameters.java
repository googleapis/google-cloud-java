...
public final class ExplanationParameters extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ExplanationParameters(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetOutputIndicesFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetSampledShapleyAttributionFieldBuilder().getBuilder(),
                    extensionRegistry);
                methodCase_ = 1;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(
                    internalGetIntegratedGradientsAttributionFieldBuilder().getBuilder(),
                    extensionRegistry);
                methodCase_ = 2;
                break;
              } // case 18
            case 26:
              {
                input.readMessage(
                    internalGetXraiAttributionFieldBuilder().getBuilder(), extensionRegistry);
                methodCase_ = 3;
                break;
              } // case 26
            case 32:
            ...
            case 42:
              {
                input.readMessage(
                    internalGetOutputIndicesFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.aiplatform.v1beta1.SampledShapleyAttribution.Builder
      ...
      return internalGetSampledShapleyAttributionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.aiplatform.v1beta1.SampledShapleyAttribution.Builder,
            com.google.cloud.aiplatform.v1beta1.SampledShapleyAttributionOrBuilder>
        internalGetSampledShapleyAttributionFieldBuilder() {
      if (sampledShapleyAttributionBuilder_ == null) {
        if (!(methodCase_ == 1)) {
          method_ =
    ...
    public com.google.cloud.aiplatform.v1beta1.IntegratedGradientsAttribution.Builder
      ...
      return internalGetIntegratedGradientsAttributionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.aiplatform.v1beta1.IntegratedGradientsAttribution.Builder,
            com.google.cloud.aiplatform.v1beta1.IntegratedGradientsAttributionOrBuilder>
        internalGetIntegratedGradientsAttributionFieldBuilder() {
      if (integratedGradientsAttributionBuilder_ == null) {
        if (!(methodCase_ == 2)) {
          method_ =
              com.google.cloud.aiplatform.v1beta1.IntegratedGradientsAttribution
    ...
    public com.google.cloud.aiplatform.v1beta1.XraiAttribution.Builder getXraiAttributionBuilder() {
      return internalGetXraiAttributionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.aiplatform.v1beta1.XraiAttribution.Builder,
            com.google.cloud.aiplatform.v1beta1.XraiAttributionOrBuilder>
        internalGetXraiAttributionFieldBuilder() {
      if (xraiAttributionBuilder_ == null) {
        if (!(methodCase_ == 3)) {
    ...
    public com.google.protobuf.ListValue.Builder getOutputIndicesBuilder() {
      bitField0_ |= 0x00000020;
      onChanged();
      return internalGetOutputIndicesFieldBuilder().getBuilder();
    }
