...
public final class AddContextArtifactsAndExecutionsRequest
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        AddContextArtifactsAndExecutionsRequest.class.getName());
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < artifacts_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, artifacts_.getRaw(i));
    }
    for (int i = 0; i < executions_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, executions_.getRaw(i));
    }
