...
public interface RecommendSpecResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.RecommendSpecResponse)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.Recommendation>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.Recommendation getRecommendations(
      int index);
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.RecommendSpecResponse.MachineAndModelContainerSpec getSpecs(
      int index);
