...
public final class ExecuteExtensionRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ExecuteExtensionRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetOperationParamsFieldBuilder();
        internalGetRuntimeAuthConfigFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(
                    internalGetOperationParamsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 34:
              {
                input.readMessage(
                    internalGetRuntimeAuthConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.protobuf.Struct.Builder getOperationParamsBuilder() {
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetOperationParamsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.aiplatform.v1beta1.AuthConfig.Builder getRuntimeAuthConfigBuilder() {
      bitField0_ |= 0x00000008;
      onChanged();
      return internalGetRuntimeAuthConfigFieldBuilder().getBuilder();
    }
