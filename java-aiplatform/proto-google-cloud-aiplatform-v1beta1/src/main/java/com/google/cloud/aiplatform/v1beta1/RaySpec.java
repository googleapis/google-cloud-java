...
public final class RaySpec extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private RaySpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    com.google.protobuf.GeneratedMessage.serializeStringMapTo(
        ...
        ResourcePoolImagesDefaultEntryHolder.defaultEntry,
        6);
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(headNodeResourcePoolId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, headNodeResourcePoolId_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(headNodeResourcePoolId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, headNodeResourcePoolId_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetNfsMountsFieldBuilder();
        internalGetRayMetricSpecFieldBuilder();
        internalGetRayLogsSpecFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66:
              {
                input.readMessage(
                    internalGetRayMetricSpecFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 82:
              {
                input.readMessage(
                    internalGetRayLogsSpecFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.aiplatform.v1beta1.NfsMount.Builder getNfsMountsBuilder(int index) {
      return internalGetNfsMountsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.aiplatform.v1beta1.NfsMount.Builder addNfsMountsBuilder() {
      return internalGetNfsMountsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.aiplatform.v1beta1.NfsMount.Builder>
      ...
      return internalGetNfsMountsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.aiplatform.v1beta1.RayMetricSpec.Builder getRayMetricSpecBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetRayMetricSpecFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.aiplatform.v1beta1.RayLogsSpec.Builder getRayLogsSpecBuilder() {
      bitField0_ |= 0x00000020;
      onChanged();
      return internalGetRayLogsSpecFieldBuilder().getBuilder();
    }
