...
public class FeatureViewSyncName implements ResourceName {
  ...
  private FeatureViewSyncName(Builder builder) {
  ...
  public static FeatureViewSyncName of(
  ...
  public static @Nullable FeatureViewSyncName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_FEATURE_ONLINE_STORE_FEATURE_VIEW.validatedMatch(
            formattedString, "FeatureViewSyncName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<FeatureViewSyncName> parseList(List<String> formattedStrings) {
    List<FeatureViewSyncName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable FeatureViewSyncName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (FeatureViewSyncName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      FeatureViewSyncName that = ((FeatureViewSyncName) o);
  ...
  public static class Builder {
    ...
    private Builder(FeatureViewSyncName featureViewSyncName) {
      this.project = featureViewSyncName.project;
      this.location = featureViewSyncName.location;
      this.featureOnlineStore = featureViewSyncName.featureOnlineStore;
      this.featureView = featureViewSyncName.featureView;
    }

    public FeatureViewSyncName build() {
      return new FeatureViewSyncName(this);
    }
  }
}
