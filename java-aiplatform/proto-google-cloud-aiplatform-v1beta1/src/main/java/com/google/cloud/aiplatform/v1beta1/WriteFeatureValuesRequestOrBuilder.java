...
public interface WriteFeatureValuesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.WriteFeatureValuesRequest)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.WriteFeatureValuesPayload> getPayloadsList();
  /**
   *
   *
   * <pre>
