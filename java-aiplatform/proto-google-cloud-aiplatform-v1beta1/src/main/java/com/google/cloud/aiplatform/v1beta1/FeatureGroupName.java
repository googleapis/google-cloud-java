...
public class FeatureGroupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_FEATURE_GROUP =
  ...
  public static @Nullable FeatureGroupName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_FEATURE_GROUP.validatedMatch(
            formattedString, "FeatureGroupName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("feature_group"));
  }

  public static List<FeatureGroupName> parseList(List<String> formattedStrings) {
    List<FeatureGroupName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable FeatureGroupName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_FEATURE_GROUP.instantiate(
        "project", project, "location", location, "feature_group", featureGroup);
  }
