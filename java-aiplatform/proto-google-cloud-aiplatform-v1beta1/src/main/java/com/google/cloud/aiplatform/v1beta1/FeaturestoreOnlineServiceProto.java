...
public final class FeaturestoreOnlineServiceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "Agoogle/cloud/aiplatform/v1beta1/featurestore_online_service.proto\022\037google.clou"
          + "d.aiplatform.v1beta1\032\034google/api/annotat"
          + "ions.proto\032\027google/api/client.proto\032\037goo"
          + "gle/api/field_behavior.proto\032\031google/api"
          + "/resource.proto\0326google/cloud/aiplatform/v1beta1/feature_selector.proto\032+google/"
          + "cloud/aiplatform/v1beta1/types.proto\032\037google/protobuf/timestamp.proto\"\261\001\n"
          + "\031WriteFeatureValuesRequest\022A\n"
          + "\013entity_type\030\001 \001(\tB,\340A\002\372A&\n"
          + "$aiplatform.googleapis.com/EntityType\022Q\n"
          + "\010payloads\030\002 \003(\0132:.google.cloud."
          + "aiplatform.v1beta1.WriteFeatureValuesPayloadB\003\340A\002\"\204\002\n"
          + "\031WriteFeatureValuesPayload\022\026\n"
          + "\tentity_id\030\001 \001(\tB\003\340A\002\022j\n"
          + "\016feature_values\030\002 \003(\0132M.google.cloud.aiplatform.v1beta"
          + "1.WriteFeatureValuesPayload.FeatureValuesEntryB\003\340A\002\032c\n"
          + "\022FeatureValuesEntry\022\013\n"
          + "\003key\030\001 \001(\t\022<\n"
          + "\005value\030\002"
          + " \001(\0132-.google.cloud.aiplatform.v1beta1.FeatureValue:\0028\001\"\034\n"
          + "\032WriteFeatureValuesResponse\"\306\001\n"
          ...
          + " \001(\01320.google.cloud.aiplatform.v1beta1.FeatureSelectorB\003\340A\002\"\263\005\n"
          + "\031ReadFeatureValuesResponse\022Q\n"
          + "\006header\030\001 \001(\0132A.google.c"
          + "loud.aiplatform.v1beta1.ReadFeatureValuesResponse.Header\022Z\n"
          + "\013entity_view\030\002 \001(\0132E."
          + "google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse.EntityView\032\037\n"
          + "\021FeatureDescriptor\022\n\n"
          + "\002id\030\001 \001(\t\032\263\001\n"
          + "\006Header\022>\n"
          + "\013entity_type\030\001 \001(\tB)\372A&\n"
          + "$aiplatform.googleapis.com/EntityType\022i\n"
          + "\023feature_descriptors\030\002 \003(\0132L.google.cloud.aiplatform.v1beta1."
          + "ReadFeatureValuesResponse.FeatureDescriptor\032\217\002\n\n"
          + "EntityView\022\021\n"
          + "\tentity_id\030\001 \001(\t\022X\n"
          + "\004data\030\002 \003(\0132J.google.cloud.aiplatform.v1"
          + "beta1.ReadFeatureValuesResponse.EntityView.Data\032\223\001\n"
          + "\004Data\022>\n"
          + "\005value\030\001 \001(\0132-.google.cloud.aiplatform.v1beta1.FeatureValueH\000\022C\n"
          + "\006values\030\002"
          + " \001(\01321.google.cloud.aiplatform.v1beta1.FeatureValueListH\000B\006\n"
          + "\004data\"\320\001\n"
          ...
          + "le.cloud.aiplatform.v1beta1.FeatureSelectorB\003\340A\002\"\204\005\n"
          ...
          + " \001(\0132*.google.cloud.aiplatform.v1beta1.BoolArrayH\000\022J\n"
          + "\022double_array_value\030\010"
          + " \001(\0132,.google.cloud.aiplatform.v1beta1.DoubleArrayH\000\022H\n"
          + "\021int64_array_value\030\013"
          + " \001(\0132+.google.cloud.aiplatform.v1beta1.Int64ArrayH\000\022J\n"
          + "\022string_array_value\030\014"
          + " \001(\0132,.google.cloud.aiplatform.v1beta1.StringArrayH\000\022\025\n"
          + "\013bytes_value\030\r"
          + " \001(\014H\000\022D\n"
          + "\014struct_value\030\017"
          + " \001(\0132,.google.cloud.aiplatform.v1beta1.StructValueH\000\022H\n"
          + "\010metadata\030\016"
          + " \001(\01326.google.cloud.aiplatform.v1beta1.FeatureValue.Metadata\032=\n"
          + "\010Metadata\0221\n\r"
          + "generate_time\030\001 \001(\0132\032.google.protobuf.TimestampB\007\n"
          + "\005value\"P\n"
          + "\013StructValue\022A\n"
          + "\006values\030\001 \003(\01321.google.cloud.aiplatform.v1beta1.StructFieldValue\"^\n"
          + "\020StructFieldValue\022\014\n"
          + "\004name\030\001 \001(\t\022<\n"
          + "\005value\030\002 \001(\0132-.google.cloud.aiplatform.v1beta1.FeatureValue\"Q\n"
          + "\020FeatureValueList\022=\n"
          + "\006values\030\001 \003(\0132-.google.cloud.aiplatform.v1beta1.FeatureValue2\253\007\n"
          + " FeaturestoreOnlineServingService\022\202\002\n"
          + "\021ReadFeatureValues\0229.google.cloud.aiplatfor"
          + "m.v1beta1.ReadFeatureValuesRequest\032:.google.cloud.aiplatform.v1beta1.ReadFeature"
          + "ValuesResponse\"v\332A\013entity_type\202\323\344\223\002b\"]/v"
          + "1beta1/{entity_type=projects/*/locations"
          + "/*/featurestores/*/entityTypes/*}:readFeatureValues:\001*\022\237\002\n"
          + "\032StreamingReadFeatureValues\022B.google.cloud.aiplatform.v1beta1."
          + "StreamingReadFeatureValuesRequest\032:.google.cloud.aiplatform.v1beta1.ReadFeatureV"
          + "aluesResponse\"\177\332A\013entity_type\202\323\344\223\002k\"f/v1"
          + "beta1/{entity_type=projects/*/locations/"
          + "*/featurestores/*/entityTypes/*}:streamingReadFeatureValues:\001*0\001\022\220\002\n"
          + "\022WriteFeatureValues\022:.google.cloud.aiplatform.v1beta"
          + "1.WriteFeatureValuesRequest\032;.google.cloud.aiplatform.v1beta1.WriteFeatureValues"
          + "Response\"\200\001\332A\024entity_type,payloads\202\323\344\223\002c"
          + "\"^/v1beta1/{entity_type=projects/*/locations/*/featurestores/*/entityTypes/*}:wr"
          + "iteFeatureValues:\001*\032M\312A\031aiplatform.googl"
          + "eapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\365\001\n"
          + "#com.google.cloud.aiplatform.v1beta1B\036FeaturestoreOnlineSe"
          + "rviceProtoP\001ZCcloud.google.com/go/aiplatform/apiv1beta1/aiplatformpb;aiplatformp"
    ...
    internal_static_google_cloud_aiplatform_v1beta1_FeatureValue_Metadata_descriptor =
        internal_static_google_cloud_aiplatform_v1beta1_FeatureValue_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1beta1_FeatureValue_Metadata_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1beta1_FeatureValue_Metadata_descriptor,
            new java.lang.String[] {
