...
public final class AutoMLVideoActionRecognitionProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\ncgoogle/cloud/aiplatform/v1beta1/schema"
          ...
          + "ORAL_VERSATILE_1\020\004B\221\003\nAcom.google.cloud."
          + "aiplatform.v1beta1.schema.trainingjob.de"
          + "finitionB!AutoMLVideoActionRecognitionPr"
          + "otoP\001Zacloud.google.com/go/aiplatform/ap"
          + "iv1beta1/schema/trainingjob/definition/d"
          + "efinitionpb;definitionpb\252\002=Google.Cloud."
          + "AIPlatform.V1Beta1.Schema.TrainingJob.De"
          + "finition\312\002=Google\\Cloud\\AIPlatform\\V1bet"
          + "a1\\Schema\\TrainingJob\\Definition\352\002CGoogl"
          + "e::Cloud::AIPlatform::V1beta1::Schema::T"
          + "rainingJob::Definitionb\006proto3"
    };
    descriptor =
