...
public final class AutoMlVideoObjectTracking extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AutoMlVideoObjectTracking(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetInputsFieldBuilder().getBuilder(), extensionRegistry);
