...
public final class AuthConfig extends com.google.protobuf.GeneratedMessage
  ...
  public static final class ApiKeyConfig extends com.google.protobuf.GeneratedMessage
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(apiKeySecret_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, apiKeySecret_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(apiKeySecret_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, apiKeySecret_);
      }
      if (httpElementLocation_
          != com.google.cloud.aiplatform.v1beta1.HttpElementLocation.HTTP_IN_UNSPECIFIED
              .getNumber()) {
   ...
   */
  public static final class HttpBasicAuthConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private HttpBasicAuthConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(credentialSecret_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, credentialSecret_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(credentialSecret_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, credentialSecret_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
   ...
   */
  public static final class GoogleServiceAccountConfig extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public static final class OauthConfig extends com.google.protobuf.GeneratedMessage
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (oauthConfigCase_ == 1) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, oauthConfig_);
      }
      if (oauthConfigCase_ == 2) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, oauthConfig_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (oauthConfigCase_ == 1) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, oauthConfig_);
      }
      if (oauthConfigCase_ == 2) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, oauthConfig_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
   ...
   */
  public static final class OidcConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (oidcConfigCase_ == 1) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, oidcConfig_);
      }
      if (oidcConfigCase_ == 2) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, oidcConfig_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (oidcConfigCase_ == 1) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, oidcConfig_);
      }
      if (oidcConfigCase_ == 2) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, oidcConfig_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(
                    internalGetHttpBasicAuthConfigFieldBuilder().getBuilder(), extensionRegistry);
                authConfigCase_ = 3;
                break;
              } // case 26
            case 34:
            ...
            case 58:
              {
                input.readMessage(
                    internalGetOidcConfigFieldBuilder().getBuilder(), extensionRegistry);
                authConfigCase_ = 7;
                break;
              } // case 58
            case 808:
    ...
    public com.google.cloud.aiplatform.v1beta1.AuthConfig.HttpBasicAuthConfig.Builder
      ...
      return internalGetHttpBasicAuthConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.aiplatform.v1beta1.AuthConfig.HttpBasicAuthConfig.Builder,
            com.google.cloud.aiplatform.v1beta1.AuthConfig.HttpBasicAuthConfigOrBuilder>
        internalGetHttpBasicAuthConfigFieldBuilder() {
      if (httpBasicAuthConfigBuilder_ == null) {
        if (!(authConfigCase_ == 3)) {
          authConfig_ =
              com.google.cloud.aiplatform.v1beta1.AuthConfig.HttpBasicAuthConfig
    ...
    public com.google.cloud.aiplatform.v1beta1.AuthConfig.OidcConfig.Builder
      ...
      return internalGetOidcConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.aiplatform.v1beta1.AuthConfig.OidcConfig.Builder,
            com.google.cloud.aiplatform.v1beta1.AuthConfig.OidcConfigOrBuilder>
        internalGetOidcConfigFieldBuilder() {
      if (oidcConfigBuilder_ == null) {
        if (!(authConfigCase_ == 7)) {
          authConfig_ =
              com.google.cloud.aiplatform.v1beta1.AuthConfig.OidcConfig.getDefaultInstance();
