...
public class HyperparameterTuningJobName implements ResourceName {
  ...
  public static @Nullable HyperparameterTuningJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable HyperparameterTuningJobName> values) {
