...
public final class FeatureStatsAndAnomaly extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private FeatureStatsAndAnomaly(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(featureMonitorId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, featureMonitorId_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(featureMonitorId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, featureMonitorId_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetStatsTimeFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.cloud.aiplatform.v1beta1.FeatureStatsAndAnomaly other) {
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getDistributionDeviation()) != 0) {
        setDistributionDeviation(other.getDistributionDeviation());
      }
      if (java.lang.Double.doubleToRawLongBits(other.getDriftDetectionThreshold()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetFeatureStatsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 50:
              {
                input.readMessage(
                    internalGetStatsTimeFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.protobuf.Value.Builder getFeatureStatsBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetFeatureStatsFieldBuilder().getBuilder();
    }
    ...
    public com.google.protobuf.Timestamp.Builder getStatsTimeBuilder() {
      bitField0_ |= 0x00000020;
      onChanged();
      return internalGetStatsTimeFieldBuilder().getBuilder();
    }
