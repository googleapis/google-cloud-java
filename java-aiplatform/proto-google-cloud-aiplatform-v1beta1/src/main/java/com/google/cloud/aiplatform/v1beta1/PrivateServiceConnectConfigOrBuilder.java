...
public interface PrivateServiceConnectConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.PrivateServiceConnectConfig)
   ...
   * </pre>
   *
   * <code>bool enable_secure_private_service_connect = 4 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   * @return The enableSecurePrivateServiceConnect.
   */
