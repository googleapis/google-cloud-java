...
public class RagCorpusName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RAG_CORPUS =
  ...
  public static RagCorpusName of(String project, String location, String ragCorpus) {
    return newBuilder().setProject(project).setLocation(location).setRagCorpus(ragCorpus).build();
  }
  ...
  public static @Nullable RagCorpusName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_RAG_CORPUS.validatedMatch(
            formattedString, "RagCorpusName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("rag_corpus"));
  }

  public static List<RagCorpusName> parseList(List<String> formattedStrings) {
    List<RagCorpusName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable RagCorpusName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_RAG_CORPUS.instantiate(
        "project", project, "location", location, "rag_corpus", ragCorpus);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/ragCorpora/{rag_corpus}. */
