...
public class NotebookExecutionJobName implements ResourceName {
  ...
  public static @Nullable NotebookExecutionJobName parse(String formattedString) {
  ...
  public static List<NotebookExecutionJobName> parseList(List<String> formattedStrings) {
    List<NotebookExecutionJobName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable NotebookExecutionJobName> values) {
