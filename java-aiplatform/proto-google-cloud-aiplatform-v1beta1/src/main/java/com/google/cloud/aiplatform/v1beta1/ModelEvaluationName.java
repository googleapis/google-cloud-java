...
public class ModelEvaluationName implements ResourceName {
  ...
  public static @Nullable ModelEvaluationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ModelEvaluationName> values) {
