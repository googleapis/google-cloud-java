...
public interface EvaluateDatasetOperationMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.EvaluateDatasetOperationMetadata)
