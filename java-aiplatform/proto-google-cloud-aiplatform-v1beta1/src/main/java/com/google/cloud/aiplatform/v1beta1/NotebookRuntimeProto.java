...
public final class NotebookRuntimeProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "6google/cloud/aiplatform/v1beta1/notebook_runtime.proto\022\037google.cloud.aiplatfor"
          + "m.v1beta1\032\037google/api/field_behavior.pro"
          + "to\032\031google/api/resource.proto\0325google/cl"
          + "oud/aiplatform/v1beta1/encryption_spec.proto\0327google/cloud/aiplatform/v1beta1/ma"
          + "chine_resources.proto\0322google/cloud/aiplatform/v1beta1/network_spec.proto\0329googl"
          + "e/cloud/aiplatform/v1beta1/notebook_euc_config.proto\032Cgoogle/cloud/aiplatform/v1"
          + "beta1/notebook_idle_shutdown_config.proto\032Cgoogle/cloud/aiplatform/v1beta1/noteb"
          + "ook_runtime_template_ref.proto\032>google/cloud/aiplatform/v1beta1/notebook_softwar"
          + "e_config.proto\032\037google/protobuf/timestamp.proto\"\253\n\n"
          ...
          + "d.aiplatform.v1beta1.MachineSpecB\006\340A\001\340A\005\022[\n"
          + "\031data_persistent_disk_spec\030\010 \001(\01323.go"
          + "ogle.cloud.aiplatform.v1beta1.PersistentDiskSpecB\003\340A\001\022G\n"
          + "\014network_spec\030\014 \001(\0132,.go"
          + "ogle.cloud.aiplatform.v1beta1.NetworkSpecB\003\340A\001\022\033\n"
          + "\017service_account\030\r"
          + " \001(\tB\002\030\001\022\014\n"
          + "\004etag\030\016 \001(\t\022T\n"
          + "\006labels\030\017 \003(\0132D.google.cloud"
          + ".aiplatform.v1beta1.NotebookRuntimeTemplate.LabelsEntry\022Y\n"
          + "\024idle_shutdown_config\030\021"
          + " \001(\0132;.google.cloud.aiplatform.v1beta1.NotebookIdleShutdownConfig\022F\n\n"
          + "euc_config\030\022"
          + " \001(\01322.google.cloud.aiplatform.v1beta1.NotebookEucConfig\0224\n"
          + "\013create_time\030\n"
          ...
          + "google.cloud.aiplatform.v1beta1.NotebookRuntimeTypeB\006\340A\001\340A\005\022U\n"
          + "\022shielded_vm_config\030\024"
          + " \001(\01321.google.cloud.aiplatform.v1beta1.ShieldedVmConfigB\006\340A\001\340A\005\022\031\n"
          + "\014network_tags\030\025 \003(\tB\003\340A\001\022H\n"
          + "\017encryption_spec\030\027 \001(\0132/"
          + ".google.cloud.aiplatform.v1beta1.EncryptionSpec\022U\n"
          + "\017software_config\030\030 \001(\01327.googl"
          + "e.cloud.aiplatform.v1beta1.NotebookSoftwareConfigB\003\340A\001\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\225\001\352A\221\001\n"
          + "1aiplatform.googleapis.com/NotebookRuntimeTemplate\022"
          + "\\projects/{project}/locations/{location}"
          + "/notebookRuntimeTemplates/{notebook_runtime_template}\"\274\017\n"
          ...
          + ".google.cloud.aiplatform.v1beta1.NotebookRuntimeTemplateRefB\003\340A\003\022\026\n"
          ...
          + "\014health_state\030\010 \001(\0162<.google.cloud.aiplat"
          + "form.v1beta1.NotebookRuntime.HealthStateB\003\340A\003\022\031\n"
          + "\014display_name\030\n"
          + " \001(\tB\003\340A\002\022\023\n"
          + "\013description\030\013 \001(\t\022\034\n"
          + "\017service_account\030\r"
          + " \001(\tB\003\340A\003\022Y\n\r"
          + "runtime_state\030\016 \001(\0162=.google.clou"
          + "d.aiplatform.v1beta1.NotebookRuntime.RuntimeStateB\003\340A\003\022\032\n\r"
          + "is_upgradable\030\017 \001(\010B\003\340A\003\022L\n"
          + "\006labels\030\020 \003(\0132<.google.cloud.aiplat"
          + "form.v1beta1.NotebookRuntime.LabelsEntry\0228\n"
          ...
          + ".cloud.aiplatform.v1beta1.NotebookRuntimeTypeB\003\340A\003\022G\n"
          + "\014machine_spec\030\024 \001(\0132,.googl"
          + "e.cloud.aiplatform.v1beta1.MachineSpecB\003\340A\003\022[\n"
          + "\031data_persistent_disk_spec\030\025 \001(\01323"
          + ".google.cloud.aiplatform.v1beta1.PersistentDiskSpecB\003\340A\003\022G\n"
          + "\014network_spec\030\026 \001(\0132,"
          + ".google.cloud.aiplatform.v1beta1.NetworkSpecB\003\340A\003\022^\n"
          + "\024idle_shutdown_config\030\027 \001(\0132"
          + ";.google.cloud.aiplatform.v1beta1.NotebookIdleShutdownConfigB\003\340A\003\022K\n\n"
          + "euc_config\030\030"
          + " \001(\01322.google.cloud.aiplatform.v1beta1.NotebookEucConfigB\003\340A\003\022R\n"
          + "\022shielded_vm_config\030 "
          + " \001(\01321.google.cloud.aiplatform.v1beta1.ShieldedVmConfigB\003\340A\003\022\031\n"
          + "\014network_tags\030\031 \003(\tB\003\340A\001\022U\n"
          + "\017software_config\030\037 \001(\01327"
          + ".google.cloud.aiplatform.v1beta1.NotebookSoftwareConfigB\003\340A\003\022M\n"
          + "\017encryption_spec\030\034"
          + " \001(\0132/.google.cloud.aiplatform.v1beta1.EncryptionSpecB\003\340A\003\022\032\n\r"
          ...
          + ")aiplatform.googleapis.com/NotebookRuntime\022"
          + "Kprojects/{project}/locations/{location}/notebookRuntimes/{notebook_runtime}*]\n"
          ...
          + "#com.google.cloud.aiplatform.v1beta1B\024NotebookRuntimeProtoP\001ZCclo"
    ...
    internal_static_google_cloud_aiplatform_v1beta1_NotebookRuntime_LabelsEntry_descriptor =
        internal_static_google_cloud_aiplatform_v1beta1_NotebookRuntime_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1beta1_NotebookRuntime_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1beta1_NotebookRuntime_LabelsEntry_descriptor,
            new java.lang.String[] {
