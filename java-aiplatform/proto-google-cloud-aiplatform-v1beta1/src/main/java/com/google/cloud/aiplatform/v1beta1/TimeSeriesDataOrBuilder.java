...
public interface TimeSeriesDataOrBuilder
   ...
   * </code>
   */
  java.util.List<com.google.cloud.aiplatform.v1beta1.TimeSeriesDataPoint> getValuesList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1beta1.TimeSeriesDataPointOrBuilder getValuesOrBuilder(int index);
}
