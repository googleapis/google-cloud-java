...
public final class ModelMonitoringStatsDataPoint extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ModelMonitoringStatsDataPoint(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class TypedValue extends com.google.protobuf.GeneratedMessage
      implements
     ...
     */
    public static final class DistributionDataValue extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private DistributionDataValue(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(modelMonitoringJob_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, modelMonitoringJob_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(algorithm_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, algorithm_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(modelMonitoringJob_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, modelMonitoringJob_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(schedule_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(algorithm_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, algorithm_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetBaselineStatsFieldBuilder();
    ...
    public Builder mergeFrom(
      ...
      if (java.lang.Double.doubleToRawLongBits(other.getThresholdValue()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetBaselineStatsFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000002;
                break;
              } // case 18
            case 25:
    ...
    public com.google.cloud.aiplatform.v1beta1.ModelMonitoringStatsDataPoint.TypedValue.Builder
      ...
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetBaselineStatsFieldBuilder().getBuilder();
    }
