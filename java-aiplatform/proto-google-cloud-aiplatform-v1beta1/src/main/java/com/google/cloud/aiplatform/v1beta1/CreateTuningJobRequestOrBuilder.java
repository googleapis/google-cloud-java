...
public interface CreateTuningJobRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1beta1.CreateTuningJobRequest)
   ...
   *
   * <code>
   * .google.cloud.aiplatform.v1beta1.TuningJob tuning_job = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
