  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "ield_behavior.proto\032\031google/api/resource.proto\"\276\001\n"
          + "\010RagQuery\022\023\n"
          + "\004text\030\001 \001(\tB\003\340A\001H\000\022\035\n"
          + "\020similarity_top_k\030\002 \001(\005B\003\340A\001\022G\n"
          + "\007ranking\030\004"
          + " \001(\01321.google.cloud.aiplatform.v1beta1.RagQuery.RankingB\003\340A\001\032,\n"
          + "\007Ranking\022\027\n"
          + "\005alpha\030\001 \001(\002B\003\340A\001H\000\210\001\001B\010\n"
          + "\006_alphaB\007\n"
          + "\005query\"\335\004\n"
          + "\027RetrieveContextsRequest\022c\n"
          + "\020vertex_rag_store\030\002 \001(\0132G.google.cloud.aiplatform."
          + "v1beta1.RetrieveContextsRequest.VertexRagStoreH\000\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022=\n"
          + "\005query\030\003 \001"
          + "(\0132).google.cloud.aiplatform.v1beta1.RagQueryB\003\340A\002\032\323\002\n"
          + "\016VertexRagStore\022\032\n"
          + "\013rag_corpora\030\001 \003(\tB\005\030\001\340A\001\022o\n\r"
          + "rag_resources\030\003 \003(\0132S.google.cloud.aiplatform.v1beta1.Retri"
          + "eveContextsRequest.VertexRagStore.RagResourceB\003\340A\001\022+\n"
          ...
          + "\013data_source\"\255\001\n"
          + "\013RagContexts\022F\n"
          + "\010contexts\030\001 \003("
          + "\01324.google.cloud.aiplatform.v1beta1.RagContexts.Context\032V\n"
          + "\007Context\022\022\n\n"
          ...
          + "\010contexts\030\001"
          + " \001(\0132,.google.cloud.aiplatform.v1beta1.RagContexts2\300\002\n"
          + "\020VertexRagService\022\334\001\n"
          + "\020RetrieveContexts\0228.google.cloud.aiplatform.v1beta1.Retrieve"
          ...
          + "www.googleapis.com/auth/cloud-platformB\354\001\n"
          + "#com.google.cloud.aiplatform.v1beta1B\025VertexRagServiceProtoP\001ZCcloud.google.co"
          ...
          + "\352\002\"Google::Cloud::AIPlatform::V1beta1b\006proto3"
    };
    descriptor =
