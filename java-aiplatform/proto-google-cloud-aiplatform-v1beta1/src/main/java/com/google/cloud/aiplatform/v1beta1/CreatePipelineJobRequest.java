          ...
          case 18:
            {
              ...
              pipelineJob_ =
                  input.readMessage(
                      com.google.cloud.aiplatform.v1beta1.PipelineJob.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.aiplatform.v1beta1.CreatePipelineJobRequest) e.getUnfinishedMessage();
    ...
    public Builder mergePipelineJob(com.google.cloud.aiplatform.v1beta1.PipelineJob value) {
      if (pipelineJobBuilder_ == null) {
        if (pipelineJob_ != null) {
          pipelineJob_ =
              com.google.cloud.aiplatform.v1beta1.PipelineJob.newBuilder(pipelineJob_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          pipelineJob_ = value;
