...
public class DeploymentResourcePoolName implements ResourceName {
  ...
  public static @Nullable DeploymentResourcePoolName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DeploymentResourcePoolName> values) {
