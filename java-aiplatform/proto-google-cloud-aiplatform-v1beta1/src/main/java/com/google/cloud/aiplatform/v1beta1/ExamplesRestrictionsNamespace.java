 ...
 */
public final class ExamplesRestrictionsNamespace extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        ExamplesRestrictionsNamespace.class.getName());
  }
  // Use ExamplesRestrictionsNamespace.newBuilder() to construct.
  private ExamplesRestrictionsNamespace(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(namespaceName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, namespaceName_);
    }
    for (int i = 0; i < allow_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, allow_.getRaw(i));
    }
    for (int i = 0; i < deny_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, deny_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(namespaceName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, namespaceName_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < allow_.size(); i++) {
