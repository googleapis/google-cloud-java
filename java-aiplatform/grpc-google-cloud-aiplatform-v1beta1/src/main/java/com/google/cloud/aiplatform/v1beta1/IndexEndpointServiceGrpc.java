...
public final class IndexEndpointServiceGrpc {
  ...
  public static IndexEndpointServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<IndexEndpointServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<IndexEndpointServiceBlockingV2Stub>() {
          @java.lang.Override
          public IndexEndpointServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new IndexEndpointServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return IndexEndpointServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class IndexEndpointServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<IndexEndpointServiceBlockingV2Stub> {
    private IndexEndpointServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected IndexEndpointServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new IndexEndpointServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service IndexEndpointService.
   *
   * <pre>
   * A service for managing Vertex AI's IndexEndpoints.
   * </pre>
