...
public final class ExtensionExecutionServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.cloud.aiplatform.v1beta1.ExecuteExtensionResponse>
        getExecuteExtensionMethod;
    if ((getExecuteExtensionMethod = ExtensionExecutionServiceGrpc.getExecuteExtensionMethod)
        == null) {
      synchronized (ExtensionExecutionServiceGrpc.class) {
        if ((getExecuteExtensionMethod = ExtensionExecutionServiceGrpc.getExecuteExtensionMethod)
            == null) {
          ExtensionExecutionServiceGrpc.getExecuteExtensionMethod =
              getExecuteExtensionMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.aiplatform.v1beta1.ExecuteExtensionRequest,
                          com.google.cloud.aiplatform.v1beta1.ExecuteExtensionResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.aiplatform.v1beta1.ExecuteExtensionResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new ExtensionExecutionServiceMethodDescriptorSupplier("ExecuteExtension"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getQueryExtensionMethod = ExtensionExecutionServiceGrpc.getQueryExtensionMethod) == null) {
      synchronized (ExtensionExecutionServiceGrpc.class) {
        if ((getQueryExtensionMethod = ExtensionExecutionServiceGrpc.getQueryExtensionMethod)
            == null) {
          ExtensionExecutionServiceGrpc.getQueryExtensionMethod =
              getQueryExtensionMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.aiplatform.v1beta1.QueryExtensionRequest,
                          com.google.cloud.aiplatform.v1beta1.QueryExtensionResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.aiplatform.v1beta1.QueryExtensionResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new ExtensionExecutionServiceMethodDescriptorSupplier("QueryExtension"))
                      .build();
        }
      }
    }
  ...
  public static ExtensionExecutionServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ExtensionExecutionServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ExtensionExecutionServiceStub>() {
          @java.lang.Override
          public ExtensionExecutionServiceStub newStub(
   ...
   */
  public static ExtensionExecutionServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ExtensionExecutionServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ExtensionExecutionServiceBlockingStub>() {
          @java.lang.Override
          public ExtensionExecutionServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static ExtensionExecutionServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<ExtensionExecutionServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<ExtensionExecutionServiceFutureStub>() {
          @java.lang.Override
          public ExtensionExecutionServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void executeExtension(
        com.google.cloud.aiplatform.v1beta1.ExecuteExtensionRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.ExecuteExtensionResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getExecuteExtensionMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void queryExtension(
        com.google.cloud.aiplatform.v1beta1.QueryExtensionRequest request,
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.QueryExtensionResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getQueryExtensionMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public abstract static class ExtensionExecutionServiceImplBase
  ...
  public static final class ExtensionExecutionServiceStub
    ...
    public void executeExtension(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getExecuteExtensionMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void queryExtension(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.aiplatform.v1beta1.QueryExtensionResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getQueryExtensionMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  public static final class ExtensionExecutionServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.aiplatform.v1beta1.ExecuteExtensionResponse>
        executeExtension(com.google.cloud.aiplatform.v1beta1.ExecuteExtensionRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.aiplatform.v1beta1.QueryExtensionResponse>
        queryExtension(com.google.cloud.aiplatform.v1beta1.QueryExtensionRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
  ...
  private abstract static class ExtensionExecutionServiceBaseDescriptorSupplier
