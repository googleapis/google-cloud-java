...
public final class FeaturestoreOnlineServingServiceGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse>
        getReadFeatureValuesMethod;
    if ((getReadFeatureValuesMethod =
            FeaturestoreOnlineServingServiceGrpc.getReadFeatureValuesMethod)
        == null) {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse>
        getStreamingReadFeatureValuesMethod;
    if ((getStreamingReadFeatureValuesMethod =
          ...
          FeaturestoreOnlineServingServiceGrpc.getStreamingReadFeatureValuesMethod =
              getStreamingReadFeatureValuesMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "StreamingReadFeatureValues"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.aiplatform.v1beta1.StreamingReadFeatureValuesRequest
  ...
  public static FeaturestoreOnlineServingServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FeaturestoreOnlineServingServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<FeaturestoreOnlineServingServiceStub>() {
          @java.lang.Override
          public FeaturestoreOnlineServingServiceStub newStub(
  ...
  public static FeaturestoreOnlineServingServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<FeaturestoreOnlineServingServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<FeaturestoreOnlineServingServiceBlockingStub>() {
          @java.lang.Override
          public FeaturestoreOnlineServingServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static FeaturestoreOnlineServingServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FeaturestoreOnlineServingServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<FeaturestoreOnlineServingServiceFutureStub>() {
          @java.lang.Override
          public FeaturestoreOnlineServingServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public abstract static class FeaturestoreOnlineServingServiceImplBase
    ...
    public void readFeatureValues(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getReadFeatureValuesMethod(), responseObserver);
    }
  ...
  public static final class FeaturestoreOnlineServingServiceStub
    ...
    public void readFeatureValues(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getReadFeatureValuesMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void streamingReadFeatureValues(
      ...
      io.grpc.stub.ClientCalls.asyncServerStreamingCall(
          getChannel().newCall(getStreamingReadFeatureValuesMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  ...
  public static final class FeaturestoreOnlineServingServiceBlockingStub
     ...
     * </pre>
     */
    public java.util.Iterator<com.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse>
        streamingReadFeatureValues(
            com.google.cloud.aiplatform.v1beta1.StreamingReadFeatureValuesRequest request) {
  ...
  public static final class FeaturestoreOnlineServingServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse>
        readFeatureValues(com.google.cloud.aiplatform.v1beta1.ReadFeatureValuesRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.aiplatform.v1beta1.WriteFeatureValuesResponse>
        writeFeatureValues(com.google.cloud.aiplatform.v1beta1.WriteFeatureValuesRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_STREAMING_READ_FEATURE_VALUES:
          serviceImpl.streamingReadFeatureValues(
              (com.google.cloud.aiplatform.v1beta1.StreamingReadFeatureValuesRequest) request,
              (io.grpc.stub.StreamObserver<
                      com.google.cloud.aiplatform.v1beta1.ReadFeatureValuesResponse>)
                  responseObserver);
