...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-aiplatform" % "3.40.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-aiplatform/3.40.0
