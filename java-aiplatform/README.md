...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-aiplatform" % "3.69.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-aiplatform/3.69.0
