...
public class EndpointServiceClient implements BackgroundResource {
  ...
  public final OperationFuture<PublisherModelConfig, SetPublisherModelConfigOperationMetadata>
      setPublisherModelConfigAsync(
          @Nullable EndpointName name, PublisherModelConfig publisherModelConfig) {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final PublisherModelConfig fetchPublisherModelConfig(@Nullable EndpointName name) {
