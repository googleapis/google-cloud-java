...
/**
 * Base stub class for the ExtensionExecutionService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@BetaApi
@Generated("by gapic-generator-java")
public abstract class ExtensionExecutionServiceStub implements BackgroundResource {

  public UnaryCallable<ExecuteExtensionRequest, ExecuteExtensionResponse>
      executeExtensionCallable() {
    throw new UnsupportedOperationException("Not implemented: executeExtensionCallable()");
  }

  public UnaryCallable<QueryExtensionRequest, QueryExtensionResponse> queryExtensionCallable() {
    throw new UnsupportedOperationException("Not implemented: queryExtensionCallable()");
  }
