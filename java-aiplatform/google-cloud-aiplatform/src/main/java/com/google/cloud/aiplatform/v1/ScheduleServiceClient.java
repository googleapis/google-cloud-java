 ...
 *    <tr>
 *      <td>PauseSchedule</td>
 *      <td><p> Pauses a Schedule. Will mark [Schedule.state][google.cloud.aiplatform.v1.Schedule.state] to 'PAUSED'. If the schedule is paused, no new runs will be created. Already created runs will NOT be paused or canceled.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class ScheduleServiceClient implements BackgroundResource {
  ...
  // AUTO-GENERATED DOCUMENTATION AND METHOD.
  /**
   * Pauses a Schedule. Will mark [Schedule.state][google.cloud.aiplatform.v1.Schedule.state] to
   * 'PAUSED'. If the schedule is paused, no new runs will be created. Already created runs will NOT
   ...
   * [Schedule.state][google.cloud.aiplatform.v1.Schedule.state] to 'ACTIVE'. Only paused Schedule
   * can be resumed.
   *
