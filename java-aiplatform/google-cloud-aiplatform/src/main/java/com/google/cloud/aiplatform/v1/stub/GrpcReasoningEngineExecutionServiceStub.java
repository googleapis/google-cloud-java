...
public class GrpcReasoningEngineExecutionServiceStub extends ReasoningEngineExecutionServiceStub {
  private static final MethodDescriptor<QueryReasoningEngineRequest, QueryReasoningEngineResponse>
      queryReasoningEngineMethodDescriptor =
          MethodDescriptor.<QueryReasoningEngineRequest, QueryReasoningEngineResponse>newBuilder()
  ...
  private static final MethodDescriptor<AsyncQueryReasoningEngineRequest, Operation>
      asyncQueryReasoningEngineMethodDescriptor =
          MethodDescriptor.<AsyncQueryReasoningEngineRequest, Operation>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
  ...
  private final UnaryCallable<AsyncQueryReasoningEngineRequest, Operation>
  ...
  public static final GrpcReasoningEngineExecutionServiceStub create(
      ReasoningEngineExecutionServiceStubSettings settings) throws IOException {
    return new GrpcReasoningEngineExecutionServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcReasoningEngineExecutionServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcReasoningEngineExecutionServiceStub(
        ReasoningEngineExecutionServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcReasoningEngineExecutionServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcReasoningEngineExecutionServiceStub(
        ReasoningEngineExecutionServiceStubSettings.newBuilder().build(),
        clientContext,
        callableFactory);
  }

  /**
   * Constructs an instance of GrpcReasoningEngineExecutionServiceStub, using the given settings.
   * This is protected so that it is easy to make a subclass, but otherwise, the static factory
   * methods should be preferred.
   */
  protected GrpcReasoningEngineExecutionServiceStub(
      ReasoningEngineExecutionServiceStubSettings settings, ClientContext clientContext)
      throws IOException {
    this(settings, clientContext, new GrpcReasoningEngineExecutionServiceCallableFactory());
  }
   ...
   */
  protected GrpcReasoningEngineExecutionServiceStub(
      ReasoningEngineExecutionServiceStubSettings settings,
    ...
    GrpcCallSettings<QueryReasoningEngineRequest, QueryReasoningEngineResponse>
        queryReasoningEngineTransportSettings =
            GrpcCallSettings.<QueryReasoningEngineRequest, QueryReasoningEngineResponse>newBuilder()
                .setMethodDescriptor(queryReasoningEngineMethodDescriptor)
                .setParamsExtractor(
                    request -> {
    ...
    GrpcCallSettings<StreamQueryReasoningEngineRequest, HttpBody>
        streamQueryReasoningEngineTransportSettings =
            GrpcCallSettings.<StreamQueryReasoningEngineRequest, HttpBody>newBuilder()
                ...
                .setResourceNameExtractor(request -> request.getName())
                .build();
    GrpcCallSettings<AsyncQueryReasoningEngineRequest, Operation>
        asyncQueryReasoningEngineTransportSettings =
            GrpcCallSettings.<AsyncQueryReasoningEngineRequest, Operation>newBuilder()
