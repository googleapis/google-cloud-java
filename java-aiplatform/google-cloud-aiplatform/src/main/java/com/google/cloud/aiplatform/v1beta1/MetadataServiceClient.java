...
public class MetadataServiceClient implements BackgroundResource {
   ...
   *     MetadataStore's ID will be a UUID generated by the service. Must be 4-128 characters in
   *     length. Valid characters are /[a-z][0-9]-/. Must be unique across all MetadataStores in the
   *     parent Location. (Otherwise the request will fail with ALREADY_EXISTS, or PERMISSION_DENIED
