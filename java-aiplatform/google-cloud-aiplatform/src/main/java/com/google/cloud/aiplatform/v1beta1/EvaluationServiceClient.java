 ...
 *    </tr>
 *    <tr>
 *      <td><p> EvaluateInstances</td>
 *      <td><p> Evaluates instances based on a given metric.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> evaluateInstances(EvaluateInstancesRequest request)
 *      </ul>
...
public class EvaluationServiceClient implements BackgroundResource {
   ...
   */
  public final EvaluateInstancesResponse evaluateInstances(EvaluateInstancesRequest request) {
    return evaluateInstancesCallable().call(request);
  }
   ...
   *   // Do something.
   *   EvaluateInstancesResponse response = future.get();
   * }
   * }</pre>
   */
   ...
   *           .build();
   *   Policy response = evaluationServiceClient.setIamPolicy(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   *           .setUpdateMask(FieldMask.newBuilder().build())
   *           .build();
   *   ApiFuture<Policy> future = evaluationServiceClient.setIamPolicyCallable().futureCall(request);
   *   // Do something.
   ...
   *           .build();
   *   Policy response = evaluationServiceClient.getIamPolicy(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   *           .setOptions(GetPolicyOptions.newBuilder().build())
   *           .build();
   *   ApiFuture<Policy> future = evaluationServiceClient.getIamPolicyCallable().futureCall(request);
   *   // Do something.
   *   Policy response = future.get();
   * }
   * }</pre>
   ...
   *           .build();
   *   TestIamPermissionsResponse response = evaluationServiceClient.testIamPermissions(request);
   * }
   * }</pre>
   *
   * @param request The request object containing all of the parameters for the API call.
   ...
   *       evaluationServiceClient.testIamPermissionsCallable().futureCall(request);
   *   // Do something.
