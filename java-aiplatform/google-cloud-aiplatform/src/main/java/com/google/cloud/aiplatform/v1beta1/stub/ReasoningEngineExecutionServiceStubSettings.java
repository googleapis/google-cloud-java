...
/**
 * Settings class to configure an instance of {@link ReasoningEngineExecutionServiceStub}.
 *
...
public class ReasoningEngineExecutionServiceStubSettings
  ...
  public ReasoningEngineExecutionServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcReasoningEngineExecutionServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic",
            GaxProperties.getLibraryVersion(ReasoningEngineExecutionServiceStubSettings.class))
        .setTransportToken(
  ...
  protected ReasoningEngineExecutionServiceStubSettings(Builder settingsBuilder)
      throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<ReasoningEngineExecutionServiceStubSettings, Builder> {
    ...
    protected Builder(ReasoningEngineExecutionServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public ReasoningEngineExecutionServiceStubSettings build() throws IOException {
      return new ReasoningEngineExecutionServiceStubSettings(this);
    }
  }
}
