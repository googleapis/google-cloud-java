...
import com.google.cloud.aiplatform.v1.EvaluateInstancesRequest;
...
public class GrpcEvaluationServiceStub extends EvaluationServiceStub {
  private static final MethodDescriptor<EvaluateInstancesRequest, EvaluateInstancesResponse>
      evaluateInstancesMethodDescriptor =
          MethodDescriptor.<EvaluateInstancesRequest, EvaluateInstancesResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.aiplatform.v1.EvaluationService/EvaluateInstances")
  ...
  protected GrpcEvaluationServiceStub(
    ...
    GrpcCallSettings<EvaluateInstancesRequest, EvaluateInstancesResponse>
        evaluateInstancesTransportSettings =
            GrpcCallSettings.<EvaluateInstancesRequest, EvaluateInstancesResponse>newBuilder()
                .setMethodDescriptor(evaluateInstancesMethodDescriptor)
                .setParamsExtractor(
                    request -> {
