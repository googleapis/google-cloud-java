...
/**
 * Settings class to configure an instance of {@link FeatureOnlineStoreServiceStub}.
 *
...
public class FeatureOnlineStoreServiceStubSettings
  ...
  public FeatureOnlineStoreServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcFeatureOnlineStoreServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(FeatureOnlineStoreServiceStubSettings.class))
        .setTransportToken(
  ...
  protected FeatureOnlineStoreServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<FeatureOnlineStoreServiceStubSettings, Builder> {
    ...
    protected Builder(FeatureOnlineStoreServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public FeatureOnlineStoreServiceStubSettings build() throws IOException {
      return new FeatureOnlineStoreServiceStubSettings(this);
    }
  }
}
