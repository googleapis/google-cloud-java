 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the OnlineEvaluatorServiceClient object to clean up
 ...
 *    </tr>
 *    <tr>
 *      <td><p> CreateOnlineEvaluator</td>
 *      <td><p> Creates an OnlineEvaluator in the given project and location.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> createOnlineEvaluatorAsync(CreateOnlineEvaluatorRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> createOnlineEvaluatorAsync(LocationName parent, OnlineEvaluator onlineEvaluator)
 *           <li><p> createOnlineEvaluatorAsync(String parent, OnlineEvaluator onlineEvaluator)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> createOnlineEvaluatorOperationCallable()
 *           <li><p> createOnlineEvaluatorCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> GetOnlineEvaluator</td>
 *      <td><p> Gets details of an OnlineEvaluator.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> getOnlineEvaluator(GetOnlineEvaluatorRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> getOnlineEvaluator(OnlineEvaluatorName name)
 *           <li><p> getOnlineEvaluator(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> getOnlineEvaluatorCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> UpdateOnlineEvaluator</td>
 *      <td><p> Updates the fields of an OnlineEvaluator.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> updateOnlineEvaluatorAsync(UpdateOnlineEvaluatorRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> updateOnlineEvaluatorAsync(OnlineEvaluator onlineEvaluator, FieldMask updateMask)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> updateOnlineEvaluatorOperationCallable()
 *           <li><p> updateOnlineEvaluatorCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> DeleteOnlineEvaluator</td>
 *      <td><p> Deletes an OnlineEvaluator.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> deleteOnlineEvaluatorAsync(DeleteOnlineEvaluatorRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> deleteOnlineEvaluatorAsync(OnlineEvaluatorName name)
 *           <li><p> deleteOnlineEvaluatorAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> deleteOnlineEvaluatorOperationCallable()
 *           <li><p> deleteOnlineEvaluatorCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> ListOnlineEvaluators</td>
 *      <td><p> Lists the OnlineEvaluators for the given project and location.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> listOnlineEvaluators(ListOnlineEvaluatorsRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> listOnlineEvaluators(LocationName parent)
 *           <li><p> listOnlineEvaluators(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> listOnlineEvaluatorsPagedCallable()
 *           <li><p> listOnlineEvaluatorsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> ActivateOnlineEvaluator</td>
 *      <td><p> Activates an OnlineEvaluator.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> activateOnlineEvaluatorAsync(ActivateOnlineEvaluatorRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> activateOnlineEvaluatorAsync(OnlineEvaluatorName name)
 *           <li><p> activateOnlineEvaluatorAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> activateOnlineEvaluatorOperationCallable()
 *           <li><p> activateOnlineEvaluatorCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> SuspendOnlineEvaluator</td>
 *      <td><p> Suspends an OnlineEvaluator. When an OnlineEvaluator is suspended, it won't run any evaluations until it is activated again.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> suspendOnlineEvaluatorAsync(SuspendOnlineEvaluatorRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li><p> suspendOnlineEvaluatorAsync(OnlineEvaluatorName name)
 *           <li><p> suspendOnlineEvaluatorAsync(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> suspendOnlineEvaluatorOperationCallable()
 *           <li><p> suspendOnlineEvaluatorCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 ...
 *
 * <p>This class can be customized by passing in a custom instance of OnlineEvaluatorServiceSettings
...
public class OnlineEvaluatorServiceClient implements BackgroundResource {
   ...
   * }</pre>
   */
  public final UnaryCallable<CreateOnlineEvaluatorRequest, Operation>
   ...
   * }</pre>
   */
  public final UnaryCallable<GetOnlineEvaluatorRequest, OnlineEvaluator>
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final OperationFuture<OnlineEvaluator, UpdateOnlineEvaluatorOperationMetadata>
   ...
   * }</pre>
   */
  public final UnaryCallable<UpdateOnlineEvaluatorRequest, Operation>
   ...
   * }</pre>
   */
  public final UnaryCallable<DeleteOnlineEvaluatorRequest, Operation>
   ...
   * }</pre>
   */
  public final UnaryCallable<ListOnlineEvaluatorsRequest, ListOnlineEvaluatorsPagedResponse>
   ...
   * }</pre>
   */
  public final UnaryCallable<ListOnlineEvaluatorsRequest, ListOnlineEvaluatorsResponse>
   ...
   * }</pre>
   */
  public final UnaryCallable<ActivateOnlineEvaluatorRequest, Operation>
   ...
   * }</pre>
   */
  public final UnaryCallable<SuspendOnlineEvaluatorRequest, Operation>
  ...
  public static class ListOnlineEvaluatorsPagedResponse
    ...
    public static ApiFuture<ListOnlineEvaluatorsPagedResponse> createAsync(
      ...
      ApiFuture<ListOnlineEvaluatorsPage> futurePage =
