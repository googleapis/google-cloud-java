...
/**
 * Settings class to configure an instance of {@link VertexRagServiceStub}.
 *
...
public class VertexRagServiceStubSettings extends StubSettings<VertexRagServiceStubSettings> {
  ...
  public VertexRagServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcVertexRagServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(VertexRagServiceStubSettings.class))
        .setTransportToken(
  ...
  protected VertexRagServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for VertexRagServiceStubSettings. */
  public static class Builder extends StubSettings.Builder<VertexRagServiceStubSettings, Builder> {
    ...
    protected Builder(VertexRagServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public VertexRagServiceStubSettings build() throws IOException {
      return new VertexRagServiceStubSettings(this);
    }
  }
}
