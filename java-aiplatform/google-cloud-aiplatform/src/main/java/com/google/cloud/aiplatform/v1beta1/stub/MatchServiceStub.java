...
public abstract class MatchServiceStub implements BackgroundResource {

  public UnaryCallable<FindNeighborsRequest, FindNeighborsResponse> findNeighborsCallable() {
    throw new UnsupportedOperationException("Not implemented: findNeighborsCallable()");
  }

  public UnaryCallable<ReadIndexDatapointsRequest, ReadIndexDatapointsResponse>
      readIndexDatapointsCallable() {
    throw new UnsupportedOperationException("Not implemented: readIndexDatapointsCallable()");
  }
