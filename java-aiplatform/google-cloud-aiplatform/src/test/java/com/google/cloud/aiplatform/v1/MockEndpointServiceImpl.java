...
import com.google.cloud.aiplatform.v1.EndpointServiceGrpc.EndpointServiceImplBase;
...
public class MockEndpointServiceImpl extends EndpointServiceImplBase {
  ...
  public void updateEndpointLongRunning(
      UpdateEndpointLongRunningRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
