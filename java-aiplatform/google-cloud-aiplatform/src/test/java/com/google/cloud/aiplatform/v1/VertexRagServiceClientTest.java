...
public class VertexRagServiceClientTest {
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private static MockVertexRagService mockVertexRagService;
  private LocalChannelProvider channelProvider;
  private VertexRagServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockVertexRagService = new MockVertexRagService();
    mockLocations = new MockLocations();
    mockIAMPolicy = new MockIAMPolicy();
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(),
            Arrays.<MockGrpcService>asList(mockVertexRagService, mockLocations, mockIAMPolicy));
  ...
  public void setUp() throws IOException {
    ...
    VertexRagServiceSettings settings =
        VertexRagServiceSettings.newBuilder()
            .setTransportChannelProvider(channelProvider)
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = VertexRagServiceClient.create(settings);
  }
  ...
  @Test
  public void retrieveContextsTest() throws Exception {
    RetrieveContextsResponse expectedResponse =
        RetrieveContextsResponse.newBuilder().setContexts(RagContexts.newBuilder().build()).build();
    mockVertexRagService.addResponse(expectedResponse);

    LocationName parent = LocationName.of("[PROJECT]", "[LOCATION]");
    RagQuery query = RagQuery.newBuilder().build();

    RetrieveContextsResponse actualResponse = client.retrieveContexts(parent, query);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockVertexRagService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    RetrieveContextsRequest actualRequest = ((RetrieveContextsRequest) actualRequests.get(0));
  ...
  @Test
  public void retrieveContextsExceptionTest() throws Exception {
    ...
    try {
      LocationName parent = LocationName.of("[PROJECT]", "[LOCATION]");
      RagQuery query = RagQuery.newBuilder().build();
      client.retrieveContexts(parent, query);
  ...
  @Test
  public void retrieveContextsTest2() throws Exception {
    RetrieveContextsResponse expectedResponse =
        RetrieveContextsResponse.newBuilder().setContexts(RagContexts.newBuilder().build()).build();
    mockVertexRagService.addResponse(expectedResponse);
  ...
  @Test
  public void retrieveContextsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockVertexRagService.addException(exception);
