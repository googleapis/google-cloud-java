...
public class ReasoningEngineExecutionServiceClientTest {
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockReasoningEngineExecutionService mockReasoningEngineExecutionService;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private ReasoningEngineExecutionServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockReasoningEngineExecutionService = new MockReasoningEngineExecutionService();
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(
                mockReasoningEngineExecutionService, mockLocations, mockIAMPolicy));
  ...
  public void setUp() throws IOException {
    ...
    ReasoningEngineExecutionServiceSettings settings =
        ReasoningEngineExecutionServiceSettings.newBuilder()
            .setTransportChannelProvider(channelProvider)
            .setCredentialsProvider(NoCredentialsProvider.create())
            .build();
    client = ReasoningEngineExecutionServiceClient.create(settings);
  }
  ...
  @Test
  public void queryReasoningEngineTest() throws Exception {
    QueryReasoningEngineResponse expectedResponse =
        QueryReasoningEngineResponse.newBuilder()
            .setOutput(Value.newBuilder().setBoolValue(true).build())
            .build();
    ...
    QueryReasoningEngineRequest actualRequest =
        ((QueryReasoningEngineRequest) actualRequests.get(0));
  ...
  @Test
  public void queryReasoningEngineExceptionTest() throws Exception {
