...
public interface SearchDataItemsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.DataItemView> getDataItemViewsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.aiplatform.v1.DataItemView data_item_views = 1;</code>
   */
  com.google.cloud.aiplatform.v1.DataItemViewOrBuilder getDataItemViewsOrBuilder(int index);
