  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " \003(\0132).google.cloud.aiplatform.v1.DeployedModelB\003\340A\003\022M\n\r"
          + "traffic_split\030\005"
          + " \003(\01326.google.cloud.aiplatform.v1.Endpoint.TrafficSplitEntry\022\014\n"
          ...
          + " \001(\0132*.google.cloud.aiplatform.v1.EncryptionSpec\0227\n"
          + "\007network\030\r"
          + " \001(\tB&\340A\001\372A \n"
          + "\036compute.googleapis.com/Network\022*\n"
          + "\036enable_private_service_connect\030\021 \001(\010B\002\030\001\022d\n"
          + "\036private_service_connect_config\030\025 \001(\01327.google.cloud."
          + "aiplatform.v1.PrivateServiceConnectConfigB\003\340A\001\022g\n"
          + "\037model_deployment_monitoring_job\030\016 \001(\tB>\340A\003\372A8\n"
          + "6aiplatform.googleapis.com/ModelDeploymentMonitoringJob\022p\n"
          + "\'predict_request_response_logging_config\030\022 \001(\013"
          + "2?.google.cloud.aiplatform.v1.PredictRequestResponseLoggingConfig\022\"\n"
          + "\032dedicated_endpoint_enabled\030\030 \001(\010\022#\n"
          + "\026dedicated_endpoint_dns\030\031 \001(\tB\003\340A\003\022T\n"
          + "\030client_connection_config\030\027"
          + " \001(\01322.google.cloud.aiplatform.v1.ClientConnectionConfig\022\032\n\r"
          ...
          + "\"aiplatform.googleapis.com/Endpoint\022<projects/{project}/locations/{loca"
          + "tion}/endpoints/{endpoint}\022Mprojects/{pr"
          + "oject}/locations/{location}/publishers/{publisher}/models/{model}\"\362\t\n\r"
          + "DeployedModel\022M\n"
          + "\023dedicated_resources\030\007 \001(\0132..googl"
          + "e.cloud.aiplatform.v1.DedicatedResourcesH\000\022M\n"
          + "\023automatic_resources\030\010 \001(\0132..google"
          + ".cloud.aiplatform.v1.AutomaticResourcesH\000\022Q\n"
          ...
          + "\013create_time\030\006 \001(\0132\032.google.protobuf.TimestampB\003\340A\003\022E\n"
          + "\020explanation_spec\030\t"
          + " \001(\0132+.google.cloud.aiplatform.v1.ExplanationSpec\022\034\n"
          ...
          + " \001(\010\022L\n"
          + "\021private_endpoints\030\016 \001(\013"
          + "2,.google.cloud.aiplatform.v1.PrivateEndpointsB\003\340A\003\022T\n"
          + "\030faster_deployment_config\030\027"
          + " \001(\01322.google.cloud.aiplatform.v1.FasterDeploymentConfig\022E\n"
          + "\006status\030\032 \001(\01320.goog"
          + "le.cloud.aiplatform.v1.DeployedModel.StatusB\003\340A\003\022R\n\r"
          + "system_labels\030\034 \003(\0132;.google"
          + ".cloud.aiplatform.v1.DeployedModel.SystemLabelsEntry\022\025\n\r"
          + "checkpoint_id\030\035 \001(\t\022[\n"
          + "\031speculative_decoding_spec\030\036 \001(\01323.google."
          + "cloud.aiplatform.v1.SpeculativeDecodingSpecB\003\340A\001\032\177\n"
          + "\006Status\022\024\n"
          ...
          + "cloud.aiplatform.v1.BigQueryDestination\"N\n"
          ...
          + "\023fast_tryout_enabled\030\002 \001(\010\"\225\001\n"
          + "\033GenAiAdvancedFeaturesConfig\022U\n\n"
          + "rag_config\030\001 \001(\0132A.google.clou"
          + "d.aiplatform.v1.GenAiAdvancedFeaturesConfig.RagConfig\032\037\n"
          + "\tRagConfig\022\022\n\n"
          + "enable_rag\030\001 \001(\010\"\231\003\n"
          + "\027SpeculativeDecodingSpec\022l\n"
          + "\027draft_model_speculation\030\002 \001(\0132I.google.clo"
          + "ud.aiplatform.v1.SpeculativeDecodingSpec.DraftModelSpeculationH\000\022a\n"
          + "\021ngram_speculation\030\003 \001(\0132D.google.cloud.aiplatform.v1"
          + ".SpeculativeDecodingSpec.NgramSpeculationH\000\022\037\n"
          ...
          + "EndpointProtoP\001Z>cloud.google.com/go/aiplatform/apiv1/aiplatformp"
    ...
    internal_static_google_cloud_aiplatform_v1_Endpoint_TrafficSplitEntry_descriptor =
        internal_static_google_cloud_aiplatform_v1_Endpoint_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1_Endpoint_TrafficSplitEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_Endpoint_TrafficSplitEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_Endpoint_LabelsEntry_descriptor =
        internal_static_google_cloud_aiplatform_v1_Endpoint_descriptor.getNestedType(1);
    internal_static_google_cloud_aiplatform_v1_Endpoint_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_Endpoint_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_DeployedModel_Status_descriptor =
        internal_static_google_cloud_aiplatform_v1_DeployedModel_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1_DeployedModel_Status_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_DeployedModel_Status_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_DeployedModel_SystemLabelsEntry_descriptor =
        internal_static_google_cloud_aiplatform_v1_DeployedModel_descriptor.getNestedType(1);
    internal_static_google_cloud_aiplatform_v1_DeployedModel_SystemLabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_DeployedModel_SystemLabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_SpeculativeDecodingSpec_DraftModelSpeculation_descriptor =
        internal_static_google_cloud_aiplatform_v1_SpeculativeDecodingSpec_descriptor.getNestedType(
            0);
    internal_static_google_cloud_aiplatform_v1_SpeculativeDecodingSpec_DraftModelSpeculation_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_SpeculativeDecodingSpec_DraftModelSpeculation_descriptor,
