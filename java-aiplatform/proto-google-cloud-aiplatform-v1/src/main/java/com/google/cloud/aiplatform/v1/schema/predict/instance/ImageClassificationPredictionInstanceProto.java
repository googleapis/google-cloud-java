  ...
  static {
    java.lang.String[] descriptorData = {
      "\nMgoogle/cloud/aiplatform/v1/schema/pred"
          ...
          + "pe\030\002 \001(\tB\337\002\n6com.google.cloud.aiplatform"
          + ".v1.schema.predict.instanceB*ImageClassi"
          + "ficationPredictionInstanceProtoP\001ZRcloud"
          + ".google.com/go/aiplatform/apiv1/schema/p"
          + "redict/instance/instancepb;instancepb\252\0022"
          + "Google.Cloud.AIPlatform.V1.Schema.Predic"
          + "t.Instance\312\0022Google\\Cloud\\AIPlatform\\V1\\"
          + "Schema\\Predict\\Instance\352\0028Google::Cloud:"
          + ":AIPlatform::V1::Schema::Predict::Instan"
          + "ceb\006proto3"
    };
    descriptor =
