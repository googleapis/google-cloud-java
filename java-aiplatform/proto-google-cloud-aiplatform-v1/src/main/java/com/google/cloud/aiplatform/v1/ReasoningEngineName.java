...
public class ReasoningEngineName implements ResourceName {
  ...
  public static @Nullable ReasoningEngineName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ReasoningEngineName> values) {
