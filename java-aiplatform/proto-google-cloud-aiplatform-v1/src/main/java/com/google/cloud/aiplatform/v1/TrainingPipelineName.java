...
public class TrainingPipelineName implements ResourceName {
  ...
  public static @Nullable TrainingPipelineName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TrainingPipelineName> values) {
