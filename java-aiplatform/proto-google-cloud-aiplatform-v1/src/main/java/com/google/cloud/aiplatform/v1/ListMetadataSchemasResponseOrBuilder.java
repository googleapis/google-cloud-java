...
public interface ListMetadataSchemasResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.MetadataSchema> getMetadataSchemasList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.aiplatform.v1.MetadataSchema metadata_schemas = 1;</code>
   */
  com.google.cloud.aiplatform.v1.MetadataSchemaOrBuilder getMetadataSchemasOrBuilder(int index);
