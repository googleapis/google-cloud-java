...
public final class PersistentResourceServiceProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "<google/cloud/aiplatform/v1/persistent_resource_service.proto\022\032google.cloud.aip"
          ...
          + "proto\032*google/cloud/aiplatform/v1/operation.proto\0324google/cloud/aiplatform/v1/pe"
          + "rsistent_resource.proto\032#google/longrunn"
          + "ing/operations.proto\032\033google/protobuf/empty.proto\032"
          + " google/protobuf/field_mask.proto\"\323\001\n"
          + "\037CreatePersistentResourceRequest\0229\n"
          + "\006parent\030\001 \001(\tB)\340A\002\372A#\n"
          + "!locations.googleapis.com/Location\022P\n"
          + "\023persistent_resource\030\002"
          + " \001(\0132..google.cloud.aiplatform.v1.PersistentResourceB\003\340A\002\022#\n"
          + "\026persistent_resource_id\030\003 \001(\tB\003\340A\002\"\225\001\n"
          + ")CreatePersistentResourceOperationMetadata\022N\n"
          + "\020generic_metadata\030\001"
          + " \001(\01324.google.cloud.aiplatform.v1.GenericOperationMetadata\022\030\n"
          + "\020progress_message\030\002 \001(\t\"\225\001\n"
          + ")UpdatePersistentResourceOperationMetadata\022N\n"
          + "\020generic_metadata\030\001 \001("
          + "\01324.google.cloud.aiplatform.v1.GenericOperationMetadata\022\030\n"
          + "\020progress_message\030\002 \001(\t\"\225\001\n"
          + ")RebootPersistentResourceOperationMetadata\022N\n"
          + "\020generic_metadata\030\001 \001(\01324.goog"
          + "le.cloud.aiplatform.v1.GenericOperationMetadata\022\030\n"
          ...
          + " \003(\0132..google.cloud.aiplatform.v1.PersistentResource\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"e\n"
          + "\037DeletePersistentResourceRequest\022B\n"
          + "\004name\030\001 \001(\tB4\340A\002\372A.\n"
          + ",aiplatform.googleapis.com/PersistentResource\"\251\001\n"
          + "\037UpdatePersistentResourceRequest\022P\n"
          + "\023persistent_resource\030\001"
          + " \001(\0132..google.cloud.aiplatform.v1.PersistentResourceB\003\340A\002\0224\n"
          + "\013update_mask\030\002 \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\"e\n"
          + "\037RebootPersistentResourceRequest\022B\n"
          + "\004name\030\001 \001(\tB4\340A\002\372A.\n"
          + ",aiplatform.googleapis.com/PersistentResource2\245\r\n"
          + "\031PersistentResourceService\022\303\002\n"
          + "\030CreatePersistentResource\022;.google.cloud.aiplatform.v"
          + "1.CreatePersistentResourceRequest\032\035.google.longrunning.Operation\"\312\001\312A?\n"
          + "\022PersistentResource\022)CreatePersistentResourceOper"
          + "ationMetadata\332A1parent,persistent_resour"
          + "ce,persistent_resource_id\202\323\344\223\002N\"7/v1/{pa"
          + "rent=projects/*/locations/*}/persistentResources:\023persistent_resource\022\311\001\n"
          + "\025GetPersistentResource\0228.google.cloud.aiplatfor"
          + "m.v1.GetPersistentResourceRequest\032..google.cloud.aiplatform.v1.PersistentResourc"
          + "e\"F\332A\004name\202\323\344\223\0029\0227/v1/{name=projects/*/locations/*/persistentResources/*}\022\334\001\n"
          + "\027ListPersistentResources\022:.google.cloud.aip"
          + "latform.v1.ListPersistentResourcesRequest\032;.google.cloud.aiplatform.v1.ListPersi"
          + "stentResourcesResponse\"H\332A\006parent\202\323\344\223\0029\022"
          + "7/v1/{parent=projects/*/locations/*}/persistentResources\022\361\001\n"
          + "\030DeletePersistentResource\022;.google.cloud.aiplatform.v1.Delet"
          + "ePersistentResourceRequest\032\035.google.longrunning.Operation\"y\312A0\n"
          + "\025google.protobuf.Empty\022\027DeleteOperationMetadata\332A\004name\202\323\344"
          + "\223\0029*7/v1/{name=projects/*/locations/*/persistentResources/*}\022\305\002\n"
          + "\030UpdatePersistentResource\022;.google.cloud.aiplatform.v1.U"
          + "pdatePersistentResourceRequest\032\035.google.longrunning.Operation\"\314\001\312A?\n"
          + "\022PersistentResource\022)UpdatePersistentResourceOperati"
          + "onMetadata\332A\037persistent_resource,update_"
          + "mask\202\323\344\223\002b2K/v1/{persistent_resource.nam"
          + "e=projects/*/locations/*/persistentResources/*}:\023persistent_resource\022\213\002\n"
          + "\030RebootPersistentResource\022;.google.cloud.aiplatf"
          + "orm.v1.RebootPersistentResourceRequest\032\035.google.longrunning.Operation\"\222\001\312A?\n"
          + "\022PersistentResource\022)RebootPersistentResourc"
          ...
          + "apis.com\322A.https://www.googleapis.com/auth/cloud-platformB\334\001\n"
          + "\036com.google.cloud.aiplatform.v1B\036PersistentResourceServiceP"
