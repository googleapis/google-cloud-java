...
public class ContextName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_METADATA_STORE_CONTEXT =
  ...
  public static ContextName of(
      String project, String location, String metadataStore, String context) {
    return newBuilder()
        .setProject(project)
  ...
  public static ContextName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_METADATA_STORE_CONTEXT.validatedMatch(
  ...
  public String toString() {
    return PROJECT_LOCATION_METADATA_STORE_CONTEXT.instantiate(
        "project",
        project,
        "location",
        location,
