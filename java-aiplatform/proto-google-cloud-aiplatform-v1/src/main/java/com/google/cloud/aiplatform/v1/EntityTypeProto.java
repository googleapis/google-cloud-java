  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "v1/featurestore_monitoring.proto\032\037google/protobuf/timestamp.proto\"\366\004\n\n"
          + "EntityType\022\021\n"
          ...
          + "\006labels\030\006"
          + " \003(\01322.google.cloud.aiplatform.v1.EntityType.LabelsEntryB\003\340A\001\022\021\n"
          + "\004etag\030\007 \001(\tB\003\340A\001\022X\n"
          + "\021monitoring_config\030\010 \001(\01328.googl"
          + "e.cloud.aiplatform.v1.FeaturestoreMonitoringConfigB\003\340A\001\022%\n"
          + "\030offline_storage_ttl_days\030\n"
          + " \001(\005B\003\340A\001\022\032\n\r"
          + "satisfies_pzs\030\013 \001(\010B\003\340A\003\022\032\n\r"
          + "satisfies_pzi\030\014 \001(\010B\003\340A\003\032-\n"
          + "\013LabelsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\212\001\352A\206\001\n"
          + "$aiplatform.googleapis.com/EntityType\022^projects/{project}/locations/{locati"
          + "on}/featurestores/{featurestore}/entityTypes/{entity_type}B\315\001\n"
          + "\036com.google.cloud.aiplatform.v1B\017EntityTypeProtoP\001Z>cloud."
    ...
    internal_static_google_cloud_aiplatform_v1_EntityType_LabelsEntry_descriptor =
        internal_static_google_cloud_aiplatform_v1_EntityType_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1_EntityType_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_EntityType_LabelsEntry_descriptor,
            new java.lang.String[] {
