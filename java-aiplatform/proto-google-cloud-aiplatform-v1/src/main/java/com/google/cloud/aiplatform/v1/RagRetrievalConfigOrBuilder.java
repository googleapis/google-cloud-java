...
public interface RagRetrievalConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.RagRetrievalConfig)
   ...
   * @return The filter.
   */
  com.google.cloud.aiplatform.v1.RagRetrievalConfig.Filter getFilter();
  /**
   *
   *
   * <pre>
