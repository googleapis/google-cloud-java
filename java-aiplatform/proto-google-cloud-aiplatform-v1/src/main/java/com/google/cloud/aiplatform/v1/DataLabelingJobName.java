...
public class DataLabelingJobName implements ResourceName {
  ...
  public static @Nullable DataLabelingJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DataLabelingJobName> values) {
