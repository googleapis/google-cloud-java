...
public interface ListCustomJobsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.aiplatform.v1.CustomJob> getCustomJobsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.aiplatform.v1.CustomJob custom_jobs = 1;</code>
   */
  com.google.cloud.aiplatform.v1.CustomJobOrBuilder getCustomJobsOrBuilder(int index);
