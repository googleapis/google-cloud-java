  ...
  static {
    java.lang.String[] descriptorData = {
      "\nPgoogle/cloud/aiplatform/v1/schema/pred"
          ...
          + "rotobuf.FloatValueB\353\002\n8com.google.cloud."
          + "aiplatform.v1.schema.predict.predictionB"
          + "(VideoObjectTrackingPredictionResultProt"
          + "oP\001ZXcloud.google.com/go/aiplatform/apiv"
          + "1/schema/predict/prediction/predictionpb"
          + ";predictionpb\252\0024Google.Cloud.AIPlatform."
          + "V1.Schema.Predict.Prediction\312\0024Google\\Cl"
