...
public class TensorboardExperimentName implements ResourceName {
  ...
  public static @Nullable TensorboardExperimentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TensorboardExperimentName> values) {
