...
public class NotebookRuntimeName implements ResourceName {
  ...
  public static @Nullable NotebookRuntimeName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable NotebookRuntimeName> values) {
