  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3google/cloud/aiplatform/v1/prediction_"
          ...
          + "tobuf.Value2\327\006\n\021PredictionService\022\224\002\n\007Pr"
          + "edict\022*.google.cloud.aiplatform.v1.Predi"
          + "ctRequest\032+.google.cloud.aiplatform.v1.P"
          + "redictResponse\"\257\001\202\323\344\223\002\210\001\"9/v1/{endpoint="
          + "projects/*/locations/*/endpoints/*}:pred"
          + "ict:\001*ZH\"C/v1/{endpoint=projects/*/locat"
          + "ions/*/publishers/*/models/*}:predict:\001*"
          + "\332A\035endpoint,instances,parameters\022\376\001\n\nRaw"
          + "Predict\022-.google.cloud.aiplatform.v1.Raw"
          + "PredictRequest\032\024.google.api.HttpBody\"\252\001\202"
          + "\323\344\223\002\216\001\"</v1/{endpoint=projects/*/locatio"
          + "ns/*/endpoints/*}:rawPredict:\001*ZK\"F/v1/{"
          + "endpoint=projects/*/locations/*/publishe"
          + "rs/*/models/*}:rawPredict:\001*\332A\022endpoint,"
          + "http_body\022\332\001\n\007Explain\022*.google.cloud.aip"
          + "latform.v1.ExplainRequest\032+.google.cloud"
          + ".aiplatform.v1.ExplainResponse\"v\202\323\344\223\002>\"9"
          + "/v1/{endpoint=projects/*/locations/*/end"
          + "points/*}:explain:\001*\332A/endpoint,instance"
          + "s,parameters,deployed_model_id\032M\312A\031aipla"
