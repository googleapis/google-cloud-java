  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + " \003(\0132..google.cloud.aiplatform.v1.ModalityTokenCountB\003\340A\003\022[\n"
          + "\036tool_use_prompt_tokens_details\030\014 \003(\0132..google.cl"
          + "oud.aiplatform.v1.ModalityTokenCountB\003\340A\003\022h\n"
          + "\014traffic_type\030\010 \001(\0162M.google.cloud.a"
          + "iplatform.v1.GenerateContentResponse.UsageMetadata.TrafficTypeB\003\340A\003\"\202\001\n"
          + "\013TrafficType\022\034\n"
          + "\030TRAFFIC_TYPE_UNSPECIFIED\020\000\022\r\n"
          + "\tON_DEMAND\020\001\022\026\n"
          + "\022ON_DEMAND_PRIORITY\020\003\022\022\n"
          + "\016ON_DEMAND_FLEX\020\004\022\032\n"
          + "\026PROVISIONED_THROUGHPUT\020\002\"\245\t\n"
          + "\023EmbedContentRequest\022;\n"
          + "\005model\030\001 \001(\tB\'\372A$\n"
          + "\"aiplatform.googleapis.com/EndpointH\000\210\001\001\0229\n"
          + "\007content\030\002"
          + " \001(\0132#.google.cloud.aiplatform.v1.ContentH\001\210\001\001\022\031\n"
          + "\005title\030\004 \001(\tB\005\030\001\340A\001H\002\210\001\001\022`\n"
          + "\ttask_type\030\005 \001(\0162A.google."
          + "cloud.aiplatform.v1.EmbedContentRequest.EmbeddingTaskTypeB\005\030\001\340A\001H\003\210\001\001\022)\n"
          + "\025output_dimensionality\030\006"
          + " \001(\005B\005\030\001\340A\001H\004\210\001\001\022!\n\r"
          + "auto_truncate\030\007 \001(\010B\005\030\001\340A\001H\005\210\001\001\022j\n"
          + "\024embed_content_config\030\010 \001(\0132B.google.cloud.aiplatf"
          + "orm.v1.EmbedContentRequest.EmbedContentConfigB\003\340A\001H\006\210\001\001\032\221\003\n"
          + "\022EmbedContentConfig\022\027\n"
          + "\005title\030\001 \001(\tB\003\340A\001H\000\210\001\001\022^\n"
          + "\ttask_type\030\002 \001(\0162A.google.cloud.aiplatform.v1.EmbedCon"
          + "tentRequest.EmbeddingTaskTypeB\003\340A\001H\001\210\001\001\022\037\n\r"
          ...
          + "\025_embed_content_config\"\330\001\n"
          + "\024EmbedContentResponse\022M\n"
          + "\tembedding\030\001 \001(\0132:.g"
          + "oogle.cloud.aiplatform.v1.EmbedContentResponse.Embedding\022A\n"
          + "\016usage_metadata\030\002 \001(\013"
          + "2).google.cloud.aiplatform.v1.UsageMetadata\022\021\n"
          + "\ttruncated\030\004 \001(\010\032\033\n"
          + "\tEmbedding\022\016\n"
          + "\006values\030\001 \003(\0022\310\033\n"
          + "\021PredictionService\022\224\002\n"
          + "\007Predict\022*.google.cloud.aiplatform.v1.Predi"
          + "ctRequest\032+.google.cloud.aiplatform.v1.P"
          + "redictResponse\"\257\001\332A\035endpoint,instances,p"
          + "arameters\202\323\344\223\002\210\001\"9/v1/{endpoint=projects"
          + "/*/locations/*/endpoints/*}:predict:\001*ZH"
          + "\"C/v1/{endpoint=projects/*/locations/*/publishers/*/models/*}:predict:\001*\022\376\001\n\n"
          + "RawPredict\022-.google.cloud.aiplatform.v1.Raw"
          + "PredictRequest\032\024.google.api.HttpBody\"\252\001\332"
          + "A\022endpoint,http_body\202\323\344\223\002\216\001\"</v1/{endpoi"
          + "nt=projects/*/locations/*/endpoints/*}:rawPredict:\001*ZK\"F/v1/{endpoint=projects/*"
          + "/locations/*/publishers/*/models/*}:rawPredict:\001*\022\230\002\n"
          + "\020StreamRawPredict\0223.google.cloud.aiplatform.v1.StreamRawPredictRequ"
          + "est\032\024.google.api.HttpBody\"\266\001\332A\022endpoint,"
          + "http_body\202\323\344\223\002\232\001\"B/v1/{endpoint=projects"
          + "/*/locations/*/endpoints/*}:streamRawPredict:\001*ZQ\"L/v1/{endpoint=projects/*/loca"
          + "tions/*/publishers/*/models/*}:streamRawPredict:\001*0\001\022\300\001\n\r"
          + "DirectPredict\0220.google.cloud.aiplatform.v1.DirectPredictRequest"
          + "\0321.google.cloud.aiplatform.v1.DirectPred"
          + "ictResponse\"J\202\323\344\223\002D\"?/v1/{endpoint=proje"
          + "cts/*/locations/*/endpoints/*}:directPredict:\001*\022\314\001\n"
          + "\020DirectRawPredict\0223.google.cloud.aiplatform.v1.DirectRawPredictReques"
          + "t\0324.google.cloud.aiplatform.v1.DirectRaw"
          + "PredictResponse\"M\202\323\344\223\002G\"B/v1/{endpoint=p"
          + "rojects/*/locations/*/endpoints/*}:directRawPredict:\001*\022\214\001\n"
          + "\023StreamDirectPredict\0226.google.cloud.aiplatform.v1.StreamDirect"
          + "PredictRequest\0327.google.cloud.aiplatform"
          + ".v1.StreamDirectPredictResponse\"\000(\0010\001\022\225\001\n"
          + "\026StreamDirectRawPredict\0229.google.cloud.aiplatform.v1.StreamDirectRawPredictRequ"
          + "est\032:.google.cloud.aiplatform.v1.StreamDirectRawPredictResponse\"\000(\0010\001\022\203\001\n"
          + "\020StreamingPredict\0223.google.cloud.aiplatform.v1."
          + "StreamingPredictRequest\0324.google.cloud.a"
          + "iplatform.v1.StreamingPredictResponse\"\000(\0010\001\022\265\002\n"
          + "\026ServerStreamingPredict\0223.google.cloud.aiplatform.v1.StreamingPredictRequ"
          + "est\0324.google.cloud.aiplatform.v1.Streami"
          + "ngPredictResponse\"\255\001\202\323\344\223\002\246\001\"H/v1/{endpoi"
          + "nt=projects/*/locations/*/endpoints/*}:serverStreamingPredict:\001*ZW\"R/v1/{endpoin"
          + "t=projects/*/locations/*/publishers/*/models/*}:serverStreamingPredict:\001*0\001\022\214\001\n"
          + "\023StreamingRawPredict\0226.google.cloud.aipla"
          + "tform.v1.StreamingRawPredictRequest\0327.go"
          + "ogle.cloud.aiplatform.v1.StreamingRawPredictResponse\"\000(\0010\001\022\332\001\n"
          + "\007Explain\022*.google.cloud.aiplatform.v1.ExplainRequest\032+.goo"
          + "gle.cloud.aiplatform.v1.ExplainResponse\"v\332A/endpoint,instances,parameters,deploy"
          + "ed_model_id\202\323\344\223\002>\"9/v1/{endpoint=project"
          + "s/*/locations/*/endpoints/*}:explain:\001*\022\215\003\n"
          + "\017GenerateContent\0222.google.cloud.aiplatform.v1.GenerateContentRequest\0323.google"
          + ".cloud.aiplatform.v1.GenerateContentResp"
          + "onse\"\220\002\332A\016model,contents\202\323\344\223\002\370\001\">/v1/{mo"
          + "del=projects/*/locations/*/endpoints/*}:generateContent:\001*ZM\"H/v1/{model=project"
          + "s/*/locations/*/publishers/*/models/*}:generateContent:\001*Z,\"\'/v1/{model=endpoint"
          + "s/*}:generateContent:\001*Z6\"1/v1/{model=pu"
          + "blishers/*/models/*}:generateContent:\001*\022\255\003\n"
          + "\025StreamGenerateContent\0222.google.cloud.aiplatform.v1.GenerateContentRequest\0323."
          + "google.cloud.aiplatform.v1.GenerateConte"
          + "ntResponse\"\250\002\332A\016model,contents\202\323\344\223\002\220\002\"D/"
          + "v1/{model=projects/*/locations/*/endpoints/*}:streamGenerateContent:\001*ZS\"N/v1/{m"
          + "odel=projects/*/locations/*/publishers/*/models/*}:streamGenerateContent:\001*Z2\"-/"
          + "v1/{model=endpoints/*}:streamGenerateCon"
          + "tent:\001*Z<\"7/v1/{model=publishers/*/models/*}:streamGenerateContent:\001*0\001\022\323\001\n"
          + "\014EmbedContent\022/.google.cloud.aiplatform.v1.Em"
          + "bedContentRequest\0320.google.cloud.aiplatform.v1.EmbedContentResponse\"`\332A\r"
          + "model,content\202\323\344\223\002J\"E/v1/{model=projects/*/locat"
          + "ions/*/publishers/*/models/*}:embedConte"
          + "nt:\001*\032\206\001\312A\031aiplatform.googleapis.com\322Agh"
          + "ttps://www.googleapis.com/auth/cloud-pla"
          + "tform,https://www.googleapis.com/auth/cloud-platform.read-onlyB\324\001\n"
          + "\036com.google.cloud.aiplatform.v1B\026PredictionServiceProt"
    ...
    internal_static_google_cloud_aiplatform_v1_EmbedContentRequest_EmbedContentConfig_descriptor =
        internal_static_google_cloud_aiplatform_v1_EmbedContentRequest_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1_EmbedContentRequest_EmbedContentConfig_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_EmbedContentRequest_EmbedContentConfig_descriptor,
            new java.lang.String[] {
