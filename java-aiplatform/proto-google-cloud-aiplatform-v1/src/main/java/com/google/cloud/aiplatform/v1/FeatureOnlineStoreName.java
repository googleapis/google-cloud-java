...
public class FeatureOnlineStoreName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_FEATURE_ONLINE_STORE =
  ...
  public static FeatureOnlineStoreName of(
      String project, String location, String featureOnlineStore) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable FeatureOnlineStoreName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_FEATURE_ONLINE_STORE.validatedMatch(
            formattedString, "FeatureOnlineStoreName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("feature_online_store"));
  }

  public static List<FeatureOnlineStoreName> parseList(List<String> formattedStrings) {
    List<FeatureOnlineStoreName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable FeatureOnlineStoreName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_FEATURE_ONLINE_STORE.instantiate(
        "project", project, "location", location, "feature_online_store", featureOnlineStore);
  }
  ...
  /**
   * Builder for projects/{project}/locations/{location}/featureOnlineStores/{feature_online_store}.
   */
