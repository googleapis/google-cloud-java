...
public final class SafetyRating extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SafetyRating(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.cloud.aiplatform.v1.SafetyRating other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getProbabilityScore()) != 0) {
        setProbabilityScore(other.getProbabilityScore());
      }
      if (other.severity_ != 0) {
        setSeverityValue(other.getSeverityValue());
      }
      if (java.lang.Float.floatToRawIntBits(other.getSeverityScore()) != 0) {
