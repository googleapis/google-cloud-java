...
public class ModelDeploymentMonitoringJobName implements ResourceName {
  ...
  public static @Nullable ModelDeploymentMonitoringJobName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ModelDeploymentMonitoringJobName> values) {
