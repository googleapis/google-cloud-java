          ...
          case 26:
            {
              ...
              value_ =
                  input.readMessage(
                      com.google.cloud.aiplatform.v1.Scalar.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 34:
            {
              ...
              if (valueCase_ == 4) {
                subBuilder =
                    ((com.google.cloud.aiplatform.v1.TensorboardTensor) value_).toBuilder();
              }
              value_ =
                  input.readMessage(
                      com.google.cloud.aiplatform.v1.TensorboardTensor.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 42:
            {
              ...
              if (valueCase_ == 5) {
                subBuilder =
                    ((com.google.cloud.aiplatform.v1.TensorboardBlobSequence) value_).toBuilder();
              }
              value_ =
                  input.readMessage(
                      com.google.cloud.aiplatform.v1.TensorboardBlobSequence.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.aiplatform.v1.TimeSeriesDataPoint) e.getUnfinishedMessage();
