...
public final class MigratableResourceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n4google/cloud/aiplatform/v1/migratable_"
          ...
          + "tform.v1B\027MigratableResourceProtoP\001Z>clo"
          ...
          + "Google::Cloud::AIPlatform::V1\352AQ\n\031ml.goo"
          + "gleapis.com/Version\0224projects/{project}/"
          + "models/{model}/versions/{version}\352AU\n\033au"
          + "toml.googleapis.com/Model\0226projects/{pro"
          + "ject}/locations/{location}/models/{model"
          + "}\352A[\n\035automl.googleapis.com/Dataset\022:pro"
          + "jects/{project}/locations/{location}/dat"
          + "asets/{dataset}\352AL\n#datalabeling.googlea"
          + "pis.com/Dataset\022%projects/{project}/data"
          + "sets/{dataset}\352A{\n,datalabeling.googleap"
          + "is.com/AnnotatedDataset\022Kprojects/{proje"
          + "ct}/datasets/{dataset}/annotatedDatasets"
          + "/{annotated_dataset}b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_aiplatform_v1_MigratableResource_MlEngineModelVersion_descriptor =
        internal_static_google_cloud_aiplatform_v1_MigratableResource_descriptor.getNestedType(0);
    internal_static_google_cloud_aiplatform_v1_MigratableResource_MlEngineModelVersion_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_MigratableResource_MlEngineModelVersion_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_MigratableResource_AutomlModel_descriptor =
        internal_static_google_cloud_aiplatform_v1_MigratableResource_descriptor.getNestedType(1);
    internal_static_google_cloud_aiplatform_v1_MigratableResource_AutomlModel_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_MigratableResource_AutomlModel_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_MigratableResource_AutomlDataset_descriptor =
        internal_static_google_cloud_aiplatform_v1_MigratableResource_descriptor.getNestedType(2);
    internal_static_google_cloud_aiplatform_v1_MigratableResource_AutomlDataset_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_MigratableResource_AutomlDataset_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_aiplatform_v1_MigratableResource_DataLabelingDataset_descriptor =
        internal_static_google_cloud_aiplatform_v1_MigratableResource_descriptor.getNestedType(3);
    internal_static_google_cloud_aiplatform_v1_MigratableResource_DataLabelingDataset_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_aiplatform_v1_MigratableResource_DataLabelingDataset_descriptor,
            new java.lang.String[] {
