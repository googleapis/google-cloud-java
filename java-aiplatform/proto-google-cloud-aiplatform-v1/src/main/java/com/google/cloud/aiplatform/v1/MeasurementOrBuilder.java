...
public interface MeasurementOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.aiplatform.v1.Measurement)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.aiplatform.v1.Measurement.Metric> getMetricsList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1.Measurement.Metric getMetrics(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.aiplatform.v1.Measurement.MetricOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.aiplatform.v1.Measurement.MetricOrBuilder getMetricsOrBuilder(int index);
}
