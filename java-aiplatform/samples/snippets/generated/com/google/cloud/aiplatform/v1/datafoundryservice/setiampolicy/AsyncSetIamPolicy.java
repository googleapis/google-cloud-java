...
// [START aiplatform_v1_generated_DataFoundryService_SetIamPolicy_async]
  ...
  public static void asyncSetIamPolicy() throws Exception {
    ...
    try (DataFoundryServiceClient dataFoundryServiceClient = DataFoundryServiceClient.create()) {
      ...
      ApiFuture<Policy> future =
          dataFoundryServiceClient.setIamPolicyCallable().futureCall(request);
      // Do something.
      Policy response = future.get();
    }
  }
}
// [END aiplatform_v1_generated_DataFoundryService_SetIamPolicy_async]
