...
// [START aiplatform_v1_generated_DataFoundryService_ListLocations_Paged_async]
    ...
    try (DataFoundryServiceClient dataFoundryServiceClient = DataFoundryServiceClient.create()) {
      ...
      while (true) {
        ListLocationsResponse response =
            dataFoundryServiceClient.listLocationsCallable().call(request);
...
// [END aiplatform_v1_generated_DataFoundryService_ListLocations_Paged_async]
