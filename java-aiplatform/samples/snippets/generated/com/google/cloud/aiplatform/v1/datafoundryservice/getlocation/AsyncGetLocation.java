...
// [START aiplatform_v1_generated_DataFoundryService_GetLocation_async]
  ...
  public static void asyncGetLocation() throws Exception {
    ...
    try (DataFoundryServiceClient dataFoundryServiceClient = DataFoundryServiceClient.create()) {
      ...
      ApiFuture<Location> future =
          dataFoundryServiceClient.getLocationCallable().futureCall(request);
      // Do something.
      Location response = future.get();
    }
  }
}
// [END aiplatform_v1_generated_DataFoundryService_GetLocation_async]
