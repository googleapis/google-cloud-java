...
// [START aiplatform_v1_generated_DataFoundryService_ListLocations_async]
  ...
  public static void asyncListLocations() throws Exception {
    ...
    try (DataFoundryServiceClient dataFoundryServiceClient = DataFoundryServiceClient.create()) {
      ...
      ApiFuture<Location> future =
          dataFoundryServiceClient.listLocationsPagedCallable().futureCall(request);
      // Do something.
...
// [END aiplatform_v1_generated_DataFoundryService_ListLocations_async]
