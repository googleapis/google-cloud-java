...
// [START aiplatform_v1_generated_DataFoundryService_TestIamPermissions_async]
  ...
  public static void asyncTestIamPermissions() throws Exception {
    ...
    try (DataFoundryServiceClient dataFoundryServiceClient = DataFoundryServiceClient.create()) {
      ...
      ApiFuture<TestIamPermissionsResponse> future =
          dataFoundryServiceClient.testIamPermissionsCallable().futureCall(request);
      // Do something.
      TestIamPermissionsResponse response = future.get();
    }
  }
}
// [END aiplatform_v1_generated_DataFoundryService_TestIamPermissions_async]
