...
public final class TranslateTextRequest extends com.google.protobuf.GeneratedMessage
   ...
   */
  @java.lang.Override
  public com.google.cloud.translate.v3.TransliterationConfig getTransliterationConfig() {
    return transliterationConfig_ == null
   ...
   */
  @java.lang.Override
  public com.google.cloud.translate.v3.TransliterationConfigOrBuilder
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      output.writeMessage(13, getTransliterationConfig());
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(13, getTransliterationConfig());
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasTransliterationConfig() != other.hasTransliterationConfig()) return false;
    if (hasTransliterationConfig()) {
      if (!getTransliterationConfig().equals(other.getTransliterationConfig())) return false;
    }
  ...
  public int hashCode() {
    ...
    if (hasTransliterationConfig()) {
      hash = (37 * hash) + TRANSLITERATION_CONFIG_FIELD_NUMBER;
      hash = (53 * hash) + getTransliterationConfig().hashCode();
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetTransliterationConfigFieldBuilder();
      }
    }
    ...
    public Builder clear() {
      ...
      transliterationConfig_ = null;
      if (transliterationConfigBuilder_ != null) {
        transliterationConfigBuilder_.dispose();
        transliterationConfigBuilder_ = null;
      }
    ...
    private void buildPartial0(com.google.cloud.translate.v3.TranslateTextRequest result) {
      ...
      if (((from_bitField0_ & 0x00000080) != 0)) {
        result.transliterationConfig_ =
            transliterationConfigBuilder_ == null
                ? transliterationConfig_
                : transliterationConfigBuilder_.build();
    ...
    public Builder mergeFrom(com.google.cloud.translate.v3.TranslateTextRequest other) {
      ...
      if (other.hasTransliterationConfig()) {
        mergeTransliterationConfig(other.getTransliterationConfig());
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106:
              {
                input.readMessage(
                    internalGetTransliterationConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    private com.google.cloud.translate.v3.TransliterationConfig transliterationConfig_;
    private com.google.protobuf.SingleFieldBuilder<
            com.google.cloud.translate.v3.TransliterationConfig,
     ...
     * </code>
     */
    public Builder setTransliterationConfig(
        com.google.cloud.translate.v3.TransliterationConfig value) {
      if (transliterationConfigBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
        ...
        transliterationConfigBuilder_.setMessage(value);
      }
      bitField0_ |= 0x00000080;
      onChanged();
      return this;
     ...
     */
    public Builder setTransliterationConfig(
        com.google.cloud.translate.v3.TransliterationConfig.Builder builderForValue) {
      if (transliterationConfigBuilder_ == null) {
        transliterationConfig_ = builderForValue.build();
      } else {
        transliterationConfigBuilder_.setMessage(builderForValue.build());
      }
      bitField0_ |= 0x00000080;
      onChanged();
      return this;
     ...
     * </code>
     */
    public Builder mergeTransliterationConfig(
        com.google.cloud.translate.v3.TransliterationConfig value) {
      if (transliterationConfigBuilder_ == null) {
        if (((bitField0_ & 0x00000080) != 0)
            ...
            && transliterationConfig_
                != com.google.cloud.translate.v3.TransliterationConfig.getDefaultInstance()) {
          getTransliterationConfigBuilder().mergeFrom(value);
        } else {
          transliterationConfig_ = value;
        }
      } else {
        transliterationConfigBuilder_.mergeFrom(value);
      }
     ...
     * </code>
     */
    public com.google.cloud.translate.v3.TransliterationConfig.Builder
        getTransliterationConfigBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetTransliterationConfigFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.translate.v3.TransliterationConfigOrBuilder
        getTransliterationConfigOrBuilder() {
      if (transliterationConfigBuilder_ != null) {
        return transliterationConfigBuilder_.getMessageOrBuilder();
      } else {
        return transliterationConfig_ == null
            ? com.google.cloud.translate.v3.TransliterationConfig.getDefaultInstance()
            : transliterationConfig_;
      ...
      if (transliterationConfigBuilder_ == null) {
        transliterationConfigBuilder_ =
            new com.google.protobuf.SingleFieldBuilder<
                ...
                com.google.cloud.translate.v3.TransliterationConfig.Builder,
                com.google.cloud.translate.v3.TransliterationConfigOrBuilder>(
                getTransliterationConfig(), getParentForChildren(), isClean());
        transliterationConfig_ = null;
      }
      return transliterationConfigBuilder_;
    }
