...
public interface DatasetOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.translation.v3.Dataset)
   ...
   * </pre>
   *
   * <code>int32 example_count = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
   ...
   * </pre>
   *
   * <code>int32 test_example_count = 8 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
