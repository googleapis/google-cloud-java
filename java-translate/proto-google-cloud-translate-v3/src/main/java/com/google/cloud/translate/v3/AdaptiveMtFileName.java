...
public class AdaptiveMtFileName implements ResourceName {
  ...
  public static AdaptiveMtFileName of(
      String project, String location, String dataset, String file) {
    return newBuilder()
        .setProject(project)
  ...
  public static AdaptiveMtFileName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_DATASET_FILE.validatedMatch(
            formattedString, "AdaptiveMtFileName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<AdaptiveMtFileName> parseList(List<String> formattedStrings) {
    List<AdaptiveMtFileName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return PROJECT_LOCATION_DATASET_FILE.instantiate(
        "project", project, "location", location, "dataset", dataset, "file", file);
  }
