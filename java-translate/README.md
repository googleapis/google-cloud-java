...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-translate" % "2.81.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-translate/2.81.0
