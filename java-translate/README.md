...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-translate" % "2.38.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-translate/2.37.0
