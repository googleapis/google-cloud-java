...
public class MembershipBindingName implements ResourceName {
  ...
  public static @Nullable MembershipBindingName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable MembershipBindingName> values) {
