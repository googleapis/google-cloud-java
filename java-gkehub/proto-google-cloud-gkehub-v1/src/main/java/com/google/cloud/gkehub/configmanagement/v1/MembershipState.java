...
public final class MembershipState extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18:
            {
              com.google.cloud.gkehub.configmanagement.v1.MembershipSpec.Builder subBuilder = null;
              if (membershipSpec_ != null) {
                subBuilder = membershipSpec_.toBuilder();
              }
              membershipSpec_ =
                  input.readMessage(
                      com.google.cloud.gkehub.configmanagement.v1.MembershipSpec.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 26:
            {
              com.google.cloud.gkehub.configmanagement.v1.OperatorState.Builder subBuilder = null;
              if (operatorState_ != null) {
                subBuilder = operatorState_.toBuilder();
              }
              operatorState_ =
                  input.readMessage(
                      com.google.cloud.gkehub.configmanagement.v1.OperatorState.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 34:
            {
              com.google.cloud.gkehub.configmanagement.v1.ConfigSyncState.Builder subBuilder = null;
              if (configSyncState_ != null) {
                subBuilder = configSyncState_.toBuilder();
              }
              configSyncState_ =
                  input.readMessage(
                      com.google.cloud.gkehub.configmanagement.v1.ConfigSyncState.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 42:
            {
              com.google.cloud.gkehub.configmanagement.v1.PolicyControllerState.Builder subBuilder =
                  null;
              ...
              policyControllerState_ =
                  input.readMessage(
                      com.google.cloud.gkehub.configmanagement.v1.PolicyControllerState.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 58:
            {
              ...
              hierarchyControllerState_ =
                  input.readMessage(
                      com.google.cloud.gkehub.configmanagement.v1.HierarchyControllerState.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.gkehub.configmanagement.v1.MembershipState parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.gkehub.configmanagement.v1.MembershipState) e.getUnfinishedMessage();
    ...
    public Builder mergeMembershipSpec(
      ...
      if (membershipSpecBuilder_ == null) {
        if (membershipSpec_ != null) {
          membershipSpec_ =
              com.google.cloud.gkehub.configmanagement.v1.MembershipSpec.newBuilder(membershipSpec_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          membershipSpec_ = value;
    ...
    public Builder mergeOperatorState(
      ...
      if (operatorStateBuilder_ == null) {
        if (operatorState_ != null) {
          operatorState_ =
              com.google.cloud.gkehub.configmanagement.v1.OperatorState.newBuilder(operatorState_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          operatorState_ = value;
    ...
    public Builder mergeConfigSyncState(
      ...
      if (configSyncStateBuilder_ == null) {
        if (configSyncState_ != null) {
          configSyncState_ =
              com.google.cloud.gkehub.configmanagement.v1.ConfigSyncState.newBuilder(
                      configSyncState_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
