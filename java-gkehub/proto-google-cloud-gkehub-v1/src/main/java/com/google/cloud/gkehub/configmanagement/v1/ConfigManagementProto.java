  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "kehub.configmanagement.v1\032\037google/protobuf/timestamp.proto\"\346\003\n"
          ...
          + "\027policy_controller_state\030\005 \001(\0132>.google.cloud.gkeh"
          + "ub.configmanagement.v1.PolicyControllerState\022e\n"
          + "\032hierarchy_controller_state\030\007 \001(\013"
          + "2A.google.cloud.gkehub.configmanagement.v1.HierarchyControllerState\"\347\003\n"
          + "\016MembershipSpec\022H\n"
          + "\013config_sync\030\001 \001(\01323.google.clo"
          + "ud.gkehub.configmanagement.v1.ConfigSync\022T\n"
          + "\021policy_controller\030\002 \001(\01329.google.clo"
          + "ud.gkehub.configmanagement.v1.PolicyController\022`\n"
          + "\024hierarchy_controller\030\004 \001(\0132B.g"
          + "oogle.cloud.gkehub.configmanagement.v1.HierarchyControllerConfig\022\017\n"
          + "\007version\030\n"
          + " \001(\t\022\017\n"
          + "\007cluster\030\013 \001(\t\022V\n\n"
          + "management\030\014 \001(\0162B"
          + ".google.cloud.gkehub.configmanagement.v1.MembershipSpec.Management\"Y\n\n"
          + "Management\022\032\n"
          ...
          + "\r"
          + "source_format\030\010 \001(\t\022\024\n"
          + "\007enabled\030\n"
          + " \001(\010H\000\210\001\001\022\025\n\r"
          + "prevent_drift\030\013 \001(\010\022?\n"
          ...
          + "le.cloud.gkehub.configmanagement.v1.DeploymentState\022K\n"
          + "\textension\030\002 \001(\01628.google."
          + "cloud.gkehub.configmanagement.v1.DeploymentState\"<\n"
          ...
          + "oogle.cloud.gkehub.configmanagement.v1.HierarchyControllerVersion\022Z\n"
          + "\005state\030\002 \001(\0132K.google.cloud.gkehub.configmanagement."
          ...
          + "error_message\030\001 \001(\t\"\304\006\n"
          + "\017ConfigSyncState\022K\n"
          + "\007version\030\001 \001(\0132:.google.cloud.g"
          + "kehub.configmanagement.v1.ConfigSyncVersion\022\\\n"
          + "\020deployment_state\030\002 \001(\0132B.google.c"
          + "loud.gkehub.configmanagement.v1.ConfigSyncDeploymentState\022F\n\n"
          + "sync_state\030\003 \001(\01322."
          + "google.cloud.gkehub.configmanagement.v1.SyncState\022H\n"
          + "\006errors\030\004 \003(\01328.google.cloud"
          + ".gkehub.configmanagement.v1.ConfigSyncError\022W\n"
          + "\014rootsync_crd\030\005 \001(\0162A.google.cloud"
          + ".gkehub.configmanagement.v1.ConfigSyncState.CRDState\022W\n"
          + "\014reposync_crd\030\006 \001(\0162A.goo"
          + "gle.cloud.gkehub.configmanagement.v1.ConfigSyncState.CRDState\022M\n"
          + "\005state\030\007 \001(\0162>.g"
          + "oogle.cloud.gkehub.configmanagement.v1.ConfigSyncState.State\"h\n"
          + "\010CRDState\022\031\n"
          + "\025CRD_STATE_UNSPECIFIED\020\000\022\021\n\r"
          + "NOT_INSTALLED\020\001\022\r"
          + "\n"
          ...
          + "error_message\030\001 \001(\t\"\250\001\n"
          ...
          + "28.google.cloud.gkehub.configmanagement.v1.DeploymentState\022J\n"
          + "\010git_sync\030\003 \001(\01628.g"
          + "oogle.cloud.gkehub.configmanagement.v1.DeploymentState\022I\n"
          + "\007monitor\030\004 \001(\01628.google"
          + ".cloud.gkehub.configmanagement.v1.DeploymentState\022T\n"
          + "\022reconciler_manager\030\005 \001(\01628."
          + "google.cloud.gkehub.configmanagement.v1.DeploymentState\022Q\n"
          + "\017root_reconciler\030\006 \001(\016"
          + "28.google.cloud.gkehub.configmanagement.v1.DeploymentState\022S\n"
          + "\021admission_webhook\030\007"
          ...
          + "cloud.gkehub.configmanagement.v1.SyncState.SyncCode\022B\n"
          + "\006errors\030\006 \003(\01322.google.clo"
          + "ud.gkehub.configmanagement.v1.SyncError\"\223\001\n"
          + "\010SyncCode\022\031\n"
          ...
          + ".gkehub.configmanagement.v1.ErrorResource\"\250\001\n\r"
          ...
          + "le.cloud.gkehub.configmanagement.v1.GroupVersionKind\"@\n"
          ...
          + "\0132@.google.cloud.gkehub.configmanagement.v1.PolicyControllerVersion\022\\\n"
          + "\020deployment_state\030\002 \001(\0132B.google.cloud.gkehub.conf"
          + "igmanagement.v1.GatekeeperDeploymentState\"*\n"
          + "\027PolicyControllerVersion\022\017\n"
          + "\007version\030\001 \001(\t\"\326\001\n"
          + "\031GatekeeperDeploymentState\022e\n"
          + "#gatekeeper_controller_manager_state\030\001 \001(\016"
          + "28.google.cloud.gkehub.configmanagement.v1.DeploymentState\022R\n"
          + "\020gatekeeper_audit\030\002"
          + " \001(\01628.google.cloud.gkehub.configmanagement.v1.DeploymentState*m\n"
          ...
          + "+com.google.cloud.gkehub.configmanagement.v1B\025ConfigManagementP"
          + "rotoP\001ZWcloud.google.com/go/gkehub/configmanagement/apiv1/configmanagementpb;con"
          + "figmanagementpb\252\002\'Google.Cloud.GkeHub.Co"
          + "nfigManagement.V1\312\002\'Google\\Cloud\\GkeHub\\"
          + "ConfigManagement\\V1\352\002+Google::Cloud::GkeHub::ConfigManagement::V1b\006proto3"
    };
    descriptor =
