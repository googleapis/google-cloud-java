    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 818:
            {
              com.google.cloud.gkehub.multiclusteringress.v1beta.FeatureSpec.Builder subBuilder =
                  null;
              ...
              featureSpec_ =
                  input.readMessage(
                      com.google.cloud.gkehub.multiclusteringress.v1beta.FeatureSpec.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
