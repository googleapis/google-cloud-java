          ...
          case 26:
            {
              ...
              resourceState_ =
                  input.readMessage(
                      com.google.cloud.gkehub.v1beta.FeatureResourceState.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 34:
            {
              ...
              spec_ =
                  input.readMessage(
                      com.google.cloud.gkehub.v1beta.CommonFeatureSpec.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 50:
            {
              ...
              state_ =
                  input.readMessage(
                      com.google.cloud.gkehub.v1beta.CommonFeatureState.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeResourceState(com.google.cloud.gkehub.v1beta.FeatureResourceState value) {
      if (resourceStateBuilder_ == null) {
        if (resourceState_ != null) {
          resourceState_ =
              com.google.cloud.gkehub.v1beta.FeatureResourceState.newBuilder(resourceState_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          resourceState_ = value;
    ...
    public Builder mergeSpec(com.google.cloud.gkehub.v1beta.CommonFeatureSpec value) {
      if (specBuilder_ == null) {
        if (spec_ != null) {
          spec_ =
              com.google.cloud.gkehub.v1beta.CommonFeatureSpec.newBuilder(spec_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          spec_ = value;
    ...
    public Builder mergeState(com.google.cloud.gkehub.v1beta.CommonFeatureState value) {
      if (stateBuilder_ == null) {
        if (state_ != null) {
          state_ =
              com.google.cloud.gkehub.v1beta.CommonFeatureState.newBuilder(state_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          state_ = value;
