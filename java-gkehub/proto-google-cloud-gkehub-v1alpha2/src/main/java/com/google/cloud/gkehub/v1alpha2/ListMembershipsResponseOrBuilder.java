...
public interface ListMembershipsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.gkehub.v1alpha2.Membership> getResourcesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.gkehub.v1alpha2.Membership resources = 1;</code>
   */
  com.google.cloud.gkehub.v1alpha2.MembershipOrBuilder getResourcesOrBuilder(int index);
