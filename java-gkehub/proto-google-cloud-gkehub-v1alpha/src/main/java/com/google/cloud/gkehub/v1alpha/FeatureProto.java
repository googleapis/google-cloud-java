  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "h/servicemesh.proto\032\037google/protobuf/timestamp.proto\"\367\007\n"
          + "\007Feature\022\021\n"
          ...
          + "\004spec\030\004 "
          + "\001(\0132..google.cloud.gkehub.v1alpha.CommonFeatureSpecB\003\340A\001\022X\n"
          + "\020membership_specs\030\005 \003"
          + "(\01329.google.cloud.gkehub.v1alpha.Feature.MembershipSpecsEntryB\003\340A\001\022C\n"
          + "\005state\030\006 \001("
          + "\0132/.google.cloud.gkehub.v1alpha.CommonFeatureStateB\003\340A\003\022Z\n"
          + "\021membership_states\030\007 \003"
          + "(\0132:.google.cloud.gkehub.v1alpha.Feature.MembershipStatesEntryB\003\340A\003\0224\n"
          ...
          + "\005value\030\002"
          + " \001(\01322.google.cloud.gkehub.v1alpha.MembershipFeatureSpec:\0028\001\032l\n"
          + "\025MembershipStatesEntry\022\013\n"
          + "\003key\030\001 \001(\t\022B\n"
          + "\005value\030\002 \001(\01323."
          + "google.cloud.gkehub.v1alpha.MembershipFeatureState:\0028\001:^\352A[\n"
          + "\035gkehub.googleapis.c"
          + "om/Feature\022:projects/{project}/locations/{location}/features/{feature}\"\313\001\n"
          + "\024FeatureResourceState\022F\n"
          + "\005state\030\001 \001(\01627.google."
          + "cloud.gkehub.v1alpha.FeatureResourceState.State\"k\n"
          + "\005State\022\025\n"
          ...
          + "\023multiclusteringress\030f \001(\0132<.google.cloud.gkehub"
          + ".multiclusteringress.v1alpha.FeatureSpecH\000\022W\n"
          + "\021cloudauditlogging\030l \001(\0132:.google.c"
          + "loud.gkehub.cloudauditlogging.v1alpha.FeatureSpecH\000B\016\n"
          + "\014feature_spec\"\262\001\n"
          + "\022CommonFeatureState\022L\n"
          + "\013servicemesh\030d \001(\01325.google"
          + ".cloud.gkehub.servicemesh.v1alpha.FeatureStateH\000\022=\n"
          + "\005state\030\001"
          ...
          + "ub.configmanagement.v1alpha.MembershipSpecH\000B\016\n"
          + "\014feature_spec\"\332\002\n"
          + "\026MembershipFeatureState\022O\n"
          + "\013servicemesh\030d \001(\01328.google.cl"
          + "oud.gkehub.servicemesh.v1alpha.MembershipStateH\000\022I\n"
          + "\010metering\030h \001(\01325.google.clou"
          + "d.gkehub.metering.v1alpha.MembershipStateH\000\022Y\n"
          + "\020configmanagement\030j \001(\0132=.google.c"
          + "loud.gkehub.configmanagement.v1alpha.MembershipStateH\000\0228\n"
          + "\005state\030\001 \001(\0132).google.cloud.gkehub.v1alpha.FeatureStateB\017\n\r"
          + "feature_stateB\307\001\n"
          + "\037com.google.cloud.gkehub.v1alphaB\014FeatureProtoP\001Z7cloud.google.com/"
    ...
    internal_static_google_cloud_gkehub_v1alpha_Feature_LabelsEntry_descriptor =
        internal_static_google_cloud_gkehub_v1alpha_Feature_descriptor.getNestedType(0);
    internal_static_google_cloud_gkehub_v1alpha_Feature_LabelsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkehub_v1alpha_Feature_LabelsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_gkehub_v1alpha_Feature_MembershipSpecsEntry_descriptor =
        internal_static_google_cloud_gkehub_v1alpha_Feature_descriptor.getNestedType(1);
    internal_static_google_cloud_gkehub_v1alpha_Feature_MembershipSpecsEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkehub_v1alpha_Feature_MembershipSpecsEntry_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_gkehub_v1alpha_Feature_MembershipStatesEntry_descriptor =
        internal_static_google_cloud_gkehub_v1alpha_Feature_descriptor.getNestedType(2);
    internal_static_google_cloud_gkehub_v1alpha_Feature_MembershipStatesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_gkehub_v1alpha_Feature_MembershipStatesEntry_descriptor,
            new java.lang.String[] {
