...
import com.google.api.cloudquotas.v1.stub.QuotaAdjusterSettingsManagerStub;
...
public class QuotaAdjusterSettingsManagerClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param name Required. Identifier. Name of the `quotaAdjusterSettings` configuration. Only a
