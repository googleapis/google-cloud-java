...
/**
 * Base stub class for the QuotaAdjusterSettingsManager service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@BetaApi
@Generated("by gapic-generator-java")
public abstract class QuotaAdjusterSettingsManagerStub implements BackgroundResource {

  public UnaryCallable<UpdateQuotaAdjusterSettingsRequest, QuotaAdjusterSettings>
      updateQuotaAdjusterSettingsCallable() {
    throw new UnsupportedOperationException(
        "Not implemented: updateQuotaAdjusterSettingsCallable()");
  }

  public UnaryCallable<GetQuotaAdjusterSettingsRequest, QuotaAdjusterSettings>
      getQuotaAdjusterSettingsCallable() {
    throw new UnsupportedOperationException("Not implemented: getQuotaAdjusterSettingsCallable()");
  }
