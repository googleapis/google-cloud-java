...
```Groovy
implementation 'com.google.cloud:google-cloud-notification:0.190.0-beta'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-notification" % "0.190.0-beta"
```
