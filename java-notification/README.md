...
```Groovy
implementation 'com.google.cloud:google-cloud-notification:0.123.21-beta'
```
...
[product-docs]: 
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-notification/latest/history
