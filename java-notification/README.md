...
<dependency>
  <groupId>com.google.cloud</groupId>
  <artifactId>google-cloud-notification</artifactId>
  <version>0.198.0-beta.1</version>
</dependency>
```
...
```Groovy
implementation 'com.google.cloud:google-cloud-notification:0.198.0-beta.1'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-notification" % "0.198.0-beta.1"
```
