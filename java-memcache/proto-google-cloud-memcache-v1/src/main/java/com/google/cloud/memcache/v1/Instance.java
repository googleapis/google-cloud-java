...
public final class Instance extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 58:
            {
              com.google.cloud.memcache.v1.Instance.NodeConfig.Builder subBuilder = null;
              if (nodeConfig_ != null) {
                subBuilder = nodeConfig_.toBuilder();
              }
              nodeConfig_ =
                  input.readMessage(
                      com.google.cloud.memcache.v1.Instance.NodeConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 90:
            {
              com.google.cloud.memcache.v1.MemcacheParameters.Builder subBuilder = null;
              if (parameters_ != null) {
                subBuilder = parameters_.toBuilder();
              }
              parameters_ =
                  input.readMessage(
                      com.google.cloud.memcache.v1.MemcacheParameters.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 98:
            {
              if (!((mutable_bitField0_ & 0x00000004) != 0)) {
                memcacheNodes_ =
                    new java.util.ArrayList<com.google.cloud.memcache.v1.Instance.Node>();
  ...
  public static final class NodeConfig extends com.google.protobuf.GeneratedMessageV3
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.google.cloud.memcache.v1.Instance.NodeConfig parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage =
              (com.google.cloud.memcache.v1.Instance.NodeConfig) e.getUnfinishedMessage();
  ...
  public static final class Node extends com.google.protobuf.GeneratedMessageV3
            ...
            case 50:
              {
                ...
                parameters_ =
                    input.readMessage(
                        com.google.cloud.memcache.v1.MemcacheParameters.parser(),
                        extensionRegistry);
                if (subBuilder != null) {
                  subBuilder.mergeFrom(parameters_);
                  parameters_ = subBuilder.buildPartial();
    ...
    public com.google.cloud.memcache.v1.Instance.Node.State getState() {
      ...
      com.google.cloud.memcache.v1.Instance.Node.State result =
          com.google.cloud.memcache.v1.Instance.Node.State.valueOf(state_);
      return result == null
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.google.cloud.memcache.v1.Instance.Node parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage = (com.google.cloud.memcache.v1.Instance.Node) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class InstanceMessage extends com.google.protobuf.GeneratedMessageV3
    ...
    public com.google.cloud.memcache.v1.Instance.InstanceMessage.Code getCode() {
      ...
      com.google.cloud.memcache.v1.Instance.InstanceMessage.Code result =
          com.google.cloud.memcache.v1.Instance.InstanceMessage.Code.valueOf(code_);
      return result == null
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.google.cloud.memcache.v1.Instance.InstanceMessage parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage =
              (com.google.cloud.memcache.v1.Instance.InstanceMessage) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public com.google.cloud.memcache.v1.MemcacheVersion getMemcacheVersion() {
    ...
    com.google.cloud.memcache.v1.MemcacheVersion result =
        com.google.cloud.memcache.v1.MemcacheVersion.valueOf(memcacheVersion_);
  ...
  public com.google.cloud.memcache.v1.Instance.State getState() {
    ...
    com.google.cloud.memcache.v1.Instance.State result =
        com.google.cloud.memcache.v1.Instance.State.valueOf(state_);
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.memcache.v1.Instance parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.memcache.v1.Instance) e.getUnfinishedMessage();
        throw e.unwrapIOException();
      } finally {
        if (parsedMessage != null) {
          mergeFrom(parsedMessage);
    ...
    public Builder mergeNodeConfig(com.google.cloud.memcache.v1.Instance.NodeConfig value) {
      if (nodeConfigBuilder_ == null) {
        if (nodeConfig_ != null) {
          nodeConfig_ =
              com.google.cloud.memcache.v1.Instance.NodeConfig.newBuilder(nodeConfig_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          nodeConfig_ = value;
