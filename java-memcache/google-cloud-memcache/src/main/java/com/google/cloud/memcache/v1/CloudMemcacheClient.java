...
public class CloudMemcacheClient implements BackgroundResource {
  private final @Nullable CloudMemcacheSettings settings;
  ...
  public final @Nullable CloudMemcacheSettings getSettings() {
    return settings;
  }
  ...
  public final OperationFuture<Instance, OperationMetadata> updateParametersAsync(
      @Nullable InstanceName name, FieldMask updateMask, MemcacheParameters parameters) {
  ...
  public final OperationFuture<Instance, OperationMetadata> applyParametersAsync(
      @Nullable InstanceName name, List<String> nodeIds, boolean applyAll) {
