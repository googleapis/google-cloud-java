...
```Groovy
compile 'com.google.cloud:google-cloud-errorreporting:0.120.39-beta'
```

If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-errorreporting" % "0.120.39-beta"
```
