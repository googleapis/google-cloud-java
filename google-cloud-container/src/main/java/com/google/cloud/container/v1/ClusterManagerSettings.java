...
public class ClusterManagerSettings extends ClientSettings<ClusterManagerSettings> {
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return GrpcClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(null, GaxProperties.getLibraryVersion(ClusterManagerSettings.class));
  }
  ...
  private ClusterManagerSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder extends ClientSettings.Builder<ClusterManagerSettings, Builder> {
    ...
    private Builder(ClusterManagerSettings settings) {
      super(settings);
