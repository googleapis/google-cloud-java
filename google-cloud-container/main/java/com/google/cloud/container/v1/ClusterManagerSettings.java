...
public class ClusterManagerSettings extends ClientSettings<ClusterManagerSettings> {
  ...
  private static final String PROPERTIES_FILE = "/com/google/cloud/container/project.properties";
    ...
    if (gapicVersion == null) {
      gapicVersion =
          PropertiesProvider.loadProperty(
              ClusterManagerSettings.class, PROPERTIES_FILE, META_VERSION_KEY);
