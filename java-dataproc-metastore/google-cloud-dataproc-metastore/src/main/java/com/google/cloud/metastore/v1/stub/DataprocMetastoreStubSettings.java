      ...
      LIST_METADATA_IMPORTS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            public Iterable<MetadataImport> extractResources(ListMetadataImportsResponse payload) {
              return payload.getMetadataImportsList();
            }
          };
          ...
          .setPollingAlgorithm(
              OperationTimedPollAlgorithm.create(
                  RetrySettings.newBuilder()
                      ...
                      .setTotalTimeoutDuration(Duration.ofMillis(4800000L))
                      .build()));
          ...
          .setPollingAlgorithm(
              OperationTimedPollAlgorithm.create(
                  RetrySettings.newBuilder()
                      ...
                      .setRpcTimeoutMultiplier(1.0)
                      .setMaxRpcTimeoutDuration(Duration.ZERO)
                      .setTotalTimeoutDuration(Duration.ofMillis(3000000L))
                      .build()));
          ...
          .setPollingAlgorithm(
              OperationTimedPollAlgorithm.create(
                  RetrySettings.newBuilder()
                      ...
                      .setRpcTimeoutMultiplier(1.0)
                      .setMaxRpcTimeoutDuration(Duration.ZERO)
                      .setTotalTimeoutDuration(Duration.ofMillis(1500000L))
                      .build()));
