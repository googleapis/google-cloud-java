...
public class BackupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_SERVICE_BACKUP =
  ...
  public static BackupName of(String project, String location, String service, String backup) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String service, String backup) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setService(service)
  ...
  public static @Nullable BackupName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_SERVICE_BACKUP.validatedMatch(
  ...
  public static List<String> toStringList(List<@Nullable BackupName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_SERVICE_BACKUP.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_SERVICE_BACKUP.instantiate(
