...
public interface ListRegistryBooksRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.numberregistry.v1alpha.ListRegistryBooksRequest)
