...
public interface DeleteIpamAdminScopeRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.numberregistry.v1alpha.DeleteIpamAdminScopeRequest)
