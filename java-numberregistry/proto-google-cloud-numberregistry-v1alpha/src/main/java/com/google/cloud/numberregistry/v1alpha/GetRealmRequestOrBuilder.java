...
public interface GetRealmRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.numberregistry.v1alpha.GetRealmRequest)
   ...
   * @return The view.
   */
  com.google.cloud.numberregistry.v1alpha.Realm.RealmView getView();
}
