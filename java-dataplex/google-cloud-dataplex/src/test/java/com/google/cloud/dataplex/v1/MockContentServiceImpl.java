...
public class MockContentServiceImpl extends ContentServiceImplBase {
  ...
  public void createContent(
      CreateContentRequest request, StreamObserver<Content> responseObserver) {
  ...
  public void updateContent(
      UpdateContentRequest request, StreamObserver<Content> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Content) {
      requests.add(request);
      responseObserver.onNext(((Content) response));
  ...
  public void listContent(
      ListContentRequest request, StreamObserver<ListContentResponse> responseObserver) {
    Object response = responses.poll();
