...
public class CatalogServiceClientTest {
  ...
  public void createMetadataJobTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockCatalogService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    CreateMetadataJobRequest actualRequest = ((CreateMetadataJobRequest) actualRequests.get(0));

    Assert.assertEquals(parent.toString(), actualRequest.getParent());
    Assert.assertEquals(metadataJob, actualRequest.getMetadataJob());
    Assert.assertEquals(metadataJobId, actualRequest.getMetadataJobId());
    Assert.assertTrue(
        channelProvider.isHeaderSent(
            ApiClientHeaderProvider.getDefaultApiClientHeaderKey(),
            GaxGrpcProperties.getDefaultApiClientHeaderPattern()));
  ...
  public void getMetadataJobTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockCatalogService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetMetadataJobRequest actualRequest = ((GetMetadataJobRequest) actualRequests.get(0));
  ...
  public void listMetadataJobsTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockCatalogService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    ListMetadataJobsRequest actualRequest = ((ListMetadataJobsRequest) actualRequests.get(0));
  ...
  public void cancelMetadataJobTest() throws Exception {
    ...
    List<AbstractMessage> actualRequests = mockCatalogService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    CancelMetadataJobRequest actualRequest = ((CancelMetadataJobRequest) actualRequests.get(0));
