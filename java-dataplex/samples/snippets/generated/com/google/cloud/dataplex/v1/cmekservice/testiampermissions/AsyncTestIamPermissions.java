...
// [START dataplex_v1_generated_CmekService_TestIamPermissions_async]
  ...
  public static void asyncTestIamPermissions() throws Exception {
    ...
    try (CmekServiceClient cmekServiceClient = CmekServiceClient.create()) {
      ...
      ApiFuture<TestIamPermissionsResponse> future =
          cmekServiceClient.testIamPermissionsCallable().futureCall(request);
      // Do something.
      TestIamPermissionsResponse response = future.get();
    }
  }
}
// [END dataplex_v1_generated_CmekService_TestIamPermissions_async]
