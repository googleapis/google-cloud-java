...
// [START dataplex_v1_generated_DataplexService_TestIamPermissions_async]
  ...
  public static void asyncTestIamPermissions() throws Exception {
    ...
    try (DataplexServiceClient dataplexServiceClient = DataplexServiceClient.create()) {
      ...
      ApiFuture<TestIamPermissionsResponse> future =
          dataplexServiceClient.testIamPermissionsCallable().futureCall(request);
      // Do something.
      TestIamPermissionsResponse response = future.get();
    }
  }
}
// [END dataplex_v1_generated_DataplexService_TestIamPermissions_async]
