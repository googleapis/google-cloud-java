...
public class EnvironmentName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_LAKE_ENVIRONMENT =
  ...
  public static EnvironmentName of(
      String project, String location, String lake, String environment) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String lake, String environment) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setLake(lake)
  ...
  public static EnvironmentName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_LAKE_ENVIRONMENT.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_LAKE_ENVIRONMENT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_LAKE_ENVIRONMENT.instantiate(
  ...
  public static class Builder {
    ...
    private Builder(EnvironmentName environmentName) {
      ...
      this.lake = environmentName.lake;
