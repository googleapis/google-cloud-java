...
public final class MetadataJob extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private MetadataJob(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class ImportJobResult extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ImportJobResult(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class ExportJobResult extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ExportJobResult(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class ImportJobSpec extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ImportJobSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
     ...
     */
    public static final class ImportJobScope extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private ImportJobScope(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        for (int i = 0; i < entryGroups_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 1, entryGroups_.getRaw(i));
        }
        for (int i = 0; i < entryTypes_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 2, entryTypes_.getRaw(i));
        }
        ...
        for (int i = 0; i < glossaries_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 4, glossaries_.getRaw(i));
        }
        for (int i = 0; i < entryLinkTypes_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 5, entryLinkTypes_.getRaw(i));
        }
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceStorageUri_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, sourceStorageUri_);
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sourceStorageUri_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, sourceStorageUri_);
      }
      if (((bitField0_ & 0x00000002) != 0)) {
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetSourceCreateTimeFieldBuilder();
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 42:
                {
                  input.readMessage(
                      internalGetSourceCreateTimeFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000002;
                  break;
                } // case 42
              case 48:
      ...
      public com.google.protobuf.Timestamp.Builder getSourceCreateTimeBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetSourceCreateTimeFieldBuilder().getBuilder();
      }
   ...
   */
  public static final class ExportJobSpec extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ExportJobSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
     ...
     */
    public static final class ExportJobScope extends com.google.protobuf.GeneratedMessage
        implements
      ...
      private ExportJobScope(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
        super(builder);
      }
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        ...
        for (int i = 0; i < entryTypes_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 4, entryTypes_.getRaw(i));
        }
        for (int i = 0; i < aspectTypes_.size(); i++) {
          com.google.protobuf.GeneratedMessage.writeString(output, 5, aspectTypes_.getRaw(i));
        }
        getUnknownFields().writeTo(output);
      }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputPath_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, outputPath_);
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(outputPath_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, outputPath_);
      }
      size += getUnknownFields().getSerializedSize();
      memoizedSize = size;
      return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 802:
              {
                input.readMessage(
                    internalGetImportSpecFieldBuilder().getBuilder(), extensionRegistry);
                specCase_ = 100;
                break;
              } // case 802
            case 810:
              {
                input.readMessage(
                    internalGetExportSpecFieldBuilder().getBuilder(), extensionRegistry);
                specCase_ = 101;
                break;
              } // case 810
            case 1602:
              {
                input.readMessage(
                    internalGetImportResultFieldBuilder().getBuilder(), extensionRegistry);
                resultCase_ = 200;
                break;
              } // case 1602
            case 1610:
              {
                input.readMessage(
                    internalGetExportResultFieldBuilder().getBuilder(), extensionRegistry);
                resultCase_ = 201;
                break;
              } // case 1610
            default:
    ...
    public com.google.cloud.dataplex.v1.MetadataJob.ImportJobSpec.Builder getImportSpecBuilder() {
      return internalGetImportSpecFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dataplex.v1.MetadataJob.ImportJobSpec.Builder,
            com.google.cloud.dataplex.v1.MetadataJob.ImportJobSpecOrBuilder>
        internalGetImportSpecFieldBuilder() {
      if (importSpecBuilder_ == null) {
        if (!(specCase_ == 100)) {
    ...
    public com.google.cloud.dataplex.v1.MetadataJob.ExportJobSpec.Builder getExportSpecBuilder() {
      return internalGetExportSpecFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dataplex.v1.MetadataJob.ExportJobSpec.Builder,
            com.google.cloud.dataplex.v1.MetadataJob.ExportJobSpecOrBuilder>
        internalGetExportSpecFieldBuilder() {
      if (exportSpecBuilder_ == null) {
        if (!(specCase_ == 101)) {
    ...
    public com.google.cloud.dataplex.v1.MetadataJob.ImportJobResult.Builder
      ...
      return internalGetImportResultFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dataplex.v1.MetadataJob.ImportJobResult.Builder,
            com.google.cloud.dataplex.v1.MetadataJob.ImportJobResultOrBuilder>
        internalGetImportResultFieldBuilder() {
      if (importResultBuilder_ == null) {
        if (!(resultCase_ == 200)) {
    ...
    public com.google.cloud.dataplex.v1.MetadataJob.ExportJobResult.Builder
      ...
      return internalGetExportResultFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.dataplex.v1.MetadataJob.ExportJobResult.Builder,
            com.google.cloud.dataplex.v1.MetadataJob.ExportJobResultOrBuilder>
        internalGetExportResultFieldBuilder() {
      if (exportResultBuilder_ == null) {
        if (!(resultCase_ == 201)) {
