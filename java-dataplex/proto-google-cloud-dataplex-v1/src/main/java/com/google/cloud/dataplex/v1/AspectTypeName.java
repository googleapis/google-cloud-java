...
public class AspectTypeName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_ASPECT_TYPE =
  ...
  private AspectTypeName(Builder builder) {
    ...
    aspectType = Preconditions.checkNotNull(builder.getAspectType());
  }
  ...
  public static AspectTypeName of(String project, String location, String aspectType) {
    return newBuilder().setProject(project).setLocation(location).setAspectType(aspectType).build();
  }
  ...
  public static @Nullable AspectTypeName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_ASPECT_TYPE.validatedMatch(
            formattedString, "AspectTypeName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("aspect_type"));
  }

  public static List<AspectTypeName> parseList(List<String> formattedStrings) {
    List<AspectTypeName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable AspectTypeName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (aspectType != null) {
            fieldMapBuilder.put("aspect_type", aspectType);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_ASPECT_TYPE.instantiate(
        "project", project, "location", location, "aspect_type", aspectType);
  }
