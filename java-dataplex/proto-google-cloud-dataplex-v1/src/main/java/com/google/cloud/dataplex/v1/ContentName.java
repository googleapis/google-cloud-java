...
public class ContentName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_LAKE_CONTENT =
  ...
  public String toString() {
    return PROJECT_LOCATION_LAKE_CONTENT.instantiate(
