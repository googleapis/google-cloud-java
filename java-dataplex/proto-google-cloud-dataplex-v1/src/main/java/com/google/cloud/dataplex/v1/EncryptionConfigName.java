...
public class EncryptionConfigName implements ResourceName {
  ...
  public static @Nullable EncryptionConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable EncryptionConfigName> values) {
