          ...
          case 802:
            {
              ...
              infrastructureSpec_ =
                  input.readMessage(
                      com.google.cloud.dataplex.v1.Environment.InfrastructureSpec.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 810:
            {
              ...
              sessionSpec_ =
                  input.readMessage(
                      com.google.cloud.dataplex.v1.Environment.SessionSpec.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 818:
            {
              ...
              sessionStatus_ =
                  input.readMessage(
                      com.google.cloud.dataplex.v1.Environment.SessionStatus.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 1602:
            {
              ...
              endpoints_ =
                  input.readMessage(
                      com.google.cloud.dataplex.v1.Environment.Endpoints.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final class OsImageRuntime extends com.google.protobuf.GeneratedMessageV3
      ...
      public static final class Builder
        ...
        public Builder mergeFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws java.io.IOException {
          com.google.cloud.dataplex.v1.Environment.InfrastructureSpec.OsImageRuntime parsedMessage =
              null;
          try {
            parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
          } catch (com.google.protobuf.InvalidProtocolBufferException e) {
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage =
              (com.google.cloud.dataplex.v1.Environment.SessionSpec) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
      ...
      public Builder mergeMaxIdleDuration(com.google.protobuf.Duration value) {
        if (maxIdleDurationBuilder_ == null) {
          if (maxIdleDuration_ != null) {
            maxIdleDuration_ =
                com.google.protobuf.Duration.newBuilder(maxIdleDuration_)
                    .mergeFrom(value)
                    .buildPartial();
          } else {
            maxIdleDuration_ = value;
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage =
              (com.google.cloud.dataplex.v1.Environment.SessionStatus) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage =
              (com.google.cloud.dataplex.v1.Environment.Endpoints) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeInfrastructureSpec(
      ...
      if (infrastructureSpecBuilder_ == null) {
        if (infrastructureSpec_ != null) {
          infrastructureSpec_ =
              com.google.cloud.dataplex.v1.Environment.InfrastructureSpec.newBuilder(
                      infrastructureSpec_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
    ...
    public Builder mergeSessionSpec(com.google.cloud.dataplex.v1.Environment.SessionSpec value) {
      if (sessionSpecBuilder_ == null) {
        if (sessionSpec_ != null) {
          sessionSpec_ =
              com.google.cloud.dataplex.v1.Environment.SessionSpec.newBuilder(sessionSpec_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          sessionSpec_ = value;
    ...
    public Builder mergeSessionStatus(
      ...
      if (sessionStatusBuilder_ == null) {
        if (sessionStatus_ != null) {
          sessionStatus_ =
              com.google.cloud.dataplex.v1.Environment.SessionStatus.newBuilder(sessionStatus_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          sessionStatus_ = value;
    ...
    public Builder mergeEndpoints(com.google.cloud.dataplex.v1.Environment.Endpoints value) {
      if (endpointsBuilder_ == null) {
        if (endpoints_ != null) {
          endpoints_ =
              com.google.cloud.dataplex.v1.Environment.Endpoints.newBuilder(endpoints_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          endpoints_ = value;
