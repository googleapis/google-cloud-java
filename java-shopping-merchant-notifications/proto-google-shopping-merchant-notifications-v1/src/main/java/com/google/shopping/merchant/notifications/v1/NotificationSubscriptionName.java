...
public class NotificationSubscriptionName implements ResourceName {
  ...
  public static @Nullable NotificationSubscriptionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable NotificationSubscriptionName> values) {
