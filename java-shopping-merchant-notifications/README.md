...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-notifications:0.9.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-notifications" % "0.9.0"
```
