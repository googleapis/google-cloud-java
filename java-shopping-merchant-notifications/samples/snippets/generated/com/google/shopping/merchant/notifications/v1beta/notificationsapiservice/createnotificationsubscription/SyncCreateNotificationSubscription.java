...
public class SyncCreateNotificationSubscription {

  public static void main(String[] args) throws Exception {
    syncCreateNotificationSubscription();
  }

  public static void syncCreateNotificationSubscription() throws Exception {
