...
public class NotificationsApiServiceClientTest {
  ...
  @Test
  public void getNotificationSubscriptionHealthMetricsTest() throws Exception {
    NotificationSubscriptionHealthMetrics expectedResponse =
        NotificationSubscriptionHealthMetrics.newBuilder()
            .setName(
                NotificationSubscriptionHealthMetricsName.of(
                        "[ACCOUNT]", "[NOTIFICATION_SUBSCRIPTION]")
                    .toString())
            .setAcknowledgedMessagesCount(1331941427)
            .setUndeliveredMessagesCount(1001002256)
            .setOldestUnacknowledgedMessageWaitingTime(-2012289131)
            .build();
    mockNotificationsApiService.addResponse(expectedResponse);
    ...
    NotificationSubscriptionHealthMetrics actualResponse =
        client.getNotificationSubscriptionHealthMetrics(name);
    Assert.assertEquals(expectedResponse, actualResponse);

    List<AbstractMessage> actualRequests = mockNotificationsApiService.getRequests();
    Assert.assertEquals(1, actualRequests.size());
    GetNotificationSubscriptionHealthMetricsRequest actualRequest =
        ((GetNotificationSubscriptionHealthMetricsRequest) actualRequests.get(0));
  ...
  @Test
  public void getNotificationSubscriptionHealthMetricsExceptionTest() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockNotificationsApiService.addException(exception);
  ...
  @Test
  public void getNotificationSubscriptionHealthMetricsTest2() throws Exception {
    NotificationSubscriptionHealthMetrics expectedResponse =
        NotificationSubscriptionHealthMetrics.newBuilder()
            .setName(
                NotificationSubscriptionHealthMetricsName.of(
  ...
  @Test
  public void getNotificationSubscriptionHealthMetricsExceptionTest2() throws Exception {
    StatusRuntimeException exception = new StatusRuntimeException(io.grpc.Status.INVALID_ARGUMENT);
    mockNotificationsApiService.addException(exception);
