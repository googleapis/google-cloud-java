...
public class NotificationsApiServiceStubSettings
      ...
      LIST_NOTIFICATION_SUBSCRIPTIONS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            public Iterable<NotificationSubscription> extractResources(
              ...
              return payload.getNotificationSubscriptionsList();
            }
          };
  ...
  protected NotificationsApiServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getNotificationSubscriptionHealthMetricsSettings =
        settingsBuilder.getNotificationSubscriptionHealthMetricsSettings().build();
  }

  @Override
  protected LibraryMetadata getLibraryMetadata() {
    return LibraryMetadata.newBuilder()
        .setArtifactName("com.google.shopping:google-shopping-merchant-notifications")
  ...
  public static class Builder
    ...
    protected Builder(NotificationsApiServiceStubSettings settings) {
      ...
      getNotificationSubscriptionHealthMetricsSettings =
          settings.getNotificationSubscriptionHealthMetricsSettings.toBuilder();
