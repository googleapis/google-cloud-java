...
public final class NotificationsApiServiceGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType =
          com.google.shopping.merchant.notifications.v1.GetNotificationSubscriptionRequest.class,
      responseType = com.google.shopping.merchant.notifications.v1.NotificationSubscription.class,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType =
          com.google.shopping.merchant.notifications.v1.CreateNotificationSubscriptionRequest.class,
      responseType = com.google.shopping.merchant.notifications.v1.NotificationSubscription.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          com.google.shopping.merchant.notifications.v1.CreateNotificationSubscriptionRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType =
          com.google.shopping.merchant.notifications.v1.UpdateNotificationSubscriptionRequest.class,
      responseType = com.google.shopping.merchant.notifications.v1.NotificationSubscription.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          com.google.shopping.merchant.notifications.v1.UpdateNotificationSubscriptionRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType =
          com.google.shopping.merchant.notifications.v1.DeleteNotificationSubscriptionRequest.class,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType =
          com.google.shopping.merchant.notifications.v1.ListNotificationSubscriptionsRequest.class,
      responseType =
          com.google.shopping.merchant.notifications.v1.ListNotificationSubscriptionsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          com.google.shopping.merchant.notifications.v1.ListNotificationSubscriptionsRequest,
          com.google.shopping.merchant.notifications.v1.ListNotificationSubscriptionsResponse>
  ...
  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetNotificationSubscriptionHealthMetrics",
      requestType =
          com.google.shopping.merchant.notifications.v1
              .GetNotificationSubscriptionHealthMetricsRequest.class,
      responseType =
          com.google.shopping.merchant.notifications.v1.NotificationSubscriptionHealthMetrics.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          com.google.shopping.merchant.notifications.v1
              .GetNotificationSubscriptionHealthMetricsRequest,
    ...
    if ((getGetNotificationSubscriptionHealthMetricsMethod =
            NotificationsApiServiceGrpc.getGetNotificationSubscriptionHealthMetricsMethod)
        == null) {
      synchronized (NotificationsApiServiceGrpc.class) {
        if ((getGetNotificationSubscriptionHealthMetricsMethod =
                NotificationsApiServiceGrpc.getGetNotificationSubscriptionHealthMetricsMethod)
                  ...
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(
                              SERVICE_NAME, "GetNotificationSubscriptionHealthMetrics"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.merchant.notifications.v1
    ...
    return getGetNotificationSubscriptionHealthMetricsMethod;
  }
  ...
  public interface AsyncService {
    ...
    default void getNotificationSubscription(
        com.google.shopping.merchant.notifications.v1.GetNotificationSubscriptionRequest request,
    ...
    default void createNotificationSubscription(
        com.google.shopping.merchant.notifications.v1.CreateNotificationSubscriptionRequest request,
        io.grpc.stub.StreamObserver<
                com.google.shopping.merchant.notifications.v1.NotificationSubscription>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
    ...
    default void updateNotificationSubscription(
        com.google.shopping.merchant.notifications.v1.UpdateNotificationSubscriptionRequest request,
        io.grpc.stub.StreamObserver<
                com.google.shopping.merchant.notifications.v1.NotificationSubscription>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
    ...
    default void listNotificationSubscriptions(
        com.google.shopping.merchant.notifications.v1.ListNotificationSubscriptionsRequest request,
        io.grpc.stub.StreamObserver<
                com.google.shopping.merchant.notifications.v1.ListNotificationSubscriptionsResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
     ...
     * </pre>
     */
    default void getNotificationSubscriptionHealthMetrics(
        com.google.shopping.merchant.notifications.v1
                .GetNotificationSubscriptionHealthMetricsRequest
            request,
        io.grpc.stub.StreamObserver<
            ...
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getGetNotificationSubscriptionHealthMetricsMethod(), responseObserver);
    }
  }
  ...
  public static final class NotificationsApiServiceStub
    ...
    public void getNotificationSubscriptionHealthMetrics(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel()
              .newCall(getGetNotificationSubscriptionHealthMetricsMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
  ...
  private static final int METHODID_GET_NOTIFICATION_SUBSCRIPTION_HEALTH_METRICS = 5;
        ...
        case METHODID_LIST_NOTIFICATION_SUBSCRIPTIONS:
          serviceImpl.listNotificationSubscriptions(
              ...
              (io.grpc.stub.StreamObserver<
                  ...
                  responseObserver);
          break;
        case METHODID_GET_NOTIFICATION_SUBSCRIPTION_HEALTH_METRICS:
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    ...
                    com.google.shopping.merchant.notifications.v1
                        .NotificationSubscriptionHealthMetrics>(
                    service, METHODID_GET_NOTIFICATION_SUBSCRIPTION_HEALTH_METRICS)))
        .build();
  }
  ...
  private abstract static class NotificationsApiServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.shopping.merchant.notifications.v1.NotificationsApiProto.getDescriptor();
    }
