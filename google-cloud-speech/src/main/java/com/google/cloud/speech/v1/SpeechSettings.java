    ...
    private static Builder initDefaults(Builder builder) {
      ...
      builder
          ...
          .setResponseTransformer(
              ProtoOperationTransformers.ResponseTransformer.of(LongRunningRecognizeResponse.class))
          .setMetadataTransformer(
              ProtoOperationTransformers.MetadataTransformer.of(LongRunningRecognizeMetadata.class))
          .setPollingAlgorithm(
