...
public class UserListServiceSettings extends ClientSettings<UserListServiceSettings> {
  ...
  public PagedCallSettings<ListUserListsRequest, ListUserListsResponse, ListUserListsPagedResponse>
    ...
    return ((UserListServiceStubSettings) getStubSettings()).listUserListsSettings();
  }
  ...
  public UnaryCallSettings<CreateUserListRequest, UserList> createUserListSettings() {
    return ((UserListServiceStubSettings) getStubSettings()).createUserListSettings();
  }
  ...
  public UnaryCallSettings<UpdateUserListRequest, UserList> updateUserListSettings() {
    return ((UserListServiceStubSettings) getStubSettings()).updateUserListSettings();
  }
  ...
  public UnaryCallSettings<DeleteUserListRequest, Empty> deleteUserListSettings() {
    return ((UserListServiceStubSettings) getStubSettings()).deleteUserListSettings();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return UserListServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }
  ...
  public static class Builder extends ClientSettings.Builder<UserListServiceSettings, Builder> {
    ...
    private static Builder createHttpJsonDefault() {
      return new Builder(UserListServiceStubSettings.newHttpJsonBuilder());
    }
    ...
    public PagedCallSettings.Builder<
        ...
        listUserListsSettings() {
      return getStubSettingsBuilder().listUserListsSettings();
    }
    ...
    public UnaryCallSettings.Builder<CreateUserListRequest, UserList> createUserListSettings() {
      return getStubSettingsBuilder().createUserListSettings();
    }
    ...
    public UnaryCallSettings.Builder<UpdateUserListRequest, UserList> updateUserListSettings() {
      return getStubSettingsBuilder().updateUserListSettings();
    }
    ...
    public UnaryCallSettings.Builder<DeleteUserListRequest, Empty> deleteUserListSettings() {
      return getStubSettingsBuilder().deleteUserListSettings();
    }
