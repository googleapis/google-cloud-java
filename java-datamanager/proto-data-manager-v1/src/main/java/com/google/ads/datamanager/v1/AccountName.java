...
public class AccountName implements ResourceName {
  private static final PathTemplate ACCOUNT_TYPE_ACCOUNT =
      PathTemplate.createWithoutUrlEncoding("accountTypes/{account_type}/accounts/{account}");
  ...
  public static AccountName of(String accountType, String account) {
    return newBuilder().setAccountType(accountType).setAccount(account).build();
  }

  public static String format(String accountType, String account) {
    return newBuilder().setAccountType(accountType).setAccount(account).build().toString();
  }
  ...
  public static AccountName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        ACCOUNT_TYPE_ACCOUNT.validatedMatch(
            formattedString, "AccountName.parse: formattedString not in valid format");
    return of(matchMap.get("account_type"), matchMap.get("account"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return ACCOUNT_TYPE_ACCOUNT.matches(formattedString);
  }
  ...
  public String toString() {
    return ACCOUNT_TYPE_ACCOUNT.instantiate("account_type", accountType, "account", account);
  }
  ...
  /** Builder for accountTypes/{account_type}/accounts/{account}. */
  public static class Builder {
    ...
    private Builder(AccountName accountName) {
      this.accountType = accountName.accountType;
