...
public interface CreateBindingRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.agentregistry.v1.CreateBindingRequest)
   ...
   * </pre>
   *
   * <code>string binding_id = 2 [(.google.api.field_behavior) = REQUIRED];</code>
   *
