  ...
  static {
    java.lang.String[] descriptorData = {
      "\n3google/cloud/networkconnectivity/v1alp"
          ...
          + "m/auth/cloud-platformB\323\003\n-com.google.clo"
          ...
          + "tworkconnectivity\352A`\n compute.googleapis"
          + ".com/VpnTunnel\022<projects/{project}/regio"
          + "ns/{region}/vpnTunnels/{resource_id}\352Az\n"
          + "-compute.googleapis.com/InterconnectAtta"
          + "chment\022Iprojects/{project}/regions/{regi"
          + "on}/interconnectAttachments/{resource_id"
          + "}\352AW\n\037compute.googleapis.com/Instance\0224p"
