 ...
 *    <tr>
 *      <td>ListHubs</td>
 *      <td><p>Lists the Network Connectivity Center hubs associated with a given project.</p></td>
 *      <td>
 ...
 *    <tr>
 *      <td>GetHub</td>
 *      <td><p>Gets details about a Network Connectivity Center hub.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>CreateHub</td>
 *      <td><p>Creates a new Network Connectivity Center hub in the specified project.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>UpdateHub</td>
 *      <td><p>Updates the description and/or labels of a Network Connectivity Center
 *  hub.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>DeleteHub</td>
 *      <td><p>Deletes a Network Connectivity Center hub.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>ListHubSpokes</td>
 *      <td><p>Lists the Network Connectivity Center spokes associated with a
 *  specified hub and location. The list includes both spokes that are attached
 *  to the hub and spokes that have been proposed but not yet accepted.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listHubSpokes(ListHubSpokesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listHubSpokes(HubName name)
 *           <li>listHubSpokes(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listHubSpokesPagedCallable()
 *           <li>listHubSpokesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>ListSpokes</td>
 *      <td><p>Lists the Network Connectivity Center spokes in a specified project and
 *  location.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>GetSpoke</td>
 *      <td><p>Gets details about a Network Connectivity Center spoke.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>CreateSpoke</td>
 *      <td><p>Creates a Network Connectivity Center spoke.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>UpdateSpoke</td>
 *      <td><p>Updates the parameters of a Network Connectivity Center spoke.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    </tr>
 *    <tr>
 *      <td>RejectHubSpoke</td>
 *      <td><p>Rejects a Network Connectivity Center spoke from being attached to a hub.
 *  If the spoke was previously in the `ACTIVE` state, it
 *  transitions to the `INACTIVE` state and is no longer able to
 *  connect to other spokes that are attached to the hub.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>rejectHubSpokeAsync(RejectHubSpokeRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>rejectHubSpokeAsync(HubName name, SpokeName spokeUri)
 *           <li>rejectHubSpokeAsync(HubName name, String spokeUri)
 *           <li>rejectHubSpokeAsync(String name, SpokeName spokeUri)
 *           <li>rejectHubSpokeAsync(String name, String spokeUri)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>rejectHubSpokeOperationCallable()
 *           <li>rejectHubSpokeCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>AcceptHubSpoke</td>
 *      <td><p>Accepts a proposal to attach a Network Connectivity Center spoke
 *  to a hub.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>acceptHubSpokeAsync(AcceptHubSpokeRequest request)
 *      </ul>
 *      <p>Methods that return long-running operations have "Async" method variants that return `OperationFuture`, which is used to track polling of the service.</p>
 *      <ul>
 *           <li>acceptHubSpokeAsync(HubName name, SpokeName spokeUri)
 *           <li>acceptHubSpokeAsync(HubName name, String spokeUri)
 *           <li>acceptHubSpokeAsync(String name, SpokeName spokeUri)
 *           <li>acceptHubSpokeAsync(String name, String spokeUri)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>acceptHubSpokeOperationCallable()
 *           <li>acceptHubSpokeCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>DeleteSpoke</td>
 *      <td><p>Deletes a Network Connectivity Center spoke.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>GetRouteTable</td>
 *      <td><p>Gets details about a Network Connectivity Center route table.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>getRouteTable(GetRouteTableRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>getRouteTable(RouteTableName name)
 *           <li>getRouteTable(String name)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>getRouteTableCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetRoute</td>
 *      <td><p>Gets details about the specified route.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>ListRoutes</td>
 *      <td><p>Lists routes in a given project.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listRoutes(RouteTableName parent)
 ...
 *      <td><p>Lists route tables in a given project.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>listRouteTables(ListRouteTablesRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li>listRouteTables(HubName parent)
 *           <li>listRouteTables(String parent)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>listRouteTablesPagedCallable()
 *           <li>listRouteTablesCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>GetGroup</td>
 *      <td><p>Gets details about a Network Connectivity Center group.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *    <tr>
 *      <td>ListGroups</td>
 *      <td><p>Lists groups in a given hub.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
