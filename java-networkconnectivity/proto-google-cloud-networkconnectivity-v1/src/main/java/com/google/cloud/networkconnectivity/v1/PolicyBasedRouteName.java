...
public class PolicyBasedRouteName implements ResourceName {
  ...
  public static @Nullable PolicyBasedRouteName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PolicyBasedRouteName> values) {
