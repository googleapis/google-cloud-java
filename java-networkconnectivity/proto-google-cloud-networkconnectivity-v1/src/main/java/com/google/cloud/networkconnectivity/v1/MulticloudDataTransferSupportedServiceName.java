...
public class MulticloudDataTransferSupportedServiceName implements ResourceName {
  ...
  public static @Nullable MulticloudDataTransferSupportedServiceName parse(String formattedString) {
  ...
  public static List<String> toStringList(
      List<@Nullable MulticloudDataTransferSupportedServiceName> values) {
