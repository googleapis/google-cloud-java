...
public class ServiceConnectionMapName implements ResourceName {
  ...
  public static @Nullable ServiceConnectionMapName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ServiceConnectionMapName> values) {
