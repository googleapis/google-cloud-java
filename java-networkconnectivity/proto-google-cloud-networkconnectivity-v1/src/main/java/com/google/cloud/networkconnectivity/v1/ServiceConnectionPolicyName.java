...
public class ServiceConnectionPolicyName implements ResourceName {
  ...
  public static @Nullable ServiceConnectionPolicyName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ServiceConnectionPolicyName> values) {
