...
public class GatewayAdvertisedRouteName implements ResourceName {
  ...
  public static @Nullable GatewayAdvertisedRouteName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GatewayAdvertisedRouteName> values) {
