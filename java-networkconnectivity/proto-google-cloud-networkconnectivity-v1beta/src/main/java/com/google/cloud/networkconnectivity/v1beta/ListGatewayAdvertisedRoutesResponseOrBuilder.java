...
public interface ListGatewayAdvertisedRoutesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkconnectivity.v1beta.ListGatewayAdvertisedRoutesResponse)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute>
   ...
   * </code>
   */
  com.google.cloud.networkconnectivity.v1beta.GatewayAdvertisedRoute getGatewayAdvertisedRoutes(
      int index);
   ...
   * </code>
   */
  int getGatewayAdvertisedRoutesCount();
