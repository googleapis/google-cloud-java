...
public interface CreatePolicyBasedRouteRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkconnectivity.v1beta.CreatePolicyBasedRouteRequest)
   ...
   *
   * <code>
   * .google.cloud.networkconnectivity.v1beta.PolicyBasedRoute policy_based_route = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.networkconnectivity.v1beta.PolicyBasedRoute getPolicyBasedRoute();
