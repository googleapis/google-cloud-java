...
public interface UpdateDestinationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkconnectivity.v1beta.UpdateDestinationRequest)
   ...
   *
   * <code>
   * .google.cloud.networkconnectivity.v1beta.Destination destination = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.networkconnectivity.v1beta.Destination getDestination();
   ...
   * </code>
   */
  com.google.cloud.networkconnectivity.v1beta.DestinationOrBuilder getDestinationOrBuilder();
