...
public class RemoteTransportProfileName implements ResourceName {
  ...
  public static @Nullable RemoteTransportProfileName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RemoteTransportProfileName> values) {
