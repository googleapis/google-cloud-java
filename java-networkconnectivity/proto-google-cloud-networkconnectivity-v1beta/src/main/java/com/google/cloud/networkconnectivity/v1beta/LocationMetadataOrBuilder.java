...
public interface LocationMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkconnectivity.v1beta.LocationMetadata)
   ...
   * </pre>
   *
   * <code>repeated .google.cloud.networkconnectivity.v1beta.LocationFeature location_features = 1;
   * </code>
   *
   * @return A list containing the locationFeatures.
   */
  java.util.List<com.google.cloud.networkconnectivity.v1beta.LocationFeature>
   ...
   */
  com.google.cloud.networkconnectivity.v1beta.LocationFeature getLocationFeatures(int index);
