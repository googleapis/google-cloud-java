...
public interface LinkedVpcNetworkOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.networkconnectivity.v1beta.LinkedVpcNetwork)
   ...
   *
   * <code>
   * repeated string proposed_include_export_ranges = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
