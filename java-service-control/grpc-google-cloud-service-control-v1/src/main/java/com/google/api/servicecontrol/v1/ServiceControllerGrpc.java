...
public final class ServiceControllerGrpc {
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.api.servicecontrol.v1.CheckRequest,
                    com.google.api.servicecontrol.v1.CheckResponse>(service, METHODID_CHECK)))
        .addMethod(
            getReportMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.api.servicecontrol.v1.ReportRequest,
                    com.google.api.servicecontrol.v1.ReportResponse>(service, METHODID_REPORT)))
        .build();
  }
  ...
  private static final class ServiceControllerMethodDescriptorSupplier
    ...
    ServiceControllerMethodDescriptorSupplier(java.lang.String methodName) {
