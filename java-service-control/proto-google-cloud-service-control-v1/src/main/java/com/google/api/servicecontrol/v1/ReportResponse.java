...
public final class ReportResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ReportResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class ReportError extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ReportError(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceConfigId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, serviceConfigId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceRolloutId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, serviceRolloutId_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceConfigId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, serviceConfigId_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceRolloutId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, serviceRolloutId_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          if (reportErrorsBuilder_.isEmpty()) {
            ...
            reportErrorsBuilder_ =
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                    ? internalGetReportErrorsFieldBuilder()
                    : null;
          } else {
    ...
    public com.google.api.servicecontrol.v1.ReportResponse.ReportError.Builder
      ...
      return internalGetReportErrorsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.api.servicecontrol.v1.ReportResponse.ReportError.Builder
      ...
      return internalGetReportErrorsFieldBuilder()
          .addBuilder(
              com.google.api.servicecontrol.v1.ReportResponse.ReportError.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.api.servicecontrol.v1.ReportResponse.ReportError.Builder>
      ...
      return internalGetReportErrorsFieldBuilder().getBuilderList();
    }
