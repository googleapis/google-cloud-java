...
public final class CheckResponse extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class CheckInfo extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      for (int i = 0; i < unusedArguments_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, unusedArguments_.getRaw(i));
      }
      if (((bitField0_ & 0x00000001) != 0)) {
        output.writeMessage(2, getConsumerInfo());
      }
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(apiKeyUid_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 5, apiKeyUid_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(apiKeyUid_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(5, apiKeyUid_);
      }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetConsumerInfoFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18:
                {
                  input.readMessage(
                      internalGetConsumerInfoFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.api.servicecontrol.v1.CheckResponse.ConsumerInfo.Builder
        ...
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetConsumerInfoFieldBuilder().getBuilder();
      }
   ...
   */
  public static final class ConsumerInfo extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceRolloutId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, serviceRolloutId_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceRolloutId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(11, serviceRolloutId_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetCheckErrorsFieldBuilder();
        internalGetCheckInfoFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50:
              {
                input.readMessage(
                    internalGetCheckInfoFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.api.servicecontrol.v1.CheckError.Builder getCheckErrorsBuilder(int index) {
      return internalGetCheckErrorsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.api.servicecontrol.v1.CheckError.Builder addCheckErrorsBuilder() {
      return internalGetCheckErrorsFieldBuilder()
    ...
    public java.util.List<com.google.api.servicecontrol.v1.CheckError.Builder>
      ...
      return internalGetCheckErrorsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.api.servicecontrol.v1.CheckResponse.CheckInfo.Builder getCheckInfoBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetCheckInfoFieldBuilder().getBuilder();
    }
