...
public class ServiceControllerStubSettings extends StubSettings<ServiceControllerStubSettings> {
  ...
  public static class Builder extends StubSettings.Builder<ServiceControllerStubSettings, Builder> {
    ...
    static {
      ...
      settings =
          RetrySettings.newBuilder()
              .setInitialRpcTimeoutDuration(Duration.ofMillis(16000L))
              .setRpcTimeoutMultiplier(1.0)
              .setMaxRpcTimeoutDuration(Duration.ofMillis(16000L))
              .setTotalTimeoutDuration(Duration.ofMillis(16000L))
              .build();
