...
/**
 * Settings class to configure an instance of {@link ServiceControllerStub}.
 *
...
public class ServiceControllerStubSettings extends StubSettings<ServiceControllerStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder()
          .add("https://www.googleapis.com/auth/cloud-platform")
          .add("https://www.googleapis.com/auth/servicecontrol")
          .build();

  private final UnaryCallSettings<CheckRequest, CheckResponse> checkSettings;
  private final UnaryCallSettings<ReportRequest, ReportResponse> reportSettings;
  ...
  public static String getDefaultEndpoint() {
    return "servicecontrol.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "servicecontrol.mtls.googleapis.com:443";
  }
  ...
  protected ServiceControllerStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    checkSettings = settingsBuilder.checkSettings().build();
    reportSettings = settingsBuilder.reportSettings().build();
  }

  /** Builder for ServiceControllerStubSettings. */
  public static class Builder extends StubSettings.Builder<ServiceControllerStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<CheckRequest, CheckResponse> checkSettings;
    private final UnaryCallSettings.Builder<ReportRequest, ReportResponse> reportSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      checkSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      reportSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(checkSettings, reportSettings);
      initDefaults(this);
    }

    protected Builder(ServiceControllerStubSettings settings) {
      super(settings);

      checkSettings = settings.checkSettings.toBuilder();
      reportSettings = settings.reportSettings.toBuilder();
    ...
    @Override
    public ServiceControllerStubSettings build() throws IOException {
      return new ServiceControllerStubSettings(this);
    }
  }
}
