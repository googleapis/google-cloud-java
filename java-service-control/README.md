...
```Groovy
implementation 'com.google.cloud:google-cloud-service-control:1.1.11'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-service-control" % "1.1.11"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-service-control/latest/history
...
[contributing]: https://github.com/googleapis/java-service-control/blob/main/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-service-control/blob/main/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-service-control/blob/main/LICENSE
