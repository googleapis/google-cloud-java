...
public class CertificateMapName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CERTIFICATE_MAP =
  ...
  public static CertificateMapName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CERTIFICATE_MAP.validatedMatch(
            formattedString, "CertificateMapName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("certificate_map"));
  }

  public static List<CertificateMapName> parseList(List<String> formattedStrings) {
    List<CertificateMapName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return PROJECT_LOCATION_CERTIFICATE_MAP.instantiate(
        "project", project, "location", location, "certificate_map", certificateMap);
  }
