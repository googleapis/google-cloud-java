...
public class CertificateIssuanceConfigName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CERTIFICATE_ISSUANCE_CONFIG =
  ...
  private CertificateIssuanceConfigName(Builder builder) {
    ...
    certificateIssuanceConfig = Preconditions.checkNotNull(builder.getCertificateIssuanceConfig());
  }
  ...
  public static CertificateIssuanceConfigName of(
      String project, String location, String certificateIssuanceConfig) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable CertificateIssuanceConfigName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_CERTIFICATE_ISSUANCE_CONFIG.validatedMatch(
            formattedString,
            "CertificateIssuanceConfigName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("certificate_issuance_config"));
  }

  public static List<CertificateIssuanceConfigName> parseList(List<String> formattedStrings) {
    List<CertificateIssuanceConfigName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable CertificateIssuanceConfigName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (certificateIssuanceConfig != null) {
            fieldMapBuilder.put("certificate_issuance_config", certificateIssuanceConfig);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_CERTIFICATE_ISSUANCE_CONFIG.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.certificateIssuanceConfig, that.certificateIssuanceConfig);
    }
    return false;
  }
