...
public class CertificateMapEntryName implements ResourceName {
  ...
  public static @Nullable CertificateMapEntryName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CertificateMapEntryName> values) {
