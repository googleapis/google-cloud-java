          ...
          case 18:
            {
              ...
              if (typeSpecCase_ == 2) {
                subBuilder =
                    ((com.google.cloud.datacatalog.v1beta1.ViewSpec) typeSpec_).toBuilder();
              }
              typeSpec_ =
                  input.readMessage(
                      com.google.cloud.datacatalog.v1beta1.ViewSpec.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 26:
            {
              ...
              if (typeSpecCase_ == 3) {
                subBuilder =
                    ((com.google.cloud.datacatalog.v1beta1.TableSpec) typeSpec_).toBuilder();
              }
              typeSpec_ =
                  input.readMessage(
                      com.google.cloud.datacatalog.v1beta1.TableSpec.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.datacatalog.v1beta1.BigQueryTableSpec) e.getUnfinishedMessage();
