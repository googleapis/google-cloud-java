...
public final class LookupEntryRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private LookupEntryRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (targetNameCase_ == 1) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, targetName_);
    }
    if (targetNameCase_ == 3) {
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (targetNameCase_ == 1) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, targetName_);
    }
    if (targetNameCase_ == 3) {
