...
public final class PolicyTag extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private PolicyTag(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parentPolicyTag_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, parentPolicyTag_);
    }
    for (int i = 0; i < childPolicyTags_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, childPolicyTags_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parentPolicyTag_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, parentPolicyTag_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < childPolicyTags_.size(); i++) {
