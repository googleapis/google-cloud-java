...
public final class SearchCatalogResult extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SearchCatalogResult(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(searchResultSubtype_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, searchResultSubtype_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(relativeResourceName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, relativeResourceName_);
    }
    ...
    if (systemCase_ == 9) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, system_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(fullyQualifiedName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, fullyQualifiedName_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(searchResultSubtype_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, searchResultSubtype_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(relativeResourceName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, relativeResourceName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(linkedResource_)) {
    ...
    if (systemCase_ == 9) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(9, system_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(fullyQualifiedName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(10, fullyQualifiedName_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(displayName_)) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58:
              {
                input.readMessage(
                    internalGetModifyTimeFieldBuilder().getBuilder(), extensionRegistry);
