...
public final class DatabaseTableSpec extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DatabaseTableSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class DatabaseViewSpec extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private DatabaseViewSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (sourceDefinitionCase_ == 2) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, sourceDefinition_);
      }
      if (sourceDefinitionCase_ == 3) {
        com.google.protobuf.GeneratedMessage.writeString(output, 3, sourceDefinition_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (sourceDefinitionCase_ == 2) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, sourceDefinition_);
      }
      if (sourceDefinitionCase_ == 3) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(3, sourceDefinition_);
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetDataplexTableFieldBuilder();
        internalGetDatabaseViewSpecFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetDataplexTableFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 26:
              {
                input.readMessage(
                    internalGetDatabaseViewSpecFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.datacatalog.v1.DataplexTableSpec.Builder getDataplexTableBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetDataplexTableFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.datacatalog.v1.DatabaseTableSpec.DatabaseViewSpec.Builder
      ...
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetDatabaseViewSpecFieldBuilder().getBuilder();
    }
