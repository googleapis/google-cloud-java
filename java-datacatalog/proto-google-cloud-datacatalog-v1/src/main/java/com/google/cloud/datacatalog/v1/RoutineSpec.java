...
public final class RoutineSpec extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private RoutineSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class Argument extends com.google.protobuf.GeneratedMessage
      implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(definitionBody_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, definitionBody_);
    }
    if (systemSpecCase_ == 6) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(definitionBody_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, definitionBody_);
    }
    if (systemSpecCase_ == 6) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          if (routineArgumentsBuilder_.isEmpty()) {
            ...
            routineArgumentsBuilder_ =
                com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                    ? internalGetRoutineArgumentsFieldBuilder()
                    : null;
          } else {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50:
              {
                input.readMessage(
                    internalGetBigqueryRoutineSpecFieldBuilder().getBuilder(), extensionRegistry);
                systemSpecCase_ = 6;
                break;
              } // case 50
            default:
    ...
    public com.google.cloud.datacatalog.v1.RoutineSpec.Argument.Builder getRoutineArgumentsBuilder(
        int index) {
      return internalGetRoutineArgumentsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.datacatalog.v1.RoutineSpec.Argument.Builder
      ...
      return internalGetRoutineArgumentsFieldBuilder()
    ...
    public java.util.List<com.google.cloud.datacatalog.v1.RoutineSpec.Argument.Builder>
      ...
      return internalGetRoutineArgumentsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.datacatalog.v1.BigQueryRoutineSpec.Builder
      ...
      return internalGetBigqueryRoutineSpecFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datacatalog.v1.BigQueryRoutineSpec.Builder,
            com.google.cloud.datacatalog.v1.BigQueryRoutineSpecOrBuilder>
        internalGetBigqueryRoutineSpecFieldBuilder() {
      if (bigqueryRoutineSpecBuilder_ == null) {
        if (!(systemSpecCase_ == 6)) {
