...
public final class ColumnSchema extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class LookerColumnSpec extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private LookerColumnSpec(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(defaultValue_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, defaultValue_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gcRule_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, gcRule_);
    }
    if (systemSpecCase_ == 18) {
      output.writeMessage(
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(defaultValue_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, defaultValue_);
    }
    if (ordinalPosition_ != 0) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gcRule_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(11, gcRule_);
    }
    if (systemSpecCase_ == 18) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 146:
              {
                input.readMessage(
                    internalGetLookerColumnSpecFieldBuilder().getBuilder(), extensionRegistry);
                systemSpecCase_ = 18;
                break;
              } // case 146
            case 154:
    ...
    public com.google.cloud.datacatalog.v1.ColumnSchema.LookerColumnSpec.Builder
      ...
      return internalGetLookerColumnSpecFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.datacatalog.v1.ColumnSchema.LookerColumnSpec.Builder,
            com.google.cloud.datacatalog.v1.ColumnSchema.LookerColumnSpecOrBuilder>
        internalGetLookerColumnSpecFieldBuilder() {
      if (lookerColumnSpecBuilder_ == null) {
        if (!(systemSpecCase_ == 18)) {
          systemSpec_ =
              com.google.cloud.datacatalog.v1.ColumnSchema.LookerColumnSpec.getDefaultInstance();
