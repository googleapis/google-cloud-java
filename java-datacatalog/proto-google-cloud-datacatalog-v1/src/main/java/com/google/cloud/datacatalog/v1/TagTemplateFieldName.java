...
public class TagTemplateFieldName implements ResourceName {
  ...
  public static @Nullable TagTemplateFieldName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable TagTemplateFieldName> values) {
