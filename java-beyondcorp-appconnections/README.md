...
```Groovy
implementation 'com.google.cloud:google-cloud-beyondcorp-appconnections:0.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-beyondcorp-appconnections" % "0.0.0"
```
