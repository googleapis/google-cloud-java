...
public final class AppConnectionsServiceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "Ggoogle/cloud/beyondcorp/appconnections/v1/app_connections_service.proto\022)googl"
          ...
          + " google/protobuf/field_mask.proto\032\037google/protobuf/timestamp.proto\"\271\001\n"
          + "\031ListAppConnectionsRequest\022?\n"
          + "\006parent\030\001 \001("
          + "\tB/\340A\002\372A)\022\'beyondcorp.googleapis.com/AppConnection\022\026\n"
          + "\tpage_size\030\002 \001(\005B\003\340A\001\022\027\n\n"
          + "page_token\030\003 \001(\tB\003\340A\001\022\023\n"
          + "\006filter\030\004 \001(\tB\003\340A\001\022\025\n"
          + "\010order_by\030\005 \001(\tB\003\340A\001\"\235\001\n"
          + "\032ListAppConnectionsResponse\022Q\n"
          + "\017app_connections\030\001"
          + " \003(\01328.google.cloud.beyondcorp.appconnections.v1.AppConnection\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\"X\n"
          + "\027GetAppConnectionRequest\022=\n"
          + "\004name\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'beyondcorp.googleapis.com/AppConnection\"\211\002\n"
          + "\032CreateAppConnectionRequest\022?\n"
          + "\006parent\030\001 \001("
          + "\tB/\340A\002\372A)\022\'beyondcorp.googleapis.com/AppConnection\022\036\n"
          + "\021app_connection_id\030\002 \001(\tB\003\340A\001\022U\n"
          + "\016app_connection\030\003"
          + " \001(\01328.google.cloud.beyondcorp.appconnections.v1.AppConnectionB\003\340A\002\022\027\n\n"
          + "request_id\030\004 \001(\tB\003\340A\001\022\032\n\r"
          + "validate_only\030\005 \001(\010B\003\340A\001\"\372\001\n"
          + "\032UpdateAppConnectionRequest\0224\n"
          + "\013update_mask\030\001 \001(\0132\032.google.protobuf.FieldMaskB\003\340A\002\022U\n"
          + "\016app_connection\030\002 \001(\01328.google."
          + "cloud.beyondcorp.appconnections.v1.AppConnectionB\003\340A\002\022\027\n\n"
          + "request_id\030\003 \001(\tB\003\340A\001\022\032\n\r"
          + "validate_only\030\004 \001(\010B\003\340A\001\022\032\n\r"
          + "allow_missing\030\005 \001(\010B\003\340A\001\"\220\001\n"
          + "\032DeleteAppConnectionRequest\022=\n"
          + "\004name\030\001 \001(\tB/\340A\002\372A)\n"
          + "\'beyondcorp.googleapis.com/AppConnection\022\027\n\n"
          + "request_id\030\002 \001(\tB\003\340A\001\022\032\n\r"
          + "validate_only\030\003 \001(\010B\003\340A\001\"\332\001\n"
          + "\034ResolveAppConnectionsRequest\022?\n"
          + "\006parent\030\001 \001("
          + "\tB/\340A\002\372A)\022\'beyondcorp.googleapis.com/AppConnection\022H\n"
          ...
          + "\026app_connection_details\030\001 \003(\0132].google.cloud.beyondcorp.appco"
          + "nnections.v1.ResolveAppConnectionsResponse.AppConnectionDetails\022\027\n"
          + "\017next_page_token\030\002 \001(\t\022\023\n"
          + "\013unreachable\030\003 \003(\t\032\200\001\n"
          + "\024AppConnectionDetails\022P\n"
          + "\016app_connection\030\001 \001(\01328"
          + ".google.cloud.beyondcorp.appconnections.v1.AppConnection\022\026\n"
          + "\016recent_mig_vms\030\002 \003(\t\"\231\n\n\r"
          + "AppConnection\022\021\n"
          ...
          + "\0132D.google.cloud.beyondcorp.appconnections.v1.AppConnection.LabelsEntryB\003\340A\001\022\031\n"
          ...
          + "p.appconnections.v1.AppConnection.TypeB\003\340A\002\022o\n"
          + "\024application_endpoint\030\010 \001(\0132L.goog"
          + "le.cloud.beyondcorp.appconnections.v1.AppConnection.ApplicationEndpointB\003\340A\002\022\027\n\n"
          + "connectors\030\t \003(\tB\003\340A\001\022R\n"
          + "\005state\030\n"
          + " \001(\0162>.g"
          + "oogle.cloud.beyondcorp.appconnections.v1.AppConnection.StateB\003\340A\003\022V\n"
          + "\007gateway\030\013 \001"
          + "(\0132@.google.cloud.beyondcorp.appconnections.v1.AppConnection.GatewayB\003\340A\001\032;\n"
          + "\023ApplicationEndpoint\022\021\n"
          + "\004host\030\001 \001(\tB\003\340A\002\022\021\n"
          + "\004port\030\002 \001(\005B\003\340A\002\032\207\002\n"
          + "\007Gateway\022X\n"
          + "\004type\030\002 \001(\016"
          + "2E.google.cloud.beyondcorp.appconnections.v1.AppConnection.Gateway.TypeB\003\340A\002\022\020\n"
          + "\003uri\030\003 \001(\tB\003\340A\003\022\031\n"
          ...
          + "\'beyondcorp.googleapis.com/AppConnection\022Gpro"
          + "jects/{project}/locations/{location}/appConnections/{app_connection}\"\215\002\n"
          + "\036AppConnectionOperationMetadata\0224\n"
          ...
          + "\013api_version\030\007 \001(\tB\003\340A\0032\352\014\n"
          + "\025AppConnectionsService\022\346\001\n"
          + "\022ListAppConnections\022D.google.cloud.beyondcorp.appconnections.v1.ListAp"
          + "pConnectionsRequest\032E.google.cloud.beyondcorp.appconnections.v1.ListAppConnectio"
          + "nsResponse\"C\332A\006parent\202\323\344\223\0024\0222/v1/{parent"
          + "=projects/*/locations/*}/appConnections\022\323\001\n"
          + "\020GetAppConnection\022B.google.cloud.beyondcorp.appconnections.v1.GetAppConnectio"
          + "nRequest\0328.google.cloud.beyondcorp.appco"
          + "nnections.v1.AppConnection\"A\332A\004name\202\323\344\223\002"
          + "4\0222/v1/{name=projects/*/locations/*/appConnections/*}\022\244\002\n"
          + "\023CreateAppConnection\022E.google.cloud.beyondcorp.appconnections.v"
          + "1.CreateAppConnectionRequest\032\035.google.longrunning.Operation\"\246\001\312A/\n\r"
          + "AppConnection\022\036AppConnectionOperationMetadata\332A\'paren"
          + "t,app_connection,app_connection_id\202\323\344\223\002D"
          + "\"2/v1/{parent=projects/*/locations/*}/appConnections:\016app_connection\022\246\002\n"
          + "\023UpdateAppConnection\022E.google.cloud.beyondcorp.a"
          + "ppconnections.v1.UpdateAppConnectionRequ"
          + "est\032\035.google.longrunning.Operation\"\250\001\312A/\n\r"
          + "AppConnection\022\036AppConnectionOperationM"
          + "etadata\332A\032app_connection,update_mask\202\323\344\223"
          + "\002S2A/v1/{app_connection.name=projects/*/"
          + "locations/*/appConnections/*}:\016app_connection\022\370\001\n"
          + "\023DeleteAppConnection\022E.google.cloud.beyondcorp.appconnections.v1.Delete"
          + "AppConnectionRequest\032\035.google.longrunning.Operation\"{\312A7\n"
          + "\025google.protobuf.Empty\022\036AppConnectionOperationMetadata\332A\004name\202\323"
          + "\344\223\0024*2/v1/{name=projects/*/locations/*/appConnections/*}\022\367\001\n"
          + "\025ResolveAppConnections\022G.google.cloud.beyondcorp.appconnecti"
          + "ons.v1.ResolveAppConnectionsRequest\032H.google.cloud.beyondcorp.appconnections.v1."
          + "ResolveAppConnectionsResponse\"K\332A\006parent"
          + "\202\323\344\223\002<\022:/v1/{parent=projects/*/locations"
          + "/*}/appConnections:resolve\032M\312A\031beyondcor"
          + "p.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\212\004\n"
          + "-com.google.cloud.beyondcorp.appconnections.v1B\032App"
          + "ConnectionsServiceProtoP\001ZUcloud.google.com/go/beyondcorp/appconnections/apiv1/a"
          ...
          + "\352\002-Google::Cloud::BeyondCorp::AppConnections::V1\352Ao\n"
          + "&beyondcorp.googleapis.com/AppConnector\022Eprojects/{project}/location"
          + "s/{location}/appConnectors/{app_connector}\352Ai\n"
          + "$beyondcorp.googleapis.com/AppGateway\022Aprojects/{project}/locations/{locat"
