...
public final class ConnectNetworkConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ConnectNetworkConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    for (int i = 0; i < dnsDomainNames_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, dnsDomainNames_.getRaw(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(primarySubnet_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, primarySubnet_);
    }
    for (int i = 0; i < additionalSubnets_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, additionalSubnets_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(primarySubnet_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, primarySubnet_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < additionalSubnets_.size(); i++) {
