...
public final class CreateTopicRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CreateTopicRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(internalGetTopicFieldBuilder().getBuilder(), extensionRegistry);
