  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "on.proto\032\037google/protobuf/timestamp.proto\"\330\006\n"
          + "\007Cluster\022B\n\n"
          ...
          + "satisfies_pzs\030\014 \001(\010B\003\340A\003H\002\210\001\001\032-\n"
          ...
          + "#managedkafka.googleapis.com/Cluster\022:projects/{project}/locations/{lo"
          + "cation}/clusters/{cluster}*\010clusters2\007clusterB\021\n"
          ...
          + "\004mode\030\001"
          + " \001(\01622.google.cloud.managedkafka.v1.RebalanceConfig.ModeB\003\340A\001\"N\n"
          + "\004Mode\022\024\n"
          ...
          + "!managedkafka.googleapis.com/Topic\022Iprojects/{project}/locations/{location}/clu"
          + "sters/{cluster}/topics/{topic}*\006topics2\005topic\"\341\001\n"
          + "\025ConsumerTopicMetadata\022\\\n\n"
          + "partitions\030\001 \003(\0132C.google.cloud.managedkafka."
          + "v1.ConsumerTopicMetadata.PartitionsEntryB\003\340A\001\032j\n"
          + "\017PartitionsEntry\022\013\n"
          + "\003key\030\001 \001(\005\022F\n"
          + "\005value\030\002"
          + " \001(\01327.google.cloud.managedkafka.v1.ConsumerPartitionMetadata:\0028\001\"G\n"
          ...
          + "7.google.cloud.managedkafka.v1.ConsumerGroup.TopicsEntryB\003\340A\001\032b\n"
          + "\013TopicsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022B\n"
          + "\005value\030\002 \001(\01323.google.cloud."
          + "managedkafka.v1.ConsumerTopicMetadata:\0028\001:\252\001\352A\246\001\n"
          + ")managedkafka.googleapis.com/ConsumerGroup\022Zprojects/{project}/location"
          + "s/{location}/clusters/{cluster}/consumerGroups/{consumer_group}*\016consumerGroups2\r"
          ...
          + "e.cloud.managedkafka.v1.ConnectGcpConfigB\003\340A\002H\000\022\021\n"
          ...
          + "agedkafka.v1.ConnectCluster.LabelsEntryB\003\340A\001\022J\n"
          + "\017capacity_config\030\006 \001(\0132,.google.c"
          + "loud.managedkafka.v1.CapacityConfigB\003\340A\002\022F\n"
          + "\005state\030\010"
          ...
          + "*managedkafka.googleapis.com/ConnectCluster\022Iprojects/{project}/locations/{"
          + "location}/connectClusters/{connect_cluster}*\017connectClusters2\016connectClusterB\021\n"
          ...
          + "\017network_configs\030\001 \003(\01322.google.cloud.mana"
          + "gedkafka.v1.ConnectNetworkConfigB\003\340A\002\"\253\001\n"
          + "\020ConnectGcpConfig\022M\n\r"
          + "access_config\030\001 \001("
          + "\01321.google.cloud.managedkafka.v1.ConnectAccessConfigB\003\340A\002\022H\n"
          ...
          + "managedkafka.v1.Connector.ConfigsEntryB\003\340A\001\022A\n"
          + "\005state\030\003"
          ...
          + "%managedkafka.googleapis.com/Connector\022`projects/{project}/locations/{location}/"
