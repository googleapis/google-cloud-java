  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "i/resource.proto\032\037google/protobuf/timestamp.proto\"\362\005\n"
          + "\007Cluster\022B\n\n"
          + "gcp_config\030\t \001("
          + "\0132\'.google.cloud.managedkafka.v1.GcpConfigB\003\340A\002H\000\022\021\n"
          ...
          + "e.cloud.managedkafka.v1.Cluster.LabelsEntryB\003\340A\001\022J\n"
          + "\017capacity_config\030\005 \001(\0132,.goog"
          + "le.cloud.managedkafka.v1.CapacityConfigB\003\340A\002\022L\n"
          + "\020rebalance_config\030\010 \001(\0132-.google."
          + "cloud.managedkafka.v1.RebalanceConfigB\003\340A\001\022?\n"
          + "\005state\030\n"
          + " \001(\0162+.google.cloud.managedkafka.v1.Cluster.StateB\003\340A\003\032-\n"
          ...
          + "#managedkafka.googleapis.com/Cluster\022:projects/{"
          + "project}/locations/{location}/clusters/{cluster}*\010clusters2\007clusterB\021\n"
          + "\017platform_config\"D\n"
          ...
          + "google.cloud.managedkafka.v1.Topic.ConfigsEntryB\003\340A\001\032.\n"
          + "\014ConfigsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001:\200\001\352A}\n"
          + "!managedkafka.googleapis.com/Topic\022Iprojects/{project"
          + "}/locations/{location}/clusters/{cluster}/topics/{topic}*\006topics2\005topic\"\341\001\n"
          + "\025ConsumerTopicMetadata\022\\\n\n"
          + "partitions\030\001 \003(\0132C."
          + "google.cloud.managedkafka.v1.ConsumerTopicMetadata.PartitionsEntryB\003\340A\001\032j\n"
          + "\017PartitionsEntry\022\013\n"
          + "\003key\030\001 \001(\005\022F\n"
          + "\005value\030\002 \001(\01327"
          + ".google.cloud.managedkafka.v1.ConsumerPartitionMetadata:\0028\001\"G\n"
          ...
          + ".managedkafka.v1.ConsumerGroup.TopicsEntryB\003\340A\001\032b\n"
          + "\013TopicsEntry\022\013\n"
          + "\003key\030\001 \001(\t\022B\n"
          + "\005value\030\002"
          + " \001(\01323.google.cloud.managedkafka.v1.ConsumerTopicMetadata:\0028\001:\252\001\352A\246\001\n"
          + ")managedkafka.googleapis.com/ConsumerGroup\022Zp"
          + "rojects/{project}/locations/{location}/c"
          + "lusters/{cluster}/consumerGroups/{consumer_group}*\016consumerGroups2\r"
          ...
          + " com.google.cloud.managedkafka.v1B\016ResourcesProtoP\001ZDclou"
          ...
          + "fka\\V1\352\002\037Google::Cloud::ManagedKafka::V1\352Ax\n"
