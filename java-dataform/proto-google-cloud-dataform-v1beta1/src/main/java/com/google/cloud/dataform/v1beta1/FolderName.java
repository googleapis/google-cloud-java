...
public class FolderName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_FOLDER =
  ...
  public static FolderName of(String project, String location, String folder) {
    return newBuilder().setProject(project).setLocation(location).setFolder(folder).build();
  }

  public static String format(String project, String location, String folder) {
    return newBuilder()
        .setProject(project)
  ...
  public static FolderName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_FOLDER.validatedMatch(
            formattedString, "FolderName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("folder"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_FOLDER.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_FOLDER.instantiate(
        "project", project, "location", location, "folder", folder);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/folders/{folder}. */
  public static class Builder {
    ...
    private Builder(FolderName folderName) {
      ...
      this.location = folderName.location;
