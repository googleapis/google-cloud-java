...
public interface CompilationResultOrBuilder
   ...
   *
   * <code>
   * .google.cloud.dataform.v1beta1.DataEncryptionState data_encryption_state = 9 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   *
   * <code>
   * .google.cloud.dataform.v1beta1.PrivateResourceMetadata private_resource_metadata = 12 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
