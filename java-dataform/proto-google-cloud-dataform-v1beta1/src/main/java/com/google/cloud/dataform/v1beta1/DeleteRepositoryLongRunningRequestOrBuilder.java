...
public interface DeleteRepositoryLongRunningRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1beta1.DeleteRepositoryLongRunningRequest)
