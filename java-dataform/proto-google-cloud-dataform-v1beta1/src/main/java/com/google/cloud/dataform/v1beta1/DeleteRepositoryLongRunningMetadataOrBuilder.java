...
public interface DeleteRepositoryLongRunningMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1beta1.DeleteRepositoryLongRunningMetadata)
   ...
   * @return The state.
   */
  com.google.cloud.dataform.v1beta1.DeleteRepositoryLongRunningMetadata.State getState();
