...
public interface FetchWorkspaceBranchesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1beta1.FetchWorkspaceBranchesRequest)
   ...
   *
   * <code>
   * .google.cloud.dataform.v1beta1.FetchWorkspaceBranchesRequest.BranchFilter filter = 2 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The filter.
   */
  com.google.cloud.dataform.v1beta1.FetchWorkspaceBranchesRequest.BranchFilter getFilter();
