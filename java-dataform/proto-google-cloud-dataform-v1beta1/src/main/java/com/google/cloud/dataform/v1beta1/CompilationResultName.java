...
public class CompilationResultName implements ResourceName {
  ...
  public static @Nullable CompilationResultName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CompilationResultName> values) {
