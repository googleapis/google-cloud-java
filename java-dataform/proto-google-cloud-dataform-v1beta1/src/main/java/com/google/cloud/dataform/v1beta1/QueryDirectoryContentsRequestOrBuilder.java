...
public interface QueryDirectoryContentsRequestOrBuilder
   ...
   *
   * <code>
   * .google.cloud.dataform.v1beta1.DirectoryContentsView view = 5 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The view.
   */
  com.google.cloud.dataform.v1beta1.DirectoryContentsView getView();
}
