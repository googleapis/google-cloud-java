    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 18:
            {
              com.google.cloud.dataform.v1beta1.Repository.GitRemoteSettings.Builder subBuilder =
                  null;
              ...
              gitRemoteSettings_ =
                  input.readMessage(
                      com.google.cloud.dataform.v1beta1.Repository.GitRemoteSettings.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
