...
public interface GcsRepositorySnapshotDestinationOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1beta1.GcsRepositorySnapshotDestination)
   ...
   * </pre>
   *
   * <code>string repository_snapshot_uri = 1 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
