...
public class ReleaseConfigName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_REPOSITORY_RELEASE_CONFIG =
  ...
  private ReleaseConfigName(Builder builder) {
    ...
    releaseConfig = Preconditions.checkNotNull(builder.getReleaseConfig());
  }
  ...
  public static ReleaseConfigName of(
      String project, String location, String repository, String releaseConfig) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable ReleaseConfigName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_REPOSITORY_RELEASE_CONFIG.validatedMatch(
            formattedString, "ReleaseConfigName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("repository"),
        matchMap.get("release_config"));
  }

  public static List<ReleaseConfigName> parseList(List<String> formattedStrings) {
    List<ReleaseConfigName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ReleaseConfigName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (releaseConfig != null) {
            fieldMapBuilder.put("release_config", releaseConfig);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_REPOSITORY_RELEASE_CONFIG.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.releaseConfig, that.releaseConfig);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(releaseConfig);
    return h;
  }
