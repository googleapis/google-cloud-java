...
public interface MoveFolderMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1beta1.MoveFolderMetadata)
   ...
   * @return The state.
   */
  com.google.cloud.dataform.v1beta1.MoveFolderMetadata.State getState();
