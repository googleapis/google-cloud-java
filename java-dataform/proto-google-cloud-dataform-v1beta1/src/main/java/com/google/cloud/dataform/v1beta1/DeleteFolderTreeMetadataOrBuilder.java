...
public interface DeleteFolderTreeMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1beta1.DeleteFolderTreeMetadata)
   ...
   *
   * <code>
   * .google.cloud.dataform.v1beta1.DeleteFolderTreeMetadata.State state = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The state.
   */
  com.google.cloud.dataform.v1beta1.DeleteFolderTreeMetadata.State getState();
