...
public class WorkflowInvocationName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_REPOSITORY_WORKFLOW_INVOCATION =
  ...
  private WorkflowInvocationName(Builder builder) {
    ...
    workflowInvocation = Preconditions.checkNotNull(builder.getWorkflowInvocation());
  }
  ...
  public static WorkflowInvocationName of(
      String project, String location, String repository, String workflowInvocation) {
    return newBuilder()
        .setProject(project)
  ...
  public static WorkflowInvocationName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_REPOSITORY_WORKFLOW_INVOCATION.validatedMatch(
            formattedString, "WorkflowInvocationName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("repository"),
        matchMap.get("workflow_invocation"));
  }

  public static List<WorkflowInvocationName> parseList(List<String> formattedStrings) {
    List<WorkflowInvocationName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (workflowInvocation != null) {
            fieldMapBuilder.put("workflow_invocation", workflowInvocation);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_REPOSITORY_WORKFLOW_INVOCATION.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(Object o) {
    ...
    if (o != null || getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.workflowInvocation, that.workflowInvocation);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(workflowInvocation);
    return h;
  }
