...
public final class ReleaseConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ReleaseConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class ScheduledReleaseRecord extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ScheduledReleaseRecord(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gitCommitish_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, gitCommitish_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(3, getCodeCompilationConfig());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cronSchedule_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, cronSchedule_);
    }
    for (int i = 0; i < recentScheduledReleaseRecords_.size(); i++) {
      output.writeMessage(5, recentScheduledReleaseRecords_.get(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(releaseCompilationResult_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, releaseCompilationResult_);
    }
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, internalMetadata_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(gitCommitish_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, gitCommitish_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size +=
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cronSchedule_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, cronSchedule_);
    }
    for (int i = 0; i < recentScheduledReleaseRecords_.size(); i++) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(releaseCompilationResult_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, releaseCompilationResult_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(timeZone_)) {
    ...
    if (((bitField0_ & 0x00000002) != 0)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(9, internalMetadata_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetRecentScheduledReleaseRecordsFieldBuilder();
      }
    }
    ...
    public com.google.cloud.dataform.v1.ReleaseConfig.ScheduledReleaseRecord.Builder
      ...
      return internalGetRecentScheduledReleaseRecordsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.dataform.v1.ReleaseConfig.ScheduledReleaseRecord.Builder
      ...
      return internalGetRecentScheduledReleaseRecordsFieldBuilder()
          .addBuilder(
              com.google.cloud.dataform.v1.ReleaseConfig.ScheduledReleaseRecord
                  .getDefaultInstance());
    }
    ...
    public java.util.List<com.google.cloud.dataform.v1.ReleaseConfig.ScheduledReleaseRecord.Builder>
      ...
      return internalGetRecentScheduledReleaseRecordsFieldBuilder().getBuilderList();
    }
