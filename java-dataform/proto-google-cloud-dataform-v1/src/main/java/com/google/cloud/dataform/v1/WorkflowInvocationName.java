...
public class WorkflowInvocationName implements ResourceName {
  ...
  public static @Nullable WorkflowInvocationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable WorkflowInvocationName> values) {
