...
public interface RelationDescriptorOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1.RelationDescriptor)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.dataform.v1.RelationDescriptor.ColumnDescriptor> getColumnsList();
   ...
   * </code>
   */
  com.google.cloud.dataform.v1.RelationDescriptor.ColumnDescriptor getColumns(int index);
   ...
   * </code>
   */
  com.google.cloud.dataform.v1.RelationDescriptor.ColumnDescriptorOrBuilder getColumnsOrBuilder(
      int index);
