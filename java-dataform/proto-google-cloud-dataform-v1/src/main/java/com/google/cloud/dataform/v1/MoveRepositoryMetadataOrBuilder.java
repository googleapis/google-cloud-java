...
public interface MoveRepositoryMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1.MoveRepositoryMetadata)
   ...
   * @return The state.
   */
  com.google.cloud.dataform.v1.MoveRepositoryMetadata.State getState();
