...
public interface InvocationConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dataform.v1.InvocationConfig)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.dataform.v1.Target> getIncludedTargetsList();
   ...
   * </code>
   */
  com.google.cloud.dataform.v1.Target getIncludedTargets(int index);
   ...
   * </code>
   */
  com.google.cloud.dataform.v1.TargetOrBuilder getIncludedTargetsOrBuilder(int index);
