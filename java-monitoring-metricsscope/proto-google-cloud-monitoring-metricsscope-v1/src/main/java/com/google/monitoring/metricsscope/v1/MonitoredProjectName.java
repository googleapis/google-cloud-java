...
public class MonitoredProjectName implements ResourceName {
  ...
  public static @Nullable MonitoredProjectName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable MonitoredProjectName> values) {
