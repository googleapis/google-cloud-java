...
public final class Source extends com.google.protobuf.GeneratedMessageV3
   ...
   */
  @java.lang.Override
  public /* nullable */ io.grafeas.v1beta1.provenance.FileHashes getFileHashesOrDefault(
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    private static final class FileHashesConverter
      ...
      public io.grafeas.v1beta1.provenance.FileHashes build(
          io.grafeas.v1beta1.provenance.FileHashesOrBuilder val) {
        if (val instanceof io.grafeas.v1beta1.provenance.FileHashes) {
          return (io.grafeas.v1beta1.provenance.FileHashes) val;
        }
        return ((io.grafeas.v1beta1.provenance.FileHashes.Builder) val).build();
      }
    ...
    public /* nullable */ io.grafeas.v1beta1.provenance.FileHashes getFileHashesOrDefault(
      ...
      java.util.Map<java.lang.String, io.grafeas.v1beta1.provenance.FileHashesOrBuilder> map =
    ...
    public Builder putAllFileHashes(
      ...
      for (java.util.Map.Entry<java.lang.String, io.grafeas.v1beta1.provenance.FileHashes> e :
          values.entrySet()) {
     ...
     * <code>map&lt;string, .grafeas.v1beta1.provenance.FileHashes&gt; file_hashes = 2;</code>
     */
    public io.grafeas.v1beta1.provenance.FileHashes.Builder putFileHashesBuilderIfAbsent(
        java.lang.String key) {
      java.util.Map<java.lang.String, io.grafeas.v1beta1.provenance.FileHashesOrBuilder>
          builderMap = internalGetMutableFileHashes().ensureBuilderMap();
      io.grafeas.v1beta1.provenance.FileHashesOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = io.grafeas.v1beta1.provenance.FileHashes.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof io.grafeas.v1beta1.provenance.FileHashes) {
        entry = ((io.grafeas.v1beta1.provenance.FileHashes) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (io.grafeas.v1beta1.provenance.FileHashes.Builder) entry;
    }
