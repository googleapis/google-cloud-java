...
public final class Details extends com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    private void buildPartial0(io.grafeas.v1beta1.pkg.Details result) {
      int from_bitField0_ = bitField0_;
      int to_bitField0_ = 0;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.installation_ =
            installationBuilder_ == null ? installation_ : installationBuilder_.build();
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(getInstallationFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public Builder mergeInstallation(io.grafeas.v1beta1.pkg.Installation value) {
      if (installationBuilder_ == null) {
        if (((bitField0_ & 0x00000001) != 0)
            && installation_ != null
            && installation_ != io.grafeas.v1beta1.pkg.Installation.getDefaultInstance()) {
