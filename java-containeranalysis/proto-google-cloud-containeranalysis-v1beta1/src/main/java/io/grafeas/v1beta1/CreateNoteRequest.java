...
public final class CreateNoteRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CreateNoteRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(noteId_)) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(internalGetNoteFieldBuilder().getBuilder(), extensionRegistry);
