...
public final class BuildOuterClass extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + ";google/devtools/containeranalysis/v1beta1/build/build.proto\022\025grafeas.v1beta1.b"
          + "uild\032Egoogle/devtools/containeranalysis/v1beta1/provenance/provenance.proto\"Z\n"
          + "\005Build\022\027\n"
          + "\017builder_version\030\001 \001(\t\0228\n"
          + "\tsignature\030\002 \001(\0132%.grafeas.v1beta1.build.BuildSignature\"\322\001\n"
          + "\016BuildSignature\022\022\n\n"
          + "public_key\030\001 \001(\t\022\021\n"
          + "\tsignature\030\002 \001(\014\022\016\n"
          + "\006key_id\030\003 \001(\t\022?\n"
          + "\010key_type\030\004 \001(\0162-.grafeas.v1beta1.build.BuildSignature.KeyType\"H\n"
          + "\007KeyType\022\030\n"
          + "\024KEY_TYPE_UNSPECIFIED\020\000\022\025\n"
          + "\021PGP_ASCII_ARMORED\020\001\022\014\n"
          + "\010PKIX_PEM\020\002\"d\n"
          + "\007Details\022?\n\n"
          + "provenance\030\001 \001(\0132+.grafeas.v1beta1.provenance.BuildProvenance\022\030\n"
          + "\020provenance_bytes\030\002 \001(\tB|\n"
          + "\030io.grafeas.v1beta1.buildP\001ZXcloud.google.com/go/containeranalysis/apiv1bet"
          + "a1/containeranalysispb;containeranalysispb\242\002\003GRAb\006proto3"
    };
    descriptor =
    ...
    internal_static_grafeas_v1beta1_build_Build_descriptor = getDescriptor().getMessageType(0);
    internal_static_grafeas_v1beta1_build_Build_fieldAccessorTable =
    ...
    internal_static_grafeas_v1beta1_build_Details_descriptor = getDescriptor().getMessageType(2);
    internal_static_grafeas_v1beta1_build_Details_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_grafeas_v1beta1_build_Details_descriptor,
            new java.lang.String[] {
