...
public final class BatchCreateNotesRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private BatchCreateNotesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  @java.lang.Override
  public /* nullable */ io.grafeas.v1beta1.Note getNotesOrDefault(
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(io.grafeas.v1beta1.BatchCreateNotesRequest result) {
      int from_bitField0_ = bitField0_;
      if (((from_bitField0_ & 0x00000001) != 0)) {
        result.parent_ = parent_;
      }
      if (((from_bitField0_ & 0x00000002) != 0)) {
        result.notes_ = internalGetNotes().build(NotesDefaultEntryHolder.defaultEntry);
      }
    }
            ...
            case 18:
              {
                ...
                internalGetMutableNotes()
                    .ensureBuilderMap()
                    .put(notes__.getKey(), notes__.getValue());
                bitField0_ |= 0x00000002;
                break;
              } // case 18
            default:
    ...
    private static final class NotesConverter
        implements com.google.protobuf.MapFieldBuilder.Converter<
            java.lang.String, io.grafeas.v1beta1.NoteOrBuilder, io.grafeas.v1beta1.Note> {
      @java.lang.Override
      public io.grafeas.v1beta1.Note build(io.grafeas.v1beta1.NoteOrBuilder val) {
        if (val instanceof io.grafeas.v1beta1.Note) {
          return (io.grafeas.v1beta1.Note) val;
        }
        return ((io.grafeas.v1beta1.Note.Builder) val).build();
      }

      @java.lang.Override
      public com.google.protobuf.MapEntry<java.lang.String, io.grafeas.v1beta1.Note>
          defaultEntry() {
    ...
    private com.google.protobuf.MapFieldBuilder<
        ...
        internalGetNotes() {
      if (notes_ == null) {
        return new com.google.protobuf.MapFieldBuilder<>(notesConverter);
      }
      return notes_;
    }
    ...
    private com.google.protobuf.MapFieldBuilder<
        ...
        internalGetMutableNotes() {
      if (notes_ == null) {
        notes_ = new com.google.protobuf.MapFieldBuilder<>(notesConverter);
      }
      bitField0_ |= 0x00000002;
      onChanged();
      return notes_;
    ...
    public /* nullable */ io.grafeas.v1beta1.Note getNotesOrDefault(
      ...
      java.util.Map<java.lang.String, io.grafeas.v1beta1.NoteOrBuilder> map =
    ...
    public io.grafeas.v1beta1.Note getNotesOrThrow(java.lang.String key) {
      ...
      return notesConverter.build(map.get(key));
    }
    ...
    public Builder putNotes(java.lang.String key, io.grafeas.v1beta1.Note value) {
      ...
      internalGetMutableNotes().ensureBuilderMap().put(key, value);
      bitField0_ |= 0x00000002;
      return this;
    }
    ...
    public Builder putAllNotes(java.util.Map<java.lang.String, io.grafeas.v1beta1.Note> values) {
      for (java.util.Map.Entry<java.lang.String, io.grafeas.v1beta1.Note> e : values.entrySet()) {
        if (e.getKey() == null || e.getValue() == null) {
          throw new NullPointerException();
        }
      }
      internalGetMutableNotes().ensureBuilderMap().putAll(values);
      bitField0_ |= 0x00000002;
      return this;
    }
     ...
     * <code>map&lt;string, .grafeas.v1beta1.Note&gt; notes = 2;</code>
     */
    public io.grafeas.v1beta1.Note.Builder putNotesBuilderIfAbsent(java.lang.String key) {
      java.util.Map<java.lang.String, io.grafeas.v1beta1.NoteOrBuilder> builderMap =
          internalGetMutableNotes().ensureBuilderMap();
      io.grafeas.v1beta1.NoteOrBuilder entry = builderMap.get(key);
      if (entry == null) {
        entry = io.grafeas.v1beta1.Note.newBuilder();
        builderMap.put(key, entry);
      }
      if (entry instanceof io.grafeas.v1beta1.Note) {
        entry = ((io.grafeas.v1beta1.Note) entry).toBuilder();
        builderMap.put(key, entry);
      }
      return (io.grafeas.v1beta1.Note.Builder) entry;
    }
