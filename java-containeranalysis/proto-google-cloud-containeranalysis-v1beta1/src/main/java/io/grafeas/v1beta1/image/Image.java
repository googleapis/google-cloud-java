...
public final class Image {
  ...
  static {
    ...
    internal_static_grafeas_v1beta1_image_Layer_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1beta1_image_Layer_descriptor,
        new java.lang.String[] { "Directive", "Arguments", });
    internal_static_grafeas_v1beta1_image_Fingerprint_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_grafeas_v1beta1_image_Fingerprint_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1beta1_image_Fingerprint_descriptor,
        new java.lang.String[] { "V1Name", "V2Blob", "V2Name", });
    internal_static_grafeas_v1beta1_image_Basis_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_grafeas_v1beta1_image_Basis_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1beta1_image_Basis_descriptor,
        new java.lang.String[] { "ResourceUrl", "Fingerprint", });
    internal_static_grafeas_v1beta1_image_Details_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_grafeas_v1beta1_image_Details_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1beta1_image_Details_descriptor,
        new java.lang.String[] { "DerivedImage", });
    internal_static_grafeas_v1beta1_image_Derived_descriptor =
      getDescriptor().getMessageTypes().get(4);
    internal_static_grafeas_v1beta1_image_Derived_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1beta1_image_Derived_descriptor,
