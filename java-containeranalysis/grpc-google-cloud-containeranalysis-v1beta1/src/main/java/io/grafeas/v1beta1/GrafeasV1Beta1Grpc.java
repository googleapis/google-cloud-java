...
public final class GrafeasV1Beta1Grpc {
  ...
  public static final java.lang.String SERVICE_NAME = "grafeas.v1beta1.GrafeasV1Beta1";
  ...
  public static GrafeasV1Beta1BlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1BlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<GrafeasV1Beta1BlockingV2Stub>() {
          @java.lang.Override
          public GrafeasV1Beta1BlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new GrafeasV1Beta1BlockingV2Stub(channel, callOptions);
          }
        };
    return GrafeasV1Beta1BlockingV2Stub.newStub(factory, channel);
  }
  ...
  /**
   * Base class for the server implementation of the service GrafeasV1Beta1.
   *
   * <pre>
   * [Grafeas](grafeas.io) API.
   * Retrieves analysis results of Cloud components such as Docker container
   ...
   * </pre>
   */
  public abstract static class GrafeasV1Beta1ImplBase
      implements io.grpc.BindableService, AsyncService {

    @java.lang.Override
    public final io.grpc.ServerServiceDefinition bindService() {
      return GrafeasV1Beta1Grpc.bindService(this);
    }
  }

  /**
   * A stub to allow clients to do asynchronous rpc calls to service GrafeasV1Beta1.
   *
   * <pre>
   * [Grafeas](grafeas.io) API.
   * Retrieves analysis results of Cloud components such as Docker container
  ...
  /**
   * A stub to allow clients to do synchronous rpc calls to service GrafeasV1Beta1.
   *
   * <pre>
   * [Grafeas](grafeas.io) API.
   * Retrieves analysis results of Cloud components such as Docker container
   ...
   * </pre>
   */
  public static final class GrafeasV1Beta1BlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<GrafeasV1Beta1BlockingV2Stub> {
    private GrafeasV1Beta1BlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected GrafeasV1Beta1BlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new GrafeasV1Beta1BlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grafeas.v1beta1.Occurrence getOccurrence(
        io.grafeas.v1beta1.GetOccurrenceRequest request) throws io.grpc.StatusException {
    ...
    public io.grafeas.v1beta1.ListOccurrencesResponse listOccurrences(
        io.grafeas.v1beta1.ListOccurrencesRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public com.google.protobuf.Empty deleteOccurrence(
        io.grafeas.v1beta1.DeleteOccurrenceRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.Occurrence createOccurrence(
        io.grafeas.v1beta1.CreateOccurrenceRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.BatchCreateOccurrencesResponse batchCreateOccurrences(
        io.grafeas.v1beta1.BatchCreateOccurrencesRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.Occurrence updateOccurrence(
        io.grafeas.v1beta1.UpdateOccurrenceRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.Note getOccurrenceNote(
        io.grafeas.v1beta1.GetOccurrenceNoteRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.ListNotesResponse listNotes(
        io.grafeas.v1beta1.ListNotesRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.BatchCreateNotesResponse batchCreateNotes(
        io.grafeas.v1beta1.BatchCreateNotesRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
    ...
    public io.grafeas.v1beta1.ListNoteOccurrencesResponse listNoteOccurrences(
        io.grafeas.v1beta1.ListNoteOccurrencesRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service GrafeasV1Beta1.
   *
   * <pre>
   * [Grafeas](grafeas.io) API.
   * Retrieves analysis results of Cloud components such as Docker container
  ...
  /**
   * A stub to allow clients to do ListenableFuture-style rpc calls to service GrafeasV1Beta1.
   *
   * <pre>
   * [Grafeas](grafeas.io) API.
   * Retrieves analysis results of Cloud components such as Docker container
  ...
  public static final io.grpc.ServerServiceDefinition bindService(AsyncService service) {
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
            getDeleteNoteMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<io.grafeas.v1beta1.DeleteNoteRequest, com.google.protobuf.Empty>(
  ...
  private static final class GrafeasV1Beta1MethodDescriptorSupplier
    ...
    GrafeasV1Beta1MethodDescriptorSupplier(java.lang.String methodName) {
