...
public final class CreateSubmissionRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CreateSubmissionRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetSubmissionFieldBuilder().getBuilder(), extensionRegistry);
