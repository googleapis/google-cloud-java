...
public final class SearchUrisResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SearchUrisResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class ThreatUri extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ThreatUri(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }

    private ThreatUri() {
      threatTypes_ = emptyIntList();
    }
    ...
    private com.google.protobuf.Internal.IntList threatTypes_ = emptyIntList();
    ...
    private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
        ...
        threatTypes_converter_ =
            new com.google.protobuf.Internal.IntListAdapter.IntConverter<
                com.google.webrisk.v1beta1.ThreatType>() {
              public com.google.webrisk.v1beta1.ThreatType convert(int from) {
    ...
    public java.util.List<com.google.webrisk.v1beta1.ThreatType> getThreatTypesList() {
      return new com.google.protobuf.Internal.IntListAdapter<com.google.webrisk.v1beta1.ThreatType>(
    ...
    public com.google.webrisk.v1beta1.ThreatType getThreatTypes(int index) {
      return threatTypes_converter_.convert(threatTypes_.getInt(index));
    }
    ...
    public int getThreatTypesValue(int index) {
      return threatTypes_.getInt(index);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < threatTypes_.size(); i++) {
        output.writeEnumNoTag(threatTypes_.getInt(i));
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      {
        ...
        for (int i = 0; i < threatTypes_.size(); i++) {
          dataSize +=
              com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(threatTypes_.getInt(i));
        }
        size += dataSize;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
              ...
              case 10:
                {
                  ...
                  while (input.getBytesUntilLimit() > 0) {
                    threatTypes_.addInt(input.readEnum());
                  }
      ...
      private void ensureThreatTypesIsMutable() {
        if (!threatTypes_.isModifiable()) {
          threatTypes_ = makeMutableCopy(threatTypes_);
        }
        bitField0_ |= 0x00000001;
      }
      ...
      public java.util.List<com.google.webrisk.v1beta1.ThreatType> getThreatTypesList() {
        return new com.google.protobuf.Internal.IntListAdapter<
            com.google.webrisk.v1beta1.ThreatType>(threatTypes_, threatTypes_converter_);
      }
      ...
      public Builder setThreatTypes(int index, com.google.webrisk.v1beta1.ThreatType value) {
        ...
        ensureThreatTypesIsMutable();
        threatTypes_.setInt(index, value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder addThreatTypes(com.google.webrisk.v1beta1.ThreatType value) {
        ...
        ensureThreatTypesIsMutable();
        threatTypes_.addInt(value.getNumber());
        onChanged();
        return this;
      }
      ...
      public Builder setThreatTypesValue(int index, int value) {
        ensureThreatTypesIsMutable();
        threatTypes_.setInt(index, value);
        onChanged();
        return this;
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetThreatFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
            default:
    ...
    public com.google.webrisk.v1beta1.SearchUrisResponse.ThreatUri.Builder getThreatBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetThreatFieldBuilder().getBuilder();
    }
