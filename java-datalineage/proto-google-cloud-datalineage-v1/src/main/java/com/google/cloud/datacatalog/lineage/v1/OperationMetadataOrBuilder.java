...
public interface OperationMetadataOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.datacatalog.lineage.v1.OperationMetadata)
   ...
   * @return The state.
   */
  com.google.cloud.datacatalog.lineage.v1.OperationMetadata.State getState();
   ...
   */
  com.google.cloud.datacatalog.lineage.v1.OperationMetadata.Type getOperationType();
   ...
   * </pre>
   *
   * <code>string resource = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
   * @return The resource.
   */
   ...
   * </pre>
   *
   * <code>string resource_uuid = 4 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
