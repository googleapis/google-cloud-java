...
public class ConfigName implements ResourceName {
  ...
  private static final PathTemplate FOLDER_LOCATION =
      PathTemplate.createWithoutUrlEncoding("folders/{folder}/locations/{location}/config");
  ...
  private ConfigName(FolderLocationBuilder builder) {
  ...
  private ConfigName(OrganizationLocationBuilder builder) {
  ...
  public static ConfigName ofProjectLocationName(String project, String location) {
    return newBuilder().setProject(project).setLocation(location).build();
  }

  public static ConfigName ofFolderLocationName(String folder, String location) {
    return newFolderLocationBuilder().setFolder(folder).setLocation(location).build();
  }

  public static ConfigName ofOrganizationLocationName(String organization, String location) {
  ...
  public static ConfigName parse(String formattedString) {
    ...
    throw new ValidationException("ConfigName.parse: formattedString not in valid format");
  }
  ...
  public static class Builder {
    ...
    private Builder(ConfigName configName) {
      Preconditions.checkArgument(
          Objects.equals(configName.pathTemplate, PROJECT_LOCATION),
          "toBuilder is only supported when ConfigName has the pattern of"
  ...
  /** Builder for folders/{folder}/locations/{location}/config. */
  ...
  /** Builder for organizations/{organization}/locations/{location}/config. */
