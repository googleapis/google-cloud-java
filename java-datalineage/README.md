...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datalineage" % "0.45.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datalineage/0.45.0
