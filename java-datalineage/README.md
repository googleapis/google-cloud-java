...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datalineage" % "0.60.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datalineage/0.60.0
