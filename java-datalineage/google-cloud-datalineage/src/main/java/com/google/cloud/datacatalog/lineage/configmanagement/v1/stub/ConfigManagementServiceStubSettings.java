...
/**
 * Settings class to configure an instance of {@link ConfigManagementServiceStub}.
 *
...
public class ConfigManagementServiceStubSettings
    extends StubSettings<ConfigManagementServiceStubSettings> {
  ...
  public ConfigManagementServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcConfigManagementServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonConfigManagementServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ConfigManagementServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ConfigManagementServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected ConfigManagementServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for ConfigManagementServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<ConfigManagementServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getConfigSettings, updateConfigSettings);
      initDefaults(this);
    }

    protected Builder(ConfigManagementServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public ConfigManagementServiceStubSettings build() throws IOException {
      return new ConfigManagementServiceStubSettings(this);
    }
  }
}
