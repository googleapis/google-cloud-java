...
public interface RenderAccountIssuesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.issueresolution.v1.RenderAccountIssuesRequest)
   ...
   *
   * <code>
   * .google.shopping.merchant.issueresolution.v1.RenderIssuesRequestPayload payload = 4 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The payload.
   */
  com.google.shopping.merchant.issueresolution.v1.RenderIssuesRequestPayload getPayload();
   ...
   * </code>
   */
  com.google.shopping.merchant.issueresolution.v1.RenderIssuesRequestPayloadOrBuilder
      getPayloadOrBuilder();
}
