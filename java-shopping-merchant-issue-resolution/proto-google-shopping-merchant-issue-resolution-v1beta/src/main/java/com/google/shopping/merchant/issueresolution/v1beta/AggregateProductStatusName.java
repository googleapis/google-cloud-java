...
public class AggregateProductStatusName implements ResourceName {
  ...
  public static @Nullable AggregateProductStatusName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AggregateProductStatusName> values) {
