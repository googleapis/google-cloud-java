...
public interface BreakdownOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.issueresolution.v1beta.Breakdown)
   ...
   * </code>
   */
  java.util.List<com.google.shopping.merchant.issueresolution.v1beta.Breakdown.Region>
      getRegionsList();
   ...
   * </code>
   */
  com.google.shopping.merchant.issueresolution.v1beta.Breakdown.Region getRegions(int index);
   ...
   * </code>
   */
  com.google.shopping.merchant.issueresolution.v1beta.Breakdown.RegionOrBuilder getRegionsOrBuilder(
      int index);
