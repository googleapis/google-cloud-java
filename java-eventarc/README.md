...
```Groovy
compile 'com.google.cloud:google-cloud-eventarc:0.0.0'
```

If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-eventarc" % "0.0.0"
```
...
[javadocs]: https://googleapis.dev/java/google-cloud-eventarc/latest/index.html
...
[contributing]: https://github.com/googleapis/java-eventarc/blob/master/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-eventarc/blob/master/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-eventarc/blob/master/LICENSE
