  ...
  static {
    java.lang.String[] descriptorData = {
      "\n&google/cloud/eventarc/v1/trigger.proto"
          ...
          + "subscription\030\002 \001(\tB\003\340A\003B\270\003\n\034com.google.c"
          + "loud.eventarc.v1B\014TriggerProtoP\001Z8cloud."
          + "google.com/go/eventarc/apiv1/eventarcpb;"
          + "eventarcpb\352Ak\n+cloudfunctions.googleapis"
          + ".com/CloudFunction\022<projects/{project}/l"
          + "ocations/{location}/functions/{function}"
          + "\352AY\n!iam.googleapis.com/ServiceAccount\0224"
          + "projects/{project}/serviceAccounts/{serv"
          + "ice_account}\352A\037\n\032run.googleapis.com/Serv"
          + "ice\022\001*\352Aa\n!workflows.googleapis.com/Work"
          + "flow\022<projects/{project}/locations/{loca"
          + "tion}/workflows/{workflow}b\006proto3"
    };
    descriptor =
