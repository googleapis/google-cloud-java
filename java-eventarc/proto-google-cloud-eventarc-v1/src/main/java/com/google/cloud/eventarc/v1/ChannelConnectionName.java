...
public class ChannelConnectionName implements ResourceName {
  ...
  public static @Nullable ChannelConnectionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ChannelConnectionName> values) {
