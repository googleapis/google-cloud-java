...
public final class Destination extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (descriptorCase_ == 2) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, descriptor_);
    }
    if (descriptorCase_ == 3) {
      output.writeMessage(3, (com.google.cloud.eventarc.v1.GKE) descriptor_);
    }
    if (descriptorCase_ == 4) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, descriptor_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (descriptorCase_ == 2) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, descriptor_);
    }
    if (descriptorCase_ == 3) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
    ...
    if (descriptorCase_ == 4) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, descriptor_);
    }
