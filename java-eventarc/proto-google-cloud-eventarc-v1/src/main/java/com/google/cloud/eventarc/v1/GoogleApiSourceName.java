...
public class GoogleApiSourceName implements ResourceName {
  ...
  public static @Nullable GoogleApiSourceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GoogleApiSourceName> values) {
