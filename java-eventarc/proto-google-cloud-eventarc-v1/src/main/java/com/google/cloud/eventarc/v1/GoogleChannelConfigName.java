...
public class GoogleChannelConfigName implements ResourceName {
  ...
  public static @Nullable GoogleChannelConfigName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION.validatedMatch(
            formattedString, "GoogleChannelConfigName.parse: formattedString not in valid format");
  ...
  public static List<GoogleChannelConfigName> parseList(List<String> formattedStrings) {
    List<GoogleChannelConfigName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable GoogleChannelConfigName> values) {
