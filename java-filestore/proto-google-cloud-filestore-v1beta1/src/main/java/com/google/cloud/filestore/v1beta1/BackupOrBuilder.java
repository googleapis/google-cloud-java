...
public interface BackupOrBuilder
   ...
   */
  com.google.cloud.filestore.v1beta1.Instance.Tier getSourceInstanceTier();
   ...
   *
   * <code>
   * .google.cloud.filestore.v1beta1.Instance.FileProtocol file_system_protocol = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.filestore.v1beta1.Instance.FileProtocol getFileSystemProtocol();
}
