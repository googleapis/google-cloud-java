...
```Groovy
implementation 'com.google.cloud:google-cloud-filestore:1.13.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-filestore/1.13.0
