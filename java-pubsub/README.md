...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-pubsub" % "1.135.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-pubsub/1.135.0
