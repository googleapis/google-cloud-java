...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-pubsub" % "1.126.1"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-pubsub/1.126.1
