...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-pubsub" % "1.129.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-pubsub/1.129.0
