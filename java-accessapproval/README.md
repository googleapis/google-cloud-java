...
```Groovy
implementation 'com.google.cloud:google-cloud-accessapproval:2.46.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-accessapproval" % "2.46.0"
```
...
[Access Approval][product-docs] enables controlling access to your organization's data by Google personnel test test test test.
