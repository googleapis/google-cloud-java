...
public class EntitlementName implements ResourceName {
  ...
  public static EntitlementName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_ENTITLEMENT.validatedMatch(
            formattedString, "EntitlementName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("entitlement"));
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_ENTITLEMENT.instantiate(
        "project", project, "location", location, "entitlement", entitlement);
  }
