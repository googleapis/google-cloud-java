...
public class GoldengateDeploymentVersionName implements ResourceName {
  ...
  public static GoldengateDeploymentVersionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<GoldengateDeploymentVersionName> values) {
