...
public class CloudExadataInfrastructureName implements ResourceName {
  ...
  public static @Nullable CloudExadataInfrastructureName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CloudExadataInfrastructureName> values) {
