...
public interface MinorVersionOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.oracledatabase.v1.MinorVersion)
   ...
   * </pre>
   *
   * <code>string grid_image_id = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
