...
public interface GoldengateMysqlConnectionPropertiesOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.oracledatabase.v1.GoldengateMysqlConnectionProperties)
   ...
   * </pre>
   *
   * <code>string host = 4 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   * @return The host.
   */
   ...
   * </pre>
   *
   * <code>string database = 6 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   * @return The database.
   */
   ...
   */
  com.google.cloud.oracledatabase.v1.GoldengateMysqlConnectionProperties.MysqlSecurityProtocol
      getSecurityProtocol();
   ...
   * @return The sslMode.
   */
  com.google.cloud.oracledatabase.v1.GoldengateMysqlConnectionProperties.SSLMode getSslMode();
   ...
   * </pre>
   *
   * <code>string ssl_crl_file = 10 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   ...
   * </pre>
   *
   * <code>string ssl_cert_file = 11 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
   ...
   * </pre>
   *
   * <code>string ssl_key_file = 12 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
