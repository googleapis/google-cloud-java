...
public class DatabaseName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_DATABASE =
  ...
  public static DatabaseName of(String project, String location, String database) {
    return newBuilder().setProject(project).setLocation(location).setDatabase(database).build();
  }

  public static String format(String project, String location, String database) {
    return newBuilder()
        .setProject(project)
  ...
  public static DatabaseName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_DATABASE.validatedMatch(
            formattedString, "DatabaseName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("database"));
  }
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_DATABASE.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_DATABASE.instantiate(
  ...
  /** Builder for projects/{project}/locations/{location}/databases/{database}. */
