...
public class AutonomousDbVersionName implements ResourceName {
  ...
  public static @Nullable AutonomousDbVersionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AutonomousDbVersionName> values) {
