...
public class GoldengateDeploymentName implements ResourceName {
  ...
  public static @Nullable GoldengateDeploymentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable GoldengateDeploymentName> values) {
