...
public class RecommenderConfigName implements ResourceName {
  ...
  public static @Nullable RecommenderConfigName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RecommenderConfigName> values) {
