...
public final class InsightOuterClass extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "truct.proto\032\037google/protobuf/timestamp.proto\"\312\t\n"
          + "\007Insight\022\014\n"
          ...
          + "\010category\030\007"
          + " \001(\01622.google.cloud.recommender.v1beta1.Insight.Category\022D\n"
          + "\010severity\030\017"
          + " \001(\01622.google.cloud.recommender.v1beta1.Insight.Severity\022\014\n"
          + "\004etag\030\013 \001(\t\022e\n"
          + "\032associated_recommendations\030\010 \003(\0132A.g"
          + "oogle.cloud.recommender.v1beta1.Insight.RecommendationReference\0321\n"
          ...
          + "\"recommender.googleapis.com/Insight\022Vprojects/{project}/l"
          + "ocations/{location}/insightTypes/{insight_type}/insights/{insight}\022ebillingAccou"
          + "nts/{billing_account}/locations/{location}/insightTypes/{insight_type}/insights/"
          + "{insight}\022Tfolders/{folder}/locations/{location}/insightTypes/{insight_type}/ins"
          + "ights/{insight}\022`organizations/{organiza"
          + "tion}/locations/{location}/insightTypes/{insight_type}/insights/{insight}\"\271\002\n"
          + "\020InsightStateInfo\022G\n"
          + "\005state\030\001 \001(\01628.google.c"
          + "loud.recommender.v1beta1.InsightStateInfo.State\022]\n"
          + "\016state_metadata\030\002 \003(\0132E.google"
          + ".cloud.recommender.v1beta1.InsightStateInfo.StateMetadataEntry\0324\n"
          ...
          + "\013InsightType\022\014\n"
          + "\004name\030\001 \001(\t:\364\002\352A\360\002\n"
          + "&recommender.googleapis.com/InsightType\022Cprojects/{pr"
          + "oject}/locations/{location}/insightTypes/{insight_type}\022RbillingAccounts/{billin"
          + "g_account}/locations/{location}/insightTypes/{insight_type}\022Afolders/{folder}/lo"
          + "cations/{location}/insightTypes/{insight_type}\022Morganizations/{organization}/loc"
          + "ations/{location}/insightTypes/{insight_type}\022\033insightTypes/{insight_type}B\232\001\n"
          + "$com.google.cloud.recommender.v1beta1P\001ZFc"
          + "loud.google.com/go/recommender/apiv1beta1/recommenderpb;recommenderpb\242\002\004CREC\252\002"
    ...
    internal_static_google_cloud_recommender_v1beta1_Insight_RecommendationReference_descriptor =
        internal_static_google_cloud_recommender_v1beta1_Insight_descriptor.getNestedType(0);
    internal_static_google_cloud_recommender_v1beta1_Insight_RecommendationReference_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_recommender_v1beta1_Insight_RecommendationReference_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_recommender_v1beta1_InsightStateInfo_StateMetadataEntry_descriptor =
        internal_static_google_cloud_recommender_v1beta1_InsightStateInfo_descriptor.getNestedType(
            0);
    internal_static_google_cloud_recommender_v1beta1_InsightStateInfo_StateMetadataEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_recommender_v1beta1_InsightStateInfo_StateMetadataEntry_descriptor,
