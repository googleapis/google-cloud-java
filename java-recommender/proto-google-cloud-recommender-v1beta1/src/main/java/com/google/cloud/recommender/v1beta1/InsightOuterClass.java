  ...
  static {
    java.lang.String[] descriptorData = {
      "\n.google/cloud/recommender/v1beta1/insig"
          ...
          + "ogle.cloud.recommender.v1beta1P\001ZKgoogle"
          + ".golang.org/genproto/googleapis/cloud/re"
          + "commender/v1beta1;recommender\242\002\004CREC\252\002 G"
          + "oogle.Cloud.Recommender.V1Beta1\352A\323\002\n&rec"
          + "ommender.googleapis.com/InsightType\022Cpro"
          + "jects/{project}/locations/{location}/ins"
          + "ightTypes/{insight_type}\022RbillingAccount"
          + "s/{billing_account}/locations/{location}"
          + "/insightTypes/{insight_type}\022Afolders/{f"
          + "older}/locations/{location}/insightTypes"
          + "/{insight_type}\022Morganizations/{organiza"
          + "tion}/locations/{location}/insightTypes/"
