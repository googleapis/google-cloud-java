...
public interface PromotionStatusOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.promotions.v1.PromotionStatus)
   ...
   *
   * <code>
   * repeated .google.shopping.merchant.promotions.v1.PromotionStatus.DestinationStatus destination_statuses = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   */
  java.util.List<com.google.shopping.merchant.promotions.v1.PromotionStatus.DestinationStatus>
   ...
   * </code>
   */
  com.google.shopping.merchant.promotions.v1.PromotionStatus.DestinationStatus
  ...
  java.util.List<
          ? extends
              com.google.shopping.merchant.promotions.v1.PromotionStatus.DestinationStatusOrBuilder>
   ...
   *
   * <code>
   * repeated .google.shopping.merchant.promotions.v1.PromotionStatus.ItemLevelIssue item_level_issues = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   */
  java.util.List<com.google.shopping.merchant.promotions.v1.PromotionStatus.ItemLevelIssue>
   ...
   * </code>
   */
  com.google.shopping.merchant.promotions.v1.PromotionStatus.ItemLevelIssue getItemLevelIssues(
      int index);
  ...
  java.util.List<
          ? extends
              com.google.shopping.merchant.promotions.v1.PromotionStatus.ItemLevelIssueOrBuilder>
