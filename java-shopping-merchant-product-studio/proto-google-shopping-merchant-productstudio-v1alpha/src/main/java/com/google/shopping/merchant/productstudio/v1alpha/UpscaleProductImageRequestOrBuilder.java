...
public interface UpscaleProductImageRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.productstudio.v1alpha.UpscaleProductImageRequest)
