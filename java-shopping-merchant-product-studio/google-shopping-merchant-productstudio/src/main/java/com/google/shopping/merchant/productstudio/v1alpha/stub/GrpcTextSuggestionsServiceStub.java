...
/**
 * gRPC stub implementation for the TextSuggestionsService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@BetaApi
@Generated("by gapic-generator-java")
public class GrpcTextSuggestionsServiceStub extends TextSuggestionsServiceStub {
      ...
      generateProductTextSuggestionsMethodDescriptor =
          MethodDescriptor
              ...
              .setRequestMarshaller(
                  ProtoUtils.marshaller(GenerateProductTextSuggestionsRequest.getDefaultInstance()))
  ...
  public static final GrpcTextSuggestionsServiceStub create(
      TextSuggestionsServiceStubSettings settings) throws IOException {
    return new GrpcTextSuggestionsServiceStub(settings, ClientContext.create(settings));
  }

  public static final GrpcTextSuggestionsServiceStub create(ClientContext clientContext)
      throws IOException {
    return new GrpcTextSuggestionsServiceStub(
        TextSuggestionsServiceStubSettings.newBuilder().build(), clientContext);
  }

  public static final GrpcTextSuggestionsServiceStub create(
      ClientContext clientContext, GrpcStubCallableFactory callableFactory) throws IOException {
    return new GrpcTextSuggestionsServiceStub(
        TextSuggestionsServiceStubSettings.newBuilder().build(), clientContext, callableFactory);
  }

  /**
   * Constructs an instance of GrpcTextSuggestionsServiceStub, using the given settings. This is
   * protected so that it is easy to make a subclass, but otherwise, the static factory methods
   * should be preferred.
   */
  protected GrpcTextSuggestionsServiceStub(
      TextSuggestionsServiceStubSettings settings, ClientContext clientContext) throws IOException {
    this(settings, clientContext, new GrpcTextSuggestionsServiceCallableFactory());
  }
  ...
  protected GrpcTextSuggestionsServiceStub(
    ...
    GrpcCallSettings<GenerateProductTextSuggestionsRequest, GenerateProductTextSuggestionsResponse>
