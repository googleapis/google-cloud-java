...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-iamcredentials" % "2.41.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-iamcredentials/2.41.0
