...
public final class CreateBuildTriggerRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CreateBuildTriggerRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(internalGetTriggerFieldBuilder().getBuilder(), extensionRegistry);
