          ...
          case 10:
            {
              ...
              workerConfig_ =
                  input.readMessage(
                      com.google.cloudbuild.v1.PrivatePoolV1Config.WorkerConfig.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 18:
            {
              ...
              networkConfig_ =
                  input.readMessage(
                      com.google.cloudbuild.v1.PrivatePoolV1Config.NetworkConfig.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
        ...
        try {
          ...
          parsedMessage =
              (com.google.cloudbuild.v1.PrivatePoolV1Config.NetworkConfig) e.getUnfinishedMessage();
          throw e.unwrapIOException();
        } finally {
          if (parsedMessage != null) {
            mergeFrom(parsedMessage);
