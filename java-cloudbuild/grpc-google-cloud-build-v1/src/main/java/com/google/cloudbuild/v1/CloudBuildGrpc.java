...
public final class CloudBuildGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getReceiveTriggerWebhookMethod = CloudBuildGrpc.getReceiveTriggerWebhookMethod) == null) {
      synchronized (CloudBuildGrpc.class) {
        if ((getReceiveTriggerWebhookMethod = CloudBuildGrpc.getReceiveTriggerWebhookMethod)
            == null) {
          CloudBuildGrpc.getReceiveTriggerWebhookMethod =
              getReceiveTriggerWebhookMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloudbuild.v1.ReceiveTriggerWebhookRequest,
                          com.google.cloudbuild.v1.ReceiveTriggerWebhookResponse>
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "ReceiveTriggerWebhook"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloudbuild.v1.ReceiveTriggerWebhookRequest
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloudbuild.v1.ReceiveTriggerWebhookResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new CloudBuildMethodDescriptorSupplier("ReceiveTriggerWebhook"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloudbuild.v1.CreateWorkerPoolRequest, com.google.longrunning.Operation>
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloudbuild.v1.DeleteWorkerPoolRequest, com.google.longrunning.Operation>
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloudbuild.v1.UpdateWorkerPoolRequest, com.google.longrunning.Operation>
  ...
  public static CloudBuildBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<CloudBuildBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<CloudBuildBlockingV2Stub>() {
          @java.lang.Override
          public CloudBuildBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new CloudBuildBlockingV2Stub(channel, callOptions);
          }
        };
    return CloudBuildBlockingV2Stub.newStub(factory, channel);
  }
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void cancelBuild(
        com.google.cloudbuild.v1.CancelBuildRequest request,
        io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.Build> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getCancelBuildMethod(), responseObserver);
    }
    ...
    default void createBuildTrigger(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getCreateBuildTriggerMethod(), responseObserver);
    }
    ...
    default void getBuildTrigger(
        ...
        io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.BuildTrigger> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getGetBuildTriggerMethod(), responseObserver);
    }
    ...
    default void listBuildTriggers(
        ...
        io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.ListBuildTriggersResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getListBuildTriggersMethod(), responseObserver);
    }
    ...
    default void deleteBuildTrigger(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getDeleteBuildTriggerMethod(), responseObserver);
    }
    ...
    default void updateBuildTrigger(
        ...
        io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.BuildTrigger> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getUpdateBuildTriggerMethod(), responseObserver);
    }
    ...
    default void runBuildTrigger(
        ...
        io.grpc.stub.StreamObserver<com.google.longrunning.Operation> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getRunBuildTriggerMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void receiveTriggerWebhook(
        com.google.cloudbuild.v1.ReceiveTriggerWebhookRequest request,
        io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.ReceiveTriggerWebhookResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getReceiveTriggerWebhookMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public abstract static class CloudBuildImplBase implements io.grpc.BindableService, AsyncService {
  ...
  public static final class CloudBuildStub extends io.grpc.stub.AbstractAsyncStub<CloudBuildStub> {
    ...
    public void receiveTriggerWebhook(
        ...
        io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.ReceiveTriggerWebhookResponse>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getReceiveTriggerWebhookMethod(), getCallOptions()),
          request,
          responseObserver);
    }
   ...
   * </pre>
   */
  public static final class CloudBuildBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<CloudBuildBlockingV2Stub> {
    private CloudBuildBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected CloudBuildBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new CloudBuildBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service CloudBuild.
   *
   * <pre>
   * Creates and manages builds on Google Cloud Platform.
   * The main concept used by this API is a `Build`, which describes the location
  ...
  public static final class CloudBuildFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloudbuild.v1.ReceiveTriggerWebhookResponse>
        receiveTriggerWebhook(com.google.cloudbuild.v1.ReceiveTriggerWebhookRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_RECEIVE_TRIGGER_WEBHOOK:
          serviceImpl.receiveTriggerWebhook(
              (com.google.cloudbuild.v1.ReceiveTriggerWebhookRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloudbuild.v1.ReceiveTriggerWebhookResponse>)
                  responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloudbuild.v1.ListBuildsRequest,
                    com.google.cloudbuild.v1.ListBuildsResponse>(service, METHODID_LIST_BUILDS)))
        .addMethod(
            getCancelBuildMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloudbuild.v1.CreateBuildTriggerRequest,
                    com.google.cloudbuild.v1.BuildTrigger>(service, METHODID_CREATE_BUILD_TRIGGER)))
        .addMethod(
            getGetBuildTriggerMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloudbuild.v1.GetBuildTriggerRequest,
                    com.google.cloudbuild.v1.BuildTrigger>(service, METHODID_GET_BUILD_TRIGGER)))
        .addMethod(
            getListBuildTriggersMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloudbuild.v1.UpdateBuildTriggerRequest,
                    com.google.cloudbuild.v1.BuildTrigger>(service, METHODID_UPDATE_BUILD_TRIGGER)))
        .addMethod(
            getRunBuildTriggerMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloudbuild.v1.RunBuildTriggerRequest,
                    com.google.longrunning.Operation>(service, METHODID_RUN_BUILD_TRIGGER)))
        .addMethod(
            getReceiveTriggerWebhookMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloudbuild.v1.GetWorkerPoolRequest,
                    com.google.cloudbuild.v1.WorkerPool>(service, METHODID_GET_WORKER_POOL)))
        .addMethod(
            getDeleteWorkerPoolMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
