...
public class AsyncGetBuildTrigger {

  public static void main(String[] args) throws Exception {
    asyncGetBuildTrigger();
  }

  public static void asyncGetBuildTrigger() throws Exception {
    ...
    try (CloudBuildClient cloudBuildClient = CloudBuildClient.create()) {
      GetBuildTriggerRequest request =
          GetBuildTriggerRequest.newBuilder()
              .setName(
                  BuildTriggerName.ofProjectLocationTriggerName(
