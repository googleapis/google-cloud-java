...
public class RepositoryName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_CONNECTION_REPOSITORY =
  ...
  public static RepositoryName of(
      String project, String location, String connection, String repository) {
    return newBuilder()
        .setProject(project)
  ...
  public static RepositoryName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_CONNECTION_REPOSITORY.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_CONNECTION_REPOSITORY.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_CONNECTION_REPOSITORY.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public static class Builder {
    ...
    private Builder(RepositoryName repositoryName) {
      ...
      this.connection = repositoryName.connection;
