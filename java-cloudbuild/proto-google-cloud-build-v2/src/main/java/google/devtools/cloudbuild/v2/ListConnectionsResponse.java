...
public final class ListConnectionsResponse extends com.google.protobuf.GeneratedMessageV3
  ...
  protected com.google.protobuf.GeneratedMessageV3.FieldAccessorTable
    ...
    return google.devtools.cloudbuild.v2.RepositoryManagerProto
        ...
        .ensureFieldAccessorsInitialized(
            google.devtools.cloudbuild.v2.ListConnectionsResponse.class,
            google.devtools.cloudbuild.v2.ListConnectionsResponse.Builder.class);
  }

  public static final int CONNECTIONS_FIELD_NUMBER = 1;

  @SuppressWarnings("serial")
  private java.util.List<google.devtools.cloudbuild.v2.Connection> connections_;
  /**
   *
   *
   * <pre>
   ...
   */
  @java.lang.Override
  public java.util.List<google.devtools.cloudbuild.v2.Connection> getConnectionsList() {
    return connections_;
  }
  /**
   *
   ...
   */
  @java.lang.Override
  public java.util.List<? extends google.devtools.cloudbuild.v2.ConnectionOrBuilder>
   ...
   */
  @java.lang.Override
  public google.devtools.cloudbuild.v2.Connection getConnections(int index) {
   ...
   */
  @java.lang.Override
  public google.devtools.cloudbuild.v2.ConnectionOrBuilder getConnectionsOrBuilder(int index) {
    return connections_.get(index);
  }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!(obj instanceof google.devtools.cloudbuild.v2.ListConnectionsResponse)) {
      return super.equals(obj);
    }
    google.devtools.cloudbuild.v2.ListConnectionsResponse other =
        (google.devtools.cloudbuild.v2.ListConnectionsResponse) obj;
  ...
  public static google.devtools.cloudbuild.v2.ListConnectionsResponse parseFrom(
  ...
  public static google.devtools.cloudbuild.v2.ListConnectionsResponse parseFrom(byte[] data)
      throws com.google.protobuf.InvalidProtocolBufferException {
    return PARSER.parseFrom(data);
  }
  ...
  public static google.devtools.cloudbuild.v2.ListConnectionsResponse parseDelimitedFrom(
      java.io.InputStream input) throws java.io.IOException {
  ...
  public static Builder newBuilder(
      google.devtools.cloudbuild.v2.ListConnectionsResponse prototype) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
      ...
      google.devtools.cloudbuild.v2.ListConnectionsResponseOrBuilder {
    public static final com.google.protobuf.Descriptors.Descriptor getDescriptor() {
      return google.devtools.cloudbuild.v2.RepositoryManagerProto
          .internal_static_google_devtools_cloudbuild_v2_ListConnectionsResponse_descriptor;
    }
    ...
    // Construct using google.devtools.cloudbuild.v2.ListConnectionsResponse.newBuilder()
    private Builder() {}
    ...
    @java.lang.Override
    public google.devtools.cloudbuild.v2.ListConnectionsResponse getDefaultInstanceForType() {
      return google.devtools.cloudbuild.v2.ListConnectionsResponse.getDefaultInstance();
    }

    @java.lang.Override
    public google.devtools.cloudbuild.v2.ListConnectionsResponse build() {
      google.devtools.cloudbuild.v2.ListConnectionsResponse result = buildPartial();
    ...
    @java.lang.Override
    public google.devtools.cloudbuild.v2.ListConnectionsResponse buildPartial() {
      google.devtools.cloudbuild.v2.ListConnectionsResponse result =
          new google.devtools.cloudbuild.v2.ListConnectionsResponse(this);
    ...
    private void buildPartial0(google.devtools.cloudbuild.v2.ListConnectionsResponse result) {
    ...
    public Builder mergeFrom(com.google.protobuf.Message other) {
      if (other instanceof google.devtools.cloudbuild.v2.ListConnectionsResponse) {
        return mergeFrom((google.devtools.cloudbuild.v2.ListConnectionsResponse) other);
      } else {
    ...
    public Builder mergeFrom(google.devtools.cloudbuild.v2.ListConnectionsResponse other) {
      if (other == google.devtools.cloudbuild.v2.ListConnectionsResponse.getDefaultInstance())
        return this;
      if (connectionsBuilder_ == null) {
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                google.devtools.cloudbuild.v2.Connection m =
                    input.readMessage(
                        google.devtools.cloudbuild.v2.Connection.parser(), extensionRegistry);
                if (connectionsBuilder_ == null) {
                  ensureConnectionsIsMutable();
                  connections_.add(m);
                } else {
    ...
    private void ensureConnectionsIsMutable() {
      if (!((bitField0_ & 0x00000001) != 0)) {
        connections_ =
            new java.util.ArrayList<google.devtools.cloudbuild.v2.Connection>(connections_);
    ...
    private com.google.protobuf.RepeatedFieldBuilderV3<
            ...
            google.devtools.cloudbuild.v2.Connection.Builder,
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public Builder setConnections(int index, google.devtools.cloudbuild.v2.Connection value) {
      if (connectionsBuilder_ == null) {
        if (value == null) {
    ...
    public Builder setConnections(
        int index, google.devtools.cloudbuild.v2.Connection.Builder builderForValue) {
      if (connectionsBuilder_ == null) {
        ensureConnectionsIsMutable();
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public Builder addConnections(google.devtools.cloudbuild.v2.Connection value) {
      if (connectionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public Builder addConnections(int index, google.devtools.cloudbuild.v2.Connection value) {
      if (connectionsBuilder_ == null) {
        if (value == null) {
          throw new NullPointerException();
        }
    ...
    public Builder addConnections(
        google.devtools.cloudbuild.v2.Connection.Builder builderForValue) {
      if (connectionsBuilder_ == null) {
        ensureConnectionsIsMutable();
    ...
    public Builder addAllConnections(
        java.lang.Iterable<? extends google.devtools.cloudbuild.v2.Connection> values) {
      if (connectionsBuilder_ == null) {
        ensureConnectionsIsMutable();
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public google.devtools.cloudbuild.v2.Connection.Builder getConnectionsBuilder(int index) {
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public google.devtools.cloudbuild.v2.Connection.Builder addConnectionsBuilder() {
      return getConnectionsFieldBuilder()
          .addBuilder(google.devtools.cloudbuild.v2.Connection.getDefaultInstance());
    }
    /**
     *
     *
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public google.devtools.cloudbuild.v2.Connection.Builder addConnectionsBuilder(int index) {
      return getConnectionsFieldBuilder()
          .addBuilder(index, google.devtools.cloudbuild.v2.Connection.getDefaultInstance());
    }
    /**
     *
     *
     ...
     * <code>repeated .google.devtools.cloudbuild.v2.Connection connections = 1;</code>
     */
    public java.util.List<google.devtools.cloudbuild.v2.Connection.Builder>
  ...
  private static final google.devtools.cloudbuild.v2.ListConnectionsResponse DEFAULT_INSTANCE;

  static {
    DEFAULT_INSTANCE = new google.devtools.cloudbuild.v2.ListConnectionsResponse();
  }

  public static google.devtools.cloudbuild.v2.ListConnectionsResponse getDefaultInstance() {
