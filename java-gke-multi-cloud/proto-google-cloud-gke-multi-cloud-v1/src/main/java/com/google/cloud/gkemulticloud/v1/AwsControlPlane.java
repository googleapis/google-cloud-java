...
public final class AwsControlPlane extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 82:
            {
              com.google.cloud.gkemulticloud.v1.AwsDatabaseEncryption.Builder subBuilder = null;
              if (databaseEncryption_ != null) {
                subBuilder = databaseEncryption_.toBuilder();
              }
              databaseEncryption_ =
                  input.readMessage(
                      com.google.cloud.gkemulticloud.v1.AwsDatabaseEncryption.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 98:
            {
              com.google.cloud.gkemulticloud.v1.AwsServicesAuthentication.Builder subBuilder = null;
              if (awsServicesAuthentication_ != null) {
                subBuilder = awsServicesAuthentication_.toBuilder();
              }
              awsServicesAuthentication_ =
                  input.readMessage(
                      com.google.cloud.gkemulticloud.v1.AwsServicesAuthentication.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(awsServicesAuthentication_);
                awsServicesAuthentication_ = subBuilder.buildPartial();
              }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.gkemulticloud.v1.AwsControlPlane parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.gkemulticloud.v1.AwsControlPlane) e.getUnfinishedMessage();
    ...
    public Builder mergeMainVolume(com.google.cloud.gkemulticloud.v1.AwsVolumeTemplate value) {
      if (mainVolumeBuilder_ == null) {
        if (mainVolume_ != null) {
          mainVolume_ =
              com.google.cloud.gkemulticloud.v1.AwsVolumeTemplate.newBuilder(mainVolume_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          mainVolume_ = value;
    ...
    public Builder mergeDatabaseEncryption(
      ...
      if (databaseEncryptionBuilder_ == null) {
        if (databaseEncryption_ != null) {
          databaseEncryption_ =
              com.google.cloud.gkemulticloud.v1.AwsDatabaseEncryption.newBuilder(
                      databaseEncryption_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
    ...
    public Builder mergeAwsServicesAuthentication(
      ...
      if (awsServicesAuthenticationBuilder_ == null) {
        if (awsServicesAuthentication_ != null) {
          awsServicesAuthentication_ =
              com.google.cloud.gkemulticloud.v1.AwsServicesAuthentication.newBuilder(
                      awsServicesAuthentication_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
  ...
  private static final com.google.protobuf.Parser<AwsControlPlane> PARSER =
      new com.google.protobuf.AbstractParser<AwsControlPlane>() {
        ...
        public AwsControlPlane parsePartialFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
          return new AwsControlPlane(input, extensionRegistry);
        }
      };
