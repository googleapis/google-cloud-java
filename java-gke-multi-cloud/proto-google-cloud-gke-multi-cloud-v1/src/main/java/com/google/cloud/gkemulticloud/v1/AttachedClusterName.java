...
public class AttachedClusterName implements ResourceName {
  ...
  public static @Nullable AttachedClusterName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AttachedClusterName> values) {
