...
public class AzureClientName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_AZURE_CLIENT =
  ...
  private AzureClientName(Builder builder) {
    ...
    azureClient = Preconditions.checkNotNull(builder.getAzureClient());
  }
  ...
  public static @Nullable AzureClientName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_AZURE_CLIENT.validatedMatch(
            formattedString, "AzureClientName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("azure_client"));
  }

  public static List<AzureClientName> parseList(List<String> formattedStrings) {
    List<AzureClientName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable AzureClientName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (azureClient != null) {
            fieldMapBuilder.put("azure_client", azureClient);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_AZURE_CLIENT.instantiate(
        "project", project, "location", location, "azure_client", azureClient);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.azureClient, that.azureClient);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(azureClient);
    return h;
  }
