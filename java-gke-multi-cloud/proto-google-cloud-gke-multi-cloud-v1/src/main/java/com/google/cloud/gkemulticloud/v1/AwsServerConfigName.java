...
public class AwsServerConfigName implements ResourceName {
  ...
  public static @Nullable AwsServerConfigName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION.validatedMatch(
            formattedString, "AwsServerConfigName.parse: formattedString not in valid format");
  ...
  public static List<AwsServerConfigName> parseList(List<String> formattedStrings) {
    List<AwsServerConfigName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable AwsServerConfigName> values) {
