...
/**
 * Settings class to configure an instance of {@link LustreStub}.
 *
...
public class LustreStubSettings extends StubSettings<LustreStubSettings> {
  ...
  public LustreStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcLustreStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonLustreStub.create(this);
    }
  ...
  public static String getDefaultEndpoint() {
    return "lustre.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "lustre.mtls.googleapis.com:443";
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken("gapic", GaxProperties.getLibraryVersion(LustreStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return LustreStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected LustreStubSettings(Builder settingsBuilder) throws IOException {
  ...
  protected LibraryMetadata getLibraryMetadata() {
    return LibraryMetadata.newBuilder()
        .setArtifactName("com.google.cloud:google-cloud-lustre")
        .setRepository("googleapis/google-cloud-java")
        .build();
  }

  /** Builder for LustreStubSettings. */
  public static class Builder extends StubSettings.Builder<LustreStubSettings, Builder> {
    ...
    protected Builder(LustreStubSettings settings) {
      super(settings);
    ...
    @Override
    public LustreStubSettings build() throws IOException {
      return new LustreStubSettings(this);
    }
  }
}
