...
function modify_shared_config() {
  java "${scriptDir}/../../.github/scripts/PomTool.java" set-dep-version pom.xml "google-cloud-shared-config" "${SHARED_CONFIG_VERSION}"
}
...
SHARED_CONFIG_VERSION=$(java "${scriptDir}/../../.github/scripts/PomTool.java" get-version "${VERSION_POM}")
