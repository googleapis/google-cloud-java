...
public final class MuxStream extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 42:
            {
              com.google.cloud.video.livestream.v1.SegmentSettings.Builder subBuilder = null;
              if (segmentSettings_ != null) {
                subBuilder = segmentSettings_.toBuilder();
              }
              segmentSettings_ =
                  input.readMessage(
                      com.google.cloud.video.livestream.v1.SegmentSettings.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.video.livestream.v1.MuxStream parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.video.livestream.v1.MuxStream) e.getUnfinishedMessage();
    ...
    public Builder mergeSegmentSettings(
      ...
      if (segmentSettingsBuilder_ == null) {
        if (segmentSettings_ != null) {
          segmentSettings_ =
              com.google.cloud.video.livestream.v1.SegmentSettings.newBuilder(segmentSettings_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          segmentSettings_ = value;
