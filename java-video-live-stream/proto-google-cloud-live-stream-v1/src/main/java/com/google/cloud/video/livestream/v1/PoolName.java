...
public class PoolName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_POOL =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/pools/{pool}");
  ...
  private PoolName(Builder builder) {
    ...
    pool = Preconditions.checkNotNull(builder.getPool());
  }
  ...
  public static PoolName of(String project, String location, String pool) {
    return newBuilder().setProject(project).setLocation(location).setPool(pool).build();
  }
  ...
  public static PoolName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_POOL.validatedMatch(
            formattedString, "PoolName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("pool"));
  }

  public static List<PoolName> parseList(List<String> formattedStrings) {
    List<PoolName> list = new ArrayList<>(formattedStrings.size());
  ...
  public String toString() {
    return PROJECT_LOCATION_POOL.instantiate(
        "project", project, "location", location, "pool", pool);
  }
