...
public class RegionalInventoryName implements ResourceName {
  ...
  public static @Nullable RegionalInventoryName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable RegionalInventoryName> values) {
