...
public interface InventoryLoyaltyProgramOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.inventories.v1.InventoryLoyaltyProgram)
   ...
   * </pre>
   *
   * <code>optional .google.type.Interval member_price_effective_interval = 6;</code>
   *
   * @return Whether the memberPriceEffectiveInterval field is set.
   */
  boolean hasMemberPriceEffectiveInterval();
   ...
   * <code>optional .google.type.Interval member_price_effective_interval = 6;</code>
   *
   * @return The memberPriceEffectiveInterval.
   */
  com.google.type.Interval getMemberPriceEffectiveInterval();
   ...
   * <code>optional .google.type.Interval member_price_effective_interval = 6;</code>
   */
  com.google.type.IntervalOrBuilder getMemberPriceEffectiveIntervalOrBuilder();
