...
public final class LocalInventoryServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.shopping.merchant.inventories.v1.ListLocalInventoriesRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.google.shopping.merchant.inventories.v1.ListLocalInventoriesRequest.class,
      responseType = com.google.shopping.merchant.inventories.v1.ListLocalInventoriesResponse.class,
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.shopping.merchant.inventories.v1.ListLocalInventoriesResponse>
        getListLocalInventoriesMethod;
    if ((getListLocalInventoriesMethod = LocalInventoryServiceGrpc.getListLocalInventoriesMethod)
        == null) {
      synchronized (LocalInventoryServiceGrpc.class) {
        if ((getListLocalInventoriesMethod =
                LocalInventoryServiceGrpc.getListLocalInventoriesMethod)
            == null) {
          LocalInventoryServiceGrpc.getListLocalInventoriesMethod =
              getListLocalInventoriesMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "ListLocalInventories"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.merchant.inventories.v1
                                  .ListLocalInventoriesRequest.getDefaultInstance()))
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.merchant.inventories.v1
                                  .ListLocalInventoriesResponse.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new LocalInventoryServiceMethodDescriptorSupplier("ListLocalInventories"))
                      .build();
        }
      }
    }
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = com.google.shopping.merchant.inventories.v1.InsertLocalInventoryRequest.class,
      responseType = com.google.shopping.merchant.inventories.v1.LocalInventory.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          com.google.shopping.merchant.inventories.v1.InsertLocalInventoryRequest,
          com.google.shopping.merchant.inventories.v1.LocalInventory>
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.shopping.merchant.inventories.v1.LocalInventory>
        getInsertLocalInventoryMethod;
    if ((getInsertLocalInventoryMethod = LocalInventoryServiceGrpc.getInsertLocalInventoryMethod)
        == null) {
      synchronized (LocalInventoryServiceGrpc.class) {
        if ((getInsertLocalInventoryMethod =
                LocalInventoryServiceGrpc.getInsertLocalInventoryMethod)
            == null) {
          LocalInventoryServiceGrpc.getInsertLocalInventoryMethod =
              getInsertLocalInventoryMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "InsertLocalInventory"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.merchant.inventories.v1
                                  .InsertLocalInventoryRequest.getDefaultInstance()))
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.merchant.inventories.v1.LocalInventory
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new LocalInventoryServiceMethodDescriptorSupplier("InsertLocalInventory"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.shopping.merchant.inventories.v1.DeleteLocalInventoryRequest,
          com.google.protobuf.Empty>
      getDeleteLocalInventoryMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "DeleteLocalInventory",
      requestType = com.google.shopping.merchant.inventories.v1.DeleteLocalInventoryRequest.class,
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.protobuf.Empty>
        getDeleteLocalInventoryMethod;
    if ((getDeleteLocalInventoryMethod = LocalInventoryServiceGrpc.getDeleteLocalInventoryMethod)
        == null) {
      synchronized (LocalInventoryServiceGrpc.class) {
        if ((getDeleteLocalInventoryMethod =
                LocalInventoryServiceGrpc.getDeleteLocalInventoryMethod)
            == null) {
          LocalInventoryServiceGrpc.getDeleteLocalInventoryMethod =
              getDeleteLocalInventoryMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "DeleteLocalInventory"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.shopping.merchant.inventories.v1
                                  .DeleteLocalInventoryRequest.getDefaultInstance()))
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.protobuf.Empty.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new LocalInventoryServiceMethodDescriptorSupplier("DeleteLocalInventory"))
                      .build();
        }
      }
    }
  ...
  public static LocalInventoryServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<LocalInventoryServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<LocalInventoryServiceStub>() {
          @java.lang.Override
          public LocalInventoryServiceStub newStub(
   ...
   */
  public static LocalInventoryServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<LocalInventoryServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<LocalInventoryServiceBlockingStub>() {
          @java.lang.Override
          public LocalInventoryServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static LocalInventoryServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<LocalInventoryServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<LocalInventoryServiceFutureStub>() {
          @java.lang.Override
          public LocalInventoryServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void listLocalInventories(
     ...
     * </pre>
     */
    default void insertLocalInventory(
        com.google.shopping.merchant.inventories.v1.InsertLocalInventoryRequest request,
        io.grpc.stub.StreamObserver<com.google.shopping.merchant.inventories.v1.LocalInventory>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getInsertLocalInventoryMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public abstract static class LocalInventoryServiceImplBase
  ...
  public static final class LocalInventoryServiceStub
    ...
    private LocalInventoryServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void listLocalInventories(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListLocalInventoriesMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void insertLocalInventory(
        ...
        io.grpc.stub.StreamObserver<com.google.shopping.merchant.inventories.v1.LocalInventory>
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getInsertLocalInventoryMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void deleteLocalInventory(
        ...
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteLocalInventoryMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_LIST_LOCAL_INVENTORIES:
          serviceImpl.listLocalInventories(
              (com.google.shopping.merchant.inventories.v1.ListLocalInventoriesRequest) request,
              (io.grpc.stub.StreamObserver<
                      com.google.shopping.merchant.inventories.v1.ListLocalInventoriesResponse>)
                  responseObserver);
        ...
        case METHODID_INSERT_LOCAL_INVENTORY:
          serviceImpl.insertLocalInventory(
              (com.google.shopping.merchant.inventories.v1.InsertLocalInventoryRequest) request,
              (io.grpc.stub.StreamObserver<
                      com.google.shopping.merchant.inventories.v1.LocalInventory>)
                  responseObserver);
        ...
        case METHODID_DELETE_LOCAL_INVENTORY:
          serviceImpl.deleteLocalInventory(
              (com.google.shopping.merchant.inventories.v1.DeleteLocalInventoryRequest) request,
              (io.grpc.stub.StreamObserver<com.google.protobuf.Empty>) responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        ...
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.shopping.merchant.inventories.v1.DeleteLocalInventoryRequest,
                    com.google.protobuf.Empty>(service, METHODID_DELETE_LOCAL_INVENTORY)))
        .build();
  }

  private abstract static class LocalInventoryServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.shopping.merchant.inventories.v1.LocalInventoryProto.getDescriptor();
    }
