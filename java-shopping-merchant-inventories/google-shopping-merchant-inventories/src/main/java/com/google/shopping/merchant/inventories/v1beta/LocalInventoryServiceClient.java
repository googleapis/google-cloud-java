 ...
 *      <td><p>Lists the `LocalInventory` resources for the given product in your merchant
 ...
 *
 *  `LocalInventory` resources are listed per product for a given account.</p></td>
 *      <td>
 ...
 *      <td><p>Inserts a `LocalInventory` resource to a product in your merchant
 *  account.
 *
 ...
 *      <td><p>Deletes the specified `LocalInventory` from the given product in your
