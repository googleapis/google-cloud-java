 ...
 *
 * <p>======================= LocalInventoryServiceClient =======================
 *
 * <p>Service Description: Service to manage local inventory for products
 *
 * <p>Sample for LocalInventoryServiceClient:
 *
 * <pre>{@code
 ...
 * }</pre>
 *
 * <p>======================= RegionalInventoryServiceClient =======================
 *
 * <p>Service Description: Service to manage regional inventory for products. There is also separate
 * `regions` resource and API to manage regions definitions.
 *
 * <p>Sample for RegionalInventoryServiceClient:
 *
 * <pre>{@code
 * // This snippet has been automatically generated and should be regarded as a code template only.
 * // It will require modifications to work:
