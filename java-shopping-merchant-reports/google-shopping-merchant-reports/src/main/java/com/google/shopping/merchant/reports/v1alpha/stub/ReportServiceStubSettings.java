...
public class ReportServiceStubSettings extends StubSettings<ReportServiceStubSettings> {
  ...
  private static final PagedListDescriptor<SearchRequest, SearchResponse, ReportRow>
      SEARCH_PAGE_STR_DESC =
          new PagedListDescriptor<SearchRequest, SearchResponse, ReportRow>() {
            @Override
            ...
            @Override
            public Iterable<ReportRow> extractResources(SearchResponse payload) {
      ...
      SEARCH_PAGE_STR_FACT =
          new PagedListResponseFactory<SearchRequest, SearchResponse, SearchPagedResponse>() {
            ...
            public ApiFuture<SearchPagedResponse> getFuturePagedResponse(
              ...
              PageContext<SearchRequest, SearchResponse, ReportRow> pageContext =
  ...
  public ReportServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcReportServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ReportServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
