...
public interface ProductViewOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.reports.v1alpha.ProductView)
   ...
   * </code>
   */
  java.util.List<com.google.shopping.merchant.reports.v1alpha.ProductView.ItemIssue>
      getItemIssuesList();
