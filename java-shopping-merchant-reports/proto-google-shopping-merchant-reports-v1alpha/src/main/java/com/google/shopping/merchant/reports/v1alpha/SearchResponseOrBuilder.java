...
public interface SearchResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.reports.v1alpha.SearchResponse)
   ...
   */
  java.util.List<com.google.shopping.merchant.reports.v1alpha.ReportRow> getResultsList();
