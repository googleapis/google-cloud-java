...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-reports:0.26.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-reports" % "0.26.0"
```
