...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-reports:0.14.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-reports" % "0.14.0"
```
