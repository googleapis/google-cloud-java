...
import com.google.shopping.merchant.datasources.v1.stub.DataSourcesServiceStub;
 ...
 *      <td><p> Creates the new data source configuration for the given account. This method always creates a new data source.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class DataSourcesServiceClient implements BackgroundResource {
   ...
   *     <p>For example, If you insert `updateMask=displayName` in the request, it will only update
   *     the `displayName` leaving all other fields untouched.
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
