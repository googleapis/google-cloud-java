...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-datasources:0.15.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-datasources" % "0.15.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.shopping/google-shopping-merchant-datasources/0.15.0
