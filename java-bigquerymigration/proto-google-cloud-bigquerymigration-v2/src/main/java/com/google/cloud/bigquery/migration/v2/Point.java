...
public final class Point extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10:
            {
              com.google.cloud.bigquery.migration.v2.TimeInterval.Builder subBuilder = null;
              if (interval_ != null) {
                subBuilder = interval_.toBuilder();
              }
              interval_ =
                  input.readMessage(
                      com.google.cloud.bigquery.migration.v2.TimeInterval.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
          ...
          case 18:
            {
              com.google.cloud.bigquery.migration.v2.TypedValue.Builder subBuilder = null;
              if (value_ != null) {
                subBuilder = value_.toBuilder();
              }
              value_ =
                  input.readMessage(
                      com.google.cloud.bigquery.migration.v2.TypedValue.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.bigquery.migration.v2.Point parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage = (com.google.cloud.bigquery.migration.v2.Point) e.getUnfinishedMessage();
    ...
    public Builder mergeValue(com.google.cloud.bigquery.migration.v2.TypedValue value) {
      if (valueBuilder_ == null) {
        if (value_ != null) {
          value_ =
              com.google.cloud.bigquery.migration.v2.TypedValue.newBuilder(value_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          value_ = value;
