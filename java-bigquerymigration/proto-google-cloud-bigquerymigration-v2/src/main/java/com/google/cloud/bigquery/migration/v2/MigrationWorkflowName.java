...
public class MigrationWorkflowName implements ResourceName {
  ...
  public static @Nullable MigrationWorkflowName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable MigrationWorkflowName> values) {
