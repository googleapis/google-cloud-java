...
public class MigrationSubtaskName implements ResourceName {
  ...
  public static @Nullable MigrationSubtaskName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable MigrationSubtaskName> values) {
