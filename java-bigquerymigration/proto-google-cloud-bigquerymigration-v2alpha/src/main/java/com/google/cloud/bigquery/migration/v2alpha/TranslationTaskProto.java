...
public final class TranslationTaskProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "a/translation_task.proto\022\'google.cloud.bigquery.migration.v2alpha\"A\n"
          + "\026TranslationFileMapping\022\022\n\n"
          + "input_path\030\001 \001(\t\022\023\n"
          + "\013output_path\030\002 \001(\t\"\372\010\n"
          + "\026TranslationTaskDetails\022T\n"
          + "\020teradata_options\030\n"
          + " \001(\01328.google.cloud.bigquery.migration.v2alpha.TeradataOptionsH\000\022L\n"
          + "\014bteq_options\030\013 \001(\01324.google.clo"
          + "ud.bigquery.migration.v2alpha.BteqOptionsH\000\022\022\n\n"
          + "input_path\030\001 \001(\t\022\023\n"
          + "\013output_path\030\002 \001(\t\022S\n\n"
          + "file_paths\030\014 \003(\0132?.google.cloud."
          + "bigquery.migration.v2alpha.TranslationFileMapping\022\023\n"
          + "\013schema_path\030\003 \001(\t\022c\n\r"
          + "file_encoding\030\004 \001(\0162L.google.cloud.bigquery.mi"
          + "gration.v2alpha.TranslationTaskDetails.FileEncoding\022X\n"
          + "\023identifier_settings\030\005 \001(\013"
          + "2;.google.cloud.bigquery.migration.v2alpha.IdentifierSettings\022o\n"
          + "\021special_token_map\030\006 \003(\0132T.google.cloud.bigquery.migrati"
          + "on.v2alpha.TranslationTaskDetails.SpecialTokenMapEntry\022?\n"
          + "\006filter\030\007 \001(\0132/.google.cloud.bigquery.migration.v2alpha.Filter\022#\n"
          + "\033translation_exception_table\030\r"
          + " \001(\t\032\201\001\n"
          + "\024SpecialTokenMapEntry\022\013\n"
          + "\003key\030\001 \001(\t\022X\n"
          + "\005value\030\002 \001(\0162I.google.cloud.bigquery.migrat"
          + "ion.v2alpha.TranslationTaskDetails.TokenType:\0028\001\"~\n"
          + "\014FileEncoding\022\035\n"
          + "\031FILE_ENCODING_UNSPECIFIED\020\000\022\t\n"
          ...
          + "\010UTF_16BE\020\006\"{\n"
          + "\tTokenType\022\032\n"
          + "\026TOKEN_TYPE_UNSPECIFIED\020\000\022\n\n"
          ...
          + "\020language_options\"/\n"
          + "\006Filter\022%\n"
          + "\035input_file_exclusion_prefixes\030\001 \003(\t\"\250\003\n"
          + "\022IdentifierSettings\022j\n"
          + "\026output_identifier_case\030\001 \001(\0162J.google.cloud"
          + ".bigquery.migration.v2alpha.IdentifierSettings.IdentifierCase\022r\n"
          + "\027identifier_rewrite_mode\030\002 \001(\0162Q.google.cloud.bigquery.m"
          + "igration.v2alpha.IdentifierSettings.IdentifierRewriteMode\"U\n"
          + "\016IdentifierCase\022\037\n"
          + "\033IDENTIFIER_CASE_UNSPECIFIED\020\000\022\014\n"
          + "\010ORIGINAL\020\001\022\t\n"
          + "\005UPPER\020\002\022\t\n"
          + "\005LOWER\020\003\"[\n"
          + "\025IdentifierRewriteMode\022\'\n"
          + "#IDENTIFIER_REWRITE_MODE_UNSPECIFIED\020\000\022\010\n"
          + "\004NONE\020\001\022\017\n"
          + "\013REWRITE_ALL\020\002\"\021\n"
          + "\017TeradataOptions\"\242\002\n"
          + "\013BteqOptions\022R\n"
          + "\017project_dataset\030\001"
          + " \001(\01329.google.cloud.bigquery.migration.v2alpha.DatasetReference\022\030\n"
          + "\020default_path_uri\030\002 \001(\t\022j\n"
          + "\024file_replacement_map\030\003 \003(\0132L.google.cloud.bigquery.mig"
          + "ration.v2alpha.BteqOptions.FileReplacementMapEntry\0329\n"
          + "\027FileReplacementMapEntry\022\013\n"
          + "\003key\030\001 \001(\t\022\r\n"
          + "\005value\030\002 \001(\t:\0028\001\":\n"
          + "\020DatasetReference\022\022\n\n"
          + "dataset_id\030\001 \001(\t\022\022\n\n"
          + "project_id\030\002 \001(\tB\344\001\n"
          + "+com.google.cloud.bigquery.migration.v2alphaB\024TranslationTaskProtoP"
