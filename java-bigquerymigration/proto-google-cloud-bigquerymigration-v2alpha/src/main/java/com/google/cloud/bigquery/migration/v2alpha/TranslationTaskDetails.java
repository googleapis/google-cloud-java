...
public final class TranslationTaskDetails extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TranslationTaskDetails(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(schemaPath_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, schemaPath_);
    }
    if (fileEncoding_
        != com.google.cloud.bigquery.migration.v2alpha.TranslationTaskDetails.FileEncoding
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(translationExceptionTable_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 13, translationExceptionTable_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(schemaPath_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, schemaPath_);
    }
    if (fileEncoding_
        != com.google.cloud.bigquery.migration.v2alpha.TranslationTaskDetails.FileEncoding
            .FILE_ENCODING_UNSPECIFIED
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(translationExceptionTable_)) {
      size +=
          com.google.protobuf.GeneratedMessage.computeStringSize(13, translationExceptionTable_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetFilePathsFieldBuilder();
        internalGetIdentifierSettingsFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetIdentifierSettingsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 82:
              {
                input.readMessage(
                    internalGetTeradataOptionsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 90:
              {
                input.readMessage(
                    internalGetBteqOptionsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.bigquery.migration.v2alpha.TeradataOptions.Builder
      ...
      return internalGetTeradataOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.bigquery.migration.v2alpha.TeradataOptions.Builder,
            com.google.cloud.bigquery.migration.v2alpha.TeradataOptionsOrBuilder>
        internalGetTeradataOptionsFieldBuilder() {
      if (teradataOptionsBuilder_ == null) {
        if (!(languageOptionsCase_ == 10)) {
          languageOptions_ =
    ...
    public com.google.cloud.bigquery.migration.v2alpha.BteqOptions.Builder getBteqOptionsBuilder() {
      return internalGetBteqOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.bigquery.migration.v2alpha.BteqOptions.Builder,
            com.google.cloud.bigquery.migration.v2alpha.BteqOptionsOrBuilder>
        internalGetBteqOptionsFieldBuilder() {
      if (bteqOptionsBuilder_ == null) {
        if (!(languageOptionsCase_ == 11)) {
          languageOptions_ =
              com.google.cloud.bigquery.migration.v2alpha.BteqOptions.getDefaultInstance();
    ...
    public com.google.cloud.bigquery.migration.v2alpha.TranslationFileMapping.Builder
      ...
      return internalGetFilePathsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.bigquery.migration.v2alpha.TranslationFileMapping.Builder
        addFilePathsBuilder() {
      return internalGetFilePathsFieldBuilder()
          .addBuilder(
              com.google.cloud.bigquery.migration.v2alpha.TranslationFileMapping
                  .getDefaultInstance());
    }
    ...
    public java.util.List<
      ...
      return internalGetFilePathsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.bigquery.migration.v2alpha.IdentifierSettings.Builder
      ...
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetIdentifierSettingsFieldBuilder().getBuilder();
    }
