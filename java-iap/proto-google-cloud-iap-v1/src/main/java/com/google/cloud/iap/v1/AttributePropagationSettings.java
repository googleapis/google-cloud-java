...
public final class AttributePropagationSettings extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AttributePropagationSettings(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private AttributePropagationSettings() {
    expression_ = "";
    outputCredentials_ = emptyIntList();
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList outputCredentials_ = emptyIntList();
  ...
  public com.google.cloud.iap.v1.AttributePropagationSettings.OutputCredentials
    ...
    return outputCredentials_converter_.convert(outputCredentials_.getInt(index));
  }
  ...
  public int getOutputCredentialsValue(int index) {
    return outputCredentials_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < outputCredentials_.size(); i++) {
      output.writeEnumNoTag(outputCredentials_.getInt(i));
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.cloud.iap.v1.AttributePropagationSettings result) {
      ...
      if (((from_bitField0_ & 0x00000002) != 0)) {
        outputCredentials_.makeImmutable();
            ...
            case 16:
              {
                ...
                ensureOutputCredentialsIsMutable();
                outputCredentials_.addInt(tmpRaw);
                break;
              } // case 16
            case 18:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  outputCredentials_.addInt(input.readEnum());
                }
    ...
    private void ensureOutputCredentialsIsMutable() {
      if (!outputCredentials_.isModifiable()) {
        outputCredentials_ = makeMutableCopy(outputCredentials_);
      }
      bitField0_ |= 0x00000002;
    }
    ...
    public Builder setOutputCredentials(
      ...
      ensureOutputCredentialsIsMutable();
      outputCredentials_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addOutputCredentials(
      ...
      ensureOutputCredentialsIsMutable();
      outputCredentials_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setOutputCredentialsValue(int index, int value) {
      ensureOutputCredentialsIsMutable();
      outputCredentials_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addOutputCredentialsValue(int value) {
      ensureOutputCredentialsIsMutable();
      outputCredentials_.addInt(value);
      onChanged();
      return this;
    }
