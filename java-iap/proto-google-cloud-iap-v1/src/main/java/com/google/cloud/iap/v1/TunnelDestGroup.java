...
public final class TunnelDestGroup extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TunnelDestGroup(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < cidrs_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, cidrs_.getRaw(i));
    }
    for (int i = 0; i < fqdns_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, fqdns_.getRaw(i));
    }
