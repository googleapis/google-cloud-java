...
public class ClientConnectorServiceName implements ResourceName {
  ...
  public static @Nullable ClientConnectorServiceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ClientConnectorServiceName> values) {
