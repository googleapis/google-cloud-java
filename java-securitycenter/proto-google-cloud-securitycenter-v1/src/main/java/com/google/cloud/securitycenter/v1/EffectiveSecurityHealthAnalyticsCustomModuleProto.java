...
public final class EffectiveSecurityHealthAnalyticsCustomModuleProto {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "Vgoogle/cloud/securitycenter/v1/effective_security_health_analytics_custom_modu"
          + "le.proto\022\036google.cloud.securitycenter.v1"
          + "\032\037google/api/field_behavior.proto\032\031googl"
          + "e/api/resource.proto\032Lgoogle/cloud/secur"
          + "itycenter/v1/security_health_analytics_custom_config.proto\"\375\005\n"
          + ",EffectiveSecurityHealthAnalyticsCustomModule\022\021\n"
          + "\004name\030\001 \001(\tB\003\340A\003\022H\n\r"
          + "custom_config\030\002 \001(\0132,.google.c"
          + "loud.securitycenter.v1.CustomConfigB\003\340A\003\022{\n"
          + "\020enablement_state\030\003 \001(\0162\\.google.clou"
          + "d.securitycenter.v1.EffectiveSecurityHea"
          + "lthAnalyticsCustomModule.EnablementStateB\003\340A\003\022\031\n"
          ...
          + "Jsecuritycenter.googleapis.com/EffectiveSecurityHealthAnalyticsCustomModule\022morg"
          + "anizations/{organization}/securityHealthAnalyticsSettings/effectiveCustomModules"
          + "/{effective_custom_module}\022afolders/{folder}/securityHealthAnalyticsSettings/eff"
          + "ectiveCustomModules/{effective_custom_module}\022cprojects/{project}/securityHealth"
          + "AnalyticsSettings/effectiveCustomModules/{effective_custom_module}B\213\002\n"
          + "\"com.google.cloud.securitycenter.v1B1EffectiveSecu"
          + "rityHealthAnalyticsCustomModuleProtoP\001ZJcloud.google.com/go/securitycenter/apiv1"
          + "/securitycenterpb;securitycenterpb\252\002\036Goo"
          + "gle.Cloud.SecurityCenter.V1\312\002\036Google\\Clo"
          + "ud\\SecurityCenter\\V1\352\002!Google::Cloud::SecurityCenter::V1b\006proto3"
    };
    descriptor =
