...
public interface AttackExposureOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.securitycenter.v1.AttackExposure)
   ...
   * @return The state.
   */
  com.google.cloud.securitycenter.v1.AttackExposure.State getState();
