...
public class OrganizationSettingsName implements ResourceName {
  ...
  public static @Nullable OrganizationSettingsName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable OrganizationSettingsName> values) {
