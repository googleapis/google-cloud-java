...
public class EventThreatDetectionCustomModuleName implements ResourceName {
  ...
  public static EventThreatDetectionCustomModuleName ofOrganizationModuleName(
      String organization, String module) {
    return newBuilder().setOrganization(organization).setModule(module).build();
  }

  public static EventThreatDetectionCustomModuleName ofFolderModuleName(
      String folder, String module) {
    return newFolderModuleBuilder().setFolder(folder).setModule(module).build();
  }

  public static EventThreatDetectionCustomModuleName ofProjectModuleName(
  ...
  public static @Nullable EventThreatDetectionCustomModuleName parse(String formattedString) {
  ...
  public static List<String> toStringList(
      List<@Nullable EventThreatDetectionCustomModuleName> values) {
