...
public class EventThreatDetectionSettingsName implements ResourceName {
  ...
  private static final PathTemplate FOLDER =
      PathTemplate.createWithoutUrlEncoding("folders/{folder}/eventThreatDetectionSettings");
  private static final PathTemplate PROJECT =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/eventThreatDetectionSettings");
  ...
  @Deprecated
  protected EventThreatDetectionSettingsName() {
    organization = null;
    folder = null;
    project = null;
  }

  private EventThreatDetectionSettingsName(Builder builder) {
  ...
  private EventThreatDetectionSettingsName(FolderBuilder builder) {
  ...
  private EventThreatDetectionSettingsName(ProjectBuilder builder) {
  ...
  public static EventThreatDetectionSettingsName of(String organization) {
    return newBuilder().setOrganization(organization).build();
  }

  public static EventThreatDetectionSettingsName ofOrganizationName(String organization) {
    return newBuilder().setOrganization(organization).build();
  }

  public static EventThreatDetectionSettingsName ofFolderName(String folder) {
    return newFolderBuilder().setFolder(folder).build();
  }

  public static EventThreatDetectionSettingsName ofProjectName(String project) {
  ...
  public static EventThreatDetectionSettingsName parse(String formattedString) {
    ...
    throw new ValidationException(
        "EventThreatDetectionSettingsName.parse: formattedString not in valid format");
  }

  public static List<EventThreatDetectionSettingsName> parseList(List<String> formattedStrings) {
    List<EventThreatDetectionSettingsName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(java.lang.Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      EventThreatDetectionSettingsName that = ((EventThreatDetectionSettingsName) o);
  ...
  public static class Builder {
    ...
    public EventThreatDetectionSettingsName build() {
      return new EventThreatDetectionSettingsName(this);
    }
  }
