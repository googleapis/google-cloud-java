  ...
  static {
    java.lang.String[] descriptorData = {
      "\n,google/cloud/securitycenter/v2/finding"
          ...
          + "\0326google/cloud/securitycenter/v2/data_ac"
          + "cess_event.proto\0324google/cloud/securityc"
          + "enter/v2/data_flow_event.proto\032Bgoogle/c"
          + "loud/securitycenter/v2/data_retention_de"
          + "letion_event.proto\032-google/cloud/securit"
          + "ycenter/v2/database.proto\032)google/cloud/"
          + "securitycenter/v2/disk.proto\0321google/clo"
          + "ud/securitycenter/v2/exfiltration.proto\032"
          + "4google/cloud/securitycenter/v2/external"
          + "_system.proto\032)google/cloud/securitycent"
          + "er/v2/file.proto\0325google/cloud/securityc"
          + "enter/v2/group_membership.proto\0320google/"
          + "cloud/securitycenter/v2/iam_binding.prot"
          + "o\032.google/cloud/securitycenter/v2/indica"
          + "tor.proto\0323google/cloud/securitycenter/v"
          + "2/kernel_rootkit.proto\032/google/cloud/sec"
          + "uritycenter/v2/kubernetes.proto\0322google/"
          + "cloud/securitycenter/v2/load_balancer.pr"
          + "oto\032.google/cloud/securitycenter/v2/log_"
          + "entry.proto\0321google/cloud/securitycenter"
          + "/v2/mitre_attack.proto\032-google/cloud/sec"
          + "uritycenter/v2/notebook.proto\032/google/cl"
          + "oud/securitycenter/v2/org_policy.proto\032,"
          + "google/cloud/securitycenter/v2/process.p"
          + "roto\0323google/cloud/securitycenter/v2/sec"
          + "urity_marks.proto\0325google/cloud/security"
          + "center/v2/security_posture.proto\0326google"
          + "/cloud/securitycenter/v2/toxic_combinati"
          + "on.proto\0322google/cloud/securitycenter/v2"
          + "/vulnerability.proto\032\034google/protobuf/st"
          + "ruct.proto\032\037google/protobuf/timestamp.pr"
          + "oto\"\332%\n\007Finding\022\014\n\004name\030\001 \001(\t\022\033\n\016canonic"
          + "al_name\030\002 \001(\tB\003\340A\003\022\016\n\006parent\030\003 \001(\t\022\032\n\rre"
          + "source_name\030\004 \001(\tB\003\340A\005\022A\n\005state\030\006 \001(\0162-."
          + "google.cloud.securitycenter.v2.Finding.S"
          + "tateB\003\340A\003\022\025\n\010category\030\007 \001(\tB\003\340A\005\022\024\n\014exte"
          + "rnal_uri\030\010 \001(\t\022X\n\021source_properties\030\t \003("
          + "\0132=.google.cloud.securitycenter.v2.Findi"
          + "ng.SourcePropertiesEntry\022J\n\016security_mar"
          + "ks\030\n \001(\0132-.google.cloud.securitycenter.v"
          + "2.SecurityMarksB\003\340A\003\022.\n\nevent_time\030\013 \001(\013"
          + "2\032.google.protobuf.Timestamp\0224\n\013create_t"
          + "ime\030\014 \001(\0132\032.google.protobuf.TimestampB\003\340"
          + "A\003\022B\n\010severity\030\016 \001(\01620.google.cloud.secu"
          + "ritycenter.v2.Finding.Severity\022:\n\004mute\030\017"
          + " \001(\0162,.google.cloud.securitycenter.v2.Fi"
          + "nding.Mute\022H\n\tmute_info\0305 \001(\01320.google.c"
          + "loud.securitycenter.v2.Finding.MuteInfoB"
          + "\003\340A\003\022K\n\rfinding_class\030\020 \001(\01624.google.clo"
          + "ud.securitycenter.v2.Finding.FindingClas"
          + "s\022<\n\tindicator\030\021 \001(\0132).google.cloud.secu"
          + "ritycenter.v2.Indicator\022D\n\rvulnerability"
          + "\030\022 \001(\0132-.google.cloud.securitycenter.v2."
          + "Vulnerability\0229\n\020mute_update_time\030\023 \001(\0132"
          + "\032.google.protobuf.TimestampB\003\340A\003\022[\n\020exte"
          + "rnal_systems\030\024 \003(\0132<.google.cloud.securi"
          + "tycenter.v2.Finding.ExternalSystemsEntry"
          + "B\003\340A\003\022A\n\014mitre_attack\030\025 \001(\0132+.google.clo"
          + "ud.securitycenter.v2.MitreAttack\0226\n\006acce"
          + "ss\030\026 \001(\0132&.google.cloud.securitycenter.v"
          + "2.Access\022?\n\013connections\030\027 \003(\0132*.google.c"
          + "loud.securitycenter.v2.Connection\022\026\n\016mut"
          + "e_initiator\030\030 \001(\t\022:\n\tprocesses\030\031 \003(\0132\'.g"
          + "oogle.cloud.securitycenter.v2.Process\022L\n"
          + "\010contacts\030\032 \003(\01325.google.cloud.securityc"
          + "enter.v2.Finding.ContactsEntryB\003\340A\003\022?\n\013c"
          + "ompliances\030\033 \003(\0132*.google.cloud.security"
          + "center.v2.Compliance\022 \n\023parent_display_n"
          + "ame\030\035 \001(\tB\003\340A\003\022\023\n\013description\030\036 \001(\t\022B\n\014e"
          + "xfiltration\030\037 \001(\0132,.google.cloud.securit"
          + "ycenter.v2.Exfiltration\022@\n\014iam_bindings\030"
          + "  \003(\0132*.google.cloud.securitycenter.v2.I"
          + "amBinding\022\022\n\nnext_steps\030! \001(\t\022\023\n\013module_"
          + "name\030\" \001(\t\022=\n\ncontainers\030# \003(\0132).google."
          + "cloud.securitycenter.v2.Container\022>\n\nkub"
          + "ernetes\030$ \001(\0132*.google.cloud.securitycen"
          + "ter.v2.Kubernetes\022:\n\010database\030% \001(\0132(.go"
          + "ogle.cloud.securitycenter.v2.Database\022G\n"
          + "\017attack_exposure\030& \001(\0132..google.cloud.se"
          + "curitycenter.v2.AttackExposure\0223\n\005files\030"
          + "\' \003(\0132$.google.cloud.securitycenter.v2.F"
          + "ile\022P\n\024cloud_dlp_inspection\030( \001(\01322.goog"
          + "le.cloud.securitycenter.v2.CloudDlpInspe"
          + "ction\022S\n\026cloud_dlp_data_profile\030) \001(\01323."
          + "google.cloud.securitycenter.v2.CloudDlpD"
          + "ataProfile\022E\n\016kernel_rootkit\030* \001(\0132-.goo"
          + "gle.cloud.securitycenter.v2.KernelRootki"
          + "t\022?\n\014org_policies\030+ \003(\0132).google.cloud.s"
          + "ecuritycenter.v2.OrgPolicy\022@\n\013applicatio"
          + "n\030- \001(\0132+.google.cloud.securitycenter.v2"
          + ".Application\022X\n\030backup_disaster_recovery"
          + "\030/ \001(\01326.google.cloud.securitycenter.v2."
          + "BackupDisasterRecovery\022I\n\020security_postu"
          + "re\0300 \001(\0132/.google.cloud.securitycenter.v"
          + "2.SecurityPosture\022=\n\013log_entries\0301 \003(\0132("
          + ".google.cloud.securitycenter.v2.LogEntry"
          + "\022D\n\016load_balancers\0302 \003(\0132,.google.cloud."
          + "securitycenter.v2.LoadBalancer\022?\n\013cloud_"
          + "armor\0303 \001(\0132*.google.cloud.securitycente"
          + "r.v2.CloudArmor\022:\n\010notebook\0307 \001(\0132(.goog"
          + "le.cloud.securitycenter.v2.Notebook\022K\n\021t"
          + "oxic_combination\0308 \001(\01320.google.cloud.se"
          + "curitycenter.v2.ToxicCombination\022J\n\021grou"
          + "p_memberships\0309 \003(\0132/.google.cloud.secur"
          + "itycenter.v2.GroupMembership\0222\n\004disk\030: \001"
          + "(\0132$.google.cloud.securitycenter.v2.Disk"
          + "\022K\n\022data_access_events\030= \003(\0132/.google.cl"
          + "oud.securitycenter.v2.DataAccessEvent\022G\n"
          + "\020data_flow_events\030> \003(\0132-.google.cloud.s"
          + "ecuritycenter.v2.DataFlowEvent\022b\n\036data_r"
          + "etention_deletion_events\030@ \003(\0132:.google."
          + "cloud.securitycenter.v2.DataRetentionDel"
          + "etionEvent\032\223\003\n\010MuteInfo\022P\n\013static_mute\030\001"
          + " \001(\0132;.google.cloud.securitycenter.v2.Fi"
          + "nding.MuteInfo.StaticMute\022`\n\024dynamic_mut"
          + "e_records\030\002 \003(\0132B.google.cloud.securityc"
          + "enter.v2.Finding.MuteInfo.DynamicMuteRec"
          + "ord\032y\n\nStaticMute\022;\n\005state\030\001 \001(\0162,.googl"
          + "e.cloud.securitycenter.v2.Finding.Mute\022."
          + "\n\napply_time\030\002 \001(\0132\032.google.protobuf.Tim"
          + "estamp\032X\n\021DynamicMuteRecord\022\023\n\013mute_conf"
          + "ig\030\001 \001(\t\022.\n\nmatch_time\030\002 \001(\0132\032.google.pr"
          + "otobuf.Timestamp\032O\n\025SourcePropertiesEntr"
          ...
          + "loud.securitycenter.v2.ExternalSystem:\0028"
          + "\001\032_\n\rContactsEntry\022\013\n\003key\030\001 \001(\t\022=\n\005value"
          + "\030\002 \001(\0132..google.cloud.securitycenter.v2."
          ...
          + "ATION\020\007\022\027\n\023SENSITIVE_DATA_RISK\020\010:\335\003\352A\331\003\n"
          + "%securitycenter.googleapis.com/Finding\022@"
          + "organizations/{organization}/sources/{so"
          + "urce}/findings/{finding}\022Uorganizations/"
          + "{organization}/sources/{source}/location"
          + "s/{location}/findings/{finding}\0224folders"
          + "/{folder}/sources/{source}/findings/{fin"
          + "ding}\022Ifolders/{folder}/sources/{source}"
          + "/locations/{location}/findings/{finding}"
          + "\0226projects/{project}/sources/{source}/fi"
          + "ndings/{finding}\022Kprojects/{project}/sou"
          + "rces/{source}/locations/{location}/findi"
          + "ngs/{finding}*\010findings2\007findingB\346\001\n\"com"
          + ".google.cloud.securitycenter.v2B\014Finding"
