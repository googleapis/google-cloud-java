  ...
  static {
    java.lang.String[] descriptorData = {
      "\n4google/cloud/securitycenter/v2/bigquer"
          ...
          + "obuf.TimestampB\003\340A\003\022\037\n\022most_recent_edito"
          + "r\030\007 \001(\tB\003\340A\003\022\026\n\tprincipal\030\010 \001(\tB\003\340A\003:\241\002\352"
          + "A\235\002\n,securitycenter.googleapis.com/BigQu"
          + "eryExport\022Jorganizations/{organization}/"
          + "locations/{location}/bigQueryExports/{ex"
          + "port}\022>folders/{folder}/locations/{locat"
          + "ion}/bigQueryExports/{export}\022@projects/"
          + "{project}/locations/{location}/bigQueryE"
          + "xports/{export}*\017bigQueryExports2\016bigQue"
          + "ryExportB\355\001\n\"com.google.cloud.securityce"
          + "nter.v2B\023BigQueryExportProtoP\001ZJcloud.go"
