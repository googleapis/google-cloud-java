  ...
  static {
    java.lang.String[] descriptorData = {
      "\n4google/cloud/securitycenter/v2/valued_"
          ...
          + "ter.v2\032\031google/api/resource.proto\"\306\005\n\016Va"
          ...
          + "RESOURCE_VALUE_HIGH\020\003:\232\002\352A\226\002\n,securityce"
          + "nter.googleapis.com/ValuedResource\022Worga"
          + "nizations/{organization}/simulations/{si"
          + "mulation}/valuedResources/{valued_resour"
          + "ce}\022lorganizations/{organization}/locati"
          + "ons/{location}/simulations/{simluation}/"
          + "valuedResources/{valued_resource}*\017value"
          + "dResources2\016valuedResource\"+\n\033ResourceVa"
          + "lueConfigMetadata\022\014\n\004name\030\001 \001(\tB\355\001\n\"com."
          + "google.cloud.securitycenter.v2B\023ValuedRe"
          + "sourceProtoP\001ZJcloud.google.com/go/secur"
          + "itycenter/apiv2/securitycenterpb;securit"
          + "ycenterpb\252\002\036Google.Cloud.SecurityCenter."
          + "V2\312\002\036Google\\Cloud\\SecurityCenter\\V2\352\002!Go"
          + "ogle::Cloud::SecurityCenter::V2b\006proto3"
    };
    descriptor =
