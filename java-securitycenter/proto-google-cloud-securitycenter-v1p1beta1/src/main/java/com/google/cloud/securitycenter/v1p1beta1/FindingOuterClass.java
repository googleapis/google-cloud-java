  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "_marks.proto\032\034google/protobuf/struct.proto\032\037google/protobuf/timestamp.proto\"\337\007\n"
          + "\007Finding\022\014\n"
          ...
          + "ogle.cloud.securitycenter.v1p1beta1.Finding.State\022\020\n"
          + "\010category\030\005 \001(\t\022\024\n"
          + "\014external_uri\030\006 \001(\t\022_\n"
          + "\021source_properties\030\007 \003(\0132D.g"
          + "oogle.cloud.securitycenter.v1p1beta1.Finding.SourcePropertiesEntry\022Q\n"
          ...
          + "%securitycenter.googleapis.com/Finding\022@organizations/{organizati"
          + "on}/sources/{source}/findings/{finding}\0224folders/{folder}/sources/{source}/findi"
          + "ngs/{finding}\0226projects/{project}/sources/{source}/findings/{finding}B\373\001\n"
          + ")com.google.cloud.securitycenter.v1p1beta1P\001ZQc"
          + "loud.google.com/go/securitycenter/apiv1p1beta1/securitycenterpb;securitycenterpb"
          + "\252\002%Google.Cloud.SecurityCenter.V1P1Beta1"
          + "\312\002%Google\\Cloud\\SecurityCenter\\V1p1beta1"
          + "\352\002(Google::Cloud::SecurityCenter::V1p1beta1b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_securitycenter_v1p1beta1_Finding_SourcePropertiesEntry_descriptor =
        internal_static_google_cloud_securitycenter_v1p1beta1_Finding_descriptor.getNestedType(0);
    internal_static_google_cloud_securitycenter_v1p1beta1_Finding_SourcePropertiesEntry_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_securitycenter_v1p1beta1_Finding_SourcePropertiesEntry_descriptor,
            new java.lang.String[] {
