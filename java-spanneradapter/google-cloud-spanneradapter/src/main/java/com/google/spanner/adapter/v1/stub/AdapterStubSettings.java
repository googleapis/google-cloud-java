...
/**
 * Settings class to configure an instance of {@link AdapterStub}.
 *
...
public class AdapterStubSettings extends StubSettings<AdapterStubSettings> {
  ...
  private final ServerStreamingCallSettings<AdaptMessageRequest, AdaptMessageResponse>
  ...
  public ServerStreamingCallSettings<AdaptMessageRequest, AdaptMessageResponse>
      adaptMessageSettings() {
    return adaptMessageSettings;
  }

  public AdapterStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcAdapterStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonAdapterStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken("gapic", GaxProperties.getLibraryVersion(AdapterStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return AdapterStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected AdapterStubSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);

    createSessionSettings = settingsBuilder.createSessionSettings().build();
    adaptMessageSettings = settingsBuilder.adaptMessageSettings().build();
  }

  /** Builder for AdapterStubSettings. */
  public static class Builder extends StubSettings.Builder<AdapterStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<CreateSessionRequest, Session> createSessionSettings;
    private final ServerStreamingCallSettings.Builder<AdaptMessageRequest, AdaptMessageResponse>
        adaptMessageSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      adaptMessageSettings = ServerStreamingCallSettings.newBuilder();

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(createSessionSettings);
      initDefaults(this);
    }

    protected Builder(AdapterStubSettings settings) {
      super(settings);

      createSessionSettings = settings.createSessionSettings.toBuilder();
      adaptMessageSettings = settings.adaptMessageSettings.toBuilder();
    ...
    @Override
    public AdapterStubSettings build() throws IOException {
      return new AdapterStubSettings(this);
    }
  }
}
