...
public class OrganizationEventName implements ResourceName {
  private static final PathTemplate ORGANIZATION_LOCATION_EVENT =
  ...
  public static OrganizationEventName of(String organization, String location, String event) {
    return newBuilder().setOrganization(organization).setLocation(location).setEvent(event).build();
  }
  ...
  public static @Nullable OrganizationEventName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        ORGANIZATION_LOCATION_EVENT.validatedMatch(
            formattedString, "OrganizationEventName.parse: formattedString not in valid format");
    return of(matchMap.get("organization"), matchMap.get("location"), matchMap.get("event"));
  }

  public static List<OrganizationEventName> parseList(List<String> formattedStrings) {
    List<OrganizationEventName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable OrganizationEventName> values) {
  ...
  public String toString() {
    return ORGANIZATION_LOCATION_EVENT.instantiate(
        "organization", organization, "location", location, "event", event);
  }
  ...
  /** Builder for organizations/{organization}/locations/{location}/organizationEvents/{event}. */
