...
public class EventName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_EVENT =
  ...
  public static EventName of(String project, String location, String event) {
    return newBuilder().setProject(project).setLocation(location).setEvent(event).build();
  }

  public static String format(String project, String location, String event) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable EventName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_EVENT.validatedMatch(
            formattedString, "EventName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("event"));
  }
  ...
  public static List<String> toStringList(List<@Nullable EventName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_EVENT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_EVENT.instantiate(
        "project", project, "location", location, "event", event);
  }
