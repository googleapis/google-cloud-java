...
public class PolicyTroubleshooterClientTest {
  private static MockPolicyTroubleshooter mockPolicyTroubleshooter;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private PolicyTroubleshooterClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockPolicyTroubleshooter = new MockPolicyTroubleshooter();
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(), Arrays.<MockGrpcService>asList(mockPolicyTroubleshooter));
  ...
  public void troubleshootIamPolicyTest() throws Exception {
    TroubleshootIamPolicyResponse expectedResponse =
        TroubleshootIamPolicyResponse.newBuilder()
            ...
            .build();
    mockPolicyTroubleshooter.addResponse(expectedResponse);
    ...
    List<AbstractMessage> actualRequests = mockPolicyTroubleshooter.getRequests();
  ...
  public void troubleshootIamPolicyExceptionTest() throws Exception {
    ...
    mockPolicyTroubleshooter.addException(exception);
