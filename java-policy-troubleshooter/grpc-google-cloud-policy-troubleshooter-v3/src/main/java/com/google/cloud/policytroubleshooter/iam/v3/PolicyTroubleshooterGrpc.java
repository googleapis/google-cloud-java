...
public final class PolicyTroubleshooterGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.cloud.policytroubleshooter.iam.v3.TroubleshootIamPolicyResponse>
        getTroubleshootIamPolicyMethod;
    if ((getTroubleshootIamPolicyMethod = PolicyTroubleshooterGrpc.getTroubleshootIamPolicyMethod)
        == null) {
      synchronized (PolicyTroubleshooterGrpc.class) {
        if ((getTroubleshootIamPolicyMethod =
                PolicyTroubleshooterGrpc.getTroubleshootIamPolicyMethod)
            == null) {
          PolicyTroubleshooterGrpc.getTroubleshootIamPolicyMethod =
              getTroubleshootIamPolicyMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.policytroubleshooter.iam.v3.TroubleshootIamPolicyRequest,
                          com.google.cloud.policytroubleshooter.iam.v3
                      ...
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.policytroubleshooter.iam.v3
                                  .TroubleshootIamPolicyRequest.getDefaultInstance()))
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.policytroubleshooter.iam.v3
                                  .TroubleshootIamPolicyResponse.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new PolicyTroubleshooterMethodDescriptorSupplier("TroubleshootIamPolicy"))
                      .build();
        }
      }
    }
  ...
  public static PolicyTroubleshooterStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PolicyTroubleshooterStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PolicyTroubleshooterStub>() {
          @java.lang.Override
          public PolicyTroubleshooterStub newStub(
   ...
   */
  public static PolicyTroubleshooterBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PolicyTroubleshooterBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PolicyTroubleshooterBlockingStub>() {
          @java.lang.Override
          public PolicyTroubleshooterBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static PolicyTroubleshooterFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<PolicyTroubleshooterFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<PolicyTroubleshooterFutureStub>() {
          @java.lang.Override
          public PolicyTroubleshooterFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public abstract static class PolicyTroubleshooterImplBase
  ...
  public static final class PolicyTroubleshooterStub
    ...
    private PolicyTroubleshooterStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  private abstract static class PolicyTroubleshooterBaseDescriptorSupplier
