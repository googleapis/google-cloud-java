...
```Groovy
implementation 'com.google.cloud:google-cloud-policy-troubleshooter:1.16.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-policy-troubleshooter" % "1.16.0"
```
