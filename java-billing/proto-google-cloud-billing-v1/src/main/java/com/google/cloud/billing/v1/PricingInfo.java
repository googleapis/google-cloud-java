          ...
          case 26:
            {
              ...
              pricingExpression_ =
                  input.readMessage(
                      com.google.cloud.billing.v1.PricingExpression.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 34:
            {
              ...
              aggregationInfo_ =
                  input.readMessage(
                      com.google.cloud.billing.v1.AggregationInfo.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergePricingExpression(com.google.cloud.billing.v1.PricingExpression value) {
      if (pricingExpressionBuilder_ == null) {
        if (pricingExpression_ != null) {
          pricingExpression_ =
              com.google.cloud.billing.v1.PricingExpression.newBuilder(pricingExpression_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          pricingExpression_ = value;
