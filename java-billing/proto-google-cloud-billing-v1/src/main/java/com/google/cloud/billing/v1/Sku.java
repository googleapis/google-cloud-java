...
public final class Sku extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private Sku(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < serviceRegions_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, serviceRegions_.getRaw(i));
    }
    for (int i = 0; i < pricingInfo_.size(); i++) {
      output.writeMessage(6, pricingInfo_.get(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceProviderName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, serviceProviderName_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(serviceProviderName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, serviceProviderName_);
    }
    if (((bitField0_ & 0x00000002) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetPricingInfoFieldBuilder();
        internalGetGeoTaxonomyFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetCategoryFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 66:
              {
                input.readMessage(
                    internalGetGeoTaxonomyFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.billing.v1.PricingInfo.Builder getPricingInfoBuilder(int index) {
      return internalGetPricingInfoFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.billing.v1.PricingInfo.Builder addPricingInfoBuilder() {
      return internalGetPricingInfoFieldBuilder()
    ...
    public java.util.List<com.google.cloud.billing.v1.PricingInfo.Builder>
      ...
      return internalGetPricingInfoFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.billing.v1.GeoTaxonomy.Builder getGeoTaxonomyBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetGeoTaxonomyFieldBuilder().getBuilder();
    }
