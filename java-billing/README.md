...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-billing" % "2.60.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-billing/2.60.0
