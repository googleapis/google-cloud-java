...
public interface LoginProfileOrBuilder
   ...
   */
  java.util.List<com.google.cloud.oslogin.v1beta.SecurityKey> getSecurityKeysList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.oslogin.v1beta.SecurityKey security_keys = 5;</code>
   */
  com.google.cloud.oslogin.v1beta.SecurityKeyOrBuilder getSecurityKeysOrBuilder(int index);
}
