...
```Groovy
implementation 'com.google.cloud:google-cloud-os-login:2.86.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-os-login/2.86.0
