...
public class OsLoginServiceStubSettings extends StubSettings<OsLoginServiceStubSettings> {
  ...
  private final UnaryCallSettings<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
  ...
  public UnaryCallSettings<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
      signSshPublicKeySettings() {
    return signSshPublicKeySettings;
  }
  ...
  protected OsLoginServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    signSshPublicKeySettings = settingsBuilder.signSshPublicKeySettings().build();
  }
  ...
  public static class Builder extends StubSettings.Builder<OsLoginServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<UpdateSshPublicKeyRequest, OsLoginProto.SshPublicKey>
        updateSshPublicKeySettings;
    private final UnaryCallSettings.Builder<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
        signSshPublicKeySettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      signSshPublicKeySettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(OsLoginServiceStubSettings settings) {
      ...
      signSshPublicKeySettings = settings.signSshPublicKeySettings.toBuilder();
