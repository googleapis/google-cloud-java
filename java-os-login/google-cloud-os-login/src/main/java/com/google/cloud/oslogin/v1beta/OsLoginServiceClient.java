...
import com.google.cloud.oslogin.v1beta.stub.OsLoginServiceStub;
 ...
 *    </tr>
 *    <tr>
 *      <td><p> SignSshPublicKey</td>
 *      <td><p> Signs an SSH public key for a user to authenticate to an instance.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> signSshPublicKey(SignSshPublicKeyRequest request)
 *      </ul>
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> signSshPublicKey(String parent, String sshPublicKey)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> signSshPublicKeyCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *  </table>
...
public class OsLoginServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param parent The parent project and zone for the signing request. This is needed to properly
   *     ensure per-organization ISS processing and potentially to provide for the possibility of
   *     zone-specific certificates used in the signing process.
   ...
   *           .setParent("parent-995424086")
   *           .build();
   *   ApiFuture<SignSshPublicKeyResponse> future =
   ...
   * }</pre>
   */
  public final UnaryCallable<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
      signSshPublicKeyCallable() {
    return stub.signSshPublicKeyCallable();
  }
