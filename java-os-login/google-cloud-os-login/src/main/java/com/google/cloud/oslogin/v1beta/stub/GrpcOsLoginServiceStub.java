...
public class GrpcOsLoginServiceStub extends OsLoginServiceStub {
  private static final MethodDescriptor<CreateSshPublicKeyRequest, OsLoginProto.SshPublicKey>
      createSshPublicKeyMethodDescriptor =
          MethodDescriptor.<CreateSshPublicKeyRequest, OsLoginProto.SshPublicKey>newBuilder()
              ...
              .setFullMethodName("google.cloud.oslogin.v1beta.OsLoginService/CreateSshPublicKey")
  ...
  private static final MethodDescriptor<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
      signSshPublicKeyMethodDescriptor =
          MethodDescriptor.<SignSshPublicKeyRequest, SignSshPublicKeyResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName("google.cloud.oslogin.v1beta.OsLoginService/SignSshPublicKey")
              .setRequestMarshaller(
                  ProtoUtils.marshaller(SignSshPublicKeyRequest.getDefaultInstance()))
              .setResponseMarshaller(
                  ProtoUtils.marshaller(SignSshPublicKeyResponse.getDefaultInstance()))
              .build();
  ...
  private final UnaryCallable<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
  ...
  protected GrpcOsLoginServiceStub(
    ...
    GrpcCallSettings<UpdateSshPublicKeyRequest, OsLoginProto.SshPublicKey>
        updateSshPublicKeyTransportSettings =
            GrpcCallSettings.<UpdateSshPublicKeyRequest, OsLoginProto.SshPublicKey>newBuilder()
                ...
                .build();
    GrpcCallSettings<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
        signSshPublicKeyTransportSettings =
            GrpcCallSettings.<SignSshPublicKeyRequest, SignSshPublicKeyResponse>newBuilder()
                .setMethodDescriptor(signSshPublicKeyMethodDescriptor)
                .setParamsExtractor(
                    request -> {
                      RequestParamsBuilder builder = RequestParamsBuilder.create();
                      builder.add("parent", String.valueOf(request.getParent()));
    ...
    this.updateSshPublicKeyCallable =
        callableFactory.createUnaryCallable(
            ...
            clientContext);
    this.signSshPublicKeyCallable =
        callableFactory.createUnaryCallable(
            signSshPublicKeyTransportSettings, settings.signSshPublicKeySettings(), clientContext);
  ...
  public UnaryCallable<SignSshPublicKeyRequest, SignSshPublicKeyResponse>
      signSshPublicKeyCallable() {
    return signSshPublicKeyCallable;
  }
