...
public class ConversionWorkspaceName implements ResourceName {
  ...
  public static @Nullable ConversionWorkspaceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ConversionWorkspaceName> values) {
