...
public final class MigrationJob extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private MigrationJob(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class DumpFlag extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private DumpFlag(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class DumpFlags extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private DumpFlags(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            ...
            if (dumpFlagsBuilder_.isEmpty()) {
              ...
              dumpFlagsBuilder_ =
                  com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                      ? internalGetDumpFlagsFieldBuilder()
                      : null;
            } else {
      ...
      public com.google.cloud.clouddms.v1.MigrationJob.DumpFlag.Builder getDumpFlagsBuilder(
          int index) {
        return internalGetDumpFlagsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.clouddms.v1.MigrationJob.DumpFlag.Builder addDumpFlagsBuilder() {
        return internalGetDumpFlagsFieldBuilder()
      ...
      public java.util.List<com.google.cloud.clouddms.v1.MigrationJob.DumpFlag.Builder>
        ...
        return internalGetDumpFlagsFieldBuilder().getBuilderList();
      }
   ...
   */
  public static final class PerformanceConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private PerformanceConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dumpPath_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, dumpPath_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(filter_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 20, filter_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cmekKeyName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 21, cmekKeyName_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dumpPath_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(9, dumpPath_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(source_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(filter_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(20, filter_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cmekKeyName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(21, cmekKeyName_);
    }
    if (((bitField0_ & 0x00000200) != 0)) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetSourceDatabaseFieldBuilder();
        internalGetDestinationDatabaseFieldBuilder();
        internalGetEndTimeFieldBuilder();
        internalGetConversionWorkspaceFieldBuilder();
        internalGetPerformanceConfigFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114:
              {
                input.readMessage(
                    internalGetSourceDatabaseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 122:
              {
                input.readMessage(
                    internalGetDestinationDatabaseFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 138:
              {
                input.readMessage(
                    internalGetDumpFlagsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 178:
              {
                input.readMessage(
                    internalGetPerformanceConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 810:
              {
                input.readMessage(
                    internalGetReverseSshConnectivityFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 818:
              {
                input.readMessage(
                    internalGetVpcPeeringConnectivityFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.cloud.clouddms.v1.MigrationJob.DumpFlags.Builder getDumpFlagsBuilder() {
      bitField0_ |= 0x00000200;
      onChanged();
      return internalGetDumpFlagsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.clouddms.v1.ReverseSshConnectivity.Builder
      ...
      return internalGetReverseSshConnectivityFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.clouddms.v1.ReverseSshConnectivity.Builder,
            com.google.cloud.clouddms.v1.ReverseSshConnectivityOrBuilder>
        internalGetReverseSshConnectivityFieldBuilder() {
      if (reverseSshConnectivityBuilder_ == null) {
        if (!(connectivityCase_ == 101)) {
    ...
    public com.google.cloud.clouddms.v1.VpcPeeringConnectivity.Builder
      ...
      return internalGetVpcPeeringConnectivityFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.clouddms.v1.VpcPeeringConnectivity.Builder,
            com.google.cloud.clouddms.v1.VpcPeeringConnectivityOrBuilder>
        internalGetVpcPeeringConnectivityFieldBuilder() {
      if (vpcPeeringConnectivityBuilder_ == null) {
        if (!(connectivityCase_ == 102)) {
    ...
    public com.google.cloud.clouddms.v1.DatabaseType.Builder getSourceDatabaseBuilder() {
      bitField0_ |= 0x00020000;
      onChanged();
      return internalGetSourceDatabaseFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.clouddms.v1.DatabaseType.Builder getDestinationDatabaseBuilder() {
      bitField0_ |= 0x00040000;
      onChanged();
      return internalGetDestinationDatabaseFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.clouddms.v1.MigrationJob.PerformanceConfig.Builder
      ...
      bitField0_ |= 0x00800000;
      onChanged();
      return internalGetPerformanceConfigFieldBuilder().getBuilder();
    }
