...
public final class PostgreSqlConnectionProfile extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private PostgreSqlConnectionProfile(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cloudSqlId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, cloudSqlId_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cloudSqlId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(7, cloudSqlId_);
    }
    if (networkArchitecture_
        != com.google.cloud.clouddms.v1.NetworkArchitecture.NETWORK_ARCHITECTURE_UNSPECIFIED
            .getNumber()) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 802:
              {
                input.readMessage(
                    internalGetStaticIpConnectivityFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 810:
              {
                input.readMessage(
                    internalGetPrivateServiceConnectConnectivityFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    public com.google.cloud.clouddms.v1.StaticIpConnectivity.Builder
      ...
      return internalGetStaticIpConnectivityFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.clouddms.v1.StaticIpConnectivity.Builder,
            com.google.cloud.clouddms.v1.StaticIpConnectivityOrBuilder>
        internalGetStaticIpConnectivityFieldBuilder() {
      if (staticIpConnectivityBuilder_ == null) {
        if (!(connectivityCase_ == 100)) {
    ...
    public com.google.cloud.clouddms.v1.PrivateServiceConnectConnectivity.Builder
      ...
      return internalGetPrivateServiceConnectConnectivityFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.clouddms.v1.PrivateServiceConnectConnectivity.Builder,
            com.google.cloud.clouddms.v1.PrivateServiceConnectConnectivityOrBuilder>
        internalGetPrivateServiceConnectConnectivityFieldBuilder() {
      if (privateServiceConnectConnectivityBuilder_ == null) {
        if (!(connectivityCase_ == 101)) {
          connectivity_ =
