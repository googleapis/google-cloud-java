 ...
 */
public final class CloudSqlConnectionProfile extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        CloudSqlConnectionProfile.class.getName());
  }
  // Use CloudSqlConnectionProfile.newBuilder() to construct.
  private CloudSqlConnectionProfile(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cloudSqlId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, cloudSqlId_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(2, getSettings());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(privateIp_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, privateIp_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(publicIp_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, publicIp_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(additionalPublicIp_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, additionalPublicIp_);
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(cloudSqlId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, cloudSqlId_);
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, getSettings());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(privateIp_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, privateIp_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(publicIp_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, publicIp_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(additionalPublicIp_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, additionalPublicIp_);
    }
