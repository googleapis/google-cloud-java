 ...
 */
public final class MappingRuleFilter extends com.google.protobuf.GeneratedMessage
    implements
  ...
  static {
    com.google.protobuf.RuntimeVersion.validateProtobufGencodeVersion(
        ...
        /* patch= */ 1,
        /* suffix= */ "",
        MappingRuleFilter.class.getName());
  }
  // Use MappingRuleFilter.newBuilder() to construct.
  private MappingRuleFilter(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parentEntity_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, parentEntity_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(entityNamePrefix_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, entityNamePrefix_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(entityNameSuffix_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, entityNameSuffix_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(entityNameContains_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 4, entityNameContains_);
    }
    for (int i = 0; i < entities_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, entities_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(parentEntity_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, parentEntity_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(entityNamePrefix_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, entityNamePrefix_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(entityNameSuffix_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, entityNameSuffix_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(entityNameContains_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(4, entityNameContains_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < entities_.size(); i++) {
