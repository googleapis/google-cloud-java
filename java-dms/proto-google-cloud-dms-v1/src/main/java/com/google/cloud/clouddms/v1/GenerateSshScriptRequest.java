          ...
          case 802:
            {
              ...
              if (vmConfigCase_ == 100) {
                subBuilder =
                    ((com.google.cloud.clouddms.v1.VmCreationConfig) vmConfig_).toBuilder();
              }
              vmConfig_ =
                  input.readMessage(
                      com.google.cloud.clouddms.v1.VmCreationConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
          ...
          case 810:
            {
              ...
              if (vmConfigCase_ == 101) {
                subBuilder =
                    ((com.google.cloud.clouddms.v1.VmSelectionConfig) vmConfig_).toBuilder();
              }
              vmConfig_ =
                  input.readMessage(
                      com.google.cloud.clouddms.v1.VmSelectionConfig.parser(), extensionRegistry);
              if (subBuilder != null) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
      ...
      try {
        ...
        parsedMessage =
            (com.google.cloud.clouddms.v1.GenerateSshScriptRequest) e.getUnfinishedMessage();
