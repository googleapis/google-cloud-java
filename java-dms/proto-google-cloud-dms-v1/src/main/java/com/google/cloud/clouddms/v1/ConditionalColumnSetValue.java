...
public final class ConditionalColumnSetValue extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ConditionalColumnSetValue(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetValueTransformationFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetValueTransformationFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 802:
              {
                input.readMessage(
                    internalGetSourceTextFilterFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 810:
              {
                input.readMessage(
                    internalGetSourceNumericFilterFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.clouddms.v1.SourceTextFilter.Builder getSourceTextFilterBuilder() {
      return internalGetSourceTextFilterFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.clouddms.v1.SourceTextFilter.Builder,
            com.google.cloud.clouddms.v1.SourceTextFilterOrBuilder>
        internalGetSourceTextFilterFieldBuilder() {
      if (sourceTextFilterBuilder_ == null) {
        if (!(sourceFilterCase_ == 100)) {
    ...
    public com.google.cloud.clouddms.v1.SourceNumericFilter.Builder
      ...
      return internalGetSourceNumericFilterFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.clouddms.v1.SourceNumericFilter.Builder,
            com.google.cloud.clouddms.v1.SourceNumericFilterOrBuilder>
        internalGetSourceNumericFilterFieldBuilder() {
      if (sourceNumericFilterBuilder_ == null) {
        if (!(sourceFilterCase_ == 101)) {
    ...
    public com.google.cloud.clouddms.v1.ValueTransformation.Builder
      ...
      bitField0_ |= 0x00000004;
      onChanged();
      return internalGetValueTransformationFieldBuilder().getBuilder();
    }
