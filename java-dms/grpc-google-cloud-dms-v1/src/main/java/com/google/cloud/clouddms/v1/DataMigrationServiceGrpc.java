...
public final class DataMigrationServiceGrpc {
  ...
  public static DataMigrationServiceBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<DataMigrationServiceBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<DataMigrationServiceBlockingV2Stub>() {
          @java.lang.Override
          public DataMigrationServiceBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new DataMigrationServiceBlockingV2Stub(channel, callOptions);
          }
        };
    return DataMigrationServiceBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class DataMigrationServiceBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<DataMigrationServiceBlockingV2Stub> {
    private DataMigrationServiceBlockingV2Stub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected DataMigrationServiceBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new DataMigrationServiceBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service DataMigrationService.
   *
   * <pre>
   * Database Migration service
   * </pre>
