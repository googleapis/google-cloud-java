...
public class FloorSettingName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION =
      PathTemplate.createWithoutUrlEncoding("projects/{project}/locations/{location}/floorSetting");
  private static final PathTemplate FOLDER_LOCATION =
      PathTemplate.createWithoutUrlEncoding("folders/{folder}/locations/{location}/floorSetting");
  ...
  private FloorSettingName(Builder builder) {
  ...
  private FloorSettingName(FolderLocationBuilder builder) {
  ...
  private FloorSettingName(OrganizationLocationBuilder builder) {
  ...
  public static FloorSettingName of(String project, String location) {
    return newBuilder().setProject(project).setLocation(location).build();
  }

  public static FloorSettingName ofProjectLocationName(String project, String location) {
    return newBuilder().setProject(project).setLocation(location).build();
  }

  public static FloorSettingName ofFolderLocationName(String folder, String location) {
    return newFolderLocationBuilder().setFolder(folder).setLocation(location).build();
  }

  public static FloorSettingName ofOrganizationLocationName(String organization, String location) {
  ...
  public static @Nullable FloorSettingName parse(String formattedString) {
    ...
    throw new ValidationException("FloorSettingName.parse: formattedString not in valid format");
  }

  public static List<FloorSettingName> parseList(List<String> formattedStrings) {
    List<FloorSettingName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable FloorSettingName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (FloorSettingName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      FloorSettingName that = ((FloorSettingName) o);
  ...
  /** Builder for projects/{project}/locations/{location}/floorSetting. */
  public static class Builder {
    ...
    public FloorSettingName build() {
      return new FloorSettingName(this);
    }
  }

  /** Builder for folders/{folder}/locations/{location}/floorSetting. */
  ...
  /** Builder for organizations/{organization}/locations/{location}/floorSetting. */
