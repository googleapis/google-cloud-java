...
public final class BatchRecognizeFileResult extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private BatchRecognizeFileResult(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   *     google/cloud/speech/v2/cloud_speech.proto;l=1494
   * @return The uri.
   */
  @java.lang.Override
  @java.lang.Deprecated
   ...
   *     google/cloud/speech/v2/cloud_speech.proto;l=1497
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetCloudStorageResultFieldBuilder().getBuilder(), extensionRegistry);
                resultCase_ = 5;
                break;
              } // case 42
            case 50:
              {
                input.readMessage(
                    internalGetInlineResultFieldBuilder().getBuilder(), extensionRegistry);
                resultCase_ = 6;
                break;
              } // case 50
            default:
    ...
    public com.google.cloud.speech.v2.CloudStorageResult.Builder getCloudStorageResultBuilder() {
      return internalGetCloudStorageResultFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.speech.v2.CloudStorageResult.Builder,
            com.google.cloud.speech.v2.CloudStorageResultOrBuilder>
        internalGetCloudStorageResultFieldBuilder() {
      if (cloudStorageResultBuilder_ == null) {
        if (!(resultCase_ == 5)) {
          result_ = com.google.cloud.speech.v2.CloudStorageResult.getDefaultInstance();
        }
    ...
    public com.google.cloud.speech.v2.InlineResult.Builder getInlineResultBuilder() {
      return internalGetInlineResultFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.speech.v2.InlineResult.Builder,
            com.google.cloud.speech.v2.InlineResultOrBuilder>
        internalGetInlineResultFieldBuilder() {
      if (inlineResultBuilder_ == null) {
        if (!(resultCase_ == 6)) {
          result_ = com.google.cloud.speech.v2.InlineResult.getDefaultInstance();
        }
