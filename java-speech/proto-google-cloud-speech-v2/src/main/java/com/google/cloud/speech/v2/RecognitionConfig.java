...
public final class RecognitionConfig extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < languageCodes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, languageCodes_.getRaw(i));
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetTranslationConfigFieldBuilder();
        internalGetDenoiserConfigFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58:
              {
                input.readMessage(
                    internalGetAutoDecodingConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 66:
              {
                input.readMessage(
                    internalGetExplicitDecodingConfigFieldBuilder().getBuilder(),
                    extensionRegistry);
            ...
            case 122:
              {
                input.readMessage(
                    internalGetTranslationConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 130:
              {
                input.readMessage(
                    internalGetDenoiserConfigFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.speech.v2.AutoDetectDecodingConfig.Builder
      ...
      return internalGetAutoDecodingConfigFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.speech.v2.AutoDetectDecodingConfig.Builder,
            com.google.cloud.speech.v2.AutoDetectDecodingConfigOrBuilder>
        internalGetAutoDecodingConfigFieldBuilder() {
      if (autoDecodingConfigBuilder_ == null) {
        if (!(decodingConfigCase_ == 7)) {
          decodingConfig_ =
              com.google.cloud.speech.v2.AutoDetectDecodingConfig.getDefaultInstance();
    ...
    public com.google.cloud.speech.v2.ExplicitDecodingConfig.Builder
      ...
      return internalGetExplicitDecodingConfigFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.speech.v2.TranslationConfig.Builder getTranslationConfigBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetTranslationConfigFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.speech.v2.DenoiserConfig.Builder getDenoiserConfigBuilder() {
      bitField0_ |= 0x00000100;
      onChanged();
      return internalGetDenoiserConfigFieldBuilder().getBuilder();
    }
