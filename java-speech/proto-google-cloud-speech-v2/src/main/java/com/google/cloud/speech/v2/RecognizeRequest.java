...
public final class RecognizeRequest extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(recognizer_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, recognizer_);
    }
    if (audioSourceCase_ == 5) {
      output.writeBytes(5, (com.google.protobuf.ByteString) audioSource_);
    }
    if (audioSourceCase_ == 6) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, audioSource_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(recognizer_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, recognizer_);
    }
    if (audioSourceCase_ == 5) {
      size +=
    ...
    if (audioSourceCase_ == 6) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, audioSource_);
    }
    if (((bitField0_ & 0x00000002) != 0)) {
