...
public class RecognizerName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RECOGNIZER =
  ...
  private RecognizerName(Builder builder) {
    ...
    recognizer = Preconditions.checkNotNull(builder.getRecognizer());
  }
  ...
  public static RecognizerName of(String project, String location, String recognizer) {
    return newBuilder().setProject(project).setLocation(location).setRecognizer(recognizer).build();
  }
  ...
  public static @Nullable RecognizerName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_RECOGNIZER.validatedMatch(
            formattedString, "RecognizerName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("recognizer"));
  }

  public static List<RecognizerName> parseList(List<String> formattedStrings) {
    List<RecognizerName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable RecognizerName> values) {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (recognizer != null) {
            fieldMapBuilder.put("recognizer", recognizer);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_RECOGNIZER.instantiate(
        "project", project, "location", location, "recognizer", recognizer);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.recognizer, that.recognizer);
    }
    return false;
  }
