...
public interface PhraseSetOrBuilder
   ...
   * <code>repeated .google.cloud.speech.v1p1beta1.PhraseSet.Phrase phrases = 2;</code>
   */
  com.google.cloud.speech.v1p1beta1.PhraseSet.PhraseOrBuilder getPhrasesOrBuilder(int index);
   ...
   *
   * <code>
   * string kms_key_name = 7 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }
   * </code>
   *
   ...
   *
   * <code>
   * string kms_key_version_name = 8 [(.google.api.field_behavior) = OUTPUT_ONLY, (.google.api.resource_reference) = { ... }
   * </code>
   *
   ...
   *
   * <code>
   * .google.cloud.speech.v1p1beta1.PhraseSet.State state = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The state.
   */
  com.google.cloud.speech.v1p1beta1.PhraseSet.State getState();
   ...
   * </pre>
   *
   * <code>.google.protobuf.Timestamp expire_time = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * </pre>
   *
   * <code>map&lt;string, string&gt; annotations = 14 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   */
   ...
   * </pre>
   *
   * <code>string etag = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];</code>
   *
   * @return The etag.
   */
