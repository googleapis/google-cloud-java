...
public final class RecognizeRequest extends com.google.protobuf.GeneratedMessage
    implements
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(internalGetAudioFieldBuilder().getBuilder(), extensionRegistry);
