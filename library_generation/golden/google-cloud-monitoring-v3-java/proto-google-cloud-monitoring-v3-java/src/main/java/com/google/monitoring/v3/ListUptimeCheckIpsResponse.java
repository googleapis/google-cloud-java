...
private static final long serialVersionUID = 0L;
  ...
  public static final class Builder extends
    ...
    private void buildPartialRepeatedFields(com.google.monitoring.v3.ListUptimeCheckIpsResponse result) {
      if (uptimeCheckIpsBuilder_ == null) {
        ...
        while (!done) {
          ...
          switch (tag) {
            case 0:
              ...
              break;
            case 10: {
              com.google.monitoring.v3.UptimeCheckIp m =
                  input.readMessage(
                      com.google.monitoring.v3.UptimeCheckIp.parser(),
                      extensionRegistry);
              if (uptimeCheckIpsBuilder_ == null) {
                ensureUptimeCheckIpsIsMutable();
                uptimeCheckIps_.add(m);
              } else {
                uptimeCheckIpsBuilder_.addMessage(m);
              }
              break;
            } // case 10
            case 18: {
