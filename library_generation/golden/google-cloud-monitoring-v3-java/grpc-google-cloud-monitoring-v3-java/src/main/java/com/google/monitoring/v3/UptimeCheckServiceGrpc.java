...
public final class UptimeCheckServiceGrpc {
      ...
      synchronized (UptimeCheckServiceGrpc.class) {
        if ((getListUptimeCheckConfigsMethod = UptimeCheckServiceGrpc.getListUptimeCheckConfigsMethod) == null) {
          UptimeCheckServiceGrpc.getListUptimeCheckConfigsMethod = getListUptimeCheckConfigsMethod =
              ...
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "ListUptimeCheckConfigs"))
      ...
      synchronized (UptimeCheckServiceGrpc.class) {
        if ((getGetUptimeCheckConfigMethod = UptimeCheckServiceGrpc.getGetUptimeCheckConfigMethod) == null) {
          UptimeCheckServiceGrpc.getGetUptimeCheckConfigMethod = getGetUptimeCheckConfigMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "GetUptimeCheckConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (UptimeCheckServiceGrpc.class) {
        if ((getCreateUptimeCheckConfigMethod = UptimeCheckServiceGrpc.getCreateUptimeCheckConfigMethod) == null) {
          UptimeCheckServiceGrpc.getCreateUptimeCheckConfigMethod = getCreateUptimeCheckConfigMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "CreateUptimeCheckConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (UptimeCheckServiceGrpc.class) {
        if ((getUpdateUptimeCheckConfigMethod = UptimeCheckServiceGrpc.getUpdateUptimeCheckConfigMethod) == null) {
          UptimeCheckServiceGrpc.getUpdateUptimeCheckConfigMethod = getUpdateUptimeCheckConfigMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "UpdateUptimeCheckConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
      ...
      synchronized (UptimeCheckServiceGrpc.class) {
        if ((getDeleteUptimeCheckConfigMethod = UptimeCheckServiceGrpc.getDeleteUptimeCheckConfigMethod) == null) {
          UptimeCheckServiceGrpc.getDeleteUptimeCheckConfigMethod = getDeleteUptimeCheckConfigMethod =
              ...
              .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(generateFullMethodName(SERVICE_NAME, "DeleteUptimeCheckConfig"))
              .setSampledToLocalTracing(true)
              .setRequestMarshaller(io.grpc.protobuf.ProtoUtils.marshaller(
  ...
  public static UptimeCheckServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<UptimeCheckServiceStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<UptimeCheckServiceStub>() {
        @java.lang.Override
        public UptimeCheckServiceStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static UptimeCheckServiceBlockingStub newBlockingStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<UptimeCheckServiceBlockingStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<UptimeCheckServiceBlockingStub>() {
        @java.lang.Override
        public UptimeCheckServiceBlockingStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static UptimeCheckServiceFutureStub newFutureStub(
    ...
    io.grpc.stub.AbstractStub.StubFactory<UptimeCheckServiceFutureStub> factory =
      new io.grpc.stub.AbstractStub.StubFactory<UptimeCheckServiceFutureStub>() {
        @java.lang.Override
        public UptimeCheckServiceFutureStub newStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
     ...
     * </pre>
     */
    default void listUptimeCheckConfigs(com.google.monitoring.v3.ListUptimeCheckConfigsRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.ListUptimeCheckConfigsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListUptimeCheckConfigsMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void getUptimeCheckConfig(com.google.monitoring.v3.GetUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.UptimeCheckConfig> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getGetUptimeCheckConfigMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void createUptimeCheckConfig(com.google.monitoring.v3.CreateUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.UptimeCheckConfig> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getCreateUptimeCheckConfigMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void updateUptimeCheckConfig(com.google.monitoring.v3.UpdateUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.UptimeCheckConfig> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getUpdateUptimeCheckConfigMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void deleteUptimeCheckConfig(com.google.monitoring.v3.DeleteUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getDeleteUptimeCheckConfigMethod(), responseObserver);
    }
     ...
     * </pre>
     */
    default void listUptimeCheckIps(com.google.monitoring.v3.ListUptimeCheckIpsRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.ListUptimeCheckIpsResponse> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(getListUptimeCheckIpsMethod(), responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static abstract class UptimeCheckServiceImplBase
  ...
  public static final class UptimeCheckServiceStub
    ...
    private UptimeCheckServiceStub(
    ...
    public void listUptimeCheckConfigs(com.google.monitoring.v3.ListUptimeCheckConfigsRequest request,
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListUptimeCheckConfigsMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void getUptimeCheckConfig(com.google.monitoring.v3.GetUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.UptimeCheckConfig> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getGetUptimeCheckConfigMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void createUptimeCheckConfig(com.google.monitoring.v3.CreateUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.UptimeCheckConfig> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getCreateUptimeCheckConfigMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void updateUptimeCheckConfig(com.google.monitoring.v3.UpdateUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.UptimeCheckConfig> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getUpdateUptimeCheckConfigMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void deleteUptimeCheckConfig(com.google.monitoring.v3.DeleteUptimeCheckConfigRequest request,
        io.grpc.stub.StreamObserver<com.google.protobuf.Empty> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteUptimeCheckConfigMethod(), getCallOptions()), request, responseObserver);
    }
    ...
    public void listUptimeCheckIps(com.google.monitoring.v3.ListUptimeCheckIpsRequest request,
        io.grpc.stub.StreamObserver<com.google.monitoring.v3.ListUptimeCheckIpsResponse> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getListUptimeCheckIpsMethod(), getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class UptimeCheckServiceFutureStub
    ...
    private UptimeCheckServiceFutureStub(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
          ...
          io.grpc.stub.ServerCalls.asyncUnaryCall(
            new MethodHandlers<
              ...
              com.google.protobuf.Empty>(
                service, METHODID_DELETE_UPTIME_CHECK_CONFIG)))
        .addMethod(
