...
public interface AutomatedBackupConfigOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.memorystore.v1.AutomatedBackupConfig)
   ...
   *
   * <code>
   * .google.cloud.memorystore.v1.AutomatedBackupConfig.FixedFrequencySchedule fixed_frequency_schedule = 2 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   */
  com.google.cloud.memorystore.v1.AutomatedBackupConfig.FixedFrequencySchedule
   ...
   * </code>
   */
  com.google.cloud.memorystore.v1.AutomatedBackupConfig.FixedFrequencyScheduleOrBuilder
   ...
   *
   * <code>
   * .google.cloud.memorystore.v1.AutomatedBackupConfig.AutomatedBackupMode automated_backup_mode = 1 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   */
  com.google.cloud.memorystore.v1.AutomatedBackupConfig.AutomatedBackupMode
   ...
   * </pre>
   *
   * <code>.google.protobuf.Duration retention = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   *
  ...
  com.google.cloud.memorystore.v1.AutomatedBackupConfig.ScheduleCase getScheduleCase();
}
