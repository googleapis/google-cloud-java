...
public class BackupCollectionName implements ResourceName {
  ...
  public static @Nullable BackupCollectionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BackupCollectionName> values) {
