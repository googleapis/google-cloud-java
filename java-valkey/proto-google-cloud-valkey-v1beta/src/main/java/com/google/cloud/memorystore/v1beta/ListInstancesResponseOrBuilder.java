...
public interface ListInstancesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.memorystore.v1beta.ListInstancesResponse)
   ...
   * <code>repeated .google.cloud.memorystore.v1beta.Instance instances = 1;</code>
   */
  com.google.cloud.memorystore.v1beta.InstanceOrBuilder getInstancesOrBuilder(int index);
