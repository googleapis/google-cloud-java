...
public interface EncryptionInfoOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.memorystore.v1beta.EncryptionInfo)
   ...
   *
   * <code>
   * .google.cloud.memorystore.v1beta.EncryptionInfo.Type encryption_type = 1 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.memorystore.v1beta.EncryptionInfo.Type getEncryptionType();
   ...
   *
   * <code>
   * .google.cloud.memorystore.v1beta.EncryptionInfo.KmsKeyState kms_key_primary_state = 3 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.memorystore.v1beta.EncryptionInfo.KmsKeyState getKmsKeyPrimaryState();
