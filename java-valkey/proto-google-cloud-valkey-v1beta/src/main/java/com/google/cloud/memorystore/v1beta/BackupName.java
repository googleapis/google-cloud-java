...
public class BackupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_BACKUP_COLLECTION_BACKUP =
  ...
  public static BackupName of(
      String project, String location, String backupCollection, String backup) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable BackupName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_BACKUP_COLLECTION_BACKUP.validatedMatch(
            formattedString, "BackupName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("backup_collection"),
        matchMap.get("backup"));
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_BACKUP_COLLECTION_BACKUP.instantiate(
        "project",
        project,
        "location",
        location,
