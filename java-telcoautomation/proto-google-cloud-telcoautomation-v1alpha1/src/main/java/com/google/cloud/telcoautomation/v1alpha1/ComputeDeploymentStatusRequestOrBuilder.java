...
public interface ComputeDeploymentStatusRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1alpha1.ComputeDeploymentStatusRequest)
