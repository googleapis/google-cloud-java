...
public interface ListEdgeSlmsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.telcoautomation.v1alpha1.EdgeSlm> getEdgeSlmsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.telcoautomation.v1alpha1.EdgeSlm edge_slms = 1;</code>
   */
  com.google.cloud.telcoautomation.v1alpha1.EdgeSlmOrBuilder getEdgeSlmsOrBuilder(int index);
