...
public interface ListDeploymentsResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.telcoautomation.v1alpha1.Deployment> getDeploymentsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.telcoautomation.v1alpha1.Deployment deployments = 1;</code>
   */
  com.google.cloud.telcoautomation.v1alpha1.DeploymentOrBuilder getDeploymentsOrBuilder(int index);
