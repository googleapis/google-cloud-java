...
public class HydratedDeploymentName implements ResourceName {
  ...
  public static @Nullable HydratedDeploymentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable HydratedDeploymentName> values) {
