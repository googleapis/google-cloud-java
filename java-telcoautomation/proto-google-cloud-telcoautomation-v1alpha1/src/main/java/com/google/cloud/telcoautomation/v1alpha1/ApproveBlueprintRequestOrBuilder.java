...
public interface ApproveBlueprintRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1alpha1.ApproveBlueprintRequest)
