...
public class PublicBlueprintName implements ResourceName {
  ...
  public static @Nullable PublicBlueprintName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable PublicBlueprintName> values) {
