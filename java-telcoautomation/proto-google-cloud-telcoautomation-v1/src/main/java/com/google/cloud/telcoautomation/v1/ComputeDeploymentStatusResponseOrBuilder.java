...
public interface ComputeDeploymentStatusResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.telcoautomation.v1.ComputeDeploymentStatusResponse)
   ...
   */
  com.google.cloud.telcoautomation.v1.Status getAggregatedStatus();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.telcoautomation.v1.ResourceStatus> getResourceStatusesList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.telcoautomation.v1.ResourceStatus getResourceStatuses(int index);
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.telcoautomation.v1.ResourceStatusOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.telcoautomation.v1.ResourceStatusOrBuilder getResourceStatusesOrBuilder(
      int index);
}
