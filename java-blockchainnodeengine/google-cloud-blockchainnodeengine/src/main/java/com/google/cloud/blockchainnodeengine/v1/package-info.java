...
/**
 * A client to Blockchain Node Engine API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= BlockchainNodeEngineClient =======================
 *
 * <p>Service Description: This service is the control plane API for Blockchain Node Engine, and can
 * be used to create, read, and delete blockchain nodes.
 *
 * <p>Sample for BlockchainNodeEngineClient:
 *
 * <pre>{@code
