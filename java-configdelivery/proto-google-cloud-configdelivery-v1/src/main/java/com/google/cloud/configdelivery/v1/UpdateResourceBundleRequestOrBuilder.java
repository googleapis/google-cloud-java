...
public interface UpdateResourceBundleRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.configdelivery.v1.UpdateResourceBundleRequest)
   ...
   *
   * <code>
   * .google.cloud.configdelivery.v1.ResourceBundle resource_bundle = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
