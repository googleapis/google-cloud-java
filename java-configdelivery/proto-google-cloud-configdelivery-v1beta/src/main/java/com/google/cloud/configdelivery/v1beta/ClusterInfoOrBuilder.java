...
public interface ClusterInfoOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.configdelivery.v1beta.ClusterInfo)
   ...
   * @return The desired.
   */
  com.google.cloud.configdelivery.v1beta.ResourceBundleDeploymentInfo getDesired();
   ...
   * @return The initial.
   */
  com.google.cloud.configdelivery.v1beta.ResourceBundleDeploymentInfo getInitial();
   ...
   * @return The current.
   */
  com.google.cloud.configdelivery.v1beta.ResourceBundleDeploymentInfo getCurrent();
