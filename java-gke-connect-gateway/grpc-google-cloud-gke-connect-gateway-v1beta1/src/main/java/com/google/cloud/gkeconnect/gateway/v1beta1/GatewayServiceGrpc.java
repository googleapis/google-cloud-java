...
public final class GatewayServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<com.google.api.HttpBody, com.google.api.HttpBody>
  ...
  public static io.grpc.MethodDescriptor<com.google.api.HttpBody, com.google.api.HttpBody>
      getGetResourceMethod() {
    ...
    if ((getGetResourceMethod = GatewayServiceGrpc.getGetResourceMethod) == null) {
      synchronized (GatewayServiceGrpc.class) {
        if ((getGetResourceMethod = GatewayServiceGrpc.getGetResourceMethod) == null) {
          GatewayServiceGrpc.getGetResourceMethod =
              getGetResourceMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.api.HttpBody, com.google.api.HttpBody>newBuilder()
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.api.HttpBody.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new GatewayServiceMethodDescriptorSupplier("GetResource"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<com.google.api.HttpBody, com.google.api.HttpBody>
    ...
    if ((getPostResourceMethod = GatewayServiceGrpc.getPostResourceMethod) == null) {
      synchronized (GatewayServiceGrpc.class) {
        if ((getPostResourceMethod = GatewayServiceGrpc.getPostResourceMethod) == null) {
          GatewayServiceGrpc.getPostResourceMethod =
              getPostResourceMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.api.HttpBody, com.google.api.HttpBody>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.api.HttpBody.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new GatewayServiceMethodDescriptorSupplier("PostResource"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<com.google.api.HttpBody, com.google.api.HttpBody>
    ...
    if ((getDeleteResourceMethod = GatewayServiceGrpc.getDeleteResourceMethod) == null) {
      synchronized (GatewayServiceGrpc.class) {
        if ((getDeleteResourceMethod = GatewayServiceGrpc.getDeleteResourceMethod) == null) {
          GatewayServiceGrpc.getDeleteResourceMethod =
              getDeleteResourceMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.api.HttpBody, com.google.api.HttpBody>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.api.HttpBody.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new GatewayServiceMethodDescriptorSupplier("DeleteResource"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<com.google.api.HttpBody, com.google.api.HttpBody>
    ...
    if ((getPutResourceMethod = GatewayServiceGrpc.getPutResourceMethod) == null) {
      synchronized (GatewayServiceGrpc.class) {
        if ((getPutResourceMethod = GatewayServiceGrpc.getPutResourceMethod) == null) {
          GatewayServiceGrpc.getPutResourceMethod =
              getPutResourceMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.api.HttpBody, com.google.api.HttpBody>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.api.HttpBody.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new GatewayServiceMethodDescriptorSupplier("PutResource"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<com.google.api.HttpBody, com.google.api.HttpBody>
    ...
    if ((getPatchResourceMethod = GatewayServiceGrpc.getPatchResourceMethod) == null) {
      synchronized (GatewayServiceGrpc.class) {
        if ((getPatchResourceMethod = GatewayServiceGrpc.getPatchResourceMethod) == null) {
          GatewayServiceGrpc.getPatchResourceMethod =
              getPatchResourceMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.api.HttpBody, com.google.api.HttpBody>newBuilder()
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.api.HttpBody.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new GatewayServiceMethodDescriptorSupplier("PatchResource"))
                      .build();
        }
      }
    }
  ...
  public abstract static class GatewayServiceImplBase implements io.grpc.BindableService {
    ...
    public void postResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getPostResourceMethod(), responseObserver);
    }
    ...
    public void deleteResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getDeleteResourceMethod(), responseObserver);
    }
    ...
    public void putResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getPutResourceMethod(), responseObserver);
    }
  ...
  public static final class GatewayServiceStub
    ...
    public void postResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPostResourceMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void deleteResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getDeleteResourceMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void putResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPutResourceMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void patchResource(
        ...
        io.grpc.stub.StreamObserver<com.google.api.HttpBody> responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getPatchResourceMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_POST_RESOURCE:
          serviceImpl.postResource(
              (com.google.api.HttpBody) request,
              (io.grpc.stub.StreamObserver<com.google.api.HttpBody>) responseObserver);
          break;
        case METHODID_DELETE_RESOURCE:
          serviceImpl.deleteResource(
              (com.google.api.HttpBody) request,
              (io.grpc.stub.StreamObserver<com.google.api.HttpBody>) responseObserver);
          break;
        case METHODID_PUT_RESOURCE:
          serviceImpl.putResource(
              (com.google.api.HttpBody) request,
              (io.grpc.stub.StreamObserver<com.google.api.HttpBody>) responseObserver);
          break;
        case METHODID_PATCH_RESOURCE:
          serviceImpl.patchResource(
              (com.google.api.HttpBody) request,
              (io.grpc.stub.StreamObserver<com.google.api.HttpBody>) responseObserver);
          break;
        default:
