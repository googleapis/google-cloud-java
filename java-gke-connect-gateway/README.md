...
```Groovy
implementation 'com.google.cloud:google-cloud-gke-connect-gateway:0.45.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-gke-connect-gateway" % "0.45.0"
```
...
Connect Gateway API uses both gRPC and HTTP/JSON for the transport layer.
