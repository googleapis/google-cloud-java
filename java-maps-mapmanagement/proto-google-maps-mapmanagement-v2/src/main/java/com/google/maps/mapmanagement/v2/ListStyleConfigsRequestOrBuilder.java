...
public interface ListStyleConfigsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.maps.mapmanagement.v2.ListStyleConfigsRequest)
   ...
   *
   * <code>
   * .google.maps.mapmanagement.v2.StyleConfigView view = 5 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The view.
   */
  com.google.maps.mapmanagement.v2.StyleConfigView getView();
}
