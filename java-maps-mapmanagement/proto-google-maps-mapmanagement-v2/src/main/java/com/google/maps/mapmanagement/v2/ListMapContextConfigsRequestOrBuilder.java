...
public interface ListMapContextConfigsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.maps.mapmanagement.v2.ListMapContextConfigsRequest)
