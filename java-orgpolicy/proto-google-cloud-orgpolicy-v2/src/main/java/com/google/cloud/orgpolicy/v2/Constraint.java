...
public final class Constraint extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class ListConstraint extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private ListConstraint(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
   ...
   */
  public static final class CustomConstraintDefinition extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private CustomConstraintDefinition(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Parameter extends com.google.protobuf.GeneratedMessage
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        ...
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(validValuesExpr_)) {
          com.google.protobuf.GeneratedMessage.writeString(output, 3, validValuesExpr_);
        }
      ...
      public int getSerializedSize() {
        ...
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(validValuesExpr_)) {
          size += com.google.protobuf.GeneratedMessage.computeStringSize(3, validValuesExpr_);
        }
        if (((bitField0_ & 0x00000002) != 0)) {
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < resourceTypes_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, resourceTypes_.getRaw(i));
      }
   ...
   */
  public static final class BooleanConstraint extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private BooleanConstraint(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetCustomConstraintDefinitionFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 10:
                {
                  input.readMessage(
                      internalGetCustomConstraintDefinitionFieldBuilder().getBuilder(),
                      extensionRegistry);
                  bitField0_ |= 0x00000001;
                  break;
                } // case 10
      ...
      public com.google.cloud.orgpolicy.v2.Constraint.CustomConstraintDefinition.Builder
        ...
        bitField0_ |= 0x00000001;
        onChanged();
        return internalGetCustomConstraintDefinitionFieldBuilder().getBuilder();
      }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(equivalentConstraint_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, equivalentConstraint_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(equivalentConstraint_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, equivalentConstraint_);
    }
    if (supportsSimulation_ != false) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetListConstraintFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 50:
              {
                input.readMessage(
                    internalGetBooleanConstraintFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.orgpolicy.v2.Constraint.ListConstraint.Builder
      ...
      return internalGetListConstraintFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.orgpolicy.v2.Constraint.ListConstraint.Builder,
            com.google.cloud.orgpolicy.v2.Constraint.ListConstraintOrBuilder>
        internalGetListConstraintFieldBuilder() {
      if (listConstraintBuilder_ == null) {
        if (!(constraintTypeCase_ == 5)) {
          constraintType_ =
              com.google.cloud.orgpolicy.v2.Constraint.ListConstraint.getDefaultInstance();
    ...
    public com.google.cloud.orgpolicy.v2.Constraint.BooleanConstraint.Builder
      ...
      return internalGetBooleanConstraintFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.orgpolicy.v2.Constraint.BooleanConstraint.Builder,
            com.google.cloud.orgpolicy.v2.Constraint.BooleanConstraintOrBuilder>
        internalGetBooleanConstraintFieldBuilder() {
      if (booleanConstraintBuilder_ == null) {
        if (!(constraintTypeCase_ == 6)) {
          constraintType_ =
              com.google.cloud.orgpolicy.v2.Constraint.BooleanConstraint.getDefaultInstance();
