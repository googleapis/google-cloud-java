...
public final class Policy extends com.google.protobuf.GeneratedMessageV3
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public com.google.cloud.orgpolicy.v2.Policy buildPartial() {
      ...
      if (dryRunSpecBuilder_ == null) {
        result.dryRunSpec_ = dryRunSpec_;
      } else {
        result.dryRunSpec_ = dryRunSpecBuilder_.build();
      }
      onBuilt();
      return result;
    }
     ...
     */
    public boolean hasDryRunSpec() {
      return dryRunSpecBuilder_ != null || dryRunSpec_ != null;
    }
    /**
     *
     *
    ...
    public Builder mergeDryRunSpec(com.google.cloud.orgpolicy.v2.PolicySpec value) {
      if (dryRunSpecBuilder_ == null) {
        if (dryRunSpec_ != null) {
          dryRunSpec_ =
              com.google.cloud.orgpolicy.v2.PolicySpec.newBuilder(dryRunSpec_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          dryRunSpec_ = value;
