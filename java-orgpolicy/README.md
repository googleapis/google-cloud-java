...
```Groovy
compile 'com.google.api.grpc:proto-google-cloud-orgpolicy-v1:2.0.7'
```
If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.api.grpc" % "proto-google-cloud-orgpolicy-v1" % "2.0.7"
```
...
[contributing]: https://github.com/googleapis/java-orgpolicy/blob/main/CONTRIBUTING.md
[code-of-conduct]: https://github.com/googleapis/java-orgpolicy/blob/main/CODE_OF_CONDUCT.md#contributor-code-of-conduct
[license]: https://github.com/googleapis/java-orgpolicy/blob/main/LICENSE
