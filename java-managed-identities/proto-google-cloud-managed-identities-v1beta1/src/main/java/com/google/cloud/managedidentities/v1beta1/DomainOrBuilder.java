...
public interface DomainOrBuilder
   ...
   *
   * <code>
   * .google.cloud.managedidentities.v1beta1.Domain.State state = 13 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   *
   * <code>
   * repeated .google.cloud.managedidentities.v1beta1.Trust trusts = 15 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   */
  java.util.List<com.google.cloud.managedidentities.v1beta1.Trust> getTrustsList();
  /**
   *
   *
   * <pre>
   ...
   * </code>
   */
  com.google.cloud.managedidentities.v1beta1.TrustOrBuilder getTrustsOrBuilder(int index);
}
