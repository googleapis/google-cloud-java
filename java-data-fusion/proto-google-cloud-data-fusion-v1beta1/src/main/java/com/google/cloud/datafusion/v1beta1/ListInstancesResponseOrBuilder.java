...
public interface ListInstancesResponseOrBuilder
   ...
   */
  java.util.List<com.google.cloud.datafusion.v1beta1.Instance> getInstancesList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.datafusion.v1beta1.Instance instances = 1;</code>
   */
  com.google.cloud.datafusion.v1beta1.InstanceOrBuilder getInstancesOrBuilder(int index);
