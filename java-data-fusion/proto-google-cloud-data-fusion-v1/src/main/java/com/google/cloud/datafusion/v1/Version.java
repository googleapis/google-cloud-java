...
public final class Version extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(versionNumber_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, versionNumber_);
    }
    if (defaultVersion_ != false) {
      output.writeBool(2, defaultVersion_);
    }
    for (int i = 0; i < availableFeatures_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, availableFeatures_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(versionNumber_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, versionNumber_);
    }
    if (defaultVersion_ != false) {
