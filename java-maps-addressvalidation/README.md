...
```Groovy
implementation 'com.google.maps:google-maps-addressvalidation:0.0.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.maps" % "google-maps-addressvalidation" % "0.0.0"
```
...
[maven-version-link]: https://search.maven.org/search?q=g:com.google.maps%20AND%20a:google-maps-addressvalidation&core=gav
