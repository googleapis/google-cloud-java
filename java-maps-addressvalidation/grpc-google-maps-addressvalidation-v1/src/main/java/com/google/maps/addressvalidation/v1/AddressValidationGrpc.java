...
public final class AddressValidationGrpc {
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getValidateAddressMethod = AddressValidationGrpc.getValidateAddressMethod) == null) {
      synchronized (AddressValidationGrpc.class) {
        if ((getValidateAddressMethod = AddressValidationGrpc.getValidateAddressMethod) == null) {
          AddressValidationGrpc.getValidateAddressMethod =
              getValidateAddressMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.maps.addressvalidation.v1.ValidateAddressRequest,
                          com.google.maps.addressvalidation.v1.ValidateAddressResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.maps.addressvalidation.v1.ValidateAddressResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new AddressValidationMethodDescriptorSupplier("ValidateAddress"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    io.grpc.MethodDescriptor<
            ...
            com.google.maps.addressvalidation.v1.ProvideValidationFeedbackResponse>
        getProvideValidationFeedbackMethod;
    if ((getProvideValidationFeedbackMethod =
            AddressValidationGrpc.getProvideValidationFeedbackMethod)
        == null) {
      synchronized (AddressValidationGrpc.class) {
        if ((getProvideValidationFeedbackMethod =
                AddressValidationGrpc.getProvideValidationFeedbackMethod)
          ...
          AddressValidationGrpc.getProvideValidationFeedbackMethod =
              getProvideValidationFeedbackMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
                      .setFullMethodName(
                          generateFullMethodName(SERVICE_NAME, "ProvideValidationFeedback"))
                      .setSampledToLocalTracing(true)
                      .setRequestMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.maps.addressvalidation.v1.ProvideValidationFeedbackRequest
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.maps.addressvalidation.v1.ProvideValidationFeedbackResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new AddressValidationMethodDescriptorSupplier(
  ...
  public static AddressValidationStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AddressValidationStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AddressValidationStub>() {
          @java.lang.Override
          public AddressValidationStub newStub(
   ...
   */
  public static AddressValidationBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AddressValidationBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AddressValidationBlockingStub>() {
          @java.lang.Override
          public AddressValidationBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static AddressValidationFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<AddressValidationFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<AddressValidationFutureStub>() {
          @java.lang.Override
          public AddressValidationFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public interface AsyncService {
    ...
    default void validateAddress(
      ...
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
          getValidateAddressMethod(), responseObserver);
    }
   ...
   * </pre>
   */
  public static final class AddressValidationStub
      extends io.grpc.stub.AbstractAsyncStub<AddressValidationStub> {
    private AddressValidationStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
    ...
    public void validateAddress(
      ...
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getValidateAddressMethod(), getCallOptions()),
          request,
          responseObserver);
    }
    ...
    public void provideValidationFeedback(
        ...
        io.grpc.stub.StreamObserver<
            ...
            responseObserver) {
      io.grpc.stub.ClientCalls.asyncUnaryCall(
          getChannel().newCall(getProvideValidationFeedbackMethod(), getCallOptions()),
          request,
          responseObserver);
    }
  }
   ...
   * </pre>
   */
  public static final class AddressValidationBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<AddressValidationBlockingStub> {
  ...
  public static final class AddressValidationFutureStub
      extends io.grpc.stub.AbstractFutureStub<AddressValidationFutureStub> {
    private AddressValidationFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.maps.addressvalidation.v1.ValidateAddressResponse>
        validateAddress(com.google.maps.addressvalidation.v1.ValidateAddressRequest request) {
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        ...
        case METHODID_PROVIDE_VALIDATION_FEEDBACK:
          serviceImpl.provideValidationFeedback(
              (com.google.maps.addressvalidation.v1.ProvideValidationFeedbackRequest) request,
              (io.grpc.stub.StreamObserver<
                      com.google.maps.addressvalidation.v1.ProvideValidationFeedbackResponse>)
                  responseObserver);
  ...
  private static final class AddressValidationMethodDescriptorSupplier
    ...
    AddressValidationMethodDescriptorSupplier(java.lang.String methodName) {
