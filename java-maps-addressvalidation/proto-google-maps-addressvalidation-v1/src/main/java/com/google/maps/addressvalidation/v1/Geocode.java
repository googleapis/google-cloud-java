...
public final class Geocode extends com.google.protobuf.GeneratedMessage
    implements
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(placeId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, placeId_);
    }
    for (int i = 0; i < placeTypes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, placeTypes_.getRaw(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(placeId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, placeId_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < placeTypes_.size(); i++) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.maps.addressvalidation.v1.Geocode other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getFeatureSizeMeters()) != 0) {
