...
public class SecurityHealthAnalyticsCustomModuleName implements ResourceName {
  ...
  public static @Nullable SecurityHealthAnalyticsCustomModuleName parse(String formattedString) {
  ...
  public static List<String> toStringList(
      List<@Nullable SecurityHealthAnalyticsCustomModuleName> values) {
