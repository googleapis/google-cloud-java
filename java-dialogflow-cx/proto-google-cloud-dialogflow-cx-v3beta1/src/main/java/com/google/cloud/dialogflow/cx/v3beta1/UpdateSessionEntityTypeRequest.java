...
public final class UpdateSessionEntityTypeRequest extends com.google.protobuf.GeneratedMessage
    implements
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetSessionEntityTypeFieldBuilder().getBuilder(), extensionRegistry);
