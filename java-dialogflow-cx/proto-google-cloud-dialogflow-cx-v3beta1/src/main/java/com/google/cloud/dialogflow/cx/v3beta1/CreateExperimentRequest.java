...
public final class CreateExperimentRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CreateExperimentRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetExperimentFieldBuilder().getBuilder(), extensionRegistry);
