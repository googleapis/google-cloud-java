  ...
  static {
    java.lang.String[] descriptorData = {
      "\n>google/cloud/dialogflow/cx/v3beta1/dat"
          ...
          + "ehavior.proto\"\323\001\n\023DataStoreConnection\022J\n"
          + "\017data_store_type\030\001 \001(\01621.google.cloud.di"
          + "alogflow.cx.v3beta1.DataStoreType\022\022\n\ndat"
          + "a_store\030\002 \001(\t\022\\\n\030document_processing_mod"
          + "e\030\004 \001(\0162:.google.cloud.dialogflow.cx.v3b"
          + "eta1.DocumentProcessingMode\"\337\022\n\032DataStor"
          + "eConnectionSignals\022\201\001\n\033rewriter_model_ca"
          + "ll_signals\030\001 \001(\0132W.google.cloud.dialogfl"
          + "ow.cx.v3beta1.DataStoreConnectionSignals"
          + ".RewriterModelCallSignalsB\003\340A\001\022\034\n\017rewrit"
          + "ten_query\030\002 \001(\tB\003\340A\001\022j\n\017search_snippets\030"
          + "\003 \003(\0132L.google.cloud.dialogflow.cx.v3bet"
          + "a1.DataStoreConnectionSignals.SearchSnip"
          + "petB\003\340A\001\022\222\001\n$answer_generation_model_cal"
          + "l_signals\030\004 \001(\0132_.google.cloud.dialogflo"
          + "w.cx.v3beta1.DataStoreConnectionSignals."
          + "AnswerGenerationModelCallSignalsB\003\340A\001\022\023\n"
          + "\006answer\030\005 \001(\tB\003\340A\001\022d\n\014answer_parts\030\006 \003(\013"
          + "2I.google.cloud.dialogflow.cx.v3beta1.Da"
          + "taStoreConnectionSignals.AnswerPartB\003\340A\001"
          + "\022h\n\016cited_snippets\030\007 \003(\0132K.google.cloud."
          + "dialogflow.cx.v3beta1.DataStoreConnectio"
          + "nSignals.CitedSnippetB\003\340A\001\022o\n\021grounding_"
          + "signals\030\010 \001(\0132O.google.cloud.dialogflow."
          + "cx.v3beta1.DataStoreConnectionSignals.Gr"
          + "oundingSignalsB\003\340A\001\022i\n\016safety_signals\030\t "
          + "\001(\0132L.google.cloud.dialogflow.cx.v3beta1"
          + ".DataStoreConnectionSignals.SafetySignal"
          + "sB\003\340A\001\032X\n\030RewriterModelCallSignals\022\027\n\017re"
          + "ndered_prompt\030\001 \001(\t\022\024\n\014model_output\030\002 \001("
          + "\t\022\r\n\005model\030\003 \001(\t\032K\n\rSearchSnippet\022\026\n\016doc"
          + "ument_title\030\001 \001(\t\022\024\n\014document_uri\030\002 \001(\t\022"
          + "\014\n\004text\030\003 \001(\t\032`\n AnswerGenerationModelCa"
          + "llSignals\022\027\n\017rendered_prompt\030\001 \001(\t\022\024\n\014mo"
          + "del_output\030\002 \001(\t\022\r\n\005model\030\003 \001(\t\0326\n\nAnswe"
          + "rPart\022\014\n\004text\030\001 \001(\t\022\032\n\022supporting_indice"
          + "s\030\002 \003(\005\032\213\001\n\014CitedSnippet\022d\n\016search_snipp"
          + "et\030\001 \001(\0132L.google.cloud.dialogflow.cx.v3"
          + "beta1.DataStoreConnectionSignals.SearchS"
          + "nippet\022\025\n\rsnippet_index\030\002 \001(\005\032\347\003\n\020Ground"
          + "ingSignals\022s\n\010decision\030\001 \001(\0162a.google.cl"
          + "oud.dialogflow.cx.v3beta1.DataStoreConne"
          + "ctionSignals.GroundingSignals.GroundingD"
          + "ecision\022s\n\005score\030\002 \001(\0162d.google.cloud.di"
          + "alogflow.cx.v3beta1.DataStoreConnectionS"
          + "ignals.GroundingSignals.GroundingScoreBu"
          + "cket\"m\n\021GroundingDecision\022\"\n\036GROUNDING_D"
          + "ECISION_UNSPECIFIED\020\000\022\031\n\025ACCEPTED_BY_GRO"
          + "UNDING\020\001\022\031\n\025REJECTED_BY_GROUNDING\020\002\"z\n\024G"
          + "roundingScoreBucket\022&\n\"GROUNDING_SCORE_B"
          + "UCKET_UNSPECIFIED\020\000\022\014\n\010VERY_LOW\020\001\022\007\n\003LOW"
          + "\020\003\022\n\n\006MEDIUM\020\004\022\010\n\004HIGH\020\005\022\r\n\tVERY_HIGH\020\006\032"
          + "\243\004\n\rSafetySignals\022m\n\010decision\030\001 \001(\0162[.go"
          + "ogle.cloud.dialogflow.cx.v3beta1.DataSto"
          + "reConnectionSignals.SafetySignals.Safety"
          + "Decision\022{\n\023banned_phrase_match\030\002 \001(\0162^."
          + "google.cloud.dialogflow.cx.v3beta1.DataS"
          + "toreConnectionSignals.SafetySignals.Bann"
          + "edPhraseMatch\022\035\n\025matched_banned_phrase\030\003"
          + " \001(\t\"m\n\016SafetyDecision\022\037\n\033SAFETY_DECISIO"
          + "N_UNSPECIFIED\020\000\022\034\n\030ACCEPTED_BY_SAFETY_CH"
          + "ECK\020\001\022\034\n\030REJECTED_BY_SAFETY_CHECK\020\002\"\227\001\n\021"
          + "BannedPhraseMatch\022#\n\037BANNED_PHRASE_MATCH"
          + "_UNSPECIFIED\020\000\022\034\n\030BANNED_PHRASE_MATCH_NO"
          + "NE\020\001\022\035\n\031BANNED_PHRASE_MATCH_QUERY\020\002\022 \n\034B"
          + "ANNED_PHRASE_MATCH_RESPONSE\020\003*b\n\rDataSto"
          + "reType\022\037\n\033DATA_STORE_TYPE_UNSPECIFIED\020\000\022"
          + "\016\n\nPUBLIC_WEB\020\001\022\020\n\014UNSTRUCTURED\020\002\022\016\n\nSTR"
          + "UCTURED\020\003*]\n\026DocumentProcessingMode\022(\n$D"
          + "OCUMENT_PROCESSING_MODE_UNSPECIFIED\020\000\022\r\n"
          + "\tDOCUMENTS\020\001\022\n\n\006CHUNKS\020\002B\317\001\n&com.google."
          + "cloud.dialogflow.cx.v3beta1B\030DataStoreCo"
          + "nnectionProtoP\001Z6cloud.google.com/go/dia"
