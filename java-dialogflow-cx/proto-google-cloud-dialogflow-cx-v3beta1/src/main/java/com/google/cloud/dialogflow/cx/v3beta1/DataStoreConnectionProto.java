  ...
  static {
    java.lang.String[] descriptorData = {
      "\n>google/cloud/dialogflow/cx/v3beta1/dat"
          ...
          + "e_type\030\001 \001(\01621.google.cloud.dialogflow.c"
          + "x.v3beta1.DataStoreType\022\022\n\ndata_store\030\002 "
          + "\001(\t\022\\\n\030document_processing_mode\030\004 \001(\0162:."
          + "google.cloud.dialogflow.cx.v3beta1.Docum"
          + "entProcessingMode\"\212\023\n\032DataStoreConnectio"
          + "nSignals\022\201\001\n\033rewriter_model_call_signals"
          + "\030\001 \001(\0132W.google.cloud.dialogflow.cx.v3be"
          + "ta1.DataStoreConnectionSignals.RewriterM"
          + "odelCallSignalsB\003\340A\001\022\034\n\017rewritten_query\030"
          + "\002 \001(\tB\003\340A\001\022j\n\017search_snippets\030\003 \003(\0132L.go"
          + "ogle.cloud.dialogflow.cx.v3beta1.DataSto"
          + "reConnectionSignals.SearchSnippetB\003\340A\001\022\222"
          + "\001\n$answer_generation_model_call_signals\030"
          + "\004 \001(\0132_.google.cloud.dialogflow.cx.v3bet"
          + "a1.DataStoreConnectionSignals.AnswerGene"
          + "rationModelCallSignalsB\003\340A\001\022\023\n\006answer\030\005 "
          + "\001(\tB\003\340A\001\022d\n\014answer_parts\030\006 \003(\0132I.google."
          + "cloud.dialogflow.cx.v3beta1.DataStoreCon"
          + "nectionSignals.AnswerPartB\003\340A\001\022h\n\016cited_"
          + "snippets\030\007 \003(\0132K.google.cloud.dialogflow"
          + ".cx.v3beta1.DataStoreConnectionSignals.C"
          + "itedSnippetB\003\340A\001\022o\n\021grounding_signals\030\010 "
          + "\001(\0132O.google.cloud.dialogflow.cx.v3beta1"
          + ".DataStoreConnectionSignals.GroundingSig"
          + "nalsB\003\340A\001\022i\n\016safety_signals\030\t \001(\0132L.goog"
          + "le.cloud.dialogflow.cx.v3beta1.DataStore"
          + "ConnectionSignals.SafetySignalsB\003\340A\001\032X\n\030"
          + "RewriterModelCallSignals\022\027\n\017rendered_pro"
          + "mpt\030\001 \001(\t\022\024\n\014model_output\030\002 \001(\t\022\r\n\005model"
          ...
          + "Struct\032`\n AnswerGenerationModelCallSigna"
          + "ls\022\027\n\017rendered_prompt\030\001 \001(\t\022\024\n\014model_out"
          + "put\030\002 \001(\t\022\r\n\005model\030\003 \001(\t\0326\n\nAnswerPart\022\014"
          + "\n\004text\030\001 \001(\t\022\032\n\022supporting_indices\030\002 \003(\005"
          + "\032\213\001\n\014CitedSnippet\022d\n\016search_snippet\030\001 \001("
          + "\0132L.google.cloud.dialogflow.cx.v3beta1.D"
          + "ataStoreConnectionSignals.SearchSnippet\022"
          + "\025\n\rsnippet_index\030\002 \001(\005\032\347\003\n\020GroundingSign"
          + "als\022s\n\010decision\030\001 \001(\0162a.google.cloud.dia"
          + "logflow.cx.v3beta1.DataStoreConnectionSi"
          + "gnals.GroundingSignals.GroundingDecision"
          + "\022s\n\005score\030\002 \001(\0162d.google.cloud.dialogflo"
          + "w.cx.v3beta1.DataStoreConnectionSignals."
          + "GroundingSignals.GroundingScoreBucket\"m\n"
          + "\021GroundingDecision\022\"\n\036GROUNDING_DECISION"
          + "_UNSPECIFIED\020\000\022\031\n\025ACCEPTED_BY_GROUNDING\020"
          + "\001\022\031\n\025REJECTED_BY_GROUNDING\020\002\"z\n\024Groundin"
          + "gScoreBucket\022&\n\"GROUNDING_SCORE_BUCKET_U"
          + "NSPECIFIED\020\000\022\014\n\010VERY_LOW\020\001\022\007\n\003LOW\020\003\022\n\n\006M"
          + "EDIUM\020\004\022\010\n\004HIGH\020\005\022\r\n\tVERY_HIGH\020\006\032\243\004\n\rSaf"
          + "etySignals\022m\n\010decision\030\001 \001(\0162[.google.cl"
          + "oud.dialogflow.cx.v3beta1.DataStoreConne"
          + "ctionSignals.SafetySignals.SafetyDecisio"
          + "n\022{\n\023banned_phrase_match\030\002 \001(\0162^.google."
          + "cloud.dialogflow.cx.v3beta1.DataStoreCon"
          + "nectionSignals.SafetySignals.BannedPhras"
          + "eMatch\022\035\n\025matched_banned_phrase\030\003 \001(\t\"m\n"
          + "\016SafetyDecision\022\037\n\033SAFETY_DECISION_UNSPE"
          + "CIFIED\020\000\022\034\n\030ACCEPTED_BY_SAFETY_CHECK\020\001\022\034"
          + "\n\030REJECTED_BY_SAFETY_CHECK\020\002\"\227\001\n\021BannedP"
          + "hraseMatch\022#\n\037BANNED_PHRASE_MATCH_UNSPEC"
          + "IFIED\020\000\022\034\n\030BANNED_PHRASE_MATCH_NONE\020\001\022\035\n"
          + "\031BANNED_PHRASE_MATCH_QUERY\020\002\022 \n\034BANNED_P"
          + "HRASE_MATCH_RESPONSE\020\003*b\n\rDataStoreType\022"
          + "\037\n\033DATA_STORE_TYPE_UNSPECIFIED\020\000\022\016\n\nPUBL"
          + "IC_WEB\020\001\022\020\n\014UNSTRUCTURED\020\002\022\016\n\nSTRUCTURED"
          + "\020\003*]\n\026DocumentProcessingMode\022(\n$DOCUMENT"
          + "_PROCESSING_MODE_UNSPECIFIED\020\000\022\r\n\tDOCUME"
          + "NTS\020\001\022\n\n\006CHUNKS\020\002B\317\001\n&com.google.cloud.d"
          + "ialogflow.cx.v3beta1B\030DataStoreConnectio"
          + "nProtoP\001Z6cloud.google.com/go/dialogflow"
