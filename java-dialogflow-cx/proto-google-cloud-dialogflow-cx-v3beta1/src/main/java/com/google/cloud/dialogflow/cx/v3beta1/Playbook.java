...
public final class Playbook extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private Playbook(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Instruction extends com.google.protobuf.GeneratedMessage
    ...
    @java.lang.Override
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(guidelines_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, guidelines_);
      }
      for (int i = 0; i < steps_.size(); i++) {
        output.writeMessage(2, steps_.get(i));
      }
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(guidelines_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, guidelines_);
      }
      for (int i = 0; i < steps_.size(); i++) {
        size += com.google.protobuf.CodedOutputStream.computeMessageSize(2, steps_.get(i));
      }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < referencedPlaybooks_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 11, referencedPlaybooks_.getRaw(i));
    }
    for (int i = 0; i < referencedFlows_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, referencedFlows_.getRaw(i));
    }
    for (int i = 0; i < referencedTools_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 13, referencedTools_.getRaw(i));
    }
    ...
    for (int i = 0; i < inlineActions_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 22, inlineActions_.getRaw(i));
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetInputParameterDefinitionsFieldBuilder();
        internalGetOutputParameterDefinitionsFieldBuilder();
        ...
        internalGetLlmModelSettingsFieldBuilder();
        internalGetSpeechSettingsFieldBuilder();
        internalGetHandlersFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 114:
              {
                input.readMessage(
                    internalGetLlmModelSettingsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 138:
              {
                input.readMessage(
                    internalGetInstructionFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 162:
              {
                input.readMessage(
                    internalGetSpeechSettingsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.Builder
      ...
      return internalGetInputParameterDefinitionsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.Builder
      ...
      return internalGetInputParameterDefinitionsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.Builder>
      ...
      return internalGetInputParameterDefinitionsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.Builder
      ...
      return internalGetOutputParameterDefinitionsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.Builder
      ...
      return internalGetOutputParameterDefinitionsFieldBuilder()
          .addBuilder(
              com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.cloud.dialogflow.cx.v3beta1.ParameterDefinition.Builder>
      ...
      return internalGetOutputParameterDefinitionsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.Playbook.Instruction.Builder
      ...
      bitField0_ |= 0x00000020;
      onChanged();
      return internalGetInstructionFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.LlmModelSettings.Builder
      ...
      bitField0_ |= 0x00004000;
      onChanged();
      return internalGetLlmModelSettingsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.AdvancedSettings.SpeechSettings.Builder
      ...
      bitField0_ |= 0x00008000;
      onChanged();
      return internalGetSpeechSettingsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.Handler.Builder getHandlersBuilder(int index) {
      return internalGetHandlersFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.dialogflow.cx.v3beta1.Handler.Builder addHandlersBuilder() {
      return internalGetHandlersFieldBuilder()
    ...
    public java.util.List<com.google.cloud.dialogflow.cx.v3beta1.Handler.Builder>
      ...
      return internalGetHandlersFieldBuilder().getBuilderList();
    }
