...
public class FlowValidationResultName implements ResourceName {
  ...
  public static @Nullable FlowValidationResultName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable FlowValidationResultName> values) {
