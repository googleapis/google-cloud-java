...
public interface LookupEnvironmentHistoryResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3.LookupEnvironmentHistoryResponse)
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3.Environment environments = 1;</code>
   */
  com.google.cloud.dialogflow.cx.v3.EnvironmentOrBuilder getEnvironmentsOrBuilder(int index);
