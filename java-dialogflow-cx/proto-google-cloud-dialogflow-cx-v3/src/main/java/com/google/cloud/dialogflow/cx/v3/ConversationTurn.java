...
public final class ConversationTurn extends com.google.protobuf.GeneratedMessageV3
    ...
    try {
      ...
      while (!done) {
        ...
        switch (tag) {
          ...
          case 10:
            {
              com.google.cloud.dialogflow.cx.v3.ConversationTurn.UserInput.Builder subBuilder =
                  null;
              if (userInput_ != null) {
                subBuilder = userInput_.toBuilder();
              }
              userInput_ =
                  input.readMessage(
                      com.google.cloud.dialogflow.cx.v3.ConversationTurn.UserInput.parser(),
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(userInput_);
                userInput_ = subBuilder.buildPartial();
              }
          ...
          case 18:
            {
              ...
              if (virtualAgentOutput_ != null) {
                subBuilder = virtualAgentOutput_.toBuilder();
              }
              virtualAgentOutput_ =
                  input.readMessage(
                      ...
                      extensionRegistry);
              if (subBuilder != null) {
                subBuilder.mergeFrom(virtualAgentOutput_);
                virtualAgentOutput_ = subBuilder.buildPartial();
              }
  ...
  public static final class UserInput extends com.google.protobuf.GeneratedMessageV3
            ...
            case 18:
              {
                ...
                if (injectedParameters_ != null) {
                  subBuilder = injectedParameters_.toBuilder();
                }
                injectedParameters_ =
                    input.readMessage(com.google.protobuf.Struct.parser(), extensionRegistry);
                if (subBuilder != null) {
                  subBuilder.mergeFrom(injectedParameters_);
                  injectedParameters_ = subBuilder.buildPartial();
                }
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.google.cloud.dialogflow.cx.v3.ConversationTurn.UserInput parsedMessage = null;
        try {
      ...
      public Builder mergeInput(com.google.cloud.dialogflow.cx.v3.QueryInput value) {
        if (inputBuilder_ == null) {
          if (input_ != null) {
            input_ =
                com.google.cloud.dialogflow.cx.v3.QueryInput.newBuilder(input_)
                    .mergeFrom(value)
                    .buildPartial();
          } else {
            input_ = value;
  ...
  public static final class VirtualAgentOutput extends com.google.protobuf.GeneratedMessageV3
            ...
            case 34:
              {
                ...
                if (sessionParameters_ != null) {
                  subBuilder = sessionParameters_.toBuilder();
                }
                sessionParameters_ =
                    input.readMessage(com.google.protobuf.Struct.parser(), extensionRegistry);
                if (subBuilder != null) {
                  subBuilder.mergeFrom(sessionParameters_);
                  sessionParameters_ = subBuilder.buildPartial();
                }
            ...
            case 58:
              {
                ...
                if (triggeredIntent_ != null) {
                  subBuilder = triggeredIntent_.toBuilder();
                }
                triggeredIntent_ =
                    input.readMessage(
                        com.google.cloud.dialogflow.cx.v3.Intent.parser(), extensionRegistry);
                if (subBuilder != null) {
                  subBuilder.mergeFrom(triggeredIntent_);
                  triggeredIntent_ = subBuilder.buildPartial();
                }
    ...
    public static final class Builder
      ...
      public Builder mergeFrom(
          ...
          com.google.protobuf.ExtensionRegistryLite extensionRegistry)
          throws java.io.IOException {
        com.google.cloud.dialogflow.cx.v3.ConversationTurn.VirtualAgentOutput parsedMessage = null;
        try {
          parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
        } catch (com.google.protobuf.InvalidProtocolBufferException e) {
          parsedMessage =
      ...
      public Builder mergeTriggeredIntent(com.google.cloud.dialogflow.cx.v3.Intent value) {
        if (triggeredIntentBuilder_ == null) {
          if (triggeredIntent_ != null) {
            triggeredIntent_ =
                com.google.cloud.dialogflow.cx.v3.Intent.newBuilder(triggeredIntent_)
                    .mergeFrom(value)
                    .buildPartial();
          } else {
            triggeredIntent_ = value;
    ...
    private static final com.google.protobuf.Parser<VirtualAgentOutput> PARSER =
        new com.google.protobuf.AbstractParser<VirtualAgentOutput>() {
          ...
          public VirtualAgentOutput parsePartialFrom(
              ...
              com.google.protobuf.ExtensionRegistryLite extensionRegistry)
              throws com.google.protobuf.InvalidProtocolBufferException {
            return new VirtualAgentOutput(input, extensionRegistry);
          }
        };
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessageV3.Builder<Builder>
    ...
    public Builder mergeFrom(
        ...
        com.google.protobuf.ExtensionRegistryLite extensionRegistry)
        throws java.io.IOException {
      com.google.cloud.dialogflow.cx.v3.ConversationTurn parsedMessage = null;
      try {
        parsedMessage = PARSER.parsePartialFrom(input, extensionRegistry);
      } catch (com.google.protobuf.InvalidProtocolBufferException e) {
        parsedMessage =
            (com.google.cloud.dialogflow.cx.v3.ConversationTurn) e.getUnfinishedMessage();
        throw e.unwrapIOException();
      } finally {
        if (parsedMessage != null) {
          mergeFrom(parsedMessage);
    ...
    public Builder mergeUserInput(
      ...
      if (userInputBuilder_ == null) {
        if (userInput_ != null) {
          userInput_ =
              com.google.cloud.dialogflow.cx.v3.ConversationTurn.UserInput.newBuilder(userInput_)
                  .mergeFrom(value)
                  .buildPartial();
        } else {
          userInput_ = value;
  ...
  private static final com.google.protobuf.Parser<ConversationTurn> PARSER =
      new com.google.protobuf.AbstractParser<ConversationTurn>() {
        ...
        public ConversationTurn parsePartialFrom(
            ...
            com.google.protobuf.ExtensionRegistryLite extensionRegistry)
            throws com.google.protobuf.InvalidProtocolBufferException {
          return new ConversationTurn(input, extensionRegistry);
        }
      };
