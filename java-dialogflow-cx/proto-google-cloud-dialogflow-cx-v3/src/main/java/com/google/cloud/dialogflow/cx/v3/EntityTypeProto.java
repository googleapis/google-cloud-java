...
public final class EntityTypeProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          + "/google/cloud/dialogflow/cx/v3/entity_type.proto\022\035google.cloud.dialogflow.cx.v3"
          ...
          + " google/protobuf/field_mask.proto\"\232\006\n\n"
          + "EntityType\022\014\n"
          + "\004name\030\001 \001(\t\022\031\n"
          + "\014display_name\030\002 \001(\tB\003\340A\002\022A\n"
          + "\004kind\030\003"
          + " \001(\0162..google.cloud.dialogflow.cx.v3.EntityType.KindB\003\340A\002\022X\n"
          + "\023auto_expansion_mode\030\004"
          + " \001(\0162;.google.cloud.dialogflow.cx.v3.EntityType.AutoExpansionMode\022B\n"
          + "\010entities\030\005"
          + " \003(\01320.google.cloud.dialogflow.cx.v3.EntityType.Entity\022R\n"
          + "\020excluded_phrases\030\006"
          + " \003(\01328.google.cloud.dialogflow.cx.v3.EntityType.ExcludedPhrase\022\037\n"
          ...
          + "$dialogflow.googleapis.com/EntityType\022Pprojects/{project}/locat"
          + "ions/{location}/agents/{agent}/entityTypes/{entity_type}\"\220\003\n"
          + "\030ExportEntityTypesRequest\022<\n"
          + "\006parent\030\001 \001("
          + "\tB,\340A\002\372A&\022$dialogflow.googleapis.com/EntityType\022\031\n"
          ...
          + "e.cloud.dialogflow.cx.v3.ExportEntityTypesRequest.DataFormatB\003\340A\001\022\032\n\r"
          + "language_code\030\006 \001(\tB\003\340A\001\"E\n\n"
          + "DataFormat\022\033\n"
          + "\027DATA_FORMAT_UNSPECIFIED\020\000\022\010\n"
          + "\004BLOB\020\001\022\020\n"
          + "\014JSON_PACKAGE\020\005B\r\n"
          + "\013destination\"\242\001\n"
          + "\031ExportEntityTypesResponse\022\032\n"
          + "\020entity_types_uri\030\001 \001(\tH\000\022P\n"
          + "\024entity_types_content\030\002 \001(\01320.google.clo"
          + "ud.dialogflow.cx.v3.InlineDestinationH\000B\027\n"
          + "\025exported_entity_types\"\033\n"
          + "\031ExportEntityTypesMetadata\"\353\003\n"
          + "\030ImportEntityTypesRequest\022<\n"
          + "\006parent\030\001 \001("
          + "\tB,\340A\002\372A&\022$dialogflow.googleapis.com/EntityType\022\032\n"
          + "\020entity_types_uri\030\002 \001(\tH\000\022K\n"
          + "\024entity_types_content\030\003 \001"
          + "(\0132+.google.cloud.dialogflow.cx.v3.InlineSourceH\000\022^\n"
          + "\014merge_option\030\004 \001(\0162C.google"
          + ".cloud.dialogflow.cx.v3.ImportEntityTypesRequest.MergeOptionB\003\340A\002\022H\n"
          ...
          + "$dialogflow.googleapis.com/EntityType\022l\n"
          + "\025conflicting_resources\030\002 \001(\0132M.goog"
          + "le.cloud.dialogflow.cx.v3.ImportEntityTypesResponse.ConflictingResources\032W\n"
          + "\024ConflictingResources\022!\n"
          + "\031entity_type_display_names\030\001 \003(\t\022\034\n"
          ...
          + " \003(\0132).google.cloud.dialogflow.cx.v3.EntityType\022\027\n"
          + "\017next_page_token\030\002 \001(\t\"i\n"
          + "\024GetEntityTypeRequest\022:\n"
          + "\004name\030\001 \001(\tB,\340A\002\372A&\n"
          + "$dialogflow.googleapis.com/EntityType\022\025\n\r"
          + "language_code\030\002 \001(\t\"\263\001\n"
          + "\027CreateEntityTypeRequest\022<\n"
          + "\006parent\030\001 \001("
          + "\tB,\340A\002\372A&\022$dialogflow.googleapis.com/EntityType\022C\n"
          + "\013entity_type\030\002 \001(\0132).g"
          + "oogle.cloud.dialogflow.cx.v3.EntityTypeB\003\340A\002\022\025\n\r"
          + "language_code\030\003 \001(\t\"\246\001\n"
          ...
          + "GetEntityType\0223.google.cloud.dialogflow.c"
          + "x.v3.GetEntityTypeRequest\032).google.cloud"
          + ".dialogflow.cx.v3.EntityType\"G\332A\004name\202\323\344"
          + "\223\002:\0228/v3/{name=projects/*/locations/*/agents/*/entityTypes/*}\022\331\001\n"
          + "\020CreateEntityType\0226.google.cloud.dialogflow.cx.v3.Creat"
          ...
          + "ions/*/agents/*}/entityTypes:\013entity_type\022\352\001\n"
          + "\020UpdateEntityType\0226.google.cloud.dialogflow.cx.v3.UpdateEntityTypeRequest\032)"
          ...
          + "*/agents/*/entityTypes/*}:\013entity_type\022\253\001\n"
          ...
          + "{name=projects/*/locations/*/agents/*/entityTypes/*}\022\313\001\n"
          + "\017ListEntityTypes\0225.google.cloud.dialogflow.cx.v3.ListEntityTypes"
          + "Request\0326.google.cloud.dialogflow.cx.v3."
          + "ListEntityTypesResponse\"I\332A\006parent\202\323\344\223\002:"
          + "\0228/v3/{parent=projects/*/locations/*/agents/*}/entityTypes\022\361\001\n"
          + "\021ExportEntityTypes\0227.google.cloud.dialogflow.cx.v3.ExportE"
          + "ntityTypesRequest\032\035.google.longrunning.Operation\"\203\001\312A6\n"
          + "\031ExportEntityTypesRespons"
          + "e\022\031ExportEntityTypesMetadata\202\323\344\223\002D\"?/v3/"
          + "{parent=projects/*/locations/*/agents/*}/entityTypes:export:\001*\022\361\001\n"
          + "\021ImportEntityTypes\0227.google.cloud.dialogflow.cx.v3.Imp"
          + "ortEntityTypesRequest\032\035.google.longrunning.Operation\"\203\001\312A6\n"
          + "\031ImportEntityTypesResponse\022\031ImportEntityTypesMetadata\202\323\344\223\002D\"?"
          ...
          + "s.com/auth/cloud-platform,https://www.googleapis.com/auth/dialogflowB\262\001\n"
          + "!com.google.cloud.dialogflow.cx.v3B\017EntityTypePr"
          + "otoP\001Z1cloud.google.com/go/dialogflow/cx"
          + "/apiv3/cxpb;cxpb\242\002\002DF\252\002\035Google.Cloud.Dia"
          + "logflow.Cx.V3\352\002!Google::Cloud::Dialogflow::CX::V3b\006proto3"
    };
    descriptor =
    ...
    internal_static_google_cloud_dialogflow_cx_v3_EntityType_Entity_descriptor =
        internal_static_google_cloud_dialogflow_cx_v3_EntityType_descriptor.getNestedType(0);
    internal_static_google_cloud_dialogflow_cx_v3_EntityType_Entity_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_dialogflow_cx_v3_EntityType_Entity_descriptor,
            new java.lang.String[] {
    ...
    internal_static_google_cloud_dialogflow_cx_v3_EntityType_ExcludedPhrase_descriptor =
        internal_static_google_cloud_dialogflow_cx_v3_EntityType_descriptor.getNestedType(1);
    internal_static_google_cloud_dialogflow_cx_v3_EntityType_ExcludedPhrase_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_cloud_dialogflow_cx_v3_EntityType_ExcludedPhrase_descriptor,
            new java.lang.String[] {
