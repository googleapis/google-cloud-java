...
public class PlaybookName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_AGENT_PLAYBOOK =
  ...
  public static @Nullable PlaybookName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_AGENT_PLAYBOOK.validatedMatch(
            formattedString, "PlaybookName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<PlaybookName> parseList(List<String> formattedStrings) {
    List<PlaybookName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable PlaybookName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_AGENT_PLAYBOOK.instantiate(
        "project", project, "location", location, "agent", agent, "playbook", playbook);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/agents/{agent}/playbooks/{playbook}. */
