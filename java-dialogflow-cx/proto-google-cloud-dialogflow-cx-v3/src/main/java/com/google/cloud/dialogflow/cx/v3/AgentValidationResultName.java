...
public class AgentValidationResultName implements ResourceName {
  ...
  public static @Nullable AgentValidationResultName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AgentValidationResultName> values) {
