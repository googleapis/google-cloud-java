...
public interface ExampleOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3.Example)
   ...
   *
   * <code>
   * .google.cloud.dialogflow.cx.v3.PlaybookInput playbook_input = 3 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   *
   * <code>
   * .google.cloud.dialogflow.cx.v3.PlaybookOutput playbook_output = 4 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   *
   * <code>
   * repeated .google.cloud.dialogflow.cx.v3.Action actions = 2 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   */
   ...
   *
   * <code>
   * .google.cloud.dialogflow.cx.v3.OutputState conversation_state = 12 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.dialogflow.cx.v3.OutputState getConversationState();
