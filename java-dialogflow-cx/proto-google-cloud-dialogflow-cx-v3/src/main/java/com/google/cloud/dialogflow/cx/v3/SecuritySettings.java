...
public final class SecuritySettings extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class AudioExportSettings extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private AudioExportSettings(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(audioExportPattern_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, audioExportPattern_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(audioExportPattern_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, audioExportPattern_);
      }
      if (enableAudioRedaction_ != false) {
   ...
   */
  public static final class InsightsExportSettings extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private InsightsExportSettings(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList purgeDataTypes_ = emptyIntList();
  ...
  public com.google.cloud.dialogflow.cx.v3.SecuritySettings.PurgeDataType getPurgeDataTypes(
      int index) {
    return purgeDataTypes_converter_.convert(purgeDataTypes_.getInt(index));
  }
  ...
  public int getPurgeDataTypesValue(int index) {
    return purgeDataTypes_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < purgeDataTypes_.size(); i++) {
      output.writeEnumNoTag(purgeDataTypes_.getInt(i));
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(deidentifyTemplate_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 17, deidentifyTemplate_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < purgeDataTypes_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(purgeDataTypes_.getInt(i));
      }
      size += dataSize;
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(deidentifyTemplate_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(17, deidentifyTemplate_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetAudioExportSettingsFieldBuilder();
        internalGetInsightsExportSettingsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  purgeDataTypes_.addInt(input.readEnum());
                }
            ...
            case 98:
              {
                input.readMessage(
                    internalGetAudioExportSettingsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 106:
              {
                input.readMessage(
                    internalGetInsightsExportSettingsFieldBuilder().getBuilder(),
                    extensionRegistry);
    ...
    private void ensurePurgeDataTypesIsMutable() {
      if (!purgeDataTypes_.isModifiable()) {
        purgeDataTypes_ = makeMutableCopy(purgeDataTypes_);
      }
      bitField0_ |= 0x00000100;
    }
    ...
    public Builder setPurgeDataTypes(
      ...
      ensurePurgeDataTypesIsMutable();
      purgeDataTypes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addPurgeDataTypes(
      ...
      ensurePurgeDataTypesIsMutable();
      purgeDataTypes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setPurgeDataTypesValue(int index, int value) {
      ensurePurgeDataTypesIsMutable();
      purgeDataTypes_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public com.google.cloud.dialogflow.cx.v3.SecuritySettings.AudioExportSettings.Builder
      ...
      bitField0_ |= 0x00000200;
      onChanged();
      return internalGetAudioExportSettingsFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.dialogflow.cx.v3.SecuritySettings.InsightsExportSettings.Builder
      ...
      bitField0_ |= 0x00000400;
      onChanged();
      return internalGetInsightsExportSettingsFieldBuilder().getBuilder();
    }
