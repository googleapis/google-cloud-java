...
public class AgentGenerativeSettingsName implements ResourceName {
  ...
  public static AgentGenerativeSettingsName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_AGENT.validatedMatch(
            formattedString,
            "AgentGenerativeSettingsName.parse: formattedString not in valid format");
  ...
  public static List<AgentGenerativeSettingsName> parseList(List<String> formattedStrings) {
    List<AgentGenerativeSettingsName> list = new ArrayList<>(formattedStrings.size());
  ...
  /** Builder for projects/{project}/locations/{location}/agents/{agent}/generativeSettings. */
