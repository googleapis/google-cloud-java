...
public class SecuritySettingsName implements ResourceName {
  ...
  public static @Nullable SecuritySettingsName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable SecuritySettingsName> values) {
