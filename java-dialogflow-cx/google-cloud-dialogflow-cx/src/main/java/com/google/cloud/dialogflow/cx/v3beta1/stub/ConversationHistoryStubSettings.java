...
/**
 * Settings class to configure an instance of {@link ConversationHistoryStub}.
 *
 ...
 *
 * <p>For example, to set the total timeout of getConversation to 30 seconds:
 *
 * <pre>{@code
...
public class ConversationHistoryStubSettings extends StubSettings<ConversationHistoryStubSettings> {
  ...
  public ConversationHistoryStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcConversationHistoryStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonConversationHistoryStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(ConversationHistoryStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return ConversationHistoryStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected ConversationHistoryStubSettings(Builder settingsBuilder) throws IOException {
  ...
  /** Builder for ConversationHistoryStubSettings. */
  public static class Builder
      extends StubSettings.Builder<ConversationHistoryStubSettings, Builder> {
    ...
    protected Builder(ConversationHistoryStubSettings settings) {
      super(settings);
    ...
    @Override
    public ConversationHistoryStubSettings build() throws IOException {
      return new ConversationHistoryStubSettings(this);
    }
  }
}
