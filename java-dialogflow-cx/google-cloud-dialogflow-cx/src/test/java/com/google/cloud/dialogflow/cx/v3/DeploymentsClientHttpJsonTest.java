...
import com.google.cloud.dialogflow.cx.v3.stub.HttpJsonDeploymentsStub;
...
public class DeploymentsClientHttpJsonTest {
  private static MockHttpService mockService;
  private static DeploymentsClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonDeploymentsStub.getMethodDescriptors(),
            DeploymentsSettings.getDefaultEndpoint());
    DeploymentsSettings settings =
        DeploymentsSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                DeploymentsSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void getDeploymentTest2() throws Exception {
    ...
    String name =
        "projects/project-138/locations/location-138/agents/agent-138/environments/environment-138/deployments/deployment-138";
