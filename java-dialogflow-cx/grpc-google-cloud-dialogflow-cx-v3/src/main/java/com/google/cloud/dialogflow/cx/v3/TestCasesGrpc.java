...
public final class TestCasesGrpc {
  ...
  public static TestCasesBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<TestCasesBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<TestCasesBlockingV2Stub>() {
          @java.lang.Override
          public TestCasesBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new TestCasesBlockingV2Stub(channel, callOptions);
          }
        };
    return TestCasesBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class TestCasesBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<TestCasesBlockingV2Stub> {
    private TestCasesBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected TestCasesBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new TestCasesBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service TestCases.
   *
   * <pre>
   * Service for managing [Test Cases][google.cloud.dialogflow.cx.v3.TestCase] and
   * [Test Case Results][google.cloud.dialogflow.cx.v3.TestCaseResult].
