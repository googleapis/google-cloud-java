...
public interface BoostSpecsOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3beta1.BoostSpecs)
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3beta1.BoostSpec> 
      getSpecList();
  /**
   * <pre>
   * Optional. A list of boosting specifications.
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3beta1.BoostSpec spec = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   */
  com.google.cloud.dialogflow.cx.v3beta1.BoostSpecOrBuilder getSpecOrBuilder(
      int index);
}
