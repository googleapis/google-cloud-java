...
public interface PlaybookInvocationOrBuilder extends
   ...
   * </pre>
   *
   * <code>string playbook = 1 [(.google.api.field_behavior) = REQUIRED, (.google.api.resource_reference) = { ... }</code>
   * @return The playbook.
   */
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3beta1.PlaybookInput playbook_input = 2 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3beta1.PlaybookOutput playbook_output = 3 [(.google.api.field_behavior) = OPTIONAL];</code>
   ...
   * </pre>
   *
   * <code>.google.cloud.dialogflow.cx.v3beta1.OutputState playbook_state = 4 [(.google.api.field_behavior) = REQUIRED];</code>
