...
public interface ListEnvironmentsResponseOrBuilder extends
    // @@protoc_insertion_point(interface_extends:google.cloud.dialogflow.cx.v3.ListEnvironmentsResponse)
   ...
   */
  java.util.List<com.google.cloud.dialogflow.cx.v3.Environment> 
      getEnvironmentsList();
  /**
   * <pre>
   * The list of environments. There will be a maximum number of items
   ...
   * <code>repeated .google.cloud.dialogflow.cx.v3.Environment environments = 1;</code>
   */
  com.google.cloud.dialogflow.cx.v3.EnvironmentOrBuilder getEnvironmentsOrBuilder(
      int index);
