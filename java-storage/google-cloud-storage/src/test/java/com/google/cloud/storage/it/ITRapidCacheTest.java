...
public class ITRapidCacheTest {
  ...
  public static void setUpClass() throws Exception {
    ...
    storageClient = StorageOptions.grpc()
    ...
    StorageControlSettings controlSettings = StorageControlSettings.newBuilder()
  ...
  public void createRapidCache() throws Exception {
    RapidCache rapidCache = RapidCache.newBuilder()
        .setName(cacheName)
    ...
    RapidCache created = controlClient.createRapidCacheAsync(
        BucketName.format("_", bucketName), rapidCache).get();
  ...
  public void createRapidCache_duplicate() throws Exception {
    ...
    try {
      controlClient.createRapidCacheAsync(
          BucketName.format("_", bucketName), rapidCache).get();
  ...
  public void createRapidCache_invalidConfig() {
    ...
    String invalidCacheName = String.format("projects/_/buckets/%s/rapidCaches/%s", bucketName, invalidCacheId);
  ...
  public void getRapidCache_nonExistent() {
    String nonExistentCacheName = String.format("projects/_/buckets/%s/rapidCaches/non-existent-cache", bucketName);
  ...
  public void updateRapidCache() throws Exception {
    RapidCache toUpdate = RapidCache.newBuilder()
        .setName(cacheName)
        .setZone("us-central1-a")
        .setCacheType("rapid-cache-ultra")
