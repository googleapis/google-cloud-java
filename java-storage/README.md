...
```Groovy
implementation platform('com.google.cloud:libraries-bom:26.81.0')
...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage" % "2.68.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-storage/2.68.0
