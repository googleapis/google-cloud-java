...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage" % "2.66.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-storage/2.66.0
