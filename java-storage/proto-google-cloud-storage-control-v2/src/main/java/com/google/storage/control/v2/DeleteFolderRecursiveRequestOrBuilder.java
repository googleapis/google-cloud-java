...
public interface DeleteFolderRecursiveRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.storage.control.v2.DeleteFolderRecursiveRequest)
   ...
   * </pre>
   *
   * <code>optional int64 if_metageneration_match = 2 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * </pre>
   *
   * <code>optional int64 if_metageneration_not_match = 3 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
