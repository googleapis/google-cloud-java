...
public class IntelligenceFindingName implements ResourceName {
  ...
  public static @Nullable IntelligenceFindingName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable IntelligenceFindingName> values) {
