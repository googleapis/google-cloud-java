...
public final class CreateAnywhereCacheMetadata extends com.google.protobuf.GeneratedMessage
  ...
  public static final int INGEST_ON_WRITE_FIELD_NUMBER = 7;
  private boolean ingestOnWrite_ = false;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (((bitField0_ & 0x00000020) != 0)) {
      output.writeBool(7, ingestOnWrite_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (((bitField0_ & 0x00000020) != 0)) {
      size += com.google.protobuf.CodedOutputStream.computeBoolSize(7, ingestOnWrite_);
    }
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (hasIngestOnWrite() != other.hasIngestOnWrite()) return false;
    if (hasIngestOnWrite()) {
      if (getIngestOnWrite() != other.getIngestOnWrite()) return false;
    }
  ...
  public int hashCode() {
    ...
    if (hasIngestOnWrite()) {
      ...
      hash = (53 * hash) + com.google.protobuf.Internal.hashBoolean(getIngestOnWrite());
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public Builder mergeFrom(com.google.storage.control.v2.CreateAnywhereCacheMetadata other) {
      ...
      if (other.hasIngestOnWrite()) {
        setIngestOnWrite(other.getIngestOnWrite());
      }
    ...
    private boolean ingestOnWrite_;
     ...
     * @return This builder for chaining.
     */
    public Builder setIngestOnWrite(boolean value) {
