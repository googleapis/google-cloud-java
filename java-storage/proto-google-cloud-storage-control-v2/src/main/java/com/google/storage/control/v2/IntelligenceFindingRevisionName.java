...
public class IntelligenceFindingRevisionName implements ResourceName {
  ...
  public static @Nullable IntelligenceFindingRevisionName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable IntelligenceFindingRevisionName> values) {
