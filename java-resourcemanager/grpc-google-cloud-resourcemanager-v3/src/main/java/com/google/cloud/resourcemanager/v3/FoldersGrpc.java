...
public final class FoldersGrpc {
  ...
  public static FoldersBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<FoldersBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<FoldersBlockingV2Stub>() {
          @java.lang.Override
          public FoldersBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new FoldersBlockingV2Stub(channel, callOptions);
          }
        };
    return FoldersBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class FoldersBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<FoldersBlockingV2Stub> {
    private FoldersBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected FoldersBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new FoldersBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Folders.
   *
   * <pre>
   * Manages Cloud Platform folder resources.
   * Folders can be used to organize the resources under an
