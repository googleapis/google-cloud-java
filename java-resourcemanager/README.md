...
```Groovy
compile 'com.google.cloud:google-cloud-resourcemanager:1.0.0'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-resourcemanager" % "1.0.0"
```
