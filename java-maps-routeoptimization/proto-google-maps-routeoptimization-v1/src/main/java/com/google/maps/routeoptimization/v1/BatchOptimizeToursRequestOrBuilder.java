...
public interface BatchOptimizeToursRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.maps.routeoptimization.v1.BatchOptimizeToursRequest)
   ...
   * </code>
   */
  java.util.List<com.google.maps.routeoptimization.v1.BatchOptimizeToursRequest.AsyncModelConfig>
      getModelConfigsList();
  /**
   *
   *
   ...
   * </code>
   */
  com.google.maps.routeoptimization.v1.BatchOptimizeToursRequest.AsyncModelConfig getModelConfigs(
      int index);
  /**
   *
   *
