...
public interface RetrieveTransferParametersRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.domains.v1alpha2.RetrieveTransferParametersRequest)
