...
public final class DomainsGrpc {
  ...
  public static DomainsBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<DomainsBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<DomainsBlockingV2Stub>() {
          @java.lang.Override
          public DomainsBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new DomainsBlockingV2Stub(channel, callOptions);
          }
        };
    return DomainsBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class DomainsBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<DomainsBlockingV2Stub> {
    private DomainsBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected DomainsBlockingV2Stub build(
        io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new DomainsBlockingV2Stub(channel, callOptions);
    }
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Domains.
   *
   * <pre>
   * The Cloud Domains API enables management and configuration of domain names.
   * </pre>
