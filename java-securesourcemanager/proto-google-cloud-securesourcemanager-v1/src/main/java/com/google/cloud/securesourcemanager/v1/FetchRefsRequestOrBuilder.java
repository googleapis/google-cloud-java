...
public interface FetchRefsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.securesourcemanager.v1.FetchRefsRequest)
   ...
   *
   * <code>
   * .google.cloud.securesourcemanager.v1.Ref.RefType type = 2 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
