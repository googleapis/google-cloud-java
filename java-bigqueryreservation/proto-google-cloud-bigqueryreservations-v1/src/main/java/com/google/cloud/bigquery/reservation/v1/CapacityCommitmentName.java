...
public class CapacityCommitmentName implements ResourceName {
    ...
    if (fieldValuesMap == null) {
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          fieldMapBuilder.put("capacityCommitment", capacityCommitment);
  ...
  /** Builder for CapacityCommitmentName. */
  ...
  public boolean equals(Object o) {
    ...
    if (o instanceof CapacityCommitmentName) {
      ...
      return (this.project.equals(that.project))
          ...
          && (this.capacityCommitment.equals(that.capacityCommitment));
    }
    return false;
  }
