...
public interface ReservationOrBuilder
   ...
   */
  java.util.List<java.lang.String> getReservationGroupPathList();
   ...
   */
  int getReservationGroupPathCount();
   ...
   */
  java.lang.String getReservationGroupPath(int index);
   ...
   */
  com.google.protobuf.ByteString getReservationGroupPathBytes(int index);
}
