...
public class CapacityCommitmentName implements ResourceName {
  ...
  public static @Nullable CapacityCommitmentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CapacityCommitmentName> values) {
