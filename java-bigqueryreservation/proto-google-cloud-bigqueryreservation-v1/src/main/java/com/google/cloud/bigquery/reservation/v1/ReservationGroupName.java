...
public class ReservationGroupName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RESERVATION_GROUP =
  ...
  private ReservationGroupName(Builder builder) {
    ...
    reservationGroup = Preconditions.checkNotNull(builder.getReservationGroup());
  }
  ...
  public static @Nullable ReservationGroupName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_RESERVATION_GROUP.validatedMatch(
            formattedString, "ReservationGroupName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("reservation_group"));
  }

  public static List<ReservationGroupName> parseList(List<String> formattedStrings) {
    List<ReservationGroupName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ReservationGroupName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (reservationGroup != null) {
            fieldMapBuilder.put("reservation_group", reservationGroup);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_RESERVATION_GROUP.instantiate(
        "project", project, "location", location, "reservation_group", reservationGroup);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.reservationGroup, that.reservationGroup);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(reservationGroup);
    return h;
  }

  /** Builder for projects/{project}/locations/{location}/reservationGroups/{reservation_group}. */
