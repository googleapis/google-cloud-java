...
public final class SplitCapacityCommitmentResponse extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SplitCapacityCommitmentResponse(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetFirstFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
            case 18:
              {
                input.readMessage(internalGetSecondFieldBuilder().getBuilder(), extensionRegistry);
