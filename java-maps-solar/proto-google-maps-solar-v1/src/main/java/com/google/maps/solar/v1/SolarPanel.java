...
public final class SolarPanel extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SolarPanel(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetCenterFieldBuilder().getBuilder(), extensionRegistry);
