...
public final class FindClosestBuildingInsightsRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private com.google.protobuf.Internal.IntList experiments_ = emptyIntList();

  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.maps.solar.v1.Experiment>
      experiments_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.maps.solar.v1.Experiment>() {
            public com.google.maps.solar.v1.Experiment convert(int from) {
  ...
  public java.util.List<com.google.maps.solar.v1.Experiment> getExperimentsList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.maps.solar.v1.Experiment>(
  ...
  public com.google.maps.solar.v1.Experiment getExperiments(int index) {
    return experiments_converter_.convert(experiments_.getInt(index));
  }
  ...
  public int getExperimentsValue(int index) {
    return experiments_.getInt(index);
  }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < experiments_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(experiments_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            ...
            case 42:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  experiments_.addInt(input.readEnum());
                }
    ...
    private void ensureExperimentsIsMutable() {
      if (!experiments_.isModifiable()) {
        experiments_ = makeMutableCopy(experiments_);
      }
      bitField0_ |= 0x00000008;
    }
    ...
    public Builder setExperiments(int index, com.google.maps.solar.v1.Experiment value) {
      ...
      ensureExperimentsIsMutable();
      experiments_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addExperiments(com.google.maps.solar.v1.Experiment value) {
      ...
      ensureExperimentsIsMutable();
      experiments_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setExperimentsValue(int index, int value) {
      ensureExperimentsIsMutable();
      experiments_.setInt(index, value);
      onChanged();
      return this;
    }
