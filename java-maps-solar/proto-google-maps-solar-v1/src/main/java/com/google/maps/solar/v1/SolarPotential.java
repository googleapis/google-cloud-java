...
public final class SolarPotential extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SolarPotential(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetWholeRoofStatsFieldBuilder();
        internalGetBuildingStatsFieldBuilder();
        internalGetRoofSegmentStatsFieldBuilder();
        internalGetSolarPanelsFieldBuilder();
        internalGetSolarPanelConfigsFieldBuilder();
        internalGetFinancialAnalysesFieldBuilder();
      }
    }
    ...
    public Builder mergeFrom(com.google.maps.solar.v1.SolarPotential other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getPanelCapacityWatts()) != 0) {
        setPanelCapacityWatts(other.getPanelCapacityWatts());
      }
      if (java.lang.Float.floatToRawIntBits(other.getPanelHeightMeters()) != 0) {
        setPanelHeightMeters(other.getPanelHeightMeters());
      }
      if (java.lang.Float.floatToRawIntBits(other.getPanelWidthMeters()) != 0) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getMaxArrayAreaMeters2()) != 0) {
        setMaxArrayAreaMeters2(other.getMaxArrayAreaMeters2());
      }
      if (java.lang.Float.floatToRawIntBits(other.getMaxSunshineHoursPerYear()) != 0) {
        setMaxSunshineHoursPerYear(other.getMaxSunshineHoursPerYear());
      }
      if (java.lang.Float.floatToRawIntBits(other.getCarbonOffsetFactorKgPerMwh()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetWholeRoofStatsFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 106:
              {
                input.readMessage(
                    internalGetBuildingStatsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.maps.solar.v1.SizeAndSunshineStats.Builder getWholeRoofStatsBuilder() {
      bitField0_ |= 0x00000100;
      onChanged();
      return internalGetWholeRoofStatsFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.solar.v1.SizeAndSunshineStats.Builder getBuildingStatsBuilder() {
      bitField0_ |= 0x00000200;
      onChanged();
      return internalGetBuildingStatsFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.solar.v1.RoofSegmentSizeAndSunshineStats.Builder
      ...
      return internalGetRoofSegmentStatsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.solar.v1.RoofSegmentSizeAndSunshineStats.Builder
      ...
      return internalGetRoofSegmentStatsFieldBuilder()
          .addBuilder(
    ...
    public java.util.List<com.google.maps.solar.v1.RoofSegmentSizeAndSunshineStats.Builder>
      ...
      return internalGetRoofSegmentStatsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.maps.solar.v1.SolarPanel.Builder getSolarPanelsBuilder(int index) {
      return internalGetSolarPanelsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.solar.v1.SolarPanel.Builder addSolarPanelsBuilder() {
      return internalGetSolarPanelsFieldBuilder()
    ...
    public java.util.List<com.google.maps.solar.v1.SolarPanel.Builder> getSolarPanelsBuilderList() {
      return internalGetSolarPanelsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.maps.solar.v1.SolarPanelConfig.Builder getSolarPanelConfigsBuilder(
        int index) {
      return internalGetSolarPanelConfigsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.solar.v1.SolarPanelConfig.Builder addSolarPanelConfigsBuilder() {
      return internalGetSolarPanelConfigsFieldBuilder()
    ...
    public java.util.List<com.google.maps.solar.v1.SolarPanelConfig.Builder>
      ...
      return internalGetSolarPanelConfigsFieldBuilder().getBuilderList();
    }
    ...
    public com.google.maps.solar.v1.FinancialAnalysis.Builder getFinancialAnalysesBuilder(
        int index) {
      return internalGetFinancialAnalysesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.solar.v1.FinancialAnalysis.Builder addFinancialAnalysesBuilder() {
      return internalGetFinancialAnalysesFieldBuilder()
    ...
    public java.util.List<com.google.maps.solar.v1.FinancialAnalysis.Builder>
      ...
      return internalGetFinancialAnalysesFieldBuilder().getBuilderList();
    }
