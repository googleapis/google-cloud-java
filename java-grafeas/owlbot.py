...
s.replace(
    f'owl-bot-staging/java-grafeas/v1/src/main/java/io/grafeas/v1/GrafeasGrpc.java',
    f"package io.grafeas.v1;",
    f"{license}\npackage io.grafeas.v1;"
)
s.replace(
    f'owl-bot-staging/java-grafeas/v1/src/**/GrafeasStubSettings.java',
