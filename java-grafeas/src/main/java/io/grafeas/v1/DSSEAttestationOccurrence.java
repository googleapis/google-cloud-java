...
public final class DSSEAttestationOccurrence extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DSSEAttestationOccurrence(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetStatementFieldBuilder().getBuilder(), extensionRegistry);
