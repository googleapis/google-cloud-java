...
public final class AttestationOccurrence extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AttestationOccurrence(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    public io.grafeas.v1.Signature.Builder addSignaturesBuilder() {
      return internalGetSignaturesFieldBuilder()
          .addBuilder(io.grafeas.v1.Signature.getDefaultInstance());
    }
    ...
    public io.grafeas.v1.Jwt.Builder getJwtsBuilder(int index) {
      return internalGetJwtsFieldBuilder().getBuilder(index);
    }
    ...
    public io.grafeas.v1.Jwt.Builder addJwtsBuilder() {
      return internalGetJwtsFieldBuilder().addBuilder(io.grafeas.v1.Jwt.getDefaultInstance());
    }
    ...
    public io.grafeas.v1.Jwt.Builder addJwtsBuilder(int index) {
      return internalGetJwtsFieldBuilder()
          .addBuilder(index, io.grafeas.v1.Jwt.getDefaultInstance());
    }
    ...
    public java.util.List<io.grafeas.v1.Jwt.Builder> getJwtsBuilderList() {
      return internalGetJwtsFieldBuilder().getBuilderList();
    }
    ...
    private com.google.protobuf.RepeatedFieldBuilder<
      ...
      if (jwtsBuilder_ == null) {
        jwtsBuilder_ =
            new com.google.protobuf.RepeatedFieldBuilder<
                io.grafeas.v1.Jwt, io.grafeas.v1.Jwt.Builder, io.grafeas.v1.JwtOrBuilder>(
                jwts_, ((bitField0_ & 0x00000004) != 0), getParentForChildren(), isClean());
        jwts_ = null;
      }
      return jwtsBuilder_;
    }
