...
public final class Upgrade {
  ...
  static {
    ...
    internal_static_grafeas_v1_UpgradeNote_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1_UpgradeNote_descriptor,
        new java.lang.String[] { "Package", "Version", "Distributions", "WindowsUpdate", });
    internal_static_grafeas_v1_UpgradeDistribution_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_grafeas_v1_UpgradeDistribution_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1_UpgradeDistribution_descriptor,
        new java.lang.String[] { "CpeUri", "Classification", "Severity", "Cve", });
    internal_static_grafeas_v1_WindowsUpdate_descriptor =
      getDescriptor().getMessageTypes().get(2);
    internal_static_grafeas_v1_WindowsUpdate_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1_WindowsUpdate_descriptor,
        new java.lang.String[] { "Identity", "Title", "Description", "Categories", "KbArticleIds", "SupportUrl", "LastPublishedTimestamp", });
    internal_static_grafeas_v1_WindowsUpdate_Identity_descriptor =
      internal_static_grafeas_v1_WindowsUpdate_descriptor.getNestedTypes().get(0);
    internal_static_grafeas_v1_WindowsUpdate_Identity_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1_WindowsUpdate_Identity_descriptor,
        new java.lang.String[] { "UpdateId", "Revision", });
    internal_static_grafeas_v1_WindowsUpdate_Category_descriptor =
      internal_static_grafeas_v1_WindowsUpdate_descriptor.getNestedTypes().get(1);
    internal_static_grafeas_v1_WindowsUpdate_Category_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1_WindowsUpdate_Category_descriptor,
        new java.lang.String[] { "CategoryId", "Name", });
    internal_static_grafeas_v1_UpgradeOccurrence_descriptor =
      getDescriptor().getMessageTypes().get(3);
    internal_static_grafeas_v1_UpgradeOccurrence_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_grafeas_v1_UpgradeOccurrence_descriptor,
        new java.lang.String[] { "Package", "ParsedVersion", "Distribution", "WindowsUpdate", });
    com.google.protobuf.TimestampProto.getDescriptor();
    io.grafeas.v1.Package.getDescriptor();
  }
