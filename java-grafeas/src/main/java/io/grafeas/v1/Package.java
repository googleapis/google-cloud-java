...
public final class Package extends com.google.protobuf.GeneratedFile {
  private Package() {}
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "grafeas.v1\032\037"
          + "google/api/field_behavior.proto\032\027grafeas/v1/common.proto\"\267\001\n"
          + "\014Distribution\022\024\n"
          + "\007cpe_uri\030\001 \001(\tB\003\340A\002\022.\n"
          + "\014architecture\030\002 \001(\0162\030.grafeas.v1.Architecture\022+\n"
          + "\016latest_version\030\003 \001(\0132\023.grafeas.v1.Version\022\022\n\n"
          + "maintainer\030\004 \001(\t\022\013\n"
          + "\003url\030\005 \001(\t\022\023\n"
          + "\013description\030\006 \001(\t\"O\n"
          + "\010Location\022\017\n"
          + "\007cpe_uri\030\001 \001(\t\022$\n"
          + "\007version\030\002 \001(\0132\023.grafeas.v1.Version\022\014\n"
          + "\004path\030\003 \001(\t\"\320\002\n"
          + "\013PackageNote\022\024\n"
          + "\004name\030\001 \001(\tB\006\340A\002\340A\005\022.\n"
          + "\014distribution\030\n"
          + " \003(\0132\030.grafeas.v1.Distribution\022\024\n"
          + "\014package_type\030\013 \001(\t\022\017\n"
          + "\007cpe_uri\030\014 \001(\t\022.\n"
          + "\014architecture\030\r"
          + " \001(\0162\030.grafeas.v1.Architecture\022$\n"
          + "\007version\030\016 \001(\0132\023.grafeas.v1.Version\022\022\n\n"
          + "maintainer\030\017 \001(\t\022\013\n"
          + "\003url\030\020 \001(\t\022\023\n"
          ...
          + "\021PackageOccurrence\022\024\n"
          + "\004name\030\001 \001(\tB\006\340A\002\340A\003\022&\n"
          + "\010location\030\002 \003(\0132\024.grafeas.v1.Location\022\031\n"
          + "\014package_type\030\003 \001(\tB\003\340A\003\022\024\n"
          + "\007cpe_uri\030\004 \001(\tB\003\340A\003\0223\n"
          + "\014architecture\030\005 \001(\0162\030.grafeas.v1.ArchitectureB\003\340A\003\022$\n"
          + "\007license\030\006 \001(\0132\023.grafeas.v1.License\022)\n"
          + "\007version\030\007 \001(\0132\023.grafeas.v1.VersionB\003\340A\003\"\340\001\n"
          + "\007Version\022\r\n"
          + "\005epoch\030\001 \001(\005\022\014\n"
          + "\004name\030\002 \001(\t\022\020\n"
          + "\010revision\030\003 \001(\t\022\021\n"
          + "\tinclusive\030\006 \001(\010\022-\n"
          ...
          + "\003X64\020\002BQ\n\r"
          + "io.grafeas.v1P\001Z8google.golang.org/genproto/googleapis/g"
    ...
    internal_static_grafeas_v1_Distribution_descriptor = getDescriptor().getMessageType(0);
    internal_static_grafeas_v1_Distribution_fieldAccessorTable =
    ...
    internal_static_grafeas_v1_Location_descriptor = getDescriptor().getMessageType(1);
    internal_static_grafeas_v1_Location_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_grafeas_v1_Location_descriptor,
            new java.lang.String[] {
    ...
    internal_static_grafeas_v1_PackageNote_descriptor = getDescriptor().getMessageType(2);
    internal_static_grafeas_v1_PackageNote_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_grafeas_v1_PackageNote_descriptor,
            new java.lang.String[] {
    ...
    internal_static_grafeas_v1_PackageOccurrence_descriptor = getDescriptor().getMessageType(3);
    internal_static_grafeas_v1_PackageOccurrence_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_grafeas_v1_PackageOccurrence_descriptor,
            new java.lang.String[] {
    ...
    internal_static_grafeas_v1_Version_descriptor = getDescriptor().getMessageType(4);
    internal_static_grafeas_v1_Version_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_grafeas_v1_Version_descriptor,
            new java.lang.String[] {
