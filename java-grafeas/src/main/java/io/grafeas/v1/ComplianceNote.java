...
public final class ComplianceNote extends com.google.protobuf.GeneratedMessageV3
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (potentialImpactCase_ == 8) {
      com.google.protobuf.GeneratedMessageV3.writeString(output, 8, potentialImpact_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (potentialImpactCase_ == 8) {
      size += com.google.protobuf.GeneratedMessageV3.computeStringSize(8, potentialImpact_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
