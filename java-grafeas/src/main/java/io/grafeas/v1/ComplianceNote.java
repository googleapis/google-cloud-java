...
public final class ComplianceNote extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ComplianceNote(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class CisBenchmark extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private CisBenchmark(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private int potentialImpactCase_ = 0;

  @SuppressWarnings("serial")
  private java.lang.Object potentialImpact_;

  public enum PotentialImpactCase
      implements
          com.google.protobuf.Internal.EnumLite,
          com.google.protobuf.AbstractMessage.InternalOneOfEnum {
    IMPACT(8),
    POTENTIALIMPACT_NOT_SET(0);
    private final int value;
     ...
     */
    @java.lang.Deprecated
    public static PotentialImpactCase valueOf(int value) {
      return forNumber(value);
    }

    public static PotentialImpactCase forNumber(int value) {
      switch (value) {
        case 8:
          return IMPACT;
        case 0:
          return POTENTIALIMPACT_NOT_SET;
        default:
          return null;
      }
    }
  ...
  public PotentialImpactCase getPotentialImpactCase() {
    return PotentialImpactCase.forNumber(potentialImpactCase_);
  }
  ...
  public java.lang.String getImpact() {
    ...
    if (potentialImpactCase_ == 8) {
      ref = potentialImpact_;
    }
    if (ref instanceof java.lang.String) {
      return (java.lang.String) ref;
    } else {
   ...
   */
  public com.google.protobuf.ByteString getImpactBytes() {
    java.lang.Object ref = "";
    if (potentialImpactCase_ == 8) {
      ref = potentialImpact_;
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(remediation_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, remediation_);
    }
    if (complianceTypeCase_ == 6) {
    ...
    if (potentialImpactCase_ == 8) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, potentialImpact_);
    }
    getUnknownFields().writeTo(output);
  }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(remediation_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, remediation_);
    }
    if (complianceTypeCase_ == 6) {
      size +=
    ...
    if (potentialImpactCase_ == 8) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, potentialImpact_);
    }
    size += getUnknownFields().getSerializedSize();
    memoizedSize = size;
    return size;
  ...
  public boolean equals(final java.lang.Object obj) {
    ...
    if (!getPotentialImpactCase().equals(other.getPotentialImpactCase())) return false;
    switch (potentialImpactCase_) {
      case 8:
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartialOneofs(io.grafeas.v1.ComplianceNote result) {
      ...
      result.potentialImpactCase_ = potentialImpactCase_;
      result.potentialImpact_ = this.potentialImpact_;
    }
    ...
    public Builder mergeFrom(io.grafeas.v1.ComplianceNote other) {
      ...
      if (!other.getScanInstructions().isEmpty()) {
      ...
      switch (other.getPotentialImpactCase()) {
        case IMPACT:
          {
            potentialImpactCase_ = 8;
            potentialImpact_ = other.potentialImpact_;
            onChanged();
            break;
          }
        case POTENTIALIMPACT_NOT_SET:
          {
            break;
          }
      }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50:
              {
                input.readMessage(
                    internalGetCisBenchmarkFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public Builder clearPotentialImpact() {
      potentialImpactCase_ = 0;
      potentialImpact_ = null;
      onChanged();
      return this;
    ...
    public io.grafeas.v1.ComplianceVersion.Builder getVersionBuilder(int index) {
      return internalGetVersionFieldBuilder().getBuilder(index);
    }
    ...
    public io.grafeas.v1.ComplianceVersion.Builder addVersionBuilder() {
      return internalGetVersionFieldBuilder()
    ...
    public java.util.List<io.grafeas.v1.ComplianceVersion.Builder> getVersionBuilderList() {
      return internalGetVersionFieldBuilder().getBuilderList();
    }
    ...
    public io.grafeas.v1.ComplianceNote.CisBenchmark.Builder getCisBenchmarkBuilder() {
      return internalGetCisBenchmarkFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            io.grafeas.v1.ComplianceNote.CisBenchmark.Builder,
            io.grafeas.v1.ComplianceNote.CisBenchmarkOrBuilder>
        internalGetCisBenchmarkFieldBuilder() {
      if (cisBenchmarkBuilder_ == null) {
        if (!(complianceTypeCase_ == 6)) {
          complianceType_ = io.grafeas.v1.ComplianceNote.CisBenchmark.getDefaultInstance();
        }
     ...
     * @return This builder for chaining.
     */
    public Builder setImpact(java.lang.String value) {
      if (value == null) {
        throw new NullPointerException();
      }
      potentialImpactCase_ = 8;
      potentialImpact_ = value;
      onChanged();
      return this;
    }
     ...
     * <code>string impact = 8;</code>
     *
     * @param value The bytes for impact to set.
     * @return This builder for chaining.
     */
    public Builder setImpactBytes(com.google.protobuf.ByteString value) {
      if (value == null) {
        throw new NullPointerException();
      }
      checkByteStringIsUtf8(value);
