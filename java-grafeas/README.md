...
```Groovy
implementation 'io.grafeas:grafeas:2.83.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "io.grafeas" % "grafeas" % "2.83.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/io.grafeas/grafeas/2.83.0
