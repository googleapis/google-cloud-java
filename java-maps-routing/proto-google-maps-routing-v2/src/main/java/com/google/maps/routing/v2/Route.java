...
public final class Route extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class RouteLocalizedValues extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private RouteLocalizedValues(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  private com.google.protobuf.Internal.IntList routeLabels_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      routeLabels_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.maps.routing.v2.RouteLabel>() {
            public com.google.maps.routing.v2.RouteLabel convert(int from) {
  ...
  public java.util.List<com.google.maps.routing.v2.RouteLabel> getRouteLabelsList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.maps.routing.v2.RouteLabel>(
  ...
  public com.google.maps.routing.v2.RouteLabel getRouteLabels(int index) {
    return routeLabels_converter_.convert(routeLabels_.getInt(index));
  }
  ...
  public int getRouteLabelsValue(int index) {
    return routeLabels_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(routeToken_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, routeToken_);
    }
    ...
    for (int i = 0; i < routeLabels_.size(); i++) {
      output.writeEnumNoTag(routeLabels_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(routeToken_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(12, routeToken_);
    }
    {
      int dataSize = 0;
      for (int i = 0; i < routeLabels_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(routeLabels_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetPolylineDetailsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106:
              {
                ...
                ensureRouteLabelsIsMutable();
                while (input.getBytesUntilLimit() > 0) {
                  routeLabels_.addInt(input.readEnum());
                }
                input.popLimit(limit);
                break;
              } // case 106
            case 114:
              {
                input.readMessage(
                    internalGetPolylineDetailsFieldBuilder().getBuilder(), extensionRegistry);
    ...
    private void ensureRouteLabelsIsMutable() {
      if (!routeLabels_.isModifiable()) {
        routeLabels_ = makeMutableCopy(routeLabels_);
      }
      bitField0_ |= 0x00000001;
    }
    ...
    public Builder setRouteLabels(int index, com.google.maps.routing.v2.RouteLabel value) {
      ...
      ensureRouteLabelsIsMutable();
      routeLabels_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addRouteLabels(com.google.maps.routing.v2.RouteLabel value) {
      ...
      ensureRouteLabelsIsMutable();
      routeLabels_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setRouteLabelsValue(int index, int value) {
      ensureRouteLabelsIsMutable();
      routeLabels_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public com.google.maps.routing.v2.PolylineDetails.Builder getPolylineDetailsBuilder() {
      bitField0_ |= 0x00002000;
      onChanged();
      return internalGetPolylineDetailsFieldBuilder().getBuilder();
    }
