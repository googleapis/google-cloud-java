...
public final class RouteModifiers extends com.google.protobuf.GeneratedMessage
  ...
  private com.google.protobuf.Internal.IntList tollPasses_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      tollPasses_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.maps.routing.v2.TollPass>() {
            public com.google.maps.routing.v2.TollPass convert(int from) {
  ...
  public java.util.List<com.google.maps.routing.v2.TollPass> getTollPassesList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.maps.routing.v2.TollPass>(
  ...
  public com.google.maps.routing.v2.TollPass getTollPasses(int index) {
    return tollPasses_converter_.convert(tollPasses_.getInt(index));
  }
  ...
  public int getTollPassesValue(int index) {
    return tollPasses_.getInt(index);
  }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < tollPasses_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(tollPasses_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetVehicleInfoFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 42:
              {
                input.readMessage(
                    internalGetVehicleInfoFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 50:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  tollPasses_.addInt(input.readEnum());
                }
    ...
    public com.google.maps.routing.v2.VehicleInfo.Builder getVehicleInfoBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetVehicleInfoFieldBuilder().getBuilder();
    }
    ...
    private void ensureTollPassesIsMutable() {
      if (!tollPasses_.isModifiable()) {
        tollPasses_ = makeMutableCopy(tollPasses_);
      }
      bitField0_ |= 0x00000020;
    }
    ...
    public Builder setTollPasses(int index, com.google.maps.routing.v2.TollPass value) {
      ...
      ensureTollPassesIsMutable();
      tollPasses_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addTollPasses(com.google.maps.routing.v2.TollPass value) {
      ...
      ensureTollPassesIsMutable();
      tollPasses_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setTollPassesValue(int index, int value) {
      ensureTollPassesIsMutable();
      tollPasses_.setInt(index, value);
      onChanged();
      return this;
    }
