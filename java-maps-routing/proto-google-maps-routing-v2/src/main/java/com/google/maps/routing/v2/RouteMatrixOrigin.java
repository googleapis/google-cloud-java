...
public final class RouteMatrixOrigin extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private RouteMatrixOrigin(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(
                    internalGetWaypointFieldBuilder().getBuilder(), extensionRegistry);
