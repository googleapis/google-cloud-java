...
public final class RouteMatrixElement extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private RouteMatrixElement(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
   ...
   */
  public static final class LocalizedValues extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private LocalizedValues(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          ...
          internalGetStaticDurationFieldBuilder();
          internalGetTransitFareFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetStaticDurationFieldBuilder().getBuilder(), extensionRegistry);
              ...
              case 34:
                {
                  input.readMessage(
                      internalGetTransitFareFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.type.LocalizedText.Builder getStaticDurationBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetStaticDurationFieldBuilder().getBuilder();
      }
      ...
      public com.google.type.LocalizedText.Builder getTransitFareBuilder() {
        bitField0_ |= 0x00000008;
        onChanged();
        return internalGetTransitFareFieldBuilder().getBuilder();
      }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetDurationFieldBuilder();
        internalGetStaticDurationFieldBuilder();
        internalGetTravelAdvisoryFieldBuilder();
        internalGetFallbackInfoFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 58:
              {
                input.readMessage(
                    internalGetTravelAdvisoryFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 66:
              {
                input.readMessage(
                    internalGetFallbackInfoFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.maps.routing.v2.RouteTravelAdvisory.Builder getTravelAdvisoryBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetTravelAdvisoryFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.routing.v2.FallbackInfo.Builder getFallbackInfoBuilder() {
      bitField0_ |= 0x00000100;
      onChanged();
      return internalGetFallbackInfoFieldBuilder().getBuilder();
    }
