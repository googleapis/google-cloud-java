...
public final class TransitPreferences extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TransitPreferences(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private TransitPreferences() {
    allowedTravelModes_ = emptyIntList();
  ...
  private com.google.protobuf.Internal.IntList allowedTravelModes_ = emptyIntList();
  ...
  public com.google.maps.routing.v2.TransitPreferences.TransitTravelMode getAllowedTravelModes(
      int index) {
    return allowedTravelModes_converter_.convert(allowedTravelModes_.getInt(index));
  }
  ...
  public int getAllowedTravelModesValue(int index) {
    return allowedTravelModes_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < allowedTravelModes_.size(); i++) {
      output.writeEnumNoTag(allowedTravelModes_.getInt(i));
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.maps.routing.v2.TransitPreferences result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        allowedTravelModes_.makeImmutable();
            ...
            case 8:
              {
                ...
                ensureAllowedTravelModesIsMutable();
                allowedTravelModes_.addInt(tmpRaw);
                break;
              } // case 8
            case 10:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  allowedTravelModes_.addInt(input.readEnum());
                }
    ...
    private void ensureAllowedTravelModesIsMutable() {
      if (!allowedTravelModes_.isModifiable()) {
        allowedTravelModes_ = makeMutableCopy(allowedTravelModes_);
      }
      bitField0_ |= 0x00000001;
    }
    ...
    public Builder setAllowedTravelModes(
      ...
      ensureAllowedTravelModesIsMutable();
      allowedTravelModes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedTravelModes(
      ...
      ensureAllowedTravelModesIsMutable();
      allowedTravelModes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setAllowedTravelModesValue(int index, int value) {
      ensureAllowedTravelModesIsMutable();
      allowedTravelModes_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addAllowedTravelModesValue(int value) {
      ensureAllowedTravelModesIsMutable();
      allowedTravelModes_.addInt(value);
      onChanged();
      return this;
    }
