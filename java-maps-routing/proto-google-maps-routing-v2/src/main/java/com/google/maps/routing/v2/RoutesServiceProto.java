...
public final class RoutesServiceProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "oogle/maps/routing/v2/fallback_info.proto\032.google/maps/routing/v2/geocoding_resu"
          + "lts.proto\032%google/maps/routing/v2/polyli"
          + "ne.proto\032\"google/maps/routing/v2/route.p"
          + "roto\032,google/maps/routing/v2/route_modifiers.proto\032.google/maps/routing/v2/route"
          + "_travel_mode.proto\032/google/maps/routing/v2/routing_preference.proto\032*google/maps"
          + "/routing/v2/traffic_model.proto\0320google/maps/routing/v2/transit_preferences.prot"
          ...
          + "tobuf/timestamp.proto\032\027google/rpc/status.proto\032"
          + " google/type/localized_text.proto\"\276\014\n"
          ...
          + " .google.maps.routing.v2.WaypointB\003\340A\002\022<\n\r"
          + "intermediates\030\003 \003(\0132 .google.maps.routing.v2.WaypointB\003\340A\001\022A\n"
          + "\013travel_mode\030\004"
          + " \001(\0162\'.google.maps.routing.v2.RouteTravelModeB\003\340A\001\022J\n"
          + "\022routing_preference\030\005"
          + " \001(\0162).google.maps.routing.v2.RoutingPreferenceB\003\340A\001\022F\n"
          + "\020polyline_quality\030\006"
          + " \001(\0162\'.google.maps.routing.v2.PolylineQualityB\003\340A\001\022H\n"
          + "\021polyline_encoding\030\014"
          + " \001(\0162(.google.maps.routing.v2.PolylineEncodingB\003\340A\001\0227\n"
          + "\016departure_time\030\007"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\001\0225\n"
          + "\014arrival_time\030\023"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\001\022\'\n"
          + "\032compute_alternative_routes\030\010 \001(\010B\003\340A\001\022D\n"
          + "\017route_modifiers\030\t"
          + " \001(\0132&.google.maps.routing.v2.RouteModifiersB\003\340A\001\022\032\n\r"
          + "language_code\030\n"
          + " \001(\tB\003\340A\001\022\030\n"
          + "\013region_code\030\020 \001(\tB\003\340A\001\0221\n"
          + "\005units\030\013 \001(\0162\035.google.maps.routing.v2.UnitsB\003\340A\001\022$\n"
          + "\027optimize_waypoint_order\030\r"
          + " \001(\010B\003\340A\001\022d\n"
          + "\032requested_reference_routes\030\016 \003(\0162;.google.maps.routing.v2.C"
          + "omputeRoutesRequest.ReferenceRouteB\003\340A\001\022^\n"
          + "\022extra_computations\030\017 \003(\0162=.google.map"
          + "s.routing.v2.ComputeRoutesRequest.ExtraComputationB\003\340A\001\022@\n\r"
          + "traffic_model\030\022 \001(\0162$"
          + ".google.maps.routing.v2.TrafficModelB\003\340A\001\022L\n"
          ...
          + "\020SHORTER_DISTANCE\020\002\"\262\002\n"
          ...
          + "&HTML_FORMATTED_NAVIGATION_INSTRUCTIONS\020\004\022\034\n"
          + "\030FLYOVER_INFO_ON_POLYLINE\020\007\022 \n"
          + "\034NARROW_ROAD_INFO_ON_POLYLINE\020\010\022\033\n"
          + "\027TUNNEL_INFO_ON_POLYLINE\020\t\022\033\n"
          + "\027BRIDGE_INFO_ON_POLYLINE\020\n"
          + "\022\033\n"
          + "\027SKYWAY_INFO_ON_POLYLINE\020\013\"\310\001\n"
          + "\025ComputeRoutesResponse\022-\n"
          + "\006routes\030\001 \003(\0132\035.google.maps.routing.v2.Route\022;\n\r"
          + "fallback_info\030\002 \001(\0132$.google.maps.routing.v2.FallbackInfo\022C\n"
          + "\021geocoding_results\030\003 \001"
          + "(\0132(.google.maps.routing.v2.GeocodingResults\"\306\006\n"
          + "\031ComputeRouteMatrixRequest\022?\n"
          + "\007origins\030\001"
          + " \003(\0132).google.maps.routing.v2.RouteMatrixOriginB\003\340A\002\022I\n"
          + "\014destinations\030\002 \003("
          + "\0132..google.maps.routing.v2.RouteMatrixDestinationB\003\340A\002\022A\n"
          + "\013travel_mode\030\003 \001(\0162\'.go"
          + "ogle.maps.routing.v2.RouteTravelModeB\003\340A\001\022J\n"
          + "\022routing_preference\030\004"
          + " \001(\0162).google.maps.routing.v2.RoutingPreferenceB\003\340A\001\0227\n"
          + "\016departure_time\030\005"
          + " \001(\0132\032.google.protobuf.TimestampB\003\340A\001\0225\n"
          + "\014arrival_time\030\013"
          ...
          + "\022extra_computations\030\010 \003"
          + "(\0162B.google.maps.routing.v2.ComputeRouteMatrixRequest.ExtraComputationB\003\340A\001\022@\n\r"
          + "traffic_model\030\n"
          + " \001(\0162$.google.maps.routing.v2.TrafficModelB\003\340A\001\022L\n"
          + "\023transit_preferences\030\014"
          + " \001(\0132*.google.maps.routing.v2.TransitPreferencesB\003\340A\001\"@\n"
          + "\020ExtraComputation\022!\n"
          + "\035EXTRA_COMPUTATION_UNSPECIFIED\020\000\022\t\n"
          ...
          + " \001(\0132&.google.maps.routing.v2.RouteModifiersB\003\340A\001\"Q\n"
          + "\026RouteMatrixDestination\0227\n"
          + "\010waypoint\030\001 \001(\0132 "
          + ".google.maps.routing.v2.WaypointB\003\340A\002\"\214\006\n"
          ...
          + "\tcondition\030\t"
          + " \001(\01623.google.maps.routing.v2.RouteMatrixElementCondition\022\027\n"
          + "\017distance_meters\030\004 \001(\005\022+\n"
          + "\010duration\030\005 \001(\0132\031.google.protobuf.Duration\0222\n"
          + "\017static_duration\030\006 \001(\0132\031.google.protobuf.Duration\022D\n"
          + "\017travel_advisory\030\007"
          + " \001(\0132+.google.maps.routing.v2.RouteTravelAdvisory\022;\n\r"
          + "fallback_info\030\010 \001(\0132$.google.maps.routing.v2.FallbackInfo\022T\n"
          + "\020localized_values\030\n"
          + " \001(\0132:.google.maps.routing.v2.RouteMatrixElement.LocalizedValues\032\324\001\n"
          ...
          + "*ROUTE_MATRIX_ELEMENT_CONDITION_UNSPECIFIED\020\000\022\020\n"
          + "\014ROUTE_EXISTS\020\001\022\023\n"
          + "\017ROUTE_NOT_FOUND\020\0022\344\002\n"
          + "\006Routes\022\225\001\n\r"
          + "ComputeRoutes\022,.google.maps.routing.v2.Compute"
          + "RoutesRequest\032-.google.maps.routing.v2.C"
          + "omputeRoutesResponse\"\'\202\323\344\223\002!\"\034/directions/v2:computeRoutes:\001*\022\247\001\n"
          + "\022ComputeRouteMatrix\0221.google.maps.routing.v2.ComputeRou"
          + "teMatrixRequest\032*.google.maps.routing.v2"
          + ".RouteMatrixElement\"0\202\323\344\223\002*\"%/distanceMa"
          + "trix/v2:computeRouteMatrix:\001*0\001\032\030\312A\025routes.googleapis.comB\304\001\n"
          + "\032com.google.maps.routing.v2B\022RoutesServiceProtoP\001Z:cloud.go"
          + "ogle.com/go/maps/routing/apiv2/routingpb"
          + ";routingpb\242\002\005GMRV2\252\002\026Google.Maps.Routing"
    ...
    internal_static_google_maps_routing_v2_RouteMatrixElement_LocalizedValues_descriptor =
        internal_static_google_maps_routing_v2_RouteMatrixElement_descriptor.getNestedType(0);
    internal_static_google_maps_routing_v2_RouteMatrixElement_LocalizedValues_fieldAccessorTable =
        new com.google.protobuf.GeneratedMessage.FieldAccessorTable(
            internal_static_google_maps_routing_v2_RouteMatrixElement_LocalizedValues_descriptor,
            new java.lang.String[] {
