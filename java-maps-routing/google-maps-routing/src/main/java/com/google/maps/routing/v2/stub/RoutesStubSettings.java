...
public class RoutesStubSettings extends StubSettings<RoutesStubSettings> {
  ...
  public RoutesStub createStub() throws IOException {
    if (getTransportChannelProvider()
      ...
      return GrpcRoutesStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
  ...
  public static String getDefaultEndpoint() {
    return "routes.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "routes.mtls.googleapis.com:443";
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return RoutesStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected LibraryMetadata getLibraryMetadata() {
    return LibraryMetadata.newBuilder()
        .setArtifactName("com.google.maps:google-maps-routing")
