...
```Scala
libraryDependencies += "com.google.maps" % "google-maps-routing" % "1.39.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.maps/google-maps-routing/1.39.0
