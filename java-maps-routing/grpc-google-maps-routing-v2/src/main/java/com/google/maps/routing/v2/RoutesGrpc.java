...
public final class RoutesGrpc {
  ...
  public static final java.lang.String SERVICE_NAME = "google.maps.routing.v2.Routes";
  ...
  public static RoutesBlockingV2Stub newBlockingV2Stub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<RoutesBlockingV2Stub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<RoutesBlockingV2Stub>() {
          @java.lang.Override
          public RoutesBlockingV2Stub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
            return new RoutesBlockingV2Stub(channel, callOptions);
          }
        };
    return RoutesBlockingV2Stub.newStub(factory, channel);
  }
   ...
   * </pre>
   */
  public static final class RoutesBlockingV2Stub
      extends io.grpc.stub.AbstractBlockingStub<RoutesBlockingV2Stub> {
    private RoutesBlockingV2Stub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected RoutesBlockingV2Stub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new RoutesBlockingV2Stub(channel, callOptions);
    }
    ...
    public io.grpc.stub.BlockingClientCall<?, com.google.maps.routing.v2.RouteMatrixElement>
        computeRouteMatrix(com.google.maps.routing.v2.ComputeRouteMatrixRequest request) {
  ...
  /**
   * A stub to allow clients to do limited synchronous rpc calls to service Routes.
   *
   * <pre>
   * The Routes API.
   * </pre>
  ...
  private static final class RoutesMethodDescriptorSupplier extends RoutesBaseDescriptorSupplier
    ...
    RoutesMethodDescriptorSupplier(java.lang.String methodName) {
