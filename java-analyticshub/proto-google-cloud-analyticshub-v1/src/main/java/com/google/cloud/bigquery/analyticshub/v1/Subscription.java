...
public final class Subscription extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class LinkedResource extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private LinkedResource(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(listing_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, listing_);
      }
      if (referenceCase_ == 3) {
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(listing_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, listing_);
      }
      if (referenceCase_ == 3) {
    ...
    public static final class GoogleCloudMarketplaceInfo
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(order_)) {
          com.google.protobuf.GeneratedMessage.writeString(output, 1, order_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        size = 0;
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(order_)) {
          size += com.google.protobuf.GeneratedMessage.computeStringSize(1, order_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSize = size;
        return size;
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(subscriberContact_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 9, subscriberContact_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(organizationDisplayName_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, organizationDisplayName_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(subscriberContact_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(9, subscriberContact_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(organizationDisplayName_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(10, organizationDisplayName_);
    }
    for (int i = 0; i < linkedResources_.size(); i++) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetLastModifyTimeFieldBuilder();
        internalGetLinkedResourcesFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                input.readMessage(
                    internalGetLastModifyTimeFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.protobuf.Timestamp.Builder getLastModifyTimeBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetLastModifyTimeFieldBuilder().getBuilder();
    }
    ...
    public com.google.cloud.bigquery.analyticshub.v1.Subscription.LinkedResource.Builder
      ...
      return internalGetLinkedResourcesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.cloud.bigquery.analyticshub.v1.Subscription.LinkedResource.Builder
      ...
      return internalGetLinkedResourcesFieldBuilder()
          .addBuilder(
              com.google.cloud.bigquery.analyticshub.v1.Subscription.LinkedResource
                  .getDefaultInstance());
    }
    ...
    public java.util.List<
      ...
      return internalGetLinkedResourcesFieldBuilder().getBuilderList();
    }
