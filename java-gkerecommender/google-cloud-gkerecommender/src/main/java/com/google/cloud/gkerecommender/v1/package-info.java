...
/**
 * A client to GKE Recommender API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= GkeInferenceQuickstartClient =======================
 *
 * <p>Service Description: GKE Inference Quickstart (GIQ) service provides profiles with performance
 ...
 *
 * <p>Sample for GkeInferenceQuickstartClient:
 *
 * <pre>{@code
