...
public final class ReferenceListServiceGrpc {
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = google.cloud.chronicle.v1.GetReferenceListRequest.class,
      responseType = google.cloud.chronicle.v1.ReferenceList.class,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = google.cloud.chronicle.v1.ListReferenceListsRequest.class,
      responseType = google.cloud.chronicle.v1.ListReferenceListsResponse.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          google.cloud.chronicle.v1.ListReferenceListsRequest,
          google.cloud.chronicle.v1.ListReferenceListsResponse>
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = google.cloud.chronicle.v1.CreateReferenceListRequest.class,
      responseType = google.cloud.chronicle.v1.ReferenceList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          google.cloud.chronicle.v1.CreateReferenceListRequest,
  ...
  @io.grpc.stub.annotations.RpcMethod(
      ...
      requestType = google.cloud.chronicle.v1.UpdateReferenceListRequest.class,
      responseType = google.cloud.chronicle.v1.ReferenceList.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          google.cloud.chronicle.v1.UpdateReferenceListRequest,
  ...
  public interface AsyncService {
    ...
    default void getReferenceList(
        ...
        io.grpc.stub.StreamObserver<google.cloud.chronicle.v1.ReferenceList> responseObserver) {
    ...
    default void listReferenceLists(
        ...
        io.grpc.stub.StreamObserver<google.cloud.chronicle.v1.ListReferenceListsResponse>
            responseObserver) {
      io.grpc.stub.ServerCalls.asyncUnimplementedUnaryCall(
  ...
  public static final class ReferenceListServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            google.cloud.chronicle.v1.ReferenceList>
        getReferenceList(google.cloud.chronicle.v1.GetReferenceListRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            google.cloud.chronicle.v1.ReferenceList>
        createReferenceList(google.cloud.chronicle.v1.CreateReferenceListRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            google.cloud.chronicle.v1.ReferenceList>
        updateReferenceList(google.cloud.chronicle.v1.UpdateReferenceListRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
      ...
      switch (methodId) {
        case METHODID_GET_REFERENCE_LIST:
          serviceImpl.getReferenceList(
              (google.cloud.chronicle.v1.GetReferenceListRequest) request,
              (io.grpc.stub.StreamObserver<google.cloud.chronicle.v1.ReferenceList>)
                  responseObserver);
          break;
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    google.cloud.chronicle.v1.GetReferenceListRequest,
                    google.cloud.chronicle.v1.ReferenceList>(service, METHODID_GET_REFERENCE_LIST)))
        .addMethod(
            getListReferenceListsMethod(),
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
  ...
  private abstract static class ReferenceListServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return google.cloud.chronicle.v1.ReferenceListProto.getDescriptor();
    }
