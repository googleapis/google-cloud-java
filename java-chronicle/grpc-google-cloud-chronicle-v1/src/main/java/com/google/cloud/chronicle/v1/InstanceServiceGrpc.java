...
public final class InstanceServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloud.chronicle.v1.GetInstanceRequest, com.google.cloud.chronicle.v1.Instance>
      getGetInstanceMethod;

  @io.grpc.stub.annotations.RpcMethod(
      fullMethodName = SERVICE_NAME + '/' + "GetInstance",
      requestType = com.google.cloud.chronicle.v1.GetInstanceRequest.class,
      responseType = com.google.cloud.chronicle.v1.Instance.class,
      methodType = io.grpc.MethodDescriptor.MethodType.UNARY)
  public static io.grpc.MethodDescriptor<
          com.google.cloud.chronicle.v1.GetInstanceRequest, com.google.cloud.chronicle.v1.Instance>
      getGetInstanceMethod() {
    io.grpc.MethodDescriptor<
            com.google.cloud.chronicle.v1.GetInstanceRequest,
            com.google.cloud.chronicle.v1.Instance>
        getGetInstanceMethod;
              ...
              getGetInstanceMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.chronicle.v1.Instance.getDefaultInstance()))
                      .setSchemaDescriptor(
  ...
  public interface AsyncService {
    ...
    default void getInstance(
        ...
        io.grpc.stub.StreamObserver<com.google.cloud.chronicle.v1.Instance> responseObserver) {
  ...
  public static final class InstanceServiceFutureStub
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.chronicle.v1.Instance>
        getInstance(com.google.cloud.chronicle.v1.GetInstanceRequest request) {
      ...
      switch (methodId) {
        case METHODID_GET_INSTANCE:
          serviceImpl.getInstance(
              (com.google.cloud.chronicle.v1.GetInstanceRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.chronicle.v1.Instance>)
                  responseObserver);
          break;
        default:
    ...
    return io.grpc.ServerServiceDefinition.builder(getServiceDescriptor())
        .addMethod(
            ...
            io.grpc.stub.ServerCalls.asyncUnaryCall(
                new MethodHandlers<
                    com.google.cloud.chronicle.v1.GetInstanceRequest,
                    com.google.cloud.chronicle.v1.Instance>(service, METHODID_GET_INSTANCE)))
        .build();
  }
  ...
  private abstract static class InstanceServiceBaseDescriptorSupplier
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.google.cloud.chronicle.v1.InstanceProto.getDescriptor();
    }
