...
/**
 * Base stub class for the DashboardChartService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@NullMarked
@Generated("by gapic-generator-java")
public abstract class DashboardChartServiceStub implements BackgroundResource {

  public UnaryCallable<GetDashboardChartRequest, DashboardChart> getDashboardChartCallable() {
    throw new UnsupportedOperationException("Not implemented: getDashboardChartCallable()");
  }

  public UnaryCallable<BatchGetDashboardChartsRequest, BatchGetDashboardChartsResponse>
      batchGetDashboardChartsCallable() {
    throw new UnsupportedOperationException("Not implemented: batchGetDashboardChartsCallable()");
  }
