...
public class RuleExecutionErrorServiceStubSettings
    extends StubSettings<RuleExecutionErrorServiceStubSettings> {
  ...
  private static final PagedListDescriptor<
      ...
      LIST_RULE_EXECUTION_ERRORS_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public Iterable<RuleExecutionError> extractResources(
  ...
  private static final PagedListResponseFactory<
      ...
      LIST_RULE_EXECUTION_ERRORS_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ...
              ListRuleExecutionErrorsPagedResponse>() {
            @Override
            public ApiFuture<ListRuleExecutionErrorsPagedResponse> getFuturePagedResponse(
  ...
  public static class Builder
      extends StubSettings.Builder<RuleExecutionErrorServiceStubSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      ...
      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(listRuleExecutionErrorsSettings);
      initDefaults(this);
    }
