 ...
 * }</pre>
 *
 * <p>Note: close() needs to be called on the InstanceServiceClient object to clean up resources
 ...
 *
 * <p>This class can be customized by passing in a custom instance of InstanceServiceSettings to
 * create(). For example:
 *
...
public class InstanceServiceClient implements BackgroundResource {
  ...
  public static final InstanceServiceClient create() throws IOException {
    return create(InstanceServiceSettings.newBuilder().build());
  }

  /**
   * Constructs an instance of InstanceServiceClient, using the given settings. The channels are
  ...
  /**
   * Constructs an instance of InstanceServiceClient, using the given stub for making calls. This is
   * for advanced usage - prefer using create(InstanceServiceSettings).
   */
  ...
  /**
   * Constructs an instance of InstanceServiceClient, using the given settings. This is protected so
