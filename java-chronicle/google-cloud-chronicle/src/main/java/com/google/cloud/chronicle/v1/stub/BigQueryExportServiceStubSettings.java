...
/**
 * Settings class to configure an instance of {@link BigQueryExportServiceStub}.
 *
...
public class BigQueryExportServiceStubSettings
    extends StubSettings<BigQueryExportServiceStubSettings> {
  ...
  private final UnaryCallSettings<ProvisionBigQueryExportRequest, BigQueryExport>
  ...
  public UnaryCallSettings<ProvisionBigQueryExportRequest, BigQueryExport>
      provisionBigQueryExportSettings() {
    return provisionBigQueryExportSettings;
  }

  public BigQueryExportServiceStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcBigQueryExportServiceStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonBigQueryExportServiceStub.create(this);
    }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(BigQueryExportServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return BigQueryExportServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected BigQueryExportServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    provisionBigQueryExportSettings = settingsBuilder.provisionBigQueryExportSettings().build();
  }
  ...
  /** Builder for BigQueryExportServiceStubSettings. */
  public static class Builder
      extends StubSettings.Builder<BigQueryExportServiceStubSettings, Builder> {
    ...
    private final UnaryCallSettings.Builder<UpdateBigQueryExportRequest, BigQueryExport>
        updateBigQueryExportSettings;
    private final UnaryCallSettings.Builder<ProvisionBigQueryExportRequest, BigQueryExport>
        provisionBigQueryExportSettings;
    ...
    protected Builder(ClientContext clientContext) {
      ...
      provisionBigQueryExportSettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
    ...
    protected Builder(BigQueryExportServiceStubSettings settings) {
      super(settings);
      ...
      provisionBigQueryExportSettings = settings.provisionBigQueryExportSettings.toBuilder();
    ...
    @Override
    public BigQueryExportServiceStubSettings build() throws IOException {
      return new BigQueryExportServiceStubSettings(this);
    }
  }
}
