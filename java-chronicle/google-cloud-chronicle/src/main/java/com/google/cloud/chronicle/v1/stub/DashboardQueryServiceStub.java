...
/**
 * Base stub class for the DashboardQueryService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator-java")
public abstract class DashboardQueryServiceStub implements BackgroundResource {

  public UnaryCallable<GetDashboardQueryRequest, DashboardQuery> getDashboardQueryCallable() {
    throw new UnsupportedOperationException("Not implemented: getDashboardQueryCallable()");
  }

  public UnaryCallable<ExecuteDashboardQueryRequest, ExecuteDashboardQueryResponse>
      executeDashboardQueryCallable() {
    throw new UnsupportedOperationException("Not implemented: executeDashboardQueryCallable()");
  }
