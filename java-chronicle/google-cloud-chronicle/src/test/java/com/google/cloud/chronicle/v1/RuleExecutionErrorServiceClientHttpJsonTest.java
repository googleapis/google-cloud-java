...
import com.google.cloud.chronicle.v1.stub.HttpJsonRuleExecutionErrorServiceStub;
...
public class RuleExecutionErrorServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static RuleExecutionErrorServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonRuleExecutionErrorServiceStub.getMethodDescriptors(),
            RuleExecutionErrorServiceSettings.getDefaultEndpoint());
    RuleExecutionErrorServiceSettings settings =
        RuleExecutionErrorServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                RuleExecutionErrorServiceSettings.defaultHttpJsonTransportProviderBuilder()
