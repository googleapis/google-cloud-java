...
import com.google.cloud.chronicle.v1.stub.HttpJsonBigQueryExportServiceStub;
...
public class BigQueryExportServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static BigQueryExportServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonBigQueryExportServiceStub.getMethodDescriptors(),
            BigQueryExportServiceSettings.getDefaultEndpoint());
    BigQueryExportServiceSettings settings =
        BigQueryExportServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                BigQueryExportServiceSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void getBigQueryExportTest2() throws Exception {
    ...
    String name =
        "projects/project-1911/locations/location-1911/instances/instance-1911/bigQueryExport";
