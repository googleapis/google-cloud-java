...
public class NativeDashboardName implements ResourceName {
  ...
  public static @Nullable NativeDashboardName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable NativeDashboardName> values) {
