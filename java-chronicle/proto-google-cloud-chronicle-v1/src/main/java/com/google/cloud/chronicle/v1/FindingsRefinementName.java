...
public class FindingsRefinementName implements ResourceName {
  ...
  @Deprecated
  protected FindingsRefinementName() {
    project = null;
    location = null;
    instance = null;
  ...
  private FindingsRefinementName(Builder builder) {
  ...
  public static FindingsRefinementName of(
  ...
  public static @Nullable FindingsRefinementName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_INSTANCE_FINDINGS_REFINEMENT.validatedMatch(
            formattedString, "FindingsRefinementName.parse: formattedString not in valid format");
    return of(
  ...
  public static List<FindingsRefinementName> parseList(List<String> formattedStrings) {
    List<FindingsRefinementName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable FindingsRefinementName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (FindingsRefinementName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      FindingsRefinementName that = ((FindingsRefinementName) o);
  ...
  public static class Builder {
    ...
    private Builder(FindingsRefinementName findingsRefinementName) {
      this.project = findingsRefinementName.project;
      this.location = findingsRefinementName.location;
      this.instance = findingsRefinementName.instance;
      this.findingsRefinement = findingsRefinementName.findingsRefinement;
    }

    public FindingsRefinementName build() {
      return new FindingsRefinementName(this);
    }
  }
}
