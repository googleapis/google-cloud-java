...
public class BigQueryExportName implements ResourceName {
  ...
  public static BigQueryExportName of(String project, String location, String instance) {
  ...
  public static BigQueryExportName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_INSTANCE.validatedMatch(
            formattedString, "BigQueryExportName.parse: formattedString not in valid format");
  ...
  /** Builder for projects/{project}/locations/{location}/instances/{instance}/bigQueryExport. */
  public static class Builder {
    ...
    private Builder(BigQueryExportName bigQueryExportName) {
      this.project = bigQueryExportName.project;
      this.location = bigQueryExportName.location;
      this.instance = bigQueryExportName.instance;
    }
