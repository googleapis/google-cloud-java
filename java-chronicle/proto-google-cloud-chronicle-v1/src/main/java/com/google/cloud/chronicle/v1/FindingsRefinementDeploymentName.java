...
public class FindingsRefinementDeploymentName implements ResourceName {
  ...
  public static @Nullable FindingsRefinementDeploymentName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable FindingsRefinementDeploymentName> values) {
