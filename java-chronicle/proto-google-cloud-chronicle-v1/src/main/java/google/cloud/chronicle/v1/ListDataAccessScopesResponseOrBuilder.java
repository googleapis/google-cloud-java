...
public interface ListDataAccessScopesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.chronicle.v1.ListDataAccessScopesResponse)
   ...
   * <code>repeated .google.cloud.chronicle.v1.DataAccessScope data_access_scopes = 1;</code>
   */
  google.cloud.chronicle.v1.DataAccessScopeOrBuilder getDataAccessScopesOrBuilder(int index);
   ...
   */
  boolean getGlobalDataAccessScopeGranted();
