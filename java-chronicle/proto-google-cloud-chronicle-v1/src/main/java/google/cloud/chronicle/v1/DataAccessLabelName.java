...
public class DataAccessLabelName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_INSTANCE_DATA_ACCESS_LABEL =
  ...
  private DataAccessLabelName(Builder builder) {
    ...
    dataAccessLabel = Preconditions.checkNotNull(builder.getDataAccessLabel());
  }
  ...
  public static DataAccessLabelName of(
      String project, String location, String instance, String dataAccessLabel) {
    return newBuilder()
        .setProject(project)
  ...
  public static DataAccessLabelName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_INSTANCE_DATA_ACCESS_LABEL.validatedMatch(
            formattedString, "DataAccessLabelName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"),
        matchMap.get("location"),
        matchMap.get("instance"),
        matchMap.get("data_access_label"));
  }

  public static List<DataAccessLabelName> parseList(List<String> formattedStrings) {
    List<DataAccessLabelName> list = new ArrayList<>(formattedStrings.size());
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (dataAccessLabel != null) {
            fieldMapBuilder.put("data_access_label", dataAccessLabel);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_INSTANCE_DATA_ACCESS_LABEL.instantiate(
        "project",
        project,
        "location",
        location,
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.dataAccessLabel, that.dataAccessLabel);
    }
    return false;
  }
  ...
  public int hashCode() {
    ...
    h *= 1000003;
    h ^= Objects.hashCode(dataAccessLabel);
    return h;
  }
