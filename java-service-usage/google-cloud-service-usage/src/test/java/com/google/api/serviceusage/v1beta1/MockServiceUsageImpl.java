...
import com.google.api.serviceusage.v1beta1.ServiceUsageGrpc.ServiceUsageImplBase;
...
public class MockServiceUsageImpl extends ServiceUsageImplBase {
  private List<AbstractMessage> requests;
  private Queue<Object> responses;

  public MockServiceUsageImpl() {
  ...
  public void batchEnableServices(
      BatchEnableServicesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method BatchEnableServices, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void listConsumerQuotaMetrics(
      ...
      StreamObserver<ListConsumerQuotaMetricsResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListConsumerQuotaMetricsResponse) {
      requests.add(request);
      responseObserver.onNext(((ListConsumerQuotaMetricsResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void getConsumerQuotaMetric(
      GetConsumerQuotaMetricRequest request, StreamObserver<ConsumerQuotaMetric> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ConsumerQuotaMetric) {
      requests.add(request);
      responseObserver.onNext(((ConsumerQuotaMetric) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void getConsumerQuotaLimit(
      GetConsumerQuotaLimitRequest request, StreamObserver<ConsumerQuotaLimit> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ConsumerQuotaLimit) {
      requests.add(request);
      responseObserver.onNext(((ConsumerQuotaLimit) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void createAdminOverride(
      CreateAdminOverrideRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method CreateAdminOverride, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void updateAdminOverride(
      UpdateAdminOverrideRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method UpdateAdminOverride, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void deleteAdminOverride(
      DeleteAdminOverrideRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
      ...
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method DeleteAdminOverride, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  Operation.class.getName(),
                  Exception.class.getName())));
    }
  ...
  public void listAdminOverrides(
      ...
      StreamObserver<ListAdminOverridesResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListAdminOverridesResponse) {
      requests.add(request);
      responseObserver.onNext(((ListAdminOverridesResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
      responseObserver.onError(
          new IllegalArgumentException(
              String.format(
                  "Unrecognized response type %s for method ListAdminOverrides, expected %s or %s",
                  response == null ? "null" : response.getClass().getName(),
                  ListAdminOverridesResponse.class.getName(),
                  Exception.class.getName())));
    }
  }
  ...
  public void importAdminOverrides(
      ImportAdminOverridesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void createConsumerOverride(
      CreateConsumerOverrideRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void updateConsumerOverride(
      UpdateConsumerOverrideRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void deleteConsumerOverride(
      DeleteConsumerOverrideRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void listConsumerOverrides(
      ...
      StreamObserver<ListConsumerOverridesResponse> responseObserver) {
    Object response = responses.poll();
    if (response instanceof ListConsumerOverridesResponse) {
      requests.add(request);
      responseObserver.onNext(((ListConsumerOverridesResponse) response));
      responseObserver.onCompleted();
    } else if (response instanceof Exception) {
      responseObserver.onError(((Exception) response));
    } else {
  ...
  public void importConsumerOverrides(
      ImportConsumerOverridesRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
  ...
  public void generateServiceIdentity(
      GenerateServiceIdentityRequest request, StreamObserver<Operation> responseObserver) {
    Object response = responses.poll();
    if (response instanceof Operation) {
      requests.add(request);
      responseObserver.onNext(((Operation) response));
