...
public final class UpdateConsumerOverrideRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private UpdateConsumerOverrideRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetOverrideFieldBuilder().getBuilder(), extensionRegistry);
