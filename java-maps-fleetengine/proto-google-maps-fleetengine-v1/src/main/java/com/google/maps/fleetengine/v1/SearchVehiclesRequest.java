...
public final class SearchVehiclesRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private SearchVehiclesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private SearchVehiclesRequest() {
    parent_ = "";
    tripTypes_ = emptyIntList();
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList tripTypes_ = emptyIntList();
  ...
  public com.google.maps.fleetengine.v1.TripType getTripTypes(int index) {
    return tripTypes_converter_.convert(tripTypes_.getInt(index));
  }
  ...
  public int getTripTypesValue(int index) {
    return tripTypes_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < tripTypes_.size(); i++) {
      output.writeEnumNoTag(tripTypes_.getInt(i));
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tripId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 19, tripId_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(filter_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 22, filter_);
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < tripTypes_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(tripTypes_.getInt(i));
      }
      size += dataSize;
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(tripId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(19, tripId_);
    }
    for (int i = 0; i < requiredOneOfAttributeSets_.size(); i++) {
      size +=
          com.google.protobuf.CodedOutputStream.computeMessageSize(
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(filter_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(22, filter_);
    }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetMaximumStalenessFieldBuilder();
        internalGetVehicleTypesFieldBuilder();
        internalGetRequiredAttributesFieldBuilder();
        internalGetRequiredOneOfAttributesFieldBuilder();
        internalGetRequiredOneOfAttributeSetsFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 74:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  tripTypes_.addInt(input.readEnum());
                }
            ...
            case 82:
              {
                input.readMessage(
                    internalGetMaximumStalenessFieldBuilder().getBuilder(), extensionRegistry);
    ...
    private void ensureTripTypesIsMutable() {
      if (!tripTypes_.isModifiable()) {
        tripTypes_ = makeMutableCopy(tripTypes_);
      }
      bitField0_ |= 0x00000080;
    }
    ...
    public java.util.List<com.google.maps.fleetengine.v1.TripType> getTripTypesList() {
      return new com.google.protobuf.Internal.IntListAdapter<
          com.google.maps.fleetengine.v1.TripType>(tripTypes_, tripTypes_converter_);
    }
    ...
    public Builder setTripTypes(int index, com.google.maps.fleetengine.v1.TripType value) {
      ...
      ensureTripTypesIsMutable();
      tripTypes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addTripTypes(com.google.maps.fleetengine.v1.TripType value) {
      ...
      ensureTripTypesIsMutable();
      tripTypes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public com.google.protobuf.Duration.Builder getMaximumStalenessBuilder() {
      bitField0_ |= 0x00000100;
      onChanged();
      return internalGetMaximumStalenessFieldBuilder().getBuilder();
    }
    ...
    public com.google.maps.fleetengine.v1.Vehicle.VehicleType.Builder getVehicleTypesBuilder(
        int index) {
      return internalGetVehicleTypesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.fleetengine.v1.Vehicle.VehicleType.Builder addVehicleTypesBuilder() {
      return internalGetVehicleTypesFieldBuilder()
    ...
    public java.util.List<com.google.maps.fleetengine.v1.Vehicle.VehicleType.Builder>
      ...
      return internalGetVehicleTypesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.maps.fleetengine.v1.VehicleAttribute.Builder getRequiredAttributesBuilder(
        int index) {
      return internalGetRequiredAttributesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.fleetengine.v1.VehicleAttribute.Builder addRequiredAttributesBuilder() {
      return internalGetRequiredAttributesFieldBuilder()
    ...
    public java.util.List<com.google.maps.fleetengine.v1.VehicleAttribute.Builder>
      ...
      return internalGetRequiredAttributesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.maps.fleetengine.v1.VehicleAttributeList.Builder
      ...
      return internalGetRequiredOneOfAttributesFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.fleetengine.v1.VehicleAttributeList.Builder
      ...
      return internalGetRequiredOneOfAttributesFieldBuilder()
    ...
    public java.util.List<com.google.maps.fleetengine.v1.VehicleAttributeList.Builder>
      ...
      return internalGetRequiredOneOfAttributesFieldBuilder().getBuilderList();
    }
    ...
    public com.google.maps.fleetengine.v1.VehicleAttributeList.Builder
      ...
      return internalGetRequiredOneOfAttributeSetsFieldBuilder().getBuilder(index);
    }
    ...
    public com.google.maps.fleetengine.v1.VehicleAttributeList.Builder
      ...
      return internalGetRequiredOneOfAttributeSetsFieldBuilder()
          .addBuilder(com.google.maps.fleetengine.v1.VehicleAttributeList.getDefaultInstance());
    }
    ...
    public java.util.List<com.google.maps.fleetengine.v1.VehicleAttributeList.Builder>
      ...
      return internalGetRequiredOneOfAttributeSetsFieldBuilder().getBuilderList();
    }
