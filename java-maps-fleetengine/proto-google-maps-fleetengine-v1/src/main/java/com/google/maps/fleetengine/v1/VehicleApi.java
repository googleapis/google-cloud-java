  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "cles.proto\032\036google/protobuf/duration.proto\032"
          + " google/protobuf/field_mask.proto\032\037go"
          + "ogle/protobuf/timestamp.proto\032\036google/pr"
          + "otobuf/wrappers.proto\032\030google/type/latlng.proto\"\254\001\n"
          ...
          + "vehicle_types\030\016 \003(\0132(.maps"
          + ".fleetengine.v1.Vehicle.VehicleTypeB\003\340A\002\022B\n"
          ...
          + ".fleetengine.v1.SearchVehiclesRequest.CurrentTripsPresent\022\023\n"
          ...
          + "eetengine.v1.VehicleMatch.VehicleMatchType\022Z\n"
          + "\024requested_ordered_by\030\t \001(\0162<.maps."
          + "fleetengine.v1.SearchVehiclesRequest.VehicleMatchOrder\022P\n\n"
          + "ordered_by\030\n"
          ...
          + "attributes\030\001 \003(\0132%.maps.fleetengine.v1.VehicleAttribute2\362\t\n"
          + "\016VehicleService\022\267\001\n\r"
          + "CreateVehicle\022).maps.fleetengine.v1.CreateVehicleReq"
          + "uest\032\034.maps.fleetengine.v1.Vehicle\"]\202\323\344\223"
          + "\002,\"!/v1/{parent=providers/*}/vehicles:\007vehicle\212\323\344\223\002%\022#\n"
          + "\006parent\022\031{provider_id=providers/*}\022\246\001\n\n"
          + "GetVehicle\022&.maps.fleetengine.v1.GetVehicleRequest\032\034.maps.fleeteng"
          + "ine.v1.Vehicle\"R\202\323\344\223\002#\022!/v1/{name=providers/*/vehicles/*}\212\323\344\223\002#\022!\n"
          + "\004name\022\031{provider_id=providers/*}\022\265\001\n\r"
          + "UpdateVehicle\022).maps.fleetengine.v1.UpdateVehicleRequest\032"
          + "\034.maps.fleetengine.v1.Vehicle\"[\202\323\344\223\002,\032!/"
          + "v1/{name=providers/*/vehicles/*}:\007vehicle\212\323\344\223\002#\022!\n"
          + "\004name\022\031{provider_id=providers/*}\022\354\001\n"
          + "\027UpdateVehicleAttributes\0223.maps.fleetengine.v1.UpdateVehicleAttributesRequ"
          + "est\0324.maps.fleetengine.v1.UpdateVehicleA"
          + "ttributesResponse\"f\202\323\344\223\0027\"2/v1/{name=pro"
          + "viders/*/vehicles/*}:updateAttributes:\001*\212\323\344\223\002#\022!\n"
          + "\004name\022\031{provider_id=providers/*}\022\271\001\n"
          + "\014ListVehicles\022(.maps.fleetengine.v1.ListVehiclesRequest\032).maps.fleetengine."
          + "v1.ListVehiclesResponse\"T\202\323\344\223\002#\022!/v1/{parent=providers/*}/vehicles\212\323\344\223\002%\022#\n"
          + "\006parent\022\031{provider_id=providers/*}\022\311\001\n"
          + "\016SearchVehicles\022*.maps.fleetengine.v1.SearchVeh"
          + "iclesRequest\032+.maps.fleetengine.v1.Searc"
          + "hVehiclesResponse\"^\202\323\344\223\002-\"(/v1/{parent=providers/*}/vehicles:search:\001*\212\323\344\223\002%\022#\n"
          + "\006parent\022\031{provider_id=providers/*}\032N\312A\032fl"
          + "eetengine.googleapis.com\322A.https://www.googleapis.com/auth/cloud-platformB\326\001\n"
          + "\036com.google.maps.fleetengine.v1B\n"
          + "VehicleApiP\001ZFcloud.google.com/go/maps/fleetengine"
          + "/apiv1/fleetenginepb;fleetenginepb\242\002\003CFE"
          + "\252\002\032Google.Maps.FleetEngine.V1\312\002\032Google\\M"
          + "aps\\FleetEngine\\V1\352\002\035Google::Maps::FleetEngine::V1b\006proto3"
    };
    descriptor =
