...
public final class ListVehiclesRequest extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private ListVehiclesRequest(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  private ListVehiclesRequest() {
    ...
    vehicleTypeCategories_ = emptyIntList();
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList vehicleTypeCategories_ = emptyIntList();

  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.maps.fleetengine.v1.Vehicle.VehicleType.Category>
      vehicleTypeCategories_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.maps.fleetengine.v1.Vehicle.VehicleType.Category>() {
            public com.google.maps.fleetengine.v1.Vehicle.VehicleType.Category convert(int from) {
  ...
  public com.google.maps.fleetengine.v1.Vehicle.VehicleType.Category getVehicleTypeCategories(
      int index) {
    return vehicleTypeCategories_converter_.convert(vehicleTypeCategories_.getInt(index));
  }
  ...
  public int getVehicleTypeCategoriesValue(int index) {
    return vehicleTypeCategories_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < vehicleTypeCategories_.size(); i++) {
      output.writeEnumNoTag(vehicleTypeCategories_.getInt(i));
    }
    for (int i = 0; i < requiredAttributes_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, requiredAttributes_.getRaw(i));
    }
    if (vehicleState_
      ...
      for (int i = 0; i < vehicleTypeCategories_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(
                vehicleTypeCategories_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetMinimumCapacityFieldBuilder();
    ...
    private void buildPartial0(com.google.maps.fleetengine.v1.ListVehiclesRequest result) {
      ...
      if (((from_bitField0_ & 0x00000080) != 0)) {
        vehicleTypeCategories_.makeImmutable();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 50:
              {
                input.readMessage(
                    internalGetMinimumCapacityFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 72:
              {
                int tmpRaw = input.readEnum();
                ensureVehicleTypeCategoriesIsMutable();
                vehicleTypeCategories_.addInt(tmpRaw);
                break;
              } // case 72
            case 74:
              {
                ...
                ensureVehicleTypeCategoriesIsMutable();
                while (input.getBytesUntilLimit() > 0) {
                  vehicleTypeCategories_.addInt(input.readEnum());
                }
                input.popLimit(limit);
                break;
              } // case 74
    ...
    public com.google.protobuf.Int32Value.Builder getMinimumCapacityBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetMinimumCapacityFieldBuilder().getBuilder();
    }
    ...
    private void ensureVehicleTypeCategoriesIsMutable() {
      if (!vehicleTypeCategories_.isModifiable()) {
        vehicleTypeCategories_ = makeMutableCopy(vehicleTypeCategories_);
      }
      bitField0_ |= 0x00000080;
    }
    ...
    public Builder setVehicleTypeCategories(
      ...
      ensureVehicleTypeCategoriesIsMutable();
      vehicleTypeCategories_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addVehicleTypeCategories(
      ...
      ensureVehicleTypeCategoriesIsMutable();
      vehicleTypeCategories_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setVehicleTypeCategoriesValue(int index, int value) {
      ensureVehicleTypeCategoriesIsMutable();
      vehicleTypeCategories_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public Builder addVehicleTypeCategoriesValue(int value) {
      ensureVehicleTypeCategoriesIsMutable();
      vehicleTypeCategories_.addInt(value);
      onChanged();
      return this;
    }
