 ...
 *    <tr>
 *      <td><p> CreateTrip</td>
 *      <td><p> Creates a trip in the Fleet Engine and returns the new trip.</td>
 *      <td>
 ...
 *    <tr>
 *      <td><p> GetTrip</td>
 *      <td><p> Get information about a single trip.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> reportBillableTrip(ReportBillableTripRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> reportBillableTripCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> SearchTrips</td>
 *      <td><p> Get all the trips for a specific vehicle.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> searchTrips(SearchTripsRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> searchTripsPagedCallable()
 *           <li><p> searchTripsCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td><p> UpdateTrip</td>
 *      <td><p> Updates trip data.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li><p> updateTrip(UpdateTripRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li><p> updateTripCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *  </table>
