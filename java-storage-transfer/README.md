...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage-transfer" % "1.80.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-storage-transfer/1.80.0
