...
```Groovy
compile 'com.google.cloud:google-cloud-storage-transfer:0.0.0'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-storage-transfer" % "0.0.0"
```
...
[enable-api]: https://console.cloud.google.com/flows/enableapi?apiid=storage-transfer.googleapis.com
