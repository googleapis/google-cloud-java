...
public interface NetworkInterfaceOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.NetworkInterface)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.backupdr.v1beta.AccessConfig> getAccessConfigsList();
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.AccessConfig getAccessConfigs(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.backupdr.v1beta.AccessConfigOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.AccessConfigOrBuilder getAccessConfigsOrBuilder(int index);
   ...
   * </code>
   */
  java.util.List<com.google.cloud.backupdr.v1beta.AccessConfig> getIpv6AccessConfigsList();
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.AccessConfig getIpv6AccessConfigs(int index);
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.AccessConfigOrBuilder getIpv6AccessConfigsOrBuilder(int index);
   ...
   * </code>
   */
  java.util.List<com.google.cloud.backupdr.v1beta.AliasIpRange> getAliasIpRangesList();
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.AliasIpRange getAliasIpRanges(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.backupdr.v1beta.AliasIpRangeOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.AliasIpRangeOrBuilder getAliasIpRangesOrBuilder(int index);
   ...
   */
  com.google.cloud.backupdr.v1beta.NetworkInterface.StackType getStackType();
   ...
   */
  com.google.cloud.backupdr.v1beta.NetworkInterface.Ipv6AccessType getIpv6AccessType();
   ...
   * @return The nicType.
   */
  com.google.cloud.backupdr.v1beta.NetworkInterface.NicType getNicType();
