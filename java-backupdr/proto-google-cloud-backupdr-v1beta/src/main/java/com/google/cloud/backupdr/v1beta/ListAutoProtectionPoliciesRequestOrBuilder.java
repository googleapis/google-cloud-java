...
public interface ListAutoProtectionPoliciesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.ListAutoProtectionPoliciesRequest)
