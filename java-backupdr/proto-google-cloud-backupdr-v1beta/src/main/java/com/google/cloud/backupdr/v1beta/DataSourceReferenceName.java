...
public class DataSourceReferenceName implements ResourceName {
  ...
  public static @Nullable DataSourceReferenceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable DataSourceReferenceName> values) {
