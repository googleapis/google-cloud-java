...
public interface ListBindingMatchingResourcesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.ListBindingMatchingResourcesRequest)
