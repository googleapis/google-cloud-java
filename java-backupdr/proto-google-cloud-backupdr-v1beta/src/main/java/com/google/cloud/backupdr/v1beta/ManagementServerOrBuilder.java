...
public interface ManagementServerOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.ManagementServer)
   ...
   * @return The type.
   */
  com.google.cloud.backupdr.v1beta.ManagementServer.InstanceType getType();
   ...
   *
   * <code>
   * .google.cloud.backupdr.v1beta.ManagementURI management_uri = 11 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.backupdr.v1beta.ManagementURI getManagementUri();
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.ManagementURIOrBuilder getManagementUriOrBuilder();
   ...
   *
   * <code>
   * .google.cloud.backupdr.v1beta.WorkforceIdentityBasedManagementURI workforce_identity_based_management_uri = 16 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.backupdr.v1beta.WorkforceIdentityBasedManagementURI
   ...
   *
   * <code>
   * .google.cloud.backupdr.v1beta.ManagementServer.InstanceState state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The state.
   */
  com.google.cloud.backupdr.v1beta.ManagementServer.InstanceState getState();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.backupdr.v1beta.NetworkConfig> getNetworksList();
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.NetworkConfig getNetworks(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.backupdr.v1beta.NetworkConfigOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.NetworkConfigOrBuilder getNetworksOrBuilder(int index);
   ...
   *
   * <code>
   * .google.cloud.backupdr.v1beta.WorkforceIdentityBasedOAuth2ClientID workforce_identity_based_oauth2_client_id = 17 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   */
  com.google.cloud.backupdr.v1beta.WorkforceIdentityBasedOAuth2ClientID
