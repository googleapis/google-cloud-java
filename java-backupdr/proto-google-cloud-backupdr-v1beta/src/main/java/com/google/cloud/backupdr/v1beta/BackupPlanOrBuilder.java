...
public interface BackupPlanOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.BackupPlan)
   ...
   *
   * <code>
   * .google.cloud.backupdr.v1beta.DiskBackupPlanProperties disk_backup_plan_properties = 19 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   * @return Whether the diskBackupPlanProperties field is set.
   */
  boolean hasDiskBackupPlanProperties();
   ...
   * </code>
   *
   * @return The diskBackupPlanProperties.
   */
  com.google.cloud.backupdr.v1beta.DiskBackupPlanProperties getDiskBackupPlanProperties();
  ...
  com.google.cloud.backupdr.v1beta.DiskBackupPlanPropertiesOrBuilder
      getDiskBackupPlanPropertiesOrBuilder();
   ...
   * </code>
   *
   * @return Whether the computeInstanceBackupPlanProperties field is set.
   */
   ...
   * </code>
   *
   * @return The computeInstanceBackupPlanProperties.
   */
  com.google.cloud.backupdr.v1beta.ComputeInstanceBackupPlanProperties
      getComputeInstanceBackupPlanProperties();
   ...
   * </code>
   */
  java.util.List<com.google.cloud.backupdr.v1beta.BackupRule> getBackupRulesList();
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.BackupRule getBackupRules(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.backupdr.v1beta.BackupRuleOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.backupdr.v1beta.BackupRuleOrBuilder getBackupRulesOrBuilder(int index);
   ...
   * </pre>
   *
   * <code>int32 max_custom_on_demand_retention_days = 18 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   * @return The maxCustomOnDemandRetentionDays.
   */
  int getMaxCustomOnDemandRetentionDays();
   ...
   *
   * <code>
   * .google.cloud.backupdr.v1beta.BackupPlan.State state = 7 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
  ...
  com.google.cloud.backupdr.v1beta.BackupPlan.ResourcePropertiesCase getResourcePropertiesCase();
}
