...
public interface DeleteAutoProtectionPolicyRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.DeleteAutoProtectionPolicyRequest)
