...
public interface GetBindingMatchingResourceRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.backupdr.v1beta.GetBindingMatchingResourceRequest)
