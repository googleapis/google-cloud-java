...
public class ManagementServerName implements ResourceName {
  ...
  public static @Nullable ManagementServerName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ManagementServerName> values) {
