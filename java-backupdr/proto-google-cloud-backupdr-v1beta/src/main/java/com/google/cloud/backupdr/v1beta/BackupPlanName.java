...
public class BackupPlanName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_BACKUP_PLAN =
  ...
  public static BackupPlanName of(String project, String location, String backupPlan) {
    return newBuilder().setProject(project).setLocation(location).setBackupPlan(backupPlan).build();
  }
  ...
  public static @Nullable BackupPlanName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_BACKUP_PLAN.validatedMatch(
            formattedString, "BackupPlanName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("backup_plan"));
  }

  public static List<BackupPlanName> parseList(List<String> formattedStrings) {
    List<BackupPlanName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable BackupPlanName> values) {
  ...
  public String toString() {
    return PROJECT_LOCATION_BACKUP_PLAN.instantiate(
        "project", project, "location", location, "backup_plan", backupPlan);
  }
