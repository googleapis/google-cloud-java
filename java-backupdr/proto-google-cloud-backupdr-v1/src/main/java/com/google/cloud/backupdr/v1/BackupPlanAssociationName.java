...
public class BackupPlanAssociationName implements ResourceName {
  ...
  public static @Nullable BackupPlanAssociationName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable BackupPlanAssociationName> values) {
