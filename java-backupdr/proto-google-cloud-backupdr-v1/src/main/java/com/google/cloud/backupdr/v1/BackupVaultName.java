...
public class BackupVaultName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_BACKUPVAULT =
  ...
  public static @Nullable BackupVaultName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_BACKUPVAULT.validatedMatch(
            formattedString, "BackupVaultName.parse: formattedString not in valid format");
    return of(matchMap.get("project"), matchMap.get("location"), matchMap.get("backupvault"));
  }

  public static List<BackupVaultName> parseList(List<String> formattedStrings) {
    List<BackupVaultName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable BackupVaultName> values) {
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_BACKUPVAULT.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_BACKUPVAULT.instantiate(
        "project", project, "location", location, "backupvault", backupvault);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/backupVaults/{backupvault}. */
