...
// [START backupdr_v1beta_generated_BackupDR_ListAutoProtectionPolicies_async]
...
import com.google.cloud.backupdr.v1beta.LocationName;

public class AsyncListAutoProtectionPolicies {

  public static void main(String[] args) throws Exception {
    asyncListAutoProtectionPolicies();
  }

  public static void asyncListAutoProtectionPolicies() throws Exception {
    ...
    try (BackupDRClient backupDRClient = BackupDRClient.create()) {
      ListAutoProtectionPoliciesRequest request =
          ListAutoProtectionPoliciesRequest.newBuilder()
              ...
              .build();
      ApiFuture<AutoProtectionPolicy> future =
...
// [END backupdr_v1beta_generated_BackupDR_ListAutoProtectionPolicies_async]
