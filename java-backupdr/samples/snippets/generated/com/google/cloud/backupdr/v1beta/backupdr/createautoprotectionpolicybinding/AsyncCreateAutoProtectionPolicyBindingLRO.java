...
// [START backupdr_v1beta_generated_BackupDR_CreateAutoProtectionPolicyBinding_LRO_async]
...
public class AsyncCreateAutoProtectionPolicyBindingLRO {

  public static void main(String[] args) throws Exception {
    asyncCreateAutoProtectionPolicyBindingLRO();
  }

  public static void asyncCreateAutoProtectionPolicyBindingLRO() throws Exception {
    ...
    try (BackupDRClient backupDRClient = BackupDRClient.create()) {
      CreateAutoProtectionPolicyBindingRequest request =
          CreateAutoProtectionPolicyBindingRequest.newBuilder()
              ...
              .build();
      OperationFuture<AutoProtectionPolicyBinding, OperationMetadata> future =
...
// [END backupdr_v1beta_generated_BackupDR_CreateAutoProtectionPolicyBinding_LRO_async]
