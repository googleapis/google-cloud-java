...
public class AsyncUpdateAutoProtectionPolicyLRO {

  public static void main(String[] args) throws Exception {
    asyncUpdateAutoProtectionPolicyLRO();
  }

  public static void asyncUpdateAutoProtectionPolicyLRO() throws Exception {
    ...
    try (BackupDRClient backupDRClient = BackupDRClient.create()) {
      UpdateAutoProtectionPolicyRequest request =
          UpdateAutoProtectionPolicyRequest.newBuilder()
              ...
              .build();
      OperationFuture<AutoProtectionPolicy, OperationMetadata> future =
...
// [END backupdr_v1beta_generated_BackupDR_UpdateAutoProtectionPolicy_LRO_async]
