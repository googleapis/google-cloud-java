...
public class AsyncGetAutoProtectionPolicyBinding {

  public static void main(String[] args) throws Exception {
    asyncGetAutoProtectionPolicyBinding();
  }

  public static void asyncGetAutoProtectionPolicyBinding() throws Exception {
          ...
          GetAutoProtectionPolicyBindingRequest.newBuilder()
              .setName(
                  AutoProtectionPolicyBindingName.of(
                      ...
                      .toString())
              .build();
      ApiFuture<AutoProtectionPolicyBinding> future =
