...
public class StreamingSequenceName implements ResourceName {
  ...
  public static @Nullable StreamingSequenceName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable StreamingSequenceName> values) {
