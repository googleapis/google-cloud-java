...
public class SequenceReportName implements ResourceName {
  private static final PathTemplate SEQUENCE =
      PathTemplate.createWithoutUrlEncoding("sequences/{sequence}/sequenceReport");
  private volatile Map<String, String> fieldValuesMap;
  private final String sequence;

  @Deprecated
  protected SequenceReportName() {
    sequence = null;
  }

  private SequenceReportName(Builder builder) {
  ...
  public static SequenceReportName of(String sequence) {
  ...
  public static SequenceReportName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        SEQUENCE.validatedMatch(
            formattedString, "SequenceReportName.parse: formattedString not in valid format");
    return of(matchMap.get("sequence"));
  }

  public static List<SequenceReportName> parseList(List<String> formattedStrings) {
    List<SequenceReportName> list = new ArrayList<>(formattedStrings.size());
  ...
  /** Builder for sequences/{sequence}/sequenceReport. */
  public static class Builder {
    ...
    private Builder(SequenceReportName sequenceReportName) {
      this.sequence = sequenceReportName.sequence;
    }

    public SequenceReportName build() {
      return new SequenceReportName(this);
    }
  }
}
