...
public class GrpcEchoStub extends EchoStub {
  ...
  private final HttpJsonResumableUploadClient uploadClient;
  private final HttpJsonCallSettings<EchoRequest, EchoResponse> uploadMethodSettings;

  private static final ApiMethodDescriptor<EchoRequest, EchoResponse> httpJsonUploadMethodDescriptor =
      ApiMethodDescriptor.<EchoRequest, EchoResponse>newBuilder()
          ...
          .setRequestFormatter(
              ProtoMessageRequestFormatter.<EchoRequest>newBuilder()
                  .setPath("/v1beta1/echo:resumable", r -> new HashMap<>())
                  .build())
          .setResponseParser(
  ...
  protected GrpcEchoStub(
    ...
    this.uploadMethodSettings =
        HttpJsonCallSettings.<EchoRequest, EchoResponse>newBuilder()
            .setMethodDescriptor(httpJsonUploadMethodDescriptor)
            .build();
    ...
    if (clientContext.getCredentials() != null) {
      ...
      this.uploadClient = HttpJsonResumableUploadClient.create(backgroundHttpContext);
    } else {
  ...
  public ResumableUploadCallable<EchoRequest, EchoResponse> resumableUploadCallable() {
    ...
    return uploadClient.createCallable(uploadMethodSettings);
  }
