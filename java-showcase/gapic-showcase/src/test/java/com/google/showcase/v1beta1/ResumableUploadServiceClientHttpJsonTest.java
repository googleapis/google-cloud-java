...
import com.google.showcase.v1beta1.stub.HttpJsonResumableUploadServiceStub;
...
public class ResumableUploadServiceClientHttpJsonTest {
  ...
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonResumableUploadServiceStub.getMethodDescriptors(),
            ResumableUploadServiceSettings.getDefaultEndpoint());
