...
public class ResumableUploadServiceClientTest {
  private static MockIAMPolicy mockIAMPolicy;
  private static MockLocations mockLocations;
  private static MockResumableUploadService mockResumableUploadService;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private ResumableUploadServiceClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockResumableUploadService = new MockResumableUploadService();
    ...
    mockServiceHelper =
        new MockServiceHelper(
            ...
            Arrays.<MockGrpcService>asList(
                mockResumableUploadService, mockLocations, mockIAMPolicy));
  ...
  public void setUp() throws IOException {
    ...
    ResumableUploadServiceSettings settings =
        ResumableUploadServiceSettings.newBuilder()
            ...
            .build();
    client = ResumableUploadServiceClient.create(settings);
  }
