...
// [START localhost7469_v1beta1_generated_ResumableUploadService_GetIamPolicy_async]
  ...
  public static void asyncGetIamPolicy() throws Exception {
    ...
    try (ResumableUploadServiceClient resumableUploadServiceClient =
      ...
      ApiFuture<Policy> future =
          resumableUploadServiceClient.getIamPolicyCallable().futureCall(request);
      // Do something.
      Policy response = future.get();
    }
  }
}
// [END localhost7469_v1beta1_generated_ResumableUploadService_GetIamPolicy_async]
