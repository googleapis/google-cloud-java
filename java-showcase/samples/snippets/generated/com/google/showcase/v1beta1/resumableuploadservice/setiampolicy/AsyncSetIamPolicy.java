...
// [START localhost7469_v1beta1_generated_ResumableUploadService_SetIamPolicy_async]
  ...
  public static void asyncSetIamPolicy() throws Exception {
    ...
    try (ResumableUploadServiceClient resumableUploadServiceClient =
      ...
      ApiFuture<Policy> future =
          resumableUploadServiceClient.setIamPolicyCallable().futureCall(request);
      // Do something.
      Policy response = future.get();
    }
  }
}
// [END localhost7469_v1beta1_generated_ResumableUploadService_SetIamPolicy_async]
