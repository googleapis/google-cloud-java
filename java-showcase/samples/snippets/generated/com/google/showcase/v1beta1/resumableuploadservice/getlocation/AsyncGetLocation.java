...
// [START localhost7469_v1beta1_generated_ResumableUploadService_GetLocation_async]
  ...
  public static void asyncGetLocation() throws Exception {
    ...
    try (ResumableUploadServiceClient resumableUploadServiceClient =
      ...
      ApiFuture<Location> future =
          resumableUploadServiceClient.getLocationCallable().futureCall(request);
      // Do something.
      Location response = future.get();
    }
  }
}
// [END localhost7469_v1beta1_generated_ResumableUploadService_GetLocation_async]
