 ...
 *      <td><p>Gets an environment. Returns NOT_FOUND if the environment does not exist.</p></td>
 *      <td>
 ...
 *    </tr>
 *    <tr>
 *      <td>StartEnvironment</td>
 *      <td><p>Starts an existing environment, allowing clients to connect to it. The
 *  returned operation will contain an instance of StartEnvironmentMetadata in
 *  its metadata field. Users can wait for the environment to start by polling
 *  this operation via GetOperation. Once the environment has finished starting
 *  and is ready to accept connections, the operation will contain a
 *  StartEnvironmentResponse in its response field.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>startEnvironmentAsync(StartEnvironmentRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>startEnvironmentOperationCallable()
 *           <li>startEnvironmentCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>AuthorizeEnvironment</td>
 *      <td><p>Sends OAuth credentials to a running environment on behalf of a user. When
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>authorizeEnvironmentAsync(AuthorizeEnvironmentRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>authorizeEnvironmentOperationCallable()
 *           <li>authorizeEnvironmentCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>AddPublicKey</td>
 *      <td><p>Adds a public SSH key to an environment, allowing clients with the
 *  corresponding private key to connect to that environment via SSH. If a key
 *  with the same content already exists, this will error with ALREADY_EXISTS.</p></td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>addPublicKeyAsync(AddPublicKeyRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>addPublicKeyOperationCallable()
 *           <li>addPublicKeyCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    <tr>
 *      <td>RemovePublicKey</td>
 *      <td><p>Removes a public SSH key from an environment. Clients will no longer be
 ...
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
 *           <li>removePublicKeyAsync(RemovePublicKeyRequest request)
 *      </ul>
 *      <p>Callable method variants take no parameters and return an immutable API callable object, which can be used to initiate calls to the service.</p>
 *      <ul>
 *           <li>removePublicKeyOperationCallable()
 *           <li>removePublicKeyCallable()
 *      </ul>
 *       </td>
 *    </tr>
 *    </tr>
