...
```Groovy
implementation 'com.google.cloud:google-cloud-shell:2.1.1'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-shell" % "2.1.1"
```
...
[contributing]: https://github.com/googleapis/java-shell/blob/master/CONTRIBUTING.md
