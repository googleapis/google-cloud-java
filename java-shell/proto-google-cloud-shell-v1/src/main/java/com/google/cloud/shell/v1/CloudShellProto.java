...
public final class CloudShellProto extends com.google.protobuf.GeneratedFile {
  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "perations.proto\032\037google/protobuf/timestamp.proto\"\263\003\n"
          ...
          + "nment\022\'users/{user}/environments/{environment}\"T\n"
          ...
          + "google.cloud.shell.v1.StartEnvironmentMetadata.State\"p\n"
          + "\005State\022\025\n"
          ...
          + "\027RemovePublicKeyMetadata\"\236\002\n"
          + "\026CloudShellErrorDetails\022O\n"
          + "\004code\030\001"
          + " \001(\0162A.google.cloud.shell.v1.CloudShellErrorDetails.CloudShellErrorCode\"\262\001\n"
          ...
          + "\027ENVIRONMENT_UNAVAILABLE\020\0062\324\010\n"
          + "\021CloudShellService\022\224\001\n"
          + "\016GetEnvironment\022,.google.cloud.shell.v1.Ge"
          + "tEnvironmentRequest\032\".google.cloud.shell"
          + ".v1.Environment\"0\332A\004name\202\323\344\223\002#\022!/v1/{name=users/*/environments/*}\022\314\001\n"
          + "\020StartEnvironment\022..google.cloud.shell.v1.StartEnvi"
          + "ronmentRequest\032\035.google.longrunning.Operation\"i\312A4\n"
          + "\030StartEnvironmentResponse\022\030St"
          + "artEnvironmentMetadata\202\323\344\223\002,\"\'/v1/{name=users/*/environments/*}:start:\001*\022\340\001\n"
          + "\024AuthorizeEnvironment\0222.google.cloud.shell.v"
          + "1.AuthorizeEnvironmentRequest\032\035.google.longrunning.Operation\"u\312A<\n"
          + "\034AuthorizeEnvironmentResponse\022\034AuthorizeEnvironmentMet"
          + "adata\202\323\344\223\0020\"+/v1/{name=users/*/environments/*}:authorize:\001*\022\312\001\n"
          + "\014AddPublicKey\022*.g"
          + "oogle.cloud.shell.v1.AddPublicKeyRequest\032\035.google.longrunning.Operation\"o\312A,\n"
          + "\024AddPublicKeyResponse\022\024AddPublicKeyMetadata"
          + "\202\323\344\223\002:\"5/v1/{environment=users/*/environments/*}:addPublicKey:\001*\022\331\001\n"
          + "\017RemovePublicKey\022-.google.cloud.shell.v1.RemovePubli"
          + "cKeyRequest\032\035.google.longrunning.Operation\"x\312A2\n"
          ...
          + "ps://www.googleapis.com/auth/cloud-platformB_\n"
          + "\031com.google.cloud.shell.v1B\017CloudShellProtoP\001Z/cloud.google.com/go/shell/a"
