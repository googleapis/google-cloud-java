...
public final class Environment extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dockerImage_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 3, dockerImage_);
    }
    if (state_ != com.google.cloud.shell.v1.Environment.State.STATE_UNSPECIFIED.getNumber()) {
      output.writeEnum(4, state_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sshUsername_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, sshUsername_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sshHost_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 6, sshHost_);
    }
    if (sshPort_ != 0) {
      output.writeInt32(7, sshPort_);
    }
    for (int i = 0; i < publicKeys_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, publicKeys_.getRaw(i));
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(webHost_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 12, webHost_);
    }
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(dockerImage_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(3, dockerImage_);
    }
    if (state_ != com.google.cloud.shell.v1.Environment.State.STATE_UNSPECIFIED.getNumber()) {
      size += com.google.protobuf.CodedOutputStream.computeEnumSize(4, state_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sshUsername_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, sshUsername_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(sshHost_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(6, sshHost_);
    }
    if (sshPort_ != 0) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(webHost_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(12, webHost_);
    }
