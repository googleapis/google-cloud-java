...
public class TermsOfServiceServiceClientTest {
  ...
  public void acceptTermsOfServiceTest() throws Exception {
    AcceptTermsOfServiceResponse expectedResponse =
        AcceptTermsOfServiceResponse.newBuilder()
            .setTermsOfServiceAgreementState(TermsOfServiceAgreementState.newBuilder().build())
            .build();
    mockTermsOfServiceService.addResponse(expectedResponse);

    TermsOfServiceName name = TermsOfServiceName.of("[VERSION]");

    AcceptTermsOfServiceResponse actualResponse = client.acceptTermsOfService(name);
    Assert.assertEquals(expectedResponse, actualResponse);
