...
import com.google.shopping.merchant.accounts.v1.stub.TermsOfServiceAgreementStateServiceStub;
 ...
 *      <td><p> Retrieves the state of the agreement for the application terms of service.
 * <p>  Application terms of service covers permissions related to the usage of data provided through Merchant Center, CSS Center, Manufacturer Center, and more.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class TermsOfServiceAgreementStateServiceClient implements BackgroundResource {
   ...
   *
   * <p>Application terms of service covers permissions related to the usage of data provided
   * through Merchant Center, CSS Center, Manufacturer Center, and more.
   *
   * <p>Sample code:
   *
   * <pre>{@code
