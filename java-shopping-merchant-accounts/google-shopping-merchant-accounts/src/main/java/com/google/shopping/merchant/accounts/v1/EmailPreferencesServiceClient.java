...
import com.google.shopping.merchant.accounts.v1.stub.EmailPreferencesServiceStub;
 ...
 *      <td><p> Returns the email preferences for a Merchant Center account user. This service only permits retrieving and updating email preferences for the authenticated user. Use the name=accounts/&#42;/users/me/emailPreferences alias to get preferences for the authenticated user.</td>
 *      <td>
 ...
 *      <td><p> Updates the email preferences for a Merchant Center account user. Advanced account users should specify the advanced account rather than a sub-account of the advanced account.
...
public class EmailPreferencesServiceClient implements BackgroundResource {
   ...
   * name=accounts/&#42;/users/me/emailPreferences alias to get preferences for the authenticated
   * user.
   *
   * <p>Sample code:
   *
   ...
   * specify the advanced account rather than a sub-account of the advanced account.
   *
   * <p>Preferences which are not explicitly selected in the update mask will not be updated.
   *
   * <p>It is invalid for updates to specify an UNCONFIRMED opt-in status value.
