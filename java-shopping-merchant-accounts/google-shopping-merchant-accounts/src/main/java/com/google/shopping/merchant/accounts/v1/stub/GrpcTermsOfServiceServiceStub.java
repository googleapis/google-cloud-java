...
public class GrpcTermsOfServiceServiceStub extends TermsOfServiceServiceStub {
  ...
  private static final MethodDescriptor<AcceptTermsOfServiceRequest, AcceptTermsOfServiceResponse>
      acceptTermsOfServiceMethodDescriptor =
          MethodDescriptor.<AcceptTermsOfServiceRequest, AcceptTermsOfServiceResponse>newBuilder()
              .setType(MethodDescriptor.MethodType.UNARY)
              .setFullMethodName(
    ...
    GrpcCallSettings<RetrieveLatestTermsOfServiceRequest, TermsOfService>
        retrieveLatestTermsOfServiceTransportSettings =
            GrpcCallSettings.<RetrieveLatestTermsOfServiceRequest, TermsOfService>newBuilder()
                ...
                .build();
    GrpcCallSettings<AcceptTermsOfServiceRequest, AcceptTermsOfServiceResponse>
        acceptTermsOfServiceTransportSettings =
            GrpcCallSettings.<AcceptTermsOfServiceRequest, AcceptTermsOfServiceResponse>newBuilder()
