...
import com.google.shopping.merchant.accounts.v1.stub.TermsOfServiceServiceStub;
...
public class TermsOfServiceServiceClient implements BackgroundResource {
  ...
  public final AcceptTermsOfServiceResponse acceptTermsOfService(TermsOfServiceName name) {
    AcceptTermsOfServiceRequest request =
        AcceptTermsOfServiceRequest.newBuilder()
            .setName(name == null ? null : name.toString())
            .build();
    return acceptTermsOfService(request);
  }
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final AcceptTermsOfServiceResponse acceptTermsOfService(String name) {
    AcceptTermsOfServiceRequest request =
  ...
  public final AcceptTermsOfServiceResponse acceptTermsOfService(
      AcceptTermsOfServiceRequest request) {
    return acceptTermsOfServiceCallable().call(request);
  }
   ...
   *           .setRegionCode("regionCode-1991004415")
   *           .build();
   *   ApiFuture<AcceptTermsOfServiceResponse> future =
   *       termsOfServiceServiceClient.acceptTermsOfServiceCallable().futureCall(request);
   *   // Do something.
   *   AcceptTermsOfServiceResponse response = future.get();
   * }
   * }</pre>
   */
  public final UnaryCallable<AcceptTermsOfServiceRequest, AcceptTermsOfServiceResponse>
