...
import com.google.shopping.merchant.accounts.v1.stub.OnlineReturnPolicyServiceStub;
 ...
 *      <td><p> Creates a new return policy for a given business.</td>
 *      <td>
 *      <p>Request object method variants only take one parameter, a request object, which must be constructed before the call.</p>
 *      <ul>
...
public class OnlineReturnPolicyServiceClient implements BackgroundResource {
   ...
   * }</pre>
   *
   * @param parent Required. The Merchant Center account for which the return policy will be
