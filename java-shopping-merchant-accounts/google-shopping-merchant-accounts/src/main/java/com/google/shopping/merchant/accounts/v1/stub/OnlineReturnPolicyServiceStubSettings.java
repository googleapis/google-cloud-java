...
/**
 * Settings class to configure an instance of {@link OnlineReturnPolicyServiceStub}.
 *
...
public class OnlineReturnPolicyServiceStubSettings
    extends StubSettings<OnlineReturnPolicyServiceStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/content").build();

  private final UnaryCallSettings<GetOnlineReturnPolicyRequest, OnlineReturnPolicy>
      getOnlineReturnPolicySettings;
  ...
  private static final PagedListDescriptor<
      ...
      LIST_ONLINE_RETURN_POLICIES_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public ListOnlineReturnPoliciesRequest injectToken(
                ListOnlineReturnPoliciesRequest payload, String token) {
              return ListOnlineReturnPoliciesRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public ListOnlineReturnPoliciesRequest injectPageSize(
                ListOnlineReturnPoliciesRequest payload, int pageSize) {
              return ListOnlineReturnPoliciesRequest.newBuilder(payload)
            ...
            @Override
            public Integer extractPageSize(ListOnlineReturnPoliciesRequest payload) {
              return payload.getPageSize();
            }

            @Override
            public String extractNextToken(ListOnlineReturnPoliciesResponse payload) {
              return payload.getNextPageToken();
            }

            @Override
            public Iterable<OnlineReturnPolicy> extractResources(
                ListOnlineReturnPoliciesResponse payload) {
              return payload.getOnlineReturnPoliciesList();
            }
          };
  ...
  private static final PagedListResponseFactory<
          ...
          ListOnlineReturnPoliciesResponse,
          ListOnlineReturnPoliciesPagedResponse>
      LIST_ONLINE_RETURN_POLICIES_PAGE_STR_FACT =
          new PagedListResponseFactory<
              ListOnlineReturnPoliciesRequest,
              ListOnlineReturnPoliciesResponse,
              ListOnlineReturnPoliciesPagedResponse>() {
            @Override
            public ApiFuture<ListOnlineReturnPoliciesPagedResponse> getFuturePagedResponse(
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, LIST_ONLINE_RETURN_POLICIES_PAGE_STR_DESC, request, context);
              return ListOnlineReturnPoliciesPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetOnlineReturnPolicyRequest, OnlineReturnPolicy>
      getOnlineReturnPolicySettings() {
    return getOnlineReturnPolicySettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(OnlineReturnPolicyServiceStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return OnlineReturnPolicyServiceStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected OnlineReturnPolicyServiceStubSettings(Builder settingsBuilder) throws IOException {
  ...
  public static class Builder
      extends StubSettings.Builder<OnlineReturnPolicyServiceStubSettings, Builder> {
    private final ImmutableList<UnaryCallSettings.Builder<?, ?>> unaryMethodSettingsBuilders;
    private final UnaryCallSettings.Builder<GetOnlineReturnPolicyRequest, OnlineReturnPolicy>
        getOnlineReturnPolicySettings;
    ...
    protected Builder(OnlineReturnPolicyServiceStubSettings settings) {
      super(settings);
    ...
    @Override
    public OnlineReturnPolicyServiceStubSettings build() throws IOException {
