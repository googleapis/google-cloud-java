...
import com.google.shopping.merchant.accounts.v1.stub.UserServiceStub;
 ...
 *      <p>"Flattened" method variants have converted the fields of the request object into function parameters to enable multiple ways to call the same method.</p>
 *      <ul>
 *           <li><p> createUser(AccountName parent, User user, String userId)
...
public class UserServiceClient implements BackgroundResource {
   ...
   * @param user Optional. The user to create.
   * @param userId Required. The email address of the user (for example,
   *     `john.doe{@literal @}gmail.com`).
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final User createUser(@Nullable AccountName parent, User user, String userId) {
   ...
   * @throws com.google.api.gax.rpc.ApiException if the remote call fails
   */
  public final User verifySelf(@Nullable AccountName account) {
