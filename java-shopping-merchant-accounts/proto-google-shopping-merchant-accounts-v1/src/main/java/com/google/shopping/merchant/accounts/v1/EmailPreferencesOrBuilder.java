...
public interface EmailPreferencesOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.accounts.v1.EmailPreferences)
   ...
   *
   * <code>
   * .google.shopping.merchant.accounts.v1.EmailPreferences.OptInState news_and_tips = 2 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   */
  com.google.shopping.merchant.accounts.v1.EmailPreferences.OptInState getNewsAndTips();
}
