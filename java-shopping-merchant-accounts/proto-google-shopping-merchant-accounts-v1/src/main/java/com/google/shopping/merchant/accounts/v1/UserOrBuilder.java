...
public interface UserOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.accounts.v1.User)
   ...
   * @return The state.
   */
  com.google.shopping.merchant.accounts.v1.User.State getState();
   ...
   */
  java.util.List<com.google.shopping.merchant.accounts.v1.AccessRight> getAccessRightsList();
   ...
   */
  com.google.shopping.merchant.accounts.v1.AccessRight getAccessRights(int index);
