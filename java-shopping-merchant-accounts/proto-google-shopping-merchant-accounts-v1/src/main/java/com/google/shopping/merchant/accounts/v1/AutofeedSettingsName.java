...
public class AutofeedSettingsName implements ResourceName {
  private static final PathTemplate ACCOUNT =
      PathTemplate.createWithoutUrlEncoding("accounts/{account}/autofeedSettings");
  private volatile Map<String, String> fieldValuesMap;
  private final String account;

  @Deprecated
  protected AutofeedSettingsName() {
    account = null;
  }

  private AutofeedSettingsName(Builder builder) {
  ...
  public static AutofeedSettingsName of(String account) {
  ...
  public static AutofeedSettingsName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        ACCOUNT.validatedMatch(
            formattedString, "AutofeedSettingsName.parse: formattedString not in valid format");
    return of(matchMap.get("account"));
  }

  public static List<AutofeedSettingsName> parseList(List<String> formattedStrings) {
    List<AutofeedSettingsName> list = new ArrayList<>(formattedStrings.size());
  ...
  public boolean equals(Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      AutofeedSettingsName that = ((AutofeedSettingsName) o);
  ...
  /** Builder for accounts/{account}/autofeedSettings. */
  public static class Builder {
    ...
    private Builder(AutofeedSettingsName autofeedSettingsName) {
      this.account = autofeedSettingsName.account;
    }

    public AutofeedSettingsName build() {
      return new AutofeedSettingsName(this);
    }
  }
}
