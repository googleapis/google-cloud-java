...
public class AccountRelationshipName implements ResourceName {
  ...
  public static @Nullable AccountRelationshipName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable AccountRelationshipName> values) {
