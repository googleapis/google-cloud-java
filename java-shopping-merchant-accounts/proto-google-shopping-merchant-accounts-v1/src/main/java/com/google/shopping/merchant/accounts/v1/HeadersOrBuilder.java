...
public interface HeadersOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.accounts.v1.Headers)
   ...
   * </code>
   */
  java.util.List<com.google.shopping.merchant.accounts.v1.LocationIdSet> getLocationsList();
   ...
   * </code>
   */
  com.google.shopping.merchant.accounts.v1.LocationIdSet getLocations(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.shopping.merchant.accounts.v1.LocationIdSetOrBuilder>
   ...
   * </code>
   */
  com.google.shopping.merchant.accounts.v1.LocationIdSetOrBuilder getLocationsOrBuilder(int index);
}
