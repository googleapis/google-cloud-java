...
public interface TransitTableOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.accounts.v1.TransitTable)
   ...
   *
   * <code>
   * repeated .google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRow rows = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   */
  java.util.List<com.google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRow>
      getRowsList();
   ...
   * </code>
   */
  com.google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRow getRows(int index);
   ...
   */
  java.util.List<
          ? extends com.google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRowOrBuilder>
   ...
   * </code>
   */
  com.google.shopping.merchant.accounts.v1.TransitTable.TransitTimeRowOrBuilder getRowsOrBuilder(
      int index);
}
