...
public class CheckoutSettingsName implements ResourceName {
  ...
  public static @Nullable CheckoutSettingsName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable CheckoutSettingsName> values) {
