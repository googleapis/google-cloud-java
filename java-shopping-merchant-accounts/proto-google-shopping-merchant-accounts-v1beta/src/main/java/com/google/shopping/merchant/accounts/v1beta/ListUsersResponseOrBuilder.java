...
public interface ListUsersResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.shopping.merchant.accounts.v1beta.ListUsersResponse)
   ...
   * <code>repeated .google.shopping.merchant.accounts.v1beta.User users = 1;</code>
   */
  com.google.shopping.merchant.accounts.v1beta.UserOrBuilder getUsersOrBuilder(int index);
