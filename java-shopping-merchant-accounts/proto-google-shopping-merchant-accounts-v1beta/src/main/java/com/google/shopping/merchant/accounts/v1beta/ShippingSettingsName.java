...
public class ShippingSettingsName implements ResourceName {
  ...
  public static @Nullable ShippingSettingsName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ShippingSettingsName> values) {
