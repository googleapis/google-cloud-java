...
public class BusinessIdentityName implements ResourceName {
  private static final PathTemplate ACCOUNT =
      PathTemplate.createWithoutUrlEncoding("accounts/{account}/businessIdentity");
  ...
  private BusinessIdentityName(Builder builder) {
  ...
  public static @Nullable BusinessIdentityName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        ACCOUNT.validatedMatch(
            formattedString, "BusinessIdentityName.parse: formattedString not in valid format");
    return of(matchMap.get("account"));
  }

  public static List<BusinessIdentityName> parseList(List<String> formattedStrings) {
    List<BusinessIdentityName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable BusinessIdentityName> values) {
    List<String> list = new ArrayList<>(values.size());
    for (BusinessIdentityName value : values) {
      if (value == null) {
        list.add("");
      } else {
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      BusinessIdentityName that = ((BusinessIdentityName) o);
  ...
  public static class Builder {
    ...
    private Builder(BusinessIdentityName businessIdentityName) {
      this.account = businessIdentityName.account;
    }

    public BusinessIdentityName build() {
      return new BusinessIdentityName(this);
    }
  }
}
