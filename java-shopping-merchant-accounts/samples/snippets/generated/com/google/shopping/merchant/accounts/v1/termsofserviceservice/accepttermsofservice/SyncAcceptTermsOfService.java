...
public class SyncAcceptTermsOfService {

  public static void main(String[] args) throws Exception {
    syncAcceptTermsOfService();
  }

  public static void syncAcceptTermsOfService() throws Exception {
    ...
    try (TermsOfServiceServiceClient termsOfServiceServiceClient =
      ...
      AcceptTermsOfServiceRequest request =
          AcceptTermsOfServiceRequest.newBuilder()
              ...
              .build();
      AcceptTermsOfServiceResponse response =
