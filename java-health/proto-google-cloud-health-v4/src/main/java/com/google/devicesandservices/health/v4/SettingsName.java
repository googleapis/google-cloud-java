...
public class SettingsName implements ResourceName {
  private static final PathTemplate USER =
      PathTemplate.createWithoutUrlEncoding("users/{user}/settings");
  ...
  public static SettingsName of(String user) {
  ...
  /** Builder for users/{user}/settings. */
