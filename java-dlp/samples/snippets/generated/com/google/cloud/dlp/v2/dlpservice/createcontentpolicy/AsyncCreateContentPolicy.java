...
public class AsyncCreateContentPolicy {

  public static void main(String[] args) throws Exception {
    asyncCreateContentPolicy();
  }

  public static void asyncCreateContentPolicy() throws Exception {
    ...
    try (DlpServiceClient dlpServiceClient = DlpServiceClient.create()) {
      ...
      ApiFuture<ContentPolicy> future =
          dlpServiceClient.createContentPolicyCallable().futureCall(request);
      // Do something.
