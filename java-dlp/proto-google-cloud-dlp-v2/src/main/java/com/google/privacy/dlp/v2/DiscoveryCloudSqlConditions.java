...
public final class DiscoveryCloudSqlConditions extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private DiscoveryCloudSqlConditions(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private DiscoveryCloudSqlConditions() {
    databaseEngines_ = emptyIntList();
    types_ = emptyIntList();
  }
  ...
  private com.google.protobuf.Internal.IntList databaseEngines_ = emptyIntList();
  ...
  public com.google.privacy.dlp.v2.DiscoveryCloudSqlConditions.DatabaseEngine getDatabaseEngines(
      int index) {
    return databaseEngines_converter_.convert(databaseEngines_.getInt(index));
  }
  ...
  public int getDatabaseEnginesValue(int index) {
    return databaseEngines_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < databaseEngines_.size(); i++) {
      output.writeEnumNoTag(databaseEngines_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    {
      ...
      for (int i = 0; i < databaseEngines_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(databaseEngines_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void buildPartial0(com.google.privacy.dlp.v2.DiscoveryCloudSqlConditions result) {
      ...
      if (((from_bitField0_ & 0x00000001) != 0)) {
        databaseEngines_.makeImmutable();
            ...
            case 8:
              {
                ...
                ensureDatabaseEnginesIsMutable();
                databaseEngines_.addInt(tmpRaw);
                break;
              } // case 8
            case 10:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  databaseEngines_.addInt(input.readEnum());
                }
    ...
    private void ensureDatabaseEnginesIsMutable() {
      if (!databaseEngines_.isModifiable()) {
        databaseEngines_ = makeMutableCopy(databaseEngines_);
      }
      bitField0_ |= 0x00000001;
    }
    ...
    public Builder setDatabaseEngines(
      ...
      ensureDatabaseEnginesIsMutable();
      databaseEngines_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addDatabaseEngines(
      ...
      ensureDatabaseEnginesIsMutable();
      databaseEngines_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setDatabaseEnginesValue(int index, int value) {
      ensureDatabaseEnginesIsMutable();
      databaseEngines_.setInt(index, value);
      onChanged();
      return this;
    }
