  ...
  static {
    java.lang.String[] descriptorData = {
      ...
      "ationConfig.TaggedFieldB\003\340A\002\022\023\n"
          ...
          + "}/deidentifyTemplates/{deidentify_template}\022<projects/{project}/deidentifyTempla"
          + "tes/{deidentify_template}\022[organizations/{organization}/locations/{location}/dei"
          + "dentifyTemplates/{deidentify_template}\022Qprojects/{project}/locations/{location}/"
          + "deidentifyTemplates/{deidentify_template}\"\225\002\n"
          + "\005Error\022#\n"
      ...
      "Trigger\0223\n"
          ...
          + "\035dlp.googleapis.com/JobTrigger\022,projec"
          + "ts/{project}/jobTriggers/{job_trigger}\022A"
          + "projects/{project}/locations/{location}/jobTriggers/{job_trigger}B\005\n"
          + "\003job\"\202\n\n"
          + "\006Action\022C\n\r"
          ...
          + "&publish_findings_to_cloud_data_catalog\030\005 \001(\0132?.goog"
          + "le.privacy.dlp.v2.Action.PublishFindingsToCloudDataCatalogB\002\030\001H\000\022n\n"
      ...
      " \001(\t\022\022\n\n"
          ...
          + "/*}/deidentifyTemplates:\001*ZA\"</v2/{parent=organizations/*/locations/*}/deidentif"
          + "yTemplates:\001*Z0\"+/v2/{parent=projects/*}"
          + "/deidentifyTemplates:\001*Z<\"7/v2/{parent=p"
          + "rojects/*/locations/*}/deidentifyTemplates:\001*\022\226\003\n"
          + "\030UpdateDeidentifyTemplate\0226.google.privacy.dlp.v2.UpdateDeidentifyTempl"
          + "ateRequest\032).google.privacy.dlp.v2.Deide"
          + "ntifyTemplate\"\226\002\332A$name,deidentify_templ"
          + "ate,update_mask\202\323\344\223\002\350\00120/v2/{name=organi"
          + "zations/*/deidentifyTemplates/*}:\001*ZA2</v2/{name=organizations/*/locations/*/dei"
          + "dentifyTemplates/*}:\001*Z02+/v2/{name=projects/*/deidentifyTemplates/*}:\001*Z<27/v2/"
          + "{name=projects/*/locations/*/deidentifyTemplates/*}:\001*\022\344\002\n"
          + "\025GetDeidentifyTemplate\0223.google.privacy.dlp.v2.GetDeidentifyTe"
          + "mplateRequest\032).google.privacy.dlp.v2.De"
          + "identifyTemplate\"\352\001\332A\004name\202\323\344\223\002\334\001\0220/v2/{"
          + "name=organizations/*/deidentifyTemplates/*}Z>\022</v2/{name=organizations/*/locatio"
          + "ns/*/deidentifyTemplates/*}Z-\022+/v2/{name=projects/*/deidentifyTemplates/*}Z9\0227/v"
          + "2/{name=projects/*/locations/*/deidentifyTemplates/*}\022\367\002\n"
          + "\027ListDeidentifyTemplates\0225.google.privacy.dlp.v2.ListDeidentify"
          + "TemplatesRequest\0326.google.privacy.dlp.v2"
          + ".ListDeidentifyTemplatesResponse\"\354\001\332A\006pa"
          + "rent\202\323\344\223\002\334\001\0220/v2/{parent=organizations/*"
          + "}/deidentifyTemplatesZ>\022</v2/{parent=organizations/*/locations/*}/deidentifyTemp"
          + "latesZ-\022+/v2/{parent=projects/*}/deident"
          + "ifyTemplatesZ9\0227/v2/{parent=projects/*/locations/*}/deidentifyTemplates\022\327\002\n"
          + "\030DeleteDeidentifyTemplate\0226.google.privacy.dl"
          + "p.v2.DeleteDeidentifyTemplateRequest\032\026.g"
          + "oogle.protobuf.Empty\"\352\001\332A\004name\202\323\344\223\002\334\001*0/"
          + "v2/{name=organizations/*/deidentifyTemplates/*}Z>*</v2/{name=organizations/*/loc"
          + "ations/*/deidentifyTemplates/*}Z-*+/v2/{name=projects/*/deidentifyTemplates/*}Z9"
          + "*7/v2/{name=projects/*/locations/*/deidentifyTemplates/*}\022\235\002\n"
          + "\020CreateJobTrigger\022..google.privacy.dlp.v2.CreateJobTriggerR",
      "equest\032!.google.privacy.dlp.v2.JobTrigge"
          + "r\"\265\001\332A\022parent,job_trigger\202\323\344\223\002\231\001\"#/v2/{p"
          + "arent=projects/*}/jobTriggers:\001*Z4\"//v2/"
          + "{parent=projects/*/locations/*}/jobTrigg"
          + "ers:\001*Z9\"4/v2/{parent=organizations/*/lo"
          + "cations/*}/jobTriggers:\001*\022\247\002\n\020UpdateJobT"
          + "rigger\022..google.privacy.dlp.v2.UpdateJob"
          + "TriggerRequest\032!.google.privacy.dlp.v2.J"
          + "obTrigger\"\277\001\332A\034name,job_trigger,update_m"
          + "ask\202\323\344\223\002\231\0012#/v2/{name=projects/*/jobTrig"
          + "gers/*}:\001*Z42//v2/{name=projects/*/locat"
          + "ions/*/jobTriggers/*}:\001*Z924/v2/{name=or"
          + "ganizations/*/locations/*/jobTriggers/*}"
          + ":\001*\022\317\001\n\027HybridInspectJobTrigger\0225.google"
          + ".privacy.dlp.v2.HybridInspectJobTriggerR"
          + "equest\032,.google.privacy.dlp.v2.HybridIns"
          + "pectResponse\"O\332A\004name\202\323\344\223\002B\"=/v2/{name=p"
          + "rojects/*/locations/*/jobTriggers/*}:hyb"
          + "ridInspect:\001*\022\200\002\n\rGetJobTrigger\022+.google"
          + ".privacy.dlp.v2.GetJobTriggerRequest\032!.g"
          + "oogle.privacy.dlp.v2.JobTrigger\"\236\001\332A\004nam"
          + "e\202\323\344\223\002\220\001\022#/v2/{name=projects/*/jobTrigge"
          + "rs/*}Z1\022//v2/{name=projects/*/locations/"
          + "*/jobTriggers/*}Z6\0224/v2/{name=organizati"
          + "ons/*/locations/*/jobTriggers/*}\022\223\002\n\017Lis"
          + "tJobTriggers\022-.google.privacy.dlp.v2.Lis"
          + "tJobTriggersRequest\032..google.privacy.dlp"
          + ".v2.ListJobTriggersResponse\"\240\001\332A\006parent\202"
          + "\323\344\223\002\220\001\022#/v2/{parent=projects/*}/jobTrigg"
          + "ersZ1\022//v2/{parent=projects/*/locations/"
          + "*}/jobTriggersZ6\0224/v2/{parent=organizati"
          + "ons/*/locations/*}/jobTriggers\022\373\001\n\020Delet"
          + "eJobTrigger\022..google.privacy.dlp.v2.Dele"
          + "teJobTriggerRequest\032\026.google.protobuf.Em"
          + "pty\"\236\001\332A\004name\202\323\344\223\002\220\001*#/v2/{name=projects"
          + "/*/jobTriggers/*}Z1*//v2/{name=projects/"
          + "*/locations/*/jobTriggers/*}Z6*4/v2/{nam"
          + "e=organizations/*/locations/*/jobTrigger"
          + "s/*}\022\335\001\n\022ActivateJobTrigger\0220.google.pri"
          + "vacy.dlp.v2.ActivateJobTriggerRequest\032\035."
          + "google.privacy.dlp.v2.DlpJob\"v\202\323\344\223\002p\",/v"
          + "2/{name=projects/*/jobTriggers/*}:activa"
          + "te:\001*Z=\"8/v2/{name=projects/*/locations/"
          + "*/jobTriggers/*}:activate:\001*\022\220\002\n\025CreateD"
          + "iscoveryConfig\0223.google.privacy.dlp.v2.C"
          + "reateDiscoveryConfigRequest\032&.google.pri"
          + "vacy.dlp.v2.DiscoveryConfig\"\231\001\332A\027parent,"
          + "discovery_config\202\323\344\223\002y\"4/v2/{parent=proj"
          + "ects/*/locations/*}/discoveryConfigs:\001*Z"
          ...
          + "ent\202\323\344\223\002y\022</v2/{parent=organizations/*/l"
          + "ocations/*}/projectDataProfilesZ9\0227/v2/{"
          + "parent=projects/*/locations/*}/projectDa"
          + "taProfiles\022\211\002\n\025ListTableDataProfiles\0223.g"
          + "oogle.privacy.dlp.v2.ListTableDataProfil"
          + "esRequest\0324.google.privacy.dlp.v2.ListTa"
          + "bleDataProfilesResponse\"\204\001\332A\006parent\202\323\344\223\002"
          + "u\022:/v2/{parent=organizations/*/locations"
          + "/*}/tableDataProfilesZ7\0225/v2/{parent=pro"
          + "jects/*/locations/*}/tableDataProfiles\022\216"
          + "\002\n\026ListColumnDataProfiles\0224.google.priva"
          + "cy.dlp.v2.ListColumnDataProfilesRequest\032"
          + "5.google.privacy.dlp.v2.ListColumnDataPr"
          + "ofilesResponse\"\206\001\332A\006parent\202\323\344\223\002w\022;/v2/{p"
          + "arent=organizations/*/locations/*}/colum"
          + "nDataProfilesZ8\0226/v2/{parent=projects/*/"
          + "locations/*}/columnDataProfiles\022\200\002\n\025GetP"
          + "rojectDataProfile\0223.google.privacy.dlp.v"
          + "2.GetProjectDataProfileRequest\032).google."
          + "privacy.dlp.v2.ProjectDataProfile\"\206\001\332A\004n"
          + "ame\202\323\344\223\002y\022</v2/{name=organizations/*/loc"
          + "ations/*/projectDataProfiles/*}Z9\0227/v2/{"
          + "name=projects/*/locations/*/projectDataP"
          + "rofiles/*}\022\235\002\n\031ListFileStoreDataProfiles"
          + "\0227.google.privacy.dlp.v2.ListFileStoreDa"
          + "taProfilesRequest\0328.google.privacy.dlp.v"
          + "2.ListFileStoreDataProfilesResponse\"\214\001\332A"
          + "\006parent\202\323\344\223\002}\022>/v2/{parent=organizations"
