...
public final class Domain extends com.google.protobuf.GeneratedMessage
  ...
  private com.google.protobuf.Internal.IntList signals_ = emptyIntList();
  ...
  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
      ...
      signals_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.privacy.dlp.v2.Domain.Signal>() {
            public com.google.privacy.dlp.v2.Domain.Signal convert(int from) {
  ...
  public java.util.List<com.google.privacy.dlp.v2.Domain.Signal> getSignalsList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.privacy.dlp.v2.Domain.Signal>(
        signals_, signals_converter_);
  }
  ...
  public com.google.privacy.dlp.v2.Domain.Signal getSignals(int index) {
    return signals_converter_.convert(signals_.getInt(index));
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < signals_.size(); i++) {
      output.writeEnumNoTag(signals_.getInt(i));
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      int dataSize = 0;
      for (int i = 0; i < signals_.size(); i++) {
        dataSize += com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(signals_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
            ...
            case 18:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  signals_.addInt(input.readEnum());
                }
    ...
    private void ensureSignalsIsMutable() {
      if (!signals_.isModifiable()) {
        signals_ = makeMutableCopy(signals_);
      }
      bitField0_ |= 0x00000002;
    }
    ...
    public java.util.List<com.google.privacy.dlp.v2.Domain.Signal> getSignalsList() {
      return new com.google.protobuf.Internal.IntListAdapter<
          com.google.privacy.dlp.v2.Domain.Signal>(signals_, signals_converter_);
    }
    ...
    public Builder setSignals(int index, com.google.privacy.dlp.v2.Domain.Signal value) {
      ...
      ensureSignalsIsMutable();
      signals_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addSignals(com.google.privacy.dlp.v2.Domain.Signal value) {
      ...
      ensureSignalsIsMutable();
      signals_.addInt(value.getNumber());
      onChanged();
      return this;
    }
