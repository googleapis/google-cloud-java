...
public final class CloudStorageOptions extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private CloudStorageOptions(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }

  private CloudStorageOptions() {
    fileTypes_ = emptyIntList();
    sampleMethod_ = 0;
  }
   ...
   */
  public static final class FileSet extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private FileSet(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetRegexFileSetFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 18:
                {
                  input.readMessage(
                      internalGetRegexFileSetFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.privacy.dlp.v2.CloudStorageRegexFileSet.Builder getRegexFileSetBuilder() {
        bitField0_ |= 0x00000002;
        onChanged();
        return internalGetRegexFileSetFieldBuilder().getBuilder();
      }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList fileTypes_ = emptyIntList();
  ...
  public java.util.List<com.google.privacy.dlp.v2.FileType> getFileTypesList() {
    return new com.google.protobuf.Internal.IntListAdapter<com.google.privacy.dlp.v2.FileType>(
        fileTypes_, fileTypes_converter_);
  }
  ...
  public com.google.privacy.dlp.v2.FileType getFileTypes(int index) {
    return fileTypes_converter_.convert(fileTypes_.getInt(index));
  }
  ...
  public int getFileTypesValue(int index) {
    return fileTypes_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < fileTypes_.size(); i++) {
      output.writeEnumNoTag(fileTypes_.getInt(i));
    }
    if (sampleMethod_
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < fileTypes_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(fileTypes_.getInt(i));
      }
      size += dataSize;
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetFileSetFieldBuilder();
      }
    }
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 10:
              {
                input.readMessage(internalGetFileSetFieldBuilder().getBuilder(), extensionRegistry);
                bitField0_ |= 0x00000001;
                break;
              } // case 10
            case 32:
            ...
            case 42:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  fileTypes_.addInt(input.readEnum());
                }
    ...
    public com.google.privacy.dlp.v2.CloudStorageOptions.FileSet.Builder getFileSetBuilder() {
      bitField0_ |= 0x00000001;
      onChanged();
      return internalGetFileSetFieldBuilder().getBuilder();
    }
    ...
    private void ensureFileTypesIsMutable() {
      if (!fileTypes_.isModifiable()) {
        fileTypes_ = makeMutableCopy(fileTypes_);
      }
      bitField0_ |= 0x00000008;
    }
    ...
    public Builder setFileTypes(int index, com.google.privacy.dlp.v2.FileType value) {
      ...
      ensureFileTypesIsMutable();
      fileTypes_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addFileTypes(com.google.privacy.dlp.v2.FileType value) {
      ...
      ensureFileTypesIsMutable();
      fileTypes_.addInt(value.getNumber());
      onChanged();
      return this;
    }
