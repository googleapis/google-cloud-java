...
public final class InfoTypeDescription extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private InfoTypeDescription(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  @SuppressWarnings("serial")
  private com.google.protobuf.Internal.IntList supportedBy_ = emptyIntList();

  private static final com.google.protobuf.Internal.IntListAdapter.IntConverter<
          com.google.privacy.dlp.v2.InfoTypeSupportedBy>
      supportedBy_converter_ =
          new com.google.protobuf.Internal.IntListAdapter.IntConverter<
              com.google.privacy.dlp.v2.InfoTypeSupportedBy>() {
            public com.google.privacy.dlp.v2.InfoTypeSupportedBy convert(int from) {
  ...
  public java.util.List<com.google.privacy.dlp.v2.InfoTypeSupportedBy> getSupportedByList() {
    return new com.google.protobuf.Internal.IntListAdapter<
        com.google.privacy.dlp.v2.InfoTypeSupportedBy>(supportedBy_, supportedBy_converter_);
  }
  ...
  public com.google.privacy.dlp.v2.InfoTypeSupportedBy getSupportedBy(int index) {
    return supportedBy_converter_.convert(supportedBy_.getInt(index));
  }
  ...
  public int getSupportedByValue(int index) {
    return supportedBy_.getInt(index);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < supportedBy_.size(); i++) {
      output.writeEnumNoTag(supportedBy_.getInt(i));
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(example_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, example_);
    }
  ...
  public int getSerializedSize() {
    ...
    }
    {
      ...
      for (int i = 0; i < supportedBy_.size(); i++) {
        dataSize +=
            com.google.protobuf.CodedOutputStream.computeEnumSizeNoTag(supportedBy_.getInt(i));
      }
      size += dataSize;
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(example_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, example_);
    }
    for (int i = 0; i < versions_.size(); i++) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetLocationSupportFieldBuilder();
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 26:
              {
                ...
                while (input.getBytesUntilLimit() > 0) {
                  supportedBy_.addInt(input.readEnum());
                }
            ...
            case 50:
              {
                input.readMessage(
                    internalGetLocationSupportFieldBuilder().getBuilder(), extensionRegistry);
    ...
    private void ensureSupportedByIsMutable() {
      if (!supportedBy_.isModifiable()) {
        supportedBy_ = makeMutableCopy(supportedBy_);
      }
      bitField0_ |= 0x00000004;
    }
    ...
    public Builder setSupportedBy(int index, com.google.privacy.dlp.v2.InfoTypeSupportedBy value) {
      ...
      ensureSupportedByIsMutable();
      supportedBy_.setInt(index, value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder addSupportedBy(com.google.privacy.dlp.v2.InfoTypeSupportedBy value) {
      ...
      ensureSupportedByIsMutable();
      supportedBy_.addInt(value.getNumber());
      onChanged();
      return this;
    }
    ...
    public Builder setSupportedByValue(int index, int value) {
      ensureSupportedByIsMutable();
      supportedBy_.setInt(index, value);
      onChanged();
      return this;
    }
    ...
    public com.google.privacy.dlp.v2.LocationSupport.Builder getLocationSupportBuilder() {
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetLocationSupportFieldBuilder().getBuilder();
    }
