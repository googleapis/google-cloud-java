...
public final class StorageConfig extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class TimespanConfig extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private TimespanConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetTimestampFieldFieldBuilder().getBuilder(), extensionRegistry);
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetTimespanConfigFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetDatastoreOptionsFieldBuilder().getBuilder(), extensionRegistry);
                typeCase_ = 2;
                break;
              } // case 18
            case 26:
              {
                input.readMessage(
                    internalGetCloudStorageOptionsFieldBuilder().getBuilder(), extensionRegistry);
                typeCase_ = 3;
                break;
              } // case 26
            case 34:
              {
                input.readMessage(
                    internalGetBigQueryOptionsFieldBuilder().getBuilder(), extensionRegistry);
                typeCase_ = 4;
                break;
              } // case 34
            case 50:
              {
                input.readMessage(
                    internalGetTimespanConfigFieldBuilder().getBuilder(), extensionRegistry);
            ...
            case 74:
              {
                input.readMessage(
                    internalGetHybridOptionsFieldBuilder().getBuilder(), extensionRegistry);
                typeCase_ = 9;
                break;
              } // case 74
            default:
    ...
    public com.google.privacy.dlp.v2.DatastoreOptions.Builder getDatastoreOptionsBuilder() {
      return internalGetDatastoreOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.privacy.dlp.v2.DatastoreOptions.Builder,
            com.google.privacy.dlp.v2.DatastoreOptionsOrBuilder>
        internalGetDatastoreOptionsFieldBuilder() {
      if (datastoreOptionsBuilder_ == null) {
        if (!(typeCase_ == 2)) {
          type_ = com.google.privacy.dlp.v2.DatastoreOptions.getDefaultInstance();
        }
    ...
    public com.google.privacy.dlp.v2.CloudStorageOptions.Builder getCloudStorageOptionsBuilder() {
      return internalGetCloudStorageOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.privacy.dlp.v2.CloudStorageOptions.Builder,
            com.google.privacy.dlp.v2.CloudStorageOptionsOrBuilder>
        internalGetCloudStorageOptionsFieldBuilder() {
      if (cloudStorageOptionsBuilder_ == null) {
        if (!(typeCase_ == 3)) {
          type_ = com.google.privacy.dlp.v2.CloudStorageOptions.getDefaultInstance();
        }
    ...
    public com.google.privacy.dlp.v2.BigQueryOptions.Builder getBigQueryOptionsBuilder() {
      return internalGetBigQueryOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.privacy.dlp.v2.BigQueryOptions.Builder,
            com.google.privacy.dlp.v2.BigQueryOptionsOrBuilder>
        internalGetBigQueryOptionsFieldBuilder() {
      if (bigQueryOptionsBuilder_ == null) {
        if (!(typeCase_ == 4)) {
          type_ = com.google.privacy.dlp.v2.BigQueryOptions.getDefaultInstance();
        }
    ...
    public com.google.privacy.dlp.v2.HybridOptions.Builder getHybridOptionsBuilder() {
      return internalGetHybridOptionsFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.privacy.dlp.v2.HybridOptions.Builder,
            com.google.privacy.dlp.v2.HybridOptionsOrBuilder>
        internalGetHybridOptionsFieldBuilder() {
      if (hybridOptionsBuilder_ == null) {
        if (!(typeCase_ == 9)) {
          type_ = com.google.privacy.dlp.v2.HybridOptions.getDefaultInstance();
        }
    ...
    public com.google.privacy.dlp.v2.StorageConfig.TimespanConfig.Builder
      ...
      bitField0_ |= 0x00000010;
      onChanged();
      return internalGetTimespanConfigFieldBuilder().getBuilder();
    }
