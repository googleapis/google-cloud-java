...
public final class BucketingConfig extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private BucketingConfig(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          ...
          internalGetReplacementValueFieldBuilder();
        }
      }
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetReplacementValueFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.privacy.dlp.v2.Value.Builder getReplacementValueBuilder() {
        bitField0_ |= 0x00000004;
        onChanged();
        return internalGetReplacementValueFieldBuilder().getBuilder();
      }
