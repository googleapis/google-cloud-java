...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-dlp" % "3.64.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-dlp/3.64.0
