...
public final class Connector extends com.google.protobuf.GeneratedMessage
    implements
   ...
   */
  public static final class Subnet extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private Subnet(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    for (int i = 0; i < connectedProjects_.size(); i++) {
      com.google.protobuf.GeneratedMessage.writeString(output, 7, connectedProjects_.getRaw(i));
    }
    if (((bitField0_ & 0x00000001) != 0)) {
      output.writeMessage(8, getSubnet());
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(machineType_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 10, machineType_);
    }
    if (minInstances_ != 0) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(machineType_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(10, machineType_);
    }
    if (minInstances_ != 0) {
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      try {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 66:
              {
                input.readMessage(internalGetSubnetFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.vpcaccess.v1.Connector.Subnet.Builder getSubnetBuilder() {
      bitField0_ |= 0x00000080;
      onChanged();
      return internalGetSubnetFieldBuilder().getBuilder();
    }
