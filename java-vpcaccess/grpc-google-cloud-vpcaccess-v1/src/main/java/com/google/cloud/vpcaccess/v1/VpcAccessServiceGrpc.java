...
public final class VpcAccessServiceGrpc {
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloud.vpcaccess.v1.CreateConnectorRequest, com.google.longrunning.Operation>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getCreateConnectorMethod = VpcAccessServiceGrpc.getCreateConnectorMethod) == null) {
      synchronized (VpcAccessServiceGrpc.class) {
        if ((getCreateConnectorMethod = VpcAccessServiceGrpc.getCreateConnectorMethod) == null) {
          VpcAccessServiceGrpc.getCreateConnectorMethod =
              getCreateConnectorMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setSchemaDescriptor(
                          new VpcAccessServiceMethodDescriptorSupplier("CreateConnector"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getGetConnectorMethod = VpcAccessServiceGrpc.getGetConnectorMethod) == null) {
      synchronized (VpcAccessServiceGrpc.class) {
        if ((getGetConnectorMethod = VpcAccessServiceGrpc.getGetConnectorMethod) == null) {
          VpcAccessServiceGrpc.getGetConnectorMethod =
              getGetConnectorMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.vpcaccess.v1.GetConnectorRequest,
                          com.google.cloud.vpcaccess.v1.Connector>
                      ...
                      .setSchemaDescriptor(
                          new VpcAccessServiceMethodDescriptorSupplier("GetConnector"))
                      .build();
        }
      }
    }
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getListConnectorsMethod = VpcAccessServiceGrpc.getListConnectorsMethod) == null) {
      synchronized (VpcAccessServiceGrpc.class) {
        if ((getListConnectorsMethod = VpcAccessServiceGrpc.getListConnectorsMethod) == null) {
          VpcAccessServiceGrpc.getListConnectorsMethod =
              getListConnectorsMethod =
                  io.grpc.MethodDescriptor
                      .<com.google.cloud.vpcaccess.v1.ListConnectorsRequest,
                          com.google.cloud.vpcaccess.v1.ListConnectorsResponse>
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.cloud.vpcaccess.v1.ListConnectorsResponse
                                  .getDefaultInstance()))
                      .setSchemaDescriptor(
                          new VpcAccessServiceMethodDescriptorSupplier("ListConnectors"))
                      .build();
        }
      }
    }
  ...
  private static volatile io.grpc.MethodDescriptor<
          com.google.cloud.vpcaccess.v1.DeleteConnectorRequest, com.google.longrunning.Operation>
  ...
  public static io.grpc.MethodDescriptor<
    ...
    if ((getDeleteConnectorMethod = VpcAccessServiceGrpc.getDeleteConnectorMethod) == null) {
      synchronized (VpcAccessServiceGrpc.class) {
        if ((getDeleteConnectorMethod = VpcAccessServiceGrpc.getDeleteConnectorMethod) == null) {
          VpcAccessServiceGrpc.getDeleteConnectorMethod =
              getDeleteConnectorMethod =
                  io.grpc.MethodDescriptor
                      ...
                      .setResponseMarshaller(
                          io.grpc.protobuf.ProtoUtils.marshaller(
                              com.google.longrunning.Operation.getDefaultInstance()))
                      .setSchemaDescriptor(
                          new VpcAccessServiceMethodDescriptorSupplier("DeleteConnector"))
                      .build();
        }
      }
    }
  ...
  public static VpcAccessServiceStub newStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VpcAccessServiceStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<VpcAccessServiceStub>() {
          @java.lang.Override
          public VpcAccessServiceStub newStub(
   ...
   */
  public static VpcAccessServiceBlockingStub newBlockingStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VpcAccessServiceBlockingStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<VpcAccessServiceBlockingStub>() {
          @java.lang.Override
          public VpcAccessServiceBlockingStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
  ...
  public static VpcAccessServiceFutureStub newFutureStub(io.grpc.Channel channel) {
    io.grpc.stub.AbstractStub.StubFactory<VpcAccessServiceFutureStub> factory =
        new io.grpc.stub.AbstractStub.StubFactory<VpcAccessServiceFutureStub>() {
          @java.lang.Override
          public VpcAccessServiceFutureStub newStub(
              io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
   ...
   * </pre>
   */
  public static final class VpcAccessServiceStub
      extends io.grpc.stub.AbstractAsyncStub<VpcAccessServiceStub> {
    private VpcAccessServiceStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }

    @java.lang.Override
    protected VpcAccessServiceStub build(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      return new VpcAccessServiceStub(channel, callOptions);
    }
  ...
  public static final class VpcAccessServiceBlockingV2Stub
    ...
    public com.google.cloud.vpcaccess.v1.Connector getConnector(
        com.google.cloud.vpcaccess.v1.GetConnectorRequest request) throws io.grpc.StatusException {
      return io.grpc.stub.ClientCalls.blockingV2UnaryCall(
  ...
  public static final class VpcAccessServiceBlockingStub
      extends io.grpc.stub.AbstractBlockingStub<VpcAccessServiceBlockingStub> {
   ...
   * </pre>
   */
  public static final class VpcAccessServiceFutureStub
      extends io.grpc.stub.AbstractFutureStub<VpcAccessServiceFutureStub> {
    private VpcAccessServiceFutureStub(io.grpc.Channel channel, io.grpc.CallOptions callOptions) {
      super(channel, callOptions);
    }
    ...
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        createConnector(com.google.cloud.vpcaccess.v1.CreateConnectorRequest request) {
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.vpcaccess.v1.Connector>
        getConnector(com.google.cloud.vpcaccess.v1.GetConnectorRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
    ...
    public com.google.common.util.concurrent.ListenableFuture<
            com.google.cloud.vpcaccess.v1.ListConnectorsResponse>
        listConnectors(com.google.cloud.vpcaccess.v1.ListConnectorsRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
     ...
     */
    public com.google.common.util.concurrent.ListenableFuture<com.google.longrunning.Operation>
        deleteConnector(com.google.cloud.vpcaccess.v1.DeleteConnectorRequest request) {
      return io.grpc.stub.ClientCalls.futureUnaryCall(
      ...
      switch (methodId) {
        ...
        case METHODID_GET_CONNECTOR:
          serviceImpl.getConnector(
              (com.google.cloud.vpcaccess.v1.GetConnectorRequest) request,
              (io.grpc.stub.StreamObserver<com.google.cloud.vpcaccess.v1.Connector>)
                  responseObserver);
          break;
