...
/**
 * Settings class to configure an instance of {@link AppTopologyStub}.
 *
 ...
 * AppTopologyStubSettings.Builder appTopologySettingsBuilder =
 *     AppTopologyStubSettings.newBuilder();
 ...
 *             .build());
 * AppTopologyStubSettings appTopologySettings = appTopologySettingsBuilder.build();
 * }</pre>
 *
...
public class AppTopologyStubSettings extends StubSettings<AppTopologyStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder()
          .add("https://www.googleapis.com/auth/apptopology.read-only")
          .add("https://www.googleapis.com/auth/apptopology.read-write")
  ...
  public UnaryCallSettings<
          GenerateDiscoveredResourcesTopologyRequest, GenerateDiscoveredResourcesTopologyResponse>
      generateDiscoveredResourcesTopologySettings() {
    return generateDiscoveredResourcesTopologySettings;
  }
  ...
  public AppTopologyStub createStub() throws IOException {
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(GrpcTransportChannel.getGrpcTransportName())) {
      return GrpcAppTopologyStub.create(this);
    }
    if (getTransportChannelProvider()
        .getTransportName()
        .equals(HttpJsonTransportChannel.getHttpJsonTransportName())) {
      return HttpJsonAppTopologyStub.create(this);
    }
  ...
  public static String getDefaultEndpoint() {
    return "apptopology.googleapis.com:443";
  }

  /** Returns the default mTLS service endpoint. */
  public static String getDefaultMtlsEndpoint() {
    return "apptopology.mtls.googleapis.com:443";
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(AppTopologyStubSettings.class))
        .setTransportToken(
  ...
  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return AppTopologyStubSettings.defaultGrpcApiClientHeaderProviderBuilder();
  }
  ...
  protected AppTopologyStubSettings(Builder settingsBuilder) throws IOException {
  ...
  protected LibraryMetadata getLibraryMetadata() {
    return LibraryMetadata.newBuilder()
        .setArtifactName("com.google.cloud:google-cloud-apptopology")
        .setRepository("googleapis/google-cloud-java")
        .setVersion(Version.VERSION)
        .build();
  }

  /** Builder for AppTopologyStubSettings. */
  public static class Builder extends StubSettings.Builder<AppTopologyStubSettings, Builder> {
    ...
    protected Builder(AppTopologyStubSettings settings) {
      super(settings);
    ...
    @Override
    public AppTopologyStubSettings build() throws IOException {
      return new AppTopologyStubSettings(this);
    }
  }
}
