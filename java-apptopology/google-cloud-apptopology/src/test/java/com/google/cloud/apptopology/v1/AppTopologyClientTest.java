...
public class AppTopologyClientTest {
  private static MockAppTopology mockAppTopology;
  private static MockLocations mockLocations;
  private static MockServiceHelper mockServiceHelper;
  private LocalChannelProvider channelProvider;
  private AppTopologyClient client;

  @BeforeClass
  public static void startStaticServer() {
    mockAppTopology = new MockAppTopology();
    mockLocations = new MockLocations();
    mockServiceHelper =
        new MockServiceHelper(
            UUID.randomUUID().toString(),
            Arrays.<MockGrpcService>asList(mockAppTopology, mockLocations));
  ...
  public void generateDiscoveredResourcesTopologyTest() throws Exception {
    ...
    GenerateDiscoveredResourcesTopologyRequest actualRequest =
        ((GenerateDiscoveredResourcesTopologyRequest) actualRequests.get(0));

    Assert.assertEquals(name.toString(), actualRequest.getName());
    Assert.assertEquals(topologyDomains, actualRequest.getTopologyDomainsList());
    Assert.assertTrue(
