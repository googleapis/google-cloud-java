...
public interface IntValueOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.apptopology.v1.IntValue)
   ...
   */
  java.util.List<java.lang.Long> getAllowedValuesList();
   ...
   */
  long getAllowedValues(int index);
}
