...
public interface DoubleValueOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.apptopology.v1.DoubleValue)
   ...
   */
  java.util.List<java.lang.Double> getAllowedValuesList();
   ...
   */
  double getAllowedValues(int index);
}
