...
public class SchemaName implements ResourceName {
  ...
  public static SchemaName of(String project, String location, String domain) {
  ...
  /** Builder for projects/{project}/locations/{location}/domains/{domain}/schema. */
