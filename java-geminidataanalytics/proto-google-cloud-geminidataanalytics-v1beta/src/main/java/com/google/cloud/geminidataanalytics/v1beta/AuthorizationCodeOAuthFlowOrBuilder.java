...
public interface AuthorizationCodeOAuthFlowOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1beta.AuthorizationCodeOAuthFlow)
