...
public interface FirestoreReferenceOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1beta.FirestoreReference)
   ...
   *
   * <code>
   * .google.cloud.geminidataanalytics.v1beta.FirestoreDatabaseReference database_reference = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.geminidataanalytics.v1beta.FirestoreDatabaseReference getDatabaseReference();
