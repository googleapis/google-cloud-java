...
public interface HTTPAuthSecuritySchemeOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1beta.HTTPAuthSecurityScheme)
