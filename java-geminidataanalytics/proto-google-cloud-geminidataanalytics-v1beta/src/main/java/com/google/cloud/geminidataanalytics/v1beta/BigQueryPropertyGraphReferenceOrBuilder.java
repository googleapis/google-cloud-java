...
public interface BigQueryPropertyGraphReferenceOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1beta.BigQueryPropertyGraphReference)
   ...
   * </pre>
   *
   * <code>string property_graph_id = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   *
