...
/**
 * Settings class to configure an instance of {@link DataChatServiceStub}.
 *
...
public class DataChatServiceStubSettings extends StubSettings<DataChatServiceStubSettings> {
  ...
  private static final PagedListDescriptor<
          ListMessagesRequest, ListMessagesResponse, StorageMessage>
      LIST_MESSAGES_PAGE_STR_DESC =
          new PagedListDescriptor<ListMessagesRequest, ListMessagesResponse, StorageMessage>() {
            @Override
            public String emptyToken() {
              return "";
            }
      ...
      LIST_MESSAGES_PAGE_STR_FACT =
          new PagedListResponseFactory<
            ...
            public ApiFuture<ListMessagesPagedResponse> getFuturePagedResponse(
              ...
              PageContext<ListMessagesRequest, ListMessagesResponse, StorageMessage> pageContext =
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(DataChatServiceStubSettings.class))
        .setTransportToken(
  ...
  public static class Builder extends StubSettings.Builder<DataChatServiceStubSettings, Builder> {
