...
/**
 * Base stub class for the DataA2AService service API.
 *
...
public abstract class DataA2AServiceStub implements BackgroundResource {

  public UnaryCallable<SendMessageRequest, SendMessageResponse> sendMessageCallable() {
    throw new UnsupportedOperationException("Not implemented: sendMessageCallable()");
  }

  public ServerStreamingCallable<SendMessageRequest, StreamResponse>
      sendStreamingMessageCallable() {
    throw new UnsupportedOperationException("Not implemented: sendStreamingMessageCallable()");
  }

  public UnaryCallable<GetAgentCardRequest, AgentCard> getAgentCardCallable() {
    throw new UnsupportedOperationException("Not implemented: getAgentCardCallable()");
  }
