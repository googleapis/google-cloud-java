...
import com.google.cloud.geminidataanalytics.v1beta.stub.HttpJsonDataA2AServiceStub;
...
public class DataA2AServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static DataA2AServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonDataA2AServiceStub.getMethodDescriptors(),
            DataA2AServiceSettings.getDefaultEndpoint());
    DataA2AServiceSettings settings =
        DataA2AServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                DataA2AServiceSettings.defaultHttpJsonTransportProviderBuilder()
  ...
  public void sendMessageTest() throws Exception {
    ...
    String tenant = "projects/project-6353/locations/location-6353/agents/agent-6353";
