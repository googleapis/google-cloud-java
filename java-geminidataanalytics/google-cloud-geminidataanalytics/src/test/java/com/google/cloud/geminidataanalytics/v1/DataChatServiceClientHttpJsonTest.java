...
import com.google.cloud.geminidataanalytics.v1.stub.HttpJsonDataChatServiceStub;
...
public class DataChatServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static DataChatServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonDataChatServiceStub.getMethodDescriptors(),
            DataChatServiceSettings.getDefaultEndpoint());
    DataChatServiceSettings settings =
        DataChatServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                DataChatServiceSettings.defaultHttpJsonTransportProviderBuilder()
