...
public interface CreateConversationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1.CreateConversationRequest)
   ...
   *
   * <code>
   * .google.cloud.geminidataanalytics.v1.Conversation conversation = 3 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
