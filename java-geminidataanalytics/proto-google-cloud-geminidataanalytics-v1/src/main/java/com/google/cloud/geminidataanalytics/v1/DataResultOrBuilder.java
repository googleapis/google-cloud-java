...
public interface DataResultOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1.DataResult)
   ...
   *
   * <code>
   * .google.cloud.geminidataanalytics.v1.Schema schema = 5 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The schema.
   */
  com.google.cloud.geminidataanalytics.v1.Schema getSchema();
   ...
   * </code>
   */
  com.google.cloud.geminidataanalytics.v1.SchemaOrBuilder getSchemaOrBuilder();
