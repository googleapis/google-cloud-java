...
public interface ListAccessibleDataAgentsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1.ListAccessibleDataAgentsRequest)
   ...
   *
   * <code>
   * .google.cloud.geminidataanalytics.v1.ListAccessibleDataAgentsRequest.CreatorFilter creator_filter = 7 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
