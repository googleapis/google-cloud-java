...
public interface DataFilterOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1.DataFilter)
   ...
   *
   * <code>
   * .google.cloud.geminidataanalytics.v1.DataFilterType type = 3 [(.google.api.field_behavior) = OPTIONAL];
   * </code>
   *
   ...
   * @return The type.
   */
  com.google.cloud.geminidataanalytics.v1.DataFilterType getType();
}
