...
public interface UpdateConversationRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.geminidataanalytics.v1.UpdateConversationRequest)
   ...
   *
   * <code>
   * .google.cloud.geminidataanalytics.v1.Conversation conversation = 1 [(.google.api.field_behavior) = REQUIRED];
   * </code>
   *
   ...
   */
  com.google.cloud.geminidataanalytics.v1.Conversation getConversation();
   ...
   * </code>
   */
  com.google.cloud.geminidataanalytics.v1.ConversationOrBuilder getConversationOrBuilder();
