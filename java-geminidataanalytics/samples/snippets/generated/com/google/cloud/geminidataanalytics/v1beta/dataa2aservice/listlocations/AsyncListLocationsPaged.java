...
// [START geminidataanalytics_v1beta_generated_DataA2AService_ListLocations_Paged_async]
    ...
    try (DataA2AServiceClient dataA2AServiceClient = DataA2AServiceClient.create()) {
      ListLocationsRequest request =
          ListLocationsRequest.newBuilder()
              ...
              .build();
      while (true) {
        ListLocationsResponse response = dataA2AServiceClient.listLocationsCallable().call(request);
...
// [END geminidataanalytics_v1beta_generated_DataA2AService_ListLocations_Paged_async]
