...
// [START geminidataanalytics_v1beta_generated_DataA2AService_ListLocations_async]
  ...
  public static void asyncListLocations() throws Exception {
    ...
    try (DataA2AServiceClient dataA2AServiceClient = DataA2AServiceClient.create()) {
      ...
      ApiFuture<Location> future =
          dataA2AServiceClient.listLocationsPagedCallable().futureCall(request);
      // Do something.
...
// [END geminidataanalytics_v1beta_generated_DataA2AService_ListLocations_async]
