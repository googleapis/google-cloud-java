...
// [START geminidataanalytics_v1beta_generated_DataA2AService_ListLocations_sync]
    ...
    try (DataA2AServiceClient dataA2AServiceClient = DataA2AServiceClient.create()) {
      ListLocationsRequest request =
          ListLocationsRequest.newBuilder()
              ...
              .build();
      for (Location element : dataA2AServiceClient.listLocations(request).iterateAll()) {
        // doThingsWith(element);
      }
    }
  }
}
// [END geminidataanalytics_v1beta_generated_DataA2AService_ListLocations_sync]
