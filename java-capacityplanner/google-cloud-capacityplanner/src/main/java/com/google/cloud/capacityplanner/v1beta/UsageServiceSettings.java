...
/**
 * Settings class to configure an instance of {@link UsageServiceClient}.
 *
...
public class UsageServiceSettings extends ClientSettings<UsageServiceSettings> {
  ...
  public UnaryCallSettings<QueryUsageHistoriesRequest, QueryUsageHistoriesResponse>
      queryUsageHistoriesSettings() {
    return ((UsageServiceStubSettings) getStubSettings()).queryUsageHistoriesSettings();
  }
  ...
  public UnaryCallSettings<QueryForecastsRequest, QueryForecastsResponse> queryForecastsSettings() {
    return ((UsageServiceStubSettings) getStubSettings()).queryForecastsSettings();
  }
  ...
  public UnaryCallSettings<QueryReservationsRequest, QueryReservationsResponse>
    ...
    return ((UsageServiceStubSettings) getStubSettings()).queryReservationsSettings();
  }
  ...
  public UnaryCallSettings<ExportUsageHistoriesRequest, Operation> exportUsageHistoriesSettings() {
    return ((UsageServiceStubSettings) getStubSettings()).exportUsageHistoriesSettings();
  }
  ...
  public OperationCallSettings<
    ...
    return ((UsageServiceStubSettings) getStubSettings()).exportUsageHistoriesOperationSettings();
  }
  ...
  public UnaryCallSettings<ExportForecastsRequest, Operation> exportForecastsSettings() {
    return ((UsageServiceStubSettings) getStubSettings()).exportForecastsSettings();
  }
  ...
  public OperationCallSettings<ExportForecastsRequest, ExportForecastsResponse, OperationMetadata>
    ...
    return ((UsageServiceStubSettings) getStubSettings()).exportForecastsOperationSettings();
  }
  ...
  public UnaryCallSettings<ExportReservationsUsageRequest, Operation>
    ...
    return ((UsageServiceStubSettings) getStubSettings()).exportReservationsUsageSettings();
  }
  ...
  public OperationCallSettings<
    ...
    return ((UsageServiceStubSettings) getStubSettings())
        .exportReservationsUsageOperationSettings();
  }

  public static final UsageServiceSettings create(UsageServiceStubSettings stub)
      throws IOException {
    return new UsageServiceSettings.Builder(stub.toBuilder()).build();
  }

  /** Returns a builder for the default ExecutorProvider for this service. */
  public static InstantiatingExecutorProvider.Builder defaultExecutorProviderBuilder() {
    return UsageServiceStubSettings.defaultExecutorProviderBuilder();
  }

  /** Returns the default service endpoint. */
  public static String getDefaultEndpoint() {
    return UsageServiceStubSettings.getDefaultEndpoint();
  }

  /** Returns the default service scopes. */
  public static List<String> getDefaultServiceScopes() {
    return UsageServiceStubSettings.getDefaultServiceScopes();
  }

  /** Returns a builder for the default credentials for this service. */
  public static GoogleCredentialsProvider.Builder defaultCredentialsProviderBuilder() {
    return UsageServiceStubSettings.defaultCredentialsProviderBuilder();
  }

  /** Returns a builder for the default gRPC ChannelProvider for this service. */
  public static InstantiatingGrpcChannelProvider.Builder defaultGrpcTransportProviderBuilder() {
    return UsageServiceStubSettings.defaultGrpcTransportProviderBuilder();
  }
  ...
  public static InstantiatingHttpJsonChannelProvider.Builder
    ...
    return UsageServiceStubSettings.defaultHttpJsonTransportProviderBuilder();
  }

  public static TransportChannelProvider defaultTransportChannelProvider() {
    return UsageServiceStubSettings.defaultTransportChannelProvider();
  }

  public static ApiClientHeaderProvider.Builder defaultApiClientHeaderProviderBuilder() {
    return UsageServiceStubSettings.defaultApiClientHeaderProviderBuilder();
  }
  ...
  protected UsageServiceSettings(Builder settingsBuilder) throws IOException {
    super(settingsBuilder);
  }

  /** Builder for UsageServiceSettings. */
  public static class Builder extends ClientSettings.Builder<UsageServiceSettings, Builder> {
    ...
    protected Builder(ClientContext clientContext) {
      super(UsageServiceStubSettings.newBuilder(clientContext));
    }

    protected Builder(UsageServiceSettings settings) {
      super(settings.getStubSettings().toBuilder());
    }

    protected Builder(UsageServiceStubSettings.Builder stubSettings) {
      super(stubSettings);
    }

    private static Builder createDefault() {
      return new Builder(UsageServiceStubSettings.newBuilder());
    }

    private static Builder createHttpJsonDefault() {
      return new Builder(UsageServiceStubSettings.newHttpJsonBuilder());
    }

    public UsageServiceStubSettings.Builder getStubSettingsBuilder() {
      return ((UsageServiceStubSettings.Builder) getStubSettings());
    }
    ...
    public UnaryCallSettings.Builder<QueryUsageHistoriesRequest, QueryUsageHistoriesResponse>
        queryUsageHistoriesSettings() {
      return getStubSettingsBuilder().queryUsageHistoriesSettings();
    }
    ...
    public UnaryCallSettings.Builder<QueryForecastsRequest, QueryForecastsResponse>
      ...
      return getStubSettingsBuilder().queryForecastsSettings();
    }
    ...
    public UnaryCallSettings.Builder<QueryReservationsRequest, QueryReservationsResponse>
        queryReservationsSettings() {
      return getStubSettingsBuilder().queryReservationsSettings();
    }
    ...
    public UnaryCallSettings.Builder<ExportUsageHistoriesRequest, Operation>
      ...
      return getStubSettingsBuilder().exportUsageHistoriesSettings();
    }
    ...
    public OperationCallSettings.Builder<
            ExportUsageHistoriesRequest, ExportUsageHistoriesResponse, OperationMetadata>
        exportUsageHistoriesOperationSettings() {
      return getStubSettingsBuilder().exportUsageHistoriesOperationSettings();
    }
    ...
    public UnaryCallSettings.Builder<ExportForecastsRequest, Operation> exportForecastsSettings() {
      return getStubSettingsBuilder().exportForecastsSettings();
    }
    ...
    public OperationCallSettings.Builder<
        ...
        exportForecastsOperationSettings() {
      return getStubSettingsBuilder().exportForecastsOperationSettings();
    }
    ...
    public UnaryCallSettings.Builder<ExportReservationsUsageRequest, Operation>
        exportReservationsUsageSettings() {
      return getStubSettingsBuilder().exportReservationsUsageSettings();
    }
    ...
    public OperationCallSettings.Builder<
            ExportReservationsUsageRequest, ExportReservationsUsageResponse, OperationMetadata>
        exportReservationsUsageOperationSettings() {
      return getStubSettingsBuilder().exportReservationsUsageOperationSettings();
    }

    @Override
    public UsageServiceSettings build() throws IOException {
      return new UsageServiceSettings(this);
    }
  }
}
