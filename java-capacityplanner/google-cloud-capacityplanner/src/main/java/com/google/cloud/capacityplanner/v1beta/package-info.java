...
/**
 * A client to Capacity Planner API
 *
 * <p>The interfaces provided are listed below, along with usage samples.
 *
 * <p>======================= UsageServiceClient =======================
 *
 * <p>Service Description: Provides access to historical and forecasted usage data.
 *
 * <p>Sample for UsageServiceClient:
 *
 * <pre>{@code
