...
public interface ExportUsageHistoriesRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.capacityplanner.v1beta.ExportUsageHistoriesRequest)
