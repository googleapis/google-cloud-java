...
public interface ExportUsageHistoriesResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.capacityplanner.v1beta.ExportUsageHistoriesResponse)
