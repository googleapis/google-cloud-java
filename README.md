...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-datastore" % "2.16.1"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-datastore/2.16.1
