...
```Groovy
implementation 'com.google.cloud:google-cloud-logging-logback:0.129.6-alpha'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging-logback" % "0.129.6-alpha"
```
