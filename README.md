...
<dependency>
  ...
  <version>0.130.19-alpha</version>
</dependency>
```
...
```Groovy
implementation 'com.google.cloud:google-cloud-logging-logback:0.130.19-alpha'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging-logback" % "0.130.19-alpha"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-logging-logback/0.130.19-alpha
