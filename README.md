...
<dependency>
  ...
  <version>0.120.8-alpha</version>
</dependency>
```

If you are using Gradle without BOM, add this to your dependencies
```Groovy
compile 'com.google.cloud:google-cloud-logging-logback:0.120.8-alpha'
```

If you are using SBT, add this to your dependencies
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging-logback" % "0.120.8-alpha"
```
...
[product-docs]: https://cloud.google.com/logging/docs/setup/java/
