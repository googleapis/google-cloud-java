...
```Groovy
implementation 'com.google.cloud:google-cloud-logging-logback:0.131.0-alpha'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-logging-logback/0.131.0-alpha
