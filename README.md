...
```Groovy
implementation 'com.google.cloud:google-cloud-logging-logback:0.122.5-alpha'
```

If you are using SBT, add this to your dependencies

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging-logback" % "0.122.5-alpha"
```
