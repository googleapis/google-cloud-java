...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-bigquery" % "2.24.2"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-bigquery/2.24.2
