...
<dependency>
  ...
  <version>0.130.17-alpha</version>
</dependency>
```
...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging-logback" % "0.130.17-alpha"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-logging-logback/0.130.17-alpha
