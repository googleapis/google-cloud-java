...
```Groovy
implementation 'com.google.cloud:google-cloud-logging-logback:0.127.6-alpha'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-logging-logback" % "0.127.6-alpha"
```
