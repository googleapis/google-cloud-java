...
public class ProtectedResourceScopeName implements ResourceName {
  ...
  public static @Nullable ProtectedResourceScopeName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ProtectedResourceScopeName> values) {
