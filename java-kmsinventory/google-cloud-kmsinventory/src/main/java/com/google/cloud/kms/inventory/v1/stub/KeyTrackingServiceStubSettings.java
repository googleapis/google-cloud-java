...
/**
 * Settings class to configure an instance of {@link KeyTrackingServiceStub}.
 *
...
public class KeyTrackingServiceStubSettings extends StubSettings<KeyTrackingServiceStubSettings> {
  /** The default scopes of the service. */
  private static final ImmutableList<String> DEFAULT_SERVICE_SCOPES =
      ImmutableList.<String>builder().add("https://www.googleapis.com/auth/cloud-platform").build();

  private final UnaryCallSettings<GetProtectedResourcesSummaryRequest, ProtectedResourcesSummary>
      getProtectedResourcesSummarySettings;
  ...
  private static final PagedListDescriptor<
          SearchProtectedResourcesRequest, SearchProtectedResourcesResponse, ProtectedResource>
      SEARCH_PROTECTED_RESOURCES_PAGE_STR_DESC =
          new PagedListDescriptor<
            ...
            @Override
            public SearchProtectedResourcesRequest injectToken(
                SearchProtectedResourcesRequest payload, String token) {
              return SearchProtectedResourcesRequest.newBuilder(payload)
                  .setPageToken(token)
                  .build();
            }

            @Override
            public SearchProtectedResourcesRequest injectPageSize(
                SearchProtectedResourcesRequest payload, int pageSize) {
              return SearchProtectedResourcesRequest.newBuilder(payload)
            ...
            @Override
            public Iterable<ProtectedResource> extractResources(
                SearchProtectedResourcesResponse payload) {
              return payload.getProtectedResourcesList() == null
                  ? ImmutableList.<ProtectedResource>of()
                  : payload.getProtectedResourcesList();
            }
          };
  ...
  private static final PagedListResponseFactory<
          ...
          SearchProtectedResourcesResponse,
          SearchProtectedResourcesPagedResponse>
      SEARCH_PROTECTED_RESOURCES_PAGE_STR_FACT =
          new PagedListResponseFactory<
              SearchProtectedResourcesRequest,
              SearchProtectedResourcesResponse,
              SearchProtectedResourcesPagedResponse>() {
            @Override
            public ApiFuture<SearchProtectedResourcesPagedResponse> getFuturePagedResponse(
              ...
              PageContext<
                  ...
                  pageContext =
                      PageContext.create(
                          callable, SEARCH_PROTECTED_RESOURCES_PAGE_STR_DESC, request, context);
              return SearchProtectedResourcesPagedResponse.createAsync(pageContext, futureResponse);
            }
          };
  ...
  public UnaryCallSettings<GetProtectedResourcesSummaryRequest, ProtectedResourcesSummary>
      getProtectedResourcesSummarySettings() {
    return getProtectedResourcesSummarySettings;
  }
  ...
  public static ApiClientHeaderProvider.Builder defaultGrpcApiClientHeaderProviderBuilder() {
    return ApiClientHeaderProvider.newBuilder()
        .setGeneratedLibToken(
            "gapic", GaxProperties.getLibraryVersion(KeyTrackingServiceStubSettings.class))
        .setTransportToken(
  ...
  protected KeyTrackingServiceStubSettings(Builder settingsBuilder) throws IOException {
    ...
    getProtectedResourcesSummarySettings =
        settingsBuilder.getProtectedResourcesSummarySettings().build();
    searchProtectedResourcesSettings = settingsBuilder.searchProtectedResourcesSettings().build();
  }
  ...
  public static class Builder
    ...
    protected Builder(ClientContext clientContext) {
      ...
      getProtectedResourcesSummarySettings = UnaryCallSettings.newUnaryCallSettingsBuilder();
      searchProtectedResourcesSettings =
          PagedCallSettings.newBuilder(SEARCH_PROTECTED_RESOURCES_PAGE_STR_FACT);

      unaryMethodSettingsBuilders =
          ImmutableList.<UnaryCallSettings.Builder<?, ?>>of(
              getProtectedResourcesSummarySettings, searchProtectedResourcesSettings);
      initDefaults(this);
    }
    ...
    protected Builder(KeyTrackingServiceStubSettings settings) {
      ...
      getProtectedResourcesSummarySettings =
          settings.getProtectedResourcesSummarySettings.toBuilder();
      searchProtectedResourcesSettings = settings.searchProtectedResourcesSettings.toBuilder();
