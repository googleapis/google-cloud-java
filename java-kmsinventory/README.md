...
```Groovy
implementation 'com.google.cloud:google-cloud-kmsinventory:0.51.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-kmsinventory" % "0.51.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-kmsinventory/0.51.0
