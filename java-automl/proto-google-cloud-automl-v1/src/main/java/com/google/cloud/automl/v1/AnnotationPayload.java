...
public final class AnnotationPayload extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private AnnotationPayload(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(annotationSpecId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 1, annotationSpecId_);
    }
    if (detailCase_ == 2) {
  ...
  public int getSerializedSize() {
    ...
    size = 0;
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(annotationSpecId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(1, annotationSpecId_);
    }
    if (detailCase_ == 2) {
      size +=
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 18:
              {
                input.readMessage(
                    internalGetTranslationFieldBuilder().getBuilder(), extensionRegistry);
                detailCase_ = 2;
                break;
              } // case 18
            case 26:
            ...
            case 34:
              {
                input.readMessage(
                    internalGetImageObjectDetectionFieldBuilder().getBuilder(), extensionRegistry);
                detailCase_ = 4;
                break;
              } // case 34
            case 42:
            ...
            case 50:
              {
                input.readMessage(
                    internalGetTextExtractionFieldBuilder().getBuilder(), extensionRegistry);
                detailCase_ = 6;
                break;
              } // case 50
            case 58:
              {
                input.readMessage(
                    internalGetTextSentimentFieldBuilder().getBuilder(), extensionRegistry);
                detailCase_ = 7;
                break;
              } // case 58
            default:
    ...
    public com.google.cloud.automl.v1.ImageObjectDetectionAnnotation.Builder
      ...
      return internalGetImageObjectDetectionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.automl.v1.ImageObjectDetectionAnnotation.Builder,
            com.google.cloud.automl.v1.ImageObjectDetectionAnnotationOrBuilder>
        internalGetImageObjectDetectionFieldBuilder() {
      if (imageObjectDetectionBuilder_ == null) {
        if (!(detailCase_ == 4)) {
    ...
    public com.google.cloud.automl.v1.TextExtractionAnnotation.Builder getTextExtractionBuilder() {
      return internalGetTextExtractionFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.automl.v1.TextExtractionAnnotation.Builder,
            com.google.cloud.automl.v1.TextExtractionAnnotationOrBuilder>
        internalGetTextExtractionFieldBuilder() {
      if (textExtractionBuilder_ == null) {
        if (!(detailCase_ == 6)) {
    ...
    public com.google.cloud.automl.v1.TextSentimentAnnotation.Builder getTextSentimentBuilder() {
      return internalGetTextSentimentFieldBuilder().getBuilder();
    }
    ...
    private com.google.protobuf.SingleFieldBuilder<
            ...
            com.google.cloud.automl.v1.TextSentimentAnnotation.Builder,
            com.google.cloud.automl.v1.TextSentimentAnnotationOrBuilder>
        internalGetTextSentimentFieldBuilder() {
      if (textSentimentBuilder_ == null) {
        if (!(detailCase_ == 7)) {
          detail_ = com.google.cloud.automl.v1.TextSentimentAnnotation.getDefaultInstance();
        }
