...
public final class TableSpec extends com.google.protobuf.GeneratedMessage
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(timeColumnSpecId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 2, timeColumnSpecId_);
    }
    if (rowCount_ != 0L) {
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(timeColumnSpecId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(2, timeColumnSpecId_);
    }
    if (rowCount_ != 0L) {
