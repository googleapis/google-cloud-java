...
public final class TextSentimentProto extends com.google.protobuf.GeneratedFile {
   ...
   */
  public static final class TextSentimentAnnotation extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private TextSentimentAnnotation(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
  ...
  public static final class TextSentimentEvaluationMetrics
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      for (int i = 0; i < annotationSpecId_.size(); i++) {
        com.google.protobuf.GeneratedMessage.writeString(output, 9, annotationSpecId_.getRaw(i));
      }
      getUnknownFields().writeTo(output);
    }
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
      ...
      private void maybeForceBuilderInitialization() {
        if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
          internalGetConfusionMatrixFieldBuilder();
        }
      }
      ...
      public Builder mergeFrom(
        ...
        if (other
            == com.google.cloud.automl.v1beta1.TextSentimentProto.TextSentimentEvaluationMetrics
                .getDefaultInstance()) return this;
        if (java.lang.Float.floatToRawIntBits(other.getPrecision()) != 0) {
          setPrecision(other.getPrecision());
        }
        if (java.lang.Float.floatToRawIntBits(other.getRecall()) != 0) {
          setRecall(other.getRecall());
        }
        if (java.lang.Float.floatToRawIntBits(other.getF1Score()) != 0) {
          setF1Score(other.getF1Score());
        }
        if (java.lang.Float.floatToRawIntBits(other.getMeanAbsoluteError()) != 0) {
          setMeanAbsoluteError(other.getMeanAbsoluteError());
        }
        if (java.lang.Float.floatToRawIntBits(other.getMeanSquaredError()) != 0) {
          setMeanSquaredError(other.getMeanSquaredError());
        }
        if (java.lang.Float.floatToRawIntBits(other.getLinearKappa()) != 0) {
          setLinearKappa(other.getLinearKappa());
        }
        if (java.lang.Float.floatToRawIntBits(other.getQuadraticKappa()) != 0) {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 66:
                {
                  input.readMessage(
                      internalGetConfusionMatrixFieldBuilder().getBuilder(), extensionRegistry);
      ...
      public com.google.cloud.automl.v1beta1.ClassificationProto.ClassificationEvaluationMetrics
        ...
        bitField0_ |= 0x00000080;
        onChanged();
        return internalGetConfusionMatrixFieldBuilder().getBuilder();
      }
