...
public final class TablesAnnotation extends com.google.protobuf.GeneratedMessage
    implements
  ...
  private TablesAnnotation(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
    super(builder);
  }
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        internalGetPredictionIntervalFieldBuilder();
    ...
    public Builder mergeFrom(com.google.cloud.automl.v1beta1.TablesAnnotation other) {
      ...
      if (java.lang.Float.floatToRawIntBits(other.getBaselineScore()) != 0) {
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 34:
              {
                input.readMessage(
                    internalGetPredictionIntervalFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.automl.v1beta1.DoubleRange.Builder getPredictionIntervalBuilder() {
      bitField0_ |= 0x00000002;
      onChanged();
      return internalGetPredictionIntervalFieldBuilder().getBuilder();
    }
