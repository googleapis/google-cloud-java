...
public interface CreateUserRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.ftp.v1.CreateUserRequest)
   ...
   * @return The user.
   */
  com.google.cloud.ftp.v1.User getUser();
   ...
   * <code>.google.cloud.ftp.v1.User user = 3 [(.google.api.field_behavior) = REQUIRED];</code>
   */
  com.google.cloud.ftp.v1.UserOrBuilder getUserOrBuilder();
