...
public class UserName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_SERVER_USER =
  ...
  public static UserName of(String project, String location, String server, String user) {
    return newBuilder()
        .setProject(project)
  ...
  public static String format(String project, String location, String server, String user) {
    return newBuilder()
        .setProject(project)
        .setLocation(location)
        .setServer(server)
  ...
  public static @Nullable UserName parse(String formattedString) {
    ...
    Map<String, String> matchMap =
        PROJECT_LOCATION_SERVER_USER.validatedMatch(
  ...
  public static boolean isParsableFrom(String formattedString) {
    return PROJECT_LOCATION_SERVER_USER.matches(formattedString);
  }
  ...
  public String toString() {
    return PROJECT_LOCATION_SERVER_USER.instantiate(
        "project", project, "location", location, "server", server, "user", user);
  }
  ...
  /** Builder for projects/{project}/locations/{location}/servers/{server}/users/{user}. */
