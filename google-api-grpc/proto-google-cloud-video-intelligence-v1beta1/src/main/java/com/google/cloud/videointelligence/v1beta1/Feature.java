 ...
 * </pre>
 *
 * Protobuf enum {@code google.cloud.videointelligence.v1beta1.Feature}
 */
public enum Feature
   ...
   * <code>FACE_DETECTION = 2;</code>
   */
  public static final int FACE_DETECTION_VALUE = 2;
  /**
   * <pre>
   * Shot change detection.
   * </pre>
   ...
   * <code>SHOT_CHANGE_DETECTION = 3;</code>
   */
  public static final int SHOT_CHANGE_DETECTION_VALUE = 3;
  /**
   * <pre>
   * Safe search detection.
   * </pre>
   ...
   * <code>SAFE_SEARCH_DETECTION = 4;</code>
   */
  public static final int SAFE_SEARCH_DETECTION_VALUE = 4;
  ...
  public static Feature forNumber(int value) {
    switch (value) {
      ...
      case 2: return FACE_DETECTION;
      case 3: return SHOT_CHANGE_DETECTION;
      case 4: return SAFE_SEARCH_DETECTION;
      default: return null;
    }
  }
  ...
  // @@protoc_insertion_point(enum_scope:google.cloud.videointelligence.v1beta1.Feature)
}
