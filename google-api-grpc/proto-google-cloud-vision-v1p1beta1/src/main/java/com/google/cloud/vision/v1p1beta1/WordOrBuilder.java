...
public interface WordOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vision.v1p1beta1.Word)
   ...
   */
  java.util.List<com.google.cloud.vision.v1p1beta1.Symbol> getSymbolsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p1beta1.Symbol symbols = 3;</code>
   */
  java.util.List<? extends com.google.cloud.vision.v1p1beta1.SymbolOrBuilder>
