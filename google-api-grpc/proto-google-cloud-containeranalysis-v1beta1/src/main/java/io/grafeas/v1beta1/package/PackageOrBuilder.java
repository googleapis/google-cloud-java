...
public interface PackageOrBuilder extends
   ...
   */
  java.util.List<io.grafeas.v1beta1.package.Distribution> 
      getDistributionList();
  /**
   * <pre>
   * The various channels by which a package is distributed.
   ...
   * <code>repeated .grafeas.v1beta1.package.Distribution distribution = 10;</code>
   */
  io.grafeas.v1beta1.package.Distribution getDistribution(int index);
  /**
   * <pre>
   * The various channels by which a package is distributed.
   * </pre>
   ...
   * <code>repeated .grafeas.v1beta1.package.Distribution distribution = 10;</code>
   */
  java.util.List<? extends io.grafeas.v1beta1.package.DistributionOrBuilder> 
   ...
   * <code>repeated .grafeas.v1beta1.package.Distribution distribution = 10;</code>
   */
  io.grafeas.v1beta1.package.DistributionOrBuilder getDistributionOrBuilder(
      int index);
}
