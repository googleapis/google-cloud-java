...
public interface ParagraphOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.vision.v1p4beta1.Paragraph)
   ...
   */
  java.util.List<com.google.cloud.vision.v1p4beta1.Word> getWordsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.Word words = 3;</code>
   */
  com.google.cloud.vision.v1p4beta1.Word getWords(int index);
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.Word words = 3;</code>
   */
  java.util.List<? extends com.google.cloud.vision.v1p4beta1.WordOrBuilder> getWordsOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p4beta1.Word words = 3;</code>
   */
  com.google.cloud.vision.v1p4beta1.WordOrBuilder getWordsOrBuilder(int index);
