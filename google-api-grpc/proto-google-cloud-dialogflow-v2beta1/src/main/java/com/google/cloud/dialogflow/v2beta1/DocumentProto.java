  ...
  static {
    java.lang.String[] descriptorData = {
      "\n.google/cloud/dialogflow/v2beta1/docume"
          ...
          + "pes\030\004 \003(\01627.google.cloud.dialogflow.v2be"
          + "ta1.Document.KnowledgeType\022\025\n\013content_ur"
          + "i\030\005 \001(\tH\000\022\025\n\007content\030\006 \001(\tB\002\030\001H\000\022\025\n\013raw_"
          + "content\030\t \001(\014H\000\"K\n\rKnowledgeType\022\036\n\032KNOW"
          + "LEDGE_TYPE_UNSPECIFIED\020\000\022\007\n\003FAQ\020\001\022\021\n\rEXT"
          + "RACTIVE_QA\020\002B\010\n\006source\"M\n\024ListDocumentsR"
          ...
          + "rent\030\001 \001(\t\022;\n\010document\030\002 \001(\0132).google.cl"
          + "oud.dialogflow.v2beta1.Document\"%\n\025Delet"
          + "eDocumentRequest\022\014\n\004name\030\001 \001(\t\"\205\001\n\025Updat"
          + "eDocumentRequest\022;\n\010document\030\001 \001(\0132).goo"
          + "gle.cloud.dialogflow.v2beta1.Document\022/\n"
          + "\013update_mask\030\002 \001(\0132\032.google.protobuf.Fie"
          + "ldMask\"\262\001\n\032KnowledgeOperationMetadata\022P\n"
          + "\005state\030\001 \001(\0162A.google.cloud.dialogflow.v"
          + "2beta1.KnowledgeOperationMetadata.State\""
          ...
          + "sResponse\"\200\001\202\323\344\223\002z\0227/v2beta1/{parent=pro"
          + "jects/*/knowledgeBases/*}/documentsZ?\022=/"
          + "v2beta1/{parent=projects/*/agent/knowled"
          + "geBases/*}/documents\022\360\001\n\013GetDocument\0223.g"
          + "oogle.cloud.dialogflow.v2beta1.GetDocume"
          + "ntRequest\032).google.cloud.dialogflow.v2be"
          + "ta1.Document\"\200\001\202\323\344\223\002z\0227/v2beta1/{name=pr"
          + "ojects/*/knowledgeBases/*/documents/*}Z?"
          + "\022=/v2beta1/{name=projects/*/agent/knowle"
          + "dgeBases/*/documents/*}\022\377\001\n\016CreateDocume"
          + "nt\0226.google.cloud.dialogflow.v2beta1.Cre"
          + "ateDocumentRequest\032\035.google.longrunning."
          + "Operation\"\225\001\202\323\344\223\002\216\001\"7/v2beta1/{parent=pr"
          + "ojects/*/knowledgeBases/*}/documents:\010do"
          + "cumentZI\"=/v2beta1/{parent=projects/*/ag"
          + "ent/knowledgeBases/*}/documents:\010documen"
          + "t\022\352\001\n\016DeleteDocument\0226.google.cloud.dial"
          + "ogflow.v2beta1.DeleteDocumentRequest\032\035.g"
          + "oogle.longrunning.Operation\"\200\001\202\323\344\223\002z*7/v"
          + "2beta1/{name=projects/*/knowledgeBases/*"
          + "/documents/*}Z?*=/v2beta1/{name=projects"
          + "/*/agent/knowledgeBases/*/documents/*}\022\221"
          + "\002\n\016UpdateDocument\0226.google.cloud.dialogf"
          + "low.v2beta1.UpdateDocumentRequest\032\035.goog"
          + "le.longrunning.Operation\"\247\001\202\323\344\223\002\240\0012@/v2b"
          + "eta1/{document.name=projects/*/knowledge"
          + "Bases/*/documents/*}:\010documentZR2F/v2bet"
          + "a1/{document.name=projects/*/agent/knowl"
          + "edgeBases/*/documents/*}:\010document\022\377\001\n\016R"
          + "eloadDocument\0226.google.cloud.dialogflow."
          + "v2beta1.ReloadDocumentRequest\032\035.google.l"
          + "ongrunning.Operation\"\225\001\202\323\344\223\002\216\001\">/v2beta1"
          + "/{name=projects/*/knowledgeBases/*/docum"
          + "ents/*}:reload:\001*ZI\"D/v2beta1/{name=proj"
          + "ects/*/agent/knowledgeBases/*/documents/"
          + "*}:reload:\001*B\253\001\n#com.google.cloud.dialog"
          + "flow.v2beta1B\rDocumentProtoP\001ZIgoogle.go"
