...
public interface TextAnnotationOrBuilder
   ...
   */
  java.util.List<com.google.cloud.videointelligence.v1p2beta1.TextSegment> getSegmentsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.videointelligence.v1p2beta1.TextSegment segments = 2;</code>
   */
  com.google.cloud.videointelligence.v1p2beta1.TextSegmentOrBuilder getSegmentsOrBuilder(int index);
}
