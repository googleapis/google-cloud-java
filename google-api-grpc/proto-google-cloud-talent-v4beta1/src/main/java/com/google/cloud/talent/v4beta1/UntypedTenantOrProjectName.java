...
public class UntypedTenantOrProjectName extends TenantOrProjectName {
  ...
  public static List<UntypedTenantOrProjectName> parseList(List<String> formattedStrings) {
    List<UntypedTenantOrProjectName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<UntypedTenantOrProjectName> values) {
