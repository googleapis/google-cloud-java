...
public final class ProductSearchProto {
  ...
  static {
    ...
    internal_static_google_cloud_vision_v1p3beta1_ProductSearchParams_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_ProductSearchParams_descriptor,
        new java.lang.String[] { "CatalogName", "Category", "ProductCategory", "NormalizedBoundingPoly", "BoundingPoly", "View", "ProductSet", "ProductCategories", "Filter", });
    internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_descriptor =
      getDescriptor().getMessageTypes().get(1);
    internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_descriptor,
        new java.lang.String[] { "Category", "ProductCategory", "IndexTime", "Products", "Results", });
    internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_ProductInfo_descriptor =
      internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_descriptor.getNestedTypes().get(0);
    internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_ProductInfo_fieldAccessorTable = new
      com.google.protobuf.GeneratedMessageV3.FieldAccessorTable(
        internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_ProductInfo_descriptor,
        new java.lang.String[] { "ProductId", "ImageUri", "Score", });
    internal_static_google_cloud_vision_v1p3beta1_ProductSearchResults_Result_descriptor =
