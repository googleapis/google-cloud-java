...
public interface ParagraphOrBuilder
   ...
   */
  java.util.List<com.google.cloud.vision.v1p3beta1.Word> getWordsList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p3beta1.Word words = 3;</code>
   */
  java.util.List<? extends com.google.cloud.vision.v1p3beta1.WordOrBuilder> getWordsOrBuilderList();
  /**
   *
   *
   * <pre>
   ...
   * <code>repeated .google.cloud.vision.v1p3beta1.Word words = 3;</code>
   */
  com.google.cloud.vision.v1p3beta1.WordOrBuilder getWordsOrBuilder(int index);
