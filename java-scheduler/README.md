...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-scheduler" % "2.33.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-scheduler/2.33.0
