# Google Google Cloud Scheduler Client for Java
...
```Groovy
implementation 'com.google.cloud:google-cloud-scheduler:2.42.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-scheduler" % "2.42.0"
```
...
The client application making API calls must be granted [authorization scopes][auth-scopes] required for the desired Google Cloud Scheduler APIs, and the authenticated principal must have the [IAM role(s)][predefined-iam-roles] required to access GCP resources using the Google Cloud Scheduler API calls.
...
Google Cloud Scheduler uses both gRPC and HTTP/JSON for the transport layer.
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-scheduler/latest/overview
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-scheduler/2.42.0
