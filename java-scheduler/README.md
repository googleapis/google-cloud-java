...
```Groovy
implementation 'com.google.cloud:google-cloud-scheduler:2.3.11'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-scheduler" % "2.3.11"
```
...
[javadocs]: https://cloud.google.com/java/docs/reference/google-cloud-scheduler/latest/history
