...
```Scala
libraryDependencies += "com.google.cloud" % "google-cloud-meet" % "0.3.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-meet/0.3.0
