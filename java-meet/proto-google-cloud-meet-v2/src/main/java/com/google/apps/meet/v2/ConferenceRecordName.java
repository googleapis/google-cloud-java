...
public class ConferenceRecordName implements ResourceName {
  ...
  public static @Nullable ConferenceRecordName parse(String formattedString) {
  ...
  public static List<String> toStringList(List<@Nullable ConferenceRecordName> values) {
