...
public interface SmartNoteOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.apps.meet.v2.SmartNote)
   ...
   *
   * <code>
   * .google.apps.meet.v2.DocsDestination docs_destination = 5 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   *
   * <code>
   * .google.apps.meet.v2.SmartNote.State state = 2 [(.google.api.field_behavior) = OUTPUT_ONLY];
   * </code>
   *
   ...
   * @return The state.
   */
  com.google.apps.meet.v2.SmartNote.State getState();
  ...
  com.google.apps.meet.v2.SmartNote.DestinationCase getDestinationCase();
}
