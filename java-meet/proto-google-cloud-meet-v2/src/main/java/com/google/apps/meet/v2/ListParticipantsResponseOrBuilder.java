...
public interface ListParticipantsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.apps.meet.v2.ListParticipantsResponse)
   ...
   * <code>repeated .google.apps.meet.v2.Participant participants = 1;</code>
   */
  com.google.apps.meet.v2.ParticipantOrBuilder getParticipantsOrBuilder(int index);
