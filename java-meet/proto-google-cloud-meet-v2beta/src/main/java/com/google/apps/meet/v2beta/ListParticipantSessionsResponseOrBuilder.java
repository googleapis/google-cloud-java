...
public interface ListParticipantSessionsResponseOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.apps.meet.v2beta.ListParticipantSessionsResponse)
   ...
   * <code>repeated .google.apps.meet.v2beta.ParticipantSession participant_sessions = 1;</code>
   */
  com.google.apps.meet.v2beta.ParticipantSessionOrBuilder getParticipantSessionsOrBuilder(
      int index);
