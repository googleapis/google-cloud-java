...
public class MemberName implements ResourceName {
  ...
  public static @Nullable MemberName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        SPACE_MEMBER.validatedMatch(
            formattedString, "MemberName.parse: formattedString not in valid format");
    return of(matchMap.get("space"), matchMap.get("member"));
  }

  public static List<MemberName> parseList(List<String> formattedStrings) {
    List<MemberName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable MemberName> values) {
