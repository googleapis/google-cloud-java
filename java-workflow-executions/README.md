...
```Groovy
implementation 'com.google.cloud:google-cloud-workflow-executions:2.88.0'
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.cloud/google-cloud-workflow-executions/2.88.0
