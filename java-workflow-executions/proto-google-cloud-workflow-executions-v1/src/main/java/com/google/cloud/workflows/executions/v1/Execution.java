...
public final class Execution extends com.google.protobuf.GeneratedMessage
   ...
   */
  public static final class StackTraceElement extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(routine_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 2, routine_);
      }
    ...
    public int getSerializedSize() {
      ...
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(routine_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(2, routine_);
      }
      if (((bitField0_ & 0x00000001) != 0)) {
          ...
          while (!done) {
            ...
            switch (tag) {
              ...
              case 26:
                {
                  input.readMessage(
                      internalGetPositionFieldBuilder().getBuilder(), extensionRegistry);
                  bitField0_ |= 0x00000004;
                  break;
                } // case 26
              default:
   ...
   */
  public static final class StackTrace extends com.google.protobuf.GeneratedMessage
      implements
   ...
   */
  public static final class Status extends com.google.protobuf.GeneratedMessage
      implements
    ...
    public static final class Step extends com.google.protobuf.GeneratedMessage
      ...
      public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(routine_)) {
          com.google.protobuf.GeneratedMessage.writeString(output, 1, routine_);
        }
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(step_)) {
          com.google.protobuf.GeneratedMessage.writeString(output, 2, step_);
        }
        getUnknownFields().writeTo(output);
      }
      ...
      public int getSerializedSize() {
        ...
        size = 0;
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(routine_)) {
          size += com.google.protobuf.GeneratedMessage.computeStringSize(1, routine_);
        }
        if (!com.google.protobuf.GeneratedMessage.isStringEmpty(step_)) {
          size += com.google.protobuf.GeneratedMessage.computeStringSize(2, step_);
        }
        size += getUnknownFields().getSerializedSize();
        memoizedSize = size;
        return size;
    ...
    public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
          ...
          if (!other.currentSteps_.isEmpty()) {
            if (currentStepsBuilder_.isEmpty()) {
              ...
              currentStepsBuilder_ =
                  com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders
                      ? internalGetCurrentStepsFieldBuilder()
                      : null;
            } else {
      ...
      public com.google.cloud.workflows.executions.v1.Execution.Status.Step.Builder
        ...
        return internalGetCurrentStepsFieldBuilder().getBuilder(index);
      }
      ...
      public com.google.cloud.workflows.executions.v1.Execution.Status.Step.Builder
        ...
        return internalGetCurrentStepsFieldBuilder()
            .addBuilder(
                com.google.cloud.workflows.executions.v1.Execution.Status.Step
                    .getDefaultInstance());
      }
      ...
      public java.util.List<com.google.cloud.workflows.executions.v1.Execution.Status.Step.Builder>
        ...
        return internalGetCurrentStepsFieldBuilder().getBuilderList();
      }
   ...
   */
  public static final class StateError extends com.google.protobuf.GeneratedMessage
      implements
    ...
    private StateError(com.google.protobuf.GeneratedMessage.Builder<?> builder) {
      super(builder);
    }
    ...
    public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(details_)) {
        com.google.protobuf.GeneratedMessage.writeString(output, 1, details_);
      }
      if (type_
    ...
    public int getSerializedSize() {
      ...
      size = 0;
      if (!com.google.protobuf.GeneratedMessage.isStringEmpty(details_)) {
        size += com.google.protobuf.GeneratedMessage.computeStringSize(1, details_);
      }
      if (type_
          != com.google.cloud.workflows.executions.v1.Execution.StateError.Type.TYPE_UNSPECIFIED
              .getNumber()) {
  ...
  public void writeTo(com.google.protobuf.CodedOutputStream output) throws java.io.IOException {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(argument_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 5, argument_);
    }
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(workflowRevisionId_)) {
      com.google.protobuf.GeneratedMessage.writeString(output, 8, workflowRevisionId_);
    }
    if (callLogLevel_
  ...
  public int getSerializedSize() {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(argument_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(5, argument_);
    }
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(result_)) {
    ...
    if (!com.google.protobuf.GeneratedMessage.isStringEmpty(workflowRevisionId_)) {
      size += com.google.protobuf.GeneratedMessage.computeStringSize(8, workflowRevisionId_);
    }
    if (callLogLevel_
        != com.google.cloud.workflows.executions.v1.Execution.CallLogLevel
            .CALL_LOG_LEVEL_UNSPECIFIED
  ...
  public static final class Builder extends com.google.protobuf.GeneratedMessage.Builder<Builder>
    ...
    private void maybeForceBuilderInitialization() {
      if (com.google.protobuf.GeneratedMessage.alwaysUseFieldBuilders) {
        ...
        internalGetStateErrorFieldBuilder();
      }
    }
        ...
        while (!done) {
          ...
          switch (tag) {
            ...
            case 106:
              {
                input.readMessage(
                    internalGetStateErrorFieldBuilder().getBuilder(), extensionRegistry);
    ...
    public com.google.cloud.workflows.executions.v1.Execution.StateError.Builder
      ...
      bitField0_ |= 0x00001000;
      onChanged();
      return internalGetStateErrorFieldBuilder().getBuilder();
    }
