...
public class ResourceMaintenanceName implements ResourceName {
  private static final PathTemplate PROJECT_LOCATION_RESOURCE_MAINTENANCE =
  ...
  private ResourceMaintenanceName(Builder builder) {
    ...
    resourceMaintenance = Preconditions.checkNotNull(builder.getResourceMaintenance());
  }
  ...
  public static ResourceMaintenanceName of(
      String project, String location, String resourceMaintenance) {
    return newBuilder()
        .setProject(project)
  ...
  public static @Nullable ResourceMaintenanceName parse(String formattedString) {
    if (formattedString.isEmpty()) {
      return null;
    }
    Map<String, String> matchMap =
        PROJECT_LOCATION_RESOURCE_MAINTENANCE.validatedMatch(
            formattedString, "ResourceMaintenanceName.parse: formattedString not in valid format");
    return of(
        matchMap.get("project"), matchMap.get("location"), matchMap.get("resource_maintenance"));
  }

  public static List<ResourceMaintenanceName> parseList(List<String> formattedStrings) {
    List<ResourceMaintenanceName> list = new ArrayList<>(formattedStrings.size());
  ...
  public static List<String> toStringList(List<@Nullable ResourceMaintenanceName> values) {
      ...
      synchronized (this) {
        if (fieldValuesMap == null) {
          ...
          if (resourceMaintenance != null) {
            fieldMapBuilder.put("resource_maintenance", resourceMaintenance);
          }
  ...
  public String toString() {
    return PROJECT_LOCATION_RESOURCE_MAINTENANCE.instantiate(
        "project", project, "location", location, "resource_maintenance", resourceMaintenance);
  }
  ...
  public boolean equals(@Nullable Object o) {
    ...
    if (o != null && getClass() == o.getClass()) {
      ...
      return Objects.equals(this.project, that.project)
          ...
          && Objects.equals(this.resourceMaintenance, that.resourceMaintenance);
    }
    return false;
  }
