...
public interface MaintenanceSummaryOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.maintenance.api.v1.MaintenanceSummary)
   ...
   * </code>
   */
  java.util.List<com.google.cloud.maintenance.api.v1.MaintenanceSummary.Stats> getStatsList();
   ...
   * </code>
   */
  com.google.cloud.maintenance.api.v1.MaintenanceSummary.Stats getStats(int index);
   ...
   * </code>
   */
  java.util.List<? extends com.google.cloud.maintenance.api.v1.MaintenanceSummary.StatsOrBuilder>
   ...
   * </code>
   */
  com.google.cloud.maintenance.api.v1.MaintenanceSummary.StatsOrBuilder getStatsOrBuilder(
      int index);
}
