...
public interface ListDeploymentGroupRevisionsRequestOrBuilder
    extends
    // @@protoc_insertion_point(interface_extends:google.cloud.config.v1.ListDeploymentGroupRevisionsRequest)
