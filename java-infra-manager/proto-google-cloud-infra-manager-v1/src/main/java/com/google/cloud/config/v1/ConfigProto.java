  ...
  static {
    java.lang.String[] descriptorData = {
      "\n"
          ...
          + "\024artifacts_gcs_bucket\030\017 \001(\tB\003\340A\001H\001\210\001\001\022G\n"
          ...
          + "Deployment\022@projects/{project}/locations/{location}/deployments/{deployment}B\013\n"
          + "\tblueprintB\027\n"
          ...
          + "\014input_values\030\004"
          + " \003(\0132;.google.cloud.config.v1.TerraformBlueprint.InputValuesEntryB\003\340A\001\032]\n"
          ...
          + "(\01321.google.cloud.config.v1.ApplyResults.OutputsEntry\032W\n"
          ...
          + "deployment\030\003 \001(\013"
          + "2\".google.cloud.config.v1.DeploymentB\003\340A\002\022\027\n\n"
          ...
          + "delete_policy\030\004 \001(\0162<.google.clou"
          + "d.config.v1.DeleteDeploymentRequest.DeletePolicyB\003\340A\001\"F\n"
          ...
          + "\020preview_metadata\030\t \001(\01320.google.cloud.co"
          + "nfig.v1.PreviewOperationMetadataB\003\340A\003H\000\0224\n"
          ...
          + "\036config.googleapis.com/Revision\022Uprojects/{project}/location"
          + "s/{location}/deployments/{deployment}/revisions/{revision}B\013\n"
          + "\tblueprint\"\211\001\n"
          ...
          + "\004step\030\001 \001(\0162B.google.cloud.config."
          + "v1.DeploymentOperationMetadata.DeploymentStep\022;\n\r"
          ...
          + "\006intent\030\004 \001(\0162\'.go"
          + "ogle.cloud.config.v1.Resource.IntentB\003\340A\003\022:\n"
          + "\005state\030\005"
          ...
          + "\036config.googleapis.com/Resource\022jprojects/{project}"
          + "/locations/{location}/deployments/{deplo"
          + "yment}/revisions/{revision}/resources/{resource}\"B\n"
          ...
          + "\035config.googleapis.com/Preview\022:projec"
          + "ts/{project}/locations/{location}/previews/{preview}*\010previews2\007previewB\013\n"
          + "\tblueprintB\027\n"
          + "\025_artifacts_gcs_bucketB\016\n"
          + "\014_worker_poolB\030\n"
          + "\026_tf_version_constraint\"\344\003\n"
          + "\030PreviewOperationMetadata\022J\n"
          + "\004step\030\001 \001(\0162<.goo"
          + "gle.cloud.config.v1.PreviewOperationMetadata.PreviewStep\022C\n"
          ...
          + "gle.cloud.config.v1.PreviewResultB\003\340A\003\"M\n\r"
          ...
          + "..google.cloud.config.v1.TerraformVersion.StateB\003\340A\003\0225\n"
          ...
          + "&config.googleapis.com/TerraformVersion\022Mproject"
          + "s/{project}/locations/{location}/terrafo"
          + "rmVersions/{terraform_version}*\021terraformVersions2\020terraformVersionB\021\n"
          ...
          + "\016terraform_info\030\002 \001(\01323.googl"
          + "e.cloud.config.v1.ResourceChangeTerraformInfoB\003\340A\003\022B\n"
          + "\006intent\030\003 \001(\0162-.google.clou"
          + "d.config.v1.ResourceChange.IntentB\003\340A\003\022E\n"
          + "\020property_changes\030\004"
          + " \003(\0132&.google.cloud.config.v1.PropertyChangeB\003\340A\003\"a\n"
          + "\006Intent\022\026\n"
          + "\022INTENT_UNSPECIFIED\020\000\022\n\n"
          + "\006CREATE\020\001\022\n\n"
          + "\006UPDATE\020\002\022\n\n"
          ...
          + "$config.googleapis.com/ResourceChange\022\\projects/{project}/locati"
          + "ons/{location}/previews/{preview}/resour"
          + "ceChanges/{resource_change}*\017resourceChanges2\016resourceChange\"\305\001\n"
          ...
          + "\016terraform_info\030\002"
          + " \001(\01322.google.cloud.config.v1.ResourceDriftTerraformInfoB\003\340A\003\022C\n"
          + "\017property_drifts\030\003"
          + " \003(\0132%.google.cloud.config.v1.PropertyDriftB\003\340A\003:\244\001\352A\240\001\n"
          + "#config.googleapis.com/ResourceDrift\022Zprojects/{proj"
          + "ect}/locations/{location}/previews/{prev"
          + "iew}/resourceDrifts/{resource_drift}*\016resourceDrifts2\r"
          ...
          + "\017ListDeployments\022..google.cloud.config.v1.ListDeploymentsRequest\032/.google.",
      "cloud.config.v1.ListDeploymentsResponse\""
          + "@\332A\006parent\202\323\344\223\0021\022//v1/{parent=projects/*"
          + "/locations/*}/deployments\022\241\001\n\rGetDeploym"
          + "ent\022,.google.cloud.config.v1.GetDeployme"
          + "ntRequest\032\".google.cloud.config.v1.Deplo"
          + "yment\">\332A\004name\202\323\344\223\0021\022//v1/{name=projects"
          + "/*/locations/*/deployments/*}\022\354\001\n\020Create"
          + "Deployment\022/.google.cloud.config.v1.Crea"
          + "teDeploymentRequest\032\035.google.longrunning"
          + ".Operation\"\207\001\312A\037\n\nDeployment\022\021OperationM"
          + "etadata\332A\037parent,deployment,deployment_i"
          + "d\202\323\344\223\002=\"//v1/{parent=projects/*/location"
          + "s/*}/deployments:\ndeployment\022\356\001\n\020UpdateD"
          + "eployment\022/.google.cloud.config.v1.Updat"
          + "eDeploymentRequest\032\035.google.longrunning."
          + "Operation\"\211\001\312A\037\n\nDeployment\022\021OperationMe"
          + "tadata\332A\026deployment,update_mask\202\323\344\223\002H2:/"
          + "v1/{deployment.name=projects/*/locations"
          + "/*/deployments/*}:\ndeployment\022\304\001\n\020Delete"
          + "Deployment\022/.google.cloud.config.v1.Dele"
          + "teDeploymentRequest\032\035.google.longrunning"
          + ".Operation\"`\312A\037\n\nDeployment\022\021OperationMe"
          + "tadata\332A\004name\202\323\344\223\0021*//v1/{name=projects/"
          + "*/locations/*/deployments/*}\022\272\001\n\rListRev"
          + "isions\022,.google.cloud.config.v1.ListRevi"
          + "sionsRequest\032-.google.cloud.config.v1.Li"
          + "stRevisionsResponse\"L\332A\006parent\202\323\344\223\002=\022;/v"
          + "1/{parent=projects/*/locations/*/deploym"
          + "ents/*}/revisions\022\247\001\n\013GetRevision\022*.goog"
          + "le.cloud.config.v1.GetRevisionRequest\032 ."
          + "google.cloud.config.v1.Revision\"J\332A\004name"
          + "\202\323\344\223\002=\022;/v1/{name=projects/*/locations/*"
          + "/deployments/*/revisions/*}\022\263\001\n\013GetResou"
          + "rce\022*.google.cloud.config.v1.GetResource"
          + "Request\032 .google.cloud.config.v1.Resourc"
          + "e\"V\332A\004name\202\323\344\223\002I\022G/v1/{name=projects/*/l"
          + "ocations/*/deployments/*/revisions/*/res"
          + "ources/*}\022\306\001\n\rListResources\022,.google.clo"
          + "ud.config.v1.ListResourcesRequest\032-.goog"
          + "le.cloud.config.v1.ListResourcesResponse"
          + "\"X\332A\006parent\202\323\344\223\002I\022G/v1/{parent=projects/"
          + "*/locations/*/deployments/*/revisions/*}"
          + "/resources\022\302\001\n\031ExportDeploymentStatefile"
          + "\0228.google.cloud.config.v1.ExportDeployme"
          + "ntStatefileRequest\032!.google.cloud.config"
          + ".v1.Statefile\"H\202\323\344\223\002B\"=/v1/{parent=proje"
          + "cts/*/locations/*/deployments/*}:exportS"
          + "tate:\001*\022\312\001\n\027ExportRevisionStatefile\0226.go"
          + "ogle.cloud.config.v1.ExportRevisionState"
          + "fileRequest\032!.google.cloud.config.v1.Sta"
          + "tefile\"T\202\323\344\223\002N\"I/v1/{parent=projects/*/l"
          + "ocations/*/deployments/*/revisions/*}:ex"
          + "portState:\001*\022\277\001\n\017ImportStatefile\022..googl"
          + "e.cloud.config.v1.ImportStatefileRequest"
          + "\032!.google.cloud.config.v1.Statefile\"Y\332A\016"
          + "parent,lock_id\202\323\344\223\002B\"=/v1/{parent=projec"
          + "ts/*/locations/*/deployments/*}:importSt"
          + "ate:\001*\022\250\001\n\017DeleteStatefile\022..google.clou"
          + "d.config.v1.DeleteStatefileRequest\032\026.goo"
          + "gle.protobuf.Empty\"M\332A\004name\202\323\344\223\002@\";/v1/{"
          + "name=projects/*/locations/*/deployments/"
          + "*}:deleteState:\001*\022\310\001\n\016LockDeployment\022-.g"
          + "oogle.cloud.config.v1.LockDeploymentRequ"
          + "est\032\035.google.longrunning.Operation\"h\312A\037\n"
          + "\nDeployment\022\021OperationMetadata\332A\004name\202\323\344"
          + "\223\0029\"4/v1/{name=projects/*/locations/*/de"
          + "ployments/*}:lock:\001*\022\326\001\n\020UnlockDeploymen"
          + "t\022/.google.cloud.config.v1.UnlockDeploym"
          + "entRequest\032\035.google.longrunning.Operatio"
          + "n\"r\312A\037\n\nDeployment\022\021OperationMetadata\332A\014"
          + "name,lock_id\202\323\344\223\002;\"6/v1/{name=projects/*"
          + "/locations/*/deployments/*}:unlock:\001*\022\254\001"
          + "\n\016ExportLockInfo\022-.google.cloud.config.v"
          + "1.ExportLockInfoRequest\032 .google.cloud.c"
          + "onfig.v1.LockInfo\"I\332A\004name\202\323\344\223\002<\022:/v1/{n"
          + "ame=projects/*/locations/*/deployments/*"
          + "}:exportLock\022\313\001\n\rCreatePreview\022,.google."
          + "cloud.config.v1.CreatePreviewRequest\032\035.g"
          + "oogle.longrunning.Operation\"m\312A\034\n\007Previe"
          + "w\022\021OperationMetadata\332A\016parent,preview\202\323\344"
          + "\223\0027\",/v1/{parent=projects/*/locations/*}"
          + "/previews:\007preview\022\225\001\n\nGetPreview\022).goog"
          + "le.cloud.config.v1.GetPreviewRequest\032\037.g"
          + "oogle.cloud.config.v1.Preview\";\332A\004name\202\323"
          + "\344\223\002.\022,/v1/{name=projects/*/locations/*/p"
          + "reviews/*}\022\250\001\n\014ListPreviews\022+.google.clo"
          + "ud.config.v1.ListPreviewsRequest\032,.googl"
          + "e.cloud.config.v1.ListPreviewsResponse\"="
          + "\332A\006parent\202\323\344\223\002.\022,/v1/{parent=projects/*/"
          + "locations/*}/previews\022\270\001\n\rDeletePreview\022"
          + ",.google.cloud.config.v1.DeletePreviewRe"
          + "quest\032\035.google.longrunning.Operation\"Z\312A"
          + "\034\n\007Preview\022\021OperationMetadata\332A\004name\202\323\344\223"
          + "\002.*,/v1/{name=projects/*/locations/*/pre"
          + "views/*}\022\300\001\n\023ExportPreviewResult\0222.googl"
          + "e.cloud.config.v1.ExportPreviewResultReq"
          + "uest\0323.google.cloud.config.v1.ExportPrev"
          + "iewResultResponse\"@\202\323\344\223\002:\"5/v1/{parent=p"
          + "rojects/*/locations/*/previews/*}:export"
          + ":\001*\022\314\001\n\025ListTerraformVersions\0224.google.c"
          + "loud.config.v1.ListTerraformVersionsRequ"
          + "est\0325.google.cloud.config.v1.ListTerrafo"
          + "rmVersionsResponse\"F\332A\006parent\202\323\344\223\0027\0225/v1"
          + "/{parent=projects/*/locations/*}/terrafo"
          + "rmVersions\022\271\001\n\023GetTerraformVersion\0222.goo"
          + "gle.cloud.config.v1.GetTerraformVersionR"
          + "equest\032(.google.cloud.config.v1.Terrafor"
          + "mVersion\"D\332A\004name\202\323\344\223\0027\0225/v1/{name=proje"
          + "cts/*/locations/*/terraformVersions/*}\022\317"
          + "\001\n\023ListResourceChanges\0222.google.cloud.co"
          + "nfig.v1.ListResourceChangesRequest\0323.goo"
          + "gle.cloud.config.v1.ListResourceChangesR"
          + "esponse\"O\332A\006parent\202\323\344\223\002@\022>/v1/{parent=pr"
          + "ojects/*/locations/*/previews/*}/resourc"
          + "eChanges\022\274\001\n\021GetResourceChange\0220.google."
          + "cloud.config.v1.GetResourceChangeRequest"
          + "\032&.google.cloud.config.v1.ResourceChange"
          + "\"M\332A\004name\202\323\344\223\002@\022>/v1/{name=projects/*/lo"
          + "cations/*/previews/*/resourceChanges/*}\022"
          + "\313\001\n\022ListResourceDrifts\0221.google.cloud.co"
          + "nfig.v1.ListResourceDriftsRequest\0322.goog"
          + "le.cloud.config.v1.ListResourceDriftsRes"
          + "ponse\"N\332A\006parent\202\323\344\223\002?\022=/v1/{parent=proj"
          + "ects/*/locations/*/previews/*}/resourceD"
          + "rifts\022\270\001\n\020GetResourceDrift\022/.google.clou"
          + "d.config.v1.GetResourceDriftRequest\032%.go"
          + "ogle.cloud.config.v1.ResourceDrift\"L\332A\004n"
          + "ame\202\323\344\223\002?\022=/v1/{name=projects/*/location"
          + "s/*/previews/*/resourceDrifts/*}\032I\312A\025con"
          + "fig.googleapis.com\322A.https://www.googlea"
          + "pis.com/auth/cloud-platformB\374\002\n\032com.goog"
          + "le.cloud.config.v1B\013ConfigProtoP\001Z2cloud"
          + ".google.com/go/config/apiv1/configpb;con"
          + "figpb\252\002\026Google.Cloud.Config.V1\312\002\026Google\\"
          + "Cloud\\Config\\V1\352\002 Google::Cloud::ConfigS"
          + "ervice::V1\352AY\n!iam.googleapis.com/Servic"
          + "eAccount\0224projects/{project}/serviceAcco"
          + "unts/{service_account}\352Ai\n$cloudbuild.go"
          + "ogleapis.com/WorkerPool\022Aprojects/{proje"
          + "ct}/locations/{location}/workerPools/{wo"
          + "rker_pool}b\006proto3"
    };
    descriptor =
