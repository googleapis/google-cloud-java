...
```Groovy
implementation 'com.google.shopping:google-shopping-merchant-quota:1.2.0'
```

If you are using SBT, add this to your dependencies:

```Scala
libraryDependencies += "com.google.shopping" % "google-shopping-merchant-quota" % "1.2.0"
```
...
[maven-version-link]: https://central.sonatype.com/artifact/com.google.shopping/google-shopping-merchant-quota/1.2.0
