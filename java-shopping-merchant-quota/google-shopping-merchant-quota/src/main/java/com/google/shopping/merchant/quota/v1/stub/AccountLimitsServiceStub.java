...
/**
 * Base stub class for the AccountLimitsService service API.
 *
 * <p>This class is for advanced usage and reflects the underlying API directly.
 */
@Generated("by gapic-generator-java")
public abstract class AccountLimitsServiceStub implements BackgroundResource {

  public UnaryCallable<GetAccountLimitRequest, AccountLimit> getAccountLimitCallable() {
    throw new UnsupportedOperationException("Not implemented: getAccountLimitCallable()");
  }

  public UnaryCallable<ListAccountLimitsRequest, ListAccountLimitsPagedResponse>
      listAccountLimitsPagedCallable() {
    throw new UnsupportedOperationException("Not implemented: listAccountLimitsPagedCallable()");
  }

  public UnaryCallable<ListAccountLimitsRequest, ListAccountLimitsResponse>
      listAccountLimitsCallable() {
    throw new UnsupportedOperationException("Not implemented: listAccountLimitsCallable()");
  }
