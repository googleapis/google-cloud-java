...
import static com.google.shopping.merchant.quota.v1.QuotaServiceClient.ListQuotaGroupsPagedResponse;
...
import com.google.shopping.merchant.quota.v1.stub.HttpJsonQuotaServiceStub;
...
public class QuotaServiceClientHttpJsonTest {
  private static MockHttpService mockService;
  private static QuotaServiceClient client;

  @BeforeClass
  public static void startStaticServer() throws IOException {
    mockService =
        new MockHttpService(
            HttpJsonQuotaServiceStub.getMethodDescriptors(),
            QuotaServiceSettings.getDefaultEndpoint());
    QuotaServiceSettings settings =
        QuotaServiceSettings.newHttpJsonBuilder()
            .setTransportChannelProvider(
                QuotaServiceSettings.defaultHttpJsonTransportProviderBuilder()
