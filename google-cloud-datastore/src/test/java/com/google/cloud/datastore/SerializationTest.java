...
public class SerializationTest extends BaseSerializationTest {
  ...
  private static final Query<Key> QUERY2 = Query.newKeyQueryBuilder()
      .setKind("k")
      .setFilter(PropertyFilter.eq("p1", "hello"))
      .build();
  ...
  private static final Entity ENTITY2 =
      Entity.newBuilder(KEY2).set("null", NullValue.of()).build();
  private static final Entity ENTITY3 = Entity.newBuilder(KEY2)
      .set("p1", StringValue.newBuilder("hi1").setMeaning(10).build())
      .set("p2", StringValue.newBuilder("hi2").setMeaning(11).setExcludeFromIndexes(true).build())
  ...
  private static final ListValue LIST_VALUE = ListValue.newBuilder()
      .addValue(NULL_VALUE)
