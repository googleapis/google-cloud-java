...
/**
 * This is a red-black tree backed implementation of ImmutableSortedMap. This has better asymptotic complexity for
 * large collections, but performs worse in practice than an ArraySortedMap for small collections. It also uses
 * about twice as much memory.
 */
public class RBTreeSortedMap<K, V> extends ImmutableSortedMap<K,V> {
    ...
    public static <A, B> RBTreeSortedMap<A, B> fromMap(Map<A, B> values, Comparator<A> comparator) {
        return Builder.buildFrom(new ArrayList<A>(values.keySet()), values, ImmutableSortedMap.Builder.<A>identityTranslator(), comparator);
    }
    ...
    private static class Builder<A, B, C> {
        ...
        public static <A, B, C> RBTreeSortedMap<A, C> buildFrom(List<A> keys, Map<B, C> values,
            ...
            return new RBTreeSortedMap<A, C>(builder.root == null ? LLRBEmptyNode.<A, C>getInstance() : builder.root, comparator);
        }
    }
}
